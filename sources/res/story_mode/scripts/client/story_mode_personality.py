...
def preInit():
    ...
    OVERWRITE_CTRLS_DESC_MAP[story_mode_constants.ARENA_BONUS_TYPE.STORY_MODE] = {(CTRL_MODE_NAME.ARCADE): (
...
def init():
    ...
    registerScaleformBattlePackages(story_mode_constants.ARENA_GUI_TYPE.STORY_MODE, (b'story_mode.gui.Scaleform.daapi.view.battle',))
