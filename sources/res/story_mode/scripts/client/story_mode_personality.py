...
class ClientStoryModeBattleMode(battle_mode.StoryModeBattleMode):
    ...
    def _client_battleRequiredLibraries(self):
        return [b'story_mode|story_mode_battle.swf', b'story_mode|storyModeComponents.swf']

    @property
    def _client_lobbyRequiredLibraries(self):
        return [b'story_mode|story_mode_lobby.swf']
    ...
    def _client_controlModes(self):
        return {(CTRL_MODE_NAME.ARCADE): (
                                   StoryModeArcadeControlMode, b'arcadeMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SNIPER): (
                                   StoryModeSniperControlMode, b'sniperMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.MAP_CASE_ARCADE_EPIC_MINEFIELD): (
                                                           StoryModeArcadeMinefieldControlMode, b'arcadeEpicMinefieldMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SM_STRATEGIC): (
                                         SMStrategicMapCaseControlMode, b'strategicMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SM_ENTITY_VIEW): (
                                           SMEntityViewMode, b'postMortemMode', CTRL_TYPE.USUAL)}
...
class ClientOnboardingBattleMode(ClientStoryModeBattleMode):
    ...
    def _client_controlModes(self):
        return {(CTRL_MODE_NAME.ARCADE): (
                                   OnboardingArcadeControlMode, b'arcadeMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SNIPER): (
                                   OnboardingSniperControlMode, b'sniperMode', CTRL_TYPE.USUAL)}
