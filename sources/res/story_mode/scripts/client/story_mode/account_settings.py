...
_ENTRY_POINT_ANIMATION_SEEN_ID_KEY = b'entry_point_animation_seen_id'
_EVENT_ENTRY_POINT_SHOWN_KEY = b'event_entry_point_shown'
_EVENT_VISITED_KEY = b'event_visited'
_UNLOCKED_TASKS_SHOWN_KEY = b'unlocked_tasks_shown'
_WELCOME_SCREEN_SEEN_KEY = b'welcome_screen_seen'
_NEWBIE_ADVERTISING_SCREEN_SEEN_KEY = b'newbie_advertising_screen_seen'
_NEW_MISSION_SEEN_ID_KEY = b'new_mission_seen_id'
_DEFAULT_EVENT_NAME = b'story_mode_event'
