...
_STORY_MODE_VO_META = base.DictMeta({b'finishResult': b'', 
   ...
   b'arenaDateTime': b'', 
   b'vehicleName': b'', 
   b'vehicle': {}, b'rewards': {}, b'progressionInfo': {}})
...
STORY_MODE_RESULTS_BLOCK.addNextComponent(VehicleNameItem(b'vehicleName', _RECORD.PERSONAL))
STORY_MODE_RESULTS_BLOCK.addNextComponent(VehicleBlock(_VEHICLE_VO_META, b'vehicle'))
STORY_MODE_RESULTS_BLOCK.addNextComponent(RewardsBlock(base.ListMeta(), b'rewards'))
STORY_MODE_RESULTS_BLOCK.addNextComponent(ProgressionInfoItem(b'progressionInfo', _RECORD.PERSONAL))
