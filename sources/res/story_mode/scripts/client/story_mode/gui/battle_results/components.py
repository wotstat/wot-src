...
class MissionIdItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        return value[b'avatar'][b'missionId']
...
class IsForceOnboardingItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        return value[b'avatar'][b'isForceOnboarding']
...
class VehicleNameItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        mission = self._storyModeCtrl.missions.getMission(value[b'avatar'][b'missionId'])
        if mission is None:
            return b''
        else:
...
class ProgressionInfoItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        return value[b'avatar'].get(b'progressionInfo', {})
