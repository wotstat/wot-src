...
class BadgeTooltip(ViewImpl):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        badgeIcon = R.images.gui.maps.icons.library.badges.c_220x220.dyn((b'badge_{}').format(self._badgeId))()
        ...
        self.viewModel.setDescription(backport.text(R.strings.badge.dyn((b'badge_{}_descr').format(self._badgeId))()))
        badgeIcon = R.images.gui.maps.icons.library.badges.c_24x24.dyn((b'badge_{}').format(self._badgeId))()
