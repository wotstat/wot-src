...
class TaskModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addNumberProperty(b'taskId', 0)
        self._addNumberProperty(b'taskState')
        self._addBoolProperty(b'isCompletedFirstTime', False)
        self._addNumberProperty(b'secondsBeforeUnlock', 0)
        self._addBoolProperty(b'isUnlockedFirstTime', False)
        self._addNumberProperty(b'animationCounter', 0)
