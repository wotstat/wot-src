...
class StoryModeEntity(PreQueueEntity):
    ...
    def _skippedShowGUI(self):
        return self._guiCtx.get(b'skipShowGUI', False)
    ...
    def _doQueue(self, ctx):
        ...
        LOG_DEBUG(b'Sends request on queuing to the  Story Mode battles', self._queueType, ctx)
        return

    def _doDequeue(self, ctx):
        self._accountComponent.dequeueBattle()
        LOG_DEBUG(b'Sends request on dequeuing from the Story Mode battles', self._queueType)
        return
