...
import typing, BigWorld, Event, SoundGroups, WWISE
...
class StoryModeController(IStoryModeController, IGlobalListener):
    ...
    def skipOnboarding(self):
        _logger.debug(b'skipOnboarding')
    ...
    def onAccountShowGUISkipped(self, ctx):
        ...
        skippedShowGUI = ctx.get(b'skipShowGUI', False)
        self.__canSkipOnboarding = ctx.get(b'canSkipOnboarding', False)
