...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.STORY_MODE_WEB_VIEW_TRANSPARENT, StoryModeWebViewTransparent, b'browserScreen.swf', WindowLayer.FULLSCREEN_WINDOW, VIEW_ALIAS.STORY_MODE_WEB_VIEW_TRANSPARENT, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.STORY_MODE_OUTRO_VIDEO_WINDOW, OutroVideo, getSwfExtensionUrl(b'story_mode', b'IntroVideo.swf'), WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.STORY_MODE_BATTLE_RESULTS, BattleResultsWindow, b'', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE))
