...
class StoryModeBattlePageBase(object):
    ...
    def _onBattleLoadingStart(self):
        ...
        _logger.debug(b'[%s] _onBattleLoadingStart: missionId=%s', self, missionId)
