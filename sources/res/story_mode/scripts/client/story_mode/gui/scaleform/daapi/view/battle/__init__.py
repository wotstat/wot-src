...
def getViewSettings():
    return (
     ...
     GroupedViewSettings(VIEW_ALIAS.STORY_MODE_SETTINGS_WINDOW, StoryModeSettingsWindow, b'settingsWindow.swf', WindowLayer.TOP_WINDOW, b'storyModeSettingsWindow', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
...
class _StoryModeBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         ...
         (
          VIEW_ALIAS.STORY_MODE_SETTINGS_WINDOW, self.loadViewBySharedEvent),
         (
          VIEW_ALIAS.STORY_MODE_INTRO_VIDEO_WINDOW, self.loadViewBySharedEvent))
