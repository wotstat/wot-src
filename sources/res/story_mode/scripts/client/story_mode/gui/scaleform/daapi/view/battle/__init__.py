...
class ConditionalStoryModeViewSettings(ComponentSettings):
    ...
    def __new__(cls, alias, onBoardingClazz, storyModeClazz, scope):
        arenaGuiType = getattr(BigWorld.player(), b'arenaGuiType', ARENA_GUI_TYPE.UNKNOWN)
...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.STORY_MODE_BATTLE_PAGE, StoryModeBattlePage, getSwfExtensionUrl(b'story_mode', b'storyModeBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.ONBOARDING_BATTLE_PAGE, OnboardingBattlePage, getSwfExtensionUrl(b'story_mode', b'onboardingBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.INGAME_HELP, StoryModeIngameHelpWindow, b'ingameHelpWindow.swf', WindowLayer.WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, canClose=False, canDrag=False, isModal=True),
     ViewSettings(VIEW_ALIAS.INGAME_MENU, StoryModeIngameMenu, b'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     ViewSettings(VIEW_ALIAS.STORY_MODE_INTRO_VIDEO_WINDOW, IntroVideo, getSwfExtensionUrl(b'story_mode', b'IntroVideo.swf'), WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.ONBOARDING_SETTINGS_WINDOW, OnboardingSettingsWindow, b'settingsWindow.swf', WindowLayer.TOP_WINDOW, b'storyModeSettingsWindow', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
