...
class OnboardingSettingsWindow(SettingsWindow):
    ...
    def __init__(self, **kwargs):
        super(OnboardingSettingsWindow, self).__init__(ctx={b'redefinedKeyMode': True, 
           b'isBattleSettings': True, 
           b'tabIndex': (self.sessionProvider.dynamic.overrideSettingsController.defaultTab)})
    ...
    def as_setCountersDataS(self, countersData):
        ...
        countersData = [item for item in countersData if self._TAB_NAME_TO_INDEX[item[b'tabId']] not in disabledTabs]
