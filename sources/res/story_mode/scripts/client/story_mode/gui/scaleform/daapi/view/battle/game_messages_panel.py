...
class StoreModeGameMessagesPanel(GameMessagesPanel):
    ...
    def sendEndGameMessage(self, winningTeam, reason):
        ...
        endGameMsgData = {b'title': (backport.text(R.strings.sm_battle.battleResult.resultLabel.dyn(messageType)())), 
           b'subTitle': (backport.text(rReason.num(reason, rReason.default)()))}
