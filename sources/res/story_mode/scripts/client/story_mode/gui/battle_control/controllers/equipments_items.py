...
_SMN_ARCADE_ARTILLERY_ITEMS = (b'arcade_artillery_smn_battleship_lvl1', b'arcade_artillery_smn_battleship_lvl1_hard', b'arcade_artillery_smn_battleship_lvl2', b'arcade_artillery_smn_battleship_lvl2_hard', b'arcade_artillery_smn_battleship_lvl3', b'arcade_artillery_smn_battleship_lvl3_hard')
_SMN_ARCADE_ARTILLERY_DESTROYER_ITEMS = {
 b'arcade_artillery_smn_destroyer',
 b'arcade_artillery_smn_destroyer_hard'}
...
class AbilityItem(equipment_ctrl._RefillEquipmentItem, equipment_ctrl._OrderItem):
    ...
    def canActivate(self, entityName=None, avatar=None):
        if self._stage in [STAGES.STARTUP_COOLDOWN, STAGES.COOLDOWN] and self._timeRemaining > 0:
            error = equipment_ctrl._ActivationError(ABILITY_ON_COOLDOWN_ACTIVATION_ERROR_KEY, {b'name': (self.getDescriptor().userString)})
            return (
             False, error)
...
class DistractionAbilityItem(SMStrategicAbilityItem):
    _PREFAB_URL = b'content/CGFPrefabs/Storymode/tank_rectangle.prefab'
