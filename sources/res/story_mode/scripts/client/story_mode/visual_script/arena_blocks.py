...
story_mode_missions, = dependencyImporter(b'story_mode_common.configs.story_mode_missions')
...
class GetStoryModeDifficulty(Block, ArenaMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._result = self._makeDataOutputSlot(b'result', SLOT_TYPE.STR, self._getResult)
        return

    def _getResult(self):
        difficulty = MissionsDifficulty.UNDEFINED.value
        missionId = self._arena.getValue().extraData.get(b'missionId', MissionId.UNDEFINED)
