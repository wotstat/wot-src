...
_MAIN_REWARDS = (b'styleProgress', b'dossier_badge', b'dogTagComponents')
_BonusData = namedtuple(b'_BonusData', (b'bonus', b'tooltip'))

class _BaseRewardsView(ViewImpl):
    __slots__ = (b'_bonusData',)
...
class RanksRewardsView(_QuestRewardsView):
    ...
    def _packBonuses(self, *args, **kwargs):
        ...
        return packRanksRewardsQuestBonuses(quest=first(kwargs[b'quests']), periodicQuest=periodicQuest)
...
class TokensRewardsView(_QuestRewardsView):
    ...
    def _packBonuses(self, *args, **kwargs):
        return packTokensRewardsQuestBonuses(quest=first(kwargs[b'quests']))
...
class QualificationRewardsView(_QuestRewardsView):
    __slots__ = (b'__divisions',)

    def __init__(self, *args, **kwargs):
        super(QualificationRewardsView, self).__init__(*args, **kwargs)
        self.__divisions = self.__getDivisions(kwargs[b'quests'])
        return
    ...
    def _packBonuses(self, *args, **kwargs):
        return packQualificationRewardsQuestBonuses(quests=kwargs[b'quests'])
...
class YearlyRewardsView(_BaseRewardsView):
    __slots__ = (b'__hasOfferReward', b'__hasYearlyVehicle', b'__bonuses', b'__willOpenRewardsSelection')
    __comp7Controller = dependency.descriptor(IComp7Controller)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__bonuses = kwargs[b'bonuses']
        tokenBonus = self.__bonuses.get(b'tokens', {}).keys()
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as vm:
            showSeasonResults = kwargs[b'showSeasonResults']
    ...
    def __onWindowAccessibilityChanged(self, _):
        ...
        self.__onVideoStateChange({b'state': newVideoState})
        return
...
class SelectedRewardsView(_BaseRewardsView):
    ...
    def _packBonuses(self, *args, **kwargs):
        return packSelectedRewardsBonuses(bonuses=kwargs[b'bonuses'])
