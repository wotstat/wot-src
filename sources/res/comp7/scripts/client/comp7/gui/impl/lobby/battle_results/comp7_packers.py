...
class Comp7PlayerInfo(PlayerInfo):
    ...
    def packModel(cls, model, battleResults, vehicleSumInfo):
        ...
        if vehicleSumInfo.avatar:
            comp7QualActive = vehicleSumInfo.avatar.extensionInfo.get(b'comp7QualActive', False)
            rank, divisionIdx, _serialIdx = vehicleSumInfo.avatar.extensionInfo.get(b'comp7Rank', (0, 0, 0))
            if rank > 0:
            ...
            if vehicleSumInfo.avatar.extensionInfo.get(b'isSuperSquad', False):
