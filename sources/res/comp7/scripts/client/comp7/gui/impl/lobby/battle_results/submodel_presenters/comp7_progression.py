...
class Comp7ProgressionSubPresenter(BattleResultsSubPresenter):
    ...
    def __packProgressionData(self, model, battleResults):
        avatarResults = battleResults.results[b'personal'][b'avatar']
        prevRating = avatarResults.get(b'comp7Rating', 0)
        ratingDelta = avatarResults.get(b'comp7RatingDelta', 0)
        rank, _, _ = avatarResults.get(b'comp7Rank', (0, 0, 0))
        ...
        isQualActive = battleResults.results[b'personal'][b'avatar'].get(b'comp7QualActive', False)
        if isQualActive:
    ...
    def __setQualificationData(self, model, battleResults, comp7Controller=None):
        comp7QualBattleIndex = battleResults.results[b'personal'][b'avatar'].get(b'comp7QualBattleIndex', False)
