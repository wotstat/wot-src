...
class WeeklyQuestsModel(ViewModel):
    __slots__ = (b'onAnimationStart', b'onAnimationEnd', b'onGoToRewardsSelection')
    QUESTS_PER_WEEK = 5
    ...
    def _initialize(self):
        ...
        self._addNumberProperty(b'previousQuestsPassed', 0)
        self._addArrayProperty(b'progressPoints', Array())
        self._addNumberProperty(b'choiceRewardState')
