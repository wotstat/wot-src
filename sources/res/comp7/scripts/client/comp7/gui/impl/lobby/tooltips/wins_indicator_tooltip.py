...
class WinsIndicatorTooltip(ViewImpl):
    ...
    def _onLoading(self):
        ...
        with self.viewModel.transaction() as vm:
            ...
            vm.setWinRate(self.__params[b'winRate'])
            vm.setWinsCount(self.__params[b'winsCount'])
            vm.setLossCount(self.__params[b'lossCount'])
            vm.setDrawCount(self.__params[b'drawCount'])
        return
