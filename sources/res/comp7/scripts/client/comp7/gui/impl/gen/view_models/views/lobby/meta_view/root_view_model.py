...
class RootViewModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'yearlyRewardsModel', YearlyRewardsModel())
        self._addViewModelProperty(b'shopModel', ShopModel())
        self._addViewModelProperty(b'yearlyStatisticsModel', YearlyStatisticsModel())
        self._addViewModelProperty(b'claimRewardsModel', ClaimRewardsModel())
