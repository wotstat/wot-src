...
class DamageIndicatorTooltip(ViewImpl):
    ...
    def _onLoading(self):
        ...
        with self.viewModel.transaction() as vm:
            ...
            vm.setAverageDamageDealt(self.__params[b'averageDamageDealt'])
            vm.setRecordDamageDealt(self.__params[b'recordDamageDealt'])
            vm.setRecordDamageDealtVehicleName(self.__params[b'recordDamageDealtVehicleName'])
        return
