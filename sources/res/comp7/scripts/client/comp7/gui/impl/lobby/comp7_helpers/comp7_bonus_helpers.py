...
class CustomizationsBonusHelper(_BaseBonusHelper):
    ...
    def getBonusType(bonus):
        ...
        if c11nItem and c11nItem.itemTypeName == b'style' and c11nItem.is3D:
...
_BONUS_HELPERS_MAP = {b'items': _ItemsBonusHelper, 
   b'customizations': CustomizationsBonusHelper, 
   b'goodies': _GoodiesBonusHelper, 
   b'crewBooks': _CrewBooksBonusHelper, 
   b'vehicles': _VehiclesBonusHelper, 
   b'dogTagComponents': _DogTagBonusHelper, 
   b'dossier': _DossierBonusHelper, 
   ...
   b'style3DProgression': _Style3DProgressBonusHelper, 
   b'tankmen': _TankmenBonusHelper, 
   b'tokens': _TokensBonusHelper, 
   b'equipCoin': _EquipCoinBonusHelper, 
   b'battleToken': _TokenBonusHelper}
