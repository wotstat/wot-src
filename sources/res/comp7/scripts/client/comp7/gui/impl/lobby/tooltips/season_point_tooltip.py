...
class SeasonPointTooltip(ViewImpl):
    ...
    def _onLoading(self):
        ...
        with self.viewModel.transaction() as vm:
            vm.setState(self.__params[b'state'])
            vm.setIgnoreState(self.__params[b'ignoreState'])
            vm.setSeasonPointExchangeRate(self.__comp7Controller.getYearlyRewards().extra.get(b'crystal', 0))
        return
