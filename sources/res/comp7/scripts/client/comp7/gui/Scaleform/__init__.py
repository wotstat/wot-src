...
def registerComp7Scaleform():
    registerScaleformLobbyPackages((b'comp7.gui.Scaleform.daapi.view.lobby',))
    registerScaleformBattlePackages(ARENA_GUI_TYPE.COMP7, BATTLE_PACKAGES + (b'comp7.gui.Scaleform.daapi.view.battle',))
    registerScaleformBattlePackages(ARENA_GUI_TYPE.TOURNAMENT_COMP7, BATTLE_PACKAGES + (b'comp7.gui.Scaleform.daapi.view.battle',))
    registerScaleformBattlePackages(ARENA_GUI_TYPE.TRAINING_COMP7, BATTLE_PACKAGES + (b'comp7.gui.Scaleform.daapi.view.battle',))
    registerLobbyTooltipsBuilders([
     (
      b'comp7.gui.Scaleform.daapi.view.tooltips.comp7_lobby_builders', COMP7_TOOLTIPS.COMP7_LOBBY_SET)])
    COMP7_BATTLE_TOOLTIPS.COMP7_BATTLE_SET.append(TOOLTIPS_CONSTANTS.VEHICLE_ROLES)
    registerBattleTooltipsBuilders([
     (
      b'comp7.gui.Scaleform.daapi.view.tooltips.comp7_battle_builders', COMP7_BATTLE_TOOLTIPS.COMP7_BATTLE_SET)])
    return
