...
class Comp7BattleMode(AbstractBattleMode):
    ...
    _SEASON_TYPE_BY_NAME = b'comp7'
    _SEASON_TYPE = comp7_constants.GameSeasonType.COMP7
    _SEASON_MANAGER_TYPE = (comp7_constants.GameSeasonType.COMP7, b'comp7_config')
    _SM_TYPE_BATTLE_RESULT = b'comp7BattleResults'
    _SM_TYPES = [
