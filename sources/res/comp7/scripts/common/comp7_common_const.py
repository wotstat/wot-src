...
__COMP7_RENT_VEHICLES_QUEST_ID_TEMPLATE = b'comp7_{maskot}_{season}_rent_vehicles'
__COMP7_TOKEN_PREFIX_TEMPLATE = b'comp7_{maskot}_{season}'
__COMP7_SEASON_POINT_ASSET_TEMPLATE = b'comp7_season_points:{maskot}:{season}'
__COMP7_SEASON_NAME_TEMPLATE = b'comp7_{maskot}_{season}'
__COMP7_WEEKLY_QUESTS_COMPLETE_TOKEN_TEMPLATE = b'comp7_{maskot}_{season}_weekly_quests_complete'
COMP7_WEEKLY_QUESTS_COMPLETE_TOKEN_REGEXP = re.compile(__COMP7_WEEKLY_QUESTS_COMPLETE_TOKEN_TEMPLATE.format(maskot=b'\\d', season=b'\\d'))
__COMP7_SEASON_POINTS_ENTITLEMENT_TEMPLATE = b'comp7_season_points:{maskot}:{season}'
__COMP7_RATING_ENTITLEMENT_PREFIX = b'comp7_rating_points'
__COMP7_RATING_ENTITLEMENT_TEMPLATE = __COMP7_RATING_ENTITLEMENT_PREFIX + b':{maskot}:{season}'
__COMP7_ELITE_ENTITLEMENT_TEMPLATE = b'comp7_elite_rank:{maskot}:{season}'
__COMP7_ACTIVITY_ENTITLEMENT_TEMPLATE = b'comp7_activity_points:{maskot}:{season}'
__COMP7_MAX_RANK_ENTITLEMENT_TEMPLATE = b'comp7_max_achieved_rank:{maskot}:{season}'
COMP7_OFFER_GIFT_TEMPLATE = b'{token}_gift'
COMP7_OFFER_PREFIX = (b'offer:comp7_{}').format(COMP7_MASKOT_ID)
COMP7_OFFER_WEEKLY_QUESTS_REWARD_TOKEN_TEMPLATE = (b'offer:{}_weekly').format(__COMP7_TOKEN_PREFIX_TEMPLATE)
...
COMP7_OFFER_YEARLY_REWARD_TOKEN_PREFIX = (b'{}_yearly').format(COMP7_OFFER_PREFIX)
COMP7_OFFER_REWARD_CATEGORY_TOKEN_TEMPLATE = b'{token}:{category}'
COMP7_ENTITLEMENT_EXPIRES = None
COMP7_YEARLY_ACHIEVEMENT_PREFIX = (b'comp7_{}_yearly').format(COMP7_MASKOT_ID)
COMP7_YEARLY_REWARD_TOKEN = (b'comp7_{}_yearly_reward').format(COMP7_MASKOT_ID)
...
def parseRatingEnt(entCode):
    if not entCode.startswith(__COMP7_RATING_ENTITLEMENT_PREFIX):
        ...
        _, mascotID, index = entCode.split(b':', 2)
