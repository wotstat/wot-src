...
class ClientLastStandBattleMode(last_stand_constants.LastStandBattleMode):
    ...
    def _client_lobbyRequiredLibraries(self):
        return [b'last_stand|last_stand_lobby.swf', b'last_stand|components.swf']
    ...
    def _client_controlModes(self):
        return {(CTRL_MODE_NAME.ARCADE): (
                                   LSArcadeControlMode, b'arcadeMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SNIPER): (
                                   LSSniperControlMode, b'sniperMode', CTRL_TYPE.USUAL)}
    ...
    def _client_equipmentTriggers(self):
        ...
        return [
         (
          b'LSartillery_deathzone', _EventArtilleryItem, _ReplayEventArtilleryItem),
         (
          b'LSdetonator_deathzone', _EventArtilleryItem, _ReplayEventArtilleryItem)]
    ...
    def _client_equipmentItems(self):
        ...
        return [
         (
          b'LS_selfRepair', _HpRepairAndCrewHeal, LSEquipmentReplayItem),
         (
          b'LS_teamRepair', LSEquipmentItem, LSEquipmentReplayItem),
         (
          b'LS_damageShield', LSDamageShield, LSEquipmentReplayItem),
         (
          b'LS_fastReload', _FastReload, LSEquipmentReplayItem),
         (
          b'LS_aoeDamageInstantShot', _LSInstantShot, LSEquipmentReplayItem),
         (
          b'LS_aoeStunInstantShot', _LSInstantShot, LSEquipmentReplayItem),
         (
          b'LS_aoeDrainEnemyHpInstantShot', _LSInstantShot, LSEquipmentReplayItem),
         (
          b'LS_invisibility', LSEquipmentItem, LSEquipmentReplayItem),
         (
          b'LS_doubleDamage', _AbilityWithDuration, LSEquipmentReplayItem),
         (
          b'LS_nitro', _NitroEquipmentItem, _NitroEquipmentReplayItem),
         (
          b'LS_healSituational', LSSituationalEquipmentItem, LSEquipmentReplayItem),
         (
          b'LS_nitroSituational', LSSituationalEquipmentItem, LSEquipmentReplayItem),
         (
          b'LS_extraDamageSituational', LSSituationalEquipmentItem, LSEquipmentReplayItem)]
    ...
    def _client_equipmentItemsTooltipMovies(self):
        ...
        moduleMovies = {b'ls_selfRepairKit': b'last_stand|ls_selfRepairKit', 
           b'ls_teamRepairKit': b'last_stand|ls_teamRepairKit', 
           b'ls_damageShield': b'last_stand|ls_damageShield', 
           b'ls_fastReload': b'last_stand|ls_fastReload', 
           b'ls_invisibility': b'last_stand|ls_invisibility', 
           b'ls_aoeDamageInstantShot': b'last_stand|ls_aoeDamageInstantShot', 
           b'ls_aoeStunInstantShot': b'last_stand|ls_aoeStunInstantShot', 
           b'ls_aoeDrainEnemyHpInstantShot': b'last_stand|ls_aoeDrainEnemyHpInstantShot', 
           b'ls_doubleDamage': b'last_stand|ls_doubleDamage', 
           b'ls_nitro': b'last_stand|ls_nitro', 
           b'ls_healSituational': b'last_stand|ls_healSituational', 
           b'ls_nitroSituational': b'last_stand|ls_nitroSituational', 
           b'ls_extraDamageSituational': b'last_stand|ls_extraDamageSituational'}
        advancedTooltipMovies = {LS_CONSUMABLE_EMPTY_TOOLTIP: b'last_stand|ls_equipment'}
        return (
...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionLobbyPackages(__name__, [
     b'last_stand.gui.scaleform.daapi.view.lobby',
