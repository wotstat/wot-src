...
class LSVehicleSoundComponent(DynamicScriptComponent):
    ...
    def soulsContainer(self):
        return self.entity.dynamicComponents.get(b'lsSoulsContainer')
    ...
    def onLootFailed(self, lootID, vehicleIDs):
        self._components.call(b'onLootFailed', lootID, vehicleIDs)
        return

    def onLootSucceed(self, lootID, vehicleIDs):
        self._components.call(b'onLootSucceed', lootID, vehicleIDs)
        return
    ...
    def onDamageReceived(self, attackerID, attackReasonID, damage):
        ...
        self._components.call(b'onDamageReceived', attackerID, attackReason, damage)
        return
