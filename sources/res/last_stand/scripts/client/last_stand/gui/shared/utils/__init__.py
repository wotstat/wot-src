...
def findMarkerEntity():
    return [e for e in BigWorld.entities.valuesOfType(b'EmptyEntity') if any(c.__class__.__name__ == b'EntityMarkerComponent' for c in viewvalues(e.dynamicComponents))]
