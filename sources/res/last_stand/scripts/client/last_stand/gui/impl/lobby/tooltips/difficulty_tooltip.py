...
class DifficultyTooltipView(ViewImpl):
    __slots__ = (b'__isHangar', b'__difficulty', b'__completedMissions', b'__state', b'__isLocked')
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as model:
            ...
            model.setModifier(metaConfig.get(b'modifier', DEFAULT_DIFFICULTY_MODIFIER))
