...
class LSSelectorItem(ModeSelectorLegacyItem):
    ...
    def _onInitializing(self):
        ...
        for reward in self.lsCtrl.getModeSettings().modeSelectorShowRewards.get(b'rewards', []):
    ...
    def __setBattlePassState(self, itemVM):
        ...
        isShown = self.lsCtrl.getModeSettings().modeSelectorShowRewards.get(b'battlePassPoints', False)
