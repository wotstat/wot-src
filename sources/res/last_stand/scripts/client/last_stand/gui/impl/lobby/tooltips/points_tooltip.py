...
class PointsTooltipView(ViewImpl):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as model:
            ...
            model.setEndDate(self.lsCtrl.getConfig().get(b'endDate', 0))
            ...
            if self.__isPostBattle:
                ...
                model.setObelisk(self.__ctx.get(b'obelisk', 0))
                model.setVehicleDaily(self.__ctx.get(b'vehicleDaily', 0))
                model.setMissionDaily(self.__ctx.get(b'missionDaily', 0))
        return
