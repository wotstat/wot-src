...
class LSGlobalChatController(ILSGlobalChatController, IGlobalListener):
    ...
    def __init__(self):
        ...
        if not self.__clientID:
            LOG_ERROR(b'Client ID not found. Last stand channel does not work')
    ...
    def isChatEnabled(self):
        ...
        return sysChannelConfig.get(b'sysChannelsConfig', {}).get(LAZY_CHANNEL.LAST_STAND_GLOBAL_CHANNEL, False)
