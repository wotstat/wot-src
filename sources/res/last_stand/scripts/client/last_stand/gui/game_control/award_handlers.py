...
class LSAwardWindowHandler(ServiceChannelHandler):
    ...
    def _showDifficulty(self, data):
        ...
        for tokenID in difficulties:
            ...
            difficultyKey = (b'difficultyLevel_{}').format(difficulty.value)
            ...
            SystemMessages.pushMessage(difficultyUnlockedTitle, type=SM_TYPE.lsDifficultyOpenMessage, priority=NotificationPriorityLevel.MEDIUM, messageData={b'description': difficultyUnlockedDescription})
    ...
    def _showDifficultyMissions(self, data):
        ...
        for tokenID in difficultyMissions:
            _, difficulty, index, __ = tokenID.split(b':')
