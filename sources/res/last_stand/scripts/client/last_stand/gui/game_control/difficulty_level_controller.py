...
_Level = namedtuple(b'_Level', (b'queueType', b'level', b'isUnlock'))
...
class DifficultyLevelController(IDifficultyLevelController, IGlobalListener):
    ...
    def init(self):
        ...
        g_clientUpdateManager.addCallbacks({b'tokens': (self._onSyncTokensCompleted)})
        return
    ...
    def selectLevel(self, level):
        ...
        if difficultyLevel and difficultyLevel.isUnlock:
            ...
            if unlockedLevels.get(level.value, {}).get(b'isNew', False):
