...
class PREBATTLE_ACTION_NAME(settings.PREBATTLE_ACTION_NAME, ConstInjector):
    ...
    LAST_STAND_SQUAD = b'last_stand_squad'
...
class VIEW_ALIAS(views.VIEW_ALIAS, ConstInjector):
    _const_type = str
    LAST_STAND_BATTLE_PAGE = b'LastStandBattlePage'
    LS_OVERLAY_WEB_STORE = b'lsOverlayWebStore'
    LS_BATTLE_RESULTS = b'lsBattleResults'
...
LS_RENT_VEHICLE_TOOLTIP = b'lsRentVehicle'
LS_CAROUSEL_VEHICLE_TOOLTIP = b'lsCarouselVehicle'
LS_ABILITY_TOOLTIP = b'lsAbility'
LS_MAIN_SHELL = b'lsMainShell'
LS_TOOLTIP_SET = [
 LS_RENT_VEHICLE_TOOLTIP,
 LS_ABILITY_TOOLTIP,
 LS_MAIN_SHELL,
 LS_CAROUSEL_VEHICLE_TOOLTIP]
LS_INFO_PAGE_KEY = b'infoPageLastStand'
LS_INTRO_VIDEO_KEY = b'lsIntroVideo'
...
LS_BATTLE_HINTS_QUEUE_ID = BattleHintQueueParams(name=b'last_stand', withFadeOut=True)

class LSDailyQuestsDecorations(object):
    DAMAGE_TO_OBELISK_ICON_KEY = b'ls_obeliskDamage'
