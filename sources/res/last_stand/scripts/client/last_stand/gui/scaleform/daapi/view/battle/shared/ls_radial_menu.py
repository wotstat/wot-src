...
REGULAR_UPPER_STATIC_SHORTCUTS = (
 ...
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/move_to_magnus', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_MAGNUS, groups=[
 ...
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_MAGNUS_HELP, groups=[
 ...
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/move_to_camp', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_CAMP, groups=[
 ...
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_CAMP_HELP, groups=[
 ...
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/obeliskHelp', action=LS_BATTLE_CHAT_COMMANDS.LS_OBELISK_HELP, icon=LS_RADIAL_MENU_CONSTS.LS_OBELISK_HELP, groups=[
  RADIAL_MENU_CONSTS.TARGET_STATE_DEFAULT, RADIAL_MENU_CONSTS.TARGET_STATE_EMPTY], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIFTH),
 Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/obelisk', action=LS_BATTLE_CHAT_COMMANDS.LS_OBELISK, icon=LS_RADIAL_MENU_CONSTS.LS_OBELISK, groups=[
  RADIAL_MENU_CONSTS.TARGET_STATE_DEFAULT, RADIAL_MENU_CONSTS.TARGET_STATE_EMPTY], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SECOND))
_CAN_CANCEL_REPLY_SHORTCUT = Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/cancel', action=BATTLE_CHAT_COMMAND_NAMES.CANCEL_REPLY, icon=LS_RADIAL_MENU_CONSTS.LS_CANCEL, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST)
...
class LSRadialMenu(LSRadialMenuMeta):
    ...
    def _initShortCuts(self):
        ...
        for shotCut in REGULAR_UPPER_STATIC_SHORTCUTS:
            for shotCutGroup in shotCut.groups:
                if isObeliskDisabled and shotCut.action in (LS_BATTLE_CHAT_COMMANDS.LS_OBELISK,
                 LS_BATTLE_CHAT_COMMANDS.LS_OBELISK_HELP):
                    continue
    ...
    def _getCanReplayShortcut(self, shortcut, canReplyAction):
        if shortcut.action == BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT:
            return Shortcut(title=b'#last_stand.last_stand_battle:radialMenu/confirm', action=canReplyAction, icon=RADIAL_MENU_CONSTS.YES, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=shortcut.indexInGroup)
