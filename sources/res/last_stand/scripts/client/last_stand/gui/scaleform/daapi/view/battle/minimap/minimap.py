...
class LSEquipmentsPlugin(LSMinimapScaleMixin, EquipmentsPlugin):
    _SYMBOL_DEATH_ZONE = b'LSDeathZoneEntryUI'
    LS_EQ_MARKER_TO_SYMBOL = {b'LSEventDeathZoneUI': _SYMBOL_DEATH_ZONE}
...
class LSMinimapComponent(LSMinimapMeta):
    ...
    def _setupPlugins(self, arenaVisitor):
        ...
        setup[b'area_markers'] = LSAreaMarkerEntriesPlugin
        setup[b'personal'] = LSPersonalEntriesPlugin
        setup[b'vehicles'] = LSMinimapVehiclesPlugin
        setup[b'area'] = LSAreaStaticMarkerPlugin
        setup[b'equipments'] = LSEquipmentsPlugin
        if IS_DEVELOPMENT:
            setup[b'teleport'] = LSTeleportPlugin
        if not BattleReplay.g_replayCtrl.isPlaying:
            setup[b'pinging'] = LSMinimapPingPlugin
        return setup
