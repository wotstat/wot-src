...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LAST_STAND_BATTLE_PAGE, LastStandBattlePage, getSwfExtensionUrl(b'last_stand', b'LastStandBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
