        ...
        if ctx[b'state'] == CameraMovementStates.MOVING_TO_OBJECT:
            if isinstance(entity, HeroTank):
                ...
                if descriptor:
                    ...
                    showHeroTankPreview(vehicleCD, previewAlias=LAST_STAND_HANGAR_ALIASES.LS_VEHICLE_PREVIEW, backOutfit=self.__ctx.get(b'outfit'), backBtnLabel=backport.text(R.strings.menu.cst_item_ctx_menu.preview()), isHiddenMenu=True)
