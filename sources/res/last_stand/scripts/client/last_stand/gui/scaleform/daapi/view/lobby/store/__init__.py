...
def getViewSettings():
    ...
    return (
     ViewSettings(ls_gui_constants.VIEW_ALIAS.LS_OVERLAY_WEB_STORE, ShopOverlay, b'browserScreen.swf', WindowLayer.OVERLAY, ls_gui_constants.VIEW_ALIAS.LS_OVERLAY_WEB_STORE, ScopeTemplates.LOBBY_SUB_SCOPE),)
