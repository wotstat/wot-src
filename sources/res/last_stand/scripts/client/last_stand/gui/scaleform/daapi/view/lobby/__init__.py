...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(LAST_STAND_HANGAR_ALIASES.LS_MODULE_INFO, LSModuleInfoWindow, b'moduleInfo.swf', WindowLayer.WINDOW, LAST_STAND_HANGAR_ALIASES.LS_MODULE_INFO, None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(LAST_STAND_HANGAR_ALIASES.LS_BROWSER, ExtensionBrowser, b'browserScreen.swf', WindowLayer.FULLSCREEN_WINDOW, LAST_STAND_HANGAR_ALIASES.LS_BROWSER, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(LAST_STAND_HANGAR_ALIASES.LS_VEHICLE_PREVIEW, LSVehiclePreview, b'vehiclePreview.swf', WindowLayer.SUB_VIEW, LAST_STAND_HANGAR_ALIASES.LS_VEHICLE_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(LAST_STAND_HANGAR_ALIASES.LS_HERO_PREVIEW, LSVehiclePreview, b'vehiclePreview.swf', WindowLayer.SUB_VIEW, LAST_STAND_HANGAR_ALIASES.LS_HERO_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(LAST_STAND_HANGAR_ALIASES.LS_HANGAR, HangarWindow, b'', WindowLayer.SUB_VIEW, LAST_STAND_HANGAR_ALIASES.LS_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(LAST_STAND_HANGAR_ALIASES.LS_REWARD_PATH, RewardPathWindow, b'', WindowLayer.SUB_VIEW, LAST_STAND_HANGAR_ALIASES.LS_REWARD_PATH, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LS_BATTLE_RESULTS, BattleResultWindow, b'', WindowLayer.TOP_WINDOW, VIEW_ALIAS.LS_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE))
