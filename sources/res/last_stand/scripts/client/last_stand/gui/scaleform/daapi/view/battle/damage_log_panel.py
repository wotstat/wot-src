...
_LS_VEHICLE_CLASS_TAGS_ICONS = {b'sentry': (_LS_IMAGES.LS_DAMAGELOG_SENTRY_16X16), 
   b'hunter': (_LS_IMAGES.LS_DAMAGELOG_HUNTER_16X16), 
   b'runner': (_LS_IMAGES.LS_DAMAGELOG_RUNNER_16X16), 
   b'alpha': (_LS_IMAGES.LS_DAMAGELOG_ALPHA_16X16), 
   b'turret': (_LS_IMAGES.LS_DAMAGELOG_TURRET_16X16), 
   b'bomber': (_LS_IMAGES.LS_DAMAGELOG_BOMBER_16X16), 
   b'bomber_alpha': (_LS_IMAGES.LS_DAMAGELOG_BOMBER_ALPHA_16X16), 
   b'catcher': (_LS_IMAGES.LS_DAMAGELOG_CATCHER_16X16), 
   b'charger': (_LS_IMAGES.LS_DAMAGELOG_CHARGER_16X16), 
   b'ripper': (_LS_IMAGES.LS_DAMAGELOG_RIPPER_16X16), 
   b'detonator': (_LS_IMAGES.LS_DAMAGELOG_DETONATOR_16X16), 
   b'boss': (_LS_IMAGES.LS_DAMAGELOG_BOSS_16X16), 
   b'obelisk': (_LS_IMAGES.LS_DAMAGELOG_OBELISK_16X16), 
   b'bastion': (_LS_IMAGES.LS_DAMAGELOG_BASTION_16X16), 
   b'archer': (_LS_IMAGES.LS_DAMAGELOG_ARCHER_16X16)}
