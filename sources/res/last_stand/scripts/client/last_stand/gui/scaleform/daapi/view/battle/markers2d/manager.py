...
class LSMarkersManager(MarkersManager):
    MARKERS_MANAGER_SWF = getSwfExtensionUrl(b'last_stand', b'lastStandBattleVehicleMarkersApp.swf')
    ...
    def _setupPlugins(self, arenaVisitor):
        ...
        setup.update({b'area_markers': LSAreaMarkerPlugin, 
           b'vehicles': LSVehicleMarkerPlugin, 
           b'equipments': LSEquipmentsMarkerPlugin})
        return setup
