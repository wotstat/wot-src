...
_ATTACK_REASON_MSG_TO_EVENT = {b'DEATH_FROM_SHOT': b'DEATH_FROM_LS_SHOT', 
   b'DEATH_FROM_FIRE': b'DEATH_FROM_LS_FIRE', 
   b'DEATH_FROM_DEVICE_EXPLOSION_AT_SHOT': b'DEATH_FROM_LS_DEVICE_EXPLOSION_AT_SHOT'}
