...
class DissolveUpdater(object):
    __slots__ = (b'dissolveHandler', b'componentRef', b'entityRef', b'appearanceRef', b'dissolveFactor', b'fadeInTime', b'fadeOutTime', b'maxDissolveFactor', b'dissolveFashions')
    UPDATE_RATE = 0.05
