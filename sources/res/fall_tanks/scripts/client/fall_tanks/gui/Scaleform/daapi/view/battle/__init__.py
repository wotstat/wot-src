...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.FALL_TANKS_BATTLE_PAGE, FallTanksPage, getSwfExtensionUrl(b'fall_tanks', b'fallTanksBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
