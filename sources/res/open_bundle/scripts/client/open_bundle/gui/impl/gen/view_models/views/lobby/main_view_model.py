...
class MainViewModel(ViewModel):
    __slots__ = (b'play', b'onItemShown', b'showPreview', b'resetInterruption')
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'stepPrice', PriceItemModel())
        self._addStringProperty(b'bundleType', b'')
        self._addNumberProperty(b'startTime', 0)
        self._addNumberProperty(b'finishTime', 0)
        self._addBoolProperty(b'isInterrupted', False)
        self._addArrayProperty(b'cells', Array())
        self._addArrayProperty(b'fixedReward', Array())
        self.play = self._addCommand(b'play')
        self.onItemShown = self._addCommand(b'onItemShown')
        self.showPreview = self._addCommand(b'showPreview')
        self.resetInterruption = self._addCommand(b'resetInterruption')
        return
