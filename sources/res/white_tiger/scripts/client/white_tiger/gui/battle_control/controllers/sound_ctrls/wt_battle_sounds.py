...
class WTBattleSoundController(ShotsResultSoundController):
    _SHOOTING_AT_SHIELD_NOTIFICATION = b'wt23_hunters_vo_shooting_at_wt_shield'
    _SHOOTING_AT_SHIELD_NOTIFICATION_RICOCHET = b'wt23_hunters_vo_shooting_at_wt_shield_ricochet'
    _DEFAULT_THRESHOLD_PERCENT = 3
    _INSTANT_STUN_SHOT_SKIP_HIT_NOTIFICATIONS = (b'enemy_no_hp_damage_at_attempt_and_gun_damaged_by_player', b'enemy_no_hp_damage_at_no_attempt_and_gun_damaged_by_player', b'enemy_no_hp_damage_at_attempt_and_chassis_damaged_by_player', b'enemy_no_hp_damage_at_no_attempt_and_chassis_damaged_by_player', b'enemy_no_piercing_by_player', b'enemy_no_hp_damage_at_attempt_by_player', b'enemy_no_hp_damage_at_no_attempt_by_player', b'enemy_no_hp_damage_by_near_explosion_by_player', b'enemy_ricochet_by_player')
    _INSTANT_STUN_SHOT_SKIP_DAMAGE_HIT_NOTIFICATIONS = (b'enemy_hp_damaged_by_projectile_by_player',)
    _ALTERNATIVE_SOUND_NOTIFICATIONS = {b'enemy_no_hp_damage_at_attempt_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_no_hp_damage_at_no_attempt_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_hp_damaged_by_projectile_and_gun_damaged_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_hp_damaged_by_projectile_and_chassis_damaged_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_hp_damaged_by_projectile_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_hp_damaged_by_explosion_at_direct_hit_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_hp_damaged_by_near_explosion_by_player': b'wt23_hunters_vo_shooting_at_wt_shield', 
       b'enemy_ricochet_by_player': b'wt23_hunters_vo_shooting_at_wt_shield_ricochet'}
    ...
    def getVehicleHitResultSound(self, enemyVehID, hitFlags, enemiesHitCount):
        ...
        tags = vehicleInfo[b'vehicleType'].type.tags
    ...
    def __getTriggerThreshold(self, notification):
        ...
        if soundNotifications:
            value = soundNotifications.getEventInfo(notification, b'triggerThreshold')
            if value:
                return int(value)
