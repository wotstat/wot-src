...
class WTEventEntryPoint(ViewImpl, Notifiable):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.white_tiger.lobby.tooltips.LootBoxTooltipView():
            lootBoxType = event.getArgument(b'type')
            return WtEventLootBoxTooltipView(isHunterLootBox=lootBoxType == b'hunter')
    ...
    @server_settings.serverSettingsChangeListener(b'white_tiger_config')
