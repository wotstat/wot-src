...
class WhiteTigerVehicleMarkerPlugin(RespawnableVehicleMarkerPlugin):
    ...
    def _onVehicleStateUpdated(self, state, value):
        if state == VEHICLE_VIEW_STATE.WT_INSPIRE:
            ...
            self._invokeMarker(markerID, b'showInspireAura', inspireVisible)
        return
    ...
    def _setVehicleInfo(self, marker, vInfo, guiProps, nameParts):
        ...
        self._invokeMarker(markerID, b'setVehicleInfo', classTag, vType.iconPath, nameParts.vehicleName, vType.level, nameParts.playerFullName, customName, nameParts.clanAbbrev, nameParts.regionCode, vType.maxHealth, guiPropsName, hunting, squadIndex, backport.text(R.strings.ingame_gui.stun.seconds()))
