...
class _SoundPlayerAliases(CONST_CONTAINER):
    WHITE_TIGER_RESPAWN_SOUND_PLAYER = b'wtRespawnSoundPlayer'
    WHITE_TIGER_BATTLE_HINT_SOUND = b'battle_hint_sound'
...
class WhiteTigerBattlePage(ClassicPage, ISpawnListener):
    ...
    def _populate(self):
        ...
        LOG_DEBUG(b'White tiger battle page is created.')
        return
    ...
    def _dispose(self):
        ...
        LOG_DEBUG(b'White tiger battle page is destroyed.')
        return
