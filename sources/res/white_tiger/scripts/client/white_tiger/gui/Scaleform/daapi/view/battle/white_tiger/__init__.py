...
__all__ = (b'WhiteTigerBattlePage',)
...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.EVENT_BATTLE_PAGE, WhiteTigerBattlePage, getSwfExtensionUrl(b'white_tiger', b'WTBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.BATTLE_LOADING, battle_loading.WtBattleLoading, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.INGAME_MENU, ingame_menu.WTIngameMenu, b'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     ViewSettings(VIEW_ALIAS.INGAME_DETAILS_HELP, ingame_help.IngameDetailsHelpWindow, getSwfExtensionUrl(b'white_tiger', b'WTIngameDetailsHelpWindow.swf'), WindowLayer.WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, canClose=False, canDrag=False, isModal=True),
