...
def getViewSettings():
    ...
    return (
     ViewSettings(white_tiger_gui_constants.VIEW_ALIAS.WHITE_TIGER_BATTLE_PAGE, WhiteTigerBattlePage, getSwfExtensionUrl(b'white_tiger', b'whiteTigerBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.INGAME_MENU, white_tiger_ingame_menu.WhiteTigerIngameMenu, b'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     GroupedViewSettings(white_tiger_gui_constants.VIEW_ALIAS.WHITE_TIGER_SETTINGS_WINDOW, WhiteTigerSettingsWindow, getSwfExtensionUrl(b'white_tiger', b'whiteTigerSettingsWindow.swf'), WindowLayer.TOP_WINDOW, white_tiger_gui_constants.VIEW_ALIAS.WHITE_TIGER_SETTINGS_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False))
