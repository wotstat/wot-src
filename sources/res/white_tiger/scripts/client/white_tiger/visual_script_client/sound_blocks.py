...
SoundGroups = dependencyImporter(b'SoundGroups')

class PlaySoundOnVehicleSoundObject(Block, SoundMeta):
    _TANK_SOUND_OBJ_NAME_TO_INDEX = {b'chassis': (TankSoundObjectsIndexes.CHASSIS), 
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._soundObjId = self._makeDataInputSlot(b'soundObjID', SLOT_TYPE.STR, EDITOR_TYPE.ENUM_SELECTOR)
