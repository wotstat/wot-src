...
class WTImpactZoneNotificationComponent(DynamicScriptComponent):
    ...
    def set_impactAreaInfo(self, _=None):
        if self.impactAreaInfo is None:
            ...
            self.__updateImpactNotification(self.impactAreaInfo[b'timeBeforeDamage'], self.impactAreaInfo[b'isVisible'])
            self.__cd.delayCallback(self.impactAreaInfo[b'timeBeforeDamage'], self.__onCountdownEnd)
            return
