...
@ReprInjector.simple(b'text', b'counterName', b'counter', b'maximumCounter')
...
@ReprInjector.simple(b'requiredCounter', b'bonuses')
...
@ReprInjector.simple(b'bonuses', b'unlimitedTrigger', b'counterName', b'counter', b'maximumCounter')
...
@ReprInjector.simple(b'isCompleted', b'isLastProgression', b'currentStageIndex', b'maximumStageIndex')
...
@ReprInjector.simple(b'conditions', b'state', b'stages')
