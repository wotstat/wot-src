...
class FunNotificationCtx(object):
    __slots__ = (b'isInFunRandom', b'subModes', b'progression', b'transactions', b'newStates', b'settings')
...
@ReprInjector.simple((b'notificationType', b'notificationType'))
class FunNotification(object):
    __slots__ = (b'notificationType',)
    ...
    def _markProgressionAsSeen(cls, progression, settings):
        settings[FUN_RANDOM_NOTIFICATIONS_PROGRESSIONS].add(progression.config.name if progression else b'')
        return


@ReprInjector.withParent((b'subModesIDs', b'subModesIDs'), (b'isNewProgression', b'isNewProgression'))
class FunStopSubModesNotification(FunNotification):
    __slots__ = (b'subModesIDs', b'isNewProgression')
    _FINISH_STATES = (
...
@ReprInjector.withParent((b'subModesIDs', b'subModesIDs'))
class FunSwitchOnSubModesNotification(FunNotification):
    __slots__ = (b'subModesIDs',)
