...
class FunBaseConfigurationProvider(object):
    ...
    @classmethod
    def getConfigurationByPath(cls, configPath, overridesPath=b''):
        ...
        if cacheKey in g_configurationsCache:
            ...
            if section is None:
                raise SoftException((b'[FUN_RANDOM_CONFIGS] Cannot open or read config {}').format(configPath))
