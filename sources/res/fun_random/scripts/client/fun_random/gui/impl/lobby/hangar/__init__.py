...
def getViewSettings():
    ...
    return (
     ViewSettings(FUNRANDOM_ALIASES.FUN_RANDOM_HANGAR, FunRandomHangarWindow, b'', WindowLayer.SUB_VIEW, FUNRANDOM_ALIASES.FUN_RANDOM_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),)
