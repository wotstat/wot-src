...
class FunRandomHangarWidgetView(ViewImpl, FunSubModesWatcher, FunProgressionWatcher):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.battle_modifiers.lobby.tooltips.ModifiersDomainTooltipView():
            modifiersDomain = event.getArgument(b'modifiersDomain')
        ...
        return super(FunRandomHangarWidgetView, self).createToolTipContent(event, contentID)

    @hasActiveProgression(abortAction=b'showInfoPage')
