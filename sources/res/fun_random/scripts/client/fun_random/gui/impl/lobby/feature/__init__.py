...
def getViewSettings():
    ...
    return (
     ViewSettings(FUNRANDOM_ALIASES.FUN_POST_BATTLE_RESULTS, FunPostBattleResultsWindow, b'', WindowLayer.SUB_VIEW, FUNRANDOM_ALIASES.FUN_POST_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(FUNRANDOM_ALIASES.FUN_PROGRESSION, FunRandomProgressionWindow, b'', WindowLayer.SUB_VIEW, FUNRANDOM_ALIASES.FUN_PROGRESSION, ScopeTemplates.LOBBY_SUB_SCOPE))
