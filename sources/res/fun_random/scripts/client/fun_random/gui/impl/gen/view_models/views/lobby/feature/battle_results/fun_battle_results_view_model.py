...
class FunBattleResultsViewModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'battleInfo', FunRandomBattleInfoModel())
        self._addViewModelProperty(b'premiumPlus', PremiumPlusModel())
        self._addViewModelProperty(b'teamStats', FunTeamStatsModel())
        self._addViewModelProperty(b'progress', FunRandomProgressModel())
