...
_LUI_RULE_ENTRY_POINT = b'FunRandomEntryPoint'
_LUI_RULE_NOTIFICATIONS = b'FunRandomNotifications'
...
class AccountSettingsConstants(CONST_CONTAINER):
    FUN_RANDOM_ACCOUNT_SETTINGS = b'funRandomAccountSettings'
    FUN_RANDOM_INFO_PAGE_SHOWN = b'funRandomInfoPageShown'
    FUN_RANDOM_SEEN_TRIGGERS_COMPLETION = b'funRandomSeenTriggersCompletion'
