...
def getViewSettings():
    ...
    return (
     ...
     GroupedViewSettings(FUNRANDOM_ALIASES.FUN_RANDOM_CAROUSEL_FILTER_POPOVER, FunRandomCarouselFilterPopover, b'filtersPopoverView.swf', WindowLayer.WINDOW, FUNRANDOM_ALIASES.FUN_RANDOM_CAROUSEL_FILTER_POPOVER, FUNRANDOM_ALIASES.FUN_RANDOM_CAROUSEL_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE))
...
class FunRandomLobbyBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         ...
         (
          FUNRANDOM_ALIASES.FUN_RANDOM_CAROUSEL_FILTER_POPOVER, self.loadViewByCtxEvent))
