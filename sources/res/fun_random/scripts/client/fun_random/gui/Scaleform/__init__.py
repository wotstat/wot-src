...
def registerFunRandomScaleform():
    registerScaleformLobbyPackages((b'fun_random.gui.Scaleform.daapi.view.lobby',))
    registerScaleformBattlePackages(ARENA_GUI_TYPE.FUN_RANDOM, sf_config.BATTLE_PACKAGES + (b'fun_random.gui.Scaleform.daapi.view.battle',))
    registerLobbyTooltipsBuilders([
     (
      b'fun_random.gui.Scaleform.daapi.view.tooltips.lobby_builders', _TOOLTIPS.FUN_RANDOM_LOBBY_SET)])
    return
