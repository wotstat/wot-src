...
class CosmicDisableSettingsController(DisableSettingsController):
    ...
    def init(self):
        ...
        self.registerRecord(name=GAME.DYNAMIC_CAMERA, value=1, storages=(b'game',), guiPath=(b'GameSettings',))
        self.registerRecord(name=GAME.COMMANDER_CAM, value=0, storages=(b'game', b'extendedGame'), guiPath=(b'GameSettings',))
        self.registerRecord(name=GAME.PRE_COMMANDER_CAM, value=0, storages=(b'game', b'extendedGame'), guiPath=(b'GameSettings',))
        return
