...
class LootBoxVehicleBlueprintFragmentTooltipData(BlocksTooltipData):
    ...
    def __packVehicleFragmentBlock(self, vehicleCD):
        ...
        iconSource = R.images.gui.maps.icons.blueprints.fragment.medium.dyn(b'vehicle' if not isFinal else b'vehicle_complete', default=R.invalid)()
    ...
    def __getVehicleDescrStr(vehicle):
        vehicleType = vehicle.type.replace(b'-', b'_')
        if vehicle.isElite:
