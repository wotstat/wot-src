...
class LootBoxesStorageEventEnum(str, Enum):
    GOTO_REQUEST = b'GOTO_REQUEST'
    GOTO_OPENING = b'GOTO_OPENING'
    GOTO_LOSE_OPENING = b'GOTO_LOSE_OPENING'
    GOTO_ERROR = b'GOTO_ERROR'
    GOTO_UNIQUE_REWARDING = b'GOTO_UNIQUE_REWARDING'
    GOTO_REWARDING = b'GOTO_REWARDING'
    GOTO_STORAGE = b'GOTO_STORAGE'
...
class LootBoxesStorageStateMachineDescription(object):
    ...
    def getStates(cls):
        ...
        return (
         storageViewing, requestToOpen, opening, openingError,
         uniqueRewarding, rewarding, loseOpening)
