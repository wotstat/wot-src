...
class VehiclePreviewState(BaseVehiclePreviewState):
    ...
    def _getViewLoadCtx(self, event):
        ...
        params[b'ctx'].update({b'rewardID': (event.params.get(b'rewardID', None)), 
           b'numberStyle': (event.params.get(b'numberStyle', None))})
        return params
