...
class ProgressionView(ViewImpl):
    ...
    def __getCurrentRewardID(self):
        ...
        lastAvailableReward = availableReward[0] if len(availableReward) == 1 else b''
    ...
    def __fillSelectReward(self, rewardID=None):
        self.__selectedRewardId = rewardID or b''
    ...
    def __showPreview(self, rewardId):
        ...
        if purchaseMode == PurchaseMode.SEQUENTIAL_PRODUCT:
            ...
            topPanelData = {b'linkage': (VEHPREVIEW_CONSTANTS.TOP_PANEL_TABS_LINKAGE), 
               b'tabIDs': PERSONAL_NUMBER_STYLE_TABS, 
               b'currentTabID': (TabID.PERSONAL_NUMBER_VEHICLE if previewStyle else TabID.BASE_VEHICLE)}
        else:
            style = previewStyle
            topPanelData = None
