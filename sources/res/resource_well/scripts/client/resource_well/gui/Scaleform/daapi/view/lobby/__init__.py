...
def getViewSettings():
    ...
    return (
     ...
     ViewSettings(VIEW_ALIAS.RESOURCE_WELL_BROWSER_VIEW, WebView, b'browserScreen.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.RESOURCE_WELL_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ComponentSettings(VEHPREVIEW_CONSTANTS.BOTTOM_PANEL_WELL_PY_ALIAS, VehiclePreviewBottomPanel, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.RESOURCE_WELL_PROGRESSION, ProgressionWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.RESOURCE_WELL_PROGRESSION, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.RESOURCE_WELL_COMPLETED_PROGRESSION, CompletedProgressionWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.RESOURCE_WELL_COMPLETED_PROGRESSION, ScopeTemplates.LOBBY_SUB_SCOPE))
