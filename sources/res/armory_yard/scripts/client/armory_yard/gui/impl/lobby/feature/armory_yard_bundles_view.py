...
class ArmoryYardBundlesView(ViewImpl):
    __slots__ = (b'__blur', b'__onLoadedCallback', b'__parent')
    ...
    def onBuyBundle(self, args):
        showArmoryYardBuyBundleWindow(args.get(b'bundleId'), parent=self.__parent, onLoadedCallback=self.__onLoadedCallback, onClosedCallback=self.destroyWindow)
        return
    ...
    def __onEventUpdated(self):
        ...
        with self.viewModel.transaction() as vm:
            ...
            vm.setEndTime(packsSettings[b'endTime'])
            ...
            for product in self.__armoryYardCtrl.bundlesProducts:
                ...
                bundleModel.setIndex(product[b'id'])
