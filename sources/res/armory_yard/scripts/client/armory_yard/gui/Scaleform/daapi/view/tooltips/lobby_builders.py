...
def getTooltipBuilders():
    return (
     ...
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.ARMORY_YARD_ENTRY_POINT_ACTIVE, None, EntryPointActiveTooltipData(contexts.ToolTipContext(None))),
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.ARMORY_YARD_ENTRY_POINT_BEFORE_PROGRESSION, None, EntryPointBeforeProgressionTooltipData(contexts.ToolTipContext(None))))
