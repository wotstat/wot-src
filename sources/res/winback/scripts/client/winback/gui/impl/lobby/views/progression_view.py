...
class ProgressionView(SubModelPresenter):
    ...
    __slots__ = (b'__tooltipData', b'__dirtyFlags', b'__isDeferredUpdate')
    ...
    def __updateProgressionPoints(self, model, data):
        previousPoints = data[b'previousPoints']
        currentPoints = data[b'currentPoints']
        pointsForLevel = data[b'pointsForLevel']
        if currentPoints < previousPoints:
            previousPoints = pointsForLevel * len(data[b'progressionLevels'])
