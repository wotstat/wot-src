...
class ClientWinbackBattleMode(AbstractBattleMode):
    ...
    def _client_notificationListeners(self):
        ...
        return (
         listeners.WinbackSelectableRewardReminder,)

    @property
    def _client_notificationActionHandlers(self):
        from winback.notification import actions_handlers as handlers
        return (
         handlers.ShowWinbackProgressionActionHandler,
         handlers.OpenWinbackSelectableRewardView,
         handlers.OpenWinbackSelectableRewardViewFromQuest)
...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionLobbyPackages(__name__, [
     b'winback.gui.Scaleform.daapi.view.lobby'])
    return
