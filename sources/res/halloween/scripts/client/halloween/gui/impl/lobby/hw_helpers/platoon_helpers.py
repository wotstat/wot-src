        ...
        for slotInfo in unitFullData.slotsIterator:
            ...
            for slot in slots:
                ...
                if queueType in availableQueueTypes:
                    continue
                additionalMsg = backport.text(R.strings.halloween_platoon.platoon.difficulty.maxAvailable(), icon=(b'level_{0}').format(QUEUE_TYPE_TO_DIFFICULTY_LEVEL[availableQueueTypes[-1]].value))
