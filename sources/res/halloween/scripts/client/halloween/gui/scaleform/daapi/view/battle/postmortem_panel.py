...
_ATTACK_REASON_MSG_TO_EVENT = {b'DEATH_FROM_SHOT': b'HW_DEATH_FROM_SHOT', 
   b'DEATH_FROM_FIRE': b'HW_DEATH_FROM_FIRE', 
   b'DEATH_FROM_DEVICE_EXPLOSION_AT_SHOT': b'HW_DEATH_FROM_DEVICE_EXPLOSION_AT_SHOT'}

class HWPostmortemPanel(PostmortemPanelMeta):
    PHASE_DEATH_REASON = b'DEATH_FROM_PHASE_TIMER_SELF_SUICIDE'
    PHASE_DEATH_REASON_LATE = b'DEATH_FROM_PHASE_TIMER_SELF_SUICIDE_LATE'
    PHASE_DEATH_REASON_FINAL = b'DEATH_FROM_PHASE_TIMER_SELF_SUICIDE_FINAL'
    TICK_RATE = 1
    __slots__ = (b'_callbacks', b'__collectorIsFull')
    ...
    def _showPlayerInfo(self):
        ...
        self.as_setHintTitleS(b'')
        self.as_setHintDescrS(b'')
        return
