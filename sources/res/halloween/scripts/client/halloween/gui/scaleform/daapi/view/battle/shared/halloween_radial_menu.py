...
REGULAR_UPPER_STATIC_SHORTCUTS = (
 ...
 Shortcut(title=b'#halloween.halloween_battle:radialMenu/move_to_soul_collector', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_COLLECTOR, groups=[
 ...
 Shortcut(title=b'#halloween.halloween_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_COLLECTOR_HELP, groups=[
 ...
 Shortcut(title=b'#halloween.halloween_battle:radialMenu/move_to_camp', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_CAMP, groups=[
 ...
 Shortcut(title=b'#halloween.halloween_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_CAMP_HELP, groups=[
...
_CAN_CANCEL_REPLY_SHORTCUT = Shortcut(title=b'#halloween.halloween_battle:radialMenu/cancel', action=BATTLE_CHAT_COMMAND_NAMES.CANCEL_REPLY, icon=HW_RADIAL_MENU_CONSTS.HW_CANCEL, groups=HW_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST)
...
class HalloweenRadialMenu(RadialMenu):
    ...
    def _getCanReplayShortcut(self, shortcut, canReplyAction):
        if shortcut.action == BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT:
            return Shortcut(title=b'#halloween.halloween_battle:radialMenu/confirm', action=canReplyAction, icon=RADIAL_MENU_CONSTS.YES, groups=HW_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=shortcut.indexInGroup)
