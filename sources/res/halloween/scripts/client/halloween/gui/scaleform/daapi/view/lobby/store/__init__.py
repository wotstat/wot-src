...
def getViewSettings():
    ...
    return (
     ViewSettings(halloween_gui_constants.VIEW_ALIAS.HW_OVERLAY_WEB_STORE, ShopOverlay, b'browserScreen.swf', WindowLayer.OVERLAY, halloween_gui_constants.VIEW_ALIAS.HW_OVERLAY_WEB_STORE, ScopeTemplates.LOBBY_SUB_SCOPE),)
