...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.HALLOWEEN_BATTLE_PAGE, HalloweenBattlePage, getSwfExtensionUrl(b'halloween', b'HalloweenBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
