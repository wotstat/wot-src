...
def showHWBuyGoldWebOverlay(params=None, parent=None):
    ...
    if url:
        ...
        g_eventBus.handleEvent(events.LoadViewEvent(SFViewLoadParams(halloween_gui_constants.VIEW_ALIAS.HW_OVERLAY_WEB_STORE, parent=parent), ctx={b'url': url}), EVENT_BUS_SCOPE.LOBBY)
    return
