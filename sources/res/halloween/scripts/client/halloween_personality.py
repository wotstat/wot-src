...
class ClientHalloweenBattleMode(halloween_constants.HalloweenBattleMode):
    ...
    def _client_lobbyRequiredLibraries(self):
        return [b'halloween|halloween_lobby.swf', b'halloween|components.swf']
    ...
    def _client_controlModes(self):
        return {(CTRL_MODE_NAME.ARCADE): (
                                   HWArcadeControlMode, b'arcadeMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.SNIPER): (
                                   HWSniperControlMode, b'sniperMode', CTRL_TYPE.USUAL), 
           (CTRL_MODE_NAME.POSTMORTEM): (
                                       HWPostMortemControlMode, b'postMortemMode', CTRL_TYPE.USUAL)}
    ...
    def _client_equipmentTriggers(self):
        ...
        return [
         (
          b'detonator_deathzone', _EventArtilleryItem, _ReplayEventArtilleryItem),
         (
          b'artillery_deathzone', _EventArtilleryItem, _ReplayEventArtilleryItem),
         (
          b'ignite_deathzone', _EventIgniteAoeItem, _ReplayEventIgniteAoeItem),
         (
          b'stun_deathzone', _EventStunAoeItem, _ReplayEventStunAoeItem),
         (
          b'interval_deathzone', _EventIntervalAoeItem, _ReplayEventIntervalAoeItem)]
...
def preInit():
    ...
    registerLobbyTooltipsBuilders([
     (
      b'halloween.gui.scaleform.daapi.view.tooltips.tooltip_builders', HALLOWEEN_TOOLTIP_SET)])
...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionLobbyPackages(__name__, [
     b'halloween.gui.scaleform.daapi.view.lobby',
     b'halloween.gui.scaleform.daapi.view.lobby.store',
     b'halloween.gui.scaleform.daapi.view.lobby.tank_setup',
     b'halloween.gui.impl.lobby'])
    BATTLE_PACKAGES = (b'gui.Scaleform.daapi.view.battle.shared.vehicle_mechanics', b'messenger.gui.Scaleform.view.battle', b'gui.impl.battle.random', b'gui.impl.battle.shared')
    ...
    g_overrideScaleFormViewsConfig.initExtensionBattlePackages(__name__, [
     b'halloween.gui.scaleform.daapi.view.battle',
     b'halloween.gui.scaleform.daapi.view.battle.shared'], halloween_constants.ARENA_GUI_TYPE.HALLOWEEN)
