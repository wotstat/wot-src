...
class OvertimeComponent(ClientArenaComponent, CallbackDelayer):
    ...
    def activate(self):
        ...
        self.addSyncDataCallback(ARENA_SYNC_OBJECTS.OVERTIME, b'duration', self.__onDurationUpdated)
        self.addSyncDataCallback(ARENA_SYNC_OBJECTS.OVERTIME, b'endTime', self.__onEndTimeUpdated)
        return

    def deactivate(self):
        super(OvertimeComponent, self).deactivate()
        self.removeSyncDataCallback(ARENA_SYNC_OBJECTS.OVERTIME, b'duration', self.__onDurationUpdated)
        self.removeSyncDataCallback(ARENA_SYNC_OBJECTS.OVERTIME, b'endTime', self.__onEndTimeUpdated)
        return
