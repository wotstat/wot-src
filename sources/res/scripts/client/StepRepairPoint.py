...
class _StepRepairPointSettingsCache(object):
    ...
    def initSettings(self, settings):
        self.flagModel = settings.readString(b'flagModelName', b'')
        self.radiusModel = settings.readString(b'radiusModel', b'')
        self.flagAnim = settings.readString(b'flagAnim', b'')
        self.attachedSoundEventName = settings.readString(b'wwsound', b'')
        return
...
class StepRepairPoint(BigWorld.Entity):
    ...
    def __init__(self):
        ...
        if _g_stepRepairPointSettings is None:
            settingsData = ResMgr.openSection(ENVIRONMENT_EFFECTS_CONFIG_FILE + b'/stepRepairPoint')
    ...
    def prerequisites(self):
        ...
        assembler.addRootPart(_g_stepRepairPointSettings.flagModel, b'root')
        ...
        self.__stepRepairPointSoundObject = SoundGroups.g_instance.WWgetSoundObject(b'stepRepairPoint_' + str(self), mProv)
