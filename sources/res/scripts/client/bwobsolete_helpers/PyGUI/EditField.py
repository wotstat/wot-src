...
import copy, BigWorld, GUI, Math, Keys, bwobsolete_helpers.PyGUI.IME, Utils
...
class EditField(PyGUIBase):
    factoryString = b'PyGUI.EditField'
    ...
    def onBound(self):
        if hasattr(self.component, b'cursor'):
        ...
        self.component.addChild(self.cursor.comp, b'cursor')
        self._updateCursor()
    ...
    def fitVertically(self):
        ...
        _, self.component.height = self.component.text.stringDimensions(b'W')
    ...
    def onLoad(self, dataSection):
        ...
        self.maxLength = dataSection.readInt(b'maxLength', self.maxLength)
        self.focusViaMouse = dataSection.readBool(b'focusViaMouse', True)
        self.enableIME = dataSection.readBool(b'enableIME', False)
        self.shouldAdjustClipping = dataSection.readBool(b'shouldAdjustClipping', False)
        self.activeColour = dataSection.readVector4(b'activeColour', DEFAULT_TEXT_COLOUR_ACTIVE)
        self.inactiveColour = dataSection.readVector4(b'inactiveColour', DEFAULT_TEXT_COLOUR_INACTIVE)
        self.__allowAutoDefocus = dataSection.readBool(b'allowAutoDefocus', True)
        self.idealVisibleCharacters = dataSection.readInt(b'idealVisibleCharacters', self.idealVisibleCharacters)
    ...
    def onSave(self, dataSection):
        ...
        dataSection.writeInt(b'maxLength', self.maxLength)
        dataSection.writeBool(b'focusViaMouse', self.focusViaMouse)
        dataSection.writeBool(b'enableIME', self.enableIME)
        dataSection.writeBool(b'shouldAdjustClipping', self.shouldAdjustClipping)
        dataSection.writeVector4(b'activeColour', self.activeColour)
        dataSection.writeVector4(b'inactiveColour', self.inactiveColour)
        dataSection.writeBool(b'allowAutoDefocus', self.__allowAutoDefocus)
        return
    ...
    def focus(self, state):
        if self.component.parent is not None and self.component.parent.script is not None:
            ...
            if hasattr(pscript, b'editFieldChangeFocus'):
