...
class Console(PyGUIBase):
    ...
    def __init__(self, component=None):
        ...
        if component == None:
            ...
            self.component.addChild(ScrollableText().component, b'buffer')
            ...
            self.component.addChild(EditField().component, b'editField')
    ...
    def _onEnterText(self, text):
        self.component.editField.script.setText(b'')
        if len(text) > 0:
