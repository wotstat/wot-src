...
class DetachedTurret(BigWorld.Entity, ScriptGameObject):
    ...
    def __init__(self):
        ScriptGameObject.__init__(self, self.spaceID, b'DetachedTurret')
    ...
    def onEnterWorld(self, prereqs):
        ...
        self.collisions = self.createComponent(BigWorld.CollisionComponent, prereqs[b'collisionAssembler'])
    ...
    def showDamageFromShot(self, points, effectsIndex):
        ...
        for shotPoint in decodedPoints:
            if shotPoint.componentName == TankPartNames.TURRET or shotPoint.componentName == TankPartNames.GUN:
                ...
                LOG_ERROR(b"Detached turret got hit into %s component, but it's impossible" % shotPoint.componentName)
