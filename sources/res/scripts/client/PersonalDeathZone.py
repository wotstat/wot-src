...
TRIGGER_NAME_PREFIX = b'personal_deathzone'

class PersonalDeathZone(AreaOfEffect, TriggersManager.ITriggerListener):
    _TRIGGER_NAME_TEMPLATE = TRIGGER_NAME_PREFIX + b'_{}'
    ...
    def _isOwnTrigger(self, args):
        return args[b'type'] == self._TRIGGER_TYPE and args[b'name'] == self._triggerName
