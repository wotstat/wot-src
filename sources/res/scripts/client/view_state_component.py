...
class ViewStateComponentAdaptor(object):
    ...
    def timeInterval(self):
        timeInterval = {b'startTime': (self.__state.timeInterval.startTime), 
           b'endTime': (self.__state.timeInterval.endTime)}
        return timeInterval
...
class ViewStateUpdater(object):
    ...
    def _getState(self):
        if self._isActive:
            ...
            state = {b'endTime': (timeInterval.endTime), 
               b'duration': (timeInterval.endTime - timeInterval.startTime)}
        else:
            state = {b'finishing': True}
        return state
...
class _AoeInspireStateUpdater(ViewStateUpdater):
    ...
    def _getState(self):
        ...
        if self._isActive:
            state[b'isSourceVehicle'] = bool(self._component.isSourceVehicle)
        return state
