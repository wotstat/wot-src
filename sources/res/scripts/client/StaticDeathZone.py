...
class StaticDeathZone(LimitedVisibilityEntity):
    ...
    def _updateVehicleUnderFire(self):
        ...
        if not deathzonesCtrl:
            ...
            timeToStrike = vehicleUnderFire[b'nextStrikeTime'] if vehicleUnderFire is not None else 0
            visible = timeToStrike > 0
            waveDuration = vehicleUnderFire[b'waveDuration'] if visible else 0
    ...
    def _getVehicleUnderFire(self):
        ...
        if not vehicle:
            ...
            for vehicleUnderFire in self.vehiclesUnderFire:
                if vehicleUnderFire[b'vehicleId'] == vehicle.id:
