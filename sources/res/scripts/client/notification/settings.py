...
DEF_ICON_NAME = b'{0:>s}_1'
DEF_ICON_PATH = b'../maps/icons/library/{0:>s}-1.png'
NotificationData = namedtuple(b'NotificationData', (b'entityID', b'savedData', b'priorityLevel', b'entity'))
...
def makePathToIcon(iconName):
    ...
    if not iconRes.exists():
        ...
        log.warning(b'Deprecated format, iconName %s-1.png does not match with file name %s', iconName, resIcon)
        return resIcon
