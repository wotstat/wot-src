    ...
    def addItem(self, item):
        ...
        if typeID in self.__received:
            ...
            if item not in notifications:
                ...
                result = False
                LOG_WARNING(b'Notification already exists', typeID, itemID, item)
        else:
            result = False
            LOG_ERROR(b'Type of notification not found', typeID)
        return result
    ...
    def removeItem(self, typeID, itemID):
        ...
        if typeID in self.__received:
            ...
            if criteria in notifications:
                ...
                result = False
                LOG_WARNING(b'Notification not found', typeID, itemID)
        else:
            result = False
            LOG_ERROR(b'Type of notification not found', typeID)
        return result
