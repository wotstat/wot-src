...
CommonSoundSpaceSettings = namedtuple(b'CommonSoundSpaceSettings', (b'name', b'entranceStates', b'exitStates', b'persistentSounds', b'stoppableSounds', b'priorities', b'autoStart', b'enterEvent', b'exitEvent', b'parentSpace'))
