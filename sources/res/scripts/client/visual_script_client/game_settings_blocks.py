...
class GetGameSetting(Block, GameSettingsMeta):
    ...
    _settingTypes = {b'bool': (SLOT_TYPE.BOOL), b'int': (SLOT_TYPE.INT), 
       b'str': (SLOT_TYPE.STR)}
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._value = self._makeDataOutputSlot(b'value', self._settingTypes[settingType], self._getValue)
        return
    ...
    def _getValue(self):
        ...
        if value.__class__.__name__ == settingType:
            ...
            errorVScript(self, (b'Incorrect type of the game setting value, {} expected ').format(value.__class__.__name__))
        return
