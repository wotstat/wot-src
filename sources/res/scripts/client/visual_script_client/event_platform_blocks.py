...
class AddMarkerAtPoint(Block, EventPlatformMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._markerType = self._makeDataInputSlot(b'Type', SLOT_TYPE.STR)
...
class RemoveMarkerAtPoint(Block, EventPlatformMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._number > 0:
            self._markerIds = [self._makeDataInputSlot(b'markerId' + str(i), SLOT_TYPE.INT) for i in range(self._number)]
