...
class SoundNotificationsContext(VScriptContext):
    ...
    @vse_func_call(None, (SLOT_TYPE.STR,), display_name=b'OnNotificationBegins', description=b'Notifies manager when sound event is sent to wwise', aspects=[
     ASPECT.CLIENT])
    ...
    @vse_func_call(None, (SLOT_TYPE.STR,), display_name=b'Log', description=b'Adds to log VO message', aspects=[
     ASPECT.CLIENT])
    def log(self, msg):
        if self.__soundNotifications:
