...
Math, = dependencyImporter(b'Math')
...
class OnShowMessage(BattleHUDEventMeta, Block):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._active = self._makeDataInputSlot(b'active', SLOT_TYPE.BOOL)
        self._onVehicleMessage = self._makeEventOutputSlot(b'onVehicleMessage')
        self._onVehicleError = self._makeEventOutputSlot(b'onVehicleError')
        self._onPlayerMessage = self._makeEventOutputSlot(b'onPlayerMessage')
        self._key = self._makeDataOutputSlot(b'key', SLOT_TYPE.STR, None)
        return
    ...
    def onStartScript(self):
        ...
        if ctrl is not None:
            ...
            errorVScript(self, b"Can't access the BattleMessagesController")
        return
...
class ShowVehicleErrorMessage(Block, BattleHUDEventMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._paramsSlot = self._makeDataInputSlot(b'params', SLOT_TYPE.DICTIONARY)
