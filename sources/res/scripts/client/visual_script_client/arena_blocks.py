...
class GetActiveControlPoints(Block, ArenaMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._team = self._makeDataInputSlot(b'teamId', SLOT_TYPE.INT)
        self._value = self._makeDataOutputSlot(b'value', arrayOf(SLOT_TYPE.CONTROL_POINT), self._execValue)
        return
...
class GetControlPointPosition(Block, ArenaMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._controlPoint = self._makeDataInputSlot(b'controlPoint', SLOT_TYPE.CONTROL_POINT)
        self._position = self._makeDataOutputSlot(b'position', SLOT_TYPE.VECTOR3, self._execValue)
        return
