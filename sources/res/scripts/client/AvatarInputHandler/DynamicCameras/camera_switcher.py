...
class CameraSwitcher(object):
    ...
    __slots__ = (b'__switchType', b'__switchToName', b'__switchToPos', b'__lastDist', b'__intervalToSwitch', b'__lastScrollTime', b'__hasTimeout', b'__timeoutCallback', b'__timeoutTime', b'__transitionValue', b'__switchToPlaceType')
