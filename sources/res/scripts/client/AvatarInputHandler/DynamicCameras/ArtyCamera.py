...
class ArtyCamera(CameraWithSettings, CallbackDelayer):
    ...
    def enable(self, targetPos, saveDist, switchToPos=None, switchToPlace=None):
        ...
        self.__rotation = max(self.__aimingSystem.direction.pitch, self._cfg[b'minimalPitch'])
    ...
    def __choosePitchLevel(self, aimPoint):
        useHighPitch = (aimPoint - self.__aimingSystem.hitPoint).lengthSquared > self._cfg[b'highPitchThresholdSq']
        if useHighPitch:
