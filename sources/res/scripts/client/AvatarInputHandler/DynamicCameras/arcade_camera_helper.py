...
ZoomState = namedtuple(b'ZoomState', (b'distRange', b'scrollSensitivity', b'sensitivity', b'angleRangeOnMinDist', b'angleRangeOnMaxDist', b'transitionDurationIn', b'transitionDurationOut', b'transitionEasingIn', b'transitionEasingOut', b'focusRadiusOnMinMaxDist', b'heightAboveBaseOnMinMaxDist', b'overScrollProtectOnMax', b'overScrollProtectOnMin', b'minLODBiasForTanks', b'settingsKey'))
...
def readZoomState(dataSec):
    if dataSec is None:
        ...
        distRangeVec = readVec2(dataSec, b'distRange', (1, 1), (180, 180), (25, 45))
        distRange = MinMax(distRangeVec.x, distRangeVec.y)
        scrollSensitivity = readFloat(dataSec, b'scrollSensitivity', 0, 50, 10)
        sensitivity = readFloat(dataSec, b'sensitivity', 0, 5, 0.002)
        overScrollProtectOnMax = readFloat(dataSec, b'overScrollProtectOnMax', 0, 10, 0)
        overScrollProtectOnMin = readFloat(dataSec, b'overScrollProtectOnMin', 0, 10, 0)
        angleRangeOnMinDist = readAngle(dataSec, b'angleRangeOnMinDist', (1, 1), (180, 180), (10, 110))
        angleRangeOnMaxDist = readAngle(dataSec, b'angleRangeOnMaxDist', (1, 1), (180, 180), (10, 110))
        transitionDurationIn = readFloat(dataSec, b'transitionDurationIn', 0, 5, 0.5)
        transitionDurationOut = readFloat(dataSec, b'transitionDurationOut', 0, 5, 0.5)
        transitionEasingIn = readEasing(dataSec, b'transitionEasingIn', 1, 3, 3)
        transitionEasingOut = readEasing(dataSec, b'transitionEasingOut', 1, 3, 3)
        focusRadiusOnMinMaxDistVec = readVec2(dataSec, b'focusRadiusOnMinMaxDist', (-100, -100), (100, 100), (3, 3))
        focusRadiusOnMinMaxDist = MinMax(focusRadiusOnMinMaxDistVec.x, focusRadiusOnMinMaxDistVec.y)
        heightAboveBaseOnMinMaxDistVec = readVec2(dataSec, b'heightAboveBaseOnMinMaxDist', (1, 1), (180, 180), (3, 3))
        heightAboveBaseOnMinMaxDist = MinMax(heightAboveBaseOnMinMaxDistVec.x, heightAboveBaseOnMinMaxDistVec.y)
        minLODBiasForTanks = readFloat(dataSec, b'minLODBiasForTanks', 0, 5, 0.0)
        settingsKey = readString(dataSec, b'settingsKey', b'')
...
class OverScrollProtector(object):
    __slots__ = (b'__lastScrollTime', b'__interval', b'__eScrollDirection')
...
class ZoomStateSwitcher(object):
    __slots__ = (b'__zoomStates', b'__index', b'__currentZoomState')
