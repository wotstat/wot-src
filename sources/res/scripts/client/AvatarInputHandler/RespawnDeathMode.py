...
class RespawnDeathMode(IControlMode):
    ...
    def __init__(self, dataSection, avatarInputHandler):
        ...
        self.__cam = ArcadeCamera(dataSection[b'camera'], dataSection.readVector2(b'defaultOffset'))
