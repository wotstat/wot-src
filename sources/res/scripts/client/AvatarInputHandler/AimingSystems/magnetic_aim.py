...
_TargetVeh = namedtuple(b'TargetVehicle', (b'vehicleRef', b'dotResult', b'distance'))
...
def magneticAimFindTarget():
    ...
    for vehicleID in BigWorld.player().arena.vehicles.iterkeys():
        ...
        if vehicle is None:
            continue
        allyOrSelfVehicle = vehicle.publicInfo[b'team'] == BigWorld.player().team or vehicle.isPlayerVehicle
