...
class RotatingCoursorCamera(object):
    ...
    def __init__(self, cfg):
        self.__camera = None
        self.__minPitch, self.__maxPitch = cfg.readVector2(b'pitchLimits')
        self.__minDist, self.__maxDist = cfg.readVector2(b'distanceLimits')
        self.__sensitivity = cfg.readFloat(b'sensitivity')
        self.__maxDistHalfLife = cfg.readFloat(b'maxDistHalfLife', 0.0)
        self.__pivotOffset = cfg.readVector3(b'pivotOffset')
        return
