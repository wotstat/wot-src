...
class FovExtended(object):
    ...
    def __init__(self):
        ...
        self.__enabled = True
        BigWorld.addWatcher(b'Render/Fov(horizontal, deg)', (lambda : self.__horizontalFov))
        BigWorld.addWatcher(b'Render/Fov(vertical, deg)', (lambda : math.degrees(self.__verticalFov)))
