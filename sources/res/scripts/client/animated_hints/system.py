...
_Voiceover = namedtuple(b'_Voiceover', (b'name', b'sound'))

class HintSystem(object):
    highPriorityVoiceovers = (b'vo_bc_weakness_in_armor',)
    ...
    def update(self):
        ...
        for hint in self._hints:
            ...
            if curCommandId is not None:
                primaryCommandsQueue.append((
                 hint.id, hint.typeId, curCommandId, hint.timeCompleted, hint.cooldownAfter,
                 hint.message, hint.voiceover))
