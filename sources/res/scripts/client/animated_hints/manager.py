...
class HintManager(object):
    ...
    def setPenetration(self, penetrationType, isColorBlind):
        g_eventBus.handleEvent(HintActionEvent(EventAction.SetPenetration, ctx={b'penetrationType': penetrationType, b'isColorBlind': isColorBlind}), scope=EVENT_BUS_SCOPE.BATTLE)
        return
