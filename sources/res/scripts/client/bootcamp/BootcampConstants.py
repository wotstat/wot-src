...
BATTLE_STATS_RESULT_FIELDS = {(BATTLE_STATS_TOOLTIPS.DESTROYED): b'kills', 
   (BATTLE_STATS_TOOLTIPS.DAMAGE): b'damageDealt', 
   (BATTLE_STATS_TOOLTIPS.BLOCKED): b'damageBlockedByArmor', 
   (BATTLE_STATS_TOOLTIPS.DETECTED): b'spotted', 
   (BATTLE_STATS_TOOLTIPS.ASSISTED): b'damageAssisted'}
BATTLE_STATS_ICONS = {(BATTLE_STATS_TOOLTIPS.DESTROYED): b'statIconDestroyed', 
   (BATTLE_STATS_TOOLTIPS.DAMAGE): b'statIconDamage', 
   (BATTLE_STATS_TOOLTIPS.BLOCKED): b'statIconBlocked', 
   (BATTLE_STATS_TOOLTIPS.DETECTED): b'statIconDetected', 
   (BATTLE_STATS_TOOLTIPS.ASSISTED): b'statIconAssisted'}
CONSUMABLE_ERROR_MESSAGES = (b'repairkitAllDevicesAreNotDamaged', b'repairkitDeviceIsNotDamaged', b'medkitAllTankmenAreSafe', b'medkitTankmanIsSafe', b'extinguisherDoesNotActivated')
...
HINT_NAMES = (b'hintMove', b'hintMoveTurret', b'hintShoot', b'hintAdvancedSniper', b'hintAim', b'hintSniper', b'hintWeakPoints', b'hintMessageAvoid', b'hintPlayerSpotted', b'hintSectorClear', b'hintStartNarrative', b'hintCaptureTheBase', b'hintResetProgress', b'hintRepairTrack', b'hintHealCrew', b'hintUseExtinguisher', b'hintAllyShoot', b'hintPlayerDetectEnemies', b'hintExitGameArea', b'hintEnemyCanHide', b'hintSneak', b'hintSniperOnDistance', b'hintRotateLobby', b'hintTargetLock', b'hintWaitReload', b'hintNoMove', b'hintNoMoveTurret', b'hintShootWhileMoving', b'hintMoveToMarker', b'hintSecondarySniper', b'hintUselessConsumable', b'hintLowHP', b'hintTargetUnLock', b'hintB3PlayerDetected', b'hintB3FallBack', b'hintB3Foliage', b'hintB3DoCapture', b'hintB3CaptureInProgress', b'hintB3EnemiesHidden', b'hintB3CaptureReset', b'hintB3Foliage2', b'hintB3Flank', b'hintB3CaptureTogether', b'hintSniperLevel0', b'hintCustom')
