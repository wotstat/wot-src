...
@ReprInjector.simple(b'state', b'energyTurbo', b'energyFight', b'transitionTimeLeft', b'timeLeftActiveTurbo', b'timeLeftActiveFight')
class StanceDanceState(typing.NamedTuple(b'StanceDanceState', (
 (
  b'state', int), (b'params', StanceDanceParams),
 (
  b'energyTurbo', int), (b'startTimeTurbo', float), (b'durationTurbo', float),
 (
  b'energyFight', int), (b'startTimeFight', float), (b'durationFight', float),
 (
  b'startSwitch', float), (b'durationSwitch', float))), IMechanicState):

    @classmethod
    def fromComponentStatus(cls, status, params):
        state = cls(status.state, params, status.energyTurbo, status.timeActiveTurbo[b'startTime'], status.timeActiveTurbo[b'endTime'] - status.timeActiveTurbo[b'startTime'], status.energyFight, status.timeActiveFight[b'startTime'], status.timeActiveFight[b'endTime'] - status.timeActiveFight[b'startTime'], status.timeSwitch[b'startTime'], status.timeSwitch[b'endTime'] - status.timeSwitch[b'startTime'])
        return state
