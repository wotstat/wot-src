...
class SerialNumberSwitcher(object):
    ...
    lamp3digits = ComponentProperty(type=CGFMetaTypes.STRING, editorName=b'3 digits', annotations={b'path': b'*.prefab'})
    lamp4digits = ComponentProperty(type=CGFMetaTypes.STRING, editorName=b'4 digits', annotations={b'path': b'*.prefab'})
    lamp5digits = ComponentProperty(type=CGFMetaTypes.STRING, editorName=b'5 digits', annotations={b'path': b'*.prefab'})
...
class SerialNumberComponent(object):
    domain = CGF.DomainOption.DomainClient
    counterValue = ComponentProperty(type=CGFMetaTypes.STRING, editorName=b'Counter Value', value=b'00000')
    splitNumber = ComponentProperty(type=CGFMetaTypes.BOOL, editorName=b'Split number', value=False)
    decalComponent = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'DecalLink', value=DecalComponent)
    decalCount = ComponentProperty(type=CGFMetaTypes.INT, editorName=b'Decal count', value=1)
