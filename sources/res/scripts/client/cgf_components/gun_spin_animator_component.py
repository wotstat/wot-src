import math, CGF, GenericComponents, Math
...
class GunSpinAnimator(object):
    editorTitle = b'Gun Spin Animator'
    category = b'Auto Shoot Guns'
    maxRPM = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'Max RPM', value=600.0)
    barrelsCount = ComponentProperty(type=CGFMetaTypes.INT, editorName=b'Barrels count', value=8)
    timeToStop = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'Time to stop', value=0.5)
