...
class _TrajectoryDrawerImpl(object):
    __slots__ = (b'__gameObject', b'__isEnabled', b'__drawer', b'__spaceID')
    ...
    def __init__(self, spaceID):
        ...
        self.__drawer = None
        BigWorld.addWatcher(b'Debug/Ballistics/Debug draw', self.__getEnabled, self.__setEnabled, b'Enable debug trajectory drawer')
        return
    ...
    def __setEnabled(self, value):
        ...
        if self.__isEnabled:
            if self.__gameObject is None:
                self.__gameObject = CGF.GameObject(self.__spaceID, b'TrajectoryDrawer')
