...
VisualScriptEquipmentState = namedtuple(b'VisualScriptEquipmentState', (b'quantity', b'endTime', b'totalTime', b'prevStage', b'stage'))
...
def getVisualScriptEquipmentState(fixedDict):
    state = VisualScriptEquipmentState(quantity=fixedDict[b'quantity'], endTime=fixedDict[b'endTime'], totalTime=fixedDict[b'totalTime'], prevStage=fixedDict[b'prevStage'], stage=fixedDict[b'stage'])
    return state
