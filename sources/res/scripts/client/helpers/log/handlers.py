...
class WotFormatter(logging.Formatter):
    ...
    def formatException(self, ei):
        return (b'').join(traceback.format_exception(*ei))
    ...
    def formatException(self, ei):
        ...
        with closing(cStringIO.StringIO()) as sio:
            ...
            for frame in reversed(frames):
                print >> sio
                print >> sio, (b'Frame {} in {} at line {}').format(frame.f_code.co_name, frame.f_code.co_filename, frame.f_lineno)
                ...
                for key, value in frame.f_locals.iteritems():
                    ...
                    size -= 1
                    try:
                        print >> sio, (b'\t{:>20} = {}').format(key, repr(value))
                    except Exception:
                        print >> sio, (b'\t{:>20} = <UNDEFINED>').format(key)
