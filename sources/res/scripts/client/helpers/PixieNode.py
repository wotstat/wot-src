...
class BaseNodeEffect(object):
    __slots__ = (b'__weakref__', b'_enabled')
...
class PixieEffect(BaseNodeEffect):
    __slots__ = (b'__effectName', b'__pixieRef', b'__ttl', b'__node', b'__ttlCallback', b'_enabled')
...
class NodeEffectList(BaseNodeEffect):
    __slots__ = (b'__node', b'__player', b'__model', b'__timeLine')
...
class EffectNode(object):
    __slots__ = (b'__node', b'__nodeName', b'__remappedNode', b'__nodeDefaultLocalTranslation', b'__drawOrder', b'__waterY', b'__effects')
    _PIXIE_NAME = 0
    _PIXIE_ENABLED = 1
    _PIXIE_REF = 2
    _PIXIE_TTL = 3
...
class TrackEffectNode(EffectNode):
    __slots__ = (b'__appearance', b'__side', b'__index')
    _SPLITTER = b'_'
