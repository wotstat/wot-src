...
def readHintSection(xmlCtx, section, flags):
    ...
    hint = chapter.ChainHint(sectionInfo[b'hintID'], sectionInfo[b'itemID'], sectionInfo[b'text'], sectionInfo[b'hasBox'], sectionInfo[b'arrow'], sectionInfo[b'padding'], sectionInfo[b'hideImmediately'])
