        ...
        if isOn:
            ...
            for triggerID in self.__excludeTriggerIDs:
                ...
                if trigger is not None:
                    ...
                    LOG_ERROR(b'Trigger not found', triggerID)
        ...
        if flagID is None:
            ...
            if value:
                if not isActive:
                    ...
                    LOG_DEBUG(b'invalidateFlags from _setFlagValue', flagID, value)
...
class CurrentVehicleChangedTrigger(TriggerWithSubscription):
    ...
    def __onCurrentVehicleChanged(self):
        LOG_DEBUG(b'invalidateFlags from __onCurrentVehicleChanged')
        self._tutorial.invalidateFlags()
        self.toggle()
        return
...
class ItemsCacheSyncTrigger(TriggerWithSubscription):
    ...
    def __onItemCacheSyncCompleted(self, *_):
        LOG_DEBUG(b'invalidateFlags from __onItemCacheSyncCompleted')
        self._tutorial.invalidateFlags()
        self.toggle()
        return
