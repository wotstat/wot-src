...
class ControlsFactory(object):
    ...
    def createContentQuery(self, name):
        ...
        if name in self._contentQueries:
            ...
            LOG_ERROR(b'Not found ContentQuery class by name:', name)
        return result
    ...
    def createFuncEffect(self, effect):
        if effect is None:
            ...
            if effectType in self._funcEffects:
                ...
                LOG_ERROR(b'Not found FunctionalEffect class by effect type:', EFFECT_TYPE_NAMES.get(effectType, effectType))
            return funcEffect
    ...
    def createCustomFuncCondition(self, condition):
        if condition is None:
            ...
            if funcConditionClass is not None:
                ...
                LOG_ERROR(b'FunctionalCondition class is not callable', conditionType, funcConditionClass)
            elif conditionType >= CONDITION_TYPE.FIRST_CUSTOM:
                LOG_ERROR(b'Not found FunctionalCondition by custom condition type', conditionType)
            return
