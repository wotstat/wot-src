...
class BootcampLobbyControlsFactory(ControlsFactory):
    ...
    def __init__(self):
        ...
        queries_ = {b'bootcampVideo': (queries.VideoDialogContentQuery), 
           b'bootcampSubtitle': (queries.SubtitleDialogContentQuery), 
           b'bootcampMessage': (queries.MessageDialogContentQuery)}
