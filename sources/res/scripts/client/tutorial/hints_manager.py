...
HINT_SHOWN_STATUS = 1
_MAX_ACTIVE_HINTS = 1
_DESCRIPTOR_PATH = (b'{0:>s}/once-only-hints.xml').format(settings.DOC_DIRECTORY)

class HintsManager(object):
    __settingsCore = dependency.descriptor(ISettingsCore)
    __tutorialLoader = dependency.descriptor(ITutorialLoader)
    __slots__ = (b'_data', b'_gui', b'__activeHints', b'__postponedHints', b'__hintsWithClientTriggers')
    ...
    @staticmethod
    def __filterByLimitedUIRule(condition, conditionId, arguments=b''):
