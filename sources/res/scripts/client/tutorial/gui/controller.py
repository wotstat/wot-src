...
class GuiController(IGuiController):
    __slots__ = (b'__guiImpls', b'_isEnabled', b'_componentViewBindings', b'_components', b'_componentProps', b'_pendingComponentAnimations', b'__hintsWithClientTriggers', b'_config', b'__onComponentFoundHandlers', b'__descriptions')
