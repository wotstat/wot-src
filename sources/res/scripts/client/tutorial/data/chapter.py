...
class HasIDConditions(HasID):
    ...
    def __repr__(self):
        return (b'HasIDConditions({0:s}): {1!r:s}, {2!r:s}').format(self._id, self.__conditions[:], self.__conditions.eitherBlocks())
