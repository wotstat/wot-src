...
class RunCtx(object):
    ...
    def __init__(self, cache, **kwargs):
        ...
        self.cache = cache
        self.databaseID = kwargs.get(b'databaseID', 0L)
        ...
        self.initialChapter = kwargs.get(b'initialChapter', None)
...
class TutorialLoader(ITutorialLoader):
    ...
    def goToLobby(self):
        ...
        state = {b'isFirstStart': isFirstStart, 
           b'isAfterBattle': (self.__afterBattle)}
