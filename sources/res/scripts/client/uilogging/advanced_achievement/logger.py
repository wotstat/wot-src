...
class AdvancedAchievementLogger(AdvancedAchievementMetricsLoger):
    ...
    __SUBCATEGORY = {b'vehicleAchievements': {1: (AdvancedAchievementSubcategory.VEHICLE), 
                                2: (AdvancedAchievementSubcategory.NATIONS)}, 
       b'customizationAchievements': {1: (AdvancedAchievementSubcategory.CUSTOMIZATION)}}
