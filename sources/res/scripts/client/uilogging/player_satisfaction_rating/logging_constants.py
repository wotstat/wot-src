...
class PlayerSatisfactionRatingCMActions(Enum):
    ...
    UNTRACKED_ACTION = b'untracked_action'
    FRIEND_ACTION = b'friend_action'
    SEND_MESSAGE = b'send_message'
    CREATE_PLATOON = b'create_platoon'
    CREATE_UNIT = b'create_unit'
    COMPLAIN = b'complain'
    BLACKLIST = b'blacklist'
    VOICE_MESSAGES = b'voice_messages'
    COMMENDATION = b'commendation'


class PlayerSatisfactionRatingKeys(Enum):
    CONTEXT_MENU = b'context_menu'
    TEAM_SCORE_TAB = b'team_score_tab'
    TEAM_VIEW = b'team_view'
    BATTLE_GUI = b'battle_gui'
    CREATE_PLATOON = b'create_platoon'
    COMMAND_WHEEL = b'command_wheel'
    HOT_KEY = b'hot_key'
    RESPONSE = b'response'


class PlayerSatisfationRatingInviteSource(object):
    FULL_STATS_VIEW = b'full_stats_view'
    IN_BATTLE_GUI = b'in_battle_gui'


class PlayerSatisfactionRatingInfoKeys(object):
    ARENA_ID_KEY = b'arena_id'
    BATTLE_PHASE_KEY = b'battle_phase'
    PHASE_TIME_KEY = b'phase_time'
    IS_ALIVE_KEY = b'is_alive'
    PREBATTLE_ID_KEY = b'prebattle_id'
...
class PlayerSatisfactionRatingRadialMenuActions(Enum):
    NO_ACTION = b'no_action'
    UNTRACKED_ACTION = b'untracked_action'
    HELP_PROVIDE = b'help_provide'
    HELP_ASKED = b'help_asked'
