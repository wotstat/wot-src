...
_NAV_BUTTON = b'{parentScreen}_{item}_button'
...
class CrewViewLogger(CrewMetricsLogger):
    __slots__ = (b'_currentView', b'_parentViewKey', b'_currentViewKey', b'_overlappingWindowsCount', b'_isPaused')
...
class CrewBringToFrontViewLogger(CrewViewLogger):
    __slots__ = (b'_sameLayerOverlappingWindows',)
...
class CrewPersonalCaseTabLogger(CrewBringToFrontViewLogger):
    __slots__ = (b'_parentView', b'_layoutID', b'_canModifyAction')
...
class CrewDialogLogger(CrewViewLogger):
    __slots__ = (b'_additionalInfo',)
    _CLOSE_REASON_ESCAPE = b'escape'
...
class CrewTooltipLogger(CrewMetricsLogger):
    __slots__ = (b'_parentViewKey', b'_currentTooltip', b'_previousTooltipId', b'_tooltipIdMapping', b'_openedTooltipId', b'_openedTooltipArgs')
