...
class HangarSelectableLogic(BaseSelectableLogic):
    __slots__ = (b'__selected3DEntity', b'__selected3DEntityUnderMouseDown')
    ...
    def __highlight3DEntity(self, entity):
        ...
        self._callbackMethodCall(b'onHighlight3DEntity', entity)
        return

    def __fade3DEntity(self, entity):
        entity.setHighlight(False)
        self._callbackMethodCall(b'onFade3DEntity', entity)
        return
