...
class OfflineMapCreator(object):
    ...
    def create(self, mapName):
        ...
        try:
            ...
            self.__spaceMappingId = BigWorld.addSpaceGeometryMapping(self.__spaceId, None, b'spaces/' + mapName)
            self.__vEntityId = BigWorld.createEntity(b'Avatar', self.__spaceId, 0, _V_START_POS, (
