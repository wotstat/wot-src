...
class VehicleEventsDebugger(ClientEventsContainerDebugger):
    IGNORED_EVENTS = ClientEventsContainerDebugger.IGNORED_EVENTS + (b'onAppearanceReady', b'onAppearanceReset', b'onCollectAmmoStates', b'onCollectShotParams', b'onCurrentShellChanged', b'onCollectVehicleAttrs', b'onDiscreteShotDone', b'onShowDamageFromShot', b'onVehicleHealthChanged')
