...
@ReprInjector.simple(b'maxTemperature', b'coolingPerSec')
...
@ReprInjector.simple((b'_state', b'state'), (b'_updateTime', b'updateTime'), (b'_temperature', b'temperature'), (b'_directionFactor', b'directionFactor'))
