...
def _makeEvent(quickShot=None, fullShot=None, fullShotChangeTime=None):
    ...
    if quickShot is not None:
        event[b'vehicle/gun/lowChargeShot/quickShot'] = quickShot
    if fullShot is not None:
        event[b'vehicle/gun/lowChargeShot/fullShot'] = fullShot
    if fullShotChangeTime is not None:
        event[b'vehicle/gun/lowChargeShot/fullShotChangeTime'] = fullShotChangeTime
    return event
