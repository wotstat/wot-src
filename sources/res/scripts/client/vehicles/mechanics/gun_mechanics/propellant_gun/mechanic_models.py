...
@ReprInjector.simple(b'chargePerSec', b'dischargePerSec', b'maxCharge', b'maxOvercharge')
...
@ReprInjector.simple(b'state', b'currentStage', b'currentCharge', b'currentThreshold', b'isOvercharge', b'isAvailable', b'isUsableShell', b'isCharged')
class PropellantGunMechanicState(IPropellantGunMechanicState):
    ...
    def __eq__(self, other):
        return all(other.__dict__[key] == value for key, value in self.__dict__.items() if key != b'_PropellantGunMechanicState__updateTime')

    def __ne__(self, other):
        return not self == other

    def __hash__(self):
        return hash(tuple(value for key, value in self.__dict__.items() if key != b'_PropellantGunMechanicState__updateTime'))
