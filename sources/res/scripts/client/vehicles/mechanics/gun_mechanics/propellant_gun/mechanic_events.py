...
class PropellantStatesCoreIntegration(VehicleComponentEventsCoreIntegration, IMechanicStatesListenerLogic):
    ...
    def __postPropellantChangedEvent(self, lastShotTimestamp, lastShotCharge):
        gun_events.postVehicularVariablesChangedEvent(self._spaceID, self._vehicleID, self._slotName, {b'vehicle/gun/lastSingleShotTimeServer': lastShotTimestamp, 
           b'vehicle/gun/lastShotPropellantProgress': lastShotCharge})
        return
