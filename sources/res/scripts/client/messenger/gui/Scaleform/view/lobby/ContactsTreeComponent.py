...
class ContactsTreeComponent(ContactsTreeComponentMeta):
    LIST_EMPTY_STATE = b'listEmptyState'
    ...
    def _populate(self):
        ...
        self.as_setInitDataS({b'accMinChars': ACCOUNT_NAME_MIN_CHARS_LENGTH, 
           b'accMaxChars': ACCOUNT_NAME_MAX_CHARS_LENGTH})
        return
    ...
    def _updateListState(self):
        ...
        if isListEmpty:
            ...
            self.as_updateInfoMessageS(True, b'', b'', False)
        else:
