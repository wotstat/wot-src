...
class SearchContactView(SearchContactViewMeta, ISearchHandler):
    ...
    def _getInitDataObject(self):
        ...
        defData[b'inputPrompt'] = MESSENGER.MESSENGER_CONTACTS_SEARCHUSERS_SEARCHINPUTPROMPT
        defData[b'searchCoolDown'] = str(self._searchDP.processor.getSearchCoolDown())
        defData[b'accMinChars'] = ACCOUNT_NAME_MIN_CHARS_LENGTH
        defData[b'accMaxChars'] = ACCOUNT_NAME_MAX_CHARS_LENGTH
        return defData
