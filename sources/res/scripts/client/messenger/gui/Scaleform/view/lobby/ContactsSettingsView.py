...
class ContactsSettingsView(ContactsSettingsViewMeta):
    ...
    def showOfflineUsers(self, value):
        self.__currentData[b'showOfflineUsers'] = value
        self.__checkIsDataChanged()
        return

    def showOthers(self, value):
        self.__currentData[b'showOthersCategory'] = value
        self.__checkIsDataChanged()
        return
    ...
    def _getInitDataObject(self):
        ...
        self.__startData = {b'showOfflineUsers': (bool(startData[b'showOfflineUsers'])), 
           b'showOthersCategory': (bool(startData[b'showOthersCategory']))}
        ...
        baseData[b'mainData'] = self.__startData
        return baseData
