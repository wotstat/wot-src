...
class GroupManageView(BaseManageContactViewMeta):
    ...
    def _getDefaultInitData(self, mainLbl, btOkLbl, btnCancelLbl, btOkTooltip, btnCancelTooltip):
        ...
        defData[b'inputPrompt'] = i18n.makeString(MESSENGER.MESSENGER_CONTACTS_VIEW_MANAGEGROUP_RENAMEGROUP_SEARCHINPUTPROMPT, symbols=CONTACT_LIMIT.GROUP_MAX_LENGTH)
        defData[b'groupMaxChars'] = CONTACT_LIMIT.GROUP_MAX_LENGTH
        defData[b'inputTooltip'] = i18n.makeString(MESSENGER.CONTACTS_MANAGEGROUPVIEW_TOOLTIPS_INPUT, maxChars=CONTACT_LIMIT.GROUP_MAX_LENGTH)
        return defData
