...
def updatePrivateCarouselMembers(clientID, memberDBID, memberUsername):
    g_eventBus.handleEvent(events.ChannelManagementEvent(clientID, events.ChannelManagementEvent.REQUEST_TO_MULTI_CHANGE, {b'dbID': memberDBID, 
       b'userName': memberUsername}), scope=EVENT_BUS_SCOPE.LOBBY)
    return
