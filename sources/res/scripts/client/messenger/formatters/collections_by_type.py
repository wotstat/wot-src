...
registerConvertersSubFormatter(b'newYear25', NewYearMandarinsConverterFormatter)
registerConvertersSubFormatter(b'dailyQuests', DailyQuestsEpicCompensationFormatter)
...
SERVER_FORMATTERS = {(_SM_TYPE.serverReboot.index()): (_sc.ServerRebootFormatter()), 
   ...
   (_SM_TYPE.battlePassCapReset.index()): (_sc.SimpleFormatter(b'BattlePassCapResetMessage')), 
   ...
   (_SM_TYPE.bonusExcludedMap.index()): (_sc.SimpleFormatter(b'BonusExcludedMapAvailable')), 
   (_SM_TYPE.bonusExcludedMapPremium.index()): (_sc.SimpleFormatter(b'BonusExcludedMapPremiumAvailable')), 
   ...
   (_SM_TYPE.goldReserveIsFull.index()): (_sc.SimpleFormatter(b'GoldReserveFullMessage')), 
   (_SM_TYPE.passiveXPNoTank.index()): (_sc.SimpleFormatter(b'PassiveXPNoTankMessage')), 
   (_SM_TYPE.passiveXPIncompatibleCrewNewDay.index()): (_sc.SimpleFormatter(b'PassiveXPIncompatibleCrewNewDayMessage')), 
...
def initRegistrationFormatters():
    ...
    registerMessengerServerFormatter(_SM_TYPE.battlePassCapReset.index(), _sc.SimpleFormatter(b'BattlePassCapResetMessage'))
    ...
    registerMessengerServerFormatter(_SM_TYPE.bonusExcludedMap.index(), _sc.SimpleFormatter(b'BonusExcludedMapAvailable'))
    registerMessengerServerFormatter(_SM_TYPE.bonusExcludedMapPremium.index(), _sc.SimpleFormatter(b'BonusExcludedMapPremiumAvailable'))
    registerMessengerServerFormatter(_SM_TYPE.tradingCaravanMessage.index(), _sc.TradingCaravanMessageFormatter())
    registerMessengerServerFormatter(_SM_TYPE.goldReserveIsFull.index(), _sc.SimpleFormatter(b'GoldReserveFullMessage'))
    registerMessengerServerFormatter(_SM_TYPE.passiveXPNoTank.index(), _sc.SimpleFormatter(b'PassiveXPNoTankMessage'))
    registerMessengerServerFormatter(_SM_TYPE.passiveXPIncompatibleCrewNewDay.index(), _sc.SimpleFormatter(b'PassiveXPIncompatibleCrewNewDayMessage'))
    ...
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_FEATURE_DISABLED, _sc.SimpleFormatter(b'WotPlusDisabled'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_FEATURE_ENABLED, _sc.SimpleFormatter(b'WotPlusEnabled'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_FREE_DEMOUNT_ENABLED, _sc.SimpleFormatter(b'WotPlusFreeDemountUnlockMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_FREE_DEMOUNT_DISABLED, _sc.SimpleFormatter(b'WotPlusFreeDemountExpireMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_GOLDRESERVE_ENABLED, _sc.SimpleFormatter(b'GoldReserveEnabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_GOLDRESERVE_DISABLED, _sc.SimpleFormatter(b'GoldReserveDisabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_PASSIVEXP_ENABLED, _sc.SimpleFormatter(b'PassiveXpEnabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_PASSIVEXP_DISABLED, _sc.SimpleFormatter(b'PassiveXpDisabledMessage'))
    ...
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.BONUS_EXCLUDED_MAP_ENABLED, _sc.SimpleFormatter(b'BonusExcludedMapAvailable'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.BONUS_EXCLUDED_MAP_DISABLED, _sc.SimpleFormatter(b'BonusExcludedMapUnavailable'))
    ...
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_DAILY_ATTENDANCES_ENABLED, _sc.SimpleFormatter(b'DailyAttendancesEnabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_DAILY_ATTENDANCES_DISABLED, _sc.SimpleFormatter(b'DailyAttendancesDisabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_DAILY_QUESTS_EXTRA_REWARDS_ENABLED, _sc.SimpleFormatter(b'DailyQuestsExtraRewardsEnabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_DAILY_QUESTS_EXTRA_REWARDS_DISABLED, _sc.SimpleFormatter(b'DailyQuestsExtraRewardsDisabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_TEAM_CREDITS_BONUS_ENABLED, _sc.SimpleFormatter(b'TeamCreditsBonusEnabledMessage'))
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.WOTPLUS_TEAM_CREDITS_BONUS_DISABLED, _sc.SimpleFormatter(b'TeamCreditsBonusDisabledMessage'))
