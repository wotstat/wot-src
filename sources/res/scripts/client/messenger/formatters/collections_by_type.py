...
def initRegistrationFormatters():
    ...
    registerMessengerServerFormatter(_SM_TYPE.wotPlusProBoostEnabled.index(), _sc.SimpleFormatter(b'WotPlusProBoostEnabledMessage'))
    registerMessengerServerFormatter(_SM_TYPE.wotPlusProBoostDisabled.index(), _sc.SimpleFormatter(b'WotPlusProBoostDisabledMessage'))
