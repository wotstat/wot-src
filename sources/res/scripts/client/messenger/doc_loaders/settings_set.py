...
_BATTLE_ITEM_READERS = {b'messageFormat': (_xml_helpers.readUnicodeItem), 
   ...
   b'chatIsLockedParentalControlToolTipText': (_xml_helpers.readI18nStringItem), 
   b'chatIsLockedCountryControlToolTipText': (_xml_helpers.readI18nStringItem), 
   b'chatIsLockedOtherControlToolTipText': (_xml_helpers.readI18nStringItem), 
