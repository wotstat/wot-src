...
class _BattleSettings(object):
    __slots__ = (b'messageLifeCycle', b'messageFormat', b'targetFormat', b'inactiveStateAlpha', b'hintText', b'toolTipText', b'numberOfMessagesInHistory', b'receivers', b'alphaForLastMessages', b'chatIsLockedToolTipText', b'recoveredLatestMessages', b'lifeTimeRecoveredMessages', b'lastReceiver', b'toolTipTextWithMuteInfo', b'battleRoyaleTooltip')
