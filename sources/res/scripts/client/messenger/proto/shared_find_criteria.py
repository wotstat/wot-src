...
class IgnoredFindCriteria(UserTagsFindCriteria):
    ...
    def __init__(self):
        super(IgnoredFindCriteria, self).__init__({
         USER_TAG.IGNORED}, onlineMode=None)
        return
    ...
    def setOnlineMode(self, onlineMode):
        if onlineMode is None:
            ...
            LOG_WARNING(b'Online mode for ignored list will be skipped')
            return
