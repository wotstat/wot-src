...
class ChatMessage(object):
    ...
    def __init__(self, dbID=0, name=b'', body=b'', sentAt=0, affiliation=b'none', role=b'none'):
...
_BanInfoItem = namedtuple(b'_BanInfoItem', (b'source', b'setter', b'expiresAt', b'reason', b'components', b'game'))
...
WGExtsInfo = namedtuple(b'WGExtsInfo', (b'dbID', b'nickname', b'client', b'clan', b'ban'))
