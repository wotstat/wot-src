...
@ReprInjector.simple(b'priority', b'message', b'presence', (b'__wgExts', b'exts'), (b'__mucInfo', b'muc'))
class Resource(object):
    __slots__ = (b'priority', b'message', b'presence', b'__wgExts', b'__mucInfo', b'__order')
    ...
    def __init__(self, priority=0, message=0, presence=PRESENCE.UNAVAILABLE, wgExts=None, mucInfo=None):
        ...
        self.__wgExts = wgExts or WGExtsInfo(0, b'', None, None, None)
