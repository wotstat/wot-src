...
Identity = namedtuple(b'Identity', (b'name', b'category', b'type'))
...
class IdentityElement(PyExtension):
    ...
    def parseTag(self, pyGlooxTag):
        return Identity(pyGlooxTag.findAttribute(b'name'), pyGlooxTag.findAttribute(b'category'), pyGlooxTag.findAttribute(b'type'))
