...
class XMPP_BAN_COMPONENT(object):
    ...
    _STRING_TO_BITMASK = {b'battle': BATTLE, 
       b'prebattle': PREBATTLE, 
       b'private': PRIVATE, 
       b'standard': STANDARD, 
       b'user': USER, 
       b'clan': CLAN, 
    ...
    def fromString(cls, value):
        ...
        for component in components:
            ...
            if component in cls._STRING_TO_BITMASK:
                ...
                LOG_WARNING(b'Component is not supported', component)
...
class SERVICE_DISCO_FEATURE(object):
    MUC_PASSWORD_PROTECTED = b'muc_passwordprotected'
...
XMPP_MUC_USER_TEMPLATE_GROUPS = {(XMPP_MUC_USER_TYPE.OWNER): b'channelOwner', 
   (XMPP_MUC_USER_TYPE.ADMIN): b'chatAdmin', 
   (XMPP_MUC_USER_TYPE.MODERATOR): b'channelModerator', 
   (XMPP_MUC_USER_TYPE.MEMBER): b'channelMember', 
   (XMPP_MUC_USER_TYPE.PARTICIPANT): b'channelParticipant', 
   (XMPP_MUC_USER_TYPE.VISITOR): b'channelVisitor', 
   (XMPP_MUC_USER_TYPE.OUTCAST): b'channelOutcast', 
   (XMPP_MUC_USER_TYPE.NONE): b'channelNone'}
