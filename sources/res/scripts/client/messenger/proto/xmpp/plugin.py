...
class XmppPlugin(IProtoPlugin):
    __slots__ = (b'__client', b'__contacts', b'__connection', b'__logger', b'__messages', b'__isClientInited', b'__nicknameResolver', b'__clanListener')
    ...
    def __repr__(self):
        return (b'XmppPlugin(id=0x{0:08X}, ro={1!r:s},').format(id(self), [b'client', b'contacts', b'messages', b'logger'])
