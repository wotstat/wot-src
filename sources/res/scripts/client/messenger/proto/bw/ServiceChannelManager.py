...
class ServiceChannelManager(ChatActionsListener):
        ...
        if formatter:
            ...
            for mData in messagesListData:
                if mData is not None and mData.data:
                    ...
                    LOG_WARNING(b'Not enough data to format. Action data : ', message)

        elif IS_DEVELOPMENT:
            LOG_WARNING(b'Formatter not found. Action data : ', message)
        return
    ...
    def __addClientMessage(self, message, msgType, isAlert=False, auxData=None):
        ...
        if formatter:
            ...
            LOG_WARNING(b'Formatter not found:', msgType, message)
        return clientID
