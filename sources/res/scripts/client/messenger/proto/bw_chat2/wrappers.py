...
class _MessageVO(object):
    ...
    def __init__(self, floatArg1=0, strArg1=b'', **kwargs):
        ...
        self.vehicleID = 0
        self.text = strArg1 if isinstance(strArg1, unicode) else unicode(strArg1, b'utf-8', errors=b'ignore')
        self.sentAt = 0
        if floatArg1 > 0:
...
class UnitMessageVO(_MessageVO):
    ...
    def __init__(self, floatArg1=0, int64Arg1=0, strArg1=b'', strArg2=b'', **kwargs):
        ...
        self.accountName = strArg2 if isinstance(strArg2, unicode) else unicode(strArg2, b'utf-8', errors=b'ignore')
        return
...
def SearchResultIterator(value):
    value = dict(value)
    if b'strArg1' in value:
        result = pickle.loads(value[b'strArg1'])
    else:
        result = []
