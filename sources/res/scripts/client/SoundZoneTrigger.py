...
class SoundZoneTrigger(BigWorld.UserDataObject):
    ...
    def __init__(self):
        ...
        self.__gameObject = CGF.GameObject(BigWorld.player().spaceID, b'SoundZoneTrigger')
        ...
        self.__gameObject.createComponent(SoundZoneComponent, self.ZoneEnter, self.ZoneExit, self.Reverb, b'', self.ReverbLevel, self.VolumeDeviation)
        ...
        if VISUALISE_ZONE:
            self.model = BigWorld.Model(b'objects/misc/bbox/unit_cube_1m_proxy.model')
