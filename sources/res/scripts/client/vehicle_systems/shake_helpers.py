...
def shakePlayerDynamicCamera(vehicle, gunInstallationSlot, shakeReason=ShakeReason.OWN_SHOT, gunNodeName=TankNodeNames.GUN_INCLINATION, gunFireNodeName=b'HP_gunFire'):
