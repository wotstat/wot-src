...
class VehicleDamageState(object):
    ...
    __healthToStateMap = {0: b'destruction', 
       ...
       (constants.SPECIAL_VEHICLE_HEALTH.AMMO_BAY_EXPLODED): b'ammoBayBurnOff', 
    ...
    isAlive = property((lambda self: self.__state == b'alive'))
    isCrewDeath = property((lambda self: self.__state == b'crewDeath'))
    isSubmersionDeath = property((lambda self: self.__state == b'submersionDeath'))
