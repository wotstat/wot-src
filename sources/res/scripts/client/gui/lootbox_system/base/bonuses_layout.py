...
_CONFIG_FILENAME = b'gui/lootbox_system_bonuses_layout.xml'
_MAIN_SECTION_NAME = b'core'
_DEFAULT_SECTION_NAME = b'default'
_LEAST_PRIORITY = 0
    ...
    def __loadLayout(self):
        if self.__storage:
            ...
            if rootSection is None:
                _xml.raiseWrongXml(None, _CONFIG_FILENAME, b'can not open or read')
