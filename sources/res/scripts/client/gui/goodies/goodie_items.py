...
def getFullNameForBoosterIcon(boosterType, isPremium=False):
    return (b'{}{}').format(getBoosterGuiType(boosterType), b'_premium' if isPremium else b'')
...
class Booster(BoosterUICommon):
    ...
    def __repr__(self):
        ...
        if self.state == GOODIE_STATE.ACTIVE:
            ...
            stateStr = b'Used'
        return (b'Booster(id={} ({}), state={}, count={})').format(self.boosterID, self.getTypeAsString(), stateStr, self.count)
