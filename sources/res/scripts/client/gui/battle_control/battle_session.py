...
BattleExitResult = namedtuple(b'BattleExitResult', b'isDeserter playerInfo')

class BattleSessionProvider(IBattleSessionProvider):
    __slots__ = (b'__ctx', b'__sharedRepo', b'__dynamicRepo', b'__requestsCtrl', b'__arenaDP', b'__arenaListeners', b'__viewComponentsBridge', b'__weakref__', b'__arenaVisitor', b'__invitations', b'__isReplayPlaying', b'__battleCache', b'onUpdateObservedVehicleData')
    ...
    def __pe_onBattleResultsReceived(self, isActiveVehicle, _):
        if isActiveVehicle and not BattleReplay.g_replayCtrl.isPlaying:
            ...
            LOG_DEBUG(b'Try to exit from arena', arenaUniqueID, arenaBonusType)
            if arenaUniqueID:
