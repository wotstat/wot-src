...
class BattleSessionProvider(IBattleSessionProvider):
    __slots__ = (b'__ctx', b'__sharedRepo', b'__dynamicRepo', b'__requestsCtrl', b'__arenaDP', b'__arenaListeners', b'__viewComponentsBridge', b'__weakref__', b'__arenaVisitor', b'__invitations', b'__isReplayPlaying', b'__battleCache')
