...
def sniperCameraTransition(ctrlModeName, transitionTime, transitionSide):
    g_eventBus.handleEvent(GameEvent(GameEvent.SNIPER_CAMERA_TRANSITION, {b'ctrlModeName': ctrlModeName, 
       b'transitionTime': transitionTime, 
       b'transitionSide': transitionSide}), scope=_SCOPE)
    return
