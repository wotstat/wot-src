...
class SoundNotifications(object):
    DANGER_ZONE_MARKER_START = b'dstrct_death_zone_marker_start'
    DANGER_ZONE_MARKER_STOP = b'dstrct_death_zone_marker_stop'
    DANGER_ZONE_ENTER = b'dstrct_death_zone_enter'
    DANGER_ZONE_EXIT = b'dstrct_death_zone_exit'
