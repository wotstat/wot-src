...
class DevAutoShootController(AutoShootController):
    ...
    def __toggleBurstClamping(self, *_, **kwargs):
        ...
        LOG_WARNING(b'[AutoShoot][DEV] burst clamp mode: ', self.__burstClampActive)
        return
    ...
    def __updateDesiredRate(self, desiredRate):
        ...
        LOG_WARNING(b'[AutoShoot][DEV] desired shoot rate: ', self.__desiredRate)
        return
    ...
    def __updateRateSpeed(self, desiredRateSpeed):
        ...
        LOG_WARNING(b'[AutoShoot][DEV] desired shoot rate speed: ', self.__desiredRateSpeed)
        return

    def __updateServerRate(self, requestedRate):
        serverCommand = b'autoShootGunController/set_auto_shoot_rate'
        BigWorld.player().base.setDevelopmentFeature(0, serverCommand, requestedRate, b'')
        LOG_WARNING(b'[AutoShoot][DEV] requested shoot rate: ', requestedRate)
        return
