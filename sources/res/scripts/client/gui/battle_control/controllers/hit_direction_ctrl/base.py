...
class HitDirection(object):
    __slots__ = (b'__idx', b'__hitData', b'__startTime', b'__isShown', b'__indicator')
    ...
    def __repr__(self):
        return (b'_HitDirection(idx={0}, hitData={1}, startTime={2}, isShown={3}, hasUI={4})').format(self.__idx, self.__hitData, self.__startTime, self.__isShown, self.__indicator is not None)
