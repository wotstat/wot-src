...
_NONE_PLAYER_ATTACK_REASON_TAG = {(ATTACK_REASON_INDICES[b'artillery_protection']): (
                                                    INGAME_GUI.ATTACKREASON_ARTILLERYPROTECTION, b'artillery'), 
   (ATTACK_REASON_INDICES[b'artillery_sector']): (
                                                INGAME_GUI.ATTACKREASON_ARTILLERY_SECTOR, b'artillery'), 
   (ATTACK_REASON_INDICES[b'bombers']): (
                                       INGAME_GUI.ATTACKREASON_BOMBERS, b'bomber')}

class SimpleHitData(object):
    __slots__ = (b'__yaw', b'__attackerID', b'__soundName')
...
class HitData(SimpleHitData):
    __slots__ = (b'__damage', b'__attackerVehName', b'__friendlyFireMode', b'__attackerVehClassTag', b'__playerVehMaxHP', b'__hitFlags', b'__critFlags', b'__critsCount', b'__attackReasonID')

    def __init__(self, yaw=0, attackerID=0, attackerVehName=b'', attackerVehClassTag=None, playerVehMaxHP=0, damage=0, critFlags=0, isAlly=False, isBlocked=False, isHighExplosive=False, attackReasonID=0, friendlyFireMode=False):
        super(HitData, self).__init__(yaw, attackerID)
        self.__damage = damage
        self.__attackerVehName = attackerVehName
        self.__attackerVehClassTag = attackerVehClassTag or b''
    ...
    def __repr__(self):
        return (b'HitData: attackerID={}, yaw={}, damage={}, attacker vehicle=[name={}, class={}], player vehicle=[hp={}], hitFlags={}, critFlags={}[count={}]').format(self.getAttackerID(), self.getYaw(), self.__damage, self.__attackerVehName, self.__attackerVehClassTag, self.__playerVehMaxHP, self.__hitFlags, self.__critFlags, self.__critsCount)
