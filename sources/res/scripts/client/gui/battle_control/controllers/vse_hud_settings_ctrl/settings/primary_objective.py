...
class PrimaryObjectiveClientModel(TextClientModel):
    __slots__ = (b'id', b'header', b'subheader', b'startSound', b'remindTimers', b'remindSound', b'countdownTimer', b'countdownSound', b'success', b'successIcon', b'successSound', b'failure', b'failureIcon', b'failureSound')
    ...
    def __repr__(self):
        return b'<PrimaryObjectiveClientModel>: id=%s, header=%s, subheader=%s, startSound=%s, remindTimers=%s, remindSound=%s, countdownTimer=%s, countdownSound=%s, success=%s, successIcon=%s, successSound=%s, failure=%s, failureIcon=%s, failureSound=%s' % (
         self.id, self.header, self.subheader, self.startSound, self.remindTimers, self.remindSound,
         self.countdownTimer, self.countdownSound, self.success, self.successIcon, self.successSound,
         self.failure, self.failureIcon, self.failureSound)
