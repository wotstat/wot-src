...
_CALL_INTERVAL = 0.5
_W2GT_BATTLE_ZONE_TYPE = b'W2GT_BATTLE_ZONE'
...
class _StageData(namedtuple(b'_StageData', (b'stage', b'ctx', b'startTime'))):
...
class _SubPluginOngoing(_SubPlugin):
    ...
    def _buildExitContext(self, nextStage):
        return {b'selectedZoneID': (self.__selectedZoneID)}
...
class _SubPluginArrival(_SubPlugin):
    ...
    def _preInitialize(self, dataMgr, stageData):
        ...
        self.__selectedZoneID = stageData.getCtx(b'selectedZoneID')
        return
