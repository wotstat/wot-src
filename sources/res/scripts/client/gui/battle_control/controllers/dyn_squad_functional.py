...
class DynSquadMessagesController(DynSquadArenaController):
    ...
    def __sendMessage(self, resource, **kwargs):
        g_messengerEvents.onWarningReceived(_DynSquadActionMessage(backport.text(resource(), **kwargs), kwargs.get(b'squadType', DYN_SQUAD_TYPE.OWN), kwargs.get(b'squadNum')))
        return
