...
import GUI, Event, aih_constants, BattleReplay
...
class CrosshairDataProxy(IBattleController):
    __slots__ = (b'__width', b'__height', b'__positionX', b'__positionY', b'__scale', b'__viewID', b'__eManager', b'__isArenaStarted', b'__strategicCameraID', b'onCrosshairViewChanged', b'onCrosshairOffsetChanged', b'onCrosshairSizeChanged', b'onCrosshairPositionChanged', b'onCrosshairScaleChanged', b'onCrosshairZoomFactorChanged', b'onGunMarkerStateChanged', b'onGunMarkersSetChanged', b'onStrategicCameraChanged', b'onMultiGunCollisionsUpdated', b'onSPGShotsIndicatorStateChanged')
