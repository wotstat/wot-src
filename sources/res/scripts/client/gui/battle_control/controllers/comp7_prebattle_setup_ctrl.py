...
class _SceneController(object):
    __slots__ = (b'__spawnPoints', b'__config', b'__pendingSpawnPoints', b'__observers')
    ...
    def __onVehicleEnterWorld(self, vehicle):
        if vehicle.id in self.__pendingSpawnPoints:
            ...
            if b'observer' in vehicle.typeDescriptor.type.tags:
...
class Comp7PrebattleSetupController(IComp7PrebattleSetupController):
    ...
    def __makeGUIVehicle(vehicleInfo):
        ...
        builder.setSelectedComp7Skill(vehicleInfo[b'selectedComp7Skill'])
