...
__all__ = (
 b'AmmoController',
 b'AmmoReplayPlayer',
 b'AutoReloadingBoostStates',
 b'ReloadingTimeSnapshot')
_ClipSettings = namedtuple(b'_ClipSettings', b'size interval')
_BurstSettings = namedtuple(b'_BurstSettings', b'size interval syncReloading')
...
class _GunSettings(object):
    ...
    def fromVehicle(cls, vehicleID, vehicleDescr):
        ...
        isAutoReload = b'autoreload' in gun.tags
    ...
    def isUnlimitedClip(self):
        return b'unlimitedClip' in self.tags
...
@ReprInjector.simple((
 b'_actualTime', b'actual'), (b'_baseTime', b'base'), (
 b'getTimePassed', b'timePassed'), (b'getTimeLeft', b'timeLeft'), (b'isReloading', b'reloading'), (
 b'isReloadingFinished', b'reloadingFinished'), (b'_isReloadingBlocked', b'reloadingBlocked'))
class ReloadingTimeSnapshot(IGunReloadingSnapshot):
    __slots__ = (b'_actualTime', b'_baseTime', b'_startTime', b'_updateTime', b'_waitReloadingStartResponse', b'_isReloadingBlocked')
...
class _AutoReloadingBoostStateCtrl(object):
    __slots__ = (b'__changeEventDispatcher', b'__state', b'__stateDuration', b'__stateTotalTime', b'__nextStateCallbackID', b'__snapshot', b'__prevSnapshot', b'__gunSettings', b'__serverClipTime')
    ...
    def setGunReloadTime(self, timeLeft, baseTime, skipAutoLoader=False, ammoStates=None, clipTime=None):
        ...
        if self.__gunSettings.isTwinGun and self.__currShellCD == self.__nextShellCD:
            ...
            if ammoState is None or ammoState.stationaryReloadState == STATIONARY_RELOAD_STATE.IDLE:
                ...
                _logger.info(b'Stationary reloading: recalculating time for transition state')
