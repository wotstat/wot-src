...
def _poiItemFactory(descriptor, quantity, stage, timeRemaining, totalTime, tag=None):
    if descriptor.name.startswith(b'poi_artillery_aoe') or descriptor.name.startswith(b'poi_illumination_flare'):
...
_EQUIPMENT_TAG_TO_ITEM = {(b'fuel',): _AutoItem, 
   ...
   (b'CGFAbility',): CGFAbilityItem, 
   (b'CGFAbility', b'passive'): CGFPassiveAbilityItem, 
...
_REPLAY_EQUIPMENT_TAG_TO_ITEM = {(b'fuel',): _ReplayItem, 
   ...
   (b'CGFAbility',): CGFReplayAbilityItem, 
   (b'CGFAbility', b'passive'): CGFReplayPassiveAbilityItem, 
