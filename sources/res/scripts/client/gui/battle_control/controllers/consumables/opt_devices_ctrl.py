...
__all__ = (b'OptionalDevicesController',)

class OptionalDevicesController(IBattleController):
    __slots__ = (b'__eManager', b'__optionalDevices', b'__order', b'__soundManager', b'__sessionProvider', b'__optionalDevicesInDescriptor', b'onOptionalDeviceAdded', b'onOptionalDeviceUpdated', b'onOptionalDevicesCleared', b'onDescriptorDevicesChanged')
    ...
    def __repr__(self):
        return (b'OptionalDevicesController({0!r:s})').format(self.__optionalDevices)
