...
@ReprInjector.withParent((b'getPlayerIDs', b'ids'), (b'getComment', b'comment'))
class SendInvitesCtx(RequestCtx):

    def __init__(self, playerIDs, comment=b'', waitingID=b''):
    ...
    def __repr__(self):
        return (b'SendInvitesCtx(playerIDs = {0!r:s}, comment = {1:>s})').format(self.__playerIDs, self.__comment)
