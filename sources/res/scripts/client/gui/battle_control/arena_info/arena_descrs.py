...
class BootcampBattleDescription(ArenaWithLabelDescription):
    ...
    def getWinString(self, isInBattle=True):
        lessonId = self._visitor.getArenaExtraData().get(b'lessonId', 0)
        return i18n.makeString((b'#arenas:type/{}/description{}').format(functions.getArenaSubTypeName(self._visitor.type.getID()), lessonId))
