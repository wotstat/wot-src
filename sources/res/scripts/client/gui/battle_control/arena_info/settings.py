...
__all__ = (b'UNKNOWN_VEHICLE_NAME', b'UNKNOWN_VEHICLE_CLASS_NAME', b'UNKNOWN_PLAYER_NAME', b'UNKNOWN_VEHICLE_LEVEL', b'UNKNOWN_VEHICLE_CLASS_ORDER', b'SQUAD_RANGE_TO_SHOW', b'VEHICLE_STATUS', b'PLAYER_STATUS', b'INVALIDATE_OP', b'getOrderByVehicleClass')
CONTOUR_ICON_SF_PATH = b'../maps/icons/vehicle/contour/{0}.png'
CONTOUR_ICON_RES_PATH = b'gui/maps/icons/vehicle/contour/{0}.png'
SMALL_MAP_IMAGE_SF_PATH = b'../maps/icons/map/battleLoading/%s.png'
SCREEN_MAP_IMAGE_RES_PATH = b'gui/maps/icons/map/screen/%s.dds'
RESPAWN_MAP_IMAGE_RES_PATH = b'gui/maps/icons/map/respawn/%s.dds'
DEFAULT_SCREEN_MAP_IMAGE_RES_PATH = b'gui/maps/icons/map/screen/default_screen.dds'
UNKNOWN_CONTOUR_ICON_NAME = b'unknown'
...
UNKNOWN_VEHICLE_CLASS_NAME = b'unknown'
