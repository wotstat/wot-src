...
class DefaultTeamOverrides(object):
    __slots__ = (b'team', b'personal', b'isReplayPlaying')
...
class PersonalInfo(object):
    __slots__ = (b'realName', b'vehicleID', b'selectedID', b'prebattleID', b'teamKillSuspected')
