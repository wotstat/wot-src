...
class BattleRoyaleFinancialBlock(base.StatsBlock):
    __slots__ = (b'credits', b'xp', b'crystal', b'brcoin')
...
class BattleRoyaleFinancialPremBlock(BattleRoyaleFinancialBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        self.credits += avatarInfo.get(b'eventCredits', 0)
...
class BattlePassBlock(base.StatsBlock):
    __slots__ = (b'currentLevel', b'maxPoints', b'earnedPoints', b'currentLevelPoints', b'isDone', b'hasBattlePass', b'battlePassComplete', b'chapterID', b'pointsTotal', b'bpTopPoints', b'pointsAux', b'availablePoints')
...
class BattleRoyalePlayerBlock(base.StatsBlock):
    __slots__ = (b'isPersonal', b'userName', b'clanAbbrev', b'place', b'isPersonalSquad', b'squadIdx', b'hiddenName', b'achievedLevel', b'kills', b'damage', b'vehicleName', b'vehicleType', b'databaseID')
