...
class BattleResultBlock(base.StatsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        self.addNextComponent(base.DirectStatsItem(b'win', teamResult == PLAYER_TEAM_RESULT.WIN))
        self.addNextComponent(base.DirectStatsItem(b'value', teamResult))
        self.addNextComponent(base.DirectStatsItem(b'str', teamResultStr))
        return
