...
class DynamicPremiumState(base.StatsItem):
    __slots__ = (b'__arenaUniqueID', b'__postBattlePremiumPlus', b'__xpDiff', b'__creditsDiff', b'__hasXpBonusInBonusCaps', b'__hasXpInBonusCaps')
        ...
        if not self.__itemsCache.items.stats.isActivePremium(PREMIUM_TYPE.PLUS):
            if self.__itemsCache.items.stats.isActivePremium(PREMIUM_TYPE.BASIC):
                ...
                if isWotPlusBonusEnabledInConfig():
                    iconName = (b'plus_bonus_x{}').format(multiplier) if self.__adsCase == b'bonus' else self.__adsCase
...
class DamageDetailsBlock(_DetailsBlock):
    __slots__ = (b'piercings', b'damageDealtValues', b'damageDealtNames')
...
class ArmorUsingDetailsBlock(_DetailsBlock):
    __slots__ = (b'usedArmorCount', b'armorValues', b'armorNames')
...
class AssistDetailsBlock(_DetailsBlock):
    __slots__ = (b'damageAssisted', b'damageAssistedValues', b'damageAssistedNames')
...
class StunDetailsBlock(_DetailsBlock):
    __slots__ = (b'stunNum', b'stunValues', b'stunNames', b'stunDuration')
...
class CritsDetailsBlock(_DetailsBlock):
    __slots__ = (b'critsCount', b'criticalDevices', b'destroyedDevices', b'destroyedTankmen')
...
class EnemyDetailsBlock(_DetailsBlock):
    __slots__ = (b'vehicleIcon', b'vehicleName', b'vehicleIntCD', b'vehicleID', b'deathReason', b'spotted', b'piercings', b'damageDealt', b'killCount')
