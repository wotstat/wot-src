...
TankmanProgress = namedtuple(b'TankmanProgress', (b'tman', b'newSkillEarned', b'bonusSkillsAmount', b'avgBattles2NewSkill', b'skin'))
VehicleProgress = namedtuple(b'VehicleProgress', (b'item', b'unlockProps', b'avgBattles2Unlock'))
ModuleProgress = namedtuple(b'ModuleProgress', (b'item', b'unlockProps'))

class VehicleProgressHelper(object):
    __slots__ = (b'__unlocks', b'__vehTypeCompDescr', b'__vehicle', b'__vehicleXp', b'__avgVehicleXp')
