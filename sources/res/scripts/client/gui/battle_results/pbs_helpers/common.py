...
_AchievementData = namedtuple(b'_AchievementData', (b'name', b'isEpic', b'iconName', b'groupID', b'tooltipType', b'tooltipArgs'))
...
def getPersonalAchievements(battleResults):
    ...
    left, right = reusable.personal.getAchievements(results[b'personal'])
