...
AOGAS_FACTOR = CurrencyRecord(recordNames=(b'aogasFactor10',), subtractRecords=(), baseAccountValueExtractor=getDecreasingBaseAccountFactor, premiumAccountValueExtractor=getDecreasingPremiumAccountFactor, detailsValuesExtractors=(
