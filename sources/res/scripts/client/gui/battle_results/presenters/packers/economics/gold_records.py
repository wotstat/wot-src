...
INTERMEDIATE_TOTAL_GOLD = CurrencyRecord(recordNames=(b'gold',), subtractRecords=(), baseAccountValueExtractor=getIntermediateTotalGoldValue, premiumAccountValueExtractor=getIntermediateTotalGoldValue, detailsValuesExtractors=(), capsToBeChecked=None, paramName=CurrencyRecordsItemModel.INTERMEDIATE_TOTAL_GOLD, label=_STR_PATH.intermediateTotal, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.GOLD)
TOTAL_GOLD = CurrencyRecord(recordNames=(b'gold',), subtractRecords=(b'autoLoadGold', b'autoEquipGold'), baseAccountValueExtractor=getTotalGoldValue, premiumAccountValueExtractor=getTotalGoldValue, detailsValuesExtractors=(), capsToBeChecked=None, paramName=CurrencyRecordsItemModel.TOTAL_GOLD, label=_STR_PATH.title.total, modifiers=(), showZeroValue=True, currencyType=CurrenciesConstants.GOLD)
