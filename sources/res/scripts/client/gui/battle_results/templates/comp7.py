...
COMP7_PERSONAL_STATS_BLOCK.addComponent(STATS_COMPONENT_NUMBER, comp7.PersonalVehiclesComp7StatsBlock(base.ListMeta(), b'statValues', _RECORD.PERSONAL))
COMP7_PERSONAL_STATS_BLOCK.addNextComponent(comp7.PrestigePointsBlock(_PRESTIGE_POINTS_VO_META, b'prestigePoints', _RECORD.PERSONAL))
COMP7_PERSONAL_STATS_BLOCK.addNextComponent(comp7.IsDeserterFlag(b'deserterStr', _RECORD.PERSONAL))
TOURNAMENT_COMP7_PERSONAL_STATS_BLOCK = REGULAR_PERSONAL_STATS_BLOCK.clone(*COMPONENTS_TO_EXCLUDE)
TOURNAMENT_COMP7_PERSONAL_STATS_BLOCK.addComponent(STATS_COMPONENT_NUMBER, comp7.PersonalVehiclesComp7StatsBlock(base.ListMeta(), b'statValues', _RECORD.PERSONAL))
TOURNAMENT_COMP7_PERSONAL_STATS_BLOCK.addNextComponent(comp7.IsDeserterFlag(b'deserterStr', _RECORD.PERSONAL))
...
COMP7_COMMON_STATS_BLOCK.addNextComponent(comp7.Comp7RankBlock(_RANK_COMMON_VO_META, b'comp7Rating', _RECORD.PERSONAL))
COMP7_BATTLE_PASS_PROGRESS_STATS_BLOCK = progress.Comp7BattlePassProgressBlock(base.ListMeta(), b'battlePass', _RECORD.PERSONAL)
...
COMP7_TEAM_ITEM_VO_META = base.PropertyMeta((
 ...
 (
  b'statValues', comp7.AllComp7VehicleStatValuesBlock(base.ListMeta(), b'statValues'), b'statValues'),
...
COMP7_TEAMS_STATS_BLOCK.addNextComponent(comp7.Comp7TeamStatsBlock(meta=base.ListMeta(), field=b'team1'))
COMP7_TEAMS_STATS_BLOCK.addNextComponent(comp7.Comp7TeamStatsBlock(meta=base.ListMeta(), field=b'team2'))
EFFICIENCY_TITLE_WITH_SKILLS_VO = comp7.EfficiencyTitleWithSkills(b'efficiencyTitle')
