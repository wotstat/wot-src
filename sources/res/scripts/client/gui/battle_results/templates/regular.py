...
_REGULAR_TABS_VO_META = base.ListMeta([
 {b'label': (i18n.makeString(MENU.FINALSTATISTIC_TABS_COMMONSTATS)), 
...
_MULTI_TEAM_TABS_VO_META = base.ListMeta([
 {b'label': (MENU.FINALSTATISTIC_TABS_COMMONSTATS), 
    b'linkage': b'CommonStats', 
    b'viewId': b'CommonStats', 
    b'showWndBg': False},
 {b'label': (MENU.FINALSTATISTIC_TABS_TEAMSTATS), 
    b'linkage': b'MultiteamStatsUI', 
    b'viewId': b'MultiteamStatsUI', 
    b'showWndBg': False},
 {b'label': (MENU.FINALSTATISTIC_TABS_DETAILSSTATS), 
    b'linkage': b'DetailsStatsViewUI', 
    b'viewId': b'DetailsStatsViewUI', 
    b'showWndBg': True}])
REGULAR_TABS_BLOCK = base.StatsBlock(_REGULAR_TABS_VO_META, b'tabInfo')
MULTI_TEAM_TABS_BLOCK = base.StatsBlock(_MULTI_TEAM_TABS_VO_META, b'tabInfo')
...
_COMMON_VO_META = base.DictMeta({b'iconType': b'tank', 
   ...
   b'modificationStr': b'', 
   b'modificationIconPath': b'', 
   b'rank': None, 
   b'epicMode': False, 
   b'showRateSatisfactionCmp': False})
...
REGULAR_COMMON_STATS_BLOCK.addComponent(15, epic.StrBattleModificationItem(b'modificationStr'))
REGULAR_COMMON_STATS_BLOCK.addComponent(16, epic.BattleModificationItem(b'modificationIconPath'))
REGULAR_COMMON_STATS_BLOCK.addComponent(17, common.ShowRateSatisfactionCmp(b'showRateSatisfactionCmp'))
...
_PREMIUM_BONUS_VO_META = base.PropertyMeta((
 ...
 (b'wotPlusBonusLeft', b'', b'wotPlusBonusLeft'),
 (b'detailsLink', b'', b'detailsLink'),
 (b'additionalBonusLeft', b'', b'additionalBonusLeft'),
 ...
 (b'premiumAndPlusExhausted', b'', b'premiumAndPlusExhausted'),
 (b'hasWotPremium', b'', b'hasWotPremium'),
 (b'hasWotPlus', b'', b'hasWotPlus')))
...
PRESTIGE_PROGRESS_VO = progress.PrestigeProgressVO(b'prestige')
COMMENDATIONS_RECEIVED_VO = personal.CommendationsReceived(b'receivedCommendations')
