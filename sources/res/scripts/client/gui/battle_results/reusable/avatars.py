...
class AvatarInfo(shared.ItemInfo):
    __slots__ = (b'__totalDamaged', b'__avatarKills', b'__avatarDamaged', b'__avatarDamageDealt', b'__badge', b'__suffixBadge', b'__fairplayViolations', b'__accRank', b'__prevAccRank', b'__extInfo', b'__badgesInfo', b'__weakref__')
...
class AvatarsInfo(shared.UnpackedInfo):
    __slots__ = (b'__bonusType', b'__avatars')
