...
class EPIC_SOUND(object):
    HANGAR = b'frontline_hangar'
    GAMEMODE_GROUP = b'STATE_gamemode'
    GAMEMODE_STATE = b'STATE_gamemode_frontline'
    GAMEMODE_DEFAULT = b'STATE_gamemode_default'
    PROGRESS_PAGE_ENTER = b'eb_ambient_progress_page_enter'
    PROGRESS_PAGE_EXIT = b'eb_ambient_progress_page_exit'
    GUI_REWARD_SCREEN = b'gui_reward_screen_general'
    GUI_MAIN_AWARD = b'gui_hangar_reward_main_icon'
