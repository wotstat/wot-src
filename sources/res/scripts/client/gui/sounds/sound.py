...
class SoundSequence(object):
    ...
    def __clear(self):
        ...
        if self.__curPlayingSnd is not None:
            self.__curPlayingSnd.sound.setCallback(b'EVENTFINISHED', None)
    ...
    def __playNextSound(self):
        ...
        try:
            ...
            self.__curPlayingSnd.sound.setCallback(b'EVENTFINISHED', self.__finishCallback)
    ...
    def __finishCallback(self, snd):
        if snd is not None:
            snd.setCallback(b'EVENTFINISHED', None)
            snd.stop()
            snd = None
