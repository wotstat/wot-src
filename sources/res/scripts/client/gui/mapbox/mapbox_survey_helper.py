...
class Question(IQuestion):
    __slots__ = (b'__surveyGroup', b'__questionId', b'__isMultiple', b'__isRequired', b'__conditions', b'__answers', b'__guiParameters', b'__linkedParameters', b'__dependedQuestions')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__conditions = kwargs.get(b'conditions')
