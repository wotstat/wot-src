...
class PostProgressionStepItem(PurchaseProvider):
    __slots__ = (b'__action', b'__descriptor', b'__isRestricted', b'__price', b'__state')
    ...
    def __repr__(self):
        return (b'PostProgressionStepItem <stepID: {}, state: {}>').format(self.stepID, self.getState().value)
