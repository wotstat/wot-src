...
class PostProgressionAvailability(Enum):
    ...
    NOT_EXISTS = b'not_exits'
    VEH_NOT_ELITE = b' veh_not_elite'
    VEH_NOT_IN_INVENTORY = b'veh_not_in_inventory'
    VEH_IS_RENTED = b'veh_is_rented'
    VEH_IS_RENT_OVER = b'veh_is_rent_over'
    VEH_IN_BATTLE = b'veh_in_battle'
    VEH_IN_FORMATION = b'veh_in_formation'
    VEH_IN_QUEUE = b'veh_in_queue'
    VEH_IN_BREAKER = b'veh_in_breaker'
    VEH_IS_BROKEN = b'veh_is_broken'
...
class AvailabilityCheckResult(namedtuple(b'AvailabilityCheckResult', b'result, reason')):
...
class PostProgressionItem(object):
    ...
    __slots__ = (b'__state', b'__stepsCache', b'__tree', b'__vehType')
    ...
    def __repr__(self):
        return (b'PostProgressionItem <vehCD: {}, treeID: {}>').format(self.__vehType.compactDescr, self.__vehType.postProgressionTree)
