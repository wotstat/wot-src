...
def _readMacros(xmlCtx, section, valueName=b'value', nameFromSection=True):
    result = {}
...
_DEFAULT_SETTINGS = {b'registrationURL': b'', 
   ...
   b'reconFlightDuration': 0, 
   b'sightPointerLampDuration': 0, 
   ...
   b'reportBugLink': b'', 
   b'cache': [], b'imageCache': [], b'postBattleExchange': (PostBattleExchangeProps(False, b'')), 
   ...
   b'tokenShopAPIKey': b'', 
   b'progressiveItems': {}, b'rankedBattles': {}, b'referralProgram': {}, b'easterEgg': (EasterEggProps(True, [])), 
   b'premiumInfo': {}, b'crew': {b'welcomeScreens': {}}, b'checkPromoFrequencyInBattles': 5, 
   b'vivoxLicense': b'', 
   b'spgHitDirectionDelta': 10.0, 
   b'vehicleDisclaimerURLs': {}, b'reportContentURL': b''}
...
class GuiSettings(object):
    ...
    def __init__(self):
        ...
        settings = {}
        for item in resource_helper.root_iterator(GUI_SETTINGS_FILE_PATH, customReaders={b'macros': _readMacros}, nameFromSection=True):
