...
class SelectedViewState(IVehicleViewState):
    __slots__ = (b'_locked', b'_isInHangar', b'_isBroken', b'_isDisabledInRent', b'_isOnlyForEventBattles', b'_isOutfitLocked', b'_isCustomizationEnabled', b'_isEliteShown', b'_isLevelShown', b'_isRoleShown', b'_isMaintenanceVisible', b'_isCustomizationVisible')
