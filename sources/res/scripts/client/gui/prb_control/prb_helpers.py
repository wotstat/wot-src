...
class TrainingEntityViewLifecycleHandler(IViewLifecycleHandler):
    ...
    def __init__(self, entity):
        super(TrainingEntityViewLifecycleHandler, self).__init__([
         ViewKey(VIEW_ALIAS.LOBBY_HANGAR),
    ...
    def onViewCreated(self, _):
        self.__entity.setPlayerState(SetPlayerStateCtx(False, waitingID=b'prebattle/player_not_ready'))
        return
