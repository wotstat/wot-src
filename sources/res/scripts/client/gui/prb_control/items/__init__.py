...
@ReprInjector.simple(b'ctrlTypeID', b'entityTypeID', b'hasModalEntity', b'hasLockedState', b'isIntroMode')
class FunctionalState(object):
    __slots__ = (b'ctrlTypeID', b'entityTypeID', b'hasModalEntity', b'hasLockedState', b'isIntroMode', b'funcState', b'funcFlags', b'rosterType')
...
@ReprInjector.simple(b'isCreator', b'isReady')
class PlayerDecorator(object):
    __slots__ = (b'isCreator', b'isReady')
...
SelectResult = namedtuple(b'SelectResult', (b'isProcessed', b'newEntry'))
SelectResult.__new__.__defaults__ = (
 False, None)
CreationResult = namedtuple(b'SelectResult', (b'creationFlags', b'initFlags'))
CreationResult.__new__.__defaults__ = (
 FUNCTIONAL_FLAG.UNDEFINED, FUNCTIONAL_FLAG.UNDEFINED)
ValidationResult = namedtuple(b'ValidationResult', (b'isValid', b'restriction', b'ctx'))
