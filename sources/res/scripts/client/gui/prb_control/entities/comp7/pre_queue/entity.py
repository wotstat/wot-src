...
class Comp7Entity(PreQueueEntity):
    ...
    def _makeQueueCtxByAction(self, action=None):
        ...
        return Comp7QueueCtx(self._queueType, invID, waitingID=b'prebattle/join')
    ...
    def _doQueue(self, ctx):
        ...
        LOG_DEBUG(b'Sends request on queuing to the Competitive7x7', ctx)
        return

    def _doDequeue(self, ctx):
        BigWorld.player().dequeueComp7()
        LOG_DEBUG(b'Sends request on dequeuing from the Competitive7x7')
        return
