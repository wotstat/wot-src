...
@ReprInjector.simple((b'_roles', b'roles'), (b'_flags', b'flags'), (b'_isCurrentPlayer', b'isCurrentPlayer'), (b'_isPlayerReady', b'isPlayerReady'), (b'_hasLockedState', b'hasLockedState'))
