...
@ReprInjector.withParent((b'__prbID', b'id'), (b'__prbType', b'type'), (b'__prbClusterId', b'prbClusterId'))
class JoinLegacyCtx(LegacyRequestCtx):
    __slots__ = (b'__prbID', b'__prbClusterId')

    def __init__(self, prbID, prbType, prbClusterId, waitingID=b'', flags=_FUNCTIONAL_FLAG.UNDEFINED):
...
class SetPlayerStateCtx(LegacyRequestCtx):
    __slots__ = (b'__isReadyState', b'__isInitial', b'__errorString', b'silently')

    def __init__(self, isReadyState, isInitial=False, waitingID=b'', silently=False):
