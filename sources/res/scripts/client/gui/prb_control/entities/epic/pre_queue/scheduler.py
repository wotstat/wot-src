...
class EpicMetaScheduler(BaseScheduler):
    ...
    def __onEpicSettingsUpdated(self, diff):
        validVehicleLevels = diff.get(b'validVehicleLevels', self.__validVehicleLevels)
        unlockableInBattleVehicleLevels = diff.get(b'unlockableInBattleVehicleLevels', self.__unlockableInBattleVehicleLevels)
