...
class TrainingSettingsCtx(TeamSettingsCtx):
    ...
    def fetch(cls, settings):
        return TrainingSettingsCtx(isOpened=settings[b'isOpened'], comment=settings[b'comment'], isRequestToCreate=False, arenaTypeID=settings[b'arenaTypeID'], roundLen=settings[b'roundLength'])
