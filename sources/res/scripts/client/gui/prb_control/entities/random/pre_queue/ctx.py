...
@ReprInjector.withParent((b'getVehicleInventoryID', b'vInvID'), (b'getGamePlayMask', b'gamePlayMask'), (b'getWaitingID', b'waitingID'), (b'getRandomFlags', b'randomFlags'))
class RandomQueueCtx(QueueCtx):

    def __init__(self, vInventoryID, arenaTypeID=0, gamePlayMask=0, waitingID=b'', randomFlags=0):
