...
class ESportIntroEntity(UnitIntroEntity):
    ...
    def getSelectedVehicles(self, section, useAll=True):
        accSettings = dict(AccountSettings.getSettings(b'unitWindow'))
        ...
        if vehicles or not useAll:
            ...
            for vehCD in vehicles:
                ...
                if items.doesVehicleExist(vehCD):
                    ...
                    LOG_WARNING(b'There is invalid vehicle compact descriptor in the stored unit seelected vehicles data', vehCD)
    ...
    def setSelectedVehicles(self, section, vehicles):
        unitWindowSettings = dict(AccountSettings.getSettings(b'unitWindow'))
        unitWindowSettings[section] = vehicles
        AccountSettings.setSettings(b'unitWindow', unitWindowSettings)
        return
