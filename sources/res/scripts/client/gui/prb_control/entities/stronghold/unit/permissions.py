...
@ReprInjector.simple((b'_clanRoles', b'clanRoles'), (b'_isLegionary', b'isLegionary'), (b'_strongholdManageReservesRoles', b'strongholdManageReservesRoles'), (b'_strongholdStealLeadershipRoles', b'strongholdStealLeadershipRoles'), (b'_isInSlot', b'isInSlot'), (b'_isInIdle', b'isInIdle'), (b'_isEquipmentCommander', b'isEquipmentCommander'), (b'_isFreezed', b'isFreezed'))
...
@ReprInjector.simple((b'_hasLockedState', b'hasLockedState'))
