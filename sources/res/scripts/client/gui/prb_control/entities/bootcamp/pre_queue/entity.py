...
class BootcampEntity(PreQueueEntity):
    ...
    def _doQueue(self, ctx):
        ...
        LOG_DEBUG(b'Sends request to enqueue to the bootcamp battle')
        return

    def _doDequeue(self, ctx):
        self.bootcampController.hideActionWaitWindow()
        self.bootcampController.dequeueBootcamp()
        LOG_DEBUG(b'Sends request on dequeuing from the bootcamp battle')
        return

    def _makeQueueCtxByAction(self, action=None):
        return QueueCtx(entityType=QUEUE_TYPE.BOOTCAMP, waitingID=b'')
    ...
    def onBootcampBecomeNonPlayer(self):
        LOG_DEBUG(b'onBootcampBecomeNonPlayer')
