...
__all__ = (b'SubscriptionDescriptor', b'PrimeGamingDescriptor', b'WotPlusDescriptor', b'WotPlusProDescriptor')
...
class PrimeGamingDescriptor(SubscriptionDescriptor):
    __PRIME_GAMING_FILTER_STR = b'PrimeGaming'
    ...
    def __twitchFilterFunc(self, q):
        return q.getID().startswith(b'twitch')
