...
__all__ = (b'getWGNPRequestControllers',)

def getWGNPRequestControllers(manager):
    wgnpSteamAccController = WGNPSteamAccRequestController()
    wgnpSteamAccController.init()
    manager.addInstance(IWGNPSteamAccRequestController, wgnpSteamAccController, finalizer=b'fini')
    wgnpDemoAccController = WGNPDemoAccRequestController()
    wgnpDemoAccController.init()
    manager.addInstance(IWGNPDemoAccRequestController, wgnpDemoAccController, finalizer=b'fini')
    wgnpGeneralController = WGNPGeneralRequestController()
    wgnpGeneralController.init()
    manager.addInstance(IWGNPGeneralRequestController, wgnpGeneralController, finalizer=b'fini')
    return
