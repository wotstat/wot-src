...
class SeniorityAwardsController(ISeniorityAwardsController):
    ...
    def __onSettingsChanged(self, diff):
        if b'seniority_awards_config' in diff:
            self.__update()
        return
    ...
    def __onClaimRewardFailed(self):
        self.__cancelClaimTimeout()
        self.__hideWaiting()
        SystemMessages.pushI18nMessage(b'#system_messages:seniority_awards/claim_reward_failed', type=SystemMessages.SM_TYPE.Error, priority=b'high')
        return
