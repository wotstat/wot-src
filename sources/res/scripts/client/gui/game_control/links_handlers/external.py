...
_PLATFORM_PARAM = b'platform'
_WOT_PLATFORM_PARAM = b'wot_platform'
_INGAME_SHOP_PARAM = b'ingame_shop'
_PATH_TO_CHECK_ARGS = b'/id/signin/token'
_URL_ARGS_TO_CHECK = (b'next',)
_logger = logging.getLogger(__name__)
CheckHandleResult = typing.NamedTuple(b'CheckHandleResult', ((b'handled', bool), (b'externalAllowed', bool)))
...
class OpenBrowserHandler(ILinksHandler):
    ...
    def handle(self, url):
        try:
            ...
            _logger.error(b'There is error while opening web browser at page: %s', url)
...
class WtGoToLinksHandler(ILinksHandler):
    _PARAM_KEY = b'wot_client_param'
    _GO_TO_EVENT = b'go_to_event'
    _GO_TO_META = b'go_to_event_meta'
