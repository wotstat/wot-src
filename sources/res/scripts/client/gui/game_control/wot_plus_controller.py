...
class WotPlusController(IWotPlusController):
    ...
    def isEnabled(self):
        return self._cache.get(b'isEnabled', False)
    ...
    def getActiveExclusiveVehicle(self):
        ...
        if vehicleInfo:
            return getItemByCompactDescr(vehicleInfo[b'vehTypeCompDescr'])
        else:
            return
    ...
    def __onStateUpdate(self, *_):
        ...
        while self.__callbackHandler:
            try:
                ...
                _logger.exception(b'Exception in subscription controller')
