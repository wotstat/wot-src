...
PARAMS_AFFECTED_TANKMEN_SKILLS = (
 ...
 b'repair',
 b'camouflage',
 b'commander_eagleEye',
 b'commander_universalist',
 b'commander_tutor',
 b'commander_expert',
 b'commander_enemyShotPredictor',
 b'gunner_smoothTurret',
 b'gunner_sniper',
 b'gunner_rancorous',
 b'gunner_gunsmith',
 b'driver_virtuoso',
 b'driver_smoothDriving',
 b'driver_badRoadsKing',
 b'driver_tidyPerson',
 b'driver_rammingMaster',
 b'loader_desperado',
 b'loader_pedant',
 b'loader_intuition',
 b'radioman_finder',
 b'radioman_retransmitter',
 b'radioman_lastEffort',
 b'radioman_inventor',
 b'fireFighting')
...
class _VehCmpCache(FileLocalCache):
    ...
    def __init__(self, databaseID, vehiclesIterator):
        super(_VehCmpCache, self).__init__(b'veh_cmp_cache', (b'basket_state', databaseID), async=True)
...
class _VehCompareData(object):
    ...
    def getInventoryCrewData(self):
        return (
         self.__inventoryCrewLvl, self.__inventoryCrewSkills.copy())
    ...
    def getCrewData(self):
        return (
         self.__crewLvl, self.__crewSkills.copy())
