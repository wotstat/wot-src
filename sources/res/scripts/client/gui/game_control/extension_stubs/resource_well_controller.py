...
_ResourceWellConfig = namedtuple(b'_ResourceWellConfig', (b'isEnabled', b'season', b'finishTime', b'remindTime', b'rewards', b'startTime', b'infoPageUrl'))
_RESOURCE_WELL_CONFIG_STUB = _ResourceWellConfig(isEnabled=False, season=0, finishTime=0, remindTime=0, rewards={}, startTime=0, infoPageUrl=b'')
