...
class RestoreController(IRestoreController, Notifiable):
    ...
    def __updateTankmenList(self):
        ...
        self.__tankmenList = sorted(tankmen, key=operator.attrgetter(b'dismissedAt'), reverse=True)
    ...
    def __checkLimitedRestoreNotification(self):
        ...
        if vehicles and showMessage and not self.__checkForNotify:
            ...
            SystemMessages.pushI18nMessage(b'#system_messages:restoreController/hasLimitedRestoreVehicles', type=SystemMessages.SM_TYPE.Warning)
