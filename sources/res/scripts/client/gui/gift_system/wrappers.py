...
GiftsWebState = namedtuple(b'GiftsWebState', (b'sendLimit', b'expireTime', b'expireDelta', b'executionTime', b'state', b'common'))
GiftsWaitResponse = namedtuple(b'GiftsWaitResponse', b'players, lastPlayerUpdatedAt, firstPlayerUpdatedAt')
IncomeSysMessage = namedtuple(b'IncomeSysMessage', (b'eventID', b'senderID', b'giftItemID', b'meta', b'executionTime'))
SendGiftResponse = namedtuple(b'SendGiftResponse', (b'state', b'receiverIDs', b'outCount', b'entitlementCode', b'declinedReceivers', b'meta', b'executionTime', b'description', b'statusCode'))
