...
_BATTLE_RELEASE_PACKAGES = (b'gui.Scaleform.daapi.view.battle.shared', b'gui.Scaleform.daapi.view.battle.shared.vehicle_mechanics', b'messenger.gui.Scaleform.view.battle', b'gui.impl.battle.random', b'gui.impl.battle.shared')
...
registerScaleformBattlePackages(ARENA_GUI_TYPE.MAPS_TRAINING, (b'messenger.gui.Scaleform.view.battle', b'gui.Scaleform.daapi.view.battle.shared.vehicle_mechanics', b'gui.Scaleform.daapi.view.battle.maps_training', b'gui.impl.battle.random', b'gui.impl.battle.shared') + (_BATTLE_DEBUG_PACKAGES if HAS_DEV_RESOURCES else ()))
