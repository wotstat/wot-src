...
def makeStrongholdsSlotsVOs(unitEntity, unitMgrID=None, maxPlayerCount=MAX_PLAYER_COUNT_ALL):
    ...
    for idx, slot in enumerate(slots):
        ...
        if slot[b'player'] is not None:
            ...
            frozenVehicles = unitEntity.getEventFrozenVehicles(slot[b'player'][b'dbID'], vehLevel=rosterSettings.getMaxLevel())
...
def makeSortieVO(unitEntity, isCommander, unitMgrID=None, canInvite=True, maxPlayerCount=MAX_PLAYER_COUNT_ALL):
    ...
    isEventActive = g_clanCache.strongholdEventProvider.isRunning() and g_clanCache.strongholdEventProvider.getSettings().getSprintType() != b'GM'
