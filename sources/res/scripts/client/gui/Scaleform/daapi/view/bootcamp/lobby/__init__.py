...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.BOOTCAMP_OUTRO_VIDEO, BCOutroVideoPage, b'BCOutroVideo.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.BOOTCAMP_OUTRO_VIDEO, ScopeTemplates.TOP_WINDOW_SCOPE, canClose=False, canDrag=True),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_TOOLTIPS_WINDOW, BCTooltipsWindow, b'BCTooltipsWindow.swf', TOOLTIP_WINDOW_LAYER, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_LOBBY_HIGHLIGHTS, BCHighlights, b'BCHighlights.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.BOOTCAMP_LOBBY_HIGHLIGHTS, ScopeTemplates.DEFAULT_SCOPE, True),
     ComponentSettings(VIEW_ALIAS.BOOTCAMP_VEHICLE_BUY_VIEW, BCVehicleBuyView, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.BOOTCAMP_QUEUE_DIALOG, BCQueueDialog, b'BCQueueWindow.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_QUESTS_VIEW, BCQuestsView, b'missionsDetails.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.BOOTCAMP_QUESTS_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.SUBTITLES_WINDOW, SubtitlesWindow, b'SubtitlesWindow.swf', WindowLayer.OVERLAY, VIEW_ALIAS.SUBTITLES_WINDOW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_INTERLUDE_VIDEO, BCInterludeVideoPage, b'BCOutroVideo.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.BOOTCAMP_INTERLUDE_VIDEO, ScopeTemplates.TOP_WINDOW_SCOPE, canClose=False, canDrag=True))


def getBusinessHandlers():
    return (
     BootcampPackageBusinessHandler(),)
...
class BootcampPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __queueDialogShow(self, _):
        ctx = {b'backgroundImage': b'../maps/login/back_25_without_sparks.png', b'lessonNumber': (g_bootcamp.getLessonNum()), b'timeout': (g_bootcamp.getContextIntParameter(b'lessonQueueTimeout', 15))}
