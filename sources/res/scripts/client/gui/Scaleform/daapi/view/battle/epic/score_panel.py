...
class EpicScorePanel(EpicScorePanelMeta):
    ...
    def _populate(self):
        ...
        destructEntityComp = getattr(componentSystem, b'destructibleEntityComponent', None)
    ...
    def __onDestructibleEntityAdded(self, entity):
        destructEntityComp = getattr(self.sessionProvider.arenaVisitor.getComponentSystem(), b'destructibleEntityComponent', None)
        if destructEntityComp is not None:
