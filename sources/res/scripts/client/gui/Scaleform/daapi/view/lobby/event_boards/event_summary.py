...
_PARAMETER_VALUE_GETTER = {(_op.ORIGINALXP): b'getExp', 
   (_op.XP): b'getExp', 
   (_op.DAMAGEDEALT): b'getDamage', 
   (_op.DAMAGEASSISTED): b'getAssistedDamage', 
   (_op.WINS): b'getWinRate'}
...
class _Summary(object):
    ...
    def getHeader(self):
        ...
        status = (self._event.isFinished() or formatUpdateTime)(recalculationTS) if 1 else b''
        ...
        return {b'title': title, 
           ...
           b'description2': (self._getDescription2()), 
           b'status': status, 
           b'isTable': (self.isTable()), 
           b'isSquad': (self._event.getIsSquadAllowed()), 
           b'statusTooltip': ((self._event.isFinished() or self._getStatusTooltip)() if 1 else b'')}
    ...
    def getExperienceBlock(self):
        ...
        return {b'experienceValue': (str(opValue)), 
           b'experience': opName, 
           b'position': (_ms(EVENT_BOARDS.SUMMARY_POSITION, position=str(rank))), 
           b'battleValue': (str(battles)), 
           b'battle': (_ms(EVENT_BOARDS.SUMMARY_BATTLES)), 
           b'experienceIcon': battleIcon, 
           b'ribbon': groupPos, 
           b'battleIcon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_BATTLE_POPUP), 
           b'experienceTooltip': experienceTooltip, 
           b'positionTooltip': positionTooltip, 
           b'battleTooltip': battleTooltip}
    ...
    def _getDescription(self):
        ...
        if eventType == _et.VEHICLE:
            ...
            value = formatVehicleNameWithTypeIcon(vehicle, b'html_templates:lobby/elen/summary')
...
class _SummaryMax(_Summary):
    ...
    def _getStatisticsBlock(self):
        ...
        return {b'statistic1Value': statistic1Value, 
           b'statistic1': statistic1, 
           b'statistic1Icon': statistic1Icon, 
           b'statistic1Tooltip': (makeTooltip(TOOLTIPS.elen_summary_param_all_all_header(method, param1), TOOLTIPS.elen_summary_param_all_all_body(method, param1))), 
           b'statistic2Value': statistic2Value, 
           b'statistic2': statistic2, 
           b'statistic2Icon': statistic2Icon, 
           b'statistic2Tooltip': (makeTooltip(TOOLTIPS.elen_summary_param_all_all_header(method, param2), TOOLTIPS.elen_summary_param_all_all_body(method, param2))), 
           b'statistic3Value': (str(info.getBlockedDamage())), 
           b'statistic3': (EVENT_BOARDS.SUMMARY_DAMAGEBLOCKED), 
           b'statistic3Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_BLOCKED_DMG_POPUP), 
           b'statistic3Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_ADDPARAM_DAMAGEBLOCKED_HEADER, TOOLTIPS.ELEN_SUMMARY_ADDPARAM_DAMAGEBLOCKED_BODY)), 
           b'statistic4Value': (str(info.getFrags())), 
           b'statistic4': (_ms(EVENT_BOARDS.SUMMARY_DESTROYEDVEHICLES)), 
           b'statistic4Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_VEHICLE_POPUP), 
           b'statistic4Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_ADDPARAM_FRAGS_HEADER, TOOLTIPS.ELEN_SUMMARY_ADDPARAM_FRAGS_BODY))}
...
class _SummarySumAll(_Summary):
    ...
    def _getStatisticsBlock(self):
        info = self._excelItem.getInfo()
        return {b'statistic1Value': (str(info.getExp())), 
           b'statistic1': (_ms(EVENT_BOARDS.SUMMARY_AVERAGEXP)), 
           b'statistic1Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_EXP_POPUP), 
           b'statistic1Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_XP_HEADER, TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_XP_BODY)), 
           b'statistic2Value': (str(info.getWinRate())), 
           b'statistic2': (_ms(EVENT_BOARDS.SUMMARY_WINRATE)), 
           b'statistic2Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_WIN_POPUP), 
           b'statistic2Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_ADDPARAM_WINRATE_HEADER, TOOLTIPS.ELEN_SUMMARY_ADDPARAM_WINRATE_BODY)), 
           b'statistic3Value': (str(info.getAvgDamageDealt())), 
           b'statistic3': (_ms(EVENT_BOARDS.SUMMARY_AVERAGEDAMAGE)), 
           b'statistic3Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_DAMAGE_POPUP), 
           b'statistic3Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_DAMAGEDEALT_HEADER, TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_DAMAGEDEALT_BODY)), 
           b'statistic4Value': (str(info.getAvgAssistedDamage())), 
           b'statistic4': (_ms(EVENT_BOARDS.SUMMARY_AVERAGEDAMAGEASSISTED)), 
           b'statistic4Icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_POPUPICONS_ASSIST_POPUP), 
           b'statistic4Tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_DAMAGEASSISTED_HEADER, TOOLTIPS.ELEN_SUMMARY_PARAM_SUMALL_DAMAGEASSISTED_BODY))}
...
class _SummaryTable(_Summary):
    ...
    def _getTableHeaderData(self):
        result = [
         {b'tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_PLATOON_HEADER, TOOLTIPS.ELEN_SUMMARY_TABLE_PLATOON_BODY)), 
            b'icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_TABLEICONS_PLATOON)}]
        params = self.__getSortedParams()
        for p in params:
            result.append({b'tooltip': (makeTooltip(TOOLTIPS.elen_summary_table_all_header(p), TOOLTIPS.elen_summary_table_all_body(p))), 
               b'icon': (self._TableIconByParameter[p])})

        result.append({b'tooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_FRAGS_HEADER, TOOLTIPS.ELEN_SUMMARY_TABLE_FRAGS_BODY)), 
           b'icon': (RES_ICONS.MAPS_ICONS_EVENTBOARDS_TABLEICONS_VEHICLE)})
        return {b'dateTooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_DATE_HEADER)), 
           b'technicsTooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_VEHICLES_HEADER)), 
           b'resultTooltip': (makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_RESULT_HEADER)), 
           b'columns': result}
    ...
    def _getTableData(self):
        ...
        for info in infos:
            ...
            technics = formatVehicleNationAndTypeIcon(vehicle, b'html_templates:lobby/elen/summary')
            player = {b'icon': icon, 
               b'date': date, 
               b'technics': technics, 
               b'vehicle': (vehicle.iconSmall), 
               b'technicsName': technicsName, 
               b'result': result, 
               b'value1': (str(_getParameterValue(params[0], info))), 
               b'value2': (str(_getParameterValue(params[1], info))), 
               b'value3': (str(_getParameterValue(params[2], info))), 
               b'value4': (str(info.getFrags())), 
               b'rendererLinkage': (EVENTBOARDS_ALIASES.BASE_PLAYER_BATTLE_RENDERER), 
               b'isEnable': isEnable, 
               b'iconAlpha': iconAlpha}
            data.append(player)

        return {b'tableDP': data}
