...
class Comp7VoipHelper(object):
    ...
    def populate(self):
        ...
        component.as_setVoiceChatDataS({b'activeText': (self.__makeHtmlString(backport.text(R.strings.comp7.voiceChat.active()))), 
           b'inactiveText': (self.__makeHtmlString(backport.text(R.strings.comp7.voiceChat.inactive())))})
        self.__update()
        self.__subscribe()
        return
