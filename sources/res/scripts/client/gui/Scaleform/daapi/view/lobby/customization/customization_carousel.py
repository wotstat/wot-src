...
CustomizationBookmarkVO = namedtuple(b'CustomizationBookmarkVO', (b'bookmarkName', b'bookmarkIndex'))
CustomizationArrowVO = namedtuple(b'CustomizationArrowVO', (b'index', b'enabled'))
        ...
        for encodedGuiType in guiItemTypes:
            ...
            for i in customizationCache[custType]:
                ...
                if isItemCachedForDecals and decalGuiItems:
                    continue
                compactDescr = vehicles.makeIntCompactDescrByID(b'customizationItem', custType, i)
...
class CustomizationCarouselDataProvider(SortableDAAPIDataProvider):
    ...
    def getFilterData(self):
        ...
        return {b'purchasedEnabled': (self.isFilterApplied(FilterTypes.INVENTORY)), 
           b'historicEnabled': (self.isFilterApplied(FilterTypes.HISTORIC, FilterAliases.HISTORIC)), 
           b'nonHistoricEnabled': (self.isFilterApplied(FilterTypes.HISTORIC, FilterAliases.NON_HISTORIC)), 
           b'fantasticalEnabled': (self.isFilterApplied(FilterTypes.HISTORIC, FilterAliases.FANTASTICAL)), 
           b'appliedEnabled': (self.isFilterApplied(FilterTypes.APPLIED)), 
           b'groups': groups, 
           b'selectedGroup': selectedGroup, 
           b'groupCount': groupCount, 
           b'formfactorGroups': formfactors, 
           b'hideOnAnotherVehEnabled': (self.isFilterApplied(FilterTypes.USED_UP)), 
           b'showOnlyProgressionDecalsEnabled': (self.isFilterApplied(FilterTypes.PROGRESSION)), 
           b'showOnlyEditableStylesEnabled': (self.isFilterApplied(FilterTypes.EDITABLE_STYLES, FilterAliases.EDITABLE_STYLES)), 
           b'showOnlyNonEditableStylesEnabled': (self.isFilterApplied(FilterTypes.EDITABLE_STYLES, FilterAliases.NON_EDITABLE_STYLES)), 
           b'raritiesGroup': raritiesGroup}
