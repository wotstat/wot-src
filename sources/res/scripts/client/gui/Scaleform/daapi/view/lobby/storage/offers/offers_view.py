...
class StorageCategoryOffersView(StorageCategoryOffersViewMeta):
    ...
    def _getVO(self, offer):
        ...
        vo = createStorageDefVO(offer.id, title, description, 0, None, self._offersProvider.getCdnResourcePath(offer.cdnLogoPath, relative=False), b'altimage', contextMenuId=None, actionButtonLabel=actionButtonLabel)
        return vo
