...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(CLANS_ALIASES.CLAN_PROFILE_MAIN_WINDOW_PY, ClanProfileMainWindow, CLANS_ALIASES.CLAN_PROFILE_MAIN_WINDOW_UI, WindowLayer.WINDOW, b'', CLANS_ALIASES.CLAN_PROFILE_MAIN_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True),
     GroupedViewSettings(CLANS_ALIASES.CLAN_PROFILE_INVITES_WINDOW_PY, ClanInvitesWindow, b'clanInvitesWindow.swf', WindowLayer.WINDOW, CLANS_ALIASES.CLAN_PROFILE_INVITES_WINDOW_PY, None, ScopeTemplates.LOBBY_SUB_SCOPE),
     GroupedViewSettings(CLANS_ALIASES.CLAN_PROFILE_SEND_INVITES_WINDOW_PY, ClanSendInvitesWindow, b'sendInvitesWindow.swf', WindowLayer.WINDOW, b'', CLANS_ALIASES.CLAN_PROFILE_SEND_INVITES_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE),
     ...
     GroupedViewSettings(CLANS_ALIASES.CLAN_SEARCH_WINDOW_PY, ClanSearchWindow, b'clanSearchWindow.swf', WindowLayer.WINDOW, CLANS_ALIASES.CLAN_SEARCH_WINDOW_PY, None, ScopeTemplates.LOBBY_SUB_SCOPE),
