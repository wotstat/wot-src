...
class CyberSportUnitView(CyberSportUnitMeta):
    ...
    def showSettingsRoster(self, slots):
        ...
        if window is not None:
            ...
            self.fireEvent(events.LoadViewEvent(SFViewLoadParams(CYBER_SPORT_ALIASES.ROSTER_SLOT_SETTINGS_WINDOW_PY), ctx={b'settings': slots, 
               b'section': b'cs_unit_view_settings', 
