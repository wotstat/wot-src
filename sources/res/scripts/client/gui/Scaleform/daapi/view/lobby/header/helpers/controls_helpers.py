...
class DefaultLobbyHeaderHelper(ILobbyHeaderControlsHelper):
    __slots__ = ()
    _IN_SQUAD_TOOLTIP_KEY = b'inSquad'
    _OUT_SQUAD_TOOLTIP_KEY = b'squad'
...
class RankedLobbyHeaderHelper(DefaultLobbyHeaderHelper):
    __slots__ = ()
    _IN_SQUAD_TOOLTIP_KEY = b'rankedSquad'
    _OUT_SQUAD_TOOLTIP_KEY = b'rankedSquad'
...
class MapboxLobbyHeaderHelper(DefaultLobbyHeaderHelper):
    __slots__ = ()
    _IN_SQUAD_TOOLTIP_KEY = b'inMapboxSquad'
    _OUT_SQUAD_TOOLTIP_KEY = b'mapboxSquad'
...
class EventLobbyHeaderHelper(DefaultLobbyHeaderHelper):
    __slots__ = (b'__bonusType', b'__bonusCapsOverrides')
    _OUT_SQUAD_TOOLTIP_KEY = b'eventSquad'
