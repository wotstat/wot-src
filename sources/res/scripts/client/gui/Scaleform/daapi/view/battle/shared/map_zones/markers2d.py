...
class MapZonesPlugin(plugins.MarkerPlugin, MapZonesListener):
    MINIMAP_ENTRY_SYMBOL = b'ScenarioMarkerUI'
    ...
    def __updateProgress(self, zoneMarker):
        ...
        if zoneMarkerID in self.__markers:
            ...
            self._invokeMarker(markerID, b'setProgress', zoneMarker.markerProgress)
        else:
            _logger.error(b'ZoneMarker not found, id: %s', zoneMarkerID)
        return
