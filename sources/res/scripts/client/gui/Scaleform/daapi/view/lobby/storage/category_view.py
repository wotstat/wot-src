...
class BaseCategoryView(BaseStorageCategoryViewMeta):
    ...
    def _formatCountString(self, currentItemsCount, totalItemsCount):
        ...
        return (b'{} / {}').format(style(currentItemsCount), text_styles.main(totalItemsCount))
...
class InventoryCategoryView(BaseCategoryView):
    ...
    def _populate(self):
        ...
        g_clientUpdateManager.addCallbacks({b'inventory': (self._inventoryUpdatesCallback)})
        return
