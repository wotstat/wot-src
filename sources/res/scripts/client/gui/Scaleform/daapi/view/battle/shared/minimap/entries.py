...
class MinimapEntry(object):
    __slots__ = (b'_entryID', b'_isActive', b'_matrix')
...
@ReprInjector.simple((b'_entryID', b'id'), (b'_isActive', b'active'), (b'_isInAoI', b'AoI'), (b'_isEnemy', b'enemy'), (b'_classTag', b'class'))
class VehicleEntry(MinimapEntry):
    __slots__ = (b'_entryID', b'_classTag', b'_location', b'_guiLabel', b'_spottedCount', b'_spottedTime', b'_isInAoI', b'_isEnemy', b'_isAlive')
