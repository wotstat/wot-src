...
def getViewSettings():
    ...
    return (
     ...
     GroupedViewSettings(SESSION_STATS_CONSTANTS.SESSION_STATS_POPOVER, SessionStatsPopover, b'sessionStatsPopover.swf', WindowLayer.WINDOW, b'SessionStatsPopover', SESSION_STATS_CONSTANTS.SESSION_STATS_POPOVER, ScopeTemplates.WINDOW_VIEWED_MULTISCOPE))
