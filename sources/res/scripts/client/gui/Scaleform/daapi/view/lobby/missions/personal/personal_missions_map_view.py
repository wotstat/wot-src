...
class PersonalMissionsMapView(PersonalMissionsMapViewMeta, PersonalMissionsNavigation):
    ...
    def refresh(self):
        ...
        quests = sorted(viewvalues(self.getChain()), key=operator.methodcaller(b'getID'))
        questClassifier = b''
        enabled = False
    ...
    def __getFinalQuestAwardsVO(self, quest):
        ...
        elif chainID == ALLIANCE_CHAIN_ID and operationID in (OPERATION_ID_CHIMERA, OPERATION_ID_OBJECT_279):
