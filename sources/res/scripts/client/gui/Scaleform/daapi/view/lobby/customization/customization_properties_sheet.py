...
CustomizationCamoSwatchVO = namedtuple(b'CustomizationCamoSwatchVO', b'paletteIcon selected')
_MAX_PALETTES = 3
_MIN_PROGRESSION_LEVEL = 1
_PALETTE_TEXTURE = b'gui/maps/vehicles/camouflages/camo_palette_{colornum}.dds'
_DEFAULT_COLORNUM = 1
_PALETTE_BACKGROUND = b'gui/maps/vehicles/camouflages/camo_palettes_back.dds'
_PALETTE_WIDTH = 42
_PALETTE_HEIGHT = 42
...
_APPLY_TO_OTHER_SEASONS_DIALOG = b'customization/applyProjectionDecalToOtherSeasons'
...
class CustomizationPropertiesSheet(CustomizationPropertiesSheetMeta):
    ...
    def __showApplyToOtherSeasonsDialog(self, lockedSeasons):
        ...
        season = _ms(_SEASONS_REMOVE_TEXT.get(seasonMask, b'')).decode(b'utf-8').upper()
        removed = backport.text(R.strings.vehicle_customization.propertySheet.notify.decal.seasons.removed())
        removed = removed.decode(b'utf-8').upper()
        ...
        builder.setMessageArgs(fmtArgs=[
         FmtArgs(season, b'season', R.styles.AlertTextStyle()),
         FmtArgs(removed, b'removed', R.styles.AlertTextStyle()),
         FmtArgs(this, b'this')])
    ...
    def __makeVO(self):
        ...
        vo = {b'renderersData': ((isEditMode or self.__makeRenderersVOs)() if 1 else []), 
           b'isBigRadius': (self._attachedAnchor.slotType in (GUI_ITEM_TYPE.INSCRIPTION,
                          GUI_ITEM_TYPE.PROJECTION_DECAL,
                          GUI_ITEM_TYPE.EMBLEM)), 
           b'showSwitchers': (self._showSwitchers and not isEditMode), 
           b'isNarrowSlot': (self._isNarrowSlot)}
        return vo

    def __makeSlotVO(self):
        vo = None
        if not self._currentItem:
            vo = {b'imgIconSrc': (RES_ICONS.MAPS_ICONS_LIBRARY_TANKITEM_BUY_TANK_POPOVER_SMALL)}
        return vo
    ...
    def __makeSetOnOtherTankPartsRendererVO(self):
        ...
        return {b'iconSrc': icon, 
           b'iconHoverSrc': hoverIcon, 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_FULL_TANK_DISABLE), 
           b'actionBtnLabel': actionBtnLabel, 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_APPLY_TO_ALL_PARTS), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'animatedTransition': True, 
           b'disableTooltip': disableTooltip, 
           b'enabled': enabled}
    ...
    def __makeMirrorRendererVO(self):
        if self._attachedAnchor.slotType not in (GUI_ITEM_TYPE.PROJECTION_DECAL,):
            return {b'iconSrc': b'', 
               ...
               b'enabled': False}
        horizontalMirror = [
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_MIRROR_02_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_MIRROR_02_HOVER)},
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_MIRROR_01_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_MIRROR_01_HOVER)}]
        verticalMirror = [
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_UP_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_UP_HOVER)},
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_DOWN_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_DOWN_HOVER)}]
        comboMirror = [
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_LEFT_UP_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_LEFT_UP_HOVER)},
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_RIGHT_UP_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_RIGHT_UP_HOVER)},
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_LEFT_DOWN_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_LEFT_DOWN_HOVER)},
         {b'icon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_RIGHT_DOWN_NORMAL), 
            b'hoverIcon': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MIRROR_RIGHT_DOWN_HOVER)}]
        ...
        icon = mirrorStates[currentMirrorState][b'icon']
        hoverIcon = mirrorStates[currentMirrorState][b'hoverIcon']
        ...
        return {b'iconSrc': icon, 
           b'iconHoverSrc': hoverIcon, 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_MIRROR_01_DISABLED), 
           b'actionBtnLabel': actionBtnLabel, 
           b'actionType': actionType, 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_PROPERTYSHEET_DISABLED_MIRROR), 
           b'enabled': enabled}
    ...
    def __makeGetBackRendererVO(self):
        ...
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MOVE_NORMAL), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_MOVE_HOVER), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_MOVE_DISABLED), 
           b'actionBtnLabel': actionBtnLabel, 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_GET_BACK), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'enabled': enabled, 
           b'disableTooltip': disableTooltip}
    ...
    def __makeRemoveRendererVO(self):
        ...
        if isEditableStyle and item.itemTypeID in EDITABLE_STYLE_IRREMOVABLE_TYPES:
            ...
            enabled = True
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_REMOVE_DEL), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_REMOVE_DEL_HOVER), 
           b'iconDisableSrc': disableIcon, 
           b'actionBtnLabel': actionBtnLabel, 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_REMOVE_ONE), 
           b'animatedTransition': True, 
           b'disableTooltip': disableTooltip, 
           b'enabled': enabled}
    ...
    def __makeCloseRendererVO(self):
        ...
        return {b'iconSrc': iconSrc, 
           b'iconHoverSrc': hoverIcon, 
           b'actionBtnLabel': actionBtnLabel, 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_CLOSE), 
           b'enabled': True}
    ...
    def __makeStyleInfoRendererVO(self):
        ...
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_INFO), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_INFO_HOVER), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_INFO_DISABLE), 
           b'actionBtnLabel': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_POPOVER_STYLE_INFO), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_INFO), 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_PROPERTYSHEET_DISABLED_STYLEINFO), 
           b'enabled': enabled}
    ...
    def __makeRentSelectorRendererVO(self):
        ...
        return {b'iconSrc': icon, 
           b'iconHoverSrc': hoverIcon, 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_RENTAL_DISABLE), 
           b'actionBtnLabel': label, 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_RENT_CHECKBOX_CHANGE), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'animatedTransition': True, 
           b'enabled': True}
    ...
    def __makeEditStyleRendererVO(self):
        ...
        return {b'iconSrc': (backport.image(R.images.gui.maps.icons.customization.property_sheet.idle.edit_style())), b'iconHoverSrc': (backport.image(R.images.gui.maps.icons.customization.property_sheet.idle.edit_style_hover())), 
           b'iconDisableSrc': (backport.image(R.images.gui.maps.icons.customization.property_sheet.disable.edit_style_disable())), 
           b'actionBtnLabel': (backport.text(R.strings.vehicle_customization.propertySheet.actionBtn.edit.style())), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_EDIT_STYLE), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'animatedTransition': True, 
           b'disableTooltip': disableTooltip, 
           b'enabled': (bool(editingReason))}
    ...
    def __makeCamoColorRendererVO(self):
        ...
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_PALETTE), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_PALETTE_HOVER), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_PALETTE_DISABLE), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_COLOR_CHANGE), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_SCALE_COLOR_RENDERER_UI), 
           b'btnsBlockVO': btnsBlockVO, 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_PROPERTYSHEET_DISABLED_COLOR), 
           b'enabled': (len(btnsBlockVO) == _MAX_PALETTES)}
    ...
    def __makeScaleRendererVO(self):
        ...
        for idx, scaleSizeLabel in enumerate(SCALE_SIZE):
            btnsBlockVO.append({b'paletteIcon': b'', 
               b'label': scaleSizeLabel, 
               b'selected': (selected == idx), 
               b'value': idx})

        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_SCALE), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_SCALE_HOVER), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_SCALE_DISABLE), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_SCALE_CHANGE), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_SCALE_COLOR_RENDERER_UI), 
           b'btnsBlockVO': btnsBlockVO, 
           b'enabled': True}
    ...
    def __makeSetOnOtherSeasonsRendererVO(self):
        ...
        return {b'iconSrc': (backport.image(icon)), b'iconHoverSrc': (backport.image(hoverIcon)), 
           b'iconDisableSrc': (backport.image(iconDisable)), 
           b'actionBtnLabel': actionBtnLabel, 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_APPLY_TO_ALL_SEASONS), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'animatedTransition': True, 
           b'disableTooltip': disableTooltip, 
           b'notifyText': notifyString, 
           b'needNotify': needNotify, 
           b'enabled': enabled}
    ...
    def __makeProjectionDecalInstallToOtherSeasonsNotifyString(self, lockedSeasons):
        ...
        notifyString = makeHtmlString(b'html_templates:lobby/customization/notify', b'decal', {b'value': (_ms(tooltipText, season=seasonsText, removed=removedText))})
        return notifyString
    ...
    def __makeSwitchProgressionLevelRendererVO(self):
        ...
        return {b'iconSrc': (_PROGRESSION_LEVEL_ICONS[self.__displayedProgressionLevel - 1]), 
           b'iconHoverSrc': (_PROGRESSION_LEVEL_ICONS_HOVER[self.__displayedProgressionLevel - 1]), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_I_DISABLE), 
           b'actionBtnLabel': actionBtnLabel, 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_SWITCH_PROGRESSION_LVL), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_SWITCH_RENDERER_UI), 
           b'enabled': enabled, 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.PROPERTYSHEET_ACTIONBTN_SWITCHPROGRESSION_DISABLE_TOOLTIP)}
    ...
    def __getLockedSeasonsString(self, lockedSeasons):
        ...
        seasonsString = text_styles.alert(_SEASONS_REMOVE_TEXT.get(seasonsMask, b''))
        return seasonsString

    def __makeEditInscriptionRendererVO(self):
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_EDIT), 
           b'iconHoverSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_EDIT_HOVER), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_EDIT_DISABLE), 
           b'actionBtnLabel': (VEHICLE_CUSTOMIZATION.PROPERTYSHEET_ACTIONBTN_EDIT_INSCRIPTION), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_EDIT), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'animatedTransition': True, 
           b'enabled': True}
    ...
    def __makeAttachmentRotateRendererVO(self):
        ...
        return {b'iconSrc': (rotation[currentRotationState][b'icon']), 
           b'iconHoverSrc': (rotation[currentRotationState][b'hoverIcon']), 
           b'iconDisableSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_DISABLE_ICON_MIRROR_01_DISABLED), 
           b'actionBtnLabel': (VEHICLE_CUSTOMIZATION.PROPERTYSHEET_ACTIONBTN_ROTATE_ATTACHMENT), 
           b'actionType': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_ACTION_HORIZONZONTAL_MIRROR), 
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_BTN_RENDERER_UI), 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_PROPERTYSHEET_DISABLED_ATTACHMENT_ROTATE), 
           b'enabled': (self._currentItem.rotatable)}
    ...
    def __makeAttachmentScaleRendererVO(self):
        ...
        if self._currentItem.scalable:
            ...
            for idx, scaleSizeLabel in enumerate(SCALE_SIZE):
                btnsBlockVO.append({b'paletteIcon': b'', 
                   b'label': scaleSizeLabel, 
                   b'selected': (selectedIdx == idx), 
                   b'value': idx, 
                   b'enable': (idx < slotScaleFactorId)})
        ...
        return {b'iconSrc': (RES_ICONS.MAPS_ICONS_CUSTOMIZATION_PROPERTY_SHEET_IDLE_ICON_SCALE), 
           ...
           b'rendererLnk': (CUSTOMIZATION_ALIASES.CUSTOMIZATION_SHEET_SCALE_COLOR_RENDERER_UI), 
           b'btnsBlockVO': btnsBlockVO, 
           b'disableTooltip': (VEHICLE_CUSTOMIZATION.CUSTOMIZATION_PROPERTYSHEET_DISABLED_ATTACHMENT_SCALE), 
           b'enabled': (sum(btn[b'enable'] for btn in btnsBlockVO) > 1)}
