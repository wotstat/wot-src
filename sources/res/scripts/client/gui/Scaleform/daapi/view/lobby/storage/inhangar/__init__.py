...
class _ShortNameVehiclesCriteriesGroup(CriteriesGroup):
    ...
    def update(self, filters):
        ...
        if filters[b'favorite']:
            self._criteria |= REQ_CRITERIA.VEHICLE.FAVORITE
        if filters[b'searchNameVehicle']:
            searchableString = makeSearchableString(filters[b'searchNameVehicle'])
