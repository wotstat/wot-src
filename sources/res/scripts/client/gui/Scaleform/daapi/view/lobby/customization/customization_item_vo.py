...
def buildCustomizationItemDataVO(item, count=None, isApplied=False, isDarked=False, isUsedUp=False, autoRentEnabled=False, vehicle=None, progressionLevel=None, icon=None, showDetailItems=True, plainView=False, showEditableHint=False, showEditBtnHint=False, isChained=False, isUnsuitable=False, isInProgress=False, rarity=b''):
    if plainView:
        hasBonus = False
        locked = False
...
class CustomizationCarouselRendererVO(object):
    __slots__ = (b'intCD', b'typeId', b'isWide', b'icon', b'hasBonus', b'locked', b'buyPrice', b'quantity', b'isRental', b'autoRentEnabled', b'showDetailItems', b'customizationDisplayType', b'isSpecial', b'isDarked', b'isAlreadyUsed', b'showAlert', b'buyOperationAllowed', b'extraNames', b'showRareIcon', b'isEquipped', b'rentalInfoText', b'imageCached', b'isAllSeasons', b'noveltyCounter', b'editNoveltyCounter', b'formIconSource', b'defaultIconAlpha', b'lockText', b'isDim', b'formFactor', b'progressionLevel', b'editableIcon', b'editBtnEnabled', b'showEditableHint', b'showEditBtnHint', b'imageScale', b'tooltip', b'isChained', b'isUnsuitable', b'isProgressionRewindEnabled', b'isWithSerialNumber', b'isInProgress', b'isLinked', b'isNew', b'isRare', b'rarityIconSource', b'rarityBackgroundIconSource', b'showDisabled')

    def __init__(self, item, icon, hasBonus, locked, buyPrice, quantity=None, showDetailItems=True, isSpecial=False, isDarked=False, isAlreadyUsed=False, showAlert=False, buyOperationAllowed=True, extraNames=None, isEquipped=False, rentalInfoText=b'', imageCached=True, noveltyCounter=0, editNoveltyCounter=0, autoRentEnabled=False, formIconSource=b'', defaultIconAlpha=1, lockText=b'', formFactor=-1, progressionLevel=-1, imageScale=1, editableIcon=b'', editBtnEnabled=False, showEditableHint=False, showEditBtnHint=False, tooltip=b'', isChained=False, isUnsuitable=False, isProgressionRewindEnabled=False, isWithSerialNumber=False, isInProgress=False, isLinked=False, isNew=False, isRare=False, rarityIconSource=b'', rarityBackgroundIconSource=b'', showDisabled=False):
    ...
    def asDict(self):
        ret = {b'intCD': (self.intCD), 
           b'typeId': (self.typeId), 
           b'isWide': (self.isWide), 
           b'icon': (self.icon), 
           b'locked': (self.locked), 
           b'buyPrice': (self.buyPrice), 
           b'isRental': (self.isRental), 
           b'autoRentEnabled': (self.autoRentEnabled), 
           b'showDetailItems': (self.showDetailItems), 
           b'customizationDisplayType': (self.customizationDisplayType), 
           b'isSpecial': (self.isSpecial), 
           b'isDarked': (self.isDarked), 
           b'isAlreadyUsed': (self.isAlreadyUsed), 
           b'showAlert': (self.showAlert), 
           b'buyOperationAllowed': (self.buyOperationAllowed), 
           b'showRareIcon': (self.showRareIcon), 
           b'isEquipped': (self.isEquipped), 
           b'rentalInfoText': (self.rentalInfoText), 
           b'imageCached': (self.imageCached), 
           b'noveltyCounter': (self.noveltyCounter), 
           b'editNoveltyCounter': (self.editNoveltyCounter), 
           b'isAllSeasons': (self.isAllSeasons), 
           b'formIconSource': (self.formIconSource), 
           b'defaultIconAlpha': (self.defaultIconAlpha), 
           b'lockText': (self.lockText), 
           b'isDim': (self.isDim), 
           b'formFactor': (self.formFactor), 
           b'progressionLevel': (self.progressionLevel), 
           b'editableIcon': (self.editableIcon), 
           b'editBtnEnabled': (self.editBtnEnabled), 
           b'showEditableHint': (self.showEditableHint), 
           b'showEditBtnHint': (self.showEditBtnHint), 
           b'scale': (self.imageScale), 
           b'tooltip': (self.tooltip), 
           b'isChained': (self.isChained), 
           b'isUnsuitable': (self.isUnsuitable), 
           b'isProgressionRewindEnabled': (self.isProgressionRewindEnabled), 
           b'isWithSerialNumber': (self.isWithSerialNumber), 
           b'isInProgress': (self.isInProgress), 
           b'isLinked': (self.isLinked), 
           b'isNew': (self.isNew), 
           b'isRare': (self.isRare), 
           b'rarityIconSource': (self.rarityIconSource), 
           b'rarityBackgroundIconSource': (self.rarityBackgroundIconSource), 
           b'showDisabled': (self.showDisabled)}
