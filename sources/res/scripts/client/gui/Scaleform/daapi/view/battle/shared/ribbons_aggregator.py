...
class _Ribbon(object):
    __slots__ = (b'_id', b'_isAggregating')
...
class _RoleRibbon(_Ribbon):
    __slots__ = (b'_isRoleBonus', b'_role')
...
class _PerkRibbon(_Ribbon):
    ...
    @classmethod
    def createFromFeedbackEvent(cls, ribbonID, event):
        return cls(ribbonID, event[b'perkID'])
...
class _SingleVehicleRibbon(_RoleRibbon):
    __slots__ = (b'_extraValue', b'_targetVehID')
...
class _DamageRibbonClassFactory(_RibbonClassFactory):
    __slots__ = (b'__damageCls', b'__fireCls', b'__ramCls', b'__wcCls', b'__artDmgCls', b'__bombDmgCls', b'__artFireCls', b'__bombFireCls', b'__recoveryCls', b'__deathZoneCls', b'__damagedByFortArtillery', b'__berserker', b'__spawnedBotDmgCls', b'__damageByMinefield', b'__damagedBySmoke', b'__damagedByCorrodingShot', b'__dmgByFireCircle', b'__dmgByClingBrander', b'__damageByThunderStrike', b'__damageByAirStrike', b'__damageByArtillery', b'__staticDeathZoneCls', b'__damageByCircuitOverload', b'__damagedByMissile', b'__dmgByDamageShieldExplosion', b'__dmgByStunAreaModA', b'__damageByAnomaly')
...
class _AssistRibbonClassFactory(_RibbonClassFactory):
    __slots__ = (b'__trackAssistCls', b'__radioAssistCls', b'__stunAssistCls')
...
def _isRoleBonus(event):
    return getattr(event.getExtra(), b'isRoleAction', (lambda : False))()


class _RibbonsCache(object):
    __slots__ = (b'__ribbons', b'__typeToIDs')
...
class RibbonsAggregator(object):
    ...
    def _createRibbonFromPlayerFeedbackEvent(self, ribbonID, event):
        ...
        if etype not in self._FEEDBACK_EVENTS_TO_IGNORE:
            _logger.error(b'Could not find a proper ribbon class associated with the given feedback event %s', event)
        return
