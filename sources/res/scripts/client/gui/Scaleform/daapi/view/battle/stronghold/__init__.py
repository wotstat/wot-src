...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.STRONGHOLD_BATTLE_PAGE, StrongholdPage, b'strongholdBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
