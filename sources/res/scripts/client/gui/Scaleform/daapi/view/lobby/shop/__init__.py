...
def getViewSettings():
    return (
     GroupedViewSettings(SHOP_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, VehicleSellConfirmationPopover, b'vehicleSellConfirmationPopover.swf', WindowLayer.TOP_WINDOW, SHOP_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, SHOP_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(SHOP_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, RentalTermSelectionPopover, b'rentalTermSelectionPopover.swf', WindowLayer.TOP_WINDOW, SHOP_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, SHOP_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE))
