...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOBBY_HANGAR, HangarWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LEGACY_LOBBY_HANGAR, Hangar, b'hangar.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LEGACY_LOBBY_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.VEHICLE_HUB, VehicleHubWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.VEHICLE_HUB, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     GroupedViewSettings(VIEW_ALIAS.HANGAR_TANK_CAROUSEL_FILTER_POPOVER, HangarTankCarouselFilterPopover, b'filtersPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.HANGAR_TANK_CAROUSEL_FILTER_POPOVER, VIEW_ALIAS.HANGAR_TANK_CAROUSEL_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
