...
class MarathonVehiclePreview(VehiclePreview):
    ...
    def __init__(self, ctx=None):
        ...
        self.__marathonPrefix = ctx.get(b'marathonPrefix')
        self.__marathon = self.__marathonCtrl.getMarathon(self.__marathonPrefix)
        self.__backToHangar = ctx.get(b'backToHangar', False)
        return
    ...
    def _getExitEvent(self):
        ...
        exitEvent.ctx.update({b'marathonPrefix': (self.__marathonPrefix)})
        return exitEvent
