...
class SettingsWindowMeta(AbstractWindowView):
    ...
    def restartNewbieBattleHints(self):
        self._printOverrideError(b'restartNewbieBattleHints')
        return

    def autodetectPhysicsSoundQuality(self):
        self._printOverrideError(b'autodetectPhysicsSoundQuality')
        return

    def canSelectPhysicsSoundQuality(self, optionIdx):
        self._printOverrideError(b'canSelectPhysicsSoundQuality')
        return
