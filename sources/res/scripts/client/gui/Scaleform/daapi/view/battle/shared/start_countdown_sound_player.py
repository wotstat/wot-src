...
_RTPC = b'RTPC_ext_battle_countdown_timer'
...
class StartCountdownSoundPlayer(IAbstractPeriodView, IViewComponentsCtrlListener):
    ...
    def __init__(self):
        ...
        if not self.__soundID:
            _logger.warning(b'Countdown sound for this game mode is not defined! ' + b'Please define one ' + b'otherwise remove this player from the list in the corresponded page.py')
        return
