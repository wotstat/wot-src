...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.AMMUNITION_SETUP_VIEW, AmmunitionSetupView, b'ammunitionSetupView.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.AMMUNITION_SETUP_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True, isModal=True),
