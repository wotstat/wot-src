...
class PrimaryObjectiveServerModel(BaseWidgetSettingsModel):
    __slots__ = (b'timer', b'finishTime', b'progresses', b'params')
    ...
    def __repr__(self):
        return b'<PrimaryObjectiveServerModel>: id=%s, type=%s, state=%s, timer=%s, finishTime=%s, progresses=%s, params=%s' % (
