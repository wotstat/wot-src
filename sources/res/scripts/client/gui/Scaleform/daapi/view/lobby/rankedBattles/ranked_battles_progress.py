...
class RankedBattlesProgress(RankedBattlesDivisionProgressMeta, IResetablePage):
    ...
    __slots__ = (b'__selectedDivisionIdx',)
    ...
    def __buildProgressData(self):
        ...
        return {b'blocks': [divisions_vos.getRankVO(rank) for rank in ranks], b'isLocked': (not self.__getSelectedDivision().isUnlocked()), 
           b'isFirstEnter': isFirstEntry}
