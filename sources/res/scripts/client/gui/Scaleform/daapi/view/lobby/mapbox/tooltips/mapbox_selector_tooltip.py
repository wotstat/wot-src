...
class MapboxSelectorTooltip(BlocksTooltipData):
    ...
    __BODY_TEMPLATE_PATH = b'html_templates:lobby/tooltips/battle_type_selector'
    ...
    def __packMainBlock(self):
        ...
        body = makeHtmlString(self.__BODY_TEMPLATE_PATH, self.__BODY_TEMPLATE_KEY, ctx={b'range': (toRomanRangeString(self.__mapboxCtrl.getModeSettings().levels))})
