...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.EPIC_BATTLE_PAGE, page.EpicBattlePage, b'epicBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     GroupedViewSettings(BATTLE_VIEW_ALIASES.EPIC_CAROUSEL_FILTER_POPOVER, BattleTankCarouselFilterPopover, b'epicCarouselFilterPopover.swf', WindowLayer.TOP_WINDOW, BATTLE_VIEW_ALIASES.EPIC_CAROUSEL_FILTER_POPOVER, BATTLE_VIEW_ALIASES.EPIC_CAROUSEL_FILTER_POPOVER, SETTINGS_WINDOW_SCOPE),
...
class EpicBattlePageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        super(EpicBattlePageBusinessHandler, self).__init__((
         (
          BATTLE_VIEW_ALIASES.EPIC_CAROUSEL_FILTER_POPOVER, self.loadViewByCtxEvent),), APP_NAME_SPACE.SF_BATTLE, EVENT_BUS_SCOPE.BATTLE)
        return
