...
class SessionStatsPopover(SessionStatsPopoverMeta):
    ...
    def _populate(self):
        ...
        data = {b'alias': (SESSION_STATS_CONSTANTS.SESSION_STATS_OVERVIEW_PY_ALIAS), 
           b'linkage': (SESSION_STATS_CONSTANTS.SESSION_STATS_OVERVIEW_VIEW_LINKAGE)}
    ...
    def onShowSettings(self):
        data = {b'alias': (SESSION_STATS_CONSTANTS.SESSION_STATS_SETTINGS_PY_ALIAS), b'linkage': (SESSION_STATS_CONSTANTS.SESSION_STATS_SETTINGS_VIEW_LINKAGE)}
        self.as_setDataS(data)
        return
