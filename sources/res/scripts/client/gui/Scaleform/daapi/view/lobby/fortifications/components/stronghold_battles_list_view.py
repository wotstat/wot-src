...
class StrongholdBattlesListView(StrongholdBattlesListViewMeta):
    ...
    def _populate(self):
        ...
        self.fireEvent(events.RenameWindowEvent(events.RenameWindowEvent.RENAME_WINDOW, ctx={b'data': (FORTIFICATIONS.SORTIE_INTROVIEW_TITLE)}), scope=EVENT_BUS_SCOPE.LOBBY)
        return
    ...
    def __loadBrowser(self, width, height):
        ...
        if self.__browser is not None:
            ...
            LOG_ERROR(b'Setting "StrongholdsBattlesListUrl" missing!')
        return
