...
class _RentVehiclesDataProvider(StorageCarouselDataProvider):
    ...
    def _buildVehicle(self, vehicle):
        ...
        vo.update({b'isMoneyEnough': True, 
           b'enabled': (vehicle.canSell and vehicle.rentalIsOver and not vehicle.isTelecomRent), 
           b'rentText': rentText, 
           b'rentIcon': (RES_ICONS.MAPS_ICONS_LIBRARY_CLOCKICON_1), 
           b'contextMenuId': (CONTEXT_MENU_HANDLER_TYPE.STORAGE_VEHICLES_RENTED_ITEM), 
           b'sellButtonLabel': (backport.text(R.strings.storage.buttonLabel.remove()))})
        return vo
