...
class BadgesPage(BadgesPageMeta):
    ...
    def __sentSuffixBadgesVO(self):
        ...
        if self.__badgesCollector.getSuffixAchievedBadges():
            ...
            self.as_setBadgeSuffixS({b'checkboxLabel': (backport.text(R.strings.badge.badgesPage.header.suffixSetting.label())), 
               ...
               b'selectedItemIdx': (self.__selectedItemIdx), 
               b'items': suffixBadgesVO})
        return
