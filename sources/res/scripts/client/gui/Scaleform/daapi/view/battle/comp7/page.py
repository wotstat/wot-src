...
_EXTERNAL_COMPONENTS = (
 crosshair.CrosshairPanelContainer, Comp7MarkersManager)
...
class Comp7BattlePage(Comp7BattlePageMeta):
    ...
    def showHelp(self):
        event_dispatcher.toggleHelpDetailed(ctx={b'isComp7': True})
        return
...
class _ComponentsVisibilityManager(object):
    ...
    def __perksPanelPredicate(self):
        ...
        return self.__arenaPeriod >= ARENA_PERIOD.BATTLE and self.__isBattleLoaded and self.__controllingVehicleID in vehicles and avatar_getter.getPlayerTeam() == vehicles[self.__controllingVehicleID][b'team']
