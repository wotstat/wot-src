...
class SESSION_CONTROL_TYPE(object):
    AOGAS = b'AOGAS'
    KOREA_PARENTAL_CONTROL = b'KOREA_PARENTAL_CONTROL'


SessionControlAuxData = namedtuple(b'SessionControlAuxData', (b'type', b'timeoutMS'))
...
class SystemMessageMeta(IDialogMeta):
    ...
    def __init__(self, notification):
        ...
        if isinstance(auxData, SessionControlAuxData):
            ...
            self.__settingsVO[b'timeout'] = auxData.timeoutMS
        else:
