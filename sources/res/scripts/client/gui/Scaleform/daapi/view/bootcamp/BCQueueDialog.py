...
class BCQueueDialog(BCQueueWindowMeta):
    ...
    def __init__(self, settings):
        ...
        self.__backgroundImage = settings[b'backgroundImage']
        self.__lessonNumber = settings[b'lessonNumber']
        self.__timeoutTime = settings[b'timeout']
    ...
    def updateSettings(self, settings):
        ...
        if timeLeft > 0:
            ...
            self.as_showCancelButtonS(False, b'', b'')
        else:
            self.showCancel()
    ...
    def applyData(self):
        data = {b'showTutorialPages': False, 
           b'backgroundImage': (self.__backgroundImage)}
