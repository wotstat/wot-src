...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.EPIC_RANDOM_PAGE, EpicRandomPage, b'epicRandomPage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
