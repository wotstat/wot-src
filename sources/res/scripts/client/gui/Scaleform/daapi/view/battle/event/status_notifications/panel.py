...
class EventStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateNotificationTimerSettings(self):
        ...
        self._addNotificationTimerSetting(data, _TYPES.SECTOR_AIRSTRIKE, _LINKS.AIRSTRIKE_ICON, link, iconSmallName=b'secondaryAirStrikeUI', color=_COLORS.YELLOW, descriptionFontSize=24, descriptionOffsetY=10)
