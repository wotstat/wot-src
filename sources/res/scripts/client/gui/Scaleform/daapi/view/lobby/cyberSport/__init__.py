...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_PY, CyberSportMainWindow, CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_UI, WindowLayer.WINDOW, b'', CYBER_SPORT_ALIASES.CYBER_SPORT_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True),
     GroupedViewSettings(CYBER_SPORT_ALIASES.ROSTER_SLOT_SETTINGS_WINDOW_PY, RosterSlotSettingsWindow, CYBER_SPORT_ALIASES.ROSTER_SLOT_SETTINGS_WINDOW_UI, WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, True, isModal=True),
     GroupedViewSettings(CYBER_SPORT_ALIASES.VEHICLE_SELECTOR_POPUP_PY, VehicleSelectorPopup, CYBER_SPORT_ALIASES.VEHICLE_SELECTOR_POPUP_UI, WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, True, isModal=True),
     GroupedViewSettings(CYBER_SPORT_ALIASES.CYBER_SPORT_DIALOG_PY, CyberSportDialog, CYBER_SPORT_ALIASES.CYBER_SPORT_DIALOG_UI, WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DYNAMIC_SCOPE, True, isModal=True),
...
def getBusinessHandlers():
    return (
     _CyberSportBusinessHandler(), _CyberSportDialogsHandler())
...
class _CyberSportDialogsHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        super(_CyberSportDialogsHandler, self).__init__((
         (
          ShowDialogEvent.SHOW_CYBER_SPORT_DIALOG, self.__showCyberSportDialog),), APP_NAME_SPACE.SF_LOBBY, EVENT_BUS_SCOPE.DEFAULT)
        return
