...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOBBY_EVENT_BOARDS_TABLE, EventBoardsTableView, b'eventBoardsTable.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.LOBBY_EVENT_BOARDS_TABLE, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ...
     GroupedViewSettings(EVENTBOARDS_ALIASES.RESULT_FILTER_POPOVER_ALIAS, EventBoardsFilterPopover, b'FilterPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.VEHICLES_FILTER_POPOVER, EVENTBOARDS_ALIASES.RESULT_FILTER_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(EVENTBOARDS_ALIASES.RESULT_FILTER_POPOVER_VEHICLES_ALIAS, EventBoardsFilterVehiclesPopover, b'FilterVehiclesPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.VEHICLES_FILTER_POPOVER, EVENTBOARDS_ALIASES.RESULT_FILTER_POPOVER_VEHICLES_ALIAS, ScopeTemplates.DEFAULT_SCOPE))
