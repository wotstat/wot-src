...
def getViewSettings():
    ...
    return (
     ...
     ViewSettings(VIEW_ALIAS.STORAGE_RESTORE_DEVICES_VIEW, StorageRestoreDevicesView, b'storageRestoreDevicesView.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.STORAGE_RESTORE_DEVICES_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
