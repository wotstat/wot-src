...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOBBY_STORAGE, StorageView, b'storageView.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_STORAGE, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.OFFER_GIFT_VIEW, OfferGiftsWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.OFFER_GIFT_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     GroupedViewSettings(VIEW_ALIAS.STORAGE_VEHICLES_FILTER_POPOVER, StorageVehicleFilterPopover, b'vehiclesFiltersPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.STORAGE_VEHICLES_FILTER_POPOVER, VIEW_ALIAS.STORAGE_VEHICLES_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(STORAGE_CONSTANTS.BLUEPRINTS_VIEW, StorageCategoryBlueprintsView, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.STORAGE_BLUEPRINTS_FILTER_POPOVER, StorageBlueprintsFilterPopover, b'vehiclesFiltersPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.STORAGE_VEHICLES_FILTER_POPOVER, VIEW_ALIAS.STORAGE_BLUEPRINTS_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.STORAGE_VEHICLE_SELECTOR_POPOVER, VehicleSelectPopover, b'storageVehicleSelectorPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.STORAGE_VEHICLE_SELECTOR_POPOVER, VIEW_ALIAS.STORAGE_VEHICLE_SELECTOR_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
...
def getSectionsList():
    return (
     {b'id': (STORAGE_CONSTANTS.FOR_SELL), 
        b'linkage': (STORAGE_CONSTANTS.FOR_SELL_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.FOR_SELL_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_FOR_SELL)},
     {b'id': (STORAGE_CONSTANTS.STORAGE), 
        b'linkage': (STORAGE_CONSTANTS.STORAGE_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.STORAGE_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_STORAGE)},
     {b'id': (STORAGE_CONSTANTS.BLUEPRINTS), 
        b'linkage': (STORAGE_CONSTANTS.BLUEPRINTS_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.BLUEPRINTS_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_BLUEPRINTS)},
     {b'id': (STORAGE_CONSTANTS.IN_HANGAR), 
        b'linkage': (STORAGE_CONSTANTS.IN_HANGAR_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.IN_HANGAR_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_IN_HANGAR)},
     {b'id': (STORAGE_CONSTANTS.PERSONAL_RESERVES), 
        b'linkage': (STORAGE_CONSTANTS.PERSONAL_RESERVES_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.PERSONAL_RESERVES_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_PERSONAL_RESERVES)},
     {b'id': (STORAGE_CONSTANTS.CUSTOMIZATION), 
        b'linkage': (STORAGE_CONSTANTS.CUSTOMIZATION_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.CUSTOMIZATION_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_CUSTOMIZATION)},
     {b'id': (STORAGE_CONSTANTS.OFFERS), 
        b'linkage': (STORAGE_CONSTANTS.OFFERS_VIEW), 
        b'viewId': (STORAGE_CONSTANTS.OFFERS_VIEW), 
        b'tooltip': (TOOLTIPS.STORAGE_MAINMENU_OFFERS)})
