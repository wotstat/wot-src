...
_TABS_DATA = (
 {b'id': (STORAGE_CONSTANTS.VEHICLES_TAB_ALL), 
    ...
    b'viewId': (STORAGE_CONSTANTS.IN_HANGAR_ALL_VEHICLES_TAB), 
    b'selected': False},
 {b'id': (STORAGE_CONSTANTS.VEHICLES_TAB_RESTORE), 
    ...
    b'viewId': (STORAGE_CONSTANTS.IN_HANGAR_RESTORE_VEHICLES_TAB), 
    b'selected': False})
_RENT_TAB_DATA = {b'id': (STORAGE_CONSTANTS.VEHICLES_TAB_RENT), 
   ...
   b'viewId': (STORAGE_CONSTANTS.IN_HANGAR_RENT_VEHICLES_TAB), 
   b'selected': False}
