...
class _ComponentUpdater(object):
    __slots__ = (b'_parentObj', b'_totalTime', b'_timeLeft', b'_siegeState', b'_deviceState', b'_isSmooth', b'_staticMode')
    ...
    def __repr__(self):
        return (b'_UpdaterComponent(totalTime = {}, timeLeft = {}, siegeState = {}, deviceState = {})').format(self._totalTime, self._timeLeft, self._siegeState, self._deviceState)
...
class _PythonUpdater(_ComponentUpdater):
    ...
    def _tick(self):
        ...
        if timeLeft >= 0 and self._deviceState != b'destroyed':
            self._updateSnapshot(timeLeft)
        return
