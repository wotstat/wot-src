...
class AutoInviteWindow(_InviteWindow):
    ...
    def acceptInvite(self):
        ...
        if g_preDefinedHosts.isRoamingPeriphery(invite.peripheryID):
            ...
            if not success:
                return
        self.prbPeripheriesHandler.join(invite.peripheryID, JoinBattleSessionCtx(prbID, invite.prbType, invite.peripheryID, b'prebattle/join'), postActions, finishActions)
        return
