    ...
    def _applyTankmanSkill(cls, vehicle, tankmenToUpdate):
        ...
        for slotIdx, (role, _) in iteritems(tankmenToUpdate):
            ...
            if tman:
                ...
                LOG_WARNING((b'Tankmen with role index {} has not been found').format(slotIdx))
...
class VehicleCompareConfiguratorMain(LobbySubView, VehicleCompareConfiguratorMainMeta):
    ...
    def selectCrewSkills(self, skills):
        ...
        if isUpdated:
            ...
            LOG_WARNING((b'Attempt to apply the same value for {}').format(skills))
        return
