...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOGIN, LoginView, b'login.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.EULA, EULADlg, b'EULADlg.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
     GroupedViewSettings(VIEW_ALIAS.LEGAL_INFO_WINDOW, LegalInfoWindow, b'legalInfoWindow.swf', WindowLayer.WINDOW, b'legalInfoWindow', None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.EULA_FULL, EULADlg, b'EULAFullDlg.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     GroupedViewSettings(VIEW_ALIAS.LOGIN_QUEUE, LoginQueue, b'LoginQueueWindow.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, canClose=False),
     ComponentSettings(VIEW_ALIAS.RSS_NEWS_FEED, RssNewsFeed, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_INTRO, BCIntroPage, b'BCIntroVideo.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE))
