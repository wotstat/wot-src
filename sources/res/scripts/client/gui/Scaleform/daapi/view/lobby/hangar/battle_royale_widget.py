...
BattleRoyaleWidgetVO = namedtuple(b'EpicBattlesWidgetVO', (b'calendarStatus', b'showAlert'))
...
class BattleRoyaleHangarWidget(BattleRoyaleHangarWidgetMeta):
    ...
    def __getStatusBlock(self):
        ...
        if unsuitablePeriphery:
            peripheryID = self.__battleRoyaleController.getAnyPrimeStatusServerID((PrimeTimeStatus.AVAILABLE,
