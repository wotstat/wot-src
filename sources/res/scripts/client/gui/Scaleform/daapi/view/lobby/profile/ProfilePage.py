    ...
    def __getSectionsData(self):
        ...
        if self.__collectionsSystem.isEnabled():
            sectionsData.append((
             ...
             True,
             b'statsCollections'))
        return {b'sectionsData': [{b'label': (makeString(label)), b'tooltip': tooltip, b'alias': alias, b'enabled': isEnabled, b'id': uiId} for label, tooltip, alias, isEnabled, uiId in sectionsData], 
