...
def getViewSettings():
    ...
    return (
     ConditionalViewSettings(VIEW_ALIAS.BATTLE_TYPE_SELECT_POPOVER, BootcampComponentOverride(BattleTypeSelectPopover, BCBattleSelector), b'itemSelectorPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.BATTLE_TYPE_SELECT_POPOVER, VIEW_ALIAS.BATTLE_TYPE_SELECT_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.SQUAD_TYPE_SELECT_POPOVER, SquadTypeSelectPopover, b'itemSelectorPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.SQUAD_TYPE_SELECT_POPOVER, VIEW_ALIAS.SQUAD_TYPE_SELECT_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
