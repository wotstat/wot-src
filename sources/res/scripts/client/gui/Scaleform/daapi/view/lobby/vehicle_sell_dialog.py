...
class _ShellData(_VSDItemData):
    ...
    def __init__(self, shell, inInventory, onOtherVehicle):
        ...
        self._flashData[b'kind'] = shell.type
...
class _CustomizationData(_VSDItemData):
    ...
    def __init__(self, customization, count):
        ...
        self._flashData[b'onlyToInventory'] = customization.isRentable or customization.isHidden
...
class _OptionalDeviceData(_VSDItemData):
    ...
    def __init__(self, optDevice):
        ...
        self._flashData[b'alertIconDataID'] = self.__getAlertIconTooltip(optDevice)
        return

    @classmethod
    def __getAlertIconTooltip(cls, optDevice):
        if not optDevice.isModernized:
            return b'#tooltips:vehicleSellDialog/renderer/alertIconSell'
        return b'#tooltips:vehicleSellDialog/renderer/alertIconDeconstruct'
