...
class VehPriceActionInfo(ActionInfo):
    ...
    def __getCommonStatsBlock(self, vehicle):
        _params = {(VEHICLE_CLASS_NAME.LIGHT_TANK): (
                                           b'enginePowerPerTon', b'speedLimits', WHEELED_SPEED_MODE_SPEED,
                                           b'chassisRotationSpeed', b'circularVisionRadius',
                                           MAX_STEERING_LOCK_ANGLE, WHEELED_SWITCH_ON_TIME, WHEELED_SWITCH_OFF_TIME), 
           (VEHICLE_CLASS_NAME.MEDIUM_TANK): (
                                            b'avgDamagePerMinute', b'enginePowerPerTon', b'speedLimits',
                                            b'chassisRotationSpeed', TURBOSHAFT_SPEED_MODE_SPEED,
                                            TURBOSHAFT_ENGINE_POWER), 
           (VEHICLE_CLASS_NAME.HEAVY_TANK): (
                                           b'avgDamage', b'avgPiercingPower', b'hullArmor', b'turretArmor',
                                           DUAL_GUN_CHARGE_TIME), 
           (VEHICLE_CLASS_NAME.SPG): (b'avgDamage', b'stunMaxDuration', b'reloadTimeSecs', b'aimingTime', b'explosionRadius'), 
           (VEHICLE_CLASS_NAME.AT_SPG): (b'avgPiercingPower', b'shotDispersionAngle', b'avgDamagePerMinute', b'speedLimits', b'chassisRotationSpeed', b'switchOnTime', b'switchOffTime'), 
        ...
        for paramName in _params.get(vehicle.type, b'default'):
...
class BattleBoosterActionInfo(EquipmentActionInfo):
    ...
    def getTriggerChainID(self):
        return b'prebattleInstructionsPrice'
...
_PARAM_TO_IMG_DICT = {b'exchangeRate': (RES_ICONS.MAPS_ICONS_ACTIONS_480X280_CONVERT_GOLD), 
   ...
   b'calendar': (RES_ICONS.MAPS_ICONS_ACTIONS_480X280_CALENDAR), 
   b'AdventCalendarEnabled': (RES_ICONS.MAPS_ICONS_ACTIONS_480X280_CALENDAR)}
_MODIFIERS_DICT = {b'mul_EconomicsParams': EconomicsActionsInfo, 
   ...
   b'mul_PrebattleInstructionsPriceAll': BattleBoosterActionInfo, 
   b'mul_PrebattleInstructionsPrice': BattleBoosterActionInfo, 
   b'set_PrebattleInstructionsPrice': BattleBoosterActionInfo, 
   ...
   b'AdventCalendarEnabled': CalendarActionInfo}
