...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(VIEW_ALIAS.CUSTOMIZATION_FILTER_POPOVER, FilterPopover, b'customizationFiltersPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.CUSTOMIZATION_FILTER_POPOVER, VIEW_ALIAS.CUSTOMIZATION_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.CUSTOMIZATION_ITEMS_POPOVER, CustomPopover, b'customizationItemsPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.CUSTOMIZATION_ITEMS_POPOVER, VIEW_ALIAS.CUSTOMIZATION_ITEMS_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.CUSTOMIZATION_PROGRESSIVE_KIT_POPOVER, ProgressiveStylePopover, b'customizationProgressiveKitPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.CUSTOMIZATION_PROGRESSIVE_KIT_POPOVER, VIEW_ALIAS.CUSTOMIZATION_PROGRESSIVE_KIT_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.CUSTOMIZATION_EDITED_KIT_POPOVER, EditableStylePopover, b'customizationEditedKitPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.CUSTOMIZATION_EDITED_KIT_POPOVER, VIEW_ALIAS.CUSTOMIZATION_EDITED_KIT_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.CUSTOMIZATION_KIT_POPOVER, StylePopover, b'customizationKitPopover.swf', WindowLayer.WINDOW, VIEW_ALIAS.CUSTOMIZATION_KIT_POPOVER, VIEW_ALIAS.CUSTOMIZATION_KIT_POPOVER, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(CUSTOMIZATION_ALIASES.PROGRESSIVE_ITEMS_BROWSER_VIEW, ProgressiveItemsBrowserView, b'browserScreen.swf', WindowLayer.FULLSCREEN_WINDOW, CUSTOMIZATION_ALIASES.PROGRESSIVE_ITEMS_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
