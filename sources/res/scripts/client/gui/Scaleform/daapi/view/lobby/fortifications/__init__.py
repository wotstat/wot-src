...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(FORTIFICATION_ALIASES.STRONGHOLD_SEND_INVITES_WINDOW_PY, StrongholdSendInvitesWindow, b'sendInvitesWindow.swf', WindowLayer.WINDOW, b'', FORTIFICATION_ALIASES.STRONGHOLD_SEND_INVITES_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True),
     ...
     GroupedViewSettings(FORTIFICATION_ALIASES.STRONGHOLD_BATTLE_ROOM_WINDOW_ALIAS, StrongholdBattleRoomWindow, FORTIFICATION_ALIASES.FORT_BATTLE_ROOM_WINDOW_UI, WindowLayer.WINDOW, b'', FORTIFICATION_ALIASES.STRONGHOLD_BATTLE_ROOM_WINDOW_ALIAS, ScopeTemplates.DEFAULT_SCOPE, True),
...
class _FortsBusinessHandler(PackageBusinessHandler):
    ...
    def __showStrongholdBattleRoomWindow(self, event):
        ...
        if window is not None:
            if event.ctx.get(b'modeFlags') == FUNCTIONAL_FLAG.UNIT_BROWSER:
