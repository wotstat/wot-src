...
def getViewSettings():
    ...
    return (
     ViewSettings(PREBATTLE_ALIASES.TRAINING_LIST_VIEW_PY, Trainings, b'trainingForm.swf', WindowLayer.SUB_VIEW, PREBATTLE_ALIASES.TRAINING_LIST_VIEW_PY, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(PREBATTLE_ALIASES.TRAINING_ROOM_VIEW_PY, TrainingRoom, b'trainingRoom.swf', WindowLayer.SUB_VIEW, PREBATTLE_ALIASES.TRAINING_ROOM_VIEW_PY, ScopeTemplates.DEFAULT_SCOPE, True),
     GroupedViewSettings(PREBATTLE_ALIASES.TRAINING_SETTINGS_WINDOW_PY, TrainingSettingsWindow, b'trainingWindow.swf', WindowLayer.WINDOW, PREBATTLE_ALIASES.TRAINING_SETTINGS_WINDOW_PY, None, ScopeTemplates.DEFAULT_SCOPE, True))
