...
class TopModulesChecker(object):
    __slots__ = (b'_comparators', b'_requestCriteria', b'__vehicle')
...
class ChassisComparator(_BaseModuleComparator):
    ...
    def mostValuableParam(self, excludes=None):
        return self._getValuableParam(b'rotationSpeed', excludes)
...
class TurretComparator(_BaseModuleComparator):
    ...
    def mostValuableParam(self, excludes=None):
        return self._getValuableParam(b'primaryArmor', excludes)
    ...
    def mostValuableParam(self, excludes=None):
        ...
        for _, module in self._items.items():
            ...
            if gp:
                ...
                avgDamage = paramsDict.get(b'avgDamagePerMinute', 0.0)
...
class EngineComparator(_BaseModuleComparator):
    ...
    def mostValuableParam(self, excludes=None):
        return self._getValuableParam(b'power', excludes=excludes)
...
class RadioComparator(_BaseModuleComparator):
    ...
    def mostValuableParam(self, excludes=None):
        return self._getValuableParam(b'distance', excludes=excludes)
