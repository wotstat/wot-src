...
HintData = namedtuple(b'HintData', (b'vKey', b'key', b'isKeyLong', b'messageLeft', b'messageRight', b'offsetX', b'offsetY', b'priority', b'reducedPanning', b'hintCtx', b'centeredMessage'))
HintData.__new__.__defaults__ = (
 b'', b'', False, b'', b'', 0, 0, HintPriority.HELP, False, None, False)
