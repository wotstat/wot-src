...
class Comp7AlertData(AlertData):
    ...
    _PERIOD_TYPES_WITHOUT_TOOLTIP = (
     PeriodType.ALL_NOT_SET, PeriodType.ALL_NOT_AVAILABLE_END, PeriodType.AFTER_SEASON)

    @classmethod
    def _getTooltip(cls, periodInfo):
        if periodInfo.periodType in cls._PERIOD_TYPES_WITHOUT_TOOLTIP:
            return None
        else:
            return TOOLTIPS_CONSTANTS.COMP7_CALENDAR_DAY_INFO
