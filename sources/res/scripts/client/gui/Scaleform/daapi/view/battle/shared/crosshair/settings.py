...
SHOT_RESULT_TO_DEFAULT_COLOR = {(aih_constants.SHOT_RESULT.EMPTY): b'', 
   (aih_constants.SHOT_RESULT.UNDEFINED): b'normal', 
...
SHOT_RESULT_TO_ALT_COLOR = {(aih_constants.SHOT_RESULT.EMPTY): b'', 
   (aih_constants.SHOT_RESULT.UNDEFINED): b'normal', 
   (aih_constants.SHOT_RESULT.NOT_PIERCED): b'purple', 
   (aih_constants.SHOT_RESULT.LITTLE_PIERCED): b'pink', 
   (aih_constants.SHOT_RESULT.GREAT_PIERCED): b'yellow'}
