...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.MAPS_TRAINING_PAGE, MapsTrainingPage, b'mapsTrainingBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.INGAME_HELP, MapsTrainingIngameHelpWindow, b'mapsTrainingIngameHelpWindow.swf', WindowLayer.WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, canClose=False, canDrag=False, isModal=True),
