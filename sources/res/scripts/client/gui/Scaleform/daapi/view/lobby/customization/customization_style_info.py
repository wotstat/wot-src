...
StyleInfoVO = namedtuple(b'StyleInfoVO', (b'styleName', b'styleInfo', b'styleInfoBig', b'suitableBlock', b'styleParams'))
ButtonVO = namedtuple(b'ButtonVO', (b'enabled', b'label', b'disabledTooltip', b'visible'))
ParamVO = namedtuple(b'ParamVO', (b'iconSrc', b'paramText'))
STYLE_INFO_BLUR_DELAY = 0.2
BACKGROUND_ALPHA_FORWARD = 1.0
BACKGROUND_ALPHA_DEFERRED = 0.5
_INSERTION_OPEN_TAG = b"<font size='16' face='$FieldFont' color='#E9E2BF'>"
_INSERTION_OPEN_TAG_BIG = b"<font size='18' face='$TitleFont' color='#E9E2BF'>"
_INSERTION_CLOSE_TAG = b'</font>'
...
class CustomizationStyleInfo(CustomizationStyleInfoMeta, CallbackDelayer):
    ...
    def __makeVO(self, style):
        ...
        styleInfo = text_styles.mainBig(styleInfoText % {b'insertion_open': _INSERTION_OPEN_TAG, 
           b'insertion_close': _INSERTION_CLOSE_TAG})
        styleInfoBig = text_styles.mainBig(styleInfoText % {b'insertion_open': _INSERTION_OPEN_TAG_BIG, 
           b'insertion_close': _INSERTION_CLOSE_TAG})
        ...
        for season in SeasonType.COMMON_SEASONS:
            ...
            if outfit:
                ...
                if camo and camo.bonus:
                    ...
                    formattedBonus = makeHtmlString(b'html_templates:lobby/customization', b'style_info_bonus', ctx={b'bonus': bonus})
