...
class TrainingRoom(TrainingRoomBase):
    ...
    def showTrainingSettings(self):
        ...
        self.fireEvent(events.LoadViewEvent(SFViewLoadParams(PREBATTLE_ALIASES.TRAINING_SETTINGS_WINDOW_PY), ctx={b'isCreateRequest': False, b'settings': settings}), scope=EVENT_BUS_SCOPE.LOBBY)
        return
