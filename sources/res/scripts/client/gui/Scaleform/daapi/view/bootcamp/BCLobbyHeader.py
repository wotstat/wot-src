...
_ALLOWED_ENABLED_BUTTONS = [
 LobbyHeader.BUTTONS.SETTINGS,
 LobbyHeader.BUTTONS.BATTLE_SELECTOR]
...
class BCLobbyHeader(LobbyHeader):
    ...
    def __onOverrideBattleSelectorHint(self, _=None):
        enableOverride = self.__tutorialLoader.gui.lastBattleSelectorHintOverride == b'bootcamp'
    ...
    @simpleLog(argsIndex=0, logOnce=True, restrictions={b'lesson_id': (lambda x: x <= LIMITS.RESEARCH_MAX_LESSON)})
