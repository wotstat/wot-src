...
class IngameDetailsHelpWindow(IngameDetailsHelpWindowMeta, BattleGUIKeyHandler):
    ...
    def _populate(self):
        ...
        if self.__ctx is None:
            ...
            pages = [{b'buttonsGroup': b'DetailsHelpPageGroup', b'pageIndex': index, b'label': (str(index + 1)), b'status': b'', b'selected': (index == selectedIdx), b'tooltip': {}} for index in range(len(self.__detailedList))]
