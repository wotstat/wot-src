...
class ExecutionChooserDialogMeta(I18nConfirmDialogMeta):
    ...
    def getMessage(self):
        ...
        premiumCtx = {b'premiumType': premiumStr}
        return self._makeString((b'').join((self._key, _MSG_POSTFIX)), premiumCtx)
