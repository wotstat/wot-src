...
class SectorBasesPlugin(EpicMissionsPlugin, ChatCommunicationComponent):
    ...
    __slots__ = (b'_markers', b'__highlightedBaseID', b'_isInFreeSpectatorMode', b'__basesToBeActive', b'__capturedBases', b'__insideCircle', b'__clazz')
...
class HeadquartersPlugin(EpicMissionsPlugin, ChatCommunicationComponent):
    __slots__ = (b'_markers', b'__isHQBattle', b'__visibleHQ', b'_isInFreeSpectatorMode', b'__hqMissionActive', b'__clazz', b'__entitiesDamageType')
    ...
    def __onDestructibleEntityHealthChanged(self, entityId, newHealth, maxHealth, attackerID, attackReason, hitFlags):
        ...
        if marker is None:
            ...
            self._invokeMarker(marker.getMarkerID(), b'setHealth', newHealth, self.__entitiesDamageType[entityId], hitFlags & VEHICLE_HIT_FLAGS.IS_ANY_PIERCING_MASK)
            return
...
class EpicMarkersManager(MarkersManager):
    ...
    def _setupPlugins(self, arenaVisitor):
        ...
        if arenaVisitor.hasRespawns():
            setup[b'vehicles'] = EpicRespawnableVehicleMarkerPlugin
        else:
            setup[b'vehicles'] = EpicVehicleMarkerPlugin
        return setup
