...
GuiTypeViewStateBehaviour = namedtuple(b'GuiTypeViewStateBehaviour', (b'allowHPBar', b'allowHPVal', b'allowDiff', b'allowTierGrp', b'allowVehIcons'))
...
class FragCorrelationBar(FragCorrelationBarMeta, IBattleFieldListener):
    ...
    def updateTeamHealth(self, alliesHP, enemiesHP, totalAlliesHP, totalEnemiesHP):
        ...
        differanceValue = (b'+' if alliesHP - enemiesHP > 0 else b'') + self.__formatValuesToUserPreferences(alliesHP - enemiesHP)
