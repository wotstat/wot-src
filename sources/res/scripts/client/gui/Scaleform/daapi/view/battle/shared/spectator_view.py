...
_MovementKeyBindings = namedtuple(b'MovementKeyBindings', (b'forward', b'left', b'backward', b'right'))

class SPECTATOR_VIEW_SOUND(object):
    SPEED_CHANGE = b'dc_fc_speed_change'
    FOLLOW_HINT = b'dc_fc_follow_hint'
    START_TO_FOLLOW_TANK = b'dc_fc_start_to_follow_tank'
    STOP_TO_FOLLOW_TANK = b'dc_fc_stop_to_follow_tank'
...
class SpectatorView(SpectatorViewMeta, ISpectatorViewListener, CallbackDelayer):
    ...
    def __init__(self):
        ...
        self.__timeCB = None
        self.__mode = -1
        self.__movementKeyBindings = _MovementKeyBindings(b'', b'', b'', b'')
        return
    ...
    def _populate(self):
        ...
        self.as_setFollowInfoTextS(backport.text(R.strings.death_cam.hints.follow_pt1()) + b' ' + backport.text(R.strings.death_cam.hints.follow_pt2()))
    ...
    def _addGameListeners(self):
        ...
        if playerComp is not None and hasattr(playerComp, b'onReinforcementTimerUpdated'):
    ...
    def _removeGameListeners(self):
        playerComp = getattr(self.sessionProvider.arenaVisitor.getComponentSystem(), b'playerDataComponent', None)
        if hasattr(playerComp, b'onReinforcementTimerUpdated'):
            playerComp.onReinforcementTimerUpdated -= self.__onReinforcementTimerUpdated
