...
class ProfileRankedStatisticsVO(ProfileDictStatisticsVO):
    ...
    def _getHeaderData(self, data):
        ...
        return (
         PUtils.getTotalBattlesHeaderParam(targetData, PROFILE.SECTION_STATISTICS_SCORES_TOTALBATTLES, PROFILE.PROFILE_PARAMS_TOOLTIP_BATTLESCOUNT),
         PUtils.packLditItemData(avgPointsPercent, PROFILE.SECTION_STATISTICS_SCORES_RANKED_AVGPOINTS, PROFILE.PROFILE_PARAMS_TOOLTIP_RANKED_AVGPOINTS, b'rankStageFactor40x32.png', PUtils.createToolTipData(avgPointsTooltipData)),
         packAvgDmgLditItemData(self._avgDmg),
         packAvgXPLditItemData(self._avgXP))
