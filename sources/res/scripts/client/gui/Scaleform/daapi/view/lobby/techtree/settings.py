...
__all__ = (b'NODE_STATE', b'RequestState', b'SelectedNation', b'UnlockProps', b'DEFAULT_UNLOCK_PROPS', b'BpfProps', b'_DEFAULT_BPF_PROPS', b'VehicleClassInfo', b'MAX_PATH_LIMIT', b'RESEARCH_ITEMS', b'TREE_SHARED_REL_FILE_PATH', b'NATION_TREE_REL_FILE_PATH')
TREE_SHARED_REL_FILE_PATH = b'gui/flash/techtree/tree-shared.xml'
NATION_TREE_REL_FILE_PATH = b'gui/flash/techtree/{}-tree.xml'
NATION_TREE_REL_PREMIUM_FILE_PATH = b'gui/flash/techtree/{}-premium.xml'
