...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOBBY_MISSIONS, MissionsPage, b'missionsPage.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_MISSIONS, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LOBBY_MISSION_DETAILS, MissionDetailsContainerView, b'missionsDetails.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.LOBBY_MISSION_DETAILS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BROWSER_VIEW, EventBoardsDetailsBrowserView, b'eventBoardsDetails.swf', WindowLayer.TOP_SUB_VIEW, EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_VEHICLES_VIEW, EventBoardsDetailsVehiclesView, b'eventBoardsDetails.swf', WindowLayer.TOP_SUB_VIEW, EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_VEHICLES_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_AWARDS_VIEW, EventBoardsDetailsAwardsView, b'eventBoardsDetails.swf', WindowLayer.TOP_SUB_VIEW, EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_AWARDS_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BATTLE_VIEW, EventBoardsDetailsBattleView, b'eventBoardsDetails.swf', WindowLayer.TOP_SUB_VIEW, EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BATTLE_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ...
     GroupedViewSettings(QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS, MissionsFilterPopoverView, b'missionsFilterPopoverView.swf', WindowLayer.WINDOW, QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS, QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS, MissionsTokenPopover, b'missionsTokenPopover.swf', WindowLayer.WINDOW, QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS, QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.VEHICLES_FILTER_POPOVER, VehiclesFilterPopover, b'vehiclesFiltersPopoverView.swf', WindowLayer.WINDOW, VIEW_ALIAS.VEHICLES_FILTER_POPOVER, VIEW_ALIAS.VEHICLES_FILTER_POPOVER, ScopeTemplates.DEFAULT_SCOPE))
...
class MissionsPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __loadMissionsPageOrUpdateCurrentTab(self, event):
        ...
        if subView and subView.getCurrentTabAlias() == event.ctx.get(b'tab'):
            tabAlias = subView.getCurrentTabAlias()
            if tabAlias == QUESTS_ALIASES.MISSIONS_PREMIUM_VIEW_PY_ALIAS and b'subTab' in event.ctx:
                subView.currentTab.setDefaultTab(event.ctx[b'subTab'])
