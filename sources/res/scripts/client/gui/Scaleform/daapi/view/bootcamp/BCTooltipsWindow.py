...
class BCTooltipsWindow(BCTooltipsWindowMeta):
    ...
    def __init__(self, settings):
        ...
        self.__completed = settings[b'completed']
        self.__hideCallback = settings[b'hideCallback']
        self._tooltip_id = settings[b'id']
        return
    ...
    @logOnMatch(objProperty=b'tooltip_id', matches=HANGAR_HINTS_TO_LOG_ON_COMPLETE)
