...
class RankedBattlesSeasonCompleteView(RankedBattlesSeasonCompleteViewMeta):
    ...
    def _populate(self):
        ...
        if self._quest is not None and self._awards is not None:
            ...
            logging.error(b'Wrong ctx! Quest and awards must be defined!')
        return
    ...
    def __setData(self):
        ...
        if season is not None:
            ...
            _logger.warning(b'Try to show RankedBattlesSeasonCompleteView, but season is None. Params: %s %s', seasonID, league)
        return
