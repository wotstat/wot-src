...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.WAITING, WaitingView, b'waiting.swf', WindowLayer.WAITING, None, ScopeTemplates.GLOBAL_SCOPE),
     ComponentSettings(VIEW_ALIAS.REPORT_BUG, ReportBugPanel, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.SIMPLE_DIALOG, SimpleDialog, b'simpleDialog.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DYNAMIC_SCOPE, isModal=True, canDrag=False),
     GroupedViewSettings(VIEW_ALIAS.BUTTON_DIALOG, ButtonDialog, b'buttonDialog.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DYNAMIC_SCOPE, isModal=True, canDrag=False),
     GroupedViewSettings(VIEW_ALIAS.SETTINGS_WINDOW, SettingsWindow, b'settingsWindow.swf', WindowLayer.TOP_WINDOW, b'settingsWindow', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
     ViewSettings(VIEW_ALIAS.GAMMA_WIZARD, GammaWizardView, b'gammaWizard.swf', WindowLayer.FULLSCREEN_WINDOW, VIEW_ALIAS.GAMMA_WIZARD, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.COLOR_SETTING, ColorSettingsView, b'colorSettings.swf', WindowLayer.FULLSCREEN_WINDOW, VIEW_ALIAS.COLOR_SETTING, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_EXECUTION_CHOOSER, ExecutionChooserDialog, b'BCDialogWindow.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DYNAMIC_SCOPE, isModal=True),
     GroupedViewSettings(VIEW_ALIAS.ACOUSTIC_POPOVER, AcousticPopover, b'acousticPopover.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.ACOUSTIC_POPOVER, VIEW_ALIAS.ACOUSTIC_POPOVER, SETTINGS_WINDOW_SCOPE))
