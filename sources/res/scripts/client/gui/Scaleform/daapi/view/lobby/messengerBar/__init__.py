...
def getContextMenuHandlers():
    ...
    return (
     ...
     (
      CONTEXT_MENU_HANDLER_TYPE.APPEAL_CHANNEL_LIST, AppealChannelListContextMenuHandler))
...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(VIEW_ALIAS.NOTIFICATIONS_LIST, NotificationListView, b'notificationsList.swf', WindowLayer.WINDOW, b'notificationsList', VIEW_ALIAS.NOTIFICATIONS_LIST, ScopeTemplates.WINDOW_VIEWED_MULTISCOPE),
