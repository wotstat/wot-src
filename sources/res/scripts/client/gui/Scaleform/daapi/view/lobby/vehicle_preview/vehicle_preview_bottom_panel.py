...
_ButtonState = namedtuple(b'_ButtonState', (b'enabled', b'itemPrice', b'label', b'icon', b'iconAlign', b'isAction', b'actionTooltip', b'tooltip', b'title', b'isMoneyEnough', b'isUnlock', b'isPrevItemsUnlock', b'customOffer', b'isShowSpecial'))
...
class VehiclePreviewBottomPanel(VehiclePreviewBottomPanelMeta):
    ...
    def setPanelTextData(self, title=b'', buttonLabel=None, uniqueVehicleTitle=None, hideBuyBlock=False):
    ...
    def setOffers(self, offers, title, description=b''):
    ...
    def __updateBtnState(self, *_):
        ...
        if item is None:
            ...
            if self.__hideBuyBlock:
                buyingPanelData.update({b'isBuyingAvailable': False, 
                   b'isMoneyEnough': True, 
                   b'buyButtonEnabled': False, 
                   b'buyButtonLabel': b'', 
                   b'buyButtonTooltip': b'', 
                   b'itemPrice': None, 
                   b'isUnlock': False, 
                   b'showAction': False, 
                   b'warning': b''})
