    ...
    def registerFlashComponent(self, component, alias, *args):
        if alias == VIEW_ALIAS.PROFILE_TAB_NAVIGATOR:
            super(ProfileWindow, self).registerFlashComponent(component, alias, self.__userName, self.__databaseID, self.__databaseID, {b'selectedAlias': (self.__selectedAlias), 
               b'tabBarData': [
                             self.__getSectionDataObject(PROFILE.SECTION_SUMMARY_TITLE, PROFILE.PROFILE_TABS_TOOLTIP_SUMMARY, VIEW_ALIAS.PROFILE_TOTAL_PAGE, b'ProfileTotalPage_UI', b'statsSummary'),
                             self.__getSectionDataObject(PROFILE.SECTION_ADVANCEDACHIEVEMENTS_TITLE, PROFILE.PROFILE_TABS_TOOLTIP_ADVANCEDACHIEVEMENTS, VIEW_ALIAS.PROFILE_ACHIEVEMENTS_PAGE, b'ProfileTotalPage_UI', b'statsAchievements'),
                             self.__getSectionDataObject(PROFILE.SECTION_AWARDS_TITLE, PROFILE.PROFILE_TABS_TOOLTIP_AWARDS, VIEW_ALIAS.PROFILE_AWARDS, b'ProfileAwards_UI', b'statsAwards'),
                             self.__getSectionDataObject(PROFILE.SECTION_STATISTICS_TITLE, PROFILE.PROFILE_TABS_TOOLTIP_STATISTICS, VIEW_ALIAS.PROFILE_STATISTICS, b'ProfileStatistics_UI', b'statsStatistics'),
                             self.__getSectionDataObject(PROFILE.SECTION_TECHNIQUE_TITLE, PROFILE.PROFILE_TABS_TOOLTIP_TECHNIQUE, VIEW_ALIAS.PROFILE_TECHNIQUE_WINDOW, b'ProfileTechniqueWindow_UI', b'statsTechnique')]}, {b'eventOwner': (self.__eventOwner)})
        else:
