...
def getUnsuitable2queueTooltip(validationResult, resPath, **kwargs):
    ...
    if validationResult.restriction == PRE_QUEUE_RESTRICTION.LIMIT_LEVEL:
        ...
        typeSubStr = text_styles.neutral(validationResult.ctx[b'forbiddenType'])
        ...
        classSubStr = text_styles.neutral(getTypeUserName(validationResult.ctx[b'forbiddenClass'], False))
