...
EventShortcut = namedtuple(b'EventShortcut', (b'title', b'action', b'icon'))
EventShortcut.__new__.__defaults__ = (None, None, None)
_CMD_LOCALE_PFX = b'#ingame_help:chatShortcuts/'
SHORTCUTS_EVENT = (
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_1', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_1),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_2', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_2),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_3', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_3),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_4', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_4),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_5', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_5),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_6', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_6),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_7', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_7),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_1_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_1_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_2_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_2_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_3_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_3_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_4_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_4_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_5_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_5_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_6_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_6_EX),
 EventShortcut(title=_CMD_LOCALE_PFX + b'event_chat_7_ex', action=BATTLE_CHAT_COMMAND_NAMES.EVENT_CHAT_7_EX))
PAGE_DEFAULT = (
