...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(VIEW_ALIAS.CREW_OPERATIONS_POPOVER, CrewOperationsPopOver, b'crewOperationsPopOver.swf', WindowLayer.WINDOW, b'crewOperationsPopOver', VIEW_ALIAS.CREW_OPERATIONS_POPOVER, ScopeTemplates.WINDOW_VIEWED_MULTISCOPE),)
