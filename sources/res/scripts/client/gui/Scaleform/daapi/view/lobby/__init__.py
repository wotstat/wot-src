...
def getViewSettings():
    ...
    return (
     ...
     ViewSettings(VIEW_ALIAS.LOBBY_VEHICLE_MARKER_VIEW, LobbyVehicleMarkerView, b'lobbyVehicleMarkerView.swf', WindowLayer.MARKER, VIEW_ALIAS.LOBBY_VEHICLE_MARKER_VIEW, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BATTLE_QUEUE, BattleQueue, b'battleQueue.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.BATTLE_QUEUE, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.LOBBY_CUSTOMIZATION, CustomizationMainView, b'customizationMainView.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_CUSTOMIZATION, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.MAPBOX_INFO_OVERLAY, MapBoxInfoOverlay, b'browserScreen.swf', WindowLayer.FULLSCREEN_WINDOW, VIEW_ALIAS.MAPBOX_INFO_OVERLAY, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.CLAN_SUPPLY_INFO_VIEW, ClanSupplyInfoView, b'browserScreen.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.CLAN_SUPPLY_INFO_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     GroupedViewSettings(VIEW_ALIAS.BATTLE_RESULTS, BattleResultsWindow, b'battleResults.swf', WindowLayer.WINDOW, b'BattleResultsWindow', None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.POST_BATTLE_RESULTS, PostBattleResultsWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.POST_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     GroupedViewSettings(VIEW_ALIAS.LEGAL_INFO_TOP_WINDOW, LegalInfoWindow, b'legalInfoWindow.swf', WindowLayer.TOP_WINDOW, b'legalInfoWindow', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
     ...
     GroupedViewSettings(VIEW_ALIAS.VEHICLE_BUY_WINDOW, VehicleBuyWindow, b'vehicleBuyWindow.swf', WindowLayer.TOP_WINDOW, b'vehicleBuyWindow', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False),
