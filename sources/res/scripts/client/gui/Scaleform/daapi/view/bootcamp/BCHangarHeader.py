...
class BCHangarHeader(HangarHeader):
    ...
    def _getCommonQuestsToHeaderVO(self, vehicle):
        return [
         self._wrapQuestGroup(HANGAR_HEADER_QUESTS.QUEST_GROUP_COMMON, b'', [
          self._headerQuestFormatterVo(enable=True, icon=RES_ICONS.MAPS_ICONS_LIBRARY_OUTLINE_QUESTS_AVAILABLE, label=b'', questType=HANGAR_HEADER_QUESTS.QUEST_TYPE_COMMON, flag=RES_ICONS.MAPS_ICONS_LIBRARY_HANGARFLAG_FLAG_BLUE)])]
