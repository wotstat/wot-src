...
class _StyleBuyingPanelView(ViewImpl):
    __slots__ = (b'__style', b'__ordPrice', b'__dynPrice', b'__level', b'__buyParams')
    ...
    def _getCallbacks(self):
        return (((b'stats.{}').format(c), self.__updateVMData) for c in Currency.ALL)
...
def _buyRequestConfirmation(productName, priceStr, key=b'buyConfirmation'):
