...
class MissionsFilterPopoverView(MissionsFilterPopoverViewMeta):
    ...
    def __getInitialVO(self):
        dataVO = {b'titleLabel': (text_styles.highTitle(QUESTS.MISSIONS_FILTER_POPOVER_TITLE)), 
           b'hideDoneLabel': (_ms(QUESTS.MISSIONS_FILTER_POPOVER_HIDEDONE)), 
           b'hideUnavailableLabel': (_ms(QUESTS.MISSIONS_FILTER_POPOVER_HIDEUNAVAILABLE)), 
           b'defaultButtonLabel': (_ms(QUESTS.MISSIONS_FILTER_POPOVER_DEFAULTBUTTON_LABEL)), 
           b'defaultButtonTooltip': (makeTooltip(QUESTS.MISSIONS_FILTER_POPOVER_DEFAULTBUTTON_HEADER, QUESTS.MISSIONS_FILTER_POPOVER_DEFAULTBUTTON_BODY))}
        return dataVO
