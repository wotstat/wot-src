...
class VehicleInfoWindow(VehicleInfoMeta):
        ...
        if vehicle is None:
            ...
            for slotIdx, tankman in vehicle.crew:
                ...
                if tankman is not None:
                    ...
                    tankmanLabel = b'%s %s' % (tankman.rankUserName, lastUserName)
                tankmenParams.append({b'tankmanType': (getRoleUserName(role)), 
    ...
    def __packParams(self, paramsList):
        ...
        for name, value in paramsList:
            paramVO = {b'name': (overridedNamesMap.get(name, name)), b'value': value}
