...
def getViewSettings():
    ...
    return (
     GroupedViewSettings(PREBATTLE_ALIASES.SEND_INVITES_WINDOW_PY, SendInvitesWindow, b'sendInvitesWindow.swf', WindowLayer.WINDOW, b'', PREBATTLE_ALIASES.SEND_INVITES_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True, isCentered=False),
     GroupedViewSettings(PREBATTLE_ALIASES.AUTO_INVITE_WINDOW_PY, invite_windows.AutoInviteWindow, b'receivedInviteWindow.swf', WindowLayer.WINDOW, b'receivedInviteWindow', None, ScopeTemplates.DEFAULT_SCOPE, True, isCentered=False),
     GroupedViewSettings(PREBATTLE_ALIASES.BATTLE_SESSION_ROOM_WINDOW_PY, BattleSessionWindow, b'battleSessionWindow.swf', WindowLayer.WINDOW, b'', PREBATTLE_ALIASES.BATTLE_SESSION_ROOM_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True, isCentered=False),
     GroupedViewSettings(PREBATTLE_ALIASES.BATTLE_SESSION_LIST_WINDOW_PY, BattleSessionList, b'battleSessionList.swf', WindowLayer.WINDOW, b'', PREBATTLE_ALIASES.BATTLE_SESSION_LIST_WINDOW_PY, ScopeTemplates.DEFAULT_SCOPE, True, isCentered=False),
     GroupedViewSettings(VIEW_ALIAS.SQUAD_PROMO_WINDOW, SquadPromoWindow, b'squadPromoWindow.swf', WindowLayer.WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.SWITCH_PERIPHERY_WINDOW, SwitchPeripheryWindow, b'switchPeripheryWindow.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE),
     GroupedViewSettings(VIEW_ALIAS.SWITCH_PERIPHERY_WINDOW_MODAL, SwitchPeripheryWindow, b'switchPeripheryWindow.swf', WindowLayer.TOP_WINDOW, b'', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canDrag=False))
...
class _PrbPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __showAutoInviteWindow(self, event):
        ...
        name = getViewName(PREBATTLE_ALIASES.AUTO_INVITE_WINDOW_PY, event.ctx.get(b'prbID'))
        self.loadViewWithDefName(alias, name, None, event.ctx)
        return
