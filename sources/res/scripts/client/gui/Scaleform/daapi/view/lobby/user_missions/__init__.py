...
def getViewSettings():
    return (
     ViewSettings(VIEW_ALIAS.USER_MISSIONS_HUB_CONTAINER, UserMissionsHubContainerView, b'userMissionsHubContainer.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.USER_MISSIONS_HUB_CONTAINER, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.CHALLENGES_INFO, ChallengesInfoBrowserView, b'browserScreen.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.CHALLENGES_INFO, ScopeTemplates.LOBBY_SUB_SCOPE))
