...
VehicleModules = namedtuple(b'VehicleModules', [38, 39, 40, 41, 42])
...
_VehicleAllModulesBase = namedtuple(b'VehicleAllModulesBase', [38, 45, 46, 47, 48])
