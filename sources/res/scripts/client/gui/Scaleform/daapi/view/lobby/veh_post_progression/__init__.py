...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.VEH_POST_PROGRESSION, VehiclePostProgressionCfgView, b'vehPostProgressionView.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.VEH_POST_PROGRESSION, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.VEH_POST_PROGRESSION_CMP, VehiclePostProgressionCmpView, b'vehPostProgressionCmpView.swf', WindowLayer.TOP_SUB_VIEW, VIEW_ALIAS.VEH_POST_PROGRESSION_CMP, ScopeTemplates.LOBBY_SUB_SCOPE),
