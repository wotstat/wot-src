...
_CAROUSEL_FILTERS = (b'bonus', b'favorite', b'elite', b'premium')
if constants.IS_KOREA:
    _CAROUSEL_FILTERS += (b'igr',)
...
class CarouselEnvironment(CarouselEnvironmentMeta, IGlobalListener, ICarouselEnvironment):
    ...
    def _populate(self):
        ...
        self.applyFilter()
        self.updateAviability()
        self.as_setInitDataS({b'counterCloseTooltip': (makeTooltip(body=b'#tooltips:tanksFilter/counter/close/body'))})
        return
