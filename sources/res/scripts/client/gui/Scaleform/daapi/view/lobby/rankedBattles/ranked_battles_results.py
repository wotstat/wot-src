...
class RankedBattlesResults(RankedBattlesBattleResultsMeta):
    ...
    __slots__ = (b'__rankedResultsVO', b'__rankInfo', b'__questsProgress', b'__showRankedWidget__currentRanks', b'__currentRankID', b'__lastRankID', b'__lastMaxRankID')
    ...
    def __init__(self, ctx=None):
        ...
        self.__showRankedWidget = self.__rankedResultsVO.get(b'showWidgetAnimation', True)
