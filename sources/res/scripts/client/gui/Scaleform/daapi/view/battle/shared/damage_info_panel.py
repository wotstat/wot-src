...
_DEVICE_NAME_TO_ID = {b'gunHealth': (DAMAGE_INFO_PANEL_CONSTS.GUN), 
   ...
   b'leftTrack1Health': (DAMAGE_INFO_PANEL_CONSTS.SECOND_LEFT_TRACK), 
   b'rightTrack1Health': (DAMAGE_INFO_PANEL_CONSTS.SECOND_RIGHT_TRACK), 
...
_DEVICE_HIDE_METHODS = {(DAMAGE_INFO_PANEL_CONSTS.GUN): b'as_hideGunS', 
   ...
   (DAMAGE_INFO_PANEL_CONSTS.SECOND_LEFT_TRACK): b'as_hideSecondLeftTrackS', 
   (DAMAGE_INFO_PANEL_CONSTS.RIGHT_TRACK): b'as_hideRightTrackS', 
   (DAMAGE_INFO_PANEL_CONSTS.SECOND_RIGHT_TRACK): b'as_hideSecondRightTrackS', 
...
_DEVICE_UPDATE_METHODS = {(DAMAGE_INFO_PANEL_CONSTS.GUN): b'as_updateGunS', 
   ...
   (DAMAGE_INFO_PANEL_CONSTS.SECOND_LEFT_TRACK): b'as_updateSecondLeftTrackS', 
   (DAMAGE_INFO_PANEL_CONSTS.RIGHT_TRACK): b'as_updateRightTrackS', 
   (DAMAGE_INFO_PANEL_CONSTS.SECOND_RIGHT_TRACK): b'as_updateSecondRightTrackS', 
