...
_GREEN_ICONS_BY_POI_TYPE = {(PoiType.ARTILLERY): (
                       _LINKS.POI_GREEN_ARTILLERY_ICON, _LINKS.POI_GREEN_ARTILLERY_SMALL_ICON), 
   (PoiType.RECON): (
                   _LINKS.POI_GREEN_RECON_ICON, _LINKS.POI_GREEN_RECON_SMALL_ICON), 
   (PoiType.SMOKE): (
                   _LINKS.POI_GREEN_SMOKE_ICON, _LINKS.POI_GREEN_SMOKE_SMALL_ICON), 
   (PoiType.MINEFIELD): (
                       _LINKS.POI_GREEN_MINEFIELD_ICON, _LINKS.POI_GREEN_MINEFIELD_SMALL_ICON)}
_ORANGE_ICONS_BY_POI_TYPE = {(PoiType.ARTILLERY): (
                       _LINKS.POI_ORANGE_ARTILLERY_ICON, _LINKS.POI_ORANGE_ARTILLERY_SMALL_ICON), 
   (PoiType.RECON): (
                   _LINKS.POI_ORANGE_RECON_ICON, _LINKS.POI_ORANGE_RECON_SMALL_ICON), 
   (PoiType.SMOKE): (
                   _LINKS.POI_ORANGE_SMOKE_ICON, _LINKS.POI_ORANGE_SMOKE_SMALL_ICON), 
   (PoiType.MINEFIELD): (
                       _LINKS.POI_ORANGE_MINEFIELD_ICON, _LINKS.POI_ORANGE_MINEFIELD_SMALL_ICON)}
...
class PointOfInterestSN(TimerSN):
    ...
    def _setIconName(self, iconName, iconSmallName):
        self._vo[b'iconName'] = iconName
        self._vo[b'iconSmallName'] = iconSmallName
        return
...
class PoICapturingInterruptedSN(PointOfInterestSN):
    ...
    def _getTimeParams(self, value):
        ...
        if blockReason is not None:
            ...
            _logger.error(b'Attempt to get time for PoICapturingInterruptedSN with no reason for it')
            return (None, None)
