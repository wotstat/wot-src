...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.BOOTCAMP_INTRO_VIDEO, BCIntroVideoPage, b'BCIntroVideo.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_BATTLE_PAGE, BCBattlePage, b'BCbattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_INTRO_FADEOUT, BCIntroFadeOut, b'BCIntroFadeOut.swf', WindowLayer.WINDOW, None, ScopeTemplates.TOP_WINDOW_SCOPE),
     ViewSettings(VIEW_ALIAS.BOOTCAMP_BATTLE_HIGHLIGHTS, BCHighlights, b'BCHighlights.swf', WindowLayer.WINDOW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.BOOTCAMP_PREBATTLE_HITNS, BCPrebattleHints, b'BCPrebattleHints.swf', WindowLayer.WINDOW, None, ScopeTemplates.DEFAULT_SCOPE),
...
class BootcampPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        ...
        listeners = (
         (
          VIEW_ALIAS.BOOTCAMP_BATTLE_PAGE, self.__loadPage),
         (
    ...
    def __onShowIntro(self, event):
        LOG_DEBUG_DEV_BOOTCAMP(b'onShowIntro', event.name, event.ctx)
    ...
    def __onHighlightHint(self, event):
        hintWindow = self.findViewByAlias(WindowLayer.WINDOW, VIEW_ALIAS.BOOTCAMP_BATTLE_HIGHLIGHTS)
        LOG_DEBUG_DEV_BOOTCAMP(b'onHighlightHint', hintWindow, event.ctx)
