...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.EVENT_BATTLE_PAGE, EventBattlePage, b'eventBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.EVENT_LOADING, EventLoadingPage, b'eventLoading.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.TOP_WINDOW_SCOPE),
