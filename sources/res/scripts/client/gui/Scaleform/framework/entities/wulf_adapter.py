...
class WulfPackageLayoutAdapter(object):
    __slots__ = (b'__window', b'__loadID', b'__sfWindow', b'__key', b'__scope', b'__settings', b'__eManager', b'__app', b'__isDestroyed', b'onCreated', b'onDispose', b'onDisposed', b'onWulfViewLoaded', b'onWulfViewLoadError', b'__background_alpha__')
    ...
    def initWindow(self, windowClass, *args, **kwargs):
        ...
        if hasattr(window, b'__background_alpha__'):
    ...
    def __repr__(self):
        return (b'{} (key = {}, settings = {}, window = {}, isDestroyed = {})').format(self.__class__.__name__, self.__key, self.__settings, self.__window, self.__isDestroyed)
