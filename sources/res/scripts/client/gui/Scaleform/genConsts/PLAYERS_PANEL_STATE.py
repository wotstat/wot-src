class PLAYERS_PANEL_STATE(object):
    ...
    EXTENDED_STATES = [EPIC_RANDOM_THREE_COLUMN_HIDDEN, EPIC_RANDOM_THREE_COLUMN_SHORT, EPIC_RANDOM_THREE_COLUMN_MEDIUM_PLAYER, 
     EPIC_RANDOM_THREE_COLUMN_MEDIUM_TANK, EPIC_RANDOM_THREE_COLUMN_SHORT_SECOND_FOCUS, 
     EPIC_RANDOM_THREE_COLUMN_MEDIUM_PLAYER_SECOND_FOCUS, EPIC_RANDOM_THREE_COLUMN_MEDIUM_TANK_SECOND_FOCUS, 
     EPIC_RANDOM_THREE_COLUMN_SHORT_THIRD_FOCUS, EPIC_RANDOM_THREE_COLUMN_MEDIUM_PLAYER_THIRD_FOCUS, 
     EPIC_RANDOM_THREE_COLUMN_MEDIUM_TANK_THIRD_FOCUS, EPIC_RANDOM_THREE_COLUMN_BUTTON]
    BASE_STATES = [SHORT, MEDIUM, LONG, FULL]
    BASE_STATES_NO_BADGES = [SHORT_NO_BADGES, MEDIUM_NO_BADGES, LONG_NO_BADGES, FULL_NO_BADGES]
    NEVER_SHOW_HP = 22
    ALWAYS_SHOW_HP = 23
    SHOW_HP_ON_ALT = 24
