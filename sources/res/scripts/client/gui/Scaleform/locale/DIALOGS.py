...
class DIALOGS(object):
    ...
    RESETBATTLECONTEXTHINTSNOTIFICATION_TITLE = b'#dialogs:resetBattleContextHintsNotification/title'
    RESETBATTLECONTEXTHINTSNOTIFICATION_MESSAGE = b'#dialogs:resetBattleContextHintsNotification/message'
    RESETBATTLECONTEXTHINTSNOTIFICATION_MESSAGE_ALERT = b'#dialogs:resetBattleContextHintsNotification/message/alert'
    RESETBATTLECONTEXTHINTSNOTIFICATION_MESSAGE_CAPTION = b'#dialogs:resetBattleContextHintsNotification/message/caption'
    RESETBATTLECONTEXTHINTSNOTIFICATION_SUBMIT = b'#dialogs:resetBattleContextHintsNotification/submit'
    RESETBATTLECONTEXTHINTSNOTIFICATION_CANCEL = b'#dialogs:resetBattleContextHintsNotification/cancel'
    ...
    VOICECHATINITFAILEDBYOS_TITLE = b'#dialogs:voiceChatInitFailedByOS/title'
    VOICECHATINITFAILEDBYOS_MESSAGE = b'#dialogs:voiceChatInitFailedByOS/message'
    VOICECHATINITFAILEDBYOS_CANCEL = b'#dialogs:voiceChatInitFailedByOS/cancel'
