class BATTLE_HINTS(object):
    ...
    CONTEXTHINT_CONSUMABLESPANEL_AMMORELOADPREPARE = b'#battle_hints:contextHint/consumablesPanel/ammoReloadPrepare'
    CONTEXTHINT_CONSUMABLESPANEL_AMMORELOADCONFIRM = b'#battle_hints:contextHint/consumablesPanel/ammoReloadConfirm'
    ...
    INFOBATTLECONTEXTHINT_AMMOTYPEAVAILABLE = b'#battle_hints:infoBattleContextHint/AmmoTypeAvailable'
