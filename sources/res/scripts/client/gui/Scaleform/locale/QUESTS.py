...
class QUESTS(object):
    ...
    MISSIONS_TAB_LIVE_OPS_WEB_EVENTS = b'#quests:missions/tab/live_ops_web_events'
    ...
    BONUSES_BPTALER_DESCRIPTION = b'#quests:bonuses/bptaler/description'
    ...
    BONUSNAME_WDRCOIN = b'#quests:bonusName/wdrcoin'
    BONUSES_GOLDPERSONALRATE = b'#quests:bonuses/goldPersonalRate'
    BONUSES_FREEXPPERSONALRATE = b'#quests:bonuses/freeXpPersonalRate'
    ...
    DETAILS_CONDITIONS_VEHICLEBLOCKEDBYARMOR_TITLE = b'#quests:details/conditions/vehicleBlockedByArmor/title'
    ...
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED = b'#quests:details/conditions/directHitsReceived'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_NEGATIVE = b'#quests:details/conditions/directHitsReceived/negative'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_ALL = b'#quests:details/conditions/directHitsReceived/all'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_ALL_NEGATIVE = b'#quests:details/conditions/directHitsReceived/all/negative'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_EVENTCOUNT = b'#quests:details/conditions/directHitsReceived/eventCount'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_EVENTCOUNT_NEGATIVE = b'#quests:details/conditions/directHitsReceived/eventCount/negative'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_EVENTCOUNT_ALL = b'#quests:details/conditions/directHitsReceived/eventCount/all'
    DETAILS_CONDITIONS_DIRECTHITSRECEIVED_EVENTCOUNT_ALL_NEGATIVE = b'#quests:details/conditions/directHitsReceived/eventCount/all/negative'
    DETAILS_CONDITIONS_DAMAGEDEALT = b'#quests:details/conditions/damageDealt'
    DETAILS_CONDITIONS_DAMAGEDEALT_NOT = b'#quests:details/conditions/damageDealt/not'
    DETAILS_CONDITIONS_DAMAGEDEALT_ALL = b'#quests:details/conditions/damageDealt/all'
    DETAILS_CONDITIONS_DAMAGEDEALT_ALL_NOT = b'#quests:details/conditions/damageDealt/all/not'
    DETAILS_CONDITIONS_WHILEMOVINGATSPEED = b'#quests:details/conditions/whileMovingAtSpeed'
    DETAILS_CONDITIONS_WHILEMOVINGATSPEED_ALL = b'#quests:details/conditions/whileMovingAtSpeed/all'
    DETAILS_CONDITIONS_WHILEMOVINGATSPEED_EVENTCOUNT = b'#quests:details/conditions/whileMovingAtSpeed/eventCount'
    DETAILS_CONDITIONS_WHILEMOVINGATSPEED_EVENTCOUNT_ALL = b'#quests:details/conditions/whileMovingAtSpeed/eventCount/all'
    DETAILS_CONDITIONS_VEHICLEKILLS_WHILEMOVINGATSPEED = b'#quests:details/conditions/vehicleKills/whileMovingAtSpeed'
    DETAILS_CONDITIONS_VEHICLEKILLS_WHILEMOVINGATSPEED_ALL = b'#quests:details/conditions/vehicleKills/whileMovingAtSpeed/all'
    DETAILS_CONDITIONS_WHILEENEMYINVISIBLE = b'#quests:details/conditions/whileEnemyInvisible'
    DETAILS_CONDITIONS_WHILEENEMYINVISIBLE_ALL = b'#quests:details/conditions/whileEnemyInvisible/all'
    DETAILS_CONDITIONS_WHILEENEMYINVISIBLE_EVENTCOUNT = b'#quests:details/conditions/whileEnemyInvisible/eventCount'
    DETAILS_CONDITIONS_WHILEENEMYINVISIBLE_EVENTCOUNT_ALL = b'#quests:details/conditions/whileEnemyInvisible/eventCount/all'
    DETAILS_CONDITIONS_VEHICLEKILLS_WHILEENEMYINVISIBLE = b'#quests:details/conditions/vehicleKills/whileEnemyInvisible'
    DETAILS_CONDITIONS_VEHICLEKILLS_WHILEENEMYINVISIBLE_ALL = b'#quests:details/conditions/vehicleKills/whileEnemyInvisible/all'
    DETAILS_CONDITIONS_ENEMYISNOTSPOTTED = b'#quests:details/conditions/enemyIsNotSpotted'
    DETAILS_CONDITIONS_ENEMYISNOTSPOTTED_ALL = b'#quests:details/conditions/enemyIsNotSpotted/all'
    DETAILS_CONDITIONS_ENEMYISNOTSPOTTED_EVENTCOUNT = b'#quests:details/conditions/enemyIsNotSpotted/eventCount'
    DETAILS_CONDITIONS_ENEMYISNOTSPOTTED_EVENTCOUNT_ALL = b'#quests:details/conditions/enemyIsNotSpotted/eventCount/all'
    DETAILS_CONDITIONS_VEHICLEKILLS_ENEMYISNOTSPOTTED = b'#quests:details/conditions/vehicleKills/enemyIsNotSpotted'
    DETAILS_CONDITIONS_VEHICLEKILLS_ENEMYISNOTSPOTTED_ALL = b'#quests:details/conditions/vehicleKills/enemyIsNotSpotted/all'
    DETAILS_CONDITIONS_BEYONDVISIONRADIUS = b'#quests:details/conditions/beyondVisionRadius'
    DETAILS_CONDITIONS_BEYONDVISIONRADIUS_ALL = b'#quests:details/conditions/beyondVisionRadius/all'
    DETAILS_CONDITIONS_BEYONDVISIONRADIUS_EVENTCOUNT = b'#quests:details/conditions/beyondVisionRadius/eventCount'
    DETAILS_CONDITIONS_BEYONDVISIONRADIUS_EVENTCOUNT_ALL = b'#quests:details/conditions/beyondVisionRadius/eventCount/all'
    DETAILS_CONDITIONS_VEHICLEKILLS_BEYONDVISIONRADIUS = b'#quests:details/conditions/vehicleKills/beyondVisionRadius'
    DETAILS_CONDITIONS_VEHICLEKILLS_BEYONDVISIONRADIUS_ALL = b'#quests:details/conditions/vehicleKills/beyondVisionRadius/all'
    DETAILS_CONDITIONS_SPOTENEMY = b'#quests:details/conditions/spotEnemy'
    DETAILS_CONDITIONS_SPOTENEMY_ALL = b'#quests:details/conditions/spotEnemy/all'
    DETAILS_CONDITIONS_VEHICLEBLOCKEDBYARMOR_WHILESTILL = b'#quests:details/conditions/vehicleBlockedByArmor/whileStill'
    DETAILS_CONDITIONS_VEHICLEBLOCKEDBYARMOR_WHILESTILL_ALL = b'#quests:details/conditions/vehicleBlockedByArmor/whileStill/all'
    DETAILS_CONDITIONS_CLASSES_LIGHTTANK = b'#quests:details/conditions/classes/lightTank'
    DETAILS_CONDITIONS_CLASSES_MEDIUMTANK = b'#quests:details/conditions/classes/mediumTank'
    DETAILS_CONDITIONS_CLASSES_HEAVYTANK = b'#quests:details/conditions/classes/heavyTank'
    DETAILS_CONDITIONS_CLASSES_SPG = b'#quests:details/conditions/classes/SPG'
    DETAILS_CONDITIONS_CLASSES_AT_SPG = b'#quests:details/conditions/classes/AT-SPG'
    DETAILS_CONDITIONS_ENUMERATE_OR = b'#quests:details/conditions/enumerate/or'
    ...
    DETAILS_CONDITIONS_CUMULATIVE_FACTUALXP = b'#quests:details/conditions/cumulative/factualXP'
    ...
    DETAILS_DOSSIER_MEDALCARIUS = b'#quests:details/dossier/medalCarius'
    DETAILS_DOSSIER_MEDALKNISPEL = b'#quests:details/dossier/medalKnispel'
    ...
    DETAILS_DOSSIER_MEDALWITTMANN = b'#quests:details/dossier/medalWittmann'
    ...
    DETAILS_DOSSIER_MEDALHALONEN = b'#quests:details/dossier/medalHalonen'
    ...
    DETAILS_DOSSIER_MEDALBRUNOPIETRO = b'#quests:details/dossier/medalBrunoPietro'
    DETAILS_DOSSIER_MEDALTARCZAY = b'#quests:details/dossier/medalTarczay'
    DETAILS_DOSSIER_MEDALPASCUCCI = b'#quests:details/dossier/medalPascucci'
    DETAILS_DOSSIER_MEDALDUMITRU = b'#quests:details/dossier/medalDumitru'
    DETAILS_DOSSIER_MEDALLEHVASLAIHO = b'#quests:details/dossier/medalLehvaslaiho'
    ...
    DETAILS_DOSSIER_MEDALTAMADAYOSHIO = b'#quests:details/dossier/medalTamadaYoshio'
    ...
    DETAILS_DOSSIER_44_BATTLESCOUNT = b'#quests:details/dossier/44/battlesCount'
    DETAILS_DOSSIER_49_BATTLESCOUNT = b'#quests:details/dossier/49/battlesCount'
    ...
    MISSIONS_TAB_LIVE_OPS_WEB_EVENTS_BODY = b'#quests:missions/tab/live_ops_web_events/body'
    MISSIONS_TAB_LIVE_OPS_WEB_EVENTS_HEADER = b'#quests:missions/tab/live_ops_web_events/header'
    ...
    TOKEN_DEFAULT_COMP7_LIGHT = b'#quests:token/default/comp7_light'
    ...
    BONUSNAME_ATTACHMENT = b'#quests:bonusName/attachment'
    BONUSNAME_STATTRACKER = b'#quests:bonusName/statTracker'
    ...
    BONUSNAME_PERSONAL_MISSIONS_POINTS_PREVIEW = b'#quests:bonusName/personal_missions_points/preview'
    BONUSNAME_BRCOIN = b'#quests:bonusName/brcoin'
    BONUSNAME_STPCOIN = b'#quests:bonusName/stpcoin'
    ...
    BONUSNAME_EXCLUDED_MAPS = b'#quests:bonusName/excluded_maps'
    ...
    BONUSNAME_EXCLUSIVE_VEHICLES = b'#quests:bonusName/exclusive_vehicles'
    BONUSNAME_ATTENDANCE_REWARD = b'#quests:bonusName/attendance_reward'
    BONUSNAME_PRO_BOOST = b'#quests:bonusName/pro_boost'
    BONUSNAME_SERVICE_RECORD_CUSTOMIZATION = b'#quests:bonusName/service_record_customization'
    BONUSNAME_BATTLE_PASS_PLUS = b'#quests:bonusName/battle_pass_plus'
    BONUSNAME_TOURCOIN = b'#quests:bonusName/tourcoin'
    BONUSNAME_INDUSTRIALRESOURCE = b'#quests:bonusName/industrialResource'
    BONUSNAME_BPTALER = b'#quests:bonusName/bptaler'
    BONUSNAME_BATTLE_BONUSES = b'#quests:bonusName/battle_bonuses'
    BONUSNAME_BADGES = b'#quests:bonusName/badges'
    BONUSNAME_ADDITIONAL_BONUSES = b'#quests:bonusName/additional_bonuses'
    BONUSNAME_OPTIONAL_DEVICES_ASSISTANT = b'#quests:bonusName/optional_devices_assistant'
    BONUSNAME_ATTACHMENTS_SET_DEFAULT = b'#quests:bonusName/attachments_set/default'
    BONUSNAME_ATTACHMENTS_SET_OCEANICSENTINEL = b'#quests:bonusName/attachments_set/oceanicSentinel'
    BONUSNAME_ATTACHMENTS_SET_CHALLENGERSBOUNTY = b'#quests:bonusName/attachments_set/challengersBounty'
    BONUSNAME_ATTACHMENTS_SET_SEARCHANDDESTROY = b'#quests:bonusName/attachments_set/searchAndDestroy'
    BONUSNAME_ATTACHMENTS_SET_AERIALADVANCE = b'#quests:bonusName/attachments_set/aerialAdvance'
    BONUSNAME_ATTACHMENTS_SET_AIRDEFENSESUITE = b'#quests:bonusName/attachments_set/airDefenseSuite'
    BONUSNAME_ATTACHMENTS_SET_OPBCT = b'#quests:bonusName/attachments_set/OpBCt'
    ...
    PERSONALMISSION_STATUS_NOTSTARTEDREQUIRED = b'#quests:personalMission/status/notStartedRequired'
    ...
    DAILYQUESTS_POSTBATTLE_EPIC_DESCRIPTION = b'#quests:dailyQuests/postBattle/epic/description'
    ...
    DAILYQUESTS_POSTBATTLE_CONDITIONTYPEAND = b'#quests:dailyQuests/postBattle/conditionTypeAnd'
    DAILYQUESTS_POSTBATTLE_CONDITIONTYPEOR = b'#quests:dailyQuests/postBattle/conditionTypeOr'
    ...
    DAILYQUESTS_CONDITION_DODAMAGEVEH_SINGULAR_ACCUM = b'#quests:dailyQuests/condition/doDamageVeh_singular_accum'
    ...
    DAILYQUESTS_CONDITION_BATTLE_SINGULAR = b'#quests:dailyQuests/condition/battle_singular'
    ...
    LOCKEDFORREROLLTOOLTIP_HEADER = b'#quests:lockedForRerollTooltip/header'
    LOCKEDFORREROLLTOOLTIP_BODY = b'#quests:lockedForRerollTooltip/body'
    TOKEN_DEFAULT_ENUM = (
     TOKEN_DEFAULT_USSR,
