...
class AgateRequestHandlers(RequestHandlers):
    ...
    def __getInventoryEntitlements(self, ctx, callback):
        return self._requester.doRequestEx(ctx, callback, (b'agate', b'get_inventory_entitlements'), entitlement_codes=ctx.getEntitlementCodes())

    def __getInventoryEntitlementsV5(self, ctx, callback):
        return self._requester.doRequestEx(ctx, callback, (b'agate', b'get_inventory_entitlements_v5'), entitlementsFilter=ctx.getEntitlementsFilter())
