...
class WotShopRequestHandlers(RequestHandlers):
    ...
    def __getStorefrontProducts(self, ctx, callback):
        return self._requester.doRequestEx(ctx, callback, (b'wot_shop', b'get_storefront_products'), ctx)

    def __buyStorefrontProduct(self, ctx, callback):
        return self._requester.doRequestEx(ctx, callback, (b'wot_shop', b'buy_storefront_product'), ctx)
