...
class BattlePassStateMachine(StateMachine):
    __slots__ = (b'__rewards', b'__data', b'__rewardsToChoose', b'__packageRewards', b'__starterPack', b'__chapterStyle', b'__manualFlow')
    ...
    def __hasVideo(self, *_):
        return self.__hasStyleReward() or self.__data is not None and self.__data.get(b'needVideo', False)
