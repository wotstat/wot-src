    ...
    def __setBonuses(self, bonuses):
        with self.getViewModel().transaction() as tx:
            ...
            for index, reward in enumerate(bonuses):
                ...
                self.__items[index] = TooltipData(tooltip=ttTarget.get(b'tooltip', None), isSpecial=ttTarget.get(b'isSpecial', False), specialAlias=ttTarget.get(b'specialAlias', b''), specialArgs=ttTarget.get(b'specialArgs', None))
