...
class BattleMattersHintsHelper(object):
    ...
    __slots__ = (b'__hints', b'__hasHintListeners', b'__battleMattersController')
...
class _BMManualTriggeredHint(object):
    ...
    _HINT_NAME = None
    CONTROL_NAME = None
    __slots__ = (b'_isStarted', b'_battleMattersController', b'_isHintVisible', b'_controlOnScene', b'_controlIsEnabled')
...
class EntryPointHint(_BMManualTriggeredHint):
    ...
    CONTROL_NAME = b'BattleMattersEntryPoint'
    ...
    def _getHintSettings():
        return {b'updateRuntime': True, 
           b'hintText': (backport.text(R.strings.battle_matters.entryPoint.hint())), 
           b'hasArrow': True, 
           b'arrowDir': b'B', 
           b'arrowLoop': True, 
           b'positionValue': 0.5}
