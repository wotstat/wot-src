...
class BattleMattersFilterPopoverView(PopOverViewImpl):
    ...
    def onToggleFilter(self, event):
        changesFromEvent = {b'Types': (event.get(BattleMattersFilterPopoverViewModel.ARG_CONTROL_TYPE, {})), 
           b'Nations': (event.get(BattleMattersFilterPopoverViewModel.ARG_CONTROL_NATION, {}))}
