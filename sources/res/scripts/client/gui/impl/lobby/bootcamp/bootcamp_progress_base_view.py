...
class BootcampProgressBaseView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.bootcamp.RewardsTooltip():
            return RewardsTooltip(self.bootcampController.needAwarding())
        return super(BootcampProgressBaseView, self).createToolTipContent(event=event, contentID=contentID)

    def __getProgressBarItem(self, tooltipArgs):
        return {b'tooltipArgs': tooltipArgs}

    def __getProgressBarItems(self):
        if g_bootcamp.getVersion() == BootcampVersion.SHORT:
            return [
             self.__getProgressBarItem([
              BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_1, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_1]),
             self.__getProgressBarItem([
              BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_2,
              BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_2_SHORT])]
        return [
         self.__getProgressBarItem([
          BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_1, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_1]),
         self.__getProgressBarItem([
          BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_2, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_2]),
         self.__getProgressBarItem([
          BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_3, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_3]),
         self.__getProgressBarItem([
          BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_4, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_4]),
         self.__getProgressBarItem([
          BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_LESSON_5, BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_5])]
    ...
    def __fillProgressBar(self, viewModel):
        ...
        viewModel.setTotalLessons(g_bootcamp.getContextIntParameter(b'lastLessonNum'))
        ...
        for index, lessonRaw in enumerate(progressBarItems):
            ...
            self.__tooltipData[lessonNumber] = createTooltipData(isSpecial=True, specialAlias=TOOLTIPS_CONSTANTS.BOOTCAMP_LESSON_PROGRESS, specialArgs=lessonRaw[b'tooltipArgs'] + [status])
