...
class CompareAmmunitionSelectorView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.tanksetup.tooltips.SetupTabTooltipView():
            return SetupTabTooltipView(event.getArgument(b'name', b''))
        else:
    ...
    def _onLoading(self, selectedSection=b'', selectedSlot=None):
