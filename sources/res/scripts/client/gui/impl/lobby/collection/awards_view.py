...
class AwardsView(ViewImpl):
    __slots__ = (b'__collectionId', b'__bonuses', b'__isFinal', b'__tooltips', b'__content')
    ...
    def _getEvents(self):
        return (
         ...
         (
          self.viewModel.onCloseCollection, self.__closeCollection),
         (
    ...
    def __generateContentData(self):
        ...
        return [makeImageID(Group.BG, collection.name, b'bgAwards')]
    ...
    def __fillBackground(self):
        collection = self.__collectionsSystem.getCollection(self.__collectionId)
        self.viewModel.setBackground(self.__getContent(Group.BG, collection.name, b'bgAwards'))
        return
