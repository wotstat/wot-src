...
class CollectionsMainView(ViewImpl):
    __slots__ = (b'__wasFirstActivation',)
    ...
    def __openCollection(self, args):
        ...
        collection = self.__collectionsSystem.getCollection(int(args.get(b'collectionId')))
        showCollectionWindow(collection.collectionId)
        return

    def __setCompletionShown(self, args):
        setShownCompletedCollection(int(args.get(b'collectionId')))
        self.__updateData()
        return

    def __setShownNewCollection(self, args):
        setLastShownNewCollection(int(args.get(b'collectionId')))
        self.__updateData()
        return
