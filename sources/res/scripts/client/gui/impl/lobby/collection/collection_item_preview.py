...
class CollectionItemPreview(ViewImpl):
    __slots__ = (b'__itemId', b'__collectionId', b'__page', b'__collection', b'__backCallback', b'__backBtnText', b'__content', b'__pagesCount')
    ...
    def __fillPagesBlurredBackgrounds(self, model=None):
        ...
        for _ in range(1, self.__pagesCount + 1):
            ...
            pageBg = self.__getContent(Group.BG, self.__collection.name, b'bgMain')
            if pageBg:
    ...
    def __generateContentData(self):
        return [makeImageID(Group.BG, self.__collection.name, b'bgMain')]
