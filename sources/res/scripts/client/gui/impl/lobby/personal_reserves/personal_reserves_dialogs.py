...
class BuyAndActivateBoosterDialogBuilder(ResDialogBuilder):
    __slots__ = (b'boosterPrice', b'needsToBuy', b'warning')
    ...
    def setWarning(self, warning):
        ...
        self.warning = b'%(warning)' + warning
        return
    ...
    def _extendTemplate(self, template):
        ...
        if self.warning:
            image = ImageSubstitution(R.images.gui.maps.icons.personal_reserves.warning(), b'warning', 0, 0, 0, 0)
...
class BuyGoldDialogBuilder(ResDialogBuilder):
    __slots__ = (b'boosterPrice', b'warning')
