...
class CampaignService(ICampaignService):
    ...
    def __tryToUpdateBanner(self):
        if self.__isBannerVisible():
            ...
            pm3BannerData = {b'id': (self.pm3bannerMap.get(pm3BannerOperationID)), 
               b'startDate': b'01.01.2020 00:00', 
               b'endDate': b'24.09.2025 23:59', 
               b'weightConfig': b'PM3EntryPoint'}
