...
class MultipleAwardsView(ViewImpl):
    ...
    __slots__ = (b'__tooltipItems', b'__vehicleIntCD', b'__offer')
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if event.contentID == R.views.common.tooltip_window.loot_box_compensation_tooltip.LootBoxVehicleCompensationTooltipContent():
            ...
            _logger.warning(b"Couldn't find corresponded tooltip! tooltipId=%s", str(tooltipId))
                ...
                if rewardItemID:
                    ...
                    if rewardItemName in SupportedTokenTypes.ALL():
                        ...
                        if offer:
                            ...
                            _logger.warning(b"Couldn't get offer by tokenID = %s", str(rewardItemID))
                    elif rewardItemName == b'vehicles' or rewardItemName == b'vehicles_rent':
