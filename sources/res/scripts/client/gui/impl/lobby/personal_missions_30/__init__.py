...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.CAMPAIGN_SELECTOR, CampaignSelectorWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.CAMPAIGN_SELECTOR, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.PERSONAL_MISSIONS_3, PersonalMissions3Window, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.PERSONAL_MISSIONS_3, ScopeTemplates.LOBBY_SUB_SCOPE))
