...
class WinbackSelectableBonus(SimpleBonus):
    ...
    def getLevel(self):
        return int(self._value.get(b'level', b'1'))

    def getToken(self):
        return self._value.get(b'token')
...
class WinbackVehicleBonus(SimpleBonus):
    ...
    def getCrewLevel(self, vehCD):
        return self._getVehData(vehCD).get(b'crewLvl', -1)
    ...
    def getUnlockModules(self, vehicleCD):
        return self._getVehData(vehicleCD).get(b'unlockModules', [])
