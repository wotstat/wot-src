...
BrowserViewSettings = typing.NamedTuple(b'BrowserViewSettings', (
 (
  b'url', str),
 (
  b'webHandlers', typing.Optional[webApiCollection]),
 (
  b'isClosable', bool),
 (
  b'useSpecialKeys', bool),
 (
  b'allowRightClick', bool),
 (
  b'viewFlags', int),
 (
  b'restoreBackground', bool),
 (
  b'waitingMessageID', int),
 (
  b'disabledKeys', typing.Iterable[typing.Tuple[str, bool, bool, bool, bool]]),
 (
  b'soundSpaceID', typing.Optional[str]),
 (
  b'returnClb', typing.Optional[typing.Callable])))
...
class BrowserView(Browser[BrowserViewModel]):
    __slots__ = (b'__settings', b'__closedByUser', b'__forceClosed', b'__savedBackAlpha')
    ...
    def _finalize(self):
        ...
        if returnCallback is not None:
            returnCallback(byUser=self.__closedByUser, url=self.browser.url if self.browser else b'', forceClosed=self.__forceClosed)
