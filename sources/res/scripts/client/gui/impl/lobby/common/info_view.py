...
class ContentData(typing.NamedTuple(b'_ContentData', (
 (
  b'clazz', typing.Type), (b'modelClazz', typing.Type),
 (
  b'args', typing.Tuple), (b'kwargs', typing.Dict)))):
...
class _InfoWindowProcessor(IInfoWindowProcessor):
    __slots__ = (b'layoutID', b'contentData', b'uiStorageKey', b'wndFlags')
