...
class RecruitContent(object):
    __slots__ = (b'__viewModel', b'__selectedNationID', b'__selectedNation', b'__selectedVehType', b'__selectedVehicle', b'__selectedSpecialization', b'onRecruitContentChanged', b'__isFemale', b'__predefinedNations', b'__predefinedRoles', b'__vehIntCD', b'__slotSpecialization', b'__isSlotChanged')
