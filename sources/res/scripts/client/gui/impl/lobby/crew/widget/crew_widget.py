...
class CrewWidget(ViewImpl):
    __slots__ = (b'__toolTipMgr', b'__currentViewID', b'__previousViewID', b'__currentTankman', b'__currentVehicle', b'onSlotClick', b'__currentSlotIdx', b'onChangeCrewClick', b'onSlotTrySelect', b'__isButtonBarVisible', b'__uiLogger', b'_cachePossibleSkillsLevels')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.SKILL:
                args = [
                 event.getArgument(b'skillName'), int(event.getArgument(b'tankmanID'))]
            ...
            if tooltipId == TooltipConstants.TANKMAN:
                args = (
                 self.getParentWindow(), event.getArgument(b'tankmanID'))
    ...
    def createPopOverContent(self, event):
        args = {b'tankmenIds': (getRetrainTankmenIds(self.__currentVehicle)), b'vehicleCD': (self.__currentVehicle.intCD)}
    ...
    def _getEvents(self):
        return (
         (
          self.viewModel.onSlotClick, self.__onSlotClick),
         (
    ...
    def __onVehicleDossierUpdate(self, diff=None):
        ...
        if self.__currentVehicle:
            ...
            layoutIndexes = diff.get(b'layoutIndexes', {})
    ...
    def __buildConfirmationMessage(self):
        ...
        message = None
        if previousVehicle:
            vehicleName = (b'{} {}').format(int2roman(previousVehicle.level), previousVehicle.userName)
            ...
            finalString = (b'{} {}').format(removeTypeString, removeNameString)
