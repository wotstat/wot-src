...
class CrewPerksTooltip(ViewImpl):
    ...
    __slots__ = (b'_skillName', b'_tankman', b'_tankmanVehicle', b'_skill', b'_descrArgs', b'_skillLevel', b'_skillBooster', b'_isCommonExtraAvailable', b'_showAdditionalInfo')
