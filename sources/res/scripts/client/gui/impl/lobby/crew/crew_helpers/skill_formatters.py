...
class SkillLvlFormatter(object):
    ...
    __slots__ = (b'__skillLvl', b'__residual', b'__lvlCost')
    ...
    def __str__(self):
        return (b'SkillLvlFormatter(skillLvl={}, residual={}, lvlCost={})').format(self.__skillLvl, self.__residual, self.__lvlCost)

    def __repr__(self):
        return (b'<{}>').format(self.__str__())
