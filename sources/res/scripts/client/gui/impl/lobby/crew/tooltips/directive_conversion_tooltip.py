...
class DirectiveConversionTooltip(ViewImpl):
    ...
    __slots__ = (b'__oldDirective', b'__newDirective', b'__amount')
    ...
    def __init__(self, **kwargs):
        ...
        self.__oldDirective = self._itemsCache.items.getItemByCD(kwargs.get(b'oldDirectiveID'))
        self.__newDirective = self._itemsCache.items.getItemByCD(kwargs.get(b'newDirectiveID'))
        self.__amount = kwargs.get(b'amount')
