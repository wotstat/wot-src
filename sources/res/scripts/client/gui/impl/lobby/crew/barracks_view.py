...
class BarracksView(BaseTankmanListView):
    ...
    __slots__ = (b'__dataProviders', b'__filterState', b'__hasFilters', b'__filterPanelWidget', b'__berthPrice', b'__berthsInPack', b'__defaultBerthPrice', b'__tankmenStatsCache', b'__recruitsForVisit')
    ...
    def __init__(self, layoutID=R.views.lobby.crew.BarracksView(), *args, **kwargs):
        ...
        self.__filterState = FilterState(initialState={(FilterState.GROUPS.TANKMANKIND.value): (TankmanKind.RECRUIT.value if self.__hasFilters else TankmanKind.TANKMAN.value)}, persistor=Persistor(storageKey=b'barracks', persistentGroups=[
    ...
    def _tankmenProvider(self):
        return self.__dataProviders[b'tankmen']

    @property
    def _recruitsProvider(self):
        return self.__dataProviders[b'recruits']
    ...
    def _getCallbacks(self):
        return (
         ...
         (
          b'potapovQuests', self.__onNewRecruits))
