...
def loadSortingOrderType():
    ...
    _logger.warning(b"Couldn't load setting because PersonalFileView is not found!")
    return 0
...
def saveSortingOrderType(sortingType):
    ...
    if personalFileView:
        ...
        _logger.warning(b"Couldn't save setting because PersonalFileView is not found!")
    return
