...
class PremiumVehicleTooltip(ViewImpl):
    __slots__ = (b'__vehType', b'__nation')
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as model:
            model.setVehTypeName(backport.text(R.strings.crew.premiumVehType.plural.lowerCase.base.dyn(self.__vehType.replace(b'-', b'_'))()))
