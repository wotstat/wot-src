...
class FilterState(object):
    ...
    def __repr__(self):
        return (b'{0}<initialState={1!r}, state={2!r}, searchString={3!r}, isWotPlus={4!r}, persistor={5!r}>').format(self.__class__.__name__, self._initialState, self._state, self.__searchString, self._isWotPlus, self._persistor)
...
class Persistor(object):
    ...
    def __repr__(self):
        return (b'{0}<storageKey={1!r}, persistentGroups={2!r}, excludeKeys={3!r}>').format(self.__class__.__name__, self.__key, self.__persistentGroups, self.__excludeKeys)
