...
class RetrainSingleDialog(BaseCrewDialogTemplateView):
    __slots__ = (b'_tankman', b'_vehicle', b'_priceListContent', b'_roles', b'_targetRole', b'_isChangeRoleVisible', b'_beforeActions', b'_isRoleChangeForced', b'_lastChangeRoleChecked', b'_toolTipMgr', b'_targetSlotIdx', b'_originalTargetSlotIdx', b'_nativeTankmanRoles')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.SKILLS_EFFICIENCY:
                args = (
                 event.getArgument(b'tankmanInvId'), event.getArgument(b'skillEfficiency'))
