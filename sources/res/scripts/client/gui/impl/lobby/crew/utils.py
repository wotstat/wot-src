...
class TRAINING_TIPS(CONST_CONTAINER):
    CHOOSE_ANY_CREW_MEMBER = b'chooseAnyCrewMember'
    MAXED_CREW_MEMBERS = b'maxedCrewMembers'
    ENOUGH_EXPERIENCE = b'enoughExperience'
    NOT_SUITABLE_CREW = b'notSuitableCrew'
    NOT_ALL_CURRENT_CREW = b'notAllCurrentCrew'
