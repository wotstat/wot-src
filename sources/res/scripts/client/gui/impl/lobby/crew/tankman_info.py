...
class TankmanInfo(BaseCrewSoundView):
    __slots__ = (b'_tankman', b'_tankmanCurrentVehicle', b'_voiceoverParams', b'_retrainPrice', b'_toolTipMgr', b'_uiLogger', b'__sound')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.SKILL:
                args = [
                 str(event.getArgument(b'skillName')), self._tankman.invID, event.getArgument(b'level', None),
                 False, True, self.getParentWindow()]
            ...
            if tooltipId == TooltipConstants.TANKMAN:
                args = (
                 self.getParentWindow(), self._tankman.invID)
    ...
    def _getEvents(self):
        return (
         (
          self.viewModel.onPlayUniqueVoice, self.__onPlayUniqueVoice),
         (
    ...
    def __onRetrain(self):
        ...
        yield th_await(showRetrainDialog([
