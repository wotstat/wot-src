...
class CommanderBonusAdditionalTooltip(ViewImpl):
    ...
    def _fillModel(self):
        with self.viewModel.transaction() as vm:
            ...
            commanderBonus = int(self._tankman.vehicleBonuses.get(b'commander', 10) if self._tankman else DEF_COMMANDER_BONUS)
