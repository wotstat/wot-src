...
class CrewMemberRoleChangeDialog(BaseCrewDialogTemplateView):
    __slots__ = (b'_tankman', b'_vehicleCurrent', b'_vehicleNew', b'_currentSpecializationVehicle', b'_role', b'_isTankChange', b'_isSpecializationChange', b'_priceSubView')
