...
class MentorAssigmentView(BaseCrewView, BaseTankmanListView):
    ...
    __slots__ = (b'__dataProvider', b'__filterState', b'__filterPanelWidget', b'__nation', b'__vehicleInvID', b'__tankmanInvID', b'__tankman', b'__hasActiveCard', b'__parent', b'__isDefaultTipVisible', b'__isDefaultTipShown')
    ...
    def __init__(self, layoutID=R.views.lobby.crew.MentorAssigmentView(), *args, **kwargs):
        ...
        self.__parent = kwargs.get(b'parent')
        self.__tankmanInvID = kwargs.get(b'tankmanInvID', NO_TANKMAN)
        self.__tankman = None
        self.__vehicleInvID = kwargs.get(b'vehicleInvID', NO_VEHICLE_ID)
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TOOLTIPS_CONSTANTS.MENTOR_ASSIGNMENT:
                ...
                targetTmanID = event.getArgument(b'targetTmanId')
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.MENTOR_FULLY_TRAINED:
                ...
                return ExtendedTextTooltip(text, json.dumps({b'name': (self._tankman.getFullUserNameWithSkin())}))
    ...
    def _finalize(self):
        if self.__parent and callable(getattr(self.__parent, b'setSelectedTman', None)):
    ...
    def _getCallbacks(self):
        return (
         ...
         (
          b'goodies', self.__onGoodiesUpdate))
