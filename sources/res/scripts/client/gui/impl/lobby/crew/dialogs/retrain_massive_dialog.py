...
class RetrainMassiveDialog(BaseCrewDialogTemplateView):
    __slots__ = (b'_tankmen', b'_vehicle', b'_selectedTankmenIds', b'_priceListContent', b'_toolTipMgr', b'_retrainCost')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.SKILLS_EFFICIENCY:
                isShowDiscount = True
                args = (event.getArgument(b'tankmanInvId'), event.getArgument(b'skillEfficiency'), isShowDiscount)
    ...
    def _updateTankmen(self, vm):
        isApplicableForTankmen = self._priceListContent.selectedOperationData[b'isPriceApplicable']
        skillEfficienciesAfter = self._priceListContent.selectedOperationData[b'skillEfficiencies']
        tankmenVL = vm.getTankmen()
        self._selectedTankmenIds = []
    ...
    def _updatePrice(self, vm, idx):
        ...
        if price is None or itemPrice is None:
            return
        goldSum, creditsSum = getPriceDiscountMassRetrain(idx, priceData[b'isPriceApplicable'], self._tankmen)
    ...
    def _retrainTankmen(self):
        ...
        goldSum, creditsSum = getPriceDiscountMassRetrain(retrainKey, priceData[b'isPriceApplicable'], self._tankmen)
