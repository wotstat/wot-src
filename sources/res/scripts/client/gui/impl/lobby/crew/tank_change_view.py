...
class TankChangeView(BaseCrewView):
    __slots__ = (b'__dataProvider', b'__filterState', b'__tankman', b'__vehicle', b'__selectedTmanInvID', b'_filterPanelWidget')
    ...
    def __init__(self, layoutID, **kwargs):
        ...
        self.__selectedTmanInvID = kwargs.get(b'tankmanInvID', NO_TANKMAN)
        self.__tankman = None
        self.__vehicle = None
    ...
    def getTooltipData(event):
        return backport.createTooltipData(specialAlias=event.getArgument(b'tooltipId'), isSpecial=True, specialArgs=(
         event.getArgument(b'vehicleCD'),))
    ...
    def _getCallbacks(self):
        return (
         ...
         (
          b'inventory.8.compDescr', self._onVehicleUpdated))
