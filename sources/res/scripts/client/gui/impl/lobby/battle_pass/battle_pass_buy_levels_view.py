...
class BattlePassBuyLevelView(ViewImpl):
    __slots__ = (b'__package', b'__tooltipItems', b'__backCallback', b'__backBtnDescrLabel', b'__tooltipWindow', b'__chapterID')
    ...
    def __init__(self, ctx):
        ...
        self.__backCallback = ctx.get(b'backCallback')
        self.__tooltipItems = {}
        self.__tooltipWindow = None
        self.__chapterID = ctx.get(b'chapterID')
    ...
    def __onChangeSelectedLevels(self, args):
        self.__updateConfirmAnyNumberModel(args.get(b'count'))
        return
