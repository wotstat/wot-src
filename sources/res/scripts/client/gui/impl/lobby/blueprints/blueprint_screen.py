...
class BlueprintScreen(ViewImpl):
    ...
    __slots__ = (b'__vehicle', b'__xpCost', b'__fullXpCost', b'__discount', b'__convertedIndexes', b'__exitEvent', b'__accountSettings')
    ...
    def __init__(self, viewKey, viewModelClazz=BlueprintScreenModel, ctx=None):
        ...
        self.__vehicle = self.__itemsCache.items.getItemByCD(ctx.get(b'vehicleCD', None))
        self.__exitEvent = ctx.get(b'exitEvent') if ctx is not None else None
        self.__xpCost = 0
        self.__fullXpCost = 0
        self.__discount = 0
    ...
    def _finalize(self):
        ...
        if self.__exitEvent is not None:
            ...
            storageFilter[b'scroll_to'] = None
    ...
    def __addListeners(self):
        g_clientUpdateManager.addCallbacks({b'stats.unlocks': (self.__onUnlockVehicle), 
           b'stats.freeXP': (self.__onUpdateXP), 
           b'stats.vehTypeXP': (self.__onUpdateXP), 
