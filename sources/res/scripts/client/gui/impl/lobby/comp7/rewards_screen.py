...
class _BaseRewardsView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if _LOOTBOX_RES.exists() and contentID == _LOOTBOX_RES():
            ...
            lootBoxID = tooltipData.tooltip.get(b'lootBoxID')
...
class RanksRewardsView(_BaseRewardsView):
    __slots__ = (b'__division', b'__periodicQuests')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__periodicQuests = kwargs.get(b'periodicQuests', [])
        return
