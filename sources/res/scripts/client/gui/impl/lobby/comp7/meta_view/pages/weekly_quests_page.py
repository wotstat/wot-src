...
class WeeklyQuestsPage(PageSubModelPresenter):
    __slots__ = (b'__quests', b'__bonusData', b'__questsTimer')
    ...
    def __getPeriodState(self):
        ...
        if periodInfo.cycleBorderRight.delta(currentTime) < time_utils.ONE_WEEK:
            return SeasonState.LASTWEEK
    ...
    def __updateQuests(self, model):
        ...
        def parseQuestID(questID):
            return int(questID.split(b'_')[-1])
