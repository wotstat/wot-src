...
_DEFAULT_PREVIEW_VEHICLE_TYPE = b'uk:GB91_Super_Conqueror'

class RankRewardsPage(PageSubModelPresenter):
    __slots__ = (b'__bonusData', b'__rankQuests', b'__periodicQuests')
    ...
    def __parseQuestsByDivision(quests, parser, questType):
        ...
        for q in quests:
            ...
            if division is not None:
                ...
                _logger.error(b'Division number could not be parsed - %s', q.getID())
