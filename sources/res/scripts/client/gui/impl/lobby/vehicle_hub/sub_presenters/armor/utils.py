...
LEFT_TRACK = b'leftTrack'
RIGHT_TRACK = b'rightTrack'
SURVEYING_DEVICE = b'surveyingDevice'
...
class MaterialUIData(object):
    __slots__ = (b'partName', b'nominalArmor', b'viewAngle', b'resArmor', b'color', b'count', b'isSpacedArmor')

    def __init__(self, partName, viewAngle, isSpacedArmor, nominalArmor, resArmor=None, color=b'', count=1):
...
def applyNormalizationForArmor(hitAngleCos, armorValue, matInfo, normalizationAngle, shellCaliber):
    if normalizationAngle <= MIN_HIT_ANGLE_COS or hitAngleCos >= 1.0:
        ...
        return resultCos
    if getattr(matInfo, b'checkCaliberForHitAngleNorm', False) and armorValue > MIN_HIT_ANGLE_COS:
...
def _buildStaticMatInfos(vehicle):
    ...
    materialsByPart = {}
    commonMaterialsInfo = vehicles.g_cache.commonConfig[b'materials'].values()
...
MINOR_SHORT_TOOLTIP_DATA = {(MinorShortTooltipTypes.MAIN_ARMOR.value): {b'icon': (R.images.gui.maps.icons.lobby.armor_inspector.main_armor()), 
                                               b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.mainArmor.header())), 
                                               b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.mainArmor.description()))}, 
   (MinorShortTooltipTypes.SPACED_ARMOR.value): {b'icon': (R.images.gui.maps.icons.lobby.armor_inspector.spaced_armor()), 
                                                 b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.spacedArmor.header())), 
                                                 b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.spacedArmor.description()))}, 
   (MinorShortTooltipTypes.DEALING_DAMAGE_CHANCE.value): {b'icon': (R.images.gui.maps.icons.lobby.armor_inspector.damage_chance()), 
                                                          b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.damageChance.header())), 
                                                          b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.damageChance.description()))}, 
   (MinorShortTooltipTypes.NO_DAMAGE.value): {b'icon': (R.images.gui.maps.icons.lobby.armor_inspector.no_damage()), 
                                              b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.noDamage.header())), 
                                              b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.noDamage.description()))}, 
   (MinorShortTooltipTypes.RICOCHET.value): {b'icon': (R.images.gui.maps.icons.lobby.armor_inspector.ricochet()), 
                                             b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.ricochet.header())), 
                                             b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.ricochet.description()))}, 
   (MinorShortTooltipTypes.ATTACKING_CONFIGURATION.value): {b'icon': None, 
                                                            b'header': (backport.text(R.strings.armor_inspector.tooltip.minorShort.attackingConfiguration.header())), 
                                                            b'description': (backport.text(R.strings.armor_inspector.tooltip.minorShort.attackingConfiguration.description()))}}
