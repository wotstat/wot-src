        ...
        with self._viewModel.transaction() as model:
            if self._gift.fromCdn:
                ...
                if formattedBonus is not None:
                    ...
                    self._tooltipData = createTooltipData(tooltip=formattedBonus.get(b'tooltip', None), isSpecial=formattedBonus.get(b'isSpecial', False), specialAlias=formattedBonus.get(b'specialAlias', b''), specialArgs=formattedBonus.get(b'specialArgs', None))
