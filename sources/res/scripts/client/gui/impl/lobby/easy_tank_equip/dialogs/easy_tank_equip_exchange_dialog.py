...
class ExchangeToApplyEasyTankEquip(BuyAndExchange):
    __slots__ = (b'__availableGoldAmount',)

    def __init__(self, *args, **kwargs):
        price = kwargs.pop(b'price', ZERO_MONEY)
        self.__availableGoldAmount = kwargs.pop(b'availableGoldAmount', 0)
    ...
    def _stateToContent(self):
        return {(BuyAndExchangeStateEnum.EXCHANGE_CONTENT): (BuyAndExchangeBottomContentType.EXCHANGE_PANEL), (BuyAndExchangeStateEnum.NEED_EXCHANGE): (BuyAndExchangeBottomContentType.EXCHANGE_PANEL), 
