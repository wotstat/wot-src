...
class PiggyBankBaseView(ViewImpl, SoundViewMixin):
    ...
    __slots__ = (b'_config', b'_data', b'_notifier', b'_isTimerEnabled')
    ...
    def _getIsTimerEnabled(self):
        ...
        credits_ = self._data.get(b'credits', 0)
    ...
    def _onServerSettingsChange(self, diff):
        ...
        elif b'cycleLength' in diffConfig or b'cycleStartTime' in diffConfig:
            self._updateTimerStatus()
        return
