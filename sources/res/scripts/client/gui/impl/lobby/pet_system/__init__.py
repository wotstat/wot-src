...
def getViewSettings():
    return (
     ViewSettings(VIEW_ALIAS.PET_STORAGE, PetStorageViewWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.PET_STORAGE, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.PET_EVENT, EventViewWindow, b'', WindowLayer.WINDOW, VIEW_ALIAS.PET_EVENT, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.PET_EVENT_FULLSCREEN, FullscreenEventViewWindow, b'', WindowLayer.SUB_VIEW, VIEW_ALIAS.PET_EVENT_FULLSCREEN, ScopeTemplates.LOBBY_SUB_SCOPE))
