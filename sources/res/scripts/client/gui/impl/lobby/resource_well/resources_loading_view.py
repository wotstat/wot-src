...
class ResourcesLoadingView(ViewImpl):
    __slots__ = (b'__resources', b'__tooltips')
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.lobby.resource_well.tooltips.MaxProgressTooltip():
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            tooltipData = self.__tooltips[int(event.getArgument(b'tooltipId'))]
    ...
    def _getCallbacks(self):
        return (
         ...
         (
          b'premium', self.__updatePremiums))
