...
class ProgressionView(ViewImpl):
    __slots__ = (b'__notifier', b'__stageNotifier', b'__backCallback')
    ...
    def __showPreview(self, args):
        isStyled = args.get(b'isStyled', False)
        ...
        topPanelData = {b'linkage': (VEHPREVIEW_CONSTANTS.TOP_PANEL_TABS_LINKAGE), 
           ...
           b'currentTabID': (TabID.PERSONAL_NUMBER_VEHICLE if isStyled else TabID.BASE_VEHICLE)}
