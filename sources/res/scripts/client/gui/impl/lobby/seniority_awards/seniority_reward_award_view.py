...
_EXCLUDED_BONUSES = (b'slots', b'vehicles')
_BONUSES_ORDER = ({b'getLabel': _T50_2_STYLE_NAME}, {b'getName': b'crystal'}, {b'getName': b'credits'}, {b'getIcon': b'personalBook'}, {b'getIcon': b'universalBook'}, {b'getName': b'premium_plus'}, {b'getName': b'battle_bonus'}, {b'getName': b'goodies', b'getIcon': b'credits'}, {b'getName': b'goodies', b'getIcon': b'xp'}, {b'getName': b'dossier_badge', b'getLabel': _AT_NICKNAME_BADGE}, {b'getName': b'dossier_badge', b'getLabel': _BT_NICKNAME_BADGE}, {b'getName': b'dossier_badge', b'getLabel': _AT_BADGE}, {b'getName': b'dossier_badge', b'getLabel': _BT_BADGE}, {b'getIcon': b'projectionDecal'}, {b'getName': b'dossier_achievement'}, {b'getName': b'customizations', b'getIcon': b'emblem'}, {b'getName': b'customizations', b'getIcon': b'style'})
...
class SeniorityRewardAwardView(ViewImpl):
    __slots__ = (b'__bonuses', b'__specialCurrencies', b'__tooltipData')
    ...
    def _onLoading(self, data, *args, **kwargs):
        ...
        if data is None:
            _logger.error(b'Rewards data is None')
            return
        else:
