...
class DemountOptionalDeviceDialog(DialogTemplateView):
    __slots__ = (b'__item', b'__forFitting', b'removalPrice', b'__selector', b'__moneyOption')
    ...
    def _getAdditionalData(self):
        dk, _ = getDemountKitForOptDevice(self.__item)
        return {b'useDemountKit': (self._isSelected(DEMOUNT_KIT)), b'openSingleDemountWindow': (dk and not dk.enabled)}
