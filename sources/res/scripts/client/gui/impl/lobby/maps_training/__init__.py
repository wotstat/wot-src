...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.MAPS_TRAINING_BATTLE_RESULTS, MapsTrainingResultWindow, b'', WindowLayer.TOP_WINDOW, VIEW_ALIAS.MAPS_TRAINING_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE, True),)
