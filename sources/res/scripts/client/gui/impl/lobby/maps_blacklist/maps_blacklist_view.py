...
class MapsBlacklistView(ViewImpl):
    ...
    def __showMapConfirmDialog(self, mapId):
        ...
        if result.busy:
            raise SoftException(b'Excluded maps dialog is busy!')
    ...
    def __sendMapChangingRequest(self, mapToSet, mapToChange):
        ...
        cooldown = time_utils.getTillTimeString(serverSettings.getPreferredMapsConfig()[b'slotCooldown'], MENU.MAPBLACKLIST_TIMELEFTSHORT, isMinutesRoundUp=True, removeLeadingZeros=True)
...
class ExcludedMapsTooltip(ViewImpl):
    ...
    def __init__(self):
        ...
        mapsConfig = serverSettings.getPreferredMapsConfig()
        timeLeft = time_formatters.getTillTimeByResource(mapsConfig[b'slotCooldown'], R.strings.premacc.piggyBankCard.timeLeft, removeLeadingZeros=True)
