...
class AdvancedAchievementsView(SubModelPresenter):
    __slots__ = (b'__userId', b'__achievementList', b'__isAnimationInProgress', b'__isWindowOverlapped', b'__uiLogger')
    ...
    def __updatePage(self):
        ...
        with self.viewModel.transaction() as model:
            ...
            model.setCategoryBackgroundName(b'players_collection')
            model.setCategoryName(b'players_collection')
    ...
    def __updateTrophies(self, model):
        ...
        trophyModel.setType(data[b'type'])
        trophyModel.setKey(data[b'key'])
        trophyModel.setBubbles(self.__advAchmntCtrl.getUnseenTrophiesAdvancedAchievementsCount(self.__userId))
        trophyModel.setBackground(data[b'background'])
        trophyModel.setIconPosition(data[b'iconPosition'])
        trophyModel.setIsTrophy(data[b'isTrophy'])
    ...
    def __onAnimationInProgress(self, args):
        self.__isAnimationInProgress = args[b'isAnimationInProgress']
        return
