...
AchievementsViewCtx = namedtuple(b'AchievementsViewCtx', (b'menuName', b'userID'))

class AchievementMainView(ViewImpl):
    __slots__ = (b'__ctx', b'__contentPresentersMap', b'__regionName')
    ...
    def __onClose(self):
        if self.__ctx.userID is None:
            ...
            g_eventBus.handleEvent(events.Achievements20Event(events.Achievements20Event.CLOSE_SUMMARY_VIEW, {b'databaseID': (self.__ctx.userID)}), scope=EVENT_BUS_SCOPE.LOBBY)
        return
