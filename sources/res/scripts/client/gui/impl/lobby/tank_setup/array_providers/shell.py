...
_SHELLS_INFO_PARAMS = ((b'distanceDamage', b'avgDamage'),
 (b'avgPiercingPower',),
 (b'shotSpeed',),
 (b'explosionRadius',),
 (b'flameMaxDistance',),
 (b'stunMaxDuration',))
_DISTANCE_FACTOR_PARAMS = {b'avgPiercingPower': (b'piercingPower', b'distanceFactorPiercingPower'), 
   b'avgDamage': (b'damage', b'distanceFactorDamage'), 
   b'shotSpeed': (b'shotSpeedAccelerated', b'shotSpeedAccelerated')}
_DISTANCE_FACTOR_KEYS = _DISTANCE_FACTOR_PARAMS.keys()

class ShellProvider(VehicleBaseArrayProvider):
    __slots__ = (b'_interactor',)
    ...
    def _getSpecificationsModel(self, paramName, formattedParam):
        ...
        model.setMetricValue(i18n.makeString(MEASURE_UNITS.get(paramName, b'')))
