...
class BaseAmmunitionSetupView(ViewImpl):
    ...
    __slots__ = (b'_ammunitionPanel', b'_tankSetup', b'_vehItem', b'_optionalDevicesAssistant')
    ...
    def _onPanelSelected(self, args):
        sectionName, slotID = args.get(b'selectedSection'), int(args.get(b'selectedSlot'))
        if sectionName:
    ...
    def _onChangeSetupIndex(self, args):
        hudGroupID = int(args.get(b'groupId', None))
