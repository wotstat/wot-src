...
class BaseSetupSubView(BaseSubModelView):
    __slots__ = (b'_interactor', b'_tabsController', b'_provider', b'_filter', b'_curSlotID', b'__slotActions', b'_currentTabName', b'_asyncActionLock')
