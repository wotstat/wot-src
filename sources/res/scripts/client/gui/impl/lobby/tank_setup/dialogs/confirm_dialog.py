...
class TankSetupConfirmDialog(BuyAndExchange):
    __slots__ = (b'__items', b'__vehicleInvID', b'__totalPrice', b'_mainContent', b'_buyContent', b'__startState', b'_itemsType')
    ...
    def __init__(self, *args, **kwargs):
        ...
        vehicle = kwargs.pop(b'vehicle', None)
        ...
        startState = kwargs.pop(b'startState', None)
