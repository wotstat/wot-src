...
class BattleAbilitiesSetupConfirm(FullScreenDialogView):
    __slots__ = (b'__items', b'_mainContent', b'__rollBack', b'__withInstall', b'__uiEpicBattleLogger')

    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.tanksetup.dialogs.Confirm(), model=AmmunitionBuyModel())
        settings.args = args
        settings.kwargs = kwargs
        self.__items = kwargs.pop(b'items', tuple())
        self._mainContent = None
        self.__rollBack = False
        self.__withInstall = kwargs.pop(b'withInstall', False)
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        self.viewModel.setVehicleType(kwargs.get(b'vehicleType', b''))
        self.viewModel.setApplyForAllVehiclesByType(kwargs.get(b'applyForAllVehiclesByType', False))
    ...
    def _getAdditionalData(self):
        return {b'rollBack': (self.__rollBack)}
