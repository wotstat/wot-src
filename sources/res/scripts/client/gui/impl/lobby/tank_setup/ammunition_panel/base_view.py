...
class BaseAmmunitionPanelView(ViewImpl):
    ...
    __slots__ = (b'_ammunitionPanel', b'_wasVehicleOnLoading', b'onPanelSectionResized', b'onVehicleChanged')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            if self._hangarSpace.spaceLoading():
                _logger.warning(b'Failed to get slotData. HangarSpace is currently loading.')
                return
