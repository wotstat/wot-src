...
class BaseRewardWindowContent(ViewImpl):
    ...
    def _initTooltip(self, bonus, index):
        self.__items[index] = TooltipData(tooltip=bonus.get(b'tooltip', None), isSpecial=bonus.get(b'isSpecial', False), specialAlias=bonus.get(b'specialAlias', b''), specialArgs=bonus.get(b'specialArgs', None), isWulfTooltip=bonus.get(b'isWulfTooltip', False))
        return
