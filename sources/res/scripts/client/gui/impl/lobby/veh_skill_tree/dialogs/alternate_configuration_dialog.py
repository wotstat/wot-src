...
_FEATURE_TO_LOADOUT_TYPE = {b'shells_consumables_switch': (alternate_configuration_dialog_loadout_model.LoadoutType.SHELLSCONSUMABLESSWITCH), 
   b'opt_dev_boosters_switch': (alternate_configuration_dialog_loadout_model.LoadoutType.OPTDEVBOOSTERSSWITCH)}
...
class AlternateConfigurationDialog(FullScreenDialogBaseView):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.veh_post_progression.tooltip.SetupTooltipView():
            ...
            eventType = event.getArgument(b'type')
