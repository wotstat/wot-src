...
_NAVIGATION_ACTION_TARGET_KEY = b'name'
_INFO_ACTION_INDEX_KEY = b'index'
...
class NavigationPresenter(ViewComponent[NavigationBarModel], EventsHandler):
    ...
    def __processRouteChange(self, routeInfo):
        ...
        with self.getViewModel().transaction() as model:
            ...
            model.setBackNavigationDescription(routeInfo.backDescription or b'')
    ...
    def __onNavigate(self, navigationAction):
        ...
        if target == NavigationBarModel.BACK_NAVIGATION:
            ...
            _logger.warning(b'Unknown navigation target: %s', target)
        return
    ...
    def __onInfoAction(self, infoAction):
        ...
        if handlerCount > index:
            ...
            _logger.warning(b'Requested info action with index %d, but only %d actions exist!', handlerCount, index)
        return
