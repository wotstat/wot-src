...
class CustomizationConfirmDialog(FullScreenDialogBaseView):
    __slots__ = (b'__dogTagsHelper', b'__composer', b'__backgroundId', b'__engravingId', b'__additionalData', b'__isLocked')
    ...
    def __onConfirm(self):
        if not self.__isLocked:
            self.__additionalData[b'saveChanges'] = True
    ...
    def __onDiscard(self):
        self.__additionalData[b'saveChanges'] = False
        self._setResult(DialogButtons.SUBMIT)
        return
