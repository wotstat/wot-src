...
class PunishmentView(ViewImpl):
    __slots__ = (b'__iconResID', b'__title', b'__text', b'__dimmerAlpha', b'__infoText', b'__reason')
...
class WarningNotificationWindow(AfkLeaverNotification):
    __slots__ = (b'arenaTypeID', b'time', b'reason', b'isAFKViolation')
...
class BanNotificationWindow(AfkLeaverNotification):
    __slots__ = (b'arenaTypeID', b'time', b'duration')
