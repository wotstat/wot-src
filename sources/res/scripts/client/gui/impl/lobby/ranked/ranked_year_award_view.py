    ...
    def __setBonuses(self, bonuses):
        with self.getViewModel().transaction() as tx:
            ...
            for index, reward in enumerate(bonuses):
                ...
                self.__items[index] = TooltipData(tooltip=reward.get(b'tooltip', None), isSpecial=reward.get(b'isSpecial', False), specialAlias=reward.get(b'specialAlias', b''), specialArgs=reward.get(b'specialArgs', None))
