...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.LOOT_BOXES_INTRO_BROWSER_VIEW, LootBoxSystemIntroBrowserView, b'browserScreen.swf', WindowLayer.OVERLAY, VIEW_ALIAS.LOOT_BOXES_INTRO_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LOOT_BOXES_INFO_VIEW, InfoPageWindow, b'', WindowLayer.TOP_WINDOW, VIEW_ALIAS.LOOT_BOXES_INFO_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LOOT_BOXES_MAIN_VIEW, MainWindow, b'', WindowLayer.TOP_WINDOW, VIEW_ALIAS.LOOT_BOXES_MAIN_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.LOOT_BOXES_AUTO_OPEN_VIEW, AutoOpenWindow, b'', WindowLayer.TOP_WINDOW, VIEW_ALIAS.LOOT_BOXES_AUTO_OPEN_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE))
