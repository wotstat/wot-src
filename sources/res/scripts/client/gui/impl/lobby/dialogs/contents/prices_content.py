...
class DialogPricesContent(DialogContent):
    __slots__ = (b'__valueMainCost', b'__iconMainCost', b'__labelMainCost', b'__valueAdditionalCost', b'__iconAdditionalCost', b'__labelAdditionalCost', b'__totalCost', b'__labelTotalCost')
