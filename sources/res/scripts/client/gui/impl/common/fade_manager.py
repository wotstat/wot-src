...
class UseFading(object):
    __slots__ = (b'_hide', b'_show', b'_layer', b'_waitForLayoutReady', b'_currentFunctions', b'_callback')
    ...
    def __call__(self, func):
        ...
        def wrapper(*args, **kwargs):
            if func in self._currentFunctions:
                ...
                try:
                    asyncEvent = AsyncEventWithTimout(b'Got time-out during the fade-in/fade-out animation.')
