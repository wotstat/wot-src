...
class OptDeviceBlock(BaseBlock):
    ...
    def __init__(self, vehicle, currentSection, ctx=None):
        ...
        self._isSpecializationClickable = ctx.get(b'specializationClickable', False) if ctx else False
        return
...
class ShellsBlock(BaseBlock):
    ...
    def _getKeySettings(self):
        return (b'CMD_AMMO_CHOICE_1', b'CMD_AMMO_CHOICE_2', b'CMD_AMMO_CHOICE_3')
...
class ConsumablesBlock(BaseBlock):
    ...
    def _getKeySettings(self):
        return (b'CMD_AMMO_CHOICE_4', b'CMD_AMMO_CHOICE_5', b'CMD_AMMO_CHOICE_6')
...
class BattleAbilitiesBlock(BaseBlock):
    ...
    def createBlock(self, viewModel):
        ...
        viewModel.setType(self._getSectionName())
        vehType = self._vehicle.type.replace(b'-', b'_')
    ...
    def _getKeySettings(self):
        return (b'CMD_AMMO_CHOICE_7', b'CMD_AMMO_CHOICE_8', b'CMD_AMMO_CHOICE_9')
