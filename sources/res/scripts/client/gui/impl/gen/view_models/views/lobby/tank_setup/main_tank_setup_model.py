...
class MainTankSetupModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'consumablesSetup', ConsumablesSetupModel())
        self._addViewModelProperty(b'shellsSetup', ShellsSetupModel())
        self._addViewModelProperty(b'battleBoostersSetup', BattleBoostersSetupModel())
        self._addViewModelProperty(b'optDevicesSetup', OptDevicesSetupModel())
        self._addViewModelProperty(b'frontlineSetup', FrontlineSetupModel())
        self._addStringProperty(b'selectedSetup', b'')
        return
