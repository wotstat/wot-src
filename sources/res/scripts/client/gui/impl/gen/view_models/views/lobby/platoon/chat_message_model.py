...
class ChatMessageModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'playerName', ChatMessagePartModel())
        self._addViewModelProperty(b'timeStamp', ChatMessagePartModel())
        self._addViewModelProperty(b'text', ChatMessagePartModel())
