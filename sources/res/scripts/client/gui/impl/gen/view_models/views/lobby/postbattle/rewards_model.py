...
class RewardsModel(ViewModel):
    __slots__ = (b'onAppliedPremiumBonus',)
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'progressiveReward', ProgressiveRewardModel())
        self._addViewModelProperty(b'expBonus', ExpBonusModel())
        ...
        self._addBoolProperty(b'isPremiumBought', False)
        self._addArrayProperty(b'premiumBonus', Array())
        self.onAppliedPremiumBonus = self._addCommand(b'onAppliedPremiumBonus')
        return
