...
class SelectSlotSpecDialogModel(DialogWithExchange):
    __slots__ = ()
    BUY_NOT_REQUIRED_PANEL = b'buyNotRequiredPanel'
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'changePrice', PriceModel())
        self._addViewModelProperty(b'mainContent', SelectSlotSpecDialogContentModel())
        return
