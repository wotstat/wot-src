...
class CartModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'seasons', CartSeasonsModel())
        self._addViewModelProperty(b'style', CartStyleModel())
        self._addViewModelProperty(b'purchase', CartPurchaseModel())
        self._addViewModelProperty(b'rent', CartRentModel())
        self._addViewModelProperty(b'tutorial', CartTutorialModel())
