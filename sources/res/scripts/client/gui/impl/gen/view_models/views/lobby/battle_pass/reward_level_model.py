...
class RewardLevelModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'freeRewardItems', UserListModel())
        self._addViewModelProperty(b'paidRewardItems', UserListModel())
        self._addNumberProperty(b'level', 0)
        self._addNumberProperty(b'levelPoints', 0)
        self._addBoolProperty(b'isRare', False)
        self._addNumberProperty(b'state', -1)
        self._addBoolProperty(b'needTakeFree', False)
        self._addBoolProperty(b'isFreeRewardChoiceEnabled', False)
        self._addBoolProperty(b'needTakePaid', False)
        self._addBoolProperty(b'isPaidRewardChoiceEnabled', False)
        return
