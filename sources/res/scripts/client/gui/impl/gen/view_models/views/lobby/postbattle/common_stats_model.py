...
class CommonStatsModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'rewards', RewardsModel())
        self._addViewModelProperty(b'generalInfo', GeneralInfoModel())
        self._addViewModelProperty(b'detailedEfficiency', DetailedPersonalEfficiencyModel())
