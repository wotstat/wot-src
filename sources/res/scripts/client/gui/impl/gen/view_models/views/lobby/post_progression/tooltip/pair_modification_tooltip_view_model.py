...
class PairModificationTooltipViewModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'moneyShortage', PriceModel())
        self._addViewModelProperty(b'modifiers', BonusesModel())
        self._addViewModelProperty(b'multiStep', MultiStepModel())
        self._addResourceProperty(b'nameRes', R.invalid())
        self._addNumberProperty(b'level', 0)
        self._addBoolProperty(b'isPriceExist', True)
        self._addBoolProperty(b'showCTABlock', True)
        return
