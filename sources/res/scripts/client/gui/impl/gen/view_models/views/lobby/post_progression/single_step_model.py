...
class SingleStepModel(StepModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'modification', ModificationModel())
        self._addArrayProperty(b'childrenIds', Array())
        self._addBoolProperty(b'isPrebattleSwitchEnabled', True)
        self._addBoolProperty(b'isPrebattleSwitchLocked', False)
        return
