...
class UserAccountModel(ViewModel):
    __slots__ = (b'onOpenAccountDashboard',)
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'userInfo', UserInfoModel())
        self._addViewModelProperty(b'subscriptions', SubscriptionsModel())
        self.onOpenAccountDashboard = self._addCommand(b'onOpenAccountDashboard')
        return
