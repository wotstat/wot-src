...
class MapsBlacklistViewModel(ViewModel):
    __slots__ = (b'onBackAction', b'onCloseEvent', b'onMapAddToBlacklistEvent', b'onMapRemoveFromBlacklistEvent', b'onFilterReset', b'onInitialized', b'onFilterClick', b'onBuyPremiumClick', b'onGetSubscriptionClick')
    ...
    def _initialize(self):
        ...
        self._addBoolProperty(b'isWotPlusEnabled', False)
        ...
        self.onBuyPremiumClick = self._addCommand(b'onBuyPremiumClick')
        self.onGetSubscriptionClick = self._addCommand(b'onGetSubscriptionClick')
        return
