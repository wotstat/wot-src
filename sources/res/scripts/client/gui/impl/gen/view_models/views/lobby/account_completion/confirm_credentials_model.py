...
class ConfirmCredentialsModel(BaseWgnpOverlayViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'field', BaseFieldModel())
        self._addNumberProperty(b'timer', 0)
        self._addStringProperty(b'email', b'')
        self._addResourceProperty(b'resendButtonLabel', R.invalid())
        self.onResendClicked = self._addCommand(b'onResendClicked')
        return
