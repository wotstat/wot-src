...
class ReservesEntryPointModel(ViewModel):
    __slots__ = (b'openBoosterNavigation',)
    ...
    def _initialize(self):
        ...
        self._addBoolProperty(b'expiringReserveWillExpireSoon', False)
        self.openBoosterNavigation = self._addCommand(b'openBoosterNavigation')
        return
