...
class PlayerSatisfactionModel(ViewModel):
    __slots__ = (b'onSatisfactionRatingSelected',)
    ...
    def _initialize(self):
        ...
        self._addStringProperty(b'state', PlayerSatisfactionStates.NONE.value)
        self._addBoolProperty(b'isPlayerSatisfactionInterfaceEnabled', False)
        self.onSatisfactionRatingSelected = self._addCommand(b'onSatisfactionRatingSelected')
        return
