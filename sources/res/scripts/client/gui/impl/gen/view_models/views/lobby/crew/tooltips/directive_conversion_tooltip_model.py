...
class DirectiveConversionTooltipModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'oldDirective', DirectiveConversionDirectiveModel())
        self._addViewModelProperty(b'newDirective', DirectiveConversionDirectiveModel())
