...
class DialogType(Enum):
    DECONSTRUCTFROMSTORAGE = b'deconstructFromStorage'
    DECONSTRUCTFROMSLOTS = b'deconstructFromSlots'


class ConfirmActionsWithEquipmentDialogModel(DialogTemplateViewModel):
    __slots__ = (b'onDeconstruct', b'onClose')
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'detailsDevice', DetailsDeviceModel())
        self._addViewModelProperty(b'detailsPriceBlock', DetailsPriceBlockModel())
        self._addStringProperty(b'alertText', b'')
        self._addStringProperty(b'dialogType')
        self._addArrayProperty(b'balance', Array())
        self.onDeconstruct = self._addCommand(b'onDeconstruct')
