...
class DogTagsViewModel(ViewModel):
    __slots__ = (b'onExit', b'onEquip', b'onReset', b'onTabSelect', b'onInfoButtonClick', b'onPlayVideo', b'onOnboardingCloseClick', b'onNewComponentHover')
    ...
    def _initialize(self):
        ...
        self._addNumberProperty(b'newEngravingStaticCount', 0)
