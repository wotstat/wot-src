...
class OperationModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addArrayProperty(b'additionalMissions', Array())
        self._addNumberProperty(b'operationId', 0)
        self._addStringProperty(b'operationState')
        self._addNumberProperty(b'value', 0)
        self._addNumberProperty(b'maxValue', 0)
        self._addNumberProperty(b'deltaFrom', 0)
        self._addBoolProperty(b'vehicleInHangar', False)
        return
