...
class SettingsModel(ViewModel, typing.Generic[F]):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'tiersSettings', TiersSettingsModel())
        self._addViewModelProperty(b'voiceSettings', VoiceChatSettingsModel())
        self._addArrayProperty(b'searchFilterTypes', Array())
        return
