...
DialogResult = namedtuple(b'DialogResult', (b'result', b'data'))
SingleDialogResult = namedtuple(b'SingleDialogResult', (b'busy', b'result'))
...
class DialogWindow(Window):
    ...
    __slots__ = (b'__blur', b'__scope', b'__event', b'__result', b'__buttonToFocus', b'__focusInited')
    ...
    def _addButton(self, name, label=R.invalid(), isFocused=False, invalidateAll=False, isEnabled=True, soundDown=None, rawLabel=b'', tooltipHeader=R.invalid(), tooltipBody=R.invalid()):
