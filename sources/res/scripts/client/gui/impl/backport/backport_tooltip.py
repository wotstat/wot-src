...
_STATE_TYPE_INFO = b'INFO'
TooltipData = namedtuple(b'TooltipData', (b'tooltip', b'isSpecial', b'specialAlias', b'specialArgs', b'isWulfTooltip'))
TooltipData.__new__.__defaults__ = (
 b'', False, b'', None, False)
...
class _BackportTooltipContent(ViewImpl):
    ...
    __slots__ = (b'__tooltipData', b'__mousePosX', b'__mousePosY')
