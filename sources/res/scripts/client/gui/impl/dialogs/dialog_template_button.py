...
class ButtonPresenter(object):
    __slots__ = (b'__tooltip', b'_viewModel')
...
class MonoButtonTemplate(object):
    __slots__ = (b'_viewModel',)

    def __init__(self, action, label, soundTarget=b'Button', buttonType=MonoButtonType.PRIMARY, isDisabled=False):
