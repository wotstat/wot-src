...
class BaseFocusPresenter(ViewImpl):
    ...
    def __init__(self, settings, *args, **kwargs):
        msg = b'Model must be an instance of DialogBaseFocusViewModel'
...
class ButtonFocusingHandler(object):
    __slots__ = (b'__dialogTemplateViewModel',)
...
class DialogTemplateFocusingSystem(object):
    __slots__ = (b'__dialogTemplateViewModel', b'__presenters', b'__currentFocusIndex', b'__buttonFocusing', b'__indexShifting', b'__maxIndex', b'__isStarted')
    ...
    def __tabPressHandler(self, args):
        isShiftPressed = args.get(b'shift', False)
