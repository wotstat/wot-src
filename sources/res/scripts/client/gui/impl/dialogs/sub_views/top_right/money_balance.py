...
NO_WGM_TOOLTIP_DATA = {(CurrencyType.GOLD): {b'header': (R.strings.tooltips.header.buttons.gold.header()), 
                         b'body': (R.strings.tooltips.wallet.not_available_gold.body())}, 
   (CurrencyType.CREDITS): {b'header': (R.strings.tooltips.header.buttons.credits.header()), 
                            b'body': (R.strings.tooltips.wallet.not_available_credits.body())}, 
   (CurrencyType.CRYSTAL): {b'header': (R.strings.tooltips.header.buttons.crystal.header()), 
                            b'body': (R.strings.tooltips.wallet.not_available_crystal.body())}, 
   (CurrencyType.FREEXP): {b'header': (R.strings.tooltips.header.buttons.freeXP.header()), 
                           b'body': (R.strings.tooltips.wallet.not_available_freexp.body())}, 
   (CurrencyType.EQUIPCOIN): {b'header': (R.strings.tooltips.header.buttons.equipCoin.title()), 
                              b'body': (R.strings.tooltips.wallet.not_available_equipCoin.body())}}
