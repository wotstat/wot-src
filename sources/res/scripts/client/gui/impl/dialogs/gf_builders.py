...
class PassiveXPDialogBuilder(ConfirmCancelDialogBuilder):
    __slots__ = (b'__descriptionMsg', b'__iconFrom', b'__iconTo', b'__vehsCD')
    ...
    def _extendTemplate(self, template):
        ...
        if self.__descriptionMsg and self.__iconFrom:
            imageFrom = ImageSubstitution(self.__iconFrom(), b'typeIconFrom', -1, -5, -5, -5)
            imageTo = ImageSubstitution(self.__iconTo(), b'typeIconTo', -1, -5, -5, -5)
