...
class PriceModelBuilder(object):
    ...
    @classmethod
    def fillPriceModelByItemPrice(cls, priceModel, itemPrice, checkBalanceAvailability=False, priceID=b''):
    ...
    @classmethod
    def fillPriceModel(cls, priceModel, price, action=None, defPrice=None, checkBalanceAvailability=False, priceID=b''):
        ...
        if action is not None:
            ...
            if defPrice is not None:
                ...
                _logger.error(b'action and defPrice should be set both')
        priceModel.setPriceID(priceID)
        return
...
class BuyPriceModelBuilder(PriceModelBuilder):
    ...
    @classmethod
    def fillPriceModel(cls, priceModel, price, action=None, defPrice=None, checkBalanceAvailability=False, priceID=b'', balance=None):
