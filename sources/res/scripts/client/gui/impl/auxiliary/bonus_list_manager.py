...
class BonusListManager(object):
    ...
    def setBonuses(self, bonuses, model, lastCongratsIndex=-1):
        ...
        for index, reward in enumerate(bonuses):
            ...
            self.__tooltipsData[index] = TooltipData(tooltip=ttTarget.get(b'tooltip', None), isSpecial=ttTarget.get(b'isSpecial', False), specialAlias=ttTarget.get(b'specialAlias', b''), specialArgs=ttTarget.get(b'specialArgs', None))
