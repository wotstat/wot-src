...
class _BrowseActionParser(SectionParser):
    ...
    def parse(self, section):
        ...
        if target == b'internal':
            ...
            webClientHandler = section.readString(b'web_client_handler') if section.has_key(b'web_client_handler') else None
