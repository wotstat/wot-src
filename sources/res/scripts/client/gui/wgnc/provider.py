...
class _NotificationVO(object):
    ...
    def validate(self):
        ...
        try:
            ...
            LOG_ERROR(b'Notification is invalid', str(e), self)
            result = False
...
class _WGNCProvider(object):
    ...
    def fromXmlString(self, xmlString):
        ...
        try:
            ...
            LOG_ERROR(b'Can not parse notification', str(e), xmlString)
            return
    ...
    def fromSection(self, section):
        try:
            ...
            LOG_ERROR(b'Can not parse notification', str(e), section.asBinary)
            return
