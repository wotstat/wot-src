...
def controllersConfig(manager):
    manager.addInstance(IPrebattleHintsController, PrebattleHintsController(), finalizer=b'fini')
    manager.addInstance(INewbiePrebattleHintsController, NewbiePrebattleHintsController(), finalizer=b'fini')
    return
