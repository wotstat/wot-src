...
class FILTER_KEYS(object):
    ...
    IGR = b'igr'
    RENTED = b'rented'
    CLAN_RENTED = b'clanRented'
    BONUS = b'bonus'
    FAVORITE = b'favorite'
    CRYSTALS = b'crystals'
    SEARCH_NAME_VEHICLE = b'searchNameVehicle'
    EVENT = b'event'
    BATTLE_ROYALE = b'battleRoyale'
    RANKED = b'ranked'
    OWN_3D_STYLE = b'own3DStyle'
    CAN_INSTALL_ATTACHMENTS = b'canInstallAttachments'
...
class _CarouselFilter(object):
    ...
    def clear(self, save=True):
        ...
        self.update({(FILTER_KEYS.SEARCH_NAME_VEHICLE): b''}, save)
        return
