...
class Sounds(CONST_CONTAINER):
    FIRST_SELECT_EVENT = b'gui_rb_rank_Entrance_first'
    SELECT_EVENT = b'gui_rb_rank_Entrance'
    DESELECT_EVENT = b'gui_rb_rank_Exit'
    OVERLAY_SPACE_NAME = b'ranked_overlay'
    ...
    SUBVIEW_SPACE_NAME = b'ranked_subview'
    ...
    SUBVIEW_HANGAR_FILTERED = b'STATE_subview_hangar_filtered'
    SUBVIEW_HANGAR_FILTERED_ON = b'STATE_subview_hangar_filtered_on'
    SUBVIEW_HANGAR_FILTERED_OFF = b'STATE_subview_hangar_filtered_off'
    HANGAR_PLACE_STATE = b'STATE_hangar_place'
    HANGAR_PLACE_GARAGE = b'STATE_hangar_place_garage'
    MAIN_PAGE_SPACE_NAME = b'ranked_main_page'
    MAIN_PAGE_STATE = b'STATE_gamemode_progress_page'
    MAIN_PAGE_STATE_ON = b'STATE_gamemode_progress_page_on'
    MAIN_PAGE_STATE_OFF = b'STATE_gamemode_progress_page_off'
    MAIN_PAGE_AMBIENT_ON_EVENT = b'gui_rb_rank_progress_page_ambient_Entrance'
    MAIN_PAGE_AMBIENT_OFF_EVENT = b'gui_rb_rank_progress_page_ambient_Exit'
    MAIN_PAGE_AMBIENT_STATE = b'STATE_rank_ambient'
    MAIN_PAGE_AMBIENT_STATE_1 = b'STATE_rank_ambient_01'
    MAIN_PAGE_AMBIENT_STATE_2 = b'STATE_rank_ambient_02'
    PROGRESSION_STATE = b'STATE_rank_level'
    PROGRESSION_STATE_DEFAULT = b'STATE_rank_level_00'
    PROGRESSION_STATE_QUALIFICATION = b'STATE_rank_level_01'
    PROGRESSION_STATE_3_DIVISION = b'STATE_rank_level_02'
    PROGRESSION_STATE_2_DIVISION = b'STATE_rank_level_03'
    PROGRESSION_STATE_1_DIVISION = b'STATE_rank_level_04'
    PROGRESSION_STATE_LEAGUES = b'STATE_rank_level_05'
    PROGRESSION_STATE_SHOP = b'STATE_rank_level_05'
