...
def _getBonusBattleFields(stepsBonus, efficiencyBonus, isDaily):
    return {b'bonusBattleText': (_getBonusBattlesDiffLabel(stepsBonus + efficiencyBonus)), 
       b'bonusBattleTooltip': (_getBonusBattlesTooltip(stepsBonus, efficiencyBonus, isDaily))}
