...
class BasePresetsGetter(EmptyPresetsGetter):
    ...
    @ifComponentInPreset(HANGAR_CONSTS.AMMUNITION_INJECT, abortAction=b'getDefaultAmmoInjectViewAlias')
    def getAmmoInjectViewAlias(self, preset=None):
        return preset.visibleComponents[HANGAR_CONSTS.AMMUNITION_INJECT].type

    @ifComponentInPreset(HANGAR_CONSTS.CAROUSEL, abortAction=b'getDefaultCarouselSettings')
    ...
    @ifComponentInPreset(HANGAR_CONSTS.HEADER, abortAction=b'getDefaultHangarHeaderBlock')
    ...
    @ifComponentInPreset(HANGAR_CONSTS.HEADER_WIDGET, abortAction=b'getDefaultHangarWidgetAlias')
