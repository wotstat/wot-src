...
SpecBattleGuiSettings = namedtuple(b'SpecBattleGuiSettings', (b'bonusType', b'modifiersGetter', b'lobbyHelper', b'missionsHelper', b'vehicleMenuHelper'))
...
class SpecBattleHangarDynamicGuiProvider(BaseHangarDynamicGuiProvider):
    ...
    def createByPrbEntity(self, prbEntity):
        return SpecBattleHangarDynamicGuiProvider(self._config, prbEntity.getSettings()[b'arenaGuiType'])
