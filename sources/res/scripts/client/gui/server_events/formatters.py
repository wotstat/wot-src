...
def packTypedBonusesBlock(bonusesList, endlineSymbol=b'', typedTooltip=b'', typedTooltipArg=b''):
    data = {b'linkage': b'QuestTextAwardBlockUI', 
       b'items': bonusesList, 
       b'separator': b', ', 
       b'ellipsis': b'..', 
       b'endline': endlineSymbol, 
       b'typedTooltip': typedTooltip, 
       b'typedTooltipArg': typedTooltipArg}
    return UiElement(data)


def packWulfTooltipSimpleBonusesBlock(bonusesList, endlineSymbol=b'', wulfTooltip=b'', wulfTooltipArg=b''):
    data = {b'linkage': b'QuestTextAwardBlockUI', 
       b'items': bonusesList, 
       b'separator': b', ', 
       b'ellipsis': b'..', 
       b'endline': endlineSymbol, 
       b'wulfTooltip': wulfTooltip, 
       b'wulfTooltipArg': wulfTooltipArg}
    return UiElement(data)
...
def packMissionBonusTypeElements(bonusTypes, width=32, height=32, vSpace=-11):
    ...
    for bonusType in uniqueTypes:
        ...
        if ARENA_BONUS_TYPE.FUN_RANDOM == bonusType and kwargs.get(b'modeName'):
            label = kwargs.get(b'modeName')
        else:
