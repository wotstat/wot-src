...
class DailyQuestReroll(Processor):
    ...
    def _errorHandler(self, code, errStr=b'', ctx=None):
        return makeI18nError(b'daily_quests/reroll/%s' % errStr, defaultSysMsgKey=b'daily_quests/reroll/unknown_error')

    def _successHandler(self, code, ctx=None):
        return makeI18nSuccess(b'daily_quests/reroll/success')
