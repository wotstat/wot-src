...
class EconomicsSet(ActionModifier):
    ...
    def handlerBerthsPrices(self, ctx):
        ...
        return self._calculateDiscount(b'berthsPrices', ctx.getValue(), default.get(default.getCurrency(), 0), _DT.PERCENT)
...
class CalendarModifier(ActionModifier):
    ...
    def __init__(self, name, params):
        super(CalendarModifier, self).__init__(b'calendar', params, modType=ACTION_MODIFIER_TYPE.AVAILABILITY)
        return

    def getDuration(self):
        strDuration = self._params.get(b'duration')
        if strDuration:
...
class CalendarSplashModifier(ActionModifier):
    ...
    def __init__(self, name, params):
        super(CalendarSplashModifier, self).__init__(b'calendarSplash', params, modType=ACTION_MODIFIER_TYPE.AVAILABILITY)
        return
...
class HeroTankAdventCalendarRedirectModifier(ActionModifier):
    ...
    def __init__(self, _, params):
        super(HeroTankAdventCalendarRedirectModifier, self).__init__(b'heroTankAdventCalendarRedirect', params, modType=ACTION_MODIFIER_TYPE.AVAILABILITY)
        return

    def getIsEnabled(self):
        return self._params.get(b'enabled', b'').lower() in (b'1', b'yes', b'true')
...
_MODIFIERS = (
 ...
 (
  b'mul_PrebattleInstructionsPriceAll', BattleBoosterPriceAll),
 (
  b'mul_PrebattleInstructionsPrice', BattleBoosterPriceMul),
 (
  b'set_PrebattleInstructionsPrice', BattleBoosterPriceSet),
 (
 ...
 (
  b'AdventCalendarEnabled', CalendarModifier),
 (
  b'AdventCalendarForced', CalendarSplashModifier),
 (
  b'HeroTankAdventCalendarRedirect', HeroTankAdventCalendarRedirectModifier),
 (
