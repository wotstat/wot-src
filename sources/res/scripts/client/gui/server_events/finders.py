...
PERSONAL_MISSION_TOKEN = b'token:pt:final:s%s:t%s'
MAIN_PERSONAL_MISSION_TOKEN = PERSONAL_MISSION_TOKEN + b':main'
ADD_PERSONAL_MISSION_TOKEN = PERSONAL_MISSION_TOKEN + b':add'
PERSONAL_MISSION_BADGES_TOKEN = b'token:pt:s%s:badges'
FINAL_PERSONAL_MISSION_TOKEN = b'pt_final_s%s_t%s'
CHAMPION_BADGES_BY_BRANCH = {(PM_BRANCH.REGULAR): b'pt_final_badge', 
   (PM_BRANCH.PERSONAL_MISSION_2): b'pt_final_badge_s2', 
   (PM_BRANCH.PERSONAL_MISSION_3): b'pt_final_rewards_s3'}
