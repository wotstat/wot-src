...
_SITUATIONAL_BONUSES = (b'camouflageNet', b'stereoscope', b'removedRpmLimiter')
_PARTIALLY_SITUATIONAL_BONUSES = {b'lastEffortBattleBooster': (KPI.Name.RADIOMAN_ACTIVITY_TIME_AFTER_VEHICLE_DESTROY)}
...
_NOT_STACK_BONUSES = {b'circularVisionRadius': (
                           (
                            b'stereoscope_tier1', BonusTypes.OPTIONAL_DEVICE), (b'stereoscope_tier2', BonusTypes.OPTIONAL_DEVICE),
                           (
   ...
   b'radiomanHitChance': (
                        (
                         b'lastEffortBattleBooster', BonusTypes.BATTLE_BOOSTER),), 
   b'radiomanActivityTimeAfterVehicleDestroy': (
                                              (
                                               b'lastEffortBattleBooster', BonusTypes.BATTLE_BOOSTER),)}
