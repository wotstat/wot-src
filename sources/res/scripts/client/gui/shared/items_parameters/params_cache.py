...
PrecachedOptionalDevice = namedtuple(b'PrecachedOptionalDevice', b'nations')
PrecachedChassis = namedtuple(b'PrecachedChassis', b'isHydraulic, isWheeled, hasAutoSiege, isTrackWithinTrack, isWheeledOnSpotRotation, isMultiTrack')
PrecachedEngine = namedtuple(b'PrecachedEngine', b'hasTurboshaftEngine, hasRocketAcceleration')
...
class PrecachedGun(namedtuple(b'PrecachedGun', (
 b'clipVehicles', b'autoReloadVehicles', b'dualGunVehicles', b'dualAccuracyVehicles', b'autoShootFlameVehicles',
 b'autoShootVehicles', b'params', b'turretsByVehicles'))):
...
class _ParamsCache(object):
    __slots__ = (b'__cache', b'__init', b'__simplifiedParamsCoefficients', b'__bonuses', b'__noCamouflageVehicles', b'__wheeledChassisParams')
            ...
            for vDescr in vehiclesCache.generator(nationIdx):
                for vChs in vDescr.type.chassis:
                    ...
                    if vDescr.isWheeledVehicle:
                        ...
                        self.__wheeledChassisParams[chassisCD] = chassisPhysics[b'axleSteeringLockAngles']
