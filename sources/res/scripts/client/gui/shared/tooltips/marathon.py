...
class MarathonEventTooltipData(BlocksTooltipData):
    ...
    def _getHeader(self, _):
        ...
        if icon:
            formattedText = (b'{}{}').format(icons.makeImageTag(icon, width=32, height=32, vSpace=-10, hSpace=-10), text_styles.main(text))
        else:
            formattedText = (b'{}').format(text_styles.main(text))
