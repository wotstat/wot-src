...
class StatsConfiguration(object):
    __slots__ = (b'vehicle', b'sellPrice', b'buyPrice', b'unlockPrice', b'inventoryCount', b'vehiclesCount', b'node', b'xp', b'dailyXP', b'minRentPrice', b'restorePrice', b'rentals', b'slotIdx', b'futureRentals', b'isAwardWindow', b'showBonus', b'showRankedBonusBattle', b'showCompatibles', b'withSlots', b'isStaticInfoOnly', b'showEarnCrystals', b'showDebutBoxes')
...
class ParamsConfiguration(object):
    __slots__ = (b'vehicle', b'params', b'crew', b'eqs', b'devices', b'dossier', b'dossierType', b'isCurrentUserDossier', b'historicalBattleID', b'checkAchievementExistence', b'simplifiedOnly', b'externalCrewParam', b'vehicleLevel', b'arenaType', b'colorless')
...
class SelectableBonusesGiftTokenContext(ToolTipContext):
    ...
    def buildItem(self, tokenID, **kwargs):
        ...
        if offer is None:
            ...
            if shortName in (b'brochure_gift', b'guide_gift', b'book_gift'):
