...
class StatsConfiguration(object):
    __slots__ = (b'vehicle', b'sellPrice', b'buyPrice', b'unlockPrice', b'inventoryCount', b'vehiclesCount', b'node', b'xp', b'dailyXP', b'minRentPrice', b'restorePrice', b'rentals', b'slotIdx', b'futureRentals', b'isAwardWindow', b'showBonus', b'showRankedBonusBattle', b'showCompatibles', b'withSlots', b'isStaticInfoOnly', b'showEarnCrystals')
...
class ParamsConfiguration(object):
    __slots__ = (b'vehicle', b'params', b'crew', b'eqs', b'devices', b'dossier', b'dossierType', b'isCurrentUserDossier', b'historicalBattleID', b'checkAchievementExistence', b'simplifiedOnly', b'externalCrewParam', b'vehicleLevel', b'arenaType', b'colorless', b'showNormalizationAngle', b'showReboundAngle', b'showBasic', b'showPenetrationLoss', b'showScreensArmorMultiplier', b'showBasicIsUsedinCalculations')
...
class AwardContext(DefaultContext):
    ...
    def buildItem(self, intCD, tmanCrewLevel=None, rentExpiryTime=None, rentBattles=None, rentWins=None, rentSeason=None, rentCycle=None, isSeniority=False):
        ...
        self._seasonRent = {b'season': (rentSeason or []), b'cycle': (rentCycle or [])}
    ...
    def getParams(self):
        ...
        return {b'tmanRoleLevel': (self._tmanRoleLevel), b'rentExpiryTime': (self._rentExpiryTime), b'rentBattlesLeft': (self._rentBattlesLeft), 
           b'rentWinsLeft': (self._rentWinsLeft), 
           b'rentSeason': seasonRent, 
           b'isSeniority': (self._isSeniority)}
...
class ExtendedAwardContext(AwardContext):
    ...
    def getParams(self):
        ...
        params[b'showCrew'] = self._showCrew
        params[b'showVehicleSlot'] = self._showVehicleSlot
        params[b'allModulesAvailable'] = self._allModulesAvailable
        return params
...
class WinbackDiscountContext(ExtendedAwardContext):
    ...
    def getParams(self):
        ...
        params[b'blueprintFragmentsCount'] = self._blueprintsFragmentsCount
        params[b'customPrice'] = self._customPrice
        params[b'hideStatus'] = self._hideStatus
        params[b'showDiscount'] = self._showDiscount
        return params
...
class BoosterStatsConfiguration(object):
    __slots__ = (b'buyPrice', b'inventoryCount', b'quests', b'activeState', b'effectTime', b'activateInfo', b'dueDate')
...
class BattlePassGiftTokenContext(ToolTipContext):
    ...
    def buildItem(self, tokenID, **kwargs):
        ...
        if offer is None:
            ...
            if shortName in (b'brochure_gift', b'guide_gift', b'crewbook_gift'):
                gift = first(offer.getAllGifts())
                if gift is not None:
                    result.append(gift.bonus.displayedItem.getXP())
            else:
                shortOfferName = offerToken.split(b':')[2]
    ...
    def getParams(self):
        return {b'isOfferEnabled': (self.__battlePassController.isOfferEnabled() and self.__hasOffer)}
...
class PersonalMissionsPointsTooltipContext(ToolTipContext):
    ...
    def getParams(self):
        ...
        params.update({b'tooltipType': (ParamTooltipType.PM3_POINTS.value), 
           b'params': [], b'resId': (R.views.mono.personal_missions_30.tooltips.param_tooltip())})
        return params
...
class PersonalMissionOperationDisabledTooltipContext(ToolTipContext):
    ...
    def getParams(self):
        ...
        params.update({b'tooltipType': (ParamTooltipType.CUSTOM_SIMPLE.value), 
           b'params': {b'body': (backport.text(R.strings.personal_missions_30.campaignSelector.operation.tooltip.locked()))}, 
           b'resId': (R.views.mono.personal_missions_30.tooltips.param_tooltip())})
        return params
