    ...
    def _packBlocks(self, *args):
        ...
        if not self._isValidPrimeTimes(serversPeriodsMapping):
            ...
            for serverName in natsorted(serversPeriodsMapping.keys()):
                ...
                blocks.append(self.__packServerTimeBlock(serverStr=text_styles.main(backport.text(self._RES_ROOT.serverName(), server=serverName)), timeStr=text_styles.stats((b'\n').join(periodsStr))))
