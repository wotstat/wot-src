...
class TooltipBuilder(object):
    __slots__ = (b'_tooltipType', b'_linkage', b'_provider')
...
class AdvancedTooltipWindowBuilder(AdvancedBuilder):
    __slots__ = (b'_adProvider', b'_condition', b'_provider')
...
class AdvancedDataBuilder(AdvancedBuilder):
    __slots__ = (b'_provider', b'_adProvider', b'_condition')
...
class ConditionBuilder(DataBuilder):
    ...
    def _format(self, data, formatType):
        return complex_formatters.doFormatData(data[b'data'], formatType)
...
class DefaultFormatBuilder(ConditionBuilder):
    ...
    def __init__(self, tooltipType, defaultLinkage, provider):
        super(DefaultFormatBuilder, self).__init__(tooltipType, b'', defaultLinkage, provider)
        return
...
class ComplexBuilder(AdvancedBuilder):
    __slots__ = (b'advanced_ComplexTooltip',)
    ...
    def build(self, formatType, advanced_, *args, **kwargs):
        ...
        if data:
            ...
            _logger.debug(b'Complex tooltip %s can not be shown: %r', formatType, args)
...
class BuildersCollection(object):
    ...
    def addBuilder(self, builder):
        ...
        if type_ not in self._builders:
            ...
            raise SoftException((b'Builder with type {} is already added').format(type_))
        return
        ...
        for path, tooltipTypes in self._settings:
            ...
            for builder in builders:
                if builder.tooltipType not in tooltipTypes:
                    raise SoftException((b'Type "{}" is not found in tooltips settings {} in {}').format(builder.tooltipType, tooltipTypes, path))
