...
class RankedStepTooltip(BlocksTooltipData):
    ...
    def _packReceivedBlock(self, winEarnedCount, loseEarnedCount):
        ...
        if winEarnedCount > 0:
            winIcon = R.images.gui.maps.icons.rankedBattles.tops.top.c_54x50.dyn((b'top{}').format(winEarnedCount))
        ...
        if loseEarnedCount > 0:
            loseIcon = R.images.gui.maps.icons.rankedBattles.tops.lose.c_54x50.dyn((b'top{}').format(loseEarnedCount))
