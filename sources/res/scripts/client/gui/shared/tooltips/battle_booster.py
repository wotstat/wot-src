...
class HeaderBlockConstructor(BattleBoosterTooltipBlockConstructor):
    ...
    def _getIcon(self):
        ...
        if icon is None:
            _logger.warning(b'BattleBooster icon missed: R.images.gui.maps.shop.artefacts.c_180x135.%s', moduleName)
            return b''
        else:
            return icon()
    ...
    def construct(self):
        ...
        if module.isBuiltinPerkBooster():
            ...
            if kpi:
                ...
                descriptor = (b' ').join((text_styles.main(module.shortDescription.replace(b'%s ', b'', 1)),
                ...
                _logger.warning(b'BattleBooster kpi missed %s', module.descriptor.iconName)
        return block
