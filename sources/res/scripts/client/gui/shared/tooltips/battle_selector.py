...
class SeasonalBattleSelectorTooltip(BlocksTooltipData):
    ...
    def _packTillEndBlock(cls):
        ...
        return formatters.packTextBlockData(text_styles.main(backport.text(cls._R_BATTLE_SELECTOR_STR.tillEnd())) + b' ' + text_styles.stats(backport.getTillTimeStringByRClass(timeLeft, R.strings.tooltips.tillTime)))
