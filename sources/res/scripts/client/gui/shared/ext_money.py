...
class ExtendedGuiItemEconomyCode(GUI_ITEM_ECONOMY_CODE):
    ...
    COMPOUND_PRICE = b'price_is_compound'
    XP_COMPOUND_PRICE = b'price_is_xp_compound'
    STEP_LOCKED = b'step_locked'
    STEP_RECIEVED = b'step_received'
    STEP_RESTRICTED = b'step_restricted'
    MOD_PERSISTENT = b'mod_persistent'
    MULTI_NOT_EXISTS = b'multi_not_exists'
    MULTI_NOT_EMPTY = b'multi_not_empty'
    MULTI_NOT_PURCHASED = b'multi_not_purchased'
