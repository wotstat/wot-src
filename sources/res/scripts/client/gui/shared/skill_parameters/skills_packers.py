...
def _packCommanderExpert(descrArgs, skillLevel, customValues=None):
    ...
    return packBase(descrArgs, skillLevel, {b'damageMonitoringDelay': _customValue})
...
def _packEnemyShotPredictor(descrArgs, skillLevel, customValues=None):
    ...
    return packBase(descrArgs, skillLevel, {b'artNotificationDelayFactor': _customValue})
...
def _packGunnerGunsmith(descrArgs, skillLevel, customValues=None):
    ...
    def _customValue(skillDescrArg, isKpi):
        if isKpi:
            return skillDescrArg.value * MAX_SKILL_LEVEL
        return base - abs(skillDescrArg.value * skillLevel)

    return packBase(descrArgs, skillLevel, {b'damageAndPiercingDistributionLowerBound': _customValue, b'damageAndPiercingDistributionUpperBound': _customValue})
...
def _parkSixthSense(descrArgs, skillLevel, customValues=None):
    ...
    return packBase(descrArgs, skillLevel, {b'delay': _customValue})
