...
class _UnlockStats(namedtuple(b'UnlockStats', b'unlocked xps freeXP')):
...
class _VehicleResearchInfo(namedtuple(b'VehicleResearchInfo', b'vehIntCD wasSaved canBeSaved researched available viewedItems')):
