...
class Notifiable(object):
    ...
    def startNotification(self):
        forEach(operator.methodcaller(b'startNotification'), self.__notificators)
        return

    def stopNotification(self):
        forEach(operator.methodcaller(b'stopNotification'), self.__notificators)
        return

    def clearNotification(self):
        self.stopNotification()
        forEach(operator.methodcaller(b'clear'), self.__notificators)
        self.__notificators = []
        return
