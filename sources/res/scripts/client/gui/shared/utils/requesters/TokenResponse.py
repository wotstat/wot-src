...
class TokenResponse(object):
    __slots__ = (b'_receivedAt', b'_token', b'_databaseID', b'_error')
    ...
    def __repr__(self):
        return (b'{0}(receivedAt={1}, databaseID={2}, error={3})').format(self.__class__.__name__, self._receivedAt, self._databaseID, self._error)
