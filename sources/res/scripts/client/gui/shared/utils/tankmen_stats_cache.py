...
class _TankmanContext(object):
    ...
    def vehicleType(self):
        if self._vehicleType == self.NOT_INITIALIZED:
            ...
            if vehData is None:
                ...
                nationID, vehTypeID = vehicles.parseVehicleCompactDescr(vehData[b'compDescr'])
    ...
    def isLockedByVehicle(self):
        if self._isLockedByVehicle == self.NOT_INITIALIZED:
            ...
            if vehType is None:
                ...
                isLockedByVehicle = b'lockCrewSkills' in vehType.tags
    ...
    def canAddAnyBonusSkill(self):
        ...
        if self.tankman.vehicleInvID != Tankman.NO_VEHICLE_INV_ID:
            ...
            slotIdx = curVehData[b'crew'].index(self.tankman.invID)
...
class TankmenStatsCache(object):
    ...
    def update(self):
        ...
        LOG_DEBUG_DEV(b'TankmenStatsCache checked all tankmen')
        return
