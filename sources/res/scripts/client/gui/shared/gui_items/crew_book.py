...
class CrewBook(FittingItem):
    __slots__ = (b'__id', b'__count', b'nationID')
    ...
    def getBonusIconName(self):
        ...
        if not self.hasNoNation():
            iconName += b'_' + self.getNation()
        return iconName

    def getUniversalBonusIconName(self):
        return self.getBookType() + b'_universal'

    def getShopIcon(self, size=b'large'):
    ...
    def getGUIEmblemID(self):
        return (b'{}_{}').format(self.itemTypeName, self.getBookType())
