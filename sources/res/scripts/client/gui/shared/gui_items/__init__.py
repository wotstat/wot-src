...
class ItemsCollection(dict):
    ...
    def __repr__(self):
        return b'%s<size:%d>' % (self.__class__.__name__, len(self.items()))
...
def checkForTags(vTags, tags):
    if not hasattr(tags, b'__iter__'):
        tags = (
         tags,)
...
class KPI(object):
    ...
    class Name(CONST_CONTAINER):
        ...
        VEHICLE_GUN_KILL_RELOAD_TIME = b'vehicleGunKillReloadTime'
        VEHICLE_GUN_RELOAD_TIME_RECEIVE_SHOT = b'vehicleGunReloadTimeReceiveShot'
        ...
        VEHICLE_FINAL_DISPERSION = b'vehicleFinalDispersion'
        ...
        VEHICLE_GUN_DAMAGE = b'vehicleGunDamage'
        VEHICLE_GUN_SPEC_DAMAGE = b'vehicleGunSpecDamage'
        ...
        VEHICLE_RAM_OR_EXPLOSION_DAMAGE_RESISTANCE = b'vehicleRamOrExplosionDamageResistance'
        ...
        VEHICLE_PENALTY_FOR_DAMAGED_ENGINE_AND_COMBAT = b'vehPenaltyForDamageEngineAndCombat'
        ...
        LIMITS_FOR_GUN_BOOST = b'limitsForGunBoost'
        VEHICLE_GUN_AND_GUN_CLIP_COOLDOWN = b'vehicleGunAndGunClipCooldown'
        ...
        CIRCULAR_VISION_RADIUS_WHILE_SURVEYING_DEVICE_DAMAGED = b'circularVisionRadiusWhileSurveyingDeviceDamaged'
        STUN_RESISTANCE_EFFECT_FACTOR = b'stunResistanceEffectFactor'
        ART_NOTIFICATION_DELAY_FACTOR = b'artNotificationDelayFactor'
        VEHICLE_WEAK_SOIL_RESISTANCE = b'vehicleWeakSoilResistance'
        VEHICLE_AVERAGE_SOIL_RESISTANCE = b'vehicleAverageSoilResistance'
        ...
        TRACK_RAMMING_DAMAGE_FACTOR = b'trackRammingDamageFactor'
        RADIOMAN_HIT_CHANCE = b'radiomanHitChance'
        RADIOMAN_ACTIVITY_TIME_AFTER_VEHICLE_DESTROY = b'radiomanActivityTimeAfterVehicleDestroy'
        DAMAGED_MODULES_DETECTION_TIME = b'damagedModulesDetectionTime'
        FIRE_EXTINGUISHING_RATE = b'fireExtinguishingRate'
        COMMANDER_HIT_CHANCE = b'commanderHitChance'
        WOUNDED_CREW_EFFICIENCY = b'woundedCrewEfficiency'
        VEHICLE_ALLY_RADIO_DISTANCE = b'vehicleAllyRadioDistance'
        CHARGE_TIME_BONUS = b'chargeTimeBonus'
        PENALTY_AFTER_SHOT_BONUS = b'penaltyAfterShotBonus'
        LOAD_SHELL_INTO_DUALGUN_BONUS = b'loadShellIntoDualGunBonus'
        SPEED_LIMITS_BONUS = b'speedLimitsBonus'
        ABILITY_DURATION_BONUS = b'abilityDurationBonus'
        VEHICLE_GUN_RELOAD_PENALTY = b'vehicleGunReloadPenalty'
        ABILITY_COOLDOWN_BONUS = b'abilityCooldownBonus'
        TEMPERATURE_STATES_COUNT = b'temperatureStatesCount'
        TEMPERATURE_HEATING_TIME = b'temperatureHeatingTime'
        TEMPERATURE_COOLING_TIME = b'temperatureCoolingTime'
        TEMPERATURE_COOLING_DELAY = b'temperatureCoolingDelay'
        TEMPERATURE_DAMAGE_FACTOR = b'temperatureDamageFactor'
        ...
        CREW_STUN_RESISTANCE = b'crewStunResistance'
        ...
        CREW_SKILL_LAST_EFFORT = b'crewSkillLastEffort'
        CREW_SKILL_LAST_EFFORT_DURATION = b'crewSkillLastEffortDuration'
...
def kpiFormatNoSignWithSpec(kpiName, values, addEnding=True):
    ...
    return (kpiFormatNoSignValue(kpiName, value, False),
     kpiFormatNoSignValue(kpiName + b'Spec', specValue, addEnding))
...
def kpiFormatWithSpec(kpiName, values, addEnding=True):
    value, specValue = values
    return (kpiFormatValue(kpiName, value, addEnding), kpiFormatNoSignValue(kpiName + b'Spec', specValue, addEnding))
...
VEHICLE_ATTR_TO_KPI_NAME_MAP = {b'repairSpeed': (KPI.Name.VEHICLE_REPAIR_SPEED), 
   ...
   b'avgDamage': (KPI.Name.VEHICLE_GUN_DAMAGE)}
