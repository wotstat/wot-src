...
class MedalSamokhinAchievement(ClassProgressAchievement):
    ...
    def __init__(self, dossier, value=None):
        super(MedalSamokhinAchievement, self).__init__(b'medalSamokhin', _AB.TOTAL, dossier, value)
        return
    ...
    def _readProgressValue(self, dossier):
        return dossier.getRecordValue(_AB.TOTAL, b'medalSamokhin')
...
class MedalGudzAchievement(ClassProgressAchievement):
    ...
    def __init__(self, dossier, value=None):
        super(MedalGudzAchievement, self).__init__(b'medalGudz', _AB.TOTAL, dossier, value)
        return
    ...
    def _readProgressValue(self, dossier):
        return dossier.getRecordValue(_AB.TOTAL, b'medalGudz')
