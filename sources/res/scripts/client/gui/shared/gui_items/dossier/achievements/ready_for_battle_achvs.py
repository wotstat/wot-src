...
class ReadyForBattleFossaAssault(ReadyForBattleAchievement3Steps):
    ...
    def __init__(self, dossier, value=None):
        super(ReadyForBattleFossaAssault, self).__init__(name=b'readyForBattleFossaAssault', classifier=PM3QType.ASSAULT, branch=PM_BRANCH.PERSONAL_MISSION_4, dossier=dossier, value=value)
        return
...
class ReadyForBattleFossaSniper(ReadyForBattleAchievement3Steps):
    ...
    def __init__(self, dossier, value=None):
        super(ReadyForBattleFossaSniper, self).__init__(name=b'readyForBattleFossaSniper', classifier=PM3QType.SNIPER, branch=PM_BRANCH.PERSONAL_MISSION_4, dossier=dossier, value=value)
        return
...
class ReadyForBattleFossaSupport(ReadyForBattleAchievement3Steps):
    ...
    def __init__(self, dossier, value=None):
        super(ReadyForBattleFossaSupport, self).__init__(name=b'readyForBattleFossaSupport', classifier=PM3QType.SUPPORT, branch=PM_BRANCH.PERSONAL_MISSION_4, dossier=dossier, value=value)
        return
