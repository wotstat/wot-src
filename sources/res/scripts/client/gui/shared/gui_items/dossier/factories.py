...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, b'warrior'): (_CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement)), 
   ...
   (_AB.TOTAL, b'medalKnispel'): (_CustomAchieveFactory.get(_as.class_progress.MedalKnispelAchievement)), 
   (_AB.TOTAL, b'medalCarius'): (_CustomAchieveFactory.get(_as.class_progress.MedalCariusAchievement)), 
   ...
   (_AB.TOTAL, b'medalWittmann'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.TOTAL, b'readyForBattleAssault'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleAssault)), 
   (_AB.TOTAL, b'readyForBattleSniper'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleSniper)), 
   (_AB.TOTAL, b'readyForBattleSupport'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleSupport)), 
   (_AB.TOTAL, b'readyForBattleFossaAssault'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleFossaAssault)), 
   (_AB.TOTAL, b'readyForBattleFossaSniper'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleFossaSniper)), 
   (_AB.TOTAL, b'readyForBattleFossaSupport'): (_CustomAchieveFactory.get(_as.ready_for_battle.ReadyForBattleFossaSupport)), 
   ...
   (_AB.TOTAL, b'lumberjack'): (_CustomAchieveFactory.get(_as.regular.LumberjackAchievement)), 
   ...
   (_AB.UNIQUE, b'BR2019Top1Solo'): (_AchieveFactory.get(_abstract_achievements.QuestAchievement)), 
   (_AB.UNIQUE, b'BR2019Top1Squad'): (_AchieveFactory.get(_abstract_achievements.QuestAchievement)), 
   ...
   (_AB.SINGLE, b'september22'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'october22'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'november22'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'december22'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'january23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'february23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'march23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'april23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'may23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'june23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'july23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'august23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'september23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'december23'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'january24'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'february24'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'march24'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'BattlePassCommonPr_12extra'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_NY24'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'BattlePassCommonPr_15extra'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_NY25'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'BattlePassCommonPr_17extra_1'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_17extra_2'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_17extra_3'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_18'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_18extra_1'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_18extra_2'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BattlePassCommonPr_NY26'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'BPReserveAchievement_6'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BPReserveAchievement_7'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'BPReserveAchievement_9'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.TOTAL, b'lunarNY2022Progression'): (_AchieveFactory.get(_abstract_achievements.StageAchievement)), 
   (_AB.UNIQUE, b'oowTankmanWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.UNIQUE, b'oowStrategistWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'NY24_CelebChallenge'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.TOTAL, b'wt2023HunterWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.TOTAL, b'wt2023BossWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.TOTAL, b'wt2023MaxPlasma'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'hw2023Medal'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'comp7_3_yearly_iron'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_3_yearly_bronze'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_3_yearly_silver'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_3_yearly_gold'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_3_yearly_champion'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_3_yearly_legend'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'Cosmic_StarTrekCrew'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'Cosmic_LiveLongAndProsper'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'Cosmic_KlingonValor'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'comp7_4_yearly_iron'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_4_yearly_bronze'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_4_yearly_silver'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_4_yearly_gold'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_4_yearly_champion'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_4_yearly_legend'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'dDayFighter'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.TOTAL, b'wt2024HunterWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.TOTAL, b'wt2024BossWins'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.TOTAL, b'wt2024HunterWinsEpic'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'hw2024Medal'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'NY25_AtmsphrLevel'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'NY25_CelebChallenge'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'vDayHero'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'ls2025Medal'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   ...
   (_AB.SINGLE, b'comp7_5_yearly_iron'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_5_yearly_bronze'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_5_yearly_silver'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_5_yearly_gold'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_5_yearly_champion'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_5_yearly_legend'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'ls2_0Medal'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'sccHero'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'wot15thAnniversary'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'wot15thAnniversaryElite'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'wt2025progression'): (_AchieveFactory.get(_abstract_achievements.RegularAchievement)), 
   ...
   (_AB.SINGLE, b'LunarNY2026CN'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'wot16thAnniversary'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'wt2026progression'): (_AchieveFactory.get(_abstract_achievements.RegularAchievement)), 
   (_AB.SINGLE, b'comp7_6_1'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_6_yearly_iron'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
   (_AB.SINGLE, b'comp7_6_yearly_bronze'): (_AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)), 
