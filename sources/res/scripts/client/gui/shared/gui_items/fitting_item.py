...
_RentalInfoProvider = namedtuple(b'RentalInfoProvider', (b'rentExpiryTime', b'compensations', b'battlesLeft', b'winsLeft', b'seasonRent', b'isRented', b'isTelecomRent'))
...
class FittingItem(GUIItem):
    __slots__ = (b'_buyPrices', b'_sellPrices', b'_mayConsumeWalletResources', b'_personalDiscountPrice', b'_isHidden', b'_inventoryCount', b'_isUnlocked', b'_isBoughtForAltPrice', b'_rentInfo', b'_restoreInfo', b'_fullyConfigured', b'_isInitiallyUnlocked', b'_descriptor')
