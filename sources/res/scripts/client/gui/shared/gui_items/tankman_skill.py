...
COMMANDER_BONUS = b'commander_bonus'
...
class _Skill(GUIItem, ISkill):
    __slots__ = (b'_name', b'_customName', b'_crewCustomName')
...
class _SkillPresenter(_Skill, ISkillPresenter):
    ...
    def icon(self):
        if self._customName:
            return (b'{}.png').format(self.customName)
        return (b'{}.png').format(self.name)
...
class _SkillData(_Skill, ISkillData):
    __slots__ = (b'_skillRole', b'_tankmanRole', b'_level', b'_isSkillActive', b'_isZero', b'_roleType', b'_isRelevant', b'_typeName', b'_isEnable', b'_learnState')
...
class TankmanSkill(_SkillData, _SkillPresenter):
    ...
    def __repr__(self):
        return (b'TankmanSkill<name:{}, level:{}, skillRole:{}, tankmanRole:{}, isRelevant:{}>').format(self.name, self.level, self.skillRole, self.tankmanRole, self.isRelevant)
