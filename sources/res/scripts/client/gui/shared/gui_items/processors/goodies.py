...
class BoosterBuyer(BoosterTradeProcessor):
    ...
    def _request(self, callback):
        _logger.debug(b'Make server request to buy booster: %s, %s, %s, %s %s', self.booster.boosterID, self.booster.buyPrices, self.count, self.buyCurrency, self.doActivation)
