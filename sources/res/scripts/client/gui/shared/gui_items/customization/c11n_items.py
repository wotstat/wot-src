...
class Customization(FittingItem):
    __slots__ = (b'_boundVehicles', b'_bonus', b'_installedVehicles', b'__noveltyData', b'__progressingData', b'__installedCount', b'__boundInventoryCount', b'__fullInventoryCount', b'__fullCount', b'__questProgressInfo', b'__orderingNumber', b'__markedAsFavorite')
    ...
    @property
    def icon(self):
        return self.descriptor.texture.replace(b'gui/', b'../', 1)
    ...
    def specialEventIcon(self):
        return SpecialEvents.ICONS.get(self.specialEventTag, b'')
...
class Style(Customization):
    __slots__ = (b'_changableTypes', b'_itemsCache', b'__outfits', b'__dependenciesByIntCD', b'__serialNumber')
