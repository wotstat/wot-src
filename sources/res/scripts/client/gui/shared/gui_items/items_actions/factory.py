...
QUICK_SERVICE_EQUIP_TANKMAN = b'quickServiceEquipTankman'
BUY_AND_EQUIP_TANKMAN = b'buyAndEquipTankman'
CHANGE_TANKMAN_PASSPORT = b'changeTankmanPassport'
DISMISS_TANKMAN = b'dismissTankman'
RESTORE_TANKMAN = b'restoreTankman'
CONVERT_JUNK_TANKMEN = b'convertJunkTankmen'
TRANSFER_TANKMAN_XP = b'transferTankmanXp'
CHANGE_NATION = b'changeNation'
INSTALL_BATTLE_ABILITIES = b'installBattleAbilities'
FRONTLINE_INSTALL_RESERVES = b'frontlineInstallReserves'
...
ADD_SKILLS_TANKMAN = b'addSkillsTankman'
PURCHASE_VEH_SKILL_TREE_STEPS = b'purchaseVehSkillTreeSteps'
