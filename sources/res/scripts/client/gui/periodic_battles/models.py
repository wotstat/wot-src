...
class AlertData(object):
    ...
    __slots__ = (b'state', b'alertIcon', b'buttonIcon', b'buttonLabel', b'buttonVisible', b'buttonTooltip', b'statusText', b'additionalText', b'popoverAlias', b'bgVisible', b'shadowFilterVisible', b'tooltip', b'isSimpleTooltip')

    def __init__(self, state=ALERTMESSAGE_CONSTANTS.ALERT_MESSAGE_STATE_DEFAULT, alertIcon=None, buttonIcon=b'', buttonLabel=b'', buttonVisible=False, buttonTooltip=None, statusText=b'', additionalText=b'', popoverAlias=None, bgVisible=True, shadowFilterVisible=False, tooltip=None, isSimpleTooltip=False):
        self.state = state
    ...
    def packCallbacks(cls, onBtnClickCallback=None, onBlockClickCallback=None):
        return {b'onButtonClick': onBtnClickCallback, b'onBlockClick': onBlockClickCallback}

    def asDict(self):
        return {b'state': (self.state), 
           b'alertIcon': (self.alertIcon), 
           ...
           b'additionalText': (self.additionalText), 
