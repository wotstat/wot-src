...
class NewbiesCohortSettingsModel(BaseConfigModel):
    __slots__ = (b'battlesCount', b'vehicleLevel')
    ...
    def __repr__(self):
        return (b'<NewbiesCohortSettingsModel(battlesCount={}, vehicleLevel={})>').format(self.battlesCount, self.vehicleLevel)


class ConfigModel(BaseConfigModel):
    __slots__ = (b'enabled', b'sequences', b'newbiesCohort')
    ...
    def __repr__(self):
        return (b'<ConfigModel(enabled={}, sequences={}, newbiesCohort={})>').format(self.enabled, len(self.sequences), self.newbiesCohort)
...
class CdnCacheParams(object):
    __slots__ = (b'configUrl', b'itemsCacheSynced')
    ...
    def __repr__(self):
        return (b'<CdnCacheParamsModel(configUrl={}, itemsCacheSynced={})>').format(self.configUrl, self.itemsCacheSynced)
