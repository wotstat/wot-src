...
VehicleProperties = namedtuple(b'VehicleProperties', (b'difficulty', b'survivability', b'mobility', b'damage', b'spotting'))
_PriorityParameter = namedtuple(b'PriorityParameter', (b'name', b'type'))
_BRSettings = namedtuple(b'_BRSettings', (b'radar', b'detector', b'spawn', b'techTree', b'vehicleProperties', b'upgradeAttentionTime', b'observerBotMarkersVisibilityDistance', b'sounds'))
...
def _readBattleRoyaleSettings():
    ...
    result = _BRSettings(_readRadarSettings(section[b'radar']), _readRadarSettings(section[b'detector']), _readSpawnSettings(section[b'spawn']), _readTechTreeSettings(section[b'techTree']), _readVehicleProperties(section[b'vehicleProperties']), section[b'upgradeAttentionTime'].asFloat, section[b'observerBotMarkersVisibilityDistance'].asInt, _readSoundSettings(section[b'sounds']))
...
def _readVehicleProperties(section):
    ...
    for nation, properties in section[b'vehicles'].items():
        vehicleProperties[nation] = VehicleProperties(difficulty=properties[b'difficulty'].asInt, survivability=properties[b'survivability'].asInt, mobility=properties[b'mobility'].asInt, damage=properties[b'damage'].asInt, spotting=properties[b'spotting'].asInt)
