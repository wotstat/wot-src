...
def getGuiServicesConfig(manager):
    ...
    manager.addInstance(IBattleHintsOverlapController, BattleHintsOverlapController(), finalizer=b'fini')
    manager.addInstance(INewbieBattleHintsController, NewbieBattleHintsController(), finalizer=b'fini')
