...
class MarathonEventContainer(object):
    ...
    def __init__(self):
        self.prefix = b'event_marathon'
        self.tokenPrefix = b'event_marathon'
        self.styleTokenPostfix = b''
        self.urlName = b'marathonUrl'
        self.marathonCompleteUrlAdd = b'overlay/'
        self.vehicleName = b''
        self.suspendPrefix = b':suspend'
        self.completedTokenPostfix = b'_PASS'
        self.hangarFlagName = b'flag_italy'
        self.questsInChain = 10
        self.minVehicleLevel = 6
        self.awardTokensPostfix = (b'complete', b'ps_stop')
        self.awardPostTokensPostfix = (b'post_complete', b'3d_style_bought')
        ...
        self.marathonTooltipHeader = b'marathonTooltipHeader'
