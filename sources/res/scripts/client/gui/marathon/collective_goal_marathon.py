...
COLLECTIVE_GOAL_MARATHON_PREFIX = b'collective_goal'
...
class CollectiveGoalEvent(MarathonEvent):
    ...
    def setState(self):
        ...
        if config.isEnabled and config.startTime <= currentTime <= config.finishTime:
...
class CollectiveGoalMarathon(MarathonEventContainer):
    ...
    def _override(self):
        ...
        self.vehicleName = b''
        self.suspendPrefix = b''
        self.completedTokenPostfix = b''
        self.hangarFlagName = b''
        self.awardTokensPostfix = tuple()
        self.awardPostTokensPostfix = tuple()
        self.showFlagTooltipBottom = False
        self.flagTooltip = b''
        self.disabledFlagTooltip = b''
        self.marathonTooltipHeader = b''
