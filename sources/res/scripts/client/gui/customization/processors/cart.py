...
class BasePurchaseDescription(object):
    __slots__ = (b'intCD', b'identificator', b'selected', b'item', b'component', b'quantity', b'purchaseIndices', b'progressionLevel', b'_uiDataPacker', b'dependents', b'dependentOn')
...
class SeparateItemPurchaseDescription(BasePurchaseDescription):
    __slots__ = (b'itemData', b'compoundPrice', b'isFromInventory', b'group', b'locked', b'isEdited')
