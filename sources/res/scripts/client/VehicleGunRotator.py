...
class VehicleGunRotator(object):
    ...
    def start(self):
        ...
        if not self._avatar.isOnArena:
            ...
            self.showServerMarker = self.settingsCore.getSetting(b'useServerAim')
    ...
    def applySettings(self, diff):
        if b'useServerAim' in diff:
            self.showServerMarker = diff[b'useServerAim']
        return
    ...
    def getNextGunPitch(self, curAngle, shotAngle, timeDiff, angleLimits):
        ...
        elif math.fabs(curAngle - shotAngle) < VehicleGunRotator.ANGLE_EPS:
    ...
    def __getTargetedEnemyForGun(self, gunShotPosition, excludeTeam):
        ...
        if collision is not None:
            ...
            if entity is not None and entity.publicInfo and entity.publicInfo[b'team'] is not excludeTeam and entity.health > 0:
                return entity
        return
    ...
    def __getGunPitchLimits(self):
        ...
        if staticPitch is None:
            ...
            useGunStaticPitch |= deviceStates.get(b'engine') == b'destroyed'
            ...
            if useGunStaticPitch:
                gunPitchLimits = {b'minPitch': ((0.0, staticPitch), (math.pi * 2.0, staticPitch)), b'maxPitch': (
                               (
    ...
    def __getTurretYawLimits(self):
        ...
        if staticYaw is None:
            ...
            useStaticTurretYaw |= deviceStates.get(b'engine') == b'destroyed'
            useStaticTurretYaw |= deviceStates.get(b'leftTrack0') == b'destroyed'
            useStaticTurretYaw |= deviceStates.get(b'rightTrack0') == b'destroyed'
