...
class BalanceWebApiMixin(object):
    ...
    def getStats(self, cmd):
        ...
        getters = {b'changeRoleCost': (lambda stats: stats.changeRoleCost), b'freeXPConversionDiscrecity': (lambda stats: stats.freeXPConversion[0]), 
           ...
           b'berthsPrices': (lambda stats: stats.berthsPrices[2][0]), 
