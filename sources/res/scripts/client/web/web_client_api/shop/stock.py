...
_ITEMS_CRITERIA_MAP = {(ShopItemType.VEHICLE): {b'inventory': (REQ_CRITERIA.INVENTORY | ~REQ_CRITERIA.VEHICLE.EVENT), 
   ...
   (ShopItemType.DECAL): {}, (ShopItemType.EMBLEM): {}, (ShopItemType.INSCRIPTION): {}, (ShopItemType.PROJECTION_DECAL): {}, (ShopItemType.CREW_BOOKS): {}, (ShopItemType.ENHANCEMENT): {b'inventory': (REQ_CRITERIA.INVENTORY)}}
