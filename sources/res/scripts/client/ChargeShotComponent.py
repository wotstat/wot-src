...
@ReprInjector.simple(b'flags', b'level', b'baseTime', b'endTime')
class ChargeShotState(IMechanicState):
    __slots__ = (b'flags', b'level', b'baseTime', b'endTime', b'hasCharging', b'hasShotBlock', b'canStart', b'isGunDestroyed')
