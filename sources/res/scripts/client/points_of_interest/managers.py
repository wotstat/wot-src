...
class PoiStateManager(CGF.ComponentManager):
    ...
    @onProcessQuery(PoiStateComponent, tickGroup=b'PostHierarchy', updatePeriod=_UPDATE_PERIOD)
...
class PoiViewStateManager(CGF.ComponentManager):
    ...
    @onProcessQuery(PoiCaptureBlockerStateComponent, PoiVehicleStateComponent, tickGroup=b'PostHierarchy', updatePeriod=_UPDATE_PERIOD)
