...
class Window(PyObjectEntity):
    __slots__ = (b'onStatusChanged', b'__windowStatus', b'onShowingStatusChanged', b'onFocusChanged', b'__showingStatus', b'__isShown', b'__isFocused', b'__isReady', b'__weakref__')
