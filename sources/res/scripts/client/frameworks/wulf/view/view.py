...
class View(PyObjectEntity, typing.Generic[TViewModel]):
    __slots__ = (b'__viewStatus', b'__showingStatus', b'__viewModel', b'__args', b'__kwargs', b'onStatusChanged', b'__isReady', b'onShowingStatusChanged', b'onFocusChanged', b'__soundExtension', b'__isShown', b'__isFocused', b'__weakref__', b'__initialParentWindow')
