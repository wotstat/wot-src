...
GAME_EXTENDED_2 = b'gameExtData2'
...
class SETTINGS_SECTIONS(CONST_CONTAINER):
    ...
    SITUATIONAL_PERKS = b'FEEDBACK_SITUATIONAL_PERKS'
    ...
    SENIORITY_AWARDS_STORAGE = b'SENIORITY_AWARDS_STORAGE'
    LIMITED_UI_PERMANENT_1 = b'LIMITED_UI_PERMANENT_1'
    LIMITED_UI_PERMANENT_2 = b'LIMITED_UI_PERMANENT_2'
    REFERRAL_PROGRAM = b'REFERRAL_PROGRAM'
    ADVANCED_ACHIEVEMENTS_STORAGE = b'ADVANCED_ACHIEVEMENTS_STORAGE'
    PERSONAL_MISSION_3 = b'PERSONAL_MISSION_3'
    PERSONAL_MISSION_4 = b'PERSONAL_MISSION_4'
...
class UI_STORAGE_KEYS(CONST_CONTAINER):
    ...
    STEAM_ADD_EMAIL_OVERLAY_SHOWN = b'steam_add_email_overlay_shown'
    IS_CONFIRM_EMAIL_OVERLAY_ALLOWED = b'is_confirm_email_overlay_allowed'
    LIMITED_UI_ALL_NOVICE_RULES_COMPLETED = b'limited_ui_all_novice_rules_completed'
    MUTABLE_DAMAGE_SHELL_MARK_IS_SHOWN = b'mutable_damage_shell_mark_is_shown'
    AUTO_SHOOT_HIGHLIGHTS_COUNTER = b'auto_shoot_highlights_count'
    AUTO_SHOT_NPD_SHELLS_MARK_IS_SHOWN = b'auto_shot_npd_shells_mark_is_shown'
    TWIN_GUN_HIGHLIGHTS_COUNTER = b'twin_gun_highlights_count'
    NEW_C11N_SECTION_HINT_ACTION_TAKEN = b'new_c11n_section_hint_action_taken'
    C11N_VEHICLE_LIST_HINT_ACTION_TAKEN = b'c11n_vehicle_list_hint_action_taken'
    VEHICLE_C11N_FILTER_HINT_ACTION_TAKEN = b'vehicle_c11n_filter_hint_action_taken'
...
class ADVANCED_ACHIEVEMENTS_STORAGE_KEYS(CONST_CONTAINER):
    EARNING_TIMESTAMP = b'ACHIEVEMENTS_EARNING_TIMESTAMP'
...
class LIMITED_UI_SPAM_OFF(CONST_CONTAINER):
    ...
    REFERRAL_BTN_COUNTER = b'referralButtonCounter'
    AP_ZONE_HINT = b'AmmunitionPanelHintZoneHint'
    C11N_PROGRESSION_HINT = b'CustomizationProgressionViewHint'
...
class ServerSettingsManager(object):
    ...
    SECTIONS = {(SETTINGS_SECTIONS.GAME): (Section(masks={(GAME.ENABLE_OL_FILTER): 0, 
       ...
       (SETTINGS_SECTIONS.MARKERS): (Section(masks={b'markerBaseIcon': 0, 
                                     b'markerBaseLevel': 1, 
       ...
       (SETTINGS_SECTIONS.CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                               ...
                                               b'role_SPG': 25, 
                                               b'role_LT_universal': 26, 
                                               b'role_LT_scout': 27, 
                                               b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                               b'canInstallAttachments': 1}, offsets={})), 
       ...
       (SETTINGS_SECTIONS.RANKED_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                      ...
                                                      b'role_LT_scout': 27, 
                                                      b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.RANKED_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                      b'canInstallAttachments': 1}, offsets={})), 
       ...
       (SETTINGS_SECTIONS.EPICBATTLE_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                          ...
                                                          b'role_LT_scout': 27, 
                                                          b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.EPICBATTLE_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                          b'canInstallAttachments': 1}, offsets={})), 
       ...
       (SETTINGS_SECTIONS.COMP7_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                     ...
                                                     b'role_LT_scout': 27, 
                                                     b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.COMP7_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                     b'canInstallAttachments': 1}, offsets={})), 
       (SETTINGS_SECTIONS.COMP7_LIGHT_CAROUSEL_FILTER_1): (Section(masks={b'ussr': 0, 
                                                           b'germany': 1, 
                                                           b'usa': 2, 
                                                           b'china': 3, 
                                                           b'france': 4, 
                                                           ...
                                                           b'level_10': 29, 
                                                           b'level_11': 30}, offsets={})), 
       (SETTINGS_SECTIONS.COMP7_LIGHT_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                           b'elite': 1, 
                                                           b'rented': 2, 
                                                           b'igr': 3, 
                                                           b'gameMode': 4, 
                                                           ...
                                                           b'role_LT_scout': 27, 
                                                           b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.COMP7_LIGHT_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                           b'canInstallAttachments': 1}, offsets={})), 
       ...
       (SETTINGS_SECTIONS.MAPBOX_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                      ...
                                                      b'role_LT_scout': 27, 
                                                      b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.MAPBOX_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                      b'canInstallAttachments': 1}, offsets={})), 
       ...
       (SETTINGS_SECTIONS.FUN_RANDOM_CAROUSEL_FILTER_2): (Section(masks={b'premium': 0, 
                                                          ...
                                                          b'role_LT_scout': 27, 
                                                          b'role_LT_support': 28}, offsets={})), 
       (SETTINGS_SECTIONS.FUN_RANDOM_CAROUSEL_FILTER_3): (Section(masks={b'own3DStyle': 0, 
                                                          b'canInstallAttachments': 1}, offsets={})), 
    ...
    def getLimitedUIProgress(self, storageIdx, offset, ruleType):
        ...
        if storageIdx >= len(storages):
            LOG_ERROR(b"Can't read LimitedUI flag. storageIdx is out of range")
            return 0
    ...
    def setLimitedUIGroupProgress(self, data):
        ...
        for storageInfo, offsets in data.iteritems():
            ...
            storages = LIMITED_UI_STORAGES_BY_TYPE.get(ruleType, [])
            if storageIdx >= len(storages):
                LOG_ERROR(b"Can't store LimitedUI flags. storageIdx is out of range")
                continue
            storageID = storages[storageIdx]
            flags = self.getSectionSettings(storageID, LIMITED_UI_KEY, 0)
    ...
    def updateIsHintTutorial(self, hint):
        if not self.getOnceOnlyHintsSetting(hint, False):
            ...
            if storageKey is None:
                LOG_ERROR(b'Trying to update hint tutorial state for an unsupported hint')
                return False
            ...
            LOG_ERROR(b'[UPDATE] Hint tutorial storage key not found in storage')
            return False

    def setHintTutorialState(self, hint, hintSeen, tutorialSeen):
        storageKey = HINT_STORAGE_KEY_MAPPING.get(hint)
        if storageKey is None:
            LOG_ERROR(b'Trying to set hint tutorial state for an unsupported hint')
            return
        else:
            ...
            LOG_ERROR(b'[SET] Hint tutorial storage key not found in storage')
            return
    ...
    def _setSettingsSections(self, data):
        ...
        carouselFilter2 = data.get(b'carousel_filter', {})
        clearCarouselFilter2 = clear.get(b'carousel_filter', 0)
        ...
        epicFilterCarousel2 = data.get(b'epicCarouselFilter2', {})
        clearEpicFilterCarousel2 = clear.get(b'epicCarouselFilter2', 0)
        ...
        comp7LightFilterCarousel1 = data.get(b'comp7LightCarouselFilter1', {})
        clearComp7LightFilterCarousel1 = clear.get(b'comp7LightCarouselFilter1', 0)
        ...
        comp7LightFilterCarousel2 = data.get(b'comp7LightCarouselFilter2', {})
        clearComp7LightFilterCarousel2 = clear.get(b'comp7LightCarouselFilter2', 0)
