...
class BattleCommunicationSettings(IBattleCommunicationsSettings):
    __slots__ = (b'onChanged', b'_isEnabled', b'_showStickyMarkers', b'_showInPlayerList', b'_showCalloutMessages', b'_showLocationMarkers', b'_showBaseMarkers', b'_enableCommendationsFeedback')
