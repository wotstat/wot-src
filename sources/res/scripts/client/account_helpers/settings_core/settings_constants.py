...
class GRAPHICS(CONST_CONTAINER):
    ...
    SHOW_PREBATTLE_HIGHLIGHTS = b'showPrebattleHighlights'
    INCREASE_EFFECTS_CONTRAST_ENABLED = b'INCREASE_EFFECTS_CONTRAST_ENABLED'
...
class PersonalMission4(CONST_CONTAINER):
    INTRO_OP_11 = b'INTRO_OP_11'
    PM_BANNER_ANIMATION_KEY = b'PM_BANNER_ANIMATION_KEY'
    CHECKED_PM4_POINTS = b'CHECKED_PM4_POINTS'
    PART_NO = b'PART_NO'
    OPERATION_SHOWN = b'OPERATION_SHOWN'


COLOR_GRADING_TECHNIQUE_DEFAULT = 0

class NewYearStorageKeys(CONST_CONTAINER):
    NY_INTRO_SHOWN = b'nyIntroShown'
    BOOL_FLAGS = (
     NY_INTRO_SHOWN,)
