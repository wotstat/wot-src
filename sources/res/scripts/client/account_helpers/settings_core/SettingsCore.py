...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__storages = {b'game': GAME_SETTINGS_STORAGE, 
           ...
           b'situationalPerks': SITUATIONAL_PERKS_SETTINGS_STORAGE, 
        ...
        self.__options = options.SettingsContainer(graphicSettings + (
         ...
         (
          ...
          options.PlayersPanelStateSetting(GAME.PLAYERS_PANELS_STATE, b'players_panel', b'state')),
         (
         ...
         (
          ...
          options.ReadOnlySetting((lambda : graphics.getGraphicSettingImages(b'COLOR_GRADING_TECHNIQUE')))),
         (
         ...
         (
          CONTROLS.MOUSE_SNIPER_SENS, options.MouseSensitivitySetting(b'twinGun')),
         (
         ...
         (
          CONTROLS.MOUSE_FREECAM_SENS, options.MouseSensitivitySetting(b'deathfreecam')),
         (
