...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__storages = {b'game': GAME_SETTINGS_STORAGE, 
           b'extendedGame': EXTENDED_GAME_SETTINGS_STORAGE, 
           b'extendedGame2': EXTENDED_GAME_2_SETTINGS_STORAGE, 
           b'gameplay': GAMEPLAY_SETTINGS_STORAGE, 
           b'sound': SOUND_SETTINGS_STORAGE, 
           b'controls': CONTROLS_SETTINGS_STORAGE, 
           b'aim': AIM_SETTINGS_STORAGE, 
           b'markers': MARKERS_SETTINGS_STORAGE, 
           b'graphics': GRAPHICS_SETTINGS_STORAGE, 
           b'video': VIDEO_SETTINGS_STORAGE, 
           b'messenger': MESSENGER_SETTINGS_STORAGE, 
           b'extendedMessenger': EXTENDED_MESSENGER_SETTINGS_STORAGE, 
           b'marksOnGun': MARK_ON_GUN_SETTINGS_STORAGE, 
           b'FOV': FOV_SETTINGS_STORAGE, 
           b'damageIndicator': DAMAGE_INDICATOR_SETTINGS_STORAGE, 
           b'damageLog': DAMAGE_LOG_SETTINGS_STORAGE, 
           b'battleEvents': BATTLE_EVENTS_SETTINGS_STORAGE, 
           b'battleBorderMap': BATTLE_BORDER_MAP_SETTINGS_STORAGE, 
           b'questsProgress': QUESTS_PROGRESS_SETTINGS_STORAGE, 
           b'battleComm': BATTLE_COMM_SETTINGS_STORAGE, 
           b'battleHud': BATTLE_HUD_SETTINGS_STORAGE, 
           b'dogTags': DOG_TAGS_SETTINGS_STORAGE, 
           b'spgAim': SPG_AIM_SETTINGS_STORAGE, 
           b'contour': CONTOUR_SETTINGS_STORAGE, 
           b'sixthSense': SIXTH_SENSE_SETTINGS_STORAGE}
        ...
        self.__options = options.SettingsContainer(graphicSettings + (
         ...
         (
          ...
          options.PlayersPanelSetting(GAME.PLAYERS_PANELS_SHOW_LEVELS, b'players_panel', b'showLevels', storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.PLAYERS_PANELS_SHOW_TYPES,
          options.AccountDumpSetting(GAME.PLAYERS_PANELS_SHOW_TYPES, b'players_panel', b'showTypes')),
         (
          GAME.PLAYERS_PANELS_STATE,
          options.AccountDumpSetting(GAME.PLAYERS_PANELS_STATE, b'players_panel', b'state')),
         (
          GAME.EPIC_RANDOM_PLAYERS_PANELS_STATE,
          options.AccountDumpSetting(GAME.EPIC_RANDOM_PLAYERS_PANELS_STATE, b'epic_random_players_panel', b'state')),
         (
         ...
         (
          ...
          options.GameplaySetting(GAME.GAMEPLAY_MASK, b'domination', storage=GAMEPLAY_SETTINGS_STORAGE)),
         (
          GAME.GAMEPLAY_ASSAULT,
          options.GameplaySetting(GAME.GAMEPLAY_MASK, b'assault', storage=GAMEPLAY_SETTINGS_STORAGE)),
         (
          GAME.GAMEPLAY_NATIONS,
          options.GameplaySetting(GAME.GAMEPLAY_MASK, b'nations', storage=GAMEPLAY_SETTINGS_STORAGE)),
         (
          GAME.GAMEPLAY_EPIC_STANDARD,
          options.GameplaySetting(GAME.GAMEPLAY_MASK, b'ctf30x30', storage=GAMEPLAY_SETTINGS_STORAGE, delegate=_getEpicRandomSwitch)),
         (
         ...
         (
          ...
          options.GameplaySetting(GAME.GAMEPLAY_MASK, b'domination30x30', storage=GAMEPLAY_SETTINGS_STORAGE, delegate=_getEpicRandomSwitch)),
         (
          GAME.LENS_EFFECT,
         ...
         (
          ...
          options.GlobalReadOnlySetting((lambda : graphics.getGraphicSettingImages(b'COLOR_GRADING_TECHNIQUE')))),
         (
         ...
         (
          SOUND.MASTER, options.SoundSetting(b'master')),
         (
          SOUND.MUSIC, options.SoundSetting(b'music')),
         (
          SOUND.MUSIC_HANGAR, options.SoundSetting(b'music_hangar')),
         (
          SOUND.VOICE_NOTIFICATION, options.SoundSetting(b'voice')),
         (
          SOUND.VEHICLES, options.SoundSetting(b'vehicles')),
         (
          SOUND.EFFECTS, options.SoundSetting(b'effects')),
         (
          SOUND.GUI, options.SoundSetting(b'gui')),
         (
          SOUND.AMBIENT, options.SoundSetting(b'ambient')),
         (
          SOUND.NATIONS_VOICES, options.AccountSetting(b'nationalVoices')),
         (
          SOUND.VOIP_MASTER_FADE, options.SoundSetting(b'masterFadeVivox')),
         (
         ...
         (
          SOUND.GAME_EVENT_AMBIENT, options.SoundSetting(b'ev_ambient')),
         (
          SOUND.GAME_EVENT_EFFECTS, options.SoundSetting(b'ev_effects')),
         (
          SOUND.GAME_EVENT_GUI, options.SoundSetting(b'ev_gui')),
         (
          SOUND.GAME_EVENT_MUSIC, options.SoundSetting(b'ev_music')),
         (
          SOUND.GAME_EVENT_VEHICLES, options.SoundSetting(b'ev_vehicles')),
         (
          SOUND.GAME_EVENT_VOICE, options.SoundSetting(b'ev_voice')),
         (
          CONTROLS.MOUSE_ARCADE_SENS, options.MouseSensitivitySetting(b'arcade')),
         (
          CONTROLS.MOUSE_SNIPER_SENS, options.MouseSensitivitySetting(b'sniper')),
         (
          CONTROLS.MOUSE_SNIPER_SENS, options.MouseSensitivitySetting(b'dualgun')),
         (
          CONTROLS.MOUSE_STRATEGIC_SENS, options.MouseSensitivitySetting(b'strategic')),
         (
          CONTROLS.MOUSE_ASSIST_AIM_SENS,
          options.MouseSensitivitySetting(b'arty', masterSwitch=b'spgAlternativeAimingCameraEnabled')),
         (
          CONTROLS.MOUSE_ASSAULT_SENS, options.MouseSensitivitySetting(b'assaultSPG')),
         (
          CONTROLS.MOUSE_HORZ_INVERSION,
          options.MouseInversionSetting(CONTROLS.MOUSE_HORZ_INVERSION, b'horzInvert', storage=CONTROLS_SETTINGS_STORAGE)),
         (
          CONTROLS.MOUSE_VERT_INVERSION,
          options.MouseInversionSetting(CONTROLS.MOUSE_VERT_INVERSION, b'vertInvert', storage=CONTROLS_SETTINGS_STORAGE)),
         (
        ...
        LOG_DEBUG(b'SettingsCore is created')
        return
    ...
    def fini(self):
        ...
        LOG_DEBUG(b'SettingsCore is destroyed')
        return
    ...
    def applySetting(self, key, value):
        if self.isSettingChanged(key, value):
            ...
            if key in settings_constants.GRAPHICS.ALL():
                LOG_DEBUG(b'Apply graphic settings: ', {key: value})
    ...
    def setOverrideSettings(self, overrideDict, disableStorages):
        if self.__overriddenUserSettings is not None:
            LOG_ERROR(b'SettingsCore.setOverrideSettings: settings are already overridden!')
            return
        else:
    ...
    def unsetOverrideSettings(self):
        if self.__overriddenUserSettings is None:
            LOG_ERROR(b'SettingsCore.unsetOverrideSettings: settings were not overridden!')
            return
        else:
            self.__disabledStorages.clear()
