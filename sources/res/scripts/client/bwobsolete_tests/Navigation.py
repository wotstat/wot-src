...
class Navigation:
    DEBUG_MODEL_NAME = b'helpers/models/unit_cube.model'
    ...
    def _calculatePath(self, startPosition, targetPosition):
        ...
        try:
            ...
            DEBUG_MSG(b'start', startPosition)
            DEBUG_MSG(b'target', targetPosition)
            DEBUG_MSG(b'path', path)
        except ValueError as e:
            DEBUG_MSG(e)
            DEBUG_MSG(b'start', startPosition, b'end', targetPosition)
            path = [
