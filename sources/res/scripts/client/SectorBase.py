...
class _SectorBaseSettingsCache(object):
    ...
    def initSettings(self, settings):
        self.flagModelName = settings.readString(b'flagModelName', b'')
        self.flagStaffModelName = settings.readString(b'flagstaffModelName', b'')
        ...
        self.flagEmblemTex = settings.readString(b'flagEmblemTex', b'')
        self.flagEmblemTexCoords = settings.readVector4(b'flagEmblemTexCoords', Vector4())
