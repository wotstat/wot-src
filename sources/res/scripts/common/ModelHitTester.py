...
class HitTesterManager(object):
    ...
    def save(self, section):
        if IS_EDITOR:
            ...
            if self.edCrashBspModel is not b'':
...
class ModelHitTester(object):
    __slots__ = (b'__bspModel', b'__bspModelName', b'__bspModelDown', b'__bspModelNameDown', b'__bspModelUp', b'__bspModelNameUp', b'bbox', b'bboxDown', b'bboxUp')
...
if hasattr(BigWorld, b'segmentMayHitVolume'):
    segmentMayHitVolume = BigWorld.segmentMayHitVolume
if hasattr(BigWorld, b'coneMayHitVolume'):
