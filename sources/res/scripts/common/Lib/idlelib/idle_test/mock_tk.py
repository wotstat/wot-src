...
class Text(object):
    ...
    def index(self, index):
        return b'%s.%s' % self._decode(index, endflag=1)
    ...
    def _decode(self, index, endflag=0):
        ...
        try:
            ...
            raise TclError(b'bad text index "%s"' % index)
        ...
        if char.endswith(b' lineend') or char == b'end':
    ...
    def compare(self, index1, op, index2):
        ...
        raise TclError(b'bad comparison operator "%s": must be <, <=, ==, >=, >, or !=' % op)
        return
