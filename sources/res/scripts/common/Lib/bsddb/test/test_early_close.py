...
try:
    ...
    warnings.filterwarnings(b'ignore', message=b'DB could not be closed in', category=RuntimeWarning)
...
class DBEnvClosedEarlyCrash(unittest.TestCase):
    ...
    def test01_close_dbenv_before_db(self):
        ...
        self.assertRaises(db.DBNoSuchFileError, d2.open, self.filename + b'2', db.DB_BTREE, db.DB_THREAD, 438)
        d.put(b'test', b'this is a test')
        self.assertEqual(d.get(b'test'), b'this is a test', b'put!=get')
        dbenv.close()
        self.assertRaises(db.DBError, d.get, b'test')
        return
    ...
    def test04_close_massive(self):
        ...
        self.assertEqual(dbs[4].get(b'test'), b'this is a test', b'put!=get')
        for i in dbs:
        ...
        self.assertRaises(db.DBError, dbs[9].get, b'test')
