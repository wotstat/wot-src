...
class Test(unittest.TestCase):
    ...
    def test_fom_buffer(self):
        ...
        self.assertRaises(TypeError, (c_char * 16).from_buffer, b'aaaaaaaaaaaaaaaa')
        return
    ...
    def test_from_buffer_copy(self):
        ...
        gc.collect()
        self.assertEqual(x[:], range(16))
        x = (c_char * 16).from_buffer_copy(b'aaaaaaaaaaaaaaaa')
        self.assertEqual(x[:], b'aaaaaaaaaaaaaaaa')
        return
