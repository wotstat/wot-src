...
bool_values = [True, False, 0, 1, -1, 5000, b'test', [], [1]]
...
class NumberTestCase(unittest.TestCase):
    ...
    def test_typeerror(self):
        for t in signed_types + unsigned_types + float_types:
            self.assertRaises(TypeError, t, b'')
    ...
    def test_alignments(self):
        for t in signed_types + unsigned_types + float_types:
            code = t._type_
            align = struct.calcsize(b'c%c' % code) - struct.calcsize(code)
    ...
    def test_float_overflow(self):
        ...
        for t in float_types + [c_longdouble]:
            ...
            if hasattr(t, b'__ctype_be__'):
                self.assertRaises(OverflowError, t.__ctype_be__, big_int)
            if hasattr(t, b'__ctype_le__'):
...
def run_test(rep, msg, func, arg=None):
    ...
    if arg is not None:
        ...
        stop = clock()
    print b'%15s: %.2f us' % (msg, (stop - start) * 1000000.0 / 5 / rep)
    return
...
def check_perf():
    ...
    REP = 200000
    run_test(REP, b'int()', int)
    run_test(REP, b'int(999)', int)
    run_test(REP, b'c_int()', c_int)
    run_test(REP, b'c_int(999)', c_int)
    run_test(REP, b'c_int_S()', c_int_S)
    run_test(REP, b'c_int_S(999)', c_int_S)
    return
