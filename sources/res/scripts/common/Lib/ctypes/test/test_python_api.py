...
class PythonAPITestCase(unittest.TestCase):
    ...
    def test_PyString_FromStringAndSize(self):
        ...
        self.assertEqual(PyString_FromStringAndSize(b'abcdefghi', 3), b'abc')
        return
    ...
    def test_PyOS_snprintf(self):
        ...
        PyOS_snprintf(buf, sizeof(buf), b'Hello from %s', b'ctypes', 1, 2, 3)
        self.assertEqual(buf.value, b'Hello from ctypes')
        self.assertRaises(TypeError, PyOS_snprintf, buf)
        return

    def test_pyobject_repr(self):
        self.assertEqual(repr(py_object()), b'py_object(<NULL>)')
        self.assertEqual(repr(py_object(42)), b'py_object(42)')
        self.assertEqual(repr(py_object(object)), b'py_object(%r)' % object)
        return
