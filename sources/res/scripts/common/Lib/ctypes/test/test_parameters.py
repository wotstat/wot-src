...
class SimpleTypesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.prev_conv_mode = set_conversion_mode(b'ascii', b'strict')
    ...
    def test_subclasses(self):
        ...
        self.assertEqual(CVOIDP.from_param(b'abc'), b'abcabc')
        self.assertEqual(CCHARP.from_param(b'abc'), b'abcabcabcabc')
        return
    ...
    def test_subclasses_c_wchar_p(self):
        ...
        self.assertEqual(CWCHARP.from_param(b'abc'), b'abcabcabc')
        return
    ...
    def test_cstrings(self):
        ...
        self.assertEqual(c_char_p.from_param(u'123')._obj, b'123')
    ...
    def test_cw_strings(self):
        ...
        if sys.platform == b'win32':
            ...
            self.assertEqual(c_wchar_p.from_param(b'123')._obj, u'123')
    ...
    def test_noctypes_argtype(self):
        ...
        self.assertRaises(TypeError, setattr, func, b'argtypes', (object,))
