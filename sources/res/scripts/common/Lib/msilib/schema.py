from . import Table
_Validation = Table(b'_Validation')
_Validation.add_field(1, b'Table', 11552)
_Validation.add_field(2, b'Column', 11552)
_Validation.add_field(3, b'Nullable', 3332)
_Validation.add_field(4, b'MinValue', 4356)
_Validation.add_field(5, b'MaxValue', 4356)
_Validation.add_field(6, b'KeyTable', 7679)
_Validation.add_field(7, b'KeyColumn', 5378)
_Validation.add_field(8, b'Category', 7456)
_Validation.add_field(9, b'Set', 7679)
_Validation.add_field(10, b'Description', 7679)
ActionText = Table(b'ActionText')
ActionText.add_field(1, b'Action', 11592)
ActionText.add_field(2, b'Description', 7936)
ActionText.add_field(3, b'Template', 7936)
AdminExecuteSequence = Table(b'AdminExecuteSequence')
AdminExecuteSequence.add_field(1, b'Action', 11592)
AdminExecuteSequence.add_field(2, b'Condition', 7679)
AdminExecuteSequence.add_field(3, b'Sequence', 5378)
Condition = Table(b'Condition')
Condition.add_field(1, b'Feature_', 11558)
Condition.add_field(2, b'Level', 9474)
Condition.add_field(3, b'Condition', 7679)
AdminUISequence = Table(b'AdminUISequence')
AdminUISequence.add_field(1, b'Action', 11592)
AdminUISequence.add_field(2, b'Condition', 7679)
AdminUISequence.add_field(3, b'Sequence', 5378)
AdvtExecuteSequence = Table(b'AdvtExecuteSequence')
AdvtExecuteSequence.add_field(1, b'Action', 11592)
AdvtExecuteSequence.add_field(2, b'Condition', 7679)
AdvtExecuteSequence.add_field(3, b'Sequence', 5378)
AdvtUISequence = Table(b'AdvtUISequence')
AdvtUISequence.add_field(1, b'Action', 11592)
AdvtUISequence.add_field(2, b'Condition', 7679)
AdvtUISequence.add_field(3, b'Sequence', 5378)
AppId = Table(b'AppId')
AppId.add_field(1, b'AppId', 11558)
AppId.add_field(2, b'RemoteServerName', 7679)
AppId.add_field(3, b'LocalService', 7679)
AppId.add_field(4, b'ServiceParameters', 7679)
AppId.add_field(5, b'DllSurrogate', 7679)
AppId.add_field(6, b'ActivateAtStorage', 5378)
AppId.add_field(7, b'RunAsInteractiveUser', 5378)
AppSearch = Table(b'AppSearch')
AppSearch.add_field(1, b'Property', 11592)
AppSearch.add_field(2, b'Signature_', 11592)
Property = Table(b'Property')
Property.add_field(1, b'Property', 11592)
Property.add_field(2, b'Value', 3840)
BBControl = Table(b'BBControl')
BBControl.add_field(1, b'Billboard_', 11570)
BBControl.add_field(2, b'BBControl', 11570)
BBControl.add_field(3, b'Type', 3378)
BBControl.add_field(4, b'X', 1282)
BBControl.add_field(5, b'Y', 1282)
BBControl.add_field(6, b'Width', 1282)
BBControl.add_field(7, b'Height', 1282)
BBControl.add_field(8, b'Attributes', 4356)
BBControl.add_field(9, b'Text', 7986)
Billboard = Table(b'Billboard')
Billboard.add_field(1, b'Billboard', 11570)
Billboard.add_field(2, b'Feature_', 3366)
Billboard.add_field(3, b'Action', 7474)
Billboard.add_field(4, b'Ordering', 5378)
Feature = Table(b'Feature')
Feature.add_field(1, b'Feature', 11558)
Feature.add_field(2, b'Feature_Parent', 7462)
Feature.add_field(3, b'Title', 8000)
Feature.add_field(4, b'Description', 8191)
Feature.add_field(5, b'Display', 5378)
Feature.add_field(6, b'Level', 1282)
Feature.add_field(7, b'Directory_', 7496)
Feature.add_field(8, b'Attributes', 1282)
Binary = Table(b'Binary')
Binary.add_field(1, b'Name', 11592)
Binary.add_field(2, b'Data', 2304)
BindImage = Table(b'BindImage')
BindImage.add_field(1, b'File_', 11592)
BindImage.add_field(2, b'Path', 7679)
File = Table(b'File')
File.add_field(1, b'File', 11592)
File.add_field(2, b'Component_', 3400)
File.add_field(3, b'FileName', 4095)
File.add_field(4, b'FileSize', 260)
File.add_field(5, b'Version', 7496)
File.add_field(6, b'Language', 7444)
File.add_field(7, b'Attributes', 5378)
File.add_field(8, b'Sequence', 1282)
CCPSearch = Table(b'CCPSearch')
CCPSearch.add_field(1, b'Signature_', 11592)
CheckBox = Table(b'CheckBox')
CheckBox.add_field(1, b'Property', 11592)
CheckBox.add_field(2, b'Value', 7488)
Class = Table(b'Class')
Class.add_field(1, b'CLSID', 11558)
Class.add_field(2, b'Context', 11552)
Class.add_field(3, b'Component_', 11592)
Class.add_field(4, b'ProgId_Default', 7679)
Class.add_field(5, b'Description', 8191)
Class.add_field(6, b'AppId_', 7462)
Class.add_field(7, b'FileTypeMask', 7679)
Class.add_field(8, b'Icon_', 7496)
Class.add_field(9, b'IconIndex', 5378)
Class.add_field(10, b'DefInprocHandler', 7456)
Class.add_field(11, b'Argument', 7679)
Class.add_field(12, b'Feature_', 3366)
Class.add_field(13, b'Attributes', 5378)
Component = Table(b'Component')
Component.add_field(1, b'Component', 11592)
Component.add_field(2, b'ComponentId', 7462)
Component.add_field(3, b'Directory_', 3400)
Component.add_field(4, b'Attributes', 1282)
Component.add_field(5, b'Condition', 7679)
Component.add_field(6, b'KeyPath', 7496)
Icon = Table(b'Icon')
Icon.add_field(1, b'Name', 11592)
Icon.add_field(2, b'Data', 2304)
ProgId = Table(b'ProgId')
ProgId.add_field(1, b'ProgId', 11775)
ProgId.add_field(2, b'ProgId_Parent', 7679)
ProgId.add_field(3, b'Class_', 7462)
ProgId.add_field(4, b'Description', 8191)
ProgId.add_field(5, b'Icon_', 7496)
ProgId.add_field(6, b'IconIndex', 5378)
ComboBox = Table(b'ComboBox')
ComboBox.add_field(1, b'Property', 11592)
ComboBox.add_field(2, b'Order', 9474)
ComboBox.add_field(3, b'Value', 3392)
ComboBox.add_field(4, b'Text', 8000)
CompLocator = Table(b'CompLocator')
CompLocator.add_field(1, b'Signature_', 11592)
CompLocator.add_field(2, b'ComponentId', 3366)
CompLocator.add_field(3, b'Type', 5378)
Complus = Table(b'Complus')
Complus.add_field(1, b'Component_', 11592)
Complus.add_field(2, b'ExpType', 13570)
Directory = Table(b'Directory')
Directory.add_field(1, b'Directory', 11592)
Directory.add_field(2, b'Directory_Parent', 7496)
Directory.add_field(3, b'DefaultDir', 4095)
Control = Table(b'Control')
Control.add_field(1, b'Dialog_', 11592)
Control.add_field(2, b'Control', 11570)
Control.add_field(3, b'Type', 3348)
Control.add_field(4, b'X', 1282)
Control.add_field(5, b'Y', 1282)
Control.add_field(6, b'Width', 1282)
Control.add_field(7, b'Height', 1282)
Control.add_field(8, b'Attributes', 4356)
Control.add_field(9, b'Property', 7474)
Control.add_field(10, b'Text', 7936)
Control.add_field(11, b'Control_Next', 7474)
Control.add_field(12, b'Help', 7986)
Dialog = Table(b'Dialog')
Dialog.add_field(1, b'Dialog', 11592)
Dialog.add_field(2, b'HCentering', 1282)
Dialog.add_field(3, b'VCentering', 1282)
Dialog.add_field(4, b'Width', 1282)
Dialog.add_field(5, b'Height', 1282)
Dialog.add_field(6, b'Attributes', 4356)
Dialog.add_field(7, b'Title', 8064)
Dialog.add_field(8, b'Control_First', 3378)
Dialog.add_field(9, b'Control_Default', 7474)
Dialog.add_field(10, b'Control_Cancel', 7474)
ControlCondition = Table(b'ControlCondition')
ControlCondition.add_field(1, b'Dialog_', 11592)
ControlCondition.add_field(2, b'Control_', 11570)
ControlCondition.add_field(3, b'Action', 11570)
ControlCondition.add_field(4, b'Condition', 11775)
ControlEvent = Table(b'ControlEvent')
ControlEvent.add_field(1, b'Dialog_', 11592)
ControlEvent.add_field(2, b'Control_', 11570)
ControlEvent.add_field(3, b'Event', 11570)
ControlEvent.add_field(4, b'Argument', 11775)
ControlEvent.add_field(5, b'Condition', 15871)
ControlEvent.add_field(6, b'Ordering', 5378)
CreateFolder = Table(b'CreateFolder')
CreateFolder.add_field(1, b'Directory_', 11592)
CreateFolder.add_field(2, b'Component_', 11592)
CustomAction = Table(b'CustomAction')
CustomAction.add_field(1, b'Action', 11592)
CustomAction.add_field(2, b'Type', 1282)
CustomAction.add_field(3, b'Source', 7496)
CustomAction.add_field(4, b'Target', 7679)
DrLocator = Table(b'DrLocator')
DrLocator.add_field(1, b'Signature_', 11592)
DrLocator.add_field(2, b'Parent', 15688)
DrLocator.add_field(3, b'Path', 15871)
DrLocator.add_field(4, b'Depth', 5378)
DuplicateFile = Table(b'DuplicateFile')
DuplicateFile.add_field(1, b'FileKey', 11592)
DuplicateFile.add_field(2, b'Component_', 3400)
DuplicateFile.add_field(3, b'File_', 3400)
DuplicateFile.add_field(4, b'DestName', 8191)
DuplicateFile.add_field(5, b'DestFolder', 7496)
Environment = Table(b'Environment')
Environment.add_field(1, b'Environment', 11592)
Environment.add_field(2, b'Name', 4095)
Environment.add_field(3, b'Value', 8191)
Environment.add_field(4, b'Component_', 3400)
Error = Table(b'Error')
Error.add_field(1, b'Error', 9474)
Error.add_field(2, b'Message', 7936)
EventMapping = Table(b'EventMapping')
EventMapping.add_field(1, b'Dialog_', 11592)
EventMapping.add_field(2, b'Control_', 11570)
EventMapping.add_field(3, b'Event', 11570)
EventMapping.add_field(4, b'Attribute', 3378)
Extension = Table(b'Extension')
Extension.add_field(1, b'Extension', 11775)
Extension.add_field(2, b'Component_', 11592)
Extension.add_field(3, b'ProgId_', 7679)
Extension.add_field(4, b'MIME_', 7488)
Extension.add_field(5, b'Feature_', 3366)
MIME = Table(b'MIME')
MIME.add_field(1, b'ContentType', 11584)
MIME.add_field(2, b'Extension_', 3583)
MIME.add_field(3, b'CLSID', 7462)
FeatureComponents = Table(b'FeatureComponents')
FeatureComponents.add_field(1, b'Feature_', 11558)
FeatureComponents.add_field(2, b'Component_', 11592)
FileSFPCatalog = Table(b'FileSFPCatalog')
FileSFPCatalog.add_field(1, b'File_', 11592)
FileSFPCatalog.add_field(2, b'SFPCatalog_', 11775)
SFPCatalog = Table(b'SFPCatalog')
SFPCatalog.add_field(1, b'SFPCatalog', 11775)
SFPCatalog.add_field(2, b'Catalog', 2304)
SFPCatalog.add_field(3, b'Dependency', 7424)
Font = Table(b'Font')
Font.add_field(1, b'File_', 11592)
Font.add_field(2, b'FontTitle', 7552)
IniFile = Table(b'IniFile')
IniFile.add_field(1, b'IniFile', 11592)
IniFile.add_field(2, b'FileName', 4095)
IniFile.add_field(3, b'DirProperty', 7496)
IniFile.add_field(4, b'Section', 3936)
IniFile.add_field(5, b'Key', 3968)
IniFile.add_field(6, b'Value', 4095)
IniFile.add_field(7, b'Action', 1282)
IniFile.add_field(8, b'Component_', 3400)
IniLocator = Table(b'IniLocator')
IniLocator.add_field(1, b'Signature_', 11592)
IniLocator.add_field(2, b'FileName', 3583)
IniLocator.add_field(3, b'Section', 3424)
IniLocator.add_field(4, b'Key', 3456)
IniLocator.add_field(5, b'Field', 5378)
IniLocator.add_field(6, b'Type', 5378)
InstallExecuteSequence = Table(b'InstallExecuteSequence')
InstallExecuteSequence.add_field(1, b'Action', 11592)
InstallExecuteSequence.add_field(2, b'Condition', 7679)
InstallExecuteSequence.add_field(3, b'Sequence', 5378)
InstallUISequence = Table(b'InstallUISequence')
InstallUISequence.add_field(1, b'Action', 11592)
InstallUISequence.add_field(2, b'Condition', 7679)
InstallUISequence.add_field(3, b'Sequence', 5378)
IsolatedComponent = Table(b'IsolatedComponent')
IsolatedComponent.add_field(1, b'Component_Shared', 11592)
IsolatedComponent.add_field(2, b'Component_Application', 11592)
LaunchCondition = Table(b'LaunchCondition')
LaunchCondition.add_field(1, b'Condition', 11775)
LaunchCondition.add_field(2, b'Description', 4095)
ListBox = Table(b'ListBox')
ListBox.add_field(1, b'Property', 11592)
ListBox.add_field(2, b'Order', 9474)
ListBox.add_field(3, b'Value', 3392)
ListBox.add_field(4, b'Text', 8000)
ListView = Table(b'ListView')
ListView.add_field(1, b'Property', 11592)
ListView.add_field(2, b'Order', 9474)
ListView.add_field(3, b'Value', 3392)
ListView.add_field(4, b'Text', 8000)
ListView.add_field(5, b'Binary_', 7496)
LockPermissions = Table(b'LockPermissions')
LockPermissions.add_field(1, b'LockObject', 11592)
LockPermissions.add_field(2, b'Table', 11552)
LockPermissions.add_field(3, b'Domain', 15871)
LockPermissions.add_field(4, b'User', 11775)
LockPermissions.add_field(5, b'Permission', 4356)
Media = Table(b'Media')
Media.add_field(1, b'DiskId', 9474)
Media.add_field(2, b'LastSequence', 1282)
Media.add_field(3, b'DiskPrompt', 8000)
Media.add_field(4, b'Cabinet', 7679)
Media.add_field(5, b'VolumeLabel', 7456)
Media.add_field(6, b'Source', 7496)
MoveFile = Table(b'MoveFile')
MoveFile.add_field(1, b'FileKey', 11592)
MoveFile.add_field(2, b'Component_', 3400)
MoveFile.add_field(3, b'SourceName', 8191)
MoveFile.add_field(4, b'DestName', 8191)
MoveFile.add_field(5, b'SourceFolder', 7496)
MoveFile.add_field(6, b'DestFolder', 3400)
MoveFile.add_field(7, b'Options', 1282)
MsiAssembly = Table(b'MsiAssembly')
MsiAssembly.add_field(1, b'Component_', 11592)
MsiAssembly.add_field(2, b'Feature_', 3366)
MsiAssembly.add_field(3, b'File_Manifest', 7496)
MsiAssembly.add_field(4, b'File_Application', 7496)
MsiAssembly.add_field(5, b'Attributes', 5378)
MsiAssemblyName = Table(b'MsiAssemblyName')
MsiAssemblyName.add_field(1, b'Component_', 11592)
MsiAssemblyName.add_field(2, b'Name', 11775)
MsiAssemblyName.add_field(3, b'Value', 3583)
MsiDigitalCertificate = Table(b'MsiDigitalCertificate')
MsiDigitalCertificate.add_field(1, b'DigitalCertificate', 11592)
MsiDigitalCertificate.add_field(2, b'CertData', 2304)
MsiDigitalSignature = Table(b'MsiDigitalSignature')
MsiDigitalSignature.add_field(1, b'Table', 11552)
MsiDigitalSignature.add_field(2, b'SignObject', 11592)
MsiDigitalSignature.add_field(3, b'DigitalCertificate_', 3400)
MsiDigitalSignature.add_field(4, b'Hash', 6400)
MsiFileHash = Table(b'MsiFileHash')
MsiFileHash.add_field(1, b'File_', 11592)
MsiFileHash.add_field(2, b'Options', 1282)
MsiFileHash.add_field(3, b'HashPart1', 260)
MsiFileHash.add_field(4, b'HashPart2', 260)
MsiFileHash.add_field(5, b'HashPart3', 260)
MsiFileHash.add_field(6, b'HashPart4', 260)
MsiPatchHeaders = Table(b'MsiPatchHeaders')
MsiPatchHeaders.add_field(1, b'StreamRef', 11558)
MsiPatchHeaders.add_field(2, b'Header', 2304)
ODBCAttribute = Table(b'ODBCAttribute')
ODBCAttribute.add_field(1, b'Driver_', 11592)
ODBCAttribute.add_field(2, b'Attribute', 11560)
ODBCAttribute.add_field(3, b'Value', 8191)
ODBCDriver = Table(b'ODBCDriver')
ODBCDriver.add_field(1, b'Driver', 11592)
ODBCDriver.add_field(2, b'Component_', 3400)
ODBCDriver.add_field(3, b'Description', 3583)
ODBCDriver.add_field(4, b'File_', 3400)
ODBCDriver.add_field(5, b'File_Setup', 7496)
ODBCDataSource = Table(b'ODBCDataSource')
ODBCDataSource.add_field(1, b'DataSource', 11592)
ODBCDataSource.add_field(2, b'Component_', 3400)
ODBCDataSource.add_field(3, b'Description', 3583)
ODBCDataSource.add_field(4, b'DriverDescription', 3583)
ODBCDataSource.add_field(5, b'Registration', 1282)
ODBCSourceAttribute = Table(b'ODBCSourceAttribute')
ODBCSourceAttribute.add_field(1, b'DataSource_', 11592)
ODBCSourceAttribute.add_field(2, b'Attribute', 11552)
ODBCSourceAttribute.add_field(3, b'Value', 8191)
ODBCTranslator = Table(b'ODBCTranslator')
ODBCTranslator.add_field(1, b'Translator', 11592)
ODBCTranslator.add_field(2, b'Component_', 3400)
ODBCTranslator.add_field(3, b'Description', 3583)
ODBCTranslator.add_field(4, b'File_', 3400)
ODBCTranslator.add_field(5, b'File_Setup', 7496)
Patch = Table(b'Patch')
Patch.add_field(1, b'File_', 11592)
Patch.add_field(2, b'Sequence', 9474)
Patch.add_field(3, b'PatchSize', 260)
Patch.add_field(4, b'Attributes', 1282)
Patch.add_field(5, b'Header', 6400)
Patch.add_field(6, b'StreamRef_', 7462)
PatchPackage = Table(b'PatchPackage')
PatchPackage.add_field(1, b'PatchId', 11558)
PatchPackage.add_field(2, b'Media_', 1282)
PublishComponent = Table(b'PublishComponent')
PublishComponent.add_field(1, b'ComponentId', 11558)
PublishComponent.add_field(2, b'Qualifier', 11775)
PublishComponent.add_field(3, b'Component_', 11592)
PublishComponent.add_field(4, b'AppData', 8191)
PublishComponent.add_field(5, b'Feature_', 3366)
RadioButton = Table(b'RadioButton')
RadioButton.add_field(1, b'Property', 11592)
RadioButton.add_field(2, b'Order', 9474)
RadioButton.add_field(3, b'Value', 3392)
RadioButton.add_field(4, b'X', 1282)
RadioButton.add_field(5, b'Y', 1282)
RadioButton.add_field(6, b'Width', 1282)
RadioButton.add_field(7, b'Height', 1282)
RadioButton.add_field(8, b'Text', 8000)
RadioButton.add_field(9, b'Help', 7986)
Registry = Table(b'Registry')
Registry.add_field(1, b'Registry', 11592)
Registry.add_field(2, b'Root', 1282)
Registry.add_field(3, b'Key', 4095)
Registry.add_field(4, b'Name', 8191)
Registry.add_field(5, b'Value', 7936)
Registry.add_field(6, b'Component_', 3400)
RegLocator = Table(b'RegLocator')
RegLocator.add_field(1, b'Signature_', 11592)
RegLocator.add_field(2, b'Root', 1282)
RegLocator.add_field(3, b'Key', 3583)
RegLocator.add_field(4, b'Name', 7679)
RegLocator.add_field(5, b'Type', 5378)
RemoveFile = Table(b'RemoveFile')
RemoveFile.add_field(1, b'FileKey', 11592)
RemoveFile.add_field(2, b'Component_', 3400)
RemoveFile.add_field(3, b'FileName', 8191)
RemoveFile.add_field(4, b'DirProperty', 3400)
RemoveFile.add_field(5, b'InstallMode', 1282)
RemoveIniFile = Table(b'RemoveIniFile')
RemoveIniFile.add_field(1, b'RemoveIniFile', 11592)
RemoveIniFile.add_field(2, b'FileName', 4095)
RemoveIniFile.add_field(3, b'DirProperty', 7496)
RemoveIniFile.add_field(4, b'Section', 3936)
RemoveIniFile.add_field(5, b'Key', 3968)
RemoveIniFile.add_field(6, b'Value', 8191)
RemoveIniFile.add_field(7, b'Action', 1282)
RemoveIniFile.add_field(8, b'Component_', 3400)
RemoveRegistry = Table(b'RemoveRegistry')
RemoveRegistry.add_field(1, b'RemoveRegistry', 11592)
RemoveRegistry.add_field(2, b'Root', 1282)
RemoveRegistry.add_field(3, b'Key', 4095)
RemoveRegistry.add_field(4, b'Name', 8191)
RemoveRegistry.add_field(5, b'Component_', 3400)
ReserveCost = Table(b'ReserveCost')
ReserveCost.add_field(1, b'ReserveKey', 11592)
ReserveCost.add_field(2, b'Component_', 3400)
ReserveCost.add_field(3, b'ReserveFolder', 7496)
ReserveCost.add_field(4, b'ReserveLocal', 260)
ReserveCost.add_field(5, b'ReserveSource', 260)
SelfReg = Table(b'SelfReg')
SelfReg.add_field(1, b'File_', 11592)
SelfReg.add_field(2, b'Cost', 5378)
ServiceControl = Table(b'ServiceControl')
ServiceControl.add_field(1, b'ServiceControl', 11592)
ServiceControl.add_field(2, b'Name', 4095)
ServiceControl.add_field(3, b'Event', 1282)
ServiceControl.add_field(4, b'Arguments', 8191)
ServiceControl.add_field(5, b'Wait', 5378)
ServiceControl.add_field(6, b'Component_', 3400)
ServiceInstall = Table(b'ServiceInstall')
ServiceInstall.add_field(1, b'ServiceInstall', 11592)
ServiceInstall.add_field(2, b'Name', 3583)
ServiceInstall.add_field(3, b'DisplayName', 8191)
ServiceInstall.add_field(4, b'ServiceType', 260)
ServiceInstall.add_field(5, b'StartType', 260)
ServiceInstall.add_field(6, b'ErrorControl', 260)
ServiceInstall.add_field(7, b'LoadOrderGroup', 7679)
ServiceInstall.add_field(8, b'Dependencies', 7679)
ServiceInstall.add_field(9, b'StartName', 7679)
ServiceInstall.add_field(10, b'Password', 7679)
ServiceInstall.add_field(11, b'Arguments', 7679)
ServiceInstall.add_field(12, b'Component_', 3400)
ServiceInstall.add_field(13, b'Description', 8191)
Shortcut = Table(b'Shortcut')
Shortcut.add_field(1, b'Shortcut', 11592)
Shortcut.add_field(2, b'Directory_', 3400)
Shortcut.add_field(3, b'Name', 3968)
Shortcut.add_field(4, b'Component_', 3400)
Shortcut.add_field(5, b'Target', 3400)
Shortcut.add_field(6, b'Arguments', 7679)
Shortcut.add_field(7, b'Description', 8191)
Shortcut.add_field(8, b'Hotkey', 5378)
Shortcut.add_field(9, b'Icon_', 7496)
Shortcut.add_field(10, b'IconIndex', 5378)
Shortcut.add_field(11, b'ShowCmd', 5378)
Shortcut.add_field(12, b'WkDir', 7496)
Signature = Table(b'Signature')
Signature.add_field(1, b'Signature', 11592)
Signature.add_field(2, b'FileName', 3583)
Signature.add_field(3, b'MinVersion', 7444)
Signature.add_field(4, b'MaxVersion', 7444)
Signature.add_field(5, b'MinSize', 4356)
Signature.add_field(6, b'MaxSize', 4356)
Signature.add_field(7, b'MinDate', 4356)
Signature.add_field(8, b'MaxDate', 4356)
Signature.add_field(9, b'Languages', 7679)
TextStyle = Table(b'TextStyle')
TextStyle.add_field(1, b'TextStyle', 11592)
TextStyle.add_field(2, b'FaceName', 3360)
TextStyle.add_field(3, b'Size', 1282)
TextStyle.add_field(4, b'Color', 4356)
TextStyle.add_field(5, b'StyleBits', 5378)
TypeLib = Table(b'TypeLib')
TypeLib.add_field(1, b'LibID', 11558)
TypeLib.add_field(2, b'Language', 9474)
TypeLib.add_field(3, b'Component_', 11592)
TypeLib.add_field(4, b'Version', 4356)
TypeLib.add_field(5, b'Description', 8064)
TypeLib.add_field(6, b'Directory_', 7496)
TypeLib.add_field(7, b'Feature_', 3366)
TypeLib.add_field(8, b'Cost', 4356)
UIText = Table(b'UIText')
UIText.add_field(1, b'Key', 11592)
UIText.add_field(2, b'Text', 8191)
Upgrade = Table(b'Upgrade')
Upgrade.add_field(1, b'UpgradeCode', 11558)
Upgrade.add_field(2, b'VersionMin', 15636)
Upgrade.add_field(3, b'VersionMax', 15636)
Upgrade.add_field(4, b'Language', 15871)
Upgrade.add_field(5, b'Attributes', 8452)
Upgrade.add_field(6, b'Remove', 7679)
Upgrade.add_field(7, b'ActionProperty', 3400)
Verb = Table(b'Verb')
Verb.add_field(1, b'Extension_', 11775)
Verb.add_field(2, b'Verb', 11552)
Verb.add_field(3, b'Sequence', 5378)
Verb.add_field(4, b'Command', 8191)
Verb.add_field(5, b'Argument', 8191)
tables = [
