    ...
    def _buffer_decode(self, input, errors, final):
        if self.decoder is None:
            ...
            if byteorder == -1:
                ...
                raise UnicodeError(b'UTF-16 stream does not start with BOM')
...
def getregentry():
    return codecs.CodecInfo(name=b'utf-16', encode=encode, decode=decode, incrementalencoder=IncrementalEncoder, incrementaldecoder=IncrementalDecoder, streamreader=StreamReader, streamwriter=StreamWriter)
