...
__all__ = [
 b'LogReader', b'ENTER', b'EXIT', b'LINE']
ENTER = WHAT_ENTER
EXIT = WHAT_EXIT
LINE = WHAT_LINENO
...
class LogReader:
    ...
    def __init__(self, logfn):
        ...
        if b'current-directory' in self._info:
            self.cwd = self._info[b'current-directory']
        else:
            self.cwd = None
        self._stack = []
    ...
    def get_filename(self, fileno):
        try:
            ...
            raise ValueError, b'unknown fileno'
    ...
    def get_fileno(self, filename):
        ...
        raise ValueError, b'unknown filename'
        return
    ...
    def get_funcname(self, fileno, lineno):
        try:
            ...
            raise ValueError, b'unknown function location'
    ...
    def next(self, index=0):
        while 1:
            ...
            if what == WHAT_DEFINE_FILE:
                ...
                if tdelta == b'current-directory':
                    self.cwd = lineno
                self.addinfo(tdelta, lineno)
            else:
                raise ValueError, b'unknown event type'
    ...
    def _loadfile(self, fileno):
        try:
            ...
            print b'Could not identify fileId', fileno
            return 1
