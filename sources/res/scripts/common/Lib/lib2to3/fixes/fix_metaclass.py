    ...
    for node in parent.children:
        ...
        if node.type == syms.simple_stmt and node.children:
            ...
            if expr_node.type == syms.expr_stmt and expr_node.children:
                ...
                if isinstance(left_side, Leaf) and left_side.value == b'__metaclass__':
                    return True
...
def fixup_parse_tree(cls_node):
    ...
    for i, node in enumerate(cls_node.children):
        ...
        raise ValueError(b"No class suite and no ':'!")
...
def find_metas(cls_node):
    for node in cls_node.children:
        ...
        raise ValueError(b'No class suite!')
    ...
    def transform(self, node, results):
        if not has_metaclass(node):
            ...
            if len(node.children) == 7:
                ...
                raise ValueError(b'Unexpected class definition')
            meta_txt = last_metaclass.children[0].children[0]
            meta_txt.value = b'metaclass'
