    ...
    def transform(self, node, results):
        ...
        if base:
            ...
            if is_assign_target(node):
                head = results[b'head']
                if (b'').join([str(n) for n in head]).strip() == u'__builtin__':
