...
class PerkContext(VScriptContext):
    ...
    OnVehicleDamageByEnemy = vse_forward_event(b'OnVehicleDamageByEnemy', (), display_name=b'OnVehicleDamageByEnemy', description=b'On vehicle damage by enemy')
    onVehicleDamageReceived = vse_forward_event(b'onVehicleDamageReceived', (), display_name=b'onVehicleDamageReceived', description=b'On vehicle damage received')
    ...
    OnVehicleClipReload = vse_forward_event(b'OnVehicleClipReload', (), display_name=b'OnVehicleClipReload', description=b'On vehicle clip reload finished')
    ...
    OnNoDamageShot = vse_forward_event(b'OnNoDamageShot', (), display_name=b'OnNoDamageShot', description=b'the shot did no damage')
    OnInnerDeviceWasCrit = vse_forward_event(OnInnerDeviceWasCrit.__name__, lzip(OnInnerDeviceWasCrit._fields, (SLOT_TYPE.INT,)), display_name=b'OnInnerDeviceWasCrit', description=b'On inner device was crit')
    OnVehicleEquipmentActivated = vse_forward_event(OnVehicleEquipmentActivated.__name__, lzip(OnVehicleEquipmentActivated._fields, (SLOT_TYPE.INT, SLOT_TYPE.STR)), display_name=b'OnEquipmentActivated', description=b'On equipment activated')
    OnVehicleTotalDamageDealtIncrease = vse_forward_event(OnVehicleTotalDamageDealtIncrease.__name__, lzip(OnVehicleTotalDamageDealtIncrease._fields, (SLOT_TYPE.INT,)), display_name=b'OnVehicleTotalDamageDealtIncrease', description=b'On vehicle total damage dealt increase')
    OnVehicleAssistIncrease = vse_forward_event(OnVehicleAssistIncrease.__name__, lzip(OnVehicleAssistIncrease._fields, (SLOT_TYPE.INT,)), display_name=b'OnVehicleAssistIncrease', description=b'On vehicle assist increase')
    OnVehicleBlockDamage = vse_forward_event(OnVehicleBlockDamage.__name__, lzip(OnVehicleBlockDamage._fields, (SLOT_TYPE.INT,)), display_name=b'OnVehicleBlockDamage', description=b'On vehicle_block_damage')
    OnVehicleInRange = vse_forward_event(OnVehicleInRange.__name__, lzip(OnVehicleInRange._fields, (SLOT_TYPE.INT, SLOT_TYPE.STR, SLOT_TYPE.BOOL)), display_name=b'OnVehicleInRange', description=b'On vehicle in range')
    OnVehicleShotDamagedEnemyVehicle = vse_forward_event(OnVehicleShotDamagedEnemyVehicle.__name__, lzip(OnVehicleShotDamagedEnemyVehicle._fields, (SLOT_TYPE.INT,)), display_name=b'OnVehicleShotDamagedEnemyVehicle', description=b'On vehicle shot damaged enemy vehicle')
    OnWitnessEnemyDamaged = vse_forward_event(OnWitnessEnemyDamaged.__name__, lzip(OnWitnessEnemyDamaged._fields, (SLOT_TYPE.INT,)), display_name=b'OnWitnessEnemyDamaged', description=b'Vehicle has been damage in our vision')
    OnVehicleRadioDistanceChange = vse_forward_event(OnVehicleRadioDistanceChange.__name__, lzip(OnVehicleRadioDistanceChange._fields, (SLOT_TYPE.FLOAT,)), display_name=b'OnVehicleRadioDistanceChange', description=b'On vehicle radio distance change')
    ...
    @vse_get_property(SLOT_TYPE.ARENA, display_name=b'Arena', description=b'Arena entity', display_group=b'Perk')
    def getArena(self):
...
class CrewContext(PerkContext):
    ...
    @vse_context_effect_forward_event(OnTankmanStatusChanged.__name__, lzip(OnTankmanStatusChanged._fields, (SLOT_TYPE.INT,)), display_name=b'OnTankmanStatusChanged', description=b'Tankman has been deactivated or healed. This event should only be used to track perk activity and not for internal perk logic.', display_group=b'Crew')
