...
def eqDataSection(eqName):
    ...
    if not _dataSection:
        with VsePaths():
            _dataSection = ResMgr.openSection(constants.ITEM_DEFS_PATH + b'vehicles/common/equipments.xml')
