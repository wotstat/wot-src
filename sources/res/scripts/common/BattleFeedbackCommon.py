...
class BATTLE_EVENT_TYPE:
    ...
    DAMAGE_EVENTS = frozenset([RADIO_ASSIST, TRACK_ASSIST, STUN_ASSIST, TANKING, DAMAGE, RECEIVED_DAMAGE, 
     SMOKE_ASSIST, 
     INSPIRE_ASSIST, DESTRUCTIBLE_DAMAGED])
    ...
    ALL = frozenset([SPOTTED, RADIO_ASSIST, TRACK_ASSIST, STUN_ASSIST, BASE_CAPTURE_POINTS, BASE_CAPTURE_DROPPED, 
     TANKING, 
     CRIT, DAMAGE, KILL, RECEIVED_CRIT, RECEIVED_DAMAGE, TARGET_VISIBILITY, 
     ENEMY_SECTOR_CAPTURED, 
     DESTRUCTIBLE_DAMAGED, DESTRUCTIBLE_DESTROYED, DESTRUCTIBLES_DEFENDED, 
     DEFENDER_BONUS, 
     SMOKE_ASSIST, INSPIRE_ASSIST, BASE_CAPTURE_BLOCKED, MULTI_STUN, DETECTED, 
