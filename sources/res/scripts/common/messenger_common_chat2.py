...
BATTLE_CHAT_COMMANDS = [
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_SAVE_TANKS_ATK, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_atk_save_tanks', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_SAVE_TANKS_DEF, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_def_save_tanks', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_TIME_ATK, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_atk_time', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_TIME_DEF, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_def_time', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_HQ_ATK, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_atk_focus_hq', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_HQ_DEF, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_def_focus_hq', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_WEST, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_lane_west', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_CENTER, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_lane_center', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.EPIC_GLOBAL_EAST, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'global_msg_lane_east', vehMarker=None, senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
