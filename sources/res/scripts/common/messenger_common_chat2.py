...
def messageArgs(int32Arg1=0, int64Arg1=0, floatArg1=0, strArg1=b'', strArg2=b''):
    return {b'int32Arg1': int32Arg1, 
       b'int64Arg1': int64Arg1, 
       b'floatArg1': floatArg1, 
       b'strArg1': strArg1, 
       b'strArg2': strArg2}
...
_MESSENGER_ACTION_NAMES = {_id: _name for _name, _id in MESSENGER_ACTION_IDS.__dict__.iteritems() if isinstance(_id, int) and not _name.startswith(b'_')}
_MESSENGER_ERROR_NAMES = {_id: _name for _name, _id in MESSENGER_ERRORS.__dict__.iteritems() if not _name.startswith(b'_')}
...
BATTLE_CHAT_COMMANDS = (
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.SPG_AIM_AREA, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'spg_aim_area', vehMarker=None, senderVehMarker=None, soundNotification=b'ibc_ping_attention', soundNotificationReply=b'ibc_ping_reply', activeCmdTime=_DEFAULT_SPG_AREA_COMMAND_TIME),
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.RELOADING_CASSETE_AUTO_SHOOT, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'reloading_cassette_auto_shoot', vehMarker=b'reloading_gun', senderVehMarker=None, soundNotification=None, soundNotificationReply=None),
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.RELOADING_READY_CASSETE_AUTO_SHOOT, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'reloading_ready_cassette_auto_shoot', vehMarker=None, senderVehMarker=None, soundNotification=b'ibc_ping_attention', soundNotificationReply=None),
 ...
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.OVERHEAT_CANT_SHOOT, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'overheat_cant_shoot', vehMarker=b'reloading_gun', senderVehMarker=None, soundNotification=b'ibc_ping_attention', soundNotificationReply=b'ibc_ping_reply'),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.ATTACK_SUPPLY, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'attack_supply', vehMarker=b'attack', senderVehMarker=b'attackSender', soundNotification=b'ibc_ping_request', soundNotificationReply=b'ibc_ping_reply'),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.ATTACKING_SUPPLY, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'attacking_supply', vehMarker=b'attack', senderVehMarker=b'attackSender', soundNotification=b'ibc_ping_action', soundNotificationReply=b'ibc_ping_reply'),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.DEFEND_SUPPLY, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'defend_supply', vehMarker=b'defend', senderVehMarker=b'defendSender', soundNotification=b'ibc_ping_request', soundNotificationReply=b'ibc_ping_reply'),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.DEFENDING_SUPPLY, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'defending_supply', vehMarker=b'defend', senderVehMarker=b'defendSender', soundNotification=b'ibc_ping_action', soundNotificationReply=b'ibc_ping_reply'),
 BattleChatCommand(id=_makeID(), name=BATTLE_CHAT_COMMAND_NAMES.SELF_REPAIR_SUPPLY, cooldownPeriod=_SAME_BATTLE_CHAT_CMD_COOLDOWN_DURATION, msgText=b'supply_self_repair', vehMarker=None, senderVehMarker=None, soundNotification=b'ibc_ping_action', soundNotificationReply=b'ibc_ping_reply'),
...
VOIP_VIVOX_PROFILE_NAME = b'vivox'
VOIP_WEBRTC_PROFILE_NAME = b'webrtc'
