...
_comp7Season4BlockBuilder = StaticSizeBlockBuilder(b'comp7Season4', COMP7_BLOCK_LAYOUT, {}, [])
_comp7ArchiveGriffinBlockBuilder = StaticSizeBlockBuilder(b'comp7ArchiveGriffin', COMP7_BLOCK_LAYOUT, {}, [])
_versusAIBlockBuilder = StaticSizeBlockBuilder(b'mt_versusAI', VERSUS_AI_BLOCK_LAYOUT, {}, [])
...
_maxComp7Season4BlockBuilder = StaticSizeBlockBuilder(b'maxComp7Season4', MAX_COMP7_BLOCK_LAYOUT, {}, [])
_maxComp7ArchiveGriffinBlockBuilder = StaticSizeBlockBuilder(b'maxComp7ArchiveGriffin', MAX_COMP7_BLOCK_LAYOUT, {}, [])
_maxVersusAIBlockBuilder = StaticSizeBlockBuilder(b'mt_maxVersusAI', MAX_AND_BEST_VEHICLE_BLOCK_LAYOUT, {}, [])
...
class VEHICLE_STATS:
    ...
    COMP7_CUT_SEASON_4 = b'comp7CutSeason4'
    COMP7_CUT_ARCHIVE_GRIFFIN = b'comp7CutArchiveGriffin'
    MT_VERSUS_AI_CUT = b'mt_versusAICut'
    ALL = (
...
_comp7CutSeason4BlockBuilder = DictBlockBuilder(VEHICLE_STATS.COMP7_CUT_SEASON_4, b'I', b'IIII', {})
_comp7CutArchiveGriffinBlockBuilder = DictBlockBuilder(VEHICLE_STATS.COMP7_CUT_ARCHIVE_GRIFFIN, b'I', b'IIII', {})
_versusAICutBlockBuilder = DictBlockBuilder(VEHICLE_STATS.MT_VERSUS_AI_CUT, b'I', b'III', {})
...
_achievements15x15PopUps = [
 ...
 230, 231, 232, 
 233, 234, 235]
_achievements15x15BlockBuilder = StaticSizeBlockBuilder(b'achievements', _ACHIEVEMENTS15X15_BLOCK_LAYOUT, ACHIEVEMENT15X15_DEPENDENCIES, _achievements15x15PopUps, aliases=MEDAL_ALIASES)
_STEAM_BLOCK_LAYOUT = [
 286, 287, 288, 289, 
 290, 291, 292, 293, 
 294, 295, 296, 297, 
...
_steamAchievementsLogRecords = [287, 288, 289, 
 291, 292, 293, 
 295, 296, 297, 
 298, 299, 300, 
 302, 
...
ACHIEVEMENTS7X7_BLOCK_LAYOUT = [
 ...
 399, 
 400]
_achievement7x7PopUps = [364, 366, 367, 370, 
 371, 377, 376, 
 374, 373, 379, 381, 
 383, 385, 
 387, 388, 
...
_playerBadgesBlockBuilder = DictBlockBuilder(b'playerBadges', b'I', b'I', {})
...
FALLOUT_ACHIEVEMENTS_BLOCK_LAYOUT = [
 ...
 764, 765]
_falloutAchievementsPopUps = [754, 755, 756, 757, 758, 
...
EPIC_BATTLE_ACHIEVEMENTS_BLOCK_LAYOUT = [
 767, 768, 769, 770, 
 771, 772, 773, 774]
_epicBattleAchievementsPopUps = [b'frontlineMedal', b'saboteur']
...
MT_BLOCK_LAYOUT = [
 b'rpBronzeMedal', b'rpSilverMedal', b'rpGoldMedal']
_mtPopUps = [b'rpBronzeMedal', b'rpSilverMedal', b'rpGoldMedal']
_mtAchievementsBlockBuilder = StaticSizeBlockBuilder(b'mtAchievements', MT_BLOCK_LAYOUT, {}, _mtPopUps)
