...
def __updateFromAccountDossier147(compDescr):
    ...
    return (
     148, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier148(compDescr):
    ...
    comp7SeasonsNewPacking = {b'spotted': (32, b'I'), b'losses': (12, b'I'), b'roleSkillUsed': (132, b'I'), b'damageAssistedTrack': (56, b'I'), 
       ...
       b'directHits': (28, b'I')}
    seasonsNumber = 3
    archiveSeasons(b'comp7ArchiveGriffin', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsNewPacking)
    ...
    archiveMaxSeasons(b'maxComp7ArchiveGriffin', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons(b'comp7CutArchiveGriffin', seasonsNumber, updateCtx)
    setVersion(updateCtx, 149)
    return (149, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier149(compDescr):
    ...
    getHeader(updateCtx)
    formats = [
     (b'wt2023HunterWins', b'I'),
     (b'wt2023BossWins', b'I'),
     (b'wt2023MaxPlasma', b'I')]
    addRecords(updateCtx, b'achievements', formats, {})
    setVersion(updateCtx, 150)
    return (150, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier150(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'prestigeSystem')
    setVersion(updateCtx, 151)
    return (
     151, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier151(compDescr):
    ...
    playerBadges = getDictBlockRecordValues(updateCtx, b'playerBadges', b'I', b'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)

    updateDictRecords(updateCtx, b'playerBadges', b'I', b'I', playerBadges)
    setVersion(updateCtx, 152)
    return (
     152, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier152(compDescr):
    ...
    return (
     153, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier153(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'vehicleAchievements')
    addBlock(updateCtx, b'customizationAchievements')
...
def __updateFromAccountDossier154(compDescr):
    ...
    return (
     155, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier155(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'comp7ArchivePegasus')
    addBlock(updateCtx, b'maxComp7ArchivePegasus')
    addBlock(updateCtx, b'comp7CutArchivePegasus')
    setVersion(updateCtx, 156)
    return (
     156, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier156(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    comp7SeasonsPacking = {b'spotted': (32, b'I'), b'losses': (12, b'I'), b'roleSkillUsed': (132, b'I'), b'damageAssistedTrack': (56, b'I'), 
       b'damageReceived': (40, b'I'), b'battlesOnStunningVehicles': (100, b'I'), 
       b'piercingsReceived': (72, b'I'), b'originalXP': (52, b'I'), 
       b'damageAssistedRadio': (60, b'I'), b'battlesCount': (4, b'I'), b'survivedBattles': (16, b'I'), 
       b'winSeries': (112, b'I'), b'piercings': (84, b'I'), b'damageBlockedByArmor': (96, b'I'), 
       ...
       b'directHits': (28, b'I')}
    seasonsNumber = 3
    archiveSeasons(b'comp7ArchivePegasus', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsPacking)
    maxComp7SeasonsPacking = {b'maxDamage': (3, b'H'), b'maxXPVehicle': (5, b'I'), b'maxDamageVehicle': (13, b'I'), b'maxFrags': (2, b'B'), 
       b'maxXP': (0, b'H'), b'maxHealthRepair': (29, b'H'), b'maxComp7PrestigePointsVehicle': (19, b'I'), 
       b'maxEquipmentDamageDealt': (23, b'H'), b'maxFragsVehicle': (9, b'I'), 
       b'maxSquadWinSeries': (37, b'H'), b'maxComp7PrestigePoints': (17, b'H'), 
       b'maxWinSeries': (35, b'H'), b'maxEquipmentDamageDealtVehicle': (25, b'I'), 
       b'maxHealthRepairVehicle': (31, b'I')}
    archiveMaxSeasons(b'maxComp7ArchivePegasus', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons(b'comp7CutArchivePegasus', seasonsNumber, updateCtx)
...
def __updateFromAccountDossier161(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'commendations')
    setVersion(updateCtx, 162)
    return (162, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier162(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'statTrackersVehStatsCut')
    setVersion(updateCtx, 163)
    return (163, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier163(compDescr):
    ...
    getHeader(updateCtx)
    formats = [
     (b'readyForBattleAssault', b'B'),
     (b'readyForBattleSniper', b'B'),
     (b'readyForBattleSupport', b'B')]
    addRecords(updateCtx, b'achievements', formats, {})
    setVersion(updateCtx, 164)
    return (164, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier164(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'comp7ArchiveManticore')
    addBlock(updateCtx, b'maxComp7ArchiveManticore')
    addBlock(updateCtx, b'comp7CutArchiveManticore')
    setVersion(updateCtx, 165)
    return (
     165, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier165(compDescr):
    ...
    comp7SeasonsPacking = {b'spotted': (32, b'I'), b'losses': (12, b'I'), b'roleSkillUsed': (132, b'I'), b'damageAssistedTrack': (56, b'I'), 
       ...
       b'directHits': (28, b'I')}
    seasonsNumber = 3
    archiveSeasons(b'comp7ArchiveManticore', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsPacking)
    maxComp7SeasonsPacking = {b'maxDamage': (3, b'H'), b'maxXPVehicle': (5, b'I'), b'maxDamageVehicle': (13, b'I'), b'maxFrags': (2, b'B'), 
       b'maxXP': (0, b'H'), b'maxHealthRepair': (29, b'H'), b'maxComp7PrestigePointsVehicle': (19, b'I'), 
       b'maxEquipmentDamageDealt': (23, b'H'), b'maxFragsVehicle': (9, b'I'), 
       b'maxSquadWinSeries': (37, b'H'), b'maxComp7PrestigePoints': (17, b'H'), 
       b'maxWinSeries': (35, b'H'), b'maxEquipmentDamageDealtVehicle': (25, b'I'), 
       b'maxHealthRepairVehicle': (31, b'I')}
    archiveMaxSeasons(b'maxComp7ArchiveManticore', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons(b'comp7CutArchiveManticore', seasonsNumber, updateCtx)
    ...
    return (
     166, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier166(compDescr):
    ...
    getHeader(updateCtx)
    formats = [
     (b'steamGetTankLevel11Medal', b'B')]
    addRecords(updateCtx, b'steamAchievements', formats, {})
    setVersion(updateCtx, 167)
    return (
     167, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier167(compDescr):
    ...
    return (
     168, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier168(compDescr):
    ...
    return (
     169, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier169(compDescr):
    ...
    getHeader(updateCtx)
    formats = [
     (b'readyForBattleFossaAssault', b'B'),
     (b'readyForBattleFossaSniper', b'B'),
     (b'readyForBattleFossaSupport', b'B')]
    addRecords(updateCtx, b'achievements', formats, {})
    setVersion(updateCtx, 170)
    return (170, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier170(compDescr):
    ...
    updateCtx = {b'dossierCompDescr': compDescr, 
       ...
       b'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, b'comp7ArchiveDragon')
    addBlock(updateCtx, b'maxComp7ArchiveDragon')
    addBlock(updateCtx, b'comp7CutArchiveDragon')
    setVersion(updateCtx, 171)
    return (
     171, updateCtx[b'dossierCompDescr'])
...
def __updateFromAccountDossier171(compDescr):
    ...
    comp7SeasonsPacking = {b'spotted': (32, b'I'), b'losses': (12, b'I'), b'roleSkillUsed': (132, b'I'), b'damageAssistedTrack': (56, b'I'), 
       ...
       b'directHits': (28, b'I')}
    seasonsNumber = 3
    archiveSeasons(b'comp7ArchiveDragon', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsPacking)
    maxComp7SeasonsPacking = {b'maxDamage': (3, b'H'), b'maxXPVehicle': (5, b'I'), b'maxDamageVehicle': (13, b'I'), b'maxFrags': (2, b'B'), 
       b'maxXP': (0, b'H'), b'maxHealthRepair': (29, b'H'), b'maxComp7PrestigePointsVehicle': (19, b'I'), 
       b'maxEquipmentDamageDealt': (23, b'H'), b'maxFragsVehicle': (9, b'I'), 
       b'maxSquadWinSeries': (37, b'H'), b'maxComp7PrestigePoints': (17, b'H'), 
       b'maxWinSeries': (35, b'H'), b'maxEquipmentDamageDealtVehicle': (25, b'I'), 
       b'maxHealthRepairVehicle': (31, b'I')}
    archiveMaxSeasons(b'maxComp7ArchiveDragon', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons(b'comp7CutArchiveDragon', seasonsNumber, updateCtx)
    ...
    return (
     172, updateCtx[b'dossierCompDescr'])
...
def __updateFromVehicleDossier100(compDescr):
    ...
    if oldValues:
        ...
        if newValues:
            setStaticSizeBlockRecordValues(updateCtx, b'max30x30', recordsPacking, {name: max(oldValues.get(name, 0), newValues.get(name, 0)) for name in recordsPacking})
        else:
