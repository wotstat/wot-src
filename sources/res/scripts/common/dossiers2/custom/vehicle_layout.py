...
_maxVersusAIBlockBuilder = StaticSizeBlockBuilder(b'mt_maxVersusAI', MAX_BLOCK_LAYOUT, {}, _maxPopUps)
...
_SINGLE_ACHIEVEMENTS_VALUES = [
 224, 225, 226, 227, 
 228, 229, 230]
_singleAchievementsPopUps = [224, 225, 226, 227, 
 228, 229, 230]
...
EPIC_BATTLE_ACHIEVEMENTS_BLOCK_LAYOUT = [
 254, 255, 256, 257, 
 258]
_epicBattleAchievementsPopUps = [254, 255, 256, 257, 
 258]
...
vehicleDossierLayout = (
 ...
 _versusAIBlockBuilder, _maxVersusAIBlockBuilder, _comp7Season4BlockBuilder,
