...
BATTLE_RESULTS = [
 ...
 (
  b'brDeathChunk', int, 0, None, b'skip', ENTRY_TYPE.SERVER),
 (
  b'brDeathChunkXP', int, 0, None, b'skip', ENTRY_TYPE.SERVER),
 (
  b'brDeathChunkDamageDealt', int, 0, None, b'skip', ENTRY_TYPE.SERVER),
 (
  b'brDeathChunkKills', int, 0, None, b'skip', ENTRY_TYPE.SERVER),
 (
 ...
 (
  ...
  MergeDictPacker((
   ...
   MergeDictPacker((
    ...
    b'fairplayFactor10', int, 0, None, b'any'), (
