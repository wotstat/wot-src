...
BATTLE_RESULTS = [
 ...
 (
  b'details', None, None, None, b'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  b'marksOnGun', int, 0, None, b'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  b'PMProgress', dict, {}, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'dogTags', dict, {}, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventCreditsList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventXPList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventFreeXPList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventTMenXPList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventGoldList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventCrystalList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventEventCoinList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventBpcoinList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'eventEquipCoinList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
 ...
 (
  b'isNotSpotted', bool, True, None, b'min', ENTRY_TYPE.SERVER),
 (
 ...
 (
  b'cybersportRatingDeltas', tuple, (0.0, 0.0), None, b'skip', ENTRY_TYPE.SERVER),
 (
 ...
 (
  b'isDebutBoxesEnabled', bool, False, None, b'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'teamSubscribersCount', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'teamSubsBonusCredits', int, 0, None, b'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'paragonCoins', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'originalParagonCoins', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'paragonCoinsReplay', str, b'', ValueReplayPacker(), b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'paragonCoinsGrantedList', list, [], None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'paragonChapter', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  b'directivesCredits', int, 0, None, b'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesXP', int, 0, None, b'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesFreeXP', int, 0, None, b'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesTMenXP', int, 0, None, b'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesCreditsFactor100', int, 0, None, b'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesXPFactor100', int, 0, None, b'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesFreeXPFactor100', int, 0, None, b'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'directivesTMenXPFactor100', int, 0, None, b'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  b'completedQuestIDs', set, set(), None, b'joinSets', ENTRY_TYPE.SERVER)]
BATTLE_PASS_RESULTS = [
 (
  b'bpChapter', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
 ...
 (
  b'sumPoints', int, 0, None, b'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
