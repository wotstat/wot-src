...
PM3_SELECT_BONUS_NAME = b'pm3SelectBonus'
PM3_PREFIX_NAME = b'pm3'
...
class RegularDescription(IClientDescription):
    __slots__ = (b'iconID', b'limiterID', b'isInOrGroup')
    ...
    def __repr__(self):
        return self.__class__.__name__ + b': ' + str(self.iconID) + b' ' + str(self.limiterID) + b' ' + str(self.isInOrGroup)
