...
VEH_INTERACTION_DETAILS = (
 ...
 (b'directHitsReceived', b'H', 65535, 0),
 (b'damageRamming', b'I', 4294967295L, 0))
...
class VehicleInteractionDetails(object):
    ...
    def fromPacked(packed):
        ...
        values = list(struct.unpack(b'<' + VEH_INTERACTION_DETAILS_LAYOUT * count, packed[packedVehIDsLen:]))
