...
C11N_QUESTS_PROGRESSION_SOURCE_PATH = [
 b'scripts/item_defs/customization/progression/quests']
CustomizationQuest = namedtuple(b'CustomizationQuest', (b'questID', b'questName', b'questDescr', b'questClientData'))
g_cust_cache = None
...
def init():
    ...
    if g_cust_cache is None:
        g_cust_cache, _ = pdc.load(b'customization_quests_cache', _createCache, QuestValidationSerializer())
    return
