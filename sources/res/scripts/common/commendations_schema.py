...
class CommendationsConfigModel(models.Model):
    __slots__ = (b'isLiveTagsEnabled', b'isCommendationsEnabled')
...
commendationsConfigSchema = GameParamsSchema[CommendationsConfigModel](gameParamsKey=Configs.COMMENDATIONS_CONFIG.value, fields={b'isLiveTagsEnabled': (d2mfields.Boolean()), 
   b'isCommendationsEnabled': (d2mfields.Boolean())}, modelClass=CommendationsConfigModel, checkUnknown=True, usedInReplay=True)
