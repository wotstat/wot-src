...
def ShowWarningOnce():
    ...
    if WarningFlag:
        ...
        logging.warning(b'%s: This API will be deprecated soon, please use the new API.', func_name)
    return
...
def timeOfDay(spaceID):
    ...
    try:
        ...
        logging.warning(b'BigWorld.timeOfDay( spaceID ): Space is not found, spaceID=%s', str(spaceID))
        return -1.0
