...
class UserBanCommandProcessor(UserCommandProcessor):
    ...
    def _makeTuple(self, rawData):
        ...
        if words and words[0].lower() == b'kick':
            banTypeIdx *= -1
...
class ChannelEntityUnreachable(ChatException):
    ...
    def _getMessage(self):
        return b'Base entity of channel with id: %s was invalidated. Probably center is down. ' % self.__channelId
