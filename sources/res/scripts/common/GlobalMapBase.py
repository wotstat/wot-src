...
OK = GM_ERROR.OK
GM_ERROR_NAMES = {v: k for k, v in GM_ERROR.__dict__.items() if not k.startswith(b'_')}
...
class GlobalMapBase(OpsUnpacker):
    ...
    def pack(self, isForced=False):
        ...
        if self.battles:
            ...
            for battleID, data in viewitems(self.battles):
                ...
                localizedData = packPascalString(pickle.dumps(data[b'localizedData'], -1))
    ...
    def deserialize(self, pdata):
        ...
        try:
            ...
            LOG_DEBUG_DEV(b'GlobalMapBase.self: ', self)
            raise e
    ...
    def _unpackBattle(self, packedData):
        ...
        self.battles[battleID] = {b'peripheryID': peripheryID, 
           ...
           b'startTime': startTime, 
           b'isFinished': isFinished, 
           b'localizedData': (pickle.loads(localizedDataStr))}
