...
if __name__ == b'__main__':
    ...
    def error(msg):
        print(msg, end=b' ', file=sys.stderr)
        print(b'usage: %s [number_of_loops]' % sys.argv[0], file=sys.stderr)
        sys.exit(100)
        return
    ...
    if nargs > 1:
        error(b'%d arguments are too many;' % nargs)
    elif nargs == 1:
        try:
            loops = int(sys.argv[1])
        except ValueError:
            error(b'Invalid argument %r;' % sys.argv[1])
