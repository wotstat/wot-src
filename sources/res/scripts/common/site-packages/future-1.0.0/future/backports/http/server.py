...
__version__ = u'0.6'
__all__ = [
 u'HTTPServer', u'BaseHTTPRequestHandler']
...
class BaseHTTPRequestHandler(socketserver.StreamRequestHandler):
    ...
    def send_error(self, code, message=None):
        ...
        content = self.error_message_format % {u'code': code, u'message': (_quote_html(message)), u'explain': explain}
    ...
    def date_time_string(self, timestamp=None):
        ...
        s = u'%s, %02d %3s %4d %02d:%02d:%02d GMT' % (
         self.weekdayname[wd],
