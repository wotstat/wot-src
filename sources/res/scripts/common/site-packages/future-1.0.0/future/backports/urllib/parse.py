...
uses_relative = [
 ...
 35, 
 36]
uses_netloc = [20, 21, 22, 23, 37, 
 24, 25, 26, 29, 27, 28, 
 38, 30, 31, 32, 39, 
 33, 
 35, 36, 34, 40, 41, 42]
uses_params = [20, 43, 30, 21, 24, 
 27, 28, 31, 32, 44, 45, 
 29, 33, 34, 46]
non_hierarchical = [
 22, 43, 47, 48, 
 37, 25, 24, 38, 44, 45]
uses_query = [21, 25, 24, 27, 28, 29, 
 22, 31, 32, 44, 45, 33]
uses_fragment = [20, 43, 21, 22, 48, 
 23, 25, 27, 28, 38, 
 26, 30, 33]
...
def quote_plus(string, safe=u'', encoding=None, errors=None):
    if isinstance(string, str) and u' ' not in string or isinstance(string, bytes) and b' ' not in string:
