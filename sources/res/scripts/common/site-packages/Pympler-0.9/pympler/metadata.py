project_name = b'Pympler'
version = b'0.9'
url = b'https://github.com/pympler/pympler'
license = b'Apache License, Version 2.0'
author = b'Jean Brouwers, Ludwig Haehne, Robert Schuppenies'
author_email = b'pympler-dev@googlegroups.com'
copyright = b'2008-2020, ' + author
description = b'A development tool to measure, monitor and analyze the memory behavior of Python objects.'
