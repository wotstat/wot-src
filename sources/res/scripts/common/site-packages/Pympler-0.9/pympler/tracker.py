...
class SummaryTracker(object):
    ...
    def diff(self, summary1=None, summary2=None):
        ...
        if summary2 is None:
            ...
            raise ValueError(b'You cannot provide summary2 without summary1.')
...
class ObjectTracker(object):
    ...
    def _get_objects(self, ignore=()):
        ...
        if hasattr(self, b'o0'):
            ignore += (self.o0,)
        if hasattr(self, b'o1'):
            ignore += (self.o1,)
    ...
    def format_diff(self, ignore=()):
        ...
        lines.append(b'Added objects:')
        for line in summary.format_(summary.summarize(diff[b'+'])):
            lines.append(line)

        lines.append(b'Removed objects:')
        for line in summary.format_(summary.summarize(diff[b'-'])):
            lines.append(line)
