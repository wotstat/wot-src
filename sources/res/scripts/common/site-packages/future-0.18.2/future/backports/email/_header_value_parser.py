...
class Terminal(str):
    ...
    def _pp(self, indent=u''):
        return [
         (u'{}{}/{}({}){}').format(indent, self.__class__.__name__, self.token_type, super(Terminal, self).__repr__(), u'' if not self.defects else (u' {}').format(self.defects))]
...
def _get_ptext_to_endchars(value, endchars):
    ...
    return (
     (u'').join(vchars), (u'').join([fragment[pos:]] + remainder), had_qp)
