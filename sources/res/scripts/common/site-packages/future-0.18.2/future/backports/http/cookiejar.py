...
def time2isoz(t=None):
    ...
    return u'%04d-%02d-%02d %02d:%02d:%02dZ' % (
...
UTC_ZONES = {u'GMT': None, u'UTC': None, u'UT': None, u'Z': None}
...
class LWPCookieJar(FileCookieJar):
    ...
    def _really_load(self, f, filename, ignore_discard, ignore_expires):
        ...
        try:
            ...
            _warn_unhandled_exception()
            raise LoadError(u'invalid Set-Cookie3 format file %r: %r' % (
             filename, line))
...
class MozillaCookieJar(FileCookieJar):
    ...
    def _really_load(self, f, filename, ignore_discard, ignore_expires):
        ...
        try:
            ...
            _warn_unhandled_exception()
            raise LoadError(u'invalid Netscape format cookies file %r: %r' % (
             filename, line))
        ...
        try:
            ...
            for cookie in self:
                ...
                if cookie.value is None:
                    ...
                    name = cookie.name
                    value = cookie.value
                f.write((u'\t').join([cookie.domain, initial_dot, cookie.path,
                 secure, expires, name, value]) + u'\n')
