...
def newsuper(typ=_SENTINEL, type_or_obj=_SENTINEL, framedepth=1):
    if typ is _SENTINEL:
        ...
        try:
            ...
            raise RuntimeError(b'super() used in a function with no args')
        ...
        try:
            ...
            try:
                ...
                raise RuntimeError(b'super() used with a non-newstyle class')
        ...
        for typ in mro:
            ...
            raise RuntimeError(b'super() called outside a method')
