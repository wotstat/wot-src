...
class InstallableItem(with_metaclass(ReflectionMetaclass, VehicleItem)):
    __slots__ = (b'weight', b'modelsSets', b'models', b'materials', b'hitTesterManager', b'unlocks', b'armorHomogenization', b'camouflage', b'healthParams', b'sounds', b'emblemSlots', b'slotsAnchors')
...
class Turret(with_metaclass(ReflectionMetaclass, InstallableItem)):
    __slots__ = (b'gunPosition', b'gunJointPitch', b'rotationSpeed', b'turretRotatorHealth', b'surveyingDeviceHealth', b'invisibilityFactor', b'primaryArmor', b'ceilless', b'showEmblemsOnGun', b'guns', b'secondaryGuns', b'turretRotatorSoundManual', b'turretRotatorSoundGear', b'AODecals', b'turretDetachmentEffects', b'physicsShape', b'circularVisionRadius', b'customizableVehicleAreas', b'multiGun', b'prefabs', b'slotPrefabs', b'objectSlots')
...
class Gun(with_metaclass(ReflectionMetaclass, InstallableItem)):
    __slots__ = (b'rotationSpeed', b'reloadTime', b'aimingTime', b'maxAmmo', b'invisibilityFactorAtShot', b'effectsCaliber', b'effects', b'reloadEffect', b'impulse', b'recoil', b'animateEmblemSlots', b'shotOffset', b'multiGunState', b'turretYawLimits', b'pitchLimits', b'staticTurretYaw', b'staticPitch', b'shotDispersionAngle', b'shotDispersionFactors', b'burst', b'clip', b'shots', b'autoreload', b'autoreloadHasBoost', b'drivenJoints', b'customizableVehicleAreas', b'dualGun', b'edgeByVisualModel', b'prefabs', b'shootImpulses', b'dualAccuracy', b'isDamageMutable', b'forcedReloadTime', b'autoShoot', b'twinGun', b'slotPrefabs', b'objectSlots', b'prefabEffects', b'muzzleBrake', b'secondaryGunID', b'controllableReload', b'mechanicsParams', b'__weakref__')
    ...
    def prefabBased(self):
        return bool(self.prefabs and self.prefabs.get(b'default', {}).get(b'main', ()))
    ...
    @property
    def hasClip(self):
        return b'clip' in self.tags


@add_shallow_copy(b'variantName')
class Hull(with_metaclass(ReflectionMetaclass, BasicItem)):
    __slots__ = (b'variantName', b'hitTesterManager', b'materials', b'weight', b'maxHealth', b'ammoBayHealth', b'armorHomogenization', b'turretPositions', b'turretPitches', b'turretHardPoints', b'variantMatch', b'fakeTurrets', b'emblemSlots', b'slotsAnchors', b'modelsSets', b'models', b'swinging', b'customEffects', b'AODecals', b'camouflage', b'hangarShadowTexture', b'primaryArmor', b'customizableVehicleAreas', b'burnoutAnimation', b'prefabs', b'slotPrefabs', b'objectSlots')
