...
DEFAULT_GETTERS = {b'String': str, 
   b'WideString': unicode, 
   b'Float': (lambda : 0.0), 
   b'Int': (lambda : 0), 
   b'Int64': (lambda : 0), 
   b'Vector2': (Math.Vector2), 
   b'Vector3': (Math.Vector3), 
   b'Vector4': (Math.Vector4), 
   b'Matrix': (Math.Matrix), 
   b'Bool': (lambda : False), 
   b'Strings': (lambda : ()), 
