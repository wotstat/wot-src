...
def _readTankmenGroup(xmlCtx, groupName, subsection, firstNames, lastNames, icons, optimizationCache=None):
    ...
    return tankmen_components.NationGroup(_xml.readNonNegativeInt(xmlCtx, subsection, b'groupID'), groupName, b'female' == _xml.readNonEmptyString(xmlCtx, subsection, b'sex'), subsection.readBool(b'notInShop', False), _readIDs((
     xmlCtx, b'firstNames'), _xml.getChildren(xmlCtx, subsection, b'firstNames'), firstNames, parseName, optimizationNeeded=hasLocalizedName, optimizationCache=optimizationCache), _readIDs((
     xmlCtx, b'lastNames'), _xml.getChildren(xmlCtx, subsection, b'lastNames'), lastNames, parseName, optimizationNeeded=hasLocalizedName, optimizationCache=optimizationCache), _readIDs((
