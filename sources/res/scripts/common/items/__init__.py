...
_g_itemTypes = None
UNDEFINED_ITEM_CD = 0
ITEM_TYPE_NAMES = (b'_reserved', b'vehicle', b'vehicleChassis', b'vehicleTurret', b'vehicleGun', b'vehicleEngine', b'vehicleFuelTank', b'vehicleRadio', b'tankman', b'optionalDevice', b'shell', b'equipment', b'customizationItem', b'crewSkin', b'crewBook', b'pet')
...
def init(preloadEverything, pricesToCollect=None, step=None):
    ...
    if pricesToCollect is not None:
        ...
        pricesToCollect[b'camouflagePriceFactors'] = [{} for _ in nations.NAMES]
        pricesToCollect[b'notInShopCamouflages'] = [set() for _ in nations.NAMES]
        pricesToCollect[b'inscriptionGroupPriceFactors'] = [{} for _ in nations.NAMES]
        pricesToCollect[b'notInShopInscriptionGroups'] = [set() for _ in nations.NAMES]
