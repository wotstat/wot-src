...
def getLoreConfig():
    ...
    if _g_loreConfig is None:
        _g_loreConfig = tankmen_readers.readLoreConfig(ITEM_DEFS_PATH + b'tankmen/common/lore.xml')
...
def getAutoFillConfig():
    ...
    if _g_autoFillConfig is None:
        _g_autoFillConfig = skills_readers.readAutoFillConfig(ITEM_DEFS_PATH + b'tankmen/common/autofill.xml')
