...
class ItemTags(object):
    ...
    IS_3D = b'c11n3D'
    BATTLE_EFFECT = b'battleEffect'
    SHOW_DISABLED = b'showDisabled'
...
class AttachmentLogic(object):
    UNKNOWN = b''
    FLAG_PART = b'flagPart'
    FLAG_ANIMATION = b'flagAnimation'
    PREFAB = b'prefab'
...
class AttachmentType(object):
    ...
    TURRET = b'turret'
    GUN_MANTLET = b'gunMantlet'
    GUN = b'gun'
    GUN_STATIC = b'gunStatic'
    GUN_RIGHT = b'gunRight'
    GUN_LEFT = b'gunLeft'
