...
class TestBridge(object):
    ...
    moverTransform1 = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Mover1', value=GenericComponents.TransformComponent)
    moverTransform2 = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Mover2', value=GenericComponents.TransformComponent)
    trigger1 = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Trigger1', value=Triggers.AreaTriggerComponent)
    trigger2 = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Trigger2', value=Triggers.AreaTriggerComponent)
    limit = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'Limit', value=0.5)
    speed = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'Speed', value=1)
...
class TestBridgeManager(CGF.ComponentManager):
    ...
    @onProcessQuery(TestBridge, tickGroup=b'Simulation')
