...
class TestRotateWhileInTrigger(object):
    ...
    rotationSpeed = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'rotation speed when anyone is present', value=1.0)
...
class TestComponentCreation(object):
    ...
    rotationSpeed = ComponentProperty(type=CGFMetaTypes.FLOAT, editorName=b'rotation speed', value=0.0)
...
class TestPrefabSpawner(object):
    category = DEMO_CATEGORY
    domain = CGF.DomainOption.DomainClient
    prefabPath = ComponentProperty(type=CGFMetaTypes.STRING, editorName=b'Prefab to spawn', value=b'content/Prefabs/1003_cgf_test/TestExplosion.prefab', annotations={b'path': b'*.prefab'})
    instancesCount = ComponentProperty(type=CGFMetaTypes.INT, editorName=b'Instances count', value=1)
    areaToSpawn = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Area to spawn', value=Triggers.CylinderAreaComponent)
    triggerToMonitor = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Trigger to monitor', value=Triggers.AreaTriggerComponent)
    transform = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'transform', value=GenericComponents.TransformComponent)
    attachToEntered = ComponentProperty(type=CGFMetaTypes.BOOL, editorName=b'attach to entered', value=False)
...
class TestVehicleAreaTriggerComponent(object):
    ...
    health = ComponentProperty(type=CGFMetaTypes.INT, editorName=b'Health count', value=0)
    isDamageTrigger = ComponentProperty(type=CGFMetaTypes.BOOL, editorName=b'Is Damage trigger')
...
class TestHealthTriggersComponent(object):
    category = DEMO_CATEGORY
    domain = CGF.DomainOption.DomainServer | CGF.DomainOption.DomainEditor
    healthComponent = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'Health component link', value=HealthComponentCGF)
    trigger = ComponentProperty(type=CGFMetaTypes.LINK, editorName=b'AreaTrigger', value=Triggers.AreaTriggerComponent)
    health = ComponentProperty(type=CGFMetaTypes.INT, editorName=b'Health count', value=0)
    isDamageTrigger = ComponentProperty(type=CGFMetaTypes.BOOL, editorName=b'Is Damage trigger')
