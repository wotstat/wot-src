...
class PhysicsTurretShape(with_metaclass(ReflectionMetaclass, object)):
    PARAMS_DESC = {b'zScale': (0.0, 2.0, 1.0, 0), 
       ...
       b'zRounding': (0.0, 1.0, 0.0, 6), 
       b'zRoundingCenter': (0.0, 1.0, 0.0, 7), 
       b'xRounding': (0.0, 1.0, 0.0, 8), 
       b'xRoundingCenter': (0.0, 1.0, 0.0, 9), 
       b'xSlope': (0.0, 1.0, 0.0, 10), 
       b'xSlopeCenter': (0.0, 1.0, 0.0, 11), 
       b'zSlope': (0.0, 1.0, 0.0, 12), 
       b'zSlopeCenter': (0.0, 1.0, 0.0, 13), 
       b'topSlope': (0.0, 1.0, 0.0, 14)}
