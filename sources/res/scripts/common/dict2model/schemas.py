...
SchemaModelType = typing.TypeVar(b'SchemaModelType', bound=typing.Union[Model, typing.Dict])
...
class Schema(patched_typing.Generic[SchemaModelType]):
    ...
    def _deserialize(self, incoming, filter_=None, skipValidation=False, **kwargs):
        ...
        try:
            ...
            raise ValidationError((b'Model: {}, error: {}, traceback: {}').format(self._modelClass, error, traceback.format_exc()))
