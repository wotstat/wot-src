...
PLAYER_CMD_NAMES = {v: k for k, v in globals().items() if k.startswith(b'CMD_')}
...
LOCK_REASON_NAMES = {v: k for k, v in viewitems(LOCK_REASON.__dict__) if not k.startswith(b'__')}
