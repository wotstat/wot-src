...
class ATTACK_REASON(object):
    ...
    CIRCUIT_OVERLOAD = b'circuitOverload'
    MISSILE = b'missile'
    ABILITY_SHELL = b'ability_shell'
    DAMAGE_SHIELD_EXPLOSION = b'damage_shield_explosion'
    DAMAGE_STUN_AREA_MOD_A = b'stun_area_mod_a'
    ANOMALY = b'anomaly'
    NONE = b'none'
...
WINBACK_NOVICE_TOKEN = b'winback:novice'
...
VEHICLE_ATTRS_TO_SYNC = frozenset([b'circularVisionRadius', b'gun/piercing', b'gun/canShoot'])
VEHICLE_ATTRS_TO_SYNC_ALIASES = {b'gun/piercing': b'gunPiercing', b'gun/canShoot': b'gunCanShoot'}
...
DamageAbsorptionLabelToType = {b'FRAGMENTS': (DamageAbsorptionTypes.FRAGMENTS), 
   ...
   b'NONE': (DamageAbsorptionTypes.NONE)}
...
class EntityCaptured(object):
    ...
    WT_GENERATOR = b'captureGenerator'
