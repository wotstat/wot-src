...
def init():
    ...
    logging.addLevelName(BWLogger.TRACE, b'TRACE')
    logging.addLevelName(BWLogger.NOTICE, b'NOTICE')
    logging.addLevelName(BWLogger.HACK, b'HACK')
