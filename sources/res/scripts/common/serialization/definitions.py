...
__all__ = (b'FieldType', b'FieldTypes', b'FieldFlags')
if IS_EDITOR:
    FieldType = namedtuple(b'FieldType', b'type default flags saveTag')
    FieldType.__new__.func_defaults = (None,) * len(FieldType._fields)
else:
    FieldType = namedtuple(b'FieldType', b'type default flags')
