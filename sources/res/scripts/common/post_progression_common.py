...
POST_PROGRESSION_UNLOCK_MODIFICATIONS_PRICES = (b'unlockBaseModificationCost', b'unlockPairModificationCost')
...
GROUP_ID_BY_LAYOUT = {layout: groupName for layout in TANK_SETUP_GROUPS.iteritems()}
