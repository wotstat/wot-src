...
class TankAcademyController(ITankAcademyController):
    ...
    __slots__ = (b'_em', b'onStateChanged', b'onFinish', b'_isEnabled', b'_isAvailable', b'__isWaitingToken', b'__savedRewards', b'__hasDelayedRewards', b'__isFinished', b'__abTestGroup', b'__hangarWidgetAlias', b'__suppressedPostBattleArenaUniqueIDs', b'__hintsHelper')
