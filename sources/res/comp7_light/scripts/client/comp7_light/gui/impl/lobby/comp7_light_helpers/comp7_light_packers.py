...
def getComp7LightBonusPacker():
    ...
    packer.getPackers().update({b'battleToken': (Comp7LightTokenBonusUIPacker()), 
       b'token': (Comp7LightTokenBonusUIPacker()), 
...
class Comp7LightTokenBonusUIPacker(TokenBonusUIPacker):
    ...
    _COMP7_LIGHT_PROGRESSION_TOKEN = b'Comp7LightProgressionToken'
