...
_LOBBY_EXT_PACKAGES = [
 b'comp7_light.gui.impl.lobby.hangar',
 b'comp7_light.gui.impl.lobby.battle_results']
_BATTLE_EXT_PACKAGES = [
 b'comp7_light.gui.Scaleform.daapi.view.battle.shared']
...
class ClientComp7LightBattleMode(Comp7LightBattleMode):
    ...
    _CLIENT_REPLAY_MODE_TAG = b'OnslaughtLight'
    ...
    def _client_battleRequiredLibraries(self):
        return [b'comp7_light|comp7_light_battle.swf', b'comp7_core|minimapEntriesLibrary.swf']
