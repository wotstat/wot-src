...
class RootViewModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addViewModelProperty(b'bestReplays', BestReplaysModel())
        self._addViewModelProperty(b'myReplays', MyReplaysModel())
        self._addViewModelProperty(b'findReplay', FindReplayModel())
