...
class ReplaysFilterPopoverView(PopOverViewImpl):
    __slots__ = (b'__groupSettings', b'__onStateUpdated', b'__state', b'__hasVehicleFilter', b'__vehiclesSortColum', b'__isVehicleSortAscending', b'__canResetCallback', b'onTooltipCreated')
