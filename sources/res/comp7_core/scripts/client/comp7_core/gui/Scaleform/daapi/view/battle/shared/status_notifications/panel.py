...
class Comp7StatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def __genPoiTimersSettings(self, data):
        ...
        self._addNotificationTimerSetting(data, _TYPES.POI_CAPTURING, b'', link, _COLORS.GREEN, countdownVisible=True)
        self._addNotificationTimerSetting(data, _TYPES.POI_COOLDOWN, b'', link, _COLORS.ORANGE, countdownVisible=True)
        self._addNotificationTimerSetting(data, _TYPES.POI_BLOCKED_NOT_USED_ABILITY, b'', link, _COLORS.ORANGE, countdownVisible=False)
        self._addNotificationTimerSetting(data, _TYPES.POI_CAPTURING_INTERRUPTED, b'', link, _COLORS.ORANGE, countdownVisible=True, isReversedTimerDirection=True)
        self._addNotificationTimerSetting(data, _TYPES.POI_BLOCKED_NOT_INVADER, b'', link, _COLORS.ORANGE, countdownVisible=False)
        self._addNotificationTimerSetting(data, _TYPES.POI_BLOCKED_OVERTURNED, b'', link, _COLORS.ORANGE, countdownVisible=False)
        return
