...
class Comp7CoreVehicleStatsBlock(RegularVehicleStatsBlock):
    __slots__ = (b'prestigePoints', b'isSuperSquad')
    ...
    def setRecord(self, result, reusable):
        ...
        self.isSuperSquad = avatar.extensionInfo.get(b'isSuperSquad', False)
        return
...
class Comp7CoreVehicleStatValuesBlock(RegularVehicleStatValuesBlock):
    __slots__ = (b'damageDealtBySkills', b'healed', b'capturedPointsOfInterest', b'roleSkillUsed')
