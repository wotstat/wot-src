...
class Comp7FastRechargeGunTemperatureLow(_ActivationError):
    ...
    def __new__(cls, name):
        return super(Comp7FastRechargeGunTemperatureLow, cls).__new__(cls, b'comp7FastRechargeGunTemperatureLow', {b'name': name})

    def __init__(self, name):
        super(Comp7FastRechargeGunTemperatureLow, self).__init__(b'comp7FastRechargeGunTemperatureLow', {b'name': name})
        return
