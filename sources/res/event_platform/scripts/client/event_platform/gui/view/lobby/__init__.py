...
def getContextMenuHandlers():
    return (
     (
      ...
      BootcampComponentOverride(EPVehicleContextMenuHandler, BCVehicleContextMenuHandler)),)


def getViewSettings():
    return (
     ConditionalViewSettings(VIEW_ALIAS.LOBBY_HANGAR, BootcampComponentOverride(EventHangar, BCHangar), b'hangar.swf', WindowLayer.SUB_VIEW, None, VIEW_ALIAS.LOBBY_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),)
