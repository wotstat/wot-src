...
_RespawnInfo = namedtuple(b'_RespawnInfo', (b'vehicleID', b'respawnTime', b'autoRespawnTime', b'respawnZones', b'chosenRespawnZone', b'vehSetupsIndexes'))
...
_RESPAWN_SOUND_ID = b'start_battle'
_SWITCH_SETUPS_ACTION = 0

class BaseRespawnsController(ViewComponentsController):
    __slots__ = (b'__weakref__', b'__isUIInited', b'__vehicles', b'__cooldowns', b'__respawnInfo', b'__timerCallback', b'__eManager', b'onRespawnVisibilityChanged', b'onVehicleDeployed', b'onRespawnInfoUpdated', b'onPlayerRespawnLivesUpdated', b'onTeamRespawnLivesRestored', b'onRespawnVehiclesUpdated', b'__isUiShown', b'__isShowUiAllowed', b'__limits', b'__playerRespawnLives', b'__respawnSoundNotificationRequest', b'__respawnSoundNotificationCallbackID', b'__battleCtx', b'__setupsIndexes', b'__cooldownsManager')
    ...
    def respawnPlayer(self):
        LOG_ERROR(b'respawnPlayer not Implemented')
        return

    def chooseVehicleForRespawn(self, intCD):
        LOG_ERROR(b'chooseVehicleForRespawn not Implemented')
        return

    def sendSwitchVehSetupsLayout(self, vehCD, groupID, layoutIdx):
        LOG_ERROR(b'sendSwitchVehSetupsLayout not Implemented')
        return
    ...
    def updateRespawnVehicles(self, vehsList):
        ...
        battleAbilities = dict(zip(player.ammoViews[b'vehTypeCompDescrs'], player.ammoViews[b'compDescrs']))
        for v in vehsList:
    ...
    def updateRespawnInfo(self, respawnInfo):
        ...
        self.__respawnInfo = _RespawnInfo(intCD, respawnInfo[b'manualRespawnPiT'], respawnInfo[b'autoRespawnPiT'], respawnInfo[b'respawnZones'], respawnInfo[b'chosenRespawnZone'], unpackVehSetupsIndexes(list(respawnInfo[b'vehSetupsIndexes'])))
