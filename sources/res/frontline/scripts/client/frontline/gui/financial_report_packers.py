...
RANK_BONUS_XP = CurrencyRecord(recordNames=(b'playerRankXPFactor100',), subtractRecords=(), baseAccountValueExtractor=getBaseAccountValue, premiumAccountValueExtractor=getPremiumAccountValue, detailsValuesExtractors=(), capsToBeChecked={
 ARENA_BONUS_TYPE_CAPS.PLAYER_RANK_MECHANICS}, paramName=b'playerRankXP', label=R.strings.battle_results.details.calculations.playerRankXP, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)
