...
class InfoView(ViewImpl):
    ...
    def __init__(self, layoutID=R.views.frontline.mono.lobby.info_view(), showFullScreen=False, autoscrollSection=b'', **kwargs):
...
class InfoViewWindow(WindowImpl):
    ...
    def __init__(self, parent=None, autoscrollSection=b''):
