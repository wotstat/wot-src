...
class FrontlineRespawnAmmunitionPanelInject(RespawnAmmunitionPanelInject, IFrontlineRespawnView):
    ...
    def _updateGuiVehicle(self, vehicleInfo, setupIndexes):
        ...
        idx = ammoViews[b'vehTypeCompDescrs'].index(self._vehicle.intCD)
        abilitiesCDs = ammoViews[b'compDescrs'][idx] if len(ammoViews[b'compDescrs']) > idx else vehicleInfo.battleAbilities
