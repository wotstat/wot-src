...
class FrontlineStateIDs(object):
    ...
    HANGAR = b'hangar'
    ROOT = b'{root}'
    LOADOUT_CONFIRM_LEAVE = b'frontline/loadoutConfirmLeave'
    ALL_VEHICLES = b'allVehicles'
    PROGRESSION_SCREEN = b'frontlineProgressionScreen'
    BATTLE_ABILITIES = FrontlineConst.BATTLE_ABILITIES
    BATTLE_RESULTS = b'fl_battleResults'
    OVERVIEW = b'overview'
