...
class FrontlineInGameRankPanel(FrontlineInGameRankMeta):
    ...
    def __setCurrentRank(self):
        ...
        self.as_setRankS({b'rank': (self.__currentRank), 
           b'isMaxRank': (self.__currentRank == _MAX_IN_GAME_RANK), 
           b'previousProgress': 0, 
           b'newProgress': (self.__getThresholdPercentage(self.__currentExp)), 
           b'rankText': (EPIC_BATTLE.getRankLabel(self.__currentRank + 1))})
        return
