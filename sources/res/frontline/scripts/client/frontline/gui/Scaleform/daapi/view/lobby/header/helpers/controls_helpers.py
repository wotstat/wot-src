...
def getFightBtnTooltipData(result):
    ...
    if state == PRE_QUEUE_RESTRICTION.MODE_IS_IN_PREANNOUNCE:
        ...
        if state == PRE_QUEUE_RESTRICTION.LIMIT_LEVEL:
            ...
            body = backport.text(R.strings.menu.headerButtons.fightBtn.tooltip.epicBattleVehLevel.body(), requirements=backport.text(R.strings.menu.headerButtons.fightBtn.tooltip.epicBattleVehLevel.requirements(), level=toRomanRangeString(result.ctx[b'levels'])))
