...
def getFLSwfExtensionUrl(swfName):
    return getSwfExtensionUrl(b'frontline', swfName)
...
def getViewSettings():
    ...
    return (
     ViewSettings(ViewAlias.EPIC_BATTLE_PAGE, FrontlineBattlePage, getFLSwfExtensionUrl(b'frontlineBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     GroupedViewSettings(FRONTLINE_BATTLE_VIEW_ALIASES.FRONTLINE_CAROUSEL_FILTER_POPOVER, FrontlineBattleTankCarouselFilterPopover, getFLSwfExtensionUrl(b'frontlineCarouselFilterPopover.swf'), WindowLayer.TOP_WINDOW, FRONTLINE_BATTLE_VIEW_ALIASES.FRONTLINE_CAROUSEL_FILTER_POPOVER, FRONTLINE_BATTLE_VIEW_ALIASES.FRONTLINE_CAROUSEL_FILTER_POPOVER, SETTINGS_WINDOW_SCOPE),
