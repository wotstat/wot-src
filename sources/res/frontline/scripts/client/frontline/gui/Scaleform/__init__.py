...
def registerFLScaleform():
    registerBattleTooltipsBuilders([
     (
      b'frontline.gui.Scaleform.daapi.view.tooltips.frontline_battle_builders', _TOOLTIPS.FRONTLINE_BATTLE_SET)])
    registerLobbyTooltipsBuilders([
     (
      b'frontline.gui.Scaleform.daapi.view.tooltips.frontline_lobby_builders', _TOOLTIPS.FRONTLINE_LOBBY_SET)])
