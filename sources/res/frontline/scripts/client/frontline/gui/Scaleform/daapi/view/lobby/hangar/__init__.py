...
def getViewSettings():
    ...
    return (
     ViewSettings(FrontlineHangarAliases.FRONTLINE_LOBBY_HANGAR, FrontlineHangarWindow, b'', WindowLayer.SUB_VIEW, FrontlineHangarAliases.FRONTLINE_LOBBY_HANGAR, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(FrontlineHangarAliases.FRONTLINE_BATTLE_RESULTS, FrontlinePostBattleResultsWindow, b'', WindowLayer.SUB_VIEW, FrontlineHangarAliases.FRONTLINE_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE))
