...
class VehicleTooltipView(ViewImpl):
    ...
    def __fillModel(self, model):
        ...
        model.dailyBonus.setDailyBonusFactor(modeSettings.dailyBonus.get(b'bonusFactor', 0))
        model.dailyBonus.setSoloTopPlaces(modeSettings.dailyBonus.get(b'soloTopPlaces', 0))
        model.dailyBonus.setSquadTopPlaces(modeSettings.dailyBonus.get(b'squadTopPlaces', 0))
