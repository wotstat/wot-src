...
_BattleRoyaleStatusConfiguration = namedtuple(b'_BattleRoyaleStatusConfiguration', b'isRentNotActive,')
...
class BattleRoyaleCarouselContext(InventoryContext):
    ...
    def getStatusConfiguration(self, item):
        ...
        isRentNotActive = state in (EquipmentPanelCmpRentStates.STATE_RENT_AVAILABLE,
