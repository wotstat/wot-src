...
_RU_REALMS = (b'DEV', b'QA', b'RU')
_SWITCH_RU = b'SWITCH_ext_BR_vo_language'
_SWITCH_RU_ON = b'SWITCH_ext_BR_vo_language_RU'
_SWITCH_RU_OFF = b'SWITCH_ext_BR_vo_language_nonRU'
_SWITCH_CN = b'SWITCH_ext_BR_vo_language_CN'
_SWITCH_CHAR = b'SWITCH_ext_BR_vo_char'
_SWITCH_CHAR_FOR_NATIONS = {b'ussr': b'SWITCH_ext_BR_vo_char_RU', 
   b'usa': b'SWITCH_ext_BR_vo_char_US', 
   b'germany': b'SWITCH_ext_BR_vo_char_GE', 
   b'france': b'SWITCH_ext_BR_vo_char_FR', 
   b'uk': b'SWITCH_ext_BR_vo_char_UK', 
   b'sweden': b'SWITCH_ext_BR_vo_char_SE', 
   b'china': b'SWITCH_ext_BR_vo_char_CN', 
   b'poland': b'SWITCH_ext_BR_vo_char_PL'}
