...
class ProgressionOnTokensController(IBRProgressionOnTokensController):
    STORAGE_SECTION_ACC_SETTINGS_KEY = b'exampleStorage'
    ...
    def getProgessionPointsData(self):
        ...
        if curPoints < prevPoints:
            prevPoints = 0
        return {b'curPoints': curPoints, 
           b'prevPoints': prevPoints}
...
class ProgressionOnConfig(ProgressionOnTokensController):
    ...
    def getProgessionPointsData(self):
        ...
        return {b'curPoints': curPoints, 
           b'prevPoints': prevPoints, 
           b'stage': curStage, 
           b'prevStage': prevStage, 
           b'stageProgress': stageProgress, 
           b'prevStageProgress': prevStageProgress, 
           b'stagePoints': stagePoints, 
           b'prevStagePoints': prevStagePoints, 
           b'totalPoints': maxPoints}
    ...
    def _getProgressionLevels(self):
        ...
        for stageAwards in zip(*self._getStages())[1]:
            ...
            progressionLevels.append({b'rewards': bonuses})

        return progressionLevels

    def getProgressionData(self):
        return {b'progressionLevels': (self._getProgressionLevels())}
