...
_ArtefactData = namedtuple(b'_ArtefactData', (b'intCD', b'quantity', b'icon', b'tooltip'))
...
class HangarBottomPanelView(ViewImpl, IGlobalListener):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.battle_royale.lobby.tooltips.TestDriveInfoTooltipView():
            return TestDriveInfoTooltipView()
        return super(HangarBottomPanelView, self).createToolTipContent(event, contentID)
    ...
    @decorators.adisp_process(b'updateMyVehicles')
    def __repair(self):
