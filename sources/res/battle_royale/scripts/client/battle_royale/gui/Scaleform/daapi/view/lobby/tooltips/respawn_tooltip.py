...
class RespawnTooltipData(BlocksTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        headerBlockItem = [
         formatters.packBuildUpBlockData(self.__constructHeaderBlock(leftPadding, innerBlockLeftPadding), padding=formatters.packPadding(left=leftPadding, right=rightPadding, top=topPadding, bottom=verticalPadding))]
