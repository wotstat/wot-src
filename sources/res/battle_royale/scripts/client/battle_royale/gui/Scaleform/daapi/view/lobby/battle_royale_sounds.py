...
class Sounds(CONST_CONTAINER):
    OVERLAY_SPACE_NAME = b'battle_royale_overlay'
    ...
    MAIN_PAGE_SPACE_NAME = b'battle_royale_main_page'
    ...
    VEHILCE_INFO_SPACE_NAME = b'battle_royale_vehicle_info'
    VEHILCE_INFO_STATE = b'STATE_hangar_filtered'
    VEHILCE_INFO_STATE_ON = b'STATE_hangar_filtered_on'
    VEHILCE_INFO_STATE_OFF = b'STATE_hangar_filtered_off'
