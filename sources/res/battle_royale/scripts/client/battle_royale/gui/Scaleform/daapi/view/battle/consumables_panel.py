...
class BattleRoyaleConsumablesPanel(ConsumablesPanel, ISpawnListener):
    ...
    def __updateRespawnSkill(self):
        ...
        if period == ARENA_PERIOD.BATTLE:
            ...
            if vehicle and vehicle.isAlive():
                vehicleBRRespawnComponent = vehicle.dynamicComponents.get(b'vehicleBRRespawnComponent')
    ...
    def __isVehicleUpgrading(self):
        ...
        if vehicle is not None:
            inBattleUpgradesComponent = vehicle.dynamicComponents.get(b'inBattleUpgrades')
