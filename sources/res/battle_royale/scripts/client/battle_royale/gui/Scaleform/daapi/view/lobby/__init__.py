...
def getViewSettings():
    ...
    return (
     ViewSettings(BATTLEROYALE_ALIASES.BR_HANGAR_VIEW, BattleRoyaleHangarWindow, b'', WindowLayer.SUB_VIEW, BATTLEROYALE_ALIASES.BR_HANGAR_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(BATTLEROYALE_ALIASES.BR_TOURNAMENT_BATTLE_QUEUE, BattleRoyalePreBattleWindow, b'', WindowLayer.SUB_VIEW, BATTLEROYALE_ALIASES.BR_TOURNAMENT_BATTLE_QUEUE, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(BATTLEROYALE_ALIASES.BR_PROGRESSION, BattleRoyaleProgressionWindow, b'', WindowLayer.SUB_VIEW, BATTLEROYALE_ALIASES.BR_PROGRESSION, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(BATTLEROYALE_ALIASES.BR_BATTLE_RESULTS, BattleRoyaleBattleResultsWindow, b'', WindowLayer.SUB_VIEW, BATTLEROYALE_ALIASES.BR_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(BATTLEROYALE_ALIASES.HANGAR_VEH_INFO_VIEW, HangarVehicleInfo, b'battleRoyaleVehInfo.swf', WindowLayer.SUB_VIEW, BATTLEROYALE_ALIASES.HANGAR_VEH_INFO_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(BATTLEROYALE_ALIASES.BATTLE_ROYALE_BROWSER_VIEW, BattleRoyaleBrowserView, b'browserScreen.swf', WindowLayer.TOP_WINDOW, BATTLEROYALE_ALIASES.BATTLE_ROYALE_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
