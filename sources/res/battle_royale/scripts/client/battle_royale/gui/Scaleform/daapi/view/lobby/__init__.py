...
def getViewSettings():
    ...
    return (
     ...
     ViewSettings(BATTLEROYALE_ALIASES.BATTLE_ROYALE_BROWSER_VIEW, BattleRoyaleBrowserView, b'browserScreen.swf', WindowLayer.TOP_SUB_VIEW, BATTLEROYALE_ALIASES.BATTLE_ROYALE_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
