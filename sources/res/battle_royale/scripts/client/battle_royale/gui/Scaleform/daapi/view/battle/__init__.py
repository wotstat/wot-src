...
def getViewSettings(battleRoyaleController=None):
    ...
    viewSettings = (
     ViewSettings(VIEW_ALIAS.BATTLE_ROYALE_PAGE, BattleRoyalePage, b'battleRoyalePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(BATTLE_VIEW_ALIASES.BATTLE_VEHICLE_CONFIGURATOR, veh_configurator.BattleVehicleConfigurator, b'battleVehicleConfigurator.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True),
