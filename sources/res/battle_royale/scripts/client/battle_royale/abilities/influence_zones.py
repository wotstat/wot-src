...
class InfluenceZoneMultiVisualizer(object):
    ...
    influencePrefab = ComponentProperty(type=CGFMetaTypes.STRING, value=b'', editorName=b'Influence prefab', annotations={b'path': b'*.prefab'})
    rotateFromCenter = ComponentProperty(type=CGFMetaTypes.BOOL, value=False, editorName=b'Rotate from center')
...
class InfluenceZoneTerrainArea(object):
    ...
    category = b'Abilities'
    domain = CGF.DomainOption.DomainClient
    fullZoneVisual = ComponentProperty(type=CGFMetaTypes.STRING, value=b'', editorName=b'Full Zone Visual', annotations={b'path': b'*.visual'})
    dropOffset = ComponentProperty(type=CGFMetaTypes.FLOAT, value=1000.0, editorName=b'Drop Offset')
...
class InfluenceZoneEquipmentComponent(object):
    ...
    domain = CGF.DomainOption.DomainClient
    userVisible = False
    radius = ComponentProperty(type=CGFMetaTypes.FLOAT, value=0, editorName=b'Radius')
    zonesCount = ComponentProperty(type=CGFMetaTypes.INT, value=0, editorName=b'Zones Count')
    zoneRadius = ComponentProperty(type=CGFMetaTypes.FLOAT, value=0, editorName=b'Zone Radius')
