...
class EquipmentAnimatorTrigger(object):
    ...
    activeTrigger = ComponentProperty(type=CGFMetaTypes.STRING, value=b'', editorName=b'active trigger name')
    inactiveTrigger = ComponentProperty(type=CGFMetaTypes.STRING, value=b'', editorName=b'inactive trigger name')
