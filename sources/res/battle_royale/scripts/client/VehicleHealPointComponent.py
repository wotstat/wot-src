...
HealPointInfo = namedtuple(b'HealPointInfo', b'endTime')
...
class VehicleHealPointComponent(BigWorld.DynamicScriptComponent):
    ...
    def __getEffectSettings(self):
        ...
        if dynamicObjects is None:
            ...
            isAlly = self.entity.guiSessionProvider.getArenaDP().isAllyTeam(self.entity.publicInfo[b'team'])
            return dynamicObjects.getHealPointEffect().get(b'ally' if isAlly else b'enemy')
