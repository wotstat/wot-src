      ...
      for (var i = 0; i < n.length; i++) {
        ...
        if ("querySelectorAll" in o)
          for (var c = e.selectorSet.queryAll(o), l = 0; l < c.length; l++)
            for (var u = c[l], d = u.data, h = u.elements, v = 0; v < h.length; v++)
              t.push([Z, h[v], d]);
      }
    }
    function J(e, t, n) {
      ...
      ((this.rootNode = 9 === e.nodeType ? e.documentElement : e),
        ...
        (function (e, t) {
          ...
          "interactive" === n || "complete" === n
            ? F(e, t)
            : e.addEventListener("DOMContentLoaded", F(e, t));
                ...
                !(function () {
                  ...
                  initialize(e) {
                    ...
                    const o = we(e),
                      r = (function () {
                        var i = pe(function* () {
                          be({ scrollableContainer: o, element: e, componentId: t, viewId: n });
                        });
                        return function () {
