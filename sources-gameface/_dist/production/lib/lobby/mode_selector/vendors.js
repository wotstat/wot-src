(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
  [705],
  {
    ...
    8354: (t, e, n) => {
      ...
      class m {
        ...
        *getBlocks(t, e) {
          ...
          if (n === d) return;
          if (n === v)
            return (e && e.hasText() && (yield e, (e.textNodes = [])), void c(!t.firstChild));
          c(n === l || n === h);
          const r = !e || n === l,
            i = r ? new g(t) : e;
          c(i);
        ...
        applyToParagraph(t) {
          ...
          if ((c(r.length > 0), c(r.reduce((t, e) => t + e.length, 0) === n.length), r.length <= 1))
            return;
          const i = [];
          let o = 0;
        ...
        splitTextNodes(t, e) {
          ...
          for (var s, u = a(t); !(s = u()).done;) {
            ...
            (c(u.length > 0),
              f < n.length && u.push(n.substring(f)),
    ...
    7950: (t, e, n) => {
      "use strict";
      if ((n.d(e, { LW: () => f, ZM: () => l, j1: () => h, j_: () => u }), 261 == n.j))
        var r = n(1040);
            ...
            ? (function () {
                  ...
                  (void 0 === s && (s = "context" in e ? e.context : void 0),
                    ...
                    (this.states = this.config.states
                      ? (0, a.Q8)(this.config.states, function (e, n) {
                          ...
                          return (
                            Object.assign(h.idMap, (0, r.pi)((((i = {})[o.id] = o), i), o.idMap)),
                            o
                          );
                        })
                      : y));
                ...
                return (
                  ...
                  (t.prototype.transition = function (t, e, n) {
                    ...
                    var i,
                      s = (0, a.g5)(e);
                    if (t instanceof h.ZM)
                      i = void 0 === n ? t : this.resolveState(h.ZM.from(t, n));
                    else {
                      var u = (0, a.HD)(t)
                        ...
                        try {
                          for (
                            ...
                            if (f.states)
                              try {
                                for (
                                  var h = ((n = void 0), (0, r.XA)(f.events)), l = h.next();
                                  !l.done;
                                  l = h.next()
                                ) {
                                  var d = l.value;
                                ...
                                o.M ||
                                  (function (t, e, n) {
                                    var r = n.slice(0, -1).some(function (t) {
                                      ...
                                      i =
                                        e === v ? "the transient event" : "event '".concat(e, "'");
                                    (0, a.ZK)(
                                      !r,
                          ...
                          return (
                            t.onDone &&
                              e.push.apply(
                                ...
                                (0, r.ev)(
                                  [],
                                  (0, r.CR)((0, a.jh)(String((0, f.Sl)(t.id)), t.onDone)),
                                  !1,
                                ),
                              ),
                            t.onError &&
                              e.push.apply(
                                ...
                                (0, r.ev)(
                                  [],
                                  (0, r.CR)((0, a.jh)(String((0, f.vU)(t.id)), t.onError)),
                                  !1,
                                ),
                              ),
                            e
          ...
          ? (function () {
              ...
              return (
                ...
                (t.prototype.stop = function () {
                  ...
                  try {
                    for (
                      var m = (0, r.XA)(this.stopListeners), W = m.next();
                      !W.done;
                      W = m.next()
                    ) {
                  ...
                  try {
                    for (
                      var B = (0, r.XA)(this.doneListeners), w = B.next();
                      !w.done;
                      w = B.next()
                    ) {
                      y = w.value;
                  ...
                  switch (t.type) {
                    ...
                    case c.BL:
                      ...
                      if (d.type === a.M.Invoke) {
                        ...
                        var U = (0, o.mf)(p) ? p(r, s.data, { data: W, src: v, meta: d.meta }) : p;
                        if (!U) return;
                        var b = void 0;
                        ((0, o.O4)(U) && ((U = W ? U.withContext(W) : U), (b = { autoForward: m })),
                          this.spawn(U, y, b));
                ...
                (t.prototype.spawn = function (t, e, n) {
                  ...
                  if ((0, o.O4)(t))
                    return this.spawnMachine(t, (0, r.pi)((0, r.pi)({}, n), { id: e }));
          ...
          for (var W = (0, r.XA)(v), U = W.next(); !U.done; U = W.next()) {
            if ("compound" !== (_ = U.value).type || (m.get(_) && m.get(_).length)) {
              if ("parallel" === _.type)
                try {
                  for (
                    var b = ((c = void 0), (0, r.XA)(a(_))), B = b.next();
                    !B.done;
                    B = b.next()
                  ) {
                    var w = B.value;
    ...
    8322: (t, e, n) => {
      ...
      function B(t) {
        return (
          t instanceof Promise || !(null === t || (!j(t) && "object" != typeof t) || !j(t.then))
        );
      }
      function w(t) {
        return (
