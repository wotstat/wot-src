      ...
      class We extends M {
        ...
        _start() {
          this.idle &&
            ...
            r.OH.skipAnimation
              ? (r.Wn.batchedUpdates(() => this.advance()), Se(this))
              : r.fT.start(this));
        }
        _attach() {
          let e = 1;
      ...
      const Te = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
        ...
        Pe = (e) => {
          ...
          return (e) => {
            ...
            const i =
              !Ae.test(t[0]) &&
              (null == (n = t.find((e) => Ae.test(e))) ? void 0 : n.replace(We, ""));
            let o = 0;
      ...
      function fe(e, t, n, r) {
        ...
        if (r !== e.target_ && "function" == typeof n.value)
          return w(n.value)
            ...
            : ((null == (s = this.options_) ? void 0 : s.autoBind) ? kt.bound : kt).make_(
                e,
                t,
                n,
                r,
      ...
      var Qn = (function () {
        ...
        $n = (function () {
          ...
          return (
            ...
            (t.get_ = function (e) {
              return (
                ct.trackingDerivation && !P(this.target_, e) && this.has_(e),
                this.target_[e]
              );
            }),
