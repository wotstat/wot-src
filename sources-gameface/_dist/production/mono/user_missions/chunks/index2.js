...
const Me = "to_active_challenge",
  ...
  Oe = (e, s = 0, t) =>
    a({ from: be.from, to: e ? be.to : be.from, config: he, delay: e ? s : 0, onRest: t }),
  Le = (e, s, a, t) => {
    ...
    [we]: ({ kingReward: e, openPreview: s }) =>
      l.jsxs("div", {
        ...
        children: [
          ...
          l.jsx(os, {
            kingReward: e,
            classNames: { base: ms, name: _s, level: _s, vehicleInHangar: gs },
          }),
  ...
  xs = ({ kingRewardType: e, kingReward: s, openPreview: a }) => {
    const t = ye.includes(e) ? ke : e,
      n = fs[t];
    return n
      ? l.jsx(n, { kingReward: s, openPreview: a })
    ...
    const { model: n, controls: i } = Ae(),
      ...
      { rewardImage: d, overlayImage: m } = ((e) => ({
        ...
        overlayImage: e.overlayType
          ? ge({ size: ue.S400x300, name: e.name, special: e.overlayType })
          : null,
      }))(s),
      _ = ((e, s) =>
        j({
        ...
        l.jsxs("div", {
          ...
          children: [
            l.jsx("div", {
              ...
              ..._,
              children:
                m && l.jsx("div", { className: ks, style: { backgroundImage: `url(${m})` } }),
            }),
            l.jsx("div", {
              className: Cs,
...
const oa = "MissionNumber_2f758a67",
  ...
  _a = ({ number: e, active: s, className: a = "" }) =>
    l.jsx("div", {
      className: c(oa, a),
      children: l.jsx("div", { className: c(da, s && ma), children: e }),
    }),
  ua = "Content_fa80e432",
    ...
    if (
      (s.useEffect(
        () => (
          ...
          () => {
            (b.events.off("mouseWheel", $),
              b.events.off("change", W),
              b.events.off("resizeHandled", P));
          }
        ),
        [b, $, W, C, P],
      ),
      ...
      children: [
        ...
        w &&
          ...
          l.jsx(d.div, {
            className: c(
              Ya.kingReward,
              "done" === Le(e, y.length - 1, x, v) && Ya.kingReward__done,
            ),
  ...
  mt = o(function ({ challengeID: e, complexity: s, selected: a }) {
    const { model: t } = Ae(),
      ...
      b = l.jsx(F, {
        ...
        params: {
          currentMissions: l.jsx("span", { className: ot.accent, children: o }),
          totalMissions: d,
        },
      }),
...
const jn = {
  ...
  In = o(function ({ selectedChallenge: e, className: s = "", enableAnimation: t = !1 }) {
    const { model: n, controls: i } = Ae(),
      {
        activeChallengeID: r,
        isSuitableVehicles: o,
        selectedChallengeExpireTime: m,
      } = n.root.get(),
      _ = e.state,
      u = e.challengeName,
      g = m,
      ...
      v = S(
        { buttonSize: le.small },
        { large: { buttonSize: le.medium }, extraLarge: { buttonSize: le.large } },
      ),
      { breakpoint: y } = N(),
    ...
    return l.jsxs(d.div, {
      ...
      children: [
        !I &&
          l.jsx(yn, { expireTime: g, isLocked: D, isAnotherActive: T, onAction: B, buttonSize: j }),
        I &&
          l.jsx("div", {
