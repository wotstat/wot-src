  ...
  __using = (e, t, s) => {
    ...
    null != t
      ? ("object" != typeof t && "function" != typeof t && __typeError("Object expected"),
        s && (u = t[__knownSymbol("asyncDispose")]),
        void 0 === u && ((u = t[__knownSymbol("dispose")]), s && (r = u)),
        "function" != typeof u && __typeError("Object not disposable"),
        r &&
          (u = function () {
            try {
              r.call(this);
  ...
  __callDispose = (e, t, s) => {
    var u =
        "function" == typeof SuppressedError
          ...
          : function (e, t, s, u) {
              return (
                ((u = Error(s)).name = "SuppressedError"),
                (u.error = e),
                (u.suppressed = t),
                u
              );
            },
      r = (e) => (t = s ? new u(e, t, "An error was suppressed during disposal") : ((s = !0), e)),
      n = (u) => {
        for (; (u = e.pop());)
          try {
            var a = u[1] && u[1].call(u[2]);
            if (u[0]) return Promise.resolve(a).then(n, (e) => (r(e), n()));
          } catch (o) {
            r(o);
          }
        if (s) throw t;
...
import {
  ...
  y as useSpring,
  z as animated,
  A as loadDefaultJapaneseParser,
  B as parse$1,
  C as Controller,
} from "./vendor.js";
...
class ImagesRClassProvider {
  ...
  readOr(e, t, s = "silent") {
    ...
    return void 0 === r
      ? ("silent" !== s && logBySeverity$1(`Resource not found: ${u}`, s), t())
      : r;
  }
...
class StringsRClassProvider {
  ...
  pluralOr(e, t, s, u = "silent") {
    ...
    return void 0 === n
      ? ("silent" !== u && logBySeverity$1(`Resource not found: ${r}`, u), s())
      : n;
  }
...
function generateMediaClasses(e, t) {
  const s = t["width" === e ? "height" : "width"],
    ...
    r = new Set(
      s.classes.filter((e) => !(!e.endsWith("Width") && !e.endsWith("Height")) || u.has(e)),
    );
...
function useAdaptiveWidth(e, t) {
  ...
  return t
    ? Object.values(breakpointsByType).reduce(
        (e, u) => (t[u.name] && s.sides.width >= u.width ? { ...e, ...t[u.name] } : e),
        e,
      )
    : e;
}
...
function useTicker(e) {
  const { type: t, tick: s, limit: u } = e,
    ...
    n = e.start ?? zero,
    a = toMillis(s),
    [o, i] = reactExports.useState({ current: n, running: r }),
  ...
  reactExports.useEffect(() => {
    const e = (e) => {
      i((r) => {
        ...
        const n = "countdown" === t ? subtract(r.current, e) : add(r.current, e),
          a = { ...r, current: n };
        return (
          isDuration(u) &&
            ("countdown" === t
              ? lt(subtract(n, s), u) && ((a.current = u), (a.running = !1))
              : gt(add(n, s), u) && ((a.current = u), (a.running = !1))),
          a
        );
      });
    };
...
function useUntilTimer(e) {
  const {
      ...
      until: s,
      tick: u,
    } = reactExports.useMemo(() => ({ ...e, start: e.start ?? now() }), [e]),
  ...
  render(e) {
    return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
      children: this.items.reduceRight(
        (e, [t, s], u) => reactExports.createElement(t, { ...s, key: u }, e),
        e,
      ),
    });
  }
    ...
    switch (typeof t) {
      ...
      case "object": {
        ...
        switch (!0) {
          ...
          case "Dict" === n:
            return [...t.entries()].reduce((t, [s, u]) => ((t[s] = e(u, r)), t), {
              $$type: "Dict",
            });
          case "UNKNOWN" === n:
            return "UNKNOWN_TYPE";
        ...
        t.map((e) => {
          ...
          if (s)
            for (let s = r.length - 1; s >= 0; s--) {
              const u = r[s];
              if (u.href === e && (!t || "stylesheet" === u.rel)) return;
            }
      ...
      children: jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$A.outerBorderImage, t?.outerBorderImage),
          }),
...
function Tab({ tabId: e, classNames: t, className: s, children: u, ...r }) {
  ...
  return jsxRuntimeExports.jsxs(HeadlessTab, {
    ...
    children: [
      ...
      jsxRuntimeExports.jsx("div", {
        className: clsx(styles$z.backgroundPattern, t?.backgroundPattern),
      }),
...
const COLORS =
  ...
  styles$y = { COLORS: COLORS, base: base$u, base__fullSize: base__fullSize, nowrap: nowrap },
  legacyColors = new Set(styles$y.COLORS?.split(", ") ?? []);
let keyId = 0;
function takeKey() {
  return ++keyId;
}
        ...
        reactExports.Fragment,
        {
          children: [
            jsxRuntimeExports.jsxs("span", {
              className: styles$y.nowrap,
              children: [split(u), r[0]],
            }),
            n,
          ],
        },
...
const defaultBrackets = { start: "{{", end: "}}" },
  FormatText$1 = reactExports.memo(function (e) {
    const {
      ...
      _ = clsx(styles$y.base, n && styles$y.base__fullSize, l.className);
    return e.inline
      ? (console.warn(
...
function useLoadPlugin(e, t = []) {
  const [s, u] = reactExports.useState({ status: "loading" }),
      ...
      const t = (async function () {
        try {
          const t = await loadPlugin(e),
            s = await t.init(...r.current);
          return (u({ status: "loaded", result: s, instance: t }), t);
        } catch (t) {
          u({ status: "failure", error: t });
        }
      })();
      return () => {
        t.then((e) => e?.destroy());
...
const base$t = "CloseButton_7488a1b8",
...
function CloseButton({
  ...
  const a = useUpscale(styles$x[`base__${e}`], styles$x[`base__${upscaleImageSizes[e]}`]);
  return jsxRuntimeExports.jsx("div", {
    className: cx(styles$x.base, a, u),
    onMouseEnter: () => {
      (play.sound(t), r?.());
    },
    onClick: () => {
    ...
    E = reactExports.useCallback(
      (i) => {
        ...
        if (x) n({ pending: !0, offset: p.occurredEvent - p.thumb.start });
          ...
          ((p.occurredEvent > p.thumb.start ? Direction.Prev : Direction.Next) === Direction.Next
            ? d
            : m)(i);
        } else {
...
const rail$1 = "HorizontalBar_rail_37858d8f",
    ...
    const m = useEvent(
      ...
      x = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
        ...
        ((r.style.width = `${t - l + s}px`),
          (a.style.width = u.offsetWidth - e - t - l - s + "px"));
      }),
  ...
  styles$u = { base: base$q, wrapper: wrapper$1, defaultScrollArea: defaultScrollArea },
  DefaultScroll$1 = ({
    children: e,
    className: t,
    barClassNames: s,
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$u.defaultScrollArea, u),
    ...
    f = useEvent(() => {
      x.run(() => {
        ...
        t &&
          ...
          u &&
          !c &&
          (t.style.cursor = u <= s ? "auto" : "dragging" === d.type ? "move" : "grab");
      });
    });
  return (
    reactExports.useEffect(() => {
...
const DEFAULT_VERTICAL_API_CONFIG = {
    ...
    const m = useEvent((e) => e - (n.current.offsetHeight - a.current.offsetHeight) >= -0.5),
      ...
      x = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
        ...
        ((r.style.height = `${t - l + s}px`),
          (a.style.height = u.offsetHeight - e - t - l - s + "px"));
      }),
      { handleMouseEnter: f, handleMouseDownTrack: h } = useBarHandlers(
        s,
        a,
  ...
  DefaultScroll = ({
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$s.area, u),
...
function MaskArea({ classNames: e, ...t }) {
  ...
  return jsxRuntimeExports.jsx(Area, {
    ...t,
    classNames: { ...e, content: clsx(styles$s[`content__${getMaskDirection(u, r)}`], e?.content) },
  });
}
...
const base$m = "MultilineOverflow_ec9f8e47",
  ...
  styles$p = { base: base$m, content: content$2 };
...
const MultilineOverflow$1 = reactExports.forwardRef(function (
  ...
  reactExports.useEffect(() => {
    ...
    function r() {
      ...
      (u.remove(),
        (u.className = clsx(styles$p.content, t.children[0].className)),
        (u.innerHTML = ""),
      ...
      if (n === r) A(!1);
        ...
        for (
          u.style.visibility = "", u.style.left = `${r.x}px`, u.style.top = `${r.y}px`;
          n >= 0;
          n--
        ) {
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...
    ref: assignRefs([f, h]),
    className: clsx(styles$p.base, d, m?.base),
    style: { ...E, ..._ },
    children: [
  ...
  for (let u = 0; u < t.items.length; ++u)
    (t.separator &&
      ...
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          { className: cx(styles$o.detailedSeparator, styles$o[`detailedSeparator__${e}`]) },
          "separator",
        ),
      ),
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          {
            className: cx(styles$o.item, styles$o[`item__${e}`]),
            children: t.items[u]
              ?.split(" ")
              .map((t, s) =>
                jsxRuntimeExports.jsx(
                  "span",
                  { className: cx(styles$o.part, styles$o[`part__${e}`]), children: t },
                  `part_${s}`,
                ),
              ),
          },
...
function compactFormatter(e, t) {
  const s = e.length,
    ...
    r = { separator: !1, items: [] };
  for (let n = 0; n < s; ++n)
    if (Number(e[n]) > 0) return ((r.items = [LOCALE_FORMATTERS[u[n]]?.(e[n])]), r);
...
function Timer({
  ...
  return jsxRuntimeExports.jsxs("div", {
    className: cx(styles$n.base, o),
    children: [
      jsxRuntimeExports.jsx("div", {
        className: cx(styles$n.icon, styles$n[`icon__${u}`], styles$n[`icon__${r}`], i?.icon),
      }),
      n !== formats.superCompact &&
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$n.label, styles$n[`label__${u}`], styles$n[`label__${r}`], i?.label),
...
const base$k = "Tooltip_6d997cee",
  decorator = "Tooltip_decorator_b3486d4e",
  styles$m = { base: base$k, decorator: decorator },
  Base$5 = defineStyledComponent("Base", styles$m.base),
  Decorator = defineStyledComponent("Decorator", styles$m.decorator),
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, " "),
  ...
  base$j = "Formattext_bb80854d",
  styles$l = { base: base$j },
  FormatText = ({
    binding: e,
    text: t = "",
    classMix: s,
...
const base$i = "Currency_72d4be39",
  ...
  Base$4 = defineStyledComponent("Currency", styles$k.base, {
    variants: { reverse: { true: styles$k.base__reverse } },
  });
...
function Currency({
  ...
  return jsxRuntimeExports.jsxs(Base$4, {
    ...o,
    className: clsx(u?.base, a ? styles$k[`base__${t}`] : styles$k.base__notEnough, s),
    children: [
...
const getCssStyle = (e, t) => window.getComputedStyle(e, null).getPropertyValue(t),
  ...
  base$h = "Multilineoverflow_c23f658d",
  ...
  MultilineOverflow = reactExports.forwardRef(function (
    ...
    return (
      ...
      jsxRuntimeExports.jsxs("div", {
        ...a,
        ref: o,
        className: cx(styles$j.base, s, c && styles$j.base__truncated),
        children: [
          jsxRuntimeExports.jsx("div", {
            ref: i,
          ...
          jsxRuntimeExports.jsx("div", {
            className: styles$j.truncatedContent,
            children: m.map((e, t) =>
              jsxRuntimeExports.jsx(
                "div",
                { className: cx(styles$j.line, u?.line), children: e.join(" ") },
                t,
              ),
            ),
          }),
...
const multiValueTypes = [
  ...
  getDogTypeImage = (e, t, s) => {
    ...
    if (u) {
      ...
      return !n && DOG_TAG_DEFAULT_ICON_NAME[e]
        ? `${r.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}`
        : `${n}`;
    }
    return (
      console.error(
  ...
  Reward = ({
    ...
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$i.base, styles$i[`base__${r}`], !u && styles$i.base__dynamicBox, c),
      style: l,
      ...h,
      children: [
        jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            jsxRuntimeExports.jsxs("div", {
              className: cx(
                styles$i.image,
                u ? styles$i.image__fixedBox : styles$i[`image__${r}`],
                d?.image,
              ),
              children: [
                p &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$i.highlight, d?.highlight),
                    style: {
                ...
                t &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$i.icon, d?.rewardIcon),
                    style: { backgroundImage: `url(${t})` },
                  }),
                x &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$i.overlay, d?.overlay),
                    style: {
            ...
            f &&
              jsxRuntimeExports.jsx("div", {
                className: cx(
                  styles$i.info,
                  styles$i[`info__${e}`],
                  o === ValueTypes.MULTI && styles$i.info__multi,
                  d?.info,
                ),
                children: f,
              }),
            i && jsxRuntimeExports.jsx("div", { className: styles$i.title, children: i }),
          ],
        }),
        s && jsxRuntimeExports.jsx("div", { className: cx(styles$i.timer, d?.periodicIcon), ...g }),
      ],
    });
  },
...
const base$f = "RewardsList_b956755b",
  ...
  Rewards = reactExports.memo(function ({
    ...
    return jsxRuntimeExports.jsx("div", {
      className: cx(styles$h.base, u && styles$h.base__vertical, n),
      children:
        void 0 !== E
          ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                e
                  ...
                  .map((e, r) =>
                    jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: cx(styles$h.reward, u && styles$h.reward__vertical, a),
...
const base$e = "NotificationWrapper_6fe65b7",
  styles$g = { base: base$e },
...
const Lines = reactExports.memo(
    ({ containerRef: e, generation: t, border: s, cardSelector: u }) => {
                  ...
                  r.forEach((t, u) => {
                    void 0 !== r[u] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        ...
                        return e({ time: t, name: `${a ? s : `${DEFAULT_NAME_KEYFRAME}_${u}`}` });
                      });
                  });
                }
              });
...
const roles = {
  ...
  VehicleRole = reactExports.forwardRef(function (
    { roleKey: e, size: t = sizes$2.x24x24, classNames: s, ...u },
    r,
  ) {
...
const sizes$1 = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
  ...
  VehicleType = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Image, {
      ...
      className: clsx(
        styles$4.base,
        s ? styles$4[`base__premium__${t}`] : styles$4[`base__${t}`],
        r.className,
      ),
...
const base$3 = "VehicleInfo_1732f1f0",
  ...
  VehicleInfo = reactExports.forwardRef(function (e, t) {
    return jsxRuntimeExports.jsx("div", {
      ...e,
      ref: t,
      className: clsx(styles$3.base, e.className),
    });
  });
...
const base$1 = "Bubble_df22310d",
  ...
  Bubble = {
    Root: defineStyledComponent("Bubble", styles$1.base, {
      variants: { hidden: { true: styles$1.base__hidden } },
    }),
    Value: Value,
  },
  ...
  TruncatedText = reactExports.forwardRef(function (
    { text: e, tooltipParams: t, className: s, ...u },
    r,
  ) {
...
export {
  ...
  Rewards as a0,
  ExtendedText as a1,
  NotificationWrapper as a2,
  sizes$6 as a3,
  useTooltip as a4,
  SoundsRClassProvider as a5,
  concatWithPath as a6,
  logBySeverity$1 as a7,
  ImagesRClassProvider as a8,
  Alignment as a9,
  VehicleLevel as aA,
  normalizeResource as aB,
  Reward as aC,
  mapNonNullable as aD,
  useHorizontalScroll as aE,
  useSkipFrame$1 as aF,
  useCallbackOnce as aG,
  Area$1 as aH,
  Bar$1 as aI,
  Base$7 as aJ,
  CardsWrapper as aK,
  ...
  useScrollBounding as aV,
  dragDirections as aW,
  Bubble as aX,
  TruncatedText as aY,
  formats as aZ,
  ONE_DAY as a_,
  ProgressBar as aa,
  useSimpleTooltip as ab,
  useParamTooltip as ac,
  Delta as ad,
  Card as ae,
  cloneModel as af,
  add as ag,
  ...
  isEmptyObject as ao,
  useEmitter as ap,
  useSoundsOptional as aq,
  find as ar,
  remToPx$1 as as,
  usePrevious as at,
  useMount as au,
  useEmitterSubscribe as av,
  Video as aw,
  useIsFirstRender as ax,
  MultilineOverflow$1 as ay,
  getRewardTooltipConfig as az,
  seconds as b,
  useVerticalScroll as b0,
  useVerticalDrag as b1,
  MaskArea as b2,
  sizes$3 as b3,
  types$1 as b4,
  createSoundPlay as c,
  useLoadPlugin as d,
  isReactComponent as e,
  format$2 as f,
  resources as g,
  useCallbackOnEsc as h,
  initializeModelWithContext as i,
  Bar as j,
  injectGFPlugins as k,
  useCloseOnEsc as l,
  map as m,
  noop as n,
  Button as o,
