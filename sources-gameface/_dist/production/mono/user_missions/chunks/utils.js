import { a5 as e, a6 as o, a7 as r, g as s, a8 as t } from "./lib.js";
...
const d = "lootbox_images",
  c = "lootbox_sounds";
(s.register(d, n(() => new t(window.R.images)).singleton()),
  s.register(c, n(() => new a(window.R.sounds)).singleton()),
  s.resolve(d),
  s.resolve("videos"),
  s.resolve(c),
  s.resolve("strings"),
