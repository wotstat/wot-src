import { D as e, j as s, e as a } from "../../../../chunks/vendor.js";
import {
  i as r,
  n as i,
  g as t,
  ...
  M = e(function () {
    ...
    return s.jsxs(s.Fragment, {
      children: [
        ...
        s.jsx("div", {
          className: C,
          children: s.jsx(n, { text: $.readOrEmpty(`${E}.description`) }),
        }),
        a > 0 &&
          s.jsxs(s.Fragment, {
            children: [
        ...
        s.jsxs("div", {
          ...
          children: [
            ...
            s.jsxs("div", {
              className: S,
              children: [
                s.jsx("span", { className: X, children: t }),
  ...
  W = ({ condition: e }) => {
    ...
    return s.jsxs("div", {
      ...
      children: [
        s.jsx("div", {
          className: G,
          children: s.jsx("div", { className: U, style: { backgroundImage: `url(${l})` } }),
        }),
        s.jsx("div", {
          className: J,
          children: s.jsx(_, { text: `${r}`, lines: t, className: Q }),
        }),
      ],
    });
  },
    ...
    return s.jsx("div", {
      ...
      children: u(a.items, (e, a, r) =>
        s.jsxs(
          ...
          {
            className: ie,
            children: [s.jsx(W, { condition: e }), a < r.length - 1 && s.jsx(ae, {})],
          },
          e.iconKey || a,
        ),
      ),
...
function de({ size: e, special: r, className: i }) {
  return s.jsx("div", {
    className: a(le, i),
    style: { backgroundImage: `url(${ce.readOrEmpty(`quests.bonuses.${e}.${g(r)}_overlay`)})` },
  });
}
...
function ge({ reward: e, className: r = "" }) {
  const { label: i } = e;
...
const xe = {
  ...
  je = e(function () {
    ...
    return s.jsxs("div", {
      className: xe.base,
      children: [
        s.jsx("div", { className: xe.divider }),
        s.jsx("div", {
            ...
            return s.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  t && s.jsx(ge, { reward: e, className: a(xe.label, xe[`label__${e.name}`]) }),
                ],
              },
              `${e.id}__${r}`,
            );
