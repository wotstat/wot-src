...
function At(e, t, n, r) {
  ...
  if (n.set) {
    ...
    return r === e.target_
      ? null ===
        e.defineProperty_(t, { configurable: !xn.safeDescriptors || e.isPlainObject_, set: u })
        ? 0
        : 2
...
function ir(e) {
  !0 === e.isolateGlobalState &&
    (function () {
      if (
        ((xn.pendingReactions.length || xn.inBatch || xn.isRunningReactions) && pe(36),
        (En = !0),
        On)
      ) {
        var e = ve();
...
var zl = class extends al {
  ...
  _attach() {
    ...
    (Ya(Ja(this.source), (t) => {
      (Mi(t) && Qi(t, this),
        nl(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
    }),
      (this.priority = e),
      this._start());
  }
      ...
      : "idle" == e.type
        ...
        : "priority" == e.type &&
          (this.priority = Ja(this.source).reduce(
            (e, t) => Math.max(e, (nl(t) ? t.priority : 0) + 1),
            0,
          ));
  }
};
...
$l = Object.keys($l).reduce(
  (e, t) => (
    Ql.forEach((n) => (e[((e, t) => e + t.charAt(0).toUpperCase() + t.substring(1))(n, t)] = e[t])),
    e
  ),
  $l,
);
    ...
    applyAnimatedValues: function (e, t) {
      ...
      const n = "filter" === e.nodeName || (e.parentNode && "filter" === e.parentNode.nodeName),
        ...
        f = Object.keys(s).map((t) =>
          n || e.hasAttribute(t)
            ? t
            : Fl[t] || (Fl[t] = t.replace(/([A-Z])/g, (e) => "-" + e.toLowerCase())),
        );
...
var tu,
  nu = function (e) {
    return (
      e &&
      e !== Object.prototype &&
      Object.getOwnPropertyNames(e).concat(nu(Object.getPrototypeOf(e)) || [])
    );
  },
  ru = function (e) {
    return (function (e) {
...
((zu = Dl.unstable_batchedUpdates) || (zu = bu),
  ir({ reactionScheduler: zu }),
  Ou.finalizeAllImmediately);
var Ru,
  Mu,
  Du = { exports: {} };
const Iu = e(
...
class us {
  ...
  applyElement(e, t = os) {
    new rs(this, { separator: e.ownerDocument.createElement("wbr"), threshold: t }).applyToElement(
      e,
    );
  }
