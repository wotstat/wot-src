...
const O = P("clientResized"),
  C = P("self.onScaleUpdated"),
  M = { down: P("mousedown"), up: P("mouseup"), move: P("mousemove") };
function L(e) {
...
const j = { highlight: "highlight", click: "play", yes1: "yes1" },
  I = { ...Object.keys(j).reduce((e, t) => ((e[t] = () => L(j[t])), e), {}), sound: L },
  ...
  $ = {
    ...
    onExternalPaddingsUpdated: P("self.onPaddingsUpdated"),
    children: {
...
function Ae(e) {
  ...
  return (
    ...
    s.useCallback((...e) => (0, t.current)(...e), _e)
  );
}
const xe = () => {
    const e = new Map();
...
function Ne(e) {
  ...
  return o.jsx(Re.Provider, { value: r, children: e.children });
}
const Te = {
  click: ke("play"),
  "hot-key": ke("play"),
...
function Pe({ severity: e = "warn", overrides: t, silent: n = !1, children: r }) {
  const i = s.useMemo(() => ({ ...Te, ...t }), [t]),
    a = s.useMemo(
      () => ({
        play: function (t, r) {
          if (n) return;
  ...
  return o.jsx(Se.Provider, { value: a, children: r });
}
const Fe = new Set(["number", "string", "boolean", "bigint", "undefined", "function"]),
...
class Ue {
  ...
  takeItem(e, t) {
    const n = e.get(t);
    return this.options.cloneItem ? Me(n, Ie) : n;
  }
  set = u((e) => {
    this._data.set(e);
  });
...
const $e = s.createContext({ mode: "real" }),
  Ke = { equals: Y, deep: !1 };
function Be(e, t, n) {
  const r = [];
...
async function Ye(
  ...
  (s && engine.enableImmediateLayout(!0),
    ...
    f.createRoot(t).render(o.jsx(i, { children: o.jsx(Ne, { children: e }) })),
    r &&
      (!(function (e) {
        function t() {
  ...
  return Array.isArray(e)
    ? (function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n],
            i = e[n + 1];
          if ("string" != typeof i || !nt.test(i)) {
            t.push(st(r));
            continue;
          }
          const a = rt(i.slice(1));
          (t.push(
            o.jsxs(
              s.Fragment,
              { children: [o.jsxs("span", { className: Je.nowrap, children: [st(r), i[0]] }), a] },
              tt(),
            ),
          ),
            (n += 1));
    ...
    : "string" == typeof e
      ? o.jsx(s.Fragment, { children: rt(e) }, tt())
      : e;
}
const ot = {
  class: function (e, ...t) {
...
function ct(e, t) {
  for (let n = 0; n < e.length; n++) {
    if ("$" === e[n]) {
      let r = n + 1;
      for (; r < e.length && !ut(e[r]);) r++;
      const s = e.slice(n + 1, r),
        o = t[s];
      if (o) return ct(e.replace(`$${s}`, String(o)), t);
    }
  }
  return e;
}
...
function ht(e, t, n = {}, r = !0) {
  ...
  for (const u of e)
    if (u.type === Ve) a(u.value);
    else if (u.type === Xe)
      null === n[u.name] || dt.includes(typeof n[u.name])
        ? a(n[u.name] ?? `{{${u.name}}}`)
        : i.push(o.jsx(s.Fragment, { children: n[u.name] }, `var-${u.name}-${u.instanceId}`));
    else if (u.type === Ze) {
      const e = ht(u.children, t, n, !1),
        r = at(lt(u.attrs, n), e, t);
      i.push(r);
    }
  return i;
}
...
const gt = { start: "{{", end: "}}" },
  wt = s.memo(function (e) {
    const {
      ...
      m = s.useMemo(() => (e.formatters ? { ...ot, ...e.formatters } : ot), [e.formatters]),
      p = s.useMemo(
        () =>
          (function (e, t) {
            const n = [],
            ...
            for (let u = 0; u < e.length; u++) {
              ...
              if (c === t.start[0] && e.slice(u, u + t.start.length) === t.start)
                (s &&
                  (r.length > 0
                    ? r[r.length - 1].node.children.push({ type: Ve, value: s })
                    : n.push({ type: Ve, value: s }),
                  (s = "")),
                  (o = !0),
                  (u += t.start.length - 1));
      ...
      g = s.useMemo(() => ht(p, m, e.params), [p, m, e.params]),
      w = i(Je.base, u && Je.base__fullSize, h.className);
    return e.inline
      ? (console.warn(
...
function yt(e, t, n) {
  ...
  const a = m(t, n),
    u = s.forwardRef(function (t, n) {
      return o.jsx("div", { "data-name": e, ...bt(i, t), ref: n, className: a(t) });
    });
...
const Et = "Tooltip_decorator_b3486d4e",
  vt = yt("Base", "Tooltip_6d997cee"),
  _t = yt("Decorator", Et),
  At = s.forwardRef(function ({ children: e, ...t }, n) {
...
const Tt = Dt(
  ...
  kt = g.resolve("strings"),
  St = g.resolve("intl"),
  Pt = (e) => St.toUpperCase(kt.readOr(`readable_key_names.KEY_${e}`, () => Ft)),
  Ft = St.toUpperCase(kt.readOrEmpty("readable_key_names.KEY_NONE_ALT")),
  Ot = {
    [q.NONE]: Pt("NONE_ALT"),
    [q.ESCAPE]: Pt("ESCAPE"),
    [q.ENTER]: Pt("ENTER"),
    [q.SPACE]: Pt("SPACE"),
    [q.DELETE]: Pt("DELETE"),
    [q.BACKSPACE]: Pt("BACKSPACE"),
    [q.TAB]: Pt("TAB"),
    [q.HOME]: Pt("HOME"),
    [q.END]: Pt("END"),
    [q.MINUS]: Pt("MINUS"),
    [q.SLASH]: Pt("SLASH"),
    [q.BACKSLASH]: Pt("BACKSLASH"),
    [q.PERIOD]: Pt("PERIOD"),
    [q.COMMA]: Pt("COMMA"),
    [q.QUOTE]: Pt("APOSTROPHE"),
    [q.SEMICOLON]: Pt("SEMICOLON"),
    [q.INSERT]: Pt("INSERT"),
    [q.KEY_A]: Pt("A"),
    [q.KEY_B]: Pt("B"),
    [q.KEY_C]: Pt("C"),
    ...
    [q.DIGIT_8]: Pt("8"),
    [q.DIGIT_9]: Pt("9"),
    [q.NUMPAD_0]: Pt("NUMPAD0"),
    [q.NUMPAD_1]: Pt("NUMPAD1"),
    [q.NUMPAD_2]: Pt("NUMPAD2"),
    [q.NUMPAD_3]: Pt("NUMPAD3"),
    [q.NUMPAD_4]: Pt("NUMPAD4"),
    [q.NUMPAD_5]: Pt("NUMPAD5"),
    [q.NUMPAD_6]: Pt("NUMPAD6"),
    [q.NUMPAD_7]: Pt("NUMPAD7"),
    [q.NUMPAD_8]: Pt("NUMPAD8"),
    [q.NUMPAD_9]: Pt("NUMPAD9"),
    [q.F_1]: Pt("F1"),
    [q.F_2]: Pt("F2"),
    [q.F_3]: Pt("F3"),
    [q.F_4]: Pt("F4"),
    ...
    [q.F_11]: Pt("F11"),
    [q.F_12]: Pt("F12"),
    [q.NUMPAD_MULTIPLY]: Pt("NUMPADSTAR"),
    [q.NUMPAD_DIVIDE]: Pt("NUMPADSLASH"),
    [q.NUMPAD_ADD]: Pt("ADD"),
    [q.NUMPAD_SUBTRACT]: Pt("NUMPADMINUS"),
    [q.NUMPAD_DECIMAL]: Pt("NUMPADPERIOD"),
    [q.ARROW_LEFT]: Pt("LEFTARROW"),
    [q.ARROW_RIGHT]: Pt("RIGHTARROW"),
    [q.ARROW_UP]: Pt("UPARROW"),
    [q.ARROW_DOWN]: Pt("DOWNARROW"),
    [q.PAGE_UP]: Pt("PGUP"),
    [q.PAGE_DOWN]: Pt("PGDN"),
    [q.BRACKET_LEFT]: Pt("LBRACKET"),
    [q.BRACKET_RIGHT]: Pt("RBRACKET"),
  },
...
const Lt = "KeyButton_background_8a852f95",
  jt = "KeyButton_border_b1c50f01",
  It = "KeyButton_8fd343f8",
  Ut = "KeyButton_content_3ab1d990",
  $t = yt("KeyButton", It);
...
function Bt({ keyCode: e, onActive: t, silent: n, soundTarget: r, idle: i, children: a }) {
  !(function (e, t, n = !1) {
    De(Z(e), "keyup", t, n);
  })(i ? q.NONE : Z(e), t);
  const u = s.useMemo(
    () => ({ keyCode: e, onActive: t, silent: n, soundTarget: r, idle: i }),
    [e, t, r, n, i],
  );
  return o.jsx(Ct.Provider, { value: u, children: a });
}
const zt = function ({
  keyCode: e,
  onActive: t = H,
  ...
  return o.jsx(Bt, {
    ...
    children: o.jsxs(Kt, {
      ...l,
      className: i(It, u, a?.base),
      children: [
        o.jsx("div", { className: i(Lt, a?.background) }),
        o.jsx("div", { className: i(jt, a?.border) }),
        o.jsx("div", { className: i(Ut, a?.content), children: c }),
      ],
    }),
  });
};
