...
const H = (e) => {
  ...
  G = {
    ...
    contextMenu: {
      ...
      hide(e, t, n = 0) {
        (V(U, { contentID: t, decoratorID: n, targetID: e, on: !1, isMouseEvent: !1 }),
          X.delete(`${e}-${t}`));
      },
      hideAll() {
...
function ce(e, t, n) {
  return "function" == typeof t
    ? le(0, e, t)
    : (ue(void 0 !== n, "fn must be defined"), le(e, t, n));
}
function le(e, t, n) {
  ...
  Mt = o.forwardRef(function (
    ...
    return s.jsxs(jt, {
      ...
      children: [
        ...
        s.jsx("div", {
          className: i(Ft.content, a && Ft.content__fontAligned, u?.content),
          children: e,
        }),
      ],
    });
