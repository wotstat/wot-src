...
function qa() {
  ...
  (t && (Ka(Ma.splice(0, t), (e) => e.handler()), (Fa -= t)),
    Fa
      ? (ja.flush(),
        Ta.flush(e ? Math.min(64, Ia - e) : 16.667),
        La.flush(),
        za.flush(),
        Ra.flush())
      : (Ia = -1));
...
function Wa() {
  ...
  return {
    ...
    flush(n) {
      t.size &&
        ((e = new Set()), (Fa -= t.size), Ka(t, (t) => t(n) && e.add(t)), (Fa += e.size), (t = e));
    },
  };
}
function Ka(e, t) {
...
var lo = [],
  ...
  vo = class extends ho {
    ...
    reset(e) {
      (e && (this._toString = Li({ output: [this.getValue(), e] })),
        (this._value = 0),
        super.reset());
    }
  },
...
var No = class extends Co {
  ...
  _attach() {
    ...
    (Ya(ti(this.source), (t) => {
      (Di(t) && Bi(t, this),
        Eo(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
    }),
      (this.priority = e),
      this._start());
  }
      ...
      : "idle" == e.type
        ...
        : "priority" == e.type &&
          (this.priority = ti(this.source).reduce(
            (e, t) => Math.max(e, (Eo(t) ? t.priority : 0) + 1),
            0,
          ));
  }
};
...
Io = Object.keys(Io).reduce(
  (e, t) => (
    Fo.forEach((n) => (e[((e, t) => e + t.charAt(0).toUpperCase() + t.substring(1))(n, t)] = e[t])),
    e
  ),
  Io,
);
...
var Go,
  Xo = function (e) {
    return (
      e &&
      e !== Object.prototype &&
      Object.getOwnPropertyNames(e).concat(Xo(Object.getPrototypeOf(e)) || [])
    );
  },
  Yo = function (e) {
    return (function (e) {
...
((Tl = Ro.unstable_batchedUpdates) || (Tl = pl),
  lr({ reactionScheduler: Tl }),
  yl.finalizeAllImmediately);
