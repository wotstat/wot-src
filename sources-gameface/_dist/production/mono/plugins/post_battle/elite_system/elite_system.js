...
!(function (e, t) {
  ...
  function qe() {
    ...
    (t && (Xe(Fe.splice(0, t), (e) => e.handler()), (Ve -= t)),
      Ve
        ? (Ae.flush(),
          Re.flush(e ? Math.min(64, $e - e) : 16.667),
          Me.flush(),
          Ne.flush(),
          Te.flush())
        : ($e = -1));
      ...
      return r.forwardRef((s, o) => {
        ...
        (dn(
          () => (
            ...
            () => {
              f.current &&
                (Ke(f.current.deps, (e) => Wt(e, f.current)), Se.cancel(f.current.update));
            }
          ),
        ),
          r.useEffect(d, []),
  ...
  var Nn = Symbol.for("AnimatedComponent"),
    An = (e) =>
      Ge.str(e) ? e : e && Ge.str(e.displayName) ? e.displayName : (Ge.fun(e) && e.name) || null;
  function Mn(e, ...t) {
  ...
  function zn(e) {
    return (
      ...
      Ge.arr(e)
        ? e.map(zn)
        : un(e)
          ? We.createStringInterpolator({ range: [0, 1], output: [e, e] })(1)
          : e
    );
  }
  function Bn(e) {
  ...
  function Sr(e, t) {
    ...
    return (
      t &&
        Ke(Ye(t), (e) => {
          (Ge.und(e.keys) && (e = _r(e)),
            Ge.obj(e.to) || (e = { ...e, to: void 0 }),
            Mr(n, e, (e) => Ar(e)));
        }),
      Nr(e, n),
      n
  ...
  function Br(e, t, n) {
    ...
    if (
      ...
      Ke(p, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new jr() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
  ...
  var Ur = class extends lr {
    ...
    _attach() {
      ...
      (Ke(Ye(this.source), (t) => {
        (Dt(t) && Ht(t, this),
          ar(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
    ...
    eventObserved(e) {
      "change" == e.type
        ...
        : "idle" == e.type
          ? this._active.delete(e.parent)
          : "priority" == e.type &&
            (this.priority = Ye(this.source).reduce(
              (e, t) => Math.max(e, (ar(t) ? t.priority : 0) + 1),
              0,
            ));
    }
  };
  ...
  var Yr = /^(matrix|translate|scale|rotate|skew)/,
    ...
    rs = (e, t) =>
      Ge.arr(e) ? e.every((e) => rs(e, t)) : Ge.num(e) ? e === t : parseFloat(e) === t,
    ss = class extends kn {
    ...
    Us = r.forwardRef(function (
      ...
      return e.jsxs(Bs, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: S(qs.content, a && qs.content__fontAligned, i?.content),
            children: t,
          }),
        ],
      });
  ...
  const Xs = "Action_6c7b0c76",
    ...
    Ws = r.forwardRef(function (
      { className: t, theme: n = Us.themes.secondary, tooltipParams: r, ...s },
      o,
    ) {
  ...
  const [ea, ta] = (
      ...
      ({ observableModel: e }) => {
        const t = {
            ...
            currentPrestigeEmblem: e.transform(Yo, "currentPrestigeEmblemModel", {
              equals: me.shallow,
            }),
            oldPrestigeEmblemModel: e.transform(Yo, "oldPrestigeEmblemModel", {
              equals: me.shallow,
            }),
          },
  ...
  const Ma = r.forwardRef(function (
    { level: t, grade: n, type: r, size: s, classNames: o, ...a },
    i,
  ) {
    return t < 1
      ? null
      : e.jsxs("div", {
          ...
          children: [
            ...
            r !== ja &&
              e.jsx(Aa, { level: t, type: r, size: s, classNames: { levelIcon: o?.level } }),
          ],
        });
  });
  function Ta() {
  ...
  Ma.sizes = { xs: "xs", sm: "sm", md: "md", mdLg: "mdLg", lg: "lg", xl: "xl", xxl: "xxl" };
  ...
  function ni({
    ...
    return e.jsxs(ei, {
      ...
      children: [
        f && e.jsx(xe, { width: u, height: u, path: a ?? p, className: o?.icon }),
        ti(t, n),
      ],
    });
  }
  ...
  function si({
    ...
    return {
      ...
      to: { width: t },
      config: o ?? {
        duration: (n === ii.simple && r) || (!r && s) ? 0 : oi,
        easing: $t.easeInOutCubic,
      },
    };
  }
      ...
      r.forwardRef(function (
        ...
        return (
          r.useEffect(() => {
            const e = d.current;
            if (!e || 0 === E)
              return (g.set({ width: 0 }), f.set({ width: 0 }), k("done"), void x([]));
            ...
            !c &&
              e.jsx(Ri, {
                ...
                className: S(
                  n?.doneComplete,
                  Ci.complete,
                  s.progressCompleted && Ci.complete__visible,
                ),
                repeat: "repeat",
                position: "left top",
                style: { width: d.width.to((e) => `${e}%`) },
      ...
      return (
        ...
        e.jsx(Oi, {
          children:
            ...
            "function" == typeof s
              ? ce(0, r, s)
              : (le(void 0 !== o, "fn must be defined"), ce(r, s, o))),
        })
      );
      var r, s, o;
    };
  ...
  const Xi = {
    ...
    Hi = $s("ProgressBar", Xi.base, {
      variants: { size: { medium: Xi.base__medium, large: Xi.base__large } },
    }),
    Wi = function ({
      size: t = li.medium,
      backgroundPattern: n,
  ...
  const Ki = N.cubicBezier(0.33, 0, 0.25, 1),
    Ji = i.observer(function () {
      ...
      return e.jsx(Zi, {
        wrapperSpringProps: h.wrapper,
        progressBar: h.progress,
        delta: h.delta,
        fill: h.fill,
      });
    });
  ...
  function nl() {
    const {
      stepValues: t,
      progressStatsLabelRef: n,
      immediateAnimation: r,
      maxLevelReachedMarkRef: s,
    } = ua();
    return e.jsx(Pa, {
      className: Oa,
      children: e.jsxs("div", {
  ...
  const rl = i.observer(function () {
    ...
    al = {
      rootId: m.resolve("aliases").read((e) => e.battle_results.progression.Prestige("resId")),
    },
