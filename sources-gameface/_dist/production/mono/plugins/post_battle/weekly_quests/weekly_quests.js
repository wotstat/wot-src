...
!(function (e, t) {
  ...
  function me(e, t, n) {
    return "function" == typeof t
      ? pe(0, e, t)
      : (de(void 0 !== n, "fn must be defined"), pe(e, t, n));
  }
  function pe(e, t, n) {
  ...
  function Xe() {
    ...
    (t && (Ke(Ue.splice(0, t), (e) => e.handler()), (Ge -= t)),
      Ge
        ? (Fe.flush(),
          De.flush(e ? Math.min(64, Ve - e) : 16.667),
          $e.flush(),
          Be.flush(),
          Le.flush())
        : (Ve = -1));
  ...
  var Rn = Symbol.for("Animated:node"),
    ...
    Nn = class extends Sn {
      ...
      reset(e) {
        (e && (this._toString = qt({ output: [this.getValue(), e] })),
          (this._value = 0),
          super.reset());
      }
    },
      ...
      return s.forwardRef((r, o) => {
        ...
        (bn(
          () => (
            ...
            () => {
              f.current &&
                (rt(f.current.deps, (e) => en(e, f.current)), Oe.cancel(f.current.update));
            }
          ),
        ),
          s.useEffect(d, []),
  ...
  var Bn = Symbol.for("AnimatedComponent"),
    Fn = (e) =>
      nt.str(e) ? e : e && nt.str(e.displayName) ? e.displayName : (nt.fun(e) && e.name) || null;
  function $n(e, ...t) {
  ...
  var ds = class extends Error {
    ...
    hs = class extends Zt {
      ...
      interpolate(...e) {
        return (
          hn(`${pn}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          et.to(this, e)
        );
      }
      toJSON() {
  ...
  function Os(e, t) {
    ...
    return (
      t &&
        rt(at(t), (e) => {
          (nt.und(e.keys) && (e = Cs(e)),
            nt.obj(e.to) || (e = { ...e, to: void 0 }),
            $s(n, e, (e) => Fs(e)));
        }),
      Bs(e, n),
      n
  ...
  function Ys(e, t, n) {
    ...
    if (
      ...
      rt(h, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new Ms() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
  ...
  var Zs = class extends hs {
    ...
    _attach() {
      ...
      (rt(at(this.source), (t) => {
        (Qt(t) && Jt(t, this),
          ps(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
        ...
        : "idle" == e.type
          ...
          : "priority" == e.type &&
            (this.priority = at(this.source).reduce(
              (e, t) => Math.max(e, (ps(t) ? t.priority : 0) + 1),
              0,
            ));
    }
  };
  ...
  var ar = /^(matrix|translate|scale|rotate|skew)/,
    ...
    ur = (e, t) =>
      nt.arr(e) ? e.every((e) => ur(e, t)) : nt.num(e) ? e === t : parseFloat(e) === t,
    dr = class extends An {
    ...
    Qr = s.forwardRef(function (
      ...
      return e.jsxs(Gr, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: N(Hr.content, a && Hr.content__fontAligned, i?.content),
            children: t,
          }),
        ],
      });
  ...
  const Wr = "Action_6c7b0c76",
    ...
    Xr = s.forwardRef(function (
      { className: t, theme: n = Qr.themes.secondary, tooltipParams: s, ...r },
      o,
    ) {
  ...
  function ta({
    ...
    return {
      ...
      to: { width: t },
      config: o ?? {
        duration: (n === ra.simple && s) || (!s && r) ? 0 : na,
        easing: Vt.easeInOutCubic,
      },
    };
  }
  const na = 600,
      ...
      e.jsx("div", {
        ...
        children: e.jsx(xe, {
          className: N(
            ...
            0 === s.percentage
              ? pa.backgroundPattern__noProgress
              : pa[`backgroundPattern__${s.size}`],
          ),
          repeat: "repeat",
          position: "left top",
          path:
      ...
      s.forwardRef(function (
        ...
        return (
          s.useEffect(() => {
            const e = d.current;
            if (!e || 0 === C)
              return (g.set({ width: 0 }), f.set({ width: 0 }), E("done"), void x([]));
            ...
            !c &&
              e.jsx(Ca, {
                ...
                className: N(
                  n?.doneComplete,
                  Ea.complete,
                  r.progressCompleted && Ea.complete__visible,
                ),
                repeat: "repeat",
                position: "left top",
                style: { width: d.width.to((e) => `${e}%`) },
  ...
  const za = {
    ...
    qa = Lr("ProgressBar", za.base, {
      variants: { size: { medium: za.base__medium, large: za.base__large } },
    }),
    Va = function ({
      size: t = oa.medium,
      backgroundPattern: n,
  ...
  const li = {
    ...
    Root: function ({ condition: t, ...n }) {
      return e.jsx(ti.Provider, {
        ...
        children: e.jsx("div", {
          ...n,
          className: N(oi.content, t.completed && oi.content__completed),
        }),
      });
    },
    ...
    Title: function ({ questsAmount: t }) {
      const { title: n, icon: s, completed: r, progression: o, hideTitle: a } = ni(),
        { completed: i } = ri();
        ...
        children: [
          void 0 !== l &&
            e.jsx("div", {
              ...
              className: N(oi.titleIcon, l.default.isGold && oi.titleIcon__gold),
            }),
    ...
    Li = s.memo(function ({
      ...
      const m = p.resolve("strings"),
        ...
        g =
          ...
          })(Ao(m.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (o || 0),
          });
      return e.jsx("div", {
  ...
  function Zi({
    ...
    return t
      ...
      : e.jsx(Ui, { ...g, classMix: p });
  }
  const Ki = "CompletedMark_fc4eee08",
    Ji = "CompletedMark_glow_33775180",
    el = k.cubicBezier(1, 0, 0.95, 1),
    tl = k.cubicBezier(0.45, 0, 0.52, 1),
    ...
    return t
      ? e.jsx("div", {
          className: N(
            ...
            n === sl.PREMIUM && oi.iconImage__gold,
            s,
          ),
      ...
      : "union" === t.type
        ...
        : "or" === t.type
          ? e.jsxs("div", {
              ...
              children: [
                e.jsx(ol, { width: 16, height: 16, className: oi.invertedArrow }),
                al.readOrEmpty("battle_results.conditions.type.or"),
                e.jsx(ol, { width: 16, height: 16, className: oi.arrow }),
              ],
            })
          : e.jsx("div", {
        ...
        children: [
          e.jsx("div", {
            ...
            children: t.completed
              ...
              : e.jsx(rl, { value: u.path, questType: t.questType, className: t.iconClassName }),
          }),
          e.jsx("div", {
  ...
  ((gl.Content = li), (gl.Groups = hl), (gl.Separators = ll));
  const _l = {
  ...
  const Rl = p.resolve("strings"),
    El = p.resolve("aliases").read((e) => e.battle_results.progression.WeeklyMissions("resId")),
    [Cl, Tl] = (
      (t = "DataLayerProvider") =>
      (n, r, o) => {
    ...
    Sl = "mission-progress:weekly-quests:mission-card",
    Nl = p.resolve("aliases"),
    kl = p.resolve("strings"),
    Al = { rootId: Nl.read((e) => e.battle_results.progression.WeeklyMissions("resId")) },
    Il = i.observer(function ({ animation: t, immediateAnimation: n }) {
      ...
      return e.jsx(e.Fragment, {
        children: e.jsx(gl, {
          target: Sl,
          title: kl.readOrEmpty("user_missions.hub.basic_missions.weekly.title"),
          onButtonAction: a.navigateTo,
          onClick: function (e) {
            (r.play("click", { target: Sl, original: e }), a.navigateTo());
          },
          animation: t,
          immediateAnimation: n,
          actionTooltipParams: { body: kl.readOrEmpty("battle_results.progression.linkBtn.info") },
          children: o
            .quests()
            .map((t, n, r) =>
              e.jsxs(
