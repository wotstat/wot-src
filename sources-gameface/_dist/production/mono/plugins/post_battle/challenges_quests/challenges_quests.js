...
!(function (e, t) {
  ...
  function fe(e, t, n) {
    return "function" == typeof t
      ? he(0, e, t)
      : (pe(void 0 !== n, "fn must be defined"), he(e, t, n));
  }
  function he(e, t, n) {
  ...
  function qe() {
    ...
    (t && (Ge(je.splice(0, t), (e) => e.handler()), ($e -= t)),
      $e
        ? (Ae.flush(),
          Se.flush(e ? Math.min(64, Be - e) : 16.667),
          Ie.flush(),
          ke.flush(),
          Me.flush())
        : (Be = -1));
      ...
      return s.forwardRef((r, o) => {
        ...
        (dn(
          () => (
            ...
            () => {
              f.current &&
                (Ze(f.current.deps, (e) => Qt(e, f.current)), Ne.cancel(f.current.update));
            }
          ),
        ),
          s.useEffect(d, []),
  ...
  function Un(e) {
    return (
      ...
      Ye.arr(e)
        ? e.map(Un)
        : un(e)
          ? Qe.createStringInterpolator({ range: [0, 1], output: [e, e] })(1)
          : e
    );
  }
  function zn(e) {
  ...
  var rs = class extends Error {
    ...
    ls = class extends Vt {
      ...
      interpolate(...e) {
        return (
          ln(`${on}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          Qe.to(this, e)
        );
      }
      toJSON() {
  ...
  function zs(e, t, n) {
    ...
    if (
      ...
      Ze(h, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new Ts() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
  ...
  var Vs = class extends ls {
    ...
    _attach() {
      ...
      (Ze(Je(this.source), (t) => {
        (Lt(t) && Ht(t, this),
          as(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
        ...
        : "idle" == e.type
          ...
          : "priority" == e.type &&
            (this.priority = Je(this.source).reduce(
              (e, t) => Math.max(e, (as(t) ? t.priority : 0) + 1),
              0,
            ));
    }
  };
  ...
  var Js = /^(matrix|translate|scale|rotate|skew)/,
    ...
    sr = (e, t) =>
      Ye.arr(e) ? e.every((e) => sr(e, t)) : Ye.num(e) ? e === t : parseFloat(e) === t,
    rr = class extends Rn {
    ...
    Co = s.forwardRef(function (
      ...
      return e.jsxs(Eo, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: N(Ro.content, a && Ro.content__fontAligned, i?.content),
            children: t,
          }),
        ],
      });
  ...
  const To = "Action_6c7b0c76",
    ...
    So = s.forwardRef(function (
      { className: t, theme: n = Co.themes.secondary, tooltipParams: s, ...r },
      o,
    ) {
      ...
      function r() {
        ...
        if (o === r) R(!1);
          ...
          const r =
            ...
            { x: (i = t.getBoundingClientRect()).x - a.x, y: i.y - a.y });
          for (
  ...
  function aa({
    ...
    return {
      ...
      to: { width: t },
      config: o ?? {
        duration: (n === ca.simple && s) || (!s && r) ? 0 : ia,
        easing: Bt.easeInOutCubic,
      },
    };
  }
  const ia = 600,
      ...
      e.jsx("div", {
        ...
        children: e.jsx(mo, {
          className: N(
            ...
            0 === s.percentage
              ? ba.backgroundPattern__noProgress
              : ba[`backgroundPattern__${s.size}`],
          ),
          repeat: "repeat",
          position: "left top",
          path:
            ...
            !c &&
              e.jsx(ka, {
                ...
                className: N(
                  n?.doneComplete,
                  Na.complete,
                  r.progressCompleted && Na.complete__visible,
                ),
                repeat: "repeat",
                position: "left top",
                style: { width: d.width.to((e) => `${e}%`) },
  ...
  const Qa = {
    ...
    Wa = bo("ProgressBar", Qa.base, {
      variants: { size: { medium: Qa.base__medium, large: Qa.base__large } },
    }),
    Ya = function ({
      size: t = ua.medium,
      backgroundPattern: n,
  ...
  const pi = {
    ...
    Root: function ({ condition: t, ...n }) {
      return e.jsx(ai.Provider, {
        ...
        children: e.jsx("div", {
          ...n,
          className: N(ui.content, t.completed && ui.content__completed),
        }),
      });
    },
    ...
    Title: function ({ questsAmount: t }) {
      const { title: n, icon: s, completed: r, progression: o, hideTitle: a } = ii(),
        { completed: i } = ci();
        ...
        children: [
          void 0 !== l &&
            e.jsx("div", {
              ...
              className: N(ui.titleIcon, l.default.isGold && ui.titleIcon__gold),
            }),
    ...
    Gi = s.memo(function ({
      ...
      const m = p.resolve("strings"),
        ...
        g =
          ...
          })(so(m.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (o || 0),
          });
      return e.jsx("div", {
  ...
  function cl({ value: t, questType: n, className: s }) {
    return t
      ? e.jsx("div", {
          className: N(
            ui.iconImage,
            ui.iconImage__regular,
            n === ll.PREMIUM && ui.iconImage__gold,
            s,
          ),
      ...
      : "union" === t.type
        ...
        : "or" === t.type
          ? e.jsxs("div", {
              ...
              children: [
                e.jsx(ul, { width: 16, height: 16, className: ui.invertedArrow }),
                dl.readOrEmpty("battle_results.conditions.type.or"),
                e.jsx(ul, { width: 16, height: 16, className: ui.arrow }),
              ],
            })
          : e.jsx("div", {
        ...
        children: [
          e.jsx("div", {
            ...
            children: t.completed
              ...
              : e.jsx(cl, { value: u.path, questType: t.questType, className: t.iconClassName }),
          }),
          e.jsx("div", {
  ...
  ((wl.Content = pi), (wl.Groups = vl), (wl.Separators = pl));
  class xl {
    index = 0;
    next() {
      return this.index++;
  ...
  function El({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r }) {
    if ("items" in e)
      return {
        type: "items",
        separate:
        ...
        groups: ue(e.items, (e) =>
          El({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r }),
        ),
      };
    var o;
    const a = {
    ...
    return (
      e.total > 0 &&
        (a.condition.progression = { current: e.current, total: e.total, earned: e.earned }),
      a
    );
  }
  const Rl = p.resolve("images"),
    Cl = p.resolve("aliases"),
    Tl = p.resolve("strings"),
    Pl = Cl.read((e) => e.battle_results.progression.Challenges("resId")),
    Sl = { rootId: Pl },
    Nl = {
      default: { path: Rl.readOrEmpty("userMissions.challenges.icons.shields.loseShield_32") },
      large: { path: Rl.readOrEmpty("userMissions.challenges.icons.shields.loseShield_80") },
    };
  const [kl, Al] = (
      (t = "DataLayerProvider") =>
      (n, r, o) => {
      ...
      ({ externalModel: e }) => ({
        quest: Mr(() => {
          ...
          return {
            questId: t.id,
            challengeName: `${Tl.readOrEmpty("challenges.postbattle.name")}${t.challengeName}`,
            completed: n,
            navigationEnabled: t.navigationEnabled,
            bonuses: t.bonuses,
            rewardsTooltipResId: Pl,
            generalIcon: Nl,
            progress:
              t.totalProgress > 0
                ? {
    ...
    Il = "ChallengesQuests_content_4f523b72",
    Ml = "ChallengesQuests_customIcon_9154ce6c",
    jl = p.resolve("strings"),
    Dl = i.observer(function ({ animation: t, immediateAnimation: n }) {
      const { model: r, controls: o } = Al(),
        a = r.quest(),
        i = s.useCallback(() => {
      ...
      return a
        ? e.jsx(wl, {
            ...
            onClick: i,
            actionTooltipParams: {
              body: jl.readOrEmpty("battle_results.progression.linkBtn.info"),
            },
            children: e.jsx("div", {
              className: Il,
              children: e.jsx(wl.Groups, { ...a, iconClassName: Ml }),
            }),
          })
        : null;
    });
  var Ol = ((e) => ((e.Done = "done"), (e.Locked = "notAvailable"), (e.Active = ""), e))(Ol || {});
  const Bl = {
      icon: "",
      index: 0,
      name: "",
    ...
    $l = {
      challengeQuest: {
        ...
        isCompleted: !0,
        bonuses: [
          { ...Bl, index: 0, name: "credits", label: "Кредиты", value: "500000" },
          { ...Bl, index: 1, name: "freeXP", label: "Свободный опыт", value: "2500" },
          { ...Bl, index: 2, name: "gold", label: "Золото", value: "100" },
          { ...Bl, index: 3, name: "equipCoin", label: "Боны", value: "1000" },
          { ...Bl, index: 4, name: "xp", label: "Опыт", value: "5000" },
          { ...Bl, index: 5, name: "crystal", label: "Бонды", value: "50" },
          { ...Bl, index: 6, name: "premium", label: "Премиум аккаунт", value: "3" },
        ],
        postBattleCondition: {
          conditionType: "or",
          items: [
  ...
  kr({
    ...$l,
    challengeQuest: { ...$l.challengeQuest, status: Ol.Done, isCompleted: !0, currentProgress: 5 },
  });
  const Ll = new (class {
    items = [];
    add(e) {
    ...
    .addWithProps(kl, { options: Sl, mode: "real", mocks: Fl })
    .addWithProps(
      function (t) {
        return e.jsx(io, {
          children: e.jsx(yr, {
      ...
      return {
        async init() {
          ...
          try {
            ...
            const r = X(Sl, { name: "ChallengesMissionsProgressDataLayer" }),
              o =
                (u(d, ((c = r.dispose), { [Symbol.dispose]: c })), r.readByPath("challengeQuest")),
              a = !0 === o?.isCompleted;
            return {
              animated: !0,
              component: ql,
