...
!(function (e, t) {
  ...
  function ze() {
    ...
    (t && (Ve(Me.splice(0, t), (e) => e.handler()), (Be -= t)),
      Be
        ? (ke.flush(),
          Pe.flush(e ? Math.min(64, Oe - e) : 16.667),
          Ae.flush(),
          Ne.flush(),
          Ie.flush())
        : (Oe = -1));
      ...
      return s.forwardRef((r, o) => {
        ...
        (un(
          () => (
            ...
            () => {
              f.current &&
                (Xe(f.current.deps, (e) => Ht(e, f.current)), Se.cancel(f.current.update));
            }
          ),
        ),
          s.useEffect(d, []),
  ...
  var Nn = Symbol.for("AnimatedComponent"),
    kn = (e) =>
      We.str(e) ? e : e && We.str(e.displayName) ? e.displayName : (We.fun(e) && e.name) || null;
  function An(e, ...t) {
  ...
  function Ln(e) {
    return (
      ...
      We.arr(e)
        ? e.map(Ln)
        : cn(e)
          ? He.createStringInterpolator({ range: [0, 1], output: [e, e] })(1)
          : e
    );
  }
  function Un(e) {
  ...
  var ss = class extends Error {
    ...
    is = class extends qt {
      ...
      interpolate(...e) {
        return (
          an(`${rn}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          He.to(this, e)
        );
      }
      toJSON() {
  ...
  function Ss(e, t) {
    ...
    return (
      t &&
        Xe(Ke(t), (e) => {
          (We.und(e.keys) && (e = _s(e)),
            We.obj(e.to) || (e = { ...e, to: void 0 }),
            As(n, e, (e) => ks(e)));
        }),
      Ns(e, n),
      n
  ...
  function Us(e, t, n) {
    ...
    if (
      ...
      Xe(h, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new Cs() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
    ...
    eventObserved(e) {
      "change" == e.type
        ...
        : "idle" == e.type
          ? this._active.delete(e.parent)
          : "priority" == e.type &&
            (this.priority = Ke(this.source).reduce(
  ...
  var Ks = /^(matrix|translate|scale|rotate|skew)/,
    ...
    nr = (e, t) =>
      We.arr(e) ? e.every((e) => nr(e, t)) : We.num(e) ? e === t : parseFloat(e) === t,
    sr = class extends Rn {
    ...
    Ro = s.forwardRef(function (
      ...
      return e.jsxs(wo, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: N(xo.content, a && xo.content__fontAligned, i?.content),
            children: t,
          }),
        ],
      });
  ...
  const Eo = "Action_6c7b0c76",
    ...
    To = s.forwardRef(function (
      { className: t, theme: n = Ro.themes.secondary, tooltipParams: s, ...r },
      o,
    ) {
      ...
      children: [
        e.jsxs(Bo.Header, {
          ...
          children: [
            ...
            e.jsx("div", {
              className: N(Zo.tail, u?.tail),
              children: void 0 !== l && e.jsx(Yo, { ...l }),
            }),
          ],
        }),
  ...
  function ra({
    ...
    return {
      ...
      to: { width: t },
      config: o ?? {
        duration: (n === ia.simple && s) || (!s && r) ? 0 : oa,
      ...
      e.jsx("div", {
        ...
        children: e.jsx(co, {
          className: N(
            ...
            0 === s.percentage
              ? ga.backgroundPattern__noProgress
              : ga[`backgroundPattern__${s.size}`],
          ),
          repeat: "repeat",
          position: "left top",
          path:
            ...
            !c &&
              e.jsx(Sa, {
                ...
                className: N(
                  n?.doneComplete,
                  Pa.complete,
                  r.progressCompleted && Pa.complete__visible,
                ),
                repeat: "repeat",
                position: "left top",
                style: { width: d.width.to((e) => `${e}%`) },
  ...
  const Ga = {
    ...
    Ha = go("ProgressBar", Ga.base, {
      variants: { size: { medium: Ga.base__medium, large: Ga.base__large } },
    }),
    Qa = function ({
      size: t = la.medium,
      backgroundPattern: n,
  ...
  const di = {
    ...
    Root: function ({ condition: t, ...n }) {
      return e.jsx(ri.Provider, {
        ...
        children: e.jsx("div", {
          ...n,
          className: N(li.content, t.completed && li.content__completed),
        }),
      });
    },
    ...
    Title: function ({ questsAmount: t }) {
      const { title: n, icon: s, completed: r, progression: o, hideTitle: a } = oi(),
        { completed: i } = ii();
        ...
        children: [
          void 0 !== l &&
            e.jsx("div", {
              ...
              className: N(li.titleIcon, l.default.isGold && li.titleIcon__gold),
            }),
  ...
  const $i = "RewardsList_b956755b",
    ...
    Gi = s.memo(function ({
      ...
      const m = p.resolve("strings"),
        ...
        g =
          c ||
          Bi(to(m.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (o || 0),
          });
      return e.jsx("div", {
  ...
  function cl({ value: t, questType: n, className: s }) {
    return t
      ? e.jsx("div", {
          className: N(
            li.iconImage,
            li.iconImage__regular,
            n === ll.PREMIUM && li.iconImage__gold,
            s,
          ),
      ...
      : "union" === t.type
        ...
        : "or" === t.type
          ? e.jsxs("div", {
              ...
              children: [
                e.jsx(ul, { width: 16, height: 16, className: li.invertedArrow }),
                dl.readOrEmpty("battle_results.conditions.type.or"),
                e.jsx(ul, { width: 16, height: 16, className: li.arrow }),
              ],
            })
          : e.jsx("div", {
  ...
  ((wl.Content = di), (wl.Groups = vl), (wl.Separators = pl));
  const xl = p.resolve("strings"),
    Rl = p.resolve("aliases").read((e) => e.battle_results.progression.BattleMatters("resId")),
    El = { rootId: Rl },
    [Cl, Tl] = (
      (t = "DataLayerProvider") =>
      (n, r, o) => {
    ...
    Nl = i.observer(function ({ quest: t, animation: n, immediateAnimation: s }) {
      const r = Ls(),
        o = Ls(),
        a = fr({
          body: Fi("battle_results.missionsProgress.battleMatters.doneInfo", { name: t.number }),
        });
      return e.jsxs("div", {
        className: Pl.base,
        children: [
          e.jsx("div", {
            className: Pl.headContainer,
            children: t.completed
              ? e.jsx(il, {
                  ...a,
                  animationRef: o,
                  className: Pl.completedMark,
                  springProps: { immediate: s },
                })
              : e.jsx("div", { className: Pl.number, children: t.number }),
          }),
          e.jsx("div", {
            ...(t.completed && a),
            className: Pl.condition,
          ...
          e.jsx("div", {
            className: Pl.rewards,
            children: e.jsx(nl, {
              rewardsGlowRef: r,
              completed: t.completed,
              maxRewardsCount: 5,
              bonuses: t.rewards,
              rewardItemClassName: Pl.rewardItem,
    ...
    kl = i.observer(function ({ animation: t, immediateAnimation: n }) {
      ...
      return e.jsx(wl, {
        ...
        children: ce(r.quests(), (s) =>
          e.jsx(Nl, { quest: s, animation: t, immediateAnimation: n }, s.number),
        ),
      });
    }),
    Al = {
  ...
  const Ll = new (class {
    ...
    .addWithProps(Cl, { options: El, mode: "real", mocks: Fl })
    .addWithProps(
      function (t) {
        return e.jsx(oo, {
          children: e.jsx(br, {
      ...
      return {
        async init() {
          ...
          try {
            ...
            const r = X(El, { name: "BattleMattersProgressDataLayer" }),
              o =
