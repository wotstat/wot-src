...
!(function (e, t) {
  ...
  function Ve() {
    ...
    Ne = we.now();
    const t = Fe(Ne);
    (t && (Pe(ke.splice(0, t), (e) => e.handler()), (Re -= t)),
      Re
        ? (Ce.flush(),
          ye.flush(e ? Math.min(64, Ne - e) : 16.667),
          Le.flush(),
          xe.flush(),
          Ee.flush())
        : (Ne = -1));
  ...
  var At,
    ...
    Zt = (e) => {
      ...
      const t = e.output.map((e) => jt(e).replace(It, Ot).replace(Pt, Ct).replace(At, Ct)),
      ...
      return (e) => {
        const n = !Bt.test(t[0]) && t.find((e) => Bt.test(e))?.replace(St, "");
        let r = 0;
  ...
  var Jt = [],
    ...
    sn = class extends rn {
      ...
      reset(e) {
        (e && (this._toString = Lt({ output: [this.getValue(), e] })),
          (this._value = 0),
          super.reset());
      }
    },
      ...
      return r.forwardRef((s, o) => {
        ...
        (Gt(
          () => (
            ...
            () => {
              p.current &&
                (Oe(p.current.deps, (e) => $t(e, p.current)), we.cancel(p.current.update));
            }
          ),
        ),
          r.useEffect(d, []),
  ...
  var hn,
    ...
    mn = (e) =>
      Ie.str(e) ? e : e && Ie.str(e.displayName) ? e.displayName : (Ie.fun(e) && e.name) || null,
    ...
    _n = class extends Rt {
      ...
      interpolate(...e) {
        return (
          Wt(`${Ut}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          De.to(this, e)
        );
      }
      toJSON() {
  ...
  var wn = class extends _n {
    ...
    _attach() {
      ...
      (Oe(Ue(this.source), (t) => {
        (Ft(t) && Tt(t, this),
          gn(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
    ...
    eventObserved(e) {
      "change" == e.type
        ...
        : "idle" == e.type
          ...
          : "priority" == e.type &&
            (this.priority = Ue(this.source).reduce(
  ...
  var Rn = /^(matrix|translate|scale|rotate|skew)/,
    ...
    An = (e, t) =>
      Ie.arr(e) ? e.every((e) => An(e, t)) : Ie.num(e) ? e === t : parseFloat(e) === t,
    Vn = class extends an {
  ...
  function Hn({
    ...
    const a = r.useRef({ status: In, resId: e, timeoutId: 0 }),
      [l, c] = r.useMemo(() => {
        ...
        function c() {
          ((a.current.status = On), Z.tooltip.open(e, t, n, o), r && Bn.set(r, d));
        }
        function u() {
          if (
            (window.clearTimeout(a.current.timeoutId),
            ...
            for (; e && !Bn.has(e);) e = e.parentElement;
            if (e) {
              Bn.get(e).show();
            }
            r = null;
    ...
    [Br, Dr] = (
      ...
      ({ observableModel: e }) => {
        const t = {
          ...
          r = ur.shallow(() =>
            oe(t.unlockedModules.get(), (e) => ({ ...e, moduleTypeName: Pr[e.itemTypeName] })).sort(
              (e, t) =>
                e.price.value !== t.price.value
                  ? e.price.value - t.price.value
                  : e.userName.localeCompare(t.userName),
    ...
    ss = r.forwardRef(function (
      ...
      return e.jsxs(ns, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: j(rs.content, i && rs.content__fontAligned, a?.content),
            children: t,
          }),
        ],
      });
  ...
  const os = "Action_6c7b0c76",
    ...
    as = r.forwardRef(function (
      { className: t, theme: n = ss.themes.secondary, tooltipParams: r, ...s },
      o,
    ) {
    ...
    Ts = r.forwardRef((t, n) => {
      ...
      if (a) {
        ...
        return e.jsx($s, {
          ...o,
          ref: n,
          children: r.isValidElement(t) ? r.cloneElement(t, void 0, s) : null,
        });
      }
  ...
  function Ws({
    ...
    return e.jsxs(Us, {
      ...
      children: [
        p && e.jsx(zr, { width: u, height: u, path: o ?? m, className: s?.icon }),
        qs(t, n),
      ],
    });
  }
  ((Ws.sizes = Is), (Ws.types = Bs));
    ...
    return t < 1 || "undefined" === r
      ...
      : e.jsxs("div", {
          ...
          children: [
            ...
            r !== Js &&
              e.jsx("div", {
                className: j(ro.level, ro[`level__${to(t)}`], o?.level),
                children: t,
              }),
          ],
        });
    ...
    mo = {
      ...
      [`${co}_x24x24`]: (e) =>
        h.createElement(
          ...
          h.createElement("path", { d: "M10 4V9L11.5 10.5L13 9V4H10Z", fill: "#FFB34D" }),
          h.createElement("path", { d: "M10 21V16L11.5 14.5L13 16V21H10Z", fill: "#FFB34D" }),
          h.createElement("path", { d: "M8 14H3V11H8L9.5 12.5L8 14Z", fill: "#FFB34D" }),
          h.createElement("path", { d: "M20 14H15L13.5 12.5L15 11H20V14Z", fill: "#FFB34D" }),
        ),
      [`${uo}_x24x24`]: (e) =>
        h.createElement(
          "svg",
  ...
  const vo = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
    ...
    Co = r.forwardRef(function (
      { type: t, size: n = vo.x48x48, premium: r = !1, fit: s = "contain", ...o },
      a,
    ) {
  ...
  const Fo = "Module_90bedba7",
    ...
    Po = { x120x96: "x120x96", x190x152: "x190x152", x380x304: "x380x304" },
    Bo = Jr("VehicleImage", {
      element: zr,
      className: So.base,
      cva: {
        variants: {
          size: {
            [Po.x120x96]: So.base__x120x96,
            [Po.x190x152]: So.base__x190x152,
            [Po.x380x304]: So.base__x380x304,
          },
        },
      },
    });
  function Do({ size: t = Po.x380x304, ...n }) {
    return e.jsx(Bo, { ...n, size: t, path: `vehicle.${t}.tank_empty` });
  }
  const Io = r.forwardRef(function (
    { size: t = Po.x380x304, name: n, width: r, height: s, className: o, ...i },
    a,
  ) {
  ...
  ((Io.UnknownVehicleImage = Do), (Io.size = Po));
  ...
  const li = a.observer(function ({
    currency: t,
    avgBattlesTillUnlock: n = 0,
    vehicleId: r = 0,
    children: s,
  }) {
    const { controls: o } = Dr(),
  ...
  function ui(t) {
    ...
    return e.jsx("div", {
      ...n,
      children: e.jsx(li, { currency: t.price.value, children: e.jsx(Vo, { ...t }) }),
    });
  }
      ...
      render(t) {
        return e.jsx(e.Fragment, {
          children: this.items.reduceRight(
            (e, [t, n], s) => r.createElement(t, { ...n, key: s }, e),
            t,
          ),
        });
      }
    })()
      .addWithProps(Br, { options: mi })
      .addWithProps(
        function (t) {
          return e.jsx(Sr, {
            children: e.jsx(Jn, {
