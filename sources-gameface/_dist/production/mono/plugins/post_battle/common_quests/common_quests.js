...
!(function (e, t) {
  ...
  function Le() {
    ...
    (t && (ze(Ae.splice(0, t), (e) => e.handler()), (De -= t)),
      De
        ? (ke.flush(),
          Ce.flush(e ? Math.min(64, je - e) : 16.667),
          Se.flush(),
          Pe.flush(),
          Ne.flush())
        : (je = -1));
      ...
      return s.forwardRef((r, o) => {
        ...
        (ln(
          () => (
            ...
            () => {
              f.current &&
                (We(f.current.deps, (e) => Vt(e, f.current)), Te.cancel(f.current.update));
            }
          ),
        ),
          s.useEffect(d, []),
  ...
  var Pn = Symbol.for("AnimatedComponent"),
    kn = (e) =>
      He.str(e) ? e : e && He.str(e.displayName) ? e.displayName : (He.fun(e) && e.name) || null;
  function Sn(e, ...t) {
  ...
  function $n(e) {
    return (
      ...
      He.arr(e)
        ? e.map($n)
        : an(e)
          ? Ve.createStringInterpolator({ range: [0, 1], output: [e, e] })(1)
          : e
    );
  }
  function Fn(e) {
  ...
  var ts = class extends Error {
    ...
    os = class extends Ut {
      ...
      interpolate(...e) {
        return (
          rn(`${nn}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          Ve.to(this, e)
        );
      }
      toJSON() {
  ...
  function Ts(e, t) {
    ...
    return (
      t &&
        We(Xe(t), (e) => {
          (He.und(e.keys) && (e = hs(e)),
            He.obj(e.to) || (e = { ...e, to: void 0 }),
            Ss(n, e, (e) => ks(e)));
        }),
      Ps(e, n),
      n
  ...
  function Fs(e, t, n) {
    ...
    if (
      ...
      We(h, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new Es() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
  ...
  var Us = class extends os {
    ...
    _attach() {
      ...
      (We(Xe(this.source), (t) => {
        (Bt(t) && qt(t, this),
          ss(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
        ...
        : "idle" == e.type
          ...
          : "priority" == e.type &&
            (this.priority = Xe(this.source).reduce(
              (e, t) => Math.max(e, (ss(t) ? t.priority : 0) + 1),
              0,
            ));
    }
  };
  ...
  var Xs = /^(matrix|translate|scale|rotate|skew)/,
    ...
    er = (e, t) =>
      He.arr(e) ? e.every((e) => er(e, t)) : He.num(e) ? e === t : parseFloat(e) === t,
    tr = class extends wn {
  ...
  function qr(e) {
    return {
      ...
      "~run"(e, t) {
        return (
          "number" != typeof e.value || isNaN(e.value) ? Mr(this, "type", e, t) : (e.typed = !0),
          e
        );
      },
    };
    ...
    return {
      ...
      "~run"(e, t) {
        return void 0 === e.value &&
          (void 0 !== this.default && (e.value = $r(this, e, t)), void 0 === e.value)
          ? ((e.typed = !0), e)
  ...
  function Xr({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r }) {
    if ("items" in e)
      return {
        ...
        groups: ce(e.items, (e) =>
          Xr({ model: e, indexer: t, resolveIcon: n, commonIcon: s, guiDisabled: r }),
        ),
      };
    var o;
    const i = {
    ...
    To = s.forwardRef(function (
      ...
      return e.jsxs(Ro, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: S(Co.content, i && Co.content__fontAligned, a?.content),
            children: t,
          }),
        ],
      });
  ...
  const Po = "Action_6c7b0c76",
    ...
    So = s.forwardRef(function (
      { className: t, theme: n = To.themes.secondary, tooltipParams: s, ...r },
      o,
    ) {
      ...
      children: [
        e.jsxs(Lo.Header, {
          ...
          children: [
            ...
            e.jsx("div", {
              className: S(Ti.tail, u?.tail),
              children: void 0 !== l && e.jsx(Ri, { ...l }),
            }),
          ],
        }),
  ...
  function Mi({
    ...
    return {
      ...
      to: { width: t },
      config: o ?? {
        duration: (n === Oi.simple && s) || (!s && r) ? 0 : ji,
        easing: jt.easeInOutCubic,
      },
    };
  }
  const ji = 600,
      ...
      e.jsx("div", {
        ...
        children: e.jsx(mo, {
          className: S(
            ...
            0 === s.percentage
              ? Gi.backgroundPattern__noProgress
              : Gi[`backgroundPattern__${s.size}`],
          ),
          repeat: "repeat",
          position: "left top",
          path:
  ...
  const va = {
    ...
    wa = yo("ProgressBar", va.base, {
      variants: { size: { medium: va.base__medium, large: va.base__large } },
    }),
    xa = function ({
      size: t = Bi.medium,
      backgroundPattern: n,
  ...
  const La = {
    ...
    Root: function ({ condition: t, ...n }) {
      return e.jsx(Ma.Provider, {
        ...
        children: e.jsx("div", {
          ...n,
          className: S(Ba.content, t.completed && Ba.content__completed),
        }),
      });
    },
    ...
    Title: function ({ questsAmount: t }) {
      const { title: n, icon: s, completed: r, progression: o, hideTitle: i } = ja(),
        { completed: a } = Oa();
        ...
        children: [
          void 0 !== l &&
            e.jsx("div", {
              ...
              className: S(Ba.titleIcon, l.default.isGold && Ba.titleIcon__gold),
            }),
    ...
    bl = s.memo(function ({
      ...
      const p = m.resolve("strings"),
        ...
        g =
          ...
          })(ci(p.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (o || 0),
          });
      return e.jsx("div", {
  ...
  function Ol({ value: t, questType: n, className: s }) {
    return t
      ? e.jsx("div", {
          className: S(
            Ba.iconImage,
            Ba.iconImage__regular,
            n === Dl.PREMIUM && Ba.iconImage__gold,
            s,
          ),
      ...
      : "union" === t.type
        ...
        : "or" === t.type
          ? e.jsxs("div", {
              ...
              children: [
                e.jsx(Bl, { width: 16, height: 16, className: Ba.invertedArrow }),
                $l.readOrEmpty("battle_results.conditions.type.or"),
                e.jsx(Bl, { width: 16, height: 16, className: Ba.arrow }),
              ],
            })
          : e.jsx("div", {
  ...
  ((Wl.Content = La), (Wl.Groups = Ql), (Wl.Separators = Ll));
        ...
        children: ce(r.model.quests(), (i) => {
          ...
          return e.jsx(
            Wl,
            {
              ...
              actionTooltipParams: {
                body: Yl.readOrEmpty("battle_results.progression.linkBtn.info"),
              },
  ...
  const tc = {
      rootId: m.resolve("aliases").read((e) => e.battle_results.progression.CommonQuests("resId")),
    },
    nc = new (class {
      items = [];
      add(e) {
  ...
  function oc({ animation: t, immediateAnimation: n }) {
    return nc.render(
      e.jsx(Xl, { target: "mission-progress:common-quests", animation: t, immediateAnimation: n }),
    );
  }
  exports.plugin =
    ((rc = async ({ url: t }) => {
