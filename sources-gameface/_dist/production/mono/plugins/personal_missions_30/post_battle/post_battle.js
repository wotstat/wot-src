...
!(function (e, t) {
  ...
  function ie(e, t, n) {
    return "function" == typeof t
      ? ae(0, e, t)
      : (oe(void 0 !== n, "fn must be defined"), ae(e, t, n));
  }
  function ae(e, t, n) {
  ...
  function Me() {
    ...
    (t && (De(Pe.splice(0, t), (e) => e.handler()), (Ae -= t)),
      Ae
        ? (xe.flush(),
          ye.flush(e ? Math.min(64, ke - e) : 16.667),
          Ee.flush(),
          we.flush(),
          Re.flush())
        : (ke = -1));
  ...
  var on = Symbol.for("Animated:node"),
    ...
    mn = class extends dn {
      ...
      reset(e) {
        (e && (this._toString = Tt({ output: [this.getValue(), e] })),
          (this._value = 0),
          super.reset());
      }
    },
      ...
      return s.forwardRef((r, o) => {
        ...
        (en(
          () => (
            ...
            () => {
              f.current &&
                (ze(f.current.deps, (e) => Bt(e, f.current)), ve.cancel(f.current.update));
            }
          ),
        ),
          s.useEffect(m, []),
  ...
  var vn = Symbol.for("AnimatedComponent"),
    wn = (e) =>
      Fe.str(e) ? e : e && Fe.str(e.displayName) ? e.displayName : (Fe.fun(e) && e.name) || null;
  function xn(e, ...t) {
  ...
  var Wn = class extends Error {
    ...
    Kn = class extends Mt {
      ...
      interpolate(...e) {
        return (
          Zt(`${Yt}The "interpolate" function is deprecated in v9 (use "to" instead)`),
          Le.to(this, e)
        );
      }
      toJSON() {
  ...
  function ys(e, t) {
    ...
    return (
      t &&
        ze(Ge(t), (e) => {
          (Fe.und(e.keys) && (e = ls(e)),
            Fe.obj(e.to) || (e = { ...e, to: void 0 }),
            xs(n, e, (e) => ws(e)));
        }),
      vs(e, n),
      n
  ...
  function Is(e, t, n) {
    ...
    if (
      ...
      ze(p, (e, t) => {
        g[t] ||
          ((g[t] = { key: y[t], item: e, phase: "mount", ctrl: new gs() }), (g[t].ctrl.item = e));
      }),
      w.length)
    ) {
      let e = -1;
  ...
  var Ms = class extends Kn {
    ...
    _attach() {
      ...
      (ze(Ge(this.source), (t) => {
        (Nt(t) && Dt(t, this),
          Xn(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1))));
      }),
        (this.priority = e),
        this._start());
    }
    ...
    eventObserved(e) {
      "change" == e.type
        ...
        : "idle" == e.type
          ? this._active.delete(e.parent)
          : "priority" == e.type &&
            (this.priority = Ge(this.source).reduce(
              (e, t) => Math.max(e, (Xn(t) ? t.priority : 0) + 1),
              0,
            ));
    }
  };
  ...
  var qs = /^(matrix|translate|scale|rotate|skew)/,
    ...
    Qs = (e, t) =>
      Fe.arr(e) ? e.every((e) => Qs(e, t)) : Fe.num(e) ? e === t : parseFloat(e) === t,
    Ws = class extends fn {
    ...
    ko = s.memo(function ({
      ...
      const h = u.resolve("strings"),
        ...
        g =
          ...
          })(_o(h.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (o || 0),
          });
      return e.jsx("div", {
    ...
    hi = {
      ...
      return e.jsxs(mi, {
        ...
        children: [
          ...
          e.jsx("div", {
            className: S(hi.content, i && hi.content__fontAligned, a?.content),
            children: t,
          }),
        ],
      });
  ...
  const pi = "Action_6c7b0c76",
    ...
    _i = s.forwardRef(function (
      { className: t, theme: n = fi.themes.secondary, tooltipParams: s, ...r },
      o,
    ) {
  ...
  var Vi = ((e) => ((e.ASSAULT = "assault"), (e.SNIPER = "sniper"), (e.SUPPORT = "support"), e))(
    Vi || {},
  );
  const Qi = {
      icon: "",
    ...
    Zi = [
      { ...Qi, name: "xpFactor", label: "Коэффициент боевого опыта", value: "3.0" },
      Xi,
      Yi,
      Wi,
    ],
        ...
        children: [
          e.jsx(Di, {
            ...
            transitionCurrent: {
              ref: i,
              immediate: l,
              enter: { onRest: () => o && u("labelCheckmark") },
            },
          }),
          e.jsx("div", {
            ...m,
  ...
  const Ia = "PersonalMissions_43fb0d20",
    ...
    Xa = a.observer(function () {
      ...
      return e.jsx(Li, {
        ...
        actionTooltipParams: {
          body: Va.readOrEmpty("personal_missions_30.plugin.post_battle.openButton"),
        },
        classNames: { head: Ma },
        children: e.jsxs("div", {
          className: S(Ia, h && Da),
              ...
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsx(ii.Label, {
                      className: La,
                      children: Va.readOrEmpty("personal_missions_30.plugin.post_battle.condition"),
                    }),
                    h && e.jsx(Sa, {}),
                  ],
                }),
