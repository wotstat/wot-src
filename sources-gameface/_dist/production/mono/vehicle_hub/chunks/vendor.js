...
var _ = (function () {
  ...
  b = function (t, e) {
    var n,
      ...
      h =
        ...
        a(c, { x: r, y: i, width: o, height: s, top: i, right: r + o, bottom: s + i, left: r }),
        c);
    a(this, { target: t, contentRect: h });
  },
  m = (function () {
    function e(e, n, r) {
    ...
    return (
      (e.prototype.observe = function (t) {
        ...
        if ("undefined" != typeof Element && Element instanceof Object) {
          ...
          e.has(t) ||
            (e.set(t, new _(t)), this.controller_.addObserver(this), this.controller_.refresh());
        }
      }),
  ...
  g = function t(e) {
    ...
    if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
    var n = new m(e, s.getInstance(), this);
    y.set(this, n);
  };
