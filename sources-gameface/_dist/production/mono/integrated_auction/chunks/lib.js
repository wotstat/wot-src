...
const K = X("clientResized"),
  ...
  J = X("clientMinimized"),
  Q = { down: X("mousedown"), up: X("mouseup"), move: X("mousemove") };
!(function () {
  ...
  Se = () => {
    ...
    return (function (e, t, n) {
      const r = _e.reduce(
        ...
        c = u[u.length - 1] ?? fe,
        l = d[d.length - 1] ?? fe,
        h = { width: me[c].width, height: me[l].height };
      return {
        mediaClass: xe(o, r),
        breakpoint: a,
        screenWidthRem: e,
...
function Re({ children: e }) {
  ...
  return (
    ...
    i.jsx(he.Provider, { value: t, children: e })
  );
}
function Te() {
  return (function () {
    const e = o.useContext(he);
...
function Pe({ children: e, className: t, ...n }) {
  ...
  return i.jsx("div", {
    className: s(t, "media-wrapper", r, o && "media-upscale"),
    ...n,
    children: e,
  });
}
function De({ children: e, ...t }) {
  return i.jsx(Re, { children: i.jsx(Pe, { ...t, children: e }) });
}
const Me = [];
const ke = () => {
    const e = new Map();
...
function je(e, { shallow: t = !0, depth: n = 0, maxDepth: r = 32 } = {}) {
  ...
  if (Ce.has(i)) return o;
  if (null === o) return o;
  const s = { depth: n + 1, maxDepth: r };
  if (Array.isArray(o)) return o.map((e) => je(e, s));
  if ("object" === i) {
    const r = o.constructor?.name ?? "UNKNOWN";
    if (Array.isArray(e)) return e.map((e) => je(e, s));
    if ("CoherentArrayProxy" === r) return e.map((e) => je(e.value, s));
    if ("Dict" === r) return;
    if ("UNKNOWN" === r) return;
    ...
    const i = {};
    for (const e of Object.keys(o)) i[e] = je(o[e], s);
    return i;
  }
...
class Ve {
  constructor(e, t = Ae) {
    ...
    for (let o = 0; o < r.length; o++) {
      const t = r[o];
      n[t] = a.box(this.takeItem(e, t), $e);
    }
    ((this._keys = a.set(new Set(r))), (this._data = a.box(n, $e)));
  }
  _data;
  _keys;
  get keys() {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      o in n
        ? null === i
          ...
          : n[o].set(i)
        : null !== i && ((n[o] = a.box(i, $e)), this._keys.add(o), this.set(n));
    }
  }
  entries() {
...
async function We(
  ...
  (o && engine.enableImmediateLayout(!0),
    ...
    l.createRoot(t).render(i.jsx(s, { children: i.jsx(Ne, { children: e }) })),
    r &&
      (!(function (e) {
        function t() {
...
const lt = Object.keys(et).reduce(
    (e, t) => ((e[t] = () => viewEnv.getShowingStatus() === et[t]), e),
    {},
  ),
  ht = {
    set: (e, t) => {
...
const mt = {
  ...
  wt = c.forwardRef(function ({ children: e, className: t, theme: n = "default", ...r }, s) {
    ...
    return (
      ...
      i.jsx("div", {
        ...r,
        className: h(pt.base, pt[`base__theme-${n}`], t),
        ref: function (e) {
          ((a.current = e), "function" == typeof s ? s(e) : s && (s.current = e));
        },
        children: i.jsx("div", { className: pt.decorator, children: e }),
      })
    );
  }),
  gt = {
  ...
  vt = { x16x16: "x16x16", x24x24: "x24x24", x32x32: "x32x32", x48x48: "x48x48", x80x80: "x80x80" },
  yt = { accent: "accent", cooldown: "cooldown" },
  bt = {
...
function _t({ size: e, preFormatted: t }) {
  const n = [];
  for (let r = 0; r < t.items.length; ++r)
    (t.separator &&
      ...
      n.push(
        i.jsx(
          "span",
          { className: h(bt.detailedSeparator, bt[`detailedSeparator__${e}`]) },
          "separator",
        ),
      ),
      n.push(
        i.jsx(
          "span",
          {
            className: h(bt.item, bt[`item__${e}`]),
            children: t.items[r]
              ?.split(" ")
              .map((t, n) =>
                i.jsx(
                  "span",
                  { className: h(bt.part, bt[`part__${e}`]), children: t },
                  `part_${n}`,
                ),
              ),
          },
...
const xt = f.resolve("strings"),
  ...
  Tt = {
    [gt.compact]: [Et, St, Rt],
    [gt.default]: [Et, St, Rt],
    [gt.detailed]: [Et, "hh", "mm", "ss"],
  },
  Pt = {
    [gt.compact]: function (e, t) {
      const n = e.length,
        r = Tt[t],
        o = { separator: !1, items: [] };
      for (let i = 0; i < n; ++i) if (Number(e[i]) > 0) return ((o.items = [Dt[r[i]]?.(e[i])]), o);
      return ((o.items = [Dt[Rt]?.(1)]), o);
    },
    [gt.default]: function (e, t) {
      let n = 0;
      const r = e.length - 1,
        o = Tt[t],
        i = { separator: !1, items: [] };
      ...
      o[n] === Rt && 0 === Number(e[n])
        ? (i.items = [Dt[Rt]?.(1)])
        : (i.items = [n, n + 1].map((t) => Dt[o[t]]?.(e[t])));
      return i;
    },
    [gt.detailed]: function (e) {
      const [t, ...n] = e,
        r = n.join(":");
      return { separator: !0, items: Number(t) > 0 ? [Dt[Et]?.(t), r] : [r] };
    },
  },
  Dt = {
    [Et]: (e) =>
      q(
        xt.readOr("common.timer.days", () => Et.toLowerCase()),
        { days: e },
      ),
    [St]: (e) =>
      q(
        xt.readOr("common.timer.hours", () => St),
        { hours: e },
      ),
    [Rt]: (e) =>
      q(
        xt.readOr("common.timer.minutes", () => Rt),
        { minutes: e },
      ),
  };
const Mt = (e, t) =>
...
function Ot({
  ...
  const [l] = (function (e) {
    const { type: t, tick: n, limit: r } = e,
      ...
      s = e.start ?? N,
      a = V(n),
      [u, d] = o.useState({ current: s, running: i }),
      c = o.useRef(0),
      l = o.useRef(null);
    o.useEffect(() => {
      const e = (e) => {
        d((o) => {
          ...
          const i = "countdown" === t ? U(o.current, e) : B(o.current, e),
            s = { ...o, current: i };
          return (
            k(r) &&
              ("countdown" === t
                ? H(U(i, n), r) && ((s.current = r), (s.running = !1))
                : I(B(i, n), r) && ((s.current = r), (s.running = !1))),
            s
          );
        });
      };
      c.current = window.setInterval(() => {
        u.running ? e(n) : window.clearInterval(c.current);
      }, a);
      const o = J((t) => {
        if (t) l.current = Date.now();
        else {
          if (null === l.current) return;
          const t = Date.now() - l.current,
            n = Math.floor(t / a),
            r = O(n * a);
          (n > 0 && e(r), (l.current = null));
        }
      });
      return () => {
        (window.clearInterval(c.current), o());
      };
    }, [r, n, a, u.running, t]);
    const h = o.useMemo(
      () => ({
        start: () => d((e) => ({ ...e, running: !0 })),
        stop: () => d((e) => ({ ...e, running: !1 })),
        isRunning: () => u.running,
      }),
      [u.running],
    );
    ...
    children: [
      ...
      a !== gt.superCompact &&
        i.jsx("div", {
          ...
          children: i.jsx(_t, { size: r, preFormatted: Mt(l, a) }),
        }),
    ],
  });
}
((Ot.format = gt), (Ot.size = vt), (Ot.type = yt));
export { Ot as T, We as a, wt as b, He as i, se as n, f as r };
