...
function st(e, t, n) {
  return "function" == typeof t
    ? ot(0, e, t)
    : (rt(void 0 !== n, "fn must be defined"), ot(e, t, n));
}
function ot(e, t, n) {
...
function Dt({ children: e, className: t, ...n }) {
  ...
  return c.jsx("div", {
    className: u(t, "media-wrapper", r, s && "media-upscale"),
    ...n,
    children: e,
  });
}
  ...
  render(e) {
    return c.jsx(c.Fragment, {
      children: this.items.reduceRight(
        (e, [t, n], r) => i.createElement(t, { ...n, key: r }, e),
        e,
      ),
    });
  }
...
const Lr = Or(
  ...
  Kr = i.forwardRef(function (
    { type: e, size: t = $r.x48x48, premium: n = !1, fit: r = "contain", ...s },
    o,
  ) {
    const a = Ft($r[t], Hr[t]);
    return c.jsx(Lr, {
...
$.resolve("intl");
const Gr = {
    Root: qn("Bubble", "Bubble_df22310d", {
...
const Jr = "HorizontalTabs_outerBorderImage_8085e49e",
  ...
  cs = qn("Tabs", "HorizontalTabs_69e3c6f3", {
    variants: {
      size: { [Xr.large]: rs, [Xr.medium]: ns, [Xr.small]: ts },
      theme: { [Yr]: os, [qr]: void 0 },
    },
  }),
...
i.memo(function ({ classNames: e = {}, onDrag: t = je }) {
  ...
  Bs({ baseRef: n, api: h });
  const p = Kt(
      (e, t, { parent: n }) => (e.screenX - t.offset - n.getBoundingClientRect().x) / n.offsetWidth,
    ),
  ...
  lo = i.memo(function ({ classNames: e = {}, onDrag: t = je }) {
    ...
    const p = Kt((e) => e - (o.current.offsetHeight - a.current.offsetHeight) >= -0.5),
      ...
      y = Kt(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
        ...
        if (!r || !s || !a) return;
        const i = Re(5);
        ((s.style.height = `${t - i + n}px`),
          (a.style.height = r.offsetHeight - e - t - i - n + "px"));
      }),
  ...
  bo = ({ className: e, classNames: t, children: n, ...r }) => {
    ...
    return (
      ...
      c.jsx("div", {
        ...
        children: c.jsx("div", {
          ...r,
          className: u(go.content, t?.content),
          ref: s.contentRef,
          children: n,
        }),
      })
...
function _o({ classNames: e, ...t }) {
  ...
  return c.jsx(bo, {
    ...
    classNames: {
      ...e,
      content: u(
        go[`content__${((o = r), (a = s), o || a ? (o ? (a ? po : mo) : fo) : ho)}`],
        e?.content,
      ),
    },
  });
...
N({ name: I(), state: P(Object.values(zo).map((e) => M(e))) });
  ...
  $o = i.forwardRef(function (
    ...
    return c.jsxs(Lo, {
      ...
      children: [
        ...
        c.jsx("div", {
          className: u(Fo.content, o && Fo.content__fontAligned, a?.content),
          children: e,
        }),
      ],
    });
      ...
      function s() {
        ...
        if (o === s) S(!1);
          ...
          const s =
            ...
            { x: (i = e.getBoundingClientRect()).x - a.x, y: i.y - a.y });
          for (
...
function ma({ keyCode: e, onActive: t, silent: n, soundTarget: r, idle: s, children: o }) {
  ...
  const a = i.useMemo(
    () => ({ keyCode: e, onActive: t, silent: n, soundTarget: r, idle: s }),
    [e, t, r, n, s],
  );
...
const $a = "TruncateText_dcb41d92",
  Ha = i.forwardRef(function ({ text: e, tooltipParams: t, className: n, ...r }, s) {
    const o = fn({ header: t?.header, body: t?.body || e }),
      ...
      f = i.useCallback(() => {
        a.current &&
          d(a.current.scrollWidth - Math.ceil(a.current.getBoundingClientRect().width) > 0);
      }, []);
    return (
      i.useEffect(() => {
        l || o.onMouseLeave();
...
const si = { default: "default", regular: "regular", medium: "medium", big: "big" },
  ...
  di = qn("StripeIcon", { element: Lr }),
    ...
    return n
      ? c.jsx(di, { ...i, ref: l, path: r, width: s, height: o, className: u(Ya.stripeBadge, a) })
      : null;
  }),
...
((_i.Name = function ({ size: e, className: t, children: n }) {
  ...
  (_i.ClanTag = function ({ size: e, className: t, children: n, ...r }) {
    return c.jsx("div", {
      ...r,
      className: u(Ya.clanTag, e && Ya[`clanTag__${e}`], t),
      children: n,
    });
  }),
  (_i.Badge = Qa),
...
const Ei = i.forwardRef(function (
  { size: e = wi.x380x304, name: t, width: n, height: r, className: s, ...o },
  a,
) {
