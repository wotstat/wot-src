...
/* empty css                    */ const U = "vehicleLevel",
  ...
  [Y, Z] = o("WinbackSelectableRewardViewModel")(
    ({ observableModel: a }) => {
      const t = e.box(""),
        i = {
          primitives: a.primitives(["totalRewardsCount", "selectedRewardsCount"]),
          categories: a.array("categories"),
          selectableRewards: a.array("selectableRewards"),
        },
        l = s(
          () => {
        ...
        c = s(() => r().length),
        n = s(() => c() < i.primitives.totalRewardsCount.get());
      return {
        ...i.primitives,
  ...
  ee = "ErrorScreen_6fa54c0f",
  se = "ErrorScreen_icon_5cfee7d",
  ae = "ErrorScreen_title_c5b4d9cb",
  te = "ErrorScreen_description_164c1cd6",
  ie = "ErrorScreen_button_4c0ae438",
  le = n.resolve("strings"),
  re = t(function () {
    const { controls: e } = Z();
    return i.jsxs("div", {
      className: ee,
      children: [
        i.jsx("div", { className: se }),
        i.jsx(w, { className: ae, path: "winback.winbackSelectableRewardView.error.title" }),
        i.jsx(w, { className: te, path: "winback.winbackSelectableRewardView.error.description" }),
        i.jsx(h, {
          mixClass: ie,
          onClick: e.close,
          children: le.readOrEmpty("winback.winbackSelectableRewardView.error.button"),
        }),
      ],
    });
  }),
  ce = "Footer_2bc55d13",
  ne = "Footer_infoIcon_fd977a0b",
  oe = "Footer_amountRewards_68a1b3f6",
  de = "Footer_text_af3f22d1",
  me = "Footer_text__active_ade58048",
  be = "Footer_actions_877c593c",
  _e = "Footer_button_c9561362",
  we = n.resolve("strings"),
  he = t(function ({ className: e }) {
    const { controls: s, model: a } = Z(),
      t = a.selectedRewardsCount.get();
    return i.jsxs("div", {
      className: l(ce, e),
      children: [
        t
          ? i.jsx(w, {
              ...
              params: {
                infoIcon: i.jsx(u, {
                  ...
                  children: i.jsx("div", { className: ne }),
                }),
                amountRewards: i.jsx("div", { className: oe, children: t }),
              },
              split: !0,
              className: l(de, Boolean(t) && me),
            })
          : i.jsx("div", {
              className: de,
              children: we.readOrEmpty(
        ...
        i.jsxs("div", {
          ...
          children: [
            i.jsx(h, {
              ...
              disabled: !t,
              onClick: s.confirm,
              children: we.readOrEmpty("winback.winbackSelectableRewardView.buttons.confirm"),
            }),
            i.jsx(h, {
              size: x.medium,
              mixClass: _e,
              type: p.secondary,
              onClick: s.close,
              children: we.readOrEmpty("winback.winbackSelectableRewardView.buttons.cancel"),
            }),
          ],
        }),
      ],
  ...
  ue = "Tab_cb313e6e",
  pe = "Tab_title_4526d246",
  xe = "Tab_base__selected_0",
  ve = "Tab_vehicle_f3b75eea",
  fe = "Tab_base__hasSelectedRewards_0",
  je = "Tab_discount_e3d3f89d",
  ge = "Tab_vehicleLevel_7db1ed59",
  Ne = "Tab_check_4150e2cc",
  Se = "Tab_counterContainer_c3887ea6",
  ke = "Tab_counter_583b02dd",
  ye = "Tab_glow_69e84f94";
function Re({ isDiscount: e, isSelected: s, vehicleLevel: a, rewardsSelected: t, onClick: r }) {
  const c = t > 0,
    n = v(a);
  return i.jsxs("div", {
    onClick: () => {
    ...
    onMouseEnter: () => f("highlight"),
    className: l(ue, s && xe, c && fe),
    children: [
      e
        ? i.jsx(w, { className: pe, path: "winback.winbackSelectableRewardView.category.title" })
        : i.jsx(w, {
            className: pe,
            path: "winback.winbackSelectableRewardView.category.titleDiscount",
            params: { vehicleLevel: n },
          }),
      i.jsx("div", { className: ve }),
      i.jsx("div", { className: ge, children: n }),
      e && i.jsx("div", { className: je }),
      i.jsx("div", { className: Ne }),
      i.jsxs("div", {
        className: Se,
        children: [
          i.jsx(w, {
...
const Ce = "Categories_f4d88e4e",
  ...
  Pe = "SearchDetails_glow_e7fb29b2",
  Be = "SearchDetails_glow__shown_4d2a544d",
        ...
        t &&
          i.jsx(g, {
            ...
            children: i.jsxs("div", {
              className: Le,
              onClick: () => {
                (f("play"), s.resetFilter());
              },
              onMouseEnter: () => f("highlight"),
              children: [i.jsx("div", { className: Oe }), i.jsx("div", { className: $e })],
            }),
          }),
      ],
    });
  ...
  Ze = "Title_f914446f",
  es = "Title_4557be8d",
  ss = "Title_additionTitle_33baf030",
  as = n.resolve("strings");
function ts({ className: e }) {
  return i.jsxs("div", {
    ...
    children: [
      i.jsx("div", {
        className: ss,
        children: as.readOrEmpty("winback.winbackSelectableRewardView.title.additionText"),
      }),
      i.jsx("div", {
        className: es,
        children: as.readOrEmpty("winback.winbackSelectableRewardView.title.text"),
      }),
    ],
  });
}
const is = "Header_71860ac",
  ls = "Header_title_d5112efd",
  rs = "Header_categories_64d8d133";
function cs() {
  return i.jsxs("div", {
    className: is,
...
const os = "Card_dcd42ca2",
  ds = "Card_base__active_ed8b6279",
  ...
  _s = t(function ({ children: e, isSelected: s, index: a }) {
    const { controls: t } = Z(),
      {
        breakpoint: { weight: r },
      } = E();
    return i.jsx("div", {
      ...
      onClick: () => {
        (f("play"), t.selectReward(a));
      },
      onMouseEnter: () => f("highlight"),
      children: e,
    });
  }),
  ws = "BluePrintReward_bluePrintIcon_40ce3690",
  hs = "BluePrintReward_nationText_57b2ba50",
  us = "BluePrintReward_hangarInformation_52e3336c",
  ps = "BluePrintReward_hangarIcon_9428b075",
  xs = "BluePrintReward_countInHangar_cc31c0f0",
  vs = "BluePrintReward_count_471c0ddb",
  fs = n.resolve("strings");
function js({
  tooltipId: e,
  tooltipContentId: s,
  icon: a,
  ...
  return i.jsx(j, {
    ...
    children: i.jsxs(_s, {
      ...
      index: c,
      children: [
        i.jsx("div", { className: ws, style: { backgroundImage: `url(${n})` } }),
        i.jsx("div", { className: hs, children: fs.readOrEmpty(`blueprints.nations.${a}`) }),
        Boolean(t) &&
          i.jsxs("div", {
            className: us,
            children: [
              i.jsx("div", { className: ps }),
              i.jsx("div", { className: xs, children: t }),
            ],
          }),
        i.jsx(w, {
...
const gs = "Discount_contentTitle_aabc06c6",
  Ns = "Discount_vehicleName_593705d2",
  Ss = "Discount_columns_dd37923e",
  ks = "Discount_column_4474715f",
...
const Ts = "ForGift_8de3d134",
  Ds = "ForGift_vehicleName_bea2b226",
  As = n.resolve("strings");
function Ps({ vehicle: e, className: s }) {
  return i.jsx("div", {
    className: l(Ts, s),
    children: i.jsx(w, {
      path: "winback.winbackSelectableRewardView.vehicleName",
...
const Bs = "VehicleReward_nationImage_fd71a755",
  Ls = "VehicleReward_vehicleImage_404db75c";
function Os({
  children: e,
  tooltipId: s,
  tooltipContentId: a,
  ...
  return i.jsx(j, {
    ...
    children: i.jsxs(_s, {
      ...
      index: r,
      children: [
        i.jsx("div", { className: Bs, style: { backgroundImage: `url(${n})` } }),
        i.jsx("div", { className: Ls, style: { backgroundImage: `url(${c})` } }),
        e,
      ],
    }),
  });
...
const $s = "Cards_9470dddc",
  ...
  Ws = t(
    r.forwardRef(function ({ className: e }, s) {
      const { model: a } = Z(),
        { isDiscount: t, isCompensation: r } = a.computes.selectedCategory(),
        c = a.computes.selectableRewards();
      return i.jsx("div", {
        className: l($s, e),
        ref: s,
        children: c.map((e) => {
          if (r) {
            ...
            return i.jsx(
              js,
              { ...s, isSelected: s.isSelected, index: s.index },
              `${e.name}_${e.index}`,
            );
          }
          {
  ...
  Zs = "ScrollableCards_cefbdf39",
  ea = "ScrollableCards_shadow_cae4b9f5",
  sa = "ScrollableCards_shadow__visible_d6b82f2",
  aa = "ScrollableCards_shadow__top_d356f13f",
  ta = "ScrollableCards_shadow__bottom_19ddd9b2",
  ia = "ScrollableCards_noFilteredVehicles_53905af9",
  la = "ScrollableCards_cards_5afe2eb9",
  ra = "ScrollableCards_scrollBar_6694810f",
  ca = "ScrollableCards_barThumb_ec5fb105",
  na = "ScrollableCards_barRail_a535aa69",
  oa = [ns.Start, ns.WithoutScroll],
  da = [ns.End, ns.WithoutScroll],
  ma = t(function () {
    const { model: e, controls: s } = Z(),
      a = B(),
        ...
        const { animationScroll: a, getContainerSize: t, getWrapperSize: i, events: l } = e,
          ...
          o = r.useCallback(() => {
            const e = a.scrollPosition.get(),
              s = t(),
              l = i();
            n(!s || !l || s <= l ? 0 : e <= 10 ? 1 : e >= s - l - 10 ? 3 : 2);
          }, [a.scrollPosition, t, i]);
        return (
          r.useEffect(() => (l.on("change", o), () => l.off("change", o)), [l, o]),
          r.useEffect(() => C(o), [o, ...s]),
          c
        );
      })(a, [t, n, o]),
    ...
    return (
        ...
        const s = c(
          ...
          () => {
            ...
            b.run(() => {
              if (m.current)
                if (void 0 !== s) {
                  const e = m.current.children[s];
                  e instanceof HTMLElement &&
                    ((e) => {
                      const s = a.wrapperRef.current;
                      if (s) {
                        const t = e.offsetTop + (e.offsetHeight - s.offsetHeight);
                        a.applyScroll(t);
                      }
                    })(e);
                } else a.applyScroll(0, { immediate: !0 });
            });
          },
        );
        return () => {
      ...
      i.jsxs("div", {
        className: Zs,
        children: [
          i.jsx("div", { className: l(ea, aa, _ && sa) }),
          0 === t
            ? i.jsx(Ys, { className: ia })
            : i.jsxs(i.Fragment, {
                children: [
                  i.jsx($.Vertical.Area, {
                    api: a,
                    children: i.jsx(Ws, { className: la, ref: m }),
                  }),
                  i.jsx($.Vertical.Bar, { api: a, classNames: { base: ra, thumb: ca, rail: na } }),
                ],
              }),
          i.jsx("div", { className: l(ea, ta, w && sa) }),
        ],
      })
    );
  }),
  ba = "App_9ac57ea8",
  _a = "App_base__error_6a777ff1",
  wa = "App_base__hidden_1de0b422",
  ha = "App_closeButton_f5179698",
  ua = "App_container_913d6f7c",
  pa = "App_footer_2e9c7b89",
  xa = n.resolve("strings"),
  va = [R.images.gui.maps.icons.winback.selectableRewardView.background()],
  fa = t(() => {
    const { model: e, controls: s } = Z(),
      a = 0 === e.categories.get().length;
    O(s.close);
    const t = W(va) !== G.Pending;
    return i.jsx("div", {
      className: l(ba, a && _a, !t && wa),
      children:
        t &&
        i.jsxs(i.Fragment, {
          children: [
            ...
            a
              ...
              : i.jsxs("div", {
                  className: ua,
                  children: [i.jsx(cs, {}), i.jsx(ma, {}), i.jsx(he, { className: pa })],
                }),
          ],
        }),
    });
