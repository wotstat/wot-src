var __knownSymbol = (e, t) => ((t = Symbol[e]) ? t : Symbol.for("Symbol." + e)),
  ...
  __using = (e, t, n) => {
    ...
    null != t
      ? ("object" != typeof t && "function" != typeof t && __typeError("Object expected"),
        n && (s = t[__knownSymbol("asyncDispose")]),
        void 0 === s && ((s = t[__knownSymbol("dispose")]), n && (r = s)),
        "function" != typeof s && __typeError("Object not disposable"),
        r &&
          (s = function () {
            try {
              r.call(this);
  ...
  __callDispose = (e, t, n) => {
    var s =
      ...
      r = (e) => (t = n ? new s(e, t, "An error was suppressed during disposal") : ((n = !0), e)),
      o = (s) => {
        for (; (s = e.pop());)
          try {
...
class ImagesRClassProvider {
  ...
  readOr(e, t, n = "silent") {
    const s = e.startsWith("R.images") ? e : concatWithPath(this.prefix, e),
      r = readFromR$2(e.startsWith("R.images") ? window : this.root, s);
    return void 0 === r
...
class StringsRClassProvider {
  ...
  readOr(e, t, n = "silent") {
    const s = e.startsWith("R.strings") ? e : concatWithPath(this.prefix, e),
      r = readFromR$1(s, void 0, e.startsWith("R.strings") ? window : this.root);
    return void 0 === r
      ? ("silent" !== n && logBySeverity$1(`Resource not found: ${s}`, n), t())
      : r;
  }
  ...
  pluralOr(e, t, n, s = "silent") {
    ...
    return void 0 === o
      ? ("silent" !== s && logBySeverity$1(`Resource not found: ${r}`, s), n())
      : o;
  }
...
class VideosRClassProvider {
  ...
  readOr(e, t, n = "silent") {
    const s = e.startsWith("R.videos") ? e : concatWithPath(this.prefix, e),
      r = readFromR(e.startsWith("R.videos") ? window : this.root, s);
    return void 0 === r
      ? ("silent" !== n && logBySeverity$1(`Resource not found: ${e}`, n), t())
      : r;
  }
  readOrEmpty(e, t = "warn") {
    return this.readOr(e, () => "", t);
...
const sounds$1 = { highlight: "highlight", click: "play", yes1: "yes1" },
  ...
  viewEventTypes$1 = { close: 32 },
  sendViewEvent$1 = (e, t) => viewEnv.handleViewEvent({ __Type: "GFViewEventProxy", type: e }),
  sendEvent$1 = {
    closeView() {
...
function initExternalPaddings$1(e) {
  function t() {
    const { top: t, right: n, bottom: s, left: r } = viewEnv.getExternalPaddingsRem();
...
function pipe(e, t, n, s, r, o, a, i, c) {
...
function create(
  { initializer: e = !0, rootId: t = 0, getRoot: n = getRootDefault, context: s = "model" } = {},
  { name: r = "DataLayer" } = {},
) {
  const o = new Map(),
  ...
  return {
    subscribe: (n, r) => {
      const a = addModelObserver$1("string" == typeof r ? `${s}.${r}` : s, t, !0);
      return (o.set(a, n), e && n(l(r), []), a);
    },
    readByPath: l,
    readSafeByPath: (e) => {
      const t = c();
...
function findIndex(e, t) {
  for (let n = 0; n < e.length; n++) {
    if (t(unsafeGet(e, n), n, e)) return n;
  }
}
...
function arabicToRoman(e) {
  ...
  for (let n = ARABIC$1.length - 1; n >= 0; n--) {
    let s = ARABIC$1[n];
    for (; void 0 !== s && e >= s;) ((t += ROMAN$1[n]), (e -= s));
  }
  return t;
}
function toRoman(e) {
...
function generateMediaClasses(e, t) {
  const n = t["width" === e ? "height" : "width"],
    ...
    r = new Set(
      n.classes.filter((e) => !(!e.endsWith("Width") && !e.endsWith("Height")) || s.has(e)),
    );
  return Array.from(new Set([...s, ...r])).join(" ");
}
function calculateMedia(e, t, n) {
  const s = BREAKPOINTS.reduce(
      (n, s) => (
        s.width <= e &&
          (n.width.classes.push(s.className, `${s.className}Width`),
          n.width.names.push(s.name),
          (n.width.weight += 1)),
        s.height <= t &&
          (n.height.classes.push(s.className, `${s.className}Height`),
          n.height.names.push(s.name),
          (n.height.weight += 1)),
        n
      ),
      {
...
function MediaProvider({ children: e }) {
  const [t, n] = reactExports.useState(calcMediaState);
  return (
...
function MediaWrapperElement({ children: e, className: t, ...n }) {
  const { mediaClass: s, upscale: r } = useMedia();
  return jsxRuntimeExports.jsx("div", {
    className: clsx(t, "media-wrapper", s, r && "media-upscale"),
    ...n,
    children: e,
  });
}
...
function useAdaptiveWidth(e, t) {
  ...
  return t
    ? Object.values(breakpointsByType).reduce(
        (e, s) => (t[s.name] && n.sides.width >= s.width ? { ...e, ...t[s.name] } : e),
        e,
      )
    : e;
}
...
const createApi = () => {
    ...
    return {
      ...
      register: function (e, s) {
        ...
        const r = t(e);
        return (r.includes(s) || r.push(s), () => n(e, s));
      },
      unregister: n,
...
function useHandleKey(e, t, n, s = !1) {
  const r = normalizeKeyCode(e),
    o = useEvent$1((e) => {
      isEventHandled$1() || (n(e), setEventHandled$1(), s && e.stopPropagation());
    }),
    a = useApi(),
...
function Provider(e) {
  const t = reactExports.useMemo(createApi, []),
    n = reactExports.useMemo(createApi, []);
  ...
  return jsxRuntimeExports.jsx(Context$1.Provider, { value: s, children: e.children });
}
...
function SoundsProvider({ severity: e = "warn", overrides: t, silent: n = !1, children: s }) {
  ...
  return jsxRuntimeExports.jsx(Context.Provider, { value: o, children: s });
}
function useSounds() {
...
function cloneModel(e, { shallow: t = !0, depth: n = 0, maxDepth: s = 32 } = {}) {
  const r = e,
    o = typeof e;
    ...
    if (s.includes(":ViewModel:") || "Object" === s) {
      ...
      }
      {
        ...
        for (const t in r) {
          ...
          bindingsForbidden.has(s) || (e[t] = cloneModel(n, a));
        }
        return e;
      }
    }
    const o = {};
    for (const e of Object.keys(r)) o[e] = cloneModel(r[e], a);
    return o;
  }
...
class DLDict {
  constructor(e, t = DEFAULT_OPTIONS) {
    ...
    ((this._keys = observable.set(new Set(s))), (this._data = observable.box(n, MOBX_OPTIONS)));
  }
  _data;
  _keys;
  get keys() {
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      r in n
        ? null === o
          ...
          : n[r].set(o)
        : null !== o && ((n[r] = observable.box(o, MOBX_OPTIONS)), this._keys.add(r), this.set(n));
    }
  }
  entries() {
...
function createObservableModel(e, t, n) {
  ...
  const r = (r, o, a = DEFAULT_BOX_CONFIG) => {
      const i = observable.box(r(n(o)), a);
      return ("real" === t && e.subscribe((e) => s.push(() => i.set(r(e))), o), i);
    },
    o = (r, o) => {
      const a = new DLDict(n(r), o);
      return ("real" === t && e.subscribe((e, t) => s.push(() => a.update(e, t)), r), a);
    },
    a = (r, o) => {
      const a = observable.box(n(r) ?? o, DEFAULT_BOX_CONFIG);
  ...
  return {
    ...
    primitives: (r, o) => {
      const a = n(o);
      if (Array.isArray(r)) {
        const n = r.reduce((e, t) => ((e[t] = observable.box(a[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              s.push(() =>
      ...
      }
      {
        const n = r,
          i = Object.entries(n),
          c = i.reduce((e, [t, n]) => ((e[n] = observable.box(a[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              s.push(() =>
...
const initializeModelWithContext =
    ...
    (t, n, s) => {
      ...
      function o(o) {
        const { mode: a, options: i, children: c, mocks: l } = o,
          u = useMockContext(),
          d = a ?? u.mode,
          p = l ?? u.mocks,
          ...
          m = s?.useRequires?.(),
          g = useEvent$1((r, a, i) => {
            const c = "real" !== r && i ? createMockInstance(i.getter, a) : create(a, { name: e }),
              l = (e) => ("mocks" === r ? i?.getter(e, a) : c.readByPath(e)),
              ...
              p = t({
                ...
                requires: m,
                externalModel: c,
                observableModel: createObservableModel(c, r, l),
                cleanup: u,
              }),
              g = { ...d, mode: r, model: p, externalModel: c, cleanup: u, requires: m },
              h = "mocks" === r && i?.controls ? i.controls(g) : {};
            return {
              model: p,
              controls: { ...n?.(g), ...h },
              externalModel: c,
          ...
          [f, E] = reactExports.useState(d);
        reactExports.useEffect(() => {
          E(d);
        }, [d]);
        const [b, y] = reactExports.useState(() => g(f, i, p));
        return (
          reactExports.useEffect(() => {
            h.current ? y(g(f, i, p)) : (h.current = !0);
          }, [g, p, f, i?.context, i?.initializer, i?.getRoot, i?.rootId]),
          reactExports.useEffect(
            () => () => {
          ...
          jsxRuntimeExports.jsx(r.Provider, { value: b, children: c })
        );
      }
      return (
        (o.displayName = e),
...
function injectShowModel() {
  const e = (t = window.model, { depth: n = 16, convertArrays: s = !0 } = {}) => {
    if (n < 0)
      return (
        console.warn(
    ...
    switch (typeof t) {
      ...
      case "object": {
        ...
        switch (!0) {
          ...
          default: {
            const n = {};
            for (const s in t) Object.prototype.hasOwnProperty.call(t, s) && (n[s] = e(t[s], r));
            return n;
          }
        }
      }
...
async function runView(
  ...
  injectShowModel();
  const o = n ? MediaWrapper : React.Fragment,
      ...
      (t, n) => (
        (t[n] = (function (t) {
          return (n) => {
            ...
            let r = !0;
            const o = `mouse${t}`,
              a = internalMouse[t]((e) => n([e, "outside"]));
            function i(e) {
              n([e, "inside"]);
            }
            return (
              ...
              s(),
              () => {
                r && (a(), window.removeEventListener(o, i), (e.listeners -= 1), s(), (r = !1));
              }
            );
          };
        })(n)),
...
function getBrowserTexturePath(e, t, n, s = 1) {
  return viewEnv.getWebBrowserTexturePath(e, t, n, s);
}
...
const view = Object.freeze(
  ...
  TextButton = ({
    ...
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$e.base, styles$e[`base__${l}`], styles$e[`base__${c}`], s?.base),
      onMouseEnter: _,
      onMouseLeave: m,
      onMouseDown: g,
      onMouseUp: h,
      ...
      ...p,
      children: [
        "info" !== l && jsxRuntimeExports.jsx("div", { className: styles$e.shine }),
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$e.icon, styles$e[`icon__${l}`], styles$e[`icon__${c}`], s?.icon),
          children: jsxRuntimeExports.jsx("div", { className: cx(styles$e.glow, s?.glow) }),
        }),
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$e.caption, styles$e[`caption__${l}`], s?.caption),
          children: e,
        }),
...
let ClickOutsideManager$1 = class e {
  ...
  unregister(e, t) {
    const n = e,
      s = t;
    ((this.entries = this.entries.filter(({ container: e, callback: t }) => e !== n || t !== s)),
...
class DataTracker {
  ...
  addCallback(e, t, n = 0, s = !0) {
    ...
    const r = env.view.addModelObserver(e, n, s);
    return (
      r > 0
        ? ((this._callbacks[r] = t),
  ...
  for (const n in e)
    if (Object.prototype.hasOwnProperty.call(e, n)) {
      ...
      if (s.startsWith("[object CoherentArrayProxy]")) {
        const s = e[n];
        t[n] = [];
        for (let e = 0; e < s.length; e++) t[n].push({ value: dumpViewModel(s[e].value) });
      } else
...
const makeGlobalBoundingBox = (e) => ({
  ...
  sendShowPopOverEvent = (e, t, n, s, r = R.invalid("resId"), o) => {
    const a = env.view.getViewGlobalPosition(),
      { x: i, y: c, width: l, height: u } = n.getBoundingClientRect(),
      d = {
        x: env.view.pxToRem(i) + a.x,
        y: env.view.pxToRem(c) + a.y,
  ...
  getDogTypeImage = (e, t, n) => {
    ...
    if (s) {
      const r = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(s),
        o = r.$dyn(n);
      return o ? `${o}` : `${r.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}`;
    }
    return (
      console.error(
...
const base$5 = "Currency_37b937ed",
  ...
  CurrencyComponent = ({
    ...
    showPlus: a,
    isEnough: i = !0,
    stockBackgroundName: c = StockBackgroundName.Red,
    className: l,
    classNames: u,
  }) =>
    jsxRuntimeExports.jsxs("span", {
...
async function loadPlugin(e) {
  ...
  try {
    ...
    const s = promiseWithResolvers();
    loading.set(n, s);
    __using(
      t,
      defer(() => loading.delete(n)),
    );
    const r = await import(e);
    if (!is(schema, r)) throw new Error(`Not is plugin ${e}`);
    const o = await r.default.plugin({ id: n, url: e });
    return (
      plugins.set(n, o),
      s.resolve(o),
      {
...
function withResolvePath(e) {
  const t = e;
  return reactExports.forwardRef(function (e, n) {
...
function useLoadPlugin(e, t = []) {
  const [n, s] = reactExports.useState({ status: "loading" }),
      ...
      const t = (async function () {
        try {
          const t = await loadPlugin(e),
            n = await t.init(...r.current);
          return (s({ status: "loaded", result: n, instance: t }), t);
        } catch (t) {
          s({ status: "failure", error: t });
        }
      })();
      return () => {
        t.then((e) => e?.destroy());
...
withResolvePath(
  reactExports.forwardRef(function (e, t) {
    ...
    return e.unknown
      ? jsxRuntimeExports.jsx("div", { ...c, style: { width: e.width, height: e.height, ...i } })
      : jsxRuntimeExports.jsx("img", { ...c, ref: t, src: r, width: n, height: s });
  }),
);
...
function defineStyledComponent(e, t, n) {
  ...
  const o = cva(t, n),
    a = reactExports.forwardRef(function (t, n) {
      return jsxRuntimeExports.jsx("div", {
        "data-name": e,
        ...cleanProps(r, t),
        ref: n,
...
const base$3 = "HeadlessButton_df8536fc",
  ...
  HeadlessButton = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(HeadlessButtonBase, {
      ...
      ref: i,
      onMouseEnter: function (e) {
        (r || o || c.play("mouse-enter", { target: s || "Button", original: e }), n?.(e));
      },
      onClick: function (e) {
        r || (o || c.play("click", { target: s || "Button", original: e }), t?.(e));
      },
      children: e,
    });
  }),
  ...
  Button = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(HeadlessButton, {
      ...
      className: clsx(
        styles$2.base,
        styles$2[`base__size-${t}`],
        styles$2[`base__theme-${n}`],
        s ? styles$2.base__disabled : styles$2.base__enabled,
        i,
        a?.base,
      ),
      onClick: function (e) {
      ...
      children: [
        jsxRuntimeExports.jsx("div", { className: clsx(styles$2.background, a?.background) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$2.border, a?.border) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$2.overlay, a?.overlay) }),
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$2.content, o && styles$2.content__fontAligned, a?.content),
          children: e,
        }),
      ],
    });
...
const base$1 = "CloseButton_7488a1b8",
...
const base = "Tooltipdecorator_ea72f443",
  ...
  TooltipDecorator = React.forwardRef(function (
    { children: e, className: t, theme: n = "default", ...s },
    r,
  ) {
    ...
    return (
      ...
      jsxRuntimeExports.jsx("div", {
        ...s,
        className: cx(styles.base, styles[`base__theme-${n}`], t),
        ref: function (e) {
