...
const be = "extraSmall",
  xe = {
    extraSmall: { weight: 0, name: be, className: "mediaExtraSmall", width: 1280, height: 768 },
...
class Qe {
  ...
  takeItem(e, t) {
    const n = e.get(t);
    return this.options.cloneItem ? Ge(n, Ye) : n;
  }
  set = c((e) => {
    this._data.set(e);
  });
...
const rt =
  ...
  (t, n, r) => {
    ...
    function a(a) {
      ...
      const [x, v] = o.useState(() => w(y, u, m));
      return (
        o.useEffect(() => {
          _.current ? v(w(y, u, m)) : (_.current = !0);
        }, [w, m, y, u?.context, u?.initializer, u?.getRoot, u?.rootId]),
        o.useEffect(
          () => () => {
  ...
  render(e) {
    return s.jsx(s.Fragment, {
      children: this.items.reduceRight(
        (e, [t, n], r) => o.createElement(t, { ...n, key: r }, e),
        e,
      ),
    });
  }
...
function ct(e, t, n) {
  ...
  const a = h(t, n),
    c = o.forwardRef(function (t, n) {
      return s.jsx("div", { "data-name": e, ...ut(i, t), ref: n, className: a(t) });
    });
...
const lt = "Tooltip_decorator_b3486d4e",
  dt = ct("Base", "Tooltip_6d997cee"),
  ht = ct("Decorator", lt),
  ft = o.forwardRef(function ({ children: e, ...t }, n) {
...
function Et(e) {
  return Array.isArray(e)
    ? (function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          ...
          (t.push(
            s.jsxs(
              o.Fragment,
              { children: [s.jsxs("span", { className: wt.nowrap, children: [Et(r), i[0]] }), a] },
              bt(),
            ),
          ),
            (n += 1));
    ...
    : "string" == typeof e
      ? s.jsx(o.Fragment, { children: vt(e) }, bt())
      : e;
}
const St = {
  class: function (e, ...t) {
...
const jt = ["number", "string", "undefined"];
function At(e, t, n = {}, r = !0) {
  r && (yt = 0);
  const i = [];
  function a(e) {
    if (jt.includes(typeof e)) {
      const t = i.at(-1);
...
const Mt = { start: "{{", end: "}}" },
  Ct = o.memo(function (e) {
    const {
      ...
      m = o.useMemo(() => (e.formatters ? { ...St, ...e.formatters } : St), [e.formatters]),
      p = o.useMemo(
        () =>
          (function (e, t) {
            const n = [],
      ...
      w = i(wt.base, c && wt.base__fullSize, h.className);
    return e.inline
      ? (console.warn(
...
function Lt({ path: e, ...t }) {
  return s.jsx(Ct, { text: m.resolve("strings").readOrEmpty(e), ...t });
}
const Pt = () => {};
function zt(e) {
  const t = e;
  return o.forwardRef(function (e, n) {
    const r = (function (e, t) {
      ...
      c = { ...i, ref: n };
    {
      const e = o ? a.readOr(o, Pt, "warn") : void 0;
...
const Wt = {
  ...
  Ut = { x16x16: "x16x16", x24x24: "x24x24", x32x32: "x32x32", x48x48: "x48x48", x80x80: "x80x80" },
...
function qt({ size: e, preFormatted: t }) {
  const n = [];
  for (let r = 0; r < t.items.length; ++r)
    (t.separator &&
      ...
      n.push(
        s.jsx(
          "span",
          { className: f(Ht.detailedSeparator, Ht[`detailedSeparator__${e}`]) },
          "separator",
        ),
      ),
      n.push(
        s.jsx(
          "span",
          {
            className: f(Ht.item, Ht[`item__${e}`]),
            children: t.items[r]
              ?.split(" ")
              .map((t, n) =>
                s.jsx(
                  "span",
                  { className: f(Ht.part, Ht[`part__${e}`]), children: t },
                  `part_${n}`,
                ),
              ),
          },
  ...
  Yt = {
    [Wt.compact]: function (e, t) {
      const n = e.length,
        r = Jt[t],
        o = { separator: !1, items: [] };
      for (let s = 0; s < n; ++s) if (Number(e[s]) > 0) return ((o.items = [Qt[r[s]]?.(e[s])]), o);
      return ((o.items = [Qt[Kt]?.(1)]), o);
    },
    [Wt.default]: function (e, t) {
      ...
      o[n] === Kt && 0 === Number(e[n])
        ? (s.items = [Qt[Kt]?.(1)])
        : (s.items = [n, n + 1].map((t) => Qt[o[t]]?.(e[t])));
      return s;
    },
    [Wt.detailed]: function (e) {
      const [t, ...n] = e,
        r = n.join(":");
      return { separator: !0, items: Number(t) > 0 ? [Qt[Xt]?.(t), r] : [r] };
    },
  },
  Qt = {
    [Xt]: (e) =>
      X(
        Zt.readOr("common.timer.days", () => Xt.toLowerCase()),
        { days: e },
      ),
    [Gt]: (e) =>
      X(
        Zt.readOr("common.timer.hours", () => Gt),
        { hours: e },
      ),
    [Kt]: (e) =>
      X(
        Zt.readOr("common.timer.minutes", () => Kt),
        { minutes: e },
      ),
  };
const en = (e, t) => Yt[t]?.(Z(e, Jt[t]), t),
  tn = {
...
function nn({
  ...
  return s.jsxs("div", {
    className: f(tn.base, u),
    children: [
      s.jsx("div", { className: f(tn.icon, tn[`icon__${r}`], tn[`icon__${i}`], l?.icon) }),
      a !== Wt.superCompact &&
        s.jsx("div", {
          className: f(tn.label, tn[`label__${r}`], tn[`label__${i}`], l?.label),
          children: s.jsx(qt, { size: r, preFormatted: en(d, a) }),
        }),
    ],
  });
}
((nn.format = Wt), (nn.size = Ut), (nn.type = Vt));
export {
  Lt as F,
  Bt as I,
  ot as J,
