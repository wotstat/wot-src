  ...
  const a = (function (e, t) {
    ...
    s = a.map((e) =>
      (function (e) {
        ...
        const [a, s] = e;
        return (a === Le.Researched && s === Le.Selected) ||
          (a === Le.Selected && s === Le.Researched)
          ? Le.Selected
          : Le.Default;
      })(e),
    );
  return s.includes(Le.Researched)
    ? Le.Researched
    : s.includes(Le.Selected)
      ? Le.Selected
      : Le.Default;
}
function Xe(e, t, a = []) {
  ...
  aa = r.forwardRef(function (t, a) {
    ...
    return e.jsx("div", {
      ...
      className: l(
        ...
        ta[`base__${t.type}`],
        ta[`base__${t.status}`],
        t.lockedTree && ta.base__lockedTree,
      ),
      onClick: function () {
        (s.onClick(), t.onClick());
      },
  ...
  na = a(function (t) {
    ...
    switch (t.type) {
      ...
      case Oe.Special:
        return e.jsx(Wt, {
          ...m,
          ...sa(n, o, m.isHintRequired, m.root),
          showGear: t.type === Oe.Special,
        });
      case Oe.Final:
      case Oe.Major:
            ...
            r.add(
              b(
                ...
                () => {
                  ...
                  c.run(
                    () =>
                      o({ status: ra.AnimateResearched, transitionDelay: ia.transition(r, t, n) }),
                    i,
                  );
                },
              ),
...
function da({ affectedNodes: a, path: s, nodes: n }) {
  ...
  return e.jsx("path", {
    d: s,
    style: { "--scale": `${o}` },
    className: t(la.base, la[`base__${i}`]),
  });
}
const _a = ["bottom", "top"];
...
function ua(e, t, a, s, r) {
  if (a.top !== s.top && a.left !== s.left)
    return _a.includes(r) ? { x: e.x, y: t.y } : { x: t.x, y: e.y };
}
const ha = new (class {
  getElementMetrics(e) {
  ...
  getConnectionPoints(e, t, a) {
    ...
    return {
      start: c,
      middle: ua(this.getCenterPoint(o), this.getCenterPoint(i), o, i, s) ?? null,
      end: l,
    };
  }
})();
  ...
  return e.flatMap((n, o) => {
    ...
    return i && c
      ? c.reduce((t, c) => {
          ...
          if (!d)
            return (
              H.log(void 0 !== d, `NodeRefsMap dosent include targetNode with position ${o}`),
              t
            );
...
a(function () {
  const { model: a, controls: s } = ya(),
    ...
    _ = P(
      { buttonSize: oe.small, iconSize: ne.small },
      { medium: { buttonSize: oe.medium, iconSize: ne.medium } },
    ),
    m = w({
  ...
  Fa = a(function () {
    ...
    return e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: a.map((t, a) => e.jsx(Ta, { ...t }, a)),
      }),
    });
  }),
  La = "Footer_97a7d8ee",
  ...
  Xa = a(function () {
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: Wa,
          children: Ua.readOrEmpty("veh_skill_tree.rewardScreen.title"),
        }),
        e.jsx("div", {
          className: qa,
          children: e.jsx(j, {
            params: i,
            text: Ua.readOrEmpty("veh_skill_tree.rewardScreen.subtitle"),
          }),
        }),
      ],
    });
