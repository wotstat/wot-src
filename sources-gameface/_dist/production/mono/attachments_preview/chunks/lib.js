...
const Ft = "HorizontalBar_rail_37858d8f",
  ...
  Qt = s.memo(function ({ classNames: e = {}, onDrag: t = oe }) {
    ...
    const p = Fe(
      ...
      _ = s.useCallback(
        (e) => ("dragStart" === e.type ? h(!0) : "dragEnd" === e.type && h(!1), t(e)),
        [t],
      ),
      b = Ot(u, _, m, c, p),
      E = Fe(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
        ...
        if (!r || !s || !o) return;
        const i = V(5);
        ((s.style.width = `${t - i + n}px`),
          (o.style.width = r.offsetWidth - e - t - i - n + "px"));
      }),
...
function Zt({ className: e, classNames: t, children: n }) {
  ...
  return o.jsx("div", {
    ...
    children: o.jsx("div", {
      ...
      ref: r.wrapperRef,
      children: o.jsx("div", {
        className: i(Vt.content, t?.content),
        ref: r.contentRef,
        children: n,
      }),
    }),
  ...
  const p = Fe((e) => e - (c.current.offsetHeight - u.current.offsetHeight) >= -0.5),
    ...
    E = Fe(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
      ...
      ((s.style.height = `${t - i + n}px`),
        (o.style.height = r.offsetHeight - e - t - i - n + "px"));
    }),
  ...
  Tn = s.forwardRef(function (
    ...
    return o.jsxs(yn, {
      ...
      children: [
        ...
        o.jsx("div", {
          className: i(vn.content, a && vn.content__fontAligned, c?.content),
          children: e,
        }),
      ],
    });
      ...
      s.useEffect(() => {
        if (f && h.current) {
          ...
          const n = (t) => (
            ...
            m = () =>
              h.current?.cohGetKeyframeTimestamps ? h.current.cohGetKeyframeTimestamps() : [],
            p = (e) => {
              (i(e), u());
            },
            g = (e) => {
            ...
            b = (e, t) => (
              h.current?.addEventListener(e, t),
