        ...
        r.jsx("div", {
          ...
          children: _((e, a) => {
            const s = a.item || a.name,
              ...
              n = f({ tooltipId: a.tooltipId }, Number(a.tooltipContentId), {
                ignoreShowDelay: !0,
              });
            return r.jsx(o.div, {
              className: se,
...
const Be = "ChapterLogo_aa1334cf",
  ...
  Ye = ({ isElite: e, vehicleName: a, vehicleType: s, vehicleLvl: t, isWide: i }) =>
    r.jsxs("div", {
      className: n(We.base, i && We.base__wide),
      children: [
        r.jsx("div", { className: We.level, children: N(t) }),
        r.jsx("div", { className: We.type, style: Fe(s, e) }),
  ...
  ze = ({ type: e, value: a }) => {
    switch (e) {
      case k.BattlaPassFinalAchievement:
        return r.jsx(L, {
          text: Me.battlePassAwardsView.mainReward.reward(),
          binding: { name: a },
        });
      case k.TmanToken:
        return r.jsx(L, {
        ...
        r.jsx(C, {
          ...
          children: r.jsxs("div", {
            ...
            children: [
              ...
              q(_) &&
                r.jsx(Ie, { overlayType: l, rewardSize: w.S600x450, className: qe.attachment }),
              g &&
                r.jsx("div", {
                  className: qe.count,
  ...
  ra = t(() => {
    const { model: e } = Q(),
      ...
      c = (() => {
        ...
        return {
          backgroundImage: `url(${Se(e, { name: "ribbon", postfix: `${d}${a ? "_with_bp" : ""}` })})`,
        };
      })();
    ...
    const o = ((e, a, s) =>
      s
        ...
        : e
          ...
          : Na.battlePassAwardsView.additionalRewards.button())(
      i,
      a > t * (s + 1) ? 10 : a - t * s,
      e,
    );
      ...
      children: [
        ...
        r.jsxs("div", {
          ...
          children: [
            ...
            Y && r.jsx(ye, { button: z, className: n(ya, C && Sa, !I && La) }),
...
M(new Y().add(O).addWithProps(X, {}).render(r.jsx(Ca, {})));
