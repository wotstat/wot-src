...
import {
  ...
  P as T,
  a as C,
} from "../../../../chunks/per_battle_points_table.js";
...
const [O, L] = o()(
  ...
  M = "Rewards_3f324c43",
  W = ({ className: a = "", children: t = null }) =>
    e.jsx("div", { className: s(M, a), children: t }),
  ...
  Y = ({ rewardPoints: s, hasAdditionalPoints: a }) => {
    const o = t.useMemo(
        () =>
          s.soloMode.map(({ value: s }) =>
            e.jsx(l, { text: F.places(), binding: { place: s.place } }),
          ),
        [s],
      ),
      ...
      children: [
        ...
        e.jsx("div", {
          ...
          children: a.map((s, a) =>
            e.jsx(
              f,
              { ...ze(s.value, o), className: Ve[`reward__${o}`], size: o },
              `${s.name}_${a}`,
            ),
          ),
        }),
