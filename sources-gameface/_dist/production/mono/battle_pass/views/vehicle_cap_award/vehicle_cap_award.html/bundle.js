...
/* empty css                    */ const [A, f] = c()(
  ...
  z = e(() => {
    const { model: e } = f(),
      ...
      r = i(a),
      o = {
        backgroundImage: `url(R.images.gui.maps.icons.vehicleTypes.big.${i(l)}${t ? "_elite" : ""})`,
      };
    return s.jsx("div", {
      className: V,
      children: s.jsxs("div", {
        ...
        children: [
          ...
          s.jsxs("div", {
            ...
            children: [
              ...
              s.jsxs("span", {
                className: T,
                children: [c, "/", c, s.jsx("div", { className: $ })],
              }),
            ],
          }),
          s.jsxs("span", {
  ...
  ae = e(() => {
    const { model: e } = f(),
      ...
      l = !c;
    (h(),
      N({ [_.ENTER]: () => r.close(), [_.SPACE]: () => r.close(), [_.ESCAPE]: () => r.close() }));
    return s.jsxs("div", {
      className: Y,
      children: [
        s.jsx("div", {
