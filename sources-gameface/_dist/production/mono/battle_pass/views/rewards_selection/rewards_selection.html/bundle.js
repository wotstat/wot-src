...
import { g as X, a as Z } from "../../../chunks/filename.js";
/* empty css                    */ const ee = "state_limited",
  te = "state_received",
  ae = d.resolve("strings"),
  se = d.resolve("images");
function re(e) {
...
const de = (e, t = i.Small, a) => {
    if ("modernized_device" === a) {
      const a = re(e);
      if (a) return se.readOrEmpty(`quests.bonuses.${t}.modernized_devices_t${a}_gift`, "silent");
    }
    return se.readOrEmpty(`quests.bonuses.${t}.${ce(e, a)}_gift`, "silent");
  },
  le = (e, t) => {
    ...
    return a
      ? void 0 === a[1]
        ? ""
        : ae.readOrEmpty(`selectable_reward.tabs.items.${a[1]}`, "silent")
      : ae.readOrEmpty(`selectable_reward.tabs.items.${ce(e, t)}`, "silent");
  },
  ie = (e) => {
    const t = e.split("_")[1],
      a = t && ae.readOrEmpty(`blueprints.nations.${t}`, "silent"),
      s = ae.readOrEmpty(`artefacts.${e}.name`, "silent");
    return (
      a ||
      (s && "string" == typeof s ? l(s) : (console.error("title for reward is not provided"), null))
    );
  };
function _e(e, t) {
  if ("modernized_device" === t) {
    const t = re(e);
    if (t)
      return se.readOrEmpty(
        `selectableReward.reward.optDeviceType.modernized_devices_t${t}`,
        "silent",
      );
  }
  return se.readOrEmpty(`selectableReward.reward.optDeviceType.${t}`, "silent");
}
const be = (e, t = "s180x135", a = "R.images.gui.maps.icons.selectableReward.reward") =>
  `${a}.${t}.${e}`;
var ue = ((e) => ((e.None = "none"), (e.Accepting = "accepting"), e))(ue || {});
const [me, pe] = _()(
    ({ observableModel: a }) => {
      const s = {
          root: a.object(),
        ...
        r = t(
          (e) => {
            const t = u(s.tabs.get(), e);
            return { ...t, optDeviceType: oe(t.type) };
          },
          { equals: b },
        ),
        n = t(
          (e) => {
            const t = u(s.rewards.get(), e);
            return { ...t, optDeviceType: oe(t.type) };
          },
          { equals: b },
        ),
        o = t(() => m(s.tabs.get(), (e, t) => e + t.limit, 0));
      return { ...s, computes: { tabByIndex: r, rewardByIndex: n, rewardsToClaimTotal: o } };
    },
    ({ externalModel: e, model: t }) => {
      const s = a((e) => t.animationState.set(e));
      return {
  ...
  ge = d.resolve("strings"),
  Ce = d
    .resolve("views")
    .read((e) => e.common.tooltip_window.backport_tooltip_content.BackportTooltipContent("resId")),
  we = s(({ index: e, className: t, classNames: a }) => {
    const {
        breakpoint: { weight: s },
      } = p(),
      { model: c, controls: d } = pe(),
      l = c.animationState.get(),
      { optDeviceType: _, count: b, limit: u, type: m } = c.computes.tabByIndex(e),
      h = b === u,
      y = c.root.get().selectedTab === m,
      x = ge.readOrEmpty(`selectable_reward.tabs.items.${_}`, "silent"),
      k = s >= f.medium.weight ? i.Big : i.Small,
      j = g(r.useMemo(() => ({ contentId: Ce, args: { type: m } }), [m]));
    return n.jsxs("div", {
      className: o(fe.base, h && fe.base__completed, !y && b && fe[`base__${l}`], t),
      onClick: () => {
        (C.sound("bp_click"), d.openTab(m));
      },
      onMouseEnter: () => C.sound("bp_highlight"),
      children: [
        n.jsxs("div", {
          ...j,
          ...
          children: [
            n.jsx("div", {
              className: fe.image,
              style: { backgroundImage: `url(${de(m, k, _)})` },
            }),
            n.jsx("div", { className: fe.check }),
          ],
        }),
        n.jsx("div", {
          className: fe.counter,
          children: w(ge.readOrEmpty("selectable_reward.tabs.counter"), { count: b, limit: u }),
        }),
        n.jsx("div", {
          className: o(fe.title, null == a ? void 0 : a.title),
          children: n.jsx(v, { text: le(m, _), params: { equipmentType: x } }),
        }),
      ],
    });
  });
...
var he = ((e) => ((e.Plus = "plus"), (e.Minus = "minus"), e))(he || {});
const ye = ({ type: e = "plus", isEnabled: t = !0, onClick: a }) =>
    n.jsx("div", {
      className: o(ve.base, ve[`base__${e}`], !t && ve.base__disabled),
      onClick: (e) => {
  ...
  ke = d.resolve("strings"),
  je = d
    .resolve("views")
    .read((e) => e.common.tooltip_window.backport_tooltip_content.BackportTooltipContent("resId")),
  Ne = s(({ index: e, className: t }) => {
    const { model: a, controls: s } = pe(),
      c = a.animationState.get(),
      d = a.computes.rewardByIndex(e),
      { type: l, count: i, state: _, storageCount: b, packSize: u, optDeviceType: m } = d,
      { addReward: p, reduceReward: f } = s,
      v = "state_normal" === _,
      y = _ === ee,
      x = _ === te,
      k = i > 0 && !x,
      ...
      I = h(
        r.useMemo(
          () =>
            y && 0 === i
              ? {
                  header: ke.readOrEmpty("selectable_reward.reward.tooltip.state_limited.header"),
                  body: ke.readOrEmpty("selectable_reward.reward.tooltip.state_limited.body"),
                }
              : { isEnabled: !1 },
          [y, i],
        ),
      ),
      R = g(r.useMemo(() => ({ contentId: je, args: { type: l } }), [l]));
    return n.jsxs("div", {
      className: o(
        xe.base,
        t,
        k && xe.base__selected,
        N && xe.base__accepting,
        xe[
          `base__${
            ((T = _),
            T.replace(/_\w/g, (e) => {
              var t;
              return (null == (t = e[1]) ? void 0 : t.toUpperCase()) ?? e;
            }))
          }`
        ],
      ),
      onClick: () => {
        v ? (C.sound("bp_click"), p(l)) : (y || x) && C.sound("bp_click_limit");
      },
      onMouseEnter: () => C.sound("bp_highlight"),
      children: [
        n.jsxs("div", {
          className: o(xe.storage, b <= 0 && xe.storage__hidden),
          children: [n.jsx("div", { className: xe.storageIcon }), b],
        }),
        n.jsxs("div", {
          ...R,
          className: xe.reward,
          children: [
            n.jsx("div", { className: xe.image, style: { backgroundImage: `url(${be(l)})` } }),
            m !== ne.None &&
              n.jsx("div", {
                className: xe.optDeviceType,
                style: { backgroundImage: `url(${_e(l, m)})` },
              }),
            u > 1 &&
              n.jsx("div", {
                className: xe.packSize,
                children: w(ke.readOrEmpty("selectable_reward.reward.packSizeCount"), {
                  packSize: u,
                }),
              }),
          ],
        }),
        n.jsx("div", { className: xe.label, children: ie(l) }),
        j
          ? n.jsxs("div", {
              className: xe.selectControls,
              children: [
                n.jsx("span", { className: xe.countText, children: i }),
                n.jsxs("div", {
                  className: xe.select,
                  children: [
                    n.jsx(ye, {
          ...
          : (y || x) &&
            n.jsx("div", {
              ...
              className: xe.state,
              children: n.jsx("div", {
                className: xe.stateText,
                children: ke.readOrEmpty(`selectable_reward.reward.${_}`),
              }),
            }),
      ],
    });
  ...
  Re = s(({ className: e, onScrollableChange: t }) => {
    const { model: a } = pe(),
    ...
    return (
      ...
      r.useEffect(() => {
        ...
        return (_.recalculateContent(), e(), _.events.on("recalculateContent", e));
      }, [c.length, _, s]),
      r.useEffect(() => {
        var e;
        null == (e = f.current) || e.call(f, m);
      }, [m]),
      n.jsxs("div", {
        className: o(Ie.base, e),
        children: [
          n.jsx("div", {
            className: o(Ie.mask, Ie[`mask__${B(b, u)}`]),
            children: n.jsx(j, {
              classNames: {
                content: o(Ie.scrollAreaContent, !m && Ie.scrollAreaContent__centered),
              },
              children: n.jsx("div", {
                className: Ie.scrollArea,
                children: n.jsx(N, {
                  border: "contour",
                  enabled: !0,
                  className: Ie.cardsGrid,
                  children: I(c, (e, t) => {
                    const { count: a, state: s, type: r } = e,
                      { disabled: c, statusType: d } = (function (e, t, a) {
                        const s = e === ee,
                          r = e === te,
                          n = 0 === t;
                        return {
                    ...
                    return n.jsx(
                      T,
                      {
                        ...
                        disabled: c,
                        status: d,
                        className: Ie.rewardCard,
                        classNames: {
                          mainContainerContent: Ie.cardContent,
                          status: {
                            wrapper: o(Ie.statusWrapper, Ie[`statusWrapper__${d}`]),
                            icon: Ie.icon,
                          },
                        },
                        soundTarget: "reward-selection:card",
                        children: n.jsx(Ne, { index: t }),
                      },
                      r,
                    );
                  }),
          ...
          n.jsx(S, { classNames: { base: Ie.scrollBar } }),
        ],
      })
    );
  }),
  Te = "Footer_775b7239",
  Be = "Footer_buttons_877c593c",
  Se = d.resolve("strings"),
  Ee = s(({ buttonsSize: e, classNames: t }) => {
    const { model: a, controls: s } = pe(),
      { totalRewardCount: o } = a.root.get(),
      c = o > 0,
      {
        breakpoint: { weight: d },
      } = p(),
      l = e ?? ((e) => (e > f.small.weight ? E.medium : E.small))(d),
      i = O(),
      _ = h(
        r.useMemo(
          () => ({ disabled: c, body: Se.readOrEmpty("selectable_reward.tooltips.footer.body") }),
          [c],
        ),
      );
    return n.jsx("div", {
      ...
      children: n.jsx("div", {
        ...
        children: n.jsx(A, {
          ...
          theme: G.primary,
          disabled: !c,
          className: null == t ? void 0 : t.button,
          onClick: () => {
            (s.setAnimationState(ue.Accepting), i.run(s.submit, 600));
          },
          children: Se.readOrEmpty("selectable_reward.footer.okBtn.label"),
        }),
      }),
    });
  }),
  ...
  Ae = s(({ title: e, subTitle: t, classNames: a, buttonsSize: s }) => {
    const c = r.useRef(!1),
      [d, l] = r.useState(!1),
      [i, _] = r.useState(null),
      [b, u] = r.useState(!1),
      { model: m, controls: p } = pe(),
      f = m.tabs.get(),
      { selectedTab: g } = m.root.get(),
      C = m.animationState.get(),
      w = $(f, (e) => e.type === g) ?? -1;
    return (
      r.useEffect(() => {
        if (!d)
      ...
      r.useEffect(() => {
        const e = (e) => {
          (e.code !== L.ARROW_LEFT && e.code !== L.ARROW_RIGHT) || (c.current = !1);
        };
        return (window.addEventListener("keyup", e), () => window.removeEventListener("keyup", e));
      }, []),
      W(L.ARROW_LEFT, () => {
        if (c.current) return;
        if (((c.current = !0), w <= 0)) return;
        const e = M(f, w - 1);
        p.openTab(e.type);
      }),
      W(L.ARROW_RIGHT, () => {
        if (c.current) return;
        if (((c.current = !0), w < 0 || w === f.length - 1)) return;
        const e = M(f, w + 1);
        p.openTab(e.type);
      }),
      n.jsxs("div", {
        ...
        children: [
          n.jsxs(U, {
            ...
            children: [
              n.jsxs("div", {
                className: o(Oe.wrapper, d && Oe.wrapper__shown),
                children: [
                  n.jsxs("div", {
                    className: o(Oe.heading, null == a ? void 0 : a.heading),
                    children: [
                      n.jsx("div", {
                        className: o(Oe.title, null == a ? void 0 : a.title),
                        children: e,
                      }),
                      n.jsx("div", {
                        className: o(Oe.subTitle, null == a ? void 0 : a.subTitle),
                        children: t,
                      }),
                    ],
                  }),
                    ...
                    children: I(f, (e, t) => {
                      const s = g === e.type,
                        ...
                        c = {
                          ...
                          background: o(
                            Oe.tabBackground,
                            s && Oe.tabBackground__active,
                            r && Oe.tabBackground__hover,
                          ),
                          borderImage: o(
                            Oe.tabBorderImage,
                            s && Oe.tabBorderImage__active,
                            r && Oe.tabBorderImage__hover,
                          ),
                          content: Oe.tabContent,
                        };
                      return n.jsx(
                        U.Tab,
                        {
                          ...
                          onMouseLeave: () => _(null),
                          onClick: () => p.openTab(e.type),
                          children: n.jsx(we, {
                            index: t,
                            className: null == a ? void 0 : a.category,
                            classNames: { title: null == a ? void 0 : a.categoryTitle },
                          }),
                        },
                        e.type,
                      );
          ...
          n.jsxs("div", {
            className: o(Oe.footer, null == a ? void 0 : a.footer),
            children: [
              b && n.jsx("div", { className: Oe.bottomLip }),
              n.jsx(Ee, { buttonsSize: s, classNames: null == a ? void 0 : a.footerClassNames }),
            ],
          }),
        ],
      })
  ...
  Ge = "Error_9f7ff239",
  $e = "Error_title_881f33d",
  ze = "Error_description_9cc31237",
  We = "Error_footer_2ba80f61",
  Me = "Error_button_1befe7e6",
  Le = d.resolve("strings"),
  Ue = s(() => {
    const { controls: e } = pe();
    return n.jsxs("div", {
      className: Ge,
      children: [
        n.jsx("div", { className: $e, children: Le.readOrEmpty("selectable_reward.error.title") }),
        n.jsx("div", {
          className: ze,
          children: Le.readOrEmpty("selectable_reward.error.description"),
        }),
        n.jsx("div", {
          className: We,
          children: n.jsx(A, {
            ...
            size: E.medium,
            onClick: e.close,
            children: Le.readOrEmpty("selectable_reward.error.button"),
          }),
        }),
      ],
    });
  ...
  qe = s(({ title: e, subTitle: t, classNames: a, buttonsSize: s }) => {
    ...
    return n.jsx("div", {
      ...
      children:
        o.length > 0
          ? n.jsx(Ae, { title: e, subTitle: t, classNames: a, buttonsSize: s })
          : n.jsx(Ue, {}),
    });
  }),
  ...
  Ze = R.strings.battle_pass.rewardChoice,
  et = c(() => {
    ...
    const l = r.useMemo(
      () =>
        ((e, t) =>
          t
            ? {
                backgroundImage: `url(${X(R.images.gui.maps.icons.battlePass.backgrounds.chapter_general, e)})`,
              }
            : Z())(a, o),
      [a, o],
    );
