...
const [J, Q] = c()(
            ...
            return n.jsx(
              ae,
              {
                ...
                children: n.jsx(u, {
                  ...s,
                  name: s.name,
                  image: x({ ...s, icon: "icon" in s && X(s.icon) }, w.Big),
                  size: w.Big,
                  valueType: r,
                  tooltipArgs: A(
                  ...
                  classNames: { info: t(re, r === h.MULTI && ie) },
                }),
              },
              s.index,
            );
  ...
  ge = ({ count: e, onAnimationEnd: a }) => {
    ...
    return n.jsxs("div", {
      ...
      children: [
        ...
        s &&
          n.jsx("div", { className: xe, children: n.jsx(we, { goalValue: e, onAnimationEnd: a }) }),
      ],
    });
  },
  ve = "Value_1ad9fa26",
  ...
  Re = ({ reward: e }) => {
    const { name: a, tooltipId: s, label: o, value: t, icon: r } = e,
      i = m.resolve("views"),
      d = C({ size: w.S296x222 }, { medium: { size: w.S400x300 } });
    return n.jsxs("div", {
      className: ye.base,
      children: [
        n.jsx(u, {
      ...
      children: n.jsxs("div", {
        ...
        children: [
          ...
          n.jsx("div", {
            className: We,
            children:
              l && (o ? n.jsx(de, { onAnimationEnd: e }) : n.jsx(Ee, { onAnimationEnd: e })),
          }),
        ],
      }),
    });
  ...
  Ue = ({ machineState: e, isFirstEnter: a, onAnimationEnd: s }) => {
    ...
    return (
      ...
      n.jsx("div", {
        ...
        children: n.jsx("div", {
          className: t(ze, !a && De),
          children: n.jsx(Fe, { onAnimationEnd: s }),
        }),
      })
    );
  };
