...
import { a8 as s, al as i, am as l } from "./lib.js";
...
function r({ reward: r, style: c = { nameHeight: "18rem" }, className: o = "", hasShortName: d }) {
  const { breakpoint: n } = s(),
    { label: v, level: h, type: p, isElite: y, vehicleShortName: N } = r;
  return e.jsxs("div", {
    className: a(t.base, o),
    style: { fontSize: c.nameHeight },
    children: [
      void 0 !== h && e.jsx("div", { className: t.level, children: i(h) }),
      void 0 !== p &&
        void 0 !== y &&
        e.jsx("div", { className: t.type, style: m(p, y, n.width >= l.Medium) }),
      e.jsx("div", { children: d ? N : v }),
    ],
  });
}
export { r as T };
