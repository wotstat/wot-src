...
import { L as e, r as t, j as o, f as a } from "../../../chunks/vendor.js";
import {
  i as n,
  c as s,
  n as r,
...
/* empty css                    */ const [D, G] = n("ChatsProvider")(
  ...
  [te, oe] = n("VehicleCompareProvider")(
    ({ observableModel: e }) => ({
      ...e.primitives({ vehicleCount: "vehicleCount", isEnabled: "enabled" }),
    }),
    r,
  ),
  ae = {
  ...
  return o.jsxs("div", {
    ...
    children: [
      ...
      o.jsx("div", {
        className: a(
          Me.content,
          Me[`content__${((x = c), (v = d), x || v ? (v ? (x ? ye : _e) : he) : fe)}`],
        ),
        children: s,
      }),
      !m &&
  ...
  Le = e(function ({ className: e }) {
    ...
    (t.useLayoutEffect(() => {
      ...
      t.useEffect(() => {
        ...
        e();
        return new p()
          .add(n.events.on("resizeHandled", e))
          .add(n.events.on("recalculateContent", e)).dispose;
      }, [n, i.length]),
      t.useEffect(() => {
        function e() {
    ...
    return o.jsxs(o.Fragment, {
      children: [
        i.length > 0 && o.jsx(V, { className: Ae }),
        o.jsx("div", {
          className: a(Re, e),
          children: o.jsx(Pe, {
            api: n,
...
function Oe(e) {
  return o.jsx(C, { children: o.jsx(Le, { ...e }) });
}
...
const De = e(function ({ className: e }) {
    ...
    return o.jsx("div", {
      ...
      className: a(Fe, e),
      children: o.jsx(k, { ...me(m, "chat"), className: Ve }),
    });
  }),
...
const Ye = e(function () {
  ...
  Ze = t.lazy(() =>
    E(() => import("../../../chunks/widget.js"), __vite__mapDeps([0, 1, 2, 3]), import.meta.url),
  );
function et(e) {
...
const tt = "ReferralProgram_valueContainer_a1a1e336",
  ...
  it = e(function ({ className: e }) {
    const t = B(),
      ...
      m = N({ value: z.small }, { medium: { value: z.medium } }),
      u = j(m.value, S),
      _ = d({
        header: i
...
const yt = e(function () {
    ...
    return (
      ...
      o.jsxs("div", {
        ...
        onMouseEnter: function (e) {
          (m && b.play("mouse-enter", { target: "SessionStatisticButton", original: e }),
            f?.onMouseEnter(e));
        },
        children: [
          o.jsx(k, {
            ...me(_, m ? "session_stats" : "session_stats_disabled"),
            className: a(dt, m && mt),
          }),
...
const It = e(
    t.forwardRef(function ({ className: e }, n) {
      const { model: s } = J(),
        ...
        h = t.useMemo(() => [], []),
        f = b(i) ?? i,
        y = N({ value: z.small }, { medium: { value: z.medium } }),
        p = j(y.value, S),
...
const Lt = e(function () {
  ...
  return o.jsx("div", {
    className: zt,
    children: o.jsx(It, { ref: e, className: a(Wt, t.oldStyle.get() && At) }),
  });
});
F(
  new L()
    ...
    .addWithProps($, {
      options: {
        rootId: c.resolve("aliases").read((e) => e.lobby_footer.default.ContactsList("resId")),
      },
    })
    .addWithProps(K, {
      options: {
        rootId: c.resolve("aliases").read((e) => e.lobby_footer.default.ReferralProgram("resId")),
      },
    })
    .addWithProps(te, {
      options: {
        rootId: c.resolve("aliases").read((e) => e.lobby_footer.default.VehicleCompare("resId")),
      },
    })
    .addWithProps(Z, {
      options: {
        rootId: c.resolve("aliases").read((e) => e.lobby_footer.default.SessionStats("resId")),
      },
    })
    .addWithProps(q, {
      options: {
        rootId: c
          .resolve("aliases")
          .read((e) => e.lobby_footer.default.NotificationsCenter("resId")),
      },
    })
    .addWithProps(D, {
    ...
    .addWithProps(X, {
      options: {
        rootId: c.resolve("aliases").read((e) => e.lobby_footer.default.ServerInfo("resId")),
      },
    })
    .render(o.jsx(Lt, {})),
);
