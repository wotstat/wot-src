...
const ds = "Index_4a4da35",
  ...
  js = Object.freeze(
    Object.defineProperty({ __proto__: null, default: hs }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  vs = d(["None", "Core", "Pro"]),
  gs = d(["Inactive", "Active", "Cancelled"]),
  ys = d([6, 12]),
  Ns = d(["unlock", "unlockSteamAndCn", "unlockPro"]),
  ws = e({ label: t(), type: t() }),
  Ps = ie(
    p(
      e({
  ...
  Es = h.resolve("images"),
  Ts = h.resolve("strings");
function Cs({ unlockType: e }) {
  const s = {
    unlock: Ts.readOrEmpty("subscription.headerButton.tooltip.unlockSubscription"),
    unlockSteamAndCn: Ts.readOrEmpty("subscription.headerButton.tooltip.unlockSteamAndCn"),
    unlockPro: Ts.readOrEmpty("subscription.headerButton.tooltip.unlockPro"),
  };
  return a.jsx("div", {
    className: i(Bs.base, "unlockPro" === e && Bs.base__steamCn),
    children: a.jsxs("div", {
      className: Bs.base_wrapper,
      children: [
        ["unlock", "unlockSteamAndCn"].includes(e) &&
          a.jsx("img", { className: Bs.base_icon, src: Es.readOrEmpty("subscription.lock") }),
        a.jsx("div", { className: Bs.base_text, children: s[e] }),
      ],
    }),
  });
}
const Hs = "Bonuslist_30606a62",
  ...
  Ls = "Bonuslist_list_leftColumn_30606a62",
  Ss = "Bonuslist_list_rightColumn_30606a62",
  Is = "Bonuslist_list_proBonusesLeftColumn_30606a62",
  Vs = "Bonuslist_list_proBonusesRightColumn_f94cf518",
  Ds = "Bonuslist_list__unlockPro_30606a62",
  $s = "Bonuslist_list_item_a02b09a8",
  zs = "Bonuslist_icon_280817ab",
                ...
                children:
                  ...
                  m.map((e) =>
                    a.jsxs(
                      "div",
                      {
                        className: i($s, e.isProBonus && Fs),
                        children: [
                          a.jsx("img", {
                            className: zs,
                            src: o.readOrEmpty(`subscription.tooltip.${e.type}`),
                          }),
                          a.jsx("div", { className: Us, children: e.label }),
                        ],
                      },
                      e.label,
                    ),
      ...
      r !== R.UnlockSteamAndCn &&
        ...
        a.jsxs("div", {
          ...
          children: [
            ...
            a.jsxs("div", {
              className: i(Os, Rs, r === R.UnlockPro && Ds),
              children: [
                a.jsx("div", {
                  className: Is,
                  children: p?.map((e) =>
...
const qs = {
  ...
  Ys = Object.fromEntries(
    Object.entries(
      Object.assign({
        "./crew_info/index.tsx": fs,
        "./special_mechanic/index.tsx": js,
        "./wot_plus_header_widget/index.tsx": Qs,
      }),
...
S(new L().add(se).render(a.jsx(ea, {})));
