var __knownSymbol = (e, t) => ((t = Symbol[e]) ? t : Symbol.for("Symbol." + e)),
  ...
  __using = (e, t, s) => {
    ...
    null != t
      ? ("object" != typeof t && "function" != typeof t && __typeError("Object expected"),
        ...
        void 0 === r && ((r = t[__knownSymbol("dispose")]), s && (n = r)),
  ...
  __callDispose = (e, t, s) => {
    var r =
      ...
      n = (e) => (t = s ? new r(e, t, "An error was suppressed during disposal") : ((s = !0), e)),
      a = (r) => {
        for (; (r = e.pop());)
          try {
            var o = r[1] && r[1].call(r[2]);
            if (r[0]) return Promise.resolve(o).then(a, (e) => (n(e), a()));
          } catch (i) {
            n(i);
          }
        if (s) throw t;
...
function updateViewHeight(e, t, s, r) {
  (resize$1(e, t + viewEnv.remToPx(r + s), "px"),
    setSidePaddingsRem$1({ top: s, bottom: r, right: 0, left: 0 }));
}
...
const initializeModelWithContext =
    ...
    (t, s, r) => {
      ...
      function a(a) {
        ...
        const [g, h] = reactExports.useState(() => x(E, i, m));
        return (
          reactExports.useEffect(() => {
            f.current ? h(x(E, i, m)) : (f.current = !0);
...
function Atlas(e) {
  ...
  if (!t)
    return (
      console.error(`Error in Atlas: Frame for icon "${e.icon}" not found in path "${e.path}"`),
      null
    );
    ...
    return (i = {}) => {
      const { settings: u = defaultSettings } = i,
        ...
        y = reactExports.useCallback(
          ...
          [f.scrollPosition, h, p, l],
        ),
        v = reactExports.useCallback(
          function () {
            const e = d.current;
            e && (g(o(e, f.scrollPosition.goal), { immediate: !0 }), p.trigger("resizeHandled"));
          },
    ...
    _ = reactExports.useCallback(
      (u) => {
        ...
        if (f) a({ pending: !0, offset: x.occurredEvent - x.thumb.start });
          ...
          ((x.occurredEvent > x.thumb.start ? Direction.Prev : Direction.Next) === Direction.Next
            ? d
            : m)(u);
        } else {
          ...
          onMouseEnter:
            ...
            (e) => {
              (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                ...
                (x.current.timeoutId = window.setTimeout(
                  E,
...
async function loadPlugin(e) {
  ...
  try {
    ...
    if (!is(schema, n)) throw new Error(`Not is plugin ${e}`);
    const a = await n.default.plugin({ id: s, url: e });
    return (
      plugins.set(s, a),
      r.resolve(a),
      {
        ...
        init: a.init,
        destroy: async () => {
          (plugins.delete(s), await a.destroy());
        },
      }
    );
  } catch (n) {
...
const NEW_STATE = "new",
  ...
  PerkSchema = object({
    name: string(),
    state: union(Object.values(perkStates).map((e) => literal(e))),
  }),
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      jsxRuntimeExports.jsx(FormatText, {
        ...
        formatters: r,
        className: m?.text,
        style: { ...x, visibility: h ? "hidden" : void 0 },
      }),
      jsxRuntimeExports.jsx("div", {
        ref: g,
...
function useLoadPlugin(e, t = []) {
  const [s, r] = reactExports.useState({ status: "loading" }),
    n = reactExports.useRef(t);
  return (
    reactExports.useEffect(() => {
      const t = (async function () {
        try {
          const t = await loadPlugin(e),
            s = await t.init(...n.current);
          return (r({ status: "loaded", result: s, instance: t }), t);
        } catch (t) {
...
function SliderProvider({
  ...
  const g = useEvent(function (t) {
      const s = f(i + e * Math.sign(t.deltaY));
      x(i, s, t);
    }),
    h = useEvent(function (e, t) {
...
export {
  ...
  NUMBERS_ALPHABET as dH,
  upgradeLegacy as dI,
  createMockControls as dJ,
