...
const b = { integral: 0, gold: 1 },
  ...
  v = Object.keys(b),
  E = Object.keys(y);
const L = { full: x.FullTime, short: x.ShortTime };
const C = {
...
function F(e, t, n) {
  ...
  return i && "function" == typeof i[s] ? (t ? i[s](t) : i[s]()) : void 0;
}
class T {
  ...
  pluralOr(e, t, n, r = "silent") {
    const s = e.startsWith("R.strings") ? e : p(this.prefix, e),
      i = F(s, t, e.startsWith("R.strings") ? window : this.root);
    return void 0 === i ? ("silent" !== r && w(`Resource not found: ${s}`, r), n()) : i;
  }
...
g.register({
  ...
  images: r(() => new _(window.R.images.gui.maps.icons)).singleton(),
  atlases: r(() => new _(window.R.atlases)).singleton(),
...
const k = N("clientResized"),
  $ = N("self.onScaleUpdated"),
  S = N("clientMinimized"),
      ...
      (t[n] = (function (t) {
        return (n) => {
          ...
          return (
            ...
            r(),
            () => {
              (i(), window.removeEventListener(s, o), (e.listeners -= 1), r());
            }
          );
        };
      })(n)),
...
const H = { highlight: "highlight", click: "play", yes1: "yes1" },
  V = { ...Object.keys(H).reduce((e, t) => ((e[t] = () => O(H[t])), e), {}), sound: O },
...
const Z = (e) => {
  ...
  Y = {
    tooltip: {
      open(e, t, n = 0, r) {
        (W(U, { contentID: t, decoratorID: n, targetID: e, isMouseEvent: !0, on: !0, args: r }),
          G.set(`${e}-${t}`, { targetID: e, contentID: t }));
      },
      hide(e, t, n = 0) {
        (W(U, { contentID: t, decoratorID: n, targetID: e, on: !1 }), G.delete(`${e}-${t}`));
      },
      hideAll() {
...
function ee(
  ...
  return {
    ...
    dispose: function () {
      if (0 === t || window.subViews.ids().includes(t)) for (const e of i.keys()) u(e);
      a.then((e) => e());
    },
    unsubscribe: u,
    events: o,
        ...
        (self.fetch = function (t, n) {
          ...
          return (
            ...
            new fetch.Promise(function (t, n) {
              ...
              ("cors" === s.credentials && (i.withCredentials = !0),
...
const pe = ["I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CD", "D", "CM", "M"],
  ...
  _e = [void 0, "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X"];
function xe(e, t, n) {
...
const Le = new Set(["zh_cn", "zh_sg", "zh_tw", "ja", "ko", "th"]);
const Ce = s.createContext(void 0);
const Fe = "extraSmall",
  Te = {
...
var De,
  ...
  Me,
  Ie =
    (((De = Ie || {})[(De.Small = Te.small.width)] = "Small"),
    (De[(De.Medium = Te.medium.width)] = "Medium"),
    (De[(De.Large = Te.large.width)] = "Large"),
    (De[(De.ExtraLarge = Te.extraLarge.width)] = "ExtraLarge"),
    De),
  Ne =
    (((Ae = Ne || {})[(Ae.Small = Te.small.width)] = "Small"),
    (Ae[(Ae.Medium = Te.medium.width)] = "Medium"),
    (Ae[(Ae.Large = Te.large.width)] = "Large"),
    (Ae[(Ae.ExtraLarge = Te.extraLarge.width)] = "ExtraLarge"),
    Ae),
  Pe =
    (((Me = Pe || {})[(Me.Small = Te.small.height)] = "Small"),
    (Me[(Me.Medium = Te.medium.height)] = "Medium"),
    (Me[(Me.Large = Te.large.height)] = "Large"),
    (Me[(Me.ExtraLarge = Te.extraLarge.height)] = "ExtraLarge"),
    Me);
const Re = Object.values(Te);
function ke(e, t) {
...
const $e = () => {
  ...
  return (function (e, t, n) {
    const r = Re.reduce(
      ...
      i = r[s],
      o = i.names[i.names.length - 1] ?? Fe,
      a = Te[o],
      l = r.width.names,
      c = r.height.names,
      u = l[l.length - 1] ?? Fe,
      d = c[c.length - 1] ?? Fe,
      h = { width: Te[u].width, height: Te[d].height };
    return {
      mediaClass: ke(s, r),
      breakpoint: a,
      screenWidthRem: e,
...
function Se({ children: e }) {
  ...
  return (
    ...
    i.jsx(Ce.Provider, { value: t, children: e })
  );
}
function Be() {
  return (function () {
...
function Oe({ children: e, className: t, ...n }) {
  ...
  return i.jsx("div", {
    className: o(t, "media-wrapper", r, s && "media-upscale"),
    ...n,
    children: e,
  });
}
function He({ children: e, ...t }) {
  return i.jsx(Se, { children: i.jsx(Oe, { ...t, children: e }) });
}
function Ve(e, t) {
  return (function (e, t, n) {
...
function ze(e) {
  ...
  return (
    ...
    s.useCallback((...e) => (0, t.current)(...e), Ue)
  );
}
function Ze(e) {
  s.useEffect(e, []);
...
function qe(e, t, n, r = !1) {
  const i = le(e),
    ...
    l = s.useMemo(() => a[t].register(i, o), [a, t, i, o]);
  s.useEffect(() => l, [l]);
}
function Xe(e) {
  ...
  return i.jsx(Ye.Provider, { value: r, children: e.children });
}
const Qe = new WeakMap(),
  Je = "await",
  et = "idle",
  tt = "display";
function nt({ alert: e, body: t, header: n, note: r, hasHtmlContent: i, disabled: o }) {
  ...
  return (function ({
    ...
    const a = s.useRef({ status: et, resId: e, timeoutId: 0 }),
      [l, c] = s.useMemo(() => {
        let s = null;
        function l() {
          r ||
            ("display" === a.current.status && (Y.tooltip.hide(e, t, n), (a.current.status = et)),
            (a.current.status = Je),
            window.clearTimeout(a.current.timeoutId),
            (a.current.timeoutId = window.setTimeout(c, o)));
        }
        function c() {
          ((a.current.status = tt), Y.tooltip.open(e, t, n, i), s && Qe.set(s, d));
        }
        function u() {
          if (
            (window.clearTimeout(a.current.timeoutId),
            a.current.status === tt && Y.tooltip.hide(e, t, n),
            (a.current.status = et),
            s)
          ) {
            Qe.delete(s);
        ...
        const d = {
          ...
          show: c,
          rerun: function () {
            a.current.status !== et && (r ? d.hide() : l());
          },
        };
        return [
          d,
...
const st = {
  ...
  increaseAmount: it("cons_ammo_single_plus"),
  decreaseAmount: it("cons_ammo_single_minus"),
  increaseAmountRoll: it("cons_ammo_roll_plus"),
  decreaseAmountRoll: it("cons_ammo_roll_minus"),
  close: it("cancelcloseno"),
  "show-context-menu": it("tabb"),
  progressSimple: it("gui_hangar_progressbar_simple"),
  increaseDelta: it("gui_hangar_progressbar_delta_increase"),
  decreaseDelta: it("gui_hangar_progressbar_delta_decrease"),
  increaseDeltaMax: it("gui_hangar_progressbar_delta_max"),
  pointerGrab: it("gui_hangar_progressbar_pointer_grab"),
  pointerDrag: it("gui_hangar_progressbar_pointer_drag"),
};
function it(e) {
  return () => {
    V.sound(e);
...
function at({ severity: e = "warn", overrides: t, silent: n = !1, children: r }) {
  ...
  return i.jsx(ot.Provider, { value: a, children: r });
}
function lt() {
...
const ct = new Set(["number", "string", "boolean", "bigint", "undefined", "function"]),
  ut = new Set(["number", "string", "boolean", "bigint"]),
  dt = new Set(["Dict"]);
function ht(e, { shallow: t = !0, depth: n = 0, maxDepth: r = 32 } = {}) {
  const s = e,
    i = typeof e;
  if (n > r) throw new Error(`Too deeply nested to copy. Max is ${r}.`);
  if (ct.has(i)) return s;
  if (null === s) return s;
  const o = { depth: n + 1, maxDepth: r };
  if (Array.isArray(s)) return s.map((e) => ht(e, o));
  if ("object" === i) {
    const r = s.constructor?.name ?? "UNKNOWN";
    if (Array.isArray(e)) return e.map((e) => ht(e, o));
    if ("CoherentArrayProxy" === r) return e.map((e) => ht(e.value, o));
    if ("Dict" === r) return;
    if ("UNKNOWN" === r) return;
    ...
    const i = {};
    for (const e of Object.keys(s)) i[e] = ht(s[e], o);
    return i;
  }
  return (console.error("Incorrect value to clone model", s), s);
}
const mt = { deep: !1, equals: re },
  ft = { cloneItem: !0 },
  gt = { shallow: !1 };
class pt {
  constructor(e, t = ft) {
    ...
    for (let s = 0; s < r.length; s++) {
      const t = r[s];
      n[t] = a.box(this.takeItem(e, t), mt);
    }
    ((this._keys = a.set(new Set(r))), (this._data = a.box(n, mt)));
  }
  _data;
  _keys;
  get keys() {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      s in n
        ? null === i
          ...
          : n[s].set(i)
        : null !== i && ((n[s] = a.box(i, mt)), this._keys.add(s), this.set(n));
    }
  }
  entries() {
  ...
  takeItem(e, t) {
    const n = e.get(t);
    return this.options.cloneItem ? ht(n, gt) : n;
  }
  set = l((e) => {
    this._data.set(e);
  });
...
const wt = s.createContext({ mode: "real" }),
  _t = { equals: re, deep: !1 };
function xt(e, t, n) {
  const r = [];
  ...
  const s = (s, i, o = _t) => {
      const l = a.box(s(n(i)), o);
      return ("real" === t && e.subscribe((e) => r.push(() => l.set(s(e))), i), l);
    },
    i = (s, i) => {
  ...
  return {
    ...
    primitives: (s, i) => {
      const o = n(i);
      if (Array.isArray(s)) {
        const n = s.reduce((e, t) => ((e[t] = a.box(o[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              r.push(() =>
      ...
      }
      {
        const n = s,
          l = Object.entries(n),
          c = l.reduce((e, [t, n]) => ((e[n] = a.box(o[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              r.push(() =>
...
const bt =
    ...
    (t, n, r) => {
      ...
      function a(a) {
          ...
          w = ze((s, i, o) => {
            const l =
                "real" !== s && o
                  ...
                  : ee(i, { name: e }),
              c = (e) => ("mocks" === s ? o?.getter(e, i) : l.readByPath(e)),
              u = (e) => g.current.push(e),
              ...
              h = t({
                ...
                requires: p,
                externalModel: l,
                observableModel: xt(l, s, c),
                cleanup: u,
              }),
              m = { ...d, mode: s, model: h, externalModel: l, cleanup: u, requires: p },
              f = "mocks" === s && o?.controls ? o.controls(m) : {};
            return {
              model: h,
              controls: { ...n?.(m), ...f },
              externalModel: l,
        ...
        const [y, v] = s.useState(() => w(x, c, f));
        return (
          s.useEffect(() => {
            _.current ? v(w(x, c, f)) : (_.current = !0);
          }, [w, f, x, c?.context, c?.initializer, c?.getRoot, c?.rootId]),
          s.useEffect(
            () => () => {
          ...
          i.jsx(o.Provider, { value: y, children: u })
        );
      }
      return (
        (a.displayName = e),
...
async function Lt(
  ...
  (s && engine.enableImmediateLayout(!0),
    ...
    m.createRoot(t).render(i.jsx(o, { children: i.jsx(Xe, { children: e }) })),
    r &&
      (!(function (e) {
        function t() {
...
function kt(e) {
  ...
  return (function (e, t, n) {
    ...
    t,
    (e, t) => e && i.jsx("span", { children: e }, `${e}${t}`),
  );
}
function $t(e) {
  return Array.isArray(e)
    ? (function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n],
            o = e[n + 1];
          if ("string" != typeof o || !Rt.test(o)) {
            t.push($t(r));
            continue;
          }
          const a = kt(o.slice(1));
          (t.push(
            i.jsxs(
              s.Fragment,
              { children: [i.jsxs("span", { className: Mt.nowrap, children: [$t(r), o[0]] }), a] },
              Pt(),
            ),
          ),
            (n += 1));
    ...
    : "string" == typeof e
      ? i.jsx(s.Fragment, { children: kt(e) }, Pt())
      : e;
}
const St = {
  class: function (e, ...t) {
  ...
  colorLegacy: function (e, t) {
    const n = Pt();
    return It.has(String(t))
      ? i.jsx("span", { className: `FormatText_colorLegacy__${t}`, children: e }, n)
      : i.jsx("span", { style: { color: `#${t}` }, children: e }, n);
  },
...
function Bt(e, t, n, r) {
  const s = n.map((t) => {
      ...
      if (n.startsWith("(") && n.endsWith(")")) {
        ...
        return t ? Bt(e, t, s, r) : e;
      }
      return n.startsWith("'") && n.endsWith("'") ? n.slice(1, -1) : n;
    }),
    i = r[t];
  return i ? i(e, ...s) : (console.error(`Function ${t} is not registered`), e);
}
function Ot(e, t, n) {
  return e.reduce((e, t) => {
...
function Vt(e, t) {
  for (let n = 0; n < e.length; n++) {
    if ("$" === e[n]) {
      let r = n + 1;
      for (; r < e.length && !Ht(e[r]);) r++;
      const s = e.slice(n + 1, r),
        i = t[s];
      if (i) return Vt(e.replace(`$${s}`, String(i)), t);
    }
  }
  return e;
}
...
function Ut(e, t, n = {}, r = !0) {
  ...
  for (const l of e)
    if (l.type === Tt) a(l.value);
    else if (l.type === At)
      null === n[l.name] || Kt.includes(typeof n[l.name])
        ? a(n[l.name] ?? `{{${l.name}}}`)
        : o.push(i.jsx(s.Fragment, { children: n[l.name] }, `var-${l.name}-${l.instanceId}`));
    else if (l.type === Dt) {
      const e = Ut(l.children, t, n, !1),
        r = Ot(jt(l.attrs, n), e, t);
      o.push(r);
    }
  return o;
}
...
const Gt = { start: "{{", end: "}}" },
  Yt = s.memo(function (e) {
    const {
      ...
      f = s.useMemo(() => (e.formatters ? { ...St, ...e.formatters } : St), [e.formatters]),
      g = s.useMemo(
        () =>
          (function (e, t) {
            const n = [],
      ...
      p = s.useMemo(() => Ut(g, f, e.params), [g, f, e.params]),
      w = o(Mt.base, l && Mt.base__fullSize, h.className);
    return e.inline
      ? (console.warn(
      ...
      : i.jsx("span", { ...h, className: w, children: p });
  });
function qt({ path: e, ...t }) {
  return i.jsx(Yt, { text: g.resolve("strings").readOrEmpty(e), ...t });
}
const Xt = "TruncateText_dcb41d92",
  Qt = s.forwardRef(function ({ text: e, tooltipParams: t, className: n, ...r }, a) {
    const l = nt({ header: t?.header, body: t?.body || e }),
      c = s.useRef(null),
      [u, d] = s.useState(!1),
      h = s.useCallback(() => {
        c.current &&
          d(c.current.scrollWidth - Math.ceil(c.current.getBoundingClientRect().width) > 0);
      }, []);
    var m, f;
    return (
      s.useEffect(() => {
      ...
      i.jsx("div", { ...r, ref: vt([a, c]), className: o(Xt, n), ...(u ? l : {}), children: e })
    );
  });
function Jt(e, t, n) {
  ...
  const a = f(t, n),
    l = s.forwardRef(function (t, n) {
      return i.jsx("div", { "data-name": e, ...en(o, t), ref: n, className: a(t) });
    });
...
function nn(e) {
  ...
  return s.forwardRef(function (e, n) {
    const r = Ve(e, e.adaptive),
      { path: s, ...o } = r,
      a = r.images ?? g.resolve("images"),
      l = { ...o, ref: n };
    {
      const e = s ? a.readOr(s, tn, "warn") : void 0;
      return e ? i.jsx(t, { ...l, src: e }) : i.jsx(t, { ...l, unknown: !0 });
    }
  });
}
const rn = {
...
nn(
  s.forwardRef(function (e, t) {
    ...
    return e.unknown
      ? i.jsx("div", { ...c, style: { width: e.width, height: e.height, ...l } })
      : i.jsx("img", { ...c, ref: t, src: s, width: n, height: r });
  }),
);
const on = { x24x24: "24x24", x32x32: "32x32", x48x48: "48x48" },
  an = {
    [on.x24x24]: "library.gray_eye_24x24",
    [on.x32x32]: "library.gray_eye_32x32",
    [on.x48x48]: "library.gray_eye_48x48",
  },
  ln = {
    [on.x24x24]: { width: "24rem", height: "24rem" },
    [on.x32x32]: { width: "32rem", height: "32rem" },
    [on.x48x48]: { width: "48rem", height: "48rem" },
  },
  cn = Jt("PlayerInfoAnonymizer", { element: sn }),
  un = s.forwardRef(function (
    {
      size: e,
      path: t = an[e],
      width: n = ln[e].width,
      height: r = ln[e].height,
      className: s,
      ...o
    },
    a,
  ) {
    return i.jsx(cn, { ...o, ref: a, path: t, width: n, height: r, className: s });
  });
un.sizes = on;
const dn = {
  ...
  hn = { x24x24: "24x24", x48x48: "48x48", x80x80: "80x80" },
  mn = {
    [hn.x24x24]: { width: "24rem", height: "24rem" },
    [hn.x48x48]: { width: "48rem", height: "48rem" },
    [hn.x80x80]: { width: "80rem", height: "80rem" },
  },
  fn = Jt("PlayerInfoBadge", { element: sn }),
  gn = s.forwardRef(function (
    {
      size: e,
      badgeId: t,
      path: n = `library.badges.c_${e}.badge_${t}`,
      width: r = mn[e].width,
      height: s = mn[e].height,
      className: a,
      ...l
    },
    c,
  ) {
    return i.jsx(fn, { ...l, ref: c, path: n, width: r, height: s, className: o(dn.badge, a) });
  });
gn.sizes = hn;
const pn = { x64x28: "64x28", x34x16: "34x16", x26x16: "26x16", x10x10: "10x10" },
  wn = {
    [pn.x10x10]: "library.premium_igr_ico",
    [pn.x26x16]: "library.premium_igr_small",
    [pn.x34x16]: "library.premium_small",
    [pn.x64x28]: "library.premium_igr_big",
  },
  _n = {
    [pn.x10x10]: { width: "10rem", height: "10rem" },
    [pn.x26x16]: { width: "26rem", height: "16rem" },
    [pn.x34x16]: { width: "34rem", height: "16rem" },
    [pn.x64x28]: { width: "64rem", height: "28rem" },
  },
  xn = Jt("PlayerInfoIgr", { element: sn }),
  bn = s.forwardRef(function (
    {
      size: e,
      path: t = wn[e],
      width: n = _n[e].width,
      height: r = _n[e].height,
      className: s,
      ...o
    },
    a,
  ) {
    return i.jsx(xn, { ...o, ref: a, path: t, width: n, height: r, className: s });
  });
bn.sizes = pn;
const yn = { default: "default", regular: "regular", medium: "medium", big: "big" },
  vn = {
    [yn.default]: "c_64x24",
    [yn.regular]: "c_68x28",
    [yn.medium]: "c_68x28",
  ...
  Ln = {
    [yn.default]: { width: "24rem", height: "24rem", marginLeft: "-15rem" },
    [yn.regular]: { width: "32rem", height: "32rem", marginLeft: "-19rem" },
    [yn.medium]: { width: "48rem", height: "48rem", marginLeft: "-32rem" },
    [yn.big]: { width: "80rem", height: "80rem", marginLeft: "-25rem" },
  },
  Cn = Jt("StripeBadgeIcon", { element: sn }),
  Fn = s.forwardRef(function (
    {
      size: e = yn.default,
      badgeId: t,
      stripeExists: n,
      path: r = `library.badges.${En[e]}.badge_${t}`,
      width: s = Ln[e].width,
      height: o = Ln[e].height,
      marginLeft: a = Ln[e].marginLeft,
      className: l,
      ...c
    },
    u,
  ...
  Tn = {
    [yn.default]: { width: "64rem", height: "24rem" },
    [yn.regular]: { width: "68rem", height: "24rem" },
    [yn.medium]: { width: "68rem", height: "28rem" },
    [yn.big]: { width: "100rem", height: "40rem" },
  },
  Dn = Jt("StripeIcon", { element: sn }),
  An = s.forwardRef(function (
    {
      size: e = yn.default,
      badgeId: t,
      stripeExists: n,
      path: r = `library.badges.strips.${vn[e]}.strip_${t}`,
      width: s = Tn[e].width,
      height: a = Tn[e].height,
      className: l,
      ...c
    },
    u,
    ...
    return n
      ? i.jsx(Dn, { ...c, ref: u, path: r, width: s, height: a, className: o(dn.stripeBadge, l) })
      : null;
  }),
  Mn = { badge: Ln, stripe: Tn },
  In = Jt("PlayerInfoStripe", dn.stripe),
  Nn = s.forwardRef(function (
    {
      size: e = yn.default,
      badgeId: t,
      classNames: n,
    ...
    const u = g.resolve("images"),
      d = vn[e],
      h = u.has(`library.badges.strips.${d}.strip_${t}`);
    return i.jsxs(In, {
      ...l,
      ref: c,
      className: o(h && dn[`stripe__${e}`], r),
      children: [
        i.jsx(An, {
          size: e,
          badgeId: t,
...
((Nn.sizes = yn), (Nn.icons = Mn));
const Pn = Jt("AccountInfo", dn.base),
  Rn = Jt("AccountInfoWrapper", dn.base),
  kn = s.forwardRef((e, t) => i.jsx(Pn, { ref: t, ...e }));
((kn.Name = function ({ size: e, className: t, children: n }) {
  return i.jsx("div", { className: o(dn.name, e && dn[`name__${e}`], t), children: n });
}),
  (kn.ClanTag = function ({ size: e, className: t, children: n, ...r }) {
    return i.jsx("div", {
      ...r,
      className: o(dn.clanTag, e && dn[`clanTag__${e}`], t),
      children: n,
    });
  }),
  (kn.Badge = gn),
  (kn.IgrIcon = bn),
  (kn.AnonymizerIcon = un),
  (kn.Stripe = Nn),
  (kn.Wrapper = Rn));
const $n = "gold",
  Sn = "enamel",
...
function Vn(e, t, n) {
  return t === Bn ? `.c_${On[n]}.${t}` : `.c_${On[n]}.${t}.c_${e}`;
}
const jn = {
...
function Kn({ level: e, type: t, size: n, classNames: r, ...s }) {
  ...
  return i.jsx("div", {
    ...
    children: a.map((e, s) =>
      i.jsx(
        sn,
        {
          className: o(jn.levelIcon, jn[`levelIcon__${n}`], r?.levelIcon),
          path: `prestige.emblemFont.c_${Hn[n]}.${t === Sn ? $n : t}.c_${e}`,
        },
        s,
      ),
    ),
...
const Un = s.forwardRef(function (
  ...
  return e < 1
    ...
    : i.jsxs("div", {
        ...a,
        ref: l,
        className: o(jn.base, jn[`base__${r}`], s?.base),
        children: [
          i.jsx(sn, { path: `prestige.emblem${Vn(t, n, r)}`, className: o(jn.icon, s?.icon) }),
          n !== Bn &&
            i.jsx(Kn, { level: e, type: n, size: r, classNames: { levelIcon: s?.level } }),
        ],
      });
});
Un.sizes = { xs: "xs", sm: "sm", md: "md", mdLg: "mdLg", lg: "lg", xl: "xl", xxl: "xxl" };
const zn = s.forwardRef(function (
    {
      src: e,
      className: t,
      autoplay: n = !1,
    ...
    return (
      ...
      s.useEffect(
        () =>
          fe(() => {
            const e = m.current;
            if (!h || !e || !a) return void (e?.cohFastSeek && (e.cohFastSeek = !1));
      ...
      s.useEffect(() => {
        if (h && m.current) {
          const e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: ne },
            t = () => {
              let t = 0;
                  ...
                  s.forEach((t, r) => {
                    void 0 !== s[r] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        const n = Object.keys(l ?? {})[r];
                        return e({ time: t, name: `${l ? n : `Point_${r}`}` });
                      });
                  });
                }
              });
            ...
            o = (e) => {
              ...
              m.current &&
                (m.current.currentTime =
                  ((t = 0), (n = m.current.duration), (r = e) < t ? t : r > n ? n : r));
            },
            c = () => m.current?.play(),
            u = () => m.current?.pause(),
            d = () => {
      ...
      i.jsx("video", { src: e, className: t, style: r, loop: o, ref: m, onClick: c, ...u })
    );
  }),
  Zn = s.memo(zn),
  Wn = {
  ...
  er = "break",
  tr = "scout",
  nr = "VehicleLevel_3c938122",
  rr = { arabic: "arabic", roman: "roman" };
const sr = s.forwardRef(function ({ value: e, numberType: t, ...n }, r) {
  const s = (function (e, t) {
      return e || (t ? rr.arabic : rr.roman);
    })(
      t,
      (function () {
        const e = g.resolve("strings");
        return rt.includes(e.readOrEmpty("settings.LANGUAGE_CODE"));
      })(),
    ),
    a =
      s === rr.roman
        ? (function (e) {
            if (e <= 10) return _e[e] ?? String(e);
            let t = "";
            for (let n = we.length - 1; n >= 0; n--) {
              let r = we[n];
...
const ir = "prestige",
  ...
  ar = "medium",
  lr = "long",
  cr = (e) => (e < 10 ? or : e < 100 ? ar : lr),
  ur = (e, t, n) => (t === ir ? ir : `${t}.${cr(e)}.c_${n}`),
  dr = {
...
function hr({ level: e, grade: t, type: n, direction: r, classNames: s, ...a }) {
  return e < 1 || "undefined" === n
    ? null
    : i.jsxs("div", {
        ...a,
        className: o(dr.base, dr[`base__${n}`], dr[`base__${r}`], a.className, s?.base),
        children: [
          i.jsx(sn, { path: `prestige.tab.${ur(e, n, t)}`, className: o(dr.icon, s?.icon) }),
          n !== ir &&
            i.jsx("div", { className: o(dr.level, dr[`level__${cr(e)}`], s?.level), children: e }),
        ],
      });
}
hr.direction = { left: "left", right: "right" };
const mr = {
    [`${qn}_x16x16`]: (e) =>
      s.createElement(
        "svg",
  ...
  gr = { x16x16: "x16x16", x24x24: "x24x24", x32x32: "x32x32", x48x48: "x48x48" },
  pr = s.forwardRef(function ({ roleKey: e, size: t = gr.x24x24, classNames: n, ...r }, s) {
    const a = mr[`${e}_${t}`];
    if (a)
      return i.jsx("div", {
        ...r,
        ref: s,
        className: o(fr.base, fr[`base__${t}`], n?.base),
        children: i.jsx(a, { className: o(fr.icon, n?.icon) }),
      });
    console.error(`Unknown vehicle role type ${e} with size ${t}`);
  });
pr.sizes = gr;
const wr = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
  _r = { x24x24: "x64x64", x48x48: "x96x96", x64x64: "x96x96", x96x96: "x96x96" },
  xr = {
    [Wn.lightTank]: "light_tank",
    [Wn.mediumTank]: "medium_tank",
    [Wn.heavyTank]: "heavy_tank",
    [Wn.SPG]: "spg",
    [Wn["AT-SPG"]]: "tank_destroyer",
  },
  br = {
  ...
  yr = s.forwardRef(function (
    { type: e, size: t = wr.x48x48, premium: n = !1, fit: r = "contain", ...s },
    a,
  ) {
    const l = Ke(wr[t], _r[t]);
    return i.jsx(sn, {
      ...s,
      ref: a,
      fit: r,
      className: o(br.base, n ? br[`base__premium__${t}`] : br[`base__${t}`], s.className),
      path: `ui_kit.vehicle_type.${l}.${n ? "premium_" : ""}${((c = xr[e]), c.replaceAll("-", "_"))}_${l}`,
    });
    var c;
  });
((yr.types = Wn), (yr.sizes = wr));
const vr = "VehicleInfo_1732f1f0",
  Er = Jt("VehicleName", "VehicleInfo_name_3989ca04", {
    variants: { premium: { true: "VehicleInfo_name__premium_258b3b93" } },
  }),
  Lr = s.forwardRef(function (e, t) {
    return i.jsx("div", { ...e, ref: t, className: o(vr, e.className) });
  });
((Lr.Prestige = hr), (Lr.Level = sr), (Lr.Type = yr), (Lr.Name = Er), (Lr.Role = pr));
const Cr = g.resolve("strings"),
  Fr = g.resolve("intl"),
  Tr = (e) => Fr.toUpperCase(Cr.readOr(`readable_key_names.KEY_${e}`, () => Dr)),
  Dr = Fr.toUpperCase(Cr.readOrEmpty("readable_key_names.KEY_NONE_ALT")),
  Ar = {
    [oe.NONE]: Tr("NONE_ALT"),
    [oe.ESCAPE]: Tr("ESCAPE"),
    [oe.ENTER]: Tr("ENTER"),
    [oe.SPACE]: Tr("SPACE"),
    [oe.DELETE]: Tr("DELETE"),
    [oe.BACKSPACE]: Tr("BACKSPACE"),
    [oe.TAB]: Tr("TAB"),
    [oe.HOME]: Tr("HOME"),
    [oe.END]: Tr("END"),
    [oe.MINUS]: Tr("MINUS"),
    [oe.SLASH]: Tr("SLASH"),
    [oe.BACKSLASH]: Tr("BACKSLASH"),
    [oe.PERIOD]: Tr("PERIOD"),
    [oe.COMMA]: Tr("COMMA"),
    [oe.QUOTE]: Tr("APOSTROPHE"),
    [oe.SEMICOLON]: Tr("SEMICOLON"),
    [oe.INSERT]: Tr("INSERT"),
    [oe.KEY_A]: Tr("A"),
    [oe.KEY_B]: Tr("B"),
    [oe.KEY_C]: Tr("C"),
    ...
    [oe.DIGIT_8]: Tr("8"),
    [oe.DIGIT_9]: Tr("9"),
    [oe.NUMPAD_0]: Tr("NUMPAD0"),
    [oe.NUMPAD_1]: Tr("NUMPAD1"),
    [oe.NUMPAD_2]: Tr("NUMPAD2"),
    [oe.NUMPAD_3]: Tr("NUMPAD3"),
    [oe.NUMPAD_4]: Tr("NUMPAD4"),
    [oe.NUMPAD_5]: Tr("NUMPAD5"),
    [oe.NUMPAD_6]: Tr("NUMPAD6"),
    [oe.NUMPAD_7]: Tr("NUMPAD7"),
    [oe.NUMPAD_8]: Tr("NUMPAD8"),
    [oe.NUMPAD_9]: Tr("NUMPAD9"),
    [oe.F_1]: Tr("F1"),
    [oe.F_2]: Tr("F2"),
    [oe.F_3]: Tr("F3"),
    [oe.F_4]: Tr("F4"),
    ...
    [oe.F_11]: Tr("F11"),
    [oe.F_12]: Tr("F12"),
    [oe.NUMPAD_MULTIPLY]: Tr("NUMPADSTAR"),
    [oe.NUMPAD_DIVIDE]: Tr("NUMPADSLASH"),
    [oe.NUMPAD_ADD]: Tr("ADD"),
    [oe.NUMPAD_SUBTRACT]: Tr("NUMPADMINUS"),
    [oe.NUMPAD_DECIMAL]: Tr("NUMPADPERIOD"),
    [oe.ARROW_LEFT]: Tr("LEFTARROW"),
    [oe.ARROW_RIGHT]: Tr("RIGHTARROW"),
    [oe.ARROW_UP]: Tr("UPARROW"),
    [oe.ARROW_DOWN]: Tr("DOWNARROW"),
    [oe.PAGE_UP]: Tr("PGUP"),
    [oe.PAGE_DOWN]: Tr("PGDN"),
    [oe.BRACKET_LEFT]: Tr("LBRACKET"),
    [oe.BRACKET_RIGHT]: Tr("RBRACKET"),
  },
  Mr = s.createContext(void 0);
function Ir() {
  const e = s.useContext(Mr);
  if (!e) throw new Error("useKeyButtonContext must be used within KeyButtonContext");
  return e;
}
const Nr = "KeyButton_background_8a852f95",
  Pr = "KeyButton_border_b1c50f01",
  Rr = "KeyButton_8fd343f8",
  kr = "KeyButton_content_3ab1d990",
  $r = Jt("KeyButton", Rr);
function Sr({ children: e, onClick: t, onMouseEnter: n, ...r }) {
  const s = lt(),
    { soundTarget: o, silent: a } = Ir();
  return i.jsx($r, {
    ...r,
...
function Br({ keyCode: e, onActive: t, silent: n, soundTarget: r, idle: o, children: a }) {
  !(function (e, t, n = !1) {
    qe(le(e), "keyup", t, n);
  })(o ? oe.NONE : le(e), t);
  const l = s.useMemo(
  ...
  return i.jsx(Mr.Provider, { value: l, children: a });
}
const Or = function ({
  keyCode: e,
  onActive: t = ne,
  ...
  return i.jsx(Br, {
    ...
    children: i.jsxs(Sr, {
      ...u,
      className: o(Rr, l, a?.base),
      children: [
        i.jsx("div", { className: o(Nr, a?.background) }),
        i.jsx("div", { className: o(Pr, a?.border) }),
        i.jsx("div", { className: o(kr, a?.content), children: c }),
      ],
    }),
  });
};
Or.Code = function () {
  const { keyCode: e } = Ir(),
    t = le(e);
  if (t === oe.NONE) return Dr;
  const n = ((r = t), window.systemInput.getQWERTYScanCode(r));
  var r;
  const s = ((i = n), window.systemInput.getCurrentLayoutKeyName(i));
  var i;
  return s in Ar
    ? Ar[s]
    : (console.error(
