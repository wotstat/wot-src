              ...
              (e[F] = (function (e) {
                return (F) => {
                  ...
                  return (
                    ...
                    () => {
                      t &&
                        (E(), window.removeEventListener(n, o), (u.listeners -= 1), A(), (t = !1));
                    }
                  );
                };
              })(F)),
                      ...
                      a = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = D(e);
                            if (Array.isArray(u)) {
                              const t = u.reduce((u, e) => ((u[e] = xu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  r.subscribe(
                                    (0, xu.aD)((e) => {
                            ...
                            }
                            {
                              const t = u,
                                n = Object.entries(t),
                                E = n.reduce((u, [e, F]) => ((u[F] = xu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  r.subscribe(
                                    (0, xu.aD)((u) => {
