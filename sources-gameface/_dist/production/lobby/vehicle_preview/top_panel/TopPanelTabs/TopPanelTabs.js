    ...
    e = {
      941: (u, e, t) => {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (a(), window.removeEventListener(i, A), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                i = Object.entries(r),
                                a = i.reduce((u, [e, t]) => ((u[t] = _u.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, _u.aD)((u) => {
        ...
        class Ju extends A.Component {
          ...
          componentDidMount() {
            ...
            const t =
              ...
              this._getFirstTabKey(F().Children.toArray(u[e].props.children));
                        ...
                        : { isFirst: 0 === e, isLast: e === r.length - 1 },
                      {
                        ...
                        onMouseEnter: (u) => {
                          (n[e].onMouseEnter && n[e].onMouseEnter(u),
                            this.props.onMouseEnterSound && Vu(this.props.onMouseEnterSound));
                        },
                      },
                    ),
                  ),
        ...
        const ae = (u) => {
          ...
          Ae = ({ children: u, component: e, props: t = {} }) =>
        ...
        const _e = R.strings.vehicle_preview.topPanel.tab,
          ...
          Oe = () =>
            F().createElement(pu, null, F().createElement(Iu, null, F().createElement(Le, null)));
        engine.whenReady.then(() => {
