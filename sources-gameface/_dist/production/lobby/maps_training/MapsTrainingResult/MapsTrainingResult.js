  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (i(), window.removeEventListener(s, o), (u.listeners -= 1), n(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      633: (u, e, t) => {
        ...
        const Q = (u, e, t) =>
            y()(
              u,
              t >= Z.TitleAndRewards && e.base__animTitleAndRewards,
              t >= Z.Done && e.base__done,
            ),
          J = {
        ...
        const eu = (0, n.memo)(
            ({ value: u, label: e, icon: t, index: s, animState: r, all: i }) => {
              ...
              return a().createElement(
                ...
                a().createElement(
                  ...
                  void 0 !== i &&
                    i > 0 &&
                    a().createElement("div", { className: J.valueAll }, ` / ${i}`),
                ),
        ...
        const vu = (u, e, t = {}, n = 0) => {
          ...
          Lu = {
            [j.Undone]: Nu.title.lose(),
            [j.PartialDone]: Nu.title.partial(),
            [j.Done]: Nu.title.win(),
          },
          Iu = () => {
            const u = k("model"),
