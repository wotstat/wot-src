      ...
      980: (e, t, u) => {
          ...
          Ge = ve()(
            ({ observableModel: e }) => {
              const t = Object.assign(
                ...
                r = (0, ye.Om)(() =>
                  Re(t.tabs.get(), (e) =>
                    e.hasNewItems
                      ? {
                          id: e.collectionName,
                          title: se(R.strings, `collection_${e.collectionName}.collection.season`),
                ...
                g = (0, ye.Om)((e) => Te(t.rewardsInfo.get(), (t) => t.requiredItemsCount === e), {
                  equals: Fe,
                }),
                c = (0, ye.Om)(
                  (e) => {
        ...
        const Ot = {
          ...
          Mt = (0, X.Pi)(() => {
            ...
            return a().createElement(
              "div",
              { className: F()(Pt.base, Pt.base__wide) },
              e.map((e, u) =>
                a().createElement(
                  "div",
                  { className: Pt.rewardWrapper, key: u },
                  a().createElement(
                    Tt,
                    yt({}, e, {
                      size: Ot[t],
                      ...
                      classNames: {
                        info: F()(
                          e.valueType !== J.MULTI
                            ? Pt.infoLabel
                            : F()(Pt.infoCount, Pt[`infoCount__${Ot[t]}`]),
                        ),
                      },
                    }),
                  ),
                  e.valueType !== J.CURRENCY &&
                    a().createElement(
                      "div",
                      { className: F()(Pt.label, Pt[`label__${e.name}`], Pt[`label__${Ot[t]}`]) },
                      e.label,
                    ),
                ),
              ),
