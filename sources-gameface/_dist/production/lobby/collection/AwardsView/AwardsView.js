(() => {
  var __webpack_modules__ = {
      ...
      828: (e, t, u) => {
        "use strict";
        u.d(t, { B3: () => l, Z5: () => n.Z5, B0: () => o, ry: () => p, Sy: () => f });
        class i {
          constructor() {
            ((this.entries = []),
              (this._listenMouse = !1),
      ...
      909: (e, t, u) => {
        ...
        const C = {
          ...
          b = (e) => {
            ...
            const r = F(),
              ...
              o = r.mediaHeight,
              l = r.mediaSize;
            return a().createElement("div", D({ className: m()(u, C[n], B[o], v[l]) }, i), t);
          },
          S = ["children"];
        const x = (e) => {
          let t = e.children,
        ...
        const I = (e) => {
          ...
          const D = (0, i.useCallback)(
              (e) => {
                (null == l || l(e), n.O.sound.play.sound(_));
              },
              [l, _],
            ),
            C = (0, i.useCallback)(
              ...
              const h = (0, i.useRef)([]),
                d = (u, i, a) => {
                  ...
                  const o = (function ({
                    ...
                    c = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const i = s(t);
                          if (Array.isArray(e)) {
                            const a = e.reduce((e, t) => ((e[t] = se.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                l.subscribe(
                                  (0, se.aD)((t) => {
                          ...
                          }
                          {
                            const a = e,
                              r = Object.entries(a),
                              n = r.reduce((e, [t, u]) => ((e[u] = se.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                l.subscribe(
                                  (0, se.aD)((e) => {
                    ...
                    g = { mode: u, model: c, externalModel: l, cleanup: d };
                  return {
                    model: c,
                ...
                m = g[0],
                E = g[1],
                A = (0, i.useState)(() => d(r, o, s)),
                p = A[0],
                _ = A[1];
              return (
                (0, i.useEffect)(() => {
                  c.current ? _(d(m, o, s)) : (c.current = !0);
                }, [s, m, o]),
                (0, i.useEffect)(() => {
                  E(r);
                }, [r]),
          ...
          xe = ge()(
            ({ observableModel: e }) => {
              const t = Object.assign(
                ...
                l = (0, we.Om)(() => a().pages[o()].pageItems, { equals: le }),
                s = (0, we.Om)(() => {
                  const e = t.root.get().currentCollection;
                  return !be[De(e)] || e === Se;
                }),
        ...
        const At = ({ children: e, tooltipArgs: t, className: u }) => {
            ...
            const r = t.contentId;
            return r
              ? a().createElement(ot, Et({}, t, { contentId: r }), i)
              ...
              a().createElement(
                ...
                a().createElement(
                  ...
                  l &&
                    a().createElement(
                      "div",
                      { className: m()(pt.title, null == d ? void 0 : d.title) },
                      l,
                    ),
                ),
              ),
