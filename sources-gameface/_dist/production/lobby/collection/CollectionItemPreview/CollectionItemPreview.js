      ...
      252: (e, t, u) => {
        ...
        const N = (e) => {
          ...
          return n().createElement(
            ...
            i &&
              n().createElement("div", { className: F()(k.goto, null == a ? void 0 : a.goto) }, i),
          );
        };
        var U = u(20),
          I = u(828);
                    ...
                    d = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const i = s(t);
                          if (Array.isArray(e)) {
                            const a = e.reduce((e, t) => ((e[t] = q.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                o.subscribe(
                                  (0, q.aD)((t) => {
                          ...
                          }
                          {
                            const a = e,
                              r = Object.entries(a),
                              n = r.reduce((e, [t, u]) => ((e[u] = q.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                o.subscribe(
                                  (0, q.aD)((e) => {
                ...
                r = (0, Ee.Om)(() =>
                  ee(t.tabs.get(), (e) =>
                    e.hasNewItems
                      ? {
                          id: e.collectionName,
                          title: be(R.strings, `collection_${e.collectionName}.collection.season`),
        ...
        function $e(e, t, u = []) {
          ...
          return [
            (0, r.useCallback)((u) => {
              (0 !== i.current && a(),
                (i.current = window.setInterval(() => e(u, !0), t)),
                e(u, !1));
            }, n),
            a,
          ];
        ...
        const Ke = {
          ...
          ct = (0, r.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = lt, onDrag: i = st }) => {
                  ...
                  ((u.style.transform = `translateX(${0 | d}px)`),
                    ((e) => {
                      if (o.current && s.current && h.current && c.current) {
                        if (0 === e)
                          return (o.current.classList.add(nt), void s.current.classList.remove(nt));
                        if (
                          ((t = h.current),
                          (u = c.current),
                          e - (t.offsetWidth - u.offsetWidth) >= -0.5)
                        )
                          return (o.current.classList.remove(nt), void s.current.classList.add(nt));
                        var t, u;
        ...
        const At = Ze({
          ...
          yt = (0, r.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = xt, onDrag: i = vt }) => {
              const a = (0, r.useRef)(null),
                o = (0, r.useRef)(null),
                s = (0, r.useRef)(null),
                h = (0, r.useRef)(null),
                ...
                D = ze(() => {
                  ...
                  ((u.style.transform = `translateY(${0 | d}px)`),
                    ((e) => {
                      if (o.current && s.current && h.current && c.current) {
                        if (0 === Math.round(e))
                          return (o.current.classList.add(wt), void s.current.classList.remove(wt));
                        if (
                          ((t = h.current),
                          (u = c.current),
                          e - (t.offsetHeight - u.offsetHeight) >= -0.5)
                        )
                          return (o.current.classList.remove(wt), void s.current.classList.add(wt));
                        var t, u;
            ...
            return n().createElement(
              ...
              n().createElement(
                "div",
                {
                  className: Kt.image,
                  style: {
                    backgroundImage: `url(${f < D.Large ? s : f === D.Large ? l : o || l})`,
                  },
                },
