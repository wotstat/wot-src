  ...
  var __webpack_modules__ = {
              ...
              (t[u] = (function (t) {
                return (u) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (n(), window.removeEventListener(a, s), (e.listeners -= 1), i(), (r = !1));
                    }
                  );
                };
              })(u)),
      ...
      73: (e, t, u) => {
                    ...
                    d = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const i = l(t);
                          if (Array.isArray(e)) {
                            const r = e.reduce((e, t) => ((e[t] = le.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                n.subscribe(
                                  (0, le.aD)((t) => {
                          ...
                          }
                          {
                            const r = e,
                              a = Object.entries(r),
                              o = a.reduce((e, [t, u]) => ((e[u] = le.LO.box(i[t], {})), e), {});
                            return (
                              "real" === u &&
                                n.subscribe(
                                  (0, le.aD)((e) => {
                ...
                a = (0, Le.Om)(() =>
                  fe(t.tabs.get(), (e) =>
                    e.hasNewItems
                      ? {
                          id: e.collectionName,
                          title: ne(R.strings, `collection_${e.collectionName}.collection.season`),
        ...
        const ht = {
          ...
          vt = (0, a.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = Bt, onDrag: i = wt }) => {
                ...
                F = it(() => {
                  ...
                  ((u.style.transform = `translateY(${0 | d}px)`),
                    ((e) => {
                      if (n.current && s.current && l.current && h.current) {
                        if (0 === e)
                          return (n.current.classList.add(Ut), void s.current.classList.remove(Ut));
                        if (
                          ((t = l.current),
                          (u = h.current),
                          e - (t.offsetHeight - u.offsetHeight) >= -0.5)
                        )
                          return (n.current.classList.remove(Ut), void s.current.classList.add(Ut));
                        var t, u;
            ...
            return o().createElement(
              ...
              o().createElement(
                "div",
                {
                  className: du.image,
                  style: {
                    backgroundImage: `url(${F < v.Large ? l : F === v.Large ? s : n || s})`,
                  },
                },
