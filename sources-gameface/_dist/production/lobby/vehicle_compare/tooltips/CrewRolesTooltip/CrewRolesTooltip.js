  ...
  var __webpack_modules__ = {
      528: (u, e, t) => {
        ...
        const b = {
          ...
          f = Object.keys(m).reduce((u, e) => ((u[e] = () => D(m[e])), u), {}),
        ...
        const lu = { view: i, client: r, sound: v, intl: h };
      },
      20: (u, e, t) => {
        t.d(e, { n: () => n });
        let n = (function (u) {
      ...
      575: (u, e, t) => {
        ...
        const b = ((u, e) => {
            ...
            return [
              function ({ mode: n = "real", options: r, children: s, mocks: c }) {
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = c(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = D.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, D.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = D.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, D.aD)((u) => {
                ...
                return (
                  (0, i.useEffect)(() => {
                    A.current ? m(E(d, r, c)) : (A.current = !0);
                  }, [c, d, r]),
                  (0, i.useEffect)(() => {
                    C(n);
                  }, [n]),
        ...
        const x = a().memo(function ({ role: u, size: e = y.c30x30, className: t }) {
            ...
            return a().createElement("div", {
              style: n,
              className: r()(w.base, w[`base__${e}`], t),
            });
          }),
          ...
          $ = "CrewRolesTooltipApp_footerText_cdd19";
        var K = t(828);
        const Y = [
          "children",
          "contentId",
              ...
              w = (0, i.useCallback)((u) => {
                m.current.isVisible &&
                  ...
                  (m.current.hideTimerId = window.setTimeout(() => {
                    ...
                    e && !e.isSameNode(m.current.prevTarget) && g();
                  }, 200)));
              }, []);
            ((0, i.useEffect)(() => {
                      ...
                      onMouseEnter:
                        ...
                        (u) => {
                          (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                            ...
                            (m.current.timeoutId = window.setTimeout(v, l ? 100 : 400)),
                            r && r(u),
                            y && y(u));
                        }),
                      onMouseLeave: ((u) => (e) => {
        ...
        const au = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(Q, iu({}, e, { contentId: r }), n)
        ...
        const Fu = {
            [Au.NBSP]: lu.NoBreakSymbol,
            [Au.ZWNBSP]: lu.NoBreakSymbol,
            [Au.NEW_LINE]: lu.LineBreak,
          },
          ...
          bu = (u) => ({ color: `#${u}` }),
          hu = ({ elementList: u, textBlock: e, key: t }) => {
            const n = e.colorTag;
            return n
              ? _u[n]
                ? a().createElement(
              ...
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: pu },
                  u,
                );
          },
          mu = {
            ...
            [lu.NewLine]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": lu.NewLine, className: Cu },
                u,
              ),
                ...
                (u) => {
                  ...
                  r === lu.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: lu.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
        ...
        engine.whenReady.then(() => {
          F().render(
            a().createElement(E, null, a().createElement(h, null, a().createElement(Vu, null))),
