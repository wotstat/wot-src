  ...
  var __webpack_modules__ = {
              ...
              (t[r] = (function (t) {
                return (r) => {
                  ...
                  return (
                    ...
                    () => {
                      i &&
                        (o(), window.removeEventListener(a, l), (e.listeners -= 1), n(), (i = !1));
                    }
                  );
                };
              })(r)),
      ...
      235: (e, t, r) => {
        ...
        function Y(e, t) {
          var r;
          if (!(t >= e.length))
            return Array.isArray(e) ? e[t] : null == (r = e[t]) ? void 0 : r.value;
        }
        const X = (e, t, r) => {
            const n = [];
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const n = c(t);
                            if (Array.isArray(e)) {
                              const i = e.reduce((e, t) => ((e[t] = ie.LO.box(n[t], {})), e), {});
                              return (
                                "real" === r &&
                                  s.subscribe(
                                    (0, ie.aD)((t) => {
                            ...
                            }
                            {
                              const i = e,
                                a = Object.entries(i),
                                o = a.reduce((e, [t, r]) => ((e[r] = ie.LO.box(n[t], {})), e), {});
                              return (
                                "real" === r &&
                                  s.subscribe(
                                    (0, ie.aD)((e) => {
          ...
          D().render(
            a().createElement(
              ...
              a().createElement(
                A,
                null,
                a().createElement(u, { autoUpdate: !0 }, (e) =>
                  a().createElement(Oe, { sizerRef: e }),
                ),
              ),
            ),
