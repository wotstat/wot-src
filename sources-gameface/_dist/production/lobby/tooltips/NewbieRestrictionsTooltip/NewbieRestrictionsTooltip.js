      ...
      906: (u, e, t) => {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (r(), window.removeEventListener(F, D), (u.listeners -= 1), A(), (E = !1));
                    }
                  );
                };
              })(t)),
        ...
        const Hu = {
          ...
          Nu = yu((u) => {
            ...
            return n().createElement(
              "div",
              Tu({ className: o()(Mu.base, ...X, e), style: I }, G),
              W,
            );
          });
        let Wu;
        ...
        const Ne = R.strings.tooltips.newbie_restrictions.header.subtitle,
          We = ((u, e) => {
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = n(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = Me.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  D.subscribe(
                                    (0, Me.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                F = Object.entries(E),
                                r = F.reduce((u, [e, t]) => ((u[t] = Me.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  D.subscribe(
                                    (0, Me.aD)((u) => {
            ...
            return Object.assign({}, e, {
              computes: { getConditionGroups: t, getSubtitleText: A },
            });
          }, Le),
          Ge = We[0],
          je = We[1],
