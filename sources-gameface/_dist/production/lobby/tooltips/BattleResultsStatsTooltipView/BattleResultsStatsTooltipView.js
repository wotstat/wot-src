  ...
  var __webpack_modules__ = {
      85: (u, e, E) => {
              ...
              (e[E] = (function (e) {
                return (E) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(t, D), (u.listeners -= 1), A(), (F = !1));
                    }
                  );
                };
              })(E)),
        ...
        const m = {
          ...
          f = { play: Object.assign({}, b, { sound: l }), setRTPC: d },
        ...
        const Cu = { view: n, client: F, sound: f, intl: p };
      },
      973: (u, e, E) => {
        E.d(e, { Z: () => t });
        var A = E(85);
        ...
        class A {
          ...
          unregister(u, e) {
            ...
            ((this.entries = this.entries.filter(
              ({ container: u, callback: e }) => u !== E || e !== A,
            )),
      ...
      994: (u, e, E) => {
        ...
        const a = D().forwardRef(function (u, e) {
          let E = u.children,
            A = u.className,
            a = u.theme,
          ...
          return (
            (0, n.useLayoutEffect)(() => {
              const u = t.O.client.getSize("rem");
            ...
            return [
              function ({ mode: A = "real", options: F, children: r, mocks: B }) {
                const o = (0, n.useRef)([]),
                    ...
                    const D = (function ({
                      ...
                      r =
                        "real" === E
                          ...
                          : Object.assign({}, D, {
                              readByPath:
                                null != (n = null == F ? void 0 : F.getter) ? n : () => {},
                            }),
                      B = (u) =>
                      ...
                      i = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = B(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = d.LO.box(A[e], {})), u), {});
                              return (
                                "real" === E &&
                                  r.subscribe(
                                    (0, d.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                t = Object.entries(F),
                                n = t.reduce((u, [e, E]) => ((u[E] = d.LO.box(A[e], {})), u), {});
                              return (
                                "real" === E &&
                                  r.subscribe(
                                    (0, d.aD)((u) => {
                      ...
                      C = { mode: E, model: i, externalModel: r, cleanup: a };
                    return {
                      model: i,
                  ...
                  s = C[0],
                  c = C[1],
                  v = (0, n.useState)(() => a(A, F, B)),
                  p = v[0],
                  h = v[1];
                return (
                  (0, n.useEffect)(() => {
                    i.current ? h(a(s, F, B)) : (i.current = !0);
                  }, [B, s, F]),
                  (0, n.useEffect)(() => {
                    c(A);
                  }, [A]),
        ...
        const x = (u) => u.replace(/&nbsp;/g, " "),
          ...
          z = (0, s.Pi)(() => {
            const u = b().model.root.get().description;
            return D().createElement(
              "div",
              { className: V.base },
              null == u
        ...
        const W = "Footer_base_fa5b1",
          ...
          Z = (0, s.Pi)(() => {
            ...
            return D().createElement(
              "div",
              { className: W },
              q(E, (u, e) => D().createElement("div", { key: e, className: $ }, u)),
              q(e, (u, e) =>
                D().createElement(
                  "div",
                  { className: H, key: e },
                  ...
                  D().createElement(
                    ...
                    D().createElement(U, {
                      ...
                      binding: {
                        ...
                        type:
                          u.valueType && D().createElement("span", { className: Y }, u.valueType),
                      },
                    }),
                  ),
                ),
        ...
        engine.whenReady.then(() => {
          C().render(
            D().createElement(h, null, D().createElement(a, null, D().createElement(eu, null))),
