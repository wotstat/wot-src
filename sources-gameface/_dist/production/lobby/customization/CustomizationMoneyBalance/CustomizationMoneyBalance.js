(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (A(), window.removeEventListener(o, E), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      478: (u, e, t) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                A = o.reduce((u, [e, t]) => ((u[t] = G.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, G.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          A().render(
            r().createElement($, null, r().createElement(j, null)),
