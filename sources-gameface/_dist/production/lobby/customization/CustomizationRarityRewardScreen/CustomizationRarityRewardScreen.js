              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (i(), window.removeEventListener(a, E), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      304: (u, e, t) => {
                            ...
                            a.forEach((e, t) => {
                              void 0 !== a[t] &&
                                ...
                                u.changeKeyframeHandlers.forEach((u) => {
                                  ...
                                  return u({ time: e, name: `${l ? n : `Point_${t}`}` });
                                });
                            });
                          }
                        }),
                    ...
                    i = (u) => {
                      ...
                      d.current &&
                        (d.current.currentTime =
                          ((e = 0), (t = d.current.duration), (n = u) < e ? e : n > t ? t : n));
                    },
                    E = () => {
                      var u;
        ...
        const Z = (u) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: c()(V.goto, null == E ? void 0 : E.goto) }, a),
          );
        };
        var X = t(305);
        function Q(u, e) {
                      ...
                      D = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = o(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = X.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, X.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = X.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, X.aD)((u) => {
