  ...
  var __webpack_modules__ = {
      ...
      817: (u, e, t) => {
        ...
        const lu = {
          ...
          vu = (0, o.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = fu, onDrag: n = pu }) => {
                  ...
                  ((t.style.transform = `translateX(${0 | A}px)`),
                    ((u) => {
                      if (a.current && i.current && l.current && c.current) {
                        if (0 === u)
                          return (a.current.classList.add(Bu), void i.current.classList.remove(Bu));
                        if (
                          ((e = l.current),
                          (t = c.current),
                          u - (e.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (a.current.classList.remove(Bu), void i.current.classList.add(Bu));
                        var e, t;
        ...
        const Su = cu({
          ...
          Vu = (0, o.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = Hu, onDrag: n = Ru }) => {
              const r = (0, o.useRef)(null),
                a = (0, o.useRef)(null),
                i = (0, o.useRef)(null),
                l = (0, o.useRef)(null),
        ...
        const Dt = "ProgressBarDeltaSimple_base_6c",
          ...
          bt = (0, o.memo)(
            ({
              ...
              const f = (0, o.useMemo)(
                  () => Object.assign({ width: "100%" }, wt(u), ht(E)),
                  [E, u],
                ),
                p = (0, o.useMemo)(() => Object.assign({ width: "0%" }, wt(u), ht(E)), [E, u]),
                h = (0, o.useMemo)(
                  () => Object.assign({ width: "0%" }, vt(E, n), wt(u)),
                  [n, E, u],
                ),
                v = (0, o.useMemo)(
        ...
        const Cn = ({ items: u }) => {
          ...
          hn = ({ name: u, level: e, extraText: t, type: n, className: r }) => {
            const a = (0, o.useMemo)(
                () => (t ? t.replace("{tankLevel}", e) : `${e} {tankName}`),
                [t, e],
              ),
        ...
        const vn = N("model", (u) => ({ name: u.tankName, level: u.tankLevel, type: u.tankType }))(
            hn,
          ),
          wn = {
                  ...
                  class extends s().Component {
                    constructor(n) {
                      ...
                      const a = c(),
                        o = a.caller,
                        s = a.resId,
                        i = window.__feature && window.__feature !== o ? `subViews.${o}.${u}` : u,
                        l = E(i, window);
                      if (
                        (e &&
          ...
          Er = N("model", void 0, (u) => ({
            playSounds: (e) => u.playSounds({ isTutorialPageOpened: e }),
          }))(({ playSounds: u }) => {
