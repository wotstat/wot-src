  ...
  var __webpack_modules__ = {
      ...
      5191: (e, t, i) => {
        ...
        (0, n.memo)((e) => {
          ...
          const o = (0, n.useContext)(s.Y),
            ...
            x = { extraLarge: f, large: w, medium: p, small: S, extraSmall: E };
        ...
        const l = () => (e, t) => {
          ...
          return [
            function ({ mode: l = "real", options: _, children: c, mocks: d }) {
                    ...
                    m = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const n = d(t);
                          if (Array.isArray(e)) {
                            const s = e.reduce((e, t) => ((e[t] = a.LO.box(n[t], {})), e), {});
                            return (
                              "real" === i &&
                                c.subscribe(
                                  (0, a.aD)((t) => {
                          ...
                          }
                          {
                            const s = e,
                              r = Object.entries(s),
                              o = r.reduce((e, [t, i]) => ((e[i] = a.LO.box(n[t], {})), e), {});
                            return (
                              "real" === i &&
                                c.subscribe(
                                  (0, a.aD)((e) => {
              ...
              return (
                (0, s.useEffect)(() => {
                  m.current ? p(b(g, _, d)) : (m.current = !0);
                }, [d, g, _]),
                (0, s.useEffect)(() => {
                  v(l);
                }, [l]),
                (0, s.useEffect)(
                  () => () => {
                    (w.externalModel.dispose(), u.current.forEach((e) => e()));
                  },
                  [w],
                ),
                r().createElement(i.Provider, { value: w }, c)
              );
            },
            () => (0, s.useContext)(i),
          ];
              ...
              (t[i] = (function (t) {
                return (i) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (r(), window.removeEventListener(s, o), (e.listeners -= 1), n(), (a = !1));
                    }
                  );
                };
              })(i)),
      ...
      8739: (e, t, i) => {
        ...
        function a(e, t) {
          var i;
          if (!(t >= e.length))
            return Array.isArray(e) ? e[t] : null == (i = e[t]) ? void 0 : i.value;
        }
        const s = a;
        function r(e, t) {
          return Array.isArray(e)
            ? e.map(t)
            : e.map((e, i, n) => t(null == e ? void 0 : e.value, i, n));
        }
        function o(e, t) {
            ...
            ({ observableModel: e }) => {
              const t = {
                ...
                g = (0, s.Om)(
                  (e, t, i) => {
                    const n = h(e, t, i);
                    if (!n) throw Error(`No shell slot found with index: ${i}`);
                    if (!n.mechanics) throw Error("Selected shell have no mechanics");
                    const s = a.U2(n.mechanics, 0);
              ...
              return Object.assign({}, t, {
                computes: {
                  ...
                  sections: { allSectionsLength: _, length: c, section: d, IDs: v },
      ...
      682: (e, t, i) => {
        ...
        const b = "BackEffects_shine_c2121",
          ...
          w = { enterActive: "BackEffects_nut__enterActive_c50f1" },
          p = { enterActive: "BackEffects_wrench__enterActive_e5e59" },
          S = [n.dZ, n.sH],
            ...
            l().createElement(
              ...
              S.includes(t) &&
                l().createElement(
                  ...
                  l().createElement(
                    c.Z,
                    { in: e, timeout: u.wx, classNames: w },
                    l().createElement("div", { className: h }),
                  ),
                  l().createElement(
                    c.Z,
                    { in: e, timeout: u.Kz, classNames: p },
