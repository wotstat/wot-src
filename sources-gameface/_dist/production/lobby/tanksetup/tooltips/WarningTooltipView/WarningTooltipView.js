  ...
  var u,
    A = {
      4689: (u, A, F) => {
        ...
        const lu = Object.keys(k).reduce(
            (u, A) => ((u[A] = () => viewEnv.getShowingStatus() === k[A]), u),
            {},
          ),
          cu = {
            set: (u, A) => {
        ...
        const hu = C().forwardRef(function (u, A) {
          let F = u.children,
            e = u.className,
            E = u.theme,
        ...
        const Pu = (u) => u.replace(/&nbsp;/g, " "),
          ...
          Ou = (u, A, F = wu.left) => u.split(A).reduce(F === wu.left ? Ru : Su, []),
          _u = (() => {
            const u = new RegExp(
              [
          ...
          zu = (u, A = wu.left) => {
            ...
            return ((u, A = wu.left) => {
              ...
              const e =
                ...
                E = Pu(u);
              return (Ou(E, /( )/, A).forEach((u) => (F = F.concat(Ou(u, e, wu.left)))), F);
            })(u, A);
          },
          ...
          Iu = C().memo(({ reason: u, isCritical: A }) => {
            const F = (0, t.useMemo)(() => {
              const A = Gu.$dyn(u);
            ...
            return C().createElement(
              "div",
              { className: Lu },
              F.header && C().createElement("div", { className: a()(ku, A && $u) }, F.header),
              F.body &&
                C().createElement(
                  "div",
                  { className: Vu },
                  C().createElement(ju, { text: F.body }),
                ),
            );
          });
        function Nu() {}
        ...
        const Xu = ((u, A) => {
                        ...
                        return {
                          subscribe: (F, D) => {
                            const t = "string" == typeof D ? `${e}.${D}` : e,
                              C = gu.view.addModelObserver(t, A, !0);
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, A) => {
                            const e = C(A);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, A) => ((u[A] = Hu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  t.subscribe(
                                    (0, Hu.aD)((A) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                B = D.reduce((u, [A, F]) => ((u[F] = Hu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  t.subscribe(
                                    (0, Hu.aD)((u) => {
            ...
            ({ observableModel: u }) =>
              u.primitives({ reason: "reason", isCritical: "isCritical" }),
            Nu,
          ),
          Zu = Xu[0],
          Ju = Xu[1],
          Ku = (0, o.Pi)(() => {
            ...
            return C().createElement(
              hu,
              null,
              C().createElement(Iu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
            );
          });
        engine.whenReady.then(() => {
          r().render(
            C().createElement(Zu, null, C().createElement(Ku, null)),
