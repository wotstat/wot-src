  ...
  var u,
    e = {
      5682: (u, e, F) => {
        ...
        var D = {};
        (F.r(D), F.d(D, { getBgUrl: () => W, getTextureUrl: () => M }));
        var t = {};
        (F.r(t),
          F.d(t, {
            addModelObserver: () => J,
        ...
        const lu = Object.keys($).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === $[e]), u),
            {},
          ),
          cu = {
            set: (u, e) => {
        ...
        const bu = n().forwardRef(function (u, e) {
          ...
          yu = "Content_whiteText_e31ce",
          wu = "Content_yellowText_df33a",
        ...
        const zu = (u) => u.replace(/&nbsp;/g, " "),
          ...
          $u = (u, e, F = Ou.left) => u.split(e).reduce(F === Ou.left ? Mu : Wu, []),
          ju = (() => {
            const u = new RegExp(
              [
          ...
          Vu = (u, e = Ou.left) => {
            ...
            return ((u, e = Ou.left) => {
              ...
              const A =
                ...
                E = zu(u);
              return ($u(E, /( )/, e).forEach((u) => (F = F.concat($u(u, A, Ou.left)))), F);
            })(u, e);
          },
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                t = D.reduce((u, [e, F]) => ((u[F] = Yu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  B.subscribe(
                                    (0, Yu.aD)((u) => {
