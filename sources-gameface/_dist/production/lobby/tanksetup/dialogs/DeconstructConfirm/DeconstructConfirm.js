      ...
      3060: (e, u, t) => {
        ...
        const ze = (e) => {
          ...
          return i().createElement(
            ...
            n &&
              i().createElement("div", { className: m()(Ue.goto, null == r ? void 0 : r.goto) }, n),
          );
        };
        let qe = (function (e) {
          return (
        ...
        const $e = {
          ...
          Ve = (0, a.memo)(
            ({
              ...
              const D = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(_, qe),
        ...
        const Cu = ((e, u) => {
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = _u.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, _u.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                i = a.reduce((e, [u, t]) => ((e[t] = _u.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, _u.aD)((e) => {
            ...
            ({ observableModel: e }) => {
              const u = {
                ...
                t = (0, Fu.Om)(() =>
                  mu(u.vehicleEquipment.get(), (e, u) => e + Number(u.value), 0),
                ),
                n = (0, Fu.Om)(() =>
                  mu(u.inventoryEquipment.get(), (e, u) => e + Number(u.value), 0),
                ),
                r = (0, Fu.Om)(() => {
                  const e = u.root.get();
                  return {
        ...
        const Nu = {
          ...
          Qu = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = ju, onDrag: n = Xu }) => {
                  ...
                  ((t.style.transform = `translateX(${0 | _}px)`),
                    ((e) => {
                      if (o.current && l.current && c.current && E.current) {
                        if (0 === e)
                          return (o.current.classList.add($u), void l.current.classList.remove($u));
                        if (
                          ((u = c.current),
                          (t = E.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (o.current.classList.remove($u), void l.current.classList.add($u));
                        var u, t;
        ...
        const et = Ou({
          ...
          At = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Et, onDrag: n = lt }) => {
              const r = (0, a.useRef)(null),
                o = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
        ...
        const Rt = ({ children: e, tooltipArgs: u, className: t }) => {
            ...
            const r = u.contentId;
            return r
              ? i().createElement(pe, St({}, u, { contentId: r }), n)
              : i().createElement(Tt, u, n);
          },
          xt =
            (Bt.Items,
            Bt.Equipment,
              ...
              i().createElement(
                ...
                i().createElement(
                  ...
                  s &&
                    i().createElement(
                      "div",
                      { className: m()(Pt.title, null == E ? void 0 : E.title) },
                      s,
                    ),
                ),
              ),
                    ...
                    Ye(t, (e, u) =>
                      i().createElement(
                        pe,
                        {
                          ...
                          args: { intCD: e.intCD },
                          contentId:
                            R.views.lobby.tanksetup.tooltips.DeconstructFromVehicleTooltip("resId"),
                        },
                        i().createElement(
                          "div",
                          null,
