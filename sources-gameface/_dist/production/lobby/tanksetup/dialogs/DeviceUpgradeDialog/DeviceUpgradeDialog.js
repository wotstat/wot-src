  ...
  var __webpack_modules__ = {
      ...
      8688: (u, e, t) => {
                      ...
                      _ = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = l(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = U.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, U.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = U.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, U.aD)((u) => {
            ...
            ({ observableModel: u }) => {
              const e = {
                ...
                t = (0, Y.Om)(() => {
                  var u, t;
                  return null !=
                    (u = null == (t = q(e.balance.get(), 0)) ? void 0 : t.currencyValue)
                    ? u
                    : 0;
                });
        ...
        const ju = {
          ...
          zu = (0, n.memo)(
            ({
              ...
              const D = ((u, e) =>
                  Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(_, Yu),
        ...
        const Ie = ({
            ...
            r().createElement(
              ...
              r().createElement(
                ...
                r().createElement("div", { className: g()(ke, e === Ne.LastColumn && Me) }),
              ),
              e === Ne.LastColumn &&
                r().createElement(
                  "div",
        ...
        const je = r().memo(Ye),
          ...
          tt = {
            additionalText: "Footer_additionalText_30",
            missingCurrency: "Footer_missingCurrency_f8",
          },
        ...
        engine.whenReady.then(() => {
          N().render(
            r().createElement(M, null, r().createElement(z, null, r().createElement(At, null))),
