  ...
  var __webpack_modules__ = {
      ...
      9169: (u, e, t) => {
                      ...
                      _ = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = O.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, O.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = O.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, O.aD)((u) => {
            ...
            ({ observableModel: u }) => {
              const e = {
                ...
                t = (0, H.Om)(() => {
                  var u, t;
                  return null !=
                    (u = null == (t = I(e.balance.get(), 0)) ? void 0 : t.currencyValue)
                    ? u
                    : 0;
                });
        ...
        const K = (u) => u.replace(/&nbsp;/g, " "),
          ...
          ru = (u, e, t) =>
            u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : nu(u, e)));
        var au = t(6609);
        ...
        const ju = (u) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: F()($u.goto, null == o ? void 0 : o.goto) }, a),
          );
        };
        let Xu = (function (u) {
          return (
        ...
        const Yu = {
          ...
          Vu = (0, n.memo)(
            ({
              ...
              const D = ((u, e) =>
                  Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(A, Xu),
        ...
        const oe = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const a = e.contentId;
          return a
            ? r().createElement(wu, ie({}, e, { contentId: a }), n)
            : r().createElement(ae, e, n);
        };
        let le = (function (u) {
            return (
              (u.Items = "items"),
              ...
              r().createElement(
                ...
                r().createElement(
                  ...
                  l &&
                    r().createElement(
                      "div",
                      { className: F()(De.title, null == E ? void 0 : E.title) },
                      l,
                    ),
                ),
              ),
