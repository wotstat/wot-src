  ...
  var __webpack_modules__ = {
            ...
            const u = e.offsetLeft,
              ...
              W = (0, a.useCallback)(() => {
                L &&
                  g &&
                  g(
                    { x: L.scrollbarXActive, y: L.scrollbarYActive },
                    { x: L.reach.x, y: L.reach.y },
                  );
              }, [g, L]),
              ...
              $ = (0, a.useCallback)(
                (e) => {
                  L &&
                    (L.setScrollLeftImmediately(e), x && x(e, L.contentWidth - L.containerWidth));
                },
                [L, x],
              ),
              z = (0, a.useCallback)(
              ...
              q = (0, a.useCallback)(() => {
                if (I && D && L) {
                  const e = {
                    scrollPosition: I.scrollLeft < 0 ? 0 : I.scrollLeft,
                    reach: L.reach.x,
                  };
                  D(e);
                }
            ...
            (i.contains(e.scrollbarXRail) ||
              ...
              e.scrollbarYActive
                ? (i.classList.add(c.active("y")),
                  C(e, "top", i.scrollTop - e.lastScrollTop, !0, t))
                  ...
                  (p > 0 && ((o.x = m / p), (o.y = E / p), (i = h)),
                    (function (t, u) {
                      ...
                      if (a > o) {
                        ...
                        o > a &&
                        ((t < 0 && i === e.contentWidth - e.containerWidth) || (t > 0 && 0 === i))
                      )
                        return !0;
                      return !0;
          ...
          (document.addEventListener("mousedown", (u) => {
            ...
            document.addEventListener("mousemove", (u) => {
              if (
                ...
                o > a
                  ? e.setSelectionRange(a, o, "forward")
                  : e.setSelectionRange(o, a, "backward");
              }
            }),
      ...
      8982: (e, t, u) => {
        ...
        const s = "ConfirmButton_base_75",
          l = r().memo(
            ({ applyBtnString: e, isDisabled: t, onConfirm: u, confirmButtonRef: o }) => {
          ...
          x = ({ value: e, currencyType: t, isWalletAvailable: u }) => {
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                u
                  ? r().createElement(y.A, { value: e, format: i })
        ...
        const he = "ProgressBarDeltaSimple_base_6c",
          ...
          Be = (0, n.memo)(
            ({
              ...
              const C = (0, n.useMemo)(
                  () => Object.assign({ width: "100%" }, fe(e), Ce(d)),
                  [d, e],
                ),
                v = (0, n.useMemo)(() => Object.assign({ width: "0%" }, fe(e), Ce(d)), [d, e]),
                f = (0, n.useMemo)(
                  () => Object.assign({ width: "0%" }, ve(d, i), fe(e)),
                  [i, d, e],
                ),
                B = (0, n.useMemo)(
        ...
        const gt = ["ko", "no"].includes(R.strings.settings.LANGUAGE_CODE()),
          ...
          bt = {
            ...
            highlight__postProgressionModification:
              "Item_highlight__postProgressionModification_5e",
                ...
                () =>
                  u
                    ? {
                        ...
                        doesNotWork: r().createElement("span", { className: It }, i.doesNotWork()),
                      }
                    : {},
                [a, h, i, u],
              ),
          ...
          qt = ({ name: e, vehicleType: t, title: u, items: i, description: o }) => {
            const a = R.strings.common.common,
              ...
              c = e
                ? u.replace("%(name)s", `${a.open_quotes()}${(0, d.z4)(e)}${a.close_quotes()}`)
                : u,
              _ = (0, n.useMemo)(
                () => ({
                  vehicle:
