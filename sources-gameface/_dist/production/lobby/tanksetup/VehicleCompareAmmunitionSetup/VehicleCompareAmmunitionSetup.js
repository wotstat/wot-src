  ...
  var __webpack_modules__ = {
          ...
          b = i().forwardRef((e, t) => {
            const n = e.offsetLeft,
              ...
              U = (0, o.useCallback)(() => {
                if (P && f && N) {
                  const e = {
                    scrollPosition: P.scrollLeft < 0 ? 0 : P.scrollLeft,
                    reach: N.reach.x,
                  };
                  f(e);
                }
            ...
            (u.contains(e.scrollbarXRail) ||
              ...
              e.scrollbarXActive
                ...
                : (u.classList.remove(c.active("x")),
                  ...
                  (u.scrollLeft = 0)),
              e.scrollbarYActive
                ? (u.classList.add(c.active("y")),
                  A(e, "top", u.scrollTop - e.lastScrollTop, !0, t))
              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (o(), window.removeEventListener(u, i), (e.listeners -= 1), a(), (r = !1));
                    }
                  );
                };
              })(n)),
      ...
      3649: (e, t, n) => {
        ...
        const i = (e) => e.replace(/&nbsp;/g, " "),
          ...
          b = (e, t, n) =>
            e.split(/%\((.*?)\)(?:[sd])?/g).map((e) => (n && e in n ? n[e] : E(e, t)));
      },
      728: (e, t, n) => {
        "use strict";
        let a;
      ...
      7273: (e, t, n) => {
        ...
        const Te = {
          ...
          Ye = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = ze, onDrag: a = Xe }) => {
                  ...
                  ((n.style.transform = `translateX(${0 | d}px)`),
                    ((e) => {
                      if (u.current && i.current && c.current && _.current) {
                        if (0 === e)
                          return (u.current.classList.add(We), void i.current.classList.remove(We));
                        if (
                          ((t = c.current),
                          (n = _.current),
                          e - (t.offsetWidth - n.offsetWidth) >= -0.5)
                        )
                          return (u.current.classList.remove(We), void i.current.classList.add(We));
                        var t, n;
        ...
        const Ze = xe({
          ...
          lt = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = st, onDrag: a = rt }) => {
              const r = (0, s.useRef)(null),
                u = (0, s.useRef)(null),
                i = (0, s.useRef)(null),
                c = (0, s.useRef)(null),
                ...
                g = Ce(() => {
                  ...
                  ((n.style.transform = `translateY(${0 | d}px)`),
                    ((e) => {
                      if (u.current && i.current && c.current && _.current) {
                        if (0 === e)
                          return (u.current.classList.add(at), void i.current.classList.remove(at));
                        if (
                          ((t = c.current),
                          (n = _.current),
                          e - (t.offsetHeight - n.offsetHeight) >= -0.5)
                        )
                          return (u.current.classList.remove(at), void i.current.classList.add(at));
                        var t, n;
        ...
        const Xt = (0, s.memo)(
          ({ isActive: e, index: t, arrowType: n, onClick: a, classMix: r }) => {
            const u = t + 1,
            ...
            return o().createElement(
              ...
              n !== zt.None &&
                o().createElement("div", { className: l()($t.arrow, $t[`arrow__${n}`]) }),
            );
          },
        );
        var Gt = n(4179),
        ...
        const nn = {
            [tn.NBSP]: Qt.NoBreakSymbol,
            [tn.ZWNBSP]: Qt.NoBreakSymbol,
            [tn.NEW_LINE]: Qt.LineBreak,
          },
          an = {
          ...
          ln = ({ elementList: e, textBlock: t, key: n }) => {
            ...
            return a
              ? an[a]
                ...
                : o().createElement(
                    "span",
                    { key: n, "data-block-type": t.blockType, style: on(a) },
                    e,
                  )
          ...
          cn = {
            ...
            [Qt.NewLine]: ({ elementList: e, key: t }) =>
              o().createElement(
                "span",
                { key: t, "data-block-type": Qt.NewLine, className: sn },
                e,
              ),
                ...
                (e) => {
                  ...
                  r === Qt.LineBreak
                    ? n.push(
                        ...((e) => {
                          const t = [
                            { blockType: Qt.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
        ...
        const fa = {
          ...
          ya = ({
            ...
            const T = (0, s.useState)({ isBaseHovered: !1, isActionsHovered: !1 }),
              ...
              te = (0, s.useMemo)(() => {
                const e =
                    (t === x.cJ.Large || t === x.cJ.Huge ? x.cJ.Large : x.cJ.Medium) + "_" + B,
              ...
              g = b.map((n) => {
                ...
                return o().createElement(
                  "div",
                  {
                    key: n.intCD,
                    ref: r ? e : null,
                    className: l()(Oa.card, m && Oa[`card__${m}`]),
                  },
        ...
        const ar = o().memo(function ({ theme: e, className: t }) {
            ...
            return o().createElement(
              ...
              o().createElement(er.A, {
                caption:
                  e === nr.Standalone ? R.strings.tank_setup.abilities.actions.toInfoPage() : "",
                type: "info",
                side: "left",
                onClick: a,
                classNames: r,
          ...
          hr = ({ type: e, tabs: t, content: n }) => {
            ...
            return o().createElement(
              ...
              o().createElement(
                "div",
                { className: br.title },
                (0, M.WU)(R.strings.tank_setup.compare.section.title.$dyn(e), {
                  name: a.vehicleName,
                }),
              ),
              o().createElement(
        ...
        const vr = o().memo(function ({ theme: e, className: t }) {
          ...
          return o().createElement(
            ...
            o().createElement(er.A, {
              caption:
                e === fr.Standalone ? R.strings.tank_setup.abilities.actions.toInfoPage() : "",
              type: "info",
              side: "left",
              onClick: a,
              classNames: r,
        ...
        const xr = {
          ...
          Nr = wr((e) => {
            ...
            return o().createElement(
              "div",
              Tr({ className: l()(Sr.base, ...z, t), style: $ }, H),
              O,
            );
          });
        var Rr = n(3532),
        ...
        const Zr = {
          ...
          Kr = (0, s.memo)(({ isOptDeviceRestored: e, introType: t }) => {
            const n = l()(Zr.icon, Zr[`icon__currency-${t}`]),
              ...
              u = R.strings.tank_setup.introduction.message.$dyn(
                a ? `${t}${e ? "Restorable" : ""}` : t,
              );
        ...
        const Ju = ({
          ...
          const u = (0, x.GS)(),
            ...
            c = (0, w.m)(`${a}.slots`),
            _ = zu(c);
          const d = (0, s.useMemo)(() => _.sort((e, t) => e.name.localeCompare(t.name)), [_]).map(
              (n) => {
                if (!n) return null;
                ...
                return o().createElement(
                  "div",
                  {
                    key: n.intCD,
                    ref: a ? e : null,
                    className: l()(Ku.card, u && Ku[`card__${u}`]),
                  },
              ...
              c = ((e) =>
                ...
                return o().createElement(
                  "div",
                  {
                    key: t.intCD,
                    ref: n ? e : null,
                    className: l()(_s.card, s && _s[`card__${s}`]),
                  },
                  o().createElement(
                    cs,
                ...
                X = (0, s.useMemo)(() => {
                  ...
                  return (
                    I &&
                      ...
                      L ||
                        (d && !B
                          ? ((t = !F), e.push(...((e) => (e ? [Qn, ea] : [Jn]))(r)), e.push(ta))
                          : e.push(((e, t, n) => ((!Boolean(e) && !t) || n ? Zn : Kn))(i, d, m)))),
                    !v || B || p || L || e.push(na),
              ...
              content:
                ...
                o().createElement(
                  jn,
                  {
                    selectedSlotId: l,
                    scrollAreaKey: T,
                    updateKey: `${B.selectedFilterCount}:${L}`,
                  },
                  o().createElement(wo, {
                    compare: e,
                    selectedSlot: l,
                  ...
                  o().createElement(
                    ...
                    o().createElement(
                      ...
                      o().createElement(
                        ...
                        { className: v },
                        e
                          ? o().createElement(Sa.t, zo({ showZero: !0, ignoreDiscount: !0 }, u))
      ...
      8982: (e, t, n) => {
        ...
        const i = "ConfirmButton_base_75",
          l = r().memo(
            ({ applyBtnString: e, isDisabled: t, onConfirm: n, confirmButtonRef: s }) => {
      ...
      5282: (e, t, n) => {
        ...
        const m = (e) =>
          ...
          p = ({ blocks: e, linesCount: t = 2, mediaSize: n }) => {
            ...
            return i().createElement(
              "div",
              { ref: g, className: r()(c, b.height && _), style: C },
              m,
            );
          };
      },
