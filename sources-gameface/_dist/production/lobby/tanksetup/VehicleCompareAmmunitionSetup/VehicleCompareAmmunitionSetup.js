  ...
  var __webpack_modules__ = {
                    ...
                    p = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const u = d(t);
                          if (Array.isArray(e)) {
                            const r = e.reduce((e, t) => ((e[t] = n.LO.box(u[t], {})), e), {});
                            return (
                              "real" === a &&
                                c.subscribe(
                                  (0, n.aD)((t) => {
                          ...
                          }
                          {
                            const r = e,
                              s = Object.entries(r),
                              o = s.reduce((e, [t, a]) => ((e[a] = n.LO.box(u[t], {})), e), {});
                            return (
                              "real" === a &&
                                c.subscribe(
                                  (0, n.aD)((e) => {
              ...
              (t[a] = (function (t) {
                return (a) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (s(), window.removeEventListener(r, o), (e.listeners -= 1), u(), (n = !1));
                    }
                  );
                };
              })(a)),
      ...
      6591: (e, t, a) => {
        ...
        const J = {
          ...
          Q = (0, o.memo)(
            ({ parentId: e, availableActions: t, onActionClick: a, isBuyMoreDisabled: u }) =>
              i().createElement(
                "div",
            ...
            const u = (0, P.GS)(),
              ...
              M = (0, o.useMemo)(() => {
                ...
                return (
                  !A &&
                    T &&
                    (!t && y && e.push(q), (!Boolean(g) && !D) || F ? e.push(H) : e.push(z)),
                  e
                );
              }, [A, T, t, y, g, D, F]),
              O = (0, o.useCallback)(
        ...
        const Oa = (e) => {
          ...
          Ia = ({ children: e, component: t, props: a = {} }) =>
        ...
        function _u(e, t, a = []) {
          ...
          return [
            (0, o.useCallback)((a) => {
              (0 !== u.current && n(),
                (u.current = window.setInterval(() => e(a, !0), t)),
                e(a, !1));
            }, r),
            n,
          ];
        ...
        const hu = {
          ...
          Lu = (0, o.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: a = Tu, onDrag: u = xu }) => {
                  ...
                  ((a.style.transform = `translateX(${0 | c}px)`),
                    ((e) => {
                      if (s.current && l.current && d.current && _.current) {
                        if (0 === e)
                          return (s.current.classList.add(Su), void l.current.classList.remove(Su));
                        if (
                          ((t = d.current),
                          (a = _.current),
                          e - (t.offsetWidth - a.offsetWidth) >= -0.5)
                        )
                          return (s.current.classList.remove(Su), void l.current.classList.add(Su));
                        var t, a;
        ...
        const Iu = fu({
          ...
          Yu = (0, o.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: a = qu, onDrag: u = Uu }) => {
              const n = (0, o.useRef)(null),
                s = (0, o.useRef)(null),
                l = (0, o.useRef)(null),
                d = (0, o.useRef)(null),
                ...
                f = (0, du.z)(() => {
                  ...
                  ((a.style.transform = `translateY(${0 | c}px)`),
                    ((e) => {
                      if (s.current && l.current && d.current && _.current) {
                        if (0 === Math.round(e))
                          return (s.current.classList.add(Vu), void l.current.classList.remove(Vu));
                        if (
                          ((t = d.current),
                          (a = _.current),
                          e - (t.offsetHeight - a.offsetHeight) >= -0.5)
                        )
                          return (s.current.classList.remove(Vu), void l.current.classList.add(Vu));
                        var t, a;
        ...
        const bn = ({ introType: e }) => {
            ...
            return u
              ? i().createElement(En.z, { binding: a, text: u, classMix: pn.message })
              : null;
          },
          gn = (0, k.Pi)(() => {
            const e = (0, P.GS)(),
        ...
        const Dn = (
          e,
          t,
          { listenResize: a = !0, intervalMs: u = 50, minStableTicks: n = 3 },
          r,
        ) => {
        ...
        const kn = ({ children: e, tooltipArgs: t, className: a }) => {
          ...
          const n = t.contentId;
          return n
            ? i().createElement(Ce.u, Sn({}, t, { contentId: n }), u)
            : i().createElement(oa.t, t, u);
        };
        var Tn = a(1311);
        const xn = {
        ...
        const Rn = {
            [Mn.NBSP]: Nn.NoBreakSymbol,
            [Mn.ZWNBSP]: Nn.NoBreakSymbol,
            [Mn.NEW_LINE]: Nn.LineBreak,
          },
          ...
          Wn = ({ elementList: e, textBlock: t, key: a }) => {
            ...
            return u
              ...
              : i().createElement(
                  "span",
                  { key: a, "data-block-type": t.blockType, className: zn },
                  e,
                );
          },
          Gn = {
            ...
            [Nn.NewLine]: ({ elementList: e, key: t }) =>
              i().createElement(
                "span",
                { key: t, "data-block-type": Nn.NewLine, className: Hn },
                e,
              ),
          ...
          Zn = (e, t, a, u) => {
            let n = t.exec(e),
              r = 0;
            for (; n;)
              (r !== n.index && a(e.slice(r, n.index)), u(n), (r = t.lastIndex), (n = t.exec(e)));
                ...
                (e) => {
                  ...
                  n === Nn.LineBreak
                    ? u.push(
                        ...((e) => {
                          const t = [
                            { blockType: Nn.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
                  ...
                  : i().createElement(
                      ...
                      i().createElement(
                        ...
                        i().createElement(
                          ...
                          i().createElement("div", { className: or.footer_arrowLeft, onClick: D }),
                        ),
                        i().createElement(
                          "div",
                          ...
                          i().createElement(
                            Ce.u,
                            {
                              ...
                              args: { sourceVehicleCompDescr: v, optionalDevicesResultType: C },
                            },
                            i().createElement(
                              "div",
                              null,
                              i().createElement("div", { className: or.lipsIcon }),
                              i().createElement("div", { className: or.footer_wrapper_title }, B),
                            ),
                          ),
                          i().createElement(
                            "div",
                        ...
                        i().createElement(
                          ...
                          i().createElement("div", { className: or.footer_arrowRight, onClick: D }),
                        ),
                      ),
                    ),
            );
        ...
        const Nr = {
          ...
          Mr = (0, k.Pi)(({ shellID: e, specificationID: t }) => {
            ...
            const u = (0, P.GS)(),
              n = u === P.cJ.Tiny,
              r = (0, ia.t)().model.computes.shells.specification(e, t),
              s = r.paramName,
              l = r.values,
              d = r.metricValue,
              _ = null == (a = je.U2(l, 0)) ? void 0 : a.value,
              m = (0, o.useMemo)(() => {
                if ("avgPiercingPower" === s) return R.strings.menu.tank_params.no_brackets.mm();
              }, [s]);
            return "avgPiercingPower" === s || (!n && _)
              ? i().createElement(
                  "div",
                  { className: c()(Lr.base, u && Lr[`base__${u}`]) },
                  n
                    ? i().createElement(
                        i().Fragment,
                        null,
                        ...
                        i().createElement(
                          "div",
                          { className: Lr.value },
                          _ || i().createElement("span", null, "—"),
                        ),
                        i().createElement("div", { className: Lr.units }, m),
                      )
                    : i().createElement(
                        i().Fragment,
                        null,
                        ...
                        i().createElement("div", {
                          className: c()(Lr.separator, u && Lr[`separator__${u}`]),
                        }),
                        i().createElement(
                          "div",
                          { className: Lr.value },
        ...
        const Hr = R.strings.tank_setup.shells,
          zr = (0, k.Pi)(({ id: e }) => {
            const t = (0, P.GS)(),
              ...
              b = (0, o.useMemo)(
                () => Hr[a ? "shortSpecification" : "specification"].inStorage(),
                [a],
              ),
              g = (0, o.useMemo)(
                () => Hr[a ? "shortSpecification" : "specification"].inVehicle(),
                [a],
              ),
            ...
            return i().createElement(
              ...
              i().createElement(
                ...
                i().createElement("div", {
                  className: c()(Pr.separator, t && Pr[`separator__${t}`]),
                }),
                i().createElement(
                  "div",
          ...
          return t
            ? o().createElement(
                ...
                o().createElement(
                  ...
                  o().createElement(
                    "div",
                    { className: n()(c.Z.base, c.Z.base__withAnimation) },
                    e,
                  ),
                ),
              )
                      ...
                      Boolean(M) &&
                        l().createElement(
                          ...
                          l().createElement(
                            ...
                            !L &&
                              l().createElement("div", { className: h.Z.from }, C.fromVehicle()),
                            l().createElement(d.Y, {
                              location: "vehicle",
                              count: M,
                              countFirst: !0,
                      ...
                      R &&
                        l().createElement(
                          ...
                          l().createElement(
                            ...
                            { className: n()(h.Z.storage, a && h.Z[`storage__${a}`]) },
                            !L &&
                              l().createElement("div", { className: h.Z.from }, C.fromStorage()),
                            l().createElement(d.Y, {
                              location: "storage",
      ...
      256: (e, t, a) => {
        ...
        var u = a(7109),
          ...
          s = a(4812);
        const o = r().memo(
          ({ applyBtnString: e, isDisabled: t, onConfirm: a, confirmButtonRef: n }) =>
            r().createElement(
              "div",
      ...
      9074: (e, t, a) => {
        ...
        const d = (e) => {
          ...
          return o().createElement(
            ...
            u &&
              o().createElement("div", { className: n()(i.goto, null == d ? void 0 : d.goto) }, u),
          );
        };
        var _ = a(9723),
          m = a(9659),
      ...
      11: (e, t, a) => {
        ...
        const p = (e) =>
          ...
          E = ({ blocks: e, linesCount: t = 2, mediaSize: a }) => {
            ...
            const C = (0, i.useMemo)(
              () => (b.height ? { maxHeight: `${b.height}rem` } : {}),
              [b.height],
            );
            return l().createElement(
              "div",
              { ref: h, className: n()(d, b.height && _), style: C },
              m,
            );
          };
      },
