      ...
      7508: (e, u, t) => {
        ...
        const P = (e) => {
          ...
          return o().createElement(
            ...
            n &&
              o().createElement("div", { className: C()(k.goto, null == r ? void 0 : r.goto) }, n),
          );
        };
        var H = t(4020),
          I = t(828);
        ...
        const J = ((e, u) => {
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = s(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = $.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, $.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                o = a.reduce((e, [u, t]) => ((e[t] = $.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, $.aD)((e) => {
            ...
            ({ observableModel: e }) => {
              const u = {
                ...
                n = (0, K.Om)(() =>
                  Y(u.modules.onVehicles.get(), (e, u) => e + u.selectedCount, 0),
                ),
        ...
        const me = {
          ...
          Me = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = xe, onDrag: n = Te }) => {
        ...
        const Oe = De({
          ...
          Ze = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Ge, onDrag: n = qe }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                s = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                ...
                B = se(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | d}px)`),
                    ((e) => {
                      if (i.current && s.current && l.current && E.current) {
                        if (0 === Math.round(e))
                          return (i.current.classList.add(Ue), void s.current.classList.remove(Ue));
                        if (
                          ((u = l.current),
                          (t = E.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (i.current.classList.remove(Ue), void s.current.classList.add(Ue));
                        var u, t;
        ...
        const su = ({
          ...
          return o().createElement(
            ...
            o().createElement(
              "div",
              { className: C()(au.name, null == c ? void 0 : c.name) },
              E ? t : u,
            ),
          );
        };
        ...
        const gu = { calcValue: 0, isPositive: !0, valueKey: "default" },
          ...
          Su = (0, V.Pi)(({ slotIndex: e, bonusIndex: u, groupType: t }) => {
            const n = ue().model,
          ...
          et = (0, V.Pi)(({ index: e, groupType: u, className: t }) => {
            ...
            const s = i.deviceID,
              ...
              A = i.selectedCount,
              F = i.vehicleInfo,
              m = R.images.gui.maps.icons.quests.bonuses.big.$dyn(
            ...
            return o().createElement(
              ...
              o().createElement(
                ...
                o().createElement(
                  ...
                  Boolean(D) &&
                    o().createElement("div", { className: Zu }, o().createElement(su, F)),
                  o().createElement(
                    "div",
                    { className: Ku },
        ...
        const A = (e) =>
          ...
          F = ({ blocks: e, linesCount: u = 2, mediaSize: t }) => {
            ...
            return l().createElement(
              "div",
              { ref: C, className: r()(E, m.height && d), style: f },
              _,
            );
          };
      },
