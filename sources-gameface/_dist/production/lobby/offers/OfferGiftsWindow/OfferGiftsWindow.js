  ...
  var __webpack_modules__ = {
      380: (u) => {
            ...
            (i.contains(u.scrollbarXRail) ||
              ...
              u.containerHeight + u.settings.scrollYMarginOffset < u.contentHeight
                ? ((u.scrollbarYActive = !0),
                  ...
                  (u.scrollbarYHeight = b(
                    u,
                    B((u.railYHeight * u.containerHeight) / u.contentHeight),
                  )),
                  (u.scrollbarYTop = B(
              ...
              u.scrollbarXButtonEnd.classList.toggle(
                "disabled",
                d + u.containerWidth >= u.contentWidth,
              ),
              ...
              u.scrollbarXActive
                ...
                : (i.classList.remove(c.active("x")),
                  ...
                  (i.scrollLeft = 0)),
              u.scrollbarYActive
                ? (i.classList.add(c.active("y")),
                  f(u, "top", i.scrollTop - u.lastScrollTop, !0, e))
            ...
            var g = function u(n) {
              if (!s || !s()) {
                ...
                if (!isNaN(A)) {
                  ...
                  if (
                    (c.breakBounds &&
                      (g < c.startBound ? (g = c.startBound) : g > c.endBound && (g = c.endBound)),
                    l < i)
                  ) {
                    if (h) {
                      var _ = D ? g : 0,
                      ...
                      var i = (function (u) {
                        ...
                        a = (function (u) {
                          var e = u.axis,
                            t = u.cursorPositionOnRail,
                            n = u.i;
                          return t > ("y" === e ? n.scrollbarYTop : n.scrollbarXLeft) ? 1 : -1;
        ...
        function T(u, e, t) {
          ...
          function _() {
            (F(u, E),
              u[d].classList.remove(c.clicking),
              u.event.unbind(u.ownerDocument, "mousemove", g));
          }
                  ...
                  (u.settings.suppressScrollX && 0 !== a) ||
                    ...
                    (function (e, n) {
                      ...
                      if (0 === n) {
                        ...
                        if ((0 === i && e < 0) || (i >= u.contentWidth - u.containerWidth && e > 0))
                          return !u.settings.wheelPropagation;
                      }
                      return !0;
                  ...
                  (D > 0 && ((o.x = A / D), (o.y = F / D), (i = h)),
                    (function (e, t) {
                      ...
                      if (a > o) {
                        ...
                        o > a &&
                        ((e < 0 && i === u.contentWidth - u.containerWidth) || (e > 0 && 0 === i))
                      )
                        return !0;
                      return !0;
          ...
          au = i().forwardRef((u, e) => {
            const t = u.offsetLeft,
              ...
              W = (0, r.useCallback)(
                (u) => {
                  w &&
                    (w.setScrollLeftImmediately(u), _ && _(u, w.contentWidth - w.containerWidth));
                },
                [w, _],
              ),
              P = (0, r.useCallback)(
        ...
        const pu = (u, e) => u.getBoundingClientRect().top >= e,
          ...
          yu = ({ blocks: u, linesCount: e = 2, mediaSize: t }) => {
            ...
            return i().createElement(
              "div",
              { ref: d, className: g()(Lu, c.height && xu), style: h },
              a,
            );
          },
          Su = {
                ...
                ? i().createElement(
                    ...
                    b &&
                      ...
                      i().createElement(
                        "div",
                        { className: De },
                        i().createElement(Nu, { text: R.strings.offers.giftsWindow.unavailable() }),
                      ),
                  )
                : i().createElement(
                    "div",
                ...
                L &&
                  i().createElement(
                    ...
                    i().createElement(vu, {
                      ...
                      binding: {
                        count: i().createElement("span", { className: Fe, key: "available" }, B),
                      },
                    }),
                  ),
              ),
