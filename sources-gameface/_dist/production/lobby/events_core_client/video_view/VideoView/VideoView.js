(() => {
  var __webpack_modules__ = {
      ...
      31: (u, e, t) => {
        ...
        const H = Object.keys(i).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === i[e]), u),
            {},
          ),
          P = {
            set: (u, e) => {
                  ...
                  _({
                    on: (u, e) => {
                      ...
                      return (
                        ...
                        () => {
                          var t;
                          return null == (t = L.current) ? void 0 : t.removeEventListener(u, e);
                        }
                      );
                    },
                    off: (u, e) => {
                        ...
                        n().createElement(
                          ...
                          M
                            ? n().createElement(
                                ...
                                n().createElement("div", {
                                  className: o()(Su.iconLayer, Su.iconHover, Su.pauseHover),
                                }),
                                n().createElement("div", {
                                  className: o()(Su.iconLayer, Su.iconPress, Su.pausePress),
                                }),
                              )
                            : n().createElement(
                                n().Fragment,
                                ...
                                n().createElement("div", {
                                  className: o()(Su.iconLayer, Su.iconHover, Su.playHover),
                                }),
                                n().createElement("div", {
                                  className: o()(Su.iconLayer, Su.iconPress, Su.playPress),
                                }),
                              ),
                        ),
                      ),
                          ...
                          n().createElement(
                            ...
                            ue
                              ? n().createElement(
                                  ...
                                  n().createElement("div", {
                                    className: o()(Su.iconLayer, Su.iconHover, Su.soundOnHover),
                                  }),
                                )
                              : n().createElement(
                                  n().Fragment,
                                  ...
                                  n().createElement("div", {
                                    className: o()(Su.iconLayer, Su.iconHover, Su.muteHover),
                                  }),
                                ),
                          ),
                        ),
                    ...
                    p &&
                      n().createElement(
                        ...
                        n().createElement(
                          ...
                          !U &&
                            n().createElement("div", {
                              className: o()(Su.iconLayer, Su.iconHover, Su.subtitlesHover),
                            }),
                          n().createElement("div", {
                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = o(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = Wu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, Wu.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                i = a.reduce((u, [e, t]) => ((u[t] = Wu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, Wu.aD)((u) => {
