        ...
        const Mu = {
          ...
          Pu = Lu((u) => {
            ...
            return J().createElement(
              "div",
              Ru({ className: n()(Tu.base, ...G, e), style: I }, N),
              P,
            );
          });
        let Nu;
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = D(e);
                            if (Array.isArray(u)) {
                              const A = u.reduce((u, e) => ((u[e] = Ce.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, Ce.aD)((e) => {
                            ...
                            }
                            {
                              const A = u,
                                E = Object.entries(A),
                                F = E.reduce((u, [e, t]) => ((u[t] = Ce.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, Ce.aD)((u) => {
                    ...
                    J().createElement(
                      ...
                      !a &&
                        J().createElement(
                          ...
                          J().createElement(Fe, {
                            className: n()(he.operationText__done, he[`operationText__${B}`]),
                            text: String(A),
                          }),
                          J().createElement(Fe, {
                            className: n()(
                          ...
                          J().createElement(Fe, {
                            className: n()(he.operationText, o && he[`operationText__${B}`]),
                            text: String(E),
                          }),
                        ),
                      i &&
                        ...
                        J().createElement(
                          ...
                          F.map((u, e) => {
                            ...
                            return J().createElement(
                              ...
                              u.name &&
                                J().createElement(Fe, { text: u.name, className: he.rewardText }),
                            );
                          }),
                        ),
                      ),
