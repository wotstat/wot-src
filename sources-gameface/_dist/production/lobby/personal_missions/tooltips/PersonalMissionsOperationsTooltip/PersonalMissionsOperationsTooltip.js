    ...
    e = {
      ...
      67: (u, e, t) => {
        ...
        const Ru = {
          ...
          Pu = Lu((u) => {
            ...
            return J().createElement(
              "div",
              Mu({ className: n()(Tu.base, ...I, e), style: G }, N),
              P,
            );
          });
        let Nu;
        ...
        const _e = ((u, e) => {
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = D(e);
                            if (Array.isArray(u)) {
                              const A = u.reduce((u, e) => ((u[e] = oe.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, oe.aD)((e) => {
                            ...
                            }
                            {
                              const A = u,
                                E = Object.entries(A),
                                F = E.reduce((u, [e, t]) => ((u[t] = oe.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, oe.aD)((u) => {
            ...
            const e = {
                root: u.object(),
                branches: u.array("branches"),
                rewards: u.array("rewards"),
              },
              t = (0, de.Om)(() => ce(e.branches.get(), (u) => Object.assign({}, u)), {
                equals: le,
              }),
              r = (0, de.Om)(() => ce(e.rewards.get(), (u) => Object.assign({}, u)), {
                equals: le,
              });
                      ...
                      J().createElement(
                        ...
                        D.map((u, e) => {
                          ...
                          return J().createElement(
                            ...
                            J().createElement(
                              "div",
                              { className: n()(pe.branch, e === u.length - 1 && pe.branch__last) },
                              J().createElement(Ae, {
                              ...
                              J().createElement(Ae, {
                                className: n()(pe.branchText, !r && pe[`branchText__${t}`]),
                                text: String(u.all),
                              }),
                            ),
                          );
                      ...
                      J().createElement(
                        ...
                        J().createElement(
                          ...
                          i.map((u, e) => {
                            ...
                            return J().createElement(
                              "div",
                              { key: u.icon, className: n()(pe.reward, t && pe.reward__lastInRow) },
                              J().createElement("div", {
                                className: pe.rewardIcon,
                                style: { backgroundImage: `url(${u.icon})` },
                              }),
                              u.name &&
                                J().createElement(Ae, { text: u.name, className: pe.rewardText }),
                            );
                          }),
                        ),
                      ),
