        ...
        const Cu = ({ modelPath: e = "model", title: t, subTitle: u }) => {
          ...
          return r().createElement(
            ...
            r().createElement(
              ...
              { className: d },
              o === Du.Normal &&
                r().createElement(mu, { title: t, subTitle: u, isLargeWindowed: c }),
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const n = l(t);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, t) => ((e[t] = wu.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, wu.aD)((t) => {
                            ...
                            }
                            {
                              const r = e,
                                o = Object.entries(r),
                                i = o.reduce((e, [t, u]) => ((e[u] = wu.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, wu.aD)((e) => {
