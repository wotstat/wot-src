              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (o(), window.removeEventListener(i, E), (u.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(t)),
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const n = u,
                                i = Object.entries(n),
                                a = i.reduce((u, [e, t]) => ((u[t] = Fu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, Fu.aD)((u) => {
        ...
        const bu = (0, eu.Pi)(() => {
          ...
          return n().createElement(
            ...
            n().createElement(
              Z,
              {
                body: R.strings.personal_missions_3.tooltips.IntroVideoView.body(),
                ignoreShowDelay: !0,
              },
              n().createElement(G, {
                classNames: { base: gu },
