  ...
  var __webpack_modules__ = {
              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (s(), window.removeEventListener(o, l), (e.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(n)),
      ...
      5390: (e, t, n) => {
        ...
        const P = ((e, t) => {
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = l(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, t) => ((e[t] = h.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  s.subscribe(
                                    (0, h.aD)((t) => {
                            ...
                            }
                            {
                              const a = e,
                                o = Object.entries(a),
                                i = o.reduce((e, [t, n]) => ((e[n] = h.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  s.subscribe(
                                    (0, h.aD)((e) => {
            ...
            ({ externalModel: e }) => ({
              showProgression: e.createCallbackNoArgs("showProgression"),
            }),
          ),
          S = P[0],
          k = P[1],
