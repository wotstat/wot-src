  ...
  var __webpack_modules__ = {
              ...
              (e[A] = (function (e) {
                return (A) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (D(), window.removeEventListener(t, n), (u.listeners -= 1), E(), (F = !1));
                    }
                  );
                };
              })(A)),
      ...
      951: (u, e, A) => {
        ...
        const N = F().forwardRef(function (u, e) {
            ...
            return (
              (0, E.useLayoutEffect)(() => {
                const u = v.O.client.getSize("rem");
          ...
          z = "AlertTooltip_header_dbda7",
          j = "AlertTooltip_description_eaf9b",
          $ = "AlertTooltip_dangerIcon_a33d4",
          W = () => {
            const u = x(),
              e = u.header,
              A = u.body;
            return F().createElement(
              ...
              F().createElement(
                ...
                F().createElement(
                  "div",
                  { className: j },
                  F().createElement("span", { className: $ }),
        ...
        engine.whenReady.then(() => {
          D().render(F().createElement(W, null), document.getElementById("root"));
        });
      },
      363: (u) => {
        u.exports = React;
