  ...
  var __webpack_modules__ = {
        ...
        (!(function () {
          ...
          (document.addEventListener("mousedown", (u) => {
            ...
            document.addEventListener("mousemove", (u) => {
              if (
                (-1 === s && u.target.select && u.target === e && (s = e.selectionStart), s > -1)
              ) {
      ...
      55: (e, t, u) => {
        ...
        const w = {
          ...
          V = (0, l.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = z, onDrag: n = H }) => {
        ...
        const q = y({
          ...
          ae = (0, l.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = ne, onDrag: n = te }) => {
              const r = (0, l.useRef)(null),
                o = (0, l.useRef)(null),
                s = (0, l.useRef)(null),
                d = (0, l.useRef)(null),
                ...
                C = g(() => {
                  ...
                  return (
                    ...
                    (t.style.display = "flex"),
                    r.current &&
                      (1 !== a ? r.current.classList.add(K) : r.current.classList.remove(K)),
                    a
                  );
                }),
                B = g(() => {
                  ...
                  ((u.style.transform = `translateY(${0 | c}px)`),
                    ((e) => {
                      if (o.current && s.current && d.current && m.current) {
                        if (0 === Math.round(e))
                          return (o.current.classList.add(ee), void s.current.classList.remove(ee));
                        if (
                          ((t = d.current),
                          (u = m.current),
                          e - (t.offsetHeight - u.offsetHeight) >= -0.5)
                        )
                          return (o.current.classList.remove(ee), void s.current.classList.add(ee));
                        var t, u;
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const n = l(t);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, t) => ((e[t] = be.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  i.subscribe(
                                    (0, be.aD)((t) => {
                            ...
                            }
                            {
                              const r = e,
                                o = Object.entries(r),
                                a = o.reduce((e, [t, u]) => ((e[u] = be.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  i.subscribe(
                                    (0, be.aD)((e) => {
