(() => {
  var __webpack_modules__ = {
      ...
      5900: (e, t, n) => {
        ...
        const l = (0, a.memo)(function (e) {
            let t = e.width,
              ...
              p = void 0 === b ? u.O.INITIAL_FRAME_INDEX : b,
              v = e.lastFrameIndex,
              f = void 0 === v ? m - 1 : v,
              h = e.loop,
              A = void 0 === h ? u.O.LOOP : h,
              C = e.state,
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                switch (F) {
                  ...
                  case "stop":
                    return (function () {
                      const e = 0 === p && D ? { path: D, x: 0, y: 0 } : l(p),
                        t = new Image();
                      t.src = e.path;
                      const a = () => n(c(e, t));
                      return (
      ...
      1672: (e, t, n) => {
        ...
        const o = ({ children: e, tooltipArgs: t, className: n }) => {
          ...
          const o = t.contentId;
          return o
            ? r().createElement(s.u, l({}, t, { contentId: o }), a)
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const u = e,
                              i = Object.entries(u),
                              s = i.reduce((e, [t, n]) => ((e[n] = r.LO.box(a[t], {})), e), {});
                            return (
                              "real" === n &&
                                c.subscribe(
                                  (0, r.aD)((e) => {
              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (i(), window.removeEventListener(u, s), (e.listeners -= 1), a(), (r = !1));
                    }
                  );
                };
              })(n)),
            ...
            (0, a.useEffect)(() => {
              ...
              const i = ((e, t, n) => {
                ...
                d = setInterval(() => {
                  const e = s(),
                    t = i[e];
                  (u(i[e]), m(e, t), e === a && (C(), v || clearInterval(d)));
                }, g);
              return () => clearInterval(d);
            }, [c, g, o, n, b, v, m, C, h, t, w]),
      ...
      2729: (e, t, n) => {
        ...
        const re = {
          ...
          fe = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = be, onDrag: a = pe }) => {
                  ...
                  ((n.style.transform = `translateX(${0 | m}px)`),
                    ((e) => {
                      if (u.current && l.current && o.current && d.current) {
                        if (0 === e)
                          return (u.current.classList.add(ge), void l.current.classList.remove(ge));
                        if (
                          ((t = o.current),
                          (n = d.current),
                          e - (t.offsetWidth - n.offsetWidth) >= -0.5)
                        )
                          return (u.current.classList.remove(ge), void l.current.classList.add(ge));
                        var t, n;
          ...
          Ce = ({ api: e, className: t, classNames: n, children: a }) => (
            (0, i.useEffect)(() => V(e.recalculateContent)),
            s().createElement(
              "div",
        ...
        const Fe = ue({
          ...
          Me = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = xe, onDrag: a = Te }) => {
              const r = (0, i.useRef)(null),
                u = (0, i.useRef)(null),
                l = (0, i.useRef)(null),
                o = (0, i.useRef)(null),
                ...
                f = Y(() => {
                  ...
                  ((n.style.transform = `translateY(${0 | m}px)`),
                    ((e) => {
                      if (u.current && l.current && o.current && d.current) {
                        if (0 === Math.round(e))
                          return (u.current.classList.add(Ne), void l.current.classList.remove(Ne));
                        if (
                          ((t = o.current),
                          (n = d.current),
                          e - (t.offsetHeight - n.offsetHeight) >= -0.5)
                        )
                          return (u.current.classList.remove(Ne), void l.current.classList.add(Ne));
                        var t, n;
          ...
          We = ({ className: e, classNames: t, children: n, api: a }) => (
            (0, i.useEffect)(() => V(a.recalculateContent)),
            s().createElement(
              "div",
          ...
          return o().createElement(
            ...
            i.UI(e, (e, t) => {
              ...
              return o().createElement(
                ...
                o().createElement(
                  g.U,
                  v({ size: l, type: n, efficiencyState: a, skillState: u }, e),
                ),
              );
            }),
                  ...
                  u().createElement(
                    ...
                    u().createElement(
                      ...
                      u().createElement(
                        "div",
                        { className: De },
                        u().createElement(B.u5, { onClick: d }, R.strings.crew_widget.btnDetails()),
                      ),
                    ),
                  ),
                ),
        ...
        const Rt = { transform: new ie.SpringValue("translateX(0rem)") },
          ...
          Pt = (0, l.Pi)(({ layoutInfo: e, isWidgetDisabled: t, className: n, slotSize: a }) => {
            ...
            return u().createElement(
              "div",
              {
                ...
                className: v()(Lt, e.isCurrentLayoutHangar && xt, n),
              },
              i.computes
                .getSlots()
                .map((n, r) =>
          ...
          zt = (0, r.memo)(() =>
            u().createElement(
              a.z,
              null,
              u().createElement(E, { options: Wt }, u().createElement(Ht, null)),
            ),
          );
      },
      6392: (e, t, n) => {
                ...
                m.UI(u, ({ id: n, isSelected: a, tooltip: u, icon: l, counter: c }) =>
                  r().createElement(
                    ...
                    r().createElement(
                      ...
                      r().createElement(I, { id: n, icon: l, type: t, isSmall: g, isSelected: a }),
                    ),
                  ),
                ),
              ),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(2729));
