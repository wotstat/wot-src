  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      o &&
                        (a(), window.removeEventListener(r, i), (u.listeners -= 1), n(), (o = !1));
                    }
                  );
                };
              })(t)),
      ...
      1956: (u, e, t) => {
        ...
        const L = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? o().createElement(A, I({}, e, { contentId: r }), n)
            : o().createElement(S, e, n);
        };
        let V = (function (u) {
          return (
            (u[(u.LEFT = 0)] = "LEFT"),
                ...
                k(r, ({ id: t, isSelected: n, tooltip: r, icon: i, counter: l }) =>
                  o().createElement(
                    ...
                    o().createElement(
                      ...
                      o().createElement(Cu, { id: t, icon: i, type: e, isSmall: E, isSelected: n }),
                    ),
                  ),
                ),
              ),
                      ...
                      E = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const o = u.reduce((u, e) => ((u[e] = hu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, hu.aD)((e) => {
                            ...
                            }
                            {
                              const o = u,
                                r = Object.entries(o),
                                a = r.reduce((u, [e, t]) => ((u[t] = hu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, hu.aD)((u) => {
