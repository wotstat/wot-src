      ...
      5578: (u, e, t) => {
        ...
        const ee = {
          ...
          re = Zu((u) => {
            ...
            return r().createElement(
              "div",
              ue({ className: h()(Qu.base, ...U, e), style: G }, I),
              N,
            );
          }),
        ...
        const we = {
          ...
          xe = (0, n.memo)(
            ({
              ...
              const _ = ((u, e) =>
                  Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(F, fe),
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = E(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = Te.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Te.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = Te.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Te.aD)((u) => {
