      ...
      1288: (u, e, t) => {
        ...
        const ie = (u) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: D()(ne.goto, null == o ? void 0 : o.goto) }, a),
          );
        };
        let oe = (function (u) {
          return (
        ...
        const _e = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const a = e.contentId;
          return a
            ? r().createElement(Ou, De({}, e, { contentId: a }), n)
        ...
        const pe = {
            [ge.NBSP]: me.NoBreakSymbol,
            [ge.ZWNBSP]: me.NoBreakSymbol,
            [ge.NEW_LINE]: me.LineBreak,
          },
          ...
          ke = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : r().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: xe },
                  u,
                );
          },
          Le = {
            ...
            [me.NewLine]: ({ elementList: u, key: e }) =>
              r().createElement(
                "span",
                { key: e, "data-block-type": me.NewLine, className: ye },
                u,
              ),
                ...
                (u) => {
                  ...
                  r === me.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: me.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
        ...
        const Je = ({
          ...
          return r().createElement(
            ...
            r().createElement(
              "div",
              { className: D()(Xe.name, null == c ? void 0 : c.name) },
              E ? t : e,
            ),
          );
        };
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = l(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = tt.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, tt.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = tt.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, tt.aD)((u) => {
