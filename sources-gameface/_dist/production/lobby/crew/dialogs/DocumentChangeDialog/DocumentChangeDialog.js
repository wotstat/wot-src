      ...
      7734: (e, u, t) => {
        ...
        const ne = (e) => {
          ...
          de = (0, a.memo)(({ id: e, fallback: u, onLoadCallback: t, mixClass: n }) => {
            ...
            return u
              ? o().createElement("div", { className: F }, o().createElement(u, null))
              : null;
          }),
        ...
        const Qe = (e) => {
          ...
          return o().createElement(
            ...
            n &&
              o().createElement("div", { className: D()(Ye.goto, null == r ? void 0 : r.goto) }, n),
          );
        };
        let Je = (function (e) {
          return (
        ...
        const eu = {
          ...
          uu = (0, a.memo)(
            ({
              ...
              const A = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(E, Je),
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                o = a.reduce((e, [u, t]) => ((e[t] = ru.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, ru.aD)((e) => {
        ...
        const Du = ({ children: e, tooltipArgs: u, className: t }) => {
            ...
            const r = u.contentId;
            return r
              ? o().createElement(we, Fu({}, u, { contentId: r }), n)
              : o().createElement(Au, u, n);
          },
          fu = [];
        function gu(e) {
        ...
        const Tu = {
          ...
          qu = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = ju, onDrag: n = Uu }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
                  ...
                  ((t.style.transform = `translateX(${0 | E}px)`),
                    ((e) => {
                      if (i.current && l.current && c.current && d.current) {
                        if (0 === e)
                          return (i.current.classList.add($u), void l.current.classList.remove($u));
                        if (
                          ((u = c.current),
                          (t = d.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (i.current.classList.remove($u), void l.current.classList.add($u));
                        var u, t;
        ...
        const Zu = ku({
          ...
          dt = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = st, onDrag: n = ot }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
                ...
                g = gu(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | E}px)`),
                    ((e) => {
                      if (i.current && l.current && c.current && d.current) {
                        if (0 === Math.round(e))
                          return (i.current.classList.add(at), void l.current.classList.remove(at));
                        if (
                          ((u = c.current),
                          (t = d.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (i.current.classList.remove(at), void l.current.classList.add(at));
                        var u, t;
