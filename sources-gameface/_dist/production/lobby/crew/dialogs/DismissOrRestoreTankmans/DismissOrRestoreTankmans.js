      ...
      872: (u, e, t) => {
        ...
        const au = /<link.*?>/g,
          ...
          _u = (0, n.memo)(({ id: u, fallback: e, onLoadCallback: t, mixClass: a }) => {
            ...
            return e
              ? r().createElement("div", { className: d }, r().createElement(e, null))
              : null;
          });
        function du(u) {
            ...
            r().createElement(
              ...
              r().createElement(
                ...
                ju(
                  {
                    onClose: D,
                    buttons: r().createElement(Iu, null),
                    displayFlags: l,
                    isShown: !c,
                  },
                  C,
                      ...
                      c = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = l(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = Xu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Xu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = Xu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Xu.aD)((u) => {
        ...
        const ae = {
          ...
          ie = (0, n.memo)(
            ({
              ...
              const D = ((u, e) =>
                  Object.keys(e).reduce((e, t) => ((e[t] = u.includes(t)), e), {}))(c, re),
        ...
        const Se = {
          ...
          Oe = we((u) => {
            ...
            return r().createElement(
              "div",
              Me({ className: p()(xe.base, ...U, e), style: G }, I),
              P,
            );
          }),
          ...
          et = (0, n.memo)(
            ({ tankmans: u, limitOverCount: e, tankmansWithPerk: t, setIsButtonDisabled: a }) => {
              ...
              return r().createElement(
                ...
                i &&
                  r().createElement("div", { className: Ee }, r().createElement(Je, { count: e })),
                r().createElement(ze, {
                  className: le,
                        ...
                        format: {
                          binding: {
                            count: r().createElement(
                              "div",
                              { className: _e },
                              r().createElement(ze, { text: String(i ? e : t), className: Ae }),
