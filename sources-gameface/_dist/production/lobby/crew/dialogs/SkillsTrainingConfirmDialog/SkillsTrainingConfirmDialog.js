      ...
      5479: (e, u, t) => {
        ...
        const Ke = (e) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: _()(Ge.goto, null == o ? void 0 : o.goto) }, a),
          );
        };
        let Ye = (function (e) {
          return (
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                i = a.reduce((e, [u, t]) => ((e[t] = eu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, eu.aD)((e) => {
        ...
        const Cu = (0, je.Pi)((e) => {
          ...
          return r().createElement(
            ...
            Bu({ onClose: u, buttons: t, displayFlags: a, isShown: n }, i, {
              ...
              title: R.strings.dialogs.skillsTrainingConfirm.message(),
            }),
          );
        });
        engine.whenReady.then(() => {
