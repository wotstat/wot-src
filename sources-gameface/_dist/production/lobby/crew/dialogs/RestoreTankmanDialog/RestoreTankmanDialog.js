      ...
      8741: (u, e, t) => {
            ...
            a().createElement(
              ...
              a().createElement(
                ...
                Ju(
                  {
                    onClose: m,
                    buttons: a().createElement(qu, null),
                    displayFlags: l,
                    isShown: !_,
                  },
                  g,
        ...
        const Ee = {
          ...
          me = oe((u) => {
            ...
            return a().createElement(
              "div",
              ce({ className: h()(se.base, ...$, e), style: G }, P),
              I,
            );
          }),
                      ...
                      _ = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = l(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = Ge.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Ge.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                r = Object.entries(a),
                                i = r.reduce((u, [e, t]) => ((u[t] = Ge.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Ge.aD)((u) => {
          ...
          Et = (0, n.memo)(({ name: u, size: e = lt.c100x60, className: t, isSkin: n = !1 }) => {
            ...
            return a().createElement(
              "div",
              {
                ...
                className: h()(st.base, st[`base__${e}`], t),
              },
        ...
        const Ct = ({
            ...
            return a().createElement(
              ...
              a().createElement(
                "div",
                { className: h()(Ft.level, null == E ? void 0 : E.level) },
                dt(r),
              ),
              a().createElement("div", {
        ...
        const Gt = a().memo(function ({ icon: u, type: e, size: t }) {
            ...
            return a().createElement(
              ...
              i &&
                a().createElement("div", { className: h()(Pt.icon, Pt[`icon__${e}`]), style: i }),
            );
          }),
          $t = {
            base: "Skill_base_a9",
