      ...
      8128: (e, t, u) => {
        ...
        const ot = (e) => {
          ...
          return a().createElement(
            ...
            r &&
              a().createElement("div", { className: g()(it.goto, null == l ? void 0 : l.goto) }, r),
          );
        };
        let ct = (function (e) {
          return (
        ...
        const _t = {
          ...
          mt = (0, n.memo)(
            ({
              ...
              const m = ((e, t) =>
                  Object.keys(t).reduce((t, u) => ((t[u] = e.includes(u)), t), {}))(d, ct),
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const n = o(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, t) => ((e[t] = gt.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  s.subscribe(
                                    (0, gt.aD)((t) => {
                            ...
                            }
                            {
                              const a = e,
                                r = Object.entries(a),
                                i = r.reduce((e, [t, u]) => ((e[u] = gt.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  s.subscribe(
                                    (0, gt.aD)((e) => {
        ...
        const Vu = ({ children: e, tooltipArgs: t, className: u }) => {
            ...
            const r = t.contentId;
            return r
              ? a().createElement(Me, ju({}, t, { contentId: r }), n)
              : a().createElement($t, t, n);
          },
        ...
        const Ku = a().memo(function ({ iconName: e, size: t = Yu.c24x24, className: u }) {
          ...
          Qu = ({
            ...
            return a().createElement(
              ...
              m &&
                l === uu.Learned &&
                a().createElement("div", { className: Zu.newSkillHighLight }),
                ...
                a().createElement(
                  ...
                  a().createElement(
                    ...
                    t
                      ...
                      : a().createElement(
                          St,
                          Dn({}, e.tankmanVehicleInfo, { type: Tt.whiteSpanish, isShortName: !0 }),
                        ),
                  ),
                ),
                a().createElement(gn, {
          ...
          Wn = a().memo(({ duration: e }) =>
            a().createElement(
              ...
              a().createElement(
                "div",
                { className: $n },
                a().createElement(Rn, { duration: ae(e, 1) }),
              ),
            ),
          ),
        ...
        const ra = {
            [aa.NBSP]: ua.NoBreakSymbol,
            [aa.ZWNBSP]: ua.NoBreakSymbol,
            [aa.NEW_LINE]: ua.LineBreak,
          },
          ...
          ma = ({ elementList: e, textBlock: t, key: u }) => {
            ...
            return n
              ...
              : a().createElement(
                  "span",
                  { key: u, "data-block-type": t.blockType, className: da },
                  e,
                );
          },
          Ea = {
            ...
            [ua.NewLine]: ({ elementList: e, key: t }) =>
              a().createElement(
                "span",
                { key: t, "data-block-type": ua.NewLine, className: ca },
                e,
              ),
                ...
                (e) => {
                  ...
                  a === ua.LineBreak
                    ? n.push(
                        ...((e) => {
                          const t = [
                            { blockType: ua.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
