(() => {
  var __webpack_modules__ = {
      ...
      8901: (e, u, t) => {
        ...
        const du = {
            [_u.NBSP]: cu.NoBreakSymbol,
            [_u.ZWNBSP]: cu.NoBreakSymbol,
            [_u.NEW_LINE]: cu.LineBreak,
          },
          mu = {
          ...
          Fu = ({ elementList: e, textBlock: u, key: t }) => {
            ...
            return n
              ? mu[n]
                ...
                : r().createElement(
                    "span",
                    { key: t, "data-block-type": u.blockType, style: pu(n) },
                    e,
                  )
          ...
          Du = {
            ...
            [cu.NewLine]: ({ elementList: e, key: u }) =>
              r().createElement(
                "span",
                { key: u, "data-block-type": cu.NewLine, className: Au },
                e,
              ),
        ...
        const Hu = {
          ...
          Uu = (0, n.memo)(
            ({
              ...
              const h = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(d, Ru),
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = c(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = Vu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Vu.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                i = Object.entries(r),
                                a = i.reduce((e, [u, t]) => ((e[t] = Vu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Vu.aD)((e) => {
            ...
            et({ onClose: u, buttons: t, displayFlags: i, isShown: n }, a, {
              ...
              footer: r().createElement(
                ...
                r().createElement(
                  "div",
                  { className: Qu },
                  r().createElement(Ke, o.bookPrice.get()),
                ),
              ),
            }),
          );
