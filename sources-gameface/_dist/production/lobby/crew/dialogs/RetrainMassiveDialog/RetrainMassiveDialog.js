  ...
  var __webpack_modules__ = {
      ...
      1672: (e, u, t) => {
        ...
        const l = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const l = u.contentId;
          return l
            ? r().createElement(o.u, s({}, u, { contentId: l }), n)
      ...
      6758: (e, u, t) => {
        ...
        const s = (e) => e.replace(/&nbsp;/g, " "),
          ...
          D = (e, u, t) =>
            e.split(/%\((.*?)\)(?:[sd])?/g).map((e) => (t && e in t ? t[e] : A(e, u))),
      ...
      3591: (e, u, t) => {
        ...
        const x = (e) => {
          ...
          M = (0, r.memo)(({ id: e, fallback: u, onLoadCallback: t, mixClass: n }) => {
            ...
            return u
              ? a().createElement("div", { className: f }, a().createElement(u, null))
              : null;
          }),
        ...
        const fe = (e) => {
          ...
          return a().createElement(
            ...
            n &&
              a().createElement("div", { className: o()(me.goto, null == i ? void 0 : i.goto) }, n),
          );
        };
        let Fe = (function (e) {
          return (
        ...
        const be = {
          ...
          Be = (0, r.memo)(
            ({
              ...
              const m = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(_, Fe),
        ...
        const xe = (0, he.q3)()(
            ({ observableModel: e }) => {
              const u = Object.assign({}, e.primitives(["isPriceSelected", "isPriceVisible"]), {
                ...
                n = (0, ye.Om)(
                  () => we.u4(u.tankmen.get(), (e, u) => (u.isSelected ? e + 1 : e), 0),
                  { equals: ve.jv },
                );
      ...
      5447: (e, u, t) => {
                  ...
                  ((t.style.transform = `translateX(${0 | _}px)`),
                    ((e) => {
                      if (o.current && s.current && l.current && c.current) {
                        if (0 === e)
                          return (o.current.classList.add(ge), void s.current.classList.remove(ge));
                        if (
                          ((u = l.current),
                          (t = c.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (o.current.classList.remove(ge), void s.current.classList.add(ge));
                        var u, t;
        ...
        const ke = de({
          ...
          ze = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = We, onDrag: n = Ie }) => {
              const r = (0, a.useRef)(null),
                o = (0, a.useRef)(null),
                s = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                ...
                F = Z(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | _}px)`),
                    ((e) => {
                      if (o.current && s.current && l.current && c.current) {
                        if (0 === Math.round(e))
                          return (o.current.classList.add(Me), void s.current.classList.remove(Me));
                        if (
                          ((u = l.current),
                          (t = c.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (o.current.classList.remove(Me), void s.current.classList.add(Me));
                        var u, t;
        ...
        const xu = ({ header: e, body: u, contentId: t }, n, r) =>
          ...
          ku = ({
            ...
            (0, a.useEffect)(() => {
              L !== H.None &&
                C.O.sound.play.sound(
                  L === H.Increase ? v.gO.CREW_RETRAIN_UP : v.gO.CREW_RETRAIN_DOWN,
                );
            }, [L]);
            const I = A()(
              wu.base,
        ...
        const Lu = (0, f.Pi)(function ({ rootId: e, className: u }) {
          ...
          Ru = i().memo(function ({
            ...
            return i().createElement(
              _,
              { options: t },
              i().createElement(Lu, { rootId: e, className: u }),
            );
          });
      },
      3335: (e, u, t) => {
