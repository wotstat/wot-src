      ...
      6759: (e, t, u) => {
        ...
        const re = (e) => {
          ...
          _e = (0, a.memo)(({ id: e, fallback: t, onLoadCallback: u, mixClass: n }) => {
            ...
            return t
              ? o().createElement("div", { className: g }, o().createElement(t, null))
              : null;
          }),
            ...
            o().createElement(
              ...
              o().createElement(
                ...
                Ke(
                  {
                    onClose: E,
                    buttons: o().createElement(je, null),
                    displayFlags: l,
                    isShown: !_,
                  },
                  D,
        ...
        const tt = ({ children: e, tooltipArgs: t, className: u }) => {
          ...
          const r = t.contentId;
          return r
            ? o().createElement(ye, et({}, t, { contentId: r }), n)
            : o().createElement(Je, t, n);
        };
        var ut = u(1311);
        const nt = {
        ...
        const it = {
            [ot.NBSP]: rt.NoBreakSymbol,
            [ot.ZWNBSP]: rt.NoBreakSymbol,
            [ot.NEW_LINE]: rt.LineBreak,
          },
          ...
          gt = {
            ...
            [rt.NewLine]: ({ elementList: e, key: t }) =>
              o().createElement(
                "span",
                { key: t, "data-block-type": rt.NewLine, className: _t },
                e,
              ),
                ...
                (e) => {
                  ...
                  r === rt.LineBreak
                    ? n.push(
                        ...((e) => {
                          const t = [
                            { blockType: rt.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
        ...
        const Ot = (e) => {
          ...
          return o().createElement(
            ...
            n &&
              o().createElement("div", { className: p()(Lt.goto, null == r ? void 0 : r.goto) }, n),
          );
        };
        let It = (function (e) {
          return (
        ...
        const Pt = {
          ...
          Ht = (0, a.memo)(
            ({
              ...
              const f = ((e, t) =>
                  Object.keys(t).reduce((t, u) => ((t[u] = e.includes(u)), t), {}))(_, It),
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const n = l(t);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, t) => ((e[t] = Vt.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  i.subscribe(
                                    (0, Vt.aD)((t) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                o = a.reduce((e, [t, u]) => ((e[u] = Vt.LO.box(n[t], {})), e), {});
                              return (
                                "real" === u &&
                                  i.subscribe(
                                    (0, Vt.aD)((e) => {
        ...
        const Cu = {
          ...
          Pu = (0, a.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = Nu, onDrag: n = Ou }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
        ...
        const $u = vu({
          ...
          un = (0, a.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = Ju, onDrag: n = Zu }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
          ...
          Nn = ({ id: e, label: t, isDisabled: u }, n = !1) => {
            ...
            return o().createElement(
              ...
              o().createElement(
                "div",
                { className: Sn },
                n ? o().createElement(Oe, { content: t }) : t,
              ),
            );
          },
          ...
          Qn = ({ id: e, label: t, isDisabled: u, meta: n }, r = !1) => {
            ...
            return o().createElement(
              ...
              o().createElement(
                "div",
                { className: _ },
                r ? o().createElement(Oe, { content: t }) : t,
              ),
            );
          },
          ...
          fr = (0, Xe.Pi)(() => {
            ...
            return o().createElement(
              ...
              o().createElement(
                ...
                { className: dr },
                A.map((e, t) =>
                  o().createElement(Bn, { key: t, showIcon: 0 === t, className: _r }, e),
                ),
              ),
              o().createElement(
                "div",
