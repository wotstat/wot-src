      ...
      9808: (e, u, t) => {
        ...
        const qe = (e) => {
          ...
          return a().createElement(
            ...
            r &&
              a().createElement("div", { className: F()(je.goto, null == o ? void 0 : o.goto) }, r),
          );
        };
        let Ke = (function (e) {
          return (
        ...
        const Ye = {
          ...
          Xe = (0, n.memo)(
            ({
              ...
              const m = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(_, Ke),
                      ...
                      E = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, u) => ((e[u] = iu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, iu.aD)((u) => {
                            ...
                            }
                            {
                              const a = e,
                                r = Object.entries(a),
                                i = r.reduce((e, [u, t]) => ((e[t] = iu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, iu.aD)((e) => {
        ...
        const hu = a().memo(function ({ role: e, size: u = bu.c30x30, className: t }) {
            ...
            return a().createElement("div", {
              style: r,
              className: F()(gu.base, gu[`base__${u}`], t),
            });
          }),
          Bu = {
          ...
          Ru = () =>
            a().createElement(
              ...
              a().createElement(
                "div",
                { className: Mu },
                R.strings.dialogs.fillAllPerks.subTitle(),
              ),
              a().createElement(
                "div",
                { className: Ou },
                R.strings.dialogs.fillAllPerks.description(),
              ),
            ),
