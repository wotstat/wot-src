(() => {
  var __webpack_modules__ = {
      ...
      5900: (e, t, n) => {
        ...
        const o = (0, a.memo)(function (e) {
            let t = e.width,
              ...
              f = void 0 === E ? i.O.INITIAL_FRAME_INDEX : E,
              p = e.lastFrameIndex,
              v = void 0 === p ? _ - 1 : p,
              h = e.loop,
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                switch (C) {
                  ...
                  case "stop":
                    return (function () {
                      const e = 0 === f && y ? { path: y, x: 0, y: 0 } : o(f),
                        t = new Image();
                      t.src = e.path;
                      const a = () => n(c(e, t));
                      return (
      ...
      1672: (e, t, n) => {
        ...
        const u = ({ children: e, tooltipArgs: t, className: n }) => {
          ...
          const u = t.contentId;
          return u
            ? r().createElement(l.u, o({}, t, { contentId: u }), a)
            : r().createElement(i.t, t, a);
        };
      },
      6485: (e, t, n) => {
        "use strict";
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const i = e,
                              s = Object.entries(i),
                              l = s.reduce((e, [t, n]) => ((e[n] = r.LO.box(a[t], {})), e), {});
                            return (
                              "real" === n &&
                                c.subscribe(
                                  (0, r.aD)((e) => {
              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (s(), window.removeEventListener(i, l), (e.listeners -= 1), a(), (r = !1));
                    }
                  );
                };
              })(n)),
            ...
            (0, a.useEffect)(() => {
              ...
              const s = ((e, t, n) => {
                ...
                d = setInterval(() => {
                  const e = l(),
                    t = s[e];
                  (i(s[e]), _(e, t), e === a && (w(), p || clearInterval(d)));
                }, g);
              return () => clearInterval(d);
            }, [c, g, u, n, E, p, _, w, h, t, k]),
            r().createElement("canvas", s({}, D, { width: t, height: n, ref: y }))
          );
        });
      },
      1605: (e, t, n) => {
        ...
        const E = (e) => {
          ...
          return l().createElement(
            ...
            a &&
              l().createElement("div", { className: d()(m.goto, null == r ? void 0 : r.goto) }, a),
          );
        };
        var f = n(4020),
          p = n(828);
        ...
        const j = {
          ...
          ae = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = ee, onDrag: a = te }) => {
        ...
        const le = $({
          ...
          Ae = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = pe, onDrag: a = Ee }) => {
              const r = (0, s.useRef)(null),
                i = (0, s.useRef)(null),
                o = (0, s.useRef)(null),
                u = (0, s.useRef)(null),
        ...
        const Oe = {
            [Te.NBSP]: Le.NoBreakSymbol,
            [Te.ZWNBSP]: Le.NoBreakSymbol,
            [Te.NEW_LINE]: Le.LineBreak,
          },
          ...
          $e = ({ elementList: e, textBlock: t, key: n }) => {
            ...
            return a
              ...
              : l().createElement(
                  "span",
                  { key: n, "data-block-type": t.blockType, className: ze },
                  e,
                );
          },
          Ge = {
            ...
            [Le.NewLine]: ({ elementList: e, key: t }) =>
              l().createElement(
                "span",
                { key: t, "data-block-type": Le.NewLine, className: We },
                e,
              ),
          ...
          Ze = (e, t, n, a) => {
            let r = t.exec(e),
              i = 0;
            for (; r;)
              (i !== r.index && n(e.slice(i, r.index)), a(r), (i = t.lastIndex), (r = t.exec(e)));
                ...
                (e) => {
                  ...
                  r === Le.LineBreak
                    ? a.push(
                        ...((e) => {
                          const t = [
                            { blockType: Le.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
        ...
        const ot = {
          ...
          Ct = l().memo(function ({
            ...
            const s = a === e ? 2 : (a / t) * 254,
              ...
              m = (0, W.useSpring)(
                Object.assign({ from: { left: 2 }, to: { left: s }, delay: wt }, _),
              ),
              g = (0, W.useSpring)(
                Object.assign({ from: { width: e }, to: { width: o }, delay: wt }, _),
              );
            return l().createElement(
              "div",
              { className: gt },
        ...
        const En = [
          ...
          fn = (0, k.q3)()(
                ...
                a = (0, bn.Om)(
                  (t) => {
                    const n = ye.UI(e.array("skillsList.irrelevantSkillsList").get(), (e) =>
                        Object.assign({}, e, { popularityList: ye.UI(e.popularityList, mn.yR) }),
                      ),
            ...
            ({ externalModel: e }) => ({
              ...
              onSortingSelectionChange: e.createCallback(
                (e) => e || {},
                "onSortingSelectionChange",
              ),
            }),
          ),
          pn = fn[0],
        ...
        const Yn = ({
          ...
          Jn = (0, s.memo)(
            ({
              ...
              (0, s.useEffect)(() => N(() => N(X)), [X, i, n.length]);
        ...
        const ia = l().memo(function ({ role: e, size: t = ra.c30x30, className: n }) {
            ...
            return l().createElement("div", {
              style: a,
              className: d()(aa.base, aa[`base__${t}`], n),
            });
          }),
          ...
          _a = ({ id: e, label: t, isDisabled: n }, a = !1) => {
            ...
            return l().createElement(
              ...
              l().createElement(
                "div",
                { className: ca },
                a ? l().createElement(On, { content: t }) : t,
              ),
            );
          },
          ma = {
            ...
            availablePointsTitle__allSkillsLearned:
              "Header_availablePointsTitle__allSkillsLearned_a9635",
        ...
        const ba = (0, w.Pi)(() => {
          const e = vn(),
            ...
            c = ((e, t) => (e ? ga.AllSkillsLearned : t === ta.sU ? ga.Disabled : ga.Available))(
              r,
              u,
            ),
        ...
        const La = "SkillCardBackground_base_fffb2",
          ...
          za = (0, s.memo)(
            ({ level: e, isSelected: t, isLearned: n, hasLowEfficiency: a, isDisabled: r }) =>
              l().createElement(
                "div",
                      ...
                      v
                        ...
                        .map(({ value: e, index: t }) =>
                          l().createElement(
                            "div",
                            { key: t, className: Qa },
                            l().createElement("img", { className: Xa, src: dr[t], alt: "" }),
          ...
          return u().createElement(
            ...
            s.UI(e, (e, t) => {
              ...
              return u().createElement(
                ...
                u().createElement(
                  g.U,
                  p({ size: o, type: n, efficiencyState: a, skillState: i }, e),
                ),
              );
            }),
      ...
      7528: (e, t, n) => {
        ...
        const Ee = ({ type: e, slotSize: t, isHigh: n, className: a, isVisible: r = !0 }) => {
            ...
            return i().createElement(
              ...
              i().createElement("div", {
                ...
                style: {
                  backgroundImage: `url(R.images.gui.maps.icons.crewWidget.slot.${t}.${s})`,
                },
              }),
            );
          },
                  ...
                  i().createElement(
                    ...
                    i().createElement(
                      ...
                      i().createElement(
                        "div",
                        { className: ye },
                        i().createElement(F.u5, { onClick: d }, R.strings.crew_widget.btnDetails()),
                      ),
                    ),
                  ),
                ),
        ...
        const ut = {
          ...
          Ct = (0, r.memo)(
            ...
            (e, t) => {
              ...
              return (
                ...
                wt(n.skills.majorSkills, a.skills.majorSkills) &&
                wt(n.skills.bonusSkills, a.skills.bonusSkills) &&
          ...
          kt = "TankmanSlotContent_base_b5927",
          ...
          Tt = "SlotsList_base__hangar_c097e";
        function Ot() {
          return (
            (Ot = Object.assign
              ? Object.assign.bind()
        ...
        const Rt = { transform: new se.SpringValue("translateX(0rem)") },
          Mt = { transform: new se.SpringValue("translateX(15rem)") },
          Pt = (0, o.Pi)(({ layoutInfo: e, isWidgetDisabled: t, className: n, slotSize: a }) => {
            const s = E().model,
            ...
            return i().createElement(
              "div",
              {
                ...
                className: p()(It, e.isCurrentLayoutHangar && Tt, n),
              },
              s.computes
                .getSlots()
                .map((n, r) =>
          ...
          zt = (0, r.memo)(() =>
            i().createElement(
              a.z,
              null,
              i().createElement(b, { options: Wt }, i().createElement(Ht, null)),
            ),
          );
      },
      9729: (e, t, n) => {
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(1605));
