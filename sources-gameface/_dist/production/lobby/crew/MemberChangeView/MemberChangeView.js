  ...
  var __webpack_modules__ = {
        ...
        const _ = {
          ...
          p = (0, o.ZP)((e) => {
            let t = e.className,
              ...
              x =
                void 0 === I
                  ? (w ? "flex-start" : k && "center") || (y && "flex-end") || void 0
                  : I,
              M = e.alignSelf,
              R = e.wrap,
              P = e.flexWrap,
            ...
            return l().createElement(
              "div",
              d({ className: a()(c.Z.base, ...X, t), style: Z }, U),
              $,
            );
          });
      },
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const r = e,
                              s = Object.entries(r),
                              o = s.reduce((e, [t, u]) => ((e[u] = a.LO.box(n[t], {})), e), {});
                            return (
                              "real" === u &&
                                c.subscribe(
                                  (0, a.aD)((e) => {
      ...
      3649: (e, t, u) => {
        ...
        const i = (e) => e.replace(/&nbsp;/g, " "),
          ...
          p = (e, t, u) =>
            e.split(/%\((.*?)\)(?:[sd])?/g).map((e) => (u && e in u ? u[e] : g(e, t)));
      },
      5139: (e, t, u) => {
        "use strict";
        function n(e, t, u, n) {
      ...
      5673: (e, t, u) => {
        ...
        const Q = {
          ...
          _e = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = ce, onDrag: n = me }) => {
        ...
        const be = J({
          ...
          Te = (0, s.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = ye, onDrag: n = we }) => {
              const a = (0, s.useRef)(null),
                r = (0, s.useRef)(null),
                i = (0, s.useRef)(null),
                c = (0, s.useRef)(null),
        ...
        const qe = {
            [Xe.NBSP]: Ve.NoBreakSymbol,
            [Xe.ZWNBSP]: Ve.NoBreakSymbol,
            [Xe.NEW_LINE]: Ve.LineBreak,
          },
          Ke = {
          ...
          tt = ({ elementList: e, textBlock: t, key: u }) => {
            ...
            return n
              ? Ke[n]
                ...
                : o().createElement(
                    "span",
                    { key: u, "data-block-type": t.blockType, style: et(n) },
                    e,
                  )
          ...
          ut = {
            ...
            [Ve.NewLine]: ({ elementList: e, key: t }) =>
              o().createElement(
                "span",
                { key: t, "data-block-type": Ve.NewLine, className: Je },
                e,
              ),
                ...
                (e) => {
                  ...
                  a === Ve.LineBreak
                    ? u.push(
                        ...((e) => {
                          const t = [
                            { blockType: Ve.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
        ...
        const ht = {
          ...
          It = o().memo(function ({
            ...
            const s = n === e ? 2 : (n / t) * 254,
              ...
              _ = (0, K.useSpring)(
                Object.assign({ from: { left: 2 }, to: { left: s }, delay: Nt }, d),
              ),
              E = (0, K.useSpring)(
                Object.assign({ from: { width: e }, to: { width: i }, delay: Nt }, d),
              );
            return o().createElement(
              "div",
              { className: Ft },
        ...
        const $n = "Role_base_68",
          Un = o().memo(function ({ role: e, className: t, roleIconColor: u = zn.White }) {
            return o().createElement("div", {
              className: l()($n, t),
              style: {
                backgroundImage: `url(R.images.gui.maps.icons.tankmen.roles.opaque.${u}.${e})`,
              },
            });
          });
        var Vn = u(8271);
        ...
        const fa = "BarracksTankmanCard_headerWrapper_e3",
          ...
          Fa = "Actions_base_07",
          Ba = ({ className: e, children: t }) =>
            o().createElement("div", { className: l()(Fa, e) }, t),
      ...
      8485: (e, t, u) => {
        ...
        const c = o().memo(function ({ icon: e, type: t, size: u }) {
          ...
          return o().createElement(
            ...
            c &&
              o().createElement("div", { className: a()(i.Z.icon, i.Z[`icon__${t}`]), style: c }),
          );
        });
      },
      9631: (e, t, u) => {
      ...
      8727: (e, t, u) => {
          ...
          he = (0, n.memo)(
            ({
              ...
              return a().createElement(
                ...
                a().createElement("div", {
                  className: A()(be.hoverGlow, g && be.hoverGlow__visible),
                }),
                    ...
                    a().createElement(
                      ...
                      a().createElement(
                        ...
                        a().createElement(
                          x.u5,
                          { onClick: d },
                          a().createElement(v.ZP, { text: R.strings.crew_widget.btnDetails() }),
                        ),
                      ),
                      a().createElement("div", {
        ...
        const au = ({ size: e }) => {
            ...
            return (
              (0, n.useEffect)(
                () => (tu.instance.subscribe(o), () => tu.instance.unsubscribe(o)),
                [o],
              ),
              a().createElement(zt, {
                width: uu.width,
        ...
        const iu = (0, n.memo)(
                  ...
                  a().createElement(
                    ...
                    a().createElement(
                      "div",
                      {
                        ...
                        style: {
                          marginLeft: u !== St.W.ZeroSkill ? `${o}rem` : `${o < 0 ? 2 : o}rem`,
          ...
          Lu = (0, s.Pi)(
            ({ tankman: e, layoutInfo: t, isUntrained: u, blinkStyle: r, isDisabled: s }) => {
              const o = b().model,
                i = (0, kt.GS)().mediaSize,
                ...
                E.UI(r, ({ id: u, isSelected: n, tooltip: r, icon: i, counter: c }) =>
                  a().createElement(
                    ...
                    a().createElement(
                      ...
                      a().createElement(N, { id: u, icon: i, type: t, isSmall: m, isSelected: n }),
                    ),
                  ),
                ),
              ),
                ...
                w &&
                  (B
                    ? a().createElement(
                        ...
                        a().createElement(
                          o.u5,
                          { mixClass: Ie.button, type: i.L.primary, onClick: n.onCancelSelection },
