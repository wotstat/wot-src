  ...
  var __webpack_modules__ = {
      ...
      1672: (e, u, t) => {
        ...
        const l = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const l = u.contentId;
          return l
            ? n().createElement(i.u, s({}, u, { contentId: l }), r)
                  ...
                  const l = i.U(o),
                    c =
                      "real" === t
                        ? l
                        : Object.assign({}, l, {
                            readByPath: null != (s = null == a ? void 0 : a.getter) ? s : () => {},
                          }),
                    d = (e) =>
                    ...
                    A = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, u) => {
                          const r = d(u);
                          if (Array.isArray(e)) {
                            const o = e.reduce((e, u) => ((e[u] = n.LO.box(r[u], {})), e), {});
                            return (
                              "real" === t &&
                                c.subscribe(
                                  (0, n.aD)((u) => {
              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (a(), window.removeEventListener(o, i), (e.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(t)),
                ...
                (e) => {
                  ...
                  n === a.kH.LineBreak
                    ? r.push(
                        ...((e) => {
                          const u = [
                            { blockType: a.kH.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
      ...
      4565: (e, u, t) => {
        ...
        const r = (e, u, t, r) => {
          let n = u.exec(e),
            o = 0;
          for (; n;)
            (o !== n.index && t(e.slice(o, n.index)), r(n), (o = u.lastIndex), (n = u.exec(e)));
      ...
      5447: (e, u, t) => {
        ...
        const ce = {
          ...
          he = (0, o.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = ge, onDrag: r = be }) => {
        ...
        const ke = de({
          ...
          Ve = (0, o.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = He, onDrag: r = Ie }) => {
              const n = (0, o.useRef)(null),
                i = (0, o.useRef)(null),
                s = (0, o.useRef)(null),
                l = (0, o.useRef)(null),
        ...
        const xu = ({ header: e, body: u, contentId: t }, r, n) =>
          ...
          ku = ({
            ...
            (0, o.useEffect)(() => {
              O !== W.None &&
                p.O.sound.play.sound(
                  O === W.Increase ? h.gO.CREW_RETRAIN_UP : h.gO.CREW_RETRAIN_DOWN,
                );
            }, [O]);
            const I = F()(
              wu.base,
        ...
        a().memo(function ({
          ...
          return a().createElement(
            E,
            { options: t },
            a().createElement(Ou, { rootId: e, className: u }),
          );
        });
      },
      3335: (e, u, t) => {
