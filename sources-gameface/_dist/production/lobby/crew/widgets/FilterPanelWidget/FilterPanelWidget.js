  ...
  var __webpack_modules__ = {
      ...
      1672: (e, u, t) => {
        ...
        const l = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const l = u.contentId;
          return l
            ? o().createElement(i.u, s({}, u, { contentId: l }), n)
            : o().createElement(a.t, u, n);
        };
      },
      6485: (e, u, t) => {
        t.d(u, { i: () => l });
                  ...
                  const l = i.U(a),
                    c =
                      "real" === t
                        ? l
                        : Object.assign({}, l, {
                            readByPath: null != (s = null == r ? void 0 : r.getter) ? s : () => {},
                          }),
                    d = (e) =>
                    ...
                    F = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, u) => {
                          const n = d(u);
                          if (Array.isArray(e)) {
                            const a = e.reduce((e, u) => ((e[u] = o.LO.box(n[u], {})), e), {});
                            return (
                              "real" === t &&
                                c.subscribe(
                                  (0, o.aD)((u) => {
                          ...
                          }
                          {
                            const a = e,
                              r = Object.entries(a),
                              i = r.reduce((e, [u, t]) => ((e[t] = o.LO.box(n[u], {})), e), {});
                            return (
                              "real" === t &&
                                c.subscribe(
                                  (0, o.aD)((e) => {
              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      o &&
                        (r(), window.removeEventListener(a, i), (e.listeners -= 1), n(), (o = !1));
                    }
                  );
                };
              })(t)),
      ...
      285: (e, u, t) => {
        ...
        const s = "NumberRange_base_fab6b",
          ...
          E = "NumberRange_separator_fd341",
          _ = i().memo(function ({ from: e, to: u, isAnimated: t, isFromRed: n, className: a }) {
            return i().createElement(
              "div",
              { className: o()(s, t && l, a) },
              i().createElement("div", { className: o()(c, n && d) }, e),
              void 0 !== u &&
                i().createElement(
                  i().Fragment,
                  null,
          ...
          F = "NumberRangeWithLabel_base_e56d6",
          A = "NumberRangeWithLabel_title_ea468",
          D = "NumberRangeWithLabel_counter_cf012",
          m = "NumberRangeWithLabel_counterGlow_bb198",
          C = ({
            title: e,
            isGlowVisible: u = !1,
            className: t,
            ...
            const c = a.Z5.getNumberFormat(s, a.B3.INTEGRAL),
              d = (0, r.useMemo)(
                () => ({ left: s !== l ? 7 * c.length + 4 : Math.round((7 * c.length) / 2) }),
                [c, s, l],
              );
            return i().createElement(
              "div",
              ...
              i().createElement(
                ...
                i().createElement(_, {
                  from: c,
                  to: s !== l ? a.Z5.getNumberFormat(l, a.B3.INTEGRAL) : void 0,
                  isAnimated: s <= 0,
                  isFromRed: s <= 0 && l > 0,
                }),
                u &&
                  i().createElement("div", {
                    style: d,
                    className: o()(m, null == n ? void 0 : n.counterGlow),
                  }),
              ),
            );
          };
      ...
      6392: (e, u, t) => {
                ...
                E.UI(a, ({ id: t, isSelected: n, tooltip: a, icon: s, counter: c }) =>
                  o().createElement(
                    ...
                    o().createElement(
                      ...
                      o().createElement(P, { id: t, icon: s, type: u, isSmall: F, isSelected: n }),
                    ),
                  ),
                ),
              ),
        ...
        var G = t(7109),
          ...
          Z = t(4578),
          j = t(1421);
        const U = "PopupButton_base_fe996",
          ...
          X = ({ isHighlighted: e, hasDiscountAlert: u, popoverDirection: t = Z.IC.Bottom }) =>
            o().createElement(
              "div",
              { className: U },
              o().createElement(
          ...
          Be = o().memo(
            ({
              ...
              const I = (0, n.useCallback)(
                ...
                W = r()(Ce.input, Ce[`input__${t}`]),
                Z = r()(Ce.icon, Ce[`icon__${t}`]),
                j = r()(Ce.placeholder, Ce[`placeholder__${t}`]);
              return o().createElement(
                "div",
                {
                  id: e,
                ...
                S && !u && !f && o().createElement("div", { className: j }, S),
                c &&
                  o().createElement("div", {
                    className: Ce.clear,
                    onClick: (e) => {
        ...
        const fe = {
          ...
          we = (e) => {
            ...
            const I = (0, n.useState)(E),
              ...
              x = N[0],
              L = N[1],
              S = (0, n.useMemo)(() => Object.assign({}, fe, b), [b]),
            ...
            ((0, n.useEffect)(() => {
              ...
              (0, n.useEffect)(() => {
                (H.current.isChangeHandled &&
                  E !== H.current.value &&
                  ((H.current.value = E), M(E)),
                  (H.current.type = a));
              }, [E, a]),
              (0, n.useEffect)(() => {
                L(m);
              }, [m, s]));
            const U = (0, n.useCallback)((e) => g && g(e), [g]),
              z = (0, n.useCallback)(
                (e) => {
                  (S.disableHighlightOnFocus && x && L(!1), v && v(e));
                },
                [x, v, S.disableHighlightOnFocus],
              ),
              ...
              ee = Boolean(p) || x,
              ue = (0, n.useMemo)(
                () => ("boolean" == typeof S.withClear ? Q && S.withClear : Q && a === oe),
                [a, Q, S],
              ),
