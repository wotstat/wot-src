  ...
  var __webpack_modules__ = {
      ...
      255: (u, e, t) => {
        ...
        const T = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(m, k({}, e, { contentId: r }), n)
        ...
        const M = {
            [N.NBSP]: S.NoBreakSymbol,
            [N.ZWNBSP]: S.NoBreakSymbol,
            [N.NEW_LINE]: S.LineBreak,
          },
          ...
          G = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: z },
                  u,
                );
          },
          H = {
            ...
            [S.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": S.NoBreakWrapper, className: j },
                u,
              ),
          },
          K = (u, e, t) => {
                ...
                (u) => {
                  ...
                  r === S.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: S.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = Bu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Bu.aD)((u) => {
