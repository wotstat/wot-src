  ...
  var __webpack_modules__ = {
      ...
      2255: (u, e, t) => {
            ...
            const m = (0, i.useRef)({
              ...
              y = (0, i.useCallback)(() => {
                (m.current.isVisible && m.current.timeoutId) ||
                  (v(t, d, { isMouseEvent: !0, on: !0, arguments: f(n) }, w),
                  p && p(),
        ...
        const L = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(h, P({}, e, { contentId: r }), n)
        ...
        const W = {
            [V.NBSP]: I.NoBreakSymbol,
            [V.ZWNBSP]: I.NoBreakSymbol,
            [V.NEW_LINE]: I.LineBreak,
          },
          ...
          K = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? q[n]
                ? a().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, className: r()($, q[n]) },
                    u,
                  )
                : a().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, className: $, style: H(n) },
                    u,
                  )
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: $ },
                  u,
                );
          },
          Y = {
        ...
        const pu = ((u, e) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = _u.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, _u.aD)((u) => {
            ...
            ({ observableModel: u }) =>
              u.primitives(["bunksCount", "oldCost", "newCost", "isEnough"]),
            Au,
          ),
          gu = pu[0],
          bu = pu[1],
