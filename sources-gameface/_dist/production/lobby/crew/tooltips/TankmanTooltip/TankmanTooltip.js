  ...
  var __webpack_modules__ = {
      ...
      9832: (e, u, t) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                i = a.reduce((e, [u, t]) => ((e[t] = $.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, $.aD)((e) => {
        ...
        const Qe = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const r = u.contentId;
          return r
            ? o().createElement(Ue, Ze({}, u, { contentId: r }), n)
            : o().createElement(qe, u, n);
        };
        var Je = t(1311);
        const eu = {
        ...
        const ru = {
            [nu.NBSP]: uu.NoBreakSymbol,
            [nu.ZWNBSP]: uu.NoBreakSymbol,
            [nu.NEW_LINE]: uu.LineBreak,
          },
          ...
          Eu = ({ elementList: e, textBlock: u, key: t }) => {
            ...
            return n
              ...
              : o().createElement(
                  "span",
                  { key: t, "data-block-type": u.blockType, className: lu },
                  e,
                );
          },
          du = {
            ...
            [uu.NewLine]: ({ elementList: e, key: u }) =>
              o().createElement(
                "span",
                { key: u, "data-block-type": uu.NewLine, className: cu },
                e,
              ),
                ...
                (e) => {
                  ...
                  r === uu.LineBreak
                    ? n.push(
                        ...((e) => {
                          const u = [
                            { blockType: uu.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
          ...
          return o().createElement(
            ...
            Boolean(r) &&
              o().createElement(
                S,
                null,
                o().createElement(ut, { voiceoverReason: r, className: ct }),
              ),
            e.isDismissed.get() &&
              o().createElement(
                S,
