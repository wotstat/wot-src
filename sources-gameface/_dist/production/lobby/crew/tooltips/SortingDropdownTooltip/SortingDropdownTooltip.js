                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const F = r(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = Gu.LO.box(F[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, Gu.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                t = D.reduce((u, [e, A]) => ((u[A] = Gu.LO.box(F[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, Gu.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          bu().render(
            du().createElement(
              vu,
              null,
              du().createElement(Qu, null, du().createElement(de, null)),
            ),
