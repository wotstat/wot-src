(() => {
  ...
  var __webpack_modules__ = {
      ...
      7361: (u, e, t) => {
                  ...
                  e.split("\n").map((e, i) =>
                    a().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        n,
                        u,
                      ).map((u, e) => a().createElement(o.Fragment, { key: `${e}-${u}` }, u)),
                    ),
                  ),
                ),
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                i = Object.entries(r),
                                o = i.reduce((u, [e, t]) => ((u[t] = Y.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, Y.aD)((u) => {
          ...
          Eu = (0, S.Pi)(({ className: u }) => {
            ...
            return t.length
              ? a().createElement(
                  ...
                  {
                    className: u,
                    label: R.strings.tooltips.trainingLevel.additionalQualification(),
                  },
                  L(t, (u) =>
                    a().createElement(
                      "div",
        ...
        const Mu = {
            [Lu.NBSP]: xu.NoBreakSymbol,
            [Lu.ZWNBSP]: xu.NoBreakSymbol,
            [Lu.NEW_LINE]: xu.LineBreak,
          },
          Su = {
          ...
          ju = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? Su[n]
                ...
                : a().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: Wu(n) },
                    u,
                  )
          ...
          zu = {
            ...
            [xu.NewLine]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": xu.NewLine, className: Uu },
                u,
              ),
                ...
                (u) => {
                  ...
                  r === xu.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: xu.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
        ...
        const he = ({
            ...
            return a().createElement(
              ...
              a().createElement(
                "div",
                { className: r()(_e.level, null == l ? void 0 : l.level) },
                de(i),
              ),
              a().createElement("div", {
