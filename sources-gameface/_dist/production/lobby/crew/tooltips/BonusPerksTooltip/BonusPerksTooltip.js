      ...
      5451: (u, e, t) => {
        ...
        const C = (0, i.forwardRef)(function (u, e) {
            ...
            return (
                  ...
                  const t = (e) => (
                    ...
                    i = (u) => {
                      ...
                      f.current &&
                        (f.current.currentTime =
                          ((e = 0), (t = f.current.duration), (n = u) < e ? e : n > t ? t : n));
                    },
                    a = () => {
                      var u;
                    ...
                    _ = (u, e) => {
                      ...
                      return (
                        ...
                        () => {
                          var t;
                          return null == (t = f.current) ? void 0 : t.removeEventListener(u, e);
                        }
                      );
                    },
                    C = (u, e) => {
              ...
              a().createElement(
                "video",
                _({ src: t, className: n, style: E, loop: F, ref: f, onClick: C }, p),
              )
            );
          }),
          p = (0, i.memo)(C);
        ...
        const L = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(g, P({}, e, { contentId: r }), n)
            : a().createElement(y, e, n);
        };
        var N = t(1311);
        const S = {
        ...
        const V = {
            [W.NBSP]: I.NoBreakSymbol,
            [W.ZWNBSP]: I.NoBreakSymbol,
            [W.NEW_LINE]: I.LineBreak,
          },
          ...
          $ = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: q },
                  u,
                );
          },
          Z = {
            ...
            [I.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": I.NoBreakWrapper, className: z },
                u,
              ),
          },
          X = (u, e, t) => {
                ...
                (u) => {
                  ...
                  r === I.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: I.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
          ...
          mu = "BonusPerksTooltipApp_video_fe828",
          fu = "BonusPerksTooltipApp_divider_f8f51",
          ...
          yu = () =>
            a().createElement(
              ...
              a().createElement(
                "div",
                { className: pu },
                a().createElement("div", { className: r()(fu, hu) }),
                a().createElement(p, {
                  loop: !0,
                  autoplay: !0,
                ...
                a().createElement("div", { className: r()(fu, vu) }),
              ),
              a().createElement(
                "div",
                { className: gu },
