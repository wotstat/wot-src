  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (o(), window.removeEventListener(i, a), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      7119: (u, e, t) => {
        ...
        const m = r().memo(function ({ iconName: u, size: e = C.c24x24, className: t }) {
            var n;
            const i =
              null == (n = R.images.gui.maps.icons.tankmen.skills.$dyn(e)) ? void 0 : n.$dyn(u);
                ...
                r().createElement(
                  ...
                  t &&
                    r().createElement(
                      ...
                      t === _.Situational && n && r().createElement("div", { className: v }),
                    ),
                ),
              ),
            ),
            ...
            const b = (0, n.useRef)({
              ...
              h = (0, n.useCallback)(() => {
                (b.current.isVisible && b.current.timeoutId) ||
                  (P(t, d, { isMouseEvent: !0, on: !0, arguments: N(r) }, v),
                  m && m(),
              ...
              w = (0, n.useCallback)((u) => {
                b.current.isVisible &&
                  ...
                  (b.current.hideTimerId = window.setTimeout(() => {
                    ...
                    e && !e.isSameNode(b.current.prevTarget) && g();
                  }, 200)));
              }, []);
            ((0, n.useEffect)(() => {
        ...
        const q = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const i = e.contentId;
          return i
            ? r().createElement(L, G({}, e, { contentId: i }), n)
            : r().createElement(j, e, n);
        };
        var H = t(1311);
        const $ = {
        ...
        const J = {
            [Q.NBSP]: Y.NoBreakSymbol,
            [Q.ZWNBSP]: Y.NoBreakSymbol,
            [Q.NEW_LINE]: Y.LineBreak,
          },
          ...
          au = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : r().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: iu },
                  u,
                );
          },
          su = {
                ...
                (u) => {
                  ...
                  r === Y.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: Y.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
                ...
                r().createElement(
                  "div",
                  {
                    className: s()(
                      ...
                      e,
                      $.base__zeroPadding,
                      a && $.base__isTruncationAvailable,
                    ),
                    style: b,
                  },
                  r().createElement("div", { className: $.unTruncated, ref: d }, m),
                  r().createElement(
                    q,
                    {
                      tooltipArgs: p,
                    ...
                    r().createElement(
                      "div",
                      {
                        className: s()(
                          $.truncated,
                          !B.isTruncateFinished && a && $.truncated__hide,
                        ),
                        style: b,
                      },
        ...
        const Mu = ((u, e) => {
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = Ou.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, Ou.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                i = Object.entries(r),
                                o = i.reduce((u, [e, t]) => ((u[t] = Ou.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, Ou.aD)((u) => {
          ...
          $u = "ExtraInfo_asterisk_b56d3",
          Ku = "ExtraInfo_situationalText_c5852",
                  ...
                  r().createElement(
                    ...
                    t &&
                      r().createElement(
                        "div",
                        { className: Hu },
                        r().createElement("div", { className: s()(v, $u) }),
                        r().createElement(
                          "div",
                          { className: Ku },
              ...
              o &&
                r().createElement(
                  ...
                  r().createElement(
                    "div",
                    { className: ie },
                    R.strings.tooltips.perks.irrelevant(),
                  ),
                ),
              s &&
                !(l || o) &&
