              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (o(), window.removeEventListener(a, E), (u.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(t)),
        ...
        const eu = {
          ...
          nu = Z((u) => {
            ...
            return n().createElement(
              "div",
              uu({ className: E()(Q.base, ...G, e), style: j }, I),
              H,
            );
          });
        let au;
          ...
          ne = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return r
              ? Ju[r]
                ...
                : n().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: re(r) },
                    u,
                  )
        ...
        const ke = ((u, e) => {
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = E(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = we.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, we.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                i = a.reduce((u, [e, t]) => ((u[t] = we.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, we.aD)((u) => {
          ...
          ut = (0, B.Pi)(() => {
            ...
            return n().createElement(
              ...
              e > 0 &&
                e < 100 &&
                n().createElement(Ne, { skillType: t, skills: u.computes.boosters() }),
              n().createElement(Ke, {
                skillType: t,
