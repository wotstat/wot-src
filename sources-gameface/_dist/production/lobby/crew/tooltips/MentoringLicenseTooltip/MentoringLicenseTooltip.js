(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (A(), window.removeEventListener(r, F), (u.listeners -= 1), n(), (E = !1));
                    }
                  );
                };
              })(t)),
      ...
      164: (u, e, t) => {
        ...
        const C = E().forwardRef(function (u, e) {
          ...
          return (
            ...
            E().createElement(
              "div",
              B({}, C, {
                className: o()(i.base, i[`base__theme-${F}`], r),
                ref: function (u) {
                    ...
                    const A = (function ({
                      ...
                      F =
                        "real" === t
                          ...
                          : Object.assign({}, A, {
                              readByPath:
                                null != (r = null == E ? void 0 : E.getter) ? r : () => {},
                            }),
                      o = (u) =>
                      ...
                      s = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = o(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = j.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, j.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                r = Object.entries(E),
                                A = r.reduce((u, [e, t]) => ((u[t] = j.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, j.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          A().render(
            E().createElement(Y, null, E().createElement(iu, null)),
