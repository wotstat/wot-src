                      ...
                      u = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, n) => {
                            const o = c(n);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, n) => ((e[n] = Oe.LO.box(o[n], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, Oe.aD)((n) => {
                            ...
                            }
                            {
                              const r = e,
                                i = Object.entries(r),
                                a = i.reduce((e, [n, t]) => ((e[t] = Oe.LO.box(o[n], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, Oe.aD)((e) => {
        ...
        const Ke = (0, Pe.Pi)(() => {
          ...
          return be().createElement(
            ...
            be().createElement(
              ...
              Array.isArray(r)
                ? r.map(i)
                : r.map((e, n, t) => i(null == e ? void 0 : e.value, n, t))),
            ),
          );
          var r, i;
        });
        engine.whenReady.then(() => {
          _e().render(
            be().createElement(
              Ee,
              null,
              be().createElement(Me, null, be().createElement(Ke, null)),
            ),
