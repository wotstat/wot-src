  ...
  var __webpack_modules__ = {
      ...
      2891: (u, e, t) => {
        ...
        const y = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(C, g({}, e, { contentId: r }), n)
        ...
        const S = {
            [L.NBSP]: O.NoBreakSymbol,
            [L.ZWNBSP]: O.NoBreakSymbol,
            [L.NEW_LINE]: O.LineBreak,
          },
          ...
          z = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: V },
                  u,
                );
          },
          G = {
            ...
            [O.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": O.NoBreakWrapper, className: I },
                u,
              ),
          },
          q = (u, e, t) => {
          ...
          X = (u, e = "", t) => {
            ...
            return (
              K(
                ...
                /(\n+|[\xa0\ufeff]+)/g,
                (u) => {
                  n.push({ blockType: O.Word, colorTag: e, childList: Z(u, t) });
                },
                (u) => {
                  const t = u[0],
                    r = S[t.charAt(0)];
