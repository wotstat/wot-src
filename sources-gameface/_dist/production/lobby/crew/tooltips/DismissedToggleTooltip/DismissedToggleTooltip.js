(() => {
  ...
  var __webpack_modules__ = {
      ...
      2689: (u, e, t) => {
        ...
        const Z = {
            [X.NBSP]: G.NoBreakSymbol,
            [X.ZWNBSP]: G.NoBreakSymbol,
            [X.NEW_LINE]: G.LineBreak,
          },
          $ = {
          ...
          nu = {
            ...
            [G.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": G.NoBreakWrapper, className: Q },
                u,
              ),
          },
          ru = (u, e, t) => {
                ...
                (u) => {
                  ...
                  r === G.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: G.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
