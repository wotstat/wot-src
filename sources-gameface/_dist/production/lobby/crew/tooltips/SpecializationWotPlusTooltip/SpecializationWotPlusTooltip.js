  ...
  var __webpack_modules__ = {
      ...
      5868: (u, e, t) => {
        ...
        const k = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(h, T({}, e, { contentId: r }), n)
            : a().createElement(v, e, n);
        };
        var x = t(1311);
        const O = {
        ...
        const M = {
            [N.NBSP]: L.NoBreakSymbol,
            [N.ZWNBSP]: L.NoBreakSymbol,
            [N.NEW_LINE]: L.LineBreak,
          },
          ...
          q = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: U },
                  u,
                );
          },
          H = {
            ...
            [L.LineBreak]: ({ key: u }) =>
              a().createElement("span", { key: u, "data-block-type": L.LineBreak, className: z }),
            [L.NewLine]: ({ elementList: u, key: e }) =>
              a().createElement("span", { key: e, "data-block-type": L.NewLine, className: V }, u),
            [L.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": L.NoBreakWrapper, className: j },
                u,
              ),
          },
          $ = (u, e, t) => {
                ...
                (u) => {
                  ...
                  r === L.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: L.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
        ...
        const wu = ((u, e) => {
            ...
            return [
              function ({ mode: n = "real", options: r, children: s, mocks: c }) {
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = c(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = fu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, fu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = fu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, fu.aD)((u) => {
                ...
                return (
                  (0, i.useEffect)(() => {
                    F.current ? C(E(d, r, c)) : (F.current = !0);
                  }, [c, d, r]),
                  (0, i.useEffect)(() => {
                    D(n);
                  }, [n]),
            ...
            return a().createElement(
              ...
              a().createElement(
                ...
                a().createElement(
                  "div",
                  null,
                  R.strings.tooltips.specializationWotPlus.description(),
                ),
              ),
              a().createElement(
                Fu,
        ...
        engine.whenReady.then(() => {
          A().render(
            a().createElement(E, null, a().createElement(yu, null, a().createElement(Su, null))),
