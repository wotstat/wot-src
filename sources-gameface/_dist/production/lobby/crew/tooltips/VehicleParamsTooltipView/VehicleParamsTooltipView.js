(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (i(), window.removeEventListener(o, s), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      7104: (u, e, t) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                a = o.reduce((u, [e, t]) => ((u[t] = v.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, v.aD)((u) => {
        ...
        const Eu = {
            [lu.NBSP]: su.NoBreakSymbol,
            [lu.ZWNBSP]: su.NoBreakSymbol,
            [lu.NEW_LINE]: su.LineBreak,
          },
          Au = {
          ...
          _u = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? Au[n]
                ...
                : i().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: Bu(n) },
                    u,
                  )
          ...
          Cu = {
            ...
            [su.NewLine]: ({ elementList: u, key: e }) =>
              i().createElement(
                "span",
                { key: e, "data-block-type": su.NewLine, className: Du },
                u,
              ),
        ...
        const re = "TooltipAdvancedFooter_base_d6",
          ...
          we = (0, D.Pi)(() => {
            ...
            return i().createElement(
              ...
              e &&
                i().createElement(te, {
                  className: r()(u.computes.hasContentAfterCategories() && be),
                }),
