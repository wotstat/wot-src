  ...
  var __webpack_modules__ = {
      ...
      7878: (u, e, t) => {
                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = f.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, f.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                a = o.reduce((u, [e, t]) => ((u[t] = f.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  E.subscribe(
                                    (0, f.aD)((u) => {
        ...
        const X = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? i().createElement(z, Z({}, e, { contentId: r }), n)
            : i().createElement($, e, n);
        };
        var Q = t(1311);
        const J = {
        ...
        const cu = {
            [lu.NBSP]: Au.NoBreakSymbol,
            [lu.ZWNBSP]: Au.NoBreakSymbol,
            [lu.NEW_LINE]: Au.LineBreak,
          },
          ...
          fu = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : i().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: mu },
                  u,
                );
          },
          hu = {
            ...
            [Au.NewLine]: ({ elementList: u, key: e }) =>
              i().createElement(
                "span",
                { key: e, "data-block-type": Au.NewLine, className: _u },
                u,
              ),
                ...
                (u) => {
                  ...
                  r === Au.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: Au.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
          ...
          Uu = "ParamSource_base_db603",
          qu = "ParamSource_icon_e3858",
          $u = "ParamSource_base__enabled_eda62",
          Gu = "ParamSource_asteriskIcon_b58f8",
          Hu = "ParamSource_sourceName_b9d57",
        ...
        const Ae = "TooltipAdvancedFooter_base_b214f",
          ...
          Ne = (0, D.Pi)(() => {
            ...
            return i().createElement(
              ...
              e &&
                i().createElement(Ee, {
                  className: r()(u.computes.hasContentAfterCategories() && Pe),
                }),
