(() => {
  ...
  var __webpack_modules__ = {
      ...
      7654: (u, e, t) => {
        ...
        const Y = {
            [X.NBSP]: H.NoBreakSymbol,
            [X.ZWNBSP]: H.NoBreakSymbol,
            [X.NEW_LINE]: H.LineBreak,
          },
          Z = {
          ...
          eu = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? Z[n]
                ...
                : a().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: uu(n) },
                    u,
                  )
          ...
          tu = {
            ...
            [H.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": H.NoBreakWrapper, className: $ },
                u,
              ),
          },
          nu = (u, e, t) => {
                ...
                (u) => {
                  ...
                  r === H.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: H.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = c(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = pu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, pu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = pu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, pu.aD)((u) => {
