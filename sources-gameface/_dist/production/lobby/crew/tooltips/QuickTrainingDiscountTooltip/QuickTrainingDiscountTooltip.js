  ...
  var __webpack_modules__ = {
      ...
      5394: (u, e, t) => {
        ...
        const P = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? a().createElement(h, O({}, e, { contentId: r }), n)
        ...
        const V = {
            [j.NBSP]: N.NoBreakSymbol,
            [j.ZWNBSP]: N.NoBreakSymbol,
            [j.NEW_LINE]: N.LineBreak,
          },
          ...
          H = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? U[n]
                ...
                : a().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, className: G, style: $(n) },
                    u,
                  )
              : a().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: G },
                  u,
                );
          },
          K = {
            ...
            [N.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": N.NoBreakWrapper, className: q },
                u,
              ),
          },
          Y = (u, e, t) => {
        ...
        const Cu = ((u, e) => {
          ...
          hu = "QuickTrainingDiscountTooltipApp_label_b1e9d",
          vu = (u, e, t) =>
            a().createElement(Eu, {
              classMix: hu,
              text: u,
              binding: {
                freeXp: a().createElement(p, {
                  type: "freeXP",
                  size: "small",
                  value: e,
                  isEnough: !0,
          ...
          mu = () => {
            ...
            return a().createElement(
              ...
              a().createElement(
                "div",
                { className: fu },
                R.strings.crew_books.tooltip.sale.header(),
              ),
              vu(
