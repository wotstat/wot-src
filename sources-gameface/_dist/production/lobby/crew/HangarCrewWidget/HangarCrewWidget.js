(() => {
  var __webpack_modules__ = {
        ...
        const E = {
          ...
          F = (0, s.ZP)((e) => {
            let u = e.className,
              ...
              O =
                void 0 === I
                  ? (f ? "flex-start" : y && "center") || (k && "flex-end") || void 0
                  : I,
              M = e.alignSelf,
              R = e.wrap,
              P = e.flexWrap,
            ...
            return l().createElement(
              "div",
              d({ className: a()(c.Z.base, ...$, u), style: X }, z),
              G,
            );
          });
      },
              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (s(), window.removeEventListener(r, o), (e.listeners -= 1), n(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      491: (e, u, t) => {
        ...
        engine.whenReady.then(() => {
          i().render(
            a().createElement(A, null, a().createElement(C, null)),
      ...
      8485: (e, u, t) => {
        ...
        const c = s().memo(function ({ icon: e, type: u, size: t }) {
          ...
          return s().createElement(
            ...
            c &&
              s().createElement("div", { className: a()(o.Z.icon, o.Z[`icon__${u}`]), style: c }),
          );
        });
      },
      9631: (e, u, t) => {
      ...
      8727: (e, u, t) => {
          ...
          ge = (0, n.memo)(
            ({
              ...
              return a().createElement(
                ...
                a().createElement("div", {
                  className: C()(De.hoverGlow, A && De.hoverGlow__visible),
                }),
                    ...
                    a().createElement(
                      ...
                      a().createElement(
                        ...
                        a().createElement(
                          O.u5,
                          { onClick: d },
                          a().createElement(B.ZP, { text: R.strings.crew_widget.btnDetails() }),
                        ),
                      ),
                      a().createElement("div", {
        ...
        const tt = {
          ...
          getChunkPath:
            ((nt = "R.images.gui.maps.icons.sequence.new_skill.skill_"), (e) => `${nt}${e}`),
        };
        var nt;
        const at = ({ size: e }) => {
            const u = (function (e) {
            ...
            return (
              (0, n.useEffect)(
                () => (ut.instance.subscribe(s), () => ut.instance.unsubscribe(s)),
                [s],
              ),
              a().createElement(Uu, {
                width: tt.width,
        ...
        const ot = (0, n.memo)(
                  ...
                  a().createElement(
                    ...
                    a().createElement(
                      "div",
                      {
                        ...
                        style: {
                          marginLeft: t !== Su.W.ZeroSkill ? `${s}rem` : `${s < 0 ? 2 : s}rem`,
          ...
          xt = (0, i.Pi)(
            ({ tankman: e, layoutInfo: u, isUntrained: t, blinkStyle: r, isDisabled: i }) => {
              const s = D().model,
                o = (0, yu.GS)().mediaSize,
