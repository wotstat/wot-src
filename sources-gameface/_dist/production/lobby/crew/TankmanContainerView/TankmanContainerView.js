(() => {
  var __webpack_modules__ = {
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                switch (F) {
                  ...
                  case "stop":
                    return (function () {
                      const e = 0 === p && w ? { path: w, x: 0, y: 0 } : u(p),
                        t = new Image();
                      t.src = e.path;
                      const a = () => n(c(e, t));
                      return (
              ...
              r().createElement("canvas", o({}, k, { width: t, height: n, ref: B }))
            );
          }),
          l = (e, t) => {
            let n = e;
      ...
      7925: (e, t, n) => {
        ...
        const E = "disable",
          ...
          h = (0, d.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = p, onDrag: a = f }) => {
      ...
      5154: (e, t, n) => {
        ...
        const E = "disable",
          ...
          A = (0, d.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = f, onDrag: a = b }) => {
      ...
      1672: (e, t, n) => {
        ...
        const l = ({ children: e, tooltipArgs: t, className: n }) => {
          ...
          const l = t.contentId;
          return l
            ? r().createElement(o.u, u({}, t, { contentId: l }), a)
                  ...
                  const l = o.U(s),
                    c =
                      "real" === n
                        ? l
                        : Object.assign({}, l, {
                            readByPath: null != (u = null == i ? void 0 : i.getter) ? u : () => {},
                          }),
                    d = (e) =>
            ...
            (0, a.useEffect)(() => {
              ...
              const i = ((e, t, n) => {
                ...
                d = setInterval(() => {
                  const e = o(),
                    t = i[e];
                  (s(i[e]), m(e, t), e === a && (C(), f || clearInterval(d)));
                }, g);
              return () => clearInterval(d);
            }, [c, g, l, n, b, f, m, C, h, t, y]),
            r().createElement("canvas", i({}, D, { width: t, height: n, ref: w }))
          );
        });
      },
      9932: (e, t, n) => {
        ...
        const O = "Delta_base_bdd65",
          ...
          Y = s().memo(function ({
            ...
            const o = a === e ? 2 : (a / t) * 254,
              ...
              _ = (0, P.useSpring)(
                Object.assign({ from: { left: 2 }, to: { left: o }, delay: q }, m),
              ),
              g = (0, P.useSpring)(
                Object.assign({ from: { width: e }, to: { width: u }, delay: q }, m),
              );
            return s().createElement(
              "div",
              { className: z },
        ...
        const Qe = "Error_base_ab572",
          ...
          it = ({ message: e, className: t, classNames: n }) =>
            s().createElement(
              ...
              { className: c()(nt, t) },
              e &&
                s().createElement("div", { className: c()(at, null == n ? void 0 : n.caption) }, e),
          ...
          .then(() => {
            o().render(
              s().createElement(
                a.z,
                null,
                s().createElement(Ke, null, s().createElement(Bt, null)),
              ),
          ...
          return l().createElement(
            ...
            i.UI(e, (e, t) => {
              ...
              return l().createElement(
                ...
                l().createElement(
                  g.U,
                  f({ size: u, type: n, efficiencyState: a, skillState: s }, e),
                ),
              );
            }),
        ...
        const E = { [m.Ow.c24x24]: c.F.c22x22, [m.Ow.c44x44]: c.F.c52x52 },
          b = ({
            ...
            return l().createElement(
              ...
              F &&
                p === m.Lm.Learned &&
                l().createElement("div", { className: g.Z.newSkillHighLight }),
        ...
        const ke = { [K.Skin]: De, [K.Document]: de },
          Be = (0, g.Pi)(({ index: e, className: t }) => {
            ...
            return r().createElement(
              ...
              we({}, i, {
                className: t,
                onClick: () => o && s.selectCard(i.id, i.cardType === K.Skin),
              }),
            );
          }),
          ...
          Oe = () => {
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                r().createElement(m.p, {
                  popoverDirection: e < i.Aq.Medium ? s.IC.Left : s.IC.Bottom,
                }),
          ...
          J = (e) => {
            ...
            return {
              ...
              "--progress-glow-mixBlendMode":
                null != (v = null == (h = e.glowSettings) ? void 0 : h.mixBlendMode)
                  ? v
                  : "lighten",
        ...
        const en = "SelectedSkill_base_a5cd3",
          ...
          rn = ({ icon: e, name: t, isInProgress: n, mediaSize: a, isBonus: i }) =>
            r().createElement(
              ...
              !i &&
                a >= s.cJ.Medium &&
                r().createElement("div", { className: v()(nn, n && an) }, t),
            ),
          ...
          Yn = (0, a.memo)(
            ({ title: e, componentKey: t, isUntrained: n, isBonusQualifications: a = !1 }) =>
              r().createElement(
                "div",
                { className: v()(Gn, a && Zn) },
      ...
      6746: (e, t, n) => {
        ...
        const $ = (e, t) => R.images.gui.maps.icons.tankmen.ranks.$dyn(t).$dyn((0, H.BN)(e)),
          ...
          K = (0, a.memo)(
            ({ rankName: e, rankIcon: t, battlesCount: n, averageXP: a, className: s }) =>
              r().createElement(
                "div",
                { className: F()(I, s) },
                r().createElement(
      ...
      7528: (e, t, n) => {
                  ...
                  s().createElement(
                    ...
                    s().createElement(
                      ...
                      s().createElement(
                        "div",
                        { className: we },
                        s().createElement(k.u5, { onClick: d }, R.strings.crew_widget.btnDetails()),
                      ),
                    ),
                  ),
                ),
        ...
        const lt = {
          ...
          Rt = "SlotsList_base__hangar_c097e";
        function Lt() {
          return (
            (Lt = Object.assign
              ? Object.assign.bind()
        ...
        const Pt = { transform: new ie.SpringValue("translateX(0rem)") },
          ...
          Mt = (0, u.Pi)(({ layoutInfo: e, isWidgetDisabled: t, className: n, slotSize: a }) => {
            ...
            return s().createElement(
              "div",
              {
                ...
                className: f()(xt, e.isCurrentLayoutHangar && Rt, n),
              },
              i.computes
                .getSlots()
                .map((n, r) =>
          ...
          zt = (0, r.memo)(() =>
            s().createElement(
              a.z,
              null,
              s().createElement(E, { options: Wt }, s().createElement(Ht, null)),
            ),
          );
      },
      6392: (e, t, n) => {
                ...
                m.UI(s, ({ id: n, isSelected: a, tooltip: s, icon: u, counter: c }) =>
                  r().createElement(
                    ...
                    r().createElement(
                      ...
                      r().createElement(N, { id: n, icon: u, type: t, isSmall: g, isSelected: a }),
                    ),
                  ),
                ),
              ),
      ...
      4298: (e, t, n) => {
                            ...
                            s.forEach((t, n) => {
                              void 0 !== s[n] &&
                                ...
                                e.changeKeyframeHandlers.forEach((e) => {
                                  ...
                                  return e({ time: t, name: `${v ? a : `Point_${n}`}` });
                                });
                            });
                          }
                        }),
                  ...
                  const n = (t) => (
                    ...
                    b = (e, t) => {
                      ...
                      return (
                        ...
                        () => {
                          var n;
                          return null == (n = F.current) ? void 0 : n.removeEventListener(e, t);
                        }
                      );
                    },
                    p = (e, t) => {
            ...
            ({
              ...
              return s().createElement(
                ...
                s().createElement(
                  ...
                  { className: ye },
                  n &&
                    s().createElement(F.animated.div, { style: a ? o : void 0, className: De }, e),
        ...
        const Ge = s().memo(function ({
            vehicleType: e,
            isElite: t,
            className: n,
            iconSize: a = je.c44x44,
          }) {
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (e, t, n, a) => {
      ...
      a = a || 0;
      for (var u = deferred.length; u > 0 && deferred[u - 1][2] > a; u--)
