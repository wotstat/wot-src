            ...
            (a.contains(e.scrollbarXRail) ||
              ...
              e.scrollbarYActive
                ? (a.classList.add(c.active("y")),
                  p(e, "top", a.scrollTop - e.lastScrollTop, !0, u))
                  ...
                  (e.settings.suppressScrollX && 0 !== i) ||
                    ...
                    (function (u, n) {
                      ...
                      if (0 === n) {
                        ...
                        if ((0 === a && u < 0) || (a >= e.contentWidth - e.containerWidth && u > 0))
                          return !e.settings.wheelPropagation;
                      }
                      return !0;
                  ...
                  (A > 0 && ((o.x = _ / A), (o.y = E / A), (a = h)),
                    (function (u, t) {
                      ...
                      if (i > o) {
                        ...
                        o > i &&
                        ((u < 0 && a === e.contentWidth - e.containerWidth) || (u > 0 && 0 === a))
                      )
                        return !0;
                      return !0;
        ...
        const Fe = ((e, u) => {
                      ...
                      m = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = s(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = _e.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, _e.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                o = a.reduce((e, [u, t]) => ((e[t] = _e.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, _e.aD)((e) => {
            ...
            ({ observableModel: e }) => {
              const u = {
                ...
                o = (0, ge.Om)(
                  () => De(u.retrainings.get(), (e) => ({ id: e.id, label: e.value })),
                  { equals: me },
                ),
                i = (0, ge.Om)(
                  () => De(u.specialties.get(), (e) => ({ id: e.id, label: e.value })),
                  { equals: me },
                ),
                l = (0, ge.Om)(
                  () =>
        ...
        const Ne = {
          ...
          We = Me((e) => {
            let u = e.className,
              ...
              x =
                void 0 === y
                  ? (F ? "flex-start" : b && "center") || (p && "flex-end") || void 0
                  : y,
              k = e.alignSelf,
              S = e.wrap,
              L = e.flexWrap,
            ...
            return r().createElement(
              "div",
              He({ className: C()(Re.base, ...Y, u), style: X }, I),
              P,
            );
          });
        let Xe;
          ...
          un = r().forwardRef((e, u) => {
            const t = e.offsetLeft,
              ...
              H = (0, n.useCallback)(
                (e) => {
                  w &&
                    (w.setScrollLeftImmediately(e), b && b(e, w.contentWidth - w.containerWidth));
                },
                [w, b],
              ),
              N = (0, n.useCallback)(
          ...
          yn = ({ id: e, label: u, isDisabled: t, isHeader: n = !1 }) => {
            if (e === oe)
              return r().createElement(su, {
                text: R.strings.dialogs.recruitWindow.menuEmptyRow(),
              });
              ...
              e
                ? r().createElement(
                    ...
                    r().createElement(Pt, {
                      classMix: kn,
                      content:
                        R.strings.crew.tankmanChangeAndRecruitView.TankmanChange.retraining.$dyn(e),
                    }),
                  )
                : r().createElement(Pt, {
                    classMix: C()(kn, Sn),
                    ...
                    !m &&
                      r().createElement(
                        ...
                        r().createElement(
                          ...
                          r().createElement(
                            we,
                            { mixClass: C()(wr, xr), onClick: l.onRetrainingChange, disabled: !v },
          ...
          Pr = (0, ae.Pi)(() => {
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                { className: Or },
                r().createElement(re, {
                  id: R.views.dialogs.sub_views.topRight.MoneyBalance("resId"),
                }),
                r().createElement(
                  "div",
                  { className: Hr },
