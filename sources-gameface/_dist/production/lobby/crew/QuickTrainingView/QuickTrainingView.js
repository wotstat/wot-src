(() => {
  var __webpack_modules__ = {
      ...
      5900: (e, t, u) => {
        ...
        const s = (0, n.memo)(function (e) {
            let t = e.width,
              ...
              A = void 0 === b ? r.O.INITIAL_FRAME_INDEX : b,
              f = e.lastFrameIndex,
              p = void 0 === f ? _ - 1 : f,
              C = e.loop,
              v = void 0 === C ? r.O.LOOP : C,
              F = e.state,
              D = void 0 === F ? r.O.STATE : F,
              h = e.onAnimationDone,
                        ...
                        n = window.setInterval(() => {
                          ...
                          r
                            ? (null == m || m(a, r),
                              ...
                              a === p &&
                                (null == B || B(),
                                v || (null == h || h(), window.clearInterval(n))))
      ...
      1672: (e, t, u) => {
        ...
        const l = ({ children: e, tooltipArgs: t, className: u }) => {
          ...
          const l = t.contentId;
          return l
            ? a().createElement(o.u, s({}, t, { contentId: l }), n)
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const r = e,
                              i = Object.entries(r),
                              o = i.reduce((e, [t, u]) => ((e[u] = a.LO.box(n[t], {})), e), {});
                            return (
                              "real" === u &&
                                c.subscribe(
                                  (0, a.aD)((e) => {
        ...
        (!(function () {
          ...
          (document.addEventListener("mousedown", (u) => {
            ...
            document.addEventListener("mousemove", (u) => {
              if (
                (-1 === o && u.target.select && u.target === e && (o = e.selectionStart), o > -1)
              ) {
            ...
            (0, n.useEffect)(() => {
              ...
              const i = ((e, t, u) => {
                ...
                d = setInterval(() => {
                  const e = o(),
                    t = i[e];
                  (r(i[e]), _(e, t), e === n && (F(), f || clearInterval(d)));
                }, E);
              return () => clearInterval(d);
            }, [c, E, l, u, b, f, _, F, C, t, h]),
      ...
      9867: (e, t, u) => {
        ...
        const B = {
            [h.NBSP]: F.NoBreakSymbol,
            [h.ZWNBSP]: F.NoBreakSymbol,
            [h.NEW_LINE]: F.LineBreak,
          },
          ...
          N = ({ elementList: e, textBlock: t, key: u }) => {
            ...
            return n
              ...
              : o().createElement(
                  "span",
                  { key: u, "data-block-type": t.blockType, className: x },
                  e,
                );
          },
          I = {
            ...
            [F.NoBreakWrapper]: ({ elementList: e, key: t }) =>
              o().createElement(
                "span",
                { key: t, "data-block-type": F.NoBreakWrapper, className: k },
                e,
              ),
          },
          O = (e, t, u) => {
                ...
                (e) => {
                  ...
                  a === F.LineBreak
                    ? n.push(
                        ...((e) => {
                          const t = [
                            { blockType: F.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
          ...
          J = (0, i.forwardRef)(
            ({ id: e, text: t, onClose: u, className: n, type: a = A.Info }, r) =>
              o().createElement(
                "div",
                { ref: r },
                o().createElement(
        ...
        const he = {
          ...
          He = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = Re, onDrag: n = Me }) => {
        ...
        const $e = Be({
          ...
          nt = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: u = et, onDrag: n = Qe }) => {
              const a = (0, i.useRef)(null),
                r = (0, i.useRef)(null),
                s = (0, i.useRef)(null),
                l = (0, i.useRef)(null),
        ...
        const Lt = (0, i.memo)(
          ...
          Pt = (e, t, u) =>
            t
              ...
              : {
                  isEnabled: !u,
                  body: R.strings.tooltips.quickTraining.xpEnoughforPostProgression(),
                },
          Ht = ({
            componentKey: e,
            selectedCount: t,
          ...
          tu = (0, i.memo)(
            ({
              ...
              const h = Ee().controls,
                B = 0 === l,
                y = v && c < l,
                w = ((e, t, u) => (e || t ? kt.Disabled : u > 0 ? kt.Selected : kt.Default))(
                  g,
                  B,
                  c,
                ),
                  ...
                  : ((e, t, u, n, a) =>
                      t
                        ...
                        : u
                          ? {
                              contentId:
                                R.views.lobby.crew.tooltips.QuickTrainingLostXpTooltip("resId"),
                              args: { componentKey: e },
                            }
                          : {
                              isEnabled: n,
              ...
              return o().createElement(
                ...
                o().createElement(
                  ...
                  {
                    onWheel: (e) => {
                      k && (e.stopPropagation(), e.deltaY < 0 && c > 1 ? N() : e.deltaY > 0 && T());
                    },
                  },
                  o().createElement(Lt, {
                    icon: t,
                  ...
                  o().createElement(
                    ...
                    o().createElement(ru, {
                      ...
                      onFocus: () => {
                        ...
                        return (
                          n &&
                          (null == (e = l.current) ? void 0 : e.classList.add(ou.base__focused))
                        );
                      },
                      onKeyDown: (e) => {
                        let t, u;
            ...
            return o().createElement(
              jt.i,
              {
                ...
                body:
                  ((_ = c),
                  (m = d),
                  _ ? ht.body.perkLimit() : m ? ht.body.lowEfficiency() : void 0),
              },
              o().createElement(
                "div",
                {
              ...
              o().createElement(
                ...
                i &&
                  o().createElement(vu, {
                    ...
                    binding: {
                      memberName: o().createElement("div", { className: yu }, u.tankmanName.get()),
                      xpValue: o().createElement(Dt, {
                        type: vt.xp,
                        size: s,
          ...
          .then(() => {
            l().render(
              o().createElement(
                me,
                null,
                o().createElement(r.z, null, o().createElement(Zu, null)),
              ),
          ...
          return l().createElement(
            ...
            i.UI(e, (e, t) => {
              ...
              return l().createElement(
                ...
                l().createElement(
                  E.U,
                  f({ size: s, type: u, efficiencyState: n, skillState: r }, e),
                ),
              );
            }),
        ...
        const g = { [_.Ow.c24x24]: c.F.c22x22, [_.Ow.c44x44]: c.F.c52x52 },
          b = ({
            ...
            return l().createElement(
              ...
              D &&
                A === _.Lm.Learned &&
                l().createElement("div", { className: E.Z.newSkillHighLight }),
      ...
      7528: (e, t, u) => {
                  ...
                  r().createElement(
                    ...
                    r().createElement(
                      ...
                      r().createElement(
                        "div",
                        { className: ye },
                        r().createElement(w.u5, { onClick: d }, R.strings.crew_widget.btnDetails()),
                      ),
                    ),
                  ),
                ),
        ...
        const lt = {
          ...
          Dt = (0, a.memo)(
            ...
            (e, t) => {
              ...
              return (
                ...
                Ft(u.skills.majorSkills, n.skills.majorSkills) &&
                Ft(u.skills.bonusSkills, n.skills.bonusSkills) &&
          ...
          ht = "TankmanSlotContent_base_b5927",
          Bt = "TankmanSlotContent_icon_a25f0",
          yt = (0, a.memo)(
            ({
              slotIdx: e,
              tankman: t,
        ...
        const Rt = { transform: new ie.SpringValue("translateX(0rem)") },
          ...
          Pt = (0, s.Pi)(({ layoutInfo: e, isWidgetDisabled: t, className: u, slotSize: n }) => {
            const i = b().model,
            ...
            return r().createElement(
              "div",
              {
                ...
                className: f()(Nt, e.isCurrentLayoutHangar && It, u),
              },
              i.computes
                .getSlots()
                .map((u, a) =>
          ...
          zt = (0, a.memo)(() =>
            r().createElement(
              n.z,
              null,
              r().createElement(g, { options: Wt }, r().createElement(Ht, null)),
            ),
          );
      },
      9729: (e, t, u) => {
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(9867));
