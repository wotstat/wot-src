(() => {
  var __webpack_modules__ = {
      ...
      5900: (e, t, n) => {
        ...
        const l = (0, a.memo)(function (e) {
            let t = e.width,
              ...
              m = e.onAnimate,
              g = e.frameTime,
              b = void 0 === g ? s.O.FRAME_TIME : g,
              E = e.initialFrameIndex,
              p = void 0 === E ? s.O.INITIAL_FRAME_INDEX : E,
              f = e.lastFrameIndex,
              v = void 0 === f ? _ - 1 : f,
              h = e.loop,
              C = void 0 === h ? s.O.LOOP : h,
              A = e.state,
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                switch (y) {
                  ...
                  case "stop":
                    return (function () {
                      const e = 0 === p && F ? { path: F, x: 0, y: 0 } : l(p),
                        t = new Image();
                      t.src = e.path;
                      const a = () => n(c(e, t));
                      return (
      ...
      1672: (e, t, n) => {
        ...
        const u = ({ children: e, tooltipArgs: t, className: n }) => {
          ...
          const u = t.contentId;
          return u
            ? r().createElement(o.u, l({}, t, { contentId: u }), a)
            ...
            const F = (0, s.useRef)({
              ...
              D = (0, s.useCallback)(() => {
                (F.current.isVisible && F.current.timeoutId) ||
                  (l(n, f, { isMouseEvent: !0, on: !0, arguments: o(r) }, B),
                  y && y(),
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const s = e,
                              i = Object.entries(s),
                              o = i.reduce((e, [t, n]) => ((e[n] = r.LO.box(a[t], {})), e), {});
                            return (
                              "real" === n &&
                                c.subscribe(
                                  (0, r.aD)((e) => {
              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (i(), window.removeEventListener(s, o), (e.listeners -= 1), a(), (r = !1));
                    }
                  );
                };
              })(n)),
        ...
        const _ = {
          ...
          b = (e) => {
            ...
            const s = (0, u.GS)(),
              ...
              o = s.mediaHeight,
              b = s.mediaSize;
            return l().createElement("div", d({ className: r()(n, _[i], m[o], g[b]) }, a), t);
          };
      },
      7271: (e, t, n) => {
        "use strict";
            ...
            (0, a.useEffect)(() => {
              ...
              const i = ((e, t, n) => {
                ...
                d = setInterval(() => {
                  const e = o(),
                    t = i[e];
                  (s(i[e]), _(e, t), e === a && (A(), f || clearInterval(d)));
                }, g);
              return () => clearInterval(d);
            }, [c, g, u, n, E, f, _, A, h, t, w]),
      ...
      8030: (e, t, n) => {
        ...
        const M = {
            [O.NBSP]: I.NoBreakSymbol,
            [O.ZWNBSP]: I.NoBreakSymbol,
            [O.NEW_LINE]: I.LineBreak,
          },
          ...
          Z = ({ elementList: e, textBlock: t, key: n }) => {
            ...
            return a
              ...
              : o().createElement(
                  "span",
                  { key: n, "data-block-type": t.blockType, className: $ },
                  e,
                );
          },
          U = {
            ...
            [I.NoBreakWrapper]: ({ elementList: e, key: t }) =>
              o().createElement(
                "span",
                { key: t, "data-block-type": I.NoBreakWrapper, className: W },
                e,
              ),
          },
          V = (e, t, n) => {
                ...
                (e) => {
                  ...
                  r === I.LineBreak
                    ? a.push(
                        ...((e) => {
                          const t = [
                            { blockType: I.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
          ...
          ie = (e, t, n, a, r, s) => {
            ...
            for (let u = n; u >= 0; u--) {
              ...
              }
              {
                ...
                if (!(g < 0)) {
                  const e = _.slice(0, g);
                  ((l = o().cloneElement(c, c.props, e, b)), (i = u));
                  break;
                }
                r -= d.length;
              }
          ...
          ce = (0, i.forwardRef)(
            ({ id: e, text: t, onClose: n, className: a, type: r = D.Info }, s) =>
              o().createElement(
                "div",
                { ref: s },
                o().createElement(
        ...
        const Ce = (e) => {
            ...
            const A = (0, i.useCallback)(
              ...
              w = (0, i.useCallback)(
                (e) => {
                  (null == u || u(e), g.O.sound.play.sound(h));
                },
                [u, h],
              ),
              k = (0, i.useCallback)(
            ...
            return o().createElement(
              ...
              a &&
                o().createElement(
                  "div",
                  { className: d()(fe.goto, null == r ? void 0 : r.goto) },
                  a,
                ),
            );
          },
        ...
        const je = ({
            ...
            o().createElement(
              ...
              o().createElement(
                "div",
                { className: d()(We.title, null == a ? void 0 : a.title) },
                e,
              ),
              r,
            ),
        ...
        const tt = "WarningText_base_c7790",
          ...
          lt = "ListEmptyState_buttonWrapper_c43ed",
          ut = "ListEmptyState_button_ad234",
          ct = o().memo(function ({
            warningText: e,
                  ...
                  o().createElement(
                    ...
                    o().createElement(
                      ...
                      o().createElement(
                        ...
                        o().createElement(
                          Qe.u5,
                          { size: Qe.qE.small, type: t, disabled: a, onClick: s, mixClass: ut },
                          i,
                        ),
                      ),
                    ),
        ...
        const yt = ({
          ...
          return o().createElement(
            "div",
            {
              className: d()(
                ht.base,
                ht[`base__size${(0, x.e)(i)}`],
                ht[`base__type${(0, x.e)(l)}`],
                u,
              ),
            },
            o().createElement(
            ...
            o().createElement(
              "div",
              { className: d()(ht.name, null == c ? void 0 : c.name) },
              _ ? n : t,
            ),
          );
        };
                ...
                o().createElement(
                  ...
                  o().createElement(
                    ...
                    t
                      ...
                      : o().createElement(
                          yt,
                          It({}, e.tankmanVehicleInfo, { type: At.whiteSpanish, isShortName: !0 }),
                        ),
                  ),
                ),
            ...
            ({
              ...
              return o().createElement(
                ...
                o().createElement(
                  "div",
                  {
                    className: d()(on.base, on[`base__${e.cardState}`], l),
                    onMouseEnter: c,
                    onMouseLeave: _,
                    onMouseDown: m,
                    onClick: g,
                  ...
                  o().createElement(
                    ...
                    o().createElement(t, {
                      ...
                      isRecruit: E,
                      isDisabled: p,
                      className: d()(on.icon, null == u ? void 0 : u.icon),
                    }),
                    o().createElement(
                      "div",
                      { className: d()(on.separatorWrapper, null == u ? void 0 : u.separator) },
                      o().createElement("div", { className: d()(on.separator, on.separator__top) }),
                    ...
                    !p &&
                      ...
                      o().createElement(
                        "div",
                        { className: d()(on.actions, null == u ? void 0 : u.actions) },
                        n,
                      ),
                    b,
                  ),
        ...
        const vn = {
          ...
          Ln = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = Tn, onDrag: a = xn }) => {
                  ...
                  ((n.style.transform = `translateX(${0 | _}px)`),
                    ((e) => {
                      if (s.current && l.current && u.current && c.current) {
                        if (0 === e)
                          return (s.current.classList.add(Sn), void l.current.classList.remove(Sn));
                        if (
                          ((t = u.current),
                          (n = c.current),
                          e - (t.offsetWidth - n.offsetWidth) >= -0.5)
                        )
                          return (s.current.classList.remove(Sn), void l.current.classList.add(Sn));
                        var t, n;
                        (s.current.classList.remove(Sn), l.current.classList.remove(Sn));
                      }
                    })(_));
                },
                v = dn(() => {
          ...
          On = ({
            ...
            return o().createElement(
              ...
              o().createElement(
                ...
                o().createElement(Mn, { className: l, api: m, classNames: s }, e),
              ),
              o().createElement(Ln, { getStepByRailClick: u, api: t, onDrag: c, classNames: _ }),
            );
          },
        ...
        const Pn = hn({
          ...
          Qn = (0, i.memo)(
            ({ api: e, classNames: t = {}, getStepByRailClick: n = Xn, onDrag: a = Vn }) => {
              const r = (0, i.useRef)(null),
                s = (0, i.useRef)(null),
                l = (0, i.useRef)(null),
                u = (0, i.useRef)(null),
                ...
                v = dn(() => {
                  ...
                  ((n.style.transform = `translateY(${0 | _}px)`),
                    ((e) => {
                      if (s.current && l.current && u.current && c.current) {
                        if (0 === Math.round(e))
                          return (s.current.classList.add(Un), void l.current.classList.remove(Un));
                        if (
                          ((t = u.current),
                          (n = c.current),
                          e - (t.offsetHeight - n.offsetHeight) >= -0.5)
                        )
                          return (s.current.classList.remove(Un), void l.current.classList.add(Un));
                        var t, n;
                        (s.current.classList.remove(Un), l.current.classList.remove(Un));
                      }
                    })(_));
                }),
                h = dn(() => {
          ...
          ea = ({
            ...
            return o().createElement(
              ...
              o().createElement(
                ...
                o().createElement(ta, { className: s, classNames: l, api: m }, e),
              ),
              o().createElement(Qn, { getStepByRailClick: u, api: t, onDrag: c, classNames: _ }),
            );
          },
        ...
        const ra = ({
          ...
          la = "VirtualGridWithFade_scrollAreaFade_c5d53",
                ...
                ca(
                  {
                    ...
                    classNames: Object.assign({}, a, {
                      scrollClassName: d()(null == a ? void 0 : a.scrollClassName, l && la),
                    }),
                  },
                  r,
                ),
            ...
            o().createElement(
              da,
              {
                ...
                classNames: Object.assign({}, r, {
                  content: d()(_a, null == r ? void 0 : r.content),
                }),
                cellWidth: 318,
                cellHeight: 265,
                paddingTop: t,
        ...
        const Na = (0, i.memo)(
          ...
          Ha = (0, h.Pi)(({ index: e, className: t, onLazyLoad: n }) => {
            ...
            const u = l.cardState === pt.Disabled,
            ...
            return o().createElement(
              ln,
              {
                ...
                actions: o().createElement(
                  ya,
                  { onClick: b, disabled: l.isMainActionDisabled, className: Ma.actionBtn },
                ...
                className: d()(
                  Ma[`base__${l.cardState}`],
                  (0, et.Y4)(l.skills.skillsEfficiency) === et.H$.Untrained && Ma.base__error,
                  t,
                ),
                classNames: {
              ...
              l.lostXP > 0 && o().createElement(va, { className: Ma.alert }),
            );
          }),
              ...
              r > 0
                ? o().createElement(
                    ...
                    o().createElement(ma, { amount: r, api: a }, (e) =>
                      o().createElement(Ha, { className: $a, key: e, index: e, onLazyLoad: l }),
                    ),
                  )
                : o().createElement(
                    ct,
          ...
          Va = (0, h.Pi)(() => {
            ...
            return (
              ...
              o().createElement(
                "div",
                { className: d()(Za.base, l && Za.base__centered) },
                o().createElement(w, {
                ...
                o().createElement(
                  ...
                  o().createElement(pe, { tips: u, onTipClose: n.closeTip }),
                ),
                o().createElement(De, {
                  onBackClick: n.back,
        ...
        const l = "AlertCounter_base_cc416",
          ...
          d = ({ value: e, className: t }) =>
            o().createElement(
              ...
              !e &&
                o().createElement("div", { className: c }, R.strings.crew.common.exclamationMark()),
            );
      },
      7839: (e, t, n) => {
        "use strict";
      ...
      285: (e, t, n) => {
        ...
        const l = "NumberRange_base_fab6b",
          ...
          _ = "NumberRange_separator_fd341",
          m = o().memo(function ({ from: e, to: t, isAnimated: n, isFromRed: a, className: s }) {
            return o().createElement(
              "div",
              { className: r()(l, n && u, s) },
          ...
          f = ({
            ...
            const c = s.Z5.getNumberFormat(l, s.B3.INTEGRAL),
              d = (0, i.useMemo)(
                () => ({ left: l !== u ? 7 * c.length + 4 : Math.round((7 * c.length) / 2) }),
                [c, l, u],
              );
            return o().createElement(
              "div",
              ...
              o().createElement(
                ...
                o().createElement(m, {
                  from: c,
                  to: l !== u ? s.Z5.getNumberFormat(u, s.B3.INTEGRAL) : void 0,
                  isAnimated: l <= 0,
                  isFromRed: l <= 0 && u > 0,
                }),
                t &&
            ...
            l().createElement(
              ...
              z
                ...
                : l().createElement(
                    l().Fragment,
                    null,
                    l().createElement(m.X, p({ skills: D, isAcceleratedTrainingVisible: h }, G)),
                    W &&
                      l().createElement(
                        m.X,
                        p(
      ...
      5811: (e, t, n) => {
        ...
        const v = ({
          ...
          return c().createElement(
            "div",
            { className: r()(f.Z.base, f.Z[`base__${h}`], f.Z[`base__collapse${(0, l.e)(u)}`], F) },
      ...
      1166: (e, t, n) => {
        ...
        const v = ({
          ...
          return u().createElement(
            "div",
            { className: r()(p.Z.base, p.Z[`base__${l}`], p.Z[`base__collapse${(0, o.e)(t)}`], h) },
            i.UI(e, (e, t) => {
              const s = (0, m.mg)(e);
              return u().createElement(
                E.O,
            ...
            w && A && u().createElement(b.T, { skillLevel: A.level, className: p.Z.level }),
            C &&
              u().createElement(c.L, {
        ...
        const b = { [_.Ow.c24x24]: c.F.c22x22, [_.Ow.c44x44]: c.F.c52x52 },
          E = ({
            ...
            return u().createElement(
              ...
              y &&
                p === _.Lm.Learned &&
                u().createElement("div", { className: g.Z.newSkillHighLight }),
              u().createElement(c.y, { iconName: l, size: b[e], className: g.Z.icon }),
            ...
            return s.UI(n, (s, d) => {
              ...
              return (
                c || _ !== A || h === C || g || b !== r.jw
                  ? g && d === n.length - 1 && c
                    ? (y = l.Qm.FadeIn)
                    : (!g && !u.has(_)) || (void 0 === b && g) || (f !== m && m === r.I)
                      ? (y = l.Qm.Blink)
                      : v !== f && (y = l.Qm.ScaleUp)
      ...
      7528: (e, t, n) => {
          ...
          O = (0, l.Pi)(({ classMix: e, isWidgetDisabled: t }) => {
            ...
            return s().createElement(
              ...
              s().createElement(
                ...
                !l && i.hasDiscount && s().createElement("div", { className: I }),
              ),
            );
          });
        var M = n(166);
                  ...
                  s().createElement(
                    ...
                    s().createElement(
                      ...
                      s().createElement(
                        "div",
                        { className: Fe },
                        s().createElement(B.u5, { onClick: d }, R.strings.crew_widget.btnDetails()),
                      ),
                    ),
                  ),
                ),
        ...
        const ut = {
          ...
          dt = ({
            ...
            return s().createElement(
              "div",
              { className: f()(ut.base, n && ut.base__disabled, ut[`base__${i}`]) },
              s().createElement(
                Ve.t,
                {
                  targetId: R.views.lobby.crew.widgets.CrewWidget("resId"),
              ...
              s().createElement(
                "div",
                { className: f()(ut.specialization, o && ut.specialization__withBonusSkills) },
                s().createElement(nt, {
              ...
              s().createElement(
                "div",
                { className: f()(ut.skillsContainer, o && ut.skillsContainer__withBonusSkills) },
          ...
          yt = (0, r.memo)(
            ...
            (e, t) => {
              ...
              return (
                ...
                At(n.skills.majorSkills, a.skills.majorSkills) &&
                At(n.skills.bonusSkills, a.skills.bonusSkills) &&
          ...
          Pt = (0, l.Pi)(({ layoutInfo: e, isWidgetDisabled: t, className: n, slotSize: a }) => {
            ...
            return s().createElement(
              "div",
              {
                ...
                className: f()(It, e.isCurrentLayoutHangar && Lt, n),
              },
              i.computes
                .getSlots()
                .map((n, r) =>
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [9056], () => __webpack_require__(8030));
