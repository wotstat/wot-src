  ...
  var __webpack_modules__ = {
      ...
      8369: (e, u, t) => {
        ...
        const ve = (e) => {
          ...
          he = ((e, u) => {
                      ...
                      E = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, u) => ((e[u] = me.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, me.aD)((u) => {
                            ...
                            }
                            {
                              const a = e,
                                r = Object.entries(a),
                                s = r.reduce((e, [u, t]) => ((e[t] = me.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, me.aD)((e) => {
            ...
            ({ externalModel: e, model: u }) => ({
              ...
              goToCard: e.createCallback(
                (e, u) => ({ achievementId: e, category: u }),
                "onCardClick",
              ),
        ...
        const Du = eu({
          ...
          Nu = (0, r.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = yu, onDrag: n = xu }) => {
              const a = (0, r.useRef)(null),
                i = (0, r.useRef)(null),
                l = (0, r.useRef)(null),
                c = (0, r.useRef)(null),
                ...
                C = qe(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | E}px)`),
                    ((e) => {
                      if (i.current && l.current && c.current && d.current) {
                        if (0 === Math.round(e))
                          return (i.current.classList.add(wu), void l.current.classList.remove(wu));
                        if (
                          ((u = c.current),
                          (t = d.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (i.current.classList.remove(wu), void l.current.classList.add(wu));
                        var u, t;
        ...
        const lt = (e) =>
          e >= 90 ? ot.Third : e >= 60 ? ot.Second : e >= 30 ? ot.First : ot.Default;
        function ct(e) {
        ...
        const St = R.images.gui.maps.icons.advanced_achievements,
          ...
          Ot = ({
            ...
            return s().createElement(
              ...
              s().createElement("div", {
                ...
                style: {
                  backgroundImage: `url(${Nt.icons.subcategory.$dyn(`${e}_${n}_${Pt[i]}`)})`,
                },
              }),
            );
          },
          ...
          Mt = ({
            ...
            switch (u) {
              ...
              default:
                return (
                  console.warn(`Unreachable code for type '${u}' in AchievementResolver.`),
                  null
                );
            }
          },
        ...
        const Yt = "ProgressBarDeltaGrow_base_f4d46",
          ...
          en = (0, r.memo)(
            ({
              ...
              const p = (0, r.useMemo)(
                  () => Object.assign({ width: "100%" }, Jt(e), Kt(d)),
                  [d, e],
                ),
                f = (0, r.useMemo)(() => Object.assign({ width: "0%" }, Jt(e), Kt(d)), [d, e]),
                v = (0, r.useMemo)(
                  () => Object.assign({ width: "0%" }, Zt(d, n), Jt(e)),
                  [n, d, e],
                ),
                h = (0, r.useMemo)(
        ...
        const zn = (e, u) => window.getComputedStyle(e, null).getPropertyValue(u),
          ...
          Wn = (e) => {
            ...
            return Wn(
              n <= 1 ? Object.assign({}, e, { start: u }) : Object.assign({}, e, { end: u }),
            );
          },
        ...
        const Jn = (0, r.forwardRef)(function (e, u) {
          ...
          const E = (0, r.useRef)(null),
            ...
            w = (0, r.useCallback)(
              () => (m.current ? m.current.getBoundingClientRect().height : 0),
              [],
            ),
            x = (0, r.useCallback)(
              (e) => {
          ...
          return (
            ...
            s().createElement(
              ...
              s().createElement(
                "div",
                { ref: E, className: qn, style: { maxHeight: `${p}rem` } },
                t,
              ),
              s().createElement(
                "div",
        ...
        const ga = ({ children: e, tooltipArgs: u, className: t }) => {
            ...
            const a = u.contentId;
            return a
              ? s().createElement(Wu, Aa({}, u, { contentId: a }), n)
              : s().createElement(_a, u, n);
          },
          Fa = {
              ...
              s().createElement(
                ...
                s().createElement(
                  ...
                  o &&
                    s().createElement(
                      "div",
                      { className: g()(Fa.title, null == d ? void 0 : d.title) },
                      o,
                    ),
                ),
              ),
        ...
        const ka = {
          ...
          Ma = (0, M.Pi)(({ cardIndex: e, className: u }) => {
            ...
            return s().createElement(
              ...
              Boolean(i) &&
                s().createElement(Sa, { className: g()(Na, Ra), points: i, size: ka[c] }),
            );
          }),
        ...
        const Cr = (e) => {
          ...
          return s().createElement(
            ...
            n &&
              s().createElement("div", { className: g()(gr.goto, null == a ? void 0 : a.goto) }, n),
          );
        };
        var br = t(4020);
        const Br = (e) => {
            ...
            return s().createElement(
              ...
              s().createElement(
                ...
                s().createElement(Zu, {
                  ...
                  content: systemLocale.toUpperCase(
                    Pe(R.strings.advanced_achievements.name.$dyn(c)),
                  ),
                }),
              ),
            );
          ...
          Ur = (0, M.Pi)(() => {
            const e = xe().model,
              ...
              i = (() => {
                const e = V(L);
                return (u, t) =>
                  e({ action: I.Display, parentScreen: $.Catalog, item: u, info: t });
              })();
            var o, l;
            return (
              (o = () => {
