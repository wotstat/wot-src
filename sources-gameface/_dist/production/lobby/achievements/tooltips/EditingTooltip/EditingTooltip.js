  ...
  var u,
    F = {
      7646: (u, F, e) => {
              ...
              (F[e] = (function (F) {
                return (e) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (t(), window.removeEventListener(D, B), (u.listeners -= 1), A(), (E = !1));
                    }
                  );
                };
              })(e)),
        ...
        const fu = { view: t, client: E, sound: P, intl: y };
        const mu = {
        ...
        const hu = C().forwardRef(function (u, F) {
          ...
          return (
            ...
            (r = () => {
              ...
              const F = new ResizeObserver(() => {
                const F = u.scrollWidth,
                  e = u.scrollHeight;
                (fu.view.resize(F, e),
                  (document.body.style.width = `${F}px`),
            ...
            C().createElement(
              ...
              C().createElement("div", { className: mu.decorator }, e),
            )
          );
        });
        var bu = e(2041),
        ...
        const Tu = (u) => u.replace(/&nbsp;/g, " "),
          ...
          Su = (u, F, e = wu.left) => u.split(F).reduce(e === wu.left ? _u : Pu, []),
          Ru = (() => {
            const u = new RegExp(
              [
          ...
          zu = (u, F = wu.left) => {
            ...
            return ((u, F = wu.left) => {
              ...
              const A =
                ...
                E = Tu(u);
              return (Su(E, /( )/, F).forEach((u) => (e = e.concat(Su(u, A, wu.left)))), e);
            })(u, F);
          },
          ...
          Lu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          $u = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          Vu = (0, B.memo)(({ text: u, binding: F, classMix: e }) => {
            ...
            return C().createElement(Mu, { text: t, classMix: e, binding: E });
          });
        const Gu = function () {};
        function Iu() {
          return !1;
                ...
                const n = (0, B.useRef)([]),
                  r = (e, A, E) => {
                    ...
                    const t = (function ({
                        ...
                        return {
                          subscribe: (e, D) => {
                            const B = "string" == typeof D ? `${A}.${D}` : A,
                              C = fu.view.addModelObserver(B, F, !0);
                          ...
                          dispose: function () {
                            for (var u, e = Uu(E.keys()); !(u = e()).done;) D(u.value, F);
                          },
                          unsubscribe: D,
                        };
                      })(A),
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, F) => {
                            const A = C(F);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, F) => ((u[F] = Nu.LO.box(A[F], {})), u), {});
                              return (
                                "real" === e &&
                                  B.subscribe(
                                    (0, Nu.aD)((F) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                t = D.reduce((u, [F, e]) => ((u[e] = Nu.LO.box(A[F], {})), u), {});
                              return (
                                "real" === e &&
                                  B.subscribe(
                                    (0, Nu.aD)((u) => {
                      ...
                      i = { mode: e, model: o, externalModel: B, cleanup: r };
                    return {
                      model: o,
          ...
          Ku = (0, bu.Pi)(() => {
            ...
            return C().createElement(
              ...
              C().createElement(
                ...
                { className: Ju },
                C().createElement(Vu, {
                  text: R.strings.achievements_page.tooltips.editingTooltip.$dyn(e),
                  binding: { amount: F },
                }),
              ),
            );
