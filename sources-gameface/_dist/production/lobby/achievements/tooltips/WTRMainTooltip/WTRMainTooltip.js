(() => {
  ...
  var __webpack_modules__ = {
      ...
      79: (u, e, t) => {
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const E = a(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = d.LO.box(E[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, d.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                A = Object.entries(F),
                                n = A.reduce((u, [e, t]) => ((u[t] = d.LO.box(E[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, d.aD)((u) => {
        ...
        const U = {
          ...
          j = "Description_description_ba5ea",
          G = "Description_requiredBattles_f8f92",
                ...
                switch (!0) {
                  case 5 === E && 3 === A:
                    return F().createElement(
                      ...
                      F().createElement(W, {
                        ...
                        binding: { level: T(K.levels.$dyn(`level_${E}`), { level: (0, I.HG)(A) }) },
                      }),
                  ...
                  case !n:
                    return F().createElement($, {
                      ...
                      binding: { amount: F().createElement("div", { className: G }, u) },
                    });
                  case void 0 !== e:
                    return F().createElement(
                      F().Fragment,
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, E) => {
      ...
      E = E || 0;
      for (var a = deferred.length; a > 0 && deferred[a - 1][2] > E; a--)
