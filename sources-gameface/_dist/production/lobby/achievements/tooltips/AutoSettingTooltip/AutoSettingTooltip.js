    ...
    e = {
      3525: (u, e, F) => {
        ...
        const su = Object.keys(W).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === W[e]), u),
            {},
          ),
          lu = {
            set: (u, e) => {
        ...
        const mu = { view: t, client: E, sound: S, intl: y };
        const fu = {
        ...
        const hu = n().forwardRef(function (u, e) {
          ...
          return (
            ...
            n().createElement(
              "div",
              pu({}, t, {
                className: i()(fu.base, fu[`base__theme-${D}`], A),
                ref: function (u) {
                        ...
                        return {
                          subscribe: (F, D) => {
                            const B = "string" == typeof D ? `${A}.${D}` : A,
                              n = mu.view.addModelObserver(B, e, !0);
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = n(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = Gu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  B.subscribe(
                                    (0, Gu.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                t = D.reduce((u, [e, F]) => ((u[F] = Gu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  B.subscribe(
                                    (0, Gu.aD)((u) => {
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: Ju },
                  n().createElement("div", { className: Ku }, ee.title()),
                  n().createElement($u, { text: ee.description() }),
                ),
                ...
                n().createElement(
                  ...
                  { className: ue },
                  u
                    ? n().createElement($u, { text: ee.caption.isSwitchedOn() })
                    : n().createElement($u, { text: ee.caption.isSwitchedOff() }),
                ),
              ),
            );
          };
        engine.whenReady.then(() => {
          r().render(
            n().createElement(Qu, null, n().createElement(Fe, null)),
  ...
  ((A.m = e),
    ...
    (() => {
      ...
      var e = (e, F) => {
          ...
          for (e && e(F); C < t.length; C++)
            ((D = t[C]), A.o(u, D) && u[D] && u[D][0](), (u[D] = 0));
          return A.O(r);
        },
