    ...
    A = {
      9818: (u, A, F) => {
              ...
              (A[F] = (function (A) {
                return (F) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (B(), window.removeEventListener(D, t), (u.listeners -= 1), e(), (E = !1));
                    }
                  );
                };
              })(F)),
        ...
        const $ = {
          ...
          G = Object.keys(V).reduce((u, A) => ((u[A] = () => M(V[A])), u), {}),
        ...
        const yu = Object.keys(X).reduce(
            (u, A) => ((u[A] = () => viewEnv.getShowingStatus() === X[A]), u),
            {},
          ),
          xu = {
            set: (u, A) => {
        ...
        const Su = { view: B, client: E, sound: I, intl: N };
        const Ou = {
        ...
        const Mu = n().forwardRef(function (u, A) {
          let F = u.children,
            e = u.className,
            E = u.theme,
          ...
          return (
            ...
            n().createElement(
              ...
              n().createElement("div", { className: Ou.decorator }, F),
            )
          );
        });
        var ju = F(2041);
                        ...
                        return {
                          subscribe: (F, D) => {
                            const t = "string" == typeof D ? `${e}.${D}` : e,
                              n = Su.view.addModelObserver(t, A, !0);
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, A) => {
                            const e = n(A);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, A) => ((u[A] = $u.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  t.subscribe(
                                    (0, $u.aD)((A) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                B = D.reduce((u, [A, F]) => ((u[F] = $u.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  t.subscribe(
                                    (0, $u.aD)((u) => {
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement("div", { className: Ju }, uA.description.top.base()),
                  n().createElement(h, {
                    classMix: Yu,
                ...
                n().createElement(
                  ...
                  n().createElement(
                    ...
                    n().createElement(h, {
                      ...
                      binding: { percent: n().createElement("div", { className: Ku }, D) },
                    }),
                  ),
                  n().createElement("div", { className: Ju }, uA.description.bottom()),
                ),
              ),
            );
          });
        engine.whenReady.then(() => {
          r().render(
            n().createElement(Uu, null, n().createElement(AA, null)),
  ...
  ((e.m = A),
    ...
    (() => {
      ...
      var A = (A, F) => {
          ...
          for (A && A(F); C < B.length; C++)
            ((D = B[C]), e.o(u, D) && u[D] && u[D][0](), (u[D] = 0));
          return e.O(r);
        },
