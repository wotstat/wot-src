(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (i(), window.removeEventListener(r, s), (u.listeners -= 1), n(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      461: (u, e, t) => {
        ...
        const h = ((u, e) => {
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = E(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = c.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, c.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                r = Object.entries(a),
                                i = r.reduce((u, [e, t]) => ((u[t] = c.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, c.aD)((u) => {
            ...
            ({ observableModel: u }) => {
              const e = { root: u.object(), achievements: u.array("achievements") },
                ...
                r = (0, g.Om)(() => m(t(), (u, { achievementScore: e }) => u + e, 0), {
                  equals: A,
                });
        ...
        const yu = R.images.gui.maps.icons.advanced_achievements,
          ...
          ku = ({
            ...
            return a().createElement(
              ...
              a().createElement("div", {
                ...
                style: {
                  backgroundImage: `url(${yu.icons.subcategory.$dyn(`${u}_${n}_${Su[s]}`)})`,
                },
              }),
            );
          },
          ...
          Tu = ({
            ...
            switch (e) {
              ...
              default:
                return (
                  console.warn(`Unreachable code for type '${e}' in AchievementResolver.`),
                  null
                );
            }
          },
        ...
        const $u = (u) =>
          u >= 90 ? Iu.Third : u >= 60 ? Iu.Second : u >= 30 ? Iu.First : Iu.Default;
        ...
        const Yu = (0, n.memo)(function (u) {
            ...
            return (
              ...
              a().createElement("canvas", Ku({}, h, { width: e, height: t, ref: b }))
            );
          }),
          Zu = (u, e) => {
            let t = u;
        ...
        const ee = {
          ...
          getChunkPath:
            ((te = "R.images.gui.maps.icons.sequence.sun_shine_big_sprite.sprite_"),
            (u) => `${te}${u}`),
        };
        var te;
        const ne = ({ duration: u, isPlaying: e, onAnimationComplete: t, className: r }) => {
            const i = (function (u = {}, e = []) {
                var t, a, r, i;
                const s = (0, n.useState)(null != (t = u.state) ? t : Uu),
                  o = s[0],
                  E = s[1],
                  A = (0, n.useState)(null != (a = u.initialFrameIndex) ? a : ju),
                  c = A[0],
                  l = A[1],
                  F = (0, n.useState)(null != (r = u.frameTime) ? r : Vu),
                  D = F[0],
                  d = F[1],
                  B = (0, n.useState)(null != (i = u.loop) ? i : zu),
                  C = B[0],
                  _ = B[1],
                  m = (0, n.useRef)(c),
                  g = (0, n.useCallback)((u) => {
          ...
          ae = (0, E.Pi)(
            ({ isVisible: u, onAppearAnimationEnd: e, onHideAnimationEnd: t, className: r }) => {
              const i = v().model,
          ...
          re = "Background_base_e11fb",
          ie = "Background_gradient_b312e",
          se = "Background_base__hover_a85f1",
          oe = "Background_icon_c7e5e",
          Ee = "Background_pattern_f2dc6",
          Ae = ({ isTrophy: u, isHover: e, className: t }) =>
            a().createElement(
              "div",
              { className: p()(re, e && se, t) },
              a().createElement("div", { className: ie }),
              u && a().createElement("div", { className: oe }),
        ...
        const Be = (u) => {
            ...
            return (
              ...
              a().createElement(
                H,
                { isEnabled: E, body: e },
                a().createElement("div", de({}, i, { ref: s, className: p()(Fe, r, t) }), e),
              )
            );
          },
          Ce = "Details_base_e4643",
          _e = "Details_title_a5bfa",
          me = "Details_description_fe0fb",
          ge = R.strings.advanced_achievements,
          he = R.strings.achievements_page.earningNotification,
          be = (0, E.Pi)(({ className: u }) => {
            const e = v().model,
              ...
              A = ((u, e, t) => {
                const n = e ? he.trophy : he.achievement;
                return t > 1
                  ? {
            ...
            return a().createElement(
              "div",
              { className: p()(Ce, u) },
              a().createElement(Be, { content: c, classMix: _e }),
              e.computes.isMultiple()
                ? a().createElement(le, {
                    text: l,
                    binding: { name: a().createElement(Be, { content: E, classMix: me }) },
                    classMix: me,
                  })
                : a().createElement(Be, { content: l, classMix: me }),
            );
          }),
          ve = "Glow_base_b3401",
          fe = "Glow_glowContainer_e5689",
          pe = "Glow_glow_e91a3",
          xe = ({ isVisible: u, isHover: e }) => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement(
                  k.animated.div,
                  { style: r, className: fe },
                  a().createElement("div", { className: pe }),
                ),
              )
            );
          },
          we = { beginning: { x: "0rem" }, end: { x: "-340rem" } },
          ye = { beginning: { x: "105%", opacity: 1 }, end: { x: "0%", opacity: 1 } },
          Se = {
          ...
          Oe = (0, E.Pi)(() => {
            const u = v(),
              ...
              j = () => {
                if (W) {
                  ...
                  const u = s ? 300 : 0;
                  (F.start({ to: we.beginning, delay: u }),
                    B.start({
                      to: Object.assign({}, ye.beginning, { opacity: 0 }),
                      delay: u,
                      onRest: () => H(!1),
                    }));
                }
            ...
            return (
              ...
              a().createElement(
                "div",
                {
                  className: p()(ke.base, !O && ke.base__disabled, E && ke.base__trophy),
                  onMouseEnter: () => {
                ...
                a().createElement(
                  "div",
                  { className: ke.moveWrapper },
                  a().createElement(
                    k.animated.div,
                    { style: d, className: ke.content },
                    a().createElement(Ae, {
                      isTrophy: E,
                      isHover: q,
                      className: p()(ke.background, ke.background__1),
                    }),
                    a().createElement("div", {
                      className: ke.close,
                    ...
                    a().createElement(be, { className: ke.details }),
                    A &&
                      a().createElement(
                        k.animated.div,
                        { style: _, className: ke.pointsWrapper },
                        a().createElement(U, {
                          size: V.S48x48,
                          points: i,
                          className: ke.points,
                          classNames: { icon: ke.pointsIcon },
                        }),
                      ),
                  ),
                ),
                  ...
                  h.map((u, e) =>
                    a().createElement(
                      k.animated.div,
                      {
                        style: u,
                        key: e,
                        className: p()(ke.background, ke[`background__${e + 2}`]),
                      },
                      a().createElement(Ae, { isHover: q }),
                    ),
                  ),
                a().createElement(
                  k.animated.div,
                  { style: l, className: ke.achievementMoveWrapper },
                  a().createElement(ae, {
                    isVisible: W,
                      ...
                      (F.start({
                        ...
                        onRest: () => {
                          (T(!0),
                            ...
                            s && b.start({ from: { opacity: 1 }, to: Se.end }),
                            M.run(() => I(!0), 1800),
                            P.run(j, 1e4));
                        },
                      }),
                    ...
                    className: ke.achievement,
                  }),
                ),
                a().createElement(xe, { isVisible: L, isHover: q }),
              )
            );
          }),
          Te = "App_base_d4625",
          Pe = (0, E.Pi)(() => {
            ...
            return (
              ...
              a().createElement(
                "div",
                { className: Te },
                t.length > 0 && a().createElement(Oe, { key: u.computes.notificationUniqueKey() }),
              )
            );
          });
        engine.whenReady.then(() => {
          i().render(
            a().createElement(b, null, a().createElement(Pe, null)),
