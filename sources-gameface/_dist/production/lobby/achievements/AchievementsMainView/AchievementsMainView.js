(() => {
  var __webpack_modules__ = {
                    ...
                    m = e({
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          const a = u(t);
                          if (Array.isArray(e)) {
                            const n = e.reduce((e, t) => ((e[t] = i.LO.box(a[t], {})), e), {});
                            return (
                              "real" === r &&
                                d.subscribe(
                                  (0, i.aD)((t) => {
                          ...
                          }
                          {
                            const n = e,
                              s = Object.entries(n),
                              o = s.reduce((e, [t, r]) => ((e[r] = i.LO.box(a[t], {})), e), {});
                            return (
                              "real" === r &&
                                d.subscribe(
                                  (0, i.aD)((e) => {
              ...
              (t[r] = (function (t) {
                return (r) => {
                  ...
                  return (
                    ...
                    () => {
                      i &&
                        (o(), window.removeEventListener(n, l), (e.listeners -= 1), a(), (i = !1));
                    }
                  );
                };
              })(r)),
      ...
      1988: (e, t, r) => {
        ...
        engine.whenReady.then(() => {
          s().render(
            i().createElement(R, null, i().createElement(C, null)),
