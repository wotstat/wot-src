  ...
  var __webpack_modules__ = {
        ...
        const _ = {
          ...
          F = (0, i.ZP)((e) => {
            ...
            return l().createElement(
              "div",
              m({ className: n()(c.Z.base, ...q, u), style: X }, z),
              j,
            );
          });
      },
      ...
      7104: (e, u, t) => {
        ...
        const l = "DateTimer_base_55",
          ...
          E = (0, s.memo)(
            ({ text: e, timeStamp: u, showBg: t = !1, mixClass: r, classNames: s }) => {
              const E = (0, o._3)(u),
                m = E.day,
                _ = E.month,
                A = E.hours,
              ...
              return i().createElement(
                ...
                t && i().createElement("div", { className: c }),
                i().createElement(a.ZP, {
                  ...
                  format: {
                    binding: {
                      day: m,
                      month: R.strings.menu.dateTime.months.$num(_ + 1),
                      hours: A,
                      minutes: d,
                    },
                  },
      ...
      7200: (e, u, t) => {
                      ...
                      m = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const r = l(u);
                            if (Array.isArray(e)) {
                              const n = e.reduce((e, u) => ((e[u] = g.LO.box(r[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, g.aD)((u) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                s = a.reduce((e, [u, t]) => ((e[t] = g.LO.box(r[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, g.aD)((e) => {
        ...
        const Me = (0, s.memo)((e) => {
            ...
            switch (r.animationSettings.type) {
              case Ee.Simple:
                return i().createElement(be, Ne({}, r, { onEndAnimation: l, isComplete: a }));
              case Ee.Growing:
            ...
            ({
              ...
              const F = ((e, u, t) =>
                (0, s.useMemo)(() => {
                  ...
                  return { value: r, deltaFrom: Ge(r, u, t) };
                }, [t, u, e]))(c, e, E);
              return i().createElement(
                "div",
        ...
        const Ke = (e, u) => ("number" == typeof u ? u : e.offsetLeft),
          ...
          su = (0, s.memo)(
            ({ points: e, currentLevel: u, levels: t, maxPointsCount: r, maxLevel: a }) => {
              ...
              return i().createElement(
                ...
                i().createElement(
                  ...
                  {
                    className: uu,
                    style: { width: 310 * a + "rem", transform: `translateX(${c}rem)` },
                  },
                  l
                    .slice(0, l.length)
                    .map((e, u) =>
            ...
            ({
              ...
              i().createElement(
                ...
                i().createElement(
                  ...
                  i().createElement(Y.ZP, { text: Gu.currentLevel(), className: ue }),
                ),
                i().createElement(
                  "div",
                  { className: te },
            ...
            ({
              ...
              return i().createElement(
                ...
                i().createElement(
                  "div",
                  { className: K.header },
                  i().createElement(Y.ZP, { className: K.headerTitle, text: Gu.title() }),
            ...
            i().createElement(
              ...
              i().createElement(
                ...
                i().createElement(
                  "div",
                  { className: pu },
                  i().createElement(Y.ZP, { text: String(t), className: n()(vu, 4 === t && bu) }),
                ),
              ),
              u,
            ),
          ...
          Iu = (0, s.memo)(() =>
            i().createElement(
              ...
              i().createElement(
                ...
                i().createElement(Y.ZP, { className: Lu, text: Gu.paused.title() }),
              ),
              i().createElement(Y.ZP, { className: ku, text: Gu.paused.description() }),
            ),
          );
        var Uu = t(2372);
        const Hu = {
          ...
          Wu = (0, s.memo)(({ state: e, points: u }) =>
            i().createElement(
              ...
              i().createElement(
                "div",
                { className: Hu.header },
                i().createElement(Y.ZP, { className: Hu.headerTitle, text: Gu.title() }),
                i().createElement(Y.ZP, { className: Hu.headerSubtitle, text: String(Gu.$dyn(e)) }),
              ),
              i().createElement(
                "div",
                { className: Hu.points },
                ...
                i().createElement(Y.ZP, {
                  text: String(Gu.points.description()),
