              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (E(), window.removeEventListener(F, a), (u.listeners -= 1), A(), (r = !1));
                    }
                  );
                };
              })(t)),
        ...
        const Ru = {
          ...
          Wu = Tu((u) => {
            ...
            return J().createElement(
              "div",
              Mu({ className: D()(Lu.base, ...j, e), style: G }, P),
              W,
            );
          });
        let Pu;
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = n(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = Ce.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  D.subscribe(
                                    (0, Ce.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                F = Object.entries(r),
                                E = F.reduce((u, [e, t]) => ((u[t] = Ce.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  D.subscribe(
                                    (0, Ce.aD)((u) => {
                ...
                J().createElement(
                  ...
                  u.length > 5 &&
                    J().createElement(
                      "div",
                      { className: fe },
                      J().createElement(ie, { text: Oe.count(), binding: { count: u.length - 5 } }),
                    ),
                ),
              ),
            );
