  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (A(), window.removeEventListener(E, i), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      2829: (u, e, t) => {
                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = F(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = Lu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, Lu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                E = Object.entries(a),
                                n = E.reduce((u, [e, t]) => ((u[t] = Lu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, Lu.aD)((u) => {
        ...
        const Zu = {
          ...
          Qu = (0, r.memo)(
            ({ type: u = Yu.Normal, cardSize: e = qu.Big, isPerformanceRisk: t = !1 }) => {
              const r = {
                width: 300,
                height: 150,
                frameCount: 67,
