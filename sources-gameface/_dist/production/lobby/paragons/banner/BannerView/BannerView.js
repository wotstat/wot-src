(() => {
        ...
        const D = {
          ...
          B = (0, E.ZP)((u) => {
            let e = u.className,
              ...
              S = u.row,
              v = u.flexDirection,
              b = void 0 === v ? (p ? "column" : S && "row") || void 0 : v,
              x = u.flexStart,
              f = u.center,
              w = u.flexEnd,
              T = u.spaceBetween,
              ...
              y =
                void 0 === P
                  ? (x ? "flex-start" : f && "center") || (w && "flex-end") || void 0
                  : P,
              O = u.alignSelf,
              k = u.wrap,
              H = u.flexWrap,
              ...
              U = u.shrink,
              G = u.flex,
              W = void 0 === G ? (I || U ? `${I ? 1 : 0} ${U ? 1 : 0} auto` : void 0) : G,
              X = u.style,
              j = u.children,
              q = (function (u, e) {
                if (null == u) return {};
            ...
            return s().createElement(
              "div",
              l({ className: a()(o.Z.base, ...z, e), style: Z }, q),
              j,
            );
          });
      },
      ...
      4960: (u, e, t) => {
        ...
        const I = ((u, e) => {
          ...
          W = {
            ...
            titleContainer__hasTimer: "App_titleContainer__hasTimer_ae",
            title: "App_title_61",
            subtitleContainer: "App_subtitleContainer_7c",
            subtitleContainer__hasTimer: "App_subtitleContainer__hasTimer_5a",
            subtitle: "App_subtitle_73",
            timeInfo: "App_timeInfo_35",
            timerBase: "App_timerBase_33",
            timeText: "App_timeText_82",
            timerIcon: "App_timerIcon_49",
          },
          X = 33,
          j = 0,
          q = !0,
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                switch (m) {
                  ...
                  case "stop":
                    return (function () {
                      const u = 0 === F && h ? { path: h, x: 0, y: 0 } : r(F),
                        e = new Image();
                      e.src = u.path;
                      const a = () => t(V(u, e));
                      return (
        ...
        const J = (u) => (u < 0.5 ? 4 * u * u * u : (u - 1) * (2 * u - 2) * (2 * u - 2) + 1);
        let uu;
        !(function (u) {
          ((u.Big = "big"),
        ...
        const eu = {
          "302*152": uu.Big,
          "302*114": uu.WideSmall,
          "222*114": uu.ThinSmall,
          "162*114": uu.ThinExtraSmall,
        };
        let tu;
        !(function (u) {
        ...
        const ru = {
          ...
          au = (0, a.memo)(
            ({ type: u = tu.Normal, cardSize: e = uu.Big, isPerformanceRisk: t = !1 }) => {
              const r = {
                width: 300,
                height: 150,
                frameCount: 67,
                ...
                getChunkPath:
                  ((a = `R.images.gui.maps.icons.paragons.banner.sequence.sparks_${u}_`),
                  (u) => `${a}${u}`),
              };
              var a;
              const i = (function (u) {
          ...
          Eu = (0, T.Pi)(() => {
            const u = (0, a.useState)(!1),
              ...
              x = (0, a.useCallback)(() => {
                (w.playClick(), _.onClick());
              }, [_]),
              f = (0, M.useSpring)({
                from: { x: 10, opacity: 0 },
                to: { x: 0, opacity: 1 },
                delay: 0,
                config: { duration: 800, easing: J },
              });
            return (
              (0, a.useEffect)(() => {
              ...
              n().createElement(
                ...
                n().createElement("div", { className: W.bg }),
                n().createElement("div", { className: W.stroke }),
                n().createElement(
                  nu,
                  { classMix: W.sequence, isVisible: e },
                  n().createElement(au, { type: tu.Hover, cardSize: d }),
                ),
                n().createElement(nu, { classMix: W.hoverEffect, isVisible: e }),
                n().createElement(
                  nu,
                  { classMix: W.sequence, isVisible: !e },
                  n().createElement(au, { type: tu.Normal, cardSize: d }),
                ),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [454], () => __webpack_require__(4960));
