(() => {
  ...
  var __webpack_modules__ = {
      ...
      1571: (u, e, t) => {
        ...
        s.Sw.instance;
        const $ = S,
          q = "Countdown_base_d0c0c",
          V = "Countdown_icon_a453a",
          ...
          W = (u, e) => {
            switch (e) {
              ...
              case B.Extended:
                return `${m(R.strings.common.duration.days(), { days: u.days })} | ${z(u.hours)}:${z(u.minutes)}:${z(u.seconds)}`;
            }
          },
            ...
            ((0, n.memo)(
              ({
                ...
                return r().createElement(
                  ...
                  e !== l.None &&
                    r().createElement("div", {
                      className: E()(V, s.icon),
                      style: { backgroundImage: `url('${j(e, c)}')` },
                    }),
                  r().createElement("div", { className: E()(U, s.text) }, D),
                );
              },
            ),
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = E(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = uu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, uu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = uu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, uu.aD)((u) => {
          ...
          Au = (0, Q.Pi)(() => {
            ...
            const n = iu().model,
              ...
              V = {
                ...
                effectTime: r().createElement(
                  "span",
                  null,
                  W(N(o.totalDuration.get()), B.Description),
                ),
              },
              U = {
              ...
              j = {
                ...
                time: r().createElement(
                  ...
                  r().createElement(
                    "span",
                    {
                      className: E()(au.expirationTimerTime, k && au.expiration_timer_time__today),
                    },
                    T,
                  ),
                ),
            ...
            return r().createElement(
              ...
              r().createElement(
                "div",
                { className: au.effect },
                r().createElement(K, { text: q, binding: V }),
              ),
              r().createElement("div", { className: au.line }),
              r().createElement(
                "div",
