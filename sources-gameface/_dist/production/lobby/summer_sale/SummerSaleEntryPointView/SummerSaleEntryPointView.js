  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (F(), window.removeEventListener(A, n), (u.listeners -= 1), E(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      800: (u, e, t) => {
        ...
        const Lu = ((u, e) => {
                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const E = i(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = wu.LO.box(E[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, wu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                A = Object.entries(r),
                                a = A.reduce((u, [e, t]) => ((u[t] = wu.LO.box(E[e], {})), u), {});
                              return (
                                "real" === t &&
                                  n.subscribe(
                                    (0, wu.aD)((u) => {
            ...
            ({ externalModel: u }) => ({
              toSummerSaleEvent: u.createCallbackNoArgs("toSummerSaleEvent"),
            }),
          ),
          Ou = Lu[0],
          Tu = Lu[1],
        ...
        const ku = R.strings.event.summerSales,
          Wu = (u) => {
            ...
            return r
              ? ku.eventFinishFormat() + j(A.minutes(), { minutes: r })
              : ku.lessThanMinute();
          },
          Iu = (0, vu.Pi)(() => {
            const u = Tu(),
