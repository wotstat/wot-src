  ...
  var __webpack_modules__ = {
      ...
      25: (u, e, t) => {
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = l(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = iu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, iu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                s = n.reduce((u, [e, t]) => ((u[t] = iu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, iu.aD)((u) => {
        ...
        const ze = "VehicleReward_base_ea",
          ...
          tt = (u, e) =>
            u < b.Medium
              ? R.images.gui.maps.icons.event.summerSale.reward.vechicles.c_360x270.$dyn(
                  `${xu(e)}`,
                ) || R.images.gui.maps.shop.vehicles.c_360x270.$dyn(`${xu(e)}`)
              : R.images.gui.maps.icons.event.summerSale.reward.vechicles.c_600x450.$dyn(
                  `${xu(e)}`,
