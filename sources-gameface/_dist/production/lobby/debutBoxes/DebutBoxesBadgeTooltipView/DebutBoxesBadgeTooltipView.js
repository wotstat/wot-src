  ...
  var __webpack_modules__ = {
      ...
      581: (u, e, t) => {
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = E(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = Bu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Bu.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                i = a.reduce((u, [e, t]) => ((u[t] = Bu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, Bu.aD)((u) => {
            ...
            const h = (0, i.useRef)({
              ...
              v = (0, i.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (ne(t, D, { isMouseEvent: !0, on: !0, arguments: re(r) }, b),
                  C && C(),
        ...
        const De = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            return n || i
              ? s().createElement(ae, ce({}, e, { contentId: n || i }), r)
          ...
          me = ({
            ...
            return s().createElement(
              "div",
              { className: n()(_e.base, _e[`base__${r}`], l), style: E },
              s().createElement(
                De,
                ...
                s().createElement(
                  ...
                  s().createElement(
                    "div",
                    { className: n()(_e.image, null == A ? void 0 : A.image) },
                    D &&
                      s().createElement("div", {
                        className: n()(_e.highlight, null == A ? void 0 : A.highlight),
                        style: {
                    ...
                    e &&
                      s().createElement("div", {
                        className: n()(_e.icon, null == A ? void 0 : A.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      s().createElement("div", {
                        className: n()(_e.overlay, null == A ? void 0 : A.overlay),
                        style: {
              ...
              t &&
                s().createElement(
                  ...
                  { tooltipArgs: c },
                  s().createElement("div", {
                    className: n()(_e.timer, null == A ? void 0 : A.periodicIcon),
                  }),
                ),
            );
          },
          ...
          Oe = (0, Du.Pi)(() => {
            ...
            return s().createElement(
              ...
              s().createElement(
                ...
                s().createElement(cu, { className: Te, text: e }),
              ),
