              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (E(), window.removeEventListener(n, i), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
            ...
            ({
              ...
              a().createElement(
                ...
                a().createElement(
                  ...
                  i && n > 0 && "+",
                  a().createElement(Q, { value: n, format: r === S.gold ? "gold" : "integral" }),
                ),
                      ...
                      D = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = F(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = Bu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Bu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                E = n.reduce((u, [e, t]) => ((u[t] = Bu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Bu.aD)((u) => {
