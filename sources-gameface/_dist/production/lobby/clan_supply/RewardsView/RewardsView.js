  ...
  var __webpack_modules__ = {
      ...
      988: (e, t, n) => {
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = c(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, t) => ((e[t] = q.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  l.subscribe(
                                    (0, q.aD)((t) => {
                            ...
                            }
                            {
                              const a = e,
                                i = Object.entries(a),
                                o = i.reduce((e, [t, n]) => ((e[n] = q.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  l.subscribe(
                                    (0, q.aD)((e) => {
        ...
        const Xe = ({ children: e, tooltipArgs: t, className: n }) => {
            ...
            const i = t.contentId;
            return i
              ? a().createElement(Fe, Ke({}, t, { contentId: i }), r)
              : a().createElement(Ve, t, r);
          },
          Qe = {
              ...
              a().createElement(
                ...
                a().createElement(
                  ...
                  l &&
                    a().createElement(
                      "div",
                      { className: E()(Qe.title, null == d ? void 0 : d.title) },
                      l,
                    ),
                ),
              ),
            ...
            return a().createElement(
                        ...
                        : a().createElement(
                            ...
                            a().createElement(
                              ...
                              Dt({}, e, {
                                ...
                                tooltipArgs: l,
                                classNames: {
                                  info: E()(lt.info, e.isCompensation && lt.info__compensation),
                                  overlay: E()(lt.overlay, lt[`overlay__${e.overlayType}`]),
                                },
                              }),
                            ),
              ...
              r &&
                a().createElement(
                  "div",
                  { className: Mt },
                  a().createElement(kt, { showDelay: o }),
                ),
            );
          }),
          Gt = (0, $.Pi)(() => {
        ...
        const qt = (e) => {
          ...
          return a().createElement(
            ...
            i &&
              a().createElement("div", { className: E()(Wt.goto, null == s ? void 0 : s.goto) }, i),
          );
        };
        var Yt = n(20);
        const jt = (e) => {
                            ...
                            i.forEach((t, n) => {
                              void 0 !== i[n] &&
                                ...
                                e.changeKeyframeHandlers.forEach((e) => {
                                  ...
                                  return e({ time: t, name: `${m ? r : `Point_${n}`}` });
                                });
                            });
                          }
                        }),
                  ...
                  const n = (t) => (
                    ...
                    o = (e) => {
                      ...
                      p.current &&
                        (p.current.currentTime =
                          ((t = 0), (n = p.current.duration), (r = e) < t ? t : r > n ? n : r));
                    },
                    s = () => {
                      var e;
                    ...
                    v = (e, t) => {
                      ...
                      return (
                        ...
                        () => {
                          var n;
                          return null == (n = p.current) ? void 0 : n.removeEventListener(e, t);
                        }
                      );
                    },
                    f = (e, t) => {
