(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[E] = (function (e) {
                return (E) => {
                  ...
                  return (
                    ...
                    () => {
                      t &&
                        (D(), window.removeEventListener(F, n), (u.listeners -= 1), A(), (t = !1));
                    }
                  );
                };
              })(E)),
      ...
      687: (u, e, E) => {
        ...
        const j = R.strings.tooltips.liveOps.entryPointTooltip,
          z = ((u, e) => {
                      ...
                      i = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = r(e);
                            if (Array.isArray(u)) {
                              const t = u.reduce((u, e) => ((u[e] = L.LO.box(A[e], {})), u), {});
                              return (
                                "real" === E &&
                                  n.subscribe(
                                    (0, L.aD)((e) => {
                            ...
                            }
                            {
                              const t = u,
                                F = Object.entries(t),
                                D = F.reduce((u, [e, E]) => ((u[E] = L.LO.box(A[e], {})), u), {});
                              return (
                                "real" === E &&
                                  n.subscribe(
                                    (0, L.aD)((u) => {
            ...
            return Object.assign({}, e, {
              computes: { date: E, subTitleString: t, bodyString: A },
            });
          }, M),
          q = z[0],
          W = z[1],
        ...
        engine.whenReady.then(() => {
          D().render(
            t().createElement(q, null, t().createElement(J, null)),
