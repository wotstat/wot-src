  ...
  var u,
    e = {
      574: (u, e, A) => {
        ...
        const a = B.O.client.getSize("rem"),
          i = a.width,
          n = a.height,
          l = Object.assign({ width: i, height: n }, C(i, n, r.j)),
        ...
        const s = (u) => {
          ...
          const E = (0, F.useContext)(m),
            ...
            f = { extraLarge: g, large: _, medium: h, small: c, extraSmall: x };
        ...
        (0, F.memo)(({ children: u }) => {
          const e = (0, F.useContext)(m),
            ...
            D = A[0],
            t = A[1],
            a = (0, F.useCallback)((u, e) => {
              const A = B.O.view.pxToRem(u),
                F = B.O.view.pxToRem(e);
              t(Object.assign({ width: A, height: F }, C(A, F, r.j)));
            }, []);
          (d(() => {
            engine.on("clientResized", a);
          }),
            (0, F.useEffect)(() => () => engine.off("clientResized", a), [a]));
      ...
      558: (u, e, A) => {
        ...
        const a = ["xl", "lg", "md", "sm", "xs"],
          i = (u) => u.includes("_") && ((u) => a.includes(u))(u.split("_").at(-1)),
          ...
          l = (u, e) =>
            Object.keys(u).reduce((A, F) => {
              ...
              return (
                void 0 === E ||
                  ((u, e) => a.some((A) => void 0 !== e[`${u}_${A}`]))(F, u) ||
                  (A[F] = E),
                A
              );
            }, {}),
            ...
            const K = (0, r.useMemo)(() => {
                const u = { mt: B, mr: i, mb: l, ml: c },
                  ...
                  E = ((u) =>
                    _.reduce((e, A) => {
                      const F = u[A];
                      return ("number" == typeof F && (e[h[A]] = F + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [A, F, B, i, l, c, I, z, y, v, G, H, O]),
              V = K.computedStyle,
              Y = K.computedClassNames;
            return C().createElement("div", d({ className: E()(o.base, ...Y, e), style: V }, U), k);
          });
        let x;
        !(function (u) {
                  ...
                  e.split("\n").map((e, D) =>
                    C().createElement(
                      ...
                      ((u, e, A) =>
                        ...
                        F,
                        u,
                      ).map((u, e) => C().createElement(r.Fragment, { key: `${e}-${u}` }, u)),
                    ),
                  ),
                );
        var H = A(532),
        ...
        const W = Object.keys(T()),
          ...
          k = m((u) => {
            ...
            return C().createElement(
              ...
              P(
                {
                  className: E()(O.base, A && O[A], f, F),
                  style: x,
                  mt: !0 === a ? z[A || "paragraph-P16"].mt : a,
              ...
              void 0 !== g ? C().createElement(M, P({}, g, { text: e })) : e,
            );
          });
      },
      532: (u) => {
      ...
      67: (u, e, A) => {
        ...
        const C = B("clientResized"),
          a = { down: B("mousedown"), up: B("mouseup"), move: B("mousemove") };
        const i = (function () {
      ...
      556: (u, e, A) => {
        ...
        var F = A(558),
          E = A(179),
          D = A.n(E);
        const t = "Header_base_93",
          B = "Header_title_c9",
          r = "Header_subtitle_5c";
        D().memo(({ title: u, subtitle: e }) =>
          D().createElement(
            "div",
            { className: t },
            D().createElement(F.ZP, { className: B, text: u }),
            D().createElement(F.ZP, { className: r, text: e }),
          ),
        );
      },
    },
