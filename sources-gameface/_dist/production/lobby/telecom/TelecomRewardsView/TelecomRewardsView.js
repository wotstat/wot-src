(() => {
  var __webpack_modules__ = {
      574: (u, e, t) => {
        ...
        const o = A.O.client.getSize("rem"),
          s = o.width,
          D = o.height,
          l = Object.assign({ width: s, height: D }, F(s, D, i.j)),
          ...
          m = (0, r.memo)(({ children: u }) => {
            const e = (0, r.useContext)(_),
              ...
              o = (0, r.useCallback)((u, e) => {
                ...
                E(Object.assign({ width: t, height: r }, F(t, r, i.j)));
              }, []);
            (C(() => {
      ...
      558: (u, e, t) => {
        ...
        const o = ["xl", "lg", "md", "sm", "xs"],
          s = (u) => u.includes("_") && ((u) => o.includes(u))(u.split("_").at(-1)),
          D = [A.cJ.ExtraLarge, A.cJ.Large, A.cJ.Medium, A.cJ.Small, A.cJ.ExtraSmall],
          l = (u, e) =>
        ...
        Object.keys(E());
        const m = {
            XL: { mt: B.mt__XL, mr: B.mr__XL, mb: B.mb__XL, ml: B.ml__XL },
            LG: { mt: B.mt__LG, mr: B.mr__LG, mb: B.mb__LG, ml: B.ml__LG },
            MDp: { mt: B.mt__MDp, mr: B.mr__MDp, mb: B.mb__MDp, ml: B.ml__MDp },
            MD: { mt: B.mt__MD, mr: B.mr__MD, mb: B.mb__MD, ml: B.ml__MD },
            SMp: { mt: B.mt__SMp, mr: B.mr__SMp, mb: B.mb__SMp, ml: B.ml__SMp },
            SM: { mt: B.mt__SM, mr: B.mr__SM, mb: B.mb__SM, ml: B.ml__SM },
            XS: { mt: B.mt__XS, mr: B.mr__XS, mb: B.mb__XS, ml: B.ml__XS },
          },
          d = (Object.keys(m), ["mt", "mr", "mb", "ml"]),
          ...
          g = _((u) => {
            let e = u.className,
              ...
              y =
                void 0 === R
                  ? (x ? "flex-start" : w && "center") || (M && "flex-end") || void 0
                  : R,
              H = u.alignSelf,
              P = u.wrap,
              N = u.flexWrap,
              k = void 0 === N ? (P ? "wrap" : void 0) : N,
              I = u.grow,
              W = u.shrink,
              G = u.flex,
            ...
            const K = (0, i.useMemo)(() => {
              ...
              }, [t, r, A, s, l, g, j, U, H, f, k, O, y]),
              z = K.computedStyle,
              V = K.computedClassNames;
            return F().createElement("div", C({ className: a()(B.base, ...V, e), style: z }, $), X);
          });
        let p;
        !(function (u) {
        ...
        const v = (u, e, t) => {
          ...
          f = (u, e, t = p.left) => u.split(e).reduce(t === p.left ? v : b, []),
          x = (() => {
            const u = new RegExp(
            ...
            return w.includes(t)
              ...
              : ((u, e = p.left) => {
                  ...
                  const r =
                    ...
                    a = u.replace(/&nbsp;/g, " ");
                  return (f(a, /( )/, e).forEach((u) => (t = t.concat(f(u, r, p.left)))), t);
                })(u, e);
          },
          L = "FormatText_base_d0",
          S = ({ binding: u, text: e = "", classMix: t, alignment: r = p.left }) =>
            null === e
                  ...
                  e.split("\n").map((e, n) =>
                    F().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        r,
                        u,
                      ).map((u, e) => F().createElement(i.Fragment, { key: `${e}-${u}` }, u)),
                    ),
                  ),
                );
        var T = t(532),
        ...
        const N = Object.keys(O()),
          ...
          I = { mt: "SM", mr: "XS", mb: "XS", ml: "XS" },
          W = { mt: "XS", mr: "XS", mb: "XS", ml: "XS" },
          G = {
              ...
              P(
                {
                  ...
                  style: p,
                  mt: !0 === o ? U[t || "paragraph-P16"].mt : o,
                  mr: !0 === D ? U[t || "paragraph-P16"].mr : D,
                  mb: !0 === _ ? U[t || "paragraph-P16"].mb : _,
                  ml: !0 === c ? U[t || "paragraph-P16"].ml : c,
                },
                d,
              ),
              void 0 !== m ? F().createElement(S, P({}, m, { text: e })) : e,
            );
          });
      },
      926: (u) => {
      ...
      67: (u, e, t) => {
        ...
        var n = {};
        (t.r(n), t.d(n, { getBgUrl: () => c, getTextureUrl: () => B }));
        var E = {};
        function A(u) {
          return (e) => (
            engine.on(u, e),
      ...
      687: (u, e, t) => {
        ...
        const l = {
            [o.fd.ExtraSmall]: "",
            [o.fd.Small]: F().SMALL_WIDTH,
            [o.fd.Medium]: `${F().SMALL_WIDTH} ${F().MEDIUM_WIDTH}`,
            [o.fd.Large]: `${F().SMALL_WIDTH} ${F().MEDIUM_WIDTH} ${F().LARGE_WIDTH}`,
            [o.fd.ExtraLarge]:
              `${F().SMALL_WIDTH} ${F().MEDIUM_WIDTH} ${F().LARGE_WIDTH} ${F().EXTRA_LARGE_WIDTH}`,
          },
          _ = {
            [o.Aq.ExtraSmall]: "",
            [o.Aq.Small]: F().SMALL_HEIGHT,
            [o.Aq.Medium]: `${F().SMALL_HEIGHT} ${F().MEDIUM_HEIGHT}`,
            [o.Aq.Large]: `${F().SMALL_HEIGHT} ${F().MEDIUM_HEIGHT} ${F().LARGE_HEIGHT}`,
            [o.Aq.ExtraLarge]:
          ...
          B = {
            [o.cJ.ExtraSmall]: "",
            [o.cJ.Small]: F().SMALL,
            [o.cJ.Medium]: `${F().SMALL} ${F().MEDIUM}`,
            [o.cJ.Large]: `${F().SMALL} ${F().MEDIUM} ${F().LARGE}`,
            [o.cJ.ExtraLarge]: `${F().SMALL} ${F().MEDIUM} ${F().LARGE} ${F().EXTRA_LARGE}`,
          },
          c = (u) => {
            let e = u.children,
              t = u.className,
            ...
            const a = (0, o.GS)(),
              ...
              i = a.mediaHeight,
              F = a.mediaSize;
            return n().createElement("div", D({ className: A()(t, l[E], _[i], B[F]) }, r), e);
          },
          C = ["children"];
        const m = (u) => {
          let e = u.children,
          ...
          const C = (0, a.useRef)(null),
            ...
            I = A()(
              ...
              p[`base__${r}`],
              {
                ...
                [p[`base__${e}`]]: e,
                [p.base__focus]: d,
                [p.base__highlightActive]: f,
                [p.base__firstHover]: M,
              },
              i,
            ),
            W = A()(p.state, p.state__default);
          return (
            (0, a.useEffect)(
              () => (
        ...
        class T extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              _ = A()(M.base, M[`base__${E}`], M[`base__${a}`], null == i ? void 0 : i.base),
              B = A()(M.icon, M[`icon__${E}`], M[`icon__${a}`], null == i ? void 0 : i.icon),
              c = A()(M.glow, null == i ? void 0 : i.glow),
              C = A()(M.caption, M[`caption__${E}`], null == i ? void 0 : i.caption),
              m = A()(M.goto, null == i ? void 0 : i.goto);
            return n().createElement(
              ...
              "info" !== E && n().createElement("div", { className: M.shine }),
              n().createElement(
                "div",
                { className: B },
                ...
                const F = (0, a.useRef)([]),
                  o = (t, r, a) => {
                    ...
                    const E = (function ({
                      ...
                      s = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = i(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = U.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, U.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                E = n.reduce((u, [e, t]) => ((u[t] = U.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, U.aD)((u) => {
                      ...
                      D = { mode: t, model: s, externalModel: A, cleanup: o };
                    return {
                      model: s,
                  ...
                  l = D[0],
                  _ = D[1],
                  B = (0, a.useState)(() => o(r, E, i)),
                  c = B[0],
                  C = B[1];
                return (
                  (0, a.useEffect)(() => {
                    s.current ? C(o(l, E, i)) : (s.current = !0);
                  }, [i, l, E]),
                  (0, a.useEffect)(() => {
                    _(r);
                  }, [r]),
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  { className: `${eu} ${tu}` },
                  n().createElement(k.h, {
                    title: Eu.rewardsView.title(),
                    subtitle: Eu.rewardsView.subtitle(),
                  }),
                ),
              ),
              n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: `${eu} ${au}` },
                  n().createElement(W.a, { title: Eu.rewards.label() }),
                ),
              ),
              n().createElement(
                "div",
                ...
                n().createElement(
                  ...
                  n().createElement(
                    x,
                    { onClick: u, size: "medium" },
                    n().createElement(w.ZP, { text: Eu.common.confirm() }),
                  ),
                ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          h().render(
            n().createElement(m, null, n().createElement(z, null, n().createElement(Au, null))),
      ...
      556: (u, e, t) => {
        ...
        var r = t(558),
          a = t(179),
          n = t.n(a);
        const E = "Header_base_93",
          A = "Header_title_c9",
          i = "Header_subtitle_5c",
          F = n().memo(({ title: u, subtitle: e }) =>
            n().createElement(
              "div",
              { className: E },
              n().createElement(r.ZP, { className: A, text: u }),
              n().createElement(r.ZP, { className: i, text: e }),
            ),
          );
      },
      997: (u, e, t) => {
        ...
        var r = t(179),
          a = t.n(r);
        const n = "Hero_base_4b",
          E = "Hero_sign_ec",
          A = () =>
            a().createElement("div", { className: n }, a().createElement("div", { className: E }));
      },
      102: (u, e, t) => {
        "use strict";
        t.d(e, { a: () => B });
        var r = t(558),
          a = t(179),
          n = t.n(a);
        const E = "Rewards_base_45",
          A = "Rewards_title_f6",
          i = "Rewards_rewards_9b",
          F = "Rewards_reward_e9",
          o = "Rewards_icon_fd",
          s = "Rewards_label_4d",
          D = R.images.gui.maps.icons.telecom.shared.rewards,
          l = R.strings.telecom.rewards,
          _ = [
            { icon: D.r1(), label: l.r1() },
            { icon: D.r2(), label: l.r2() },
            { icon: D.r3(), label: l.r3() },
            { icon: D.r4(), label: l.r4() },
            { icon: D.r5(), label: l.r5() },
          ],
          B = n().memo(({ title: u }) =>
            n().createElement(
              "div",
              ...
              n().createElement(
                ...
                _.map((u) =>
                  n().createElement(
                    "div",
                    { className: F, key: u.label },
                    n().createElement("div", {
                      className: o,
                      style: { backgroundImage: `url(${u.icon})` },
                    }),
                    n().createElement(r.ZP, { className: s, text: u.label }),
                  ),
                ),
              ),
            ),
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.j = 759),
    (() => {
      var u = { 759: 0, 811: 0, 360: 0, 762: 0 };
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [655], () => __webpack_require__(687));
