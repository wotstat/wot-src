  ...
  var u,
    A = {
      5154: (u, A, F) => {
        ...
        const X = Object.keys(b).reduce(
            (u, A) => ((u[A] = () => viewEnv.getShowingStatus() === b[A]), u),
            {},
          ),
          Y = {
            set: (u, A) => {
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, A) => {
                            const E = t(A);
                            if (Array.isArray(u)) {
                              const e = u.reduce((u, A) => ((u[A] = nu.LO.box(E[A], {})), u), {});
                              return (
                                "real" === F &&
                                  C.subscribe(
                                    (0, nu.aD)((A) => {
                            ...
                            }
                            {
                              const e = u,
                                D = Object.entries(e),
                                B = D.reduce((u, [A, F]) => ((u[F] = nu.LO.box(E[A], {})), u), {});
                              return (
                                "real" === F &&
                                  C.subscribe(
                                    (0, nu.aD)((u) => {
        ...
        const xu = "Content_base_17",
          ...
          ku = () =>
            t().createElement(Bu, null, t().createElement(su, null, t().createElement(ju, null)));
        engine.whenReady.then(() => {
