              ...
              (e[F] = (function (e) {
                return (F) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (n(), window.removeEventListener(t, D), (u.listeners -= 1), A(), (E = !1));
                    }
                  );
                };
              })(F)),
                    ...
                    const n = (function ({
                      ...
                      D =
                        "real" === F
                          ...
                          : Object.assign({}, n, {
                              readByPath:
                                null != (t = null == E ? void 0 : E.getter) ? t : () => {},
                            }),
                      B = (u) =>
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = B(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = iu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  D.subscribe(
                                    (0, iu.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                t = Object.entries(E),
                                n = t.reduce((u, [e, F]) => ((u[F] = iu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === F &&
                                  D.subscribe(
                                    (0, iu.aD)((u) => {
  ...
  ((A.m = e),
    ...
    (() => {
      ...
      var e = (e, F) => {
          ...
          for (e && e(F); r < n.length; r++)
            ((t = n[r]), A.o(u, t) && u[t] && u[t][0](), (u[t] = 0));
          return A.O(C);
        },
