  ...
  var __webpack_modules__ = {
      ...
      718: (e, u, t) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                s = a.reduce((e, [u, t]) => ((e[t] = De.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, De.aD)((e) => {
        ...
        const mu = "ProgressBarDeltaSimple_base_6c",
          ...
          fu = (0, n.memo)(
            ({
              ...
              const h = (0, n.useMemo)(
                  () => Object.assign({ width: "100%" }, bu(e), pu(d)),
                  [d, e],
                ),
                b = (0, n.useMemo)(() => Object.assign({ width: "0%" }, bu(e), pu(d)), [d, e]),
                f = (0, n.useMemo)(
                  () => Object.assign({ width: "0%" }, hu(d, a), bu(e)),
                  [a, d, e],
                ),
                v = (0, n.useMemo)(
        ...
        const En = {
          ...
          wn = (0, n.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = bn, onDrag: a = fn }) => {
                  ...
                  ((t.style.transform = `translateX(${0 | E}px)`),
                    ((e) => {
                      if (o.current && i.current && l.current && c.current) {
                        if (0 === e)
                          return (o.current.classList.add(pn), void i.current.classList.remove(pn));
                        if (
                          ((u = l.current),
                          (t = c.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (o.current.classList.remove(pn), void i.current.classList.add(pn));
                        var u, t;
        ...
        const Mn = {
          base: "Arrow_base_f4",
          bg: "Arrow_bg_b9",
          base__right: "Arrow_base__right_86",
        };
        let Nn;
        !(function (e) {
        ...
        const cr = (0, W.Pi)(({ className: e, index: u }) => {
            ...
            return r().createElement(
              or,
              lr({}, a, { classMix: e, rewardItemClassMix: ir, size: n }),
            );
          }),
