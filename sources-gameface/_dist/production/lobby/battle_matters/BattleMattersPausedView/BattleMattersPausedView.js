              ...
              (t[r] = (function (t) {
                return (r) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (s(), window.removeEventListener(i, o), (e.listeners -= 1), a(), (n = !1));
                    }
                  );
                };
              })(r)),
          ...
          X = ({ isBlurred: e, children: t, onLoaded: r }) => {
            ...
            return (
              ...
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: Y, style: { backgroundImage: `url(${i})` } },
                  t,
                ),
              )
            );
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const n = e,
                                i = Object.entries(n),
                                s = i.reduce((e, [t, r]) => ((e[r] = Q.LO.box(a[t], {})), e), {});
                              return (
                                "real" === r &&
                                  l.subscribe(
                                    (0, Q.aD)((e) => {
