(() => {
  ...
  var __webpack_modules__ = {
      528: (u, e, t) => {
        ...
        const au = Object.keys(R).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === R[e]), u),
            {},
          ),
          su = {
            set: (u, e) => {
      ...
      691: (u, e, t) => {
        ...
        const P = 1e3,
          ...
          O = 3600,
          x = 86400,
          k = (Date.now(), y.Ew.getRegionalDateTime);
              ...
              (0, s.useEffect)(() => {
                if (u > 0) {
                  ...
                  const r = Date.now(),
                    a = setInterval(
                      () => {
                        const e = u - Math.floor((Date.now() - r) / P);
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                s = a.reduce((u, [e, t]) => ((u[t] = cu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, cu.aD)((u) => {
            ...
            const b = (0, s.useRef)({
              ...
              h = (0, s.useCallback)(() => {
                (b.current.isVisible && b.current.timeoutId) ||
                  (Su(t, D, { isMouseEvent: !0, on: !0, arguments: Pu(n) }, f),
                  C && C(),
        ...
        const $u = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            const r = e.contentId;
            return r
              ? o().createElement(Ou, Gu({}, e, { contentId: r }), n)
              ...
              o().createElement(
                ...
                o().createElement(
                  ...
                  l &&
                    o().createElement(
                      "div",
                      { className: r()(zu.title, null == c ? void 0 : c.title) },
                      l,
                    ),
                ),
              ),
        ...
        const _e = "ProgressBarDeltaGrow_base_f4d46",
          ...
          be = (0, s.memo)(
            ({
              ...
              const b = (0, s.useMemo)(
                  () => Object.assign({ width: "100%" }, pe(u), Ce(c)),
                  [c, u],
                ),
                f = (0, s.useMemo)(() => Object.assign({ width: "0%" }, pe(u), Ce(c)), [c, u]),
                h = (0, s.useMemo)(
                  () => Object.assign({ width: "0%" }, ge(c, n), pe(u)),
                  [n, c, u],
                ),
                v = (0, s.useMemo)(
        ...
        const Pe = (0, s.memo)((u) => {
            ...
            switch (n.animationSettings.type) {
              case oe.Simple:
                return o().createElement(Te, ye({}, n, { onEndAnimation: l, isComplete: a }));
              case oe.Growing:
                return o().createElement(fe, ye({}, n, { onEndAnimation: l, isComplete: a }));
              default:
                return null;
            }
          }),
        ...
        const Me = (0, s.memo)(
            ({
              ...
              return s.withStack
                ...
                : o().createElement(Pe, Ne({ key: `${r}-${e}-${a}` }, A));
            },
          ),
          Ie = (u) => {
        ...
        const $e = {
          ...
          Ze = (0, D.Pi)(() => {
            ...
            return o().createElement(
              ...
              o().createElement(U, {
                text: s.$dyn("conditions").$dyn("description"),
                classMix: Ye,
              }),
