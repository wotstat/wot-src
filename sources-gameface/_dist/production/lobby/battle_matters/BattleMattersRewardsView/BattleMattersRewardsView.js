  ...
  var __webpack_modules__ = {
      ...
      528: (u, e, t) => {
        ...
        const g = {
          ...
          b = { play: Object.assign({}, v, { sound: _ }), setRTPC: m };
        var w = t(308);
        function f(u, e, t = 1) {
        ...
        const Eu = { view: i, client: a, sound: b, intl: h };
      },
      20: (u, e, t) => {
        "use strict";
        t.d(e, { n: () => n });
      ...
      833: (u, e, t) => {
        ...
        const v = {
          ...
          f = (u) => {
            ...
            const r = g(),
              ...
              s = r.mediaHeight,
              o = r.mediaSize;
            return a().createElement("div", p({ className: F()(t, v[i], b[s], w[o]) }, n), e);
          },
          T = ["children"];
        const x = (u) => {
          let e = u.children,
        ...
        const L = (u) => {
            ...
            return a().createElement(
              ...
              r &&
                a().createElement(
                  "div",
                  { className: F()(M.goto, null == s ? void 0 : s.goto) },
                  r,
                ),
            );
          },
          ...
          q = ({ isBlurred: u, children: e, onLoaded: t }) => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement(
                  "div",
                  { className: W, style: { backgroundImage: `url(${r})` } },
                  e,
                ),
              )
            );
            ...
            [Symbol.iterator]() {
              ...
              return {
                next: function () {
                  ...
                  const e = u[n++];
                  return e ? { value: bu(e), done: !1 } : { done: !0, value: null };
                },
              };
            },
          };
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = l(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = gu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, gu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                r = Object.entries(a),
                                i = r.reduce((u, [e, t]) => ((u[t] = gu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, gu.aD)((u) => {
            ...
            ({ observableModel: u }) => {
              ...
              return Object.assign({}, e.primitives, {
                ...
                computes: {
                  ...
                  isLightVisible: (0, Tu.Om)(
                    () => ![Fu.Regular].includes(e.primitives.state.get()),
                  ),
                },
              });
            },
            ...
            const p = (0, n.useRef)({
              ...
              b = (0, n.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (we(t, F, { isMouseEvent: !0, on: !0, arguments: be(a) }, v),
                  C && C(),
        ...
        const Le = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            const r = e.contentId;
            return r
              ? a().createElement(fe, Pe({}, e, { contentId: r }), n)
              : a().createElement(xe, e, n);
          },
          ke = {
              ...
              a().createElement(
                ...
                a().createElement(
                  ...
                  o &&
                    a().createElement(
                      "div",
                      { className: F()(ke.title, null == c ? void 0 : c.title) },
                      o,
                    ),
                ),
              ),
                  ...
                  a().createElement(
                    ...
                    a().createElement(
                      ...
                      r.map((e, t) =>
                        a().createElement(
                          Ge,
                          { key: e.index, index: t, onEnd: () => t + 1 === r.length && u(!0) },
                          a().createElement(
                            "div",
                            { className: Ct },
                            a().createElement(Ie, gt({}, e, { size: i, image: e.image(i) })),
                          ),
                        ),
                      ),
                    ),
          ...
          vt = (0, H.Pi)(() => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement("div", { className: Pu }, a().createElement(pe, null)),
        ...
        engine.whenReady.then(() => {
          S().render(
            a().createElement(Su, null, a().createElement(x, null, a().createElement(vt, null))),
