              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (i(), window.removeEventListener(n, s), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      525: (u, e, t) => {
          ...
          K = ({ isBlurred: u, children: e, onLoaded: t }) => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement(
                  "div",
                  { className: Y, style: { backgroundImage: `url(${n})` } },
                  e,
                ),
              )
            );
            ...
            ({ observableModel: u }) => {
              ...
              return Object.assign({}, e.primitives, {
                ...
                computes: {
                  ...
                  isLightVisible: (0, ku.Om)(
                    () => ![pu.Regular].includes(e.primitives.state.get()),
                  ),
                },
              });
            },
        ...
        const it = {
          ...
          lt = tt((u) => {
            ...
            return a().createElement(
              "div",
              nt({ className: g()(rt.base, ...W, e), style: G }, H),
              I,
            );
          });
        var Et = t(532),
        ...
        const Ut = {
          ...
          $t = (0, z.Pi)(({ setMainRewardsShowed: u }) => {
            const e = Gu().model,
              ...
              i = Ut[t][n.length - 1],
              s = Gt[t][r.length - 1];
            return e.state.get() === pu.Token ||
              (e.state.get() === pu.Final && e.computes.getToken())
              ? a().createElement(
                  qe,
                  { delay: Wt, onEnd: () => u(!0) },
                  ...
                  a().createElement(
                    ...
                    a().createElement(
                      ...
                      n.map((e, t) =>
                        a().createElement(
                          qe,
                          { key: e.index, index: t, onEnd: () => t + 1 === n.length && u(!0) },
                          a().createElement(
                            "div",
                            { className: er },
                            a().createElement(We, tr({}, e, { size: i, image: e.image(i) })),
                          ),
                        ),
                      ),
                    ),
