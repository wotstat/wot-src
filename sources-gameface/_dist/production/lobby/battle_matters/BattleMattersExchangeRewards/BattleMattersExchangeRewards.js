              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (E(), window.removeEventListener(a, i), (u.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(t)),
      ...
      248: (u, e, t) => {
        ...
        const U = (u) => {
          ...
          return n().createElement(
            ...
            a &&
              n().createElement("div", { className: B()(W.goto, null == i ? void 0 : i.goto) }, a),
          );
        };
        var G = t(20);
        t(828);
                      ...
                      s = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = F(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = ou.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, ou.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                E = a.reduce((u, [e, t]) => ((u[t] = ou.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, ou.aD)((u) => {
        ...
        const Su = (0, eu.Pi)(() => {
          const u = Cu(),
            ...
            E = a[0],
            i = a[1],
            A = R.images.gui.maps.shop.vehicles.c_180x135.$dyn(
              e.vehicleName.get().replace(/-/g, "_"),
            );
          return (
