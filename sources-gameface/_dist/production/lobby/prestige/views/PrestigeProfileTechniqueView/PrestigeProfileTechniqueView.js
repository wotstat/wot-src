                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = l(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = T.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, T.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                i = a.reduce((u, [e, t]) => ((u[t] = T.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, T.aD)((u) => {
        ...
        const Tu = "ProgressBarDeltaGrow_base_f4d46",
          ...
          Wu = (0, r.memo)(
            ({
              ...
              const b = (0, r.useMemo)(
                  () => Object.assign({ width: "100%" }, Nu(u), ku(A)),
                  [A, u],
                ),
                p = (0, r.useMemo)(() => Object.assign({ width: "0%" }, Nu(u), ku(A)), [A, u]),
                f = (0, r.useMemo)(
                  () => Object.assign({ width: "0%" }, Iu(A, a), Nu(u)),
                  [a, A, u],
                ),
                w = (0, r.useMemo)(
          ...
          ue = (u) => {
            ...
            return {
              ...
              "--progress-glow-mixBlendMode":
                null != (C = null == (_ = u.glowSettings) ? void 0 : _.mixBlendMode)
                  ? C
                  : "lighten",
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: fe },
                  R.strings.prestige.profile.max.header(),
                ),
                n().createElement(
                  "div",
                  { className: we },
