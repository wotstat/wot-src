  ...
  var __webpack_modules__ = {
          ...
          C = ({ emblem: u, size: e, showLevel: t = !0, isTooltipEnabled: n = !1 }) => {
            ...
            return i().createElement(
              ...
              i().createElement(
                ...
                E && i().createElement(d, { label: u.level.toString(), type: u.type, size: e }),
              ),
            );
          };
      },
      ...
      964: (u, e, t) => {
        ...
        const Au = (0, o.memo)(
          ...
          Fu = (u) => {
            var e, t, n, r, a, o, s, i, E, A, F, l, D, d, c, B, C, m, _, g;
            return {
              ...
              "--progress-glow-mixBlendMode":
                null != (_ = null == (g = u.glowSettings) ? void 0 : g.mixBlendMode)
                  ? _
                  : "lighten",
        ...
        const Pu = ((u, e) => {
            ...
            return [
              function ({ mode: n = "real", options: r, children: i, mocks: E }) {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                o = a.reduce((u, [e, t]) => ((u[t] = fu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, fu.aD)((u) => {
                ...
                return (
                  (0, o.useEffect)(() => {
                    l.current ? m(F(d, r, E)) : (l.current = !0);
                  }, [E, d, r]),
                  (0, o.useEffect)(() => {
                    c(n);
                  }, [n]),
