              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (o(), window.removeEventListener(n, s), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      5905: (u, e, t) => {
        ...
        const Su = ((u, e) => {
                      ...
                      F = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = E(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = Cu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Cu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                i = n.reduce((u, [e, t]) => ((u[t] = Cu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Cu.aD)((u) => {
            ...
            return Object.assign({}, e, {
              computes: {
                getChapters: t,
                isAllChaptersCompleted: r,
                isPostProgressionCompleted: a,
              },
            });
          }, _u),
          Tu = Su[0],
        ...
        const ju = "ProgressBarDeltaSimple_base_6c",
          ...
          Ju = (0, i.memo)(
            ({
              ...
              const p = (0, i.useMemo)(
                  () => Object.assign({ width: "100%" }, Qu(u), qu(F)),
                  [F, u],
                ),
                b = (0, i.useMemo)(() => Object.assign({ width: "0%" }, Qu(u), qu(F)), [F, u]),
                f = (0, i.useMemo)(
                  () => Object.assign({ width: "0%" }, Zu(F, r), Qu(u)),
                  [r, F, u],
                ),
                v = (0, i.useMemo)(
            ...
            u.hours > 0
              ...
              : u.minutes > 0
                ? o().createElement(Du, {
                    text: ze.min(),
                    format: {
                      binding: { min: o().createElement(Du, { text: u.minutes.toString() }) },
                    },
                  })
                          ...
                          format: {
                            binding: {
                              vehicleInfo: o().createElement(Du, {
                                ...
                                format: { binding: { nation: m, minLvl: pe(F), maxLvl: pe(D) } },
                              }),
                            },
                          },
                        }),
                ...
                o().createElement(
                  ...
                  o().createElement(
                    ...
                    o().createElement(Du, {
                      ...
                      format: {
                        binding: {
                          completed: o().createElement(Du, { className: Me, text: s.toString() }),
