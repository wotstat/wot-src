(() => {
              ...
              (e[A] = (function (e) {
                return (A) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (r(), window.removeEventListener(t, n), (u.listeners -= 1), F(), (E = !1));
                    }
                  );
                };
              })(A)),
                  ...
                  e.split("\n").map((e, t) =>
                    r().createElement(
                      ...
                      ((u, e, A) =>
                        ...
                        F,
                        u,
                      ).map((u, e) => r().createElement(D.Fragment, { key: `${e}-${u}` }, u)),
                    ),
                  ),
                ),
          T = {
                      ...
                      i = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const F = o(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = L.LO.box(F[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, L.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                t = Object.entries(E),
                                D = t.reduce((u, [e, A]) => ((u[A] = L.LO.box(F[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, L.aD)((u) => {
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, A, F) => {
      ...
      F = F || 0;
      for (var n = deferred.length; n > 0 && deferred[n - 1][2] > F; n--)
