      ...
      6029: (e, u, t) => {
        ...
        const ae = {
          ...
          se = ue((e) => {
            ...
            return o().createElement(
              "div",
              re({ className: p()(te.base, ...G, u), style: V }, I),
              H,
            );
          });
        let le;
        ...
        const bu = ((e, u) => {
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = hu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, hu.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                o = a.reduce((e, [u, t]) => ((e[t] = hu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, hu.aD)((e) => {
            ...
            ({ observableModel: e }) => {
              const u = {
                ...
                r = (0, vu.Om)(() => t().find((e) => e.vehicleCD === n()) || t()[0], {
                  equals: gu,
                });
            ...
            ({ externalModel: e }) => ({
              ...
              showVehiclePreview: e.createCallback(
                (e) => ({ vehicleCD: e }),
        ...
        const _t = (e) => {
          ...
          mt = {
            ...
            getChunkPath: () =>
              "R.images.gui.maps.icons.early_access.widgets.tokens_hover_sequence",
          },
          dt = {
            width: 367,
            height: 192,
            ...
            chunk: { count: 1, rows: 3, columns: 4 },
            getChunkPath: () =>
              "R.images.gui.maps.icons.early_access.widgets.tokens_hover_sequence_large",
          },
          At = {
            width: 270,
            height: 233,
            ...
            chunk: { count: 1, rows: 3, columns: 4 },
            getChunkPath: () =>
              "R.images.gui.maps.icons.early_access.widgets.quests_hover_sequence",
          },
          Ft = {
            width: 221,
            height: 77,
            ...
            getChunkPath: () =>
              "R.images.gui.maps.icons.early_access.widgets.quests_cycle_hover_sequence",
          },
          Dt = {
            width: 345,
            height: 295,
            ...
            chunk: { count: 1, rows: 3, columns: 4 },
            getChunkPath: () =>
              "R.images.gui.maps.icons.early_access.widgets.quests_hover_sequence_large",
          },
          Ct = {
            width: 283,
            height: 98,
            ...
            e.hours > 0
              ...
              : e.minutes > 0
                ? o().createElement(Le, {
                    text: kt.min(),
                    format: {
                      binding: { min: o().createElement(Le, { text: e.minutes.toString() }) },
                    },
                  })
        ...
        const ln = {
          ...
          vn = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Bn, onDrag: n = pn }) => {
        ...
        const xn = cn({
          ...
          Gn = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = In, onDrag: n = On }) => {
              const r = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                s = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
