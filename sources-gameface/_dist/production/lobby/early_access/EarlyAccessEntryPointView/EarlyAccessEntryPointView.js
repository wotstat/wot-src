  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (i(), window.removeEventListener(a, A), (u.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(t)),
      ...
      9825: (u, e, t) => {
                      ...
                      C = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = s(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = F.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, F.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                E = a.reduce((u, [e, t]) => ((u[t] = F.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, F.aD)((u) => {
        ...
        const ru = {
          ...
          Eu = J((u) => {
            ...
            return n().createElement(
              "div",
              tu({ className: m()(uu.base, ...U, e), style: G }, I),
              H,
            );
          });
        let iu;
        ...
        const Nu = {
          ...
          getChunkPath: () =>
            "R.images.gui.maps.icons.early_access.entry_point.flag_hover_sequence",
        };
        var Hu = t(4179);
        const Iu = [
          "children",
        ...
        const Ee = ({ isFirstEnter: u, progressionLevel: e, state: t, onClick: a }) => {
            ...
            return n().createElement(
              ...
              _(
                (u, e) =>
                  e &&
                  n().createElement(ku.animated.div, { className: m()(Yu, l && Zu), style: u }),
              ),
              !l &&
                n().createElement(f, {
                  width: Nu.width,
