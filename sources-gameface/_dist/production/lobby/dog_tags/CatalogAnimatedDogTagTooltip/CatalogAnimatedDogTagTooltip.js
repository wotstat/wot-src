  ...
  var u,
    e = {
      744: (u, e, t) => {
        ...
        var F = {};
        (t.r(F), t.d(F, { getBgUrl: () => k, getTextureUrl: () => S }));
        var E = {};
        (t.r(E),
          t.d(E, {
            addModelObserver: () => V,
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (E(), window.removeEventListener(F, r), (u.listeners -= 1), A(), (n = !1));
                    }
                  );
                };
              })(t)),
        ...
        function T(u) {
          let e = "";
          for (let t = x.length - 1; t >= 0; t--) for (; u >= x[t];) ((e += w[t]), (u -= x[t]));
          return e;
        }
        ...
        const lu = { view: E, client: n, sound: y, intl: b };
        var cu = t(363),
          du = t.n(cu);
        const mu = (u) => {
            (0, cu.useEffect)(u, []);
        ...
        const vu = du().forwardRef(function (u, e) {
          ...
          return (
            ...
            du().createElement(
              "div",
              pu({}, E, {
                className: a()(gu.base, gu[`base__theme-${F}`], A),
                ref: function (u) {
          ...
          Ru = (u, e = yu.left) => {
            ...
            return ((u, e = yu.left) => {
              ...
              const A =
                ...
                n = xu(u);
              return (ku(n, /( )/, e).forEach((u) => (t = t.concat(ku(u, A, yu.left)))), t);
            })(u, e);
          };
        var Mu = t(41),
          zu = t(374);
        ...
        const Wu = (0, cu.forwardRef)(function (u, e) {
            ...
            return (
              ...
              (0, cu.useEffect)(() => {
                if (s && C.current) {
                          ...
                          if (C.current) {
                            ...
                            if (
                              (e !== A &&
                                ...
                                (e = A)),
                              C.current.paused || !s || !D)
                            )
                              return;
                            const F = C.current.cohGetKeyframeTimestamps
                            ...
                            F.forEach((e, t) => {
                              void 0 !== F[t] &&
                                ...
                                u.changeKeyframeHandlers.forEach((u) => {
                                  ...
                                  return u({ time: e, name: `${o ? A : `Point_${t}`}` });
                                });
                            });
                          }
                        }),
                  ...
                  const t = (e) => (
                    ...
                    E = (u) => {
                      ...
                      C.current &&
                        (C.current.currentTime =
                          ((e = 0), (t = C.current.duration), (A = u) < e ? e : A > t ? t : A));
                    },
                    r = () => {
                      var u;
                    ...
                    i = () => {
                      var u;
                      return null != (u = C.current) && u.cohGetKeyframeTimestamps
                        ? C.current.cohGetKeyframeTimestamps()
                        : [];
                    },
                    l = (u) => {
              ...
              (0, cu.useEffect)(() => {
                C.current && F && C.current.play();
              }, [F, a]),
              (l = () => {
                var u;
                null == (u = C.current) || u.pause();
              }),
              (0, cu.useEffect)(() => l, []),
              du().createElement(
                "video",
                Iu({ src: t, className: A, style: E, loop: a, ref: C, onClick: B }, i),
              )
            );
          }),
          Hu = (0, cu.memo)(Wu);
        ...
        const Xu = ({
            ...
            return du().createElement(
              ...
              du().createElement("div", {
                className: Vu,
                style: {
                  backgroundImage: `url(R.images.gui.maps.icons.dogtags.${t}.engravings.engraving_${e}_${A}${F})`,
                },
              }),
            );
          },
        ...
        const Fe = { duration: 500, easing: Ju.easeOutBack },
          Ee = {
            [ne.ExtraSmall]: ee.ExtraSmall,
            [ne.Small]: ee.Small,
            [ne.Medium]: ee.Medium,
            [ne.Large]: ee.Large,
          },
          ...
          De = ({
            ...
            const d = (0, zu.useSpring)(() => ({ from: { opacity: 0 }, config: Fe }), [A]),
              m = d[0],
              g = d[1],
              f = (0, zu.useSpring)(() => ({
              ...
              A !== Ae.Static &&
                ...
                du().createElement(
                  ...
                  du().createElement(Hu, {
                    ...
                    className: Zu.video,
                    onEnded: _,
                    isPrebufferKeyframes: Boolean(C.length),
                    src: c,
                  }),
                ),
              du().createElement(Xu, {
          ...
          ce = (0, cu.memo)(({ text: u, binding: e, classMix: t }) => {
            ...
            return du().createElement(Be, { text: E, classMix: t, binding: n });
          });
        var de = t(305);
        function me(u, e) {
        ...
        const pe = ((u, e) => {
            ...
            return [
              function ({ mode: A = "real", options: n, children: F, mocks: E }) {
                const r = (0, cu.useRef)([]),
                  a = (t, A, n) => {
                    var F;
                    const E = (function ({
                        ...
                        return {
                          ...
                          dispose: function () {
                            for (var u, t = me(n.keys()); !(u = t()).done;) F(u.value, e);
                          },
                          unsubscribe: F,
                        };
                      })(A),
                      a =
                        "real" === t
                          ...
                          : Object.assign({}, E, {
                              readByPath:
                                null != (F = null == n ? void 0 : n.getter) ? F : () => {},
                            }),
                      D = (u) =>
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = D(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = de.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, de.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                F = Object.entries(n),
                                E = F.reduce((u, [e, t]) => ((u[t] = de.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, de.aD)((u) => {
                    ...
                    return {
                      model: B,
                      controls: "mocks" === t && n ? n.controls(i) : e(i),
                      externalModel: a,
                      mode: t,
                    };
                  },
                  ...
                  B = o[0],
                  i = o[1],
                  s = (0, cu.useState)(() => a(A, n, E)),
                  C = s[0],
                  l = s[1];
                return (
                  (0, cu.useEffect)(() => {
                    D.current ? l(a(B, n, E)) : (D.current = !0);
                  }, [E, B, n]),
                  (0, cu.useEffect)(() => {
                    i(A);
                  }, [A]),
                  ...
                  du().createElement(t.Provider, { value: C }, F)
                );
              },
              () => (0, cu.useContext)(t),
            ];
          ...
          ze = (0, Mu.Pi)(() => {
            const u = be().model,
              ...
              F = u.engraving.get(),
              E = u.background.get(),
              r = R.strings.dogtags.component.engraving.coupled.$num(F.id);
            return du().createElement(
              "div",
              { className: he },
                ...
                F.isLocked
                  ? du().createElement(
                      ...
                      du().createElement(ce, {
                        ...
                        binding: { stage: t, requiredItemsCount: A, itemsLeft: n },
                      }),
                    )
                  : du().createElement(
                      du().Fragment,
        ...
        engine.whenReady.then(() => {
          hu().render(
            du().createElement(
              ve,
              null,
              du().createElement(vu, null, du().createElement(ze, null)),
            ),
    ...
    (A.O = (e, t, n, F) => {
      if (!t) {
        ...
        for (o = 0; o < u.length; o++) {
          for (var [t, n, F] = u[o], r = !0, a = 0; a < t.length; a++)
      ...
      F = F || 0;
      for (var o = u.length; o > 0 && u[o - 1][2] > F; o--) u[o] = u[o - 1];
      u[o] = [t, n, F];
    }),
    (A.n = (u) => {
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); D < E.length; D++)
            ((F = E[D]), A.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
          return A.O(o);
        },
        t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
    })());
  var n = A.O(void 0, [994], () => A(744));
  n = A.O(n);
})();
