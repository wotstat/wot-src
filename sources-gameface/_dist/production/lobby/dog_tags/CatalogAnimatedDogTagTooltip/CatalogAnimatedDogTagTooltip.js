              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (E(), window.removeEventListener(n, r), (u.listeners -= 1), A(), (F = !1));
                    }
                  );
                };
              })(t)),
                  ...
                  const t = (e) => (
                    ...
                    E = (u) => {
                      ...
                      s.current &&
                        (s.current.currentTime =
                          ((e = 0), (t = s.current.duration), (A = u) < e ? e : A > t ? t : A));
                    },
                    r = () => {
                      var u;
                    ...
                    m = (u, e) => {
                      ...
                      return (
                        ...
                        () => {
                          var t;
                          return null == (t = s.current) ? void 0 : t.removeEventListener(u, e);
                        }
                      );
                    },
                    g = (u, e) => {
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = D(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = de.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, de.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                n = Object.entries(F),
                                E = n.reduce((u, [e, t]) => ((u[t] = de.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  a.subscribe(
                                    (0, de.aD)((u) => {
