  ...
  var u,
    A = {
      442: (u, A, F) => {
        ...
        var D = {};
        (F.r(D), F.d(D, { getBgUrl: () => T, getTextureUrl: () => S }));
        var B = {};
        (F.r(B),
          F.d(B, {
            addModelObserver: () => q,
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, A) => {
                            const e = C(A);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, A) => ((u[A] = qu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  n.subscribe(
                                    (0, qu.aD)((A) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                B = D.reduce((u, [A, F]) => ((u[F] = qu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  n.subscribe(
                                    (0, qu.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          bu().render(
            du().createElement(
              Ju,
              null,
              du().createElement(mu, null, du().createElement(EA, null)),
            ),
