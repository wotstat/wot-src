              ...
              (e[A] = (function (e) {
                return (A) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(t, D), (u.listeners -= 1), E(), (F = !1));
                    }
                  );
                };
              })(A)),
                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const E = a(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = r.LO.box(E[e], {})), u), {});
                              return (
                                "real" === A &&
                                  i.subscribe(
                                    (0, r.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                t = Object.entries(F),
                                n = t.reduce((u, [e, A]) => ((u[A] = r.LO.box(E[e], {})), u), {});
                              return (
                                "real" === A &&
                                  i.subscribe(
                                    (0, r.aD)((u) => {
              ...
              : F().createElement(
                  ...
                  e.split("\n").map((e, n) =>
                    F().createElement(
                      ...
                      ((u, e, A) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : y(u, e))))(
                        e,
                        t,
                        u,
