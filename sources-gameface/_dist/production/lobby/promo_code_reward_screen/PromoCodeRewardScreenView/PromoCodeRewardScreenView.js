(() => {
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (s(), window.removeEventListener(r, i), (u.listeners -= 1), a(), (n = !1));
                    }
                  );
                };
              })(t)),
      ...
      539: (u, e, t) => {
        ...
        const y = {
          ...
          O = (u) => {
            ...
            const r = f(),
              ...
              i = r.mediaHeight,
              o = r.mediaSize;
            return n().createElement("div", M({ className: p()(t, y[s], L[i], P[o]) }, a), e);
          },
          N = ["children"];
        const k = (u) => {
          let e = u.children,
        ...
        let tu, au, nu, ru, su, iu, ou, lu, cu;
        (!(function (u) {
          ((u.Items = "items"),
        ...
        const Eu = 1e3,
          ...
          Fu = {
            ...
            getChunkPath:
              ((Du = "R.images.gui_lootboxes.gui.maps.openBox.sprite_"), (u) => `${Du}${u}`),
          };
        var Du,
          Bu = t(364);
          ...
          Su = (u, e = nu.Small) => {
            ...
            switch (t) {
              ...
              case tu.LbStyleProgress:
                return Tu(r, e, cu.ProgressionStyle);
              default:
        ...
        const Lu = (u, e, t) => {
          ...
          Ou = (u, e, t = Mu.left) => u.split(e).reduce(t === Mu.left ? Lu : Pu, []),
          Nu = (() => {
            const u = new RegExp(
            ...
            return ku.includes(t)
              ...
              : ((u, e = Mu.left) => {
                  ...
                  const a =
                    ...
                    n = u.replace(/&nbsp;/g, " ");
                  return (Ou(n, /( )/, e).forEach((u) => (t = t.concat(Ou(u, a, Mu.left)))), t);
                })(u, e);
          },
          Hu = (u) => 900 + 200 * u,
          Uu = (u, e, t = 1e3) =>
          ...
          Gu = (u, e = !1) => {
            const t = ((u, e, t) => (t && u === tu.PremiumPlus ? "universal" : e))(
              u.name,
              u.value,
              e,
            );
          ...
          Wu = ((u, e) => {
                      ...
                      _ = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const a = l(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = H.LO.box(a[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, H.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                r = Object.entries(n),
                                s = r.reduce((u, [e, t]) => ((u[t] = H.LO.box(a[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, H.aD)((u) => {
            ...
            ({ observableModel: u }) => {
              const e = {
                ...
                t = (0, X.Om)(() => $(e.mainRewards.get(), (u) => Gu(u)), { equals: I }),
                a = (0, X.Om)(() => $(e.rewards.get(), (u) => Gu(u)), { equals: I }),
                n = (0, X.Om)(() => $(e.questRewards.get(), (u) => Gu(u, !0)), { equals: I }),
                ...
                E = (0, X.Om)(() => 200 * t().length + _u, { equals: I }),
                _ = (0, X.Om)(
                  () => {
                    const u = c() > 0 ? _u : 0;
                    return E() + 200 * c() + u;
        ...
        class Ku extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              m = p()(zu.base, zu[`base__${s}`], zu[`base__${r}`], null == i ? void 0 : i.base),
              A = p()(zu.icon, zu[`icon__${s}`], zu[`icon__${r}`], null == i ? void 0 : i.icon),
              d = p()(zu.glow, null == i ? void 0 : i.glow),
              F = p()(zu.caption, zu[`caption__${s}`], null == i ? void 0 : i.caption),
              D = p()(zu.goto, null == i ? void 0 : i.goto);
        ...
        const oe = {
          ...
          Ee = ne((u) => {
            ...
            const U = (0, a.useMemo)(() => {
              ...
              }, [t, r, o, c, _, A, k, N, R, B, y, x, f]),
              G = U.computedStyle,
              W = U.computedClassNames;
            return n().createElement(
              "div",
              ie({ className: p()(re.base, ...W, e), style: G }, H),
              I,
            );
          }),
          _e = "FormatText_base_d0",
          me = ({ binding: u, text: e = "", classMix: t, alignment: r = Mu.left }) =>
            null === e
              ...
              Be(
                {
                  ...
                  mr: !0 === E ? ve[t || "paragraph-P16"].mr : E,
        ...
        const Oe = ({
          ...
          const F = (0, a.useRef)(null),
            ...
            k = p()(ye.state, ye.state__default);
          return (
            (0, a.useEffect)(
              () => (
            ...
            const p = (0, a.useRef)({
              ...
              v = (0, a.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (Xe(t, A, { isMouseEvent: !0, on: !0, arguments: $e(n) }, b),
                  C && C(),
        ...
        const ot = ["ko", "no"].includes(R.strings.settings.LANGUAGE_CODE()),
          ...
          At = n().memo(
            ({
              ...
              const l = p()(ct.base, ct[`base__${i}`], ct[`base__${o}`]),
                c = p()(ct.nation, ct[`nation__${a}`]),
                E = p()(ct.type, u && ct.type__elite, ct[`type__${yu(r)}`]),
                _ = u ? "_elite" : "";
              return n().createElement(
                "div",
                { className: l },
                ...
                n().createElement(xe, { className: ct.level, text: lt(s) }),
                n().createElement("div", {
                  className: E,
                  style: { backgroundImage: `url(${mt}.vehicleTypes.big.${yu(r)}${_})` },
                }),
          ...
          Ft = (0, a.memo)(
            ({ compensatedBonusType: u, compensatedItem: e, value: t, valueType: a }) => {
              const r = Ru(t, a);
              return n().createElement(
                "div",
                { className: dt.base },
              ...
              return n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement(
                    ...
                    n().createElement("div", { className: pt.label }, E),
                    u.isRent &&
                      n().createElement(
                        "div",
                        { className: pt.tip },
        ...
        const ft = (0, a.memo)(
            ({
              ...
              return n().createElement(
                ...
                E ? n().createElement(rt, { index: u, delay: e }, F) : F),
              );
              var F;
            },
          ),
          ...
          Mt = (0, a.memo)(
            ({
              ...
              const c = f().mediaSize,
                ...
                m = _ ? u.slice(0, e - 1) : u,
                A = (0, a.useMemo)(
                  () => (_ ? `R.images.gui.maps.icons.quests.bonuses.${E}.default` : ""),
                  [E, _],
                ),
                d = _
          ...
          Wt = "QuestRewards_info_9a",
          $t = "QuestRewards_rewards_2a",
          ...
          zt = "Content_base__withQuests_49",
          Vt = "Content_base__extendedWithQuests_2f",
          ...
          ia = (0, qu.Pi)(() => {
            const u = Xu().model,
              ...
              E = f().mediaSize,
              _ = e.length && mu[e.length] ? mu[e.length][E] : [],
              m = (0, ju.useSpring)({
        ...
        function ca(u = oa.n.NONE, e = la, t = !1) {
          (0, a.useEffect)(() => {
            if (u !== oa.n.NONE)
              return (
          ...
          Ca = (0, qu.Pi)(() => {
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(Ge, { animationDuration: Eu }),
              ),
            );
          });
        engine.whenReady.then(() => {
          s().render(
            n().createElement($u, null, n().createElement(k, null, n().createElement(Ca, null))),
