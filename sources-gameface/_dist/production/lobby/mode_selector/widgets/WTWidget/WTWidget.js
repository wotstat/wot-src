  ...
  var __webpack_modules__ = {
      ...
      4322: (u, e, t) => {
        ...
        const l = ["xl", "lg", "md", "sm", "xs"],
          ...
          F = [o.cJ.ExtraLarge, o.cJ.Large, o.cJ.Medium, o.cJ.Small, o.cJ.ExtraSmall],
          D = (u, e) =>
        ...
        Object.keys(i());
        const B = {
            XL: { mt: _.mt__XL, mr: _.mr__XL, mb: _.mb__XL, ml: _.ml__XL },
            LG: { mt: _.mt__LG, mr: _.mr__LG, mb: _.mb__LG, ml: _.ml__LG },
            MDp: { mt: _.mt__MDp, mr: _.mr__MDp, mb: _.mb__MDp, ml: _.ml__MDp },
            MD: { mt: _.mt__MD, mr: _.mr__MD, mb: _.mb__MD, ml: _.ml__MD },
            SMp: { mt: _.mt__SMp, mr: _.mr__SMp, mb: _.mb__SMp, ml: _.ml__SMp },
            SM: { mt: _.mt__SM, mr: _.mr__SM, mb: _.mb__SM, ml: _.ml__SM },
            XS: { mt: _.mt__XS, mr: _.mr__XS, mb: _.mb__XS, ml: _.ml__XS },
          },
          C = (Object.keys(B), ["mt", "mr", "mb", "ml"]),
          ...
          h = c((u) => {
            let e = u.className,
              ...
              b = u.row,
              f = u.flexDirection,
              w = void 0 === f ? (p ? "column" : b && "row") || void 0 : f,
              v = u.flexStart,
              x = u.center,
              S = u.flexEnd,
              L = u.spaceBetween,
              ...
              O =
                void 0 === M
                  ? (v ? "flex-start" : x && "center") || (S && "flex-end") || void 0
                  : M,
              R = u.alignSelf,
              P = u.wrap,
              N = u.flexWrap,
              I = void 0 === N ? (P ? "wrap" : void 0) : N,
              W = u.grow,
              H = u.shrink,
              j = u.flex,
              G = void 0 === j ? (W || H ? `${W ? 1 : 0} ${H ? 1 : 0} auto` : void 0) : j,
              z = u.style,
              U = u.children,
              X = (function (u, e) {
                if (null == u) return {};
            ...
            const V = (0, s.useMemo)(() => {
              ...
              }, [t, r, o, A, D, h, z, G, R, w, I, k, O]),
              $ = V.computedStyle,
              K = V.computedClassNames;
            return E().createElement("div", d({ className: n()(_.base, ...K, e), style: $ }, X), U);
          });
        var p = t(280),
          b = t(3532),
          f = t.n(b);
        ...
        const S = Object.keys(f()),
          L = { mt: "MD", mr: "SM", mb: "SM", ml: "SM" },
          y = { mt: "SM", mr: "XS", mb: "XS", ml: "XS" },
          ...
          R = c((u) => {
            ...
            return E().createElement(
              ...
              x(
                {
                  className: n()(w.base, t && w[t], f, r),
                  style: b,
                  mt: !0 === l ? M[t || "paragraph-P16"].mt : l,
                  mr: !0 === F ? M[t || "paragraph-P16"].mr : F,
                  mb: !0 === c ? M[t || "paragraph-P16"].mb : c,
                  ml: !0 === m ? M[t || "paragraph-P16"].ml : m,
                },
                C,
              ),
              void 0 !== B ? E().createElement(p.z, x({}, B, { text: e })) : e,
            );
          });
      },
      7078: (u, e, t) => {
      ...
      8184: (u, e, t) => {
        ...
        const p = {
            [h.NBSP]: C.NoBreakSymbol,
            [h.ZWNBSP]: C.NoBreakSymbol,
            [h.NEW_LINE]: C.LineBreak,
          },
          b = {
          ...
          S = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return r
              ? b[r]
                ...
                : n().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: x(r) },
                    u,
                  )
          ...
          L = {
            ...
            [C.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              n().createElement(
                "span",
                { key: e, "data-block-type": C.NoBreakWrapper, className: f },
                u,
              ),
          },
          y = (u, e, t) => {
                ...
                (u) => {
                  ...
                  n === C.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: C.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
        ...
        (0, r.memo)(({ totalCount: u, currentProgress: e, ticketCount: t, size: r }) => {
          const a = r === V.Id.B1 || r === V.Id.B2 || r === V.Id.B3,
            l = e && u ? (100 * e) / u : 0,
            A = i()($.base, $[`base__${r}`]),
            F = i()($.emblem, e === u && $.emblem__full),
            D = i()($.checkmark, e === u && $.checkmark__visible);
          return n().createElement(
            "div",
            { className: A },
            n().createElement(
            ...
            a &&
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: $.tickets },
                  n().createElement(X.ZP, { text: R.strings.mode_selector.event.wt.tickets() }),
                  n().createElement(
                    E.u,
                    { contentId: R.views.white_tiger.lobby.tooltips.TicketTooltipView("resId") },
                    n().createElement(X.ZP, { className: $.ticketCount, text: String(t) }),
                  ),
                ),
                n().createElement(
                  "div",
                  ...
                  n().createElement(o.ko, { size: o.$u.Small, value: l, theme: s.Yy }),
                ),
              ),
          );
        });
