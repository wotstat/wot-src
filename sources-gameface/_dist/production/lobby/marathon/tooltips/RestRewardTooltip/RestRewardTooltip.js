(() => {
  ...
  var __webpack_modules__ = {
      528: (u, e, t) => {
        ...
        var o = {};
        (t.r(o), t.d(o, { getBgUrl: () => b, getTextureUrl: () => R }));
        var i = {};
        function E(u) {
          return (e) => (
            engine.on(u, e),
      ...
      466: (u, e, t) => {
            ...
            const w = (0, n.useRef)({
              ...
              h = (0, n.useCallback)(() => {
                (w.current.isVisible && w.current.timeoutId) ||
                  (b(t, D, { isMouseEvent: !0, on: !0, arguments: f(r) }, R),
                  m && m(),
        ...
        const U = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            const o = e.contentId;
            return o
              ? r().createElement(h, k({}, e, { contentId: o }), n)
              ...
              r().createElement(
                ...
                r().createElement(
                  ...
                  s &&
                    r().createElement(
                      "div",
                      { className: a()(x.title, null == m ? void 0 : m.title) },
                      s,
                    ),
                ),
              ),
              ...
              W(() => {
                if (
                  ...
                  const t = (u) => {
                    ...
                    n = Z(u);
                  c.current = J.addCallback(n, t, a, e === uu.Deep);
                }
              }),
              (0, n.useEffect)(() => {
                if (e !== uu.None)
                  return () => {
                    J.removeCallback(c.current, a);
                  };
              }, [a, e]),
              F
            );
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                r().createElement(
                  "div",
                  { className: nu },
                  R.strings.marathon.rewardTooltip.title(),
                ),
                r().createElement(
                  "div",
                  { className: ru },
