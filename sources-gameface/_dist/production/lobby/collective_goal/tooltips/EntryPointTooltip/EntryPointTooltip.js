  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      A &&
                        (r(), window.removeEventListener(E, F), (u.listeners -= 1), n(), (A = !1));
                    }
                  );
                };
              })(t)),
      ...
      463: (u, e, t) => {
                      ...
                      c = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const A = u.reduce((u, e) => ((u[e] = o.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, o.aD)((e) => {
                            ...
                            }
                            {
                              const A = u,
                                E = Object.entries(A),
                                r = E.reduce((u, [e, t]) => ((u[t] = o.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, o.aD)((u) => {
        ...
        const q = "ProgressBarDeltaSimple_base_6c",
          ...
          Eu = (0, n.memo)(
            ({
              ...
              const b = (0, n.useMemo)(
                  () => Object.assign({ width: "100%" }, Au(u), tu(D)),
                  [D, u],
                ),
                f = (0, n.useMemo)(() => Object.assign({ width: "0%" }, Au(u), tu(D)), [D, u]),
                v = (0, n.useMemo)(
                  () => Object.assign({ width: "0%" }, nu(D, E), Au(u)),
                  [E, D, u],
                ),
                h = (0, n.useMemo)(
        ...
        const Cu = (0, n.memo)(
          ...
          Nu = 1e9,
          Lu = (u, e = 1) =>
            P.Z5.getRealFormat(0.01 * Math.floor(u / (0.01 * e)), P.Gr.WO_ZERO_DIGITS),
          Iu = (u) =>
            u > Nu
          ...
          zu = (0, m.Pi)(() => {
            const u = c().model.root.get(),
              ...
              D = F > 0 ? (100 * r) / F : 0,
              s = {
                backgroundImage: `url(R.images.gui.maps.icons.collectiveGoal.goal_icons.${n})`,
              };
            return A().createElement(
              "div",
              { className: pu },
