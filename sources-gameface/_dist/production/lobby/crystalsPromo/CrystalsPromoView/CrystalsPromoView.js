          ...
          componentDidUpdate(u, e) {
            ...
            if (e.activeKey !== this.state.activeKey || r) {
              const u = this.elementsList.findIndex((u) => {
                  if (u.props[q] === Y.CONTENT)
                    return u.props[Y.TAB].includes(this.state.activeKey);
                }),
            ...
            const e = xu("model").battleTypes,
              ...
              A = a().createElement(
                ...
                a().createElement(
                  "div",
                  { className: Zu.pointsTextStyle },
                  i.marker.description.c_2(),
                ),
                a().createElement(
                  "div",
                  { className: Zu.pointsTextStyle },
                  i.marker.description.c_3(),
                ),
              ),
              c = (0, n.useMemo)(
        ...
        const Et = (0, n.memo)(ot),
          ...
          At = ({
            ...
            return a().createElement(
              ...
              a().createElement("span", {
                className: g()(lt.border, lt.borderColors, lt.border__right),
              }),
            );
          },
