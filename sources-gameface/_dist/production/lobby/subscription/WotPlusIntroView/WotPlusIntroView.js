                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                E = n.reduce((u, [e, t]) => ((u[t] = Uu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Uu.aD)((u) => {
            ...
            const u = zu().controls,
              ...
              E = {
                ...
                generalInformationContent:
                  R.strings.subscription.introView.generalInformationContent(),
                cyclesInformation: R.strings.subscription.introView.cyclesInformation(),
                cyclesInformationContent:
                  R.strings.subscription.introView.cyclesInformationContent(),
                rewardsInformation: R.strings.subscription.introView.rewardsInformation(),
                rewardsInformationContent:
                  R.strings.subscription.introView.rewardsInformationContent(),
