(() => {
  var __webpack_modules__ = {
      ...
      72: (u, e, t) => {
        ...
        const T = {
          ...
          y = (u) => {
            ...
            const a = f(),
              ...
              s = a.mediaHeight,
              o = a.mediaSize;
            return n().createElement("div", S({ className: g()(t, T[i], M[s], L[o]) }, r), e);
          },
          P = ["children"];
        const O = (u) => {
          let e = u.children,
        ...
        const iu = ((u, e) => {
            ...
            return [
              function ({ mode: a = "real", options: s, children: o, mocks: E }) {
                const l = (0, r.useRef)([]),
                  ...
                  D = c[0],
                  _ = c[1],
                  m = (0, r.useState)(() => A(a, s, E)),
                  d = m[0],
                  B = m[1];
                return (
                  (0, r.useEffect)(() => {
                    F.current ? B(A(D, s, E)) : (F.current = !0);
                  }, [E, D, s]),
                  (0, r.useEffect)(() => {
                    _(a);
                  }, [a]),
            ...
            ({ observableModel: u }) => {
              const e = { root: u.object(), mainRewards: u.array("mainRewards.items") },
                t = (0, au.Om)(() => {
                  return (
                    (u = e.mainRewards.get()),
                    (t = J),
            ...
            ({ externalModel: u }) => ({ onClosed: u.createCallbackNoArgs("onClosed") }),
          ),
          su = iu[0],
          ou = iu[1],
          Eu = "App_base_e6",
          ...
          Fu = "App_close_34",
          cu = "App_content_dd",
          Du = "App_headerWrapper_db",
          _u = "App_rewards_88",
          mu = "App_rewards__additionalCentring_1e",
          du = "App_footer_9e",
          Bu = "App_buttonWrapper_0b";
        var Cu = t(887),
          gu = t.n(Cu);
        const hu = ["xl", "lg", "md", "sm", "xs"],
          pu = (u) => u.includes("_") && ((u) => hu.includes(u))(u.split("_").at(-1)),
          bu = [b.ExtraLarge, b.Large, b.Medium, b.Small, b.ExtraSmall],
          vu = (u, e) =>
        ...
        const Tu = {
          ...
          Ru = wu((u) => {
            ...
            const G = (0, r.useMemo)(() => {
              ...
              }, [t, a, o, l, F, D, N, k, T, B, R, f, S]),
              U = G.computedStyle,
              W = G.computedClassNames;
            return n().createElement(
              "div",
              Su({ className: g()(fu.base, ...W, e), style: U }, I),
              H,
            );
          });
        let yu;
        ...
        const Pu = (u) => u.replace(/&nbsp;/g, " "),
          ...
          Nu = (u, e, t = yu.left) => u.split(e).reduce(t === yu.left ? Ou : ku, []),
          Hu = (() => {
            const u = new RegExp(
            ...
            return Iu.includes(t)
              ...
              : ((u, e = yu.left) => {
                  ...
                  const r =
                    ...
                    n = Pu(u);
                  return (Nu(n, /( )/, e).forEach((u) => (t = t.concat(Nu(u, r, yu.left)))), t);
                })(u, e);
          },
        ...
        const Yu = Object.keys($u()),
          ...
          ee = wu((u) => {
            ...
            return n().createElement(
              ...
              zu(
                {
                  className: g()(ju.base, t && ju[t], p, a),
                  style: h,
                  mt: !0 === E ? Ju[t || "paragraph-P16"].mt : E,
                  mr: !0 === A ? Ju[t || "paragraph-P16"].mr : A,
                  mb: !0 === c ? Ju[t || "paragraph-P16"].mb : c,
                  ml: !0 === _ ? Ju[t || "paragraph-P16"].ml : _,
                },
                B,
              ),
              void 0 !== d ? n().createElement(Wu, zu({}, d, { text: e })) : e,
            );
          }),
          te = "Header_base_59",
          re = "Header_title_aa",
          ne = "Header_subtitle_fa",
          ae = R.strings.stronghold,
          ie = () =>
            n().createElement(
              "div",
              { className: te },
              n().createElement(
                ...
                { className: re },
                n().createElement(ee, {
                  text: ae.selectableReward.title(),
                  format: { binding: { season: ae.season.name().toUpperCase() } },
                }),
              ),
              n().createElement(ee, {
                text: ae.selectedReward.subTitle().toUpperCase(),
                className: ne,
              }),
            ),
          se = 33,
        ...
        const ce = (0, r.memo)(function (u) {
            ...
            return (
                        ...
                        r = window.setInterval(() => {
                          ...
                          a
                            ? (null == s || s(n, a),
                              ...
                              n === c &&
                                (null == C || C(),
                                _ || (null == B || B(), window.clearInterval(r))))
              ...
              n().createElement("canvas", Fe({}, h, { width: e, height: t, ref: p }))
            );
          }),
          De = (u, e) => {
            let t = u;
        ...
        const Be = "Glow_base_2f",
          Ce = "Glow_sunShine_f4",
          ge = "Glow_sunShineCanvas_95",
          he = {
            width: 200,
            height: 200,
            frameCount: 50,
            ...
            getChunkPath:
              ((pe = "R.images.gui.maps.icons.battlePass.icons.sprite_"), (u) => `${pe}${u}`),
          };
        var pe;
        const be = () =>
          n().createElement(
            ...
            n().createElement(
              ...
              n().createElement(ce, {
                ...
                getImageSource: de(he),
                frameTime: 50,
                className: ge,
              }),
            ),
          );
        let ve, we, fe, xe, Se, Te, Me, Le, Re;
        (!(function (u) {
          ((u.Items = "items"),
        ...
        const Ue = (u, e, t = {}, r = 0) => {
            ...
            const p = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (Ue(t, D, { isMouseEvent: !0, on: !0, arguments: Ge(n) }, b),
                  C && C(),
          ...
          ze = "Reward_image_a9",
          Ye = R.strings.selectable_reward.decorator,
          Ve = (u) => (u <= b.Small ? fe.S400x300 : fe.S600x450),
          Ke = (u, e) => ({ backgroundImage: `url(${Ne(u, e)})` });
        var Qe;
        !(function (u) {
          ((u.Style2D = "style2D"), (u.Style3D = "style3D"));
        })(Qe || (Qe = {}));
        const Ze = (0, r.memo)(({ reward: u }) => {
            const e = u.tooltipContentId,
              t = u.tooltipId,
              a = u.userName,
              i = u.bigIcon,
              s = (0, r.useState)(!1),
              ...
              E = s[1],
              l = f().mediaSize,
              A = "style_3d" === i ? Qe.Style3D : Qe.Style2D,
              F = Ye.$dyn(A);
            return (
              (0, r.useEffect)(
                () =>
                ...
                n().createElement(
                  ...
                  n().createElement(
                    ...
                    n().createElement(
                      "div",
                      { className: qe },
                      n().createElement("div", { className: ze, style: Ke(u, Ve(l)) }),
                    ),
                    n().createElement(ee, {
                      text: F,
                      format: { binding: { value: Pu(a) } },
                      className: je,
                    }),
                  ),
                ),
          ...
          Je = "RewardsWidget_base_cb",
          ut = "RewardsWidget_ribbon_4b",
          et = "RewardsWidget_rays_c7",
          tt = (0, r.memo)(({ rewards: u }) => {
            const e = u[0];
            return n().createElement(
              "div",
              { className: Je },
              n().createElement(Ze, { reward: e }),
              n().createElement("div", { className: ut }),
              n().createElement("div", { className: et }),
              n().createElement(be, null),
            );
          }),
          rt = R.strings.stronghold.button,
          nt = (0, Z.Pi)(() => {
            const u = ou(),
              e = u.model,
              t = u.controls,
            ...
            const a = e.computes.getMainRewards(),
              s = r >= b.Medium,
              o = () => {
                (t.onClosed(), i.O.view.sendEvent.close());
              };
            return n().createElement(
              "div",
              { className: Eu },
              ...
              n().createElement(
                ...
                n().createElement(
                  "div",
                  { className: cu },
                  n().createElement("div", { className: Du }, n().createElement(ie, null)),
                  n().createElement(
                    "div",
                    { className: g()(_u, mu) },
                    n().createElement(tt, { rewards: a }),
                  ),
                ),
                n().createElement(
                  "div",
        ...
        engine.whenReady.then(() => {
          N().render(
            n().createElement(su, null, n().createElement(O, null, n().createElement(nt, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [276], () => __webpack_require__(72));
