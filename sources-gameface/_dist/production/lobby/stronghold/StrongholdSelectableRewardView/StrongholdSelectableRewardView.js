(() => {
  var __webpack_modules__ = {
      380: (e) => {
        ...
        ((D.prototype.eventElement = function (e) {
          ...
          return (u || ((u = new _(e)), this.eventElements.push(u)), u);
        }),
        ...
        var p = function (e, u, t, n, r, o) {
          ...
          !(function (e, u, t, n, r, o) {
            ...
            u &&
              !r &&
              (E.dispatchEvent(g("ps-scroll-" + s)),
              u < 0
                ? E.dispatchEvent(g("ps-scroll-" + c))
                : u > 0 && E.dispatchEvent(g("ps-scroll-" + d)),
              n &&
                (function (e, u) {
                  (A(e, u), m(e, u));
                })(e, s));
            e.reach[s] && (u || o) && E.dispatchEvent(g("ps-" + s + "-reach-" + e.reach[s]));
          })(e, t, i, n, r, o);
        };
            ...
            (o.contains(e.scrollbarXRail) ||
              ...
              e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
                ? ((e.scrollbarXActive = !0),
                  ...
                  (e.scrollbarXWidth = f(e, h((e.railXWidth * e.containerWidth) / e.contentWidth))),
                  (e.scrollbarXLeft = h(
              ...
              e.scrollbarXActive
                ? (o.classList.add(c.active("x")), p(e, "left", E - e.lastScrollLeft, !0, u))
              ...
              e.scrollbarYActive
                ? (o.classList.add(c.active("y")),
                  p(e, "top", o.scrollTop - e.lastScrollTop, !0, u))
          ...
          L = function (e) {
            ...
            var h = u[E],
              B = (function (e) {
                ...
                } else u = (n[a] - n.getBoundingClientRect()[r]) | 0;
                return ["left", "top"].includes(l) ? o : u - o;
              })({
                isWindow: _,
                scrollableDomEle: u,
                elementLengthProp: m,
                initialScrollPosition: h,
                isHorizontalDirection: F,
                scrollLengthProp: A,
                direction: n,
              });
            !isNaN(l) && l < B && (B = l);
                ...
                o = function () {
                  if (1 === n.buttons) {
                    if (
                      ...
                      (y({ axis: u, cursorPositionOnRail: i, direction: a, i: e }) &&
                        clearTimeout(r),
                        b(e, !1, t));
                    }
                    n.stopPropagation();
              ...
              t.addEventListener(
                ...
                function (u) {
                  1 === u.buttons &&
                    ...
                    e.event.once(e.ownerDocument, "mousedown", F),
              ...
              C().then(function () {
                ...
                ((o.scrollbarXBottom = parseInt(n.bottom, 10)),
                  isNaN(o.scrollbarXBottom)
                    ? ((o.isScrollbarXUsingBottom = !1), (o.scrollbarXTop = h(n.top)))
                    : (o.isScrollbarXUsingBottom = !0),
                  (o.railBorderXWidth = h(n.borderLeftWidth) + h(n.borderRightWidth)),
                  t(o.scrollbarXRail, { display: "block" }),
                  (o.railXMarginWidth = h(n.marginLeft) + h(n.marginRight)),
                ...
                ((o.scrollbarYRight = parseInt(r.right, 10)),
                  isNaN(o.scrollbarYRight)
                    ? ((o.isScrollbarYUsingRight = !1), (o.scrollbarYLeft = h(r.left)))
                  ...
                  (o.scrollbarYOuterWidth = o.isRtl
                    ...
                    : null),
                  (o.railBorderYWidth = h(r.borderTopWidth) + h(r.borderBottomWidth)),
                  t(o.scrollbarYRail, { display: "block" }),
                  (o.railYMarginHeight = h(r.marginTop) + h(r.marginBottom)),
                  t(o.scrollbarXRail, { display: "" }),
          ...
          (k.prototype.update = function () {
            ...
            this.isAlive &&
              ...
              (this.railXMarginWidth =
                h(u(this.scrollbarXRail).marginLeft) + h(u(this.scrollbarXRail).marginRight)),
              (this.railYMarginHeight =
                h(u(this.scrollbarYRail).marginTop) + h(u(this.scrollbarYRail).marginBottom)),
      ...
      67: (e, u, t) => {
        ...
        var o = {};
        (t.r(o), t.d(o, { getBgUrl: () => F, getTextureUrl: () => _ }));
        var i = {};
        function a(e) {
          return (u) => (
            engine.on(e, u),
      ...
      596: (e, u, t) => {
        ...
        const c = i.O.client.getSize("rem"),
          d = c.width,
          E = c.height,
          A = Object.assign({ width: d, height: E }, s(d, E, a)),
        ...
        const I = ["xl", "lg", "md", "sm", "xs"],
          X = (e) => e.includes("_") && ((e) => I.includes(e))(e.split("_").at(-1)),
          Y = [b.ExtraLarge, b.Large, b.Medium, b.Small, b.ExtraSmall],
          U = (e, u) =>
          ...
          G = (e, u = U) => {
            ...
            return r().memo((u) =>
              Object.keys(u).some((e) => X(e) && void 0 !== u[e])
                ? r().createElement(t, u)
                : r().createElement(e, u),
            );
          },
        ...
        const K = {
          ...
          Q = G((e) => {
            let u = e.className,
              ...
              F = e.row,
              D = e.flexDirection,
              h = void 0 === D ? (_ ? "column" : F && "row") || void 0 : D,
              B = e.flexStart,
              g = e.center,
              p = e.flexEnd,
              b = e.spaceBetween,
              ...
              L =
                void 0 === S
                  ? (B ? "flex-start" : g && "center") || (p && "flex-end") || void 0
                  : S,
              y = e.alignSelf,
              x = e.wrap,
              T = e.flexWrap,
            ...
            const I = (0, n.useMemo)(() => {
                const e = { mt: l, mr: c, mb: E, ml: m },
                  u = ((e) =>
                    q.reduce((u, t) => {
                      const n = e[t];
                      return n && "number" != typeof n ? u.concat(K[!0 === n ? "MD" : n][t]) : u;
                    }, []))(e),
                  n = ((e) =>
                    q.reduce((u, t) => {
                      const n = e[t];
                      return ("number" == typeof n && (u[V[t]] = n + "rem"), u);
                    }, {}))(e);
                return {
              ...
              }, [t, o, l, c, E, m, H, O, y, h, M, w, L]),
              X = I.computedStyle,
              Y = I.computedClassNames;
            return r().createElement("div", $({ className: C()(j.base, ...Y, u), style: X }, W), N);
          });
        let Z;
        function J(e, u) {
        ...
        const ee = (e) => e.replace(/&nbsp;/g, " "),
          ...
          ne = (e, u, t = Z.left) => e.split(u).reduce(t === Z.left ? ue : te, []),
          re = (() => {
            const e = new RegExp(
            ...
            return oe.includes(t)
              ...
              : ((e, u = Z.left) => {
                  ...
                  const n =
                    ...
                    r = ee(e);
                  return (ne(r, /( )/, u).forEach((e) => (t = t.concat(ne(e, n, Z.left)))), t);
                })(e, u);
          },
          ae = "FormatText_base_d0",
          le = ({ binding: e, text: u = "", classMix: t, alignment: o = Z.left }) =>
            null === u
                  ...
                  u.split("\n").map((u, i) =>
                    r().createElement(
                      ...
                      ((e, u, t) =>
                        e
                          .split(/%\((.*?)\)(?:[sd])?/g)
                          .map((e) => (t && e in t ? t[e] : ie(e, u))))(u, o, e).map((e, u) =>
        ...
        const me = Object.keys(ce()),
          ...
          ge = G((e) => {
            ...
            return r().createElement(
              ...
              Ae(
                {
                  className: C()(de.base, t && de[t], p, o),
                  style: g,
                  mt: !0 === s ? Be[t || "paragraph-P16"].mt : s,
              ...
              void 0 !== D ? r().createElement(le, Ae({}, D, { text: u })) : u,
            );
          });
        function pe(e) {
        ...
        class we extends r().PureComponent {
          ...
          render() {
            const e = this.props,
              ...
              A = C()(be.base, be[`base__${i}`], be[`base__${o}`], null == a ? void 0 : a.base),
              m = C()(be.icon, be[`icon__${i}`], be[`icon__${o}`], null == a ? void 0 : a.icon),
              _ = C()(be.glow, null == a ? void 0 : a.glow),
              F = C()(be.caption, be[`caption__${i}`], null == a ? void 0 : a.caption),
              D = C()(be.goto, null == a ? void 0 : a.goto);
            return r().createElement(
              "div",
              ve(
                {
        ...
        function xe(e = Se.n.NONE, u = ye, t = !1) {
          (0, n.useEffect)(() => {
            if (e !== Se.n.NONE)
              return (
              ...
              D(() => {
                if (
                  ...
                  const t = (e) => {
                    ...
                    n = Ne(e);
                  E.current = We.addCallback(n, t, a, u === Ie.Deep);
                }
              }),
              (0, n.useEffect)(() => {
                if (u !== Ie.None)
                  return () => {
                    We.removeCallback(E.current, a);
                  };
              }, [a, u]),
              c
            );
          },
          Ye = (Le.Sw.instance, (0, n.createContext)("model")),
          Ue = {
          ...
          const F = (0, n.useRef)(null),
            ...
            O = C()(
              ...
              Ue[`base__${o}`],
              {
                ...
                [Ue[`base__${u}`]]: u,
                [Ue.base__focus]: h,
                [Ue.base__highlightActive]: p,
                [Ue.base__firstHover]: v,
              },
              a,
            ),
            H = C()(Ue.state, Ue.state__default);
          return (
            (0, n.useEffect)(
              () => (
        ...
        const Ve = (e, u, t = {}, n = 0) => {
          ...
          Qe = (e) => {
            ...
            const p = (0, n.useRef)({
              ...
              b = (0, n.useMemo)(() => h || Re().resId, [h]),
              f = (0, n.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (Ve(t, m, { isMouseEvent: !0, on: !0, arguments: qe(r) }, b),
                  B && B(),
          ...
          Ze = "Footer_base_2b",
          Je = "Footer_description_9a",
          eu = "Footer_selectRewards_f9",
          uu = "Footer_rewardsSelected_19",
          tu = "Footer_rewardsSelectedCount_5b",
          nu = "Footer_rewardsSelectedIcon_59",
          ru = "Footer_buttons_12",
          ou = "Footer_cButton_f7",
          iu = ({ rewardsSelectedCount: e, onOkClick: u, onCloseClick: t }) => {
            const n = e > 0,
              o = w().mediaSize > b.Small ? je.medium : je.small;
            return r().createElement(
              "div",
              { className: Ze },
              r().createElement(
                ...
                n
                  ? r().createElement(
                      ...
                      r().createElement("span", { className: tu }, e),
                      r().createElement(
                        Qe,
                        {
                          contentId:
              ...
              r().createElement(
                ...
                r().createElement(
                  $e,
                  { size: o, type: Ge.primary, disabled: !n, mixClass: ou, onClick: u },
                  R.strings.selectable_reward.footer.okBtn.label(),
                ),
                r().createElement(
                  $e,
                  { size: o, type: Ge.secondary, mixClass: ou, onClick: t },
          ...
          su = (e) => {
            const u = (0, n.useState)(lu(e ? e.current : null)),
              t = u[0],
              r = u[1];
            return (
              (0, n.useEffect)(() => {
        ...
        var cu = t(380),
          du = t.n(cu);
        const Eu = "ScrollArea_base_47",
          Au = "ScrollArea_base__scrollIndent_1d",
          mu = "ScrollArea_base__verticalScrollbarMargin_50",
          _u = "ScrollArea_base__multiple_44",
          Fu = "ScrollArea_base__hidden_ec",
          Du = r().forwardRef((e, u) => {
            const t = e.offsetLeft,
              ...
              O = (0, n.useCallback)(
                (e) => {
                  w &&
                    (w.setScrollLeftImmediately(e), g && g(e, w.contentWidth - w.containerWidth));
                },
                [w, g],
              ),
              H = (0, n.useCallback)(
            ...
            ((0, n.useEffect)(
              () => (
                !w && y && $ && S(new (du())(y, Object.assign({}, l))),
                () => {
        ...
        const Hu = (e, u = xu.Small) => `R.images.gui.maps.icons.quests.bonuses.${u}.${e}_gift`,
          Nu = (e, u) => {
            const t = ((e) => {
              var u;
              const t = e.split("_")[1],
              ...
              if (n) return n;
              const r = null == (u = R.strings.artefacts.$dyn(e)) ? void 0 : u.$dyn("name");
              if (r) return ee(r);
              const o = Xu(R.strings.vehicle_customization, e);
              return o ? ee(o) : (console.error(`title for reward is not provided: ${e}`), "");
            })(e);
            if (!u) return t;
            const n = R.strings.selectable_reward.decorator.$dyn(u);
            return n ? J(n, { value: t }) : t;
          },
          Wu = (e, u = "s180x135", t = "R.images.gui.maps.icons.selectableReward.reward") =>
            `${t}.${u}.${Iu(e)}`,
          Iu = (e) => {
            const u = e.split("/"),
              t = u.pop(),
              n = "name" === t && u.length > 0 ? u.pop() : t;
            return null != n ? n : e;
          },
          Xu = (e, u, t = "/") => {
            const n = u.split(t);
        ...
        const dt = ({ type: e = ct.Plus, isEnabled: u = !0, onClick: t }) => {
          const o = (0, n.useCallback)(
            ...
            i = C()(st.base, st[`base__${e}`], !u && st.base__disabled);
        ...
        const mt = ({
            ...
            const c = (0, n.useContext)(Vt),
              d = u > 0 && t !== Su,
              E = c === qt.Accepting && d,
              A = (function (e) {
                return e.startsWith(Et.Trophy)
                  ? Et.Trophy
                  : e.startsWith(Et.Deluxe)
                    ? Et.Deluxe
                    : e.startsWith(Et.Modernized)
                      ? Et.Modernized
                      : Et.None;
              })(e),
              m = Nu(e, s),
              _ = (0, n.useCallback)(() => {
                t === vu ? (pe("bp_click"), a(e)) : t === wu && pe("bp_click_limit");
              }, [a, t, e]),
              F = (0, n.useCallback)(() => {
                t === vu && (pe("bp_click_plus"), a(e));
              }, [t, e, a]),
              D = (0, n.useCallback)(() => {
                (pe("bp_click_minus"), l(e));
              }, [e, l]),
              h = (0, n.useCallback)(() => {
                pe("bp_highlight");
              }, []),
              B = (0, n.useMemo)(
                () => ({
                  backgroundImage: `url(R.images.gui.maps.icons.selectableReward.reward.${A})`,
                }),
                [A],
              ),
              g = (0, n.useMemo)(() => ({ backgroundImage: `url(${Wu(e)})` }), [e]),
              p = (0, n.useMemo)(() => ({ maskImage: `url(${Wu(e)})` }), [e]),
              b = (0, n.useMemo)(
                () =>
                  t === wu && 0 === u
                    ? {
              ...
              v = C()(Yu, d && Uu, E && Vu, t === vu && Gu, t === Su && Ku, t === wu && qu),
              w = C()(et, o <= 0 && ut);
            return r().createElement(
              "div",
              { className: v, onClick: _, onMouseEnter: h },
              r().createElement(
                "div",
                { className: w },
              ...
              r().createElement(
                ...
                r().createElement(
                  Cu,
                  { args: f },
                  r().createElement("div", { className: $u, style: g }),
                ),
                !d && t !== vu && r().createElement("div", { className: Qu, style: p }),
                i > 1 &&
                  r().createElement(
                    "div",
                    { className: Zu },
                    J(At.packSizeCount(), { packSize: i }),
                  ),
              ),
              A !== Et.None && r().createElement("div", { className: ju, style: B }),
              r().createElement("div", { className: Ju }, m),
              d || t === vu
                ? r().createElement(
                    r().Fragment,
                    null,
                    r().createElement("span", { className: nt }, u),
                    r().createElement(
                      "div",
                      { className: rt },
                      r().createElement(dt, { type: ct.Minus, isEnabled: d, onClick: D }),
                      r().createElement(dt, { type: ct.Plus, isEnabled: t === vu, onClick: F }),
                    ),
                  )
                : r().createElement(
                    fu,
                    ...
                    r().createElement(
                      "div",
                      { className: ot },
                      r().createElement("div", { className: it }, At.$dyn(t)),
        ...
        const ft = { suppressScrollX: !0 },
            ...
            return (
              (0, n.useEffect)(
                () => (
                  ...
                  au(
                    au(() => {
                      (D(!1), null == l.current.updateScrollArea || l.current.updateScrollArea());
                    }),
                  )
                ),
                [i],
                    ...
                    r().createElement(
                      ...
                      a.map(({ value: e }, u) =>
                        r().createElement(
                          "div",
                          { key: u, className: ht },
                          r().createElement(mt, pt({}, e, { key: u, onAdd: h, onReduce: B })),
                        ),
                      ),
                    ),
                ),
                A && "start" !== c && r().createElement("div", { className: C()(Bt, Ct) }),
                A && "end" !== c && r().createElement("div", { className: C()(Bt, gt) }),
              )
            );
          },
          wt = "Category_base_23",
          St = "Category_base__viewReady_69",
          Lt = "Category_glow_a9",
          yt = "Category_base__selected_9e",
          xt = "Category_title_54",
          ...
          Nt = ({ type: e, count: u, limit: t, isSelected: o, onClick: i }) => {
            const a = (0, n.useContext)(Vt),
              l = w().mediaSize,
              s = u === t,
              c = a === qt.Accepting && u > 0 && !o,
              d = l >= b.Medium ? xu.Big : xu.Small,
              E = (0, n.useState)(!1),
              A = E[0],
              m = E[1],
              _ = (0, n.useMemo)(() => ({ backgroundImage: `url(${Hu(e, d)})` }), [d, e]),
              F = (0, n.useMemo)(() => J(Ht.counter(), { count: u, limit: t }), [u, t]),
          ...
          Yt = "Content_title_b6",
          Ut = "Content_subTitle_77",
          Gt = "Content_wrapper_f2",
        ...
        const Vt = (0, n.createContext)(qt.None),
          Qt = ({ title: e, subTitle: u, isLargeWindowed: t }) => {
            const o = (0, n.useState)(qt.None),
              i = o[0],
              a = o[1],
              l = (0, n.useContext)(Ye),
              s = Xe(l),
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                r().createElement(
                  "div",
                  { className: Xt },
                  r().createElement("div", { className: Yt }, e),
                  r().createElement("div", { className: Ut }, u),
                ),
                r().createElement(
                  "div",
                  { className: Gt },
                  r().createElement(
                    ...
                    c.map(({ value: e }, u) =>
                      r().createElement(
                        Nt,
                        Kt({}, e, { key: u, isSelected: d === e.type, onClick: h }),
                      ),
                    ),
                  ),
                ...
                r().createElement(
                  "div",
                  { className: zt },
                  r().createElement(iu, { rewardsSelectedCount: E, onOkClick: F, onCloseClick: D }),
                ),
              ),
            );
          },
          ...
          on = () => {
            ...
            return r().createElement(
              ...
              r().createElement("div", { className: en }, rn.title()),
              r().createElement("div", { className: un }, rn.description()),
              r().createElement(
                "div",
                { className: tn },
                r().createElement(
                  $e,
                  { mixClass: nn, type: Ge.primary, size: je.medium, onClick: t },
                  rn.button(),
                ),
              ),
            );
        ...
        const sn = ({ modelPath: e = "model", title: u, subTitle: t }) => {
          const o = Xe(e).tabs.length ? ln.Normal : ln.Error,
            l = (() => {
              const e = i.O.view.getSize("rem"),
                u = (0, n.useState)({ height: e.height, width: e.width }),
                t = u[0],
                r = u[1],
            ...
            s = l.width,
            c = l.height,
            d = c >= 1017 && c < a.large.height && s === a.large.width,
            E = C()(an, d && p().LARGE);
          return r().createElement(
            Ye.Provider,
            { value: e },
            r().createElement(
              ...
              o === ln.Error && r().createElement(on, null),
            ),
          );
        };
        function cn() {
        ...
        const _n = ((e, u) => {
            ...
            return [
              function ({ mode: o = "real", options: a, children: l, mocks: s }) {
                const c = (0, n.useRef)([]),
                  d = (t, n, r) => {
                    var o;
                    const a = (function ({
                        ...
                        return {
                          ...
                          dispose: function () {
                            for (var e, t = En(r.keys()); !(e = t()).done;) o(e.value, u);
                          },
                          unsubscribe: o,
                        };
                      })(n),
                      ...
                      E = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = s(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = dn.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, dn.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                o = Object.entries(r),
                                i = o.reduce((e, [u, t]) => ((e[t] = dn.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, dn.aD)((e) => {
                      ...
                      A = { mode: t, model: E, externalModel: l, cleanup: d };
                    return {
                      model: E,
                  ...
                  m = A[0],
                  _ = A[1],
                  F = (0, n.useState)(() => d(o, a, s)),
                  D = F[0],
                  h = F[1];
                return (
                  (0, n.useEffect)(() => {
                    E.current ? h(d(m, a, s)) : (E.current = !0);
                  }, [s, m, a]),
                  (0, n.useEffect)(() => {
                    _(o);
                  }, [o]),
            ...
            ({ externalModel: e }) => ({
              onClose: e.createCallbackNoArgs("selectableRewardModel.onCloseClick"),
            }),
          ),
          Fn = _n[0],
          Dn = _n[1],
          ...
          Bn = "App_fill_81",
          Cn = "App_close_68",
          gn = R.strings.stronghold.selectableReward,
          pn = R.strings.stronghold.season,
          bn = R.strings.menu.viewHeader.closeBtn,
          fn = (0, Te.Pi)(() => {
            const e = Dn().controls;
            return (
              (function ({
              ...
              r().createElement(
                ...
                r().createElement(sn, {
                  ...
                  title: r().createElement(ge, {
                    text: gn.title(),
                    format: { binding: { season: pn.name().toUpperCase() } },
                  }),
                  subTitle: r().createElement(ge, { text: gn.subTitle() }),
                }),
                r().createElement(
                  "div",
                  { className: Cn },
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [276], () => __webpack_require__(596));
