              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (A(), window.removeEventListener(E, n), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
                      ...
                      s = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = i(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = Q.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, Q.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                E = Object.entries(a),
                                A = E.reduce((u, [e, t]) => ((u[t] = Q.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, Q.aD)((u) => {
            ...
            switch (u) {
              case Y.NotStarted:
                return a().createElement(Fu, {
                  text: su.seasonDate.seasonNotStarted(),
                  timestamp: t,
                });
              case Y.Started:
                return a().createElement(Fu, { text: su.seasonDate.seasonLasts(), timestamp: r });
