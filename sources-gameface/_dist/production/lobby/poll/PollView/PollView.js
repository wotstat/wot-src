    ...
    t = {
      ...
      877: (e, t, a) => {
              ...
              (t[a] = (function (t) {
                return (a) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (o(), window.removeEventListener(i, l), (e.listeners -= 1), r(), (n = !1));
                    }
                  );
                };
              })(a)),
        ...
        const Q = Object.keys(p).reduce(
            (e, t) => ((e[t] = () => viewEnv.getShowingStatus() === p[t]), e),
            {},
          ),
          Y = {
            set: (e, t) => {
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = s(t);
                            if (Array.isArray(e)) {
                              const n = e.reduce((e, t) => ((e[t] = je.LO.box(r[t], {})), e), {});
                              return (
                                "real" === a &&
                                  l.subscribe(
                                    (0, je.aD)((t) => {
                            ...
                            }
                            {
                              const n = e,
                                i = Object.entries(n),
                                o = i.reduce((e, [t, a]) => ((e[a] = je.LO.box(r[t], {})), e), {});
                              return (
                                "real" === a &&
                                  l.subscribe(
                                    (0, je.aD)((e) => {
