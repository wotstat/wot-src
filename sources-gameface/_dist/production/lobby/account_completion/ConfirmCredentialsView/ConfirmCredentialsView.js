        ...
        const uu = (u) => {
            ...
            return a().createElement(
              ...
              r &&
                a().createElement(
                  "div",
                  { className: _()(Z.goto, null == o ? void 0 : o.goto) },
                  r,
                ),
            );
          },
                      ...
                      A = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = ku.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, ku.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                r = Object.entries(a),
                                o = r.reduce((u, [e, t]) => ((u[t] = ku.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, ku.aD)((u) => {
        ...
        const ee = {
          ...
          te = a().memo(
            ({
              ...
              (0, n.useEffect)(() => {
                (k && y && E && S.current && S.current.select(),
                  y && S.current && S.current.focus());
              }, [E, y, k]);
        ...
        (u, e, t) => {
          ...
          a().createElement(
            ...
            a().createElement(
              ...
              {
                options: {
                  rootId: R.views.lobby.account_completion.ConfirmCredentialsView("resId"),
                },
              },
