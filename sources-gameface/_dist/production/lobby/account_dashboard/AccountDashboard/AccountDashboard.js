  ...
  var __webpack_modules__ = {
      ...
      560: (e, u, t) => {
        ...
        function ce(e, u, t, a = oe.Deep) {
          ...
          var o;
          return (
            (r.displayName = `WithModel(${((o = e), o.displayName || o.name || "Component")})`),
            r
          );
        }
        const de = (e) => {
          ...
          iu = ce(
            (e) => {
              ...
              return n().createElement(
                ...
                n().createElement("div", {
                  className: _()(Te, l ? Le : nu[r - 1] || nu[0], m && Oe),
                }),
                m &&
                  n().createElement(
                    n().Fragment,
                    ...
                    n().createElement(
                      ...
                      (({ isWotPlusBonusEnabled: e }) =>
                        e
                          ...
                          : ou(au.descriptionWotPremium, Xe, { wotPremium: au.wotPremiumLabel }))({
                      ...
                      E = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const a = l(u);
                            if (Array.isArray(e)) {
                              const n = e.reduce((e, u) => ((e[u] = ku.LO.box(a[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, ku.aD)((u) => {
                            ...
                            }
                            {
                              const n = e,
                                r = Object.entries(n),
                                o = r.reduce((e, [u, t]) => ((e[t] = ku.LO.box(a[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, ku.aD)((e) => {
        ...
        const Ou = (0, su.Pi)(({ className: e }) => {
          ...
          Iu = (e) =>
            n().createElement(
              Ru,
              { options: { context: "model.dogTags" } },
              n().createElement(Ou, e),
            ),
          ...
          bt = ({
            ...
            return e
              ? n().createElement(
                  ...
                  {
                    header:
                      (null == t ? void 0 : t.disabledTooltipHeader) || Ot.selectTooltipHeader,
          ...
          Pt = ({
            ...
            const o = Math.floor(e.cooldownEndTimeInSecs - Date.now() / U),
              ...
              c = ((e) => {
                ...
                return u[`c_${e.mapId}`] && u[`c_${e.mapId}`].name()
                  ? u[`c_${e.mapId}`].name()
                  : "";
              })(e);
            if (s) {
          ...
          Mt = ce(
            ({ className: e, path: u, excludedMaps: t }) => {
              ...
              return n().createElement(
                ...
                t.map(
                  (
                    { value: { cooldownEndTimeInSecs: e, mapId: t, slotState: r, slotType: o } },
                    i,
                  ) =>
                    n().createElement(Rt, {
                    ...
                    (e) => {
                      ...
                      if (void 0 !== window.decorator) {
                        const e = o.O.client.getMouseGlobalPosition(),
                          u = ![a.boundX, a.boundY, a.boundWidth, a.boundHeight].includes(void 0),
                          t =
                            e.x < a.boundX ||
                  ...
                  n().createElement(
                    ...
                    n().createElement(
                      ya,
                      {
                        contentId: u,
                        decoratorId:
                          R.views.common.pop_over_window.pop_over_window.PopOverWindow("resId"),
                      },
                      n().createElement("img", {
