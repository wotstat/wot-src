              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (i(), window.removeEventListener(n, E), (u.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(t)),
      ...
      889: (u, e, t) => {
        ...
        const au = ((u, e) => {
                      ...
                      D = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = F(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = uu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, uu.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                i = n.reduce((u, [e, t]) => ((u[t] = uu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, uu.aD)((u) => {
            ...
            ({ externalModel: u }) => ({
              ...
              onWotPremiumUpgradeButtonClick: u.createCallbackNoArgs(
                "onWotPremiumUpgradeButtonClick",
              ),
              onWotPlusSubscribeButtonClick: u.createCallbackNoArgs(
                "onWotPlusSubscribeButtonClick",
              ),
              onWotPremiumDetailsButtonClick: u.createCallbackNoArgs(
                "onWotPremiumDetailsButtonClick",
              ),
        ...
        const xu = {
          ...
          yu = (0, O.Pi)(({ type: u }) => {
            const e = iu(),
              ...
              C = {
                [fu.WotPremium]: xu.wotPremiumApplications,
                [fu.WotPlus]: xu.wotPlusApplications,
              },
              d = c[u] || "",
