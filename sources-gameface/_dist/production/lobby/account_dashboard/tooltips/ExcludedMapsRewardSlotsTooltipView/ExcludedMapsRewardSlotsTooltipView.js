              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      A &&
                        (n(), window.removeEventListener(E, a), (u.listeners -= 1), r(), (A = !1));
                    }
                  );
                };
              })(t)),
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = i(e);
                            if (Array.isArray(u)) {
                              const A = u.reduce((u, e) => ((u[e] = Pu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, Pu.aD)((e) => {
                            ...
                            }
                            {
                              const A = u,
                                E = Object.entries(A),
                                n = E.reduce((u, [e, t]) => ((u[t] = Pu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, Pu.aD)((u) => {
