  ...
  var __webpack_modules__ = {
      ...
      3043: (u, e, t) => {
        ...
        const k = {
          ...
          Z = (0, A.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = X, onDrag: r = K }) => {
        ...
        const uu = O({
          ...
          du = (0, A.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = cu, onDrag: r = lu }) => {
              const n = (0, A.useRef)(null),
                a = (0, A.useRef)(null),
                o = (0, A.useRef)(null),
                s = (0, A.useRef)(null),
                ...
                g = S(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | A}px)`),
                    ((u) => {
                      if (a.current && o.current && s.current && l.current) {
                        if (0 === Math.round(u))
                          return (a.current.classList.add(su), void o.current.classList.remove(su));
                        if (
                          ((e = s.current),
                          (t = l.current),
                          u - (e.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (a.current.classList.remove(su), void o.current.classList.add(su));
                        var e, t;
