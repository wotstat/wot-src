            ...
            (i.contains(e.scrollbarXRail) ||
              ...
              e.scrollbarYActive
                ? (i.classList.add(c.active("y")),
                  b(e, "top", i.scrollTop - e.lastScrollTop, !0, u))
            ...
            var _ = function e(n) {
              if (!s || !s()) {
                ...
                if (!isNaN(A)) {
                  ...
                  if (
                    (c.breakBounds &&
                      (_ < c.startBound ? (_ = c.startBound) : _ > c.endBound && (_ = c.endBound)),
                    a < i)
                  ) {
                    if (F) {
                      var v = m ? _ : 0,
                  ...
                  (e.settings.suppressScrollX && 0 !== l) ||
                    ...
                    (function (u, n) {
                      ...
                      if (0 === n) {
                        ...
                        if ((0 === i && u < 0) || (i >= e.contentWidth - e.containerWidth && u > 0))
                          return !e.settings.wheelPropagation;
                      }
                      return !0;
                  ...
                  (m > 0 && ((o.x = A / m), (o.y = h / m), (i = F)),
                    (function (u, t) {
                      ...
                      if (l > o) {
                        ...
                        o > l &&
                        ((u < 0 && i === e.contentWidth - e.containerWidth) || (u > 0 && 0 === i))
                      )
                        return !0;
                      return !0;
              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (o(), window.removeEventListener(i, l), (e.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
