              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      A &&
                        (n(), window.removeEventListener(F, r), (u.listeners -= 1), E(), (A = !1));
                    }
                  );
                };
              })(t)),
                    ...
                    .map(({ value: e }, t) => {
                      const E = ((u) => {
                        ...
                        const t = u.split("_")[1],
                          ...
                          A = null == (e = R.strings.artefacts.$dyn(u)) ? void 0 : e.$dyn("name");
                        return (
                          E || (A ? D(A) : void console.error("title for reward is not provided"))
                        );
                      })(e.type);
