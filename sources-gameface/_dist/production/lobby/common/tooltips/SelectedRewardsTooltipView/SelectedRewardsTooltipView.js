  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(A, r), (u.listeners -= 1), E(), (F = !1));
                    }
                  );
                };
              })(t)),
      ...
      5926: (u, e, t) => {
            ...
            g(() => {
              if (
                ...
                const t = (u) => {
                  ...
                  E = T(u);
                s.current = x.addCallback(E, t, D, e === k.Deep);
              }
            }),
            (0, E.useEffect)(() => {
              if (e !== k.None)
        ...
        const W = F().forwardRef(function (u, e) {
            ...
            return (
              (0, E.useLayoutEffect)(() => {
                const u = p.O.client.getSize("rem");
          ...
          q = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((D = D.replace(t, `%(${r})`)),
                  (n[r] = I[u]
                    ? F().createElement(
                        "span",
                        { className: I[u] },
                        F().createElement($, { text: a, binding: e }),
                      )
                    : F().createElement(
                        "span",
                        { style: A(u) },
            ...
            return F().createElement($, { text: D, classMix: t, binding: n });
          });
        let G = (function (u) {
            return (
              (u.Items = "items"),
        ...
        const Z = (u, e = K.Small, t) => {
          if (t === X.Modernized) {
            const t = H(u);
            if (t)
              return `R.images.gui.maps.icons.quests.bonuses.${e}.modernized_devices_t${t}_gift`;
          }
          ...
          Au = ({ type: u, rewards: e }) => {
                    ...
                    .map(({ value: e }, t) => {
                      const E = ((u) => {
                        ...
                        const t = u.split("_")[1],
                          ...
                          F = null == (e = R.strings.artefacts.$dyn(u)) ? void 0 : e.$dyn("name");
                        return (
                          E ||
                          (F && "string" == typeof F
                            ? a(F)
                      ...
                      const A = `counter${t}`,
                        n = i(Fu.counter(), { count: e.count });
                      return (
                        (u[A] = F().createElement($, { text: n, classMix: Eu })),
                        `${E}%(${A})s`
                      );
                    })
                    .join(Fu.separator());
            ...
            return F().createElement(
              ...
              F().createElement(
                ...
                F().createElement("div", { className: tu }, F().createElement($, n)),
              ),
            );
          },
          nu = "App_base_c902e",
            ...
            return F().createElement(
              ...
              F().createElement(
                ...
                F().createElement(
                  "div",
                  { className: ru },
                  F().createElement(q, { text: au.title(), binding: A }),
                ),
                F().createElement("div", { className: Du }, au.description()),
                F().createElement("div", { className: ou }),
                t.map(({ value: u }, e) =>
                  F().createElement("div", { key: e, className: iu }, F().createElement(Au, u)),
                ),
              ),
            );
          };
