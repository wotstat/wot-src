    ...
    t = {
      522: (e, t, n) => {
        ...
        const u = c("clientResized"),
          ...
          b = { down: c("mousedown"), up: c("mouseup"), move: c("mousemove") };
        const p = (function () {
        ...
        const de = Object.keys(j).reduce(
            (e, t) => ((e[t] = () => viewEnv.getShowingStatus() === j[t]), e),
            {},
          ),
          ue = {
            set: (e, t) => {
        ...
        const Ee = pe().forwardRef(function (e, t) {
          let n = e.children,
            r = e.className,
            o = e.theme,
          ...
          return (
            ...
            pe().createElement(
              ...
              pe().createElement("div", { className: he.decorator }, n),
            )
          );
        });
        var xe = n(1533),
            ...
            return [
              function ({ mode: r = "real", options: o, children: i, mocks: a }) {
                      ...
                      u = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = c(t);
                            if (Array.isArray(e)) {
                              const o = e.reduce((e, t) => ((e[t] = Re.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  l.subscribe(
                                    (0, Re.aD)((t) => {
                            ...
                            }
                            {
                              const o = e,
                                i = Object.entries(o),
                                a = i.reduce((e, [t, n]) => ((e[n] = Re.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  l.subscribe(
                                    (0, Re.aD)((e) => {
                ...
                return (
                  ...
                  pe().createElement(n.Provider, { value: g }, i)
                );
              },
              () => (0, be.useContext)(n),
            ];
        ...
        const De = (0, ke.Pi)(() => {
          ...
          return pe().createElement(
            ...
            pe().createElement(
              "div",
              { className: _e.header },
              r && pe().createElement("div", { className: _e.headerIcon, style: o }),
              e.header.get(),
            ),
            pe().createElement("div", { className: _e.text }, e.body.get()),
          );
        });
        engine.whenReady.then(() => {
          Pe().render(
            pe().createElement(
              Ee,
              null,
              pe().createElement(Ae, null, pe().createElement(De, null)),
            ),
