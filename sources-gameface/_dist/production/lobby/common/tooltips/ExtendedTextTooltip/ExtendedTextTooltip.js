(() => {
  ...
  var __webpack_modules__ = {
      ...
      203: (u, e, t) => {
        ...
        const K = {
            [V.NBSP]: j.NoBreakSymbol,
            [V.ZWNBSP]: j.NoBreakSymbol,
            [V.NEW_LINE]: j.LineBreak,
          },
          q = {
          ...
          $ = {
            ...
            [j.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": j.NoBreakWrapper, className: H },
                u,
              ),
          },
          X = (u, e, t) => {
                      ...
                      c = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = E(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = lu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, lu.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = lu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, lu.aD)((u) => {
