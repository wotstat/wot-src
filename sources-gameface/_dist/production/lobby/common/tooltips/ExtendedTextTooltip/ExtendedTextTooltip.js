        ...
        const M = {
          ...
          G = {
            ...
            [P.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              a().createElement(
                "span",
                { key: e, "data-block-type": P.NoBreakWrapper, className: j },
                u,
              ),
          },
          K = (u, e, t) => {
          ...
          iu = (u, e, t, n = "...") => {
            ...
            const F = ou(E, r, c, a, n.length, n),
              l = F[0],
              A = F[1];
            return (A && (r.splice(l, 1, A), r.splice(l + 1)), [r, !0]);
          },
          au = a().memo(
            ({
              text: u,
        ...
        const Du = ((u, e) => {
            ...
            return [
              function ({ mode: n = "real", options: r, children: s, mocks: E }) {
                const c = (0, i.useRef)([]),
                  F = (t, n, r) => {
                    ...
                    const a = (function ({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = cu.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, cu.aD)((u) => {
                      ...
                      A = { mode: t, model: l, externalModel: s, cleanup: F };
                    return {
                      model: l,
                ...
                return (
                  (0, i.useEffect)(() => {
                    l.current ? _(F(d, r, E)) : (l.current = !0);
                  }, [E, d, r]),
                  (0, i.useEffect)(() => {
                    D(n);
                  }, [n]),
