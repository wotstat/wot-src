              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (i(), window.removeEventListener(o, E), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      533: (u, e, t) => {
                      ...
                      D = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = a(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = m.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, m.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce((u, [e, t]) => ((u[t] = m.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, m.aD)((u) => {
        ...
        let T = (function (u) {
          return (
            (u.Common = "common"),
            (u.Simple = "simple"),
            (u.SimpleWithBonus = "simpleWithBonus"),
            u
          );
        })({});
        var x = t(242);
        ...
        const uu = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          const r = e.contentId;
          return r
            ? E().createElement(G, J({}, e, { contentId: r }), n)
        ...
        const iu = {
            [ou.NBSP]: nu.NoBreakSymbol,
            [ou.ZWNBSP]: nu.NoBreakSymbol,
            [ou.NEW_LINE]: nu.LineBreak,
          },
          ...
          cu = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : E().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: Du },
                  u,
                );
          },
          Bu = {
            ...
            [nu.NewLine]: ({ elementList: u, key: e }) =>
              E().createElement(
                "span",
                { key: e, "data-block-type": nu.NewLine, className: su },
                u,
              ),
