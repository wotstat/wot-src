              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      s &&
                        (o(), window.removeEventListener(r, a), (e.listeners -= 1), n(), (s = !1));
                    }
                  );
                };
              })(t)),
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const s = e.reduce((e, u) => ((e[u] = Fe.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, Fe.aD)((u) => {
                            ...
                            }
                            {
                              const s = e,
                                r = Object.entries(s),
                                o = r.reduce((e, [u, t]) => ((e[t] = Fe.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  i.subscribe(
                                    (0, Fe.aD)((e) => {
