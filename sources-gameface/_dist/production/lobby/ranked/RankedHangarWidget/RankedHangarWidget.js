                      ...
                      l = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = A(e);
                            if (Array.isArray(u)) {
                              const a = u.reduce((u, e) => ((u[e] = G.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, G.aD)((e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                i = n.reduce((u, [e, t]) => ((u[t] = G.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, G.aD)((u) => {
        ...
        const Ku = { tooltipId: Hu },
          qu = (u) => {
            ...
            return a().createElement(
              "div",
              {
                className: g()(zu.base, zu[`base__${o}`]),
                onClick: F,
                onMouseEnter: s,
                onMouseLeave: l,
              },
        ...
        const ve = R.views.common.tooltip_window.simple_tooltip_content,
          ...
          Re = (0, N.Pi)(() => {
            const u = q(),
              ...
              b = D > 0,
              x = (0, r.useMemo)(
                () => (v === w.ExtraSmall || v === w.Small ? Y.Medium : Y.Large),
                [v],
              ),
              L = (0, r.useCallback)((u) => {
            ...
            return a().createElement(
              ...
              { className: X.base },
              a().createElement("div", {
                className: g()(X.wrapperHover, { [X.wrapperHover_hover]: _ }),
              }),
              a().createElement(
                "div",
