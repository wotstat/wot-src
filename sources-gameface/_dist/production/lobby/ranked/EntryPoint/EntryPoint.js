(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      E &&
                        (F(), window.removeEventListener(A, i), (u.listeners -= 1), n(), (E = !1));
                    }
                  );
                };
              })(t)),
      ...
      917: (u, e, t) => {
                      ...
                      s = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = i(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = f.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, f.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                A = Object.entries(E),
                                F = A.reduce((u, [e, t]) => ((u[t] = f.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, f.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          F().render(
            E().createElement(P, null, E().createElement(M, null)),
