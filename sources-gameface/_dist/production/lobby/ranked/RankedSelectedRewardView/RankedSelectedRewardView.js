  ...
  var __webpack_modules__ = {
      ...
      652: (u, e, t) => {
        ...
        const ie = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
          ...
          ce = "AdditionalRewards_rewardsList_ab",
          ...
          Fe = (0, _u.Pi)(({ rewards: u, pageNumber: e, className: t }) => {
            ...
            return (
              ...
              r().createElement(
                "div",
                { className: g()(oe, t) },
                r().createElement("div", { className: le }, Ae.additionalRewards.subText()),
                r().createElement(
                  "div",
                  { className: ce },
                  E((u, e) => {
        ...
        const Ue = ({
            ...
            return r().createElement(
              ...
              r().createElement(
                "div",
                { className: g()(Oe.level, null == c ? void 0 : c.level) },
                Ne(n),
              ),
              r().createElement("div", {
                className: g()(Oe.type, u && Oe.type__elite, null == c ? void 0 : c.typeIcon),
                style: { backgroundImage: `url(${_})` },
              }),
              i && r().createElement("div", { className: Oe.premiumIGR }),
              r().createElement(
                "div",
                { className: g()(Oe.name, null == c ? void 0 : c.name) },
                A ? t : e,
              ),
            );
          },
        ...
        engine.whenReady.then(() => {
          k().render(
            r().createElement(V, null, r().createElement(N, null, r().createElement(ct, null))),
