  ...
  var __webpack_modules__ = {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (i(), window.removeEventListener(r, o), (u.listeners -= 1), a(), (n = !1));
                    }
                  );
                };
              })(t)),
      ...
      587: (u, e, t) => {
        ...
        const Ge = "ChevronChangeStatus_base_fa",
          ...
          qe = (0, Q.Pi)(
            ({ diffStage: u, earnedStage: e, className: t, rankAnimationDelay: r }) => {
              const i = mu().model,
                s = i.root.get(),
                o = s.maxRank,
                l = s.totalSteps,
        ...
        const Qt = (0, Q.Pi)(({ className: u }) => {
              ...
              s.map((u, e) =>
                n().createElement(
                  ...
                  n().createElement(
                    ...
                    n().createElement(
                      zt,
                      Kt({ size: i ? Ft.Small : Ft.Big, image: i ? u.smallImage : u.bigImage }, u),
                    ),
                  ),
                ),
              ),
          ...
          Sa = (0, Q.Pi)(({ diff: u }) => {
            ...
            const r = mu().model,
              ...
              b = (0, a.useMemo)(
                () => `url('${fa}.c_${h}.rank${c}_${F ? m : _}')`,
                [h, m, _, c, F],
              ),
              v = (0, a.useMemo)(
                () => `url('${fa}.c_${h}.rank${c}_${F ? _ : m}.png')`,
                [h, m, _, c, F],
              ),
              f = (0, a.useCallback)(
          ...
          Ha = (0, Q.Pi)(({ onHandleConfirm: u }) => {
            const e = mu(),
              ...
              d = ((u, e, t, a) => {
                ...
                return u.step
                  ? { diff: 0, status: oe.SaveChevron }
                  : { diff: 0, status: oe.SaveRank };
              })(_, c, o, E),
              F = d.diff,
              D = d.status,
              B = _.step,
