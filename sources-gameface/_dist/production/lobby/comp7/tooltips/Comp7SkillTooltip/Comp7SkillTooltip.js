        ...
        const Mu = (u, e, t = {}, r = 0) => {
          ...
          ie = ({ name: u, isModal: e = !1, className: t }) => {
            const n = (0, r.useMemo)(() => String(u && Ee.$dyn(u).$dyn("name")), [u]),
              ...
              i = (0, r.useMemo)(
                () => R.images.gui.maps.icons.roleSkills.c_22x22.$dyn(u || ""),
                [u],
              ),
              A = (0, r.useMemo)(() => ({ backgroundImage: `url(${i})` }), [i]),
              F = (0, r.useMemo)(
                () => R.images.gui.maps.icons.roleSkills.c_128x128.$dyn(u || ""),
                [u],
              ),
                  ...
                  ((e) =>
                    e.map((e, t) => {
                      const r = ((e, t) => {
                        ...
                        return { valueTextMap: a && nu(a, { value: parseFloat(t) }), descrText: E };
                      })(e.name, e.value);
                      return a().createElement(
                        "div",
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const a = u,
                                n = Object.entries(a),
                                E = n.reduce((u, [e, t]) => ((u[t] = Ce.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Ce.aD)((u) => {
