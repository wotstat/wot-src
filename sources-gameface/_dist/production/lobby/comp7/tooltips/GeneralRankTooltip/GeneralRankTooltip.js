(() => {
      ...
      395: (u, e, t) => {
        ...
        const W = {
          ...
          U = P((u) => {
            ...
            return E().createElement("div", H({ className: n()(k.base, ...q, e), style: V }, K), X);
          });
        let j;
        !(function (u) {
        ...
        const X = (u, e, t) => {
          ...
          $ = "FormatText_base_d0",
          Z = ({ binding: u, text: e = "", classMix: t, alignment: a = j.left }) =>
            null === e
        ...
        const ru = Object.keys(J()),
          ...
          Du = P((u) => {
            ...
            return E().createElement(
              ...
              tu(
                {
                  className: n()(uu.base, t && uu[t], p, a),
                  style: g,
                  mt: !0 === D ? nu[t || "paragraph-P16"].mt : D,
                  mr: !0 === l ? nu[t || "paragraph-P16"].mr : l,
                  mb: !0 === B ? nu[t || "paragraph-P16"].mb : B,
                  ml: !0 === _ ? nu[t || "paragraph-P16"].ml : _,
                },
                d,
              ),
              void 0 !== m ? E().createElement(Z, tu({}, m, { text: e })) : e,
            );
          });
        function ou() {
        ...
        const Cu = E().forwardRef(function (u, e) {
          let t = u.children,
            a = u.className,
            A = u.theme,
          ...
          return (
            ...
            E().createElement(
              "div",
              Bu({}, i, {
                className: n()(lu.base, lu[`base__theme-${F}`], a),
                ref: function (u) {
                  ((o.current = u), "function" == typeof e ? e(u) : e && (e.current = u));
                },
              }),
              E().createElement("div", { className: lu.decorator }, t),
            )
          );
        });
        var _u = t(3403);
        const cu = {
          ...
          gu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((n = n.replace(t, `%(${F})`)),
                  (A[F] = cu[u]
                    ? E().createElement(
                        "span",
                        { className: cu[u] },
                        E().createElement(Z, { text: o, binding: e }),
                      )
                    : E().createElement(
                        "span",
                        { style: a(u) },
            ...
            return E().createElement(Z, { text: n, classMix: t, binding: A });
          });
        let pu;
        !(function (u) {
          ((u[(u.First = 6)] = "First"),
        ...
        const xu = {
          ...
          vu = (u, e) => `${u.$dyn(xu[e])}`,
          bu = (u) => vu(R.strings.comp7.rank, u),
          wu = (u) => {
            return (
              (e = R.strings.comp7.rank.text()),
              (t = { rank: bu(u) }),
              e.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
          ...
          Lu = "tooltips_subHeading__topIndent_e1",
          Mu = "tooltips_divider_26",
          Ou = "tooltips_description_85",
          Ru = "tooltips_highlight_87";
        function yu() {}
        function Pu() {
          return !1;
        }
        ...
        const Iu = ((u, e) => {
                  ...
                  D = (t, r, E) => {
                    ...
                    const A = (function ({
                        ...
                        return {
                          ...
                          dispose: function () {
                            for (var u, t = Nu(E.keys()); !(u = t()).done;) a(u.value, e);
                          },
                          unsubscribe: a,
                        };
                      })(r),
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = n(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = ku.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, ku.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                a = Object.entries(E),
                                A = a.reduce((u, [e, t]) => ((u[t] = ku.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, ku.aD)((u) => {
          ...
          Gu = Iu[0],
          Uu = Iu[1],
          ju = R.strings.comp7.generalRankTooltip,
          Xu = (0, _u.Pi)(() => {
            const u = Uu().model.root.get(),
              ...
              a = u.to,
              A = u.elitePercent,
              F = E().createElement(D, { value: r }),
              i = E().createElement(D, { value: a });
            return E().createElement(
              Cu,
              null,
              E().createElement(
                "div",
                { className: fu },
                E().createElement("div", { className: Su }, wu(t)),
                E().createElement(
                  "div",
                  { className: n()(Tu, Lu) },
                  E().createElement(Du, {
                    text: ju.subheading(),
                    format: {
                      binding: { divisions: E().createElement("div", { className: Ru }, e) },
                    },
                  }),
                ),
                ...
                E().createElement(
                  ...
                  E().createElement(gu, {
                    text: vu(ju.body, t),
                    binding: { fromScore: F, toScore: i, elitePercent: A },
                  }),
                ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          A().render(
            E().createElement(Gu, null, E().createElement(Xu, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(395));
