(() => {
  var __webpack_modules__ = {
      ...
      2758: (u, e, t) => {
        ...
        const m = B.O.client.getSize("rem"),
          d = m.width,
          h = m.height,
          g = Object.assign({ width: d, height: h }, c(d, h, C)),
        ...
        (0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(p),
            ...
            F = (0, r.useCallback)((u, e) => {
              ...
              A(Object.assign({ width: t, height: r }, c(t, r, C)));
            }, []);
          (f(() => {
        ...
        const W = {
          ...
          U = P((u) => {
            ...
            const V = (0, r.useMemo)(() => {
              ...
              }, [t, a, i, o, s, C, j, U, T, d, O, w, S]),
              z = V.computedStyle,
              q = V.computedClassNames;
            return E().createElement("div", H({ className: n()(N.base, ...q, e), style: z }, K), X);
          });
        let j;
        function X(u, e) {
        ...
        const K = (u, e, t) => {
          ...
          z = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? K : V, []),
          q = (() => {
            const u = new RegExp(
            ...
            return Y.includes(t)
              ...
              : ((u, e = j.left) => {
                  ...
                  const r =
                    ...
                    E = u.replace(/&nbsp;/g, " ");
                  return (z(E, /( )/, e).forEach((u) => (t = t.concat(z(u, r, j.left)))), t);
                })(u, e);
          },
          Z = "FormatText_base_d0",
          Q = ({ binding: u, text: e = "", classMix: t, alignment: a = j.left }) =>
            null === e
                  ...
                  e.split("\n").map((e, A) =>
                    E().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        a,
                        u,
                      ).map((u, e) => E().createElement(r.Fragment, { key: `${e}-${u}` }, u)),
                    ),
                  ),
                );
        var J = t(3532),
        ...
        const _u = E().forwardRef(function (u, e) {
          let t = u.children,
            a = u.className,
            A = u.theme,
          ...
          return (
            ...
            E().createElement(
              "div",
              Cu({}, i, {
                className: n()(su.base, su[`base__theme-${F}`], a),
                ref: function (u) {
                  ((o.current = u), "function" == typeof e ? e(u) : e && (e.current = u));
                },
              }),
              E().createElement("div", { className: su.decorator }, t),
            )
          );
        });
        var cu = t(3403);
        const mu = {
          ...
          hu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          gu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          pu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((n = n.replace(t, `%(${F})`)),
                  (A[F] = mu[u]
                    ? E().createElement(
                        "span",
                        { className: mu[u] },
                        E().createElement(Q, { text: o, binding: e }),
                      )
                    : E().createElement(
                        "span",
                        { style: a(u) },
            ...
            return E().createElement(Q, { text: n, classMix: t, binding: A });
          });
        let xu, vu;
        (!(function (u) {
          ((u[(u.A = 1)] = "A"),
        ...
        const fu = R.strings.comp7.division,
          wu = { [xu.A]: "A", [xu.B]: "B", [xu.C]: "C", [xu.D]: "D", [xu.E]: "E" },
          bu = (u) => fu.$dyn(wu[u]);
        let Su;
        !(function (u) {
          ((u[(u.First = 6)] = "First"),
        ...
        const Tu = {
          ...
          Lu = (u) => ((u, e) => `${u.$dyn(Tu[e])}`)(R.strings.comp7.rank, u),
          Mu = (u) => X(R.strings.comp7.rank.text(), { rank: Lu(u) }),
          Ou = "tooltips_base_6b",
          Ru = "tooltips_heading_ac",
          yu = "tooltips_subHeading_2c",
          Pu = "tooltips_subHeading__topIndent_e1",
          Nu = "tooltips_divider_26",
          ku = "tooltips_description_85";
        let Hu, Wu, Iu;
        function Gu() {}
        (!(function (u) {
        ...
        const zu = ((u, e) => {
                ...
                const i = (0, r.useRef)([]),
                  D = (t, r, E) => {
                    ...
                    const A = (function ({
                        ...
                        return {
                          subscribe: (t, a) => {
                            const F = "string" == typeof a ? `${r}.${a}` : r,
                              n = B.O.view.addModelObserver(F, e, !0);
                          ...
                          dispose: function () {
                            for (var u, t = Xu(E.keys()); !(u = t()).done;) a(u.value, e);
                          },
                          unsubscribe: a,
                        };
                      })(r),
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = n(e);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, e) => ((u[e] = ju.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, ju.aD)((e) => {
                            ...
                            }
                            {
                              const E = u,
                                a = Object.entries(E),
                                A = a.reduce((u, [e, t]) => ((u[t] = ju.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  F.subscribe(
                                    (0, ju.aD)((u) => {
                      ...
                      l = { mode: t, model: o, externalModel: F, cleanup: D };
                    return {
                      model: o,
                  ...
                  s = l[0],
                  C = l[1],
                  _ = (0, r.useState)(() => D(a, A, n)),
                  c = _[0],
                  m = _[1];
                return (
                  (0, r.useEffect)(() => {
                    o.current ? m(D(s, A, n)) : (o.current = !0);
                  }, [n, s, A]),
                  (0, r.useEffect)(() => {
                    C(a);
                  }, [a]),
                  ...
                  E().createElement(t.Provider, { value: c }, F)
                );
              },
              () => (0, r.useContext)(t),
            ];
          ...
          qu = zu[0],
          Yu = zu[1],
          $u = R.strings.comp7.divisionTooltip,
          Zu = (0, cu.Pi)(() => {
            const u = Yu().model.root.get(),
              ...
              F = u.elitePercent,
              i = Iu[A].toLowerCase(),
              o = E().createElement(D, { value: r }),
              l = E().createElement(D, { value: a });
            return E().createElement(
              _u,
              null,
              E().createElement(
                ...
                E().createElement(
                  "div",
                  { className: Ru },
                  X($u.heading(), { divisionName: bu(e) }),
                ),
                E().createElement(
                  "div",
                  { className: n()(yu, Pu) },
                  E().createElement(ou, { text: Mu(t) }),
                ),
                ...
                E().createElement(
                  ...
                  { className: ku },
                  E().createElement(pu, {
                    text: String($u.description.$dyn(i)),
                    binding: { fromScore: o, toScore: l, elitePercent: F },
                  }),
                ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          A().render(
            E().createElement(qu, null, E().createElement(Zu, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(2758));
