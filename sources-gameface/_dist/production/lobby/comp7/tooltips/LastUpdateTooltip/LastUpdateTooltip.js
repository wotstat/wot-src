(() => {
  ...
  var __webpack_modules__ = {
              ...
              (e[A] = (function (e) {
                return (A) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(t, r), (u.listeners -= 1), E(), (F = !1));
                    }
                  );
                };
              })(A)),
      ...
      9801: (u, e, A) => {
                    ...
                    const D = (function ({
                      ...
                      n =
                        "real" === A
                          ...
                          : Object.assign({}, D, {
                              readByPath:
                                null != (t = null == F ? void 0 : F.getter) ? t : () => {},
                            }),
                      r = (u) =>
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const E = r(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = L.LO.box(E[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, L.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                t = Object.entries(F),
                                D = t.reduce((u, [e, A]) => ((u[A] = L.LO.box(E[e], {})), u), {});
                              return (
                                "real" === A &&
                                  n.subscribe(
                                    (0, L.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          D().render(
            F().createElement(W, null, F().createElement(Y, null)),
