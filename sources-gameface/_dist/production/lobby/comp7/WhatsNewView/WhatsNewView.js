  ...
  var __webpack_modules__ = {
      ...
      810: (u, e, t) => {
        ...
        const eu = {
          ...
          ru = Z((u) => {
            ...
            return r().createElement(
              "div",
              uu({ className: h()(Q.base, ...U, e), style: G }, I),
              P,
            );
          });
        let nu;
        ...
        const ku = "page_heading_05",
          ...
          Wu = "Heading_base_74",
          Gu = ({ children: u, className: e }) =>
            r().createElement("div", { className: h()(Wu, e) }, u),
          Uu = (u, e) => {
            let t;
            const a = setTimeout(() => {
              t = u();
                      ...
                      c = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const a = l(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = ju.LO.box(a[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, ju.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                n = Object.entries(r),
                                i = n.reduce((u, [e, t]) => ((u[t] = ju.LO.box(a[e], {})), u), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, ju.aD)((u) => {
