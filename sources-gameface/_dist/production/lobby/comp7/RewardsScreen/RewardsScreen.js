              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      n &&
                        (s(), window.removeEventListener(r, o), (e.listeners -= 1), a(), (n = !1));
                    }
                  );
                };
              })(t)),
      ...
      288: (e, u, t) => {
                      ...
                      d = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const a = l(u);
                            if (Array.isArray(e)) {
                              const n = e.reduce((e, u) => ((e[u] = le.LO.box(a[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, le.aD)((u) => {
                            ...
                            }
                            {
                              const n = e,
                                r = Object.entries(n),
                                i = r.reduce((e, [u, t]) => ((e[t] = le.LO.box(a[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, le.aD)((e) => {
        ...
        const je = ({ rank: e, size: u, division: t, className: r }) => {
            const i = (0, a.useMemo)(() => {
              ...
              return {
                backgroundImage: `url(${a.$dyn(`${We(e)}${n}`)})`,
                "--imageSize": `${u}rem`,
              };
            }, [e, u, t]);
        ...
        const fu = n().memo(function (e) {
            ...
            return (
                            ...
                            r.forEach((e, t) => {
                              a > r[t] - 0.02 &&
                                ...
                                u.changeKeyframeHandlers.forEach((u) => {
                                  ...
                                  return u({ time: e, name: `${l ? a : `Point_${t}`}` });
                                });
                            });
                          }
                        }),
                    ...
                    i = (e) => {
                      ...
                      A.current &&
                        (A.current.currentTime =
                          ((u = 0), (t = A.current.duration), (a = e) < u ? u : a > t ? t : a));
                    },
                    s = () => {
                      var e;
              ...
              n().createElement(
                "video",
                pu(
                  { src: u, className: t, style: i, loop: o, ref: A, onClick: E, preload: "auto" },
                  d,
                ),
              )
            );
        ...
        const Aa = {
          ...
          Fa = ({ rewardIndex: e, delay: u = 0, children: t }) =>
            n().createElement(
              da.ZP,
              { appear: !0, in: !0, timeout: _a(e, u), onEntered: ma },
              (e) => n().createElement("div", { className: g()(Aa.base, Aa[e]) }, t),
            ),
          Da = {
            "--pageContentWidth": "78vw",
          ...
          pa = (0, ae.Pi)(() => {
            ...
            return n().createElement(
              "div",
              {
                className: g()(
                  Da.base,
                  e.computes.isSingleMainReward() && Da.base__singleMainReward,
                ),
                        ...
                        n().createElement(
                          ...
                          n().createElement(
                            ...
                            n().createElement(ia, {
                              ...
                              size: s,
                              value: Te(R.strings.tooltips.quests.awards.additional.bottom(), {
                                count: t.length - 10 + 1,
                              }),
                              tooltipArgs: {
                    ...
                    n().createElement(
                      ...
                      (() => {
                        switch (a) {
                          ...
                          default:
                            return (
                              console.error("[App] Unreachable branch: add rewards screen type"),
                              null
                            );
                        }
                      })(),
