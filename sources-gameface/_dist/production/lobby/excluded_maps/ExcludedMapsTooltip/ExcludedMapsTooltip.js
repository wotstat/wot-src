  ...
  var u,
    A = {
      874: (u, A, F) => {
        ...
        var D = {};
        (F.r(D), F.d(D, { getBgUrl: () => _, getTextureUrl: () => T }));
        var B = {};
        (F.r(B),
          F.d(B, {
            addModelObserver: () => q,
        ...
        const p = {
          ...
          w = Object.keys(h).reduce((u, A) => ((u[A] = () => m(h[A])), u), {}),
          y = { play: Object.assign({}, w, { sound: m }), setRTPC: v },
        ...
        const ru = Object.keys(O).reduce(
            (u, A) => ((u[A] = () => viewEnv.getShowingStatus() === O[A]), u),
            {},
          ),
          ou = {
            set: (u, A) => {
        ...
        const gu = du().forwardRef(function (u, A) {
          let F = u.children,
            e = u.className,
            E = u.theme,
          ...
          return (
            ...
            du().createElement(
              "div",
              fu({}, B, {
                className: n()(mu.base, mu[`base__theme-${D}`], e),
                ref: function (u) {
                  ((t.current = u), "function" == typeof A ? A(u) : A && (A.current = u));
                },
              }),
              du().createElement("div", { className: mu.decorator }, F),
            )
          );
        });
        var pu = F(533),
        ...
        const xu = (u) => u.replace(/&nbsp;/g, " "),
          ...
          Su = (u, A, F = wu.left) => u.split(A).reduce(F === wu.left ? Pu : Ru, []),
          Tu = (() => {
            const u = new RegExp(
              [
          ...
          Ou = (u, A = wu.left) => {
            ...
            return ((u, A = wu.left) => {
              ...
              const e =
                ...
                E = xu(u);
              return (Su(E, /( )/, A).forEach((u) => (F = F.concat(Su(u, e, wu.left)))), F);
            })(u, A);
          },
                      ...
                      o = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, A) => {
                            const e = C(A);
                            if (Array.isArray(u)) {
                              const E = u.reduce((u, A) => ((u[A] = Lu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  n.subscribe(
                                    (0, Lu.aD)((A) => {
                            ...
                            }
                            {
                              const E = u,
                                D = Object.entries(E),
                                B = D.reduce((u, [A, F]) => ((u[F] = Lu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === F &&
                                  n.subscribe(
                                    (0, Lu.aD)((u) => {
        ...
        engine.whenReady.then(() => {
          bu().render(
            du().createElement(
              gu,
              null,
              du().createElement(Iu, null, du().createElement(Ju, null)),
            ),
