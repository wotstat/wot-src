      ...
      581: (e, u, t) => {
        ...
        const K = ({
            ...
            return (
              ...
              r().createElement(
                ...
                r().createElement(
                  "span",
                  { className: P()(Y.state, Y.state__default) },
        ...
        const ee = (e) => {
          ...
          return r().createElement(
            ...
            r().createElement(
              ...
              r().createElement("div", { className: P()(Q.glow, null == i ? void 0 : i.glow) }),
            ),
            r().createElement(
              "div",
              { className: P()(Q.caption, Q[`caption__${A}`], null == i ? void 0 : i.caption) },
              u,
            ),
            a &&
              r().createElement("div", { className: P()(Q.goto, null == i ? void 0 : i.goto) }, a),
          );
        };
        var ue = t(20);
        const te = (e) => {
        ...
        const _e = {
          ...
          Se = (0, n.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = ve, onDrag: a = we }) => {
              ...
              return r().createElement(
                "div",
                { className: P()(Fe, u.base), ref: i, onWheel: e.handleMouseWheel },
                r().createElement("div", {
                  className: P()(ge, u.leftButton),
                  onMouseDown: (e) => {
                ...
                r().createElement(
                  ...
                  r().createElement("div", { ref: E, className: P()(pe, u.thumb) }),
                  r().createElement("div", { className: P()(be, u.rail) }),
                ),
                r().createElement("div", {
          ...
          Pe = ({ api: e, className: u, classNames: t, children: a }) => (
            ...
            r().createElement(
              "div",
              { className: P()(Te.base, u) },
              r().createElement(
                "div",
                {
                  className: P()(Te.wrapper, null == t ? void 0 : t.wrapper),
                  onWheel: e.handleMouseWheel,
                  ref: e.wrapperRef,
                },
                r().createElement(
                  "div",
                  { className: P()(Te.content, null == t ? void 0 : t.content), ref: e.contentRef },
                  a,
                ),
              ),
            )
        ...
        ((Pe.Bar = Se),
          (Pe.Default = ({
            ...
            const E = (0, n.useMemo)(() => {
                const e = a || {};
                return Object.assign({}, e, { base: P()(Te.base, e.base) });
              }, [a]),
              d = (0, n.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
            return r().createElement(
              "div",
              { className: P()(Te.defaultScroll, t), onWheel: u.handleMouseWheel },
              r().createElement(
                "div",
                { className: P()(Te.defaultScrollArea, s) },
                r().createElement(Pe, { className: o, api: d, classNames: i }, e),
              ),
        ...
        const ze = R.views.common.tooltip_window.simple_tooltip_content,
          ...
          qe = r().memo(
            ({
              ...
              const d = o >= l,
                ...
                D = ((e, u) =>
                  u ? je.changeAnswer() : e ? je.startSpecialInterview() : je.startInterview())(
                  E,
                  a,
                ),
                g = ((e) => (e ? je.startSpecialInterviewTooltip() : je.startInterviewTooltip()))(
                  E,
                ),
                B = `map_${t}`,
                C = (0, n.useMemo)(
                ...
                p = W(["base"], $e),
                b = P()(p.base, a && $e.base__done, d && $e.base__ready, E && $e.base__special),
                f = !c && !d;
              return r().createElement(
                "div",
                {
          ...
          Qe = (0, n.memo)(({ cardIndex: e, children: u }) => {
            ...
            return r().createElement(
              "div",
              { className: o, style: l, onAnimationEnd: () => s(!0) },
              u,
            );
          });
        function Ze() {
        ...
        const Je = {
            settings: Object.assign({}, _e, { step: { type: "proportional", factor: 1 } }),
          },
          eu = (e) => {
            const u = e - 1;
            return u * u * u + 1;
          ...
          tu = ({ maps: e, onClick: u, onMouseEnter: t }) => {
                ...
                const n = () => {
                  (t(),
                    (t = re(() => {
                      ...
                      if (!r || !n) return;
                      const a = Math.min(1, n / r),
                        i = null != (t = ye(e, ({ value: e }) => !e.mapSurveyPassed)) ? t : 0;
                      (1 === a || i < 3
                        ? s.applyScroll(0)
            ...
            const b = { wrapper: P()(!F.current && !D.current && Oe.scrollWrapper) },
              f = P()(Oe.arrow, Oe.arrow__left, o && Oe.arrow__disabled),
              h = P()(Oe.arrow, Oe.arrow__right, E && Oe.arrow__disabled);
            return r().createElement(
              "div",
              { className: a.base },
        ...
        const iu = (0, n.memo)(
            ({ datetime: e, format: u = nu.ShortDate, isConvertedToLocal: t = !0 }) =>
        ...
        const _u = ({ size: e = Eu.Default }) => {
            const u = P()(cu.background, cu[`background__${e}`]);
        ...
        const Cu = "ProgressBarDeltaGrow_base_f4d46",
          ...
          wu = (0, n.memo)(
            ({
              ...
              const p = (0, n.useMemo)(
                  () => Object.assign({ width: "100%" }, vu(e), fu(E)),
                  [E, e],
                ),
                b = (0, n.useMemo)(() => Object.assign({ width: "0%" }, vu(e), fu(E)), [E, e]),
                f = (0, n.useMemo)(
                  () => Object.assign({ width: "0%" }, hu(E, a), vu(e)),
                  [a, E, e],
                ),
                h = (0, n.useMemo)(
        ...
        const Nu = (0, n.memo)((e) => {
            ...
            switch (a.animationSettings.type) {
              case du.Simple:
                return r().createElement(yu, Ou({}, a, { onEndAnimation: l, isComplete: i }));
              case du.Growing:
        ...
        const $u = {
          ...
          qu = (0, n.memo)(
            ({
              ...
              return r().createElement(
                "div",
                { className: P()(cu.base, A, cu[`base__${t}`]), style: Wu(u) },
        ...
        const rt = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const a = u.contentId;
          return a
            ? r().createElement(Ue, nt({}, u, { contentId: a }), n)
              ...
              r().createElement(
                ...
                r().createElement(
                  ...
                  o &&
                    r().createElement(
                      "div",
                      { className: P()(At.title, null == E ? void 0 : E.title) },
                      o,
                    ),
                ),
              ),
        ...
        const Ct = { margin: "5rem" },
          pt = r().memo(({ reward: e, isReached: u }) => {
            ...
            const c = (0, n.useMemo)(() => {
              ...
              E = P()(Dt.base, s === Bt.Changing && Dt.base__animated);
            return r().createElement(
              "div",
              { className: E },
              r().createElement(
          ...
          ft = r().memo(({ progressRewards: e, isReached: u, isLast: t }) => {
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                { className: n.items },
                e.map(({ value: e }, t) =>
                  r().createElement(pt, { key: t, reward: e, isReached: u }),
                ),
              ),
            );
          }),
                ...
                r().createElement(
                  ...
                  u.map(({ value: e }) => {
                    const u = g(e.numBattles),
                      t = P()(ht.bgSectionNumber, e.numBattles <= _ && ht.bgSectionNumber__passed);
                    return r().createElement(
                      r().Fragment,
                      { key: e.numBattles },
          ...
          Tt = () => {
            ...
            return r().createElement(
              ...
              r().createElement(
                ...
                r().createElement(tu, { maps: C, onClick: v, onMouseEnter: y }),
                r().createElement(
                  "div",
                  {
                    className: P()(Rt.progression, b && Rt.progression__enabled),
                    onAnimationEnd: () => f(!0),
                  },
                  r().createElement(wt, {
                    rewards: s,
