  ...
  var __webpack_modules__ = {
      ...
      5067: (e, u, t) => {
              ...
              (u[t] = (function (u) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (n(), window.removeEventListener(i, s), (e.listeners -= 1), a(), (r = !1));
                    }
                  );
                };
              })(t)),
        ...
        const Z = Object.keys(b).reduce(
            (e, u) => ((e[u] = () => viewEnv.getShowingStatus() === b[u]), e),
            {},
          ),
          j = {
            set: (e, u) => {
          ...
          de = (0, r.memo)(({ onButtonClick: e }) => {
            ...
            return i().createElement(
              ...
              i().createElement(
                ...
                { className: ce },
                a &&
                  i().createElement(f.u5, { type: f.L$.ghost, size: f.qE.medium, onClick: l }, n),
              ),
            );
          }),
          Ee = {
      ...
      8012: (e, u, t) => {
            ...
            ({
              ...
              const o = E()(
                ...
                l = (0, i.useMemo)(
                  () => ({
                    header: j.header(),
                    body: (0, m.WU)(j.body(), { level: (0, M.HG)(e) }),
                  }),
                  [e],
                );
              return n().createElement(
        ...
        const Q = "RoleCategoryIcon_base_1c",
          ...
          te = (0, i.memo)(
            ({ stepState: e, actionState: u, roleCategory: t = X.None, isDisabled: a }) => {
        ...
        const De = {
          ...
          Re = (0, i.memo)(({ onClick: e, isDisabled: u = !1 }) => {
            ...
            return n().createElement(
              f.i,
              {
                header: u ? void 0 : xe.tooltip.header(),
                body: u ? Me.$dyn(t) : xe.tooltip.body(),
              },
              n().createElement(
                "div",
                null,
        ...
        const He = "BuyButton_base_7f",
          ...
          Qe = {
            ...
            base__progressionAvailabilityAvailable:
              "Item_base__progressionAvailabilityAvailable_d0",
            base__interactiveStateSelectedHighlighted:
              "Item_base__interactiveStateSelectedHighlighted_02",
        ...
        const cu = {
          ...
          Bu = {
            ...
            base__interactiveStateSelectedFaded:
              "PairModification_base__interactiveStateSelectedFaded_8e",
        ...
        const xu = ({ position: e, steps: u }) => {
            ...
            return n().createElement(
              ...
              Array(r)
                .fill(null)
                .map((e, u) =>
                  n().createElement("div", { key: u, className: Pu.elementPlaceholder }),
                ),
            );
          },
          Mu = "Grid_base_bf";
