(() => {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      A &&
                        (F(), window.removeEventListener(n, r), (u.listeners -= 1), E(), (A = !1));
                    }
                  );
                };
              })(t)),
      ...
      2480: (u, e, t) => {
        ...
        (!(function (u) {
          ((u.Persistent = "persistent"),
            (u.Selectable = "selectable"),
            (u.Changeable = "changeable"));
        })(v || (v = {})),
          (function (u) {
        ...
        const X = "ModifiersBlock_base_88",
          ...
          Fu = (0, E.memo)(({ stepState: u, level: e }) => {
            ...
            return A().createElement(
              ...
              A().createElement(h.Z, null),
              u !== p.Received &&
                A().createElement("div", { className: nu.title }, F.$dyn("title")),
              A().createElement(
                "div",
        ...
        ((window.onload = () => document.body.appendChild(bu)),
          F().render(A().createElement(gu, null), bu));
      },
      7024: (u, e, t) => {
        t.d(e, { f: () => a });
        var E = t(6179),
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, E) => {
      ...
      E = E || 0;
      for (var i = deferred.length; i > 0 && deferred[i - 1][2] > E; i--)
