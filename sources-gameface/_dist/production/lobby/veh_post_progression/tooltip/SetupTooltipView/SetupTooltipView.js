(() => {
  ...
  var __webpack_modules__ = {
        ...
        const o = ({
          ...
          return D().createElement(
            ...
            a.split("\n").map((e, o) =>
              D().createElement(
                "div",
                { className: F()(r.Z.base, t), key: `${e}-${o}` },
      ...
      5528: (u, e, t) => {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(A, D), (u.listeners -= 1), E(), (F = !1));
                    }
                  );
                };
              })(t)),
        ...
        const Au = Object.keys(y).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === y[e]), u),
            {},
          ),
          nu = {
            set: (u, e) => {
        ...
        const au = { view: n, client: F, sound: h, intl: w };
      },
      4020: (u, e, t) => {
        t.d(e, { n: () => E });
        let E = (function (u) {
      ...
      6758: (u, e, t) => {
        ...
        const D = (u) => u.replace(/&nbsp;/g, " "),
          ...
          a = (u, e, t = F.left) => u.split(e).reduce(t === F.left ? r : o, []),
          i = (() => {
            const u = new RegExp(
              [
          ...
          C = (u, e = F.left) => {
            ...
            return ((u, e = F.left) => {
              ...
              const E =
                ...
                A = D(u);
              return (a(A, /( )/, e).forEach((u) => (t = t.concat(a(u, E, F.left)))), t);
            })(u, e);
          },
          s = (u, e, t) =>
      ...
      348: (u, e, t) => {
            ...
            m(() => {
              if (
                ...
                const t = (u) => {
                  ...
                  E = g(u);
                C.current = f.addCallback(E, t, r, e === b.Deep);
              }
            }),
            (0, E.useEffect)(() => {
              if (e !== b.None)
        ...
        const x = {
          ...
          S = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((r = r.replace(t, `%(${D})`)),
                  (n[D] = x[u]
                    ? F().createElement(
                        "span",
                        { className: x[u] },
                        F().createElement(y.z, { text: i, binding: e }),
                      )
                    : F().createElement(
                        "span",
                        { style: A(u) },
            ...
            return F().createElement(y.z, { text: r, classMix: t, binding: n });
          });
        var M = t(5803),
          N = t(5649),
          L = t(235),
        ...
        const U = "Content_base_a8751",
          ...
          $ = "Content_disabledSeparator_cab36",
          j = "Content_content_b3606",
          G = "Content_description_e1bbf",
          q = R.strings.veh_post_progression.setupTooltipView,
          H =
            R.images.gui.maps.icons.vehPostProgression.actionItems.modificationWithFeature
              .c_160x100,
          K = () => {
            ...
            return F().createElement(
              ...
              F().createElement(
                "div",
                { className: I },
                (0, s.uF)(q.title(), { name: q.name.$dyn(t) }),
              ),
              D && F().createElement(N.s, { level: e }),
              F().createElement(
                "div",
                { className: V },
                F().createElement("div", {
              ...
              F().createElement(W.Z, null),
              F().createElement(
                "div",
                { className: j },
                F().createElement(S, { text: String(q.description.$dyn(t)) }),
                F().createElement("div", { className: G }, q.tip()),
              ),
              F().createElement(W.Z, null),
              !n && F().createElement(L.H, { level: e }),
              A &&
                F().createElement(
                  "div",
                  null,
                  !n && F().createElement("div", { className: $ }, F().createElement(W.Z, null)),
                  F().createElement(M.c, null),
                ),
            );
          },
          Y = () => F().createElement(C, null, F().createElement(K, null));
        ...
        const A = "DisabledBlock_base_f4a90",
          ...
          o = () =>
            F().createElement(
              ...
              F().createElement("div", null, r.description()),
            );
      },
      5649: (u, e, t) => {
        t.d(e, { s: () => r });
        ...
        const D = "FeatureLevelSubtitle_level_bd52c",
          r = ({ level: u }) => {
            const e = (0, E.useMemo)(
              () => ({ level: F().createElement("div", { className: D }, (0, A.HG)(u)) }),
              [u],
            );
            return F().createElement(n.z, {
              binding: e,
      ...
      235: (u, e, t) => {
        ...
        const D = "Lock_base_d629d",
          ...
          i = ({ level: u }) => {
            const e = (0, E.useMemo)(
              () => ({ level: F().createElement("div", { className: o }, (0, A.HG)(u)) }),
              [u],
            );
            return F().createElement(
              "div",
              { className: D },
              F().createElement("div", { className: r }, a.title()),
              F().createElement(n.z, { binding: e, text: a.description() }),
            );
          };
      },
      9326: (u, e, t) => {
        ...
        const A = "Separator_base_e9e05",
          n = () => F().createElement("div", { className: A });
      },
      4880: (u, e, t) => {
        t.d(e, { Z: () => E });
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, E) => {
      ...
      E = E || 0;
      for (var r = deferred.length; r > 0 && deferred[r - 1][2] > E; r--)
