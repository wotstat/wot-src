      ...
      264: (u, e, t) => {
        ...
        const S = (u) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: A()(L.goto, null == o ? void 0 : o.goto) }, a),
          );
        };
        var P = t(20),
          I = t(828);
                      ...
                      d = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const n = s(e);
                            if (Array.isArray(u)) {
                              const r = u.reduce((u, e) => ((u[e] = z.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, z.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((u, [e, t]) => ((u[t] = z.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  l.subscribe(
                                    (0, z.aD)((u) => {
        ...
        const oe = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            const a = e.contentId;
            return a
              ? r().createElement(nu, ie({}, e, { contentId: a }), n)
        ...
        const ke = {
            [Te.NBSP]: ye.NoBreakSymbol,
            [Te.ZWNBSP]: ye.NoBreakSymbol,
            [Te.NEW_LINE]: ye.LineBreak,
          },
          ...
          Re = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ...
              : r().createElement(
                  "span",
                  { key: t, "data-block-type": e.blockType, className: Ie },
                  u,
                );
          },
          We = {
            ...
            [ye.NewLine]: ({ elementList: u, key: e }) =>
              r().createElement(
                "span",
                { key: e, "data-block-type": ye.NewLine, className: Pe },
                u,
              ),
                ...
                (u) => {
                  ...
                  r === ye.LineBreak
                    ? n.push(
                        ...((u) => {
                          const e = [
                            { blockType: ye.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
            ...
            return r().createElement(
              ...
              u.hasTradeInWidget.get() &&
                r().createElement(
                  "div",
                  { className: un },
                  r().createElement(jt, { className: en }),
                ),
            );
          }),
          nn = "Title_base_a0e4c",
