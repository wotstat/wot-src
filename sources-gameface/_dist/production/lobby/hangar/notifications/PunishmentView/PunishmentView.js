(() => {
      ...
      799: (e, u, t) => {
        ...
        const ee = (e) => {
          ...
          se = (0, n.memo)(({ id: e, fallback: u, onLoadCallback: t, mixClass: a }) => {
            ...
            return u
              ? r().createElement("div", { className: D }, r().createElement(u, null))
              : null;
          }),
        ...
        const Xe = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          const a = u.contentId;
          return a
            ? r().createElement(fe, Ye({}, u, { contentId: a }), n)
        ...
        const tu = {
            [uu.NBSP]: Je.NoBreakSymbol,
            [uu.ZWNBSP]: Je.NoBreakSymbol,
            [uu.NEW_LINE]: Je.LineBreak,
          },
          ...
          cu = ({ elementList: e, textBlock: u, key: t }) => {
            ...
            return n
              ...
              : r().createElement(
                  "span",
                  { key: t, "data-block-type": u.blockType, className: su },
                  e,
                );
          },
          du = {
            ...
            [Je.NewLine]: ({ elementList: e, key: u }) =>
              r().createElement(
                "span",
                { key: u, "data-block-type": Je.NewLine, className: ou },
                e,
              ),
                ...
                (e) => {
                  ...
                  r === Je.LineBreak
                    ? n.push(
                        ...((e) => {
                          const u = [
                            { blockType: Je.LineBreak, colorTag: "", childList: [e.charAt(0)] },
                          ];
        ...
        const Lu = (e) => {
          ...
          return r().createElement(
            ...
            a &&
              r().createElement("div", { className: F()(xu.goto, null == o ? void 0 : o.goto) }, a),
          );
        };
        let Su = (function (e) {
          return (
        ...
        const Ou = {
          ...
          Mu = (0, n.memo)(
            ({
              ...
              const m = ((e, u) =>
                  Object.keys(u).reduce((u, t) => ((u[t] = e.includes(t)), u), {}))(A, Su),
        ...
        const Vu = () => (e, u) => {
                      ...
                      E = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const n = l(u);
                            if (Array.isArray(e)) {
                              const r = e.reduce((e, u) => ((e[u] = Nu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Nu.aD)((u) => {
                            ...
                            }
                            {
                              const r = e,
                                a = Object.entries(r),
                                i = a.reduce((e, [u, t]) => ((e[t] = Nu.LO.box(n[u], {})), e), {});
                              return (
                                "real" === t &&
                                  s.subscribe(
                                    (0, Nu.aD)((e) => {
                ...
                Iu(u, (e) =>
                  e.path
                    ? r().createElement(
                        ...
                        r().createElement("img", { alt: "bg icon", src: e.path, style: o }),
                      )
                    : null,
                ),
                r().createElement(
                  ...
                  Iu(
                    ...
                    (e) =>
                      ...
                      r().createElement(
                        ...
                        r().createElement("img", { alt: "", src: e.path, style: o }),
                      ),
                  ),
                ),
                Iu(t, (e) =>
                  e.path
                    ? r().createElement(
                        "div",
                        { key: e.path, className: zu.icon },
                        r().createElement("img", { alt: "overlay icon", src: e.path, style: o }),
                      )
                    : null,
                ),
              ),
          ...
          Yu = Vu()(
            ({ observableModel: e }) =>
              Object.assign({}, e.primitives(["title", "text", "infoText"])),
            Ru,
          ),
          Xu = Yu[0],
          Zu = Yu[1],
          ...
          Ju = Qu[0],
          et = Qu[1],
          ut = "WarningTextApp_base_d1aed",
          tt = "WarningTextApp_icon_e78ee",
          nt = (0, Ue.Pi)(() => {
            const e = et().model;
            return r().createElement(
              "div",
          ...
          at = "Content_text_e7386",
          it = "Content_infoText_daa9e",
          ot = ({ text: e, infoText: u }) =>
            r().createElement(
              "div",
              null,
              r().createElement(rt, { resId: R.views.dialogs.widgets.WarningText("resId") }),
              r().createElement(yu, { classMix: at, text: e, justifyContent: eu.Center }),
        ...
        const ct = (0, Ue.Pi)((e) => {
          ...
          return r().createElement(
            Mu,
            lt({ onClose: u, buttons: t, displayFlags: a, isShown: n }, i, {
              ...
              content: r().createElement(ot, { text: o.text.get(), infoText: o.infoText.get() }),
            }),
          );
        });
        engine.whenReady.then(() => {
          L().render(
            r().createElement(
              Xu,
              null,
              r().createElement(T, null, r().createElement(Ge, { Template: ct })),
            ),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [76], () => __webpack_require__(799));
