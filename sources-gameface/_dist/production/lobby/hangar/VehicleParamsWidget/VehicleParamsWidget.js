  ...
  var __webpack_modules__ = {
      ...
      800: (e, u, t) => {
        ...
        const v = {
          ...
          I = (0, s.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = O, onDrag: n = M }) => {
        ...
        const U = g({
          ...
          te = (0, s.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = J, onDrag: n = X }) => {
              const r = (0, s.useRef)(null),
                o = (0, s.useRef)(null),
                E = (0, s.useRef)(null),
                D = (0, s.useRef)(null),
                ...
                g = d(() => {
                  ...
                  return (
                    ...
                    u.classList.add(Y),
                    r.current &&
                      (1 === a ? r.current.classList.add(H) : r.current.classList.remove(H)),
                    a
                  );
                }),
                h = d(() => {
        ...
        const Me = {
            [Oe.NBSP]: Pe.NoBreakSymbol,
            [Oe.ZWNBSP]: Pe.NoBreakSymbol,
            [Oe.NEW_LINE]: Pe.LineBreak,
          },
          xe = {
          ...
          Ve = ({ elementList: e, textBlock: u, key: t }) => {
            ...
            return n
              ? xe[n]
                ...
                : l().createElement(
                    "span",
                    { key: t, "data-block-type": u.blockType, style: ze(n) },
                    e,
                  )
          ...
          Ue = {
            ...
            [Pe.NewLine]: ({ elementList: e, key: u }) =>
              l().createElement(
                "span",
                { key: u, "data-block-type": Pe.NewLine, className: We },
                e,
              ),
        ...
        const ou = {
          ...
          fu = l().memo(function ({
            ...
            const i = n === e ? 2 : (n / u) * 254,
              ...
              A = (0, f.useSpring)(
                Object.assign({ from: { left: 2 }, to: { left: i }, delay: Cu }, d),
              ),
              F = (0, f.useSpring)(
                Object.assign({ from: { width: e }, to: { width: s }, delay: Cu }, d),
              );
            return l().createElement(
              "div",
              { className: Eu },
