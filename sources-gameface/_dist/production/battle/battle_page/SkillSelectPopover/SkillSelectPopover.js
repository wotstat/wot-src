  ...
  var __webpack_modules__ = {
      ...
      1621: (u, e, t) => {
        ...
        const Q = ["__left", "__right", "__top", "__bottom"],
          J = (0, r.forwardRef)(
            (
              { children: u, disableAutoSizeUpdate: e, onOutsideClick: t, customStyles: a = {} },
              i,
            ) => {
        ...
        const Fu = {
          ...
          su = Eu((u) => {
            let e = u.className,
              ...
              S =
                void 0 === x
                  ? (m ? "flex-start" : g && "center") || (p && "flex-end") || void 0
                  : x,
              L = u.alignSelf,
              M = u.wrap,
              O = u.flexWrap,
            ...
            return n().createElement(
              "div",
              ou({ className: h()(iu.base, ...U, e), style: G }, I),
              N,
            );
          });
        let cu;
                      ...
                      D = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const r = o(e);
                            if (Array.isArray(u)) {
                              const n = u.reduce((u, e) => ((u[e] = Gu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Gu.aD)((e) => {
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                E = a.reduce((u, [e, t]) => ((u[t] = Gu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, Gu.aD)((u) => {
