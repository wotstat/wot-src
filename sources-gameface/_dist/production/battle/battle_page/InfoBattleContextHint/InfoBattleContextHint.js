    ...
    e = {
      ...
      239: (u, e, t) => {
              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (D(), window.removeEventListener(E, r), (u.listeners -= 1), A(), (F = !1));
                    }
                  );
                };
              })(t)),
        ...
        const Fu = uu.client.getSize("rem"),
          Eu = Fu.width,
          Du = Fu.height,
          ru = Object.assign({ width: Eu, height: Du }, Au(Eu, Du, eu)),
        ...
        const nu = (u) => {
          ...
          if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
            ...
            if (t.extraLargeWidth && n) return B(e, t, x);
            if (t.largeWidth && C) return B(e, t, x);
            if (t.mediumWidth && l) return B(e, t, x);
            if (t.smallWidth && o) return B(e, t, x);
            if (t.extraSmallWidth && s) return B(e, t, x);
            if (!(
              t.extraLargeWidth ||
              t.largeWidth ||
              t.mediumWidth ||
        ...
        const fu = {
          ...
          pu = (u) => {
            ...
            const F = hu(),
              ...
              D = F.mediaHeight,
              r = F.mediaSize;
            return a().createElement("div", vu({ className: ou()(t, fu[E], wu[D], bu[r]) }, A), e);
          },
          Lu = ["children"];
        const Su = (u) => {
          let e = u.children,
          ...
          return a().createElement(Cu, null, a().createElement(pu, t, e));
        };
        function _u() {
          return !1;
        }
        ...
        const Mu = ((u, e) => {
            ...
            return [
              function ({ mode: A = "real", options: F, children: E, mocks: D }) {
                const i = (0, r.useRef)([]),
                  n = (t, A, F) => {
                    var E;
                    const D = (function ({
                        ...
                        return {
                          ...
                          dispose: function () {
                            for (var u, t = Hu(F.keys()); !(u = t()).done;) E(u.value, e);
                          },
                          unsubscribe: E,
                        };
                      })(A),
                      ...
                      B = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = a(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = Tu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, Tu.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                E = Object.entries(F),
                                D = E.reduce((u, [e, t]) => ((u[t] = Tu.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, Tu.aD)((u) => {
                      ...
                      C = { mode: t, model: B, externalModel: r, cleanup: n };
                    return {
                      model: B,
                  ...
                  l = C[0],
                  o = C[1],
                  s = (0, r.useState)(() => n(A, F, D)),
                  d = s[0],
                  m = s[1];
                return (
                  (0, r.useEffect)(() => {
                    B.current ? m(n(l, F, D)) : (B.current = !0);
                  }, [D, l, F]),
                  (0, r.useEffect)(() => {
                    o(A);
                  }, [A]),
        ...
        const Gu = {
          ...
          AmmoTypeAvailable: {
            text: R.strings.battle_hints.infoBattleContextHint.AmmoTypeAvailable(),
            video: R.videos.battleContextHints.AmmoTypeAvailable(),
          },
        };
        let Pu;
        !(function (u) {
        ...
        const $u = (u, e, t) => {
          ...
          ku = (u, e, t = Pu.left) => u.split(e).reduce(t === Pu.left ? $u : zu, []),
          ju = (() => {
            const u = new RegExp(
            ...
            return Uu.includes(t)
              ...
              : ((u, e = Pu.left) => {
                  ...
                  const A =
                    ...
                    F = u.replace(/&nbsp;/g, " ");
                  return (ku(F, /( )/, e).forEach((u) => (t = t.concat(ku(u, A, Pu.left)))), t);
                })(u, e);
          },
          ...
          Ku = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          Zu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          Ju = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((D = D.replace(t, `%(${E})`)),
                  (F[E] = qu[u]
                    ? a().createElement(
                        "span",
                        { className: qu[u] },
                        a().createElement(Xu, { text: B, binding: e }),
                      )
                    : a().createElement(
                        "span",
                        { style: A(u) },
            ...
            return a().createElement(Xu, { text: D, classMix: t, binding: F });
          }),
          Yu = "App_base_4e",
          ue = "App_video_ef",
          ee = "App_contentInner_e8",
          te = "App_contentInnerClosing_30",
          Ae = "App_content_f5",
        ...
        const ie = (0, Ou.Pi)(() => {
          ...
          return (
            ...
            (0, r.useEffect)(() => {
              ...
              const u = setTimeout(() => {
                const u = l.current;
                (u && (u.removeAttribute("src"), u.load()), E(ae.Idle), t.onHintClosed());
              }, 200);
              return () => clearTimeout(u);
            }, [F]),
            F === ae.Idle
              ...
              : a().createElement(
                  ...
                  a().createElement(
                    ...
                    a().createElement(
                      "div",
                      { className: ou()(ee, { [te]: F === ae.Closing }) },
                      C.video &&
        ...
        engine.whenReady.then(() => {
          n().render(
            a().createElement(Ru, null, a().createElement(Su, null, a().createElement(ie, null))),
  ...
  ((A.m = e),
    ...
    (A.O = (e, t, F, E) => {
      if (!t) {
        ...
        for (n = 0; n < u.length; n++) {
          for (var [t, F, E] = u[n], r = !0, a = 0; a < t.length; a++)
            (!1 & E || D >= E) && Object.keys(A.O).every((u) => A.O[u](t[a]))
              ? t.splice(a--, 1)
              : ((r = !1), E < D && (D = E));
          if (r) {
            u.splice(n--, 1);
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); i < D.length; i++)
            ((E = D[i]), A.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
          return A.O(n);
        },
        t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
    })());
  var F = A.O(void 0, [532], () => A(239));
  F = A.O(F);
})();
