(() => {
              ...
              (e[A] = (function (e) {
                return (A) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (D(), window.removeEventListener(E, r), (u.listeners -= 1), t(), (F = !1));
                    }
                  );
                };
              })(A)),
                      ...
                      i = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const t = a(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = Tu.LO.box(t[e], {})), u), {});
                              return (
                                "real" === A &&
                                  r.subscribe(
                                    (0, Tu.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                E = Object.entries(F),
                                D = E.reduce((u, [e, A]) => ((u[A] = Tu.LO.box(t[e], {})), u), {});
                              return (
                                "real" === A &&
                                  r.subscribe(
                                    (0, Tu.aD)((u) => {
  ...
  ((t.m = e),
    ...
    (t.d = (u, e) => {
      for (var A in e)
        t.o(e, A) && !t.o(u, A) && Object.defineProperty(u, A, { enumerable: !0, get: e[A] });
    }),
    (t.g = (function () {
