  ...
  class l extends HTMLElement {
    ...
    addEventListener(e, t = "_", i = () => {}) {
      e &&
        ...
        this.__eventListeners.push({ el: e, eventName: t, callback: i }));
    }
    __render() {
      const e = this.render(this.__data() || {});
      if (!e || !e.isWGFE)
        return void console.warn("WGFE: WGFE template should be returned from render method");
    ...
    __cleanup() {
      this.children.length &&
        Array.prototype.slice.apply(this.children).forEach((e) => this.removeChild(e));
    }
    render() {
