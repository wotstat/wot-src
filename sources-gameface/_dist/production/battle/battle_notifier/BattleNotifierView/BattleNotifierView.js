              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (r(), window.removeEventListener(E, i), (u.listeners -= 1), A(), (F = !1));
                    }
                  );
                };
              })(t)),
      ...
      8804: (u, e, t) => {
        ...
        const j = R.images.gui.maps.icons.battleNotifier,
          z = {
            ...
            SPG: {
              [g.Victory]: j.SPG_victory(),
              [g.Draw]: j.SPG_draw(),
              [g.Defeat]: j.SPG_defeat(),
            },
          },
          Y = {
          ...
          Z = {
            credits: j.creditsIcon(),
            experience: j.experienceIcon(),
            crystals: j.crystalIcon(),
          },
          X = j.back_shadow(),
          Q = {
