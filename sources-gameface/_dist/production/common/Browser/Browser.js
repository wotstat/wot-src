              ...
              (t[n] = (function (t) {
                return (n) => {
                  ...
                  return (
                    ...
                    () => {
                      a &&
                        (s(), window.removeEventListener(o, c), (e.listeners -= 1), r(), (a = !1));
                    }
                  );
                };
              })(n)),
                      ...
                      _ = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = c(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((e, t) => ((e[t] = b.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  s.subscribe(
                                    (0, b.aD)((t) => {
                            ...
                            }
                            {
                              const a = e,
                                o = Object.entries(a),
                                i = o.reduce((e, [t, n]) => ((e[n] = b.LO.box(r[t], {})), e), {});
                              return (
                                "real" === n &&
                                  s.subscribe(
                                    (0, b.aD)((e) => {
        ...
        const T = "BrowserView_base_6b",
          ...
          U = ({ message: e, className: t, classNames: n }) =>
            a().createElement(
              ...
              { className: S()(x, t) },
              e &&
                a().createElement("div", { className: S()(F, null == n ? void 0 : n.caption) }, e),
