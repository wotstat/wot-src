(() => {
  ...
  var __webpack_modules__ = {
      ...
      551: (u, e, E) => {
        ...
        const a = (u) => u.replace(/&nbsp;/g, " "),
          ...
          C = (u, e, E = r.left) => u.split(e).reduce(E === r.left ? o : i, []),
          s = (() => {
            const u = new RegExp(
              [
          ...
          l = (u, e = r.left) => {
            ...
            return ((u, e = r.left) => {
              ...
              const F =
                ...
                A = a(u);
              return (C(A, /( )/, e).forEach((u) => (E = E.concat(C(u, F, r.left)))), E);
            })(u, e);
          };
        var d = E(828),
          _ = E(609);
        ...
        const w = (u = 1) => {
          ...
          b = (u) => {
            const e = ((u) => {
                ...
                return { modelPrefix: A, modelPath: g(A, u || ""), resId: F };
              })(),
              E = e.modelPrefix,
              F = u.split(".");
            if (F.length > 0) {
              ...
              return (
                F.reduce((e, F) => {
                  const A = p(g(E, `${e}.${F}`), window);
                  return h(A) ? (u.push(A.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                }),
                u.reduce((u, e) => u + "." + e)
              );
            }
            ...
            v(() => {
              if (
                ...
                const E = (u) => {
                  ...
                  F = b(u);
                C.current = y.addCallback(F, E, r, e === x.Deep);
              }
            }),
            (0, F.useEffect)(() => {
              if (e !== x.None)
                return () => {
                  y.removeCallback(C.current, r);
                };
            }, [r, e]),
            o
          );
        ...
        function P(u) {
          ...
          return function (E) {
            ...
            e.run(() => {
              ((F.style.width = `${F.clientWidth}rem`),
                (F.style.height = `${F.clientHeight}rem`),
                null == u || u(F.clientWidth, F.clientHeight));
            });
          };
        }
        var S = E(849),
          M = E.n(S);
        const L = "FormatText_base_f27a4",
          N = ({
            binding: u,
            text: e = "",
            classMix: E,
          ...
          U = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          V = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          z = (0, F.memo)(({ text: u, binding: e, classMix: E }) => {
                ...
                ((r = r.replace(E, `%(${n})`)),
                  (D[n] = W[u]
                    ? A().createElement(
                        "span",
                        { className: W[u] },
                        A().createElement(N, { text: o, binding: e }),
                      )
                    : A().createElement(
                        "span",
                        { style: t(u) },
            ...
            return A().createElement(N, { text: r, classMix: E, binding: D });
          }),
          $ = "Icon_base_bfe62",
          j = (0, F.memo)(({ src: u, classMix: e, style: E }) => {
            ...
            return A().createElement(
              "div",
              { className: t, style: E },
              A().createElement("img", { alt: "icon", src: u, onLoad: F }),
            );
          }),
          ...
          H = ({ path: u, modelAdapter: e = K }) => {
            ...
            return A().createElement(
              "div",
              { className: q },
              A().createElement(z, { classMix: G, text: t, binding: r }),
            );
          },
                ...
                e.map(
                  ({ value: u }) =>
                    ...
                    A().createElement(
                      ...
                      A().createElement("img", { alt: "bg icon", src: u.path, style: n }),
                    ),
                ),
                A().createElement(
                  "div",
                  ...
                  t.map(
                    ({ value: u }, e) =>
                      ...
                      A().createElement(
                        ...
                        A().createElement("img", { alt: "icon", src: u.path, onLoad: D }),
                        u.iconLabel &&
                          A().createElement(
                            "div",
                            { className: Q },
                ...
                E.map(
                  ({ value: u }) =>
                    ...
                    A().createElement(
                      "div",
                      { key: u.path, className: uu },
                      A().createElement("img", { alt: "overlay icon", src: u.path, style: n }),
                    ),
                ),
              ),
            );
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [573], () => __webpack_require__(551));
