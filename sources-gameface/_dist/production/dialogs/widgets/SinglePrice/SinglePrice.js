              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      F &&
                        (n(), window.removeEventListener(E, r), (u.listeners -= 1), A(), (F = !1));
                    }
                  );
                };
              })(t)),
      ...
      437: (u, e, t) => {
                      ...
                      a = u({
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            const A = o(e);
                            if (Array.isArray(u)) {
                              const F = u.reduce((u, e) => ((u[e] = I.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, I.aD)((e) => {
                            ...
                            }
                            {
                              const F = u,
                                E = Object.entries(F),
                                n = E.reduce((u, [e, t]) => ((u[t] = I.LO.box(A[e], {})), u), {});
                              return (
                                "real" === t &&
                                  r.subscribe(
                                    (0, I.aD)((u) => {
        ...
        const Y = (0, v.Pi)(function ({ tooltipRootId: u }) {
          ...
          return F().createElement(
            ...
            F().createElement(
              "div",
              { className: K.text },
              F().createElement(M, { text: e.text.get() }),
            ),
            F().createElement(
              d,
              H({}, t, { targetId: u }),
        ...
        F().memo(function ({ rootId: u = R.views.dialogs.widgets.SinglePrice("resId") }) {
          return F().createElement(
            z,
            { options: { rootId: u } },
            F().createElement(Y, { tooltipRootId: u }),
          );
        });
      },
    },
