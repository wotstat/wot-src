              ...
              (e[t] = (function (e) {
                return (t) => {
                  ...
                  return (
                    ...
                    () => {
                      r &&
                        (F(), window.removeEventListener(E, A), (u.listeners -= 1), n(), (r = !1));
                    }
                  );
                };
              })(t)),
      ...
      382: (u, e, t) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, e) => {
                            ...
                            }
                            {
                              const r = u,
                                E = Object.entries(r),
                                F = E.reduce((u, [e, t]) => ((u[t] = W.LO.box(n[e], {})), u), {});
                              return (
                                "real" === t &&
                                  A.subscribe(
                                    (0, W.aD)((u) => {
        ...
        const Y = (0, _.Pi)(function ({ tooltipRootId: u }) {
          ...
          return r().createElement(
            ...
            r().createElement(
              "div",
              { className: K.text },
              r().createElement(L, { text: e.text.get() }),
            ),
            r().createElement(
              l,
              H({}, t, { targetId: u }),
        ...
        r().memo(function ({ rootId: u = R.views.dialogs.widgets.SinglePrice("resId") }) {
          return r().createElement(
            G,
            { options: { rootId: u } },
            r().createElement(Y, { tooltipRootId: u }),
          );
        });
      },
      363: (u) => {
