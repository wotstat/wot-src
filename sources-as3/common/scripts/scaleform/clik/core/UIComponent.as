package scaleform.clik.core
{
   ...
   public class UIComponent extends MovieClip implements IUIComponent
   {
      ...
      {
         if(Boolean(App.tutorialMgr.isSystemEnabled))
         {
      ...
      final protected function cancelValidation(param1:String) : void
      {
      ...
      protected function isInvalidTypes(... rest) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(Boolean(this._invalidHash[rest[_loc3_]]))
            {
               return true;
            }
            _loc3_++;
      ...
      protected function getInvalid() : String
      {
         ...
         {
            if(!Boolean(_loc2_.indexOf(_loc4_)))
            {
      ...
      final public function dispose() : void
      {
         ...
         if(Boolean(App.instance) && Boolean(App.utils))
         {
            ...
            if(Boolean(_loc1_) && _loc1_.getFocus(0) == this)
            {
      ...
      {
         var _loc1_:String = null;
         if(this._baseDisposed && Boolean(App.instance))
         {
