   ...
   public class Layout extends Sprite
   {
      ...
      public function reflow() : void
      {
         ...
         while(_loc1_ < this._managedSprites.length)
         {
            ...
            _loc6_ = this._tiedToStageSize && _loc3_.offsetHashH[this._aspectRatio] != undefined ? Number(_loc3_.offsetHashH[this._aspectRatio]) : _loc3_.offsetH;
            _loc7_ = this._tiedToStageSize && _loc3_.offsetHashV[this._aspectRatio] != undefined ? Number(_loc3_.offsetHashV[this._aspectRatio]) : _loc3_.offsetV;
