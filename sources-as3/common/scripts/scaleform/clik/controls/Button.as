   ...
   public class Button extends UIComponent
   {
      ...
      override protected function draw() : void
      {
         if(isInvalid(InvalidationType.STATE))
         {
            ...
            if(Boolean(this.focusIndicator) && Boolean(this._newFocusIndicatorFrame))
            {
      ...
      override protected function changeFocus() : void
      {
         ...
         else
         {
            ...
            else
            {
               ...
               if(Boolean(this._focusIndicatorLabelHash[_loc1_]))
               {
      ...
      protected function handleRepeat(param1:TimerEvent) : void
      {
         ...
         if(Boolean(this._autoRepeatEvent))
         {
