package scaleform.clik.controls
{
   ...
   public class NumericStepper extends UIComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this._newFrame) && this._newFrame != this._oldState)
            {
      ...
      {
         return Math.max(this._minimum,Math.min(this._maximum,this.stepSize * Math.round(param1 / this.stepSize)));
      }
   }
}
