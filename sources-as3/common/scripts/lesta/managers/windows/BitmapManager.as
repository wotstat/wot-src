...
class BitmapWrapper
{
   ...
   public function BitmapWrapper(param1:String)
   {
      super();
      this.imageId = param1;
   ...
   private function onLoad(param1:Event) : void
   {
      ...
      while(Boolean(this.onLoadCallbackList.length))
      {
   ...
   private function onFail(param1:Event) : void
   {
      this.loader.contentLoaderInfo.removeEventListener(Event.COMPLETE,this.onLoad);
      this.loader.contentLoaderInfo.removeEventListener(IOErrorEvent.IO_ERROR,this.onFail);
      while(Boolean(this.onFailCallbackList.length))
      {
   ...
   public function unload(param1:Function) : void
   {
      var _loc2_:int = 0;
      --this.counter;
      if(Boolean(this.onLoadCallbackList))
      {
         _loc2_ = int(this.onLoadCallbackList.indexOf(param1));
         if(_loc2_ > -1)
         {
