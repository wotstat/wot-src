package com.gskinner.motion.plugins
{
   ...
   public class ColorTransformPlugin
   {
      ...
      public static function tween(param1:GTween, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Boolean) : Number
      {
         ...
         if(param2 == "tint")
         {
            _loc9_ = uint(param4 >> 24 & 0xFF);
            _loc10_ = uint(param4 >> 16 & 0xFF);
            _loc11_ = uint(param4 >> 8 & 0xFF);
            _loc12_ = uint(param4 & 0xFF);
            _loc13_ = uint(param4 + param5 >> 0);
            _loc14_ = _loc9_ + param6 * ((_loc13_ >> 24 & 0xFF) - _loc9_);
            _loc15_ = _loc10_ + param6 * ((_loc13_ >> 16 & 0xFF) - _loc10_);
            _loc16_ = _loc11_ + param6 * ((_loc13_ >> 8 & 0xFF) - _loc11_);
            _loc17_ = _loc12_ + param6 * ((_loc13_ & 0xFF) - _loc12_);
