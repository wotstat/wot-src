...
class AbstractEntrySet extends AbstractSet
{
   ...
   public function AbstractEntrySet(param1:Map)
   {
      super();
      this.m = param1;
   }
...
final class CollectionImpl extends AbstractCollection
{
   ...
   public function CollectionImpl(param1:Map)
   {
      super();
      this.map = param1;
   }
...
class KeyIterator implements Iterator
{
   ...
   public function KeyIterator(param1:Iterator)
   {
      super();
      this.iter = param1;
   }
...
final class ValueIterator extends KeyIterator
{
   ...
   public function ValueIterator(param1:Iterator)
   {
      super(param1);
   }
