package net.wg.infrastructure.base.meta.impl
{
   ...
   public class TutorialManagerMeta extends BaseDAAPIModule
   {
      ...
      final public function as_setTriggers(param1:String, param2:Array) : void
      {
      ...
      final public function as_showEffect(param1:String, param2:String, param3:String, param4:Object) : void
      {
      ...
      final public function as_externalComponentFound(param1:String, param2:String, param3:Object) : void
      {
      ...
      final public function as_updateExternalComponent(param1:String, param2:String, param3:Object) : void
      {
