package net.wg.infrastructure.managers.utils.impl
{
   ...
   public class CommonsLobby extends CommonsBase
   {
      ...
      override public function formatPlayerName(param1:TextField, param2:IUserProps, param3:Boolean = false, param4:Boolean = false) : Boolean
      {
         ...
         var _loc16_:String = Boolean(param2.isAnonymized) && param4 ? Values.SPACE_STR + IMG_TAG_EYE_ICON : Values.EMPTY_STR;
         if(Boolean(param2.isAnonymized) && param3)
         {
      ...
      {
         if(Boolean(param1.isAnonymized) && param2)
         {
