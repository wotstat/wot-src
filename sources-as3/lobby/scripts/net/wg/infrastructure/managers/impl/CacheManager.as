package net.wg.infrastructure.managers.impl
{
   ...
   public class CacheManager extends CacheManagerMeta implements ICacheManager
   {
      ...
      {
         var _loc1_:int = int(this.cachedEntities.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function isCached(param1:String) : Boolean
      {
         ...
         var _loc2_:int = int(this.cachedEntities.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function freeByIdle(param1:int, param2:int = 0) : Boolean
      {
         ...
         var _loc6_:int = int(this.cachedEntities.length);
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:int = int(this.cachedEntities.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
...
class CacheSettings
{
   ...
   public var excluded:Vector.<String> = new Vector.<String>(0);
   
   public var logging:Boolean = false;
   
   public function CacheSettings(param1:Object)
   {
      super();
      if(Boolean(param1))
      {
...
class CacheEntity
{
   ...
   public function CacheEntity(param1:String, param2:Loader, param3:Class = null)
   {
      super();
      this.url = param1;
      this._priority = 0;
...
class CacheStats
{
   ...
   public function CacheStats(param1:CacheManager)
   {
      super();
   ...
   public function logSettings() : void
   {
      ...
      if(Boolean(this.cacheManager.settings))
      {
   ...
   public function logSnapshots() : void
   {
      var _loc3_:int = 0;
      var _loc1_:String = "";
      var _loc2_:int = int(this.snapshots.length);
      if(_loc2_ > 0)
      {
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
