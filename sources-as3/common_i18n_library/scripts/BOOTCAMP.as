package
{
   public class BOOTCAMP
   {
      ...
      public static const COMPLETIONWITHOUTVICTORY_2:String = "#bootcamp:completionWithoutVictory/2";
      
      public static const COMPLETIONWITHOUTVICTORY_3:String = "#bootcamp:completionWithoutVictory/3";
      
      public static const COMPLETIONWITHOUTVICTORY_4:String = "#bootcamp:completionWithoutVictory/4";
      
      public static const COMPLETIONWITHOUTVICTORY_5:String = "#bootcamp:completionWithoutVictory/5";
      ...
      public static const RESULTLABEL_COMPLETE:String = "#bootcamp:resultlabel/complete";
      ...
      public static const TOOLTIP_PROGRESSION_STATUS_WAIT:String = "#bootcamp:tooltip/progression/status/wait";
      
      public static const TOOLTIP_PROGRESSION_STATUS_WAIT_BC_COMPLETED:String = "#bootcamp:tooltip/progression/status/wait/bc_completed";
      
      public static const TOOLTIP_PROGRESSION_LABEL_LESSON_1:String = "#bootcamp:tooltip/progression/label/lesson_1";
      
      public static const TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_1:String = "#bootcamp:tooltip/progression/description/lesson_1";
      ...
      public static const TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_3:String = "#bootcamp:tooltip/progression/description/lesson_3";
      
      public static const TOOLTIP_PROGRESSION_LABEL_LESSON_4:String = "#bootcamp:tooltip/progression/label/lesson_4";
      ...
      public static const TOOLTIP_PROGRESSION_STATUS_IN_PROGRESS:String = "#bootcamp:tooltip/progression/status/in_progress";
      
      public static const TOOLTIP_PROGRESSION_STATUS_COMPLETED:String = "#bootcamp:tooltip/progression/status/completed";
      ...
      public static const PROGRESS_WIDGET_TITLE:String = "#bootcamp:progress/widget/title";
      
      public static const PROGRESS_WINDOW_TITLE:String = "#bootcamp:progress/window/title";
      
      public static const PROGRESS_WINDOW_DESCRIPTION:String = "#bootcamp:progress/window/description";
      
      public static const PROGRESS_WINDOW_EXIT:String = "#bootcamp:progress/window/exit";
      
      public static const PROGRESS_REWARDS_TAKEN_SHORT:String = "#bootcamp:progress/rewards/taken_short";
      
      public static const PROGRESS_REWARDS_TAKEN:String = "#bootcamp:progress/rewards/taken";
      
      public static const EXITWINDOW_TITLE:String = "#bootcamp:exitWindow/title";
      
      public static const EXITWINDOW_DESCRIPTION:String = "#bootcamp:exitWindow/description";
      
      public static const EXITWINDOW_REFERRAL_DESCRIPTION:String = "#bootcamp:exitWindow/referral/description";
