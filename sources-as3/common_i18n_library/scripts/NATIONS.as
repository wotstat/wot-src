package
{
   public class NATIONS
   {
      ...
      public static const INTUNION:String = "#nations:intunion";
      ...
      public static const INTUNION_GENETIVECASE:String = "#nations:intunion/genetiveCase";
      
      public static const ALL_GENETIVECASE_ENUM:Array = [USSR_GENETIVECASE,GERMANY_GENETIVECASE,USA_GENETIVECASE,CHINA_GENETIVECASE,FRANCE_GENETIVECASE,UK_GENETIVECASE,JAPAN_GENETIVECASE,CZECH_GENETIVECASE,SWEDEN_GENETIVECASE,POLAND_GENETIVECASE,ITALY_GENETIVECASE,INTUNION_GENETIVECASE];
      
      public static const ALL_ENUM:Array = [USSR,GERMANY,USA,FRANCE,UK,JAPAN,CZECH,CHINA,POLAND,SWEDEN,ITALY,INTUNION,USSR_GENETIVECASE,GERMANY_GENETIVECASE,USA_GENETIVECASE,CHINA_GENETIVECASE,FRANCE_GENETIVECASE,UK_GENETIVECASE,JAPAN_GENETIVECASE,CZECH_GENETIVECASE,SWEDEN_GENETIVECASE,POLAND_GENETIVECASE,ITALY_GENETIVECASE,INTUNION_GENETIVECASE];
