package net.wg.white_tiger.gui.battle.views.wtBattleTimer
{
   ...
   public class WTBattleTimer extends WTBattleTimerMeta implements IWTBattleTimerMeta
   {
      ...
      private function addMainTextGlitch() : void
      {
         ...
         var _loc1_:Number = this._filterCounter < ADD_TIME_GLOW_ALPHA_SHOW ? this._filterCounter / ADD_TIME_GLOW_ALPHA_SHOW : 1;
         var _loc2_:uint = this._isBoss ? COLOR_ADD_TIME_MAIN_BOSS : COLOR_ADD_TIME_MAIN_HUNTER;
