package net.wg.white_tiger.gui.battle.views.battleTimer
{
   ...
   public class WhiteTigerBattleTimer extends WhiteTigerBattleTimerMeta implements IWhiteTigerBattleTimerMeta, IBattleTimerMeta
   {
      ...
      private var _tweensMessage:Vector.<Tween> = new Vector.<Tween>();
      
      private var _tweensCommon:Vector.<Tween> = new Vector.<Tween>();
      ...
      public function updateStage(param1:Boolean = false) : void
      {
         ...
         if(this._isSmall != _loc2_ || param1)
         {
            ...
            _loc3_ = int(this.addTimeContainer.currentFrame);
            ...
            this.messageContainer.y = this._isSmall ? MESSAGE_Y_SMALL : MESSAGE_Y_BIG;
      ...
      private function addMainTextGlitch() : void
      {
         ...
         this._filterAlphaGlowDelta = this._filterCounter < ADD_TIME_GLOW_ALPHA_SHOW ? this._filterCounter / ADD_TIME_GLOW_ALPHA_SHOW : 1;
         var _loc1_:uint = this._isBoss ? COLOR_ADD_TIME_MAIN_BOSS : COLOR_ADD_TIME_MAIN_HUNTER;
