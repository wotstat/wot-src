package net.wg.white_tiger.gui.battle.views.wtHunterRespawn
{
   ...
   public class WTHunterRespawnView extends WTHunterRespawnViewMeta implements IWTHunterRespawnViewMeta, ITimerAnimation
   {
      ...
      private var _titleTextFormatBig:TextFormat = new TextFormat();
      
      private var _titleTextFormatSmall:TextFormat = new TextFormat();
      ...
      override protected function draw() : void
      {
         ...
         var _loc7_:int = 0;
         super.draw();
         if(Boolean(minimap) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            ...
            this.timerAnim.scaleX = this.timerAnim.scaleY = _loc1_ ? TIMER_SMALL_SCALE : TIMER_LARGE_SCALE;
            this.timerAnim.x = stageWidth >> 1;
            this.titleTF.x = stageWidth - this.titleTF.width >> 1;
            this.hint.x = stageWidth - this.hint.width >> 1;
            _loc2_ = _loc1_ ? CONTENT_HEIGHT_SMALL : CONTENT_HEIGHT_BIG;
            ...
            _loc6_ = _loc1_ ? MINIMAP_OFFSET_X_SMALL : MINIMAP_OFFSET_X_BIG;
