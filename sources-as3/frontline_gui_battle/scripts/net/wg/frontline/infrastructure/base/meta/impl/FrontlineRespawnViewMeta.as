package net.wg.frontline.infrastructure.base.meta.impl
{
   ...
   public class FrontlineRespawnViewMeta extends BattleDisplayable
   {
      ...
      public function FrontlineRespawnViewMeta()
      {
         super();
      }
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorRespawnPointVO))
         {
      ...
      final public function as_setRespawnLocations(param1:Array) : void
      {
