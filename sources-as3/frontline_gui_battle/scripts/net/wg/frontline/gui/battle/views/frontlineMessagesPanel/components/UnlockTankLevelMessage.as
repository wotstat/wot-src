package net.wg.frontline.gui.battle.views.frontlineMessagesPanel.components
{
   ...
   public class UnlockTankLevelMessage extends MessageContainerBase
   {
      
      private static const ERROR_CONVERTING_VO:String = "[UnlockTankLevelMessage] setData object was not in correct structure, could not convert to proper VO";
      
      public var mainTextMc:MovieClip = null;
      
      public function UnlockTankLevelMessage()
      {
         super();
      }
