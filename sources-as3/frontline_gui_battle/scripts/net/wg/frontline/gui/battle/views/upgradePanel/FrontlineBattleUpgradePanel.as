package net.wg.frontline.gui.battle.views.upgradePanel
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineBattleUpgradePanelMeta;
   ...
   public class FrontlineBattleUpgradePanel extends FrontlineBattleUpgradePanelMeta implements IFrontlineBattleUpgradePanelMeta
   {
      ...
      private static const BG_SIDE_MARGIN:int = 12;
      
      private static const BG_BOTTOM_MARGIN:int = 25;
      
      private static const DESCRIPTION_TF_MARGIN:int = 5;
      ...
      public var choicePanel:FrontlineChoiceInfoPanel = null;
      ...
      private var _data:FrontlineUpgradePanelVO = null;
      ...
      public function FrontlineBattleUpgradePanel()
      {
         super();
      }
      ...
      {
         super.configUI();
         this.choicePanel.addEventListener(FrontlineChoiceInfoPanel.SELECT_ANIM_COMPLETE,this.onChoiceInfoPanelAnimCompleteHandler);
      ...
      override protected function setData(param1:FrontlineUpgradePanelVO) : void
      {
         this._data = param1;
      ...
      override protected function onDispose() : void
      {
         ...
         this.choicePanel.removeEventListener(FrontlineChoiceInfoPanel.SELECT_ANIM_COMPLETE,this.onChoiceInfoPanelAnimCompleteHandler);
      ...
      private function updateLayout() : void
      {
         ...
         this.descriptionTF.y = this.choicePanel.y + this.bg.height + DESCRIPTION_TF_MARGIN;
      }
      
      override public function set visible(param1:Boolean) : void
      {
         super.visible = param1 && Boolean(_isCompVisible);
      }
      ...
      private function onChoicePanelModuleOverHandler(param1:ModuleConfiguratorEvent) : void
      {
         ...
         if(this.state == STATE_ACTIVE && Boolean(this.choicePanel.visible))
         {
