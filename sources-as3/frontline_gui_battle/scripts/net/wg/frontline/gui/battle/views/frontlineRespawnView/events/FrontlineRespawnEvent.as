package net.wg.frontline.gui.battle.views.frontlineRespawnView.events
{
   import flash.events.Event;
   
   public class FrontlineRespawnEvent extends Event
   {
      ...
      public function FrontlineRespawnEvent(param1:String, param2:int = -1, param3:Boolean = false, param4:Boolean = false)
      {
      ...
      {
         return new FrontlineRespawnEvent(type,this._locationIdx,bubbles,cancelable);
      }
   }
}
