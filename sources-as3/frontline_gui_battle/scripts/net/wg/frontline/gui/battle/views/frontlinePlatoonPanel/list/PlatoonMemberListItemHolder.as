package net.wg.frontline.gui.battle.views.frontlinePlatoonPanel.list
{
   ...
   public class PlatoonMemberListItemHolder implements IDisposable
   {
      ...
      private function applyVehicleData() : void
      {
         ...
         if(Boolean(this._vehicleData.vehicleAction))
         {
         ...
         this.applyUserTags();
         this.updateUserProps();
         if(this._isCurrPlayer && Boolean(this._vehicleData.isAlive()))
         {
      ...
      {
         var _loc1_:uint = uint(this._vehicleData.playerStatus);
      ...
      {
         return Boolean(this._vehicleData) ? Number(this._vehicleData.vehicleID) : NaN;
      }
      
      public function get accountDBID() : Number
      {
         return Boolean(this._vehicleData) ? Number(this._vehicleData.accountDBID) : NaN;
      }
