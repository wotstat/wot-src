package net.wg.frontline.gui.battle.views.stats.renderers
{
   ...
   public class FrontlineStatsPlayerRenderer extends BattleUIComponent implements IListItemRenderer
   {
      ...
      private var _epicData:FrontlineVehicleStatsVO = null;
      ...
      public function FrontlineStatsPlayerRenderer()
      {
         super();
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this._vehicleAction))
            {
      ...
      {
         return Boolean(this._data) ? int(this._data.accountDBID) : -1;
      }
      ...
      public function setEpicData(param1:FrontlineVehicleStatsVO) : void
      {
         var _loc2_:Boolean = false;
         if(Boolean(param1))
         {
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._data.suffixBadgeType));
      ...
      private function vehicleDataSync() : void
      {
         if(Boolean(this._data))
         {
            ...
            this.selfBg.visible = Boolean(this._data) ? Boolean(PlayerStatus.isSelected(this._data.playerStatus)) : false;
            if(Boolean(this._squadItem))
            {
               ...
               if(this._isCurrentPlayer && Boolean(this._data.isAnonymized))
               {
         ...
         else if(Boolean(this._squadItem))
         {
      ...
      private function applyUserTags(param1:DAAPIVehicleInfoVO) : void
      {
         ...
         if(Boolean(this._squadItem) && this._isCurrentPlayer)
         {
      ...
      {
         var _loc2_:uint = uint(param1.playerStatus);
      ...
      {
         var _loc2_:uint = uint(DynamicSquadState.getState(param1));
      ...
      {
         var _loc2_:FrontlineFullStatsRendererEvent = new FrontlineFullStatsRendererEvent(FrontlineFullStatsRendererEvent.RENDERER_CLICKED,this._data.vehicleID,param1);
