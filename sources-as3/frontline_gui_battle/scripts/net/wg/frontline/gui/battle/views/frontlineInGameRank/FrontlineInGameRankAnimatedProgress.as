package net.wg.frontline.gui.battle.views.frontlineInGameRank
{
   ...
   public class FrontlineInGameRankAnimatedProgress extends BattleUIComponent
   {
      ...
      public function FrontlineInGameRankAnimatedProgress()
      {
         super();
      ...
      {
         dispatchEvent(new FrontlineInGameRankEvent(FrontlineInGameRankEvent.LEVEL_UP_ANIMATION_COMPLETE));
      }
