package net.wg.frontline.gui.battle.views.frontlineMissionsPanel.components
{
   ...
   public class FrontlineMissionsAnimatedMarker extends BattleUIComponent
   {
      ...
      public function FrontlineMissionsAnimatedMarker()
      {
         super();
