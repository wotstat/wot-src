package net.wg.frontline.gui.battle.views.stats.components
{
   ...
   public class FrontlineFullStatsTableCtrl extends FrontlineStatsDataProviderBaseCtrl implements ISquadHandler
   {
      ...
      private var _table:FrontlineFullStatsTable = null;
      
      private var _squadHandler:FrontlineFullStats = null;
      ...
      public function FrontlineFullStatsTableCtrl(param1:FrontlineFullStatsTable, param2:FrontlineFullStats)
      {
         super();
         this._table = param1;
      ...
      override public function setEpicVehiclesStats(param1:Boolean, param2:Vector.<FrontlineVehicleStatsVO>, param3:Vector.<Number>) : void
      {
      ...
      {
         var _loc4_:FrontlineVehicleDataProvider = null;
         ...
         _loc5_.visible = true;
         if(Boolean(_loc5_.dataProvider))
         {
      ...
      {
         var _loc4_:FrontlineStatsPlayerRenderer = null;
         var _loc2_:int = -1;
         var _loc3_:Boolean = false;
         var _loc5_:int = int(this._table.team1PlayerList.rowCount);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc4_ = this._table.team1PlayerList.getRendererAt(_loc6_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc4_) && _loc4_.squadItem == param1)
            {
               _loc2_ = _loc6_;
               break;
            }
         ...
         _loc5_ = int(this._table.team2PlayerList.rowCount);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_)
         {
            _loc4_ = this._table.team2PlayerList.getRendererAt(_loc7_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc4_) && _loc4_.squadItem == param1)
            {
               _loc2_ = _loc7_;
               _loc3_ = true;
      ...
      {
         var _loc3_:FrontlineStatsPlayerRenderer = null;
      ...
      {
         var _loc2_:FrontlineStatsPlayerRenderer = null;
         var _loc1_:int = int(this._table.team1PlayerList.rowCount);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_)
         {
            _loc2_ = this._table.team1PlayerList.getRendererAt(_loc3_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc2_))
            {
               _loc2_.updateColorBlind();
            }
            _loc3_++;
         }
         _loc1_ = int(this._table.team2PlayerList.rowCount);
         _loc3_ = 0;
         while(_loc3_ < _loc1_)
         {
            _loc2_ = this._table.team2PlayerList.getRendererAt(_loc3_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc2_))
            {
               _loc2_.updateColorBlind();
            }
      ...
      {
         var _loc3_:FrontlineVehicleDataProvider = param1 ? enemyDP : teamDP;
      ...
      private function getRendererByAccountId(param1:Boolean, param2:int) : FrontlineStatsPlayerRenderer
      {
         var _loc3_:PlayerScrollingList = param1 ? this._table.team2PlayerList : this._table.team1PlayerList;
         var _loc4_:int = int(_loc3_.rowCount);
         var _loc5_:int = _loc3_.scrollPosition;
         var _loc6_:FrontlineStatsPlayerRenderer = null;
         var _loc7_:int = _loc5_;
         while(_loc7_ < _loc4_)
         {
            _loc6_ = _loc3_.getRendererAt(_loc7_) as FrontlineStatsPlayerRenderer;
      ...
      private function getRendererIfInRange(param1:PlayerScrollingList, param2:int, param3:FrontlineVehicleStatsVO) : FrontlineStatsPlayerRenderer
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this._filteringActive)
         {
            if(Boolean(param3) && param3.lane != this._currentLane)
            {
               return null;
            }
            ...
            if(_loc4_ >= 0)
            {
               return param1.getRendererAt(_loc4_) as FrontlineStatsPlayerRenderer;
            }
            return null;
         }
         ...
         {
            return param1.getRendererAt(_loc5_) as FrontlineStatsPlayerRenderer;
         }
         return null;
      }
      ...
      public function set isRenderingAvailable(param1:Boolean) : void
      {
         ...
         this.sortingIfVisible();
         var _loc3_:int = int(this._table.team2PlayerList.rowCount);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_ = this._table.team2PlayerList.getRendererAt(_loc4_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc2_))
            {
         ...
         _loc3_ = int(this._table.team1PlayerList.rowCount);
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_ = this._table.team1PlayerList.getRendererAt(_loc4_) as FrontlineStatsPlayerRenderer;
            if(Boolean(_loc2_))
            {
               _loc2_.isRenderingAvailable = param1;
            }
      ...
      override protected function updateTeamDPItems(param1:ListDataProviderEvent) : void
      {
         ...
         var _loc7_:FrontlineVehicleStatsVO = null;
         var _loc8_:FrontlineStatsPlayerRenderer = null;
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(Boolean(_loc6_))
            {
               ...
               if(Boolean(_loc7_))
               {
                  ...
                  if(Boolean(_loc8_))
                  {
                     if(Boolean(this._activePlayerData))
                     {
