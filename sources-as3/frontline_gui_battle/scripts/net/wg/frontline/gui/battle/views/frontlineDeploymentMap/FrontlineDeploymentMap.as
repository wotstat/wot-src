package net.wg.frontline.gui.battle.views.frontlineDeploymentMap
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineDeploymentMapMeta;
   import net.wg.gui.components.controls.UILoaderAlt;
   import net.wg.infrastructure.events.LifeCycleEvent;
   
   public class FrontlineDeploymentMap extends FrontlineDeploymentMapMeta implements IFrontlineDeploymentMapMeta
   {
      ...
      public var mapContainer:FrontlineMapContainer = null;
      ...
      public function FrontlineDeploymentMap()
      {
         super();
         var _loc1_:FrontlineDeploymentMapEntriesContainer = this.mapContainer.entriesContainer;
      ...
      {
         this.mapContainer.removeEventListener(FrontlineDeploymentMapEvent.MAP_CLICKED,this.onDeploymentMapClickedHandler);
      ...
      override protected function configUI() : void
      {
         ...
         this.mapContainer.addEventListener(FrontlineDeploymentMapEvent.MAP_CLICKED,this.onDeploymentMapClickedHandler);
      }
      ...
      public function activeInLoadingScreen(param1:Boolean, param2:int, param3:int) : void
      {
         ...
         var _loc4_:FrontlineDeploymentMapEntriesContainer = this.mapContainer.entriesContainer;
      ...
      private function onDeploymentMapClickedHandler(param1:FrontlineDeploymentMapEvent) : void
      {
