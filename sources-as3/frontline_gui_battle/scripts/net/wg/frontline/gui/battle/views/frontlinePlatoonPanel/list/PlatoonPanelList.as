package net.wg.frontline.gui.battle.views.frontlinePlatoonPanel.list
{
   ...
   public class PlatoonPanelList extends Sprite implements IDisposable
   {
      ...
      {
         if(Boolean(this._totalOrder))
         {
            this.updateOrder(this._totalOrder);
         }
      }
      
      public function setEpicVehiclesStats(param1:FrontlineVehicleStatsVO) : Boolean
      {
      ...
      {
         var _loc2_:PlatoonMemberListItemRenderer = App.utils.classFactory.getComponent(FrontlineLinkages.PLATOON_MEMBER_LIST_ITEM_UI,PlatoonMemberListItemRenderer);
         ...
         var _loc4_:Number = Number(param1.vehicleID);
