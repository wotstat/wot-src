package net.wg.frontline.gui.battle.views.upgradePanel
{
   ...
   public class FrontlineChoiceInfoPanel extends UIComponent
   {
      ...
      public var firstInfoForSelect:FrontlineModuleInfo = null;
      
      public var secondInfoForSelect:FrontlineModuleInfo = null;
      ...
      public function FrontlineChoiceInfoPanel()
      {
         super();
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SETTINGS))
         {
            ...
            this.firstInfoForSelect.initSettings(FrontlineModuleInfo.TEXT_ORIENTATION_LEFT,this._isBig,0,this._leftHitMc);
            this.secondInfoForSelect.initSettings(FrontlineModuleInfo.TEXT_ORIENTATION_RIGHT,this._isBig,1,this._rightHitMc);
         }
      }
      ...
      public function setData(param1:FrontlineChoiceInfoPanelVO) : void
      {
         this._availableModules.splice(0,this._availableModules.length);
      ...
      {
         var _loc2_:FrontlineModuleInfo = null;
         this.clearSelectAnim();
         if(param1 == 0)
         {
      ...
      private function clearTweens() : void
      {
         ...
         if(Boolean(this._tweens.length))
         {
