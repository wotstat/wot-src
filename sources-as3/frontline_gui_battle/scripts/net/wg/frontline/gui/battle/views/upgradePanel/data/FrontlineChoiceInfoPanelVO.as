package net.wg.frontline.gui.battle.views.upgradePanel.data
{
   ...
   public class FrontlineChoiceInfoPanelVO extends DAAPIDataClass
   {
      ...
      public var firstItem:FrontlineModuleInfoVO = null;
      
      public var secondItem:FrontlineModuleInfoVO = null;
      
      public function FrontlineChoiceInfoPanelVO(param1:Object = null)
      {
         super(param1);
      }
      ...
      override protected function onDataWrite(param1:String, param2:Object) : Boolean
      {
         if(param1 == FIRST_ITEM_LBL || param1 == SECOND_ITEM_LBL)
         {
            ...
            this[param1] = new FrontlineModuleInfoVO(param2);
            return false;
         }
