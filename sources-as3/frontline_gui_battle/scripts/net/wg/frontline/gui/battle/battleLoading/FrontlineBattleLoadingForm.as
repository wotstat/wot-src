package net.wg.frontline.gui.battle.battleLoading
{
   ...
   public class FrontlineBattleLoadingForm extends BaseLoadingForm implements IStageSizeDependComponent
   {
      ...
      public var team1TankBalance:FrontlineBattleLoadingTankBalance;
      
      public var team2TankBalance:FrontlineBattleLoadingTankBalance;
      
      public var table:FrontlineBattleStatsTable = null;
      
      private var _tableCtrl:FrontlineBattleStatsTableCtrl = null;
      ...
      {
         super();
         this._tableCtrl = new FrontlineBattleStatsTableCtrl(this.table);
      }
      ...
      {
         return "[WG FrontlineBattleLoadingForm " + name + "]";
      }
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data) && Boolean(isInvalid(InvalidationType.LAYOUT)))
         {
