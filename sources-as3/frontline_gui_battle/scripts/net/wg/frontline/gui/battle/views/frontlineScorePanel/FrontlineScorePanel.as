package net.wg.frontline.gui.battle.views.frontlineScorePanel
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineScorePanelMeta;
   ...
   public class FrontlineScorePanel extends FrontlineScorePanelMeta implements IFrontlineScorePanelMeta, IFrontlineBattleStatisticDataController
   {
      ...
      public function FrontlineScorePanel()
      {
         super();
      ...
      {
         super.draw();
         if(Boolean(isInvalid(InvalidationType.DATA)) && !this._inPrebattleState)
         {
      ...
      private function setCurrentTarget() : void
      {
         ...
         else if(this._currentTargetType == EPIC_CONSTS.TARGET_NONE && Boolean(this._currentActiveTarget))
         {
      ...
      public function as_setTarget(param1:int, param2:int) : void
      {
         ...
         if(Boolean(this._currentActiveTarget))
         {
            this._currentActiveTarget.setAsPrimaryTarget(false);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:int = int(this._basesMCList.length);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
         ...
         _loc3_ = int(this._headquartersMCList.length);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            if(param1)
      ...
      {
         var _loc1_:int = int(this._headquartersMCList.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      {
         var _loc1_:int = int(this._basesProgress.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function set state(param1:String) : void
      {
         ...
         gotoAndPlay(param1);
         dispatchEvent(new FrontlineScorePanelEvent(FrontlineScorePanelEvent.STATE_CHANGED,param1 == STAGE1_3_STATE || param1 == STAGE2_3_STATE ? FrontlineScorePanelEvent.DOUBLE_ROW_STATE : FrontlineScorePanelEvent.SINGLE_ROW_STATE));
      }
      
      private function delayedIntroStateTransitionEndTask() : void
      {
         dispatchEvent(new FrontlineScorePanelEvent(FrontlineScorePanelEvent.STATE_CHANGED,FrontlineScorePanelEvent.PRE_BATTLE_TRANSITION_START));
      }
