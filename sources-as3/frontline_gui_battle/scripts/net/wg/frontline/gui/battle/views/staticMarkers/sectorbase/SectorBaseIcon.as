package net.wg.frontline.gui.battle.views.staticMarkers.sectorbase
{
   ...
   public class SectorBaseIcon extends BattleIconHolder
   {
      ...
      public var progressCircle:FrontlineProgressCircle = null;
      ...
      public function setHoverColor() : void
      {
         ...
         if(Boolean(this._vmManager.isColorBlind) && this._owningTeam == ENEMY)
         {
