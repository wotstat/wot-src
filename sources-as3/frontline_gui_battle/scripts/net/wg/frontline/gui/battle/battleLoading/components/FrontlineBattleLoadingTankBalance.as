package net.wg.frontline.gui.battle.battleLoading.components
{
   ...
   public class FrontlineBattleLoadingTankBalance extends BattleUIComponent
   {
      ...
      public var heavyTankComponent:FrontlineBattleLoadingTankTypeComponent;
      
      public var mediumTankComponent:FrontlineBattleLoadingTankTypeComponent;
      
      public var lightTankComponent:FrontlineBattleLoadingTankTypeComponent;
      
      public var tankDestroyerComponent:FrontlineBattleLoadingTankTypeComponent;
      
      public var spgComponent:FrontlineBattleLoadingTankTypeComponent;
      ...
      private var _tankTypeCounter:Vector.<int> = new <int>[0,0,0,0,0];
      
      private var _tankComponents:Vector.<FrontlineBattleLoadingTankTypeComponent> = null;
      
      private var _tankTypeToElement:Vector.<String> = new <String>[DAMAGEINDICATOR.HEAVY_TANK,DAMAGEINDICATOR.MEDIUM_TANK,DAMAGEINDICATOR.LIGHT_TANK,DAMAGEINDICATOR.AT_SPG,DAMAGEINDICATOR.SPG];
      
      public function FrontlineBattleLoadingTankBalance()
      {
         super();
         this._tankTypeCounter = new <int>[0,0,0,0,0];
         this._tankComponents = new <FrontlineBattleLoadingTankTypeComponent>[this.heavyTankComponent,this.mediumTankComponent,this.lightTankComponent,this.tankDestroyerComponent,this.spgComponent];
      }
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = int(this._tankComponents.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
