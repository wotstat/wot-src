package net.wg.frontline.gui.battle.views.frontlineInGameRank
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineInGameRankMeta;
   
   public class FrontlineInGameRankPanel extends FrontlineInGameRankMeta implements IFrontlineInGameRankMeta
   {
      ...
      public var rankSymbol:FrontlineInGameRankIcon = null;
      
      public var rankTitleTF:TextField = null;
      
      public var animatedRankProgress:FrontlineInGameRankAnimatedProgress = null;
      
      public var background:MovieClip = null;
      
      private var _isActive:Boolean = false;
      
      private var _data:FrontlineInGameRankVO = null;
      
      public function FrontlineInGameRankPanel()
      {
         super();
      }
      ...
      override protected function onDispose() : void
      {
         ...
         this.animatedRankProgress.removeEventListener(FrontlineInGameRankEvent.LEVEL_UP_ANIMATION_COMPLETE,this.onRankProgressLevelUpAnimationCompleteHandler);
      ...
      {
         super.configUI();
         this.animatedRankProgress.addEventListener(FrontlineInGameRankEvent.LEVEL_UP_ANIMATION_COMPLETE,this.onRankProgressLevelUpAnimationCompleteHandler);
      }
      
      override protected function setRank(param1:FrontlineInGameRankVO) : void
      {
         this._data = param1;
         invalidateData();
      }
      ...
      private function onRankProgressLevelUpAnimationCompleteHandler(param1:FrontlineInGameRankEvent) : void
      {
         levelUpAnimationCompleteS();
      }
   }
