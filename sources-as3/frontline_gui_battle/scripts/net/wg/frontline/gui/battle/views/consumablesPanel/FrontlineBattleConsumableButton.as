package net.wg.frontline.gui.battle.views.consumablesPanel
{
   ...
   public class FrontlineBattleConsumableButton extends BattleEquipmentButton implements IFrontlineBattleConsumableButton
   {
      ...
      public function FrontlineBattleConsumableButton()
      {
         super();
      }
      ...
      public function updateLevelInformation(param1:int) : void
      {
         ...
         (glow as FrontlineBattleEquipmentButtonGlow).setLevel(this._consumableLevel);
      ...
      override protected function draw() : void
      {
         ...
         var _loc2_:Boolean = Boolean(isInvalid(LOCKED_INFO_INV));
         var _loc3_:Boolean = Boolean(isInvalid(CONSUMABLE_LEVEL_INV));
         var _loc4_:Boolean = Boolean(isInvalid(POSSIBLE_STACKS_INV));
         var _loc5_:Boolean = Boolean(isInvalid(STACKS_INV));
         if(_loc2_)
         {
            buttonMode = this._isSlotEmpty ? false : !_loc1_;
         ...
         if(_loc2_ || _loc3_)
         {
            this.levelMc.alpha = _loc1_ ? LOCKED_TF_ALPHA : FULL_ALPHA;
            this.setBindKeyVisibility();
         }
         if(_loc4_)
         {
      ...
      override protected function invokeRollOverActions() : void
      {
         ...
         else if(!this._isRankTooltipVisible && (Boolean(enabled) || Boolean(isAllowedToShowToolTipOnDisabledState)))
         {
            this.showTooltip();
         }
      }
      ...
      {
         if(!_isTooltipVisible && Boolean(StringUtils.isNotEmpty(_tooltipStr)))
         {
