package net.wg.frontline.gui.battle.views.upgradePanel
{
   ...
   public class FrontlineModuleInfo extends UIComponent
   {
      ...
      private var _module:FrontlineConfiguratorRenderer = null;
      ...
      public function FrontlineModuleInfo()
      {
         super();
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SETTINGS))
         {
            ...
            this._module = App.utils.classFactory.getComponent(_loc1_,IFrontlineConfiguratorRenderer);
            this._module.setIndex(FrontlineConfiguratorRenderer.START_COLUMN_INDEX,this._moduleIdx);
      ...
      public function setData(param1:FrontlineModuleInfoVO) : void
      {
      ...
      private function updatePositions() : void
      {
         ...
         var _loc4_:int = _loc1_ ? int(-_loc3_.width) : 0;
         if(_loc1_)
         {
      ...
      {
         if(Boolean(this._module) && Boolean(this._moduleHitArea))
         {
