package net.wg.frontline.gui.battle.battleLoading.components
{
   ...
   public class FrontlineBattleStatsTableCtrl extends FrontlineStatsDataProviderBaseCtrl
   {
      
      private var _table:FrontlineBattleStatsTable = null;
      
      public function FrontlineBattleStatsTableCtrl(param1:FrontlineBattleStatsTable)
      {
         super();
         this._table = param1;
      }
      ...
      override public function setVehiclesData(param1:Array, param2:Vector.<Number>, param3:Boolean) : void
      {
         ...
         var _loc5_:FrontlineBattleScrollingList = null;
         if(param3)
         {
      ...
      private function getRendererIfInRange(param1:ScrollingList, param2:int) : FrontlineBattleLoadingPlayerItemRenderer
      {
         var _loc5_:FrontlineBattleLoadingPlayerItemRenderer = null;
         var _loc3_:int = param2 - param1.scrollPosition;
         var _loc4_:FrontlineBattleLoadingPlayerItemRenderer = null;
         if(_loc3_ >= 0 && _loc3_ < param1.rowCount)
         {
            _loc5_ = param1.getRendererAt(_loc3_) as FrontlineBattleLoadingPlayerItemRenderer;
            if(Boolean(_loc5_))
            {
               _loc4_ = _loc5_;
            }
      ...
      override protected function updateTeamDPItems(param1:ListDataProviderEvent) : void
      {
         ...
         var _loc8_:FrontlineVehicleStatsVO = null;
