package net.wg.frontline.gui.battle.views.recoveryPanel
{
   import flash.display.MovieClip;
   import net.wg.frontline.infrastructure.base.meta.IRecoveryPanelMeta;
   import net.wg.frontline.infrastructure.base.meta.impl.RecoveryPanelMeta;
   ...
   public class RecoveryPanel extends RecoveryPanelMeta implements IRecoveryPanelMeta
   {
      ...
      public function as_displayHint(param1:Boolean, param2:Boolean) : void
      {
         ...
         else if(!param1 && Boolean(this.recoveryHint.visible))
         {
            if(param2)
            {
               this.clearTween();
