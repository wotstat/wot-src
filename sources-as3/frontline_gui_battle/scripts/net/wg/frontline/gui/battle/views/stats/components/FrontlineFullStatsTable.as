package net.wg.frontline.gui.battle.views.stats.components
{
   ...
   public class FrontlineFullStatsTable extends BattleUIComponent
   {
      ...
      public var statsFilters:FrontlineStatsTableFilterGroup = null;
      
      public var generalBonus:FrontlineStatsGeneralBonus = null;
      
      public function FrontlineFullStatsTable()
      {
         super();
      }
