package net.wg.frontline.gui.battle.views.frontlineRespawnView.components
{
   ...
   public class FrontlineRespawnMapEntriesContainer extends Sprite implements IDisposable
   {
      
      private static const RESPAWN_POINT_LINKAGE:String = "FrontlineRespawnPointUI";
      ...
      private var _respawnPoints:Vector.<FrontlineRespawnPoint> = null;
      ...
      public function FrontlineRespawnMapEntriesContainer()
      {
         super();
         this._respawnPoints = new Vector.<FrontlineRespawnPoint>();
      ...
      {
         var _loc1_:FrontlineRespawnPoint = null;
      ...
      public function setRespawnLocations(param1:Vector.<RespawnPointVO>) : void
      {
         ...
         var _loc4_:FrontlineRespawnPoint = null;
      ...
      public function setBounds(param1:Number, param2:Number) : void
      {
         ...
         var _loc7_:FrontlineRespawnPoint = null;
      ...
      {
         var _loc1_:FrontlineRespawnPoint = App.utils.classFactory.getComponent(RESPAWN_POINT_LINKAGE,FrontlineRespawnPoint);
      ...
      private function onClickHandler(param1:MouseEvent) : void
      {
         ...
         var _loc4_:FrontlineRespawnPoint = param1.target as FrontlineRespawnPoint;
         ...
         this.dispatchEvent(new FrontlineRespawnEvent(FrontlineRespawnEvent.RESPAWN_LOCATION_SELECT,this._selectedIdx));
      }
