package net.wg.frontline.gui.battle.views.frontlinePlatoonPanel.renderers
{
   ...
   public class PlatoonInviteRenderer extends UIComponentEx
   {
      ...
      {
         return Boolean(this._data) ? Number(this._data.vehicleID) : 0;
      }
      
      public function get inviteAccountId() : Number
      {
         return Boolean(this._data) ? Number(this._data.accountDBID) : 0;
      }
