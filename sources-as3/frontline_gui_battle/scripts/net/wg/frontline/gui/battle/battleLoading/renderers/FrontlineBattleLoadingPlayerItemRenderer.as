package net.wg.frontline.gui.battle.battleLoading.renderers
{
   ...
   public class FrontlineBattleLoadingPlayerItemRenderer extends BattleUIComponent implements IEpicRandomBattleLoadingRenderer, IStageSizeDependComponent
   {
      ...
      private var _epicData:FrontlineVehicleStatsVO;
      ...
      public function FrontlineBattleLoadingPlayerItemRenderer()
      {
         super();
      ...
      {
         var _loc3_:Boolean = Boolean(StringUtils.isNotEmpty(param1));
      ...
      {
         if(this.playerActionMarker != null && Boolean(this._model.vehicleAction))
         {
      ...
      private function updateState() : void
      {
         ...
         var _loc1_:Boolean = Boolean(this._model.isAlive());
         this.deadBg.visible = !_loc1_;
         var _loc2_:Boolean = Boolean(UserTags.isCurrentPlayer(this._model.userTags));
         ...
         this.prestigeLevel.alpha = _loc1_ ? PRESTIGE_LEVEL_DEFAULT_ALPHA : PRESTIGE_LEVEL_DEAD_ALPHA;
         ...
         else
         {
            ...
            {
               _loc5_ = _loc1_ && Boolean(this._model.isReady());
            }
      ...
      private function updatePlayerName() : void
      {
         ...
         var _loc1_:Boolean = Boolean(UserTags.isCurrentPlayer(this._model.userTags));
