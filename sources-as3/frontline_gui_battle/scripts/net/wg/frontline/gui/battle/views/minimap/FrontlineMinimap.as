package net.wg.frontline.gui.battle.views.minimap
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineMinimapMeta;
   ...
   public class FrontlineMinimap extends FrontlineMinimapMeta implements IFrontlineBattleStatisticDataController, IFrontlineMinimapMeta
   {
      ...
      public var entriesContainer:FrontlineMinimapEntriesContainer = null;
      ...
      private var _sectorState:Vector.<int> = new <int>[0,0,0,0,0,0,0];
      ...
      private var _settingsAlpha:Number = 1;
      
      private var _tabModeCustomAlpha:Number = 1;
      
      private var _isTabModeCustomAlpha:Boolean = false;
      
      private var _mapScaleIndex:int = 1;
      
      public function FrontlineMinimap()
      {
         super();
      ...
      {
         if((this._currentSizeIndex != param1 || this._updateSizeIndexForce) && Boolean(initialized))
         {
            this._currentSizeIndex = param1;
      ...
      {
         var _loc2_:int = int(this._sectorState.length);
      ...
      {
         alpha = this._isTabMode && this._isTabModeCustomAlpha ? this._tabModeCustomAlpha : this._settingsAlpha;
      }
      ...
      private function updateSectorOverview() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(this._sectors))
         {
            _loc1_ = int(this._sectors.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               if(this._isAttacker)
