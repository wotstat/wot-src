package net.wg.frontline.gui.battle.views.data
{
   ...
   public class FrontlineStatsDataProviderBaseCtrl implements IDisposable
   {
      ...
      protected var teamDP:FrontlineVehicleDataProvider;
      
      protected var enemyDP:FrontlineVehicleDataProvider;
      ...
      public function setEpicVehiclesStats(param1:Boolean, param2:Vector.<FrontlineVehicleStatsVO>, param3:Vector.<Number>) : void
      {
         var _loc4_:FrontlineVehicleDataProvider = param1 ? this.enemyDP : this.teamDP;
         this.updateOrder(param3,param1);
      ...
      public function setVehicleStatus(param1:Boolean, param2:Number, param3:uint, param4:Vector.<Number>) : void
      {
         ...
         var _loc6_:Boolean = Boolean(_loc5_.setVehicleStatus(param2,param3));
         if(_loc6_)
         {
            _loc5_.invalidate();
         }
      ...
      {
         var _loc4_:IVehiclesDataProvider = param1 ? this.enemyDP : this.teamDP;
         var _loc5_:Boolean = Boolean(_loc4_.updateVehiclesInfo(param2));
         if(_loc5_)
         {
            _loc4_.invalidate();
         }
