package net.wg.frontline.gui.battle.views.upgradePanel
{
   ...
   public class FrontlineConfiguratorRenderer extends UIComponent implements IFrontlineConfiguratorRenderer
   {
      ...
      private var _data:FrontlineConfiguratorModuleVO = null;
      
      public function FrontlineConfiguratorRenderer()
      {
         super();
      ...
      public function setData(param1:FrontlineConfiguratorModuleVO) : void
      {
         this._data = param1;
         invalidateData();
      }
