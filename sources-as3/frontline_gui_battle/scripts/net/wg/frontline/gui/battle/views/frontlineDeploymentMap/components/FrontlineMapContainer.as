package net.wg.frontline.gui.battle.views.frontlineDeploymentMap.components
{
   ...
   public class FrontlineMapContainer extends MovieClip implements IDisposable
   {
      ...
      public var entriesContainer:FrontlineDeploymentMapEntriesContainer = null;
      
      private var _clickAreaSpr:Sprite = null;
      
      private var _disposed:Boolean = false;
      
      public function FrontlineMapContainer()
      {
         super();
      ...
      private function onMouseClickHandler(param1:MouseEvent) : void
      {
         if(param1 is MouseEventEx && param1.target == this._clickAreaSpr)
         {
            ...
            dispatchEvent(new FrontlineDeploymentMapEvent(FrontlineDeploymentMapEvent.MAP_CLICKED,this.mapHit.mouseX,this.mapHit.mouseY,MouseEventEx(param1).buttonIdx));
         }
      }
