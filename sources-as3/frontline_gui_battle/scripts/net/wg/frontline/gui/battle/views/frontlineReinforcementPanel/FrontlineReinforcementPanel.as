package net.wg.frontline.gui.battle.views.frontlineReinforcementPanel
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineReinforcementPanelMeta;
   import net.wg.utils.IScheduler;
   
   public class FrontlineReinforcementPanel extends FrontlineReinforcementPanelMeta implements IFrontlineReinforcementPanelMeta
   {
      ...
      public function FrontlineReinforcementPanel()
      {
         super();
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.STATE))
         {
            ...
            _loc2_ = int(this._tankIconsList.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
