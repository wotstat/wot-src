package net.wg.frontline.gui.battle.views.stats
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlineFullStatsMeta;
   ...
   public class FrontlineFullStats extends FrontlineFullStatsMeta implements IFrontlineFullStatsMeta, IBattleComponentDataController, IFrontlineBattleStatisticDataController
   {
      ...
      public var header:FrontlineStatsHeader = null;
      
      public var statsTable:FrontlineFullStatsTable = null;
      
      public var modalBgSpr:Sprite = null;
      
      private var _tableCtrl:FrontlineFullStatsTableCtrl = null;
      
      private var _personalStatus:uint = 0;
      
      private var _isInteractive:Boolean = false;
      
      public function FrontlineFullStats()
      {
         super();
         this._tableCtrl = new FrontlineFullStatsTableCtrl(this.statsTable,this);
      }
      ...
      override protected function configUI() : void
      {
         ...
         this.statsTable.statsFilters.addEventListener(FrontlineFullStatsEvent.FILTER_CHANGED,this.onFilterChangedHandler);
      ...
      override protected function onDispose() : void
      {
         ...
         this.statsTable.statsFilters.removeEventListener(FrontlineFullStatsEvent.FILTER_CHANGED,this.onFilterChangedHandler);
         this.header.dispose();
         this.header = null;
      ...
      public function updateStageSize(param1:Number, param2:Number) : void
      {
         ...
         var _loc6_:int = _loc5_ ? TOP_MIN_TABLE_OFFSET : TOP_TABLE_OFFSET;
      ...
      private function applyInteractivity() : void
      {
         ...
         var _loc2_:Boolean = _loc1_ && Boolean(PersonalStatus.isCanSendInviteToAlly(this._personalStatus));
         var _loc3_:Boolean = _loc1_ && Boolean(PersonalStatus.isCanSendInviteToEnemy(this._personalStatus));
      ...
      private function onFilterChangedHandler(param1:FrontlineFullStatsEvent) : void
      {
