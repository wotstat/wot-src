package net.wg.frontline.gui.battle.VO.daapi
{
   ...
   public class FrontlineVehiclesStatsVO extends DAAPIDataClass
   {
      ...
      public var leftItems:Vector.<FrontlineVehicleStatsVO> = null;
      
      public var rightItems:Vector.<FrontlineVehicleStatsVO> = null;
      ...
      public function FrontlineVehiclesStatsVO(param1:Object)
      {
         super(param1);
      }
         ...
         switch(param1)
         {
            ...
            case COND_LEFT_FIELD_NAME:
               if(Boolean(param2))
               {
                  ...
                  _loc4_ = int(_loc3_.length);
                  this.leftItems = new Vector.<FrontlineVehicleStatsVO>();
                  _loc5_ = 0;
                  while(_loc5_ < _loc4_)
                  {
                     this.leftItems.push(new FrontlineVehicleStatsVO(_loc3_[_loc5_]));
                     _loc5_++;
                  }
               }
               return false;
            case COND_RIGHT_FIELD_NAME:
               if(Boolean(param2))
               {
                  ...
                  _loc4_ = int(_loc3_.length);
                  this.rightItems = new Vector.<FrontlineVehicleStatsVO>();
                  _loc5_ = 0;
                  while(_loc5_ < _loc4_)
                  {
                     this.rightItems.push(new FrontlineVehicleStatsVO(_loc3_[_loc5_]));
                     _loc5_++;
                  }
               }
               return false;
      ...
      {
         var _loc1_:FrontlineVehicleStatsVO = null;
         if(Boolean(this.leftItems))
         {
