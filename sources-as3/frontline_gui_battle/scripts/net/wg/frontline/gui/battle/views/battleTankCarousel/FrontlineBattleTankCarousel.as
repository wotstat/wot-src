package net.wg.frontline.gui.battle.views.battleTankCarousel
{
   ...
   public class FrontlineBattleTankCarousel extends BattleTankCarouselMeta implements IBattleTankCarouselMeta, IUIComponentEx
   {
      ...
      public function FrontlineBattleTankCarousel()
      {
         super();
      }
      ...
      override protected function configUI() : void
      {
         ...
         this._helper = new FrontlineBattleTankCarouselHelper();
      ...
      {
         var _loc1_:Boolean = Boolean(isInvalid(InvalidationType.SIZE));
         var _loc2_:Boolean = Boolean(isInvalid(INVALID_SCROLL_POS));
         if(_loc1_)
         {
      ...
      protected function getNewHelper() : FrontlineBattleTankCarouselHelper
      {
         var _loc1_:FrontlineBattleTankCarouselHelper = this._helper;
         if(!(_loc1_ is FrontlineBattleTankCarouselHelper))
         {
            _loc1_ = new FrontlineBattleTankCarouselHelper();
      ...
      {
         var _loc1_:int = scrollList.useExtendedViewPort ? MASK_TOP_OFFSET_EPIC : MASK_TOP_OFFSET_DEFAULT;
         var _loc2_:int = scrollList.useExtendedViewPort ? MASK_BOTTOM_OFFSET_EPIC : MASK_BOTTOM_OFFSET_DEFAULT;
...
class FrontlineBattleTankCarouselHelper
{
   
   private static const RENDERER_LINKAGE:String = "FLBattleTankCarouselItemRendererUI";
   ...
   public function FrontlineBattleTankCarouselHelper()
   {
      super();
   }
