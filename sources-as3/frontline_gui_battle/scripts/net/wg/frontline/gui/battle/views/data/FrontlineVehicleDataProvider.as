package net.wg.frontline.gui.battle.views.data
{
   ...
   public class FrontlineVehicleDataProvider extends VehiclesDataProvider implements IVehiclesDataProvider
   {
      ...
      public function FrontlineVehicleDataProvider(param1:Array = null)
      {
         super(param1);
      }
      ...
      override public function setSorting(param1:Vector.<Number>) : Boolean
      {
         ...
         if(Boolean(this._activeLaneVehicleIDs))
         {
      ...
      public function getActiveLaneVehicleData() : Array
      {
         ...
         if(Boolean(this._activeLaneVehicleIDs))
         {
            _loc2_ = int(this._activeLaneVehicleIDs.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               if(this._activeLaneVehicleIDs[_loc3_] != 0)
               {
                  _loc4_ = int(vehicleIDs.indexOf(this._activeLaneVehicleIDs[_loc3_]));
      ...
      {
         if(param2 && Boolean(this._activeLaneVehicleIDs))
         {
      ...
      public function requestEpicData(param1:Number) : FrontlineVehicleStatsVO
      {
      ...
      {
         var _loc2_:int = int(vehicleIDs.indexOf(param1));
         return this[_loc2_] as DAAPIVehicleInfoVO;
      }
      
      public function updateEpicStats(param1:Vector.<FrontlineVehicleStatsVO>) : Boolean
      {
         var _loc3_:FrontlineVehicleStatsVO = null;
         var _loc4_:int = 0;
         var _loc5_:DAAPIVehicleInfoVO = null;
         var _loc2_:Boolean = false;
         for each(_loc3_ in param1)
         {
            _loc4_ = int(vehicleIDs.indexOf(_loc3_.vehicleID));
            _loc5_ = this[_loc4_] as DAAPIVehicleInfoVO;
            if(_loc5_ != null)
            {
               if(Boolean(this._epicStats[_loc3_.vehicleID]))
               {
      ...
      private function resetActiveLaneVehicleList(param1:int) : void
      {
         ...
         var _loc2_:int = int(this._activeLaneVehicleIDs.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
         ...
         var _loc4_:int = 0;
         _loc2_ = int(vehicleIDs.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc2_)
         {
            _loc6_ = this[_loc5_] as DAAPIVehicleInfoVO;
            if(Boolean(_loc6_ != null && this._epicStats[_loc6_.vehicleID]) && Boolean(this._epicStats[_loc6_.vehicleID].lane == param1) && param1 > 0)
            {
      ...
      private function evaluatePlayerLane(param1:FrontlineVehicleStatsVO, param2:FrontlineVehicleStatsVO, param3:Number) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param1.lane >= 0 && param2.lane > 0 && this._activeLane > 0 && Boolean(this._activeLaneVehicleIDs))
         {
      ...
      {
         var _loc3_:int = int(vehicleIDs.indexOf(param1));
         var _loc4_:int = int(vehicleIDs.indexOf(param2));
      ...
      {
         var _loc1_:int = int(this._activeLaneVehicleIDs.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
