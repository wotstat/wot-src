package net.wg.frontline.gui.battle.views.frontlinePlatoonPanel
{
   ...
   import net.wg.frontline.infrastructure.base.meta.impl.FrontlinePlatoonPanelMeta;
   ...
   public class FrontlinePlatoonPanel extends FrontlinePlatoonPanelMeta implements IFrontlineBattleStatisticDataController, IBattleComponentDataController, IFrontlinePlatoonPanelMeta, IStatsBaseMeta, IPlayersPanelMeta
   {
      ...
      public function FrontlinePlatoonPanel()
      {
         super();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.platoonInvitePanel))
         {
      ...
      public function setUserTags(param1:IDAAPIDataClass) : void
      {
         ...
         if(this._playerSquad > 0)
         {
            ...
            {
               if(Boolean(this._vehicleDataCache[_loc4_.vehicleID]))
               {
      ...
      public function updateInvitationsStatuses(param1:IDAAPIDataClass) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            if(Boolean(InvitationStatus.isReceived(_loc4_.status)) && this._playerSquad <= DAAPIVehicleInfoVO.DEFAULT_SQUAD_IDX)
            {
      ...
      public function updatePlayerStatus(param1:IDAAPIDataClass) : void
      {
         ...
         if(Boolean(this._vehicleDataCache[this._playerVehicleId]) && this._vehicleDataCache[this._playerVehicleId].squadIndex > 0)
         {
      ...
      public function updateUserTags(param1:IDAAPIDataClass) : void
      {
         ...
         if(Boolean(this._vehicleDataCache[_loc2_.vehicleID]))
         {
      ...
      private function applyVehicleData(param1:DAAPIVehiclesDataVO) : void
      {
         ...
         var _loc4_:FrontlineVehicleStatsVO = null;
         ...
         for each(_loc3_ in param1.leftVehicleInfos)
         {
            ...
            if(_loc3_.squadIndex != DAAPIVehicleInfoVO.DEFAULT_SQUAD_IDX)
            {
               ...
               if(_loc3_.squadIndex == this._playerSquad)
               {
                  ...
                  {
                     _loc4_ = this._epicStatsDict[_loc3_.vehicleID] as FrontlineVehicleStatsVO;
                     if(Boolean(_loc4_))
                     {
      ...
      private function initializePlatoon(param1:int) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            if(Boolean(_loc2_[_loc7_]))
            {
               ...
               _loc4_ = this._epicStatsDict[_loc2_[_loc7_].vehicleID] as FrontlineVehicleStatsVO;
               if(Boolean(_loc4_))
               {
                  this.platoonMembersPanel.setEpicVehiclesStats(_loc4_);
               }
      ...
      private function updateEpicStats(param1:Vector.<FrontlineVehicleStatsVO>, param2:Vector.<Number>) : void
      {
         var _loc3_:FrontlineVehicleStatsVO = null;
         for each(_loc3_ in param1)
         {
            if(Boolean(this._epicStatsDict[_loc3_.vehicleID]))
            {
