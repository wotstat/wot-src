package net.wg.gui.messenger.controls
{
   ...
   public class ContactsTreeComponent extends ContactsTreeComponentMeta implements IContactsTreeComponentMeta, IFocusChainContainer, IFocusContainer
   {
      ...
      private var _mainTreeDataProvider:ContactsTreeDataProvider = new ContactsTreeDataProvider();
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(InvalidationType.SIZE)) || Boolean(isInvalid(LIST_HEIGHT_INV)))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         this.list.dispose();
         this.list = null;
         if(Boolean(this._externalSearchView))
         {
      ...
      {
         var _loc2_:uint = uint(param1.accMaxChars);
      ...
      {
         if(Boolean(this._externalSearchView) && Boolean(this._externalSearchView.visible))
         {
         ...
         if(_loc2_)
         {
            ...
            else if(_loc3_.gui[ID] != null)
            {
               ...
               if(_loc8_.hasOwnProperty(USER_PROPS))
               {
                  ...
                  if(Boolean(_loc3_.parent) && Boolean(_loc3_.parent.parent) && Boolean(_loc3_.parent.data))
                  {
