package net.wg.gui.messenger.controls
{
   ...
   public class ContactsTreeItemRenderer extends ContactItemRenderer
   {
      ...
      override public function setData(param1:Object) : void
      {
         ...
         if(Boolean(param1) && Boolean(this._myData) && this._myData.id != null)
         {
      ...
      override protected function draw() : void
      {
         ...
         if(_loc1_)
         {
            if(Boolean(this._myData))
            {
               ...
               {
                  if(Boolean(this._currentContentItem))
                  {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._mainGroupItem))
         {
            this._mainGroupItem.dispose();
         }
         if(Boolean(this._contactGroupItem))
         {
      ...
      protected function showTooltip() : void
      {
         ...
         if(this._currentContentItem == this._contactItem && Boolean(this._contactItem))
         {
...
class EmptyRowVO extends DAAPIDataClass
{
   ...
   public function EmptyRowVO(param1:Object)
   {
      super(param1);
   }
}
