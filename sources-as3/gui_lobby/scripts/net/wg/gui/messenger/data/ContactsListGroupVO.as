package net.wg.gui.messenger.data
{
   ...
   public class ContactsListGroupVO extends TreeContentVO
   {
      ...
      {
         return Boolean(this._rules) ? this._rules.getBitMask() : 0;
      }
      ...
      {
         return Boolean(this._rules) ? this._rules.isResizable() : false;
      }
      
      public function get isDropAllowed() : Boolean
      {
         return Boolean(this._rules) ? this._rules.isDropAllowed() : false;
      }
      
      public function get canBeManaged() : Boolean
      {
         return Boolean(this._rules) ? this._rules.canBeManaged() : false;
      }
   }
}
