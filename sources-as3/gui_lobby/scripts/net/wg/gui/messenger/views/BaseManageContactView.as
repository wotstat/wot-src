package net.wg.gui.messenger.views
{
   ...
   public class BaseManageContactView extends BaseManageContactViewMeta implements IBaseManageContactViewMeta
   {
      ...
      {
         super.update(param1);
         if(Boolean(param1) && param1.hasOwnProperty("text"))
         {
      ...
      {
         super.draw();
         if(Boolean(isInvalid(TXT_INV)) && this.inputText != null)
         {
      ...
      private function onInputInputHandler(param1:InputEvent) : void
      {
         ...
         if(_loc2_.code == Keyboard.ENTER && Boolean(btns.btnOk.enabled) && Boolean(visible))
         {
            param1.handled = true;
            this.onButtonClick();
         }
