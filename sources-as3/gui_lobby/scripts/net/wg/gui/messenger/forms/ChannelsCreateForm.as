package net.wg.gui.messenger.forms
{
   ...
   public class ChannelsCreateForm extends UIComponentEx implements IViewStackContent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.channelPasswordInput) && Boolean(isInvalid(UPDATE_PASSWORD_TEXT)))
         {
      ...
      private function createChannel() : void
      {
         ...
         var _loc2_:Boolean = Boolean(this.channelPasswordCheckBox.selected);
      ...
      override public function handleInput(param1:InputEvent) : void
      {
         ...
         var _loc3_:uint = uint(_loc2_.controllerIndex);
