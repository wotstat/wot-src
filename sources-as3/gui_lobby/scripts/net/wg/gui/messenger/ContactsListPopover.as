package net.wg.gui.messenger
{
   ...
   public class ContactsListPopover extends ContactsListPopoverMeta implements IContactsListPopoverMeta
   {
      ...
      private var _linkageUtils:LinkageUtils = new LinkageUtils();
      ...
      {
         this.addGroupButton.enabled = Boolean(this._initData) ? this._initData.isGroupSupported : false;
      ...
      {
         param1.stopImmediatePropagation();
         if(Boolean(this.viewStack.currentViewId))
         {
