package net.wg.gui.messenger.windows
{
   ...
   public class LobbyChannelWindow extends LobbyChannelWindowMeta implements ILobbyChannelWindowMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(INVALID_LIST_VISIBILITY)) && this._needToHideList)
         {
         ...
         if(Boolean(isInvalid(INVALID_WARNING_VISIBILITY)) && this.warningPanel.visible != this._showWarning)
         {
