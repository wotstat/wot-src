package net.wg.gui.components.common
{
   ...
   public class ConfirmItemComponent extends UIComponentEx
   {
      ...
      public function setIcon(param1:DisplayObject, param2:Boolean = false) : void
      {
         ...
         DisplayObject(this.itemIcon).addEventListener(Event.RESIZE,this.onIconResizeHandler);
         addChild(param1);
         if(param2)
         {
            invalidateSize();
      ...
      private function tryClearItemIcon() : void
      {
         ...
         {
            DisplayObject(this.itemIcon).removeEventListener(Event.RESIZE,this.onIconResizeHandler);
            this.itemIcon.dispose();
            this.itemIcon = null;
         }
      }
      
      private function onIconResizeHandler(param1:Event) : void
      {
         invalidateSize();
      }
   }
