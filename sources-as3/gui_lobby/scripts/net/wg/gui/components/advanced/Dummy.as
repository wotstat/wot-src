package net.wg.gui.components.advanced
{
   ...
   public class Dummy extends UIComponentEx implements IDummy
   {
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._data.iconSource));
      ...
      private function layoutLeft(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(Boolean(this._icon))
         {
            _loc6_ = param3 ? ICON_SMALL_OFFSET_Y : ICON_BIG_OFFSET_Y;
      ...
      private function layoutCenter(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc5_:int = 0;
         if(Boolean(this._icon) && !param3)
         {
            _loc5_ = int(this._icon.height);
         }
         var _loc6_:int = 0;
         if(Boolean(this._button))
         {
         ...
         if(Boolean(this._icon))
         {
            if(param3)
            {
               _loc9_ = param4 ? ICON_SMALL_OFFSET_Y : ICON_BIG_OFFSET_Y;
