package net.wg.gui.components.advanced
{
   ...
   public class ShellButton extends CooldownSlot
   {
      ...
      private var _statesPassive:Vector.<String> = Vector.<String>([STATE_PREFIX_PASSIVE]);
      
      private var _statesInactive:Vector.<String> = Vector.<String>([STATE_PREFIX_INACTIVE]);
      ...
      [Inspectable(name="ammunitionType",defaultValue="")]
      ...
      [Inspectable(name="count",defaultValue="")]
      ...
      [Inspectable(name="ammunitionIcon",defaultValue="")]
