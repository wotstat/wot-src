package net.wg.gui.components.advanced
{
   ...
   public class TextAreaSimple extends scaleform.clik.controls.TextArea
   {
      ...
      private var _textPadding:Padding = new Padding(0,0,0,0);
      ...
      override protected function updateTextField() : void
      {
         ...
         textField.selectable = enabled ? this._selectable : Boolean(enabled);
         textField.type = Boolean(_editable) && Boolean(enabled) ? TextFieldType.INPUT : TextFieldType.DYNAMIC;
         textField.tabEnabled = this._selectable && Boolean(enabled) && Boolean(_focusable);
      ...
      {
         _focusable = param1;
         if(!_focusable && Boolean(enabled))
         {
            tabChildren = false;
         }
         changeFocus();
         if(Boolean(_focusable) && this.selectable)
         {
            addEventListener(MouseEvent.MOUSE_DOWN,handleMouseDown,false,0,true);
         }
         else
      ...
      override public function set editable(param1:Boolean) : void
      {
         _editable = param1;
         textField.type = Boolean(_editable) && Boolean(enabled) ? TextFieldType.INPUT : TextFieldType.DYNAMIC;
         this.focusable = _editable ? Boolean(_editable) : this.selectable;
      }
      ...
      [Inspectable(name="textPadding",defaultValue="top:0,right:0,bottom:0,left:0")]
      ...
      public function set selectable(param1:Boolean) : void
      {
         ...
         this.focusable = _editable ? Boolean(_editable) : this._selectable;
      }
      
      [Inspectable(type="Color",defaultValue="#1E1E1B")]
      ...
      [Inspectable(type="Color",defaultValue="#969687")]
