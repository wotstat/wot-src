   ...
   public class DayRenderer extends UIComponentEx
   {
      ...
      public function setDateAndState(param1:Date, param2:Boolean) : void
      {
         ...
         if(Boolean(param1))
         {
            ...
            _loc3_ = Boolean(App.utils.dateTime.isToday(param1));
            if(_loc3_)
            {
      ...
      public function switchHighlighted(param1:Boolean) : void
      {
         ...
         if(_loc2_)
         {
            ...
            else if(Boolean(this._state & STATE_HIGHLIGHTED))
            {
               this._state ^= STATE_HIGHLIGHTED;
            }
         }
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         else if(param1 && Boolean(this._state & STATE_DISABLED))
         {
      ...
      {
         if(Boolean(this._state & STATE_ENABLED))
         {
