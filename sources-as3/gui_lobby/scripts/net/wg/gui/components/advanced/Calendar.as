package net.wg.gui.components.advanced
{
   ...
   public class Calendar extends CalendarMeta implements ICalendarMeta, IFocusContainer
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._componentForFocus))
         {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALID_DISPLAY_DATE,INVALID_HEADER))
         {
            if(this._showYear)
            {
               _loc1_ = Number(this._dateTime.toPyTimestamp(this._displayDate));
         ...
         {
            if(Boolean(this._componentForFocus) && this._componentForFocus.parent == this.monthDaysContainer)
            {
      ...
      private function updateHighlightedDays() : void
      {
         ...
         var _loc7_:int = int(Values.DEFAULT_INT);
         var _loc8_:int = int(Values.DEFAULT_INT);
         _loc2_ = int(this._highlightedDays.length);
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = Number(this._highlightedDays[_loc3_]);
            if(_loc4_ == 0)
            {
               _loc5_ = null;
            }
            else if(Boolean(_loc5_))
            {
               ...
               {
                  _loc7_ = int(Values.DEFAULT_INT);
                  _loc8_ = int(Values.DEFAULT_INT);
      ...
      private function updateSelectedRenderer() : void
      {
         ...
         if(Boolean(this._currentSelectedRenderer))
         {
      ...
      private function updateAvailableRange() : void
      {
         ...
         while(_loc5_ < TOTAL_RENDERERS)
         {
            ...
            if(_loc5_ >= this._firstVisibleIndex && _loc5_ <= this._lastVisibleIndex)
            {
               ...
               if(Boolean(this._minAvailableDate))
               {
                  _loc4_ = Boolean(_loc1_.isSameDay(_loc3_,this._minAvailableDate)) || _loc1_.timeDiff(_loc3_,this._minAvailableDate) > 0;
               }
               if(_loc4_ && Boolean(this._maxAvailableDate))
               {
                  _loc4_ = Boolean(_loc1_.isSameDay(_loc3_,this._maxAvailableDate)) || _loc1_.timeDiff(_loc3_,this._maxAvailableDate) < 0;
               }
      ...
      private function updateHighlightedWeekDay() : void
      {
         ...
         {
            _loc1_ = Boolean(this._dateTime.isCurrentMonth(this._displayDate));
            _loc2_ = uint(this._dateTime.now().day);
            _loc4_ = int(this._weekRenderers.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
      ...
      private function clearWeekDays() : void
      {
         ...
         if(Boolean(this._weekRenderers))
         {
      ...
      {
         var _loc1_:DayRenderer = null;
         var _loc2_:uint = uint(this._dateTime.getMonthDaysCount(this._displayDate));
      ...
      private function clearMonthDays() : void
      {
         ...
         if(Boolean(this._monthRenderers))
         {
            _loc2_ = int(this._monthRenderers.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      {
         return this._weekStart > param1.day ? uint(Time.DAYS_IN_WEEK - this._weekStart + param1.day) : uint(param1.day - this._weekStart);
      }
      ...
      private function getWeekShift(param1:Date) : uint
      {
         ...
         _loc2_.date = 1;
         return _loc2_.day < this._weekStart ? uint(Time.DAYS_IN_WEEK - this._weekStart + _loc2_.day) : uint(_loc2_.day - this._weekStart);
      }
      ...
      private function getRendererIndexByDate(param1:Date) : int
      {
         ...
         if(Boolean(param1) && Boolean(this._dateTime.isSameMonth(param1,this._displayDate)))
         {
      ...
      [Inspectable(name="weekDayRenderer",type="String",defaultValue="CalendarWeekDayUI")]
      ...
      [Inspectable(name="dayRenderer",type="String",defaultValue="CalendarDayUI")]
      ...
      [Inspectable(name="showYear",type="Boolean",defaultValue="false")]
      ...
      [Inspectable(name="weekStart",type="Number",defaultValue="-1")]
      ...
      [Inspectable(name="dayXStep",type="Number",defaultValue="36")]
      ...
      [Inspectable(name="dayYStep",type="Number",defaultValue="36")]
      ...
      [Inspectable(name="year",type="Number",defaultValue="-1")]
      ...
      [Inspectable(name="month",type="Number",defaultValue="-1")]
      ...
      override public function handleInput(param1:InputEvent) : void
      {
         ...
         {
            _loc3_ = _loc2_.getDate();
            _loc4_ = int(this._dateTime.getMonthDaysCount(this._displayDate));
