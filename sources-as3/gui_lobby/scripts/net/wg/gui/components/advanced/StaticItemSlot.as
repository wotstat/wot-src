      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            if(Boolean(this._data))
            {
               ...
               _loc1_ = Boolean(StringUtils.isNotEmpty(this._data.overlayType));
               this.equipSlotOverlay.visible = _loc1_;
               if(_loc1_)
               {
                  this.equipSlotOverlay.gotoAndStop(this._data.overlayType);
               }
               _loc2_ = Boolean(StringUtils.isNotEmpty(this._data.bgHighlightType));
