package net.wg.gui.components.advanced.collapsingBar
{
   ...
   public class ResizableButton extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(isInvalid(LAYOUT_INVALID)) || Boolean(isInvalid(InvalidationType.SIZE)) || Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      {
         return this.width != param1 && (!changeSizeOnlyUpwards || Boolean(changeSizeOnlyUpwards) && param1 > this.width);
      }
