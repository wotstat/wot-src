package net.wg.gui.components.advanced
{
   ...
   public class TankIcon extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._isRentDirty && Boolean(this.rentInfoField))
         {
            this.rentInfoField.htmlText = this.rentInfo;
            this._isRentDirty = false;
         }
         if((Boolean(this._tankNameDirty || this._showNameDirty || this._isPremiumDirty)) && Boolean(this.tankNameField) && Boolean(this.tankNameBg))
         {
         ...
         if(this._levelDirty && this.levelMc != null && Boolean(this._level))
         {
