   ...
   public class CounterEx extends UIComponentEx
   {
      ...
      private function createLines() : void
      {
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            if(_loc8_ > 0 && _loc8_ % 3 == 0 && Boolean(StringUtils.isNotEmpty(this.localizationSymbol)))
            {
               _loc4_ = this.createTextLine();
      ...
      private function setLinesPosition(param1:Number) : void
      {
         ...
         while(_loc6_ < _loc2_)
         {
            ...
            _loc3_ = param1 < Math.abs(this.number) ? _loc5_.currentFrame >= _loc4_.num : _loc5_.currentFrame <= _loc4_.num;
...
class PositionInfo
{
   ...
   public function PositionInfo(param1:Boolean, param2:int)
   {
      super();
      this.isSet = param1;
      this.num = param2;
