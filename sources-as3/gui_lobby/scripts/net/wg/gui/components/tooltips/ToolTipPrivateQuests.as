package net.wg.gui.components.tooltips
{
   ...
   public class ToolTipPrivateQuests extends ToolTipSpecial
   {
      ...
      override protected function redraw() : void
      {
         ...
         if(Boolean(_loc8_.conditions) && _loc8_.conditions != Values.EMPTY_STR)
         {
         ...
         if(Boolean(_loc8_.params) && _loc8_.params.length > 0)
         {
         ...
         if(Boolean(_loc8_.descr) && _loc8_.descr != Values.EMPTY_STR)
         {
