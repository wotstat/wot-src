package net.wg.gui.components.tooltips
{
   ...
   public class ToolTipRefSysDirects extends ToolTipSpecial
   {
      ...
      private static const MINIMAP_X:int = 30;
      
      private static const MINIMAP_Y:int = 93;
      
      private static const MINIMAP_SCALE:Number = 0.8;
      ...
      public function ToolTipRefSysDirects()
      {
         ...
         this._minimap = App.instance.utils.classFactory.getComponent(Linkages.LOBBY_MINIMAP,MinimapPresentation);
         this._minimap.x = MINIMAP_X;
         this._minimap.y = MINIMAP_Y;
         this._minimap.scaleX = this._minimap.scaleY = MINIMAP_SCALE;
         content.addChildAt(this._minimap,content.getChildIndex(this._infoBack));
      }
      ...
      private function setData() : void
      {
         ...
         if(this._model.isMapEnabled)
         {
            ...
            _loc2_ = int(this._model.mapPoints.length);
            while(_loc4_ < _loc2_)
            {
