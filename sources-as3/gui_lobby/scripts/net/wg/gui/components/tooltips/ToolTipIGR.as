package net.wg.gui.components.tooltips
{
   ...
   public class ToolTipIGR extends ToolTipSpecial
   {
      ...
      {
         if(Boolean(this.progressBlock))
         {
            content.removeChild(this.progressBlock);
            this.progressBlock = null;
         }
         if(Boolean(this.igrPremVehQuestBlocks))
         {
      ...
      override protected function redraw() : void
      {
         ...
         var _loc8_:int = int(_loc5_.quests.length);
         var _loc10_:Class = App.utils.classFactory.getClass(UI_igrQuestBlock);
         if(Boolean(_loc5_.quests) && _loc5_.quests.length > 0)
         {
            _loc8_ = int(_loc5_.quests.length);
            _loc2_ = 0;
            while(_loc2_ < _loc8_)
            {
               _loc9_ = new _loc10_();
         ...
         if(Boolean(_loc5_.progress) && _loc5_.progress.length > 0)
         {
            _loc6_ = Utils.instance.createSeparate(content);
            _loc6_.y = topPosition | 0;
            separators.push(_loc6_);
         ...
         if(Boolean(_loc5_.premVehQuests) && _loc5_.premVehQuests.length > 0)
         {
            ...
            while(_loc2_ < _loc3_)
            {
               if(Boolean(_loc5_.premVehQuests[_loc2_].hasOwnProperty("header") && _loc5_.premVehQuests[_loc2_].hasOwnProperty("descr")) && Boolean(_loc5_.premVehQuests[_loc2_].header != Values.EMPTY_STR) && _loc5_.premVehQuests[_loc2_].descr != Values.EMPTY_STR)
               {
                  _loc11_ = true;
                  _loc6_ = Utils.instance.createSeparate(content);
                  _loc6_.y = topPosition | 0;
