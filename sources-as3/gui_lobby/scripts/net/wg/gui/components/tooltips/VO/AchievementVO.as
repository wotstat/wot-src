package net.wg.gui.components.tooltips.VO
{
   ...
   public class AchievementVO implements IDisposable
   {
      ...
      private function parsHash(param1:Object) : void
      {
         ...
         this.showCondSeparator = param1.hasOwnProperty("showCondSeparator") && param1["showCondSeparator"] != undefined ? Boolean(param1["showCondSeparator"]) : false;
         ...
         this.value = param1.hasOwnProperty("value") && param1["value"] != undefined ? Number(param1["value"]) : NaN;
         ...
         if(Boolean(this.stats))
         {
            this.classParams = Boolean(param1["stats"].hasOwnProperty("classParams")) && param1["stats"]["classParams"] != undefined ? param1["stats"]["classParams"] : null;
         }
         ...
         if(Boolean(_loc5_))
         {
            ...
            if(this.hasReward)
            {
               ...
               {
                  _loc12_ = int(_loc5_["selectedIndex"]);
                  _loc13_ = false;
                  ...
                  if(Boolean(_loc14_ && _loc15_) && Boolean(_loc14_.length) && _loc14_.length == _loc15_.length)
                  {
