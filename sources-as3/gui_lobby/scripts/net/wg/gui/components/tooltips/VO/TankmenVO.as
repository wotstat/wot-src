package net.wg.gui.components.tooltips.VO
{
   ...
   public class TankmenVO
   {
      ...
      private function parsHash(param1:Object) : void
      {
         ...
         this.newSkillsCount = param1.hasOwnProperty("newSkillsCount") && param1["newSkillsCount"] != undefined ? Number(param1["newSkillsCount"]) : 0;
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         var _loc4_:Number = 0;
         var _loc5_:String = "";
         _loc2_ = param1.hasOwnProperty("roleLevel") && param1["roleLevel"] != undefined ? Number(param1["roleLevel"]) : 0;
         _loc3_ = param1.hasOwnProperty("penalty") && param1["penalty"] != undefined ? Number(param1["penalty"]) : 0;
         _loc4_ = param1.hasOwnProperty("addition") && param1["addition"] != undefined ? Number(param1["addition"]) : 0;
         ...
         if(_loc9_.length > 0 && _loc9_[0].id != "new_skill")
         {
            ...
            while(_loc10_ < _loc9_.length)
            {
               ...
               this.params[_loc10_ + 1][0] = Boolean(_loc9_[_loc10_].hasOwnProperty("label")) && _loc9_[_loc10_]["label"] != undefined ? _loc9_[_loc10_]["label"] : "";
               this.params[_loc10_ + 1][1] = Boolean(_loc9_[_loc10_].hasOwnProperty("level")) && _loc9_[_loc10_]["level"] != undefined ? _loc9_[_loc10_]["level"] + "%" : "";
               this.params[_loc10_ + 1][2] = Boolean(_loc9_[_loc10_].hasOwnProperty("enabled")) && _loc9_[_loc10_]["enabled"] != undefined ? _loc9_[_loc10_]["enabled"] : "";
               _loc10_++;
            }
         }
         if(param1.hasOwnProperty("status") && param1["status"] != undefined)
         {
            this.statusHeader = Boolean(param1["status"].hasOwnProperty("header")) && param1["status"]["header"] != undefined ? param1["status"]["header"] : "";
            this.statusLevel = Boolean(param1["status"].hasOwnProperty("level")) && param1["status"]["level"] != undefined ? param1["status"]["level"] : "";
            this.statusText = Boolean(param1["status"].hasOwnProperty("text")) && param1["status"]["text"] != undefined ? param1["status"]["text"] : "";
         }
         else
         {
         ...
         if(Boolean(this.statusHeader) || Boolean(this.statusText))
         {
            this.status = true;
         }
      }
