package net.wg.gui.components.windows
{
   ...
   public class SimpleWindow extends SimpleWindowMeta implements ISimpleWindowMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(window != null && Boolean(isInvalid(WindowViewInvalidationType.POSITION_INVALID)))
         {
      ...
      {
         this.headerTf.visible = Boolean(param1) && param1 != Values.EMPTY_STR;
      ...
      private function clearButtons() : void
      {
         ...
         if(this._buttons != null)
         {
            _loc1_ = int(this._buttons.length);
