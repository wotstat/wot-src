package net.wg.gui.components.controls.slotsPanel.impl
{
   ...
   public class BaseSlotsPanel extends SlotsPanelMeta implements ISlotsPanel
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._invalidData.length > 0 && Boolean(isInvalid(INV_SLOT)))
         {
      ...
      {
         var _loc2_:int = int(this._slotsData.length);
      ...
      protected function drawSlots() : void
      {
         ...
         var _loc1_:int = int(this._slotsData.length);
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
            ...
            if(!(this._group != this._allGroupId && this._group != _loc2_.group))
            {
               ...
               {
                  _loc7_ = int(this._storeSlots.length);
                  _loc8_ = -1;
                  _loc9_ = 0;
                  while(_loc9_ < _loc7_)
                  {
      ...
      protected function layoutSlots() : void
      {
         ...
         var _loc2_:int = -1;
         var _loc3_:int = int(this._slotsData.length);
         var _loc7_:int = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
      ...
      private function clearSlots() : void
      {
         ...
         var _loc1_:int = int(this._slots.length);
         var _loc4_:int = int(this._slotsData.length);
         _loc5_ = 0;
         while(_loc5_ < _loc1_)
         {
