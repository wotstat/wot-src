package net.wg.gui.components.controls
{
   ...
   public class SortableTableList extends SortableScrollingList
   {
      ...
      override protected function applySorting(param1:Array) : void
      {
         ...
         {
            if(Boolean(_dataProvider) && _dataProvider is IDAAPISortable)
            {
      ...
      private function checkSelectedItem(param1:int) : int
      {
         ...
         var _loc3_:uint = uint(dataProvider.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_ = dataProvider[_loc4_];
            if(Boolean(this._oldSelectedItem) && Boolean(_loc2_) && this._oldSelectedItem == _loc2_)
            {
               param1 = _loc4_;
               break;
            }
            if(Boolean(this._uniqueKeyForAutoSelect && _loc2_) && Boolean(_loc2_.hasOwnProperty(this._uniqueKeyForAutoSelect)) && this._lastSelectedUniqueValue == _loc2_[this._uniqueKeyForAutoSelect])
            {
               param1 = _loc4_;
               break;
            }
      ...
      private function updateOldSelected(param1:int) : void
      {
         ...
         if(Boolean(_loc2_))
         {
            ...
            if(Boolean(this._uniqueKeyForAutoSelect) && Boolean(this._oldSelectedItem) && this._oldSelectedItem.hasOwnProperty(this._uniqueKeyForAutoSelect))
            {
      ...
      {
         var _loc3_:int = -1;
         var _loc4_:uint = uint(dataProvider.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
      ...
      override public function set selectedIndex(param1:int) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc2_.selectable))
         {
      ...
      {
         if(Boolean(_selectedIndex > -1) && Boolean(dataProvider) && dataProvider.length > 0)
         {
