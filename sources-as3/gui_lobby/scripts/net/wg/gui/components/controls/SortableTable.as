package net.wg.gui.components.controls
{
   ...
   public class SortableTable extends UIComponentEx implements ISortableTable
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._sortingID) && Boolean(isInvalid(INV_SORTING)))
         {
         ...
         if(Boolean(this._scrollToKey) && Boolean(isInvalid(INV_LIST_SCROLL_TO_ITEM)))
         {
         ...
         if(this._header != null && Boolean(isInvalid(INV_HEADER_SORTABLE)))
         {
         ...
         if(this._isSortable && !this._isTableDataEmpty && Boolean(isInvalid(INV_HEADER_SELECTED_INDEX)))
         {
            this._header.selectedIndex = this._headerSelectedIndex;
            _loc2_ = true;
         }
         if(Boolean(this._sortingID) && Boolean(isInvalid(INV_SORT_FIELD)))
         {
            if(this._isSortable && !this._isTableDataEmpty)
            {
               _loc4_ = int(this._header.dataProvider.length);
               _loc5_ = 0;
               while(_loc5_ < _loc4_)
               {
      ...
      {
         if(Boolean(this._isSortable) && Boolean(this._header) && this._header.hasEnabledRenderers())
         {
            return this._header;
         }
         if(Boolean(this._list))
      ...
      {
         this._focusChain.splice(0,this._focusChain.length);
         if(Boolean(this._header) && this._header.hasEnabledRenderers())
         {
      ...
      [Inspectable(name="isListSelectable",defaultValue="true")]
      ...
      [Inspectable(name="scrollbarPadding",defaultValue="top:0,right:0,bottom:0,left:0")]
      ...
      [Inspectable(name="rowHeight",defaultValue="34")]
      ...
      [Inspectable(name="rowHeightFixed",defaultValue="false")]
      ...
      [Inspectable(name="headerHeight",defaultValue="48")]
      ...
      [Inspectable(name="rowWidthAutoResize",defaultValue="true")]
      ...
      [Inspectable(name="listLinkage",defaultValue="SortableScrollingList_UI")]
      ...
      [Inspectable(name="rendererLinkage",defaultValue="TableRenderer_UI")]
      ...
      [Inspectable(name="isSortable",defaultValue="true")]
      ...
      [Inspectable(name="useRightBtn",defaultValue="false")]
      ...
      [Inspectable(name="useSmartScrollbar",defaultValue="true")]
      ...
      [Inspectable(name="isRendererToggle",defaultValue="false")]
