package net.wg.gui.components.controls
{
   ...
   public class ProgressBarAnim extends StatusIndicatorAnim implements IProgressBarAnim
   {
      ...
      protected var _onePercent:Number = 0;
      
      protected var _onePercentWidth:Number = 0;
      
      protected var _maxProgressPixels:Number = 0;
      ...
      protected function layoutMaskProgress(param1:int) : void
      {
         if(param1 > 0)
         {
