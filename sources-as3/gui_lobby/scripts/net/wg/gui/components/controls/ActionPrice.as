package net.wg.gui.components.controls
{
   ...
   public class ActionPrice extends UIComponentEx implements ITextContainer
   {
      ...
      private function getTextColor(param1:String) : uint
      {
         ...
         switch(param1)
         {
            case IconsTypes.GOLD:
               _loc2_ = uint(CURRENCIES_CONSTANTS.GOLD_COLOR);
               break;
            case IconsTypes.GOLD_BIG:
               _loc2_ = uint(CURRENCIES_CONSTANTS.GOLD_BIG_COLOR);
               break;
            case IconsTypes.CREDITS:
               _loc2_ = uint(CURRENCIES_CONSTANTS.CREDITS_COLOR);
               break;
            ...
            case IconsTypes.CRYSTAL:
               _loc2_ = uint(CURRENCIES_CONSTANTS.CRYSTAL_COLOR);
               break;
            case IconsTypes.WDR_COIN:
               _loc2_ = uint(CURRENCIES_CONSTANTS.WDR_COIN_COLOR);
         }
         return _loc2_;
      }
      ...
      private function updateState() : void
      {
         ...
         var _loc1_:int = int(this.numChildren);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function updatePositions() : void
      {
         ...
         else
         {
            ...
            if(Boolean(this.textField.text) && this.textField.text.length > 0)
            {
      ...
      private function updateData() : void
      {
         ...
         if(this._vo.ico != Values.EMPTY_STR && Boolean(this.iconText))
         {
         ...
         {
            _loc1_ = uint(this._textColors[this._textColorType]);
         }
      ...
      private function updateHitArea(param1:String) : void
      {
         ...
         switch(param1)
         {
            case ACTION_PRICE_CONSTANTS.STATE_CAMOUFLAGE:
               _loc2_ = this.alertIco.visible ? Number(this.alertIco.x) : this.textField.x + this.textField.width - this.textField.textWidth + TEXT_FIELD_LEFT_PADDING;
      ...
      private function updateEnabledMode() : void
      {
         ...
         if(Boolean(this._owner && this._owner.enabled) && Boolean(this.enabled) && this._owner is Button)
         {
            _loc1_ = true;
         }
      ...
      [Inspectable(name="textFont",defaultValue="$FieldFont",type="list",enumeration="$FieldFont,$TextFont,$TitleFont")]
      ...
      [Inspectable(name="state",defaultValue="camouflage",type="list",enumeration="alignMiddle,alignTop,camouflage,alignMiddleSmall,alignBottom")]
      ...
      [Inspectable(name="iconPosition",defaultValue="right",type="list",enumeration="right,left")]
      ...
      [Inspectable(name="tooltipEnabled",defaultValue="true")]
      ...
      [Inspectable(name="textColorType",defaultValue="iconColor",type="list",enumeration="iconColor,error,disabledisable")]
      ...
      [Inspectable(name="textYOffset",defaultValue="0")]
      ...
      [Inspectable(name="ico",defaultValue="credits",type="list",enumeration="credits,gold,eliteXp,freeXp,crystal")]
      ...
      {
         if(Boolean(!this._isUseMouseActionSameOwner) && Boolean(this._owner) && this.checkHitTest(this._owner))
         {
