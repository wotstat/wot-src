package net.wg.gui.components.controls
{
   ...
   public class VerticalListViewPort extends UIComponentEx implements IScrollerViewPortBase
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._dataLen > 0 && Boolean(isInvalid(INVALID_LAYOUT)))
         {
      ...
      {
         if(Boolean(param1 >= 0) && Boolean(this._renderersHeight) && param1 < this._renderersHeight.length)
         {
      ...
      private function getDefRendererHeight() : int
      {
         ...
         if(this._defRendererHeight <= 0)
         {
            ...
            this._defRendererHeight = int(_loc1_.height) || MIN_DEF_RENDERER_HEIGHT;
      ...
      public function set dataProvider(param1:IDataProvider) : void
      {
         ...
         this._dataLen = Boolean(this._dataProvider) ? int(this._dataProvider.length) : 0;
         if(this._dataProvider != null)
         {
