package net.wg.gui.components.controls
{
   ...
   public class TankmanTrainingSmallButton extends SlotButtonBase
   {
      ...
      [Inspectable(name="inspectableGroupName",defaultValue="buttonGroup",verbose="1")]
      ...
      override protected function draw() : void
      {
         ...
         {
            if(this._type == TrainingType.FREE || this._type == TrainingType.BLANK)
            {
         ...
         if(Boolean(this._typedData) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            this.trainingLabel.text = this._typedData.isNativeVehicle ? MENU.TANKMANTRAININGBUTTON2_TRAININGTO : MENU.TANKMANTRAININGBUTTON2_RETRAININGTO;
            if(this.price.visible)
            {
               ...
               this.price.x = width - this.price.contentWidth - PRICE_OFFSET;
            }
         }
      ...
      [Inspectable(enumeration="free, scool, academy, blank",defaultValue="free",verbose="1")]
