package net.wg.gui.components.controls
{
   ...
   public class TableRenderer extends SoundListItemRenderer implements ITableRenderer
   {
      ...
      private var _statesPassive:Vector.<String> = Vector.<String>(["passive_"]);
      ...
      override protected function configUI() : void
      {
         ...
         if(Boolean(this.disabledOverlayMc))
         {
      ...
      override protected function draw() : void
      {
         ...
         this.updateDisable(Boolean(_data) && !enabled);
      }
      ...
      {
         if(!this._isPassive && Boolean(App.soundMgr))
         {
      ...
      {
         if(Boolean(this._rendererBgLabelsHash[_newFrame]))
         {
      ...
      private function setDefaultBgState() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(Boolean(this._rendererBgLabelsHash[_loc5_]))
            {
      ...
      {
         if(this._firstClick && Boolean(param1))
         {
            super.handleMouseRelease(param1);
         }
      ...
      private function onMouseDownHandler(param1:MouseEvent) : void
      {
         ...
         var _loc3_:Number = Number(App.appScale);
         if(this.hitTestPoint(_loc2_.x / _loc3_,_loc2_.y / _loc3_,true))
         {
            if(this._firstClick)
            {
               ...
               _loc5_ = _loc4_ == null ? 0 : uint(_loc4_.mouseIdx);
               _loc6_ = _loc4_ == null ? 0 : uint(_loc4_.buttonIdx);
