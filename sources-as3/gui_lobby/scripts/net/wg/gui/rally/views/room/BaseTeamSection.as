package net.wg.gui.rally.views.room
{
   ...
   public class BaseTeamSection extends UIComponentEx implements IBaseTeamSection
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(RallyInvalidationType.RALLY_DATA)) && Boolean(this._rallyData))
         {
         ...
         {
            if(Boolean(this._actionButtonData))
            {
               ...
               if(Boolean(this._actionButtonData.toolTipData) && Boolean(StringUtils.isNotEmpty(this.actionButtonData.toolTipData)))
               {
      ...
      override protected function onDispose() : void
      {
         ...
         while(Boolean(this._slotsUi.length))
         {
      ...
      public function enableFightButton(param1:Boolean) : void
      {
         ...
         if(Boolean(this.btnFight))
         {
            this.btnFight.enabled = param1 && (Boolean(this._actionButtonData) ? this._actionButtonData.isEnabled : true);
         }
         if(Boolean(this.btnNotReady))
         {
            this.btnNotReady.enabled = param1 && (Boolean(this._actionButtonData) ? this._actionButtonData.isEnabled : true);
         }
      }
