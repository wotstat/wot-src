package net.wg.gui.rally.views.room
{
   ...
   public class BaseWaitListSection extends UIComponentEx
   {
      ...
      override protected function configUI() : void
      {
         ...
         if(Boolean(this.btnInviteFriend))
         {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(this._rallyData) ? this._rallyData.isCommander : false;
            _loc2_ = Boolean(this._rallyData) ? this._rallyData.canInvite : false;
      ...
      protected function onListItemClick(param1:ListEventEx) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(param1.buttonIdx == MouseEventEx.RIGHT_BUTTON) && !UserTags.isCurrentPlayer(_loc2_.tags))
         {
