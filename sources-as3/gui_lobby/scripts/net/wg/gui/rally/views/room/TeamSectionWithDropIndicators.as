package net.wg.gui.rally.views.room
{
   ...
   public class TeamSectionWithDropIndicators extends BaseTeamSection implements IDropList, ITeamSectionWithDropIndicators
   {
      ...
      private function stateSlots() : void
      {
         ...
         var _loc3_:int = int(this._indicatorsUI.length);
         var _loc5_:int = 1;
         while(_loc5_ < _loc3_)
         {
      ...
      override public function highlightSlots(param1:Array) : void
      {
         ...
         if(Boolean(rallyData) && rallyData.isCommander)
         {
            _loc2_ = int(this._indicatorsUI.length);
            _loc4_ = 0;
            while(_loc4_ < _loc2_)
            {
      ...
      override protected function updateComponents() : void
      {
         ...
         var _loc2_:Boolean = Boolean(rallyData) ? rallyData.isCommander : false;
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_.playerStatus = Boolean(_loc1_) ? int(_loc1_[_loc3_.index].playerStatus) : 0;
      ...
      override protected function onDispose() : void
      {
         ...
         this.assertDropIndicatorsNotNull();
         while(Boolean(this._indicatorsUI.length))
         {
      ...
      private function onIndicatorDoubleClickHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(_loc3_.player) && _loc3_.isCommanderState)
         {
