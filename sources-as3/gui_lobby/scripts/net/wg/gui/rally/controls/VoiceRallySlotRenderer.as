package net.wg.gui.rally.controls
{
   ...
   public class VoiceRallySlotRenderer extends RallySimpleSlotRenderer
   {
      ...
      public function updateVoiceWave() : void
      {
         ...
         this.voiceWave.setMuted(Boolean(slotData) && Boolean(slotData.player) ? Boolean(UserTags.isMuted(slotData.player.tags)) : false);
      }
      ...
      public function setSpeakers(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         if(Boolean(slotData) && Boolean(slotData.player))
         {
      ...
      {
         if(Boolean(slotData) && Boolean(slotData.player) && param1 == slotData.player.dbID)
         {
