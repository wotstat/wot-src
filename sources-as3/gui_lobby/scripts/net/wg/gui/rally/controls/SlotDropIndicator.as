   ...
   public class SlotDropIndicator extends UIComponentEx implements ISlotDropIndicator
   {
      ...
      private function updateMouseEnabled() : void
      {
         if(this._isEnabled)
         {
            ...
            {
               mouseEnabled = this._index > 0 && (this._isHighlighted || Boolean(this._data));
            }
            else
            {
               mouseEnabled = Boolean(this._data) && !UserTags.isCurrentPlayer(this._data.tags);
            }
         }
         else
         {
      ...
      {
         if(Boolean(this._legionariesIcon))
         {
      ...
      private function onClickHandler(param1:MouseEvent) : void
      {
         ...
         if(App.utils.commons.isRightButton(param1))
         {
            ...
            if(Boolean(_loc2_) && !this._isUserNameLoading)
            {
