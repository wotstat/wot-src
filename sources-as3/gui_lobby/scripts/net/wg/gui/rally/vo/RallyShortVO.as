package net.wg.gui.rally.vo
{
   ...
   public class RallyShortVO extends DAAPIDataClass implements IRallyVO
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.slots))
         {
            _loc1_ = null;
            while(Boolean(this.slots.length))
            {
