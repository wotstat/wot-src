package net.wg.gui.prebattle.invites
{
   ...
   public class UserRosterItemRenderer extends SoundListItemRenderer
   {
      ...
      {
         if(Boolean(this.focusIndicatorA))
         {
      ...
      override protected function draw() : void
      {
         ...
         var _loc1_:Boolean = Boolean(isInvalid(UPDATE_DATA)) && Boolean(this._model);
         if(_loc1_ && Boolean(enabled))
         {
      ...
      private function afterSetData() : void
      {
         ...
         this.label = _loc1_;
         if(Boolean(UserTags.isIgnored(_loc2_)) || Boolean(UserTags.isMuted(_loc2_)))
         {
      ...
      override protected function updateAfterStateChange() : void
      {
         ...
         if(Boolean(this._model))
         {
            ...
            _loc2_ = Boolean(UserTags.isMuted(_loc1_));
            _loc3_ = Boolean(UserTags.isIgnored(_loc1_));
            this.updateVoiceWave();
            if(_loc3_ || _loc2_)
            {
               if(this._model.colors[1] != null)
      ...
      private function cutText(param1:String) : String
      {
         ...
         {
            _loc2_ = param1;
            _loc3_ = int(textField.getLineLength(0));
