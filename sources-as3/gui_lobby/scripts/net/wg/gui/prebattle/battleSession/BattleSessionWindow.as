   ...
   public class BattleSessionWindow extends BattleSessionWindowMeta implements IBattleSessionWindowMeta
   {
      ...
      override protected function setRosterList(param1:int, param2:Boolean, param3:DataProvider) : void
      {
         ...
         while(_loc7_ < _loc4_)
         {
            ...
            _loc6_.orderNumber = param2 ? _loc7_ + 1 : this._firstLength + _loc7_ + 1;
            if(!_loc5_)
            {
         ...
         if(param2)
         {
            this.numberingContainer.x = _loc5_ ? NUMBERING_WIDE_X : NUMBERING_X;
            ...
            while(_loc8_ < _loc4_)
            {
               if(Boolean(param3[_loc8_].isCurrentPayer))
               {
         ...
         else
         {
            ...
            while(_loc9_ < _loc4_)
            {
               if(Boolean(param3[_loc9_].isCurrentPayer))
               {
      ...
      private function updateNumberingVisibility() : void
      {
         ...
         var _loc2_:int = int(this.memberList.dataProvider.length);
         var _loc3_:uint = Math.min(_loc1_,this._maxPlayersCount);
         var _loc5_:uint = 0;
         while(_loc5_ < _loc1_)
         {
            _loc4_ = this._numberingTFs[_loc5_];
            _loc4_.visible = _loc5_ < _loc3_ ? _loc5_ >= _loc2_ : false;
            _loc5_++;
         }
      }
      ...
      {
         var _loc1_:uint = 0;
         _loc1_ = uint(this.memberList.dataProvider.length);
         var _loc2_:uint = uint(this.memberStackList.dataProvider.length);
      ...
      private function isCanMoveMemberTo(param1:Number, param2:ScrollingListEx) : Boolean
      {
         ...
         if(param1 == -1)
         {
            if(param2.dataProvider.length > 0)
            {
               ...
               _loc3_ = _loc4_ ? canMoveToAssignedS(_loc5_.accID) : canMoveToUnassignedS(_loc5_.accID);
            }
            else
            {
               _loc3_ = false;
         ...
         {
            _loc3_ = _loc4_ ? canMoveToAssignedS(param1) : canMoveToUnassignedS(param1);
         }
         return _loc3_;
      }
      ...
      private function onUpButtonClickHandler(param1:ButtonEvent) : void
      {
         ...
         var _loc3_:int = int(this.memberStackList.selectedIndex);
      ...
      private function onDownButtonClickHandler(param1:ButtonEvent) : void
      {
         ...
         var _loc3_:int = int(this.memberList.selectedIndex);
         if(_loc2_.length > 0 && _loc3_ > -1)
         {
