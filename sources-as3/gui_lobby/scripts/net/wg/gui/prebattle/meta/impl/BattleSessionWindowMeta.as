package net.wg.gui.prebattle.meta.impl
{
   ...
   public class BattleSessionWindowMeta extends PrebattleWindowAbstract
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._dataProviderBSFlagRendererVO))
         {
         ...
         if(Boolean(this._vectorBSFilterVO))
         {
      ...
      final public function as_setNationsLimits(param1:Array) : void
      {
         var _loc3_:uint = 0;
         var _loc4_:int = 0;
      ...
      final public function as_setFilters(param1:Array, param2:uint) : void
      {
