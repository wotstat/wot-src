package net.wg.gui.prebattle.controls
{
   ...
   public class TeamMemberRendererBase extends SoundListItemRenderer
   {
      ...
      override public function setData(param1:Object) : void
      {
         ...
         {
            if(Boolean(this.data) && this.currentDbID == param1.dbID)
            {
      ...
      override protected function updateAfterStateChange() : void
      {
         ...
         if(Boolean(this.model) && Boolean(this.model.vLevel != null) && this.model.vLevel != Values.EMPTY_STR)
         {
         ...
         this.vehicleNameField.htmlText = Boolean(this.model) && Boolean(this.model.vShortName) ? this.model.vShortName : Values.EMPTY_STR;
         this.updateVoiceWave();
         var _loc1_:Number = Boolean(this.model) ? this.model.getCurrentColor() : Number.NaN;
         if(!isNaN(_loc1_))
         {
      ...
      {
         if(Boolean(this.model) && param1 == this.model.dbID)
         {
            if(Boolean(data) && Boolean(this.model) && this.currentDbID == data.dbID)
            {
      ...
      {
         if(Boolean(this.model) && this.model.dbID != -1)
         {
      ...
      {
         this.voiceWave.visible = App.voiceChatMgr.isVOIPEnabledS();
         this.voiceWave.setMuted(Boolean(this.model) ? Boolean(UserTags.isMuted(this.model.tags)) : false);
      }
