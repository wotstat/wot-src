package net.wg.gui.notification.vo
{
   ...
   public class MessageInfoVO extends DAAPIDataClass
   {
      ...
      private var _buttonsLayout:Vector.<ButtonVO> = new Vector.<ButtonVO>();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.filters))
         {
            this.filters.splice(0,this.filters.length);
            this.filters = null;
         }
         var _loc1_:ButtonVO = null;
         while(Boolean(this._buttonsLayout.length))
         {
      ...
      {
         var _loc1_:int = int(this._buttonsLayout.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
