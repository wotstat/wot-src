package net.wg.gui.notification
{
   ...
   public class ProgressiveStyleMessageContent extends ServiceMessageContent
   {
      ...
      public function ProgressiveStyleMessageContent()
      {
         super();
      }
      ...
      override protected function updateLayout() : void
      {
         ...
         var _loc2_:uint = uint(bgIcon.y);
         if(Boolean(bgIcon.source))
         {
