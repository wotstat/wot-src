package net.wg.gui.notification
{
   ...
   public class NotificationListView extends NotificationsListMeta implements INotificationsListMeta
   {
      ...
      override protected function configUI() : void
      {
         ...
         this.goToNewsWidget.addEventListener(NewsWidgetEvent.ON_CLICK,this.onGoToNewsWidgetOnClick);
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.progressiveRewardWidget))
         {
            this.progressiveRewardWidget.removeEventListener(Event.RESIZE,this.onProgressiveRewardResizeHandler);
         }
         this.goToNewsWidget.removeEventListener(NewsWidgetEvent.ON_CLICK,this.onGoToNewsWidgetOnClick);
         ...
         this.scrollBar = null;
         var _loc1_:int = int(this.buttonBar.dataProvider.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function updateListItemsLayout() : void
      {
         ...
         if(this._progressiveRewardEnabled && Boolean(this.progressiveRewardWidget.visible))
         {
      ...
      private function onGoToNewsWidgetOnClick(param1:NewsWidgetEvent) : void
      {
         onCheckNewsClick();
      }
