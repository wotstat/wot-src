package net.wg.gui.notification
{
   ...
   public class ServiceMessageBase extends UIComponentEx
   {
      ...
      {
         if(Boolean(this._data) && Boolean(this._data.messageVO) && Boolean(this._data.messageVO.linkage))
         {
      ...
      {
         return Boolean(this._data) && Boolean(this._data.messageVO) && Boolean(this._data.messageVO.gfViewName);
      }
