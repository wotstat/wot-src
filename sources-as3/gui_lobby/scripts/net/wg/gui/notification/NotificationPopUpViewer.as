package net.wg.gui.notification
{
   ...
   public class NotificationPopUpViewer extends NotificationPopUpViewerMeta implements INotificationPopUpViewerMeta
   {
      ...
      private var _pendingForDisplay:Vector.<PopUpNotificationInfoVO> = new Vector.<PopUpNotificationInfoVO>();
      
      private var _displayingNowPopUps:Vector.<ServiceMessagePopUp> = new Vector.<ServiceMessagePopUp>();
      
      private var _animationManager:ExcludeTweenManager = new ExcludeTweenManager();
      ...
      private var _padding:Point = DEFAULT_PADDING;
      
      private var _externalPadding:Point = null;
      
      private var _smContainer:DisplayObjectContainer = App.systemMessages;
      
      private var _containerMgr:IContainerManager = App.instance.containerMgr;
      ...
      override protected function draw() : void
      {
         ...
         var _loc9_:int = 0;
         super.draw();
         if(this._arrangeLayout && Boolean(this._stageDimensions))
         {
            this.setupEarningPosition();
         }
         if((this._arrangeLayout || this._isMessagesCountInvalid) && Boolean(this._stageDimensions))
         {
            _loc4_ = 0;
      ...
      private function getPopUpDisplayingIndex(param1:uint, param2:Number) : int
      {
         ...
         var _loc4_:int = int(this._displayingNowPopUps.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc3_ = this._displayingNowPopUps[_loc5_].data as PopUpNotificationInfoVO;
            if(Boolean(_loc3_) && Boolean(_loc3_.typeID == param1) && _loc3_.entityID == param2)
            {
               return _loc5_;
            }
            _loc5_++;
      ...
      {
         var _loc3_:PopUpNotificationInfoVO = null;
         var _loc4_:int = int(this._pendingForDisplay.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
      ...
      {
         var _loc1_:Boolean = (this._countViewsWithExternalPadding > 0 || this._useViewPadding) && this._countOverlayViews == 0 && Boolean(this._externalPadding);
      ...
      private function onSmContainerUpdateLayoutHandler(param1:NotificationLayoutEvent) : void
      {
         ...
         if(Boolean(this._externalPadding) && Boolean(_loc2_) && this._externalPadding.equals(_loc2_))
         {
            return;
         }
