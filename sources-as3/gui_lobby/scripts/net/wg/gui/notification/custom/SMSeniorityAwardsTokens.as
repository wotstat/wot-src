package net.wg.gui.notification.custom
{
   ...
   public class SMSeniorityAwardsTokens extends ServiceMessageContent
   {
      ...
      override protected function updateData() : void
      {
         ...
         if(Boolean(StringUtils.isNotEmpty(_loc1_.finishTime)) && this._timeLeft == null)
         {
      ...
      {
         textField.y = this._hasTimer ? this._defTextYPos : this._defTextYPos + TEXT_Y_SHIFT;
         this.updateTimerPosition();
         super.updateLayout();
      }
