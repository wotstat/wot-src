package net.wg.gui.notification
{
   ...
   public class SystemMessageDialog extends SystemMessageDialogMeta implements ISystemMessageDialogMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(this.messageData) && Boolean(isInvalid(DATA_INVALID)))
         {
         ...
         if(Boolean(isInvalid(DIMENSIONS_INVALID)) && Boolean(window))
         {
         ...
         if(Boolean(isInvalid(INIT_DATA_INVALID)) && Boolean(window))
         {
      ...
      {
         var _loc2_:int = int(MessageMetrics.ICON_DEFAULT_PADDING_X);
