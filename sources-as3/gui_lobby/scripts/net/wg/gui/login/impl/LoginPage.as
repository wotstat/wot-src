package net.wg.gui.login.impl
{
   ...
   public class LoginPage extends LoginPageMeta implements ILoginPageMeta
   {
      ...
      override protected function showSimpleForm(param1:Boolean, param2:DataProvider, param3:Boolean) : void
      {
         ...
         this._simpleFormDataVo.isShowSocial = param1 && Boolean(param2);
      ...
      private function onInputHandler(param1:InputEvent) : void
      {
         ...
         if(Boolean(param1.handled) || Boolean(App.waiting) && Boolean(App.waiting.isOnStage))
         {
            return;
         }
...
class LoginFormPositionHelper
{
   ...
   public function LoginFormPositionHelper()
   {
      super();
   }
   ...
   public static function getLoginFormPosition(param1:int) : int
   {
      ...
      var _loc8_:int = 0;
      var _loc2_:int = 0;
      var _loc5_:uint = uint(SCREEN_HEIGHT.length);
      while(_loc2_ < _loc5_ - 1)
      {
         _loc3_ = int(SCREEN_HEIGHT[_loc2_]);
         _loc4_ = int(SCREEN_HEIGHT[_loc2_ + 1]);
      ...
      {
         _loc8_ = int(SCREEN_HEIGHT[SCREEN_HEIGHT.length - 1]);
