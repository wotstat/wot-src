package net.wg.gui.login.impl.views
{
   ...
   public class SimpleForm extends LoginFormView
   {
      ...
      {
         if(this.login.text.length == 0 || Boolean(this.login.highlight))
         {
      ...
      private function onInputHandler(param1:InputEvent) : void
      {
         if(param1.details.value == InputValue.KEY_DOWN)
         {
            ...
            this._hasCtrlVDown = this._lastDownKeyCode == Keyboard.V && Boolean(param1.details.ctrlKey);
         }
      }
      ...
      {
         var _loc2_:String = Boolean(this._dataVo) && this._dataVo.isShowSocial ? TOOLTIPS.LOGIN_REMEMBERPASSWORD_SIMPLE : TOOLTIPS.LOGIN_REMEMBERPASSWORD_SOCIAL;
