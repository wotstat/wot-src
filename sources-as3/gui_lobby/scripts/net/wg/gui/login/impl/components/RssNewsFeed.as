package net.wg.gui.login.impl.components
{
   ...
   public class RssNewsFeed extends RssNewsFeedMeta implements IRssNewsFeedMeta
   {
      ...
      private var _padding:Padding = new Padding(10,20,40,7);
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            {
               _loc5_ = false;
               _loc6_ = int(this._rssItems.length);
               _loc2_ = 0;
               while(_loc2_ < _loc6_)
               {
      ...
      private function updateRenderersPositions() : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc1_:int = int(this._rssItems.length);
         var _loc4_:IRssNewsFeedRenderer = null;
         var _loc5_:DisplayObject = null;
         var _loc6_:Number = Number(this._padding.bottom);
         _loc2_ = 0;
         _loc3_ = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function updateBG() : void
      {
         ...
         if(Boolean(this.container) && Boolean(this.container.numChildren))
         {
            _loc1_ = false;
            _loc2_ = 0;
            _loc3_ = 0;
