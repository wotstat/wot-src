package net.wg.gui.cyberSport.views.autoSearch
{
   ...
   public class StateViewBase extends UIComponentEx implements IAutoSearchFormView
   {
      ...
      {
         super.draw();
         if(Boolean(isInvalid(InvalidationType.DATA)) && Boolean(this.model))
         {
      ...
      {
         if(Boolean(visible) && Boolean(this.cancelButton) && Boolean(this.cancelButton.visible))
         {
      ...
      protected function formatTime(param1:int) : Object
      {
         ...
         var _loc3_:uint = uint(_loc2_ / Time.HOUR | 0);
      ...
      protected function updateTime() : void
      {
         ...
         if(Boolean(this.min) && Boolean(this.sec))
         {
      ...
      override public function handleInput(param1:InputEvent) : void
      {
         ...
         {
            param1.handled = true;
            if(Boolean(this.cancelButton) && (this.model.canInvokeAutoSearch || this.model.canInvokeBattleQueue))
            {
