package net.wg.gui.cyberSport.views.unit
{
   ...
   public class TeamSection extends CyberSportTeamSectionBase
   {
      ...
      override protected function updateComponents() : void
      {
         ...
         var _loc1_:Boolean = Boolean(unitData) ? unitData.isCommander : false;
      ...
      public function updateLockedUnit(param1:Boolean, param2:Array) : void
      {
         ...
         var _loc3_:int = int(unitData.slots.length);
      ...
      {
         if(Boolean(unitData) && !unitData.isCommander)
         {
            this.settingsIcons.visible = true;
            this.settingsIcons.flakeVisible = Boolean(unitData) ? unitData.isFreezed : false;
            this.settingsIcons.gearVisible = Boolean(unitData) ? unitData.hasRestrictions : false;
         }
         else
         {
      ...
      override protected function onControlRollOver(param1:MouseEvent) : void
      {
         ...
         switch(param1.currentTarget)
         {
            case this.btnFreeze:
               ...
               _loc3_ = Boolean(rallyData) && unitData.isFreezed ? TOOLTIPS.CYBERSPORT_UNIT_FREEZE_BODYON : TOOLTIPS.CYBERSPORT_UNIT_FREEZE_BODYOFF;
