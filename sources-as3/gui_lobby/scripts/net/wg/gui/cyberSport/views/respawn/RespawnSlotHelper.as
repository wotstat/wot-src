   ...
   public class RespawnSlotHelper extends BaseRallySlotHelper
   {
         ...
         if(Boolean(_loc6_) && Boolean(_loc5_))
         {
            switch(param1)
            {
               ...
               case _loc5_.vehicleBtn:
                  ...
                  {
                     if(Boolean(param4) && param4.type == CSVehicleButton.ALERT_DATA_TYPE)
                     {
      ...
      override public function updateComponents(param1:IRallySimpleSlotRenderer, param2:IRallySlotVO) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(_loc4_))
         {
            ...
            _loc3_.levelLbl.alpha = Boolean(_loc4_.selectedVehicleLevel) ? 1 : ALLY_LEVEL_ALPHA;
            if(Boolean(_loc4_.player))
            {
