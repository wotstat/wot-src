package net.wg.gui.cyberSport.views.autoSearch
{
   ...
   public class WaitingPlayers extends StateViewBase
   {
      ...
      override protected function onDispose() : void
      {
         ...
         this._players = null;
         if(Boolean(this.player1))
         {
            this.player1.dispose();
            this.player1 = null;
         }
         if(Boolean(this.player2))
         {
            this.player2.dispose();
            this.player2 = null;
         }
         if(Boolean(this.player3))
         {
            this.player3.dispose();
            this.player3 = null;
         }
         if(Boolean(this.player4))
         {
            this.player4.dispose();
            this.player4 = null;
         }
         if(Boolean(this.player5))
         {
            this.player5.dispose();
            this.player5 = null;
         }
         if(Boolean(this.player6))
         {
            this.player6.dispose();
            this.player6 = null;
         }
         if(Boolean(this.player7))
         {
