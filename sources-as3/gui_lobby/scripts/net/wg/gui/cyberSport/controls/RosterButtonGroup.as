package net.wg.gui.cyberSport.controls
{
   ...
   public class RosterButtonGroup extends ButtonGroup
   {
      ...
      override protected function updateSelectedButton(param1:Button, param2:Boolean = true) : void
      {
         ...
         var _loc3_:Boolean = !param2 && param1 == selectedButton && Boolean(param1.allowDeselect);
         var _loc4_:Boolean = !param2 && param1 == this.olderSelectedButton && Boolean(param1.allowDeselect);
      ...
      {
         var _loc1_:Array = [];
         if(Boolean(selectedButton))
         {
            _loc1_.push(selectedButton.data);
         }
         if(Boolean(this.olderSelectedButton))
         {
