package net.wg.gui.lobby.components.vehPostProgression
{
   ...
   public class EntryPointBg extends UIComponentEx
   {
      ...
      private var _bgBorder:Sprite = new Sprite();
      ...
      {
         var _loc1_:Number = this._isHoverState ? BG_ALPHA_HOVER : BG_ALPHA;
         var _loc2_:Number = this._isHoverState ? BORDER_ALPHA_HOVER : BORDER_ALPHA;
         this._bgBorder.graphics.clear();
