package net.wg.gui.lobby.components
{
   ...
   public class VehicleButton extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.goToVehicleViewBtn) && Boolean(isInvalid(InvalidationType.STATE)))
         {
         ...
         if(Boolean(this._vehData) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            this.subButtonsMode = this._vehData.isInInventory || !this._vehData.previewBtnEnabled ? VehicleButton.COMPARE_ONLY_MODE : VehicleButton.NORMAL_MODE;
      ...
      private function onMouseClickHandler(param1:MouseEvent) : void
      {
         ...
         else if(Boolean(App.contextMenuMgr))
         {
