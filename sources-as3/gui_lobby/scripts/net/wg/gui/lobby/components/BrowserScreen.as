package net.wg.gui.lobby.components
{
   ...
   public class BrowserScreen extends BrowserScreenMeta implements IBrowserScreenMeta
   {
      ...
      {
         return Boolean(this.browserParams) ? this.browserParams.isModal : super.isModal;
      }
      ...
      override protected function draw() : void
      {
         var _loc1_:int = 0;
         super.draw();
         if(Boolean(this.browserParams) && Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            this.waiting.setSize(_width,_height);
            this.screenBg.setSize(_width,_height + this.bottomPanelHeight);
            _loc1_ = _width > 1366 ? CLOSE_BUTTON_PADDING_BIG : CLOSE_BUTTON_PADDING_SMALL;
      ...
      {
         return this.isModal ? int(Values.ZERO) : 36;
      }
   }
}
