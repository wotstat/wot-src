package net.wg.gui.lobby.components
{
   ...
   public class VehicleSelectorFilter extends UIComponentEx implements IVehicleSelectorFilter
   {
      ...
      {
         super.draw();
         if(Boolean(this._mode) && Boolean(isInvalid(INVALID_MODE)))
         {
      ...
      private function updateVisibility() : void
      {
         ...
         var _loc5_:int = int(this._controlsOrder.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
      ...
      private function onFiltersIndexChangeHandler(param1:Event = null) : void
      {
         ...
         _loc5_.nation = Boolean(_loc2_) ? int(_loc2_.data) : -1;
         _loc5_.vehicleType = Boolean(_loc3_) ? _loc3_.data : null;
         _loc5_.level = Boolean(_loc4_) ? int(_loc4_.data) : -1;
