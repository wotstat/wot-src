package net.wg.gui.lobby.components
{
   ...
   public class BaseMissionDetailsContainerView extends BaseMissionDetailsContainerViewMeta implements IBaseMissionDetailsContainerViewMeta, IInnerView
   {
      ...
      private static const FADE_IN_DELAY:int = 200;
      ...
      override protected function configUI() : void
      {
         ...
         this.addListeners();
         this.bg.y = this._paddings.y > 0 ? 0 : TOP_PANEL_HEIGHT;
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._data != null && Boolean(isInvalid(INV_PAGINATOR_DATA)))
         {
            if(this._data.len > MIN_PAGES)
            {
         ...
         if(this._data != null && this._missionData != null && Boolean(isInvalid(INV_PAGE)))
         {
            if(this._currentMissionIndex < this._data.len)
            {
      ...
      {
         this._pageController.setPositions(this.getPaginatorPos());
      }
