package net.wg.gui.lobby.components
{
   ...
   public class StatisticsBodyContainer extends UIComponentEx
   {
      ...
      private var _availableSize:Point = new Point();
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(Boolean(this.bar.dataProvider))
            {
               _loc3_ = uint(this.bar.dataProvider.length);
         ...
         if(isInvalid(LAYOUT_INVALID))
         {
            ...
            if(Boolean(this.bar.dataProvider) && this.bar.dataProvider.length > 1)
            {
      ...
      private function onBarIndexChangeHandler(param1:IndexEvent) : void
      {
         ...
         if(_loc2_ != -1 && Boolean(param1.data))
         {
