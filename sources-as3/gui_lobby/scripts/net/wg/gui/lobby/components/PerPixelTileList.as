package net.wg.gui.lobby.components
{
   ...
   public class PerPixelTileList extends TileList
   {
      ...
      override protected function draw() : void
      {
         ...
         var _loc1_:Boolean = Boolean(isInvalid(InvalidationType.RENDERERS));
         ...
         if(_loc1_)
         {
            ...
            {
               _totalColumns = externalColumnCount == 0 ? 1 : uint(externalColumnCount);
         ...
         var _loc3_:Boolean = Boolean(isInvalid(InvalidationType.DATA));
         if(_loc3_ || !_usingExternalRenderers && _loc1_)
         {
            if(_renderers != null)
            {
               _loc5_ = uint(_renderers.length);
               _loc4_ = 0;
               while(_loc4_ < _loc5_)
               {
      ...
      {
         _totalRenderers = Boolean(dataProvider) ? uint(dataProvider.length) : 0;
         if(Boolean(_totalRenderers))
         {
      ...
      override protected function populateData(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            else if(Boolean(param1[_loc4_].hasOwnProperty("enabled")))
            {
      ...
      override protected function updateScrollBar() : void
      {
         ...
         var _loc1_:int = int(_dataProvider.length);
         if(smartScrollBar)
         {
      ...
      override public function handleInput(param1:InputEvent) : void
      {
         ...
         if(_loc5_ != int.MIN_VALUE)
         {
            ...
            {
               selectedIndex = _loc5_ < 0 ? int(_dataProvider.length - 1) : (selectedIndex < _dataProvider.length - 1 ? int(_dataProvider.length - 1) : 0);
               param1.handled = true;
            }
         }
      }
