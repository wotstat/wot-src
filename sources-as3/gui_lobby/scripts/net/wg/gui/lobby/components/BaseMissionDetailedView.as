package net.wg.gui.lobby.components
{
   ...
   public class BaseMissionDetailedView extends UIComponentEx
   {
      ...
      public function set contentAlpha(param1:Number) : void
      {
         ...
         var _loc2_:Number = enabled ? Number(Values.DEFAULT_ALPHA) : DISABLED_ALPHA;
      ...
      {
         if(Boolean(this._vo) && Boolean(StringUtils.isNotEmpty(this._vo.statusLabel)))
         {
