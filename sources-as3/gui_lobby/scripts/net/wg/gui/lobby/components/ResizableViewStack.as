package net.wg.gui.lobby.components
{
   ...
   public class ResizableViewStack extends DataViewStack
   {
      ...
      {
         return Boolean(this.availableSize) ? this.availableSize.x : super.width;
      }
      
      override public function get height() : Number
      {
         return Boolean(this.availableSize) ? this.availableSize.y : super.height;
      }
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this.availableSize) && Boolean(currentView))
            {
