package net.wg.gui.lobby.components.data
{
   ...
   public class VehicleSelectorFilterVO extends DAAPIDataClass implements IVehicleSelectorFilterVO
   {
      ...
      private var _visibility:int = VEHICLE_SELECTOR_CONSTANTS.VISIBLE_LEVEL | VEHICLE_SELECTOR_CONSTANTS.VISIBLE_NATION | VEHICLE_SELECTOR_CONSTANTS.VISIBLE_VEHICLE_TYPE | VEHICLE_SELECTOR_CONSTANTS.VISIBLE_IS_MAIN | VEHICLE_SELECTOR_CONSTANTS.VISIBLE_COMPATIBLE_ONLY;
      ...
      {
         if(Boolean(this._nationDP))
         {
            this._nationDP.cleanUp();
            this._nationDP = null;
         }
         if(Boolean(this._vehicleTypesDP))
         {
            this._vehicleTypesDP.cleanUp();
            this._vehicleTypesDP = null;
         }
         if(Boolean(this._levelsDP))
         {
