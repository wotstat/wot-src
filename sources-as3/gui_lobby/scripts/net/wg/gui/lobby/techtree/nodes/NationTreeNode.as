package net.wg.gui.lobby.techtree.nodes
{
   ...
   public class NationTreeNode extends Renderer implements IBorderHighlighted
   {
      ...
      override public function getColorIndex(param1:IRenderer = null) : uint
      {
         ...
         {
            if(Boolean(_loc2_) && Boolean(_loc2_.hasTechTreeEvent) && _loc2_.isFirstTimeActionShow)
            {
         ...
         if(isEarlyAccess)
         {
            _loc3_ = Boolean(_loc2_) && _loc2_.getNodeData().isEarlyAccess;
            return isFirstTimeEarlyAccessShow && _loc3_ ? ColorIndex.EARLY_ACCESS : ColorIndex.LOCKED;
         }
      ...
      override public function invalidateNodeState() : void
      {
         ...
         if(Boolean(_loc1_) && _loc1_ is NTDisplayInfo)
         {
      ...
      override protected function validateData() : void
      {
         ...
         if(Boolean(this.xpField))
         {
            ...
            this.xpField.x = _loc4_ && Boolean(this.discountIcon) ? XP_FIELD_ACTION_OFFSET_X : XP_FIELD_DEFAULT_OFFSET_X;
         }
         if(Boolean(this.eaField))
         {
            ...
            this.eaField.x = _loc4_ && Boolean(this.discountIcon) ? XP_FIELD_ACTION_OFFSET_X : XP_FIELD_DEFAULT_OFFSET_X;
         }
         if(Boolean(this.xpField) && Boolean(this.eaField))
         {
            if(Boolean(this.eaField.visible) || getNodeData().isEarlyAccessLocked)
            {
               this.xpField.visible = false;
            }
         }
         ...
         if(this.isBlueprintMode && !isEarlyAccess)
         {
            ...
            this.blueprintProgressBar.alpha = _loc2_ ? PROGRESS_BAR_RESEARCH_AVAILABLE_ALPHA : PROGRESS_BAR_RESEARCH_UNAVAILABLE_ALPHA;
            _loc6_ = !isUnlocked();
         ...
         if(Boolean(this.earlyAccessLock))
         {
            this.earlyAccessLock.visible = isEarlyAccess && isEarlyAccessLocked;
         }
         if(Boolean(this.earlyAccessBorder))
         {
         ...
         this.nameTF.width = getNodeData().isNationChangeAvailable ? NAME_TF_SHORT_WIDTH_FOR_NATION_CHANGE_ICON : NAME_TF_FULL_WIDTH;
         this.setTradeIcon();
      ...
      {
         if(Boolean(this.techTreeEventAnimMc))
         {
            this.techTreeEventAnimMc = null;
         }
         if(Boolean(this.techTreeEventFrameMc))
         {
         ...
         if(Boolean(this.lockedModuleHighlight))
         {
      ...
      {
         return Boolean(this.lockedModuleHighlight) ? this.lockedModuleHighlight.isHighlighted : false;
      }
      ...
      {
         if(!isNotClickable() && Boolean(App.utils.commons.isLeftButton(param1)))
         {
