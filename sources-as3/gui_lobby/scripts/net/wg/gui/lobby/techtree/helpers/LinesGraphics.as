package net.wg.gui.lobby.techtree.helpers
{
   ...
   public class LinesGraphics extends Sprite implements IDisposable
   {
      ...
      protected function getLineStyle(param1:IRenderer) : uint
      {
         ...
         var _loc3_:Boolean = Boolean(_loc2_) ? _loc2_.isEarlyAccess : false;
         var _loc4_:Boolean = Boolean(_loc2_) ? _loc2_.isEarlyAccessLocked : false;
         var _loc5_:Boolean = Boolean(_loc2_) ? _loc2_.isEarlyAccessPaused : false;
         if(_loc3_ && (_loc4_ || _loc5_))
         {
            return LineStyle.DASHED;
         }
         if(Boolean(_loc2_) && _loc2_.isLockedByParagons)
         {
            return LineStyle.DASHED;
         }
