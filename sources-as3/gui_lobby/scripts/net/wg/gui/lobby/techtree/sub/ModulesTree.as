package net.wg.gui.lobby.techtree.sub
{
   ...
   public class ModulesTree extends UIComponentEx implements IResearchContainer, IFocusContainer
   {
      ...
      {
         super.draw();
         if(this._drawEnabled && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      protected function updateLayout() : void
      {
         ...
         var _loc7_:int = int(_loc1_.column);
         var _loc8_:int = 1;
         while(_loc8_ < _loc7_)
         {
