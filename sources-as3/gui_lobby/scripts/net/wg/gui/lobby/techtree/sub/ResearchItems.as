package net.wg.gui.lobby.techtree.sub
{
   ...
   public class ResearchItems extends ModulesTree implements ITutorialCustomComponent, IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._postProgressionEntry) && Boolean(isInvalid(InvalidationType.LAYOUT)))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._postProgressionEntry))
         {
      ...
      override protected function updateLayout() : void
      {
         ...
         var _loc7_:int = int(this._topRenderers.length);
         _loc2_ = 0;
      ...
      public function setItemsField(param1:Array, param2:String) : void
      {
         ...
         while(_loc7_ < _loc3_)
         {
            ...
            _loc4_ = Number(_dataProvider.getIndexByID(_loc5_[0]));
      ...
      public function setNodesStates(param1:Number, param2:Array, param3:String = null, param4:Boolean = false) : void
      {
         ...
         while(_loc11_ < _loc5_)
         {
            ...
            _loc8_ = null;
            _loc7_ = false;
            _loc10_ = int(_dataProvider.getIndexByID(_loc9_));
            if(_loc10_ > -1 && _dataProvider.length > _loc10_)
            {
               ...
               _loc7_ = Boolean(_dataProvider.setState(_loc10_,param1,_loc6_[1]));
      ...
      public function setVehicleTypeXP(param1:Array) : void
      {
         ...
         while(_loc7_ < _loc2_)
         {
            ...
            _loc5_ = int(_loc3_[0]);
            _loc4_ = null;
            _loc6_ = int(_dataProvider.getIndexByID(_loc5_));
      ...
      {
         var _loc1_:Boolean = Boolean(this._postProgressionData) && this._postProgressionData.state != POSTPROGRESSION_CONSTS.RESEARCH_STATE_HIDDEN;
         if(Boolean(this._postProgressionEntry))
         {
         ...
         if(Boolean(this._postProgressionEntry) && Boolean(this._postProgressionData))
         {
      ...
      private function updatePostProgressionPosition() : void
      {
         ...
         if(Boolean(this._postProgressionEntry) && Boolean(renderers))
         {
            ...
            _loc6_ = _loc4_ == MAX_ROWS ? POST_PROGRESSION_OFFSET_MIN_Y : POST_PROGRESSION_OFFSET_MAX_Y;
      ...
      private function onRendererOnModuleHoverHandler(param1:TechTreeEvent) : void
      {
         ...
         if(this.view != null)
         {
            _loc2_ = param1.index != -1 ? int(this.getNodeDataByEvent(param1).id) : -1;
      ...
      {
         var _loc2_:int = int(dataProvider.getItemAt(param1.index).id);
