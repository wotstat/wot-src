package net.wg.gui.lobby.techtree.controls
{
   ...
   public class NationButton extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this.borderStates != null && Boolean(StringUtils.isNotEmpty(_newFrame)) && Boolean(isInvalid(InvalidationType.STATE)))
         {
         ...
         super.draw();
         if(_label != null && this.borderStates != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(Boolean(this.borderStates) && Boolean(isInvalid(InvalidationType.LAYOUT)))
         {
      ...
      {
         if(!_selected && Boolean(StringUtils.isNotEmpty(_tooltip)))
         {
