package net.wg.gui.lobby.techtree.controls
{
   ...
   public class LevelDelimiter extends UIComponentEx
   {
      ...
      private var _delimetersContainer:Sprite = new Sprite();
      ...
      {
         super.draw();
         if(this.level != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      {
         if(Boolean(this._hideHighlightTween) && !this._hideHighlightTween.paused)
         {
            return;
         }
      ...
      {
         if(Boolean(this._showHighlightTween) && !this._showHighlightTween.paused)
         {
            return;
         }
      ...
      private function updateDelimeters() : void
      {
         ...
         var _loc2_:int = this._showDelimeters ? int(_width / DELIMETER_W) : 0;
         while(_loc2_ < _loc1_)
         {
            _loc1_--;
