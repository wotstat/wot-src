package net.wg.gui.lobby.techtree.math
{
   public class ADG_ItemLevelsBuilder
   {
      ...
      private function hasFakeNode(param1:Number) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(_loc2_[_loc4_] != null && Boolean(_loc2_[_loc4_].fake))
            {
               return true;
            }
            _loc4_++;
      ...
      private function distributionOfVerticesOnLevels() : void
      {
         ...
         while(_loc1_ < _loc4_)
         {
            _loc3_ = Number(this.maxPaths[_loc1_]);
            _loc2_ = Number(this.fixedPaths[_loc1_]);
      ...
      private function getLines(param1:Number, param2:Boolean) : Array
      {
         ...
         var _loc13_:int = param2 ? 1 : -1;
         var _loc14_:int = param2 ? 2 : -2;
         var _loc15_:int = 0;
      ...
      private function breedNodesByNextRelations(param1:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               _loc6_++;
               if(Boolean(_loc2_[_loc4_ - 1] != null) && Boolean(_loc2_[_loc4_ - 1].fake) && _loc2_[_loc4_ + 1] != null)
               {
                  if(_loc4_ == 1)
                  {
                     _loc6_ = 0;
      ...
      private function makeMinCrossing(param1:Number, param2:Boolean) : Number
      {
         ...
         result = algo.compute(algo.makeCostMatrix(matrix,function(param1:Number):Number
         {
            return param1;
         }));
      ...
      private function findNodePositionInLevel(param1:Number, param2:Boolean) : Array
      {
         ...
         while(_loc3_ != 0 && _loc6_ != 3 && _loc4_ != _loc3_ && _loc8_ < _loc7_)
         {
            ...
            if(_loc3_ <= _loc5_)
            {
               _loc6_ = _loc3_ == _loc5_ ? int(_loc6_ + 1) : 0;
               _loc5_ = _loc3_;
            }
            _loc8_++;
         }
...
class LevelItem
{
   ...
   public function LevelItem(param1:uint, param2:uint, param3:Boolean)
   {
      super();
      this.index = param1;
      this.dx = param2;
...
class LevelLine
{
   ...
   public function LevelLine(param1:uint, param2:uint, param3:uint, param4:uint)
   {
      super();
      this.start = param1;
      this.end = param2;
