package net.wg.gui.lobby.techtree.controls
{
   ...
   public class ActionButton extends SoundButton
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this.disableIndicator != null && Boolean(isInvalid(InvalidationType.STATE)))
         {
      ...
      public function endAnimation(param1:Boolean) : void
      {
         ...
         if(this._animProps != null)
         {
            ...
            {
               _loc3_ = _loc2_ == owner || Boolean(owner.contains(_loc2_));
            }
            if(!param1 && _loc3_ && Boolean(owner.hitTestPoint(stage.mouseX,stage.mouseY,true)))
            {
               return;
            }
      ...
      {
         if(!param1 || Boolean(this._imgSubstitution && param1.subString == this._imgSubstitution.subString) && Boolean(param1.source == this._imgSubstitution.source))
         {
            return;
         }
         if(Boolean(this._imgSubstitution))
         {
