package net.wg.gui.lobby.techtree.nodes
{
   ...
   public class Renderer extends SoundListItemRenderer implements IRenderer
   {
      ...
      {
         return this.hit != null ? this.hit.width : Number(width);
      }
      
      public function getColorIndex(param1:IRenderer = null) : uint
      {
         var _loc2_:uint = ColorIndex.LOCKED;
         if(Boolean(param1) && Boolean(param1.isPremium()) || this.isPremium())
         {
            _loc2_ = ColorIndex.PREMIUM;
         }
         else if(this.isUnlocked() && (param1 == null || param1.isUnlocked()) || Boolean(this.isNext2Unlock() && param1) && Boolean(param1.isUnlocked()))
         {
      ...
      {
         return this._dataInited ? this._valueObject.state : 0;
      }
      ...
      {
         if(Boolean(this._tooltipID) && Boolean(this._valueObject) && this._valueObject.dataIsReady)
         {
      ...
      {
         this._stateProps = NodeStateCollection.instance.getStateProps(this._entityType,this._dataInited ? this._valueObject.state : 0,this._dataInited ? this._valueObject.extendedState : 0,this.getExtraState());
      ...
      final public function get nodeState() : String
      {
      ...
      {
         return this._dataInited ? this._valueObject.isAnnouncement : false;
      }
      
      protected function get isEarlyAccess() : Boolean
      {
         return this._dataInited ? this._valueObject.isEarlyAccess : false;
      }
      
      protected function get isEarlyAccessLocked() : Boolean
      {
         return this._dataInited ? this._valueObject.isEarlyAccessLocked : false;
      }
      
      protected function get isFirstTimeEarlyAccessShow() : Boolean
      {
         return this._dataInited ? this._valueObject.isFirstTimeEarlyAccessShow : false;
      }
      
      public function isResetParagons() : Boolean
      {
         return this._dataInited ? this._valueObject.isResetParagons : false;
      }
      
      public function isLockedByParagons() : Boolean
      {
         return this._dataInited ? this._valueObject.isLockedByParagons : false;
      }
