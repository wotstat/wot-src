package net.wg.gui.lobby.techtree.data.vo
{
   ...
   public class NodeData implements IValueObject
   {
      ...
      public function fromObject(param1:Object, param2:ILocale) : void
      {
         ...
         if(Boolean(param1[BUY_PRICE_FIELD]))
         {
            this.clearBuyPrice();
      ...
      public function get costLabel() : String
      {
         ...
         {
            _loc1_ = int(this._buyPrice.price.getPriceVO().value);
         }
      ...
      {
         return Boolean(this._vehCompareTreeNodeVO) && this._vehCompareTreeNodeVO.modeAvailable;
      }
      
      public function get isCompareBasketFull() : Boolean
      {
         return Boolean(this._vehCompareTreeNodeVO) && this._vehCompareTreeNodeVO.cmpBasketFull;
      }
