package net.wg.gui.lobby.techtree.postProgression
{
   ...
   public class EntryPoint extends UIComponentEx implements IStageSizeDependComponent
   {
      ...
      private var _labelCont:Sprite = new Sprite();
      
      private var _lines:Sprite = new Sprite();
      
      private var _hitMc:Sprite = new Sprite();
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            {
               this.content.height = this._isSmall ? CONTENT_HEIGHT_SMALL : CONTENT_HEIGHT_BIG;
               ...
               this.label.width = this._isSmall ? LABEL_MAX_WIDTH : LABEL_MIN_WIDTH;
               App.utils.commons.updateTextFieldSize(this.label);
               this.label.x = _width - this.label.width >> 1;
               _loc2_ = this._isSmall && y > MAX_Y ? LABEL_OFFSET_Y_SMALL : LABEL_OFFSET_Y_BIG;
      ...
      private function showCounter(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _loc2_ = this._isSmall ? COUNTER_OFFSET_Y_SMALL : COUNTER_OFFSET_Y_BIG;
      ...
      private function onMouseEventRollOverHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._data) && Boolean(this._data.label))
         {
