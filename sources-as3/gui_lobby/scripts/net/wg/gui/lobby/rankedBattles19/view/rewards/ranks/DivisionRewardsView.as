package net.wg.gui.lobby.rankedBattles19.view.rewards.ranks
{
   ...
   public class DivisionRewardsView extends UIComponentEx implements IDraggable, IStageSizeDependComponent
   {
      ...
      private var _viewPadding:Padding = new Padding();
      ...
      override protected function draw() : void
      {
         ...
         {
            this._containerGlobalLeftShift = Boolean(this._viewPadding) ? this._viewPadding.left >> 1 : Number(Values.ZERO);
            invalidateSize();
         }
      ...
      {
         var _loc2_:Number = Number(param1.target.position);
         if(isNaN(_loc2_))
         {
            return;
         }
