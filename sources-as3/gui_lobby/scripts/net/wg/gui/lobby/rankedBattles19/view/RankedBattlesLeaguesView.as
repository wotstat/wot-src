   ...
   public class RankedBattlesLeaguesView extends RankedBattlesLeaguesViewMeta implements IRankedBattlesLeaguesViewMeta, IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null)
         {
            ...
            if(Boolean(isInvalid(InvalidationType.LAYOUT)) || Boolean(isInvalid(INV_VIEW_PADDING)))
            {
      ...
      private function updateLayoutVertical() : void
      {
         ...
         if(this._isSmall)
         {
            ...
            this.statsDelta.y = this.leagueIcon.y + STATS_V_OFFSET_SMALL;
         ...
         else
         {
            ...
            this.statsDelta.y = this.leagueIcon.y + STATS_V_OFFSET_BIG;
