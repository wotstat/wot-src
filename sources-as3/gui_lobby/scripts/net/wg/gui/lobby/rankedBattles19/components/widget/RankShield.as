package net.wg.gui.lobby.rankedBattles19.components.widget
{
   ...
   public class RankShield extends UIComponentEx
   {
      ...
      override protected function onDispose() : void
      {
         ...
         this._labelTF = null;
         if(Boolean(this._shieldImg))
         {
            this._shieldImg.dispose();
            this._shieldImg = null;
         }
         this.shield = null;
         if(Boolean(this._shieldImg2))
         {
            this._shieldImg2.dispose();
            this._shieldImg2 = null;
         }
         this.shield2 = null;
         if(Boolean(this._plateImg))
         {
            this._plateImg.dispose();
            this._plateImg = null;
         }
         this.plate = null;
         if(Boolean(this._leftImg))
         {
            this._leftImg.dispose();
            this._leftImg = null;
         }
         this.left = null;
         if(Boolean(this._topImg))
         {
            this._topImg.dispose();
            this._topImg = null;
         }
         this.top = null;
         if(Boolean(this._rightImg))
         {
            this._rightImg.dispose();
            this._rightImg = null;
         }
         this.right = null;
         if(Boolean(this._bottomImg))
         {
      ...
      {
         super.draw();
         if(Boolean(this._shieldData) && Boolean(isInvalid(INVALID_ANIMATION)))
         {
            this.updateElements();
            this.animate();
         }
      ...
      public function getShieldOffset(param1:String) : Number
      {
         ...
         if(Boolean(this._shieldData))
         {
            ...
            return _loc2_ ? Number(SHIELD_OFFSETS[param1]) : 0;
         }
         return NaN;
      }
