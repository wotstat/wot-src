package net.wg.gui.lobby.rankedBattles19.components.widget
{
   ...
   import net.wg.gui.lobby.rankedBattles19.components.*;
   ...
   public class RankWidgetAnimator implements IDisposable
   {
      ...
      private var _frameScriptPool:Vector.<FrameScriptData> = new Vector.<FrameScriptData>(0);
      ...
      final public function dispose() : void
      {
         ...
         if(Boolean(this._rankFrameHelper))
         {
...
final class FrameScriptData implements IDisposable
{
   ...
   public function FrameScriptData(param1:MovieClip, param2:int)
   {
      super();
      this.target = param1;
      this.frame = param2;
