package net.wg.gui.lobby.rankedBattles19.components.divisionProgress
{
   ...
   public class DivisionProgressBlock extends UIComponentEx implements IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(isInvalid(BOUNDARIES_INVALID));
            _loc2_ = Boolean(isInvalid(InvalidationType.SIZE));
      ...
      {
         if(Boolean(this._data) && !this._data.isLocked)
         {
      ...
      private function updateData() : void
      {
         ...
         var _loc3_:int = int(this._data.blocks.length);
      ...
      {
         return Boolean(this._blockParams) ? this._blockParams.bigRank.height : super.height;
      }
