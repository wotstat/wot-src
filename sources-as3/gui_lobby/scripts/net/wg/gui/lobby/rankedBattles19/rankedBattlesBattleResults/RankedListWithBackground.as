   ...
   public class RankedListWithBackground extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._topData))
         {
            ...
            if(_loc8_ || Boolean(isInvalid(InvalidationType.SIZE)))
            {
               this.list.tileHeight = this._rendererHeight;
      ...
      {
         if(Boolean(this._topData) && this._topData.backgroundBlink)
         {
      ...
      public function blinkStandOffItem() : void
      {
         ...
         var _loc3_:int = 0;
         if(!this._standOffItemFindComplete && !this._standOffActiveItem && Boolean(this.list.dataProvider))
         {
            _loc1_ = int(this.list.dataProvider.length);
            _loc3_ = 0;
            while(_loc3_ < _loc1_)
            {
         ...
         if(Boolean(this._standOffActiveItem))
         {
