package net.wg.gui.lobby.rankedBattles19.view.rewards
{
   ...
   public class RankedBattlesRewardsRanksView extends RankedBattlesRewardsRanksMeta implements IRankedBattlesRewardsRanksMeta, IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._rewards) && Boolean(isInvalid(INV_REWARDS)))
         {
      ...
      private function updateDivisionData() : void
      {
         ...
         var _loc1_:int = int(this._divisions.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      {
         var _loc1_:String = this.divisionRewards.rewardsIconSize;
         var _loc2_:int = this.divisionRewards.rewardsCount;
         if(Boolean(StringUtils.isNotEmpty(_loc1_)) && _loc2_ >= 0)
         {
