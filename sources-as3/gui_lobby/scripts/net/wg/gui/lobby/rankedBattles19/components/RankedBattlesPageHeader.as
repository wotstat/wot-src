package net.wg.gui.lobby.rankedBattles19.components
{
   ...
   public class RankedBattlesPageHeader extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null)
         {
            if(isInvalid(InvalidationType.DATA))
            {
               ...
               this._hasCalendarTooltip = Boolean(StringUtils.isNotEmpty(this._data.tooltip)) && this._data.tooltip == TOOLTIPS_CONSTANTS.RANKED_CALENDAR_DAY_INFO;
      ...
      private function getMainDescrX() : int
      {
         ...
         if(this._hasCalendarTooltip)
         {
            _loc2_ = int(CALENDAR_WIDTHS[this._size]);
            _loc1_ += _loc2_;
         }
      ...
      {
         if(Boolean(this._data) && Boolean(StringUtils.isNotEmpty(this._data.tooltip)))
         {
