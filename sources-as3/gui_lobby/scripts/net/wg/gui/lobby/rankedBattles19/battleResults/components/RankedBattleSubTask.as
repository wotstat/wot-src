package net.wg.gui.lobby.rankedBattles19.battleResults.components
{
   ...
   public class RankedBattleSubTask extends UIComponentEx implements ISubtaskComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(StringUtils.isNotEmpty(this._data.descriptionIcon));
            _loc2_ = Boolean(StringUtils.isNotEmpty(this._data.shieldIcon));
            _loc3_ = Boolean(StringUtils.isNotEmpty(this._data.shieldCount));
