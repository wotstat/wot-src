package net.wg.gui.lobby.rankedBattles19.view.seasonComplete
{
   ...
   public class RankedBattlesSeasonContainer extends UIComponentEx
   {
      ...
      {
         super.draw();
         if(Boolean(this._seasonData) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            this.doData();
            invalidate(INV_AWARDS_DATA);
         }
         if(Boolean(this._awardsData) && Boolean(this._resultBlock) && Boolean(isInvalid(INV_AWARDS_DATA)))
         {
      ...
      {
         if(Boolean(param1) && this._awardsData != param1)
         {
      ...
      {
         if(Boolean(param1) && this._seasonData != param1)
         {
      ...
      final private function onSoundTrigger(param1:String) : void
      {
      ...
      {
         var _loc1_:uint = uint(this._screenW >> 1);
         var _loc2_:uint = uint(this._screenH >> 1);
