package net.wg.gui.lobby.rankedBattles19.view.rewards.ranks
{
   ...
   public class RewardsRankRenderer extends UIComponentEx
   {
      ...
      private function updateData() : void
      {
         ...
         if(Boolean(this._data.bonuses))
         {
            _loc3_ = int(this._data.bonuses.length);
            this.clearBonuses();
      ...
      private function updateBonusesPosition(param1:int) : void
      {
         ...
         var _loc3_:int = int(this._bonuses.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      {
         if(Boolean(this._data) && this._data.rankID != Values.DEFAULT_INT)
         {
      ...
      {
         if(Boolean(this._screen) && Boolean(App.utils.commons.isLeftButton(param1)))
         {
