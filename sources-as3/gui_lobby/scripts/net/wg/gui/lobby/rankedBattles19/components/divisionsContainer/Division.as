package net.wg.gui.lobby.rankedBattles19.components.divisionsContainer
{
   ...
   public class Division extends UIComponentEx implements IUpdatableComponent
   {
      ...
      private var _iconTweenParamsStateNormal:Object = TWEEN_ICON_NORMAL_PARAMS_BIG;
      
      private var _iconTweenParamsStateHover:Object = TWEEN_ICON_HOVER_PARAMS_BIG;
      
      private var _iconTweenParamsStateSelected:Object = TWEEN_ICON_SELECTED_PARAMS_BIG;
      
      private var _statusPositionNormal:Object = STATUS_NORMAL_POSITION_BIG;
      
      private var _statusPositionSelected:Object = STATUS_SELECTED_POSITION_BIG;
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(StringUtils.isNotEmpty(this._currentState)) && Boolean(isInvalid(InvalidationType.STATE)))
         {
