package net.wg.gui.lobby.rankedBattles19.view.intro
{
   ...
   public class RankedIntroBlocks extends UIComponentEx implements IDisposable
   {
      ...
      public function setData(param1:Vector.<RankedBattlesIntroBlockVO>, param2:int) : void
      {
      ...
      private function updateSettings() : void
      {
         ...
         var _loc1_:int = int(this._blocks.length);
         var _loc2_:RankedIntroBlock = null;
         var _loc3_:int = int(Values.ZERO);
         while(_loc3_ < _loc1_)
         {
