package net.wg.gui.lobby.fortifications.battleRoom
{
   ...
   public class LegionariesCandidateItemRenderer extends SoundListItemRenderer implements IDropItem, IUpdatable
   {
      ...
      {
         return Boolean(this.candidateItemRender) && Boolean(this.candidateItemRender.visible) ? Cursors.DRAG_OPEN : Cursors.ARROW;
      }
      
      override protected function configUI() : void
      {
         super.configUI();
         if(Boolean(this.headerRender))
         {
      ...
      override protected function setState(param1:String) : void
      {
         ...
         if(Boolean(this.candidateItemRender) && Boolean(this.candidateItemRender.visible))
         {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this.headerRender) && Boolean(this.headerRender.visible))
            {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.candidateItemRender))
         {
