package net.wg.gui.lobby.fortifications.cmp.battleRoom
{
   ...
   public class SortieSlot extends RallyLockableSlotRenderer implements IPopOverCaller
   {
      ...
      override public function setStatus(param1:int) : String
      {
         ...
         if(param1 < STATUSES.length && Boolean(param1))
         {
      ...
      override public function updateComponents() : void
      {
         ...
         if(_loc3_ || _loc1_)
         {
            removeBtn.visible = !_loc3_ && _loc1_ && this._sortieData.isRemoveAvailable && Boolean(slotData.player);
            this.typeFilters.visible = this.btnConfigure.visible = false;
            return;
         }
         var _loc4_:int = Boolean(this._sortieData.vehicles) ? int(this._sortieData.vehicles.length) : 0;
         if(_loc4_ > 0)
         {
         ...
         removeBtn.visible = this.hasFilters || Boolean(slotData.player);
      }
      ...
      private function updateFiltersAlpha() : void
      {
         ...
         var _loc2_:int = int(this.typeFilters.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc1_ = this.typeFilters.getButtonAt(_loc3_);
            if(this._isMouseOver || Boolean(_loc1_.selected))
            {
      ...
      override protected function onContextMenuAreaClick(param1:MouseEvent) : void
      {
         ...
         if(Boolean(_loc2_) && !UserTags.isCurrentPlayer(_loc2_.tags))
         {
      ...
      private function onSortieRollOutHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._sortieData && this._sortieData.isCommanderState) && Boolean(!this._sortieData.player) && !this._sortieData.isLocked)
         {
...
class PopoverCallerWrapper implements IPopOverCaller, IDisposable
{
   ...
   public function PopoverCallerWrapper(param1:DisplayObject)
   {
      super();
      this._target = param1;
   }
