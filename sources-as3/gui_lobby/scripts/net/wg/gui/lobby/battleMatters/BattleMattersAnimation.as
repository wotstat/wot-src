package net.wg.gui.lobby.battleMatters
{
   ...
   public class BattleMattersAnimation extends UIComponentEx
   {
      ...
      override protected function configUI() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = int(ADDITIONAL_ELEMENTS_POSTFIX.length);
         for(_loc2_ in ITEMS)
         {
         ...
         if(Boolean(this.textTopographyBattle) && Boolean(this.textTopographyBattle.textField) && Boolean(this.textTopographyBattle.arrow))
         {
         ...
         if(Boolean(this.textRandomBattle) && Boolean(this.textRandomBattle.textField) && Boolean(this.textRandomBattle.arrow))
         {
      ...
      {
         if(Boolean(this.textNickname) && Boolean(this.textNickname.textField))
         {
      ...
      private function fillElement(param1:MovieClip, param2:String) : void
      {
         ...
         if(Boolean(param1) && Boolean(param1.textField))
         {
      ...
      private function updateHeaderBtnsPosition() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = int(this._headerBtns.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            ...
            {
               _loc1_ += _loc5_.width;
               if(_loc3_ != _loc2_ - 1 && Boolean(_loc5_))
               {
