package net.wg.gui.lobby.battleMatters.components
{
   ...
   public class MissionsGoldHeader extends MissionPackHeaderBase
   {
      ...
      public function MissionsGoldHeader()
      {
         super();
      }
      ...
      {
         var _loc1_:MissionGoldHeaderVO = null;
         super.draw();
         if(Boolean(data) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            _loc1_ = MissionGoldHeaderVO(data);
