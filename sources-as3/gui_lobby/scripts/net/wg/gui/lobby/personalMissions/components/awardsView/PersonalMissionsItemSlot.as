package net.wg.gui.lobby.personalMissions.components.awardsView
{
   ...
   public class PersonalMissionsItemSlot extends UIComponentEx implements ISoundable
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            if(Boolean(this._slotData))
            {
               ...
               this.tankTypes.visible = !this.allianceIcon.visible && Boolean(StringUtils.isNotEmpty(this._slotData.tokenType));
      ...
      private function onMouseOutHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._slotData) && param1.target != this.unlockBtn)
         {
      ...
      private function onUnlockBtnClickHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._slotData) && Boolean(App.utils.commons.isLeftButton(param1)))
         {
