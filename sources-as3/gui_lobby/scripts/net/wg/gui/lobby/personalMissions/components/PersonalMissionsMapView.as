package net.wg.gui.lobby.personalMissions.components
{
   ...
   public class PersonalMissionsMapView extends PersonalMissionsMapViewMeta implements IViewStackContent, IPersonalMissionsMapViewMeta
   {
      ...
      {
         super.draw();
         if(this._planModel != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(this._plan != null && Boolean(isInvalid(INVALID_PLAN_VISIBILITY)))
         {
            if(this._mapMoveTween == null || this._mapMoveTween != null && Boolean(this._mapMoveTween.paused))
            {
               this.showPlan();
            }
         }
      ...
      public function showHideContent(param1:Boolean) : void
      {
         ...
         if(Boolean(this._nextMap) && Boolean(this._plan))
         {
            if(param1)
            {
      ...
      private function moveMap() : void
      {
         ...
         this.positionPlan();
         var _loc2_:Number = Number(this._plan.scaleX);
         ...
         else
         {
            if(this._needMapChange)
            {
               ...
               this._nextMap.x = this._direction == LEFT_DIRECTION ? Number(width) : -this._nextMap.width;
               this._nextMap.y = this._nextMapY;
      ...
      {
         var _loc2_:int = 0;
         if((this._mapMoveTween == null || this._mapMoveTween != null && Boolean(this._mapMoveTween.paused)) && (this._hidePlanTween == null || this._hidePlanTween != null && Boolean(this._hidePlanTween.paused)) && (this._showPlanTween == null || this._showPlanTween != null && Boolean(this._showPlanTween.paused)))
         {
