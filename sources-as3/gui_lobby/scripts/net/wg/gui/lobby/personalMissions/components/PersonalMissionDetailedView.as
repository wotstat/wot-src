   ...
   public class PersonalMissionDetailedView extends BaseMissionDetailedView
   {
      ...
      override public function getFocusItem() : InteractiveObject
      {
         if(Boolean(this._vo))
         {
            ...
            if(this._vo.holdAwardSheetBtnVisible && this._vo.holdAwardSheetBtnEnabled && Boolean(this._holdAwardSheetBtn))
            {
      ...
      {
         if(Boolean(this._vo) && Boolean(this._vo.eventID == param1.eventID) && this._vo.blockID == param1.blockID)
         {
         ...
         this._contentAdditionalHeight = this._vo.isHeaderHasProgress ? int(Values.ZERO) : CONTENT_ADDITIONAL_HEIGHT;
      }
      ...
      override protected function draw() : void
      {
         ...
         if(this._vo != null)
         {
            if(isInvalid(InvalidationType.DATA))
            {
               ...
               if(Boolean(this._vo.statusLabel))
               {
            ...
            if(this._conditionsReady && Boolean(isInvalid(INVALIDATE_CONDITIONS_LAYOUT)))
            {
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._vo.titleTooltip));
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._vo.bottomStatusText));
         var _loc2_:Boolean = Boolean(StringUtils.isNotEmpty(this._vo.addBottomStatusText));
      ...
      private function removeDynamicBtns() : void
      {
         ...
         if(Boolean(this._holdAwardSheetBtn))
         {
      ...
      private function createConditions(param1:Vector.<IQPItemRenderer>, param2:Vector.<IQuestProgressItemData>, param3:Vector.<IQPItemOrConditionIcon>) : void
      {
         ...
         {
            if(Boolean(_loc6_ && _loc6_.initData) && Boolean(_loc6_.progressData) && Boolean(_loc6_.progressData.metricsValue))
            {
               ...
               if(!this._hasLockedItem && Boolean(_loc6_.progressData.isLocked))
               {
                  this._hasLockedItem = true;
               }
               param1.push(_loc7_);
               this.conditionsContainer.addChild(DisplayObject(_loc7_));
               if(Boolean(_loc4_ && _loc4_.isInOrGroup) && Boolean(_loc7_.isInOrGroup) && _loc4_.orderType == _loc7_.orderType)
               {
