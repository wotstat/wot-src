package net.wg.gui.lobby.personalMissions.components
{
   ...
   public class OperationButton extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._dataVo) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(this._dataVo.state == PERSONAL_MISSIONS_ALIASES.OPERATION_POSTPONED_STATE && Boolean(StringUtils.isNotEmpty(this._dataVo.postponedTime)))
            {
