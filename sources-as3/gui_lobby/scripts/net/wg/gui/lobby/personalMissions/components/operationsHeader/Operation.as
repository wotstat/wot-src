package net.wg.gui.lobby.personalMissions.components.operationsHeader
{
   ...
   public class Operation extends UIComponentEx implements IUpdatableComponent
   {
      ...
      private static const TEXT_ALPHA_DEF:int = 0;
      
      private static const TEXT_ALPHA_SELECTED:int = 1;
      
      private static const ICON_ALPHA_DEF:Number = 0.6;
      
      private static const ICON_ALPHA_SELECTED:int = 1;
      
      private static const ICON_SCALE_DEF:Number = 0.75;
      
      private static const ICON_SCALE_SELECTED:int = 1;
      
      private static const FREE_SHEET_ICON_OFFSET_SELECTED:int = -10;
      ...
      private static const TWEEN_FADE_TIME:int = 250;
      ...
      private var _tweensDict:Dictionary = new Dictionary(true);
      ...
      override protected function onDispose() : void
      {
         ...
         stop();
         TWEEN_QUICKSET_DESC_DEF.onComplete = null;
      ...
      private function playTween(param1:Number, param2:Object, param3:Object, param4:Object = null) : void
      {
         ...
         var _loc6_:Tween = this._tweensDict[_loc5_];
         if(Boolean(_loc6_))
         {
            _loc6_.dispose();
         }
         this._tweensDict[_loc5_] = new Tween(param1,param2,param3,param4);
      }
      ...
      {
         if(this._isStateEnabled && !this._selected && Boolean(App.utils.commons.isLeftButton(param1)))
         {
            this._playAnim = true;
