package net.wg.gui.lobby.personalMissions.components.statusFooter
{
   ...
   public class StatusFooter extends UIComponentEx implements IUpdatableComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            ...
            {
               _loc2_ = this.descrText.visible ? int(DESCR_X_SHIFT + this.descrText.textWidth) : 0;
               _loc3_ = this.skipTaskBtn.visible ? int(FREE_SHEET_BTN_X_SHIFT + this.skipTaskBtn.width) : 0;
      ...
      {
         if(Boolean(this._data) && (Boolean(!this._data.btnVisible || this._data.tooltipOnStatus)) && Boolean(StringUtils.isNotEmpty(this._data.tooltip)))
         {
