package net.wg.gui.lobby.personalMissions.components.firstEntry
{
   ...
   public class InfoItemRenderer extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._settings) && Boolean(isInvalid(INVALID_SETTINGS)))
         {
      ...
      {
         return Boolean(this._rendererData) ? this._rendererData.index : int(Values.DEFAULT_INT);
      }
