package net.wg.gui.lobby.invites
{
   ...
   public class SendInvitesWindow extends SendInvitesWindowMeta implements ISendInvitesWindowMeta
   {
      ...
      private var _receiverData:DataProvider = new DataProvider();
      ...
      override protected function draw() : void
      {
         ...
         var _loc1_:Boolean = Boolean(isInvalid(ADD_ALL_BTN_ENABLING_INV));
         if(_loc1_)
         {
         ...
         var _loc2_:Boolean = Boolean(isInvalid(REMOVE_BTN_ENABLING_INV));
         if(_loc2_)
         {
         ...
         if(isInvalid(CHECK_CANDIDATES_LIST_INV))
         {
            ...
            {
               _loc5_ = false;
               _loc6_ = uint(this._receiverData.length);
               _loc7_ = _loc6_ - 1;
               while(_loc7_ >= 0)
               {
                  _loc8_ = ContactItemVO(this._receiverData.requestItemAt(_loc7_));
                  _loc9_ = this._pendingUpdatingContacts[_loc4_];
                  if(Boolean(_loc8_) && _loc8_.dbID == _loc9_.dbID)
                  {
                     _loc10_ = new ContactItemVO(_loc9_);
                     if(Boolean(UserTags.isIgnored(_loc10_.userPropsVO.tags)) || Boolean(UserTags.isCurrentPlayer(_loc10_.userPropsVO.tags)))
                     {
         ...
         if(Boolean(isInvalid(FOCUS_CHAIN_INVALID)) || _loc2_ || _loc1_)
         {
      ...
      override protected function configUI() : void
      {
         ...
         var _loc2_:uint = uint(this.addUserButton.height);
         var _loc3_:uint = 10;
         var _loc4_:uint = 32;
      ...
      {
         var _loc2_:Number = Number(param1.dbID);
      ...
      {
         var _loc2_:uint = uint(this._receiverData.length);
         var _loc3_:Number = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function cleanupFocusChain() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(this._focusChain))
         {
            _loc1_ = int(this._focusChain.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      {
         var _loc2_:uint = uint(this.messageTextInput.textField.getTextFormat()[COLOR]);
      ...
      private function onAddAllUsersButtonClickHandler(param1:ButtonEvent) : void
      {
         ...
         var _loc3_:uint = Boolean(_loc2_) ? _loc2_.length : 0;
         if(_loc3_ > 0)
         {
            _loc5_ = 0;
            while(_loc5_ < _loc3_)
      ...
      private function onSendButtonClickHandler(param1:ButtonEvent = null) : void
      {
         ...
         var _loc4_:uint = uint(this._receiverData.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
