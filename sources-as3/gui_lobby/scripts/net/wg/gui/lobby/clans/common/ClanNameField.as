package net.wg.gui.lobby.clans.common
{
   ...
   public class ClanNameField extends UIComponentEx implements IClanNameField
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            this.bg.visible = this._canShowBg && Boolean(this._clanVO) && this._clanVO.isActive;
         }
      ...
      {
         if(Boolean(this._clanVO) && this._clanVO.showIcon)
         {
            if(this._icon == null)
            {
               this.createIcon();
