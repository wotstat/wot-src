package net.wg.gui.lobby.clans.invites
{
   ...
   public class ClanInvitesWindow extends ClanInvitesWindowMeta implements IClanInvitesWindowMeta
   {
      ...
      {
         super.draw();
         if(this._clanInvitesWindowHeaderStateVO != null && Boolean(isInvalid(HEADER_INV)))
         {
         ...
         if(this._clanBaseInfoVO != null && Boolean(isInvalid(CLAN_INV)))
         {
      ...
      private function onViewStackViewChangedHandler(param1:ViewStackEvent) : void
      {
         ...
         if(Boolean(this._currentViewAlias) && !isFlashComponentRegisteredS(this._currentViewAlias))
         {
