package net.wg.gui.lobby.moduleInfo
{
   ...
   public class ModuleParameters extends UIComponentEx
   {
      ...
      private var _parametersHighlightTargets:Vector.<DisplayObject> = new Vector.<DisplayObject>(0);
      ...
      {
         super.draw();
         if(!StringUtils.isEmpty(this._headerText) && Boolean(isInvalid(HEADER_TEXT_INV)))
         {
      ...
      [Inspectable(name="bottomMargin",type="Number",defaultValue="0")]
