package net.wg.gui.lobby.moduleInfo
{
   ...
   public class ModuleEffects extends UIComponentEx
   {
      ...
      [Inspectable(name="bottomMargin",type="Number",defaultValue="20")]
      ...
      private function getEffectParams(param1:Object) : String
      {
         ...
         if(Boolean(param1.effectOnUse) && Boolean(param1.effectOnUse != Values.EMPTY_STR) && param1.effectOnUse != undefined)
         {
