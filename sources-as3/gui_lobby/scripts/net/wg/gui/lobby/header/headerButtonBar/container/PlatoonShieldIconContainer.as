package net.wg.gui.lobby.header.headerButtonBar.container
{
   ...
   public class PlatoonShieldIconContainer extends UIComponentEx
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._squadManArray))
         {
      ...
      public function getIconSize(param1:String) : int
      {
         ...
         switch(param1)
         {
            ...
            case STATES.squadEvent:
               _loc2_ = int(this.createStateShieldIcon.width);
               break;
      ...
      {
         this._isCommanderHatVisibleForThisContainer = param1 && this._commanderIndex == this._iconContainerIndex && Boolean(this._platoonState);
      }
      ...
      public function updateIconContainer(param1:ExtendedSquadInfoVo, param2:int) : void
      {
         ...
         this._isNormalSizePlatoon = Boolean(param1.squadManStates.length) && param1.squadManStates.length <= HBC_Squad.NORMAL_SIZE_PLATOON;
