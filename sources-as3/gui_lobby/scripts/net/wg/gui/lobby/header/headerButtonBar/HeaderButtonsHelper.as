package net.wg.gui.lobby.header.headerButtonBar
{
   ...
   public class HeaderButtonsHelper implements IDisposable
   {
      ...
      private var _settingsData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_SETTINGS,
      ...
      private var _accountData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_ACCOUNT,
      ...
      private var _wotPlusData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_WOT_PLUS,
      ...
      private var _premData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_PREM,
      ...
      private var _premShopData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_PREMSHOP,
      ...
      private var _squadData:HeaderButtonVo = new HeaderButtonVo({
         "id":ITEM_ID_SQUAD,
      ...
      private var _battleSelectorData:HeaderButtonVo = new HeaderButtonVo({
      ...
      private var _goldData:HeaderButtonVo = new HeaderButtonVo({
      ...
      private var _creditsData:HeaderButtonVo = new HeaderButtonVo({
      ...
      private var _crystalData:HeaderButtonVo = new HeaderButtonVo({
      ...
      private var _freeXPData:HeaderButtonVo = new HeaderButtonVo({
      ...
      private var _personalReservesWidgetData:HeaderButtonVo = new HeaderButtonVo({
      ...
      public function setButtonEnabled(param1:String, param2:Boolean) : void
      {
         ...
         if(Boolean(_loc3_.headerButton))
         {
