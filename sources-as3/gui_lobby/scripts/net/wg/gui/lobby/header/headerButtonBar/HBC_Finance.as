package net.wg.gui.lobby.header.headerButtonBar
{
   ...
   public class HBC_Finance extends HBC_ActionItem implements ITweenAnimatorHandler
   {
      ...
      override protected function updateSize() : void
      {
         ...
         var _loc3_:Number = Number(_loc1_.actualWidth);
         ...
         this.moneyIconText.y = this._isTopLayout && isHovered ? MONEY_TOP_Y : MONEY_CENTER_Y;
         this.wallet.y = this._isTopLayout && isHovered ? WALLET_TOP_Y : WALLET_CENTER_Y;
         super.updateSize();
      }
      ...
      override protected function updateState() : void
      {
         ...
         if(this._isTopLayout)
         {
            ...
            _loc2_ = isHovered ? WALLET_TOP_Y : WALLET_CENTER_Y;
            if(_loc1_ == this.moneyIconText)
            {
               _loc2_ = isHovered ? MONEY_TOP_Y : MONEY_CENTER_Y;
            }
      ...
      override protected function onDispose() : void
      {
         ...
         if(this.discountAnimation != null && Boolean(contains(this.discountAnimation)))
         {
      ...
      {
         return Boolean(super.isNeedUpdateFont()) || useFontSize != doItTextField.getTextFormat().size;
      }
      ...
      {
         if(Boolean(this._moneyHoverTween))
         {
