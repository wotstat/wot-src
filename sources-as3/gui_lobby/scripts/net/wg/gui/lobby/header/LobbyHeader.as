package net.wg.gui.lobby.header
{
   ...
   public class LobbyHeader extends LobbyHeaderMeta implements ILobbyHeader, IStageSizeDependComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.sparks))
         {
            this.sparks.dispose();
            this.sparks = null;
         }
         this._scheduler.cancelTask(this.stopReadyCoolDown);
         var _loc1_:int = int(this.mainMenuButtonBar.dataProvider.length);
      ...
      override protected function setHangarMenuData(param1:DataProvider) : void
      {
         ...
         {
            if(Boolean(this.mainMenuButtonBar.getButtonByValue(_loc2_.value)))
            {
      ...
      {
         this.resizeBg.alpha = param1 ? RESIZE_BG_ALPHA : 1;
      }
      ...
      private function updateSize() : void
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         var _loc4_:Number = Number(App.appWidth);
      ...
      {
         if(Boolean(this._bubbleTooltip))
         {
