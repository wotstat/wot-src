package net.wg.gui.lobby.header.headerButtonBar
{
   ...
   public class HeaderButtonContentItem extends UIComponentEx implements IHeaderButtonContentItem
   {
      ...
      private var _minScreenPadding:Padding = new Padding(0,16,0,16);
      
      private var _additionalScreenPadding:Padding = new Padding(0,10,0,10);
      ...
      private var _screen:String = LobbyHeader.NARROW_SCREEN;
