   ...
   public class HBC_BattleSelector extends HeaderButtonContentItem implements IHeaderButtonResizableItem
   {
      ...
      override protected function updateData() : void
      {
         ...
         if(Boolean(data))
         {
            ...
            if(_loc2_)
            {
               this.textField.x = Boolean(this._battleTypeVo.battleTypeIcon) ? (Boolean(this._iconWidth) ? this.icon.x + this._iconWidth : this.icon.x + this.icon.width + ICON_MARGIN) : 0;
