package net.wg.gui.lobby.header.headerButtonBar
{
   ...
   public class HBC_Prem extends HBC_ActionItem implements IStageSizeDependComponent
   {
      ...
      private static const TEXT_FIELD_WIDTH:int = 104;
      ...
      override protected function updateData() : void
      {
         ...
         if(Boolean(data))
         {
            _loc1_ = Boolean(StringUtils.isEmpty(this._premVo.doLabel));
            ...
            this.textField.width = TEXT_FIELD_WIDTH;
      ...
      {
         return Boolean(super.isNeedUpdateFont()) || useFontSize != this.textField.getTextFormat().size || useFontSize != doItTextField.getTextFormat().size;
      }
