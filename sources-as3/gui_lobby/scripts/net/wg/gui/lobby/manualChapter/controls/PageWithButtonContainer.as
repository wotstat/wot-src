package net.wg.gui.lobby.manualChapter.controls
{
   ...
   public class PageWithButtonContainer extends PageContentTemplate
   {
      ...
      private var _hintStart:HighlightRendererBase = null;
      ...
      private function addHintStart() : void
      {
         ...
         {
            this._hintStart = App.utils.classFactory.getComponent(Linkages.TUTORIAL_SIMPLE_HINT_UI,HighlightRendererBase);
            ...
            dispatchEvent(new ManualViewEvent(ManualViewEvent.BUTTON_HIGHLIGHTED,true));
         }
      }
