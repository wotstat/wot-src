package net.wg.gui.lobby.manualChapter
{
   ...
   public class ManualChapterView extends ManualChapterViewMeta implements IManualChapterViewMeta
   {
      ...
      override protected function onDispose() : void
      {
         ...
         this.btnClose = null;
         this.clearTweens();
         App.utils.data.cleanupDynamicObject(this._tweenData);
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._pages != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            _loc1_ = this._pages;
         ...
         if(this._data != null && Boolean(isInvalid(INV_PAGE)))
         {
            this._pageController.setPageIndex(this._currentMissionIndex);
            _loc4_ = int(this._data.details.length);
         ...
         {
            if(Boolean(this._pageController))
            {
      ...
      {
         if(Boolean(this._swapTween1))
         {
            this._swapTween1.dispose();
            this._swapTween1 = null;
         }
         if(Boolean(this._swapTween2))
         {
      ...
      private function onCompleteForwardTween() : void
      {
         this.createBackwardTween();
         swapChildren(this.prevBackground,this.pageBackground);
      }
      
      private function createForwardTween() : void
      {
         this._swapTween1 = new Tween(TWEEN_DURATION,this._tweenData.target,{
            "x":this._tweenData.targetX,
            "y":this._tweenData.targetY,
            "rotation":this._tweenData.targetRotation
         },{
            "onComplete":this.onCompleteForwardTween,
            "paused":false,
            "ease":Regular.easeIn
         });
      ...
      private function createBackwardTween() : void
      {
         this._swapTween2 = new Tween(TWEEN_DURATION,this._tweenData.target,{
            "x":this._tweenData.startX,
            "y":this._tweenData.startY,
            "rotation":0
         },{
      ...
      private function tweenBackground() : void
      {
         ...
         this._tweenData.target = _loc2_;
         this._tweenData.startX = _loc3_;
         this._tweenData.targetX = _loc5_;
         this._tweenData.startY = _loc4_;
         this._tweenData.targetY = _loc6_;
         this._tweenData.targetRotation = _loc7_;
         this.createForwardTween();
      }
      ...
      private function addListeners() : void
      {
         ...
         this.view.addEventListener(ManualViewEvent.BUTTON_HIGHLIGHTED,this.onViewButtonHighlightedHandler);
      ...
      private function removeListeners() : void
      {
         ...
         this.view.removeEventListener(ManualViewEvent.BUTTON_HIGHLIGHTED,this.onViewButtonHighlightedHandler);
      ...
      private function onViewButtonHighlightedHandler(param1:ManualViewEvent) : void
      {
         buttonHighlightedS();
      }
      ...
      private function onPageControllerChangeHandler(param1:Event) : void
      {
         ...
         var _loc2_:int = int(PaginationDetailsNumButton(this._pageController.getSelectedButton()).pageIndex);
