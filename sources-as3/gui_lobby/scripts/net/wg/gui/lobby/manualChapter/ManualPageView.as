package net.wg.gui.lobby.manualChapter
{
   ...
   public class ManualPageView extends UIComponentEx
   {
      ...
      private var _tweens:Vector.<IDisposable> = new Vector.<IDisposable>(0);
      ...
      override protected function draw() : void
      {
         ...
         if(_loc5_)
         {
            if(Boolean(this._contentRenderer))
            {
         ...
         if(_loc5_)
         {
            ...
            if(Boolean(this._contentRenderer))
            {
               ...
               _loc7_ = int(this._contentRenderer.height);
               _loc8_ = Boolean(this.pageDescription.visible);
               ...
               {
                  _loc9_ = _loc8_ ? int(this.pageDescription.contentHeight + this.BOTTOM_PADDING * this._contentScale) : 0;
      ...
      private function playFadeAnimations(param1:String) : void
      {
         ...
         var _loc2_:Boolean = Boolean(this.pageDescription.visible);
         if(Boolean(this._contentRenderer))
         {
