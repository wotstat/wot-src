package net.wg.gui.lobby.vehicleCustomization.controls.propertiesSheet
{
   ...
   public class CustomizationSheetBaseBtnRenderer extends CustomizationSheetRendererBase
   {
      ...
      private var _targetPositions:Vector.<Point> = new Vector.<Point>(0);
      
      private var _tweens:Vector.<Tween> = new Vector.<Tween>(0);
      
      private var _shownElements:int = 0;
      
      private var _alreadyShow:Boolean = true;
      
      private var _rightPos:Vector.<Point> = new <Point>[new Point(37,-30),new Point(65,0),new Point(37,30)];
      
      private var _bottomPos:Vector.<Point> = new <Point>[new Point(-30,37),new Point(0,65),new Point(30,37)];
      
      private var _topPos:Vector.<Point> = new <Point>[new Point(-30,-37),new Point(0,-65),new Point(30,-37)];
      
      private var _leftPos:Vector.<Point> = new <Point>[new Point(-37,-30),new Point(-65,0),new Point(-37,30)];
      
      private var _layouts:Array = [this._rightPos,this._bottomPos,this._topPos,this._leftPos];
      ...
      {
         var _loc1_:int = int(this.btns.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override protected function draw() : void
      {
         var _loc1_:int = 0;
         super.draw();
         if(Boolean(enabled) && Boolean(this.model) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            this.setButtonsData();
         }
      ...
      private function setButtonsData() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(Boolean(this.model.btnsBlockVO))
         {
            _loc1_ = int(this.btns.length);
            _loc2_ = int(this.model.btnsBlockVO.length);
            _loc3_ = 0;
            while(_loc3_ < _loc1_)
            {
               if(_loc3_ < _loc2_)
