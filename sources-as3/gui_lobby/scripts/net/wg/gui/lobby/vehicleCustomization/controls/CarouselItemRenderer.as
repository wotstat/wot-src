package net.wg.gui.lobby.vehicleCustomization.controls
{
   ...
   public class CarouselItemRenderer extends UIComponentEx implements IScrollerItemRenderer, IDropItem
   {
      ...
      private var _soundMgr:ISoundManager = App.soundMgr;
      ...
      override protected function onDispose() : void
      {
         ...
         this._tweens = null;
         if(Boolean(this._inventoryFadeTween))
         {
      ...
      private function applyData() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         var _loc1_:Boolean = this._data != null && Boolean(this._data.intCD);
         ...
         var _loc3_:Rectangle = CustomizationShared.computeItemSize(Boolean(this._data) ? this._data.isWide : false,_loc2_);
         ...
         if(!_loc1_)
         {
            ...
            this.imgIcon.alpha = Boolean(this._data) ? this._data.defaultIconAlpha : Number(Values.DEFAULT_ALPHA);
         ...
         this.btnBackground.visible = Boolean(this.editBtn.visible) || Boolean(this.editBtnSmall.visible);
         this.editBtnCounter.visible = (Boolean(this.editBtn.visible) || Boolean(this.editBtnSmall.visible)) && this._data.editNoveltyCounter > 0;
         if(this.editBtnCounter.visible)
         {
            this.editBtnCounter.setCount(this._data.editNoveltyCounter.toString());
            this.editBtnCounter.x = this.editBtn.visible ? this.editBtn.x + this.editBtn.width : this.editBtnSmall.x + this.editBtnSmall.width;
         ...
         {
            this.nonHistoricImg.alpha = this._data.locked ? LOCKED_IMG_ALPHA : 1;
         }
         this.editableImg.visible = this._data.isEditableStyle;
         this.nonHistoricImgPosition();
         this.imgIcon.alpha = this._data.locked || this._data.showDisabled ? LOCKED_IMG_ALPHA : this._data.defaultIconAlpha;
         this.alertIcon.visible = this._data.showAlert;
         this.formIcon.y = _loc2_ ? FORM_ICON_OFFSET_SMALL_Y : FORM_ICON_OFFSET_Y;
         ...
         {
            this.newMC.scaleX = this.newMC.scaleY = _loc2_ ? NEW_MC_MIN_SCALE : NEW_MC_NORMAL_SCALE;
         }
         ...
         var _loc9_:int = 0;
         var _loc10_:int = _loc2_ ? PROGRESSION_LEVEL_GAP_SMALL : PROGRESSION_LEVEL_GAP;
         ...
         if(_loc7_.visible)
         {
            ...
            _loc7_.alpha = this._data.locked ? LOCKED_IMG_ALPHA : 1;
         ...
         this.styleNameTF.width = _loc2_ ? STYLE_NAME_TF_WIDE_SMALL_WIDTH : STYLE_NAME_TF_WIDE_WIDTH;
         this.limitedText.visible = false;
         this.limitedTextIcon.visible = false;
         ...
         if(Boolean(this._data.buyPrice))
         {
            ...
            this.compoundPrice.visible = Boolean(StringUtils.isEmpty(this._data.quantity)) && !this._data.showDisabled;
            if(this.compoundPrice.visible)
            {
               _loc12_ = this._data.buyPrice.action != null;
               _loc13_ = _loc2_ ? 0 : int(-ICON_PADDING_RIGHT);
               _loc14_ = _loc12_ ? ACTION_ICON_PADDING_RIGHT : 0;
               _loc15_ = _loc12_ && _loc2_ ? ACTION_MIN_RES_OFFSET : 0;
         ...
         else if(Boolean(StringUtils.isNotEmpty(this._data.quantity)) && !this._data.showDisabled)
         {
            this.rentalTF.visible = this.rentalIcon.visible = false;
      ...
      {
         if(Boolean(this._data) && !this._data.isRental)
         {
      ...
      private function getPressedButtonIndex(param1:MouseEvent) : uint
      {
         ...
         return _loc2_ == null ? 0 : uint(_loc2_.buttonIdx);
      }
