package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationCarouselLayoutController implements IScrollerLayoutController, IDisposable
   {
      ...
      private var _itemLayouts:Vector.<Rectangle> = new Vector.<Rectangle>();
      
      private var _bookmarkLayouts:Vector.<Rectangle> = new Vector.<Rectangle>();
      
      private var _separatorsLayouts:Vector.<Point> = new Vector.<Point>();
      
      private var _itemLayoutSize:Vector.<Boolean> = new Vector.<Boolean>();
      ...
      public function generateLayout() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = int(this._scrollList.horizontalGap);
      ...
      public function getLeftIndex(param1:int) : int
      {
         ...
         var _loc3_:int = int(this._scrollList.viewPort.horizontalScrollPosition);
      ...
      {
         if(Boolean(this._arrowsData) && Boolean(this._arrowsData[param1]))
         {
