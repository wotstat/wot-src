   ...
   public class PropertySheetSeasonItemPopover extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._model != null)
         {
            ...
            {
               this.itemIcon.height = this._model.iconHeight != Values.DEFAULT_INT ? this._model.iconHeight : ICON_HEIGHT;
               ...
               {
                  this.itemIcon.width = this._model.itemIsWide ? WIDE_ICON_WIDTH : ICON_WIDTH;
               }
