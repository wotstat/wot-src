package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationProgressiveKitPopover extends CustomizationProgressiveKitPopoverMeta implements ICustomizationProgressiveKitPopoverMeta
   {
      ...
      private var _title:String = String.prototype;
      
      private var _clearMsg:String = String.prototype;
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(StringUtils.isNotEmpty(this._clearMsg));
            _loc2_ = true;
         ...
         {
            if(Boolean(this.historicBtn.selected) || Boolean(this.nonHistoricBtn.selected) || Boolean(this.fantasticBtn.selected) || Boolean(this.progressiveLockedBtn.selected))
            {
