package net.wg.gui.lobby.vehicleCustomization.controls.propertiesSheet
{
   ...
   public class CustomizationSheetElementControls extends UIComponentEx
   {
      ...
      public function hideElementsAnimation() : void
      {
         ...
         graphics.clear();
         this.clearTweens();
         if(Boolean(this._contentRenderers))
         {
      ...
      public function setRenderers(param1:CustomizationPropertiesSheetVO) : void
      {
         ...
         _loc2_ = null;
         var _loc3_:int = int(this._contentRenderers.length);
      ...
      private function setPositions() : void
      {
         ...
         _loc1_ = this._activeRenderersCount >= START_BY_ZERO_RENDERERS_COUNT ? int(_loc1_ - ZERO_RADIUS_GAP) : _loc1_;
         ...
         var _loc9_:int = int(Values.DEFAULT_INT);
