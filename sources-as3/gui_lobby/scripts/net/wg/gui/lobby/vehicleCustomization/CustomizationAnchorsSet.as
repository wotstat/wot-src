package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationAnchorsSet extends UIComponentEx implements IMagneticClickHandler
   {
      ...
      private var _rendererData:Vector.<ICustomizationEndPointIcon> = new Vector.<ICustomizationEndPointIcon>();
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this._anchorItemData))
            {
      ...
      public function highlightAnchor(param1:CustomizationSlotIdVO) : void
      {
         ...
         for each(_loc2_ in this._rendererData)
         {
            if(Boolean(_loc2_ != null) && Boolean(_loc2_.slotData) && Boolean(_loc2_.slotData.slotId))
            {
      ...
      public function onAfterDrop() : void
      {
         ...
         for each(_loc1_ in this._rendererData)
         {
            if(Boolean(_loc1_) && _loc1_ is CustomizationAnchorRenderer)
            {
      ...
      public function setInitData(param1:CustomizationAnchorInitVO) : void
      {
         ...
         this._numAnchors = Boolean(this._anchorItemData) ? int(this._anchorItemData.length) : 0;
         var _loc2_:Array = [];
      ...
      private function clearPositionData() : void
      {
         ...
         if(Boolean(this._anchorPositionData))
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:int = this._anchorItemData != null ? int(this._anchorItemData.length) : 0;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
