package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationDecalAnchorRenderer extends CustomizationAnchorRenderer
   {
      ...
      override protected function applyNewState(param1:Boolean = true) : void
      {
         ...
         switch(currentState)
         {
            case CUSTOMIZATION_ALIASES.ANCHOR_STATE_LOCKED:
               ...
               enabled = false;
               if(Boolean(visible) && Boolean(App.cursor.getAttachedSprite()) && param1)
               {
                  deactivateAlpha();
      ...
      override protected function configUI() : void
      {
         var _loc1_:uint = 0;
         super.configUI();
         _loc1_ = uint(this.anchorEmptyUnavailble.totalFrames);
         ...
         _loc1_ = uint(anchorUnselectedEmpty.totalFrames);
