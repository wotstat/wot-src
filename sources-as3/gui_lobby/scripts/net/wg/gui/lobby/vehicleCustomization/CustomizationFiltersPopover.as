package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationFiltersPopover extends CustomizationFiltersPopoverMeta implements ICustomizationFiltersPopoverMeta
   {
      ...
      override protected function setData(param1:FiltersPopoverVO) : void
      {
         ...
         this.formBtns.visible = Boolean(this._initData.formsBtns) && Boolean(this._initData.formsBtns.length);
         this.lblFormFilters.visible = this.formBtns.visible;
         this.raritiesBtns.dataProvider = this._initData.raritiesBtns;
         this.raritiesBtns.visible = Boolean(this._initData.raritiesBtns) && Boolean(this._initData.raritiesBtns.length);
      ...
      {
         var _loc1_:int = int(this._focusChain.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
