package net.wg.gui.lobby.vehicleCustomization
{
   ...
   public class CustomizationCarouselLayoutRenderer implements IDisposable
   {
      ...
      private var _separatorItems:Vector.<MovieClip> = new Vector.<MovieClip>();
      
      private var _arrowItems:Vector.<MovieClip> = new Vector.<MovieClip>();
