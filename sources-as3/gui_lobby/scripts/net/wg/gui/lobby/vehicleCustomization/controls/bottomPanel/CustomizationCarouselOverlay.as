package net.wg.gui.lobby.vehicleCustomization.controls.bottomPanel
{
   ...
   public class CustomizationCarouselOverlay extends UIComponentEx
   {
      ...
      private static const NORMAL_BG_X_POS:int = 270;
      
      private static const MINRES_BG_X_POS:int = 230;
      ...
      override protected function draw() : void
      {
         ...
         {
            this.bg.x = this._isMinResolution ? MINRES_BG_X_POS : NORMAL_BG_X_POS;
            this.bg.width = this._stageWidth - this.bg.x;
            this.scrollHint.x = this.bg.x + (this.bg.width >> 1);
