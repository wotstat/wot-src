package net.wg.gui.lobby.profile.components.chart
{
   ...
   public class ChartBase extends UIComponentEx
   {
      ...
      protected var _renderers:Vector.<IChartItem> = new Vector.<IChartItem>();
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(LAYOUT_INV)) && Boolean(this._currentLayout))
         {
            _loc1_ = 0;
      ...
      protected function updateRenderers() : void
      {
         ...
         var _loc2_:uint = uint(this.getDataProviderLength());
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
      ...
      public function set itemRendererName(param1:String) : void
      {
         ...
         if(Boolean(_inspector) && param1 == "" || param1 == "")
         {
            return;
         }
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._currentLayout))
         {
