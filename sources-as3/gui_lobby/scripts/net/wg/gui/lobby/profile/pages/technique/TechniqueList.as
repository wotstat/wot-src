package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class TechniqueList extends SortableScrollingList
   {
      ...
      public static const ELITE_LEVEL_COLUMN_ID:String = "prestigeLevel";
      
      private static const ADDITIONAL_SORTING_COLUMNS:Array = ["level","shortUserName"];
      ...
      override protected function get additionalSortingFields() : Array
      {
         return ADDITIONAL_SORTING_COLUMNS;
      }
      ...
      private function onIndexChangeHandler(param1:ListEvent) : void
      {
         ...
         if(Boolean(_loc2_) && _loc2_.id != this._selectedVehicleId)
         {
