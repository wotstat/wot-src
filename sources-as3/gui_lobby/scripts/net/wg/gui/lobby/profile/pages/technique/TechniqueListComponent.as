package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class TechniqueListComponent extends UIComponentEx
   {
      ...
      private var _tweenManager:ExcludeTweenManager = new ExcludeTweenManager();
      ...
      override public function setSize(param1:Number, param2:Number) : void
      {
         ...
         var _loc3_:Number = Number(this.techniqueList.rowHeight);
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = uint(this.techniqueList.dataProvider.length);
            _loc2_ = int(this.techniqueList.renderersCount);
            if(_loc1_ <= _loc2_)
            {
            ...
            else
            {
               ...
               _loc5_ = Boolean(_loc4_) ? Number(_loc4_.position) : 0;
               if(_loc5_ == 0)
               {
                  this._tweenManager.registerAndLaunch(ANIM_SPEED,this.upperShadow,{"alpha":0},this.getAnimTweenSet());
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vehicles))
         {
            this._vehicles.splice(0,this._vehicles.length);
            this._vehicles = null;
         }
         if(Boolean(this.techniqueList))
         {
         ...
         if(Boolean(this.sortableButtonBar))
         {
      ...
      private function applyDefaultSorting() : void
      {
         ...
         var _loc2_:int = int(this.sortableButtonBar.dataProvider.indexOf(_loc1_.data));
         if(_loc2_ == -1)
         {
      ...
      {
         if(Boolean(this.sortableButtonBar.container))
         {
      ...
      private function onSortableButtonBarSortDirectionChangedHandler(param1:SortingEvent) : void
      {
         ...
         var _loc3_:int = int(this.sortableButtonBar.dataProvider.indexOf(_loc2_.data));
