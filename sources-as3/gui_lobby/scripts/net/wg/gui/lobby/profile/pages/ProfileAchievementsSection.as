package net.wg.gui.lobby.profile.pages
{
   ...
   public class ProfileAchievementsSection extends ProfileAchievementSectionMeta implements IProfileAchievementSectionMeta
   {
      ...
      {
         super.draw();
         if(Boolean(isInvalid(ProfileInvalidationTypes.RARE_ACHMNT_RECEIVED_DATA_INV)) && this._pendingAchievementsData != null && this._pendingAchievementsDataChanged)
         {
      ...
      {
         if(Boolean(this._pendingAchievementsData))
         {
