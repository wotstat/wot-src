package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class ProfileTechnique extends ProfileTechniqueMeta implements IProfileTechniqueMeta
   {
      ...
      override protected function applyResizing() : void
      {
         ...
         var _loc5_:Number = isWindowed || !_loc2_ ? 1 : 0.85;
         var _loc6_:int = isWindowed || !_loc2_ ? 0 : LIST_OFFSET_X;
         var _loc7_:int = isWindowed || !_loc2_ ? STACK_OFFSET_X : STACK_OFFSET_OFFSET_X_SMALL;
      ...
      {
         super.draw();
         if(Boolean(currentDimension) && Boolean(isInvalid(CURRENT_DIMENSION_INVALID)))
         {
            this.applyResizing();
         }
      }
