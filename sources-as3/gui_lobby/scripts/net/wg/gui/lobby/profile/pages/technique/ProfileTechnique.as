package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class ProfileTechnique extends ProfileTechniqueMeta implements IProfileTechniqueMeta
   {
      ...
      {
         if(Boolean(this.techniqueInitVO))
         {
      ...
      override protected function applyResizing() : void
      {
         ...
         {
            this.listComponent.y = this.stackComponent.y = this.seasonDropdown.visible ? CONTENT_Y_SEASON_DROPDOWN : CONTENT_Y_DEFAULT;
         ...
         var _loc7_:Number = _loc6_ ? 1 : SMALL_SCALE;
         var _loc8_:int = _loc6_ ? 0 : LIST_OFFSET_X;
         var _loc9_:int = _loc6_ ? STACK_OFFSET_X : STACK_OFFSET_OFFSET_X_SMALL;
      ...
      override protected function onDispose() : void
      {
         ...
         {
            if(Boolean(this.emptyScreen.parent))
            {
      ...
      private function onStackComponentPrestigeWidgetEnabledHandler(param1:ProfileTechniqueEvent) : void
      {
         ...
         if(this._isPrestigeEnabled && Boolean(_loc2_))
         {
