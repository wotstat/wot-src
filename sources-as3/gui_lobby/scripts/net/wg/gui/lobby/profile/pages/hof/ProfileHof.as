   ...
   public class ProfileHof extends ProfileHofMeta implements IProfileHofMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INV_BACKGROUND_POSITION))
         {
            ...
            this.updateBgLoaderSize(_loc3_ ? _loc1_ : int(_loc2_ * ORIGINAL_BACKGROUND_ASPECT_RATIO),_loc3_ ? int(_loc1_ / ORIGINAL_BACKGROUND_ASPECT_RATIO) : _loc2_);
         }
      }
      ...
      {
         var _loc1_:Number = Number(App.appHeight);
