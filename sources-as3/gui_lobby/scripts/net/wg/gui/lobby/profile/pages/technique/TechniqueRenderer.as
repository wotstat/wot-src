package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class TechniqueRenderer extends SoundListItemRenderer
   {
      ...
      private static const LEVEL_SCALE:Number = 1.25;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            if(Boolean(data))
            {
               ...
               if(Boolean(this.prestigeLevelTF))
               {
                  this.prestigeLevelTF.text = _loc5_.prestigeLevel > Values.DEFAULT_INT ? getString(_loc5_.prestigeLevel) : Values.EMPTY_STR;
               }
            }
            _loc3_ = int(this.numChildren);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      private function updateScale() : void
      {
         ...
         if(Boolean(data))
         {
            _loc1_ = App.appWidth < StageSizeBoundaries.WIDTH_1280;
            this.levelMC.scaleX = this.levelMC.scaleY = _loc1_ && !data.isOtherPlayer ? LEVEL_SCALE : 1;
         }
      }
      ...
      {
         if(this._compareModeAvailable && Boolean(this._commons.isRightButton(param1)))
         {
