   ...
   public class TechniqueRenderer extends SoundListItemRenderer
   {
      ...
      private function updateScale() : void
      {
         ...
         if(Boolean(data))
         {
            ...
            this.levelMC.scaleX = this.levelMC.scaleY = _loc1_ && Boolean(data.isOtherPlayer) ? 1.25 : 1;
         }
      }
      ...
      {
         if(this._compareModeAvailable && Boolean(App.utils.commons.isRightButton(param1)))
         {
