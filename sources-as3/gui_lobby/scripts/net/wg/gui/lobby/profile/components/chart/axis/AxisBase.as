package net.wg.gui.lobby.profile.components.chart.axis
{
   ...
   public class AxisBase extends UIComponentEx implements IChartAxis
   {
      ...
      protected var _points:Vector.<IListItemRenderer> = new Vector.<IListItemRenderer>();
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc2_ = Boolean(this._dataProvider) ? uint(this._dataProvider.length) : 0;
      ...
      override protected function onDispose() : void
      {
         ...
         this.renderers = null;
         var _loc1_:int = int(this._points.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
