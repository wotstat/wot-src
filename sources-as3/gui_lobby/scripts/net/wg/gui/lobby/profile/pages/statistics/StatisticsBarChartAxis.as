package net.wg.gui.lobby.profile.pages.statistics
{
   ...
   public class StatisticsBarChartAxis extends AxisBase
   {
      ...
      private var _statisticsChartPoints:Vector.<StatisticBarChartAxisPoint> = new Vector.<StatisticBarChartAxisPoint>();
      ...
      override protected function onDispose() : void
      {
         ...
         this.lineText = null;
         var _loc1_:int = int(this._statisticsChartPoints.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function onIconLoadedHandler(param1:IconLoaderEvent) : void
      {
         ...
         var _loc3_:int = int(this._statisticsChartPoints.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
