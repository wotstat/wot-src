package net.wg.gui.lobby.profile.pages.technique
{
   ...
   public class ProfileTechniquePage extends ProfileTechniquePageMeta implements IProfileTechniquePageMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(CURRENT_DIMENSION_INVALID)) || Boolean(InvalidationType.SIZE))
         {
            this.checkBoxExistence.x = App.appWidth <= StageSizeBoundaries.WIDTH_1366 ? CHECKBOX_OFFSET_SMALL : CHECKBOX_OFFSET_BIG;
         }
      }
