package net.wg.gui.lobby.profile.pages.statistics.body
{
   ...
   public class ChartsStatisticsGroup extends Group
   {
      ...
      public var placeChart:StatisticsBarChart;
      
      public var classChart:StatisticsBarChart;
      ...
      public function ChartsStatisticsGroup()
      {
         ...
         this._orderedCharts = new <StatisticsBarChart>[this.typeChart,this.nationChart,this.levelChart,this.classChart,this.placeChart];
      }
      ...
      override protected function configUI() : void
      {
         ...
         this.placeChart.setAxisText(PROFILE.SECTION_STATISTICS_CHARTS_BYPLACELABEL);
         this.classChart.setAxisText(PROFILE.SECTION_STATISTICS_CHARTS_BYCLASSLABEL);
      }
      ...
      public function setDossierData(param1:Array) : void
      {
         ...
         this.clearChartInfoData();
         var _loc2_:int = int(this._orderedCharts.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc2_)
         {
      ...
      {
         var _loc1_:int = int(this._chartInfoData.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
