package net.wg.gui.lobby.profile.pages.statistics
{
   ...
   public class ProfileStatistics extends ProfileStatisticsMeta implements IProfileStatisticsMeta
   {
      ...
      override protected function applyResizing() : void
      {
         ...
         this.headerLabel.y = isWindowed ? HEADER_Y : HEADER_Y_WINDOW;
         var _loc4_:Number = isWindowed || !_loc1_ ? 1 : SCALE_SMALL;
         var _loc5_:int = isWindowed || !_loc1_ ? 0 : WINDOW_OFFSET_X;
      ...
      override protected function applyData(param1:Object) : void
      {
         ...
         var _loc2_:Boolean = Boolean(param1.playersStats);
         ...
         if(_loc2_)
         {
            ...
            this.playersStats.y = isWindowed ? STATS_BTN_WINDOW_Y : STATS_BTN_Y;
         ...
         if(isWindowed && Boolean(battlesDropdown.visible))
         {
            battlesDropdown.y = DROP_DOWN_BATTLE_MODE_WINDOW_Y;
         }
         if(this.seasonDropdown.visible)
         {
            if(Boolean(param1.seasonDropdownAttachToTitle))
            {
            ...
            this.seasonDropdown.y = isWindowed ? DROP_DOWN_LADDER_WINDOW_Y : DROP_DOWN_LADDER_Y;
            this.lblSeasonDropdown.y = isWindowed ? DROP_DOWN_LADDER_LABEL_WINDOW_Y : DROP_DOWN_LADDER_LABEL_Y;
         ...
         var _loc3_:Boolean = Boolean(StringUtils.isNotEmpty(param1.testText));
