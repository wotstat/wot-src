package net.wg.gui.lobby.profile
{
   ...
   public class ProfileTabNavigator extends ProfileTabNavigatorMeta implements IProfileTabNavigatorMeta
   {
      ...
      private var _sectionsDataUtil:LinkageUtils = new LinkageUtils();
      
      private var _centerOffset:int = 0;
      
      private var _countersToSet:Vector.<CountersVo> = null;
      
      private var _actualCounters:Vector.<DisplayObject> = new Vector.<DisplayObject>();
      ...
      override protected function draw() : void
      {
         ...
         var _loc13_:int = 0;
         super.draw();
         if(Boolean(isInvalid(INIT_DATA_INV)) && Boolean(this._data))
         {
         ...
         if(this._isButtonBarReady && Boolean(isInvalid(INVALIDATE_TAB_COUNTERS)))
         {
            _loc9_ = 0;
            ...
            {
               _loc9_ = int(this._countersToSet.length);
               _loc13_ = 0;
      ...
      private function updateMenu() : void
      {
         ...
         var _loc2_:int = _loc1_ ? MENU_OFFSET_SMALL_X : MENU_OFFSET_X;
         var _loc3_:int = _loc1_ ? MENU_OFFSET_SMALL_Y : MENU_OFFSET_Y;
         this.removeCounters();
