package net.wg.gui.lobby.storage.categories.cards
{
   public class CustomizationCardVO extends BaseCardVO
   {
      ...
      override public function isEqual(param1:BaseCardVO) : Boolean
      {
         ...
         return Boolean(super.isEqual(_loc2_)) && this.previewAvailable == _loc2_.previewAvailable && this.isRentable == _loc2_.isRentable && this.previewTooltip == _loc2_.previewTooltip && this.progressiveLevelIcon == _loc2_.progressiveLevelIcon && this.formfactor == _loc2_.formfactor;
      }
