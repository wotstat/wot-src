package net.wg.gui.lobby.storage
{
   ...
   public class StorageView extends StorageViewMeta implements IStorageViewMeta, IStageSizeDependComponent, IInnerView
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.content.currentView) && Boolean(isInvalid(MENU_SIZE_FLAG)))
         {
      ...
      private function updateLayouts() : void
      {
         ...
         if(this._smallSize)
         {
            this.menu.y = _topOffset > 0 ? _topOffset + MENU_Y_OFFSET : SMALL_CONTENT_V_OFFSET;
            this.content.y = _topOffset > 0 ? Number(_topOffset) : SMALL_CONTENT_V_OFFSET;
         ...
         {
            this.menu.y = this.content.y = _topOffset > 0 ? _topOffset + MENU_Y_OFFSET : NORMAL_CONTENT_V_OFFSET;
      ...
      private function updateCounters(param1:Boolean = false) : void
      {
         ...
         {
            _loc2_ = int(this._sidebarCounter[_loc4_]);
