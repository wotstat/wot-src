   ...
   public class BaseCard extends UIComponentEx implements IStageSizeDependComponent, IScrollerItemRenderer, ISoundable
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            ...
            this.titleTF.width = Boolean(this.price && this.price.visible) || Boolean(!this.inInventoryIcon) || !this.inInventoryIcon.visible ? _loc3_.width : this.inInventoryIcon.x - this.titleTF.x;
            if(!this._isOver)
            {
            ...
            if(Boolean(this.descriptionTF))
            {
               ...
               _loc4_ = this._sizeVO.size.width < CARD_SMALL_WIDTH ? DESCRIPTION_SMALL_CARD_MAX_LINES : DESCRIPTION_BIG_CARD_MAX_LINES;
