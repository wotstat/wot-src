package net.wg.gui.lobby.storage.categories.cards
{
   ...
   public class BlueprintsCard extends UIComponentEx implements IStageSizeDependComponent, IScrollerItemRenderer, ISoundable
   {
      ...
      private var _fragmentsCostItems:Vector.<BlueprintCostRenderer> = new Vector.<BlueprintCostRenderer>(0);
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(Boolean(_loc2_))
            {
               _loc4_ = int(this._fragmentsCostItems.length);
               _loc6_ = 0;
               while(_loc6_ < _loc2_)
               {
      ...
      {
         return this._useSmallImage ? COST_OFFSET_Y_SMALL : COST_OFFSET_Y;
      }
      
      private function getCostRolloverOffset() : int
      {
         return this._useSmallImage ? COST_ROLL_OVER_OFFSET_Y_SMALL : COST_ROLL_OVER_OFFSET_Y;
      }
      ...
      private function startRollOverTweens() : void
      {
         ...
         if(Boolean(this.navigateButton.visible) && _loc1_ + this._container.height > this.navigateButton.y)
         {
      ...
      public function set data(param1:Object) : void
      {
         ...
         if(Boolean(this._data) && this._data.isEqual(_loc2_))
         {
            return;
         }
         this._data = _loc2_;
