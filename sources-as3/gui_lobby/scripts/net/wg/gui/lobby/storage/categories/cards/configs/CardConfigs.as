package net.wg.gui.lobby.storage.categories.cards.configs
{
   ...
   public final class CardConfigs implements IDisposable
   {
      ...
      private var _allowCardsResolution:Array = [StageSizeBoundaries.WIDTH_1024,StageSizeBoundaries.WIDTH_1366,StageSizeBoundaries.WIDTH_1600,StageSizeBoundaries.WIDTH_1920];
