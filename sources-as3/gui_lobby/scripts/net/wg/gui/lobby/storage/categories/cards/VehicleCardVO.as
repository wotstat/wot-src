package net.wg.gui.lobby.storage.categories.cards
{
   ...
   public class VehicleCardVO extends RestoreBaseCardVO
   {
      ...
      override public function isEqual(param1:BaseCardVO) : Boolean
      {
         ...
         return Boolean(super.isEqual(_loc2_)) && this.infoImgSrc == _loc2_.infoImgSrc && this.infoText == _loc2_.infoText && this.rentText == _loc2_.rentText && this.rentIcon == _loc2_.rentIcon && (this.tradeOffPrice == _loc2_.tradeOffPrice || this.tradeOffPrice && this.tradeOffPrice.isEqual(_loc2_.tradeOffPrice));
      }
