package net.wg.gui.lobby.storage.categories.cards
{
   ...
   [Event(type="net.wg.gui.lobby.storage.categories.cards.CardEvent",name="deselect")]
   [Event(type="net.wg.gui.lobby.storage.categories.cards.CardEvent",name="select")]
