package net.wg.gui.lobby.storage.categories.storage
{
   ...
   public class ExtraParams extends GroupEx
   {
      ...
      {
         return Boolean(dataProvider) ? uint(Math.min(dataProvider.length,this._maxLines)) : 0;
      }
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = 0;
            _loc3_ = int(numRenderers());
            _loc4_ = int(GroupLayout(layout).gap);
            _loc5_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
      ...
      private function updateLayout() : void
      {
         ...
         var _loc5_:ExtraParamsRenderer = null;
         var _loc1_:int = 0;
         var _loc3_:int = int(numRenderers());
         var _loc4_:int = int(GroupLayout(layout).gap);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
