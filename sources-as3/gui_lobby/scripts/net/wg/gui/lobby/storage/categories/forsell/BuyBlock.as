package net.wg.gui.lobby.storage.categories.forsell
{
   ...
   [Event(type="net.wg.gui.lobby.storage.categories.forsell.BuyBlockEvent",name="sell")]
   [Event(type="net.wg.gui.lobby.storage.categories.forsell.BuyBlockEvent",name="deselectAll")]
   [Event(type="net.wg.gui.lobby.storage.categories.forsell.BuyBlockEvent",name="selectAll")]
