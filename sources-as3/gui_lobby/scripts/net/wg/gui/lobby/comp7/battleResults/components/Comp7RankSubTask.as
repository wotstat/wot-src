package net.wg.gui.lobby.comp7.battleResults.components
{
   ...
   public class Comp7RankSubTask extends UIComponentEx implements ISubtaskComponent
   {
      
      private static const RATING_DIFF_PROGRESS_BAR_X_SHIFT:int = -7;
      ...
      public function Comp7RankSubTask()
      {
         super();
