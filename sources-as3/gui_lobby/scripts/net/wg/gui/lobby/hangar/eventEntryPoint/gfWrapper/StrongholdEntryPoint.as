package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.IStrongholdEntryPointMeta;
   import net.wg.infrastructure.base.meta.impl.StrongholdEntryPointMeta;
   
   public class StrongholdEntryPoint extends StrongholdEntryPointMeta implements IStrongholdEntryPointMeta
   {
      ...
      public function StrongholdEntryPoint()
      {
         super();
      }
      ...
      override protected function updateSize() : void
      {
         ...
         isSingleS((size & EntryPointSize.WIDE_MASK) > 0);
      }
   }
}
