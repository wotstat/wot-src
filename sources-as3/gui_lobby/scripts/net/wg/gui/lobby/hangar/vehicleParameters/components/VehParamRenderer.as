   ...
   public class VehParamRenderer extends SoundListItemRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._model != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            else if(this._model.state == HANGAR_ALIASES.VEH_PARAM_RENDERER_STATE_LINE_SEPARATOR && Boolean(this.separator))
            {
            ...
            else if(this._model.state == HANGAR_ALIASES.VEH_PARAM_RENDERER_STATE_ABILITY && Boolean(this.ability))
            {
