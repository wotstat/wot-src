package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.IResizableEntryPointMeta;
   import net.wg.infrastructure.base.meta.impl.ResizableEntryPointMeta;
   
   public class ResizableEntryPoint extends ResizableEntryPointMeta implements IResizableEntryPointMeta
   {
      ...
      public function ResizableEntryPoint()
      {
         super();
      }
