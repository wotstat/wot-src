package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.ICommonEntryPointMeta;
   import net.wg.infrastructure.base.meta.impl.CommonEntryPointMeta;
   
   public class CommonEntryPoint extends CommonEntryPointMeta implements ICommonEntryPointMeta
   {
      ...
      public function CommonEntryPoint()
      {
         super();
      }
