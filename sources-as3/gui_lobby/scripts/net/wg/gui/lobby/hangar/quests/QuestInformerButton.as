package net.wg.gui.lobby.hangar.quests
{
   ...
   public class QuestInformerButton extends SoundButtonEx implements IQuestInformerButton
   {
      ...
      {
         super.draw();
         if(Boolean(this._questVO) && Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(Boolean(isInvalid(INVALIDATE_FIELDS)) && !isInvalid(INVALIDATE_FIELDS) && enabled)
         {
      ...
      final public function setCollapsePoint(param1:int, param2:int) : void
      {
      ...
      final public function setExpandPoint(param1:int, param2:int) : void
      {
      ...
      final public function get collapsePoint() : Point
      {
         return this._collapsePoint;
      }
      
      final public function get expandPoint() : Point
      {
