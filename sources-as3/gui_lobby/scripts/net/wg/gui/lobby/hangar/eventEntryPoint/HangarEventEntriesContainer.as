package net.wg.gui.lobby.hangar.eventEntryPoint
{
   ...
   public class HangarEventEntriesContainer extends EventEntryPointsContainerMeta implements IEventEntryPointsContainerMeta, IHelpLayoutComponent, IStageSizeDependComponent
   {
      ...
      private static const EVENT_ENTRY_POINT_GAP:int = 8;
      
      private static const EXTRA_SMALL_MARGINS:Rectangle = new Rectangle(0,5,5,28);
      
      private static const SMALL_MARGINS:Rectangle = new Rectangle(0,5,16,28);
      ...
      MARGINS[EntryPointSize.EXTRA_SMALL] = EXTRA_SMALL_MARGINS;
      ...
      private var _entryByLinkageMap:Dictionary = new Dictionary();
      
      private var _data:Vector.<EntryPointVO> = null;
      
      private var _currentSize:int = EntryPointSize.MEDIUM;
      ...
      public function setStateSizeBoundaries(param1:int, param2:int) : void
      {
         ...
         {
            _loc3_ = EntryPointSize.EXTRA_SMALL;
         }
      ...
      private function updateData() : void
      {
         ...
         for each(_loc1_ in this._entryByLinkageMap)
         {
            if(Boolean(_loc1_.entryPointDO) && _loc1_.entryPointDO.parent == null)
            {
      ...
      private function updateLayout() : void
      {
         ...
         var _loc4_:int = int(this._data.length);
         if(_loc4_ <= 1)
         {
      ...
      private function removeEntriesFromContainer() : void
      {
         ...
         for each(_loc1_ in this._entryByLinkageMap)
         {
            if(Boolean(_loc1_.entryPointDO))
            {
      ...
      {
         var _loc2_:EntryPointVO = null;
         var _loc3_:int = int(this._data.length);
         var _loc4_:int = 0;
