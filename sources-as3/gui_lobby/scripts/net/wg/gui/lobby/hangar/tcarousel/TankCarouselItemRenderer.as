   ...
   public class TankCarouselItemRenderer extends SoundButtonEx implements IScrollerItemRenderer
   {
      ...
      protected function updateData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            this._isSpecialSlot = Boolean(this._dataVO.buySlot) || Boolean(this._dataVO.buyTank) || Boolean(this._dataVO.isRentPromotion);
            this.updateBorder();
         ...
         this._hasRankedBonus = _loc1_ ? Boolean(this._dataVO.hasRankedBonus) : false;
         this.updateRankedBonus();
         this._hasProgression = _loc1_ ? Boolean(this._dataVO.hasProgression) : false;
         this.updateProgressionPoints();
         this.updateInteractiveState();
         this.updateEarlyAccess();
         this._hasLevelInfo = false;
         if(_loc1_ && Boolean(this._dataVO.hasExtendedInfo))
         {
            this._hasLevelInfo = true;
            this._isSpecialSlot = this._isSpecialSlot || Boolean(this._dataVO.levelInfo.isCollapsible);
         }
         this.updateInfoLevelContent();
         if(!_loc1_ || this._hasLevelInfo || Boolean(this._dataVO.isNull))
         {
      ...
      protected function onShowTooltip() : void
      {
         ...
         if(Boolean(this._dataVO.buyTank) || Boolean(this._dataVO.restoreTank))
         {
         ...
         else if(Boolean(this._dataVO.isWotPlusSlot) && this._dataVO.intCD == Values.DEFAULT_INT)
         {
            this._toolTipMgr.showComplex(this._dataVO.tooltip);
         }
         else
      ...
      {
         this.extraBorder.visible = Boolean(this._dataVO.isEarnCrystals) && !this._dataVO.isCrystalsLimitReached || Boolean(this._dataVO.isWotPlusSlot);
      ...
      private function updateEarlyAccess() : void
      {
         ...
         var _loc1_:Boolean = Boolean(this._dataVO.isEarlyAccess);
         if(_loc1_)
         {
      ...
      {
         if(Boolean(this._progressionPoints))
         {
      ...
      public function set rowsCount(param1:int) : void
      {
         ...
         if(Boolean(this._infoLevelContent))
         {
            this._infoLevelContent.doubled = this._rowCount > 1;
         }
      }
      ...
      private function onSlotMouseClickHandler(param1:Event) : void
      {
         ...
         if(this._dataVO != null)
         {
            ...
            _loc3_ = _loc2_ == null ? 0 : uint(_loc2_.buttonIdx);
            if(!selected && _loc3_ == MouseEventEx.LEFT_BUTTON)
            {
               ...
               else if(Boolean(this._dataVO.isWotPlusSlot) && this._dataVO.intCD < 0)
               {
               ...
               else
               {
                  ...
                  else if(!this._hasLevelInfo && Boolean(this._dataVO.clickEnabled))
                  {
            ...
            else if(Boolean(isUseRightBtn) && _loc3_ == MouseEventEx.RIGHT_BUTTON && !this._dataVO.buySlot && !this._dataVO.buyTank && !this._dataVO.restoreTank && !this._dataVO.isRentPromotion)
            {
