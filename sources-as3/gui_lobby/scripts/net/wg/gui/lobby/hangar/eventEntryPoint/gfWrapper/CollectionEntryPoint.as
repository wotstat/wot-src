package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.ICollectionEntryPointMeta;
   import net.wg.infrastructure.base.meta.impl.CollectionEntryPointMeta;
   
   public class CollectionEntryPoint extends CollectionEntryPointMeta implements ICollectionEntryPointMeta
   {
      ...
      public function CollectionEntryPoint()
      {
         super();
      }
