package net.wg.gui.lobby.hangar.tcarousel
{
   ...
   public class BaseTankIcon extends UIComponentEx
   {
      ...
      final public function setData(param1:VehicleCarouselVO) : void
      {
         if(param1 != null)
         {
      ...
      final public function setTextInfo(param1:String) : void
      {
      ...
      protected function updateData(param1:VehicleCarouselVO) : void
      {
         ...
         if(Boolean(StringUtils.isNotEmpty(param1.infoText)) || Boolean(StringUtils.isNotEmpty(param1.smallInfoText)))
         {
         ...
         this.extraGlow.visible = _loc2_ || Boolean(param1.isWotPlusSlot);
         ...
         this._isBuyTank = Boolean(param1.buyTank) || Boolean(param1.restoreTank);
         ...
         this.bpSpecialBorder.visible = Boolean(param1.progressionPoints) && Boolean(param1.progressionPoints.isSpecialVehicle);
         this.updateLockBg();
