package net.wg.gui.lobby.hangar
{
   ...
   public class HangarHeader extends HangarHeaderMeta implements IHangarHeaderMeta, IHelpLayoutComponent, IHangarHeader, IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = 0;
            _loc2_ = Boolean(this.economyWidget.visible);
            _loc3_ = Boolean(this._widget) ? int(this._widget.y + this._widget.visibleHeight) : 0;
            ...
            else
            {
               ...
               if(_loc2_)
               {
                  ...
                  else
                  {
                     ...
                     this.questsFlags.noEntryPointLeftMargin = this.questsFlags.noEntryPointRightMargin = this.economyWidget.isSmall ? ECONOMY_SMALL_WIDGET_MARGIN_X : ECONOMY_WIDGET_MARGIN_X;
                  }
               }
            }
      ...
      private function removeQuestFlagsEntryPoint(param1:String, param2:Boolean) : void
      {
         ...
         if(Boolean(_loc3_) && _loc3_.alias == param1)
         {
      ...
      {
         if(Boolean(this.questsFlags.getSecondaryEntryPoint(param2)))
         {
            return;
         }
      ...
      {
         return Boolean(this._widget) && this._widget.alias == param1 && this._widget.registerAlias == param2;
      }
