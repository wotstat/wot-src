package net.wg.gui.lobby.hangar.quests
{
   ...
   public class HeaderQuestsContainer extends Sprite implements IHeaderQuestsContainer
   {
      ...
      private var _questsMap:Dictionary = new Dictionary();
      ...
      final public function animCollapse() : void
      {
      ...
      public function getQuestBtnByType(param1:String) : IQuestInformerButton
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(Boolean(this._questsInformers))
         {
            _loc2_ = int(this._questsInformers.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      final public function setData(param1:HeaderQuestGroupVO) : void
      {
         if(param1 == null)
         {
            return;
      ...
      private function createQuests(param1:Vector.<HeaderQuestsVO>, param2:String) : void
      {
         ...
         if(Boolean(_loc4_))
         {
            ...
            if(!this._isSingle || Boolean(StringUtils.isNotEmpty(param2)) && Boolean(StringUtils.isEmpty(param1[0].icon)))
            {
               this.clearIcon();
      ...
      private function initQuestFlag(param1:IQuestInformerButton, param2:int, param3:Boolean) : void
      {
         ...
         if(this._isSingle)
         {
            _loc4_ = int(Values.ZERO);
            _loc5_ = int(Values.ZERO);
            _loc6_ = int(Values.ZERO);
         }
         else
         {
            ...
            _loc6_ = param2 * HEADER_QUESTS_CONSTANTS.QUEST_BUTTONS_EXPAND_STEP * (this._isRightSide ? 1 : -1);
            if(!param3)
            {
      ...
      private function clearTweens() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(this._itemsTween))
         {
            _loc1_ = int(this._itemsTween.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      {
         if(Boolean(this._iconTweenShow))
         {
      ...
      private function clearQuests() : void
      {
         ...
         if(Boolean(this._questsInformers))
         {
            _loc1_ = int(this._questsInformers.length);
            _loc2_ = null;
            if(Boolean(_loc1_))
            {
               _loc3_ = 0;
      ...
      public function get cmptWidth() : int
      {
         ...
         if(this._isSingle)
         {
            return HEADER_QUESTS_CONSTANTS.QUEST_BUTTON_VISUAL_WIDTH;
         }
         _loc1_ = int(this._questsInformers.length);
         if(this.isAnimExpanded)
         {
            return _loc1_ * HEADER_QUESTS_CONSTANTS.QUEST_BUTTONS_EXPAND_STEP;
         }
         return (_loc1_ - 1) * HEADER_QUESTS_CONSTANTS.QUEST_BUTTONS_GROUP_STEP + HEADER_QUESTS_CONSTANTS.QUEST_BUTTON_VISUAL_WIDTH;
      }
      
      public function get cmptCollapsedWidth() : int
      {
         var _loc1_:Boolean = this.isAnimExpanded;
         this._isAnimExpanded = false;
         var _loc2_:int = this.cmptWidth;
         this._isAnimExpanded = _loc1_;
         return _loc2_;
      }
      
      public function get cmptLeftShift() : int
      {
         if(this._isSingle)
         {
            return 0;
         }
         return (this._questsInformers.length - 1) * HEADER_QUESTS_CONSTANTS.QUEST_BUTTONS_GROUP_STEP;
      }
      ...
      {
         var _loc2_:IQuestInformerButton = param1.target as IQuestInformerButton;
         if(Boolean(_loc2_) && !this._isAnimExpanded)
         {
