   ...
   public class TankCarousel extends TankCarouselMeta implements ITankCarousel
   {
      ...
      private function checkMaskOffsets() : void
      {
         ...
         if(scrollList.useExtendedViewPort)
         {
            ...
            _loc1_ = _loc3_ ? MASK_TOP_OFFSET_EPIC_SMALL : MASK_TOP_OFFSET_EPIC_BIG;
            _loc2_ = _loc3_ ? MASK_BOTTOM_OFFSET_EPIC_SMALL : MASK_BOTTOM_OFFSET_EPIC_BIG;
         }
         else
         {
      ...
      {
         this.background.alpha = param1 ? BG_ALPHA : 1;
      }
