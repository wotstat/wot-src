package net.wg.gui.lobby.hangar.tcarousel
{
   ...
   public class TankCarousel extends TankCarouselMeta implements ITankCarousel
   {
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:int = param2 + OFFSET_ARROW;
      ...
      override protected function draw() : void
      {
         ...
         var _loc2_:Boolean = Boolean(isInvalid(INV_ROW_COUNT));
         if(_loc1_)
         {
            this._helper = this.getNewHelper();
         }
      ...
      override protected function onDispose() : void
      {
         ...
         removeEventListener(TankItemEvent.SELECT_TELECOM_VEHICLE,this.onSelectTelecomVehicleHandler);
      ...
      private function checkMaskOffsets() : void
      {
         ...
         if(scrollList.useExtendedViewPort)
         {
            ...
            _loc1_ = _loc4_ ? MASK_TOP_OFFSET_EPIC_SMALL : MASK_TOP_OFFSET_EPIC_BIG;
            _loc2_ = _loc4_ ? MASK_BOTTOM_OFFSET_EPIC_SMALL : MASK_BOTTOM_OFFSET_EPIC_BIG;
         }
         else
         {
      ...
      private function updateScrollListSettings() : void
      {
         ...
         var _loc5_:int = int(this._helper.padding.top);
         scrollList.y = _loc5_;
      ...
      {
         return Boolean(this._helper) && !this._helper.isSmall && this._rowCount > 1;
      }
      ...
      {
         selectTelecomRentalVehicleS(param1.itemId);
      }
...
class TankCarouselHelper implements ITankCarouselHelper
{
   ...
   public function TankCarouselHelper()
   {
      super();
   }
...
class SmallTankCarouselHelper implements ITankCarouselHelper
{
   ...
   public function SmallTankCarouselHelper()
   {
      super();
   }
