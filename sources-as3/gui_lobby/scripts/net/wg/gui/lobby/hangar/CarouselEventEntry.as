package net.wg.gui.lobby.hangar
{
   ...
   public class CarouselEventEntry extends CarouselEventEntryMeta implements ICarouselEventEntryMeta
   {
      ...
      public function CarouselEventEntry()
      {
         super();
         setManageSize(true);
         setSize(WRAPPER_WIDTH_BIG,WRAPPER_HEIGHT_BIG);
      }
      
      public function set isSmall(param1:Boolean) : void
      {
         this._isSmall = param1;
         var _loc2_:int = param1 ? WRAPPER_WIDTH_SMALL : WRAPPER_WIDTH_BIG;
         var _loc3_:int = param1 ? WRAPPER_HEIGHT_SMALL : WRAPPER_HEIGHT_BIG;
      ...
      {
         return this._isSmall ? ENTRY_POINT_WIDTH_SMALL : ENTRY_POINT_WIDTH_BIG;
      }
      
      public function get marginTop() : int
      {
         return this._isSmall ? ENTRY_POINT_MARGIN_TOP_SMALL : ENTRY_POINT_MARGIN_TOP_BIG;
      }
      
      public function get marginLeft() : int
      {
         return this._isSmall ? ENTRY_POINT_MARGIN_LEFT_SMALL : ENTRY_POINT_MARGIN_LEFT_BIG;
      }
   }
}
