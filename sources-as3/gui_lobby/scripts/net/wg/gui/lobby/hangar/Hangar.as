package net.wg.gui.lobby.hangar
{
   ...
   public class Hangar extends HangarMeta implements IHangar, ITutorialCustomComponent
   {
      ...
      override protected function draw() : void
      {
         var _loc4_:int = 0;
         super.draw();
         var _loc1_:Boolean = Boolean(isInvalid(ENTRY_CONT_POSITION_INVALID,INVALIDATE_AMMUNITION_PANEL_SIZE));
         ...
         if(isInvalid(INVALIDATE_CAROUSEL_EVENT_ENTRY_STATE))
         {
            ...
            if(Boolean(this._carousel) && Boolean(this.carouselEventEntry))
            {
      ...
      public function as_setVehicleParams(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_ = Boolean(this._vehicleParams.visible);
            this._vehicleParams.removeEventListener(Event.RESIZE,this.onParamsResizeHandler);
      ...
      {
         this.bottomBg.alpha = param1 ? BOTTOM_BG_ALPHA : 1;
         if(Boolean(this._carousel))
         {
      ...
      private function removeBattleModifiersPanel() : void
      {
         if(this._battleModifiersPanelInject != null)
         {
            ...
            if(!_baseDisposed && Boolean(isFlashComponentRegisteredS(HANGAR_ALIASES.BATTLE_MODIFIERS_PANEL)))
            {
      ...
      private function updateEntriesPosition() : void
      {
         ...
         var _loc2_:Boolean = Boolean(this.carousel) && this._eventsEntryContainer.isActive;
         ...
         if(_loc2_)
         {
            ...
            _loc3_ = false;
            if(Boolean(_loc1_) && Boolean(this.ammunitionPanelInject.visible) && _loc1_.width > 0)
            {
      ...
      private function updateParamsPosition() : void
      {
         ...
         if(Boolean(this._eventsEntryContainer) && Boolean(this._eventsEntryContainer.isActive) && this._eventsEntryContainer.height > 0)
         {
            _loc2_ = this._eventsEntryContainer.y - this.params.y - this._eventsEntryContainer.margin.top;
         }
         if(Boolean(this._battleModifiersPanelInject))
         {
