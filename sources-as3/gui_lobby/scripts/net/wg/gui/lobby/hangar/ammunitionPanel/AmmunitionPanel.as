   ...
   public class AmmunitionPanel extends AmmunitionPanelMeta implements IAmmunitionPanel
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INV_TUNING_BUTTON_STATE))
         {
            ...
            _loc1_ ||= this._tuningBtnVisible != this.tuningBtn.visible;
         ...
         {
            _loc1_ ||= this._maintenanceBtnVisible != this.maintenanceBtn.visible;
      ...
      private function placeVehicleStatus() : void
      {
         ...
         var _loc2_:int = _loc1_ ? VEHICLE_STATUS_TO_BUTTONS_OFFSET_Y : int(this.maintenanceBtn.height + VEHICLE_STATUS_TO_SLOTS_OFFSET_Y);
      ...
      private function onResizeHandler(param1:Event) : void
      {
         ...
         if(param1.currentTarget.width > this._buttonWidth)
         {
            ...
            _loc3_ = int(this._buttonsList.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
