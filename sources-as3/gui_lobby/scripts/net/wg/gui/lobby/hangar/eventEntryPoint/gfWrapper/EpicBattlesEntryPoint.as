package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.impl.EpicBattlesEntryPointMeta;
   
   public class EpicBattlesEntryPoint extends EpicBattlesEntryPointMeta implements IEpicBattlesEntryPointMeta
   {
      ...
      public function EpicBattlesEntryPoint()
      {
         super();
      }
