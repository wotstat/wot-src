package net.wg.gui.lobby.hangar.quests
{
   ...
   public class HeaderQuestsFlags extends UIComponentEx implements IQuestsButtonsContainer
   {
      ...
      private function updateHitArea() : void
      {
         ...
         var _loc5_:uint = uint(Values.ZERO);
         var _loc6_:uint = uint(Values.ZERO);
      ...
      public function set isSmall(param1:Boolean) : void
      {
         if(param1 != this._isSmall)
         {
            ...
            this._secondaryMargin = this._isSmall ? SECONDARY_MARGIN_SMALL : SECONDARY_MARGIN;
            this._secondaryOffsetX = this._isSmall ? SECONDARY_OFFSET_X_SMALL : SECONDARY_OFFSET_X;
            invalidateSize();
         }
      }
      ...
      {
         return Boolean(this._entryPoint) ? this._entryPoint.marginRight : 0;
      }
      
      private function get entryPointMarginLeft() : int
      {
         return Boolean(this._entryPoint) ? this._entryPoint.marginLeft : 0;
      }
