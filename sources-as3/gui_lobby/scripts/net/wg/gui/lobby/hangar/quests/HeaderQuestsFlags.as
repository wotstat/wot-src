package net.wg.gui.lobby.hangar.quests
{
   ...
   public class HeaderQuestsFlags extends UIComponentEx implements IQuestsButtonsContainer
   {
      ...
      {
         super.draw();
         if(Boolean(this._questsGroupsData))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._secondaryEntryPointLeft))
         {
      ...
      public function getQuestBtnByType(param1:String) : IQuestInformerButton
      {
         ...
         if(Boolean(this._questsGroupsContainers))
         {
      ...
      private function doUpdateData() : void
      {
         ...
         var _loc3_:int = Boolean(this._questsGroupsData) ? int(this._questsGroupsData.length) : 0;
         var _loc4_:int = Boolean(this._questsGroupsContainers) ? int(this._questsGroupsContainers.length) : 0;
      ...
      private function createQuestContainers() : void
      {
         ...
         var _loc1_:int = int(this._questsGroupsData.length);
         if(_loc1_ > 0)
         {
      ...
      private function updateSecondaryEntryPointsPositions() : void
      {
         ...
         if(Boolean(this._secondaryEntryPointLeft))
         {
            _loc3_ = this._isSmall ? SECONDARY_OFFSET_LEFT_X_SMALL : SECONDARY_OFFSET_LEFT_X;
      ...
      private function animFlagsPosition() : void
      {
         ...
         var _loc3_:int = int(this._questsGroupsData.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      private function updateHitArea() : void
      {
         ...
         var _loc3_:int = Boolean(this._entryPoint) ? int(-(_loc1_ >> 1)) : 0;
         var _loc4_:int = 0;
      ...
      private function startDisabledItemTween(param1:Object) : void
      {
         ...
         if(!this._isDisableTweenInProgress && !this._isMoveContainerInProgress)
         {
            ...
            _loc2_ = int(TWEEN_DX_STEPS.length);
            _loc3_ = null;
            _loc4_ = 0;
            _loc5_ = null;
            _loc6_ = 0;
      ...
      private function animContainers(param1:IHeaderQuestsContainer) : void
      {
         ...
         if(Boolean(this._questsGroupsContainers))
         {
            if(Boolean(this._disableItemsTweens))
            {
            ...
            _loc3_ = -1;
            _loc4_ = int(this._questsGroupsContainers.length);
            _loc5_ = null;
            _loc6_ = _loc4_ - 1;
            _loc7_ = false;
            _loc8_ = 0;
      ...
      private function getInitialRightSideX() : int
      {
         ...
         if(Boolean(this._secondaryEntryPointRight))
         {
            _loc2_ = this._isSmall ? SECONDARY_MARGIN_RIGHT_SMALL : SECONDARY_MARGIN_RIGHT;
      ...
      {
         return Boolean(this._questsGroupsContainers) && this._questsGroupsContainers.length > 0;
      }
      ...
      {
         return Boolean(this._entryPoint) ? int(this._entryPoint.width) : 0;
      }
      
      private function get entryPointMarginRight() : int
      {
         return Boolean(this._entryPoint) ? this._entryPoint.marginRight : this._noEntryPointRightMargin;
      }
      
      private function get entryPointMarginLeft() : int
      {
         return Boolean(this._entryPoint) ? this._entryPoint.marginLeft : this._noEntryPointLeftMargin;
      }
      
      private function get entryPointMarginTop() : int
      {
         return Boolean(this._entryPoint) ? this._entryPoint.marginTop : 0;
      }
