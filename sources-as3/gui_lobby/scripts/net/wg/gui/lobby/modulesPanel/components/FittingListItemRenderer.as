package net.wg.gui.lobby.modulesPanel.components
{
   ...
   public class FittingListItemRenderer extends TableRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SIZE))
         {
            if(rendererBg.width != width)
            {
               ...
               updateDisable(Boolean(_data) && !enabled);
      ...
      protected function setup() : void
      {
         ...
         this.setupTarget();
         this.errorField.visible = !this._deviceData.isSelected && Boolean(StringUtils.isNotEmpty(this._deviceData.status));
         ...
         if(enabled && Boolean(hitTestPoint(App.stage.mouseX,App.stage.mouseY,false)))
         {
