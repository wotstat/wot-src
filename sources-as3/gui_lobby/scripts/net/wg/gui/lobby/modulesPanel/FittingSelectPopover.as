   ...
   public class FittingSelectPopover extends FittingSelectPopoverMeta implements IFittingSelectPopoverMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            else if(Boolean(this._listOverlay))
            {
               this._listOverlay.visible = false;
            }
            this.textTf.htmlText = this._data.title;
            if(Boolean(this._data.tabCounters))
            {
               _loc4_ = int(this._data.tabCounters.length);
               _loc5_ = 0;
               while(_loc5_ < _loc4_)
               {
      ...
      private function updateSize() : void
      {
         ...
         var _loc2_:int = Boolean(_loc1_) ? int(_loc1_.length) : 0;
         if(Boolean(_loc2_))
         {
         ...
         if(this._data.rearmCheckboxVisible || this._data.battleAbilitiesButtonVisible)
         {
            ...
            if(Boolean(this.battleAbilitiesButton.visible) && this._battleAbilitiesBtnArea == null)
            {
            ...
            if(Boolean(this._battleAbilitiesBtnArea))
            {
         ...
         if(Boolean(this._listOverlay) && Boolean(this._listOverlay.visible))
         {
      ...
      private function onItemsListItemClickHandler(param1:ListEvent) : void
      {
         ...
         var _loc3_:int = int(param1.index);
         if(_loc2_ != _loc3_)
         {
            _loc4_ = null;
            _loc5_ = null;
