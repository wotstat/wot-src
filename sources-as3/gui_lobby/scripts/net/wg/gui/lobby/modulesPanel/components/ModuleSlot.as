package net.wg.gui.lobby.modulesPanel.components
{
   ...
   public class ModuleSlot extends DeviceSlot implements IModuleSlot
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.disabledBg) && Boolean(isInvalid(InvalidationType.STATE)))
         {
            this.disabledBg.visible = Boolean(slotData) && slotData.isDisabledBgVisible;
         }
      }
