package net.wg.gui.lobby.vehicleTradeWnds.sell
{
   ...
   public class SaleItemBlockRenderer extends ListItemRenderer implements ISaleItemBlockRenderer
   {
      ...
      override public function setData(param1:Object) : void
      {
         ...
         if(Boolean(this._rendererData.sellActionPriceVo))
         {
         ...
         if(Boolean(this._rendererData.removeActionPriceVo))
         {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(isInvalid(InvalidationType.DATA)) && Boolean(data))
         {
            _loc1_ = this._rendererData.onlyToInventory;
            this.labelTf.visible = _loc1_;
            this.ddm.visible = !_loc1_;
            this.alertIcon.visible = this._rendererData.isAlertVisible && Boolean(this._rendererData.alertIconDataID);
            if(_loc1_)
            {
         ...
         if(this._rendererData.isComplexOptionalDevice)
         {
            ...
            if(Boolean(_loc1_))
            {
               ...
               while(_loc4_ < _loc3_)
               {
                  ...
                  if(Boolean(_loc2_) && Boolean(_loc2_.currency == this._rendererData.removeCurrency) && _loc2_.toInventory)
                  {
                     return _loc4_;
                  }
                  _loc4_++;
...
class DDItem
{
   ...
   public function DDItem(param1:String, param2:int = 0, param3:ActionPriceVO = null, param4:Boolean = true, param5:String = null)
   {
      super();
      this.label = param1;
      this.value = param2;
