package net.wg.gui.lobby.vehicleTradeWnds.buy.views
{
   ...
   public class ContentBuyTradInView extends ContentBuyViewBase implements IPopOverCaller
   {
      ...
      override protected function updateTotalResult() : void
      {
         ...
         if(Boolean(vehicleBuyTradeOffVo) && vehicleBuyTradeOffVo.price > Values.DEFAULT_INT)
         {
      ...
      {
         var _loc1_:Number = 0;
         if(vehicleBuyTradeOffVo != null && Boolean(vehicleBuyTradeOffVo.price))
         {
            _loc1_ = -vehicleBuyTradeOffVo.price;
         }
      ...
      {
         if(Boolean(vehicleBuyTradeOffVo) && Boolean(vehicleBuyTradeOffVo.vehicleVo.actionPrice))
         {
      ...
      private function updateCrewDashLine() : void
      {
         ...
         var _loc2_:Number = Number(this.crewDropdown.x);
      ...
      {
         if(Boolean(contentData) && contentData.hasTradeOffVehicles)
         {
