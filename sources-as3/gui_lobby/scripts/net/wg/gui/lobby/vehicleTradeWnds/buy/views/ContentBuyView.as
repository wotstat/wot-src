package net.wg.gui.lobby.vehicleTradeWnds.buy.views
{
   ...
   public class ContentBuyView extends ContentBuyViewBase
   {
      ...
      override protected function drawContent(param1:VehicleBuyContentVo) : void
      {
         ...
         if(Boolean(param1.slotCheckboxTooltip))
         {
         ...
         if(param1.isRentable && Boolean(_loc2_))
         {
      ...
      {
         param1 = Boolean(contentData) && contentData.warningMsg != null ? contentData.warningMsg : Values.EMPTY_STR;
      ...
      {
         if(Boolean(this._lastSelectedButton))
         {
      ...
      public function get crewType() : int
      {
         ...
         if(this._btnGroup != null && Boolean(this._btnGroup.selectedButton))
         {
      ...
      {
         if(Boolean(this._btnGroup) && Boolean(this._btnGroup.selectedButton))
         {
      ...
      {
         if(Boolean(this._btnGroup.selectedButton))
         {
