package net.wg.gui.lobby.vehicleTradeWnds.sell
{
   ...
   public class SellHeaderComponent extends UIComponentEx
   {
      ...
      public function setData(param1:SellVehicleVo) : void
      {
         ...
         var _loc2_:Boolean = Boolean(App.utils.commons.truncateTextFieldMultiline(this.tankInNationGroupTF,param1.inNationGroupDescription,2));
      ...
      {
         this.alertIcon.visible = Boolean(StringUtils.isNotEmpty(this._crewTooltip)) && this.inBarracksDrop.selectedIndex == DEMOBILIZE_INDEX;
      }
