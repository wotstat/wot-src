package net.wg.gui.lobby.vehicleTradeWnds.sell
{
   ...
   public class ControlQuestionComponent extends UIComponentEx
   {
      ...
      public var sellDisabledBlock:SellDisabledMessage;
      ...
      override protected function onDispose() : void
      {
         ...
         this.userInput = null;
         this.sellDisabledBlock.dispose();
         this.sellDisabledBlock = null;
      ...
      public function setSellDisabledText(param1:String) : void
      {
         this.sellDisabledBlock.setMessage(param1);
      }
      
      public function setSellEnabled(param1:Boolean) : void
      {
         this.sellDisabledBlock.visible = !param1;
         this.textHeader.visible = this.controlQuestion.visible = this.userInput.visible = param1;
         this.runtimeValidate();
      }
      
      private function showErrorState(param1:Boolean) : void
      {
         if(this.userInput.text == Values.EMPTY_STR || !param1)
         {
      ...
      {
         if(Boolean(this._creditsParseResult))
         {
