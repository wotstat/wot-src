package net.wg.gui.lobby.vehicleTradeWnds.sell
{
   ...
   public class SlidingScrollingList extends ScrollingList
   {
      ...
      override protected function configUI() : void
      {
         ...
         tabEnabled = Boolean(_focusable) && Boolean(enabled);
         tabChildren = false;
      ...
      override protected function draw() : void
      {
         ...
         if(!_usingExternalRenderers && (Boolean(isInvalid(InvalidationType.SIZE)) || Boolean(isInvalid(InvalidationType.DATA))))
         {
         ...
         if(_scrollBarValue is String)
         {
            ...
            if(_loc1_ == null)
            {
               ...
               if(Boolean(_loc1_))
               {
                  ...
                  if(Boolean(_loc3_) && Boolean(thumbOffset))
                  {
