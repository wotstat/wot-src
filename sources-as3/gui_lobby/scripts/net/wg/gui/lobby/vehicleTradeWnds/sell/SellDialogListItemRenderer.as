package net.wg.gui.lobby.vehicleTradeWnds.sell
{
   ...
   public class SellDialogListItemRenderer extends ListItemRenderer
   {
      ...
      private var _elements:Vector.<SellDialogElementVO> = new Vector.<SellDialogElementVO>();
      
      private var _renderers:Vector.<ISaleItemBlockRenderer> = new Vector.<ISaleItemBlockRenderer>();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._elements))
         {
            this._elements.splice(0,this._elements.length);
            this._elements = null;
         }
         if(Boolean(this._renderers))
         {
      ...
      private function drawLayout() : void
      {
         ...
         var _loc3_:int = Boolean(this._renderers) ? int(this._renderers.length) : 0;
