package net.wg.gui.lobby.vehicleTradeWnds.buy.views
{
   ...
   public class ContentBuyViewBase extends BaseDAAPIComponent implements IVehicleBuyView, IDAAPIModule
   {
      ...
      protected var locale:ILocale = App.utils.locale;
      ...
      {
         super.draw();
         if(this.contentData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.vehicleBuyTradeOffVo))
         {
      ...
      final protected function dispatchUpdate() : void
      {
