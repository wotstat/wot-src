package net.wg.gui.lobby.manual
{
   ...
   public class ManualMainView extends ManualMainViewMeta implements IManualMainViewMeta
   {
      ...
      private var _renderers:Vector.<SoundButtonEx> = new Vector.<SoundButtonEx>(0);
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            _loc4_ = int(this.chapterItem1.actualHeight);
            _loc5_ = -1;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            _loc10_ = _loc9_ ? Number(_width) : _height * BACK_IMAGE_RATIO;
            _loc11_ = _loc9_ ? _width / BACK_IMAGE_RATIO : Number(_height);
