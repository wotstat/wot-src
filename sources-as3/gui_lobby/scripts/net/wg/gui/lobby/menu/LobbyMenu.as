package net.wg.gui.lobby.menu
{
   ...
   public class LobbyMenu extends LobbyMenuMeta implements ILobbyMenuMeta
   {
      ...
      private static const COPYRIGHT_MIN_BOTTOM_MARGIN:int = 4;
      
      private static const VERSION_MIN_BOTTOM_MARGIN:int = 11;
      ...
      private var _btns:Dictionary = new Dictionary();
      ...
      private var _bootomPositions:Dictionary = new Dictionary();
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Y_OFFSET_MENU_BUTTON;
            _loc1_ += this._showManualButton ? 0 : Y_OFFSET_MENU_BUTTON;
            _loc1_ += this._showPostButton ? 0 : Y_OFFSET_MENU_BUTTON;
            this.rePositionBottomElements(_loc1_);
         }
      }
      ...
      public function as_showVersion(param1:Boolean) : void
      {
      ...
      private function updateButtons() : void
      {
         ...
         for each(_loc1_ in [this.logoffBtn,this.settingsBtn,this.quitBtn,this.cancelBtn,this.manualBtn,this.postBtn])
         {
      ...
      private function rePositionBottomElements(param1:int = 0) : void
      {
      ...
      {
         this.updateCopyrightPos();
         this.updateVersionPos();
      }
      
      private function updateVersionPos() : void
      {
         this.versionTF.y = this.background.y + this.background.height - (BACKGROUND_SIZE_FIX >> 1) - VERSION_MIN_BOTTOM_MARGIN - this.versionTF.height | 0;
         this.versionTF.x = this.background.x + VERSION_LEFT_OFFSET + BACKGROUND_SIZE_FIX | 0;
      }
