package net.wg.gui.lobby.userMissions.components.headerComponents
{
   ...
   public class MarathonHeaderConditionItemRenderer extends ListItemRenderer implements IPopOverCaller
   {
      ...
      private static const DEFAULT_SCALE:int = 1;
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._model) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(Boolean(this._model.titleText))
            {
         ...
         if(Boolean(this._model) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            this.updateLayout();
            visible = true;
         }
