package net.wg.gui.lobby.sessionStats
{
   ...
   public class SessionVehicleStatsView extends SessionVehicleStatsViewMeta implements ISeassonResizableContent
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = _height - this.vehicles.y;
            this.vehiclesMask.height = _loc1_ - (_loc1_ + GAP) % (RENDERER_HEIGHT + GAP);
            this.vehiclesMask.width = _width;
         }
      }
      ...
      {
         return this.vehicles.y + this.vehiclesMask.height;
      }
