package net.wg.gui.lobby.sessionStats.components
{
   ...
   public class SessionStatsAnimatedCounter extends UIComponentEx
   {
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:int = int(this.numbers.length);
         var _loc3_:int = int(this.targetNumberV.length);
      ...
      {
         var _loc4_:int = 0;
         var _loc1_:int = int(this.numbers.length);
         var _loc2_:int = int(this.currentNumberV.length);
