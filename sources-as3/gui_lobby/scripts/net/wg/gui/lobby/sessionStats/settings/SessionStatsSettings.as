package net.wg.gui.lobby.sessionStats.settings
{
   ...
   public class SessionStatsSettings extends SessionStatsSettingsMeta implements ISeassonResizableContent, ISessionStatsSettingsMeta
   {
      ...
      override protected function draw() : void
      {
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            this.battle.setSize(width,height - this.battle.y - this.controls.height + this.controls.lipBg.y);
         }
         super.draw();
      }
