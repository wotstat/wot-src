   ...
   public class VehicleInfo extends VehicleInfoMeta implements IVehicleInfoMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(Boolean(this._data.abilityData))
            {
               _loc1_.push({
         ...
         if(Boolean(this._changeNationData) && Boolean(isInvalid(INV_CHANGE_NATION_DATA)))
         {
         ...
         if(Boolean(this._compareData) && Boolean(isInvalid(INV_COMPARE_DATA)))
         {
