package net.wg.gui.lobby.window
{
   ...
   public class AwardWindow extends AwardWindowMeta implements IAwardWindow
   {
      ...
      private function updateComponentsPosition() : void
      {
         ...
         if(this._model.textAreaIconIsShow)
         {
            _loc1_ = int(this.textAreaIcon.height);
         }
         ...
         var _loc4_:Number = Number(this.width);
         if(this._bodyButtonOnly)
         {
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._model.additionalText));
      ...
      private function updateTextAreaBlockPosition() : void
      {
         ...
         if(this._model.textAreaIconIsShow && Boolean(this.textAreaIcon.visible))
         {
            _loc2_ = int(this.textAreaIcon.width);
      ...
      {
         var _loc1_:int = int(this._buttonsForFocus.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
