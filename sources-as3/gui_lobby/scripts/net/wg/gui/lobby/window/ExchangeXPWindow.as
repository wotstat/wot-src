package net.wg.gui.lobby.window
{
   ...
   public class ExchangeXPWindow extends ExchangeXpWindowMeta implements IExchangeXpWindowMeta
   {
      ...
      private var _locale:ILocale = Boolean(App.utils) ? App.utils.locale : null;
      ...
      private function invalidateTotalResult() : void
      {
         ...
         var _loc5_:int = Boolean(this.scrollList.dataProvider) ? int(this.scrollList.dataProvider.length) : 0;
      ...
      private function invalidateAvailableXp() : void
      {
         ...
         if(Boolean(this._scrollListProvider))
         {
            _loc7_ = uint(this._scrollListProvider.length);
            _loc9_ = 0;
            while(_loc9_ < _loc7_)
            {
               ...
               _loc5_ &&= _loc8_.isSelectCandidate;
               _loc2_ += _loc4_;
               _loc9_++;
            }
      ...
      private function onButtonBarSortDirectionChangedHandler(param1:Event) : void
      {
         ...
         if(Boolean(_loc2_) && _loc2_.sortDirection != SortingInfo.WITHOUT_SORT)
         {
      ...
      private function onSubmitBtnClickHandler(param1:ButtonEvent) : void
      {
         ...
         var _loc5_:uint = Boolean(_loc4_) ? uint(_loc4_.length) : 0;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
