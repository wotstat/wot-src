package net.wg.gui.lobby.training
{
   ...
   public class TrainingWindow extends TrainingWindowMeta implements ITrainingWindowMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         var _loc3_:uint = 0;
         super.draw();
         if(this._paramsVO != null && this._mapsData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            else
            {
               ...
               _loc1_ = uint(this._mapsData.length);
      ...
      {
         var _loc2_:Number = Number(this._mapsData[this.maps.selectedIndex].key);
         var _loc3_:Number = Number(this.battleTime.value);
         var _loc4_:int = this.isPrivate.selected ? 1 : int(Values.ZERO);
      ...
      private function onMapIndexChangeHandler(param1:ListEvent) : void
      {
         ...
         if(param1.index > Values.DEFAULT_INT && param1.index < this._mapsData.length)
         {
            ...
            else if(Boolean(_loc2_.additionalInfo))
            {
         ...
         if(this._dataWasSetted && Boolean(this._paramsVO))
         {
