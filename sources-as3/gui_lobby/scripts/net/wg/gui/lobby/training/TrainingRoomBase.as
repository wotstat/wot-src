package net.wg.gui.lobby.training
{
   ...
   public class TrainingRoomBase extends TrainingRoomBaseMeta implements ITrainingRoomBaseMeta, IInnerView
   {
      ...
      private var _voiceChatMgr:IVoiceChatManager = App.voiceChatMgr;
      ...
      final override public function setViewSize(param1:Number, param2:Number) : void
      {
      ...
      override protected function onDispose() : void
      {
         ...
         this.other.dispose();
         this.other = null;
         if(Boolean(this._slots))
         {
            this._slots.splice(0,this._slots.length);
            this._slots = null;
         }
         if(Boolean(this._swapBtns))
         {
      ...
      override protected function onPopulate() : void
      {
         ...
         this.setTeamsInfo();
         var _loc1_:Boolean = Boolean(this._voiceChatMgr.isVOIPEnabledS());
      ...
      public function as_startCoolDownSwapButton(param1:Number) : void
      {
         ...
         if(Boolean(this._swapBtns))
         {
            _loc2_ = int(this._swapBtns.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      final protected function isSlotDroppable(param1:uint, param2:uint) : Boolean
      {
         var _loc3_:uint = uint(getPlayerTeamS(param1));
      ...
      {
         if(Boolean(this._dragDropListDelegateCtrl))
         {
      ...
      private function finishDisable_swapButton_CoolDownHandler() : void
      {
         ...
         if(Boolean(this._swapBtns))
         {
            _loc1_ = int(this._swapBtns.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      final protected function get slots() : Vector.<InteractiveObject>
      {
         return this._slots;
      }
