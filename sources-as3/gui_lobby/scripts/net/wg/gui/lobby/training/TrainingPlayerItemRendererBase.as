package net.wg.gui.lobby.training
{
   ...
   public class TrainingPlayerItemRendererBase extends ListItemRenderer implements IDropItem
   {
      ...
      protected function doUpdateData(param1:TrainingRoomRendererVO) : void
      {
         ...
         var _loc3_:Boolean = Boolean(StringUtils.isNotEmpty(_loc2_));
      ...
      protected function updateHoverState() : Boolean
      {
         ...
         if(this._isMouseOver && Boolean(hitTestPoint(_loc1_.x,_loc1_.y,true)))
         {
      ...
      protected function resetData() : void
      {
         ...
         if(Boolean(this.vehicleField))
         {
            this.vehicleField.text = Values.EMPTY_STR;
         }
         if(Boolean(this.vehicleLevelField))
         {
      ...
      {
         if(Boolean(App.utils.commons.isRightButton(param1)) && Boolean(data))
         {
            this.hideTooltip();
