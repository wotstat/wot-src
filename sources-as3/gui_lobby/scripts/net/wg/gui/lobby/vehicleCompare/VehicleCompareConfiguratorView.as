package net.wg.gui.lobby.vehicleCompare
{
   ...
   public class VehicleCompareConfiguratorView extends VehicleCompareConfiguratorViewMeta implements IVehicleCompareConfiguratorViewMeta, IViewStackContent
   {
      ...
      private var _offsetsNoModifications:Dictionary = new Dictionary();
      ...
      override protected function updateLayout() : void
      {
         ...
         {
            this.modificationsWidget.setSize(MODIFICATIONS_WIDGET_WIDTH,_loc1_ ? MODIFICATIONS_WIDGET_HEIGHT_SMALL : MODIFICATIONS_WIDGET_HEIGHT_BIG);
