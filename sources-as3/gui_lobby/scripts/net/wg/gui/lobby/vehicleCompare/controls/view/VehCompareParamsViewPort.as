package net.wg.gui.lobby.vehicleCompare.controls.view
{
   ...
   public class VehCompareParamsViewPort extends HorizontalScrollerViewPort
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._paramsDelta.parent))
         {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._deltaData) && Boolean(isInvalid(INV_DELTA_DATA)))
         {
         ...
         if(Boolean(isInvalid(INVALIDATE_RENDERER)) || Boolean(isInvalid(INVALIDATE_LAYOUT_RENDERER)) || Boolean(isInvalid(InvalidationType.SIZE)))
         {
