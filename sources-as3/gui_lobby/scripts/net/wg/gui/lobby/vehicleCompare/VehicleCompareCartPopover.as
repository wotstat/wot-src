package net.wg.gui.lobby.vehicleCompare
{
   ...
   public class VehicleCompareCartPopover extends VehicleCompareCartPopoverMeta implements IVehicleCompareCartPopoverMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(this._initData) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            this.titleTF.htmlText = this._initData.title;
         }
         if(Boolean(this._toCmpBtnProps) && Boolean(isInvalid(INV_TOCMPBTN_PROPS)))
         {
         ...
         if(Boolean(this._clearBtnProps) && Boolean(isInvalid(INV_CLEARBTN_PROPS)))
         {
