   ...
   public class VehCompareVehicleRenderer extends ListItemRenderer implements IScrollerItemRenderer, IPopOverCaller
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALIATE_RENDERER_DATA))
         {
            ...
            this.addVehicleBtn.visible = Boolean(this._rendererData) && this._rendererData.isFirstEmptySlot;
            ...
            if(_loc1_)
            {
               ...
               _loc2_ = this.revertBtn.visible ? int(this.revertBtn.width + BTN_GAP) : 0;
      ...
      private function onVehicleIconMouseOverHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._rendererData) && !this._rendererData.isFirstEmptySlot)
         {
