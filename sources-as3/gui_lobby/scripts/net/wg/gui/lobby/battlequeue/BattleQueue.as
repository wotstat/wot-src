package net.wg.gui.lobby.battlequeue
{
   ...
   public class BattleQueue extends BattleQueueMeta implements IBattleQueueMeta, IInnerView
   {
      ...
      {
         if(Boolean(this._viewFrameHelper))
         {
            this._viewFrameHelper.dispose();
            this._viewFrameHelper = null;
         }
         if(Boolean(this._battleIconBgFrameHelper))
         {
         ...
         this.tankIcon = null;
         if(Boolean(this.battleTypeIcon))
         {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(this._typeInfo) && Boolean(isInvalid(INV_TYPE_INFO)))
         {
            ...
            _loc8_ = Boolean(StringUtils.isNotEmpty(_loc7_));
