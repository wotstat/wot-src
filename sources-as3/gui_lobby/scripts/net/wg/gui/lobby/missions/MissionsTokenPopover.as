package net.wg.gui.lobby.missions
{
   ...
   public class MissionsTokenPopover extends MissionsTokenPopoverMeta implements IMissionsTokenPopoverMeta
   {
      ...
      private var _separatorHitArea:Sprite = new Sprite();
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            {
               _loc3_ = this.descrTF.height == DESCR_TF_MIN_HEIGHT ? BUY_BTN_ONLY_SHOP_OFFSET_TEXT_SMALL : BUY_BTN_ONLY_SHOP_OFFSET_TEXT_BIG;
