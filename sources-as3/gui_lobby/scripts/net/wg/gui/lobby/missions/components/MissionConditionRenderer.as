package net.wg.gui.lobby.missions.components
{
   ...
   public class MissionConditionRenderer extends UIComponentEx implements IListItemRenderer
   {
      ...
      {
         super.draw();
         if(this.rendererData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(Boolean(this.icon.visible) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
      ...
      {
         if(this.rendererData.tooltipData != null && Boolean(this.rendererData.tooltipData.tooltip))
         {
