package net.wg.gui.lobby.missions.components
{
   ...
   public class MissionsList extends ScrollerBase
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._dataProvider != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      public function scrollTo(param1:Number, param2:Number = 0) : void
      {
      ...
      {
         var _loc3_:int = int(IListDAAPIDataProvider(this._dataProvider).getItemIndex(param1,param2));
