package net.wg.gui.lobby.missions.components.headerComponents
{
   ...
   public class MissionHeaderCalendar extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(this._isIconVisible && Boolean(StringUtils.isEmpty(this.calendarIcon.source)))
            {
      ...
      public function setText(param1:String) : void
      {
         ...
         {
            _loc2_ = Boolean(App.utils.commons.truncateHtmlTextMultiline(this.calendarText,param1,MAX_LINE_NUMBER,DOTS));
            if(_loc2_)
            {
