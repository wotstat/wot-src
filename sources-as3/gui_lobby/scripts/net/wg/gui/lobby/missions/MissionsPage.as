package net.wg.gui.lobby.missions
{
   ...
   public class MissionsPage extends MissionsPageMeta implements IMissionsPageMeta
   {
      ...
      override public function updateStage(param1:Number, param2:Number) : void
      {
         ...
         this.updateViewSize();
         if(Boolean(this._battleMattersAnimWrapper))
         {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._tabsDataProvider) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            setFocus(this);
            _loc1_ = -1;
         ...
         if(Boolean(this._tabsCounterData) && Boolean(isInvalid(INV_TABS_COUNTER_DATA)))
         {
      ...
      {
         if(Boolean(this.viewStack.currentView))
         {
      ...
      private function setTabBarLabels() : void
      {
         ...
         var _loc1_:int = int(this._tabsCounterData.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_)
         {
      ...
      {
         var _loc2_:MissionTabVO = null;
         if(param1.lastIndex != -1 && Boolean(param1.data))
         {
