      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            if(this._data.isMultiline)
            {
               ...
               _loc2_ = Boolean(App.utils.commons.truncateHtmlTextMultiline(this.descText,this._data.descr,MAX_LINE_NUMBER,DOTS));
               if(_loc2_)
               {
            ...
            _loc1_ = Boolean(StringUtils.isNotEmpty(this._data.period));
