package net.wg.gui.lobby.badges
{
   ...
   public class BadgesHeader extends UIComponentEx implements IUpdatableComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._badgeVisualVO != null && Boolean(isInvalid(INV_BADGE_VISUAL)))
         {
         ...
         else if(this._suffixData != null && Boolean(isInvalid(INV_SUFFIX_DATA)))
         {
         ...
         if(this._hasSuffixBadgeImg && Boolean(isInvalid(INV_SUFFIX_SELECTED)))
         {
         ...
         if(this._hasSuffixBadgeImg && Boolean(isInvalid(INV_SUFFIX_IMG)))
         {
