package net.wg.gui.lobby.badges.components
{
   ...
   public class BadgeRenderer extends SoundListItemRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._badgeData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            this.badgeComponent.alpha = enabled ? Number(Values.DEFAULT_ALPHA) : ICON_AND_CONTENT_NOT_ENABLED_ALPHA;
         ...
         if(isInvalid(INV_SELECTED))
         {
            if(_selected)
            {
               ...
               if(Boolean(this.selectedImg) && Boolean(StringUtils.isEmpty(this.selectedImg.source)))
               {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.selectedImg))
         {
            this.selectedImg.dispose();
            this.selectedImg = null;
         }
         if(Boolean(this.badgeComponent))
         {
