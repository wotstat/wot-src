package net.wg.gui.lobby.vehiclePreview.infoPanel
{
   ...
   public class VPInfoPanel extends UIComponentEx implements IStageSizeDependComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
               ...
               this.vehicleNameTF.scaleX = this.vehicleNameTF.scaleY = this._isSmallHeight ? VEH_NAME_SCALE_SMALL : VEH_NAME_SCALE_BIG;
               this.vehicleLevelTF.scaleX = this.vehicleLevelTF.scaleY = this._isSmallHeight ? VEH_NAME_SCALE_SMALL : VEH_NAME_SCALE_BIG;
               this.vehicleTypeIcon.scaleX = this.vehicleTypeIcon.scaleY = this._isSmallHeight ? VEH_TYPE_SCALE_SMALL : VEH_TYPE_SCALE_BIG;
               this.nationFlagIcon.scaleX = this.nationFlagIcon.scaleY = this._isSmallHeight ? NATION_FLAG_SCALE_SMALL : NATION_FLAG_SCALE_BIG;
               this.nationFlagIcon.x = this._isSmallHeight ? NATION_FLAG_X_SMALL : NATION_FLAG_X_BIG;
               this.nationFlagIcon.y = this._isSmallHeight ? NATION_FLAG_Y_SMALL : NATION_FLAG_Y_BIG;
               this.vehicleNameTF.y = this.vehicleLevelTF.y = this._isSmallHeight ? VEH_NAME_Y_SMALL : VEH_NAME_Y_BIG;
               this.nationChangeIcon.y = this._isSmallHeight ? NATION_CHANGE_IMG_Y_SMALL : NATION_CHANGE_IMG_Y_BIG;
               _loc2_ = this._isSmallHeight ? VEH_TYPE_Y_SHIFT_SMALL : VEH_TYPE_Y_SHIFT_BIG;
               this.vehicleTypeIcon.y = this.vehicleLevelTF.y + _loc2_ >> 0;
               _loc3_ = this._isSmallHeight ? VEH_TYPE_X_SHIFT_SMALL : VEH_TYPE_X_SHIFT_BIG;
               ...
               if(this.roleTF.visible)
               {
                  _loc4_ = this._isSmallHeight ? ROLE_Y_SHIFT_SMALL : ROLE_Y_SHIFT_BIG;
                  this.roleTF.y = this.vehicleNameTF.y + this.vehicleNameTF.height + _loc4_ >> 0;
                  _loc4_ += this.roleTF.height;
               }
               _loc5_ = this._isSmallHeight ? TAB_BAR_Y_SHIFT_SMALL : TAB_BAR_Y_SHIFT_BIG;
               ...
               _loc6_ = this._isSmallHeight ? VIEW_STACK_Y_SHIFT_SMALL : VIEW_STACK_Y_SHIFT_BIG;
      ...
      private function updatePostProgressionVisibility() : void
      {
         ...
         this.vehPostProgressionBtn.visible = Boolean(this._data) && this._data.showPostProgressionBtn && _loc1_;
      }
