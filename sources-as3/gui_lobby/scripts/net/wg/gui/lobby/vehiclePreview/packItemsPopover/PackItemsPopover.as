package net.wg.gui.lobby.vehiclePreview.packItemsPopover
{
   ...
   public class PackItemsPopover extends PackItemsPopoverMeta implements IPackItemsPopoverMeta
   {
      ...
      override protected function configUI() : void
      {
         ...
         this.itemsList.addEventListener(VehiclePreviewEvent.SHOW_TOOLTIP,this.onItemsListShowTooltipHandler);
      }
      ...
      {
         this.titleTf = null;
         this.itemsList.removeEventListener(VehiclePreviewEvent.SHOW_TOOLTIP,this.onItemsListShowTooltipHandler);
      ...
      private function onItemsListShowTooltipHandler(param1:VehiclePreviewEvent) : void
      {
         param1.stopImmediatePropagation();
         var _loc2_:VPPackItemVO = VPPackItemVO(param1.data);
