package net.wg.gui.lobby.vehiclePreview.bottomPanel
{
   ...
   public class VPBottomPanel extends VehiclePreviewBottomPanelMeta implements IVehiclePreviewBottomPanelMeta, IStageSizeDependComponent, IVPBottomPanel
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this._formattedLeftTime))
            {
      ...
      public function setStateSizeBoundaries(param1:int, param2:int) : void
      {
         ...
         if(Boolean(isDAAPIInited) && this._useCompactData != _loc3_)
         {
      ...
      private function updatePanelData() : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            this.discountOverlay.visible = false;
            this.discountValueOverlay.visible = false;
            if(Boolean(this._data.uniqueVehicleTitle))
            {
            ...
            if(Boolean(this._data.setTitle))
            {
            ...
            else if(this._data.isBuyingAvailable)
            {
               ...
               if(Boolean(this._data.itemPrice))
               {
         ...
         if(this._data.isBuyingAvailable)
         {
            ...
            if(this.compoundPrice.visible)
            {
               ...
               if(this.compensation.visible)
               {
                  ...
                  _loc1_ = int(this.compoundPrice.x);
               }
               else
               {
      ...
      {
         if(this._data == null || Boolean(StringUtils.isEmpty(this._data.buyButtonTooltip)))
         {
            return;
         }
