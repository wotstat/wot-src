package net.wg.gui.lobby.vehiclePreview.bottomPanel
{
   ...
   import net.wg.infrastructure.base.meta.impl.VehiclePreviewBottomPanelTradeInMeta;
   import net.wg.utils.IStageSizeDependComponent;
   import net.wg.utils.StageSizeBoundaries;
   import scaleform.clik.constants.InvalidationType;
   import scaleform.clik.events.ButtonEvent;
   
   public class VPBottomPanelTradeIn extends VehiclePreviewBottomPanelTradeInMeta implements IVehiclePreviewBottomPanelTradeInMeta, IVPBottomPanel, IStageSizeDependComponent
   {
      ...
      public function VPBottomPanelTradeIn()
      {
         super();
      }
      ...
      {
         this._offsetY = param2 <= StageSizeBoundaries.HEIGHT_900 ? SMALL_Y_OFFSET : BIG_Y_OFFSET;
         invalidateSize();
      }
