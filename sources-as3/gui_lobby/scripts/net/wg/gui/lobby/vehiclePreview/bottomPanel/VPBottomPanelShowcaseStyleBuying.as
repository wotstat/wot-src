package net.wg.gui.lobby.vehiclePreview.bottomPanel
{
   ...
   public class VPBottomPanelShowcaseStyleBuying extends VehiclePreviewBottomPanelShowcaseStyleBuyingMeta implements IVehiclePreviewBottomPanelShowcaseStyleBuyingMeta, IVPBottomPanel
   {
      ...
      {
         var _loc2_:uint = uint(IconsTypes.MONEY_COLOR);
         switch(param1)
         {
            case IconsTypes.GOLD:
               _loc2_ = uint(IconsTypes.GOLD_COLOR);
               break;
            case IconsTypes.GOLD_BIG:
               _loc2_ = uint(IconsTypes.GOLD_COLOR);
               break;
            case IconsTypes.CREDITS:
               _loc2_ = uint(IconsTypes.CREDITS_COLOR);
               break;
            case IconsTypes.CREDITS_BIG:
               _loc2_ = uint(IconsTypes.CREDITS_COLOR);
               break;
            case IconsTypes.CRYSTAL:
               _loc2_ = uint(IconsTypes.CRYSTAL_COLOR);
               break;
            case IconsTypes.FREE_XP:
            case CURRENCIES_CONSTANTS.FREE_XP:
               _loc2_ = uint(IconsTypes.XP_COLOR);
         }
         return _loc2_;
      }
         ...
         if(Boolean(this._data))
         {
            if(isInvalid(InvalidationType.DATA))
            {
               ...
               else
               {
                  ...
                  _loc2_ = Boolean(StringUtils.isNotEmpty(this._data.timeRemainingStr));
                  ...
                  this.currentPriceTf.textColor = this._data.isMoneyEnough ? getCurrentPriceTextColor(this._data.priceType) : COLOR_ERROR;
            ...
            if(this._isBuyingTimeStateChangedFlag && Boolean(isInvalid(INVALIDATE_BUYING_TIME_ELAPSED)))
            {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
               ...
               else
               {
                  ...
                  if(Boolean(this._data.actionPrice))
                  {
                  ...
                  _loc4_ = uint(this.bg.width - _loc3_ >> 1);
      ...
      {
         if(Boolean(this._data) && Boolean(StringUtils.isNotEmpty(this._data.actionBtnTooltip)))
         {
