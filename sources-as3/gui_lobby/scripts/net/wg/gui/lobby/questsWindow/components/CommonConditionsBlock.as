   ...
   public class CommonConditionsBlock extends AbstractResizableContent implements ISortable
   {
      ...
      override protected function draw() : void
      {
         if(Boolean(isInvalid(InvalidationType.DATA)) && Boolean(this.data))
         {
            ...
            this.description.width = Boolean(this.data.counterValue) || this.data.showDone ? DEFAULT_WIDTH : availableWidth;
      ...
      {
         var _loc1_:Number = Boolean(this.data.description) ? Math.round(this.description.height + HEADER_PADDING) : 0;
