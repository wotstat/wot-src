package net.wg.gui.lobby.questsWindow.components
{
   ...
   public class VehiclesSortingBlock extends AbstractResizableContent implements ISortable
   {
      ...
      {
         var _loc3_:int = int(param1.dataProvider.length);
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(InvalidationType.DATA)) && Boolean(this.data))
         {
      ...
      {
         var _loc1_:Number = Number(this.nationFilter.dataProvider[this.nationFilter.selectedIndex].data);
         var _loc2_:String = String(this.tankFilter.dataProvider[this.tankFilter.selectedIndex].data);
         var _loc3_:Number = Number(this.levelFilter.dataProvider[this.levelFilter.selectedIndex].data);
         var _loc4_:Boolean = Boolean(this.sortCheckBox.selected);
