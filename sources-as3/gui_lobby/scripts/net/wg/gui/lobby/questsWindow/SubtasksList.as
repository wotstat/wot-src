package net.wg.gui.lobby.questsWindow
{
   ...
   public class SubtasksList extends UIComponentEx
   {
      ...
      protected var tasks:Vector.<ISubtaskComponent> = new Vector.<ISubtaskComponent>();
      ...
      private var _tasksDict:Dictionary = new Dictionary(true);
      ...
      {
         var _loc1_:ISubtaskComponent = null;
         var _loc2_:int = int(this.tasks.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
