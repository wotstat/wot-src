package net.wg.gui.lobby.questsWindow
{
   ...
   public class QuestAwardsBlock extends UIComponentEx
   {
      ...
      override protected function configUI() : void
      {
         ...
         if(Boolean(this.bobyBg))
         {
            this.bobyBg.mouseEnabled = false;
         }
         if(Boolean(this.flagBottom))
         {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            if(Boolean(this._data) && this._data.length > 0)
            {
               ...
               if(this._haveAdditional)
               {
                  if(Boolean(this._addData) && this._addData.length > 0)
                  {
               ...
               if(this.hasFixedHeight && _loc3_ > this.defaultHeight)
               {
                  ...
                  this.container.validateNow();
                  if(Boolean(this._addData) && Boolean(this._haveAdditional) && this._addData.length > 0)
                  {
               ...
               _loc1_ = this._autoHeight ? _loc3_ : this.defaultHeight;
