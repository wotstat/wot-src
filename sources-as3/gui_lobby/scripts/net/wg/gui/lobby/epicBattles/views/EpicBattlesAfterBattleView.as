package net.wg.gui.lobby.epicBattles.views
{
   ...
   public class EpicBattlesAfterBattleView extends EpicBattlesAfterBattleViewMeta implements IEpicBattlesAfterBattleViewMeta
   {
      ...
      private static const BOTTOM_BUTTONS_GAP:int = 9;
      ...
      public var rewardsButton:UniversalBtn = null;
      ...
      private var _rewardsButtonFadeInTween:Tween = null;
      
      private var _fameBarFadeOutTween:Tween = null;
      
      private var _maxLevelInfoFadeInTween:Tween = null;
      
      private var _isRewardsButtonShown:Boolean = false;
      ...
      override protected function onBeforeDispose() : void
      {
         ...
         this._scheduler.cancelTask(this.delayedRewardsButtonIntroTweenTask);
         this.nextButton.removeEventListener(ButtonEvent.CLICK,this.onNextButtonClickHandler);
         this.rewardsButton.removeEventListener(ButtonEvent.CLICK,this.onRewardsButtonClickHandler);
      ...
      override protected function onDispose() : void
      {
         ...
         if(this._rewardsButtonFadeInTween != null)
         {
            this._rewardsButtonFadeInTween.paused = true;
            this._rewardsButtonFadeInTween.dispose();
            this._rewardsButtonFadeInTween = null;
         }
      ...
      override protected function configUI() : void
      {
         ...
         this._utils.universalBtnStyles.setStyle(this.nextButton,UniversalBtnStylesConst.STYLE_HEAVY_GREEN);
         this.rewardsButton.alpha = 0;
         this.rewardsButton.visible = false;
         this.rewardsButton.label = EPIC_BATTLE.EPIC_BATTLES_AFTER_BATTLE_CHOOSEREWARDS;
         this.rewardsButton.addEventListener(ButtonEvent.CLICK,this.onRewardsButtonClickHandler);
         this._utils.universalBtnStyles.setStyle(this.rewardsButton,UniversalBtnStylesConst.STYLE_HEAVY_BLACK);
      ...
      override protected function setData(param1:EpicBattlesAfterBattleViewVO) : void
      {
         ...
         this._isRewardsButtonShown = param1.isRewardsButtonShown;
      ...
      override protected function draw() : void
      {
         ...
         var _loc8_:int = 0;
         super.draw();
         if(Boolean(this._completedBattleData))
         {
            _loc1_ = Boolean(isInvalid(InvalidationType.SIZE));
            _loc2_ = int(App.appHeight);
            ...
            if(_loc1_)
            {
               ...
               this.nextButton.y = this.rewardsButton.y = _loc7_ + BAR_TO_BUTTON_GAP;
               ...
               if(this._isRewardsButtonShown)
               {
                  this.nextButton.x = Math.round(_loc5_ - this.nextButton.width - BOTTOM_BUTTONS_GAP);
                  this.rewardsButton.x = Math.round(_loc5_ + BOTTOM_BUTTONS_GAP);
               }
               else
               {
      ...
      private function startIntroAnimation() : void
      {
         ...
         else
         {
            ...
            this._scheduler.scheduleTask(this.delayedRewardsButtonIntroTweenTask,BASIC_DELAY);
         }
      }
      ...
      private function delayedRewardsButtonIntroTweenTask() : void
      {
         this.rewardsButton.visible = this._isRewardsButtonShown;
         this._rewardsButtonFadeInTween = new Tween(FADE_IN_LENGTH,this.rewardsButton,{"alpha":1},{"delay":BASIC_DELAY});
      }
