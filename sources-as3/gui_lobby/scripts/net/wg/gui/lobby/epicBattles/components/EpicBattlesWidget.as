package net.wg.gui.lobby.epicBattles.components
{
   ...
   public class EpicBattlesWidget extends EpicBattlesWidgetMeta implements IEpicBattlesWidgetMeta
   {
      ...
      public var reservesPoints:EpicReservesPointsPanelWrapper = null;
      ...
      private function validateSize() : void
      {
         ...
         this.reservesPoints.updateSize(this._isSmall,this.button.ribbonWidth);
      }
      ...
      private function showWidget() : void
      {
         ...
         {
            this._isShown = true;
            this.gotoAndPlay(SHOW_ANIM_LABEL);
         }
      }
      ...
      override public function get marginRight() : int
      {
         ...
         {
            return this.isSmall ? MARGIN_RIGHT_SMALL : MARGIN_RIGHT_BIG;
         }
