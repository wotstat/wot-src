package net.wg.gui.lobby.battleResults.data
{
   ...
   public class CommonStatsVO extends DAAPIDataClass
   {
      ...
      override protected function onDispose() : void
      {
         ...
         this.overtime = null;
         var _loc1_:int = int(this.playerVehicles.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
         ...
         {
            _loc3_ = int(this.timeStats.length);
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
         ...
         {
            _loc4_ = int(this.victoryScore.length);
            _loc2_ = 0;
            while(_loc2_ < _loc4_)
            {
         ...
         if(Boolean(this.rank))
         {
            this.rank.dispose();
            this.rank = null;
         }
         if(Boolean(this.comp7Rating))
         {
