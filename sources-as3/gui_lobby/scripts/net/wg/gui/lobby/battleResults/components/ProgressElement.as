      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            if(this._data != null)
            {
               ...
               _loc1_ = Boolean(this._data.questState) && Boolean(this._data.questState.statusState);
               if(_loc1_)
               {
         ...
         {
            _loc4_ = this.titleTF.label.length > 0 ? int(this.titleTF.height + LABEL_OFFSET_Y) : 0;
