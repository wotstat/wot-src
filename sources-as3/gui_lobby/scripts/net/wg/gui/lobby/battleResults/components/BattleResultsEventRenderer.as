package net.wg.gui.lobby.battleResults.components
{
   ...
   public class BattleResultsEventRenderer extends UIComponentEx implements ISubtaskComponent
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            if(this._data != null)
            {
               ...
               if(Boolean(this.linkBtn.visible) && !this._linkBtnHasListeners)
               {
      ...
      {
         var _loc2_:Boolean = Boolean(this._data.progressList) && this._data.progressList.length > 0;
         ...
         return _loc2_ ? int(this.progressList.height + BOTTOM_PADDING + PROGRESS_LIST_BOTTOM_PADDING) : 0;
      }
      ...
      private function checkAlertMsg(param1:int) : int
      {
         ...
         this.alert.y = param1;
         return StringUtils.isNotEmpty(_loc2_) ? int(TextField(this.alert.msgTF).textHeight + BOTTOM_PADDING) : 0;
      }
      ...
      private function checkLabels() : int
      {
         ...
         if(this.taskTF.htmlText != this._questInfo.description)
         {
            ...
            _loc1_ = Boolean(StringUtils.isNotEmpty(this._questInfo.description));
      ...
      private function checkCounter() : void
      {
         if(this._tasksCount != this._questInfo.tasksCount)
         {
            ...
            if(this._tasksCount >= 0 && Boolean(StringUtils.isEmpty(this._status)))
            {
