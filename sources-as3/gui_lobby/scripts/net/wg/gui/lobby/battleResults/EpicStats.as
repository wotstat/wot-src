package net.wg.gui.lobby.battleResults
{
   ...
   public class EpicStats extends UIComponentEx implements IViewStackContent, IRegisteredComponent
   {
      ...
      {
         var _loc2_:Array = [];
         if(Boolean(param1.damage) && param1.damage != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.damageToSupplies) && param1.damageToSupplies != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.questsCompleted) && param1.questsCompleted != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.kill) && param1.kill != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.suppliesDestroyed) && param1.suppliesDestroyed != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.assist) && param1.assist != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.armor) && param1.armor != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.spotted) && param1.spotted != DASH_ELEMENT_STRING)
         {
         ...
         if(Boolean(param1.crits) && param1.crits != DASH_ELEMENT_STRING)
         {
