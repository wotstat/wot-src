package net.wg.gui.lobby.battleResults.controller
{
   ...
   public class TeamStatsControllerAbstract implements IDisposable
   {
      ...
      private var _columnTooltip:Dictionary = new Dictionary();
      
      private var _columnWidth:Dictionary = new Dictionary();
      
      private var _sortingKey:Dictionary = new Dictionary();
      
      private var _sortingIsNumeric:Dictionary = new Dictionary();
      
      private var _sortingDirection:Dictionary = new Dictionary();
      ...
      private function setupColumns(param1:ColumnCollection, param2:CommonStatsVO) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               _loc6_ = _loc4_ in this._sortingIsNumeric ? Boolean(this._sortingIsNumeric[_loc4_]) : true;
      ...
      private function applySort(param1:String, param2:String) : void
      {
         ...
         if(Boolean(_loc4_) && Boolean(_loc4_.sortingKeys))
         {
            if(_loc4_.isNumeric)
            {
