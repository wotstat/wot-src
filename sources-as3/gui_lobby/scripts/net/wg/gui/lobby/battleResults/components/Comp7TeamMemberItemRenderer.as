package net.wg.gui.lobby.battleResults.components
{
   ...
   public class Comp7TeamMemberItemRenderer extends TeamMemberRendererBase
   {
      ...
      private static const PLAYER_NAME_WIDTH:int = 111;
      ...
      override protected function showData(param1:TeamMemberItemVO) : void
      {
         ...
         this._isSuperSquad = param1.isSuperSquad;
      ...
      override protected function updateCommonData(param1:CommonStatsVO) : void
      {
         ...
         if(param1.isShowSquad)
         {
            if(this._squadID > 0)
            {
               this.squadIcon.show(this._isOwnSquad,this._squadID,this._isSuperSquad);
            }
         }
         else
         {
      ...
      {
         var _loc1_:Boolean = Boolean(StringUtils.isNotEmpty(this._suffixBadgeIcon));
