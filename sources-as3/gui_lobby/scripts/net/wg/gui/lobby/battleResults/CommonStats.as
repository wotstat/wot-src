package net.wg.gui.lobby.battleResults
{
   ...
   public class CommonStats extends UIComponentEx implements IViewStackContent, IEmblemLoadedDelegate
   {
      ...
      private var _linkageSelector:ISubtaskListLinkageSelector = new ProgressReportLinkageSelector();
      ...
      private var _statsUtilsManager:IStatsUtilsManager = StatsUtilsManager.getInstance();
      ...
      override protected function onDispose() : void
      {
         ...
         this.deserter = null;
         if(Boolean(this.playerSatisfactionWidget))
         {
      ...
      {
         super.draw();
         if(this._data != null && Boolean(isInvalidTypes(InvalidationType.DATA,InvalidationType.SIZE)))
         {
      ...
      public function update(param1:Object) : void
      {
         ...
         var _loc9_:int = 0;
         if(Boolean(this._progressBlocksData))
         {
            this._progressBlocksData.splice(0,this._progressBlocksData.length);
         }
         else
         ...
         if(Boolean(_loc8_) && _loc8_.isLvlUp)
         {
         ...
         this._hasPrestigePoints = Boolean(_loc2_.prestigePoints) && _loc2_.prestigePoints.isVisible;
         ...
         if(_loc3_.eligibleForCrystalRewards || Boolean(StringUtils.isNotEmpty(_loc2_.crystalStr)) && _loc2_.crystalStr != ZERO_STR)
         {
         ...
         this.medalsListLeft.x = this._hasPrestigePoints ? 0 : MEDALS_LIST_LEFT_X;
         ...
         var _loc14_:Boolean = Boolean(StringUtils.isNotEmpty(_loc13_));
      ...
      {
         if(Boolean(param1) && Boolean(param1.efficiencyHeader) && param1.efficiencyHeader.hasEfficencyStats)
         {
      ...
      private function initResultText(param1:CommonStatsVO) : void
      {
         ...
         if(Boolean(this.secondaryFinishReason))
         {
      ...
      {
         var _loc1_:Number = Number(this.detailsMc.x);
         var _loc2_:Number = Number(this.detailsMc.y);
         var _loc3_:Number = Number(this.detailsMc.width);
      ...
      private function initEfficiencyList(param1:PersonalDataVO) : void
      {
         ...
         if(Boolean(param1.details) && param1.details.length > 0)
         {
      ...
      private function initProgressReport(param1:int, param2:int) : void
      {
         ...
         if(Boolean(this._progressBlocksData) && this._progressBlocksData.length > 0)
         {
      ...
      private function layoutProgressReport(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = param1 ? int(PROGRESS_BLOCK_V_DELTA) : 0;
         }
         else
         {
            _loc2_ = param1 ? 0 : int(-PROGRESS_BLOCK_V_DELTA);
         }
         if(_loc2_ != 0)
         {
      ...
      private function initCrystalCounter(param1:String) : void
      {
         ...
         var _loc2_:int = this._hasPrestigePoints ? PRESTIGE_POINTS_X_SHIFT : 0;
      ...
      private function initCounters(param1:String, param2:String) : void
      {
         ...
         var _loc3_:int = this._hasPrestigePoints ? PRESTIGE_POINTS_X_SHIFT : 0;
      ...
      private function updateSatisfactionRatingCmp() : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            else if(Boolean(this.playerSatisfactionWidget))
            {
