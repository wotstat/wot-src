package net.wg.gui.lobby.battleResults.components
{
   ...
   public class TeamMemberStatsView extends TeamMemberStatsViewBase
   {
      ...
      {
         super();
         var _loc1_:Number = Number(scaleX);
         var _loc2_:Number = Number(scaleY);
         scaleX = 1;
         scaleY = 1;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            if(Boolean(data))
            {
               ...
               _loc1_ = Boolean(UserTags.isCurrentPlayer(data.userVO.tags));
               ...
               else if(data.killerID > 0)
               {
                  ...
                  _loc5_ = Boolean(App.utils.commons.formatPlayerName(this.vehicleStateLbl,_loc4_,true));
                  if(_loc5_)
                  {
