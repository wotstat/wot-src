   ...
   public class EfficiencyRenderer extends UIComponentEx implements IListItemRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._dataDirty)
         {
            if(this._data != null)
            {
               if(Boolean(this._data.groupLabel))
               {
      ...
      public function setData(param1:Object) : void
      {
         ...
         if(param1 != null)
         {
            if(Boolean(this._data.hoveredKind))
            {
      ...
      private function setTechniquesData() : void
      {
         ...
         if(Boolean(this._data.isStunDataEnabled))
         {
      ...
      private function checkMouseOverOnScroll() : void
      {
         ...
         while(_loc3_ < this._iconsLength)
         {
            ...
            if(this._isMouseOver && Boolean(_loc2_.hitTestPoint(_loc1_.x,_loc1_.y,true)))
            {
