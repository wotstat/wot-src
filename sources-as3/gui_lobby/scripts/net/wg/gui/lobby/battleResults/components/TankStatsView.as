package net.wg.gui.lobby.battleResults.components
{
   ...
   public class TankStatsView extends UIComponentEx
   {
      ...
      private var _tankMaskObj:Sprite = new Sprite();
      ...
      public function setData(param1:BattleResultsVO) : void
      {
         ...
         var _loc2_:int = int(this._playerVehicles.length);
         if(_loc2_ > 1)
         {
      ...
      private function setVehicleStateLbl() : void
      {
         ...
         else if(_loc1_.killerID > 0)
         {
            ...
            _loc3_ = Boolean(App.utils.commons.formatPlayerName(this.vehicleStateLbl,_loc2_,true));
            if(_loc3_)
            {
      ...
      private function customizeByCountVehicles(param1:Boolean, param2:Boolean) : void
      {
         ...
         var _loc3_:uint = param2 ? uint(this.commendationMC.x) : DEFAULT_COMPONENT_WIDTH;
         var _loc4_:uint = param2 ? COMMENDATION_PADDING : PLAYER_TANK_NAME_PADDING;
