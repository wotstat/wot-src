package net.wg.gui.lobby.battleResults.components
{
   ...
   public class MedalsList extends CoreListEx
   {
      ...
      {
         var _loc2_:Boolean = Boolean(param1[IS_EPIC_PROP_NAME]);
      ...
      override protected function drawLayout() : void
      {
         ...
         var _loc2_:uint = uint(_renderers.length);
         var _loc3_:int = 0;
      ...
      {
         if(Boolean(dataProvider) && Boolean(!_usingExternalRenderers) && Boolean(isInvalid(InvalidationType.DATA)))
         {
            _totalRenderers = dataProvider.length;
            invalidateRenderers();
         }
         super.draw();
         if(!_usingExternalRenderers && Boolean(isInvalid(InvalidationType.SIZE)))
         {
      ...
      private function getPersonalPadding(param1:IListItemRenderer) : int
      {
         ...
         return Boolean(_loc2_) && this._paddings.hasOwnProperty(_loc2_.type) ? int(this._paddings[_loc2_.type]) : 0;
      }
      ...
      private function stripesUpdatePosition() : void
      {
         ...
         var _loc1_:int = int(this._stripes.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_)
         {
      ...
      [Inspectable(name="alignTo",enumeration="left,right,center",defaultValue="left")]
      ...
      [Inspectable(name="colorDodgeMulty",type="Number",defaultValue="1.3",verbose="1")]
