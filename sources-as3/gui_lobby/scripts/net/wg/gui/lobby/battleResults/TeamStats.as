package net.wg.gui.lobby.battleResults
{
   ...
   public class TeamStats extends UIComponentEx implements IViewStackContent
   {
      ...
      private var _columns:ColumnCollection = new ColumnCollection();
      ...
      {
         if(Boolean(this._team1StatsViewBase) && Boolean(this._team2StatsViewBase))
         {
