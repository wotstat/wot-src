package net.wg.gui.lobby.eventBoards.components
{
   ...
   public class AwardStripeRenderer extends SoundListItemRenderer
   {
      ...
      {
         if(Boolean(this._rendererData) && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      private function invalidateAwards() : void
      {
         ...
         if(Boolean(this._rendererData.icons))
         {
      ...
      private function onEnterFrameHandler(param1:Event) : void
      {
         ...
         if(Boolean(this._rendererData && this._prevPosition != _loc2_) && Boolean(_loc2_ <= AWARDS_BOTTOM_THRESHOLD) && _loc2_ >= AWARDS_TOP_THRESHOLD)
         {
