package net.wg.gui.lobby.eventBoards.components
{
   ...
   public class MissionsEventBoardsBody extends MissionPackMarathonBody implements IPopOverCaller
   {
      ...
      {
         var _loc1_:int = Boolean(missionsList.height) ? int(missionsList.height + LIST_PADDING_BOTTOM_MIN) : 0;
         return dummy.visible ? int(dummy.height) : _loc1_;
      }
      ...
      private function getBottomOffset() : int
      {
         ...
         var _loc2_:int = Boolean(this.btnRegistration.visible) && !this._isRegistrationTop ? BUTTON_OFFSET : _loc1_;
