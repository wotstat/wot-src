package net.wg.gui.lobby.eventBoards.components
{
   ...
   public class BasePlayerAwardRenderer extends SoundListItemRenderer
   {
      ...
      override public function setData(param1:Object) : void
      {
         if(param1 != null)
         {
            if(Boolean(this.specialBackground) && Boolean(this.placeIcon))
            {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.specialBackground))
         {
            this.specialBackground = null;
         }
         if(Boolean(this.placeIcon))
         {
      ...
      {
         if(Boolean(this._rendererData.userVO))
         {
