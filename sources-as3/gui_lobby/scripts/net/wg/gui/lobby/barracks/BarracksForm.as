   ...
   public class BarracksForm extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALIDATE_TANKMEN_FILTER))
         {
            ...
            if(Boolean(this._nationID))
            {
               this.locationButtonBar.selectedIndex = 0;
               _loc1_ = 0;
               _loc2_ = int(this.tank.dataProvider.length);
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
            ...
            else
            {
               ...
               _loc4_ = int(this.locationButtonBar.dataProvider.length);
               _loc5_ = 1;
               while(_loc5_ < _loc4_)
               {
         ...
         if(Boolean(isInvalid(INV_COUNTERS)) && Boolean(this._countersData))
         {
      ...
      {
         var _loc1_:Number = Number(this.nationDDM.dataProvider[this.nationDDM.selectedIndex].data);
