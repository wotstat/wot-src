package net.wg.gui.bootcamp.messageWindow.views
{
   ...
   public class MessageViewBase extends UIComponentEx implements IMessageView
   {
      ...
      override protected function draw() : void
      {
         ...
         if(this._messageData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            this.updateContent();
         }
      ...
      protected function updateContent() : void
      {
         ...
         if(Boolean(this.iconContainer) && Boolean(StringUtils.isNotEmpty(this._messageData.iconPath)))
         {
            this.iconContainer.source = this._messageData.iconPath;
         }
         if(Boolean(this.imgBg) && Boolean(StringUtils.isNotEmpty(this._messageData.background)))
         {
