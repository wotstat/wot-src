package net.wg.infrastructure.base.meta.impl
{
   ...
   public class RankedBattlesRewardsYearMeta extends RankedBattlesViewStackComponent
   {
      ...
      public var onChooseRewardBtnClick:Function;
      ...
      {
         if(Boolean(this._rankedRewardsYearVO))
         {
      ...
      public function onChooseRewardBtnClickS() : void
      {
         App.utils.asserter.assertNotNull(this.onChooseRewardBtnClick,"onChooseRewardBtnClick" + Errors.CANT_NULL);
         this.onChooseRewardBtnClick();
      }
