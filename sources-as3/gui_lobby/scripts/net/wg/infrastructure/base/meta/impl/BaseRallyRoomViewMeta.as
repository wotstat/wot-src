package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BaseRallyRoomViewMeta extends BaseRallyView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._tooltipDataVO))
         {
      ...
      final public function as_updateRally(param1:Object) : void
      {
      ...
      final public function as_setMembers(param1:Boolean, param2:Array) : void
      {
      ...
      final public function as_setMemberVehicle(param1:uint, param2:uint, param3:Object) : void
      {
         var _loc4_:VehicleVO = Boolean(param3) ? new VehicleVO(param3) : null;
         this.setMemberVehicle(param1,param2,_loc4_);
      }
      
      final public function as_setActionButtonState(param1:Object) : void
      {
      ...
      final public function as_highlightSlots(param1:Array) : void
      {
      ...
      final public function as_setVehiclesTitle(param1:String, param2:Object) : void
      {
