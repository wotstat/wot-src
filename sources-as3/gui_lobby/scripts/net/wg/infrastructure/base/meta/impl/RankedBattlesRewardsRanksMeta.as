package net.wg.infrastructure.base.meta.impl
{
   ...
   public class RankedBattlesRewardsRanksMeta extends RankedBattlesViewStackComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorDivisionVO))
         {
         ...
         if(Boolean(this._vectorRewardsRankRendererVO))
         {
      ...
      final public function as_setDivisionsData(param1:Array, param2:Boolean) : void
      {
      ...
      final public function as_setRewards(param1:Array, param2:Boolean) : void
      {
