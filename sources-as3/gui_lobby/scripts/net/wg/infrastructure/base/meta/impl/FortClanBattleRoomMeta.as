package net.wg.infrastructure.base.meta.impl
{
   ...
   public class FortClanBattleRoomMeta extends BaseRallyRoomViewWithWaiting
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorDeviceSlotVO))
         {
         ...
         if(Boolean(this._vectorNormalSortingBtnVO))
         {
         ...
         if(Boolean(this._buttonFiltersVO))
         {
      ...
      final public function as_setBattleRoomData(param1:Object) : void
      {
      ...
      final public function as_setConfigureButtonState(param1:Object) : void
      {
      ...
      final public function as_setTimerDelta(param1:Object) : void
      {
      ...
      final public function as_setReservesEnabled(param1:Array) : void
      {
      ...
      final public function as_setReservesData(param1:Array) : void
      {
      ...
      final public function as_setTableHeader(param1:Array) : void
      {
      ...
      final public function as_setFiltersData(param1:Object) : void
      {
