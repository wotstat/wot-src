package net.wg.infrastructure.base.meta.impl
{
   ...
   public class ResearchViewMeta extends AbstractView
   {
      ...
      final public function as_setNodesStates(param1:Number, param2:Array, param3:Boolean) : void
      {
      ...
      final public function as_setNext2Unlock(param1:Array) : void
      {
      ...
      final public function as_setVehicleTypeXP(param1:Array) : void
      {
      ...
      final public function as_setInventoryItems(param1:Array) : void
      {
      ...
      final public function as_setNodeVehCompareData(param1:Array) : void
      {
