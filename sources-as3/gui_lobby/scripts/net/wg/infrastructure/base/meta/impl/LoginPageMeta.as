package net.wg.infrastructure.base.meta.impl
{
   ...
   public class LoginPageMeta extends AbstractView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._simpleFormVo))
         {
            this._simpleFormVo.dispose();
            this._simpleFormVo = null;
         }
         if(Boolean(this._dataProviderSocialIconVo))
         {
         ...
         if(Boolean(this._filledLoginFormVo))
         {
            this._filledLoginFormVo.dispose();
            this._filledLoginFormVo = null;
         }
         if(Boolean(this._steamLoginFormVo))
         {
      ...
      final public function as_setDefaultValues(param1:Object) : void
      {
      ...
      final public function as_showSimpleForm(param1:Boolean, param2:Array, param3:Boolean) : void
      {
         var _loc5_:uint = 0;
         var _loc6_:int = 0;
      ...
      final public function as_showFilledLoginForm(param1:Object) : void
      {
      ...
      final public function as_showSteamLoginForm(param1:Object) : void
      {
