package net.wg.infrastructure.base.meta.impl
{
   ...
   public class VehiclePreviewBottomPanelOfferGiftMeta extends BaseDAAPIComponent
   {
      ...
      public function VehiclePreviewBottomPanelOfferGiftMeta()
      {
         super();
      }
      ...
      {
         if(Boolean(this._vPOfferGiftBuyingPanelVO))
         {
