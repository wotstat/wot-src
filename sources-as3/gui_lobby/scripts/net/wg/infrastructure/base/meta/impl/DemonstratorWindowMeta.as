package net.wg.infrastructure.base.meta.impl
{
   ...
   public class DemonstratorWindowMeta extends AbstractWindowView
   {
      ...
      final public function as_setGameplayTabs(param1:Array, param2:int) : void
      {
      ...
      final public function as_setSpawns(param1:Array, param2:int) : void
      {
      ...
      final public function as_setLevels(param1:Array, param2:int) : void
      {
