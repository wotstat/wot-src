package net.wg.infrastructure.base.meta.impl
{
   ...
   public class NotificationsListMeta extends SmartPopOverView
   {
      ...
      {
         if(Boolean(this._notificationViewInitVO))
         {
            this._notificationViewInitVO.dispose();
            this._notificationViewInitVO = null;
         }
         if(Boolean(this._notificationMessagesListVO))
         {
      ...
      final public function as_setMessagesList(param1:Object) : void
      {
      ...
      final public function as_appendMessage(param1:Object) : void
      {
         var _loc2_:NotificationInfoVO = new NotificationInfoVO(param1);
         this.appendMessage(_loc2_);
      }
      
      final public function as_updateMessage(param1:Object) : void
      {
         var _loc2_:NotificationInfoVO = new NotificationInfoVO(param1);
         this.updateMessage(_loc2_);
      }
      
      final public function as_updateCounters(param1:Array) : void
      {
