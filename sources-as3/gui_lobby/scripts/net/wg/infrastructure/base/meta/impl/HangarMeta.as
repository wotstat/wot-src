package net.wg.infrastructure.base.meta.impl
{
   ...
   public class HangarMeta extends AbstractView
   {
      ...
      {
         if(Boolean(this._ammunitionPanelVO))
         {
      ...
      final public function as_setupAmmunitionPanel(param1:Object) : void
      {
      ...
      final public function as_show3DSceneTooltip(param1:String, param2:Array) : void
      {
      ...
      final public function as_showTeaser(param1:Object) : void
      {
      ...
      final public function as_updateHangarComponents(param1:Array, param2:Array) : void
      {
