package net.wg.infrastructure.base.meta.impl
{
   ...
   public class VehicleCompareViewMeta extends VehicleCompareCommonView
   {
      ...
      {
         if(Boolean(this._vehCompareStaticDataVO))
         {
            this._vehCompareStaticDataVO.dispose();
            this._vehCompareStaticDataVO = null;
         }
         if(Boolean(this._vehCompareParamsDeltaVO))
         {
      ...
      final public function as_setParamsDelta(param1:Object) : void
      {
      ...
      final public function as_setVehicleParamsData(param1:Array) : void
      {
