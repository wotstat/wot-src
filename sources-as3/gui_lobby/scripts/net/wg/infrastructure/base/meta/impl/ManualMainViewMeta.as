package net.wg.infrastructure.base.meta.impl
{
   ...
   public class ManualMainViewMeta extends AbstractView
   {
      ...
      public var onBackButton:Function;
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorChapterItemRendererVO))
         {
      ...
      public function onBackButtonS() : void
      {
         App.utils.asserter.assertNotNull(this.onBackButton,"onBackButton" + Errors.CANT_NULL);
         this.onBackButton();
      }
      
      final public function as_setChapters(param1:Array) : void
      {
