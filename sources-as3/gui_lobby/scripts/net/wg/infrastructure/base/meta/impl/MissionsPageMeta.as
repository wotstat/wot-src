package net.wg.infrastructure.base.meta.impl
{
   ...
   public class MissionsPageMeta extends AbstractView
   {
      ...
      private var _battleMattersAnimVO:BattleMattersAnimVO;
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._dataProviderMissionTabVO))
         {
         ...
         if(Boolean(this._vectorMissionTabCounterVO))
         {
         ...
         if(Boolean(this._battleMattersAnimVO))
         {
            this._battleMattersAnimVO.dispose();
            this._battleMattersAnimVO = null;
         }
         super.onDispose();
      }
      ...
      final public function as_setTabsDataProvider(param1:Array) : void
      {
      ...
      final public function as_setTabsCounterData(param1:Array) : void
      {
      ...
      final public function as_showBattleMattersAnimation(param1:String, param2:Object) : void
      {
         var _loc3_:BattleMattersAnimVO = this._battleMattersAnimVO;
         this._battleMattersAnimVO = new BattleMattersAnimVO(param2);
         this.showBattleMattersAnimation(param1,this._battleMattersAnimVO);
         if(Boolean(_loc3_))
         {
            _loc3_.dispose();
         }
      ...
      protected function showBattleMattersAnimation(param1:String, param2:BattleMattersAnimVO) : void
      {
         var _loc3_:String = "as_showBattleMattersAnimation" + Errors.ABSTRACT_INVOKE;
