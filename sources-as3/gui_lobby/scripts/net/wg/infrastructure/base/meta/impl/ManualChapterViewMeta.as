package net.wg.infrastructure.base.meta.impl
{
   ...
   public class ManualChapterViewMeta extends AbstractView
   {
      ...
      public var bootcampHighlighted:Function;
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._manualChapterContainerVO))
         {
            this._manualChapterContainerVO.dispose();
            this._manualChapterContainerVO = null;
         }
         if(Boolean(this._dataProviderPaginatorPageNumVO))
         {
      ...
      public function bootcampHighlightedS() : void
      {
         App.utils.asserter.assertNotNull(this.bootcampHighlighted,"bootcampHighlighted" + Errors.CANT_NULL);
         this.bootcampHighlighted();
      }
      ...
      final public function as_setPages(param1:Array) : void
      {
