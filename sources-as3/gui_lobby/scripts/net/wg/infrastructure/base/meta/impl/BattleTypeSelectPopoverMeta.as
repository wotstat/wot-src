package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleTypeSelectPopoverMeta extends SmartPopOverView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._dataProviderItemSelectorRendererVO))
         {
         ...
         if(Boolean(this._dataProviderExtraItemSelectorRendererVO))
         {
      ...
      final public function as_update(param1:Array, param2:Array, param3:Boolean, param4:Boolean) : void
      {
