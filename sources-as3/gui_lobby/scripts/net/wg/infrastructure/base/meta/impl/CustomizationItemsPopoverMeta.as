package net.wg.infrastructure.base.meta.impl
{
   ...
   public class CustomizationItemsPopoverMeta extends SmartPopOverView
   {
      ...
      {
         if(Boolean(this._customizationItemPopoverHeaderVO))
         {
      ...
      public function onFilterChangedS(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         App.utils.asserter.assertNotNull(this.onFilterChanged,"onFilterChanged" + Errors.CANT_NULL);
         this.onFilterChanged(param1,param2,param3);
      }
