package net.wg.infrastructure.base.meta.impl
{
   ...
   public class LobbyHeaderMeta extends BaseDAAPIComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._hBC_WotPlusDataVO))
         {
            this._hBC_WotPlusDataVO.dispose();
            this._hBC_WotPlusDataVO = null;
         }
         if(Boolean(this._hBC_PremDataVo))
         {
            this._hBC_PremDataVo.dispose();
            this._hBC_PremDataVo = null;
         }
         if(Boolean(this._dataProviderHangarMenuTabItemVO))
         {
      ...
      final public function as_updateWalletBtn(param1:String, param2:Object) : void
      {
      ...
      final public function as_updateSquad(param1:Boolean, param2:String, param3:String, param4:Boolean, param5:String, param6:Boolean, param7:Object) : void
      {
      ...
      final public function as_nameResponse(param1:Object) : void
      {
      ...
      final public function as_setBadge(param1:Object, param2:Boolean) : void
      {
      ...
      final public function as_setWotPlusData(param1:Object) : void
      {
      ...
      final public function as_setPremiumParams(param1:Object) : void
      {
      ...
      final public function as_setHangarMenuData(param1:Array) : void
      {
      ...
      final public function as_setHeaderButtons(param1:Array) : void
      {
