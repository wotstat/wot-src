package net.wg.infrastructure.base.meta.impl
{
   ...
   public class EpicBattlesAfterBattleViewMeta extends AbstractView
   {
      ...
      {
         if(Boolean(this._epicBattlesAfterBattleViewVO))
         {
      ...
      public function onRewardsBtnClickS() : void
      {
         App.utils.asserter.assertNotNull(this.onRewardsBtnClick,"onRewardsBtnClick" + Errors.CANT_NULL);
         this.onRewardsBtnClick();
      }
