package net.wg.infrastructure.base.meta.impl
{
   ...
   public class VehicleCompareConfiguratorViewMeta extends VehicleCompareConfiguratorBaseView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorShellButtonVO))
         {
         ...
         if(Boolean(this._dataProviderVehConfSkillVO))
         {
      ...
      final public function as_setDevicesData(param1:Array) : void
      {
      ...
      final public function as_setAmmo(param1:Array) : void
      {
      ...
      final public function as_setSkills(param1:Array) : void
      {
