package net.wg.infrastructure.base.meta.impl
{
   ...
   public class SlotsPanelMeta extends BaseDAAPIComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._slotsPanelPropsVO))
         {
            this._slotsPanelPropsVO.dispose();
            this._slotsPanelPropsVO = null;
         }
         if(Boolean(this._vectorSlotVO))
         {
      ...
      final public function as_setPanelProps(param1:Object) : void
      {
      ...
      final public function as_setSlots(param1:Array) : void
      {
      ...
      final public function as_updateSlot(param1:Object) : void
      {
