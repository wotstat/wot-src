package net.wg.infrastructure.base.meta.impl
{
   ...
   public class StorageCategoryPersonalReservesViewMeta extends BaseCategoryView
   {
      ...
      {
         if(Boolean(this._storageCategoryPersonalReservesVO))
         {
      ...
      final public function as_init(param1:Object) : void
      {
      ...
      final public function as_initFilter(param1:Object) : void
      {
