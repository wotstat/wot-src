package net.wg.infrastructure.base.meta.impl
{
   ...
   public class VehiclePreviewBottomPanelWotPlusMeta extends BaseDAAPIComponent
   {
      ...
      public function VehiclePreviewBottomPanelWotPlusMeta()
      {
         super();
      }
      ...
      {
         if(Boolean(this._vPWotPlusPanelData))
         {
