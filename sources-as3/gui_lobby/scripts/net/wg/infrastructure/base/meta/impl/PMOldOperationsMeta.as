package net.wg.infrastructure.base.meta.impl
{
   ...
   public class PMOldOperationsMeta extends BaseDAAPIComponent
   {
      ...
      public function PMOldOperationsMeta()
      {
         super();
      }
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorOperationDataVO))
         {
         ...
         if(Boolean(this._operationTitleVO))
         {
      ...
      final public function as_setOperations(param1:Array) : void
      {
      ...
      final public function as_setTitle(param1:Object) : void
      {
