package net.wg.infrastructure.base.meta.impl
{
   ...
   public class CyberSportIntroMeta extends BaseRallyIntroView
   {
      ...
      {
         if(Boolean(this._introVehicleVO))
         {
            this._introVehicleVO.dispose();
            this._introVehicleVO = null;
         }
         if(Boolean(this._cSIntroViewTextsVO))
         {
      ...
      final public function as_setSelectedVehicle(param1:Object) : void
      {
      ...
      final public function as_setTexts(param1:Object) : void
      {
