package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleStrongholdsQueueMeta extends AbstractView
   {
      ...
      {
         if(Boolean(this._battleStrongholdsQueueTypeInfoVO))
         {
            this._battleStrongholdsQueueTypeInfoVO.dispose();
            this._battleStrongholdsQueueTypeInfoVO = null;
         }
         if(Boolean(this._battleStrongholdsLeaguesVO))
         {
      ...
      final public function as_setTypeInfo(param1:Object) : void
      {
      ...
      final public function as_setLeagues(param1:Object) : void
      {
