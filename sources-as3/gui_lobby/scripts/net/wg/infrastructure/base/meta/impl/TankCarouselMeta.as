package net.wg.infrastructure.base.meta.impl
{
   ...
   public class TankCarouselMeta extends CarouselEnvironment
   {
      ...
      public var selectTelecomRentalVehicle:Function;
      ...
      public function selectTelecomRentalVehicleS(param1:int) : void
      {
         App.utils.asserter.assertNotNull(this.selectTelecomRentalVehicle,"selectTelecomRentalVehicle" + Errors.CANT_NULL);
         this.selectTelecomRentalVehicle(param1);
      }
