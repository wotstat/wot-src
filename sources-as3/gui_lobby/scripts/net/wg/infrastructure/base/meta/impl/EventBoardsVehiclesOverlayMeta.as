package net.wg.infrastructure.base.meta.impl
{
   ...
   public class EventBoardsVehiclesOverlayMeta extends BaseDAAPIComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._eventBoardsVehiclesOverlayVO))
         {
      ...
      final public function as_setFilters(param1:Object) : void
      {
      ...
      final public function as_setVehicles(param1:Object) : void
      {
