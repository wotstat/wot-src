package net.wg.infrastructure.base.meta.impl
{
   ...
   public class StorageCategoryBlueprintsViewMeta extends StorageCarouselEnvironmentMeta
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._blueprintsFragmentVO))
         {
            this._blueprintsFragmentVO.dispose();
            this._blueprintsFragmentVO = null;
         }
         if(Boolean(this._dataProviderBlueprintsFragmentVO))
         {
      ...
      final public function as_updateIntelligenceData(param1:Object) : void
      {
      ...
      final public function as_updateNationalFragments(param1:Array) : void
      {
