package net.wg.infrastructure.base.meta.impl
{
   ...
   public class RosterSlotSettingsWindowMeta extends AbstractWindowView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._dataProviderVehicleSelectorItemVO))
         {
      ...
      final public function as_setVehicleSelection(param1:Object) : void
      {
      ...
      final public function as_setRangeSelection(param1:Object) : void
      {
         var _loc2_:SettingRosterVO = new SettingRosterVO(param1);
         this.setRangeSelection(_loc2_);
      }
      
      final public function as_setListData(param1:Array) : void
      {
      ...
      final public function as_setStaticData(param1:Object) : void
      {
      ...
      final public function as_setRosterLimits(param1:Object) : void
      {
      ...
      final public function as_updateVehicleFilters(param1:Object) : void
      {
