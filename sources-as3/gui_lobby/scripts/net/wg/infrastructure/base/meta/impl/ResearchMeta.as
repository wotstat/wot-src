package net.wg.infrastructure.base.meta.impl
{
   ...
   public class ResearchMeta extends ResearchViewMeta
   {
      ...
      {
         if(Boolean(this._researchPageVO))
         {
            this._researchPageVO.dispose();
            this._researchPageVO = null;
         }
         if(Boolean(this._researchRootVO))
         {
         ...
         if(Boolean(this._researchPostProgressionDataVO))
         {
      ...
      final public function as_setRootData(param1:Object) : void
      {
      ...
      final public function as_setInstalledItems(param1:Array) : void
      {
      ...
      final public function as_setPostProgressionData(param1:Object) : void
      {
