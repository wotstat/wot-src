package net.wg.infrastructure.tutorial.builders.bootcamp
{
   ...
   public class TutorialHighlightEffectBuilder extends TutorialEffectBuilder
   {
      ...
      override protected function createEffect(param1:Object) : void
      {
         ...
         this.updateRect();
         this._container = this._model.addToParent ? component.parent : view as DisplayObjectContainer;
         this._container.addChild(this._hint);
      ...
      private function disposeHint() : void
      {
         if(this._hint != null)
         {
            this._container.removeChild(this._hint);
            this._hint.dispose();
            this._hint = null;
         }
      }
