package net.wg.infrastructure.tutorial.builders
{
   ...
   public class TutorialHintBuilder extends TutorialEffectBuilder
   {
      ...
      private var _componentPosition:Point = new Point();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._hintHighLight))
         {
      ...
      protected function layoutHint() : void
      {
         ...
         if(this._componentPosition.x != _loc1_.x || this._componentPosition.y != _loc1_.y || this._componentWidth != _loc2_ || this._componentHeight != _loc3_)
         {
            ...
            if(Boolean(this._hint))
            {
               this._hint.scaleX = 1 / view.scaleX;
               this._hint.scaleY = 1 / view.scaleY;
               _loc4_ = Number(component.scaleX || 1);
               _loc5_ = Number(component.scaleY || 1);
               _loc6_ = this._model.padding;
               this._hint.x = _loc1_.x - HINT_GLOW_OFFSET * this._hint.actualScaleX + _loc6_.left * _loc4_ | 0;
               this._hint.y = _loc1_.y - HINT_GLOW_OFFSET * this._hint.actualScaleY + _loc6_.top * _loc5_ | 0;
               _loc7_ = this._componentWidth - (_loc6_.left + _loc6_.right) * _loc4_ | 0;
               _loc8_ = this._componentHeight - (_loc6_.top + _loc6_.bottom) * _loc5_ | 0;
      ...
      private function createAndLayoutHint() : void
      {
         ...
         if(!this.model.hasArrow && Boolean(StringUtils.isEmpty(this.model.hintText)))
         {
