package net.wg.data.constants
{
   public class UserTags
   {
      ...
      {
         return Boolean(param1) && param1.indexOf(FRIEND) != -1;
      }
      
      public static function isIgnored(param1:Array) : Boolean
      {
         return Boolean(param1) && (param1.indexOf(IGNORED) != -1 || param1.indexOf(IGNORED_TMP) != -1);
      }
      
      public static function isIgnoredTmp(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(IGNORED_TMP) != -1;
      }
      
      public static function isMuted(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(MUTED) != -1;
      }
      
      public static function isCurrentPlayer(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(CURRENT) != -1;
      }
      
      public static function isBusy(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(PRESENCE_DND) != -1;
      }
      
      public static function isBaseIGR(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(IGR_BASE) != -1;
      }
      
      public static function isPremiumIGR(param1:Array) : Boolean
      {
         return Boolean(param1) && param1.indexOf(IGR_PREMIUM) != -1;
      }
      ...
      {
         return Boolean(param1) && param1.indexOf(BAN_CHAT) != -1;
      }
   }
}
