package net.wg.data.VO
{
   ...
   public class AchievementProgressVO extends AchievementCounterVO
   {
      ...
      {
         if(param1 == FIELD_PROGRESS && Boolean(param2))
         {
      ...
      override public function isEquals(param1:DAAPIDataClass) : Boolean
      {
         ...
         if(Boolean(this._progressInfo) && Boolean(_loc2_.progressInfo))
         {
         ...
         return Boolean(super.isEquals(param1)) && Boolean(isHomogenArraysEquals(this.progress,_loc2_.progress)) && _loc3_;
      }
   }
}
