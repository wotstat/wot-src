package net.wg.data.VO
{
   ...
   public class AchievementProfileVO extends AchievementProgressVO
   {
      ...
      override public function isEquals(param1:DAAPIDataClass) : Boolean
      {
         ...
         return Boolean(super.isEquals(param1)) && this.rareIconId == _loc2_.rareIconId && this.isRare == _loc2_.isRare && this.isDossierForCurrentUser == _loc2_.isDossierForCurrentUser;
      }
   }
}
