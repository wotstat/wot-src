package net.wg.infrastructure.uilogging.deprecated.bootcamp
{
   ...
   public class LoadingPageLogger extends DeprecatedLogger
   {
      ...
      {
         stopAction(BOOTCAMP_LOGGER_CONSTANTS.HINT_PAGE_WATCHED_ACTION,LogLevels.INFO,{"page":this._page},BOOTCAMP_LOGGER_CONSTANTS.TIME_LIMIT);
      }
   }
}
