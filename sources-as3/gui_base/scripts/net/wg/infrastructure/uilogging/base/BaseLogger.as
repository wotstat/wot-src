package net.wg.infrastructure.uilogging.base
{
   ...
   import net.wg.infrastructure.uilogging.*;
   ...
   public class BaseLogger implements IDisposable
   {
      ...
      private var _logOnceActions:Dictionary = new Dictionary();
      
      private var _timedActions:Dictionary = new Dictionary();
      
      private var _suspendedActions:Dictionary = new Dictionary();
      ...
      public function resumeAction(param1:String) : void
      {
         ...
         _loc2_ = int(this._suspendedActions[param1]);
         if(!_loc2_)
         {
            return;
         }
      ...
      protected function _stopAction(param1:String, param2:int = 20, param3:Object = null, param4:Number = 0) : void
      {
         ...
         if(this._timedActions.hasOwnProperty(param1))
         {
            ...
            _loc5_ = uint(this._timedActions[param1]);
