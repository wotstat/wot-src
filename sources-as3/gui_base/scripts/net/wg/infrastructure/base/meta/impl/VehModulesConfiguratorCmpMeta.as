package net.wg.infrastructure.base.meta.impl
{
   ...
   public class VehModulesConfiguratorCmpMeta extends BaseDAAPIComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorConfiguratorColumnVO))
         {
         ...
         if(Boolean(this._vectorConfiguratorColumnVO1))
         {
      ...
      final public function as_setItems(param1:Array) : void
      {
      ...
      final public function as_updateItems(param1:Array) : void
      {
         var _loc5_:ConfiguratorColumnVO = null;
