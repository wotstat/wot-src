package net.wg.infrastructure.base.meta.impl
{
   ...
   public class CarouselEnvironmentMeta extends ScrollCarousel
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._tankCarouselFilterInitVO))
         {
      ...
      final public function as_setCarouselFilter(param1:Object) : void
      {
      ...
      final public function as_initCarouselFilter(param1:Object) : void
      {
