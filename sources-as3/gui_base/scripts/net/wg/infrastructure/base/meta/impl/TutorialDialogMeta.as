package net.wg.infrastructure.base.meta.impl
{
   ...
   public class TutorialDialogMeta extends AbstractWindowView
   {
      ...
      {
         if(Boolean(this._tutorialDialogVO))
         {
            this._tutorialDialogVO.dispose();
            this._tutorialDialogVO = null;
         }
         if(Boolean(this._tutorialDialogVO1))
         {
      ...
      final public function as_setContent(param1:Object) : void
      {
      ...
      final public function as_updateContent(param1:Object) : void
      {
