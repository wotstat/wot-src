package net.wg.infrastructure.base.meta.impl
{
   ...
   public class ColorSettingsViewMeta extends AbstractScreen
   {
      ...
      {
         if(Boolean(this._colorSettingsVO))
         {
            this._colorSettingsVO.dispose();
            this._colorSettingsVO = null;
         }
         if(Boolean(this._colorSettingsUpdateVO))
         {
      ...
      final public function as_initData(param1:Object) : void
      {
      ...
      final public function as_updateData(param1:int, param2:Object) : void
      {
