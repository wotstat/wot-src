package net.wg.infrastructure.base.meta.impl
{
   ...
   public class SettingsWindowMeta extends AbstractWindowView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorSettingsNewCountersVo))
         {
      ...
      final public function as_setCountersData(param1:Array) : void
      {
      ...
      final public function as_setFeedbackDataProvider(param1:Array) : void
      {
      ...
      final public function as_setDisabledTabsOverlay(param1:Array, param2:String) : void
      {
