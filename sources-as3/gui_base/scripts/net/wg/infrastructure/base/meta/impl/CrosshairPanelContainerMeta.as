package net.wg.infrastructure.base.meta.impl
{
   ...
   public class CrosshairPanelContainerMeta extends DAAPISimpleContainer
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorGunMarkerIndicatorVO))
         {
         ...
         if(Boolean(this._vectorShotFlyTimeVO))
         {
      ...
      final public function as_setGunMarkersIndicators(param1:Array) : void
      {
      ...
      final public function as_setShotFlyTimes(param1:Array) : void
      {
      ...
      final public function as_addOverheat(param1:Array) : void
      {
