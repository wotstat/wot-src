package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleDamageLogPanelMeta extends BaseDAAPIComponent
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorMessageRenderModel))
         {
         ...
         if(Boolean(this._vectorMessageRenderModel1))
         {
      ...
      final public function as_detailStatsTop(param1:Boolean, param2:Boolean, param3:Array) : void
      {
      ...
      final public function as_detailStatsBottom(param1:Boolean, param2:Boolean, param3:Array) : void
      {
         var _loc7_:MessageRenderModel = null;
