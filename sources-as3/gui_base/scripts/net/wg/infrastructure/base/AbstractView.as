package net.wg.infrastructure.base
{
   ...
   public class AbstractView extends AbstractViewMeta implements IView, IAbstractViewMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(Boolean(constraints) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            constraints.update(_width,_height);
         }
         if(Boolean(isInvalid(INVALID_MODAL_FOCUS)) && this.hasFocus)
         {
      ...
      final public function leaveModalFocus() : void
      {
      ...
      final public function setModalFocus() : void
      {
      ...
      final protected function setFocus(param1:InteractiveObject) : void
      {
      ...
      final protected function assertUpdateStageMethod(param1:Boolean = false) : void
      {
         if(!param1)
         {
      ...
      final protected function assert(param1:Boolean, param2:String = "failed assert", param3:Class = null) : void
      {
      ...
      final protected function assertLifeCycle() : void
      {
         this.assert(!disposed,Errors.MTHD_CORRUPT_INVOKE,LifecycleException);
      }
      
      final protected function assertNotNull(param1:Object, param2:String = "object", param3:Class = null) : void
      {
         if(Boolean(App.instance))
         {
      ...
      final protected function assertNull(param1:Object, param2:String = "object", param3:Class = null) : void
      {
         if(Boolean(App.instance))
         {
      ...
      final override public function get hasFocus() : Boolean
      {
