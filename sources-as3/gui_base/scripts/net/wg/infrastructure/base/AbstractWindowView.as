package net.wg.infrastructure.base
{
   ...
   public class AbstractWindowView extends WindowViewMeta implements IAbstractWindowView
   {
      ...
      {
         super.draw();
         if(Boolean(this.geometry) && Boolean(this._window) && Boolean(isInvalid(WindowViewInvalidationType.POSITION_INVALID)))
         {
      ...
      final protected function canCloseFromInputDetails(param1:InputDetails) : Boolean
      {
      ...
      protected function changeBackgroundLabel(param1:String) : void
      {
         ...
         if(Boolean(this.window))
         {
            ...
            if(Boolean(_loc2_) && _loc2_.currentLabel != param1)
            {
      ...
      private function checkAppBounds() : void
      {
         ...
         var _loc2_:int = int(_loc1_.leftOffset);
         var _loc3_:int = int(_loc1_.topOffset);
         var _loc4_:int = App.appWidth - _loc1_.horizontalOffset;
         var _loc5_:int = App.appHeight - _loc1_.verticalOffset;
         var _loc6_:int = int(this._window.width);
         if(_loc6_ > _loc4_)
         {
         ...
         var _loc7_:int = int(this._window.height);
         if(_loc7_ > _loc5_)
         {
