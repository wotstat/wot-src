package net.wg.gui.lobby.settings
{
   ...
   public class SettingsArcadeForm extends SettingsNewCountersForm implements ISettingsAimForm
   {
            ...
            for(; _loc9_ < _loc5_; _loc9_++)
            {
               ...
               switch(_loc7_.type)
               {
                  case SettingsConfigHelper.TYPE_SLIDER:
                     ...
                     if(_loc7_.hasValue && Boolean(this[_loc6_ + SettingsConfigHelper.TYPE_VALUE]))
                     {
                        _loc13_ = this[_loc6_ + SettingsConfigHelper.TYPE_VALUE];
                        _loc13_.text = _loc11_.toString();
                     }
                     if(_loc7_.hasLabel && Boolean(this[_loc6_ + SettingsConfigHelper.TYPE_LABEL]))
                     {
                  ...
                  case SettingsConfigHelper.TYPE_DROPDOWN:
                     ...
                     _loc12_.menuRowCount = _loc7_.options is Array ? _loc7_.options.length : 0;
      ...
      private function onSliderValueChangeHandler(param1:SliderEvent) : void
      {
         ...
         if(_loc4_.hasValue && Boolean(this[_loc3_ + SettingsConfigHelper.TYPE_VALUE]))
         {
