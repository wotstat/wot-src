package net.wg.gui.lobby.settings
{
   ...
   public class MarkerSettings extends MarkerSettingsBase
   {
      ...
      private var _markerTabsDataProvider:IDataProvider = SettingsConfigHelper.instance.markerTabsDataProvider;
      ...
      override protected function setData(param1:SettingsDataVo) : void
      {
         ...
         while(_loc12_ < _loc5_)
         {
            ...
            if(Boolean(this[_loc7_ + FORM_STR]))
            {
      ...
      override protected function updateNewCountersControls(param1:Vector.<SettingsTabNewCounterVo>) : void
      {
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:int = int(this._markerTabsDataProvider.length);
      ...
      private function updateShowContent() : void
      {
         ...
         while(_loc11_ < _loc1_)
         {
            ...
            if(Boolean(this[_loc4_ + ALT_STR]))
            {
            ...
            if(_loc5_ == ENEMY_STR)
            {
               autoAimMarker.visible = _loc10_ && Boolean(this._dynamicMarkersData[_loc5_][AIM_MARKER_SETTING_ID_BASE]);
               autoAimMarkerAlt.visible = _loc10_ && Boolean(this._dynamicMarkersData[_loc5_][AIM_MARKER_SETTING_ID_ALT]);
            }
            _loc11_++;
         }
