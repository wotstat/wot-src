   ...
   public class BattleRibbonsForm extends FeedbackBaseForm
   {
      ...
      override public function updateNewCounters(param1:Vector.<CountersVo>) : void
      {
         ...
         for each(_loc6_ in param1)
         {
            ...
            if(Boolean(_loc5_))
            {
               ...
               if(Boolean(_loc3_) && _loc6_.count != CounterBase.DEFAULT_EMPTY_VALUE)
               {
      ...
      override public function updateContent(param1:Object) : void
      {
         ...
         for(_loc4_ in this._itemsMap)
         {
            ...
            _loc2_ = Boolean(_loc3_.selected);
      ...
      override protected function onCheckBoxSelected(param1:CheckBox) : void
      {
         ...
         else if(this._countSelectedItems == 0 && param1 == this.controlsContainer.battleEventsShowInBattleCheckbox && Boolean(param1.selected))
         {
      ...
      {
         var _loc2_:String = null;
         var _loc1_:Boolean = Boolean(this.controlsContainer.battleEventsShowInBattleCheckbox.selected) && this.controlsContainer.battleEventsShowInBattleCheckbox.enabled;
         for(_loc2_ in this._itemsMap)
         {
