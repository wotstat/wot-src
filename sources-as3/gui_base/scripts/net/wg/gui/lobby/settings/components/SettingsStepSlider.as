   ...
   public class SettingsStepSlider extends StepSlider
   {
      ...
      override protected function checkIsItemDisabled(param1:Object) : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc2_ = Boolean(param1[ADVANCED_STR]);
            }
         }
         else
         {
      ...
      {
         if(Boolean(valueLabelControl) && Boolean(!this._inAdvancedMode) && name == SettingsConfigHelper.SHADOWS_QUALITY + SettingsConfigHelper.TYPE_STEP_SLIDER)
         {
