package net.wg.gui.lobby.settings.config
{
   ...
   public class SettingsConfigHelper implements IDisposable
   {
      ...
      private var _settingsData:SettingsDataVo = new SettingConfigDataVo();
      
      private var _changesData:SettingsChangesMap = new SettingsChangesMap();
      
      private var _settingsDataWithChanges:Dictionary = new Dictionary();
      
      private var _markerTabsDataProvider:DataProvider = new DataProvider([new MarkerTabsDataVo({
      ...
      private var _cursorTabsDataProvider:DataProvider = new DataProvider([new CursorTabsDataVo({
      ...
      private var _graphicSettingsTabsDataProvider:DataProvider = new DataProvider([new TabsDataVo({
      ...
      private var _liveUpdateVideoSettingsOrderData:Vector.<String> = Vector.<String>([MONITOR,SCREEN_MODE,WINDOW_SIZE,RESOLUTION,BORDERLESS_SIZE,SIZES,REFRESH_RATE,DYNAMIC_RENDERER,INTERFACE_SCALE]);
      ...
      private var _liveUpdateColorFilterData:ColorFilerSettingsVo = new ColorFilerSettingsVo();
      
      private var _tabsDataProvider:Array = [new TabsDataVo({
      ...
      private static function getControlInLayer(param1:SettingsDataVo, param2:String) : Object
      {
         ...
         var _loc4_:int = int(param1.keys.length);
      ...
      {
         var _loc2_:int = int(SIZES_ORDER_ID.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
