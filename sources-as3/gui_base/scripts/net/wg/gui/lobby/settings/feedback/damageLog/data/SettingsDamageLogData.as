package net.wg.gui.lobby.settings.feedback.damageLog.data
{
   ...
   public class SettingsDamageLogData
   {
      ...
      {
         return new <MessageRenderModel>[getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_TOTAL_VALUE4,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_DAMAGE_ENEMY_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,E100,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING,DAMAGE_LOG_SHELL_BG_TYPES.DEFAULT),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_TOTAL_VALUE3,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_IMMOBILIZED_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,E100,Values.EMPTY_STR,DAMAGE_LOG_SHELL_BG_TYPES.EMPTY),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_TOTAL_VALUE2,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_COORDINATE_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,T34,Values.EMPTY_STR,DAMAGE_LOG_SHELL_BG_TYPES.EMPTY),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_TOTAL_VALUE1,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_REFLECT_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,T34,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING,DAMAGE_LOG_SHELL_BG_TYPES.DEFAULT)];
      }
      ...
      {
         return new <MessageRenderModel>[getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_NEGATIVE_VALUE4,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_CRITICAL_ENEMY_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,IS7,INGAME_GUI.DAMAGELOG_SHELLTYPE_HIGH_EXPLOSIVE,DAMAGE_LOG_SHELL_BG_TYPES.DEFAULT),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_NEGATIVE_VALUE3,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_CRITICAL_ENEMY_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,E100,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING,DAMAGE_LOG_SHELL_BG_TYPES.DEFAULT),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_NEGATIVE_VALUE2,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_REFLECT_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,T34,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING,DAMAGE_LOG_SHELL_BG_TYPES.DEFAULT),getItemData(SETTINGS.FEEDBACK_TAB_DAMAGELOGPANEL_NEGATIVE_VALUE1,BATTLEDAMAGELOG_IMAGES.DAMAGELOG_DAMAGE_ENEMY_16X16,BATTLEDAMAGELOG_IMAGES.WHITE_ICON_HEAVYTANK_16X16,IS7,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_CR
         ,DAMAGE_LOG_SHELL_BG_TYPES.GOLD)];
      }
