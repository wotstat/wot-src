      ...
      public function SettingsKeyProp(param1:String = null, param2:Boolean = false, param3:String = null, param4:String = null, param5:Number = NaN, param6:Number = NaN, param7:Array = null, param8:Boolean = false, param9:Number = 0, param10:String = "")
      {
         ...
         if(Boolean(param7))
         {
            ...
            if(Boolean(_loc12_))
            {
               ...
               {
                  _loc15_ = _loc13_.makeString(Boolean(param7[_loc14_].hasOwnProperty(HEADER_STR)) && param7[_loc14_][HEADER_STR] != undefined ? param7[_loc14_][HEADER_STR] : Values.EMPTY_STR);
                  _loc16_ = _loc13_.makeString(Boolean(param7[_loc14_].hasOwnProperty(LABEL_STR)) && param7[_loc14_][LABEL_STR] != undefined ? param7[_loc14_][LABEL_STR] : Values.EMPTY_STR);
