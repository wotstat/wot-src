package net.wg.gui.lobby.settings
{
   ...
   public class SettingsNewCountersForm extends UIComponentEx
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._settingsTabsNewCounters))
         {
      ...
      {
         super.draw();
         if(this._isButtonBarReady && Boolean(isInvalid(INVALIDATE_BUTTON_BAR)))
         {
            invalidate(INVALIDATE_TABS_NEW_COUNTERS);
         }
         if(Boolean(this._isButtonBarReady) && Boolean(this._settingsTabsNewCounters) && Boolean(isInvalid(INVALIDATE_TABS_NEW_COUNTERS)))
         {
            this.updateNewCountersForTabs();
         }
         if(Boolean(this._settingsTabsNewCounters) && Boolean(isInvalid(INV_NEW_COUNTERS)))
         {
      ...
      protected function isCounterCanMarkAsVisited(param1:String, param2:CountersVo) : Boolean
      {
         ...
         if(Boolean(_loc3_) && LINE_COUNTER_TYPES.indexOf(_loc3_.type) != Values.DEFAULT_INT)
         {
            return true;
         }
         return false;
      ...
      protected function addNewCounterControl(param1:DisplayObject, param2:String, param3:ICounterProps, param4:Boolean) : void
      {
         ...
         var _loc6_:int = int(this._counterManager.setCounter(param1,param2,_loc5_,param3));
         if(param4)
         {
      ...
      private function onIndexChangeHandler(param1:IndexEvent) : void
      {
         ...
         var _loc2_:int = int(param1.lastIndex);
