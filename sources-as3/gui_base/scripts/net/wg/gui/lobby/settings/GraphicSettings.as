package net.wg.gui.lobby.settings
{
   ...
   public class GraphicSettings extends GraphicSettingsBase
   {
      ...
      private var _extendAdvancedControlsIds:Vector.<String> = Vector.<String>([SettingsConfigHelper.COLOR_GRADING_TECHNIQUE]);
      ...
      private var _settingsConfigHelper:SettingsConfigHelper = SettingsConfigHelper.instance;
      ...
      override public function updateDependentData() : void
      {
         ...
         if(this._isInited && Boolean(this._settingsConfigHelper.liveUpdateVideoSettingsData))
         {
            this.initMonitors();
      ...
      override protected function updateDependedControl(param1:String) : void
      {
         ...
         if(param1 == SettingsConfigHelper.TERRAIN_TESSELLATION_ENABLED)
         {
            ...
            _loc7_.selected = Boolean(_loc7_.selected) && _loc2_;
            _loc4_.selected = Boolean(_loc4_.selected) && _loc2_;
      ...
      public function tryFindPreset() : Number
      {
         ...
         if(this._allowCheckPreset)
         {
            ...
            while(_loc6_ < _loc2_)
            {
               ...
               if(Boolean(_loc8_[SUPPORTED_STR]))
               {
                  for(_loc5_ in _loc8_.settings)
                  {
                     _loc9_ = Number(_loc8_.settings[_loc5_]);
      ...
      private function setControlsData(param1:SettingsDataVo) : void
      {
         ...
         for(; _loc8_ < _loc5_; _loc8_++)
         {
            ...
            if(Boolean(_loc4_[_loc8_].type) && this[_loc6_ + _loc4_[_loc8_].type] != undefined)
            {
      ...
      private function updateRefreshRate(param1:Boolean = false) : void
      {
         ...
         var _loc3_:SettingsControlProp = SettingsControlProp(data[_loc2_]);
         var _loc4_:DropdownMenu = this[_loc2_ + _loc3_.type];
         if(Boolean(this._settingsConfigHelper.liveUpdateVideoSettingsData[_loc2_]) && param1)
         {
         ...
         this.updateDropDownEnabled(_loc2_);
         var _loc6_:int = int(_loc4_.dataProvider.indexOf(_loc5_));
         if(_loc6_ == -1)
         {
      ...
      private function updateInterfaceScale() : void
      {
         ...
         {
            _loc8_ = _loc3_.selectedIndex < _loc7_.length ? _loc3_.selectedIndex : int(_loc7_.length - 1);
         }
      ...
      private function setPresets() : void
      {
         ...
         for(_loc10_ in _loc8_)
         {
            ...
            if(Boolean(_loc9_.supported))
            {
               _loc6_ = int(_loc9_.index);
               _loc5_ = _loc9_.key;
               _loc7_ = {
      ...
      private function setRenderPipeline() : void
      {
         ...
         if(Boolean(data[_loc1_]) && this[_loc1_ + data[_loc1_].type] != undefined)
         {
      ...
      private function getDPItemIndex(param1:IDataProvider, param2:Object, param3:String = "data") : int
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            {
               _loc4_ = int(param1.indexOf(_loc5_));
               break;
            }
         }
         return _loc4_;
      ...
      private function updateQualityControls() : void
      {
         ...
         for(_loc1_ in this._graphicsQualityDataProv)
         {
            if(_loc1_ != SettingsConfigHelper.RENDER_PIPELINE)
            {
               if(Boolean(this[_loc1_ + SettingsControlProp(this._graphicsQualityDataProv[_loc1_]).type]))
               {
                  _loc2_ = SettingsControlProp(this._graphicsQualityDataProv[_loc1_]);
      ...
      private function updateAdvancedQualityControl(param1:String, param2:SettingsControlProp) : void
      {
         ...
         switch(param2.type)
         {
            case SettingsConfigHelper.TYPE_CHECKBOX:
               ...
               _loc11_ = Boolean(param2.changedVal);
            ...
            case SettingsConfigHelper.TYPE_STEP_SLIDER:
               ...
               _loc7_ = Number(_loc9_[_loc12_.value].data);
            ...
            case SettingsConfigHelper.TYPE_DROPDOWN:
               ...
               _loc13_.selectedIndex = _loc4_ != -1 ? int(_loc4_) : 0;
               _loc7_ = Number(_loc9_[_loc13_.selectedIndex].data);
      ...
      private function updateExtendedAdvancedControlsData() : void
      {
         ...
         if(Boolean(this._extendAdvancedControls))
         {
      ...
      private function updateLiveVideoData() : void
      {
         ...
         for(; _loc10_ < _loc6_; _loc10_++)
         {
            _loc8_ = _loc4_[_loc10_];
            _loc9_ = SettingsControlProp(data[_loc8_]);
            if(!(Boolean(_loc9_) && Boolean(this[_loc8_ + _loc9_.type])))
            {
               continue;
            }
            switch(_loc9_.type)
            {
               ...
               case SettingsConfigHelper.TYPE_DROPDOWN:
                  ...
                  if(_loc8_ == SettingsConfigHelper.SIZES)
                  {
                     ...
                     if(Boolean(_loc13_) && _loc13_.options is Array)
                     {
      ...
      private function updateSliderLabel(param1:String, param2:Boolean, param3:String) : void
      {
         ...
         var _loc5_:String = null;
         if(param2 && Boolean(this[param1 + SettingsConfigHelper.TYPE_VALUE]))
         {
      ...
      private function onGraphicsQualityIndexChangeHandler(param1:ListEvent) : void
      {
         ...
         if(Boolean(_loc5_) && this[_loc4_ + _loc5_.type] != undefined)
         {
            _loc6_ = SettingsControlProp(_loc5_);
            _loc7_ = this[_loc4_ + _loc6_.type];
            _loc8_ = Number(_loc7_.selectedItem[DATA_STR]);
            _loc9_ = Number(_loc2_.settings[SettingsConfigHelper.RENDER_PIPELINE]);
            if(_loc8_ != _loc9_)
            {
               ...
               if(_loc10_ != -1)
               {
                  ...
                  _loc12_ = _loc11_.hasOwnProperty(SUPPORTED_STR) ? Boolean(_loc11_[SUPPORTED_STR]) : true;
                  if(_loc12_)
                  {
      ...
      {
         var _loc2_:Number = Number(param1.index);
         ...
         var _loc6_:Number = Number(_loc5_.options[_loc2_].data);
      ...
      private function onDropDownIndexChangeHandler(param1:ListEvent) : void
      {
         ...
         var _loc5_:Number = _loc4_.isDataAsSelectedIndex && Boolean(_loc4_.options[param1.index].hasOwnProperty(DATA_STR)) ? Number(_loc4_.options[param1.index].data) : Number(param1.index);
      ...
      private function onSliderOrderedValueChangeHandler(param1:SliderEvent) : void
      {
         ...
         var _loc5_:Number = Number(_loc4_.options[_loc2_.value].data);
         _loc4_.prevVal = _loc4_.changedVal;
         _loc4_.changedVal = _loc5_;
         if(Boolean(_loc4_.isDependOn))
         {
