   ...
   public class SettingsWindow extends SettingsWindowMeta implements ISettingsWindowMeta
   {
      ...
      public function as_isPresetApplied() : Boolean
      {
         ...
         if(Boolean(_loc1_))
         {
            ...
            _loc3_ = Number(_loc2_.dataProvider.requestItemAt(_loc2_.selectedIndex)[FIELD_DATA]);
      ...
      {
         var _loc2_:uint = 0;
         if(Boolean(this.tabs.dataProvider))
         {
            _loc2_ = uint(this.tabs.dataProvider.length);
         ...
         if(Boolean(initialized) && param1 != -1)
         {
      ...
      private function updateTabsCounters() : void
      {
         ...
         var _loc2_:Number = Number(this.tabs.dataProvider.length);
            ...
            for each(_loc1_ in this._countersData)
            {
               if(_loc1_.tabId == _loc4_.linkage)
               {
                  ...
                  if(Boolean(_loc5_))
                  {
                     ...
                     {
                        _loc7_ = int(_loc6_[_loc12_].counters.length);
                        _loc14_ = 0;
      ...
      {
         var _loc2_:Boolean = false;
         if(this._invalidTabs.hasOwnProperty(param1) && Boolean(this._invalidTabs[param1]))
         {
            _loc2_ = true;
         }
         return _loc2_;
      ...
      {
         return this._invalidTabsNewCounterData.hasOwnProperty(param1) && Boolean(this._invalidTabsNewCounterData[param1]);
      }
      ...
      private function normalize(param1:SettingsDataVo) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            if(Boolean(_loc4_[_loc6_]))
            {
               this.normalizeInside(SettingsDataVo(_loc4_[_loc6_]),_loc2_[_loc3_[_loc6_]]);
            }
            _loc6_++;
         }
         if(Boolean(_loc2_[SettingsConfigHelper.SOUND_SETTINGS][SettingsConfigHelper.PTT]) && Boolean(_loc2_[SettingsConfigHelper.CONTROLS_SETTINGS][SettingsConfigHelper.KEYBOARD].getByKey(SettingsConfigHelper.PUSH_TO_TALK)))
         {
      ...
      private function normalizeInside(param1:SettingsDataVo, param2:SettingsDataVo) : void
      {
         var _loc6_:int = 0;
         var _loc9_:int = 0;
         var _loc3_:int = int(param1.keys.length);
            ...
            else if(param3 is Object && param3.current != undefined)
            {
               if(_loc5_.type == SettingsConfigHelper.TYPE_CHECKBOX)
               {
                  ...
                  if(param3.hasOwnProperty(SettingsControlProp.OPTIONS_LBL))
                  {
                     ...
                     {
                        if(Boolean(param3.options[_loc6_].hasOwnProperty(SettingsControlProp.ADVANCED_LBL)) && param3.options[_loc6_].advanced == true)
                        {
      ...
      private function normalizeKeys(param1:Object, param2:SettingsDataVo, param3:Vector.<String>) : void
      {
         ...
         while(_loc18_ < _loc17_)
         {
            ...
            while(_loc19_ < _loc8_)
            {
               ...
               {
                  _loc13_ = Number(_loc12_[FIELD_CURRENT]);
                  _loc14_ = Number(_loc12_[FIELD_DEF]);
                  param3.push(_loc9_);
      ...
      private function markVisitedCounterItems(param1:int) : void
      {
         ...
         if(Boolean(this.view) && Boolean(_loc3_))
         {
            ...
            if(Boolean(_loc4_))
            {
               ...
               if(Boolean(_loc5_.length))
               {
                  ...
                  {
                     if(Boolean(_loc6_.ids) && Boolean(_loc6_.ids.length))
                     {
      ...
      private function onOnControlChangedHandler(param1:SettingViewEvent) : void
      {
         ...
         if(Boolean(this._graphicSettings))
         {
            this._graphicSettings.onSettingsChanged();
         }
         if(_loc4_ == SettingsConfigHelper.MINIMAP_ALPHA_ENABLED && Boolean(_loc5_))
         {
