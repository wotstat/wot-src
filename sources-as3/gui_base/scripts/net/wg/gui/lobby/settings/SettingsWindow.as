package net.wg.gui.lobby.settings
{
   ...
   public class SettingsWindow extends SettingsWindowMeta implements ISettingsWindowMeta
   {
               ...
               if(_loc1_.tabId == _loc4_.linkage)
               {
                  ...
                  if(Boolean(_loc5_))
                  {
                     ...
                     while(_loc12_ < _loc8_)
                     {
                        ...
                        _loc7_ = int(_loc14_.counters.length);
                        _loc15_ = 0;
            ...
            else if(param3 is Object && param3.current != undefined)
            {
               if(_loc5_.type == SettingsConfigHelper.TYPE_CHECKBOX)
               {
                  ...
                  if(param3.hasOwnProperty(SettingsControlProp.OPTIONS_LBL))
                  {
                     ...
                     {
                        if(Boolean(param3.options[_loc6_].hasOwnProperty(SettingsControlProp.ADVANCED_LBL)) && Boolean(param3.options[_loc6_].advanced))
                        {
      ...
      private function markVisitedCounterItems() : void
      {
         ...
         if(Boolean(this.view) && Boolean(_loc2_))
         {
            ...
            if(Boolean(_loc3_))
            {
               ...
               if(Boolean(_loc4_.length))
               {
                  for each(_loc5_ in _loc4_)
                  {
                     if(Boolean(_loc5_.ids) && Boolean(_loc5_.ids.length))
                     {
