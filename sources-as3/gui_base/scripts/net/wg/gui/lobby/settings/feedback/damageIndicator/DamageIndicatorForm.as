package net.wg.gui.lobby.settings.feedback.damageIndicator
{
   ...
   public class DamageIndicatorForm extends FeedbackBaseForm
   {
      ...
      private var _standardSettings:Vector.<DamageIndicatorStandardSetting> = new <DamageIndicatorStandardSetting>[new DamageIndicatorStandardSetting(0,DAMAGEINDICATOR.DAMAGE_STANDARD,DAMAGEINDICATOR.DAMAGE_STANDARD_BLIND,270,400,-0.25),new DamageIndicatorStandardSetting(1,DAMAGEINDICATOR.BLOCKED_STANDARD,DAMAGEINDICATOR.BLOCKED_STANDARD,140,400,0.43)];
      
      private var _extendedSettings:Vector.<DamageIndicatorExtendedSetting> = new <DamageIndicatorExtendedSetting>[new DamageIndicatorExtendedSetting(0,DAMAGEINDICATOR.CRIT,DAMAGEINDICATOR.CRIT_BLIND,DAMAGEINDICATOR.TRACKS_CIRCLE,DAMAGEINDICATOR.TRACKS_CIRCLE,T57_58,DAMAGEINDICATOR.HEAVY_TANK,Values.EMPTY_STR,220,280,-0.43,DamageIndicatorExtendedSetting.CRIT),new DamageIndicatorExtendedSetting(1,DAMAGEINDICATOR.BLOCKED_SMALL,DAMAGEINDICATOR.BLOCKED_SMALL,DAMAGEINDICATOR.BLOCK_CIRCLE,DAMAGEINDICATOR.BLOCK_CIRCLE,M103,DAMAGEINDICATOR.HEAVY_TANK,"400",245,245,-0.18,DamageIndicatorExtendedSetting.BLOCKED),new DamageIndicatorExtendedSetting(2,DAMAGEINDICATOR.BLOCKED_SMALL,DAMAGEINDICATOR.BLOCKED_SMALL,DAMAGEINDICATOR.BLOCK_CIRCLE,DAMAGEINDICATOR.BLOCK_CIRCLE,T110E5,DAMAGEINDICATOR.ALLY_HEAVY_TANK,App.utils.locale.makeString(INGAME_GUI.DAMAGEINDICATOR_FRIENDLYFIRE_NODAMAGELABEL),270,245,0.18,DamageIndicatorExtendedSetting.ALLY),new DamageIndicatorExtendedSetting(3,DAMAGEINDICATOR.DAMAGE_SMALL,DAMAGEINDICATOR
      .DAMAGE_SMALL_BLIND,DAMAGEINDICATOR.DAMAGE_CIRCLE,DAMAGEINDICATOR.DAMAGE_CIRCLE_BLIND,T34,DAMAGEINDICATOR.HEAVY_TANK,"400",295,280,0.43,DamageIndicatorExtendedSetting.DAMAGE)];
      ...
      override public function updateContent(param1:Object) : void
      {
         ...
         var _loc5_:Boolean = Boolean(param1[WITH_TANK_INFO_CONTROL_ID]);
         var _loc6_:Boolean = Boolean(param1[WITH_VALUE_CONTROL_ID]);
         _loc2_ &&= !getControlPropsByKey(DAMAGE_INDICATOR_TYPE_CONTROL_ID).readOnly;
