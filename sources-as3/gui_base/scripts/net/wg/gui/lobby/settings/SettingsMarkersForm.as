package net.wg.gui.lobby.settings
{
   ...
   public class SettingsMarkersForm extends SettingsNewCountersForm
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._data) && Boolean(this._data.keys))
         {
            ...
            for(; _loc4_ < _loc2_; _loc4_++)
            {
               ...
               if(!Boolean(this[_loc1_ + _loc3_.type]))
               {
                  continue;
               }
               switch(_loc3_.type)
         ...
         if(Boolean(this.markerBaseAimMarker2DCheckbox))
         {
            this.markerBaseAimMarker2DCheckbox.dispose();
            this.markerBaseAimMarker2DCheckbox = null;
         }
         if(Boolean(this.markerAltAimMarker2DCheckbox))
         {
