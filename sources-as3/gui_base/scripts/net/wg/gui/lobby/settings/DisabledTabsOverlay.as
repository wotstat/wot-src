package net.wg.gui.lobby.settings
{
   ...
   public class DisabledTabsOverlay extends UIComponentEx
   {
      ...
      private var _mainTabCovers:Vector.<Sprite> = new Vector.<Sprite>(0);
      
      private var _secondaryTabCovers:Vector.<Sprite> = new Vector.<Sprite>(0);
      ...
      private static function drawTabs(param1:ButtonBarEx, param2:Vector.<int>, param3:Vector.<Sprite>) : void
      {
         ...
         var _loc8_:uint = uint(param1.dataProvider.length);
         var _loc9_:uint = 0;
         while(_loc9_ < _loc8_)
         {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._currentView != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
