package net.wg.gui.lobby.settings
{
   ...
   public class AimSettings extends AimSettingsBase
   {
      ...
      private var _cursorTabsDataProvider:IDataProvider = SettingsConfigHelper.instance.cursorTabsDataProvider;
      ...
      {
         var _loc8_:int = 0;
         var _loc2_:int = int(this._cursorTabsDataProvider.length);
      ...
      {
         var _loc3_:Array = [];
         if(Boolean(StringUtils.isEmpty(param1)) || this._aimData == null)
         {
            return _loc3_;
         }
      ...
      override protected function isCounterCanMarkAsVisited(param1:String, param2:CountersVo) : Boolean
      {
         ...
         if(Boolean(_loc4_) && LINE_COUNTER_TYPES.indexOf(_loc4_.type) != Values.DEFAULT_INT)
         {
            return true;
         }
      ...
      {
         var _loc1_:uint = uint(this._cursorTabsDataProvider.length);
      ...
      private function updateCrosshairs(param1:Number) : void
      {
         ...
         var _loc4_:Number = Boolean(_loc3_[CENTRAL_TAG_TYPE_STR]) ? Number(_loc3_[CENTRAL_TAG_TYPE_STR]) : DEFAULT_TYPE;
         var _loc5_:Number = Boolean(_loc3_[CENTRAL_TAG_STR]) ? _loc3_[CENTRAL_TAG_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc6_:Number = Boolean(_loc3_[NET_TYPE_STR]) ? Number(_loc3_[NET_TYPE_STR]) : DEFAULT_TYPE;
         var _loc7_:Number = Boolean(_loc3_[NET_STR]) ? _loc3_[NET_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc8_:Number = Boolean(_loc3_[RELOADER_STR]) ? _loc3_[RELOADER_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc9_:Number = Boolean(_loc3_[CONDITION_STR]) ? _loc3_[CONDITION_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc10_:Number = Boolean(_loc3_[RELOADER_TIMER_STR]) ? _loc3_[RELOADER_TIMER_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc11_:Number = Boolean(_loc3_[CASSETTE_STR]) ? _loc3_[CASSETTE_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc12_:Boolean = Boolean(_loc3_[ZOOM_INDICATOR_STR]);
         var _loc13_:Number = _loc12_ ? _loc3_[ZOOM_INDICATOR_STR] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc14_:Number = Boolean(_loc3_[MIXING]) ? _loc3_[MIXING] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc15_:Number = Boolean(_loc3_[GUN_TAG]) ? _loc3_[GUN_TAG] / PRC_DIVIDER : DEFAULT_ALPHA;
         var _loc16_:Number = Number(_loc3_[MIXING_TYPE]);
         var _loc17_:Number = Number(_loc3_[GUN_TAG_TYPE]);
         ...
         artyShotIndicatorsPanel.visible = artyShotNotify.visible = param1 == ARTY_TAB_INDEX && Boolean(_loc3_[SHOTS_RESULT_INDICATOR_STR]);
         artyZoomPanel.visible = param1 == ARTY_TAB_INDEX && Boolean(_loc3_[SPG_SCALE_WIDGET_STR]);
      ...
      {
         var _loc2_:Boolean = Boolean(this._colorSchemeMgr.getIsColorBlindS());
