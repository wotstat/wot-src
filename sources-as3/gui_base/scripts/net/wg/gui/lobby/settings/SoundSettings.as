package net.wg.gui.lobby.settings
{
   ...
   public class SoundSettings extends SoundSettingsBase implements IPopOverCaller
   {
      ...
      private function controlsUnsubscribe() : void
      {
         ...
         var _loc5_:int = 0;
         if(Boolean(data) && Boolean(data.keys))
         {
            _loc3_ = int(data.keys.length);
            _loc5_ = 0;
            while(_loc5_ < _loc3_)
            {
      ...
      private function prepareCheckbox(param1:CheckBox, param2:String, param3:Boolean, param4:SettingsControlProp) : void
      {
         ...
         {
            param1.enabled = param3 && Boolean(SettingsControlProp(data[SettingsConfigHelper.VOICE_CHAT_SUPPORTED]).current);
         }
         ...
         else if(param2 == SettingsConfigHelper.SOUND_QUALITY)
         {
            ...
            _loc5_ = Boolean(param1.selected) && param1.visible;
            ...
            if(param1.visible)
            {
               param1.enabled = param3 && Boolean(SettingsControlProp(data[SettingsConfigHelper.MASTER_VOLUME_TOGGLE]).current);
            }
         }
         else
         {
      ...
      private function updateMasterVolumeEnabled() : void
      {
         ...
         bulbVoicesButton.enabled = this._masterVolumeSelected && Boolean(this._existsBulbVoices[bulbVoicesDropDown.selectedIndex]);
         commonForm.bulbIcon.enabled = this._masterVolumeSelected;
         artyBulbVoicesIcon.alpha = this._masterVolumeSelected ? ENABLE_ALPHA : DISABLE_ALPHA;
         ...
         artyBulbVoicesButton.enabled = this._masterVolumeSelected && Boolean(this._existsArtyBulbVoices[artyBulbVoicesDropDown.selectedIndex]);
      ...
      {
         this.breakSoundCheck();
         var _loc1_:Boolean = Boolean(enableVoIPCheckbox.selected) && Boolean(SettingsControlProp(data[SettingsConfigHelper.VOICE_CHAT_SUPPORTED]).current);
      ...
      {
         if(Boolean(param1) && Boolean(param1.hasOwnProperty(SettingsConfigHelper.SOUND_SPEAKERS_TOOLTIP_FIELD)) && param1.hasOwnProperty(SettingsConfigHelper.SOUND_SPEAKERS_ID_FIELD))
         {
      ...
      private function onCheckboxSelectHandler(param1:Event) : void
      {
         ...
         {
            _loc2_.toolTip = Boolean(_loc2_.selected) && _loc2_.visible ? TOOLTIPS.SOUNDQUALITYON : Values.EMPTY_STR;
            _loc2_.infoIcoType = Boolean(_loc2_.selected) && _loc2_.visible ? InfoIcon.TYPE_WARNING : Values.EMPTY_STR;
         }
      ...
      private function onSliderValueChangeHandler(param1:SliderEvent) : void
      {
         ...
         if(Boolean(_loc5_) && _loc4_.hasValue)
         {
      ...
      private function onDropdownIndexChangeHandler(param1:ListEvent) : void
      {
         ...
         if(_loc3_ == SettingsConfigHelper.SOUND_SPEAKERS)
         {
            ...
            _loc6_ = Boolean(_loc5_[SettingsConfigHelper.SOUND_SPEAKERS_IS_AUTODETECT_FIELD]);
            if(_loc6_)
            {
