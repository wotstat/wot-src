package net.wg.gui.lobby.settings.components
{
   ...
   public class KeysItemRenderer extends ListItemRenderer
   {
      ...
      {
         data = null;
         if(Boolean(this.keyInput) && Boolean(this.keyInput.hasEventListener(KeyInputEvents.CHANGE)))
         {
      ...
      private function keyCodeWasUsed(param1:Number) : Array
      {
         ...
         if(Boolean(this._codependentID))
         {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               if(this.keyInput.keyCode == _loc2_[_loc6_].key && (this._codependentID == null || !(Boolean(this._codependentID) && this._codependentID == _loc2_[_loc6_].id && _loc2_[_loc6_].keysRang.indexOf(_loc4_) > -1)))
               {
      ...
      private function setText() : void
      {
         ...
         {
            _loc1_ = Boolean(data.additionalDiscr) ? 10 : 0;
            _loc2_ = this.bg.height - textField.height;
            _loc3_ = Number(textField.height);
      ...
      private function onKeyChangeHandler(param1:KeyInputEvents) : void
      {
         ...
         if(Boolean(data) && Boolean(data.hasOwnProperty(KEY_STR)))
         {
