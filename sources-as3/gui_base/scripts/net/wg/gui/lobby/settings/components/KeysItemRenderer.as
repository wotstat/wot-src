   ...
   public class KeysItemRenderer extends ListItemRenderer
   {
      ...
      private function keyCodeWasUsed(param1:Number) : Array
      {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               if(this.keyInput.keyCode == _loc8_.key && (this._codependentID == null || !(Boolean(this._codependentID) && this._codependentID == _loc8_.id && _loc8_.keysRang.indexOf(_loc4_) > -1)))
               {
                  _loc5_.push(_loc8_);
               }
            }
