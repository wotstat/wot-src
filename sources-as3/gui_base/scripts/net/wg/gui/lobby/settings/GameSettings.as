package net.wg.gui.lobby.settings
{
   ...
   public class GameSettings extends SettingsBaseView
   {
            ...
            if(Boolean(_loc7_[_loc8_]))
            {
               ...
               switch(_loc6_.type)
               {
                  ...
                  case SettingsConfigHelper.TYPE_SLIDER:
                     ...
                     if(_loc6_.hasValue && Boolean(_loc7_[_loc5_ + SettingsConfigHelper.TYPE_VALUE]))
                     {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._limitedUISettingBlock))
         {
      ...
      override protected function updateNewCounter(param1:CountersVo) : Boolean
      {
         ...
         if(Boolean(this._limitedUISettingBlock) && param1.componentId == GAME_COUNTER_LIMITED_UI_CONTROL)
         {
      ...
      {
         if(Boolean(this._limitedUISettingBlock) && param2.componentId == GAME_COUNTER_LIMITED_UI_CONTROL)
         {
            return true;
         }
      ...
      private function onSliderValueChangeHandler(param1:SliderEvent) : void
      {
         ...
         if(_loc4_.hasValue && Boolean(_loc5_[_loc6_]))
         {
      ...
      {
         if(Boolean(this._restartNewbieBattleHints))
         {
