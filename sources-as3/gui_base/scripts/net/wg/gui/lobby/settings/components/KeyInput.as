package net.wg.gui.lobby.settings.components
{
   ...
   public class KeyInput extends SoundButton
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._keys) && Boolean(isInvalid(INVALID_KEYS)))
         {
      ...
      {
         var _loc1_:int = int(this._keys.length);
         var _loc2_:uint = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override public function handleInput(param1:InputEvent) : void
      {
         ...
         if(selected)
         {
            ...
            if(_loc2_.value == InputValue.KEY_DOWN && Boolean(selected))
            {
      ...
      private function onStageMouseDownHandler(param1:MouseEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc2_ = int(_loc4_.mouseIdx);
            _loc3_ = int(_loc4_.buttonIdx);
         }
