package net.wg.gui.popover
{
   ...
   public class AcousticPopover extends AcousticPopoverMeta implements IAcousticPopoverMeta
   {
      ...
      private function releaseAcousticItems() : void
      {
         ...
         if(Boolean(this._acoustics))
         {
            _loc1_ = null;
            while(Boolean(this._acoustics.length))
            {
      ...
      override protected function onItemSelect(param1:Array) : void
      {
         ...
         var _loc2_:int = int(this._lastSelectedItems.length);
         var _loc3_:int = 0;
         ...
         while(_loc3_ < _loc2_)
         {
            if(Boolean(this._acousticsById) && this._acousticsById.hasOwnProperty(param1[_loc3_]))
            {
      ...
      override protected function onItemPlay(param1:Array) : void
      {
         ...
         var _loc2_:int = int(this._lastAnimatedItems.length);
         var _loc3_:int = 0;
         var _loc4_:Boolean = !(param1 && param1.length > 0);
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
      ...
      public function as_setEnable(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = 0;
            _loc3_ = int(this._acoustics.length);
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
