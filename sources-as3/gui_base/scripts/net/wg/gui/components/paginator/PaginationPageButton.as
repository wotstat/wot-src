package net.wg.gui.components.paginator
{
   ...
   public class PaginationPageButton extends SoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(this._isMinimize && Boolean(isInvalid(InvalidationType.STATE)))
         {
         ...
         if(this._isMinimize && Boolean(isInvalid(INVALID_IMAGE)))
         {
            this.navImg.source = this._imageSource;
         }
         if(this._isMinimize && Boolean(isInvalid(InvalidationType.SIZE)))
         {
