   ...
   public class PaginatorArrowsController extends EventDispatcher implements IPaginatorArrowsController
   {
      ...
      protected function updatePageBtns() : void
      {
         ...
         if(this._hasPagesBtns)
         {
            ...
            this._nextPageBtn.width = _loc1_ ? NAV_BUTTON_MIN_WIDTH : NAV_BUTTON_WIDTH;
            if(!_loc1_)
            {
               _loc2_ = this._pageButtons.getProviderRealLength() - (this._currentPageIndex + 1) * this._maxElementsPerPage;
               _loc2_ = _loc2_ > this._maxElementsPerPage ? uint(this._maxElementsPerPage) : _loc2_;
            ...
            this._prevPageBtn.width = _loc1_ ? NAV_BUTTON_MIN_WIDTH : NAV_BUTTON_WIDTH;
            if(!_loc1_)
            {
      ...
      private function layoutPageBtns() : void
      {
         ...
         if(this._hasPagesBtns)
         {
            if(this._isCenterPages && Boolean(this._paginatorPos))
            {
               _loc1_ = this._prevPageBtn.visible ? int(-(this._prevPageBtn.width + PAGE_BUTTON_RIGHT_X_SHIFT)) : 0;
      ...
      private function onPageUpdate() : void
      {
         ...
         {
            _loc2_ = int(this._buttonGroup.length);
            _loc3_ = 0;
            while(_loc3_ != _loc2_)
            {
      ...
      private function updateControlsStates() : void
      {
         ...
         if(this._hideDisabledArrows)
         {
            ...
            this._arrowLeftBtn.visible = Boolean(this._arrowLeftBtn.enabled) && _loc1_;
            this._arrowRightBtn.visible = Boolean(this._arrowRightBtn.enabled) && _loc1_;
         }
         if(this._hasPagesBtns)
         {
      ...
      {
         var _loc2_:int = 0;
         if(this._allowPageChange && Boolean(param1.enabled))
         {
      ...
      {
         if(this._allowPageChange && Boolean(this._arrowRightBtn.enabled))
         {
      ...
      {
         if(this._allowPageChange && Boolean(this._arrowLeftBtn.enabled))
         {
            this.onArrowClick(ISoundButtonEx(param1.target));
