package net.wg.gui.components.questProgress
{
   ...
   public class ItemRendererTopView extends ItemRenderer implements IQPItemRenderer
   {
      ...
      {
         if(Boolean(this._metricsCmpnt && param1) && Boolean(this._mainMetricIndex >= 0) && param1.length > this._mainMetricIndex)
         {
            this._metricsCmpnt.update(param1[this._mainMetricIndex],param2);
         }
         if(this._additionalMetricIndex != Values.DEFAULT_INT && Boolean(this._metricsAdditionalCmpnt))
         {
