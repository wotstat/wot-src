package net.wg.gui.components.questProgress
{
   ...
   public class ItemRendererTabView extends ItemRenderer
   {
      ...
      private var _startCmpntsPoint:Point = new Point(0,0);
      ...
      override public function init(param1:IQPInitData) : void
      {
         ...
         var _loc2_:Boolean = Boolean(StringUtils.isNotEmpty(param1.multiplier));
      ...
      override protected function updateMetrics(param1:Vector.<IQPMetrics>, param2:int) : void
      {
         ...
         var _loc6_:int = 0;
         if(Boolean(this._metricsCmpnts) && Boolean(param1))
         {
            _loc3_ = int(param1.length);
            _loc4_ = int(this._metricsCmpnts.length);
            if(_loc3_ < _loc4_)
            {
      ...
      override protected function updateState(param1:IQPProgressData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(Boolean(this._metricsCmpnts))
         {
      ...
      override protected function doLayout() : void
      {
         ...
         if(Boolean(!_loc1_) && Boolean(_loc4_) && _loc3_)
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.alertLabel))
         {
            this.alertLabel.dispose();
            this.alertLabel = null;
         }
         if(Boolean(this.resultMetric))
         {
