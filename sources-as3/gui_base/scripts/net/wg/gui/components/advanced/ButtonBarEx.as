package net.wg.gui.components.advanced
{
   ...
   public class ButtonBarEx extends ButtonBar implements IGroupedControl
   {
      ...
      override protected function populateRendererData(param1:Button, param2:uint) : void
      {
         ...
         if(Boolean(_loc3_))
         {
            if(Boolean(param1.hasOwnProperty(TOOLTIP_PROP_NAME)) && _loc3_.hasOwnProperty(TOOLTIP_PROP_NAME))
            {
               param1[TOOLTIP_PROP_NAME] = _loc3_.tooltip;
            }
            if(Boolean(param1.hasOwnProperty(IS_WULF_TOOLTIP_PROP_NAME)) && _loc3_.hasOwnProperty(IS_WULF_TOOLTIP_PROP_NAME))
            {
      ...
      override protected function updateRenderers() : void
      {
         ...
         tabEnabled = Boolean(_focusable) && this.enabled;
      ...
      public function disposeRenderers() : void
      {
         ...
         var _loc1_:Number = Number(_renderers.length);
         _loc2_ = _loc1_ - 1;
         while(_loc2_ >= 0)
         {
      ...
      protected function getNextEnabledBtnIndex(param1:int, param2:int) : int
      {
         ...
         var _loc3_:int = Boolean(_renderers) ? int(_renderers.length) : 0;
      ...
      [Inspectable(name="paddingHorizontal",defaultValue="10")]
