package net.wg.gui.components.advanced
{
   ...
   public class ViewStack extends UIComponentEx implements ITutorialCustomComponent
   {
      ...
      {
         var _loc1_:int = 0;
         if(this.rescaleContainer && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            _loc1_ = 5;
      ...
      private function changeView() : void
      {
         ...
         if(Boolean(this._targetGroup) && this._targetGroup.selectedItem != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               {
                  if(_loc2_ == null || Boolean(StringUtils.isEmpty(_loc2_)))
                  {
      ...
      private function setCurrentView(param1:IViewStackContent, param2:String, param3:Boolean) : void
      {
         ...
         if(Boolean(this._currentView) && Boolean(this._currentViewId))
         {
      ...
      private function clearSubView(param1:IViewStackContent) : void
      {
         ...
         if(Boolean(this._container) && this._container.contains(_loc3_))
         {
