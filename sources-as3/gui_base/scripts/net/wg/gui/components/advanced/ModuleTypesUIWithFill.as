package net.wg.gui.components.advanced
{
   ...
   public class ModuleTypesUIWithFill extends UIComponentEx
   {
      ...
      {
         super.draw();
         if(Boolean(this.moduleIcon) && Boolean(isInvalid(INV_MODULE_ICON_POS)))
         {
         ...
         if(Boolean(this._extraIcon) && Boolean(isInvalid(INV_EXTRA_ICON_POS)))
         {
