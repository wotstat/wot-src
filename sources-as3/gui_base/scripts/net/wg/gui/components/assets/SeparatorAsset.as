package net.wg.gui.components.assets
{
   ...
   public class SeparatorAsset extends Sprite implements ISeparatorAsset
   {
      ...
      public function setCenterAsset(param1:String) : void
      {
         ...
         if(_loc3_ is Sprite)
         {
            ...
            else if(this._mode == SeparatorConstants.TILE_MODE)
            {
               ...
               if(Boolean(this._centerPartBitmapData))
               {
      ...
      public function setMode(param1:String) : void
      {
         ...
         this._mode = param1;
         if(Boolean(this._currentCenterPartLnk))
         {
      ...
      {
         if(Boolean(this._leftPart))
         {
            while(Boolean(this._leftPart.numChildren))
            {
         ...
         if(Boolean(this._rightPart))
         {
            while(Boolean(this._rightPart.numChildren))
            {
      ...
      {
         if(Boolean(this._centerPart))
         {
            while(Boolean(this._centerPart.numChildren))
            {
