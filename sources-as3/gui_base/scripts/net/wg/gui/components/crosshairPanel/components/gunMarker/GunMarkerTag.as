package net.wg.gui.components.crosshairPanel.components.gunMarker
{
   ...
   public class GunMarkerTag extends SimpleContainer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(StringUtils.isNotEmpty(this._colorName)) && isInvalid(GunMarkerConsts.GUN_TAG_COLOR_VALIDATION) && GUN_MARKER_VIEW_CONSTANTS.GUN_TAG_SHOT_RESULT_TYPES.indexOf(this._gunTagType) != -1)
         {
            this.tag.gotoAndStop(this._colorName);
         }
         if(Boolean(StringUtils.isNotEmpty(this._reloadingState)) && isInvalid(GunMarkerConsts.GUN_RELOADING_STATE_VALIDATION) && GUN_MARKER_VIEW_CONSTANTS.GUN_TAG_RELOADING_TYPES.indexOf(this._gunTagType) != -1)
         {
