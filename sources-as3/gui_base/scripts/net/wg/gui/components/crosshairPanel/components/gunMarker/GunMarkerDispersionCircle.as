package net.wg.gui.components.crosshairPanel.components.gunMarker
{
   ...
   public class GunMarkerDispersionCircle extends SimpleContainer implements IGunMarkerDispersion
   {
      ...
      public function GunMarkerDispersionCircle()
      {
         ...
         if(Boolean(this.chargeableBurst))
         {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(GunMarkerConsts.GUN_MIXING_TYPE_VALIDATION))
         {
            ...
            if(this._isBurst && Boolean(this.chargeableBurst))
            {
         ...
         if(Boolean(this.currMixingMC) && Boolean(this._reloadingInPercent != -1) && isInvalid(GunMarkerConsts.GUN_RELOAD_VALIDATION))
         {
