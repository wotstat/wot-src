package net.wg.gui.components.crosshairPanel.components.gunMarker
{
   ...
   public class GunMarker extends SimpleContainer implements IGunMarker
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            this.radiusMC.alpha = this._isSecondary ? this._mixingAlpha * this.SECONDARY_ALPHA_MULTIPLAYER : this._mixingAlpha;
         }
      ...
      {
         if(Boolean(this.radiusMC))
         {
            this.radiusMC.dispose();
            this.radiusMC = null;
         }
         if(Boolean(this.gunTag))
         {
            this.gunTag.dispose();
            this.gunTag = null;
         }
