package net.wg.gui.components.battleRoyale
{
   ...
   public class VehModuleConfiguratorCmp extends VehModulesConfiguratorCmpMeta implements IVehModulesConfiguratorCmpMeta, IViewStackExContent
   {
      ...
      private var _columnSelector:Bitmap = new Bitmap();
      
      private var _data:Vector.<ConfiguratorColumnVO> = null;
      
      private var _itemsByIntCD:Dictionary = new Dictionary();
      
      private var _columnsContainers:Vector.<Sprite> = new Vector.<Sprite>(0);
      
      private var _headers:Vector.<ColumnHeader> = new Vector.<ColumnHeader>(0);
      
      private var _arrowsRenderer:Bitmap = new Bitmap();
      ...
      override protected function updateItems(param1:Vector.<ConfiguratorColumnVO>) : void
      {
         ...
         var _loc10_:int = int(Values.DEFAULT_INT);
      ...
      {
         if(Boolean(this._currentOverStateModule))
         {
      ...
      private function updateHeaderAlpha(param1:ColumnHeader, param2:ConfiguratorColumnVO) : void
      {
         ...
         {
            param1.status = param2.highlighted ? ColumnHeader.HIGHLIGHTED : ColumnHeader.ENABLED;
         }
         else
         {
