package net.wg.gui.components.tooltips
{
   ...
   public class ToolTipBase extends UIComponentEx implements IToolTip
   {
      ...
      protected var contentMargin:Padding = new Padding(12,17,12,17);
      
      protected var bgShadowMargin:Padding = new Padding(3,5,7,5);
      ...
      private const LIMIT_BUILD_TIME:Number = 500;
      ...
      {
         super.configUI();
         if(Boolean(this._data) && !this._isRedrawed)
         {
            this.redraw();
         }
      }
      ...
      final protected function beginShow() : void
      {
         this.clearDelayIntervalID();
         var _loc1_:Number = Boolean(this._props) && this._props.drawDelay != -1 ? Number(this._props.drawDelay) : this.SHOW_DELAY;
