package net.wg.gui.components.tooltips.inblocks.blocks
{
   ...
   public class AtlasIconTextBlock extends SpriteTextBlockInBlocks
   {
      ...
      {
         return Boolean(this._blockData) && this._blockData.ignoreIconSize ? titleTF.textHeight : Number(super.getHeight());
      }
      ...
      {
         super.applyData();
         if(Boolean(this._blockData.atlasName) && Boolean(this._blockData.iconName))
         {
