package net.wg.gui.components.vehicleStatus
{
   ...
   public class VehicleStatus extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data))
         {
            if(isInvalid(InvalidationType.DATA))
            {
               ...
               _loc2_ = Boolean(StringUtils.isNotEmpty(_loc1_));
               ...
               _loc4_ = Boolean(StringUtils.isNotEmpty(_loc3_));
               ...
               _loc6_ = Boolean(StringUtils.isNotEmpty(_loc5_));
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
               ...
               _loc8_ = this._data.isElite ? ELITE_TYPE_GAP : COMMON_TYPE_GAP;
               _loc9_ = _loc7_ ? uint(this.vehicleLevel.x + this.vehicleLevel.width) : 0;
      ...
      public function createHelpLayoutData() : HelpLayoutVO
      {
         ...
         var _loc1_:Boolean = Boolean(this.message.visible) || Boolean(this.roleMessage.visible);
         var _loc2_:HelpLayoutVO = new HelpLayoutVO();
         _loc2_.x = -HELP_LAYOUT_WIDTH >> 1;
         _loc2_.y = Boolean(y + _loc1_) ? HELP_LAYOUT_OFFSET_Y : HELP_LAYOUT_NO_BG_OFFSET_Y;
      ...
      {
         if(Boolean(this._data) && this._data.roleId > 0)
         {
