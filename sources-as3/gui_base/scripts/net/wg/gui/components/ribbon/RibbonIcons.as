package net.wg.gui.components.ribbon
{
   ...
   public class RibbonIcons extends MovieClip implements IDisposable
   {
      ...
      private function updateDamageIcon() : void
      {
         ...
         if(Boolean(this._isWithVehName && this._damageSourceIcon != null && this._damageSourceIcon.visible) && Boolean(this._damageSourceTypeStr) && this._damageSourceTypeStr != Values.EMPTY_STR)
         {
