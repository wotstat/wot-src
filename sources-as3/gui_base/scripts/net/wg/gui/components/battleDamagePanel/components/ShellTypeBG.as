package net.wg.gui.components.battleDamagePanel.components
{
   ...
   public class ShellTypeBG extends Sprite implements IDisposable
   {
      ...
      private var _leftEdge:Shape = new Shape();
      
      private var _rightEdge:Shape = new Shape();
      
      private var _center:Shape = new Shape();
      
      private var _emptyShellBG:Sprite = new Sprite();
      
      private var _compositeBGContainer:Sprite = new Sprite();
