package net.wg.gui.components.battleDamagePanel.components
{
   ...
   public class DamageLogRenderer extends MovieClip implements IDisposable
   {
      ...
      private function calculateShellMaxWidth() : void
      {
         ...
         _loc1_ = new <String>[INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING,INGAME_GUI.DAMAGELOG_SHELLTYPE_HIGH_EXPLOSIVE,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_HE,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_CR,INGAME_GUI.DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_FSDS,INGAME_GUI.DAMAGELOG_SHELLTYPE_HOLLOW_CHARGE,INGAME_GUI.DAMAGELOG_SHELLTYPE_FLAME];
