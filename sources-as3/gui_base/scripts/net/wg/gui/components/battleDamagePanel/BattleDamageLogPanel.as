package net.wg.gui.components.battleDamagePanel
{
   ...
   public class BattleDamageLogPanel extends BattleDamageLogPanelMeta implements IBattleDamageLogPanelMeta, IDisplayableComponent
   {
      ...
      private var _detailsBottomContainer:Sprite = new Sprite();
      
      private var _detailsTopContainer:Sprite = new Sprite();
      ...
      public function setDetailActionCount(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:int = param2 ? int(this._detailActionRowsCount + 1) : this._detailActionRowsCount;
