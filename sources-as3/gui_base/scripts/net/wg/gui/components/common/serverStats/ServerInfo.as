package net.wg.gui.components.common.serverStats
{
   ...
   public class ServerInfo extends UIComponentEx
   {
      ...
      {
         super.draw();
         if(Boolean(isInvalid(InvalidationType.SIZE)) && Boolean(this.relativelyOwner))
         {
      ...
      public function setValues(param1:String, param2:String) : void
      {
         ...
         if(Boolean(param1) && param1 != Values.EMPTY_STR)
         {
         ...
         this.updateVisibility(param1 != "" && Boolean(App.instance.globalVarsMgr.isShowServerStatsS()));
         invalidateSize();
      }
