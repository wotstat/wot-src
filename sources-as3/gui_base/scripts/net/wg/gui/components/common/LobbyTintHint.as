package net.wg.gui.components.common
{
   ...
   public class LobbyTintHint extends HighlightRendererBase
   {
      ...
      {
         var _loc3_:int = this._fastDisappear ? FADE_OUT_TIME_ALPHA_SHORT : FADE_OUT_TIME_ALPHA;
      ...
      private function addVoidFrameScript(param1:Function) : void
      {
         ...
         var _loc3_:int = int(currentLabels.length);
         var _loc4_:uint = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      private function resizeTweens() : void
      {
         ...
         var _loc5_:int = 0;
         if(Boolean(this._fadeInTweens))
         {
            _loc3_ = int(this._fadeInTweens.length);
