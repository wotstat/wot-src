package net.wg.gui.components.common.markers
{
   ...
   public class VehicleActionMarker extends UIComponentEx
   {
      ...
      {
         if(Boolean(this.currentRenderer))
         {
      ...
      [Inspectable(name="actionRenderers",type="Object",defaultValue="attack:,attackSPG:,reloading_gun:,reloading_gunSPG:,help_me:,help_meSPG:,follow_me:,follow_meSPG:,attackSender:,attackSenderSPG:,negative:,negativeSPG:,positive:,positiveSPG:,stop:,stopSPG:,help_me_ex:,help_me_exSPG:,turn_back:,turn_backSPG:")]
