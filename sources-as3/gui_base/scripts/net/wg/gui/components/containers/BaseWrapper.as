package net.wg.gui.components.containers
{
   ...
   public class BaseWrapper extends Sprite implements IViewWrapper
   {
      ...
      protected var _tutorialHintZones:Dictionary = new Dictionary();
      ...
      public function hide(param1:Boolean) : void
      {
         ...
         {
            if(Boolean(this._containerWrapper) && Boolean(this._containerWrapper.isInTransition))
            {
      ...
      {
         visible = false;
         if(Boolean(this._containerWrapper))
         {
