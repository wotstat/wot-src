package net.wg.gui.components.containers
{
   ...
   public class GroupEx extends Group implements IGroupEx
   {
      ...
      {
         return Boolean(this._dataProvider) ? uint(this._dataProvider.length) : 0;
      }
      ...
      protected function commitProperties() : void
      {
         ...
         {
            _loc1_ = Boolean(StringUtils.isNotEmpty(this._itemRendererLinkage));
            if(_loc1_)
            {
               _loc2_ = int(this.getProviderLength());
      ...
      private function removeRedundantChildren() : void
      {
         ...
         var _loc1_:int = int(this.getProviderLength());
