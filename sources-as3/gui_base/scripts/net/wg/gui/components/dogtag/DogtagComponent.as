package net.wg.gui.components.dogtag
{
   ...
   public class DogtagComponent extends UIComponentEx
   {
      ...
      private var _animationPath:String = String.prototype;
      
      private var _animation:UILoaderAlt = new UILoaderAlt();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.flames))
         {
            this.flames.stop();
            this.flames = null;
         }
         if(Boolean(this.dogtagDown))
         {
            this.dogtagDown.dispose();
            this.dogtagDown = null;
         }
         if(Boolean(this._fadeIn))
         {
            this._fadeIn.paused = true;
            this._fadeIn.dispose();
            this._fadeIn = null;
         }
         if(Boolean(this._fadeOut))
         {
      ...
      {
         this._animation.unload();
         if(Boolean(this._animationPath))
         {
      ...
      private function addAnimationCallback(param1:String, param2:Function) : void
      {
         ...
         {
            _loc3_ = int(this._dogtagFrameHelper.getFrameByLabel(param1));
