package net.wg.gui.components.dogtag
{
   ...
   public class DogtagDownPlate extends UIComponentEx
   {
      ...
      private var _characters:Vector.<Image> = new Vector.<Image>();
      
      private var _plate:Image = new Image();
      
      private var _engravingStatValueContainer:Sprite = new Sprite();
      
      private var _imageRepository:ImageRepository = ImageRepository.getInstance();
      ...
      private function removeCharacters() : void
      {
         ...
         var _loc1_:int = int(this._characters.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
