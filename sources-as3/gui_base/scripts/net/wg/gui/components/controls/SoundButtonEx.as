package net.wg.gui.components.controls
{
   ...
   public class SoundButtonEx extends SoundButton implements ISoundButtonEx
   {
      ...
      private var _disabledFillPadding:Padding = new Padding(0,0,0,0);
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._tooltipParams))
         {
      ...
      override protected function draw() : void
      {
         if(isInvalid(InvalidationType.STATE))
         {
            ...
            if(Boolean(focusIndicator) && Boolean(_newFocusIndicatorFrame))
            {
      ...
      protected function updateDynamicSizeByText() : void
      {
         ...
         if(Boolean(textField) && textField.text != Values.EMPTY_STR)
         {
      ...
      {
         if(Boolean(this._tooltip) && Boolean(App.toolTipMgr))
         {
      ...
      override public function set visible(param1:Boolean) : void
      {
         ...
         if(!param1 && !toggle && enabled && Boolean(initialized))
         {
      ...
      public function set tooltip(param1:String) : void
      {
         ...
         if(Boolean(App.toolTipMgr) && this._isTooltipShown)
         {
            this.hideTooltip();
         }
      }
      ...
      [Inspectable(name="disabledFillPadding",defaultValue="top:0,right:0,bottom:0,left:0")]
      ...
      [Inspectable(name="paddingHorizontal",defaultValue="5")]
      ...
      public function set paddingHorizontal(param1:Number) : void
      {
         ...
         if(autoSize != "none" && textField != null && Boolean(initialized))
         {
