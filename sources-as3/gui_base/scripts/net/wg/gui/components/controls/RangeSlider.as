package net.wg.gui.components.controls
{
   ...
   public class RangeSlider extends Slider
   {
      ...
      [Inspectable(name="divisionPointRenderer",defaultValue="SliderDivisionPointUI")]
      ...
      [Inspectable(name="divisionLabelPostfix",defaultValue="")]
      ...
      override protected function trackPress(param1:MouseEvent) : void
      {
         ...
         if(this._rangeMode && Boolean(App.utils.commons.isLeftButton(param1)))
         {
            _trackPressed = true;
            ...
            _dragOffset = {"x":0};
            if(Boolean(this._draggingThumb))
            {
      ...
      override protected function doDrag(param1:MouseEvent) : void
      {
         ...
         if(this._draggingThumb == thumb && Boolean(thumb.visible))
         {
      ...
      private function getValueByPosition(param1:MouseEvent) : Number
      {
         ...
         return (_loc3_.x - offsetLeft - this._trackEdge) / _loc2_ * (_maximum - _minimum) + _minimum;
      }
