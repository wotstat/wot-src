package net.wg.gui.components.controls.universalBtn
{
   ...
   public class UniversalBtn extends SoundButtonEx implements IUniversalBtn, ISoundButtonEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(InvalidationType.LAYOUT)) || Boolean(isInvalid(InvalidationType.SIZE)) || Boolean(isInvalid(InvalidationType.DATA)))
         {
         ...
         if(isInvalid(INV_ALERT_INDICATOR))
         {
            ...
            {
               if(!this._alertIndicator && Boolean(focusIndicator))
               {
            ...
            else if(Boolean(this._alertIndicator))
            {
      ...
      override protected function updateDynamicSizeByText() : void
      {
         ...
         if(Boolean(textField.text) || this.image.visible)
         {
      ...
      public function setStyle(param1:String, param2:IUniversalBtnStyledDisplayObjects, param3:uint, param4:uint, param5:Dictionary, param6:String, param7:DropShadowFilter, param8:String, param9:uint) : void
      {
         ...
         this.clearStyledDisplayObjects();
         var _loc10_:int = int(this.getChildIndex(disableMc));
      ...
      public function shine(param1:int = 1, param2:int = 0) : void
      {
         ...
         if(!this._shineAnim && Boolean(StringUtils.isNotEmpty(this._shineLinkage)))
         {
      ...
      {
         if(Boolean(this._styledDisplayObjects))
         {
      ...
      {
         if(Boolean(this._alertIndicator))
         {
      ...
      private function rescaleItems(param1:uint) : void
      {
         ...
         var _loc2_:int = int(this.numChildren);
      ...
      private function updatePositions() : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Boolean = Boolean(StringUtils.isNotEmpty(textField.text));
