package net.wg.gui.components.controls
{
   ...
   public class DragableListItemRenderer extends SoundListItemRenderer
   {
      ...
      {
         if(Boolean(this.draggableOwner) && !this.draggableOwner.isSliding)
         {
      ...
      override protected function handleMousePress(param1:MouseEvent) : void
      {
         ...
         if(!this.isDragging && this.dragEnabled)
         {
            ...
            _loc3_ = _loc2_ == null ? 0 : uint(_loc2_.mouseIdx);
            _loc4_ = _loc2_ == null ? 0 : uint(_loc2_.buttonIdx);
      ...
      [Inspectable(name="dragEnabled",defaultValue="false")]
