package net.wg.gui.components.controls
{
   ...
   public class UserNameField extends UIComponentEx implements ITextContainer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(InvalidationType.DATA)) && !this._isFrozen)
         {
            this.textField.setTextFormat(this._textFormat);
            if(Boolean(this.userVO))
            {
               this.updateBadge();
               this.updateTFPosition();
               this.updateTFSize();
               ...
               _loc2_ = false;
               if(Boolean(this.userVO.userProps))
               {
                  _loc2_ = Boolean(App.utils.commons.formatPlayerName(this.textField,this.userVO.userProps,this.useFakeName,this.showAnonymizerIcon));
               }
      ...
      private function updateBadgeVisibility() : void
      {
         if(this._badge != null)
         {
            this._badge.visible = Boolean(this._userVO) && Boolean(this._userVO.userName) && this._badgeVisibility;
         }
      }
      ...
      [Inspectable(name="textFont",defaultValue="$FieldFont",type="list",enumeration="$TextFont,$FieldFont,$TitleFont")]
      ...
      [Inspectable(name="textColor",type="Color",defaultValue="#E9E2BF")]
      ...
      [Inspectable(name="shadowColor",defaultValue="Black",type="list",enumeration="White, Black")]
      ...
      {
         return Boolean(this._userVO) && Boolean(this._userVO.userProps) && UserTags.isCurrentPlayer(this.userVO.userProps.tags);
      }
      
      private function get isAnonymized() : Boolean
      {
         return Boolean(this._userVO) && this._userVO.isAnonymized;
      }
      ...
      protected function onMouseRollOverHandler(param1:MouseEvent) : void
      {
         if(this._showToolTip)
         {
            ...
            else if(Boolean(this._altToolTip))
            {
               this._toolTipMgr.show(this._altToolTip);
            }
            else if(Boolean(this._toolTip))
            {
