package net.wg.gui.components.controls
{
   ...
   public class StepSlider extends Slider
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this._valueLabel) && Boolean(parent))
            {
               this.valueLabelControl = parent[this._valueLabel];
               this.updateValueLabel();
            }
         }
         if(Boolean(isInvalid(INVALID_KEY_POINT_RENDERER)) || Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this.valueLabelControl))
         {
      ...
      public function set dataProvider(param1:IDataProvider) : void
      {
         ...
         maximum = Boolean(this._dataProvider) && this._dataProvider.length > 0 ? this._dataProvider.length - 1 : 0;
         invalidateData();
      }
      
      [Inspectable(name="keyPointRenderer",defaultValue="SliderKeyPointUI")]
         ...
         if(Boolean(this._dataProvider))
         {
            ...
            while(_loc3_ < _loc1_)
            {
               ...
               if(!(_loc4_ is String))
               {
                  ...
                  if(Boolean(_loc5_) && this.checkIsItemDisabled(_loc5_))
                  {
                     _loc2_ = _loc3_ - 1;
                     break;
                  }
      ...
      {
         var _loc1_:ISliderKeyPoint = null;
         while(Boolean(this.keyPointsContainer.numChildren))
         {
      ...
      [Inspectable(name="valueLabel",defaultValue="")]
