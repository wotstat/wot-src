   ...
   public class ScrollingListWithDisRenderers extends SortableScrollingList
   {
      ...
      override protected function populateData(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc5_.enabled = _loc4_ < _loc2_ && Boolean(param1) && Boolean(param1[_loc4_].enabled);
      ...
      {
         return this.isFocusedDisabledRenderers || Boolean(param1.enabled);
      }
      ...
      [Inspectable(name="isFocusedDisRenderers",defaultValue="false",verbose="1")]
