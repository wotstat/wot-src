package net.wg.gui.components.controls
{
   ...
   public class BlackButton extends SoundButtonEx
   {
      ...
      private var _iconAlign:String = ICON_ALIGN_LEFT;
      ...
      override protected function updateDynamicSizeByText() : void
      {
         ...
         if(textField != null && Boolean(StringUtils.isNotEmpty(textField.text)))
         {
      ...
      {
         var _loc6_:uint = 0;
         var _loc4_:Boolean = textField.text != null && Boolean(StringUtils.isNotEmpty(textField.text));
      ...
      {
         var _loc2_:Boolean = Boolean(StringUtils.isNotEmpty(label));
         var _loc3_:Boolean = Boolean(StringUtils.isNotEmpty(this._imageSource));
