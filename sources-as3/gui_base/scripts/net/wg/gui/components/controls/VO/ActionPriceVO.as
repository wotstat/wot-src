package net.wg.gui.components.controls.VO
{
   ...
   public class ActionPriceVO extends DAAPIDataClass
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._newPrices))
         {
            this._newPrices.splice(0);
            this._newPrices = null;
         }
         if(Boolean(this.newPriceBases))
         {
            this.newPriceBases.splice(0);
            this.newPriceBases = null;
         }
         if(Boolean(this.oldPriceBases))
         {
      ...
      {
         if(Boolean(this._states) && Boolean(this.ico))
         {
         ...
         this._useAction = Boolean(this.state) && this._newPrice != this._oldPrice;
      }
      
      private function updateOldPrice() : void
      {
         if(Boolean(this._oldPrices))
         {
            switch(this.ico)
            {
      ...
      public function set newPrices(param1:Array) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = int(this._newPrices.length);
         while(_loc2_ < _loc3_)
         {
