package net.wg.gui.components.controls
{
   ...
   public class ContextMenu extends UIComponentEx implements IContextMenu
   {
      ...
      public function build(param1:Vector.<IContextItem>, param2:Point) : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            while(_loc6_ < _loc15_)
            {
               ...
               else if(Boolean(_loc19_.initData.visible))
               {
                  _loc20_ = Linkages.CONTEXT_MENU_ITEM;
                  if(Boolean(StringUtils.isNotEmpty(_loc19_.linkage)) && _loc19_.linkage != _LINKAGE_NULL)
                  {
      ...
      protected function clearItems() : void
      {
         ...
         var _loc1_:int = int(this._contextMenuItems.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_)
         {
         ...
         _loc1_ = int(this._separators.length);
         _loc3_ = 0;
         while(_loc3_ < _loc1_)
         {
      ...
      {
         this._tweenManager.unregisterAll();
         if(Boolean(this._groupItemSelected) && this._groupItemSelected == param1)
         {
         ...
         {
            if(Boolean(this._groupItemSelected) && this._groupItemSelected.isOpened)
            {
               this.hideSub(this._groupItemSelected);
            }
      ...
      private function expand(param1:ContextMenuItem) : void
      {
         ...
         if(param1.isOpened)
         {
            _loc8_ = uint(this.calculateItemsHeight(param1.subItems));
         }
         _loc7_ += _loc8_;
      ...
      private function showSub(param1:ContextMenuItem) : void
      {
         ...
         var _loc2_:int = int(param1.subItems.length);
         var _loc4_:uint = 0;
         while(_loc4_ < _loc2_)
         {
