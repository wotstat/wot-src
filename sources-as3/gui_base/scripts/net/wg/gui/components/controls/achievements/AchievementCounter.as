package net.wg.gui.components.controls.achievements
{
   ...
   public class AchievementCounter extends CustomAchievement
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(COUNTER_TYPE_INVALID))
         {
            if(this._oldCounterType != this._counterType)
            {
               ...
               this.disposeCounter();
               if(Boolean(this._counterType) && this._counterType != "")
               {
         ...
         if(Boolean(isInvalid(COUNTER_VALUE_INVALID)) && Boolean(this.counter))
         {
      ...
      {
         if(Boolean(this.counter) && Boolean(loader.width != 0) && loader.height != 0)
         {
      ...
      {
         if(Boolean(this._profileAchievement))
         {
      ...
      {
         if(Boolean(this.counter) && Boolean(contains(this.counter)))
         {
