package net.wg.gui.components.controls
{
   ...
   public class SortableScrollingList extends ScrollingListEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(COLUMNS_INVALID)) && this._columnsData != null)
         {
      ...
      protected function applySorting(param1:Array) : void
      {
         ...
         if(Boolean(dataProvider))
         {
            ...
            if(Boolean(_loc4_ > 0) && Boolean(_loc2_) && _loc4_ == _loc2_.length)
            {
      ...
      private function invalidateColumnsData() : void
      {
         ...
         if(Boolean(this._columnsData))
         {
            ...
            for each(_loc3_ in this._columnsData)
            {
               ...
               else
               {
                  ...
                  _loc6_ = _loc3_.hasOwnProperty("dataSortType") ? uint(_loc3_.dataSortType) : Array.NUMERIC;
                  _loc7_ = _loc3_.hasOwnProperty("defaultSortDir") ? uint(_loc3_.defaultSortDir) : 0;
                  _loc8_ = _loc3_.hasOwnProperty("sortOrder") ? int(_loc3_.sortOrder) : _loc9_;
               }
               if(_loc8_ >= 0)
               {
         ...
         if(Boolean(this._sortProps) && Boolean(this._sortProps.length > 0) && this._sortProps.length != this._sortingOrder.length)
         {
            ...
            _loc1_ = uint(this._optionsDict[_loc2_]);
         }
         else
         {
            this._sortProps = this._sortingOrder.slice();
