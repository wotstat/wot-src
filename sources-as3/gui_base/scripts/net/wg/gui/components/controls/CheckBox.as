package net.wg.gui.components.controls
{
   ...
   public class CheckBox extends scaleform.clik.controls.CheckBox implements ISoundable, ITextContainer
   {
      ...
      public var tooltipType:ToolTipShowType = ToolTipShowType.COMPLEX;
      ...
      private var _textLineSpacing:Number = 0;
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(VISIBILITY_INV)) && Boolean(this._infoIco))
         {
            this._infoIco.visible = this.visible;
         }
         if(textField != null)
         {
            if(Boolean(isInvalid(INVALIDATION_LABEL_VISIBILITY)) || Boolean(isInvalid(InvalidationType.STATE)))
            {
      ...
      {
         if(Boolean(this._tooltip) && Boolean(this._toolTipMgr) && !this._infoIco)
         {
      ...
      {
         if(Boolean(textField) && Boolean(textField.text) && textField.text.length > 0)
         {
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         if(!param1 && Boolean(_focusIndicator))
         {
      ...
      [Inspectable(name="textColor",type="Color",defaultValue="#969687")]
      ...
      [Inspectable(name="disabledTextAlpha",type="Number",defaultValue="0.5")]
