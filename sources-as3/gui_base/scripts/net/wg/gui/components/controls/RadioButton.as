package net.wg.gui.components.controls
{
   ...
   public class RadioButton extends scaleform.clik.controls.RadioButton implements ISoundable
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(StringUtils.isNotEmpty(this._infoIcoType)) && Boolean(StringUtils.isNotEmpty(this._infoTooltip)))
            {
               if(!this._infoIco)
               {
                  this.createInfoIco();
      ...
      {
         if(owner != null && Boolean(owner.hasEventListener(Event.COMPLETE)))
         {
      ...
      [Inspectable(type="String",defaultValue="radioButton")]
