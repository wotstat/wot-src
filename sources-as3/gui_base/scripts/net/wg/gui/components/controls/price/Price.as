package net.wg.gui.components.controls.price
{
   ...
   public class Price extends UIComponentEx
   {
      ...
      private var _iconOffset:Point = new Point(0,0);
      
      private var _actionOffset:Point = new Point(0,0);
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalidTypes(InvalidationType.DATA,InvalidationType.STATE))
         {
            ...
            if(Boolean(this._defaultData) && this._oldPriceVisible)
            {
      ...
      {
         this._data = param1;
         this._actionData = Boolean(this._data) && Boolean(param2) && param2.value != 0 ? param2 : null;
         this._defaultData = Boolean(this._data) && Boolean(param3) && param3.value != this._data.value ? param3 : null;
         invalidateData();
      }
      ...
      private function updateLayout() : void
      {
         ...
         if(Boolean(this.actionCmp) && Boolean(this.actionCmp.visible))
         {
