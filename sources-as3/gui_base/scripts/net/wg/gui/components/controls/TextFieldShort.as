package net.wg.gui.components.controls
{
   ...
   public class TextFieldShort extends ListItemRenderer implements ITextContainer
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(isInvalid(INV_TEXT_SIZE));
            _loc2_ = Boolean(isInvalid(INV_TEXT_FONT));
            _loc3_ = Boolean(isInvalid(INV_TEXT_COLOR));
            _loc4_ = Boolean(isInvalid(INV_TEXT_FONT));
            _loc5_ = Boolean(isInvalid(INV_TEXT_SHADOW));
            if(_loc1_)
            {
      ...
      private function updateConstraints() : void
      {
         if(autoSize != TextFieldAutoSize.NONE)
         {
            ...
            if(!constraintsDisabled && Boolean(constraints))
            {
      ...
      [Inspectable(name="useHtml",defaultValue="false",type="Boolean")]
      ...
      [Inspectable(name="textColor",type="Color",defaultValue="#E9E9DA")]
