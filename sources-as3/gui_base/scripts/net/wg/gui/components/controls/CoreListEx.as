package net.wg.gui.components.controls
{
   ...
   public class CoreListEx extends CoreList
   {
      ...
      [Inspectable(name="useRightButton",defaultValue="false")]
      ...
      [Inspectable(name="useRightButtonForSelect",defaultValue="false")]
      ...
      override protected function dispatchItemEvent(param1:Event) : Boolean
      {
         ...
         {
            _loc4_ = uint((param1 as ButtonEvent).controllerIdx);
         }
         else if(param1 is MouseEventEx)
         {
            _loc4_ = uint((param1 as MouseEventEx).mouseIdx);
         }
         var _loc5_:uint = 0;
         if(param1 is ButtonEvent)
         {
            _loc5_ = uint((param1 as ButtonEvent).buttonIdx);
         }
         else if(param1 is MouseEventEx)
         {
            _loc5_ = uint((param1 as MouseEventEx).buttonIdx);
         }
         var _loc6_:Boolean = false;
         if(param1 is ButtonEvent)
         {
            _loc6_ = Boolean((param1 as ButtonEvent).isKeyboard);
         }
      ...
      {
         var _loc3_:Number = Number(IListItemRenderer(param1.currentTarget).index);
         if(isNaN(_loc3_))
         {
            return;
         }
