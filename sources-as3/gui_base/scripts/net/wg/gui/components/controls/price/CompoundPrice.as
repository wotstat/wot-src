package net.wg.gui.components.controls.price
{
   ...
   public class CompoundPrice extends UIComponentEx
   {
      ...
      private var _priceActionOffset:Point = new Point(0,0);
      ...
      private function updatePositions() : void
      {
         ...
         {
            _loc19_ = _loc11_ ? int(_loc2_ - 1 - _loc20_) : _loc20_;
            ...
            if(_loc3_)
            {
               ...
               _loc12_ = _loc3_.x < _loc12_ ? Number(_loc3_.x) : _loc12_;
               _loc14_ = _loc3_.y < _loc14_ ? Number(_loc3_.y) : _loc14_;
      ...
      {
         if(this._priceIconOffset == param1 || Boolean(this._priceIconOffset) && Boolean(this._priceIconOffset.equals(param1)))
         {
            return;
         }
      ...
      {
         if(this._priceActionOffset == param1 || Boolean(this._priceActionOffset) && Boolean(this._priceActionOffset.equals(param1)))
         {
            return;
         }
