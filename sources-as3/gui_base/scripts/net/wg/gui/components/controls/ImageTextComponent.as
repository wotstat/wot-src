package net.wg.gui.components.controls
{
   ...
   public class ImageTextComponent extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         var _loc3_:Boolean = Boolean(isInvalid(TEXT_STYLE_INVALID));
         var _loc4_:Boolean = Boolean(isInvalid(InvalidationType.LAYOUT));
         if(_loc3_)
         {
            if(!this._htmlText)
            {
         ...
         if(_loc1_)
         {
            ...
            _loc4_ ||= this._updateTextFieldSize || this._textWidth == 0 || this._textHeight == 0;
         }
         if(_loc3_)
         {
