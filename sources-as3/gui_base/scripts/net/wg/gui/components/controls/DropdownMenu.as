package net.wg.gui.components.controls
{
   ...
   public class DropdownMenu extends scaleform.clik.controls.DropdownMenu implements ISoundable
   {
      ...
      override protected function draw() : void
      {
         ...
         var _loc2_:int = 0;
         super.draw();
         if(Boolean(_dataProvider) && Boolean(isInvalid(INV_LIST_DATA)))
         {
            if(isOpen())
            {
      ...
      override protected function showDropdown() : void
      {
         ...
         if(Boolean(_loc1_))
         {
            ...
            _loc1_.width = menuWidth == -1 ? width + menuOffset.left + menuOffset.right : Number(menuWidth);
            _loc1_.dataProvider = _dataProvider;
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(scrollBar) && scrollBar is IDisposable)
         {
      ...
      {
         if(Boolean(isOpen()) && !_dropdownRef.hitTestPoint(stage.mouseX,stage.mouseY,true))
         {
            this.close();
         }
      }
      ...
      {
         var _loc1_:uint = Boolean(_dataProvider) ? uint(_dataProvider.length) : 0;
         if(!menuRowsFixed)
         {
      ...
      override public function set selectedIndex(param1:int) : void
      {
         ...
         if(_dropdownRef != null)
         {
            ...
            _loc3_ = _loc2_ is ScrollingList ? uint(ScrollingList(_loc2_).scrollPosition) : 0;
      ...
      [Inspectable(type="String",defaultValue="dropDownMenu")]
      ...
      [Inspectable(name="menuRowCount",variable="rowCount",defaultValue="-1")]
      ...
      override protected function handleStageClick(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._dropdownRef) && Boolean(this._dropdownRef.contains(_loc2_)))
         {
            return;
         }
         this.close();
      ...
      private function onMouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(_dropdownRef) && _loc3_ != _selectedIndex)
         {
