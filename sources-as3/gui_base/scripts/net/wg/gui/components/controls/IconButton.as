package net.wg.gui.components.controls
{
   ...
   public class IconButton extends SoundButtonEx
   {
      ...
      [Inspectable(name="iconOffsetTop",type="Number",defaultValue="0")]
      ...
      [Inspectable(name="iconOffsetLeft",type="Number",defaultValue="0")]
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.loader) && Boolean(this.contains(this.loader)) && this.updateNestedChild)
         {
