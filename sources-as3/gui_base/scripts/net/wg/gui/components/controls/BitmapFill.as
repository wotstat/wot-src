package net.wg.gui.components.controls
{
   ...
   public class BitmapFill extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         this.graphics.clear();
         if(this._bitmapData != null && Boolean(isInvalid(InvalidationType.DATA)))
         {
            ...
            {
               case REPEAT_NONE:
                  _loc3_ = uint(this._bitmapData.width);
                  _loc4_ = uint(this._bitmapData.height);
                  break;
      ...
      {
         if(this._needDispose && Boolean(this._bitmapData))
         {
      ...
      [Inspectable(name="source",defaultValue="")]
      ...
      [Inspectable(name="widthFill",type="Number",defaultValue="100")]
      ...
      [Inspectable(name="heightFill",type="Number",defaultValue="100")]
