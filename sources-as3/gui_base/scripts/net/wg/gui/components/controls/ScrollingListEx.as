package net.wg.gui.components.controls
{
   ...
   public class ScrollingListEx extends CoreListEx
   {
      ...
      [Inspectable(enumeration="normal,stick,wrap",defaultValue="stick")]
      ...
      [Inspectable(name="gap",type="Number",defaultValue="0",verbose="1")]
      ...
      override protected function drawLayout() : void
      {
         ...
         var _loc6_:Boolean = Boolean(isInvalid(InvalidationType.DATA));
         var _loc7_:uint = 0;
         while(_loc7_ < _loc1_)
         {
      ...
      public function setSelectionNavigator(param1:AbstractListSelectionNavigator) : void
      {
         ...
         if(Boolean(this._selectionNavigator))
         {
      ...
      protected function updateVisibleScrollBar() : void
      {
         ...
         if(Boolean(this._scrollBar))
         {
            ...
            {
               if(Boolean(_dataProvider) && _dataProvider.length > 0)
               {
               ...
               {
                  _loc2_ = Boolean(isInvalid(InvalidationType.DATA));
                  if(_loc1_.visible)
                  {
               ...
               if(Boolean(_loc1_) && Boolean(container.contains(_loc1_)))
               {
      ...
      protected function updateScrollBar() : void
      {
         ...
         if(Boolean(_dataProvider) && this._scrollBar is ScrollIndicator)
         {
      ...
      [Inspectable(name="buttonModeEnabled",type="Boolean",defaultValue="true")]
      ...
      [Inspectable(name="sbPadding",defaultValue="top:0,right:0,bottom:0,left:0")]
      ...
      [Inspectable(name="smartScrollBar",defaultValue="false")]
      ...
      {
         param1 = Boolean(_dataProvider) ? Math.max(0,Math.min(_dataProvider.length - _totalRenderers,Math.round(param1))) : 0;
      ...
      {
         return Boolean(_renderers) ? int(_renderers.length) : -1;
      }
      ...
      override protected function handleMouseWheel(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._scrollBar) && Boolean(this._scrollBar.visible))
         {
