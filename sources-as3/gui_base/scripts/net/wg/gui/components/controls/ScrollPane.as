package net.wg.gui.components.controls
{
   ...
   public class ScrollPane extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.scrollBar) && Boolean(isInvalid(THUMB_INV)))
         {
      ...
      protected function applyScrollBarUpdating() : void
      {
         ...
         if(Boolean(this._target) && enabled)
         {
      ...
      [Inspectable(name="scrollBarMargin",type="Number",defaultValue="0",verbose="1")]
