package net.wg.gui.components.controls
{
   ...
   public class WalletResourcesStatus extends UIComponentEx implements IDisposable
   {
      ...
      {
         super.draw();
         if(Boolean(StringUtils.isNotEmpty(this._icoType)) && Boolean(isInvalid(InvalidationType.STATE)))
         {
            gotoAndStop(this._state);
            this.alertIco.x = Boolean(this.alertIco.visible) && this._state == RESOURCE_ICO_ALIGN_LEFT_ALERT_RIGHT ? ICO_RIGHT_MARGIN : 0;
         ...
         if(this._icoType != Values.EMPTY_STR && Boolean(isInvalid(InvalidationType.DATA)))
         {
      ...
      [Inspectable(name="state",defaultValue="empty",type="list",enumeration="empty,resIcoLeft,resIcoRight,resIcoForTechTree,resIcoLeftAlertRight")]
      ...
      [Inspectable(name="icoType",defaultValue="empty",type="list",enumeration="empty,gold,freeXp,credits,crystal")]
