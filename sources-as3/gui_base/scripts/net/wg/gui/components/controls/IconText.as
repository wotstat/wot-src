   ...
   public class IconText extends UIComponentEx implements ITextContainer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this.textField))
         {
            ...
            _loc2_ = Boolean(isInvalid(INV_ICON));
            _loc3_ = Boolean(isInvalid(INV_TEXT));
            _loc4_ = Boolean(isInvalid(INV_TEXT_SIZE));
            _loc5_ = Boolean(isInvalid(INV_TEXT_COLOR));
            _loc6_ = Boolean(isInvalid(INV_TEXT_FONT));
            if(_loc1_)
            {
            ...
            if(!this._useHtmlText)
            {
               if(_loc5_ || _loc2_)
               {
                  _loc7_ = Number(IconsTypes.getTextColor(this._icon));
      ...
      [Inspectable(name="iconPosition",defaultValue="left",type="list",enumeration="left,right")]
      ...
      [Inspectable(name="Anti-alias",defaultValue="advanced",type="list",enumeration="advanced,normal")]
      ...
      [Inspectable(name="fitIconPosition",defaultValue="false",type="Boolean")]
      ...
      [Inspectable(name="textAlign",defaultValue="left",type="list",enumeration="left,right,center")]
      ...
      [Inspectable(name="textFont",defaultValue="$TextFont",type="list",enumeration="$TextFont,$FieldFont,$TitleFont")]
      ...
      [Inspectable(name="textSize",defaultValue="12",type="Number")]
      ...
      [Inspectable(name="toolTip",defaultValue="")]
      ...
      [Inspectable(name="icon",defaultValue="credits")]
      ...
      {
         if(Boolean(this._toolTip) && this._enabledTooltip)
         {
