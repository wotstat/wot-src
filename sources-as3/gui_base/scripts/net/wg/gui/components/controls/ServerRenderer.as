package net.wg.gui.components.controls
{
   ...
   public class ServerRenderer extends SoundListItemRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(_newFrame) && Boolean(isInvalid(InvalidationType.STATE)))
         {
         ...
         if(Boolean(this._serverData) && Boolean(isInvalid(InvalidationType.SIZE)))
         {
            this.updateLayout();
         }
      }
      ...
      private function onRollOverHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._serverData) && Boolean(this._serverData.tooltipVo))
         {
         ...
         else if(Boolean(_label) && textField.text != _label)
         {
