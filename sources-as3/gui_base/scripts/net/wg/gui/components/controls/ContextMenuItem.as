package net.wg.gui.components.controls
{
   ...
   public class ContextMenuItem extends SoundListItemRenderer
   {
      ...
      {
         if(!constraintsDisabled && Boolean(this.textFieldSub))
         {
         ...
         if(isInvalid(InvalidationType.STATE))
         {
            if(this.showCheckmark)
            {
               ...
               else if(!enabled)
               {
                  ...
                  this._checkDynamic.x = this.type == this.CONTEXT_MENU_ITEM_SUB ? CHECK_X_SUB : CHECK_X_MAIN;
            ...
            switch(this.type)
            {
               ...
               case this.CONTEXT_MENU_ITEM_SUB:
                  ...
                  this.iconsMc.visible = false;
                  this.iconsMc.visible = false;
                  this.circleMc.visible = Boolean(this._checkDynamic) && !enabled ? false : true;
      ...
      override protected function updateText() : void
      {
         if(_label != null)
         {
            if(Boolean(textField) && Boolean(textField.visible))
            {
               this.applyText(textField,_label);
            }
            if(Boolean(this.textFieldSub) && this.textFieldSub.visible)
            {
