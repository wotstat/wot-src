package net.wg.gui.components.controls
{
   ...
   public class ButtonIconLoader extends SoundButtonEx implements IButtonIconLoader
   {
      ...
      private function initItems() : void
      {
         ...
         var _loc1_:Number = Number(this.numChildren);
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(InvalidationType.SIZE)) || Boolean(isInvalid(this.LAYOUT_INVALID)))
         {
            this.configIcon();
         }
         if(Boolean(isInvalid(this.ICON_LOADED_INVALID)) && this.iconWasLoaded)
         {
      ...
      protected function configIcon() : void
      {
         ...
         if(Boolean(this.container) && Boolean(this.loader))
         {
            _loc1_ = 0;
            _loc2_ = 0;
            _loc3_ = 1;
      ...
      {
         return Boolean(this.states) ? super.width * this.newScaleX : super.width;
      }
      
      override public function get height() : Number
      {
         return Boolean(this.states) ? super.height * this.newScaleY : super.height;
      }
