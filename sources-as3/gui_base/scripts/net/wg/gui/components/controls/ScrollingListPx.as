package net.wg.gui.components.controls
{
   ...
   public class ScrollingListPx extends CoreListEx
   {
      ...
      private var _scrollStepFactor:Number = 1;
         ...
         if(this._scrollBarValue is String)
         {
            ...
            if(_loc1_ == null)
            {
               ...
               if(Boolean(_loc1_))
               {
                  ...
                  if(Boolean(_loc4_) && Boolean(this.thumbOffset))
                  {
      ...
      [Inspectable(name="scrollStepFactor",type="Number",defaultValue="1.0",verbose="1")]
