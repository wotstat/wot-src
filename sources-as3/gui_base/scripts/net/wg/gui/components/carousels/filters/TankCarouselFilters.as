   ...
   public class TankCarouselFilters extends UIComponentEx implements IPopOverCaller
   {
      ...
      override protected function draw() : void
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ && Boolean(isInvalid(InvalidationType.SIZE)))
            {
         ...
         if(_loc3_)
         {
            if(this._selectedVO != null && Boolean(isInvalid(SELECTED_INVALID)))
            {
               ...
               if(this._selectedVO != null)
               {
                  ...
                  while(_loc11_ < _loc9_)
                  {
                     ...
                     _loc1_.validateNow();
                     _loc1_.selectable = _loc11_ < _loc10_.length ? _loc10_[_loc11_] : false;
                     _loc11_++;
                  }
               }
            }
