package net.wg.gui.components.carousels.filters
{
   ...
   public class TankCarouselFilters extends UIComponentEx implements IPopOverCaller
   {
      ...
      protected var popoverMgr:IPopoverManager = App.popoverMgr;
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(INIT_INVALID)) && _loc2_)
         {
         ...
         if(Boolean(isInvalid(InvalidationType.SIZE)) && _loc3_ && _loc2_)
         {
         ...
         if(this._selectedVO != null && Boolean(isInvalid(SELECTED_INVALID)) && _loc3_)
         {
         ...
         if(!this._enableStateInitialized && _loc3_)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc11_ < _loc9_)
               {
                  ...
                  if(Boolean(_loc12_) && Boolean(this._initVO.hotFilters[_loc11_]))
                  {
