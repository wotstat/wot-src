package net.wg.gui.components.carousels.controls.levelInfo
{
   ...
   public class LevelInfoItem extends UIComponentEx
   {
      ...
      final public function setData(param1:CarouselLevelInfoVO) : void
      {
         if(Boolean(param1) && Boolean(param1.level))
         {
            this._data = param1;
         ...
         if(!this._isCollapsed)
         {
            if(Boolean(this.infoLabel))
            {
               ...
               else
               {
                  ...
                  _loc2_ = Boolean(App.utils.commons.truncateHtmlTextMultiline(this.infoLabel,this._data.infoText,MAX_LINE_NUMBER,Values.THREE_DOTS));
                  if(_loc2_)
                  {
      ...
      private function handleInfoIconClick(param1:MouseEvent) : void
      {
         ...
         if(Boolean(App.utils.commons.isLeftButton(param1)) && this._data.isCollapsible)
         {
