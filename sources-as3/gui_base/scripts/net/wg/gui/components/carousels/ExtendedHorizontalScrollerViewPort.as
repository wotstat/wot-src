   ...
   public class ExtendedHorizontalScrollerViewPort extends ScrollerViewPort
   {
      ...
      override protected function updateActiveRenderer() : void
      {
         ...
         if(dataCount > 0)
         {
            ...
            _loc4_ = int(activeRenderers.length);
            if(_loc4_ > 0)
            {
               ...
               if(_loc6_ == -1)
               {
                  _loc6_ = int(activeRenderers[_loc4_ - 1].index);
               }
      ...
      override protected function resize() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc3_ = int(this._itemRendererIndexToDataProviderIndex[this._indexExtendedData[_loc5_]]);
            _loc2_ = _loc3_ > EMPTY_SLOT_DP_INDEX ? getDataByIndex(_loc3_) as IScrollerItemRendererData : null;
            if(Boolean(_loc2_) && _loc2_.isItemExtended)
            {
      ...
      override protected function getLeftIndex() : int
      {
         ...
         _loc1_ -= rowCount;
         if(_loc1_ < dataCount && rowCount > 1 && Boolean(this._indexRenderersCountToRenderer[_loc1_] % 2))
         {
            _loc1_--;
         }
      ...
      override protected function updateDataCount() : void
      {
         ...
         {
            _loc1_ = int(dataProvider.length);
            ...
            while(_loc7_ < _loc1_)
            {
               ...
               _loc5_ = false;
               if(Boolean(_loc2_) && _loc2_.hasExtendedInfo)
               {
                  _loc5_ = true;
                  if(rowCount > 1)
                  {
      ...
      override protected function getRendererByIndex(param1:int) : IScrollerItemRenderer
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc2_:int = int(activeRenderers.length);
         if(_loc2_ > 0 && param1 > EMPTY_SLOT_DP_INDEX)
         {
            _loc3_ = param1 < this._indexDataProviderToRenderer.length ? this._indexDataProviderToRenderer[param1] : EMPTY_SLOT_DP_INDEX;
            if(_loc3_ == -1)
            {
               return null;
            }
      ...
      {
         var _loc2_:int = int(this._itemRendererIndexToDataProviderIndex[param1.index]);
      ...
      private function createRenderer(param1:int) : IScrollerItemRenderer
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc2_:int = dataProvider != null ? int(dataProvider.length) : 0;
         _loc3_ = this._indexRenderersCountToRenderer[param1];
         _loc4_ = int(this._itemRendererIndexToDataProviderIndex[_loc3_]);
      ...
      {
         var _loc4_:int = dataProvider != null ? int(dataProvider.length) : 0;
      ...
      private function updateItemsPrecalculatedPositions(param1:int = 0) : void
      {
         ...
         if(dataProvider != null)
         {
            ...
            _loc3_ = 0;
            _loc5_ = false;
            _loc6_ = param1 > 0 ? int(this._itemRendererIndexToRendererX[param1]) : 0;
            ...
            while(_loc9_ < dataCount)
            {
               ...
               _loc10_ = _loc5_ ? this.getActualWidth(_loc2_) : this.getRendererWidthByRendererIndex(_loc3_,true);
               _loc6_ += _loc10_;
               if(_loc9_ == _loc8_)
               {
      ...
      {
         return param2 && rowCount == 1 ? typicalRendererWidth : int((param1 % rowCount ^ 0) * typicalRendererWidth);
      }
      ...
      private function getActualWidth(param1:IScrollerItemRendererData) : int
      {
         ...
         return _loc2_ > -1 ? int(_loc2_ + horizontalGap) : typicalRendererWidth;
      }
      ...
      {
         var _loc2_:int = int(this._itemRendererIndexToDataProviderIndex[param1.itemId]);
