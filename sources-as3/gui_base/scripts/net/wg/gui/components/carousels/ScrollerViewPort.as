package net.wg.gui.components.carousels
{
   ...
   public class ScrollerViewPort extends UIComponentEx implements IScrollerViewPort, ITutorialCustomComponent
   {
      ...
      private var _activeRenderers:Vector.<IScrollerItemRenderer> = new Vector.<IScrollerItemRenderer>(0);
      
      private var _inactiveRenderers:Vector.<IScrollerItemRenderer> = new Vector.<IScrollerItemRenderer>(0);
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         var _loc1_:Boolean = Boolean(isInvalid(INVALIDATE_RENDERER));
         var _loc2_:Boolean = _loc1_ || Boolean(isInvalid(InvalidationType.DATA));
         var _loc3_:Boolean = _loc2_ || Boolean(isInvalid(InvalidationType.SIZE));
         if(_loc2_)
         {
         ...
         if(_loc3_ || Boolean(isInvalid(INVALIDATE_LAYOUT_RENDERER)))
         {
      ...
      protected function createRenderers(param1:int, param2:int) : void
      {
         ...
         while(_loc6_ < param2)
         {
            ...
            _loc5_ = Boolean(_loc3_) && _loc3_.length > _loc6_ ? _loc3_[_loc6_] : null;
      ...
      protected function updateActiveRenderer() : void
      {
         ...
         if(this.dataCount > 0)
         {
            ...
            {
               _loc4_ = int(this.activeRenderers[0].index);
               _loc5_ = int(this.activeRenderers[this.activeRenderers.length - 1].index);
