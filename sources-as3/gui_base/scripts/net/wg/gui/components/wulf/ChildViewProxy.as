package net.wg.gui.components.wulf
{
   ...
   public class ChildViewProxy extends Sprite implements IChildViewProxy
   {
      ...
      {
         if(param3 ? hasFocusInside(param1) : param1 == App.utils.focusHandler.getFocus(0))
         {
      ...
      public function removeWrapper(param1:IViewWrapper = null, param2:uint = 0) : void
      {
         ...
         if(!this._disposed && Boolean(this._wrapper.focused))
         {
      ...
      {
         return this._manageSize ? this._containerHeight : (Boolean(this._wrapper) ? Number(this._wrapper.height) : 0);
      }
      ...
      {
         return this._manageSize ? this._containerWidth : (Boolean(this._wrapper) ? Number(this._wrapper.width) : 0);
      }
