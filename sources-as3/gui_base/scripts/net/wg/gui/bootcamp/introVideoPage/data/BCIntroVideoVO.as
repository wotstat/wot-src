package net.wg.gui.bootcamp.introVideoPage.data
{
   ...
   public class BCIntroVideoVO extends DAAPIDataClass
   {
      ...
      public var lessonPagesBigData:Vector.<BCTutorialPageVO> = new Vector.<BCTutorialPageVO>();
      
      public var lessonPagesSmallData:Vector.<BCTutorialPageVO> = new Vector.<BCTutorialPageVO>();
