package net.wg.gui.bootcamp.introVideoPage.containers
{
   ...
   public class IntroRewardsContainer extends UIComponentEx
   {
      ...
      {
         this.txtRewards.y = param1 ? TXREWARDS_POS_Y_SMALL : TXREWARDS_POS_Y;
         this.rewards.y = param1 ? REWARDS_POS_Y_SMALL : REWARDS_POS_Y;
         this.background.height = param1 ? BG_HEIGHT_SMALL : BG_HEIGHT;
      }
   }
}
