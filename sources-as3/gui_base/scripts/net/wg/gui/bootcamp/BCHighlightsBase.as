package net.wg.gui.bootcamp
{
   ...
   public class BCHighlightsBase extends BCHighlightsMeta implements IBCHighlightsMeta
   {
      ...
      private var _highlightsData:Dictionary = new Dictionary(true);
      
      private var _foundComponents:Dictionary = new Dictionary(true);
      
      private var _componentToId:Dictionary = new Dictionary(true);
      
      private var _hintsMap:Dictionary = new Dictionary(true);
      
      private var _viewsCache:Dictionary = new Dictionary(true);
      ...
      public static function seekView(param1:String) : DisplayObjectContainer
      {
         ...
         for(_loc5_ in _loc3_)
         {
            ...
            if(Boolean(_loc4_))
            {
               _loc6_ = uint(_loc4_.numChildren);
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
                  ...
                  if(Boolean(_loc9_) && _loc9_.as_config.alias == param1)
                  {
      ...
      public function as_setDescriptors(param1:Object) : void
      {
         ...
         for(_loc2_ in param1)
         {
            ...
            if(Boolean(this._highlightsData[_loc2_]))
            {
      ...
      {
         if(Boolean(this._readyForTutorialDispatcher))
         {
      ...
      {
         return Boolean(param1) && param1[param2] == param3;
      }
      ...
      private function highlightRoutine(param1:String) : void
      {
         ...
         if(Boolean(this._foundComponents[param1]))
         {
            return;
         }
         var _loc2_:HighlightData = this._highlightsData[param1];
         _loc2_.componentId = param1;
         if(Boolean(this._viewsCache[_loc2_.viewAlias]))
         {
      ...
      private function updateComponentPosition(param1:Object, param2:String) : void
      {
         ...
         if(Boolean(_loc4_) && _loc6_.parent == null)
         {
      ...
      private function onLoaderViewLoadedHandler(param1:LoaderEvent) : void
      {
         ...
         if(Boolean(this._currentComponentSearching))
         {
...
class HighlightData extends DAAPIDataClass
{
   ...
   public function HighlightData(param1:Object)
   {
      super(param1);
   }
