package net.wg.gui.dialogs
{
   ...
   public class SimpleDialog extends SimpleDialogMeta implements ISimpleDialogMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(isInvalid(BUTTON_ENABLE_INVALID)) && Boolean(this._btnEnableCandidate))
         {
            ...
            while(_loc6_ < _loc5_)
            {
               ...
               if(Boolean(_loc4_.data) && Boolean(_loc4_.data.hasOwnProperty(ID_FIELD)))
               {
         ...
         if(Boolean(isInvalid(BUTTON_FOCUS_INVALID)) && Boolean(this._btnFocusCandidateId))
         {
            _loc1_ = this.getAllButtons();
            for each(_loc7_ in _loc1_)
            {
               if(Boolean(_loc7_.data) && Boolean(_loc7_.data.hasOwnProperty(ID_FIELD)) && this._btnFocusCandidateId == _loc7_.data.id)
               {
                  if(_loc7_.enabled)
                  {
      ...
      {
         var _loc1_:Number = Number(this.thirdBtn.height);
