package net.wg.infrastructure.helpers.statisticsDataController
{
   ...
   public class BattleStatisticDataController extends BattleStatisticDataControllerMeta implements IBattleStatisticDataControllerMeta, IDAAPIModule, IQuestProgressDataHub
   {
      ...
      protected var _componentControllers:Vector.<IBattleComponentDataController> = new Vector.<IBattleComponentDataController>();
      
      protected var _tabControllers:Vector.<IBattleTabDataController> = new Vector.<IBattleTabDataController>();
      
      private var _questProgressViews:Vector.<IQuestProgressViewUpdatable> = new Vector.<IQuestProgressViewUpdatable>(0);
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._questProgressData))
         {
      ...
      final public function setDisplayObjectContainer(param1:DisplayObjectContainer) : void
      {
         this._container = param1;
      }
      ...
      {
         return this._questProgressData != null && Boolean(this._questProgressData.isActiveData);
      }
