package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleRoyaleFullStatsMeta extends BattleDisplayable
   {
      ...
      {
         if(Boolean(this._battleRoyaleFullStatsVO))
         {
            this._battleRoyaleFullStatsVO.dispose();
            this._battleRoyaleFullStatsVO = null;
         }
         if(Boolean(this._battleRoyaleNationsVehiclesCounterVO))
         {
      ...
      final public function as_updateVehiclesCounter(param1:Object) : void
      {
