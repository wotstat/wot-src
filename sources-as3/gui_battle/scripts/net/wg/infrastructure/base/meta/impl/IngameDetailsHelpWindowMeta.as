package net.wg.infrastructure.base.meta.impl
{
   ...
   public class IngameDetailsHelpWindowMeta extends AbstractWindowView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._ingameDetailsPageVO))
         {
      ...
      final public function as_setPaginatorData(param1:Array) : void
      {
      ...
      final public function as_setPageData(param1:Object) : void
      {
