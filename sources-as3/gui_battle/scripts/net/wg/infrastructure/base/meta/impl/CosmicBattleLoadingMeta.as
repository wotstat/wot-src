package net.wg.infrastructure.base.meta.impl
{
   ...
   public class CosmicBattleLoadingMeta extends BaseBattleLoading
   {
      
      private var _vectorString:Vector.<String>;
      
      public function CosmicBattleLoadingMeta()
      {
         super();
      }
      ...
      final public function as_setTips(param1:Array) : void
      {
