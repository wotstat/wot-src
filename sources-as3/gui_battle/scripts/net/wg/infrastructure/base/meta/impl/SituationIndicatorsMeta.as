package net.wg.infrastructure.base.meta.impl
{
   ...
   public class SituationIndicatorsMeta extends BattleDisplayable
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorPerkItemVO))
         {
         ...
         if(Boolean(this._vectorWeatherItemVO))
         {
      ...
      final public function as_setPerks(param1:Array) : void
      {
      ...
      final public function as_setWeather(param1:Array) : void
      {
