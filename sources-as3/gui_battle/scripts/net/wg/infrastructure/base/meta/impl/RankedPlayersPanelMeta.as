package net.wg.infrastructure.base.meta.impl
{
   ...
   public class RankedPlayersPanelMeta extends PlayersPanel
   {
      ...
      public function RankedPlayersPanelMeta()
      {
         super();
      }
      ...
      {
         if(Boolean(this._voiceChatActivationVO))
         {
      ...
      final public function as_setVoiceChatData(param1:Object) : void
      {
