package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BasePostmortemPanelMeta extends BattleDisplayable
   {
      ...
      final public function as_setDeadReasonInfo(param1:String, param2:Boolean, param3:String, param4:String, param5:String, param6:String, param7:Object) : void
      {
