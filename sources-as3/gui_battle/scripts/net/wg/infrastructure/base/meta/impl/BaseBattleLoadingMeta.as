package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BaseBattleLoadingMeta extends BattleDisplayable
   {
      ...
      {
         if(Boolean(this._eventInfoPanelVO))
         {
            this._eventInfoPanelVO.dispose();
            this._eventInfoPanelVO = null;
         }
         if(Boolean(this._visualTipInfoVO))
         {
      ...
      final public function as_setEventInfoPanelData(param1:Object) : void
      {
      ...
      final public function as_setVisualTipInfo(param1:Object) : void
      {
