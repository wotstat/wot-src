package net.wg.infrastructure.base.meta.impl
{
   ...
   public class PostmortemPanelMeta extends BasePostmortemPanel
   {
      ...
      {
         if(Boolean(this._dogTagVO))
         {
            this._dogTagVO.dispose();
            this._dogTagVO = null;
         }
         if(Boolean(this._dogTagVO1))
         {
      ...
      final public function as_showKillerDogTag(param1:Object, param2:Boolean) : void
      {
      ...
      final public function as_showVictimDogTag(param1:Object) : void
      {
      ...
      final public function as_preloadComponents(param1:Array) : void
      {
