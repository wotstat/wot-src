package net.wg.infrastructure.base.meta.impl
{
   ...
   public class MapsTrainingIngameHelpWindowMeta extends AbstractWindowView
   {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._vectorEventLoadingPageVO))
         {
      ...
      final public function as_setData(param1:Array) : void
      {
