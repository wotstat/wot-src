package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleStatisticDataControllerMeta extends BattleDAAPIComponent
   {
      ...
      final public function as_setVehiclesData(param1:Object) : void
      {
      ...
      final public function as_addVehiclesInfo(param1:Object) : void
      {
      ...
      final public function as_setQuestStatus(param1:Object) : void
      {
      ...
      final public function as_setUserTags(param1:Object) : void
      {
      ...
      final public function as_updateUserTags(param1:Object) : void
      {
         var _loc2_:DAAPIVehicleUserTagsVO = new DAAPIVehicleUserTagsVO(param1);
         this.updateUserTags(_loc2_);
      }
      
      final public function as_updateInvitationsStatuses(param1:Object) : void
      {
      ...
      final public function as_setQuestsInfo(param1:Object, param2:Boolean) : void
      {
         var _loc3_:QuestProgressVO = new QuestProgressVO(param1);
         this.setQuestsInfo(_loc3_,param2);
      }
      
      final public function as_updateQuestHeaderProgress(param1:Array) : void
      {
      ...
      final public function as_updateTriggeredChatCommands(param1:Object) : void
      {
         var _loc2_:DAAPITriggeredCommandsVO = new DAAPITriggeredCommandsVO(param1);
         this.updateTriggeredChatCommands(_loc2_);
      }
      
      final public function as_updatePriorityChatCommand(param1:Object) : void
      {
