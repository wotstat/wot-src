package net.wg.infrastructure.base.meta
{
   ...
   public interface IDamagePanelMeta extends IEventDispatcher
   {
      ...
      function as_setup(param1:String, param2:int, param3:String, param4:Array, param5:Array, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : void;
