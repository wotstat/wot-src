package net.wg.data.VO.daapi
{
   ...
   public class DAAPIVehicleInfoVO extends DAAPIDataClass
   {
      ...
      {
         return Boolean(this.playerFakeName) && this.playerFakeName != this.playerName;
      }
      
      public function get isCurrentPlayer() : Boolean
      {
         return Boolean(this.userTags) && Boolean(UserTags.isCurrentPlayer(this.userTags));
      }
      
      public function get isIGR() : Boolean
      {
         return this.isVehiclePremiumIgr && Boolean(this.vehicleType) && this.vehicleType != BATTLEATLAS.UNKNOWN;
      }
