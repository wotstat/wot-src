package net.wg.gui.battle.components.pointsOfInterestNotificationPanel
{
   ...
   public class PointsOfInterestNotificationPanel extends PointsOfInterestNotificationPanelMeta implements IPointsOfInterestNotificationPanelMeta
   {
      ...
      private var _tasksList:Vector.<Task> = new Vector.<Task>(0);
      
      private var _poiStatusIndicators:Vector.<PoiStatusIndicator> = new Vector.<PoiStatusIndicator>(0);
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._notificationPoiStatusIndicator))
         {
      ...
      public function as_updatePoiProgress(param1:uint, param2:uint) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(this._notificationPoiStatusIndicator != _loc3_) && _loc3_.getData().status == POI_CONSTS.POI_STATUS_CAPTURING)
         {
      ...
      {
         return Boolean(this._tasksList.length) || Boolean(this._notificationPoiStatusIndicator);
      }
      
      private function updateYPos() : void
      {
         var _loc1_:int = int(App.appHeight);
      ...
      {
         if(Boolean(this._notificationTextTween))
         {
      ...
      {
         if(Boolean(this._tfShadowTween))
         {
      ...
      private function onNotificationShowComplete() : void
      {
         ...
         if(Boolean(this._tasksList.length))
         {
