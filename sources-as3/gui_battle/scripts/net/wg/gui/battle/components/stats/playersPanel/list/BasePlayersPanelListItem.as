package net.wg.gui.battle.components.stats.playersPanel.list
{
   ...
   public class BasePlayersPanelListItem extends BattleUIComponent implements IPlayersPanelListItem
   {
      ...
      override protected function configUI() : void
      {
         ...
         if(Boolean(this.disableCommunication))
         {
      ...
      override protected function draw() : void
      {
         ...
         {
            this.badge.alpha = this._isOffline || !this.isAlive ? BADGE_ALPHA_NOT_ACTIVE : BADGE_ALPHA;
            if(Boolean(this.dogTag))
            {
      ...
      protected function updatePositions() : void
      {
         ...
         var _loc2_:int = -x;
         this.hit.x = _loc2_;
         this.hit.width = this._isRightAligned ? WIDTH + _loc2_ : WIDTH - _loc2_;
      ...
      protected function updateColors() : void
      {
         ...
         this.prestigeLevel.alpha = this.isAlive ? PRESTIGE_LEVEL_DEFAULT_ALPHA : PRESTIGE_LEVEL_DEAD_ALPHA;
         ...
         if(Boolean(_loc2_))
         {
            _loc4_ = this._isHpBarsVisible && !this._isCurrentPlayer && !this.isSquadPersonal() && !this._isTeamKiller ? ALT_TEXT_COLOR : uint(_loc2_.rgb);
            this.fragsTF.textColor = this.playerNameFullTF.textColor = this.playerNameCutTF.textColor = this.vehicleTF.textColor = _loc4_;
         }
         var _loc3_:Boolean = Boolean(App.colorSchemeMgr.getIsColorBlindS());
      ...
      {
         if(Boolean(this.dynamicSquad) && this.dynamicSquad.hitTestPoint(param1.stageX,param1.stageY))
         {
            return;
         }
