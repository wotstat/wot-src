package net.wg.gui.battle.components.stats.playersPanel.list
{
   ...
   public class BasePlayersListItemHolder implements IPlayersPanelListItemHolder
   {
      ...
      private function applyVehicleData() : void
      {
         ...
         if(Boolean(this.vehicleData.vehicleAction))
         {
      ...
      {
         return Boolean(this.vehicleData) ? this.vehicleData.vehicleID : NaN;
      }
      
      public function get accountDBID() : Number
      {
         return Boolean(this.vehicleData) ? this.vehicleData.accountDBID : NaN;
      }
      ...
      {
         return Boolean(this.vehicleData) && this.vehicleData.isCurrentPlayer;
      }
