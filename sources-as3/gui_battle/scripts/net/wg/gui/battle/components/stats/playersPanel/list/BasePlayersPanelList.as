package net.wg.gui.battle.components.stats.playersPanel.list
{
   ...
   public class BasePlayersPanelList extends Sprite implements IPlayersPanelList
   {
      ...
      protected var panelListItems:Vector.<IPlayersPanelListItem> = new Vector.<IPlayersPanelListItem>();
      
      protected var renderersContainer:Sprite = new Sprite();
      
      private var _state:int;
      
      protected var _items:Vector.<IPlayersPanelListItemHolder> = new Vector.<IPlayersPanelListItemHolder>();
      
      private var _itemsHealth:Dictionary = new Dictionary();
      
      private var _currOrder:Vector.<Number> = new Vector.<Number>();
      ...
      private var _mapHolderByVehicleID:Dictionary = new Dictionary();
      ...
      public function removeAllItems() : void
      {
         ...
         if(Boolean(this._mapHolderByVehicleID))
         {
         ...
         if(Boolean(this._currOrder))
         {
            this._currOrder.splice(0,this._currOrder.length);
         }
         if(Boolean(this.panelListItems))
         {
      ...
      public function resetFrags() : void
      {
         ...
         var _loc1_:int = int(this.panelListItems.length);
         var _loc2_:uint = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function setVehicleData(param1:Vector.<DAAPIVehicleInfoVO>) : void
      {
         ...
         if(this._currentPlayerIsAnonymized && Boolean(_loc2_))
         {
      ...
      private function onPlayersListItemOnItemClickHandler(param1:PlayersPanelItemEvent) : void
      {
         ...
         if(Boolean(this._commons.isRightButton(param1.mEvent)) && !_loc2_.isCurrentPlayer)
         {
