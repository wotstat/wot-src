package net.wg.gui.battle.components.animatedBattleHint
{
   ...
   import net.wg.infrastructure.base.meta.IAnimatedBattleHintMeta;
   import net.wg.infrastructure.base.meta.impl.AnimatedBattleHintMeta;
   import scaleform.clik.motion.Tween;
   
   public class AnimatedBattleHint extends AnimatedBattleHintMeta implements IAnimatedBattleHintMeta
   {
      ...
      public function AnimatedBattleHint()
      {
         super();
      }
         ...
         if(param1 == PENETRATION_HIGH || param1 == PENETRATION_MEDIUM || param1 == PENETRATION_LOW)
         {
            ...
            switch(param1)
            {
               case PENETRATION_HIGH:
                  this.penetrationHint.text = BATTLE_HINTS.PENETRATION_CHANCE_HIGH;
                  break;
               case PENETRATION_MEDIUM:
                  this.penetrationHint.text = BATTLE_HINTS.PENETRATION_CHANCE_MEDIUM;
                  break;
               case PENETRATION_LOW:
                  this.penetrationHint.text = BATTLE_HINTS.PENETRATION_CHANCE_LOW;
