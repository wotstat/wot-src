package net.wg.gui.battle.eventBattle.views.loading.data
{
   ...
   public class EventLoadingVO extends DAAPIDataClass
   {
      ...
      public var lessonPagesBigData:Vector.<EventLoadingPageVO> = new Vector.<EventLoadingPageVO>();
      
      public var lessonPagesSmallData:Vector.<EventLoadingPageVO> = new Vector.<EventLoadingPageVO>();
