package net.wg.gui.battle.eventBattle.views.loading.containers
{
   ...
   public class LoadingPageContainer extends Sprite implements IDisposable
   {
      ...
      public function LoadingPageContainer()
      {
         super();
      }
      ...
      public function setData(param1:EventLoadingPageVO) : void
      {
