package net.wg.gui.battle.eventBattle.views.eventPlayersPanel
{
   ...
   public class EventPlayersPanel extends EventPlayersPanelMeta implements IEventPlayersPanelMeta
   {
      ...
      {
         var _loc1_:int = 0;
         if(Boolean(this._playerRendererContainer))
         {
      ...
      private function clearPlayersPanelListItems() : void
      {
         ...
         if(Boolean(this._playersPanelListItems))
         {
      ...
      {
         var _loc2_:int = int(this._playersPanelListItems.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      {
         this._pointsCount = 0;
         var _loc1_:int = int(this._playersPanelListItems.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
