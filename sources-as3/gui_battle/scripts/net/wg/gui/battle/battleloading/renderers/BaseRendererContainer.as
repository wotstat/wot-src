package net.wg.gui.battle.battleloading.renderers
{
   ...
   public class BaseRendererContainer extends Sprite implements IDisposable
   {
      ...
      protected function onDispose() : void
      {
         ...
         if(Boolean(this.prestigeLevelsEnemy))
         {
         ...
         if(Boolean(this.icoIGRsAlly))
         {
            this.icoIGRsAlly.length = 0;
            this.icoIGRsAlly = null;
         }
         if(Boolean(this.icoIGRsEnemy))
         {
