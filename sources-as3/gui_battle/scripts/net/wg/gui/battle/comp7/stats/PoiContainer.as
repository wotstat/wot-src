package net.wg.gui.battle.comp7.stats
{
   ...
   public class PoiContainer extends BattleUIComponent
   {
      ...
      private var _pois:Vector.<PoiProgressCircleWrapper> = new Vector.<PoiProgressCircleWrapper>();
      
      private var _poisDict:Dictionary = new Dictionary();
      
      private var _poisXTween:Vector.<Tween> = new Vector.<Tween>();
