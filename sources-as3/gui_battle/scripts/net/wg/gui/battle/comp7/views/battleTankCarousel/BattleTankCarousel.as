package net.wg.gui.battle.comp7.views.battleTankCarousel
{
   ...
   public class BattleTankCarousel extends Comp7BattleTankCarouselMeta implements IComp7BattleTankCarouselMeta
   {
      ...
      {
         if(Boolean(isDisposed()) || param1 == width)
         {
            return;
         }
         width = param1;
      ...
      {
         var _loc2_:Boolean = Boolean(this._tween) && Boolean(this._tween.paused);
      ...
      private function updateScrollListSettings() : void
      {
         ...
         _loc1_ = int(this._helper.rowCount);
      ...
      {
         if(visible == param1 || Boolean(isDisposed()))
         {
            return;
         }
         if(Boolean(this.vehicleFilters))
         {
