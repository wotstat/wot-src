package net.wg.gui.battle.random.views.stats.components.fullStats.tableItem
{
   ...
   public class DynamicSquadCtrl extends DogTagCtrl implements IClickButtonHandler, IRollOutButtonHandler
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.STATE | SquadInvalidationType.SQUAD_NO_SOUND) && Boolean(this._noSoundSpr))
         {
      ...
      private function updateTooltip() : void
      {
         ...
         var _loc2_:Boolean = !_loc1_ && this._isCurrentPlayerAnonymized && Boolean(this._toolTipString);
         if(this._isMouseOver && Boolean(this._activePlayerData))
         {
