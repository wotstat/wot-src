package net.wg.gui.battle.ranked.stats.components
{
   ...
   public class RankedVoiceChatActivation extends BattleUIComponent
   {
      ...
      public function RankedVoiceChatActivation()
      {
         super();
         visible = false;
      }
