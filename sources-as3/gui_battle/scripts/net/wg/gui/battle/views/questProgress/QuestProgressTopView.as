package net.wg.gui.battle.views.questProgress
{
   ...
   public class QuestProgressTopView extends QuestProgressTopViewMeta implements IQuestProgressTopViewMeta
   {
      ...
      {
         return param1 != null && Boolean(param1.isHiddenInBattleHud);
      }
      ...
      public function unlock() : void
      {
         ...
         if(!_loc1_)
         {
            _loc2_ = Boolean(items) ? int(items.length) : 0;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      {
         this.separator.visible = this._isQPVisibleBySettings && this._separatorPositionAfterTaskIndex != Values.DEFAULT_INT && (Boolean(items) && items.length > 1);
      }
      ...
      private function layoutOrItems() : void
      {
         ...
         if(Boolean(orItems))
         {
            ...
            {
               _loc1_.visible = Boolean(_loc1_.item.visible) && Boolean(_loc1_.previousItem.visible);
               if(_loc1_.visible)
               {
      ...
      private function onFlagShowAnimCompleted() : void
      {
         ...
         if(Boolean(orItems))
         {
            ...
            for each(_loc2_ in orItems)
            {
               _loc2_.visible = Boolean(_loc2_.item.visible) && Boolean(_loc2_.previousItem.visible);
               if(_loc2_.visible)
               {
      ...
      {
         if(Boolean(this._flagTween))
         {
            this._flagTween.dispose();
            this._flagTween = null;
         }
         if(Boolean(this._separatorTween))
         {
         ...
         if(Boolean(this._orItemsTween))
         {
            _loc1_ = int(this._orItemsTween.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
