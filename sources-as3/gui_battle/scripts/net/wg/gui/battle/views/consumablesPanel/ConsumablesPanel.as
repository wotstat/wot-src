package net.wg.gui.battle.views.consumablesPanel
{
   ...
   public class ConsumablesPanel extends ConsumablesPanelMeta implements IConsumablesPanel, IStageSizeDependComponent
   {
      ...
      private var _renderers:Vector.<IConsumablesButton> = new <IConsumablesButton>[null,null,null,null,null,null,null,null,null,null,null,null];
      ...
      private var _settings:Vector.<ConsumablesPanelSettings> = new Vector.<ConsumablesPanelSettings>();
