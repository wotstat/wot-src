package net.wg.gui.battle.views.damagePanel.components.modules
{
   ...
   public class ModulesCtrl implements IDamagePanelItemsCtrl
   {
      ...
      public function reset() : void
      {
         ...
         if(Boolean(this._yohChassisState))
         {
      ...
      public function setChassis(param1:Boolean, param2:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(Boolean(this._chassis) && this._modules.indexOf(this._chassis) != -1)
            {
         ...
         else
         {
            ...
            if(Boolean(this._wheel) && this._modules.indexOf(this._wheel) != -1)
            {
      ...
      public function setModuleRepairing(param1:String, param2:int, param3:int, param4:int = 0) : void
      {
         ...
         if(!this._isDestroyed)
         {
            ...
            if(Boolean(VehicleModules.isTrack(param1)) || Boolean(VehicleModules.isWheel(param1)))
            {
               if(this._hasYoh)
               {
                  this._yohChassisState.updateRepairTime(param1,param3,param2);
                  _loc6_ = this._yohChassisState.getHigherRepairTimePart();
                  param2 = _loc6_ != null ? _loc6_.repairPercent : 0;
                  param3 = _loc6_ != null ? _loc6_.repairTime : 0;
      ...
      private function checkWheelChassisDestroyed() : String
      {
         ...
         if(Boolean(this._lastBrokenChassisDevice) || Boolean(this._lastDestroyedChassisDevice))
         {
...
class YohChassisState implements IDisposable
{
   ...
   public var leftTrack0:PartState = new PartState();
   
   public var rightTrack0:PartState = new PartState();
   
   public var leftTrack1:PartState = new PartState();
   
   public var rightTrack1:PartState = new PartState();
