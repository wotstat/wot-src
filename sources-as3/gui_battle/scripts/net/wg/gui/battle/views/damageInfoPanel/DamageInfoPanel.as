   ...
   public class DamageInfoPanel extends DamageInfoPanelMeta implements IDamageInfoPanelMeta
   {
      ...
      override protected function show(param1:Array, param2:int, param3:Boolean) : void
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc6_ = int(_loc4_[DAMAGE_INFO_PANEL_CONSTS.STATE_ID]);
      ...
      private function updateDevicesPosition() : void
      {
         ...
         if(Boolean(this.gun.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.gun.updateXPos(_loc1_);
         }
         if(Boolean(this.turretRotator.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.turretRotator.updateXPos(_loc1_);
         }
         if(Boolean(this.surveyingDevice.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.surveyingDevice.updateXPos(_loc1_);
         }
         if(Boolean(this.wheel.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.wheel.updateXPos(_loc1_);
         }
         if(Boolean(this.engine.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.engine.updateXPos(_loc1_);
         }
         if(Boolean(this.fuelTank.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.fuelTank.updateXPos(_loc1_);
         }
         if(Boolean(this.radio.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.radio.updateXPos(_loc1_);
         }
         if(Boolean(this.ammoBay.stateId))
         {
            _loc1_ -= ITEM_WIDTH;
            this.ammoBay.updateXPos(_loc1_);
         }
         if(Boolean(this.leftTrack.stateId) || this.leftTrack.hasForcedNormalDisplay)
         {
            _loc1_ -= this._hasMultitrack ? ITEM_WIDTH + MULTITRACK_ITEM_OFFSET : ITEM_WIDTH;
            this.leftTrack.updateXPos(_loc1_);
         }
         if(Boolean(this.secondLeftTrack.stateId) || this.secondLeftTrack.hasForcedNormalDisplay)
         {
            this.secondLeftTrack.updateXPos(_loc1_ + MULTITRACK_ITEM_OFFSET);
         }
         if(Boolean(this.rightTrack.stateId) || this.rightTrack.hasForcedNormalDisplay)
         {
            _loc1_ -= ITEM_WIDTH;
            this.rightTrack.updateXPos(_loc1_);
         }
         if(Boolean(this.secondRightTrack.stateId) || this.secondRightTrack.hasForcedNormalDisplay)
         {
      ...
      {
         var _loc1_:int = DAMAGE_INFO_PANEL_CONSTS.ITEM_START_X;
         if(Boolean(this.commander.stateId))
         {
            this.commander.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.firstGunner.stateId))
         {
            this.firstGunner.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.secondGunner.stateId))
         {
            this.secondGunner.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.driver.stateId))
         {
            this.driver.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.firstRadioman.stateId))
         {
            this.firstRadioman.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.secondRadioman.stateId))
         {
            this.secondRadioman.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.firstLoader.stateId))
         {
            this.firstLoader.updateXPos(_loc1_);
            _loc1_ += ITEM_WIDTH;
         }
         if(Boolean(this.secondLoader.stateId))
         {
