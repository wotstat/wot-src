package net.wg.gui.battle.views.vehicleMessages
{
   ...
   public class VehicleMessages extends MessageListDAAPI
   {
      ...
      private function prepareReplayMessage() : void
      {
         ...
         if(Boolean(_loc1_ && _loc1_.key.indexOf(REPLAY_SUBSTR) == 0) && Boolean(_loc1_.key.indexOf(REPLAY_HELP_SUBSTR) == -1) && this.calcShowedLinesCount() >= this._renderersPool.capacity)
         {
      ...
      {
         if(Boolean(this._dataQueue))
         {
            this._dataQueue.dispose();
            this._dataQueue = null;
         }
         if(Boolean(this._renderersPool))
         {
      ...
      override protected function rearrangeMessages() : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc1_:int = int(messages.length);
         if(Boolean(_loc1_))
         {
