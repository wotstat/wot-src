package net.wg.gui.battle.views.questProgress.animated
{
   ...
   public class QuestProgressQueueAnimAbstract extends EventDispatcher implements IQueueAnimControllerItem
   {
      ...
      final public function onAnimStartCallback() : void
      {
         this.onAnimStart();
      }
      
      final public function onAnimStartSndCallBack(param1:String) : void
      {
         this.onAnimStartSnd(param1);
      }
      
      final public function onAnmCompleteCallback() : void
      {
         this.onAnimCompleted();
      }
      
      final public function onPreCompletedCallBack() : void
      {
         this.onPreCompletedAnim();
      }
      
      final public function run(param1:Function) : void
      {
         if(param1 == null)
         {
