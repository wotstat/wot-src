package net.wg.gui.battle.views.stats.fullStats
{
   ...
   public class StatsTableItemCommon extends StatsTableItemBase
   {
      ...
      public function StatsTableItemCommon(param1:MovieClip, param2:int, param3:int)
      {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(FullStatsValidationType.COLORS))
         {
            ...
            if(Boolean(_loc2_) && Boolean(_loc2_.colorTransform))
            {
               this._vehicleIcon.transform.colorTransform = _loc2_.colorTransform;
            }
            this._prestigeLevel.alpha = isDead ? PRESTIGE_LEVEL_DEAD_ALPHA : PRESTIGE_LEVEL_DEFAULT_ALPHA;
         }
         ...
         {
            if(Boolean(this._vehicleIconName))
            {
