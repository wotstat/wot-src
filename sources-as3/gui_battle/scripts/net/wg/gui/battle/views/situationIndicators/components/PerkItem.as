package net.wg.gui.battle.views.situationIndicators.components
{
   ...
   public class PerkItem extends BattleUIComponent
   {
      ...
      {
         if(Boolean(this._progressTween))
         {
      ...
      private function hide() : void
      {
         ...
         var _loc2_:int = int(this._frameHelper.getFrameByLabel(_loc1_ + END_FRAME));
      ...
      {
         var _loc1_:int = int(this._frameHelper.getFrameByLabel(SHOW_FRAME + END_FRAME));
