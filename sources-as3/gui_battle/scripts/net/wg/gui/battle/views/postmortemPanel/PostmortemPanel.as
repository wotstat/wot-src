package net.wg.gui.battle.views.postmortemPanel
{
   ...
   public class PostmortemPanel extends PostmortemPanelMeta implements IPostmortemPanelMeta
   {
      ...
      {
         super.draw();
         if(Boolean(this.postmortemInfoPanel))
         {
         ...
         if(isInvalid(INVALID_VEHICLE_PANEL))
         {
            ...
            if(Boolean(_userName) && Boolean(_userName.userVO) && _userName.userVO.userName != Values.EMPTY_STR)
            {
               this.showPanel();
            }
         }
      ...
      public function animateVictimDogTag() : void
      {
         ...
         if(Boolean(this._victimDogTagTweenIn))
         {
            this._victimDogTagTweenIn.paused = true;
         }
         if(Boolean(this._victimDogTagTweenOut))
         {
      ...
      {
         var _loc1_:Boolean = Boolean(this._colorSchemeMgr.getIsColorBlindS());
         if(_loc1_)
         {
