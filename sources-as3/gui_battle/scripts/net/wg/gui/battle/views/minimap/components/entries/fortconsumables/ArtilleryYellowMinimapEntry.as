package net.wg.gui.battle.views.minimap.components.entries.fortconsumables
{
   ...
   public class ArtilleryYellowMinimapEntry extends BattleUIComponent
   {
      ...
      public function ArtilleryYellowMinimapEntry()
      {
         super();
      }
      ...
      {
         super.configUI();
         this._atlasManager.drawGraphics(ATLAS_CONSTANTS.BATTLE_ATLAS,FortConsumablesMinimapEntryConst.ARTILLERY_YELLOW_ATLAS_ITEM_NAME,this.atlasPlaceholder.graphics,EpicMinimapEntryConst.EMPTY_DOUBLE_STR,true);
      }
