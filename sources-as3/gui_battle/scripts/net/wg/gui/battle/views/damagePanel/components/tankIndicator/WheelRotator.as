package net.wg.gui.battle.views.damagePanel.components.tankIndicator
{
   ...
   public class WheelRotator extends SPGRotator
   {
      ...
      private var _wheels:Vector.<Wheel> = new Vector.<Wheel>(0);
      ...
      {
         super.reset();
         var _loc1_:int = int(this._wheels.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      {
         var _loc2_:Number = param1 ? SLAVE_WHEEL_ALPHA : Number(Values.DEFAULT_ALPHA);
