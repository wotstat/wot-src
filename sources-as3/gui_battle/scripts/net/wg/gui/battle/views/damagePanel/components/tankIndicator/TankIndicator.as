   ...
   public class TankIndicator extends BattleUIComponent
   {
      ...
      public function setModuleState(param1:String, param2:String) : void
      {
         ...
         else if(this.isVehicleWithTurret)
         {
            ...
            {
               _loc3_ = Boolean(VehicleModules.checkIsInTurret(param1));
               if(_loc3_)
               {
                  this._turretTank.setModuleState(param1,param2);
               }
      ...
      public function get isAnyTrackCritical() : Boolean
      {
         ...
         if(Boolean(this._hull))
         {
            ...
            while(_loc2_ < _loc1_)
            {
               ...
               if(Boolean(VehicleModules.isTrack(_loc3_.name)) && _loc3_.state == BATTLE_ITEM_STATES.CRITICAL)
               {
                  return true;
               }
               _loc2_++;
