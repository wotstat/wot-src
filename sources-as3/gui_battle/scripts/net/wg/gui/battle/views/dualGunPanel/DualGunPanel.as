package net.wg.gui.battle.views.dualGunPanel
{
   ...
   public class DualGunPanel extends DualGunPanelMeta implements IDualGunPanelMeta
   {
      ...
      private var _gunIndicators:Vector.<DualGunPanelGunIndicator> = new Vector.<DualGunPanelGunIndicator>(0);
      
      private var _activeTimers:Vector.<String> = new Vector.<String>();
      ...
      public function as_updateActiveGun(param1:int, param2:Number, param3:Number) : void
      {
         ...
         var _loc6_:int = int(this._gunIndicators.length);
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
      ...
      private function updatePanelTimer() : void
      {
         ...
         var _loc7_:Number = Number(Values.ZERO);
         if(_loc5_.isRunning)
         {
            _loc6_ = DualGunPanelTimer.STYLE_DEBUFF;
            _loc7_ = Number(_loc5_.timeLeft);
         }
         else if(_loc4_.isRunning)
         {
            _loc6_ = DualGunPanelTimer.STYLE_CHARGE;
            _loc7_ = Number(_loc4_.timeLeft);
         }
         else if(Boolean(_loc2_.isRunning) || Boolean(_loc3_.isRunning))
         {
         ...
         {
            _loc7_ = Number(this.getTimerById(RELOADING_TIMERS[this._activeGunId]).totalTime);
