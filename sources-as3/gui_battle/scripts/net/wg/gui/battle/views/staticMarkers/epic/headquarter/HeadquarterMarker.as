package net.wg.gui.battle.views.staticMarkers.epic.headquarter
{
   ...
   public class HeadquarterMarker extends BattleUIComponent
   {
      ...
      private function setHealthBarHeight(param1:Boolean) : void
      {
         ...
         this.squadHitLabel.y = this.playerHitLabel.isActive() ? this.playerHitLabel.y + EXTRA_HIT_LABEL_Y_OFFSET : this.playerHitLabel.y;
         this.otherHitLabel.y = this.squadHitLabel.isActive() ? this.squadHitLabel.y + EXTRA_HIT_LABEL_Y_OFFSET : this.squadHitLabel.y;
      }
