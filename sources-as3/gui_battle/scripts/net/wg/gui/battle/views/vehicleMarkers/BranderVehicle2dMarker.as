package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class BranderVehicle2dMarker extends BaseActionMarker implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      private function updateMarkerSettings() : void
      {
         ...
         §§push(this);
         var _temp_3:* = new <Boolean>[_loc1_ || _loc2_,_loc4_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()];
         §§pop().layoutParts(new <Boolean>[_loc1_ || _loc2_,_loc4_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()]);
      }
