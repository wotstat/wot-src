package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class BranderVehicle2dMarker extends BaseActionMarker implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
         ...
         if(this._isPopulated)
         {
            ...
            if(this.getIsPartVisible(DAMAGE_PANEL))
            {
               if(_loc5_ > 0)
               {
                  ...
                  this.squadHitLabel.y = this.playerHitLabel.isActive() ? this.playerHitLabel.y + VehicleMarker.EXTRA_HIT_LABEL_OFFSET_Y : this.playerHitLabel.y;
                  this.otherHitLabel.y = this.squadHitLabel.isActive() ? this.squadHitLabel.y + VehicleMarker.EXTRA_HIT_LABEL_OFFSET_Y : this.squadHitLabel.y;
               }
      ...
      private function updateCriticalLayout() : void
      {
         ...
         var _loc3_:int = Boolean(_loc1_) ? BLOCK_HORIZONTAL_OFFSET : START_HORIZONTAL_OFFSET;
      ...
      private function updateMarkerSettings() : void
      {
         ...
         §§push(this);
         var _temp_2:* = new <Boolean>[_loc1_ || _loc2_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()];
         §§pop().layoutParts(new <Boolean>[_loc1_ || _loc2_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()]);
      }
      ...
      private function layoutParts(param1:Vector.<Boolean>) : void
      {
         ...
         var _loc3_:int = int(this._markerParts.length);
      ...
      private function setupSquadIcon() : void
      {
         ...
         if(Boolean(this._model.squadIndex))
         {
