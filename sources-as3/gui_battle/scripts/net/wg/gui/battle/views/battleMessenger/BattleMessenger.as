package net.wg.gui.battle.views.battleMessenger
{
   ...
   public class BattleMessenger extends BattleMessengerMeta implements IBattleMessenger
   {
      ...
      public var swapArea:Sprite = new Sprite();
      
      private var _swapAreaHit:Sprite;
      
      private var _appStage:Stage = App.stage;
      
      private var _messagesContainer:Sprite = new Sprite();
      
      private var _receiverIdx:int = 0;
      
      private var _receivers:Vector.<BattleMessengerReceiverVO> = new Vector.<BattleMessengerReceiverVO>();
      ...
      private var _messages:Vector.<BattleMessage> = new Vector.<BattleMessage>();
      ...
      private var _battleSmileyMap:BattleSmileyMap = new BattleSmileyMap();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._userInteractionCmp))
         {
      ...
      public function updateSwapAreaHeight(param1:Number) : void
      {
         ...
         drawRect(this.swapArea,0,0,this._isSmallState ? BOTTOM_SIDE_WIDTH : BattleMessage.DEFAULT_TEXT_WIDTH,param1 - BOTTOM_SIDE_Y_POSITION,false);
      ...
      private function updateReceivers() : void
      {
         ...
         var _loc1_:int = int(this._receivers.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function pushMessage(param1:BattleMessage) : void
      {
         ...
         if(_loc2_ > 1 && (_loc3_ || Boolean(App.contextMenuMgr.isShown())))
         {
      ...
      {
         var _loc2_:int = int(this._messages.length);
      ...
      private function updateTopMesState() : void
      {
         ...
         {
            _loc1_ = this._isTopMessageVisible ? BattleMessage.STATE_VISIBLE_WHEEL_MES : BattleMessage.STATE_HIDEHALF_MES;
      ...
      private function showMessageByIndex(param1:int) : void
      {
         ...
         var _loc3_:int = param1 == this._topMessageIndex && this._topMessageIndex != 0 ? BattleMessage.STATE_HIDEHALF_MES : BattleMessage.STATE_VISIBLE_WHEEL_MES;
      ...
      private function showLastIndexMessages() : void
      {
         ...
         var _loc2_:int = int(this._messages.length);
         var _loc3_:int = this._isFocused || this._isCtrlButtonPressed ? BattleMessage.STATE_VISIBLE_MES : BattleMessage.STATE_RECOVERED_MES;
         this._bottomMessageIndex = _loc2_ - 1;
      ...
      {
         if(Boolean(param1) && Boolean(this._messages.length > 0) && this._isMessengerOver)
         {
