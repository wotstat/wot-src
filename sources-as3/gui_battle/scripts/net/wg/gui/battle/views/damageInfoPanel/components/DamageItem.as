package net.wg.gui.battle.views.damageInfoPanel.components
{
   ...
   public class DamageItem extends BattleUIComponent
   {
      ...
      private var _switcherBitmap:Bitmap = new Bitmap();
      
      private var _switcherEffectBitmap:Bitmap = new Bitmap();
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._switcherBitmap.bitmapData))
         {
         ...
         if(Boolean(this._switcherEffectBitmap.bitmapData))
         {
