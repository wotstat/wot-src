package net.wg.gui.battle.views.mapInfoTip
{
   ...
   public class MapInfoTip extends MapInfoTipMeta implements IMapInfoTipMeta
   {
      ...
      public function updateLayout(param1:Number) : void
      {
         ...
         this.mapInfoTipTF.width = _loc2_ ? MAP_INFO_WIDTH_SMALL : MAP_INFO_WIDTH_BIG;
         ...
         this.mapInfoTipTF.y = this.mapInfoTipTF.height > MAP_INFO_LINE_HEIGHT ? OFFSET_MAP_INFO_Y_LARGE : OFFSET_MAP_INFO_Y;
      }
