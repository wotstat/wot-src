package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class Comp7VehicleMarker extends VehicleMarker
   {
      ...
      override protected function showHitLabelAnim(param1:int, param2:String, param3:uint) : void
      {
         ...
         squadHitLabel.y = playerHitLabel.isActive() ? playerHitLabel.y + EXTRA_HIT_LABEL_OFFSET_Y : playerHitLabel.y;
         otherHitLabel.y = squadHitLabel.isActive() ? squadHitLabel.y + EXTRA_HIT_LABEL_OFFSET_Y : squadHitLabel.y;
      }
      ...
      {
         if(isStickyAndOutOfScreen || Boolean(!vehicleDestroyed && model) && Boolean(model.speaking))
         {
            return false;
         }
      ...
      {
         if(this.checkModelExists() && Boolean(StringUtils.isNotEmpty(model.vClass)))
         {
      ...
      private function updatePlayerLoadedStatus() : void
      {
         ...
         if(this.checkModelExists())
         {
            _loc1_ = model.isPlayerLoaded ? 1 : PLAYER_NOT_LOADED_ALPHA;
