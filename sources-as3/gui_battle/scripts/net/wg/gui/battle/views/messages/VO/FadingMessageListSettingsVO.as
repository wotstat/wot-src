package net.wg.gui.battle.views.messages.VO
{
   ...
   public class FadingMessageListSettingsVO extends MessageListSettingsVO
   {
      ...
      public var alphaSpeed:int = 0;
      
      public var useHtml:Boolean = false;
      
      public var textRightPadding:Number = 0;
      
      public var textBottomPadding:Number = 0;
      ...
      override protected function onDispose() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(this.poolSettings))
         {
            _loc2_ = int(this.poolSettings.length);
            _loc1_ = 0;
            while(_loc1_ < _loc2_)
            {
