package net.wg.gui.battle.views.damagePanel
{
   ...
   public class DamagePanel extends DamagePanelMeta implements IDamagePanelMeta
   {
      ...
      private var _cruiseVector:Vector.<BattleAtlasSprite> = new Vector.<BattleAtlasSprite>();
      
      private var _cruiseStateShift:int = 2;
      
      private var _speed:int = -1;
      
      private var _cruiseCurrentStateId:int = this._cruiseStateShift;
      
      private var _cruiseNewStateId:int = this._cruiseCurrentStateId;
      ...
      public function as_updateDeviceState(param1:String, param2:String) : void
      {
         if(VehicleModules.checkModuleName(param1))
         {
            ...
            if(param2 == BATTLE_ITEM_STATES.NORMAL && Boolean(VehicleModules.isTrack(param1)) && this.tankIndicator.isAnyTrackCritical)
            {
