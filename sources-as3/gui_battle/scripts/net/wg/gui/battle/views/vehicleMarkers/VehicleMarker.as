package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class VehicleMarker extends BattleUIComponent implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      private var _insertedPart:Dictionary = new Dictionary();
      
      private var _insertedPartsSorted:Vector.<VehicleMarkerPart> = new Vector.<VehicleMarkerPart>(0);
      ...
      protected function updatePartsVisibility() : Vector.<Boolean>
      {
         ...
         var _temp_2:* = new <Boolean>[_loc5_ || _loc6_,_loc3_,_loc4_,_loc2_,_loc1_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible];
      ...
      protected function updateCriticalLayout() : void
      {
         ...
         var _loc2_:int = Boolean(_loc1_) ? int(_loc1_.damageLabel.textWidth) : 0;
      ...
      private function updateVehicleMarkerHover() : void
      {
         ...
         {
            if(Boolean(_loc2_.part.visible))
            {
               _loc1_ = true;
               break;
            }
      ...
      {
         this.hpField.textColor = this.isObserver ? this.vmManager.getRGB(this._markerSchemeName) : uint(VEHICLE_DESTROY_COLOR);
      }
      ...
      private function getHealthPercents() : int
      {
         ...
         return _loc1_ <= MAX_HEALTH_PERCENT ? _loc1_ : int(MAX_HEALTH_PERCENT);
      }
