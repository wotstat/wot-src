package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class VehicleMarker extends BattleUIComponent implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      protected var offsets:Array = [-2,-2,1,1,1,-20,1,1,0,0,-66,-150];
      ...
      protected function updatePartsVisibility() : Vector.<Boolean>
      {
         ...
         this.statTrack.visible = this.isStickyAndOutOfScreen ? false : this.statTrack.isAnimationPlaying();
         this.actionMarker.visible = !this.statTrack.visible;
         this.vehicleMarkerHoverMC.visible = this.statTrack.visible ? false : this._isVehicleHoverVisible;
         ...
         var _temp_4:* = new <Boolean>[_loc5_ || _loc6_,_loc3_,_loc4_,_loc2_,_loc1_,_loc8_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.visible && this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible,this.statTrack.visible];
         var _temp_14:* = new <Boolean>[_loc5_ || _loc6_,_loc3_,_loc4_,_loc2_,_loc1_,_loc8_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.visible && this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible,this.statTrack.visible];
      ...
      protected function layoutParts(param1:Vector.<Boolean>) : void
      {
         ...
         var _loc3_:int = int(this.markerParts.length);
      ...
      {
         if(param1 && Boolean(StringUtils.isNotEmpty(this._objectiveActionMarker)))
         {
      ...
      protected function updateHitLayout() : void
      {
         ...
         var _loc2_:int = _loc1_ ? int(this.hitLabel.damageLabel.textWidth) : 0;
      ...
      private function setHealthText() : void
      {
         ...
         var _loc2_:int = int(this.markerSettings[MARKER + (this.exInfo ? ALT : BASE) + HEALTH_LBL]);
         switch(_loc2_)
         {
      ...
      public function get markerSettings() : Object
      {
         ...
         if(Boolean(this._markerSettingsOverride))
         {
