package net.wg.gui.battle.views.situationIndicators.components
{
   ...
   public class WeatherItem extends BattleUIComponent
   {
      ...
      private var _weatherName:String = String.prototype;
      ...
      {
         var _loc1_:int = int(this._frameHelper.getFrameByLabel(HIDE_END_FRAME));
      ...
      {
         var _loc1_:int = int(this._frameHelper.getFrameByLabel(SHOW_END_FRAME));
