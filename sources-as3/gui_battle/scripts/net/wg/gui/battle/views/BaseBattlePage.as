package net.wg.gui.battle.views
{
   ...
   public class BaseBattlePage extends BattlePageMeta implements IBattlePageMeta
   {
      ...
      protected var hitTestFix:Sprite = new Sprite();
      
      protected var excludedComponentAliases:Vector.<String> = new Vector.<String>();
      ...
      override public function updateStage(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(this.piercingDebugPanel))
         {
      ...
      override protected function configUI() : void
      {
         ...
         if(this.prebattleAmmunitionPanelAvailable && Boolean(this.prebattleAmmunitionPanel))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         if(Boolean(this._messagesContainer))
         {
      ...
      {
         if(Boolean(this.postmortemTips) && this.postmortemTips.visible)
         {
      ...
      protected function updateAmmunitionPanelY() : void
      {
         if(Boolean(this.prebattleAmmunitionPanel))
         {
            this.prebattleAmmunitionPanel.setYPos(Boolean(this.battleLoading) && this.prebattleAmmunitionPanel.isInLoading ? int(this.battleLoading.getContentY() + this.getAmmunitionPanelYShift()) : int(_originalHeight - this.prebattleAmmunitionPanel.height + this.getLoadedPrebattleAmmoPanelYShift()));
         }
      }
      ...
      {
         return this.prebattleAmmunitionPanelAvailable && Boolean(this.prebattleAmmunitionPanel) && !this.prebattleAmmunitionPanel.isHidden;
      }
