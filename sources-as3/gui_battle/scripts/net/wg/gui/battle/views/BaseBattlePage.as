package net.wg.gui.battle.views
{
   ...
   public class BaseBattlePage extends BattlePageMeta implements IBattlePageMeta
   {
      ...
      override public function updateStage(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(this.prebattleTimer))
         {
         ...
         if(Boolean(this.situationIndicatorsPanel))
         {
         ...
         if(Boolean(this.sixthSense))
         {
            this.sixthSense.x = _loc3_;
            this.sixthSense.y = param2 >> 2;
         }
         if(Boolean(this.unspotted))
         {
         ...
         if(Boolean(this.deathCamHud))
         {
            this.deathCamHud.updateStage(param1,param2);
         }
         if(Boolean(this.spectatorViewUI))
         {
            this.spectatorViewUI.updateStage(param1,param2);
         }
         if(Boolean(this.postmortemPanelUI))
         {
      ...
      {
         if(Boolean(this.postmortemPanelUI) && this.postmortemPanelUI.visible)
         {
      ...
      protected function updateAmmunitionPanelY() : void
      {
         ...
         if(Boolean(this.prebattleAmmunitionPanel))
         {
            _loc1_ = Boolean(this.battleLoading) ? this.battleLoading.getContentY() : 0;
