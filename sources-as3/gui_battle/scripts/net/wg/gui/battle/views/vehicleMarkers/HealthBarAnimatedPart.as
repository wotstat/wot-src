package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class HealthBarAnimatedPart extends BattleUIComponent
   {
      ...
      {
         var _loc1_:int = int(currentScene.labels[ACTIVE_LABEL_INDEX].frame);
         addFrameScript(_loc1_,this.tweenCompleteShowTrue);
         _loc1_ = int(currentScene.labels[INACTIVE_LABEL_INDEX].frame);
         addFrameScript(_loc1_,this.tweenCompleteShowFalse);
         _loc1_ = int(currentScene.labels[BLINK_END_LABEL_INDEX].frame);
         addFrameScript(_loc1_,this.tweenCompleteShowFalse);
      }
