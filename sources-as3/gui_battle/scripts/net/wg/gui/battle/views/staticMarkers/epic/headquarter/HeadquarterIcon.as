package net.wg.gui.battle.views.staticMarkers.epic.headquarter
{
   ...
   public class HeadquarterIcon extends BattleIconHolder
   {
      ...
      private var _vmManager:VehicleMarkersManager = VehicleMarkersManager.getInstance();
      ...
      public function setColor() : void
      {
         ...
         var _loc1_:Boolean = this._isHudElement ? Boolean(App.colorSchemeMgr.getIsColorBlindS()) : this._vmManager.isColorBlind;
