package net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list
{
   ...
   public class PlayersPanelListItemHolder implements IPlayersPanelListItemHolder
   {
      ...
      {
         this._listItem.setPriorityCommand(param1,param2,param3);
      }
      ...
      {
         var _loc1_:uint = uint(DynamicSquadState.getState(this._vehicleData));
      ...
      {
         return Boolean(this._vehicleData) ? this._vehicleData.vehicleID : NaN;
      }
      
      public function get accountDBID() : Number
      {
         return Boolean(this._vehicleData) ? this._vehicleData.accountDBID : NaN;
      }
