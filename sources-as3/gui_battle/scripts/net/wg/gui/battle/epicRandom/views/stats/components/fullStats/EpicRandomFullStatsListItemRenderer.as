package net.wg.gui.battle.epicRandom.views.stats.components.fullStats
{
   ...
   public class EpicRandomFullStatsListItemRenderer extends UIComponentEx implements IListItemRenderer
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            if(Boolean(this.vehicleIcon) && Boolean(this._vehicleImage))
            {
      ...
      private function vehicleDataSync() : void
      {
         if(Boolean(this._data))
         {
            ...
            this.selfBg.visible = Boolean(this._data) ? PlayerStatus.isSelected(this._data.playerStatus) : false;
            if(Boolean(this._squadItem))
            {
      ...
      {
         if(!this._dogTag && Boolean(param1))
         {
            this.buildDogTag();
         }
