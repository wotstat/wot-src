package net.wg.gui.battle.epicRandom.views.stats.components.fullStats
{
   ...
   public class EpicRandomFullStatsTableCtrl extends EpicRandomStatsTableCtrl implements ITabbedFullStatsTableController, ISquadHandler
   {
      ...
      public function onSquadBtVisibleChange(param1:DynamicSquadCtrl) : void
      {
         ...
         if(Boolean(_loc2_ != -1) && Boolean(_loc4_) && !_loc4_.isCurrentPlayer())
         {
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:int = int(this._table.team1PlayerList.rowCount);
         ...
         {
            _loc4_ = int(this._table.team2PlayerList.rowCount);
            _loc3_ = 0;
            while(_loc3_ < _loc4_)
            {
      ...
      public function updateColorBlind() : void
      {
         var _loc3_:EpicRandomFullStatsListItemRenderer = null;
         var _loc1_:int = 0;
         var _loc2_:int = int(this._table.team1PlayerList.rowCount);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
         ...
         _loc2_ = int(this._table.team2PlayerList.rowCount);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
      ...
      private function getRendererByAccountId(param1:Boolean, param2:int) : EpicRandomFullStatsListItemRenderer
      {
         ...
         var _loc5_:int = int(_loc3_.scrollPosition);
         while(_loc5_ < _loc4_)
         {
            _loc6_ = _loc3_.getRendererAt(_loc5_) as EpicRandomFullStatsListItemRenderer;
            if(Boolean(_loc6_) && _loc6_.getAccountId() == param2)
            {
               return _loc6_;
            }
            _loc5_++;
      ...
      public function set isRenderingAvailable(param1:Boolean) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = int(this._table.team2PlayerList.rowCount);
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
         {
         ...
         _loc4_ = int(this._table.team1PlayerList.rowCount);
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
         {
      ...
      override protected function updateTeamDPItems(param1:ListDataProviderEvent) : void
      {
         ...
         var _loc2_:uint = uint(this._table.team1PlayerList.scrollPosition);
      ...
      override protected function updateEnemyDPItems(param1:ListDataProviderEvent) : void
      {
         ...
         var _loc6_:DAAPIVehicleInfoVO = null;
         var _loc7_:EpicRandomFullStatsListItemRenderer = null;
         var _loc2_:uint = uint(this._table.team2PlayerList.scrollPosition);
         ...
         for each(_loc5_ in _loc4_)
         {
            if(!(_loc5_ < _loc2_ || _loc5_ > _loc3_))
            {
               ...
               if(Boolean(_loc6_) && Boolean(_loc7_))
               {
                  if(Boolean(this._dogTagsToShow[_loc6_.vehicleID]))
                  {
