package net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list
{
   ...
   public class PlayersPanelList extends MovieClip implements IEpicPlayersPanelList
   {
      ...
      public function removeAllItems() : void
      {
         ...
         var _loc4_:int = 0;
         if(Boolean(this._panelListItems))
         {
      ...
      public function setIsCursorVisible(param1:Boolean) : void
      {
         ...
         if(Boolean(this._itemUnderMouse))
         {
         ...
         if(!this._isCursorVisible && Boolean(this._dogTag))
         {
      ...
      public function setVehicleData(param1:Vector.<DAAPIVehicleInfoVO>) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            if(Boolean(_loc7_))
            {
               _loc8_ = int(this._vehicleIDtoPlayerGroup[_loc3_.vehicleID]);
         ...
         _loc4_ = 0;
         _loc5_ = int(this._currOrder.length);
         _loc6_ = 0;
         while(_loc6_ < _loc5_)
         {
            if(this._currOrder[_loc6_].length > _loc4_)
            {
               _loc4_ = int(this._currOrder[_loc6_].length);
            }
            _loc6_++;
         }
      ...
      public function updateOrder(param1:Vector.<Number>) : void
      {
         ...
         while(_loc9_ < _loc6_)
         {
            ...
            {
               _loc8_ = int(this._vehicleIDtoPlayerGroup[_loc7_]);
            }
            if(_loc8_ <= 0)
            {
      ...
      protected function setGroupIcons() : void
      {
         ...
         var _loc2_:uint = uint(1 << _loc1_ & 3);
         var _loc3_:uint = uint(1 << _loc2_ & 3);
      ...
      {
         var _loc2_:int = int(this._rendererStates.length);
         var _loc3_:int = 0;
         ...
         var _loc4_:int = int(this._spawnGroupIcons.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
      ...
      {
         if(Boolean(this._toolTipString))
         {
      ...
      private function onPlayersPanelOnItemOverHandler(param1:PlayersPanelItemEvent) : void
      {
         ...
         if(Boolean(this._itemUnderMouse.dogTag))
         {
