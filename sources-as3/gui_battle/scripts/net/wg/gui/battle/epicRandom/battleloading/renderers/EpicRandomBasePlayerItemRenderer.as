package net.wg.gui.battle.epicRandom.battleloading.renderers
{
   ...
   public class EpicRandomBasePlayerItemRenderer extends UIComponentEx implements IEpicRandomBattleLoadingRenderer
   {
      ...
      {
         if(this.selfBg != null && this.model != null)
         {
      ...
      {
         if(this.playerActionMarker != null && Boolean(this.model.vehicleAction))
         {
      ...
      private function updateState() : void
      {
         ...
         var _loc2_:Boolean = Boolean(UserTags.isCurrentPlayer(this.model.userTags));
      ...
      {
         this.prestigeLevel.markId = this.model.prestigeMarkId;
         this.prestigeLevel.level = this.model.prestigeLevel;
      }
