package net.wg.gui.battle.pveBase.views.stats.components.playersPanel.list
{
   ...
   public class PvePlayersPanelListRight extends PveBasePlayersPanelListRight
   {
      ...
      private var _renderersContainer:Sprite = new Sprite();
      
      private var _newVehicles:Vector.<Number> = new Vector.<Number>(0);
      
      private var _removedVehicles:Vector.<Number> = new Vector.<Number>(0);
      
      private var _vehiclesOrder:Vector.<Number> = new Vector.<Number>(0);
      
      private var _vehicleInfoDict:Dictionary = new Dictionary();
      
      private var _tweenByVehicleID:Dictionary = new Dictionary();
      
      private var _mapHolderByVehicleID:Dictionary = new Dictionary();
      
      private var _auxiliaryVehicleData:Dictionary = new Dictionary();
      
      private var _isCursorVisible:Boolean = false;
      
      private var _vehicleIDUnderMouse:int = -1;
      
      private var _holders:Vector.<IPvePlayersPanelListItemHolder> = new Vector.<IPvePlayersPanelListItemHolder>();
      ...
      {
         var _loc2_:IPlayersPanelListItemHolder = null;
         var _loc1_:int = int(this._vehiclesOrder.length);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_)
         {
      ...
      override public function removeAllItems() : void
      {
         ...
         if(Boolean(this._holders))
         {
            _loc1_ = int(this._holders.length);
            _loc3_ = 0;
            while(_loc3_ < _loc1_)
            {
...
class AuxiliaryVehicleData
{
   ...
   public function AuxiliaryVehicleData()
   {
      super();
   }
}
