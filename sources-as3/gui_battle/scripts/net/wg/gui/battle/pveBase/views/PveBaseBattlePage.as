package net.wg.gui.battle.pveBase.views
{
   ...
   public class PveBaseBattlePage extends BattlePage
   {
      ...
      {
         var _loc1_:int = battleMessenger.visible ? (battleMessenger.isHistoryEnabled ? OBJECTS_WIDGET_OFFSET : OBJECTS_WIDGET_WITHOUT_HISTORY_MESSAGES_OFFSET) : HIDDEN_CHAT_OFFSET;
      ...
      {
         return this.pvePlayerLives.visible && this.pvePlayerLives.isEnabled ? DAMAGE_PANEL_SPACING : 0;
      }
