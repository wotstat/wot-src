package net.wg.gui.battle.pveBase.views.minimap
{
   ...
   public class PveFullMap extends PveMinimapMeta implements IPveMinimapMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         var _loc1_:Number = Number(App.instance.appWidth);
         _loc2_ = Number(App.instance.appHeight);
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            this._clickAreaSpr.x = this.entriesContainer.x = this._clickAreaSpr.y = this.entriesContainer.y = this.simpleJacket.visible ? SIMPLE_JACKET_BORDER : PveFullMapGridJacket.THICK_BORDER;
