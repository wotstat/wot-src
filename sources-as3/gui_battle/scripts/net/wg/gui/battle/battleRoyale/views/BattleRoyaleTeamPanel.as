package net.wg.gui.battle.battleRoyale.views
{
   ...
   public class BattleRoyaleTeamPanel extends BattleRoyaleTeamPanelMeta implements IBattleRoyaleTeamPanelMeta, IBattleComponentDataController
   {
      ...
      private var _userTags:Dictionary = new Dictionary();
      
      private var _initUserTags:Vector.<DAAPIVehicleUserTagsVO> = new Vector.<DAAPIVehicleUserTagsVO>();
      ...
      public function updateUserTags(param1:IDAAPIDataClass) : void
      {
         ...
         var _loc3_:int = int(this._vIDToItemIndex[_loc2_.vehicleID]);
         ...
         if(Boolean(_loc4_))
         {
            ...
            if(Boolean(UserTags.isIgnored(_loc2_.userTags)) && Boolean(UserTags.isMuted(_loc2_.userTags)))
            {
      ...
      private function onVoiceChatStartSpeakingHandler(param1:VoiceChatEvent) : void
      {
         ...
         _loc2_ = Number(param1.getAccountDBID());
         var _loc3_:int = int(this._dbIDToItemIndex[_loc2_]);
         var _loc4_:BattleRoyaleTeamPanelListItem = this.getListItem(_loc3_);
         if(Boolean(_loc4_) && _loc4_.getVoiceState() == BATTLE_ROYAL_CONSTS.VOICE_DEFAULT)
         {
      ...
      private function onVoiceChatStopSpeakingHandler(param1:VoiceChatEvent) : void
      {
         ...
         var _loc3_:int = int(this._dbIDToItemIndex[_loc2_]);
         var _loc4_:BattleRoyaleTeamPanelListItem = this.getListItem(_loc3_);
         if(Boolean(_loc4_) && _loc4_.getVoiceState() == BATTLE_ROYAL_CONSTS.VOICE_ACTIVE)
         {
            _loc4_.setVoiceState(BATTLE_ROYAL_CONSTS.VOICE_DEFAULT);
         }
      }
