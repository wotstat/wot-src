package net.wg.gui.battle.battleRoyale.views
{
   ...
   public class BattleRoyaleTeamPanelListItem extends BattleUIComponent
   {
      ...
      private function applyState() : void
      {
         ...
         var _loc2_:Number = !this._isReady || !this._isAlive ? NOT_READY_STATUS_ALPHA : READY_STATUS_ALPHA;
      ...
      {
         if(!this._isCurrentPlayer && this._isCurrentPlayerTeam && Boolean(this._commons.isRightButton(param1)))
         {
