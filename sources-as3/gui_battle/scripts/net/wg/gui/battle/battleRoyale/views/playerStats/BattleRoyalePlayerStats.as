package net.wg.gui.battle.battleRoyale.views.playerStats
{
   ...
   public class BattleRoyalePlayerStats extends BattleRoyalePlayerStatsMeta implements IBattleRoyalePlayerStatsMeta, IShamrockListener
   {
      ...
      private var _renderers:Vector.<BattleRoyalePlayerStatRenderer> = new Vector.<BattleRoyalePlayerStatRenderer>();
      ...
      {
         super.draw();
         if(Boolean(this._shamrockAnimation) && isInvalid(InvalidationType.SIZE))
         {
            this._shamrockAnimation.x = 0;
            this._shamrockAnimation.y = SHAMROCK_ANIMATION_Y_OFFSET;
         }
      }
      ...
      override protected function onDispose() : void
      {
         ...
         this.bg = null;
         if(Boolean(this._shamrockAnimation))
         {
