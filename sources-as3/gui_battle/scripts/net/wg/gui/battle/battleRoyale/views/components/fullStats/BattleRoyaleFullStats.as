package net.wg.gui.battle.battleRoyale.views.components.fullStats
{
   ...
   public class BattleRoyaleFullStats extends BattleRoyaleFullStatsMeta implements IBattleRoyaleFullStatsMeta
   {
      ...
      private function layoutElements() : void
      {
         ...
         if(Boolean(this._minimapBounds))
         {
            ...
            this.score.y = _loc2_;
            _loc3_ = this._isSmallScreenSize ? MAP_NAME_MODE_SMALL_OFFSET_X : MAP_NAME_MODE_BIG_OFFSET_X;
            _loc4_ = this._isSmallScreenSize ? MAP_NAME_MODE_SMALL_OFFSET_Y : MAP_NAME_MODE_BIG_OFFSET_Y;
