package net.wg.gui.battle.battleRoyale.views
{
   ...
   public class BattleRoyalePostmortemPanel extends BattleRoyalePostmortemPanelMeta implements IBattleRoyalePostmortemPanelMeta, IStageSizeDependComponent
   {
      ...
      private var PLAYER_INFO_FILTERS:Array = [new DropShadowFilter(0,0,0,0.5,12,12),new DropShadowFilter(0,0,0,1,4,4)];
      ...
      {
         return Boolean(_userVO) && _userVO.userName != Values.EMPTY_STR ? GAP_VEHICLE_PANEL_DEAD_REASON : GAP_VEHICLE_PANEL_DEAD_REASON_SMALL;
      }
