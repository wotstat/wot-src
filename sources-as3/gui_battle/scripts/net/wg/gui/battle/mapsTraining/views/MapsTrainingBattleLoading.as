package net.wg.gui.battle.mapsTraining.views
{
   ...
   public class MapsTrainingBattleLoading extends MapsTrainingBattleLoadingMeta implements IMapsTrainingBattleLoadingMeta
   {
      ...
      private var _tutorialPageList:Vector.<TutorialPageContainer> = new Vector.<TutorialPageContainer>();
      ...
      private function setStepperPosition() : void
      {
         ...
         this.stepperBar.y = this._isMinResolution ? STEPPER_OFFSET_MIN : STEPPER_OFFSET;
      }
      ...
      private function setTextsPosition() : void
      {
         ...
         if(Boolean(this._tutorialPageList.length))
         {
            ...
            _loc2_ = this._isMinResolution ? HEADER_OFFSET_MIN : HEADER_OFFSET;
            _loc3_ = this._isMinResolution ? DESCRIPTION_OFFSET_MIN : DESCRIPTION_OFFSET;
      ...
      private function updatePosition() : void
      {
         ...
         var _loc1_:int = this._isMinResolution ? BTN_OFFSET_MIN : BTN_OFFSET;
      ...
      private function createImagesList() : void
      {
         ...
         var _loc1_:int = int(this._dataPage.length);
         var _loc2_:uint = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._dataPage) && isInvalid(InvalidationType.DATA))
         {
      ...
      private function disposeBackgroundRenderers() : void
      {
         ...
         var _loc1_:int = int(this._tutorialPageList.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function setPage(param1:Boolean) : void
      {
         if(param1)
         {
            this._picIndex = this._picIndex < this._tutorialPageList.length - 1 ? int(this._picIndex + 1) : 0;
         }
         else
         {
