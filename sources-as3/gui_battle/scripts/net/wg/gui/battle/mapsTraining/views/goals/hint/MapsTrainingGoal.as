package net.wg.gui.battle.mapsTraining.views.goals.hint
{
   ...
   public class MapsTrainingGoal extends Sprite implements IDisposable
   {
      ...
      private var _items:Vector.<MapsTrainingGoalItem> = new Vector.<MapsTrainingGoalItem>();
      
      private var _destroyedItems:Vector.<MapsTrainingGoalItem> = new Vector.<MapsTrainingGoalItem>();
