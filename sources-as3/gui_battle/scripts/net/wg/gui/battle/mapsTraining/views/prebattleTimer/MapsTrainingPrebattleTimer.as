package net.wg.gui.battle.mapsTraining.views.prebattleTimer
{
   ...
   public class MapsTrainingPrebattleTimer extends MapsTrainingPrebattleTimerMeta implements IMapsTrainingPrebattleTimerMeta
   {
      ...
      override protected function doUpdateSize(param1:String) : void
      {
         ...
         this.side.setSize(_loc2_,_loc2_ ? SIDE_FONT_SMALL : SIDE_FONT);
         this.title.setSize(_loc2_,_loc2_ ? TITLE_FONT_SMALL : TITLE_FONT);
         this.title.offset = _loc2_ ? TITLE_SMALL_OFFSET : 0;
         this.goals.offset = _loc2_ ? GOALS_SMALL_OFFSET : 0;
         this.goals.scale = _loc2_ ? GOALS_SMALL_SCALE : 1;
      }
