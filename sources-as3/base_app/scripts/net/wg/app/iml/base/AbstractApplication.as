package net.wg.app.iml.base
{
   ...
   public class AbstractApplication extends ApplicationMeta implements IApplication
   {
      ...
      final protected function registerManagers() : void
      {
      ...
      {
         if(Boolean(this._sharedLayoutManagerMgr))
         {
      ...
      final public function get loaderMgr() : ILoaderManager
      {
      ...
      final public function get utils() : IUtils
      {
         return this._utils;
      }
      
      final public function get tweenMgr() : ITweenManager
      {
      ...
      final public function get cursor() : ICursorManager
      {
         return this._cursorMgr;
      }
      
      final public function get cacheMgr() : ICacheManager
      {
