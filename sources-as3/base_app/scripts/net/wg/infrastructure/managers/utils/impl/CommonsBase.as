package net.wg.infrastructure.managers.utils.impl
{
   ...
   public class CommonsBase implements ICommons
   {
      ...
      public function keyToString(param1:Number) : KeyProps
      {
         ...
         {
            if(Boolean(KeysMap.mapping[_loc2_].hasOwnProperty(FIELD_TO_SHOW)))
            {
         ...
         {
            if(Boolean(KeysMap.mapping[param1].hasOwnProperty(FIELD_COMMAND)))
            {
      ...
      public function moveDsiplObjToEndOfText(param1:DisplayObject, param2:TextField, param3:int = 0, param4:int = 0) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            if(Boolean(param2.getLineText(_loc8_)))
            {
               _loc7_ = _loc8_;
               break;
            }
      ...
      private function getVirtualKey(param1:Number) : Number
      {
         ...
         {
            _loc2_ = Number(App.utils.mapScaleformToVirtualKeyS(param1));
            if(_loc2_ != 0)
            {
               param1 = _loc2_;
            }
      ...
      {
         var _loc2_:Number = Number(App.utils.getCharFromVirtualKeyS(param1));
         if(_loc2_ != 0)
         {
            return _loc2_;
         }
...
class UserProps implements IUserProps
{
   ...
   public function UserProps(param1:String, param2:String, param3:String, param4:int, param5:Array = null, param6:String = "")
   {
      super();
   ...
   {
      return Boolean(this._fakeName) && this._fakeName != this._userName;
   }
}
