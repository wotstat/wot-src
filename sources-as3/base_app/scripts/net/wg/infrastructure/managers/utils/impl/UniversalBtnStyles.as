package net.wg.infrastructure.managers.utils.impl
{
   ...
   public class UniversalBtnStyles implements IUniversalBtnStyles
   {
      ...
      private static const DISABLE_FILL_BMP_LINKAGE:String = "uniDisablePattern";
      ...
      private static const SLIM_SHINE_LINKAGE:String = "UniSlimBtnShineAnimUI";
      
      private static const SLIM_SHINE_WIDTH:uint = 160;
      ...
      public function UniversalBtnStyles()
      {
         ...
         this._styles[UniversalBtnStylesConst.STYLE_SLIM_BLACK] = new UniversalStyle(SLIM_STATES_BLACK_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_SLIM,TF_COLOR,_loc1_,STATES_BASIC_SHADOW_FILTER,SLIM_SHINE_LINKAGE,SLIM_SHINE_WIDTH);
         var _loc2_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_SLIM_ORANGE] = new UniversalStyle(SLIM_STATES_ORANGE_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_SLIM,TF_COLOR,_loc2_,STATES_ORANGE_SHADOW_FILTER,SLIM_SHINE_LINKAGE,SLIM_SHINE_WIDTH);
         var _loc3_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_SLIM_GREEN] = new UniversalStyle(SLIM_STATES_GREEN_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_SLIM,TF_COLOR,_loc3_,STATES_BASIC_SHADOW_FILTER,SLIM_SHINE_LINKAGE,SLIM_SHINE_WIDTH);
         var _loc4_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_SLIM_RED] = new UniversalStyle(SLIM_STATES_RED_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_SLIM,TF_COLOR,_loc4_,STATES_BASIC_SHADOW_FILTER,SLIM_SHINE_LINKAGE,SLIM_SHINE_WIDTH);
         var _loc5_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_SLIM_LIME] = new UniversalStyle(SLIM_STATES_LIME_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_SLIM,TF_COLOR,_loc5_,STATES_BASIC_SHADOW_FILTER,SLIM_SHINE_LINKAGE,SLIM_SHINE_WIDTH);
         var _loc6_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_HEAVY_BLACK] = new UniversalStyle(HEAVY_STATES_BLACK_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_HEAVY,TF_COLOR,_loc6_,STATES_BASIC_SHADOW_FILTER,Values.EMPTY_STR,Values.ZERO);
         var _loc7_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_HEAVY_GREEN] = new UniversalStyle(HEAVY_STATES_GREEN_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_HEAVY,TF_COLOR,_loc7_,STATES_BASIC_SHADOW_FILTER,Values.EMPTY_STR,Values.ZERO);
         var _loc8_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_HEAVY_ORANGE] = new UniversalStyle(HEAVY_STATES_ORANGE_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_HEAVY,TF_COLOR,_loc8_,STATES_ORANGE_SHADOW_FILTER,Values.EMPTY_STR,Values.ZERO);
         var _loc9_:Dictionary = createTextAlphaStates(1,1,1,1,1,0.6);
         this._styles[UniversalBtnStylesConst.STYLE_HEAVY_LIME] = new UniversalStyle(HEAVY_STATES_LIME_LINKAGE,DISABLE_FILL_BMP_LINKAGE,SLIM_TOGGLE_INDICATOR_LINKAGE,SLIM_TOGGLE_GLOW_LINKAGE,TF_SIZE_HEAVY,TF_COLOR,_loc9_,STATES_BASIC_SHADOW_FILTER,Values.EMPTY_STR,Values.ZERO);
      }
      ...
      public function setStyle(param1:IUniversalBtn, param2:String) : void
      {
         ...
         param1.setStyle(param2,_loc4_,_loc3_.tfSize,_loc3_.tfColor,_loc3_.statesTextFieldColor,_loc3_.disableBitmapSrc,_loc3_.tfShadowFilter,_loc3_.shineLinkage,_loc3_.shineWidth);
      }
