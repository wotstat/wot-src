package net.wg.infrastructure.managers.utils.impl
{
   ...
   public class TweenAnimator implements ITweenAnimator
   {
      ...
      private var tweensData:Vector.<TweenLinkedObjects> = new Vector.<TweenLinkedObjects>(0);
      ...
      final public function dispose() : void
      {
         ...
         this._disposed = true;
         while(this.tweensData.length > 0 && Boolean(this.tweenManager))
         {
      ...
      private function removeTween(param1:ITween) : void
      {
         ...
         {
            _loc3_ = this.tweensData[_loc2_];
            if(_loc3_.tween == param1 && Boolean(this.tweenManager))
            {
               this.tweensData.splice(_loc2_,1);
      ...
      {
         var _loc2_:uint = uint(param1.getTweenIdxS());
         var _loc3_:int = 0;
...
class TweenLinkedObjects implements IDisposable
{
   ...
   public function TweenLinkedObjects(param1:ITween, param2:DisplayObject, param3:ITweenAnimatorHandler)
   {
      super();
      this._tween = param1;
      this._target = param2;
