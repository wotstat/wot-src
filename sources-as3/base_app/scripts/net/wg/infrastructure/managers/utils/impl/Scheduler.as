...
class TimedTask extends Task
{
   ...
   public function TimedTask(param1:Number, param2:Function, param3:Array)
   {
      super(param2,param3);
...
class TimedTaskStack implements IDisposable
{
   ...
   public function TimedTaskStack()
   {
      super();
   ...
   internal function pushTask(param1:TimedTask, param2:Boolean = false) : void
   {
   ...
   internal function removeTaskByHandler(param1:Function) : Boolean
   {
   ...
   internal function popTask() : TimedTask
   {
      return this._tasks.pop();
   }
   
   internal function top() : TimedTask
   {
      return this._tasks[this._tasks.length - 1];
   }
   
   internal function isTop(param1:Function) : Boolean
   {
      if(!this.isEmpty())
      {
...
class InProcessTaskStack implements IDisposable
{
   ...
   public function InProcessTaskStack()
   {
      super();
      this._tasks = new Vector.<TimedTask>();
   }
   ...
   internal function removeTaskByHandler(param1:Function) : Boolean
   {
      var _loc2_:int = int(this._tasks.length);
      var _loc3_:int = 0;
      while(_loc3_ < _loc2_)
      {
   ...
   internal function push(param1:TimedTask) : void
   {
      this._tasks.push(param1);
   }
   
   internal function pull(param1:TimedTask) : TimedTask
   {
...
class NextFrameTasks implements IDisposable
{
   ...
   public function NextFrameTasks()
   {
      super();
   ...
   internal function pushTask(param1:Task) : void
   {
   ...
   internal function cancelAll() : void
   {
      var _loc2_:int = 0;
