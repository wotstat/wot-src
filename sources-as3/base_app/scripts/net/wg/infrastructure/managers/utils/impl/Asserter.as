package net.wg.infrastructure.managers.utils.impl
{
   ...
   public final class Asserter implements IAssertable
   {
      ...
      final public function assert(param1:Boolean, param2:String, param3:Class = null) : void
      {
         this.assertProcessing(param1,param2,param3);
      }
      
      final public function assertNotNull(param1:Object, param2:String, param3:Class = null) : void
      {
         this.assert(param1 != null,param2);
      }
      
      final public function assertNull(param1:Object, param2:String, param3:Class = null) : void
      {
         this.assert(param1 == null,param2);
      }
      ...
      final public function enableErrorLogging(param1:Boolean) : void
      {
      ...
      private function throwException(param1:String, param2:Class = null) : void
      {
         ...
         if(!Extensions.isGFxPlayer && Boolean(Extensions.isScaleform) && this._errorLoggingEnabled)
         {
      ...
      {
         if(!param1 && !Extensions.isGFxPlayer && Boolean(Extensions.isScaleform) && this._errorLoggingEnabled)
         {
