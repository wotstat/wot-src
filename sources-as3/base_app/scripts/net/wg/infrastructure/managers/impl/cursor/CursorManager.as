package net.wg.infrastructure.managers.impl.cursor
{
   ...
   public class CursorManager extends DroppingCursorManager implements ICursorManager
   {
      ...
      private var _dragObjects:Dictionary = new Dictionary(true);
      ...
      {
         return Boolean(super.cursorIsFree()) && !this._isOnDragging && !this._customLock;
      }
...
class DragInfo extends BaseInfo
{
   ...
   public function DragInfo(param1:IDraggable, param2:String)
   {
