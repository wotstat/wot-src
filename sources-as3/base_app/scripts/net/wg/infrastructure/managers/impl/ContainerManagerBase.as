package net.wg.infrastructure.managers.impl
{
   ...
   public class ContainerManagerBase extends ContainerManagerMeta implements IContainerManager, IContainerManagerMeta
   {
      ...
      private var _addWrapperInNextFrameDict:Dictionary = new Dictionary();
      ...
      public function ContainerManagerBase()
      {
         ...
         if(Boolean(App.instance) && Boolean(App.utils))
         {
      ...
      override protected function onDispose() : void
      {
         ...
         try
         {
            ...
            this._containersMap = null;
            if(Boolean(this._visibleContainers))
            {
      ...
      {
         if(Boolean(App.toolTipMgr))
         {
            App.toolTipMgr.hide();
         }
         if(Boolean(App.utils) && Boolean(App.utils.popupMgr))
         {
      ...
      public function as_isOnTop(param1:int, param2:String) : Boolean
      {
         ...
         try
         {
            ...
            result = Boolean(obj) && windowName == getViewName(obj);
         }
         catch(error:Error)
         {
            DebugUtils.LOG_ERROR(error.message,error.getStackTrace());
      ...
      public function as_show(param1:String, param2:int, param3:int) : Boolean
      {
         ...
         if(Boolean(_loc5_) && Boolean(_loc5_.view))
         {
            _loc6_ = _loc5_.view;
            _loc6_.x = param2;
            _loc6_.y = param3;
            ...
            if(Boolean(_loc8_) && Boolean(_loc8_.visible) && Boolean(_loc8_.manageFocus))
            {
      ...
      public function focusWrapper(param1:IViewWrapper = null, param2:uint = 0) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(_loc3_.manageFocus))
         {
      ...
      public function tryFocusView(param1:IView) : Boolean
      {
         ...
         _loc2_ = int(param1.as_config.configVO.layer);
      ...
      public function updateFocus(param1:Object = null) : void
      {
         ...
         for each(_loc2_ in _loc5_)
         {
            ...
            if(!(!_loc3_ || _loc3_ == param1))
            {
               ...
               if(!(Boolean(_loc6_) && !_loc6_.isFocusable))
               {
                  if(!_loc4_)
                  {
                     if(_loc3_.visible)
                     {
                        _loc4_ = Boolean(_loc3_.tryToSetFocus(true));
                     }
                  }
                  else
                  {
      ...
      public function updateStage(param1:Number, param2:Number) : void
      {
         ...
         {
            if(Boolean(_loc3_) && Boolean(_loc3_.manageSize))
            {
      ...
      private function removeItemFromContainer(param1:int, param2:IManagedContent) : void
      {
         ...
         if(Boolean(this._scheduler) && _loc3_ != null)
         {
      ...
      private function addWrapperInNextFrame(param1:DisplayObject, param2:int) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(_loc3_.manageFocus) && param1.visible)
         {
      ...
      private function onViewLoadedHandler(param1:LoaderEvent) : void
      {
         ...
         try
         {
            ...
            layer = int(asConfig.configVO.layer);
            ...
            n = int(this._containersForLoadingViews[layer].length);
            i = 0;
            while(i < n)
            {
      ...
      {
         var _loc2_:int = int(param1.config.layer);
      ...
      private function onViewDisposeHandler(param1:LifeCycleEvent) : void
      {
         ...
         var _loc5_:int = int(_loc2_.as_config.configVO.layer);
...
class ViewInfo implements IDisposable
{
   ...
   public function ViewInfo(param1:IManagedContainer, param2:IView)
   {
      super();
...
class AliasVO
{
   ...
   public function AliasVO(param1:String, param2:String)
   {
      super();
      this._alias = param1;
      this._name = param2;
