package net.wg.infrastructure.managers.impl
{
   ...
   public final class EnvironmentManager extends EventDispatcher implements IEnvironmentManager
   {
      ...
      final public function useEventSystem() : void
      {
         this._useEventSystem = true;
      }
      
      final public function useExternallInterface() : void
      {
         this._useEventSystem = false;
      }
      
      final public function addCallback(param1:String, param2:Function) : void
      {
      ...
      [Event(name="",type="net.wg.infrastructure.events.EnvironmentEvent")]
      final public function call(... rest) : *
      {
      ...
      [Event(name="",type="net.wg.infrastructure.events.EnvironmentEvent")]
      final public function envoke(param1:String) : *
      {
         this._result = null;
         if(this._useEventSystem)
         {
