package net.wg.infrastructure.managers.impl
{
   ...
   public class TutorialManager extends TutorialManagerMeta implements ITutorialManager
   {
      ...
      private var _ignoredInTutorialComponents:Vector.<DisplayObject> = new Vector.<DisplayObject>();
      
      private var _tutorialLinkages:Vector.<String> = new Vector.<String>();
      ...
      private var _idToView:Dictionary = new Dictionary();
      
      private var _componentToVO:Dictionary = new Dictionary(true);
      
      private var _criteriaHash:Object = {};
      
      private var _shownIds:Vector.<String> = new Vector.<String>();
      ...
      private var _buildersMap:BuildersMap = new BuildersMap();
      
      private var _unboudViewsForRegister:Dictionary = new Dictionary();
      
      private var _unboundComponents:Dictionary = new Dictionary();
      
      private var _dataUtils:IDataUtils = App.utils.data;
      ...
      private static function createPathFromRoot(param1:DisplayObject) : String
      {
         ...
         if(Boolean(param1))
         {
            ...
            while(Boolean(param1) && param1 != _loc3_)
            {
      ...
      override protected function onDispose() : void
      {
         ...
         _loc4_ = int(this._ignoredInTutorialComponents.length);
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
      ...
      override protected function updateExternalComponent(param1:String, param2:String, param3:TutorialComponentData) : void
      {
         ...
         if(Boolean(_loc4_) && Boolean(_loc4_.foundComponent))
         {
      ...
      override protected function externalComponentFound(param1:String, param2:String, param3:TutorialComponentData) : void
      {
         ...
         var _loc4_:TutorialComponentPathVO = this._idToVO[param1];
         if(Boolean(_loc4_) && !_loc4_.foundComponent)
         {
      ...
      override protected function showEffect(param1:String, param2:String, param3:String, param4:TutorialBuilderVO) : void
      {
         ...
         var _loc6_:int = int(setTimeout(this.showDelayedEffect,SHOW_DELAY,param1,param2,param3,new TutorialBuilderVO(param4.toHash())));
      ...
      public function as_getComponentGlobalBounds(param1:String, param2:String) : Object
      {
         ...
         if(Boolean(this._fullPathToVO[_loc3_]))
         {
      ...
      public function as_getComponentPath(param1:String, param2:String) : String
      {
         ...
         var _loc3_:String = this.makeFullPath(param1,param2);
         if(Boolean(this._fullPathToVO[param2]))
         {
      ...
      public function dispatchEventForCustomComponent(param1:ITutorialCustomComponent) : void
      {
         ...
         if(Boolean(this._isSystemEnabled))
         {
         ...
         while(_loc11_ < _loc9_)
         {
            ...
            if(_loc12_.match(_loc8_) != null)
            {
               if(_loc12_.indexOf(":") != -1 == (_loc7_.indexOf(":") != -1))
               {
                  ...
                  if(Boolean(StringUtils.isNotEmpty(_loc18_.viewTutorialId)) && _loc18_.viewTutorialId != param3)
                  {
                     return;
                  }
      ...
      public function registerUnboundComponent(param1:String, param2:String, param3:DisplayObject) : void
      {
         ...
         if(Boolean(_loc5_) && (Boolean(_loc5_.foundComponent) || Boolean(this._unboundComponents[_loc4_])))
         {
         ...
         if(Boolean(_loc5_) && Boolean(!_loc6_) && Boolean(this._idToView[param1]))
         {
      ...
      {
         var _loc3_:String = this.makeFullPath(param1,param2);
         if(Boolean(this._unboundComponents[_loc3_]))
         {
      ...
      {
         if(Boolean(this._idToView[param1]))
         {
      ...
      private function unregisterExternalComponent(param1:TutorialComponentPathVO) : void
      {
         ...
         if(Boolean(param1) && Boolean(param1.foundComponent))
         {
      ...
      private function createTriggerWatchers(param1:String, param2:Array) : Vector.<ITriggerWatcher>
      {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(Boolean(_loc6_) && Boolean(_loc6_.foundComponent))
            {
      ...
      private function checkForFullMatching(param1:Array, param2:Vector.<String>, param3:Vector.<DisplayObject>, param4:TutorialEvent) : int
      {
         ...
         var _loc5_:int = int(param4.pathPointNames.length);
         _loc6_ = 0;
         while(_loc6_ < _loc5_)
         {
            ...
            else
            {
               ...
               while(_loc12_ < _loc11_)
               {
                  ...
                  if(Boolean(_loc13_.match(new RegExp(_loc9_ + "?.*"))))
                  {
      ...
      private function clearCriteriaHash(param1:Function) : void
      {
         ...
         {
            if(Boolean(param1(this._criteriaHash[_loc3_])))
            {
               _loc2_.push(_loc3_);
            }
         }
      ...
      {
         var _loc2_:DisplayObject = param1.target as DisplayObject;
         if(Boolean(_loc2_) && _loc2_ == param1.currentTarget)
         {
      ...
      private function onViewReadyForTutorialHandler(param1:TutorialEvent) : void
      {
         ...
         if(param1.target != param1.currentTarget)
         {
            ...
            if(_loc2_.needPreventInnerEvents())
            {
               ...
               if(_loc3_ != null && Boolean(_loc3_.generatedUnstoppableEvents()))
               {
                  return;
               }
