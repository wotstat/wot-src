package net.wg.infrastructure.managers.impl
{
   ...
   public class ElementBlurAdapter implements IElementBlurAdapter
   {
      ...
      public function blurElements(param1:int, param2:int, param3:int) : void
      {
         ...
         for each(_loc6_ in this._containers)
         {
            if(_loc6_.layer < param1)
            {
               ...
               else
               {
                  ...
                  _loc10_ = int(_loc9_.numChildren);
                  _loc11_ = 0;
         ...
         if(Boolean(this._bluredElements) && Boolean(this._bluredElements.length))
         {
         ...
         var _loc7_:int = int(_loc5_.numChildren);
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
      ...
      {
         if(Boolean(this._bluredElements))
         {
