package net.wg.story_mode.battle.views.timer
{
   ...
   import net.wg.story_mode.infrastructure.base.meta.IStoryModeTimerMeta;
   import net.wg.story_mode.infrastructure.base.meta.impl.StoryModeTimerMeta;
   import org.idmedia.as3commons.util.StringUtils;
   
   public class StoryModeTimer extends StoryModeTimerMeta implements IStoryModeTimerMeta
   {
      ...
      private static const HINT_NO_TIMER_NO_HEADER_Y:int = -20;
      
      private static const HINT_TIMER_Y:int = 84;
      
      private static const HINT_TIMER_NO_HEADER_Y:int = 10;
      ...
      public function StoryModeTimer()
      {
         super();
      }
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = Boolean(StringUtils.isEmpty(this._header));
            if(StringUtils.isEmpty(this._time))
            {
               this.hintTask.y = _loc1_ ? HINT_NO_TIMER_NO_HEADER_Y : HINT_NO_TIMER_Y;
            }
            else
            {
               this.hintTask.y = _loc1_ ? HINT_TIMER_NO_HEADER_Y : HINT_TIMER_Y;
            }
      ...
      public function as_playFx(param1:Boolean, param2:Boolean, param3:String) : void
      {
         this.timer.playFx(param1,param2,param3);
      }
      ...
      {
         var _loc1_:int = 0;
         if(this._state == STATE_SMALL_ID || Boolean(StringUtils.isEmpty(this._time)))
         {
