   ...
   public class QuickStartContentBase extends UIComponentEx
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.SIZE))
         {
            ...
            this.averageTimeLabel.y = this.isSmall ? AVERAGE_TIME_LABEL_OFFSET_Y_SMALL : AVERAGE_TIME_LABEL_OFFSET_Y_BIG;
            this.clockIcon.y = this.isSmall ? CLOCK_OFFSET_Y_SMALL : CLOCK_OFFSET_Y_BIG;
            this.averageTimeText.y = this.isSmall ? AVERAGE_TIME_TEXT_OFFSET_Y_SMALL : AVERAGE_TIME_TEXT_OFFSET_Y_BIG;
         }
      }
