package net.wg.white_tiger.gui.lobby.battleQueue.components
{
   ...
   public class QuickStartHunterContent extends QuickStartContentBase
   {
      ...
      override protected function draw() : void
      {
         ...
         if(Boolean(this._data))
         {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
               ...
               rect.width = width;
               infoText.y = Boolean(rect.y + isSmall) ? INFO_OFFSET_Y_SMALL : INFO_OFFSET_Y_BIG;
               quickStartBtn.y = Boolean(rect.y + isSmall) ? QUICK_START_BTN_OFFSET_Y_SMALL : QUICK_START_BTN_OFFSET_Y_BIG;
               this.vehicleList.y = isSmall ? LIST_Y_SMALL : LIST_Y_BIG;
      ...
      {
         var _loc1_:int = isSmall ? WIDTH_SMALL : WIDTH_BIG;
         var _loc2_:int = isSmall ? HEIGHT_SMALL : HEIGHT_BIG;
      ...
      {
         return Boolean(this.vehicleList.selectedVehicle) ? this.vehicleList.selectedVehicle.vehID : int(Values.DEFAULT_INT);
      }
